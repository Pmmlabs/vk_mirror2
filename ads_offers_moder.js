var OffersModer = {
  ...
  showRequestInfo: function(requestId) {
    showBox('/offersmoder?act=a_request_info_box', {request_id: requestId}, {dark: 1});
  },
  ...
  showPreview: function(offerId) {
    var box = showBox('/offersmoder', {act: 'a_preview_box', offer_id: offerId}, {params: {width: 500, bodyStyle: 'padding: 25px; line-height: 180%;'}, dark: 1});
  ...
  showLog: function(offerId) {
    showBox('/offersmoder', {act: 'a_testlogs_box', offer_id: offerId}, {params: {width: 700, bodyStyle: 'padding: 25px; line-height: 180%;', hideButtons: 1}, dark: 1});
  },
...
try{stManager.done('ads_offers_moder.js');}catch(e){}
