...
function addQuery() {
    ...
    ajax.post('/cheatgroups.php', {
        'act': 'a_add_groupquery',
        'words': ge('add_query').value,
        'hash': ge('hash').value
    });
}
