! function(e) {
            ...
            o = window.WriteBox = {
                ...
                show: function(e, t) {
                    ...
                    if (e.setOptions({
                            ...
                            title: t.title,
                            titleControls: ('<a class="mail_box_header_link" href="/im?sel=' + a + '" onclick="return WriteBox.toFull(event, ' + a + ')">' + t.mail_go_to_dialog + "</a>").replace("%s", r)
                        ...
                        for (var i = [], c = t.emojiRcnt, s = 0, l = c.length; l > s; ++s) {
                            var u = c[s];
                            u && i.push('<a id="mbe_rc_em_' + u + '" class="mbe_rc_emojibtn" onmousedown="Emoji.addEmoji(cur.emojiWId, \'' + u + "', this); return cancelEvent(event);\">" + Emoji.getEmojiHTML(u, !1, !0) + "</a>")
                        }
                ...
                toFull: function(e, t) {
                    if (!checkEvent(e)) {
                        ...
                        if (n && (a.message = n), cur.mbMedia.chosenMedias) {
                            for (var i = cur.mbMedia.getMedias(), o = [], c = 0, s = i.length; s > c; ++c) {
                                var l = i[c],
                                    u = [];
                                for (var d in l) "object" != r(l[d]) && u.push(l[d]);
                                o.push(u.join(","))
                            }
                            a.media = o.join("*")
                        }
                ...
                send: function(e) {
                    if (!buttonLocked("mail_box_send")) {
                        ...
                        for (var n, c = 0, s = a.length; s > c; ++c)(n = a[c]) && r.media.push(n[0] + ":" + n[1]);
    ...
    128: function(e, t, a) {
        ...
        function o(e, t) {
            for (var a = void 0, r = 0, n = e; null !== (a = g.MESSAGE_REGEXP.exec(e));) {
                a = l(a);
                var i = a[0].length,
                    o = a.index + i,
                    c = e[a.index - 1],
                ...
                if (!d && !m) {
                    var b = u(a),
                        h = b.domain;
                    if (h.length <= g.MAX_DOMAIN_LENGTH && -1 !== g.TOP_DOMAINS.indexOf(h)) {
                        var p = t(b);
        ...
        function s(e, t) {
            return e.replace(g.MENTION, t || function(e, t, a, r, n) {
        ...
        function h(e, t) {
            ...
            if (o.length > 55 && (o = o.substr(0, 53) + ".."), o = k(o).replace(/&amp;/g, "&"), !e && i.match(g.OUR_DOMAINS)) {
                r = w(r).replace(g.ENTITIES, encodeURIComponent);
                var s = r,
                    l = r.indexOf("#/"),
                    u = "",
                    d = void 0;
                return l >= 0 ? s = r.substr(l + 1) : (l = r.indexOf("#!"), l >= 0 && (s = "/" + r.substr(l + 2).replace(/^\//, ""))), d = s.match(g.VK_DOMAIN), d && d[1].length < 32 && (u = ' mention_id="' + d[1] + '" onclick="return mentionClick(this, event)" onmouseover="mentionOver(this)"'), '<a href="' + p(a + r + n) + '" target="_blank"' + u + ">" + o + "</a>"
            }
    ...
    155: function(e, t) {
        ...
        var r, n = "\\w\\$А-Яа-яёЁєЄҐґЇїІіЈј",
            ...
            k = "бг,бел,дети,ею,католик,ком,мкд,мон,москва,онлайн,орг,рус,рф,сайт,срб,укр",
            ...
            _ = (t.OUR_DOMAINS = /^([a-zA-Z0-9\.\_\-]+\.)?(vkontakte\.ru|vk\.com|vkadre\.ru|vshtate\.ru|userapi\.com|vk\.me)$/, t.ENTITIES = /([^a-zA-Z0-9#%;_\-.\/?&=\[\]])/g, t.VK_DOMAIN = /^(?:https?:\/\/)?(?:vk\.com|vkontakte\.ru)?\/([a-zA-Z0-9\._]+)\??$/, t.MENTION = /\[(id|club)(\d+)(?:\:([a-z0-9_\-]+))?\|([^\$]+?)\]/g, t.MENTION_RAW = /(^|[\s.,:\'\";>\)\(])(\*|@)([A-Za-z0-9_\.]{2,32})\s*\((.+?)\)/g, t.ARROW_UP = 38),
            x = t.ARROW_DOWN = 40,
            j = t.PAGE_UP = 33,
            E = t.PAGE_DOWN = 34,
            D = t.END_KEY = 35,
    ...
    163: function(e, t) {
        ...
        function i(e, t, a) {
            return t === d ? e[t] || [] : t === m ? e[t] && e[t][a] : e[t] ? extend(!0, {}, e[t][a]) : null
        }
        ...
        function c(e, t) {
            for (var a = ["fwd", "draft", "bind_attach"], i = r(e), o = !1, c = a.length; c--;) a[c] in i && (delete i[a[c]], o = !0);
            o && n(e, i, t)
        }
        ...
        function l(e) {
            ...
            return window.addEventListener("storage", l, !1), {
                select: function(t, n) {
                    return Date.now() - a.checkTime > 1e3 && (a.db = r(e)), i(a.db, t, n)
                },
                selectByKey: function(t) {
                    return Date.now() - a.checkTime > 1e3 && (a.db = r(e)), a.db[t]
                },
                update: function(r, i) {
                    var c = o(a.db, r, i);
                    return a.db = c, a.checkTime = Date.now(), n(e, c, t)
                },
                updateByKey: function(r, i) {
                    return a.db[r] = i, a.checkTime = Date.now(), n(e, a.db, t)
                },
                unmount: function() {
