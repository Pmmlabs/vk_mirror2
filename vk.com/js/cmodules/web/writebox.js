! function(e) {
    ...
    function mt(e) {
        return e.peer ? fe(e.peer, e) ? me(e.peer, e) : (0,
            Bt.isFullyLoadedTab)(e, e.peer) ? e.tabs[e.peer].allShown : !1 : !0
    }
    ...
    var r = n(6),
        ...
        c = function() {
            var e, t = n(146)("iframe"),
                r = i.length,
                a = ">";
            for (t.style.display = "none", n(53).appendChild(t), t.src = "javascript:", e = t.contentWindow.document, e.open(), e.write("<script>document.F=Object</script" + a), e.close(), c = e.F; r--;) delete c[u][i[r]];
            return c()
        };
    ...
    for (var r = n(47), a = n(9), i = n(140), o = n(143), s = n(102), u = n(123), c = u("iterator"), d = u("toStringTag"), l = s.Array, m = ["NodeList", "DOMTokenList", "MediaList", "StyleSheetList", "CSSRuleList"], f = 0; 5 > f; f++) {
        var _, p = m[f],
            g = i[p],
            h = g && g.prototype;
        if (h) {
    ...
    var r = n(29),
        ...
        i = n(30),
        o = {};
    n(143)(o, n(123)("iterator"), function() {
        return this
    }), e.exports = function(e, t, n) {
        e.prototype = r(o, {
            next: a(1, n)
    ...
    var r, a = "\\w\\$А-Яа-яёЁєЄҐґЇїІіЈј",
        ...
        T = (t.OUR_DOMAINS = /^([a-zA-Z0-9\.\_\-]+\.)?(vkontakte\.ru|vk\.com|vkadre\.ru|vshtate\.ru|userapi\.com|vk\.me)$/,
