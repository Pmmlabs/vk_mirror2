! function(e) {
    ...
    18: function(e, t, n) {
        ...
        function ot(e, t) {
            ...
            var o = ut(e, t),
                u = i + kt(e, t.text, t.kludges, !1, t.peerId);
        ...
        function dt(e, t, n) {
            ...
            var s = [];
            t.local || (s = e.imQueue(t.peerId, r)), s.length > 0 && Bt(s.map(function(e) {
            ...
            if (!g || wt(o, g, t, e, i)) {
                var v = "",
                    y = !1;
                if (p && Object(c.isOut)(t) && Sn(e, n, t.peerId), 1 === o.unread && !Object(c.isOut)(t) && i && (v += he("im_mess_bar", {}), y = !0, Sn(e, n, t.peerId)), !Te(new Date(b))) {
                    var O = new Date,
            ...
            } else p && e.peer === t.peerId && !o.inplaceSearch && Object(c.isOut)(t) && Sn(e, n, t.peerId), ce("_im_stack_messages", _).appendChild(V(l));
        ...
        function wt(e, t, n, r, i) {
            ...
            var a = yt(t.date, r),
                o = yt(n.date, r);
            return !Ee(a, o) || (!(!Object(u.isCommunityInterface)(r) || Z(t.kludges.from_admin) === Z(n.kludges.from_admin)) || (n.date - t.date > 300 || (!(!Object(c.isServiceMsg)(t) && !Object(c.isServiceMsg)(n)) || (!(!Object(c.isCallMessage)(n) && !Object(c.isCallMessage)(t)) || (!(!Object(c.isGift)(t) && !Object(c.isGift)(n)) || (!(!Object(c.isGraffiti)(t) && !Object(c.isGraffiti)(n)) || (!!Object(c.hasReply)(n) || !(Object(c.isUnread)(e, t) === Object(c.isUnread)(e, n) || !i || Object(c.isOut)(n) || Zt(n.peerId, r.gid)))))))))
        }
        ...
        function Kt(e, t, n, r) {
            ...
            var a = (Object(u.isClassicInterface)(r), 60),
                o = Wt(e, t, n, r, !1, i);
            return o.length > a ? Wt(e, t, n, r, !0, i) : o
        }
        ...
        function Xt(e, t, n) {
            ...
            if (s = (s = ve(c.sex, be(s, "raw"))).replace("{from}", Yt(c.link, c.name, r)), o && o !== u) {
                ...
                if (l) s = s.replace("{user}", Yt("/im?email=" + encodeURIComponent(l), "email", r));
                    ...
                    s = s.replace("{user}", Yt(f.link, _, r))
                }
            }
            if (i.source_text) {
            ...
            if (i.source_act === P || i.source_act === x)
                if (i.source_message) {
                    var p = Yt("", Qt(Le.emojiToHTML(ee(i.source_message.replace(/<br\s?\/?>/gi, " ")), !0)), !1, "im_srv_mess_link");
                    s = s.replace("{msg}", p)
        ...
        function wn(e, t) {
            return On(e.get(), t, Object(u.getTab)(e, t).last_seen)
        }
        ...
        function zn(e, t) {
            e.bodyNode.addEventListener("mouseover", function(e) {
                me(e.target, "_im_edit_time") && Gn(t, 0, e.target)
            })
        }
    ...
    65: function(__webpack_module__, __webpack_exports__, __webpack_require__) {
        "use strict";
        ...
        var _utils_common__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(0),
            _ui_util__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(99),
            _debug_tools__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(112);
    ...
    99: function(__webpack_module__, __webpack_exports__, __webpack_require__) {
        "use strict";
        ...
        var _dom__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(103),
