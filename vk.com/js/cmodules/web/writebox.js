! function(e) {
    ...
    Object.defineProperty(t, "__esModule", {
        value: !0
    }), t.unpackStore = a, t.getFirstUnread = i, t.getPeer = o, t.getTab = s, t.getCurrentTab = u, t.getSelectedMessages = c, t.getMessageRangeFromSelection = d, t.countUnread = l, t.getMessageByRid = m, t.isRidExist = f, t.getLocalId = _, t.getLastMessage = p, t.parserMessage = g, t.getAuthorFullName = h, t.getMessage = v, t.isClassicInterface = b, t.isLocksAvailable = y, t.isFoldersAvailable = E, t.isCommunityInterface = T, t.getBareTab = I, t.isReversedDialogs = k, t.isFullyLoadedTab = O, t.makeTabNotFullyLoaded = L, t.isGoToEndVisible = A, t.getUnreadScrollBottom = w, t.isSendingAvailable = S, t.isCommunityPeer = C, t.isCommunityBlocked = M, t.checkVoiceMessageAvailable = R, t.isSearching = P, t.getSearchText = x, t.isSearchingValue = D, t.isRecentSearchesActive = N, t.getPinnedMessage = j, t.doPopularSuggExist = F, t.isAnyMessageBeingEdited = H, t.getTabDraft = U;
    var G = n(37),
        B = n(70),
        q = r(B),
        z = n(68),
    ...
    e.exports = function(e, t, n, p, g, h) {
        ...
        if ("function" == typeof b && (h || E.forEach && !l(function() {
            ...
            }), b.prototype = E, E.constructor = b), (L || w) && (I("delete"), I("has"), g && I("get")), (w || O) && I(y), h && E.clear && delete E.clear
    ...
    var r, a = "\\w\\$А-Яа-яёЁєЄҐґЇїІіЈј",
        ...
        w = t.ENTER = 13,
        S = t.ESC = 27,
        C = (t.UNPRINTABLE_KEYS = [T, I, k, O, w, S, L, A], t.UP_DOWN_CONTROLS = [k, O, I, T, A, L], t.PRINTABLE = "printable", t.FOLDER_UNREAD = "unread"),
        M = t.FOLDER_ALL = "all",
    ...
    t.deleteEvent = r, t.replaceFlagsEvent = a, t.setFlagsEvent = i, t.resetFlagsEvent = o, t.addMessageEvent = s, t.editMessageEvent = u, t.editMessageLocallyEvent = c, t.readInboundEvent = d, t.readOutboundEvent = l, t.gotOnlineEvent = m, t.gotOfflineEvent = f, t.resetDirectoriesEvent = _, t.replaceDirectoriesEvent = p, t.setDirectoriesEvent = g, t.deleteDialogEvent = h, t.chatChangedEvent = v, t.typingUserEvent = b, t.typingChatEvent = y, t.videoCallEvent = E, t.unreadCountEvent = T, t.notifySettingsChangedEvent = I, t.emptyEvent = k, t.transitionEvent = O, t.resyncEvent = L, t.resetPeer = A, t.changePeer = w, t.changeTab = S, t.failedMessage = C, t.mutexEvent = M, t.resendEvent = R;
    var x = n(81),
        D = n(3),
    ...
    var r = n(98),
        ...
        c = function() {
            var e, t = n(78)("iframe"),
                r = i.length,
                a = ">";
            for (t.style.display = "none", n(94).appendChild(t), t.src = "javascript:", e = t.contentWindow.document, e.open(), e.write("<script>document.F=Object</script" + a), e.close(), c = e.F; r--;) delete c[u][i[r]];
            return c()
        };
    ...
    function u(e, t) {
        ...
        return t ? '<div class="im_sticker_row">\n      <a onmouseover="return Emoji.stickerOver(' + Vt(e) + ', this);"\n        onclick="return Emoji.clickSticker(' + Vt(t) + ', this, event);">\n          <img height="128"\n            class="im_gift"\n            src="/images/stickers/' + Vt(e) + "/" + n + '.png"/>\n      </a>\n    </div>' : '<div class="im_sticker_row">\n      <img height="128"\n        class="im_gift"\n        src="/images/stickers/' + Vt(e) + "/" + n + '.png"/>\n    </div>'
    }
    ...
    function d(e, t, n) {
        ...
        return a && (t = J([a], t), t = b(e, n, t, !0, !1)), t
    }

    function l(e) {
        var t = (0, lt.checkVoiceMessageAvailable)(e);
    ...
    function g(e, t, n) {
        ...
        return a && a.parentNode.replaceChild(Bt(r), a), n
    }

    function h(e, t) {
        var n = ["_im_mess"],
            r = (0, gt.isUnread)(e.tabs[t.peerId], t);
        (0, gt.isOut)(t) && r && n.push("im-mess_unread _im_mess_unread"), (0, gt.isOut)(t) && n.push("im-mess_out"), (0, gt.wasEdited)(t) && n.push("im-mess_was_edited"), (0, It.canMessageBeEdited)(e, t) && n.push("im-mess_editable"), (0, gt.isImportant)(t) && n.push("im-mess_fav"), -1 != (e.selectedMessages || []).indexOf(t.messageId) && n.push("im-mess_selected");
        var a = Date.now() - 1e3 * t.date > 1e3;
        t.local && a && n.push("im-mess_sending"), t.local && n.push("" + kt), t.local && (0, gt.wasEdited)(t) && !r && n.push("im-mess_unread im-mess_nobg"), t.failed && n.push("im-mess_failed " + Ot), (0, gt.isGift)(t) && n.push("im-mess_gift");
        var i = v(t),
            o = D(t.text, t.kludges);
        "" != o && (0, gt.wasEdited)(t) && (o += fn("sImLblWasEdited", {
            update_time: t.update_time
        })), t.subject && "..." !== t.subject.trim() && !A(t.peerId) && (o = fn("im_topic", {
            topic: t.subject
        }) + o);
        var s = fn("im_message_media", {
            messageId: t.messageId,
            attaches: i.join(""),
            text: (0, gt.isGift)(t) ? '<div class="im-mess--gift-lbl">' + o + "</div>" : ""
        });
        return (0, gt.isGift)(t) || (s = o + s), "" == o && (0, gt.wasEdited)(t) && (s += fn("sImLblWasEdited", {
            update_time: t.update_time
        })), fn("im_msg_row", {
            msg_id: t.messageId,
            from_id: t.peerId,
    ...
    function b(e, t, n) {
        var r = (arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : !0, arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : !0),
            ...
            o = e.tabs[t.peerId];
        if (!n || rn("_im_mess", n) || rn("_im_bar_date", n) || (n.innerHTML = ""), o.skipped > 0) return n;
        var s = [];
        t.local || (s = e.imQueue(t.peerId, r)), s.length > 0 && J(s.map(function(e) {
        ...
        var u = h(e, t),
            c = Zt(n);
        cn(c, "_im_mess_stack") || (c = en(c, "._im_mess_stack", -1));
        var d = (0, lt.getLastMessage)(e, t.peerId, t.messageId),
            l = rn("_im_unread_bar_row", n),
            m = (0, gt.getUserId)(t),
            f = d ? R(d.date, e) : 0;
        if (!d || P(o, d, t, e, a)) {
            var _ = "",
                p = !1;
            if (l && (0, gt.isOut)(t) && Ue(e, n, t.peerId), 1 === o.unread && !(0, gt.isOut)(t) && a && (_ += fn("im_mess_bar", {}), p = !0, Ue(e, n, t.peerId)), !Tn(new Date(f))) {
                var g = new Date,
                    v = p ? "im-page--history-new-bar_hide _im_invisible_bar" : "";
                _ += fn("im_day_bar", {
                    day: yn(t.date, e.timeshift, !0, _n("months_of", "raw"), !0),
                    date: t.date,
                    day_class: g.getDate() + g.getMonth() + g.getFullYear() + " " + v
                })
            }
            if (oe(t)) _ += fn("im_service_row", {
                text: ue(e, t, o),
                type: "",
                date: t.date,
                from_id: "",
                ...
                var b = e.gid && (0, gt.isOut)(t) ? Vt(t.kludges.from_admin) || 0 : 0,
                    E = (0, Et.oCacheGet)(e, b ? -e.gid : m) || o,
                    T = A(t.peerId) ? E.name : E.first_name,
                    I = E.link || o.href,
                    k = fn("im_mess_stack_name", {
                        name: T,
                        link: I,
                        "class": (0, gt.isMoney)(t) ? " im-mess-stack--lnk-money-transfer" : ""
                    });
                if ((0, gt.isGift)(t)) {
                    var O = _n("mail_gift_message_sent", "raw");
                    k += ' <span class="im-mess-stack--gift">' + pn(E.sex || 0, O) + "</span>"
                }
                if ((0, gt.isMoney)(t)) {
                    var L = (0, gt.isMoneyRequest)(t) ? _n("mail_money_request_message_sent", "raw") : _n("mail_money_tranfer_message_sent", "raw");
                    k += ' <span class="im-mess-stack--money-transfer">' + pn(E.sex || 0, L) + "</span>"
                }
                t.attaches[0] && "chronicle_invite" === t.attaches[0].type && (k += " " + _n("mail_chronicle_invite_inf"));
                var w = e.gid ? "/gim" + e.gid : "/im",
                    S = void 0;
                if (S = t.local ? x(t.date, e.timeshift) : fn("im_stack_date", {
                        date: x(t.date, e.timeshift),
                        link: w + "?sel=" + t.peerId + "&msgid=" + t.messageId
                    }), b && e.admins[b]) {
                    var C = e.admins[b],
                        M = b === Ut.id ? _n("mail_by_you") : C[0];
                    S = S + " " + fn("im_admin_link", {
                        name: M,
                        href: C[1]
                    })
                }
            ...
            }(0, yt.toArray)(Wt(_)).forEach(function(e) {
                return n && n.appendChild(e)
            })
        } else l && e.peer === t.peerId && !o.inplaceSearch && (0, gt.isOut)(t) && Ue(e, n, t.peerId), rn("_im_stack_messages", c).appendChild(Bt(u));
        return (0, gt.isOut)(t) && !i && setTimeout(function() {
            var e = rn("_im_mess_" + t.messageId, n);
            cn(e, kt) && on(e, "im-mess_sending")
    ...
    function y(e, t, n) {
        ...
        return r = "object" === ("undefined" == typeof e ? "undefined" : dt(e)) ? e : t.imQueue(e, !1), r.length > 0 && r.map(function(e) {
            ...
            return (0, lt.getMessage)(t, e.peerId, e.messageId)
        }).forEach(function(e) {
            return b(t, e, n, !1)
        }), n
    }
    ...
    function k(e, t) {
        if (!(0, lt.isFullyLoadedTab)(t, e.peerId)) return 0;
    ...
    function P(e, t, n, r, a) {
        if ((0, gt.getUserId)(t) !== (0, gt.getUserId)(n)) return !0;
        var i = R(t.date, r),
            o = R(n.date, r);
        return En(i, o) ? (0, lt.isCommunityInterface)(r) && Vt(t.kludges.from_admin) !== Vt(n.kludges.from_admin) ? !0 : n.date - t.date > 300 ? !0 : oe(t) || oe(n) ? !0 : (0, gt.isGift)(t) || (0, gt.isGift)(n) ? !0 : (0, gt.isGraffiti)(t) || (0, gt.isGraffiti)(n) ? !0 : (0, gt.isUnread)(e, t) === (0, gt.isUnread)(e, n) || !a || (0, gt.isOut)(n) || le(n.peerId, r.gid) ? !1 : !0 : !0
    }

    function x(e, t) {
        return gn(1e3 * e, "{hour}:{minute} {am_pm}", 1e3 * t, [], !0)
    }
    ...
    function D(e, t) {
        ...
        }), t.emoji && (e = Rn.emojiToHTML(e, !0)), e
    }

    function N(e) {
        return A(e) ? "c" + (e - 2e9) : w(e) ? "e" + Math.abs(e + 2e9) : e
    }
    ...
    function Q() {
        return '<li class="im-search-results-head _im_recent_bar">\n    ' + _n("mail_recent_searches") + '\n    <button type="button" class="' + jt + ' im-page--clear-recent">' + _n("mail_clear_recent") + "</button>\n  </li>"
    }

    function Y(e) {
        var t = e.get().popular_sugg,
            n = (0, lt.isClassicInterface)(e) ? 8 : 5;
    ...
    function $(e, t, n) {
        ...
        if (r) {
            dn(r, "aria-hidden", "false"), on(r, "im-mess_failed " + Ot);
    ...
    function X(e, t, n) {
        ...
        if (r) {
            sn(r, "im-mess_failed"), dn(r, "aria-hidden", "true"), sn(r, Ot);
            var a = rn("_im_mess_marker", r);
    ...
    function ee(e, t, n, r) {
        return e.map(function(e) {
            ...
            mn(e, ae(t, e, n)), on(e, "im-mess_light")
        }), r
    }
    ...
    function te(e, t, n) {
        ...
        if (r) {
            var a = rn(Lt, r);
            mn(r, a.innerHTML), sn(r, "im-mess_light")
        }
        return n
    }
    ...
    function ne(e, t, n, r) {
        ...
        var o = ((0, lt.isClassicInterface)(r), 60),
            s = re(e, t, n, r, !1, a);
    ...
    function re(e, t, n, r, a) {
        ...
        if (L(t) || (0, lt.isCommunityPeer)(t)) {
            var s = n ? "" : (0, Et.oCacheGet)(r, t).first_name;
            return s + " " + _n("mail_typing")
        }
        var u = _n("mail_typing_several", o.length),
            c = o.slice(0, o.length > i ? i : i - 1).filter(function(e) {
                return (0, Et.oCacheExists)(r, e)
            }),
            d = a ? "short_name" : "name",
            l = c.map(function(e) {
                return (0, Et.oCacheGet)(r, e)[d]
            }).join(", ");
        if (o.length > i) {
            var m = o.length - i;
            l += " " + _n("mail_and_peer").replace("{count}", m).replace("{typing}", u)
        } else {
            var f = !!l,
                _ = void 0;
            f && o[i - 1] && (l += " " + _n("mail_and_peer_one") + " "), _ = f && o.length !== i || !o[i - 1] ? "" : (0, Et.oCacheGet)(r, o[i - 1])[d], l += _ + " " + u
        }
        return l
    }
    ...
    function ae(e, t, n) {
        ...
        return '<div class="im-mess--text">\n    ' + _n(a) + ' <button type="button" data-peer="' + e + '" class="' + At + ' im-mess--btn">' + _n("mail_restore") + '</button>\n    <div class="' + Lt + ' im-mess--original">' + r + "</div>\n  </div>"
    }
    ...
    function ue(e, t, n) {
        ...
        if (c = pn(u.sex, _n(c, "raw")), c = c.replace("{from}", se(u.link, u.name, r)), o && o !== s) {
            var l = a.source_email;
            if (l) c = c.replace("{user}", se("/im?email=" + encodeURIComponent(l), "email", r));
            else {
                var m = (0, Et.oCacheGet)(e, o),
                    f = i === Mt ? m.inv_name : m.kick_name;
        ...
        if (a.source_act === xt || a.source_act === Dt)
            if (a.source_message) {
                var p = de(Rn.emojiToHTML(Yt(a.source_message.replace(/<br\s?\/?>/gi, " ")), !0)),
    ...
    function me(e, t) {
        return An(e, {
            url: (0, lt.isCommunityPeer)(t) ? "al_groups.php" : "al_profile.php",
            params: {
                act: "verified_tt",
                mid: t,
                gid: t
    ...
    function fe(e) {
        return function(t) {
            ...
            setTimeout(function() {
                ...
                i = !0, sn(a, "im-preloader_visible"), a.parentNode && a.parentNode.removeChild(a)
            })
        }
    }
    ...
    function ve(e, t) {
        var n = _n(A(e) ? "mail_chat_sure_to_delete_all" : (0, lt.isCommunityPeer)(e) ? "mail_group_sure_to_delete_all" : "mail_sure_to_delete_all");
        return On({
                ...
                var i = (0, bt.createModule)({
                    handlers: function(a, o) {
                        o(r.bodyNode.parentNode, "click", "_im_invite_box", function() {
                            r.hide(), Te(e, e.get().peer, t, n), (0, bt.destroyModule)(i)
    ...
    function ke(e, t, n, r) {
        ...
        var a = (0, lt.isReversedDialogs)(t);
        return t.set(r.bind(null, e)).then(function(e) {
            return n().restoreDialogs(e, !0, a !== (0, lt.isReversedDialogs)(e)), e
        })
    }
    ...
    function Le(e, t) {
        var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : !1;
        if ("undefined" == typeof t && (t = e.get().peer), !(0, lt.isFoldersAvailable)(e)) return !1;
    ...
    function Me(e, t, n) {
        ...
        return !Ln("al_im.php", {
            ...
            params: {
                width: 638,
                onHide: function() {
                    Mn.loaded && Mn.detachPlayer(!0), r.unmount()
                }
            }
        }, n)
    }
    ...
    function Re(e, t) {
        var n = (0, lt.getTab)(e, t).last_seen;
        if (n[0]) return 2 === n[2] ? '<span class="is_vk_mobile is_online">' + _n("mail_header_online_status") + Pe(t, !1, !0) + "</span>" : "online" + (Sn[n[0]] ? Pe(t) : "");
        if (!n[1]) return "";
    ...
    function Ue(e, t, n) {
        ...
        var a = en(r, "._im_mess_stack", -1),
            ...
            o = a ? nn("_im_mess", a).pop() : null,
            s = i ? rn("_im_mess", i) : null;
        if (qt(r), p(t), !s || !o) return t;
        var u = tn(o, "msgid"),
            c = tn(s, "msgid"),
            d = (0, lt.getMessage)(e, n, u),
            l = (0, lt.getMessage)(e, n, c);
        if (P(e.tabs[n], d, l, e)) return t;
        var m = rn("_im_stack_messages", a),
            f = rn("_im_stack_messages", i).children;
        return (0, yt.toArray)(f).forEach(function(e) {
            qt(e), m.appendChild(e)
        }), qt(i), t
    }

    function Ge(e, t, n) {
        var r = (0, lt.getFirstUnread)(e, e.get().peer);
        if (!r) return [!1, 0];
        var a = rn("_im_mess_" + r, t);
        if (!a) {
            var i = (0, lt.getLastMessage)(e, e.get().peer, r);
            if (!i) return [!0, 0];
            a = rn("_im_mess_" + i.messageId, t)
        }
        var o = cn(a, "_im_mess_srv") ? a : an("_im_mess_stack", a);
        if (!o) return [!0, 0];
    ...
    function Be(e, t, n) {
        ...
        a && cn(a, "im-page--dialogs-notice") && sn(a, "im-page--dialogs-notice"), In.post("al_im.php", {
    ...
    function qe(e, t, n) {
        ...
        Pn(r, 200, qt.pbind(r)), In.post("al_im.php", {
            act: "a_hide_top_notice",
            type: r.getAttribute("data-type"),
            hash: r.getAttribute("data-hash")
        })
    ...
    function ze(e, t, n, r, a) {
        return n = n.replace(/\<br\s*\/?\>(\n)?/gi, " ").replace(/[\n\r]/gi, " "), n = (0, ht.replaceMentions)(n, function(e, t, n, r, a) {
            return a
        }), r && (n = Rn.emojiToHTML(n, !0)), t && "..." !== t.trim() && !A(e) && (n = fn("im_topic", {
            topic: t,
            cls: "im-topic_dialog"
    ...
    function Ve(e) {
        ...
        var u = Ke(n, r),
            c = ct(u, 1),
            d = c[0];
        return Object.keys(Un).length > 300 && (Un = {}), Un[e] = d, d
    }
    ...
    function Qe(e, t) {
        ...
        switch (e.type) {
            case "mail":
                return hn(e.object.fwd_count, _n("mail_fwd_msgs", "raw"), !0);
            case "photo":
            case "video":
            case "audio":
    ...
    function Xe(e) {
        var t = e.get(),
            n = (0, lt.getPinnedMessage)(e);
        if (!n || !(0, Tt.isPinnedMessageVisibleInTab)(e, (0, lt.getPeer)(e))) return "";
    ...
    function tt(e, t) {
        return A(e.peerId) ? e.memberIds.indexOf(t) >= 0 && e.inactiveIds.indexOf(t) < 0 : !1
    }

    function nt(e) {
        return !A(e.peerId) || e.data.kicked ? 0 : e.memberIds.length - e.inactiveIds.length
    }
    ...
    function it(e, t) {
        var n = [],
            ...
            a = r ? r[1].split(";") : [];
        for (a.length > jn && (r[1] = a.slice(0, jn).join(";")); e.length > Nn;) {
        ...
        for (e.length && n.push({
                ...
                attaches: t
            }), a = a.slice(jn); a.length; a = a.slice(jn)) n.push({
            attaches: [
                ["mail", a.slice(0, jn).join(";")]
            ]
        });
        return n
    }
    ...
    function ut() {
        On(_n("global_error"), _n("mail_message_wait_until_uploaded"))
    }
    Object.defineProperty(t, "__esModule", {
        value: !0
    ...
    }), t.getClassicChatHeight = a, t.setClassicChatHeight = i, t.fixTableCellChildHeight = o, t.applyInnerHtml = s, t.renderSticker = u, t.isAlreadyDeleted = c, t.replaceMessageAttrs = d, t.isVoiceMessageAvailable = l, t.getAvailableMicrophones = m, t.renderAttach = f, t.dayFromVal = _, t.showInvisibleBar = p, t.editAndReplaceMessage = g, t.renderMessage = h, t.renderMessageMedia = v, t.appendToHistory = b, t.restoreQueue = y, t.markMessagesAsRead = T, t.replaceAttaches = I, t.isDuplicate = k, t.isReservedPeer = O, t.isUserPeer = L, t.isChatPeer = A, t.isPeerActive = S, t.isTabLoaded = C, t.isTabLoadedWithMessage = M, t.parseMessage = D, t.convertPeerToUrl = N, t.unUrlPeer = j, t.simplifyCounter = F, t.chatActions = H, t.renderPhotos = B, t.renderPhotosFromTab = q, t.renderBtnSearchOnlyMessages = z, t.renderMessagesSep = W, t.renderConversationsSep = K, t.renderPopularSuggSep = V, t.renderClearRecent = Q, t.renderPopularSuggestions = Y, t.setMessageError = $, t.startResendMessage = X, t.removeMessages = Z, t.removeMessagesWithRestore = ee, t.restoreMessage = te, t.formatTyper = ne, t.formatTyperHelper = re, t.renderEmptySearch = ie, t.isServiceMsg = oe, t.serviceLink = se, t.renderServiceMsg = ue, t.addChatPhotoToUpdate = ce, t.replaceSpecialSymbols = de, t.isSelfMessage = le, t.showVerifiedTooltip = me, t.wrapLoading = fe, t.tabFromIds = _e, t.checkSelectClick = pe, t.renderGoTo = he, t.showFlushDialog = ve, t.showUnpinDialog = be, t.cleanHistory = ye, t.showChatMembers = Ee, t.inviteUser = Te, t.showUnreadOnly = Ie, t.changeTab = ke, t.isImportant = Oe, t.isUnrespond = Le, t.isPeerBlocked = Ae, t.isPendingForward = we, t.isPeerBlockedByMe = Se, t.blockLatencyCompensation = Ce, t.showSpamLayer = Me, t.getLastSeenTextInHeader = Re, t.getMobileIcon = Pe, t.showBlacklistBoxUser = xe, t.showBlacklistBox = De, t.getBaseLink = Ne, t.showFavvedBox = je, t.isEditableFocused = Fe, t.updateStar = He, t.removewNewUnreadBarAndMerge = Ue, t.isMessagesVisible = Ge, t.hideTopNotice = Be, t.hideAsideNotice = qe, t.renderShortText = ze, t.parseFwd = Ve, t.attachToText = Qe, t.lockButton = Ye, t.unlockButton = $e, t.renderPinnedMessage = Xe, t.showEditTimeTooltip = Ze, t.boxHandleEditTimeTooltips = Je, t.showPinnedBox = et, t.isUserAliveInChat = tt, t.getAliveMembersCount = nt, t.normalizeTab = rt, t.normalizeTabsGotFromServer = at, t.splitMessageToParts = it, t.isMessageTooLong = ot, t.showInvitationBox = st, t.showWaitUntilUploadedBox = ut;
    var mt = n(70),
        ft = r(mt),
        _t = n(68),
        pt = r(_t),
        ...
        Tt = n(59),
        It = n(6),
        kt = t.SENDING_CLASS = "_im_mess_sending",
        Ot = t.FAILED_CLASS = "_im_mess_failed",
        Lt = t.ORIGINAL_CLASS = "_im_mess_original",
        At = t.RESTORE_CLASS = "_im_mess_restore",
        wt = (t.TYPING_CLASS = "_im_typing", t.CREATE_CHAT_ACTION = "chat_create"),
        St = t.CHAT_TITLE_ACTION = "chat_title_update",
        Ct = t.CHAT_INVITE_USER = "chat_invite_user",
        Mt = t.CHAT_KICK_USER = "chat_kick_user",
        Rt = t.CHAT_PHOTO_UPDATE = "chat_photo_update",
        Pt = t.CHAT_PHOTO_REMOVE = "chat_photo_remove",
        xt = t.CHAT_PIN_MESSAGE = "chat_pin_message",
        Dt = t.CHAT_UNPIN_MESSAGE = "chat_unpin_message",
        Nt = t.CHAT_INVITE_BY_LINK = "chat_invite_user_by_link",
        jt = (t.DESELECT_ALL_CLASS = "_im_deselect_all", t.SHOW_CHAT_MEMBERS_CLASS = "_im_show_chat_mems", t.HIDE_TOP_NOTICE_CLASS = "_im_top_notice_hide", t.HIDE_ASIDE_NOTICE_CLASS = "_im_aside_notice_hide", t.CLEAR_RECENT_CLASS = "_im_clear_recent"),
        ...
        Ln = Ht.showTabbedBox,
        An = Ht.showTooltip,
        wn = Ht.mobileOnlineTip,
        Sn = Ht.mobPlatforms,
        Cn = Ht.onlinePlatformClass,
        Mn = Ht.AudioMessagePlayer,
        Rn = Ht.Emoji,
        Pn = Ht.slideUp,
        xn = Ht.fadeOut,
        Dn = Ht.cancelEvent,
    ...
    var r = n(73),
        ...
        i = n(63),
        o = {};
    n(127)(o, n(104)("iterator"), function() {
        return this
    }), e.exports = function(e, t, n) {
        e.prototype = r(o, {
            next: a(1, n)
    ...
    for (var r = n(42), a = n(108), i = n(121), o = n(127), s = n(134), u = n(104), c = u("iterator"), d = u("toStringTag"), l = s.Array, m = ["NodeList", "DOMTokenList", "MediaList", "StyleSheetList", "CSSRuleList"], f = 0; 5 > f; f++) {
        var _, p = m[f],
            g = i[p],
            h = g && g.prototype;
        if (h) {
    ...
    e.exports = function(e, t, n, v, b, y, E) {
        ...
        var T, I, k, O = function(e) {
            ...
            C = S[m] || S[_] || b && S[b],
            M = C || O(b),
            R = b ? A ? O("entries") : M : void 0,
            P = "Array" == t ? S.entries || C : C;
        if (P && (k = l(P.call(new e)), k !== Object.prototype && (d(k, L, !0), r || s(k, m) || o(k, m, h))), A && C && C.name !== g && (w = !0, M = function() {
                return C.call(this)
            }), r && !E || !f && !w && S[m] || o(S, m, M), u[t] = M, u[L] = h, b)
            if (T = {
                    values: A ? M : O(g),
                    keys: y ? M : O(p),
                    entries: R
    ...
    function H(e, t) {
        if ((0, Bt.isFullyLoadedTab)(t, e.peerId)) {
            var n = t.tabs[e.peerId],
                r = n.unread;
            if (t = L(t, e.peerId, e.upToId, 0), n.unread = e.upToId >= n.lastmsg ? 0 : (0, zt.countUnread)(e.peerId, t) + (n.unread > 0 ? +n.skipped : 0), r > 0 && !n.unread && F(t, -1, e.peerId), !n.skipped) {
                var a = c(n.history);
    ...
    function U(e, t) {
        var n = t.tabs[e.peerId];
        if ((0, Bt.isTabLoaded)(t, e.peerId) && L(t, e.peerId, e.upToId, Ft.FLAG_OUTBOUND), (0, Bt.isFullyLoadedTab)(t, e.peerId)) {
            var r = c(n.history);
    ...
    t.readLastMessages = u(function(e, t) {
        ...
        return n.skipped > 0 && (r = r.filter(function(e) {
            ...
            return L(t, e, r, Ft.FLAG_OUTBOUND)
        }))
        ...
        return Le(e, (0, Dt.post)("al_im.php", {
            act: "a_flush_history",
            id: e,
            from: "im",
            gid: t.gid,
