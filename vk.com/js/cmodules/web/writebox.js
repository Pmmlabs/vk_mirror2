! function(e) {
    ...
    var r = n(250),
        ...
        i = n(184),
        o = {};
    n(152)(o, n(165)("iterator"), function() {
        return this
    ...
    t.readLastMessages = u(function(e, t) {
        ...
        return (0, Ft.post)(Ft.CONTROLLER, {
            ...
            var r = Nt(t, 2),
                a = (r[0], r[1]);
            return n.tabs[e] = extend(n.tabs[e], (0,
                Wt.normalizeTab)(n, a)), n
        })
    ...
    var r = n(26),
        ...
        c = function() {
            var e, t = n(190)("iframe"),
                r = i.length,
                a = ">";
            for (t.style.display = "none", n(92).appendChild(t), t.src = "javascript:", e = t.contentWindow.document, e.open(), e.write("<script>document.F=Object</script" + a), e.close(), c = e.F; r--;) delete c[u][i[r]];
            return c()
        };
    ...
    for (var r = n(112), a = n(166), i = n(259), o = n(152), s = n(239), u = n(165), c = u("iterator"), l = u("toStringTag"), d = s.Array, m = ["NodeList", "DOMTokenList", "MediaList", "StyleSheetList", "CSSRuleList"], f = 0; 5 > f; f++) {
        var p, g = m[f],
            _ = i[g],
            h = _ && _.prototype;
        if (h) {
