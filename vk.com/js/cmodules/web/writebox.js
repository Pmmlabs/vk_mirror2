! function(e) {
    ...
    46: function(e, t, n) {
        ...
        function h(e) {
            return s(e, "link") && (t = e.kludges.attach1_url, /^https:\/\/(.+\.)?vk\.com\/vk-me\.php\?act=join&(amp;)?link=[\w\/=_]+$/.test(t) || /^https:\/\/vk\.me\/join\/[\w\/=_]+$/.test(t));
            var t
        }
    ...
    66: function(e, t, n) {
        ...
        function ot(e) {
            return e.attaches.map(function(t) {
                return "sticker" === t.type ? e.messageId ? $e(t.id, t.productId, t.kind, e.messageId) : $e(t.id, t.productId) : et(t.type)
            })
        }
        ...
        function vt(e, t, n, r, i) {
            ...
            var a = bt(t.date, r),
                c = bt(n.date, r);
            return !je(a, c) || (!(!Object(o.isCommunityInterface)(r) || Q(t.kludges.from_admin) === Q(n.kludges.from_admin)) || (n.date - t.date > 300 || (!(!Object(u.isServiceMsg)(t) && !Object(u.isServiceMsg)(n)) || (!(!Object(u.isCallMessage)(n) && !Object(u.isCallMessage)(t)) || (!(!Object(u.isGift)(t) && !Object(u.isGift)(n)) || (!(!Object(u.isGraffiti)(t) && !Object(u.isGraffiti)(n)) || !(Object(u.isUnread)(e, t) === Object(u.isUnread)(e, n) || !i || Object(u.isOut)(n) || Xt(n.peerId, r.gid))))))))
        }
        ...
        function Wt(e, t, n) {
            ...
            if (i.source_act === M || i.source_act === x)
                if (i.source_message) {
                    var h = Vt("", $t(De.emojiToHTML(J(i.source_message.replace(/<br\s?\/?>/gi, " ")), !0)), !1, "im_srv_mess_link");
                    s = s.replace("{msg}", h)
