! function(e) {
    ...
    253: function(e, t, n) {
        ...
        function ot(e, t) {
            var n = ["_im_mess"],
                ...
                i = Object(c.hasReply)(t) && e.newReplyAllowed ? he("im_message_media", {
                    type: "reply",
            ...
            t.local && a && n.push("im-mess_sending"), t.local && n.push("" + w), t.local && Object(c.wasEdited)(t) && !r && n.push("im-mess_unread im-mess_nobg"), t.failed && n.push("im-mess_failed " + O), Object(c.isGift)(t) && n.push("im-mess_gift");
            var o = ut(e, t),
                u = i + Ot(e, t.text, t.kludges, !1, t.peerId);
            "" != u && Object(c.wasEdited)(t) && (u += he("sImLblWasEdited", {
                update_time: t.update_time
            })), t.subject && "..." !== t.subject.trim() && !Object(d.isChatPeer)(t.peerId) && (u = he("im_topic", {
                topic: t.subject
            }) + u);
            var s = he("im_message_media", {
                type: "media",
                messageId: t.messageId,
                attaches: o.join(""),
                text: Object(c.isGift)(t) ? '<div class="im-mess--gift-lbl">' + u + "</div>" : ""
            });
            return Object(c.isGift)(t) || (s = u + s), "" == u && Object(c.wasEdited)(t) && (s += he("sImLblWasEdited", {
                update_time: t.update_time
            })), he("im_msg_row", {
                msg_id: t.messageId,
                from_id: t.peerId,
        ...
        function ut(e, t) {
            ...
            return t.attaches.reduce(function(e, r) {
                return Object(c.hasReply)(t) && n && ("mail" === r.type || "reply" === r.type) ? e : ("sticker" === r.type ? t.messageId ? e.push($e(r.id, r.productId, r.kind, t.messageId)) : e.push($e(r.id, r.productId)) : e.push(tt(r.type)), e)
            }, [])
        }
        ...
        function dt(e, t, n) {
            ...
            var s = [];
            t.local || (s = e.imQueue(t.peerId, r)), s.length > 0 && Ut(s.map(function(e) {
            ...
            for (var g = Object(u.getLastMessage)(e, t.peerId, t.messageId); t.peerId === e.peer && g && !ce("_im_mess_" + g.messageId);) g = Object(u.getLastMessage)(e, t.peerId, g.messageId);
            ...
            if (!g || yt(o, g, t, e, i)) {
                var v = "",
                    y = !1;
                if (p && Object(c.isOut)(t) && Cn(e, n, t.peerId), 1 === o.unread && !Object(c.isOut)(t) && i && (v += he("im_mess_bar", {}), y = !0, Cn(e, n, t.peerId)), !Te(new Date(b))) {
                    var O = new Date,
                ...
                if (Object(c.isServiceMsg)(t)) v += he("im_service_row", {
                    text: Yt(e, t, o),
                    type: "",
                    date: t.date,
                    from_id: "",
                ...
                else if (Object(c.isCallMessage)(t)) v += he("im_service_row", {
                    text: Vt("", st(t, !1, e), ""),
                    type: "",
                    date: t.date,
                    from_id: "",
                    ...
                    var j = e.gid && Object(c.isOut)(t) ? Z(t.kludges.from_admin) || -e.gid : 0,
                    ...
                    if (Object(c.isMoney)(t)) {
                        var S = Object(c.isMoneyRequest)(t) ? be("mail_money_request_message_sent", "raw") : be("mail_money_tranfer_message_sent", "raw");
                        A += ' <span class="im-mess-stack--money-transfer">' + ve(E.sex || 0, S) + "</span>"
                    }
                    var M = e.gid ? "/gim" + e.gid : "/im",
                        P = void 0;
                    if (P = t.local ? wt(t.date, e.timeshift) : he("im_stack_date", {
                            date: wt(t.date, e.timeshift),
                            link: M + "?sel=" + t.peerId + "&msgid=" + t.messageId
                        }), j && e.admins[j]) {
                        var x = e.admins[j],
                            D = j === K.id ? be("mail_by_you") : x[0];
                ...
                Object(f.toArray)($(v)).forEach(function(e) {
                    return n && n.appendChild(e)
                })
            } else p && e.peer === t.peerId && !o.inplaceSearch && Object(c.isOut)(t) && Cn(e, n, t.peerId), ce("_im_stack_messages", _).appendChild(V(l));
            return Object(c.isOut)(t) && !a && setTimeout(function() {
                var e = ce("_im_mess_" + t.messageId, n);
                me(e, w) && de(e, "im-mess_sending")
        ...
        function yt(e, t, n, r, i) {
            ...
            var a = vt(t.date, r),
                o = vt(n.date, r);
            return !Ee(a, o) || (!(!Object(u.isCommunityInterface)(r) || Z(t.kludges.from_admin) === Z(n.kludges.from_admin)) || (n.date - t.date > 300 || (!(!Object(c.isServiceMsg)(t) && !Object(c.isServiceMsg)(n)) || (!(!Object(c.isCallMessage)(n) && !Object(c.isCallMessage)(t)) || (!(!Object(c.isGift)(t) && !Object(c.isGift)(n)) || (!(!Object(c.isGraffiti)(t) && !Object(c.isGraffiti)(n)) || (!!Object(c.hasReply)(n) || !(Object(c.isUnread)(e, t) === Object(c.isUnread)(e, n) || !i || Object(c.isOut)(n) || Qt(n.peerId, r.gid)))))))))
        }
        ...
        function kt(e) {
            return Object(d.isChatPeer)(e) ? "c" + (e - 2e9) : e < -2e9 ? "e" + Math.abs(e + 2e9) : e
        }
        ...
        function Rt(e, t, n) {
            ...
            if (r) {
                _e(r, "aria-hidden", "false"), de(r, "im-mess_failed " + O);
        ...
        function Ft(e, t, n) {
            ...
            if (r) {
                le(r, "im-mess_failed"), _e(r, "aria-hidden", "true"), le(r, O);
                var i = ce("_im_mess_marker", r);
        ...
        function Gt(e, t, n, r) {
            return e.map(function(e) {
                ...
                pe(e, function(e, t, n) {
                    var r = t.innerHTML;
                    return '<div class="im-mess--text">\n    ' + be("delete" === n ? "mail_deleted_stop" : "mail_marked_as_spam") + ' <button type="button" data-peer="' + e + '" class="' + j + ' im-mess--btn">' + be("mail_restore") + '</button>\n    <div class="' + k + ' im-mess--original">' + r + "</div>\n  </div>"
        ...
        function zt(e, t, n, r) {
            ...
            var a = (Object(u.isClassicInterface)(r), 60),
                o = Kt(e, t, n, r, !1, i);
        ...
        function Kt(e, t, n, r, i, a) {
            var o, c, s, l = [],
                f = (e && e.userIds || []).filter(function(e) {
                    var t = Object(m.oCacheExists)(r, e);
                    return t || l.push(e), t && e != r.id
                });
            if (l.length && Object(p.loadChatMember)((s = l, (c = t) in (o = {}) ? Object.defineProperty(o, c, {
                    value: s,
                    enumerable: !0,
                    configurable: !0,
                    writable: !0
                }) : o[c] = s, o), r), 0 === f.length) return "";
            var _ = Object(d.isUserPeer)(t) || Object(u.isCommunityPeer)(t) ? "first_name" : i ? "short_name" : "name";
            if (1 == f.length) return (n ? "" : Object(m.oCacheGet)(r, f[0])[_]) + " " + be("mail_typing");
            var g = be("mail_typing_several", f.length),
                h = f.slice(0, Math.min(f.length - 1, a)),
                b = h.map(function(e) {
                    return Object(m.oCacheGet)(r, e)[_]
                }).join(", ");
            if (f.length > a + 1) b += " " + be("mail_and_peer").replace("{count}", e.totalCount - a).replace("{typing}", g);
            else {
                var v = Object(m.oCacheGet)(r, f[h.length])[_];
                b += " " + be("mail_and_peer_one") + " " + v + " " + g
            }
            return b
        }
        ...
        function Yt(e, t, n) {
            ...
            if (s = (s = ve(c.sex, be(s, "raw"))).replace("{from}", Vt(c.link, c.name, r)), o && o !== u) {
                var l = i.source_email;
                if (l) s = s.replace("{user}", Vt("/im?email=" + encodeURIComponent(l), "email", r));
                else {
                    var f = Object(m.oCacheGet)(e, o),
                        _ = a === C ? f.inv_name : f.kick_name;
                    s = s.replace("{user}", Vt(f.link, _, r))
                }
            }
            if (i.source_text) {
            ...
            if (i.source_act === P || i.source_act === x)
                if (i.source_message) {
                    var p = Vt("", $t(Le.emojiToHTML(ee(i.source_message.replace(/<br\s?\/?>/gi, " ")), !0)), !1, "im_srv_mess_link");
                    s = s.replace("{msg}", p)
        ...
        function nn(e, t) {
            return '<div class="im-mess--text">\n      <span>' + be("mail_restored") + '</span>\n      <a class="_im_go_to" href="/im?sel=' + kt(e) + "&msgid=" + t + '">' + be("mail_im_goto_conversation") + "</a>\n    </div>"
        }
        ...
        function rn(e, t, n) {
            var r = be("mail_deleteall1"),
                ...
                a = be("mail_delete");
            return Object(d.isChatPeer)(t) && (Object(b.doesChatTabHaveFlag)(e, 1024) ? (r = be("mail_leave_channel"), i = be("mail_unfollow_channel_confirmation"), a = be("mail_unfollow_channel")) : i = be("mail_chat_sure_to_delete_all")), Object(u.isCommunityPeer)(t) && (i = be("mail_group_sure_to_delete_all")), Ce(r, i, a, n, be("global_cancel"))
        }
        ...
        function an(e, t, n) {
            var r = Object(u.getTab)(e, t),
                ...
                s = be("mail_delete");
            if (i) {
                if (r.data.closed || r.data.kicked) return rn(r, t, n.bind(null, !0));
                a ? (o = be("mail_leave_channel"), c = be("mail_vkcomgroup_leave_confirm"), s = be("mail_leave_channel")) : (o = be("mail_leave_chat"), c = be("mail_chat_leave_confirm"), s = be("mail_leave_chat"))
            }
            Object(u.isCommunityPeer)(t) && (c = be("mail_group_sure_to_delete_all"));
        ...
        function yn(e, t) {
            return wn(e.get(), t, Object(u.getTab)(e, t).last_seen)
        }

        function wn(e, t, n, r) {
            if (n[0]) return be("mail_header_online_status") + (Pe[n[0]] ? On(t, !1, !1, !0) : "");
            if (!n[1]) return "";
            var i = Oe(n[1], e.timeshift),
                a = ve(Object(m.oCacheGet)(e, t).sex, be("mail_last_activity_tip", "raw")).replace("{user}", "").replace("{time}", i);
        ...
        function Sn(e, t, n) {
            ...
            var o = me(i, "_im_mess_srv") ? i : se("_im_mess_stack", i);
            if (!o) return [!0, 0];
        ...
        function Pn(e, t, n) {
            ...
            Ne(r, 200, Y.pbind(r)), Ie.post("al_im.php", {
                act: "a_hide_top_notice",
                type: r.getAttribute("data-type"),
                hash: r.getAttribute("data-hash")
            })
        ...
        function xn(e, t) {
            ...
            Ne(n, 200, Y.pbind(n)), Ie.post("al_im.php", {
        ...
        function Ln(e, t, n, r, i) {
            return n = n.replace(/\<br\s*\/?\>(\n)?/gi, " ").replace(/[\n\r]/gi, " "), n = Object(s.replaceMentions)(n, function(e, t, n, r, i) {
                return i
            }), r && (n = Le.emojiToHTML(n, !0)), t && "..." !== t.trim() && !Object(d.isChatPeer)(e) && (n = he("im_topic", {
                topic: t,
                cls: "im-topic_dialog"
        ...
        function Hn(e) {
            ...
            }) : Ot(e, i, n && n.kludges || {}) || ""), i = i.replace(/<br\s?\/?>/gi, " "), he("im_pinned_message", {
        ...
        function Un(e, t) {
            ...
            if (t && Object(c.isMoneyRequest)(t) && void 0 !== t.kludges.attach1_tr_amount) {
                ...
                if (Z(t.kludges.attach1_held_amount)) {
                    var u = we(t.kludges.attach1_held_amount / 1e3, r, !0);
                    n += " " + be("mail_money_request_held_amount").replace("{amount}", u)
                }
                t.text && (n += '<span class="divider"></span>' + Ot(e, t.text, t.kludges)), t.kludges.attach1_total_amount && (n += he("im_pinned_message_media_bar", {
        ...
        function qn(e, t) {
            e.bodyNode.addEventListener("mouseover", function(e) {
                me(e.target, "_im_edit_time") && Bn(t, 0, e.target)
            })
        }
        ...
        function ar(e, t, n, i) {
            i && !Qe(e, n, i) && (Object(u.getMessage)(e, n, i) ? (e.setState({
                msgid: i
        ...
        function or(e) {
            ...
            var n = e.get().tabs[e.get().peer],
                r = Object(u.parserMessage)(n.msgs[oe(t, "msgid")]);
    ...
    27: function(__webpack_module__, __webpack_exports__, __webpack_require__) {
        "use strict";
        ...
        var _dom__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(178),
            _utils_common__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(316);
    ...
    286: function(e, t, n) {
        ...
        function R(e, t) {
            ...
            }, r.msgs), t.imQueueSet(e, i), t.tabs[e].history = Object(s.restoreQueue)(i, t, x(t.tabs[e].history)), Promise.resolve(t)
        }
        ...
        function F(e, t, n) {
            ...
            return n.imQueueSet(e, r), n.tabs[e].history = Object(s.removeMessages)([t], x(n.tabs[e].history)), Promise.resolve(n)
        }
        ...
        function Z(e, t, n) {
            var r = n.tabs[e];
            return r.msgs[t.messageId] && (r.msgs[t.messageId].errored = 1, r.history = Object(s.setMessageError)(e, t, x(r.history))), Promise.resolve(n)
        }

        function J(e, t, n, r) {
            var i = r.tabs[e];
            return i.msgs[t] && (i.msgs[t].errored = 0, i.lastmsg_meta = n, i.lastmsg = t, i.history = Object(s.startResendMessage)(e, t, x(i.history))), Promise.resolve(r)
        }
        ...
        var ve = function(e, t, n, i) {
                var a = Date.now() + rand(0, 100).toFixed(0),
                    o = i.ref_id,
                    u = i.ref_source;
                i.ref_source = void 0, i.ref_id = void 0, (u || o) && (T({
                    ref_source: null,
                    ref: null
                }), I()), Object(h.statlogsSendingQueueLength)(i);
        ...
        function Ee(e, t) {
            if (Object(s.isFullyLoadedTab)(t, e.peerId)) {
                ...
                t.imQueueSet(e.peerId, r), t.imQueueComplete(e.peerId, e.randomId), n.lastmsg_meta = e, n.lastmsg = e.messageId, n.msgs["rid" + e.randomId] && (n.msgs[e.messageId] = e, delete n.msgs["rid" + e.randomId]), n.history = Object(s.replaceMessageAttrs)(t, x(n.history), e)
            }
            return Promise.resolve(t)
        }
        ...
        function Ie(e, t) {
            ...
            return Object(o.retryFn)(r.post, 3, function(e) {
                ...
                return Object(h.statlogsSendingError)(t, n, "unknown", "server_load_attach"), Ae(e, null, t)
            })
        }
        ...
        function Ce(e, t) {
            var n = t.tabs[e.peerId];
            return n.history = Object(s.replaceAttaches)(x(n.history), e, t), Promise.resolve(t)
        }
        ...
        function Ze(e, t, n) {
            if (Object(s.isFullyLoadedTab)(n, t)) {
                var r = n.tabs[t];
                r.history = Object(s.removeMessages)(e, x(r.history)), r.offset -= e.filter(function(e) {
                    return r.msgs[e]
        ...
        function et(e, t, n, r) {
            if (Object(s.isFullyLoadedTab)(r, t)) {
                var i = r.tabs[t];
                i.deleted = i.deleted ? i.deleted.concat(e) : e, i.history = Object(s.removeMessagesWithRestore)(e, t, n, x(i.history)), i.offset -= e.filter(function(e) {
                    return i.msgs[e]
                }).length
            }
            return Promise.resolve(r)
        ...
        function tt(e, t, n) {
            if (Object(s.isFullyLoadedTab)(n, t)) {
                ...
                r.deleted && (r.deleted = r.deleted.filter(function(t) {
                    return t !== e
                })), r.history = Object(s.restoreMessage)(e, t, x(r.history)), r.offset++
            }
            return Promise.resolve(n)
        }
        ...
        var gt = P(function(e, t) {
            return e.kludges.source_act === s.CHAT_PHOTO_REMOVE ? (delete t.tabs[e.peerId].photo, delete t.tabs[e.peerId].photoLarge, Promise.resolve(t)) : Object(r.post)(k, {
                ...
                if (t.tabs[e.peerId].photo = i[0], t.tabs[e.peerId].photoLarge = i[1], Object(s.isFullyLoadedTab)(t, e.peerId)) {
                    ...
                    o.history = Object(s.addChatPhotoToUpdate)(e, u, t, x(o.history))
                }
                return t
            })
        });
        ...
        var ht = P(function(e, t) {
                return Object(r.post)(k, {
                    act: "a_leave_chat",
                    chat: e - 2e9,
                    gid: t.gid,
                    hash: t.tabs[e].hash
                }).then(pt.bind(null, s.CHAT_KICK_USER, vk.id, e, t))
            }),
            bt = P(function(e, t) {
                return Object(r.post)(k, {
                    ...
                    gid: t.gid,
                    hash: t.tabs[e].hash
                }).then(pt.bind(null, s.CHAT_INVITE_USER, vk.id, e, t))
            }),
            vt = P(function(e, t, n) {
                return Object(r.post)(k, {
                    act: "a_mute",
        ...
        function kt(e, t, n, r) {
            if (Object(s.isFullyLoadedTab)(r, t)) {
                ...
                e.filter(function(e) {
                    ...
                    o.flags = u, i.msgs[e] = o, i.history = Object(s.updateStar)(e, n, x(i.history))
                })
            }
            return Promise.resolve(r)
        }
        ...
        function Pt(e) {
            ...
            return Object(r.post)(k, {
                ...
                return g.then(function(n) {
                    e.tabs = a, e.admins = extend(e.admins, l), n && (e.tabs[_] = n.tabs[_], e.tabs[_].history = Object(s.restoreQueue)(_, e, x(e.tabs[_].history))), e.loadingDialogs = !1, e.mutedPeers = c.mutedPeers, e.lastDialogsOptions = {
                        has_more: c.has_more
                ...
                return Object(u.lplog)("Resync error: " + t.message + " " + t.stack, "error"), Object(o.pause)(2).then(Pt.bind(null, e))
            })
        }
        ...
        function qt(e, t, n, r, i) {
            ...
            return N(e, 0, 0, 0, i).then(qt.bind(null, e, t, n, i))
        }
        var zt = P(function(e, t) {
        ...
        function Jt(e) {
            return !e.peer || (ze(e.peer, e) ? qe(e.peer, e) : !!Object(s.isFullyLoadedTab)(e, e.peer) && e.tabs[e.peer].allShown)
        }
        ...
        function xn(e, t, n, r) {
            ...
            return Object(m.oCacheGet)(r, i) ? Promise.resolve(r) : ft(w({}, n, [i]), r)
        }
    ...
    396: function(__webpack_module__, __webpack_exports__, __webpack_require__) {
        "use strict";
        ...
        var _utils_common__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(316),
            _ui_util__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(27),
            _debug_tools__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(239);
