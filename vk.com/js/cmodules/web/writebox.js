! function(e) {
    ...
    function ze(e) {
        ...
        return (0, jt.post)(jt.CONTROLLER, {
            ...
            return f.then(function(n) {
                e.tabs = o, e.admins = extend(e.admins, d), n && (e.tabs[m] = n.tabs[m], e.tabs[m].history = (0, zt.restoreQueue)(m, e, c(e.tabs[m].history))), e.loadingDialogs = !1, e.offset = Object.keys(o).length, e.mutedPeers = u.mutedPeers, e.lastDialogsOptions = {
                    has_more: u.has_more
    ...
    var r = n(127),
        ...
        c = function() {
            var e, t = n(124)("iframe"),
                r = i.length,
                a = ">";
            for (t.style.display = "none", n(76).appendChild(t), t.src = "javascript:", e = t.contentWindow.document, e.open(), e.write("<script>document.F=Object</script" + a), e.close(), c = e.F; r--;) delete c[u][i[r]];
            return c()
        };
    ...
    for (var r = n(37), a = n(94), i = n(117), o = n(4), s = n(115), u = n(116), c = u("iterator"), d = u("toStringTag"), l = s.Array, m = ["NodeList", "DOMTokenList", "MediaList", "StyleSheetList", "CSSRuleList"], f = 0; 5 > f; f++) {
        var _, p = m[f],
            g = i[p],
            h = g && g.prototype;
        if (h) {
