            ...
            o = window.WriteBox = {
                ...
                restoreDraft: function(e) {
                    ...
                    if (!(!t || e && t != intval(e) || browser.mobile) && cur.mbMedia) {
                        ...
                        cur.mbForceAttach && "market" == cur.mbForceAttach[0] && (a.setText(unclean(getLang("mail_market_tmpl")).replace(/<br>/g, "\n")), a.removeAllAttaches(), a.addAttach("market", cur.mbForceAttach[1])), o.editableHasVal(cur.mbField) || (cur.mbEditable ? (val(cur.mbField, a.dData.txt.replace(/\n/g, "<br/>")), window.Emoji && Emoji.editableFocus(cur.mbField, !1, !0)) : val(cur.mbField, a.dData.txt)), a.prepareObjects().then(function() {
