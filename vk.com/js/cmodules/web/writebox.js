! function(e) {
    ...
    e.exports = {
        getConstructor: function(e, t, n, l) {
            var d = e(function(e, r) {
                s(e, d, t, "_i"), e._i = a(null), e._f = void 0, e._l = void 0, e[p] = 0, void 0 != r && c(r, n, e[l], e)
            });
    ...
    t.deleteEvent = r, t.replaceFlagsEvent = a, t.setFlagsEvent = i, t.resetFlagsEvent = o, t.addMessageEvent = s, t.editMessageEvent = u, t.editMessageLocallyEvent = c, t.readInboundEvent = l, t.readOutboundEvent = d, t.gotOnlineEvent = m, t.gotOfflineEvent = f, t.resetDirectoriesEvent = _, t.replaceDirectoriesEvent = p, t.setDirectoriesEvent = g, t.deleteDialogEvent = h, t.chatChangedEvent = v, t.typingUserEvent = b, t.typingChatEvent = y, t.videoCallEvent = E, t.unreadCountEvent = T, t.notifySettingsChangedEvent = k, t.emptyEvent = I, t.transitionEvent = O, t.resyncEvent = L, t.resetPeer = w, t.changePeer = A, t.changeTab = S, t.failedMessage = M, t.mutexEvent = C, t.resendEvent = R;
    var x = n(68),
        D = n(59),
    ...
    function r(e, t) {
        for (var n = void 0, r = 0, a = e; null !== (n = l.MESSAGE_REGEXP.exec(e));) {
            var i = n[0].length,
                s = n.index + i,
                u = e[n.index - 1],
                c = e[s - 1],
                d = void 0 !== u && /([\w\$А-Яа-яёЁєЄҐґЇїІіЈј\—\-\_@;.])/i.test(u),
                m = void 0 !== c && /([:;$])/i.test(c);
            if (!d && !m) {
                var f = o(n),
                    _ = f.domain;
                if (_.length <= l.MAX_DOMAIN_LENGTH && -1 !== l.TOP_DOMAINS.indexOf(_)) {
                    var p = t(f);
    ...
    function i(e, t) {
        return e.replace(l.MENTION, t || function(e, t, n, r, a) {
    ...
    function u(e, t) {
        ...
        if (o.length > 55 && (o = o.substr(0, 53) + ".."), o = m(o).replace(/&amp;/g, "&"), !e && i.match(l.OUR_DOMAINS)) {
            r = f(r).replace(l.ENTITIES, encodeURIComponent);
            var u = r,
                d = r.indexOf("#/"),
                _ = "",
                p = void 0;
            return d >= 0 ? u = r.substr(d + 1) : (d = r.indexOf("#!"), d >= 0 && (u = "/" + r.substr(d + 2).replace(/^\//, ""))), p = u.match(l.VK_DOMAIN), p && p[1].length < 32 && (_ = ' mention_id="' + p[1] + '" onclick="return mentionClick(this, event)" onmouseover="mentionOver(this)"'), '<a href="' + c(n + r + a) + '" target="_blank"' + _ + ">" + o + "</a>"
        }
    ...
    var r = n(47)("meta"),
        ...
        f = function(e) {
            return c && _.NEED && u(e) && !i(e, r) && l(e), e
        },
        _ = e.exports = {
            KEY: r,
            NEED: !1,
    ...
    e.exports = function(e, t, n, v, b, y, E) {
        ...
        if (P && (I = d(P.call(new e)), I !== Object.prototype && (l(I, L, !0), r || s(I, m) || o(I, m, h))), w && M && M.name !== g && (A = !0, C = function() {
                return M.call(this)
    ...
    function E(e, t, n) {
        ...
        var l = (0, pt.getLastMessage)(e, t.peerId, t.messageId),
        ...
        if (!l || D(o, l, t, e, a)) {
            var _ = "",
                p = !1;
            if (d && (0, yt.isOut)(t) && qe(e, n, t.peerId), 1 === o.unread && !(0, yt.isOut)(t) && a && (_ += vn("im_mess_bar", {}), p = !0, qe(e, n, t.peerId)), !wn(new Date(f))) {
                var g = new Date,
        ...
        } else d && e.peer === t.peerId && !o.inplaceSearch && (0, yt.isOut)(t) && qe(e, n, t.peerId), cn("_im_stack_messages", c).appendChild(Vt(u));
        return (0, yt.isOut)(t) && !i && setTimeout(function() {
            var e = cn("_im_mess_" + t.messageId, n);
            _n(e, St) && dn(e, "im-mess_sending")
    ...
    function Z(e, t, n) {
        ...
        if (r) {
            pn(r, "aria-hidden", "false"), dn(r, "im-mess_failed " + Mt);
    ...
    function ie(e, t, n, r, i, o) {
        ...
        if (1 == u.length) {
            var l = n ? "" : (0, Ot.oCacheGet)(r, u[0])[c];
    ...
    function Te(e, t, n) {
        var r = bn("mail_dialog_msg_delete_N", t),
            a = Mn(bn("mail_dialog_msg_delete_title"), r, bn("mail_delete"), function() {
    ...
    function qe(e, t, n) {
        ...
        var u = sn(o, "msgid"),
            c = sn(s, "msgid"),
            l = (0, pt.getMessage)(e, n, u),
            d = (0, pt.getMessage)(e, n, c);
    ...
    function ze(e, t, n) {
        ...
        var o = _n(a, "_im_mess_srv") ? a : ln("_im_mess_stack", a);
        if (!o) return [!0, 0];
    ...
    function $e(e) {
        ...
        var u = Ye(n, r),
            c = ft(u, 1),
            l = c[0];
        return Object.keys(Wn).length > 300 && (Wn = {}), Wn[e] = l, l
    }
    ...
    var r = n(91),
        ...
        c = function(e, t, n) {
            var l, d, m, f, _ = e & c.F,
                ...
                E = y[u] || (y[u] = {});
            p && (n = t);
            for (l in n) d = !_ && b && void 0 !== b[l], m = (d ? b : n)[l], f = v && d ? s(m, r) : h && "function" == typeof m ? s(Function.call, m) : m, b && o(b, l, m, e & c.U), y[l] != m && i(y, l, f), h && E[l] != m && (E[l] = m)
        };
    ...
    Object.defineProperty(t, "__esModule", {
        value: !0
    }), t.unpackStore = a, t.getFirstUnread = i, t.getPeer = o, t.getTab = s, t.getCurrentTab = u, t.getSelectedMessages = c, t.getMessageRangeFromSelection = l, t.countUnread = d, t.getMessageByRid = m, t.isRidExist = f, t.getLocalId = _, t.getLastMessage = p, t.parserMessage = g, t.getAuthorFullName = h, t.getMessage = v, t.isClassicInterface = b, t.isLocksAvailable = y, t.isFoldersAvailable = E, t.isCommunityInterface = T, t.getBareTab = k, t.isReversedDialogs = I, t.isFullyLoadedTab = O, t.makeTabNotFullyLoaded = L, t.isGoToEndVisible = w, t.getUnreadScrollBottom = A, t.isSendingAvailable = S, t.isCommunityPeer = M, t.isCommunityBlocked = C, t.checkVoiceMessageAvailable = R, t.isSearching = P, t.getSearchText = x, t.isSearchingValue = D, t.isRecentSearchesActive = N, t.getPinnedMessage = j, t.doPopularSuggExist = F, t.isAnyMessageBeingEdited = H, t.getTabDraft = U;
    var G = n(117),
        B = n(19),
        q = r(B),
        z = n(119),
    ...
    var r = n(10),
        ...
        c = function() {
            var e, t = n(147)("iframe"),
                r = i.length,
                a = ">";
            for (t.style.display = "none", n(104).appendChild(t), t.src = "javascript:", e = t.contentWindow.document, e.open(), e.write("<script>document.F=Object</script" + a), e.close(), c = e.F; r--;) delete c[u][i[r]];
            return c()
        };
    ...
    e.exports = function(e, t, n, c, l) {
        ...
        if (i(_))
            for (d = s(e.length); d > g; g++) t ? p(o(m = e[g])[0], m[1]) : p(e[g]);
        else
    ...
    function o(e) {
        if (!e.renew_hashes) {
            ...
            e.renew_hashes = (0, jt.post)(jt.CONTROLLER, {
                act: "a_renew_hash",
                peers: n.join(","),
                gid: e.gid
            }).then(function(t) {
    ...
    function _(e, t, n, r, a) {
        return a.tabHistoryNotChanged = !1, (0, Gt.retryFn)(jt.post, 3, function(e) {
            return e - 1
        })(jt.CONTROLLER, {
            act: "a_start",
            peer: e,
            ...
            if (o.forEach(function(e) {
                ...
                }), a.tabs || (a.tabs = {}), a.dialog_tab_cts = c, a.tabs[e] || (a.tabs[e] = (0, zt.normalizeTab)(a, i)), f(u, a), n) {
                if (a.tabs[e]) {
    ...
    function p(e, t) {
        ...
        }, r.msgs), t.imQueueSet(e, a), t.tabs[e].history = (0, zt.restoreQueue)(a, t, c(t.tabs[e].history)), Promise.resolve(t)
    }
    ...
    function g(e, t, n) {
        ...
        return n.imQueueSet(e, r), n.tabs[e].history = (0, zt.removeMessages)([t], c(n.tabs[e].history)), Promise.resolve(n)
    }

    function h(e, t) {
        return (t.block_states[e] || {}).free === !1 ? Promise.resolve(t) : (0, jt.post)(jt.CONTROLLER, {
            act: "a_block",
            peer: e,
            prevPeer: t.prevPeer,
            gid: t.gid
    ...
    function v(e, t) {
        ...
        return Promise.resolve(t).then(function(t) {
            return t.tabHistoryNotChanged = !1, (0, zt.isFullyLoadedTab)(t, n) && !t.tabs[n].msgid ? (t.gid && h(n, t), Promise.resolve(t).then(k)) : ((0, zt.isFullyLoadedTab)(t, n) && (t.tabs[n].msgid = !1), _(n, e, !1, !0, t))
    ...
    function y(e, t, n) {
        var r = n.msgid,
            a = n.peer;
        return !e && (0, zt.isFullyLoadedTab)(n, a) && n.tabs[a].msgs[r] ? (t === n.peer ? n.tabHistoryNotChanged = !0 : n.tabHistoryNotChanged = !1, n.gid && h(a, n), Promise.resolve(n).then(k).then(b.bind(null, a))) : _(a, !0, r, !0, n).then(k).then(function() {
    ...
    function E(e, t, n) {
        if ($e(n)) throw (0, zt.showWaitUntilUploadedBox)(), new Error("Cant change peer while loading somethind");
    ...
    function I(e, t, n) {
        var r = n.tabs[n.peer];
        return (0, jt.post)(jt.CONTROLLER, {
            peer: n.peer,
            whole: e,
            act: "a_history",
    ...
    function M(e, t, n) {
        var r = n.tabs[e];
        return r.msgs[t.messageId] && (r.msgs[t.messageId].errored = 1, r.history = (0, zt.setMessageError)(e, t, c(r.history))), Promise.resolve(n)
    }

    function C(e, t, n, r) {
        var a = r.tabs[e];
        return a.msgs[t] && (a.msgs[t].errored = 0, a.lastmsg_meta = n, a.lastmsg = t, a.history = (0, zt.startResendMessage)(e, t, c(a.history))), Promise.resolve(r)
    }
    ...
    function R(e, t, n, r) {
        ...
        t.deletedDialog || (e.dialog_tabs = Object.keys(e.dialog_tabs).reduce(function(e, i) {
            return !n && !nt(i)(t) || a && !a(i, e[i], t) || (e[i] = (0, Bt.arrayUnique)(r(e[i], i))), e
        }, e.dialog_tabs))
    }

    function P(e, t) {
        return 0 === e.length ? Promise.resolve(t) : (0, jt.post)(jt.CONTROLLER, {
            act: "a_get_admin",
            admins: e.join(","),
            gid: t.gid
        }).then(function(e) {
    ...
    function j(e, t) {
        ...
        if ((0, zt.isTabLoaded)(t, r)) {
            ...
            if (i.deletedDialog = !1, !t.msg_local_ids_sort && e.local ? t.msg_local_ids_sort = a({}, e.messageId, 0) : e.local && (t.msg_local_ids_sort[e.messageId] = Object.keys(t.msg_local_ids_sort).length), n ? i.unread = 0 : (i.lastmsg == e.messageId && i.unread ? F(t, 1, e.peerId) : (!i.unread && F(t, 1, e.peerId), i.unread++), x(e.peerId, t)), (0, zt.isFullyLoadedTab)(t, r)) {
                var o = c(i.history);
                i.skipped > 0 && i.skipped++, i.offset++, i.msgs[e.messageId] = extend(!0, {}, e), i.history = (0, zt.appendToHistory)(t, e, o, !0, !0, !0), (0, Vt.isOut)(e) && (i.blocked_community = 0, k(t))
            }
            return i.typing && i.typing[e.userId] && delete i.typing[e.userId], i.lastmsg = e.messageId, i.lastmsg_meta = e, b(e.peerId, t), R(t, i, !1, D.bind(null, r), ot.bind(null, t)), Promise.resolve(t)
        }
        return _(r, 0, 0, 0, t).then(function(t) {
            var a = t.tabs[r];
            return R(t, a, !1, D.bind(null, r), ot.bind(null, t)), b(e.peerId, t), n || x(e.peerId, t), t
        })
    }
    ...
    function H(e, t) {
        if ((0, zt.isFullyLoadedTab)(t, e.peerId)) {
            var n = t.tabs[e.peerId],
                r = n.unread;
            if (t = L(t, e.peerId, e.upToId, 0), null != e.unread ? n.unread = e.unread : n.unread = e.upToId >= n.lastmsg ? 0 : (0, Kt.countUnread)(e.peerId, t) + (n.unread > 0 ? +n.skipped : 0), r > 0 && !n.unread && F(t, -1, e.peerId), !n.skipped) {
                var a = c(n.history);
        ...
        return (0, zt.isTabLoaded)(t, e.peerId) && (t.dialog_tabs[Wt.FOLDER_UNREAD] = t.dialog_tabs[Wt.FOLDER_UNREAD].filter(function(t) {
    ...
    function U(e, t) {
        var n = t.tabs[e.peerId];
        if ((0, zt.isTabLoaded)(t, e.peerId) && L(t, e.peerId, e.upToId, Ut.FLAG_OUTBOUND), (0, zt.isFullyLoadedTab)(t, e.peerId)) {
            var r = c(n.history);
    ...
    function X(e, t) {
        if ((0, zt.isFullyLoadedTab)(t, e.peerId)) {
            ...
            a && (n.msgs[e.messageId] = e, delete n.msgs["rid" + e.randomId]), n.history = (0, zt.replaceMessageAttrs)(t, c(n.history), e)
        }
        return Promise.resolve(t)
    }
    ...
    function J(e, t) {
        ...
        return (0, Gt.retryFn)(jt.post, 3, function(e) {
            return e * e
    ...
    function te(e, t) {
        var n = t.tabs[e.peerId];
        return n.history = (0, zt.replaceAttaches)(c(n.history), e, t), Promise.resolve(t)
    }
    ...
    function le(e) {
        ...
        return n = e.dialog_tabs[t].length > 0 ? Math.min.apply(null, e.dialog_tabs[t].map(function(t) {
            ...
            }), f(s, e), q(i, e), e.dialog_tabs[t] = e.dialog_tabs[t].concat(Object.keys(i).map(intval)), e.dialog_tabs_all[t] = !a.has_more, Promise.resolve(e)
        })
    }
    ...
    function de(e, t) {
        return (0, jt.post)(jt.CONTROLLER, {
            ...
            }), (0, zt.normalizeTabsGotFromServer)(t, a), e === t.searchText && (t.searchOffset = s, t.searchAllLoaded = u), Object.keys(a).filter(function(e) {
                return !t.tabs[e]
            }).forEach(function(e) {
                t.tabs[e] = a[e]
            }), [a, o]
    ...
    function be(e, t) {
        ...
        return (0, jt.post)(jt.CONTROLLER, {
            ...
            n.unread = s[0], n.in_up_to = s[1], n.out_up_to = s[2], n.unread || (e.get().dialog_tabs[Wt.FOLDER_UNREAD] = e.get().dialog_tabs[Wt.FOLDER_UNREAD].filter(function(e) {
                return e != t
            })), R(e.get(), n, !1, D.bind(null, t), ot.bind(null, e.get()))
        })
    }
    ...
    function Ee(e, t, n) {
        if ((0, zt.isFullyLoadedTab)(n, t)) {
            var r = n.tabs[t];
            r.history = (0, zt.removeMessages)(e, c(r.history)), r.offset -= e.filter(function(e) {
                return r.msgs[e]
    ...
    function ke(e, t, n, r) {
        if ((0, zt.isFullyLoadedTab)(r, t)) {
            var a = r.tabs[t];
            a.deleted = a.deleted ? a.deleted.concat(e) : e, a.history = (0, zt.removeMessagesWithRestore)(e, t, n, c(a.history)), a.offset -= e.filter(function(e) {
                return a.msgs[e]
            }).length
        }
        return Promise.resolve(r)
    ...
    function Ie(e, t, n) {
        if ((0, zt.isFullyLoadedTab)(n, t)) {
            ...
            r.deleted && (r.deleted = r.deleted.filter(function(t) {
                return t !== e
            })), r.history = (0, zt.restoreMessage)(e, t, c(r.history)), r.offset++
        }
        return Promise.resolve(n)
    }
    ...
    function Ce(e, t, n, r) {
        function a(e, t) {
            (0, zt.isChatPeer)(e) && t && !(0, Qt.oCacheExists)(r, t) && (i[e] ? -1 === i[e].indexOf(t) && i[e].push(t) : i[e] = [t])
        }
        var i = {},
        ...
        return 0 === Object.keys(i).length && 0 === s.length && 0 === o.length ? Promise.resolve(r) : (n.pause(), Promise.all([Me(i, r), P(s, r), Promise.all(o)])["catch"](function() {
            return r
        }).then(function() {
            return n.resume()
        }).then(function() {
    ...
    function Re(e, t, n, r) {
        return t !== vk.id ? Promise.resolve(r) : ((0, zt.isTabLoaded)(r, n) && r.peer == n && (r = k(r)), Promise.resolve(r))
    }
    ...
    function De(e, t, n, r) {
        if ((0, zt.isFullyLoadedTab)(r, t)) {
            ...
            e.filter(function(e) {
                ...
                i.flags = o, a.msgs[e] = i, a.history = (0, zt.updateStar)(e, n, c(a.history))
            })
        }
        return Promise.resolve(r)
    }
    ...
    function qe(e, t, n, r) {
        return r.creating = !0, r.longpoll.pause(), (0, jt.post)(jt.CONTROLLER, {
            act: "a_multi_start",
            hash: r.writeHash,
            peers: t.join(","),
            title: n
    ...
    function ze(e) {
        ...
        return (0, jt.post)(jt.CONTROLLER, {
            ...
            s.forEach(function(t) {
                return (0, Qt.oCacheAdd)(e, t)
            }), (0, zt.normalizeTabsGotFromServer)(e, o), u.user_unread && handlePageCount("msg", u.user_unread), (0, Bt.lplog)("Resync success", "success");
            var m = e.peer,
                f = void 0;
            if ((0, zt.isReservedPeer)(m)) f = Promise.resolve(!1);
            else {
                var _ = {
                    tabs: a({}, m, e.tabs[m]),
                    oCache: {}
            ...
            return f.then(function(n) {
                e.tabs = o, e.admins = extend(e.admins, l), n && (e.tabs[m] = n.tabs[m], e.tabs[m].history = (0, zt.restoreQueue)(m, e, c(e.tabs[m].history))), e.loadingDialogs = !1, e.mutedPeers = u.mutedPeers, e.lastDialogsOptions = {
                    has_more: u.has_more
            ...
            return (0, Bt.lplog)("Resync error: " + t.message + " " + t.stack, "error"), (0, Gt.pause)(2).then(ze.bind(null, e))
        })
    }
    ...
    function Ze(e, t) {
        return t.ctrl_submit = !!e, (0, jt.post)(jt.CONTROLLER, {
    ...
    function rt(e, t) {
        ...
        var n = [];
        if (e !== Wt.FOLDER_ALL && !(0, zt.isReversedDialogs)(t)) {
    ...
    function st(e, t, n, r, a) {
        if ((0, zt.isTabLoaded)(a, e)) {
            var i = a.tabs[e];
            return n === Ut.REPLACE_DIRECTORIES && (t ^= i.folders), at(n, t, i) && Object.keys(Wt.FOLDER_MASKS).filter(function(e) {
                return Wt.FOLDER_MASKS[e] & t
            }).forEach(function(e) {
                a.dialog_tab_cts[e] += it(i, n, e)
            }), n === Ut.SET_DIRECTORIES ? a.tabs[e].folders |= t : n === Ut.RESET_DIRECTORIES ? a.tabs[e].folders &= ~t : a.tabs[e].folders = t ^= i.folders, R(a, a.tabs[e], !0, function(t, n) {
        ...
        return _(e, 0, 0, 0, a).then(st.bind(null, e, t, n, a))
    }
    ...
    function _t(e) {
        return e.peer ? fe(e.peer, e) ? me(e.peer, e) : (0, zt.isFullyLoadedTab)(e, e.peer) ? e.tabs[e.peer].allShown : !1 : !0
    }
    ...
    function gt(e, t) {
        var n = t.tabs[e];
        return (0, zt.isFullyLoadedTab)(t, e) && (n.history = m(n.history)), Promise.resolve(t)
    }
    ...
    function vt(e, t, n) {
        ...
        return r.blocked_community = !e, (0, jt.post)(jt.CONTROLLER, {
    ...
    function Lt(e, t, n) {
        return (0, jt.post)(jt.CONTROLLER, {
            ...
            }), n.tabs[r] = a, R(n, a, !1, D.bind(null, r), ot.bind(null, n)), n.admins = extend(n.admins, o), [r]
        })
    }
    ...
    function St(e, t) {
        var n = (0, Bt.arrayUnique)([e].concat(t.select(qt.RECENT_SEARCH_OP))).slice(0, 500);
    ...
    t.strHistory = m, t.updateBlockStates = f, t.loadPeer = _, t.restoreHistoryQueue = p, t.removeFailed = g, t.selectPeer = v, t.selectPeerOnMessage = y, t.changePeer = E, t.updateMentions = T, t.setActions = k, t.loadMoreHistory = I, t.loadLessHistory = O, t.createEmailChat = w, t.loadLongPollKey = A, t.loadLongPollTs = S, t.setMessageErrored = M, t.resendMessage = C, t.loadAdmins = P, t.editMessage = N, t.addMessage = j, t.markInboundMessagesAsRead = H, t.markOutboundMessagesAsRead = U, t.initTextStore = G, t.processFwd = B, t.mergeTabs = q, t.updateOnline = z, t.setTyping = W, t.waitTyping = K, t.addSelection = Q, t.cleanSelected = Y, t.dropSelection = $, t.replaceMessage = X, t.saveMedia = Z, t.loadMedia = J, t.addAttachmentsToStoreData = ee, t.replaceMediaAttachesStore = te, t.setCurrentSearchDate = ne, t.setCurrentSearch = re, t.searchHints = ae, t.searchHintsIndex = ie, t.localIndexToDialog = oe, t.preloadSearchIndex = ce, t.loadDialogs = le, t.searchMessages = de, t.isSearchAllLoaded = me, t.isSearchingInplace = fe, t.cancelSearch = _e, t.clearDate = pe, t.searchInplaceStart = ge, t.searchMessagesInplace = he, t.loadImportant = ve, t.loadActualLastMessage = be, t.removeMessagesMarkDeleted = ye, t.removeMessages = Ee, t.removeMessageSend = Te, t.removeMessagesWithRestore = ke, t.restoreMessage = Ie, t.restoreMessageSend = Oe, t.forwardMessages = Le, t.prepareForward = we, t.deletedDialog = Ae, t.setChatTitle = Se, t.loadChatMember = Me, t.checkNewPeople = Ce, t.updateActions = Re, t.setMutedPeer = Pe, t.setExecStack = xe, t.updateFavMessage = De, t.updateImportant = Ne, t.loadSpam = je, t.flushSpam = Fe, t.setCreationType = He, t.getOwnerPhoto = Ue, t.presetAvatar = Ge, t.setChatPhoto = Be, t.createChat = qe, t.resync = ze, t.chatUserHasJoined = We, t.chatUserHasLeft = Ke, t.toggleSendingAbility = Ve, t.setDelayedMessage = Qe, t.isAnythingLoading = $e, t.updateUnreadCount = Xe, t.changeSubmitSettings = Ze, t.updateFavAndTitle = et, t.saveHistoryScroll = tt, t.filterFromTab = nt, t.changeDialogsTab = rt, t.updateFolderState = st, t.getMutexQueue = ut, t.releaseBlock = ct, t.toggleCommunityMute = lt, t.restoreDialog = dt, t.spamDialog = mt, t.updateTabbedPeers = ft, t.isEverythingLoaded = _t, t.cleanTab = pt, t.stringifyTab = gt, t.updateGoToEndVisibility = ht, t.toggleCommunityMessages = vt, t.updateHistory = bt, t.startRecording = yt, t.cancelRecording = Et, t.setVoiceMessageAvail = Tt, t.toggleConversation = kt, t.updateSearchQuery = It, t.initializeChatResize = Ot, t.joinChat = Lt, t.resetInviteLink = wt, t.leaveInvitation = At, t.saveRecentSearchPeer = St, t.resetRecentSearch = Mt, t.removeFromRecentSearch = Ct, t.pinMessageOptimistic = Rt, t.unpinMessageOptimistic = Pt, t.checkChatMember = xt, t.hidePromoTooltip = Dt;
    var jt = n(43),
        Ft = n(64),
        Ht = n(19),
        Ut = r(Ht),
    ...
    t.readLastMessages = u(function(e, t) {
        ...
        return n.skipped > 0 && (r = r.filter(function(e) {
        ...
        })), r = intval(r.shift()), r <= n.in_up_to ? Promise.resolve(t) : (t.longpoll.push([Ut.readInboundEvent([6, e, r])]), (0, jt.post)(jt.CONTROLLER, {
            peer: e,
            ids: [r],
            hash: n.hash,
            act: "a_mark_read",
            ...
            return L(t, e, r, Ut.FLAG_OUTBOUND)
        }))
    }), t.deliverMessage = u(function(e, t, n) {
        var r = Date.now() + rand(0, 100).toFixed(0),
            a = n.tabs[e];
        return (0, Gt.retryFn)(jt.post, 1)(jt.CONTROLLER, {
            act: "a_send",
            to: e,
            hash: a.hash,
            msg: t.message,
        ...
        return t.tabs[e].lastTyping = Date.now(), (0, jt.post)(jt.CONTROLLER, {
            act: "a_typing",
            peer: e,
            gid: t.gid,
            hash: t.tabs[e].hash
        ...
        return Ae(e, (0, jt.post)("al_im.php", {
            act: "a_flush_history",
            id: e,
            from: "im",
            gid: t.gid,
        ...
        return e.kludges.source_act === zt.CHAT_PHOTO_REMOVE ? (delete t.tabs[e.peerId].photo, Promise.resolve(t)) : (0, jt.post)(jt.CONTROLLER, {
            ...
            if (t.tabs[e.peerId].photo = a, (0, zt.isFullyLoadedTab)(t, e.peerId)) {
                ...
                o.history = (0, zt.addChatPhotoToUpdate)(e, s, t, c(o.history))
            }
            return t
        })
        ...
        }).then(Pe.bind(null, e, t))
    }), t.favMessage = u(function(e, t, n, r) {
        return De(e, n, t, r), (0, jt.post)(jt.CONTROLLER, {
        ...
        return t.longpoll.push([a([0, e, n, !0])]), (0, jt.post)(jt.CONTROLLER, {
            act: "a_dialog_star",
            val: r ? 0 : 1,
            peer: e,
            hash: t.tabs[e].hash,
        ...
        return n.longpoll.push([Ut.resetDirectoriesEvent([0, e, r, !0]), Ut.readInboundEvent([6, e, t])]), (0, jt.post)(jt.CONTROLLER, {
            act: "a_mark_answered",
            peer: e,
            lastmsg: t,
            hash: n.tabs[e].hash,
        ...
        return R(t, t.tabs[e], !0, function(t) {
        ...
        }), t.tabs[e].deletedDialog = !0, (0, jt.post)(jt.CONTROLLER, {
            act: "a_delete_dialog",
            peer: e,
            gid: t.gid,
            hash: t.tabs[e].hash
            ...
            return n[0] ? (ft(t.tabbedPeers.filter(function(t) {
                return t.peer !== e
            }), !0, t), t.tabs[e].unread = 0, t.tabs[e].lastmsg = !1, t.tabs[e].lastmsg_meta = null) : (t.tabs[e].deletedDialog = !1, R(t, t.tabs[e], !1, D.bind(null, e), ot.bind(null, t))), n
        })
    }), t.pinMessage = u(function(e, t, n) {
        var r = n.tabs[t];
        return r.data.kicked || r.data.closed ? Promise.resolve(n) : (0, jt.post)(jt.CONTROLLER, {
            act: "a_pin_message",
            msgid: e,
            chat: t,
            hash: n.tabs[t].hash
        ...
        var n = t.tabs[e];
        return n.data.kicked || n.data.closed ? Promise.resolve(t) : (0, jt.post)(jt.CONTROLLER, {
            act: "a_unpin_message",
            chat: e,
            hash: t.tabs[e].hash
        }).then(function(r) {
    ...
    for (var r = n(57), a = n(53), i = n(91), o = n(54), s = n(79), u = n(80), c = u("iterator"), l = u("toStringTag"), d = s.Array, m = ["NodeList", "DOMTokenList", "MediaList", "StyleSheetList", "CSSRuleList"], f = 0; 5 > f; f++) {
        var _, p = m[f],
            g = i[p],
            h = g && g.prototype;
        if (h) {
            h[c] || o(h, c, d), h[l] || o(h, l, p), s[p] = d;
    ...
    Object.defineProperty(t, "__esModule", {
        value: !0
    }), t.isUnread = a, t.isOut = i, t.isGraffiti = s, t.isAudioMsg = u, t.isSticker = c, t.isGift = l, t.isMoney = d, t.isMoneyRequest = m, t.isMessageWithInviteLink = f, t.isImportant = p, t.getUserId = g, t.wasEdited = h, t.isMessageSelected = v;
    var b = n(19),
        y = r(b)
}, function(e, t, n) {
    "use strict";
