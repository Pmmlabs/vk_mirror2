! function(e) {
    ...
    121: function(e, t, n) {
        ...
        function st(e, t, n) {
            ...
            if (!g || vt(c, g, t, e, i)) {
                var v = "",
                    w = !1;
                if (p && Object(u.isOut)(t) && In(e, n, t.peerId), 1 === c.unread && !Object(u.isOut)(t) && i && (v += pe("im_mess_bar", {}), w = !0, In(e, n, t.peerId)), !Ee(new Date(b))) {
                    var O = new Date,
            ...
            } else p && e.peer === t.peerId && !c.inplaceSearch && Object(u.isOut)(t) && In(e, n, t.peerId), ue("_im_stack_messages", _).appendChild(W(m));
        ...
        function wt(e, t, n) {
            ...
            }), n.emoji && (t = xe.emojiToHTML(t, !0)), Fe && (t = Fe(t)), t
        }
        ...
        function Vt(e, t, n) {
            ...
            if (i.source_act === M || i.source_act === P)
                if (i.source_message) {
                    var p = Wt("", Xt(xe.emojiToHTML(J(i.source_message.replace(/<br\s?\/?>/gi, " ")), !0)), !1, "im_srv_mess_link");
                    s = s.replace("{msg}", p)
        ...
        function nn(e, t, n) {
            var r = he("mail_deleteall1"),
                ...
                a = he("mail_delete");
            return Object(s.isChatPeer)(t) && (Object(h.doesChatTabHaveFlag)(e, 1024) ? (r = he("mail_leave_vkcomgroup"), i = he("mail_unfollow_channel_confirmation"), a = he("mail_unfollow_channel")) : i = he("mail_chat_sure_to_delete_all")), Object(o.isCommunityPeer)(t) && (i = he("mail_group_sure_to_delete_all")), Ae(r, i, a, n, he("global_cancel"))
        }
        ...
        function vn(e, t, n, r) {
            if (n[0]) return he("mail_header_online_status") + (Me[n[0]] ? yn(t, !1, !1, !0, r) : "");
            if (!n[1]) return "";
        ...
        function Dn(e, t, n, r, i) {
            return n = n.replace(/\<br\s*\/?\>(\n)?/gi, " ").replace(/[\n\r]/gi, " "), n = Object(c.replaceMentions)(n, function(e, t, n, r, i) {
                return i
            }), r && (n = xe.emojiToHTML(n, !0)), t && "..." !== t.trim() && !Object(s.isChatPeer)(e) && (n = pe("im_topic", {
                topic: t,
                cls: "im-topic_dialog"
        ...
        function Rn(e) {
            ...
            return i || (i = !(i = n.text) && n.attaches.length ? pe("im_pinned_message_media", {
                text: xn(n.attaches[0], n.attaches)
    ...
    156: function(e, t, n) {
        ...
        function W(e) {
            ...
            n.offset && r.push("photos"), n.offset && r.push("search"), (t < -2e9 || n.offset) && !a && r.push("clear"), Object(s.isCommunityInterface)(e) && !a && r.push("block"), Object(s.isCommunityPeer)(t) && (n.blocked_community ? r.push("allow_community") : r.push("block_community")), !Object(s.isChatPeer)(t) && !Object(s.isUserPeer)(t) || Object(s.isCommunityInterface)(e) || Object(s.isChatPeer)(t) && (n.data.kicked || n.data.closed) || (inArray(t, e.mutedPeers) ? r.push("unmute") : r.push("mute")), Object(s.isUserPeer)(t) && !e.gid && !n.blacklisted && n.is_friend && r.push("invite"), !e.chatSettingsAllowed && Object(s.isChatPeer)(t) && !i && n.data.link && r.push("invite_link"), Object(s.isChatPeer)(t) && !i && (e.chatSettingsAllowed || (Object(p.canChangeTitle)(e) && r.push("topic"), Object(p.canChangeAvatar)(e) && r.push("avatar")), Object(p.canInviteUser)(e) && r.push("invite"), e.gid || r.push("leave")), Object(s.isChatPeer)(t) && n.data.closed && !n.data.kicked && r.push("return"), Object(s.isChatPeer)(t) && e.chatSettingsAllowed && !n.data.closed && !n.data.kicked && r.push("settings"), Object(s.isChatPeer)(t) && n.pinned && (r.push(Object(g.isPinnedMessageVisibleInTab)(e, t) ? "pin_hide" : "pin_unhide"), Object(p.canPinOrUnpin)(e) && r.push("unpin"));
        ...
        function Dt(e) {
            ...
            return Object(r.post)(k, {
                ...
                return Object(u.lplog)("Resync error: " + t.message + " " + t.stack, "error"), Object(o.pause)(2).then(Dt.bind(null, e))
            })
        }
