! function(e) {
    ...
    e.exports = {
        set: Object.setPrototypeOf || ("__proto__" in {} ? function(e, t, r) {
            try {
                r = n(128)(Function.call, n(38).f(Object.prototype, "__proto__").set, 2), r(e, []), t = !(e instanceof Array)
            } catch (i) {
                t = !0
            }
            return function(e, n) {
    ...
    function a(e) {
        e >= window.clientHeight() - 30 && (e = 0), Gt.set(Hn, e)
    }
    ...
    function h(e, t) {
        ...
        t.local && i && n.push("im-mess_sending"), t.local && n.push("" + St), t.local && (0, pt.wasEdited)(t) && !r && n.push("im-mess_unread im-mess_nobg"), t.failed && n.push("im-mess_failed " + kt), (0, pt.isGift)(t) && n.push("im-mess_gift");
        var a = v(t),
            s = R(t.text, t.kludges);
        "" != s && (0, pt.wasEdited)(t) && (s += fn("sImLblWasEdited", {
            update_time: t.update_time
        })), t.subject && "..." !== t.subject.trim() && !I(t.peerId) && (s = fn("im_topic", {
            topic: t.subject
        }) + s);
    ...
    function b(e, t, n) {
        ...
        if (!c || D(s, c, t, e, i)) {
            var f = "",
                _ = !1;
            if (d && (0, pt.isOut)(t) && He(e, n, t.peerId), 1 === s.unread && !(0, pt.isOut)(t) && i && (f += fn("im_mess_bar", {}), _ = !0, He(e, n, t.peerId)), !wn(new Date(m))) {
                var p = new Date,
            ...
            if (se(t)) f += fn("im_service_row", {
                ...
                if ((0, pt.isMoney)(t)) {
                    var k = (0, pt.isMoneyRequest)(t) ? _n("mail_money_request_message_sent", "raw") : _n("mail_money_tranfer_message_sent", "raw");
                    T += ' <span class="im-mess-stack--money-transfer">' + pn(C.sex || 0, k) + "</span>"
                }
        ...
        } else d && e.peer === t.peerId && !s.inplaceSearch && (0, pt.isOut)(t) && He(e, n, t.peerId), an("_im_stack_messages", u).appendChild(qt(l));
    ...
    function D(e, t, n, r, i) {
        ...
        var a = O(t.date, r),
            s = O(n.date, r);
        return En(a, s) ? (0, dt.isCommunityInterface)(r) && Yt(t.kludges.from_admin) !== Yt(n.kludges.from_admin) ? !0 : n.date - t.date > 300 ? !0 : se(t) || se(n) ? !0 : (0, pt.isGift)(t) || (0, pt.isGift)(n) ? !0 : (0, pt.isGraffiti)(t) || (0, pt.isGraffiti)(n) ? !0 : (0, pt.isUnread)(e, t) !== (0, pt.isUnread)(e, n) && i && !(0, pt.isOut)(n) ? !0 : !1 : !0
    }
    ...
    function ve(e, t) {
        var n = _n(I(e) ? "mail_chat_sure_to_delete_all" : (0, dt.isCommunityPeer)(e) ? "mail_group_sure_to_delete_all" : "mail_sure_to_delete_all");
        return kn({
    ...
    function ze(e, t, n, r, i) {
        return n = n.replace(/\<br\s*\/?\>(\n)?/gi, " ").replace(/[\n\r]/gi, " "), n = (0, ht.replaceMentions)(n, function(e, t, n, r, i) {
            return i
        }), r && (n = Dn.emojiToHTML(n, !0)), t && "..." !== t.trim() && !I(e) && (n = fn("im_topic", {
            topic: t,
            cls: "im-topic_dialog"
    ...
    var gt = n(27),
        ...
        In = Ht.showTabbedBox,
        Mn = Ht.showTooltip,
        Pn = Ht.mobileOnlineTip,
        Ln = Ht.mobPlatforms,
        An = Ht.onlinePlatformClass,
        On = Ht.AudioMessagePlayer,
        Dn = Ht.Emoji,
        xn = Ht.slideUp,
        Rn = Ht.fadeOut,
        Bn = Ht.cancelEvent,
    ...
    function h(e, t, n, r, i, a, s) {
        ...
        } else w(r, e, i, t, l) || r.scrollBottom(Ie);
    ...
    function C(e, t, n, r, i, a, s, o) {
        ...
        if ((e.get().history_init || (e.get().history_init = !0, !(o.scrollTop() >= 0))) && !b() && (i.update(o), i.show(), 0 !== e.get().peer && (0, te.isFullyLoadedTab)(e.get(), e.get().peer) && (Ce["default"].onHistoryScroll(o.scrollTop()), !(layers.visible || e.get().showed && (0, te.isClassicInterface)(e))))) {
            ...
            c && !c.skipped && 0 > s ? y(e, o, a) : s > 0 && !c.skipped && !c.unread && H(e, a), I(e, o) && (u && c && !c.skipped && H(e, a), c.unread > 0 && E(e));
        ...
        return {
            ...
            updateChatPhoto: function(e, i, a) {
                if ((0, te.isPeerActive)(e.peerId, a.get())) {
                    r.renderPeer(a);
                    var s = P(n);
                    (0, te.addChatPhotoToUpdate)(e, i, a.get(), f(t)), s && n.scrollBottom(Ie)
                }
            },
            ...
            scroll: function(e, t) {
                ...
                if (0 !== e.get().peer) {
                    ...
                    i === !0 && (a = n.contHeight()), a = "up" === t ? -a : a, r || i ? k(a, function() {
                        m(a, n)
    ...
    function _(e, t, n, r, i) {
        ...
        t.get().creation_shown_all = !1, n.reset(), n.pipe(f(u, r, t), r), n.toTop(), r ? (l = (0, k.searchTopConv)(r, t.get()), o = (0, k.searchHintsIndex)(r, [], "friends", t.get()), n.pipe(f(o, r, t), r).then(c), n.pipe(f(l, r, t), r).then(c)) : (o = Promise.resolve([]), l = Promise.resolve([])), t.set(a.bind(null, [u, l, o], !0)), uiSearch.showProgress(s), Promise.all([u, o, l]).then(function() {
    ...
    function p(e, t, n, r, i, a, s, o) {
        ...
        e.set(k.setCreationType.bind(null, l, [])).then(m.bind(null, t, r, i))
    }
    ...
    function v(e, t, n, r) {
        ...
        cur.recieveCropResult = function(n) {
            cur.recieveCropResult = !1, curBox() && curBox().hide(), e.set(k.presetAvatar.bind(null, n)), (0, k.getOwnerPhoto)(n, i).then(function(e) {
    ...
    function C(e, t, n, r, a, s, l) {
        function u(i) {
            y(e, t, n, r, a, s), o(e, n, s, i, a, t), unlockButton(m), (0, I.isSearching)(e) ? s().cancelSearch(e) : s().restoreDialogs(e)
        }
        var c = g(t),
            d = e.get(),
            m = geByClass1(q, n),
        ...
        }), i(e, n, s, "", a, t)) : (lockButton(m), 1 === c.length ? u(c[0]) : void e.set(k.createChat.bind(null, d.next_chat_avatar, c, f)).then(function() {
        ...
        var r = (0, D["default"])({
            ...
            o = (0, M.mount)(s, (0, D["default"])({
                ...
                return {
                    ...
                    more: function(e, n) {
                        var i = void 0;
                        return t.get().shown ? (t.get().creation_shown_all || d(r) !== !1 ? i = Promise.resolve([]) : (t.get().creation_shown_all = !0, i = (0, k.searchTopConv)(d(r), t.get())), t.set(a.bind(null, [i], !1)), f(i, d(r), t)) : Promise.resolve(!1)
                    },
    ...
    var r = n(96),
        ...
        u = function() {
            var e, t = n(11)("iframe"),
                r = a.length,
                i = ">";
            for (t.style.display = "none", n(19).appendChild(t), t.src = "javascript:", e = t.contentWindow.document, e.open(), e.write("<script>document.F=Object</script" + i), e.close(), u = e.F; r--;) delete u[l][a[r]];
            return u()
        };
    ...
    function w(e, t, n, r, i, a, s, o, l) {
        ...
        var u = e.get().peer;
        (0, ae.updateMentions)(e.get()), (0, se.isFullyLoadedTab)(e, t.peerId) && (t.msgid && !(0, ie.getMessage)(e, t.peerId, t.msgid) || !t.msgid && !(0, ie.getMessage)(e, t.peerId, (0, ie.getTab)(e, t.peerId).lastmsg) || (0, ie.getTab)(e, t.peerId).skipped) && e.mutate(function(e) {
                ...
                return e.invite_chat_id && s.invite_hash ? !0 : (Object.keys(e).sort().forEach(function(e) {
                    switch (e) {
                        ...
                        case "tab":
                            ...
                            break;
                        case "act":
                            s.act && "create" === s.act ? k(E, [], b, r, t, n, a) : I(E, [], b, a);
                            break;
                        case "q":
    ...
    function N(e, t) {
        ...
        t.setState({
            longpoll: c
        }), t.set(ae.setExecStack.bind(null, [])), I.on("unidle", function() {
            c.abortPauses(), k()
        }), I.start(), nav.objLoc.box && (l(t, nav.objLoc.box), (0, z.updateLocation)({
            box: null
        }));
        var B = R(t);
        ...
        var F = (0, re.throttleAccumulate)(a.bind(null, t, _), 200),
            ...
            X = (0, W.createModule)({
                handlers: function(t, n) {
                    t(document, "mousemove mousedown keypress", k), t(window, "resize", O), n(e, "click", se.HIDE_TOP_NOTICE_CLASS, V), n(gpeByClass("_im-page-wrap", e), "click", se.HIDE_ASIDE_NOTICE_CLASS, K), browser.safari && t(document, "visibilitychange", D)
                }
            });
        return u(X, m, _, p, e, I, c, F, o, r, h, t, T, B, N, b, y, v, S, O)
    }
    Object.defineProperty(t, "__esModule", {
        value: !0
    });
    ...
    function T(e, t, n, r) {
        var i = e.get(),
            ...
            o = e.setState({
                ...
                }).then(k.bind(null, e, s, r, t, i.pipeId)) : (u = Promise.resolve(), y(s, r, t, e)), u
            });
        if (!n) {
    ...
    var _modules = __webpack_require__(53),
    ...
    function p(e, t, n, r, i, a, s) {
        function o(n, r) {
            var i = e.get().peer,
                a = Emoji.val(r);
            (0, H.isReservedPeer)(i) || S(i, e) || g(e).dData.txt == a || !a || I(e), O(e, t, a), u(r);
    ...
    function L(e, t, n) {
        ...
        return n.disabled && (n.disabled = !1, removeClass(r, "im-chat-input_error"), n.contentEditable = "true",
            removeClass(n, "im-chat-input--text_disabled"), removeClass(geByClass1("_im_page_history"), "is_tf_blocked"), val(i, "")), !1
    }
    ...
    function R(e, t, n) {
        ...
        setTimeout(function() {
            (0, U.getPeer)(t) && a().setDraft(t, (0, U.getTabDraft)((0, U.getCurrentTab)(t))), p(t, e, L, O, k, l, n)
        }, 0);
    ...
    Object.defineProperty(t, "__esModule", {
        value: !0
    }), t.unpackStore = i, t.getFirstUnread = a, t.getPeer = s, t.getTab = o, t.getCurrentTab = l, t.getSelectedMessages = u, t.getMessageRangeFromSelection = c, t.countUnread = d, t.getMessageByRid = g, t.isRidExist = m, t.getLocalId = f, t.getLastMessage = _, t.parserMessage = p, t.getAuthorFullName = h, t.getMessage = v, t.isClassicInterface = b, t.isLocksAvailable = y, t.isFoldersAvailable = C, t.isCommunityInterface = E, t.getBareTab = w, t.isReversedDialogs = T, t.isFullyLoadedTab = S, t.makeTabNotFullyLoaded = k, t.isGoToEndVisible = I, t.getUnreadScrollBottom = M, t.isSendingAvailable = P, t.isCommunityPeer = L, t.isCommunityBlocked = A, t.checkVoiceMessageAvailable = O, t.isSearching = D, t.getSearchText = x, t.isSearchingValue = R, t.isRecentSearchesActive = B, t.getPinnedMessage = N, t.doPopularSuggExist = F, t.isAnyMessageBeingEdited = j, t.getTabDraft = H;
    var U = n(61),
        G = n(27),
        q = r(G),
        z = n(21),
    ...
    function u(e, t, n) {
        ...
        if (removeClass(k, L.DESELECT_ALL_CLASS), show(geByClass1(j, e)), removeClass(geByClass1(H, e), "im-page--mess-actions_visible"), removeClass(geByClass1(H, e), "im-page--mess-actions_all-sel"), o(e, t, []), (0, L.isClassicInterface)(t)) {
            ...
            attr(I, "href", (0, L.getBaseLink)(t) + "?tab=" + i.active_tab)
        }
    ...
    function b(e, t, n, r, a) {
        return {
            ...
            unmount: function() {
                r.stop(), (0, I.destroyModule)(a), uiSearch.destroy(n), cancelStackFilter("im_search")
            }
        }
    }
    ...
    n(104), n(102), n(98), n(42), e.exports = n(93).Map
}, function(e, t) {
    ...
    e.exports = !n(57) && !n(50)(function() {
        return 7 != Object.defineProperty(n(11)("div"), "a", {
            get: function() {
                return 7
            }
        }).a
    ...
    (function(e, i, a) {
        (function() {
            ...
            function R(e, t, n, r) {
                ...
                t._state !== se || (u && s ? I(t, i) : l ? L(t, a) : e === oe ? P(t, i) : e === le && L(t, i))
            }
            ...
            q.prototype._validationError = function() {
                ...
                if (r === ae) {
                    ...
                    if (i === ie && e._state !== se) this._settledAt(e._state, t, e._result);
                        ...
                        var a = new n(b);
                        k(a, e, i), this._willSettleAt(a, t)
    ...
    for (var r = n(112), i = n(88), a = n(120), s = n(15), o = n(49), l = n(10), u = l("iterator"), c = l("toStringTag"), d = o.Array, g = ["NodeList", "DOMTokenList", "MediaList", "StyleSheetList", "CSSRuleList"], m = 0; 5 > m; m++) {
        var f, _ = g[m],
            p = a[_],
            h = p && p.prototype;
        if (h) {
    ...
    var r = n(24),
        i = {};
    i[n(10)("toStringTag")] = "z", i + "" != "[object z]" && n(88)(Object.prototype, "toString", function() {
    ...
    function f(e, t, n, r, s) {
        ...
        var p = (0, w.isPinnedMessageVisibleInTab)(o, o.peer) ? S : 0,
            ...
            A = !1,
            O = !1;
        I || l || (I = m(r)), I ? L = I : A = !0, E && I && M > -k && 0 > M && (O = !0, A = !1, L = I, P = "translateY(" + (-k - M) + "px)"), L && a(n, L), O ? t.set(c.bind(null, n, E.date, _)) : t.set(d.bind(null, n)), P && setStyle(n, i({}, cssTransformProp, P)), toggleClass(n, "im-page--top-date-bar_no-b", A)
    }
    ...
    function m(e, t, n, r) {
        ...
        switch (r.failed) {
            case 1:
                return (0, k.lplog)("Old timestamp, init resync", "error"), e.set(d.bind(null, a)), n([w.resyncEvent()]), e.set(v.loadLongPollTs).then(s).then(f.bind(null, e, t, n));
            case 2:
                return (0, k.lplog)("Key is incorrect", "error"), e.set(d.bind(null, a)), e.set(v.loadLongPollKey).then(s).then(f.bind(null, e, t, n));
            case 3:
                throw nav.reload({
                    force: !0
