! function(e) {
    ...
    e.exports = {
        set: Object.setPrototypeOf || ("__proto__" in {} ? function(e, t, r) {
            try {
                r = n(317)(Function.call, n(158).f(Object.prototype, "__proto__").set, 2), r(e, []), t = !(e instanceof Array)
            } catch (a) {
                t = !0
            }
            return function(e, n) {
    ...
    e.exports = n(199).document && document.documentElement
}, , , , function(e, t, n) {
    "use strict";
    ...
    var r = n(281),
        a = {};
    a[n(189)("toStringTag")] = "z", a + "" != "[object z]" && n(156)(Object.prototype, "toString", function() {
    ...
    "use strict";
    var r = n(98);
    e.exports = n(143)("Map", function(e) {
        return function() {
    ...
    e.exports = !n(147) && !n(171)(function() {
                    ...
                    s.forEach(function(o) {
                        switch (o.type) {
                            case Z.ADD_MESSAGE:
                                ...
                                if (0 === d) {
                                    o.flags & Z.FLAG_OUTBOUND || e.set(oe.updateFavAndTitle.bind(null, o.peerId, !0)), e.set(oe.addMessage.bind(null, o)), y(e, i),
                                        g(e, o) && (f(e, o), t.updateTyping(o.peerId, e), (0, ie.isSearching)(e) ? t.updateDialog(o.peerId, e) : t.promoteDialog(e, o.peerId));
    ...
    function s(e, t, n, r, a) {
        t.origText = n, t.text = (0, c.replaceSpecialSymbols)(clean(n)).replace(/\n/gi, "<br>"),
            t.attaches = r, t.kludges.emoji = 1, t.local = 1, t.share_url = a, t.update_time = Math.floor(Date.now() / 1e3), e.get().tabs[t.peerId].msgs[t.messageId] = t
    }
    Object.defineProperty(t, "__esModule", {
        value: !0
                ...
                if (!(0, te.isSearchingInplace)(u, e.get()) && l && r(s), !Qe && (0 > o || 0 === s.scrollBottom()) && s.scrollBottom() < Ie) {
                    ...
                    if (d.skipped > 0 && !e.get().no_moving_down) {
                        ...
                        var g = e.set(te.loadLessHistory).then(t().loadHistory.bind(null, m.peer, {
                            ...
                            C(e), Qe = !1, M(e, p), d.skipped || e.set(te.changePeer.bind(null, e.get().peer, !1, !1))
                        });
    ...
    function D(e, t, n, r) {
        ...
        return a.skipped ? (N(n, !0), void t.set(te.changePeer.bind(null, t.get().peer, !1, !1)).then(function() {
    ...
    function X(e, t, n, r, a) {
        var i = 50,
            o = (0, re.getTab)(e, t),
            s = o && o.msgs && o.history && !Qe && o.offset > 60 && 0 == o.skipped && 50 > n && n >= 0 && 0 === (e.get().selectedMessages || []).length;
        if (s) {
    ...
    function b(e, t, n, r) {
        if (Ke(r)) throw (0, qt.showWaitUntilUploadedBox)(), new Error("Cant change peer while loading somethind");
        var a = r.gid ? "gim" + r.gid : "im";
        if (r.prevPeer = r.peer, r.peer = e, r.msgid = t || "", r.currentEntryPoint = n, cur.peer = e, an({
            ...
            var i = [];
            (0, qt.isTabLoaded)(r, e) && _(e, r, !0), i = r.tabbedPeers.map(function(e) {
                return e.peer
            }).indexOf(e) < 0 ? [{
                peer: e,
                type: "perm"
    ...
    var r = n(360),
        ...
        l = "prototype",
        u = function() {
            var e, t = n(155)("iframe"),
                r = i.length,
                a = ">";
            for (t.style.display = "none", n(92).appendChild(t), t.src = "javascript:", e = t.contentWindow.document, e.open(), e.write("<script>document.F=Object</script" + a), e.close(), u = e.F; r--;) delete u[l][i[r]];
            return u()
        };
    ...
    n(161), n(120), n(365), n(172), e.exports = n(3).Map
}, function(e, t, n) {
    var r = n(317),
        a = n(99),
        i = n(176),
    ...
    function s(e) {
        ...
        return s || ((0, B.imWeirdLog)("empty_other_kludges", [n, r, a, i, o, s, l, u, c, d]), s = {}), {
            ...
            peerId: intval(a),
            date: intval(i),
            attaches: (0, F.convertKludgesToAttaches)(f, n),
            subject: s.title || "",
            text: o,
            kludges: f,
            randomId: intval(u),
            userId: (0, j.isChatPeer)(a) ? intval(f.from) : intval(a),
            update_time: d,
            chat_local_id: c
        }
    }
    ...
    var j = n(335),
        ...
        $ = t.CONVERSATION_UPDATED = "event_chat_updated",
        X = t.TYPING = "event_typing",
        ...
        oe = t.REFRESH_LP_KEY = "event_refresh_lp_key",
        se = t.TRANSITION = "transition_event",
        le = t.RESET_PEER = "reset_peer",
        ue = t.MUTEX = "mutex",
        ce = t.CHANGE_PEER = "change_peer",
        de = t.CHANGE_TAB = "event_change_tab",
        fe = t.FAILED_MESSAGE = "event_failed_message",
        pe = t.RESEND = "event_resend",
        me = t.DELETE_DIALOG = "event_delete_dialog",
        ge = t.EDIT_MESSAGE = "event_edit_message";
    ...
    function o(e) {
        e >= window.clientHeight() - 30 && (e = 0), en.set(Jn, e)
    }

    function s(e, t) {
        var n = _n(e, t),
            r = n.firstElementChild.offsetHeight !== n.parentNode.offsetHeight;
        r && kn(n.firstElementChild, {
    ...
    function u(e, t, n, r) {
        ...
        return t && (l = '<a onmouseover="return Emoji.stickerOver(' + sn(e) + ', this);"\n        onclick="return Emoji.clickSticker(' + sn(t) + ', this, event);">' + l + "</a>"), l = '<div class="im_sticker_row">' + l + "</div>"
    }
    ...
    function m(e) {
        return Tn("im_preloader", {
            preloader: rn(Jt.pr_tpl, {
                id: ""
            }),
    ...
    function h(e) {
        var t = _n("_im_invisible_bar", e);
        t && (yn(t, "_im_invisible_bar"), yn(t, "im-page--history-new-bar_hide"))
    }

    function _(e, t, n) {
        var r = v(e, t),
            a = _n("_im_mess_" + t.messageId, n);
        return a && (a.parentNode.replaceChild(tn(r), a), y(n)), n
    }

    function v(e, t) {
        var n = ["_im_mess"],
            r = (0, It.isUnread)(e.tabs[t.peerId], t);
        (0, It.isOut)(t) && r && n.push("im-mess_unread _im_mess_unread"), (0, It.isOut)(t) && n.push("im-mess_out"), (0, It.wasEdited)(t) && n.push("im-mess_was_edited"), (0, xt.canMessageBeEdited)(e, t) && n.push("im-mess_editable"), (0, It.isImportant)(t) && n.push("im-mess_fav"), -1 != (e.selectedMessages || []).indexOf(t.messageId) && n.push("im-mess_selected");
        var a = Date.now() - 1e3 * t.date > 1e3;
        t.local && a && n.push("im-mess_sending"), t.local && n.push("" + Rt), t.local && (0, It.wasEdited)(t) && !r && n.push("im-mess_unread im-mess_nobg"), t.failed && n.push("im-mess_failed " + jt), (0, It.isGift)(t) && n.push("im-mess_gift");
        var i = b(t),
            o = j(e, t.text, t.kludges);
        "" != o && (0, It.wasEdited)(t) && (o += Tn("sImLblWasEdited", {
            update_time: t.update_time
        })), t.subject && "..." !== t.subject.trim() && !P(t.peerId) && (o = Tn("im_topic", {
            topic: t.subject
        }) + o);
        var s = Tn("im_message_media", {
            messageId: t.messageId,
            attaches: i.join(""),
            text: (0, It.isGift)(t) ? '<div class="im-mess--gift-lbl">' + o + "</div>" : ""
        });
        return (0, It.isGift)(t) || (s = o + s), "" == o && (0, It.wasEdited)(t) && (s += Tn("sImLblWasEdited", {
            update_time: t.update_time
        })), Tn("im_msg_row", {
            msg_id: t.messageId,
            from_id: t.peerId,
            ...
            ts: t.date,
            marker_params: t.failed ? 'aria-label="' + In("mail_send_message_error") + '" role="link"' : "",
            unread_params: r ? 'aria-label="' + In("mail_unread_message") + '"' : "",
            cls: n.join(" ")
        })
    }
    ...
    function y(e) {
        for (var t = e.getElementsByClassName("_im_mess_noa"), n = t.length; n--;) Cn(t[n], "im-mess_fwd") || t[n].insertAdjacentHTML("afterbegin", Tn("sImHistoryRowActions")), yn(t[n], "_im_mess_noa")
    }
    ...
    function w(e, t, n) {
        var r = (arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : !0, arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : !0),
            ...
            o = e.tabs[t.peerId];
        if (!n || _n("_im_mess", n) || _n("_im_bar_date", n) || (n.innerHTML = ""), o.skipped > 0) return n;
        var s = [];
        t.local || (s = e.imQueue(t.peerId, r)), s.length > 0 && te(s.map(function(e) {
            return _n("_im_mess_rid" + e.rid, n)
        }, n).filter(function(e) {
            return e
        }));
        var l = v(e, t),
            u = fn(n);
        Cn(u, "_im_mess_stack") || (u = mn(u, "._im_mess_stack", -1));
        for (var c = (0, wt.getLastMessage)(e, t.peerId, t.messageId); t.peerId === e.peer && c && !_n("_im_mess_" + c.messageId);) c = (0, wt.getLastMessage)(e, t.peerId, c.messageId);
        var d = _n("_im_unread_bar_row", n),
            f = (0, It.getUserId)(t),
            p = c ? N(c.date, e) : 0;
        if (!c || D(o, c, t, e, a)) {
            var m = "",
                g = !1;
            if (d && (0, It.isOut)(t) && Ve(e, n, t.peerId), 1 === o.unread && !(0, It.isOut)(t) && a && (m += Tn("im_mess_bar", {}), g = !0, Ve(e, n, t.peerId)), !Dn(new Date(p))) {
                var h = new Date,
                    _ = g ? "im-page--history-new-bar_hide _im_invisible_bar" : "";
                m += Tn("im_day_bar", {
                    day: xn(t.date, e.timeshift, !0, In("months_of", "raw"), !0),
                    date: t.date,
                    day_class: h.getDate() + h.getMonth() + h.getFullYear() + " " + _
                })
            }
            if (le(t)) m += Tn("im_service_row", {
                text: ce(e, t, o),
                type: "",
                date: t.date,
                from_id: "",
                ...
                var b = e.gid && (0, It.isOut)(t) ? sn(t.kludges.from_admin) || 0 : 0,
                    w = (0, Ot.oCacheGet)(e, b ? -e.gid : f) || o,
                    E = P(t.peerId) ? w.name : w.first_name,
                    k = w.link || o.href,
                    S = Tn("im_mess_stack_name", {
                        name: E,
                        link: k,
                        "class": (0, It.isMoney)(t) ? " im-mess-stack--lnk-money-transfer" : ""
                    });
                if ((0, It.isGift)(t)) {
                    var T = In("mail_gift_message_sent", "raw");
                    S += ' <span class="im-mess-stack--gift">' + Mn(w.sex || 0, T) + "</span>"
                }
                if ((0, It.isMoney)(t)) {
                    var I = (0, It.isMoneyRequest)(t) ? In("mail_money_request_message_sent", "raw") : In("mail_money_tranfer_message_sent", "raw");
                    S += ' <span class="im-mess-stack--money-transfer">' + Mn(w.sex || 0, I) + "</span>"
                }
                var M = e.gid ? "/gim" + e.gid : "/im",
                    L = void 0;
                if (L = t.local ? R(t.date, e.timeshift) : Tn("im_stack_date", {
                        date: R(t.date, e.timeshift),
                        link: M + "?sel=" + t.peerId + "&msgid=" + t.messageId
                    }), b && e.admins[b]) {
                    var O = e.admins[b],
                        A = b === Jt.id ? In("mail_by_you") : O[0];
                    L = L + " " + Tn("im_admin_link", {
                        name: A,
                        href: O[1]
                    })
                }
            ...
            }(0, Lt.toArray)(an(m)).forEach(function(e) {
                return n && n.appendChild(e)
            })
        } else d && e.peer === t.peerId && !o.inplaceSearch && (0, It.isOut)(t) && Ve(e, n, t.peerId), _n("_im_stack_messages", u).appendChild(tn(l));
        return (0, It.isOut)(t) && !i && setTimeout(function() {
            var e = _n("_im_mess_" + t.messageId, n);
            Cn(e, Rt) && bn(e, "im-mess_sending")
    ...
    function C(e, t, n) {
        var r = void 0;
        return r = "object" === ("undefined" == typeof e ? "undefined" : yt(e)) ? e : t.imQueue(e, !1), r.length > 0 && r.map(function(e) {
    ...
    function E(e) {
        var t = _n("_im_mess_blind_unread_marker", e);
        t && (t.removeAttribute("aria-label"), t.removeAttribute("role"), t.removeAttribute("tabindex"))
    }

    function k(e, t, n) {
        var r = e.tabs[t];
        return (0, Lt.toArray)(hn("_im_mess_unread", n)).forEach(function(e) {
            var t = sn(gn(e, "msgid"));
            t > 0 && r.out_up_to >= t && (yn(e, "_im_mess_unread"), yn(e, "im-mess_unread"), E(e))
        }), n
    }

    function S(e, t, n) {
        var r = _n("_im_msg_media" + t.messageId, e);
    ...
    function D(e, t, n, r, a) {
        if ((0, It.getUserId)(t) !== (0, It.getUserId)(n)) return !0;
        var i = N(t.date, r),
            o = N(n.date, r);
        return Nn(i, o) ? (0, wt.isCommunityInterface)(r) && sn(t.kludges.from_admin) !== sn(n.kludges.from_admin) ? !0 : n.date - t.date > 300 ? !0 : le(t) || le(n) ? !0 : (0, It.isGift)(t) || (0, It.isGift)(n) ? !0 : (0, It.isGraffiti)(t) || (0, It.isGraffiti)(n) ? !0 : (0, It.isUnread)(e, t) === (0, It.isUnread)(e, n) || !a || (0, It.isOut)(n) || pe(n.peerId, r.gid) ? !1 : !0 : !0
    }

    function R(e, t) {
        return Pn(1e3 * e, "{hour}:{minute} {am_pm}", 1e3 * t, [], !0)
    }
    ...
    function j(e, t, n) {
        var r = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : !1,
            ...
            i = {},
            o = 0;
        return t = (0, Mt.replaceHyperLinks)(t || "", Mt.linksReplacer.bind(null, r)), t = t.replace(/(<a.+?<\/a>)/gi, function(e) {
            var t = "!link_" + o + "_" + a + "!";
            return i[t] = e, o++, t
        }), t = (0, Mt.replaceMentions)(t), t = (0, Mt.replaceEmailLinks)(t), t = (0, Mt.replaceHashtags)(t, function(t) {
            var n = (0, wt.getGroupId)(e),
                r = n ? "gim" + n : "im";
            return '<a href="/' + r + "?sel=" + (0, wt.getPeer)(e) + "&st=" + encodeURIComponent(t) + '">' + t + "</a>"
        }), Object.keys(i).forEach(function(e) {
            t = t.replace(e, function() {
                return i[e]
            })
        }), n.emoji && (t = Vn.emojiToHTML(t, !0)), Yn && (t = Yn(t)), t
    }
    ...
    function U(e) {
        return {
            search: {
                name: In("mail_im_peer_search"),
                icon: "search"
            },
            block_community: {
                icon: "block",
                name: In("mail_block_comm_messages")
            },
            allow_community: {
                icon: "unblock",
                name: In("mail_allow_comm_messages")
            },
            clear: {
                name: In(e.peer < -2e9 ? "mail_im_delete_email_contact" : "mail_im_delete_all_history"),
                icon: "clear"
            },
            chat: {
                name: In("mail_im_create_chat_with"),
                icon: "invite"
            },
            mute: {
                name: In("mail_im_mute"),
                icon: "mute"
            },
            unmute: {
                name: In("mail_im_unmute"),
                icon: "unmute"
            },
            photos: {
                name: In(e.gid ? "mail_im_show_media_history_group" : "mail_im_show_media_history"),
                icon: "media"
            },
            avatar: {
                icon: "avatar",
                name: In("mail_update_photo_red")
            },
            block: {
                icon: "block",
                name: In("mail_block_user")
            },
            invite: {
                icon: "invite",
                name: In("mail_im_create_chat_with")
            ...
            invite_link: {
                icon: "invite-link",
                name: In("mail_chat_invite_link")
            },
            leave: {
                icon: "leave",
                name: In("mail_leave_chat")
            },
            topic: {
                icon: "topic",
                name: In("mail_change_topic")
            },
            "return": {
                icon: "return",
                name: In("mail_return_to_chat")
            },
            pin_hide: {
                icon: "pin_hide",
                name: In("mail_menu_pin_hide")
            },
            pin_unhide: {
                icon: "pin_unhide",
                name: In("mail_menu_pin_show")
            },
            unpin: {
                icon: "unpin",
                name: In("mail_menu_unpin")
            },
            settings: {
                icon: "settings",
                name: In("mail_settings")
            }
        }
    }
    ...
    function W(e) {
        var t = In(e.get().gid ? "mail_search_only_messages_comm" : "mail_search_only_messages");
        return '<li class="im-page--mess-search-w">\n    <div class="im-page--mess-search ' + $t + '">\n      <button type="button" class="im-i--messages-search"></button>' + t + "\n    </div>\n  </li>"
    }

    function K() {
        return '<li class="im-search-results-head">' + In("mail_search_messages") + "</li>"
    }

    function Y() {
        return '<li class="im-search-results-head">' + In("mail_search_conversations_sep") + "</li>"
    }

    function Q() {
        return '<li class="im-search-results-head">' + In("mail_search_dialogs_sep") + "</li>"
    }

    function $() {
        return '<li class="im-search-results-head _im_recent_bar">\n    ' + In("mail_recent_searches") + '\n    <button type="button" class="' + Qt + ' im-page--clear-recent">' + In("mail_clear_recent") + "</button>\n  </li>"
    }

    function X(e) {
        var t = e.get().popular_sugg,
            n = (0, wt.isClassicInterface)(e) ? 8 : 5;
        return t.length > n && (t = t.slice(0, n)), '<li class="im-popular clear_fix">' + t.map(function(t) {
            ...
            return '<div class="' + o + '" data-peer="' + n + '">\n    <a class="im-popular--avatar-w ' + zn(a.online) + '" href="' + r.link + '"><img class="im-popular--avatar" src="' + r.photo + '"/></a>\n    <div class="im-popular--name-w"><a class="im-popular--name" href="' + r.link + '">' + (r.first_name || r.name) + '</a></div>\n    <span class="im-popular--unread _sugg_unread_ct">' + H(a.unread) + "</span>\n</div>"
        }).join("") + "</li>"
    }

    function Z(e, t, n) {
        var r = _n("_im_mess_" + t.messageId, n);
        if (r) {
            En(r, "aria-hidden", "false"), bn(r, "im-mess_failed " + jt);
            var a = _n("_im_mess_marker", r);
            En(a, "aria-label", In("mail_send_message_error")), En(a, "role", "link")
        }
        return n
    }

    function J(e, t, n) {
        var r = _n("_im_mess_" + t, n);
        if (r) {
            yn(r, "im-mess_failed"), En(r, "aria-hidden", "true"), yn(r, jt);
            var a = _n("_im_mess_marker", r);
            En(a, "aria-label", ""), En(a, "role", "")
        }
        return n
    }
    ...
    function te(e, t) {
        ...
        return e.forEach(function(e) {
            ...
            return 0 === pn(e).length
        }).map(function(e) {
            return vn("_im_mess_stack", e)
        }).forEach(function(e) {
            Cn(dn(e), "_im_bar_date") && nn(dn(e)), Cn(dn(e), "_im_unread_bar_row") && nn(dn(e)), nn(e)
        }), t
    }

    function ne(e, t, n, r) {
        return e.map(function(e) {
            return _n("_im_mess_" + e, r)
        }).filter(function(e) {
            return e
        }).forEach(function(e) {
            Sn(e, oe(t, e, n)), bn(e, "im-mess_light")
        }), r
    }

    function re(e, t, n) {
        var r = _n("_im_mess_" + e, n);
        if (r) {
            var a = _n(Ft, r);
            Sn(r, a.innerHTML), yn(r, "im-mess_light")
        }
        return n
    }
    ...
    function ae(e, t, n, r) {
        ...
        var o = ((0, wt.isClassicInterface)(r), 60),
            s = ie(e, t, n, r, !1, a);
    ...
    function ie(e, t, n, r, i, o) {
        ...
        if (s.length && (0, Nt.loadChatMember)(a({}, t, s), r), 0 === l.length) return "";
        var u = M(t) || (0, wt.isCommunityPeer)(t) ? "first_name" : i ? "short_name" : "name";
        if (1 == l.length) {
            var c = n ? "" : (0, Ot.oCacheGet)(r, l[0])[u];
            return c + " " + In("mail_typing")
        }
        var d = In("mail_typing_several", l.length),
            f = l.slice(0, Math.min(l.length - 1, o)),
            p = f.map(function(e) {
                return (0, Ot.oCacheGet)(r, e)[u]
            }).join(", ");
        if (l.length > o + 1) p += " " + In("mail_and_peer").replace("{count}", l.length - o).replace("{typing}", d);
        else {
            var m = (0, Ot.oCacheGet)(r, l[f.length])[u];
            p += " " + In("mail_and_peer_one") + " " + m + " " + d
        }
        return p
    }
    ...
    function ce(e, t, n) {
        ...
        if (u = Mn(l.sex, In(u, "raw")), u = u.replace("{from}", ue(l.link, l.name, r)), o && o !== s) {
            var d = a.source_email;
            if (d) u = u.replace("{user}", ue("/im?email=" + encodeURIComponent(d), "email", r));
            else {
                var f = (0, Ot.oCacheGet)(e, o),
                    p = i === Gt ? f.inv_name : f.kick_name;
        ...
        if (a.source_act === Wt || a.source_act === Kt)
            if (a.source_message) {
                var g = fe(Vn.emojiToHTML(un(a.source_message.replace(/<br\s?\/?>/gi, " ")), !0)),
    ...
    function de(e, t, n, r) {
        if (t === Vt) {
            var a = _n("_im_mess_" + e.messageId, r);
            if (a) {
                var i = n.tabs[e.peerId];
                a.parentNode.innerHTML = Tn("im_msg_row", {
                    msg_id: e.messageId,
                    from_id: e.peerId,
    ...
    function fe(e) {
        return e.replace(/&lt;&lt;/g, "&laquo;").replace(/&gt;&gt;/g, "&raquo;").replace(/ \-\-/g, " &mdash;").replace(/\-\- /g, "&mdash; ").replace(St.MENTION_RAW, "$1$4")
    }
    ...
    function ge(e) {
        return function(t) {
            function n() {
                o = !0, yn(i, "im-preloader_visible"), i.parentNode && i.parentNode.removeChild(i)
            }
            var r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "bottom",
                a = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : "",
                i = tn(Tn("im_preloader", {
                    preloader: rn(Jt.pr_tpl, {
                        id: ""
                    }),
                ...
                o = !1;
            setTimeout(function() {
                o || ("bottom" === r ? e.appendChild(i) : e.insertBefore(i, cn(e)), bn(i, "im-preloader_visible"))
            }, 0), t.then(n)["catch"](function(e) {
                (0, Dt.imWeirdCatch)("wrapLoading", e), n()
            })
        }
    }
        ...
        return {
            0: {
                msgs: e.reduce(function(e, t) {
                    return e[t] = [t, Et.FLAG_IMPORTANT, 0, 0, "", "", {}, 0], e
                }, {}),
                hash: t,
                history: 1
            }
    ...
    function be(e, t) {
        return '<div class="im-mess--text">\n      <span>' + In("mail_restored") + '</span>\n      <a class="_im_go_to" href="/im?sel=' + F(e) + "&msgid=" + t + '">' + In("mail_im_goto_conversation") + "</a>\n    </div>"
    }

    function ye(e, t) {
        var n = In(P(e) ? "mail_chat_sure_to_delete_all" : (0, wt.isCommunityPeer)(e) ? "mail_group_sure_to_delete_all" : "mail_sure_to_delete_all");
        return Fn(In("mail_deleteall1"), n, In("mail_delete"), t, In("global_cancel"))
    }

    function we(e) {
        return Fn(In("mail_unpin_title"), In("mail_unpin_text"), In("mail_unpin"), e, In("global_cancel"))
    }

    function Ce(e, t, n, r) {
        var a = In("mail_dialog_msg_delete_N", t),
            i = Fn(In("mail_dialog_msg_delete_title"), a, In("mail_delete"), function() {
                return r(isChecked(_n("_check_forall")))
            }, In("global_cancel")),
            o = "",
            s = !1;
        return n && (o = '<div class="checkbox im-delete-forall-checkbox _check_forall" onclick="checkbox(this);" role="checkbox" aria-checked="false">' + In("mail_delete_for_all") + "</div>", s = cur.imDb.selectByKey("del_forall_checked")), i.setControlsText(o), s && checkbox(_n("_check_forall")), i
    }
                ...
                var i = (0, Tt.createModule)({
                    handlers: function(a, o) {
                        o(r.bodyNode.parentNode, "click", "_im_invite_box", function() {
                            r.hide(), Se(e, e.get().peer, t, n), (0, Tt.destroyModule)(i)
                        }), o(r.bodyNode.parentNode, "mouseover", "im_status_mob_onl", function(e, t) {
                            var n = _n("_im_chat_members_w", r.bodyNode.parentNode),
                                a = 160,
                                i = vn("_im_member_item", t),
                                o = i.offsetTop - n.scrollTop + a,
                                s = o > 370;
                            mobileOnlineTip(t, {
                                was: sn(gn(t, "was")),
                                mid: sn(gn(t, "peer")),
                                vk_mobile: sn(gn(t, "vk_mobile")),
                                forcetoup: s
                            })
                        })
                    }
    ...
    function Te(e, t, n) {
        if (e.get().active_tab === St.FOLDER_ALL && 0 === e.get().unread_cnt) return !1;
        var r = e.get().active_tab === St.FOLDER_ALL ? St.FOLDER_UNREAD : St.FOLDER_ALL;
    ...
    function Ie(e, t, n, r) {
        ...
        var a = (0, wt.isReversedDialogs)(t);
        return t.set(r.bind(null, e)).then(function(e) {
            return n().restoreDialogs(e, !0, a !== (0, wt.isReversedDialogs)(e)), e
        })
    }
    ...
    function Me(e, t) {
        ...
        var n = e.get().tabs[t];
        return St.FOLDER_MASKS[St.FOLDER_IMPORTANT] & n.folders
    }
    ...
    function Pe(e, t) {
        ...
        return St.FOLDER_MASKS[St.FOLDER_UNRESPOND] & r.folders
    }
    ...
    function xe(e, t) {
        ...
        Object.keys(n).forEach(function(r) {
            n[r].time ? n[r].free === !1 && Date.now() - n[r].time >= 5e4 && t.push([Et.mutexEvent([, 1, "gim" + e.get().gid, r, 0, ""])]) : n[r].time = Date.now()
        })
    }
    ...
    function Ne(e, t, n) {
        ...
        return !Bn("al_im.php", {
            ...
            params: {
                width: 638,
                onHide: function() {
                    Gn.loaded && Gn.detachPlayer(!0), r.unmount()
                }
            }
        }, n)
    }
    ...
    function De(e, t) {
        return Re(e.get(), t, (0, wt.getTab)(e, t).last_seen)
    }

    function Re(e, t, n, r) {
        if (n[0]) return 2 === n[2] ? '<span class="is_vk_mobile is_online">' + In("mail_header_online_status") + je(t, !1, !0, !0, r) + "</span>" : "online" + (Un[n[0]] ? je(t, !1, !1, !0, r) : "");
        if (!n[1]) return "";
        var a = On(n[1], e.timeshift),
            i = Mn((0, Ot.oCacheGet)(e, t).sex, In("mail_last_activity_tip", "raw")).replace("{user}", "").replace("{time}", a);
    ...
    function Ge(e, t, n) {
        var r = _n("_im_mess_" + e, n);
        return r && wn(r, "im-mess_fav", t), n
    }

    function Ve(e, t, n) {
        var r = _n("_im_unread_bar_row", t);
        if (!r) return t;
        var a = mn(r, "._im_mess_stack", -1),
            i = mn(r, "._im_mess_stack"),
            o = a ? hn("_im_mess", a).pop() : null,
            s = i ? _n("_im_mess", i) : null;
        if (nn(r), h(t), !s || !o) return t;
        var l = gn(s, "msgid"),
            u = (0, wt.getPreviousMessage)(e, n, l),
            c = (0, wt.getMessage)(e, n, l);
        if (!u || D(e.tabs[n], u, c, e)) return t;
        var d = _n("_im_stack_messages", a),
            f = _n("_im_stack_messages", i).children;
        return (0, Lt.toArray)(f).forEach(function(e) {
            nn(e), d.appendChild(e)
        }), nn(i), t
    }

    function qe(e, t, n) {
        var r = (0, wt.getFirstUnread)(e, e.get().peer);
        if (!r) return [!1, 0];
        var a = _n("_im_mess_" + r, t);
        if (!a) {
            var i = (0, wt.getLastMessage)(e, e.get().peer, r);
            if (!i) return [!0, 0];
            a = _n("_im_mess_" + i.messageId, t)
        }
        var o = Cn(a, "_im_mess_srv") ? a : vn("_im_mess_stack", a);
        if (!o) return [!0, 0];
    ...
    function We(e, t, n) {
        Kn(t);
        var r = vn("_im_top_notice", n);
        Wn(r, 200, nn.pbind(r));
        var a = vn("_im_page_dialogs", r);
        a && Cn(a, "im-page--dialogs-notice") && yn(a, "im-page--dialogs-notice"), Rn.post("al_im.php", {
    ...
    function Ke(e, t, n) {
        Kn(t);
        var r = vn("_im_aside_notice", n);
        qn(r, 200, nn.pbind(r)), Rn.post("al_im.php", {
            act: "a_hide_top_notice",
            type: r.getAttribute("data-type"),
            hash: r.getAttribute("data-hash")
        })
    ...
    function Ye(e, t) {
        Kn(e);
        var n = vn("_im_aside_promo_block", t);
        qn(n, 200, nn.pbind(n)), Rn.post("al_im.php", {
    ...
    function Qe(e, t) {
        var n = vn("_im_aside_promo_block", t);
        n.classList.add("--action-called"), Rn.post("al_im.php", {
            act: "a_vkadmin_app_install",
            hash: gn(t, "hash"),
            platform: gn(t, "platform")
        })
    }

    function $e(e, t, n, r, a) {
        return n = n.replace(/\<br\s*\/?\>(\n)?/gi, " ").replace(/[\n\r]/gi, " "), n = (0, Mt.replaceMentions)(n, function(e, t, n, r, a) {
            return a
        }), r && (n = Vn.emojiToHTML(n, !0)), t && "..." !== t.trim() && !P(e) && (n = Tn("im_topic", {
            topic: t,
            cls: "im-topic_dialog"
        }) + n), !n && a.length > 0 && (n = Tn("im_dialog_media", {
            name: Xe(a[0], a)
        })), n
    }
    ...
    function Xe(e, t) {
        var n = {
            photo: In("mail_added_photos", "raw"),
            video: In("mail_added_videos", "raw"),
            audio: In("mail_added_audios", "raw")
        };
        switch (e.type) {
            case "mail":
                return Ln(e.object.fwd_count, In("mail_fwd_msgs", "raw"), !0);
            case "photo":
            case "video":
            case "audio":
                ...
                return Ln(r, n[e.type], !0);
            case "audio_playlist":
                return In("mail_added_audio_playlist");
            case "doc":
                switch (e.kind) {
                    case "graffiti":
                        return In("mail_added_graffiti");
                    case "audiomsg":
                        return In("mail_added_audiomsg");
                    default:
                        return In("mail_added_docs")
                }
            case "geo":
            case "map":
                return In("mail_added_geo");
            case "wall":
                return In("mail_added_wall");
            case "wall_reply":
                return In("mail_added_wall_reply");
            case "gift":
                return In("mail_added_gift");
            case "link":
            case "share":
                return In("mail_added_link");
            case "sticker":
                return In("mail_added_sticker");
            case "market":
                return In("mail_added_market_item");
            case "money_transfer":
                return In("mail_added_money_transfer");
            case "money_request":
                return In("mail_added_money_request");
            case "story":
                return In("mail_added_story");
            case "mask":
                return In("mail_added_mask");
            case "article":
                return In("mail_added_article");
            default:
                return In("mail_added_" + e.type)
        }
        return ""
    }

    function Ze(e) {
        bn(e, "im-send-btn_loading")
    }
    ...
    function et(e) {
        var t = e.get(),
            n = (0, wt.getPinnedMessage)(e);
        if (!n || !(0, At.isPinnedMessageVisibleInTab)(e, (0, wt.getPeer)(e))) return "";
        var r = (0, Ot.oCacheGet)(e, n.userId);
        if (!r) return "";
        var a = tt(e, n);
        a || (a = n.text, a = !a && n.attaches.length ? Tn("im_pinned_message_media", {
            text: Xe(n.attaches[0], n.attaches)
        }) : j(e, a, n && n.kludges || {}) || ""), a = a.replace(/<br\s?\/?>/gi, " ");
        var i = Tn("im_pinned_message", {
            date: An(n.date, t.timeshift),
            content: a,
            link: r.link,
            name: r.name
        });
    ...
    function tt(e, t) {
        var n = "";
        if (t && (0, It.isMoneyRequest)(t) && void 0 !== t.kludges.attach1_tr_amount) {
            var r = "%s " + t.kludges.attach1_currency;
            if ("RUB" === t.kludges.attach1_currency && (r = In("mail_money_amount_rub", "raw")), t.kludges.attach1_total_amount) {
                var a = Ln(t.kludges.attach1_tr_amount / 1e3, "%s", !0),
                    i = Ln(t.kludges.attach1_total_amount / 1e3, r, !0);
                n = In("mail_money_request_collected_amount_from").replace("{amount}", a).replace("{total_amount}", i)
            } else {
                var o = Ln(t.kludges.attach1_tr_amount / 1e3, r, !0);
                n = In("mail_money_request_collected_amount").replace("{amount}", o)
            }
            if (sn(t.kludges.attach1_held_amount)) {
                var s = Ln(t.kludges.attach1_held_amount / 1e3, r, !0);
                n += " " + In("mail_money_request_held_amount").replace("{amount}", s)
            }
            t.text && (n += '<span class="divider"></span>' + j(e, t.text, t.kludges)), t.kludges.attach1_total_amount && (n += Tn("im_pinned_message_media_bar", {
    ...
    function nt(e, t, n) {
        ...
        r && Hn(n, {
            text: In("mail_message_edited") + " " + An(r, e.get().timeshift),
    ...
    function rt() {
        var e = getSize(_n(Xt))[1];
        return e || (e = Zn), e
    }

    function at(e, t) {
        e.bodyNode.addEventListener("mouseover", function(e) {
            Cn(e.target, "_im_edit_time") && nt(t, e, e.target)
        })
    }
    ...
    function ct(e, t) {
        var n = [],
            ...
            a = r ? r[1].split(";") : [];
        for (a.length > $n && (r[1] = a.slice(0, $n).join(";")); e.length > Qn;) {
            var i = e.substr(0, Qn).lastIndexOf(" "); - 1 == i && (i = Qn), n.push({
                msgText: ln(e.substr(0, i))
            }), e = ln(e.substr(i))
        }
        for (e.length && n.push({
                msgText: e,
                ...
                attaches: t
            }), a = a.slice($n); a.length; a = a.slice($n)) n.push({
            attaches: [
                ["mail", a.slice(0, $n).join(";")]
            ]
        });
        return n
    }
    ...
    function pt() {
        Fn(In("global_error"), In("mail_message_wait_until_uploaded"))
    }

    function mt(e, t) {
        var n = (0, wt.getTab)(e, t.peerId) || {};
        if (!t || !(0, It.isOut)(t)) return !1;
    ...
    function gt(e, t) {
        ...
        return i = i.concat(n.memberIds.filter(function(t) {
            return t !== n.ownerId && (0, Ot.oCacheExists)(e, t)
        }).slice(0, r ? a - 1 : a)), i.map(function(t) {
            return (0, Ot.oCacheGet)(e, t)
        })
    }
    ...
    function vt(e, t) {
        ...
        var n = 1,
            ...
            l = 31536e3,
            u = [
                [l, t ? In("global_years_accusative", "raw") : In("global_age_years", "raw")],
                [s, t ? In("global_months_accusative", "raw") : In("global_age_months", "raw")],
                [o, t ? In("global_weeks_accusative", "raw") : In("global_age_weeks", "raw")],
                [i, t ? In("global_days_accusative", "raw") : In("global_age_days", "raw")],
                [a, t ? In("global_hours_accusative", "raw") : In("global_hours", "raw")],
                [r, t ? In("global_minutes_accusative", "raw") : In("global_minutes", "raw")],
                [n, t ? In("global_seconds_accusative", "raw") : In("global_age_seconds", "raw")]
            ],
            c = e,
            d = [],
            f = void 0;
        if (u.forEach(function(e) {
                var t = bt(e, 2),
                    ...
                    r = t[1],
                    a = Math.floor(c / n);
                c %= n, a >= 1 && d.push(Ln(a, r))
            }), f = d.length, 1 === f) return d.pop();
        var p = d.slice(0, f - 1).join(", "),
            m = d.pop();
        return In("global_and").replace(/{before}/gi, p).replace(/{after}/gi, m)
    }
    Object.defineProperty(t, "__esModule", {
        value: !0
    ...
    var Ct = n(324),
        ...
        Nt = n(271),
        Dt = n(328),
        Rt = t.SENDING_CLASS = "_im_mess_sending",
        jt = t.FAILED_CLASS = "_im_mess_failed",
        Ft = t.ORIGINAL_CLASS = "_im_mess_original",
        Bt = t.RESTORE_CLASS = "_im_mess_restore",
        Ht = (t.TYPING_CLASS = "_im_typing", t.CREATE_CHAT_ACTION = "chat_create"),
        Ut = t.CHAT_TITLE_ACTION = "chat_title_update",
        zt = t.CHAT_INVITE_USER = "chat_invite_user",
        Gt = t.CHAT_KICK_USER = "chat_kick_user",
        Vt = t.CHAT_PHOTO_UPDATE = "chat_photo_update",
        qt = t.CHAT_PHOTO_REMOVE = "chat_photo_remove",
        Wt = t.CHAT_PIN_MESSAGE = "chat_pin_message",
        Kt = t.CHAT_UNPIN_MESSAGE = "chat_unpin_message",
        Yt = t.CHAT_INVITE_BY_LINK = "chat_invite_user_by_link",
        Qt = (t.DESELECT_ALL_CLASS = "_im_deselect_all", t.SHOW_CHAT_MEMBERS_CLASS = "_im_show_chat_mems", t.HIDE_TOP_NOTICE_CLASS = "_im_top_notice_hide", t.HIDE_ASIDE_NOTICE_CLASS = "_im_aside_notice_hide", t.HIDE_ASIDE_PROMO_BLOCK_CLASS = "_im_aside_promo_block_hide", t.INSTALL_VKADMIN_LINK = "_im_vkadmin_promo_link", t.CLEAR_RECENT_CLASS = "_im_clear_recent"),
        $t = t.MESSAGE_SEARCH_CLASS = "_im_mess_search",
        Xt = t.PINNED_CONTAINER_CLASS = "_im_pinned",
        Zt = window,
        Jt = Zt.vk,
        en = Zt.ls,
        tn = Zt.se,
        ...
        Hn = Zt.showTooltip,
        Un = Zt.mobPlatforms,
        zn = Zt.onlinePlatformClass,
        Gn = Zt.AudioMessagePlayer,
        Vn = Zt.Emoji,
        qn = Zt.slideUp,
        Wn = Zt.fadeOut,
        Kn = Zt.cancelEvent,
        Yn = Zt.ny2018ReplaceText,
        Qn = 4096,
        $n = 100,
        Xn = 8,
        Zn = 52,
    ...
    var r = n(189)("unscopables"),
        a = Array.prototype;
    void 0 == a[r] && n(319)(a, r, {}), e.exports = function(e) {
        a[r][e] = !0
    }
}, function(e, t, n) {
    "use strict";
        ...
        function t(e) {
            ...
            for (q(), t.current = e, J = n; null !== J;) {
                ...
                try {
                    for (; null !== J;) {
                        var c = J.effectTag;
                        if (36 & c && j(J.alternate, J),
                            128 & c && F(J), 64 & c) switch (i = J, o = void 0, null !== ee && (o = ee.get(i), ee["delete"](i), null == o && null !== i.alternate && (i = i.alternate, o = ee.get(i), ee["delete"](i))), null == o ? r("184") : void 0, i.tag) {
                            case 2:
    ...
    var Br = {
        ...
        Kr = {},
        Yr = {};
    yn.canUseDOM && (Yr = document.createElement("div").style, "AnimationEvent" in window || (delete Wr.animationend.animation,
    ...
    var r = n(282),
        ...
        i = n(181),
        o = {};
    n(319)(o, n(189)("iterator"), function() {
        return this
    }), e.exports = function(e, t, n) {
        e.prototype = r(o, {
            next: a(1, n)
    ...
    for (var r = n(250), a = n(156), i = n(199), o = n(319), s = n(303), l = n(189), u = l("iterator"), c = l("toStringTag"), d = s.Array, f = ["NodeList", "DOMTokenList", "MediaList", "StyleSheetList", "CSSRuleList"], p = 0; 5 > p; p++) {
        var m, g = f[p],
            h = i[g],
            _ = h && h.prototype;
        if (_) {
