! function(e) {
    ...
    var r = n(167),
        a = n(266);
    e.exports = n(264) ? function(e, t, n) {
    ...
    e.exports = n(308).document && document.documentElement
}, function(e, t, n) {
    "use strict";
    var r = n(126),
        a = n(192),
    ...
    e.exports = {
        set: Object.setPrototypeOf || ("__proto__" in {} ? function(e, t, r) {
            try {
                r = n(298)(Function.call, n(15).f(Object.prototype, "__proto__").set, 2), r(e, []), t = !(e instanceof Array)
            } catch (a) {
                t = !0
            }
            return function(e, n) {
    ...
    function o(e) {
        if (!e.renew_hashes) {
            ...
            e.renew_hashes = (0, Bt.post)(Bt.CONTROLLER, {
                act: "a_renew_hash",
                peers: n.join(","),
                gid: e.gid
            }).then(function(t) {
    ...
    function f(e, t, n, r, a) {
        return a.tabHistoryNotChanged = !1, (0, zt.retryFn)(Bt.post, 3, function(e) {
            return e - 1
        })(Bt.CONTROLLER, {
            act: "a_start",
            peer: e,
    ...
    function g(e, t) {
        return (t.block_states[e] || {}).free === !1 ? Promise.resolve(t) : (0, Bt.post)(Bt.CONTROLLER, {
            act: "a_block",
            peer: e,
            prevPeer: t.prevPeer,
            gid: t.gid
    ...
    function C(e, t, n) {
        var r = n.tabs[n.peer];
        return (0, Bt.post)(Bt.CONTROLLER, {
            peer: n.peer,
            whole: e,
            act: "a_history",
    ...
    function L(e, t) {
        return 0 === e.length ? Promise.resolve(t) : (0, Bt.post)(Bt.CONTROLLER, {
            act: "a_get_admin",
            admins: e.join(","),
            gid: t.gid
        }).then(function(e) {
    ...
    function $(e, t) {
        ...
        return (0, zt.retryFn)(Bt.post, 3, function(e) {
            return e * e
        })(Bt.CONTROLLER, n).then(function(n) {
            return X(e, n, t)
        })["catch"](function() {
            return X(e, null, t)
        })
    ...
    function oe(e, t) {
        ...
        return (0, zt.retryFn)(Bt.post, 1, function() {
            return 4
        })(Bt.CONTROLLER, {
    ...
    function ze(e, t, n, r) {
        return r.creating = !0, r.longpoll.pause(), (0, Bt.post)(Bt.CONTROLLER, {
            act: "a_multi_start",
            hash: r.writeHash,
            peers: t.join(","),
            title: n
    ...
    function Qe(e, t) {
        return t.ctrl_submit = !!e, (0, Bt.post)(Bt.CONTROLLER, {
    ...
    function et(e, t) {
        t.active_tab = e, (0, Ft.updateLocation)({
    ...
    function gt(e, t, n) {
        ...
        return r.blocked_community = !e, (0, Bt.post)(Bt.CONTROLLER, {
    ...
    t.readLastMessages = l(function(e, t) {
        ...
        })), r = intval(r.shift()), r <= n.in_up_to ? Promise.resolve(t) : (t.longpoll.push([Ut.readInboundEvent([6, e, r])]), (0, Bt.post)(Bt.CONTROLLER, {
            peer: e,
            ids: [r],
            hash: n.hash,
            act: "a_mark_read",
        ...
        var r = Date.now() + rand(0, 100).toFixed(0),
            a = n.tabs[e];
        return (0, zt.retryFn)(Bt.post, 1)(Bt.CONTROLLER, {
            act: "a_send",
            to: e,
            hash: a.hash,
            msg: t.message,
        ...
        return t.tabs[e].lastTyping = Date.now(), (0, Bt.post)(Bt.CONTROLLER, {
            act: "a_typing",
            peer: e,
            gid: t.gid,
            hash: t.tabs[e].hash
        ...
        return Te(e, (0, Bt.post)("al_im.php", {
            act: "a_flush_history",
            id: e,
            from: "im",
            gid: t.gid,
        ...
        return e.kludges.source_act === qt.CHAT_PHOTO_REMOVE ? (delete t.tabs[e.peerId].photo, delete t.tabs[e.peerId].photoLarge, Promise.resolve(t)) : (0, Bt.post)(Bt.CONTROLLER, {
        ...
        return Ne(e, n, t, r), (0, Bt.post)(Bt.CONTROLLER, {
        ...
        return t.longpoll.push([a([0, e, n, !0])]), (0, Bt.post)(Bt.CONTROLLER, {
            act: "a_dialog_star",
            val: r ? 0 : 1,
            peer: e,
            hash: t.tabs[e].hash,
        ...
        return n.longpoll.push([Ut.resetDirectoriesEvent([0, e, r, !0]), Ut.readInboundEvent([6, e, t])]), (0, Bt.post)(Bt.CONTROLLER, {
            act: "a_mark_answered",
            peer: e,
            lastmsg: t,
            hash: n.tabs[e].hash,
        ...
        }), t.tabs[e].deletedDialog = !0, (0, Bt.post)(Bt.CONTROLLER, {
            act: "a_delete_dialog",
            peer: e,
            gid: t.gid,
            hash: t.tabs[e].hash
        ...
        var r = n.tabs[t];
        return r.data.kicked || r.data.closed ? Promise.resolve(n) : (0, Bt.post)(Bt.CONTROLLER, {
            act: "a_pin_message",
            msgid: e,
            chat: t,
            hash: n.tabs[t].hash
        ...
        var n = t.tabs[e];
        return n.data.kicked || n.data.closed ? Promise.resolve(t) : (0, Bt.post)(Bt.CONTROLLER, {
            act: "a_unpin_message",
            chat: e,
            hash: t.tabs[e].hash
        }).then(function(r) {
    ...
    var r = n(308),
        ...
        l = Function[s],
        u = ("" + l).split(s);
    n(224).inspectSource = function(e) {
        return l.call(e)
    ...
    var r = n(212),
        a = {};
    a[n(51)("toStringTag")] = "z", a + "" != "[object z]" && n(91)(Object.prototype, "toString", function() {
    ...
    e.exports = !n(264) && !n(129)(function() {
    ...
    n(99), n(54), n(204), n(222), e.exports = n(224).Map
}, function(e, t) {
    "use strict";
    ...
    function oe(e, t, n) {
        ...
        return '<div class="im-mess--text">\n    ' + In(a) + ' <button type="button" data-peer="' + e + '" class="' + Ft + ' im-mess--btn">' + In("mail_restore") + '</button>\n    <div class="' + Bt + ' im-mess--original">' + r + "</div>\n  </div>"
    }
    ...
    function be(e, t) {
        return '<div class="im-mess--text">\n      <span>' + In("mail_restored") + '</span>\n      <a class="_im_go_to" href="/im?sel=' + B(e) + "&msgid=" + t + '">' + In("mail_im_goto_conversation") + "</a>\n    </div>"
    }

    function ye(e, t) {
        var n = In(P(e) ? "mail_chat_sure_to_delete_all" : (0, wt.isCommunityPeer)(e) ? "mail_group_sure_to_delete_all" : "mail_sure_to_delete_all");
        return Bn(In("mail_deleteall1"), n, In("mail_delete"), t, In("global_cancel"))
    }

    function we(e) {
        return Bn(In("mail_unpin_title"), In("mail_unpin_text"), In("mail_unpin"), e, In("global_cancel"))
    }

    function Ce(e, t, n, r) {
        var a = In("mail_dialog_msg_delete_N", t),
            i = Bn(In("mail_dialog_msg_delete_title"), a, In("mail_delete"), function() {
    ...
    function pt() {
        Bn(In("global_error"), In("mail_message_wait_until_uploaded"))
    }
    ...
    var Ct = n(10),
        ...
        Bt = t.ORIGINAL_CLASS = "_im_mess_original",
        Ft = t.RESTORE_CLASS = "_im_mess_restore",
    ...
    var r = n(232),
        ...
        l = "prototype",
        u = function() {
            var e, t = n(175)("iframe"),
                r = i.length,
                a = ">";
            for (t.style.display = "none", n(23).appendChild(t), t.src = "javascript:", e = t.contentWindow.document, e.open(), e.write("<script>document.F=Object</script" + a), e.close(), u = e.F; r--;) delete u[l][i[r]];
            return u()
        };
    ...
    t.f = n(264) ? Object.defineProperty : function(e, t, n) {
    ...
    var r = n(51)("unscopables"),
        a = Array.prototype;
    void 0 == a[r] && n(2)(a, r, {}), e.exports = function(e) {
        a[r][e] = !0
    }
}, function(e, t, n) {
    var r = n(281);
    ...
    function S(e, t, n) {
        ...
        var f = geByClass1(H, e),
            ...
            F = (0, O.createModule)({
                handlers: function(t, n) {
                    t(N, "click", g), t(N, "mouseover", C.bind(null, N)), t(geByClass1(U, e), "click", S), t(geByClass1(z, e), "click", I), t(geByClass1(V, e), "click", P), t(geByClass1(G, e), "click", A), t(e, "mouseover", throttle(s.unhoverElements.bind(s, W), 100)), n(e, "click", B, E)
                }
            });
    ...
    for (var r = n(142), a = n(91), i = n(308), o = n(2), s = n(242), l = n(51), u = l("iterator"), c = l("toStringTag"), d = s.Array, f = ["NodeList", "DOMTokenList", "MediaList", "StyleSheetList", "CSSRuleList"], p = 0; 5 > p; p++) {
        var m, g = f[p],
            h = i[g],
            _ = h && h.prototype;
        if (_) {
    ...
    var r = n(167),
        a = n(232),
        i = n(84);
    e.exports = n(264) ? Object.defineProperties : function(e, t) {
        a(e);
    ...
    function P(e, t, n, r, i, o, d, p, v, b, w, P, L, O, A, x, N, D, R, B) {
        return {
            ...
            unmount: function() {
                (0, Y.destroyModule)(e), clearInterval(P.get().update_title_to), o.stop(), d.stop(),
                    t.unmount();
    ...
    function l(e, t, n) {
        ...
        var o = (0, x.getTab)(n, n.get().peer),
            ...
            l = a(t, n, n.get().peer),
            u = i(t, n),
            c = (0, O.isChatPeer)(o.peerId) && (0, B.canPinOrUnpin)(n, o.peerId);
    ...
    function I(e, t, n) {
        var r = (0, P.createMutations)(T),
            ...
            h = (0, P.createModule)({
                handlers: function(n, r) {
                    r(e, "click", V, o), r(e, "click", F, s), r(e, "click", O.DESELECT_ALL_CLASS, l), r(e, "mouseover", W, u), r(e, "mouseover", "_im_header_icon", c), r(e, "mouseover", V, d), r(e, "click", "_im_header_icon", f), r(e, "click", "_im_header_link", m), r(e, "click", Y, m), r(e, "click", Q, p), r(e, "click", "_im_page_back", function(e) {
    ...
    function N(e, t) {
        for (var n, r = t ? B : j, a = []; e && (n = e.match(r));) {
    ...
    function M(e, t, n) {
        ...
        if (!(0, ne.isReservedPeer)(a)) {
            ...
            var l = !1;
            (n || i.skipped > 0) && !(0, te.isSearchingInplace)(e.get().peer, e.get()) ? (l = !0, addClass(o, "im-to-end_shown")) : F(o, !0), e.set(te.updateGoToEndVisibility.bind(null, [l, intval(r)]))
        }
    }
    ...
    function H(e, t) {
        var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : !1,
            r = geByClass1(De, t);
        e.set(te.updateGoToEndVisibility.bind(null, [!1, 0])), F(r, n)
    }
    ...
    function J(e, t, n) {
        ...
        var N = L.bind(null, t, e, o),
            ...
            oe = (0, se.createModule)({
                handlers: function(n, r) {
                    r(e, "click", ne.RESTORE_CLASS, R), r(e, "mouseover click", ne.FAILED_CLASS, q), r(e, "mouseover", "_im_edit_time", W), r(e, "click", "_im_mess_susp", i.bind(null, e)), r(e, "click", Ne, j), r(e, "click", Re, K), r(e, "click", ne.SHOW_CHAT_MEMBERS_CLASS, Y), r(e, "click", je, X), r(e, "mouseover", Be, B), r(e, "mouseover", qe, ee), r(e, "click", We, ae), r(e, "click", He, u), r(e, "click", Ke, function(e, n) {
                        ...
                        return Q(t, o, e)
                    }), n(geByClass1("_im_peer_history_w", e), "mousemove", g.show), n(geByClass1("_im_start_new", e), "click", F), n(geByClass1(De, e), "click", H), n(geByClass1("_im_cancel_edit", e), "click", function() {
    ...
    function It(e) {
        ...
        function _(r, i, s, l) {
            ...
            for (d = a(r, d); f < s.length; f++)(p = h(d, r, f, s[f], l)) && (e && null !== p.alternate && d["delete"](null === p.key ? f : p.key), i = o(p, i, f), null === c ? u = p : c.sibling = p,
                c = p);
    ...
    var r = n(212),
        a = n(51)("iterator"),
        i = n(242);
    e.exports = n(224).getIteratorMethod = function(e) {
