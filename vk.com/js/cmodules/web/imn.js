! function(e) {
    ...
    function x(e, t) {
        ...
        if ((0, jt.isTabLoaded)(t, r)) {
            ...
            return i.typing && i.typing[e.userId] && delete i.typing[e.userId], i.lastmsg = e.messageId, i.lastmsg_meta = e, h(e.peerId, t), A(t, i, !1, O.bind(null, r), tt.bind(null, t)), Promise.resolve(t)
        }
        return g(r, 0, 0, 0, t).then(function(t) {
            var a = t.tabs[r];
            return A(t, a, !1, O.bind(null, r), tt.bind(null, t)), h(e.peerId, t), n || P(e.peerId, t), t
        })
    }
    ...
    function le(e) {
        ...
        return n = e.dialog_tabs[t].length > 0 ? Math.min.apply(null, e.dialog_tabs[t].map(function(t) {
            ...
            }), d(o, e), j(i, e), e.dialog_tabs[t] = e.dialog_tabs[t].concat(Object.keys(i).map(intval)), e.dialog_tabs_all[t] = !a.has_more, Promise.resolve(e)
        })
    }
    ...
    function he(e, t) {
        ...
        return (0, Dt.post)(Dt.CONTROLLER, {
            ...
            n.unread = o[0], n.in_up_to = o[1], n.out_up_to = o[2], n.unread || (e.get().dialog_tabs[Ut.FOLDER_UNREAD] = e.get().dialog_tabs[Ut.FOLDER_UNREAD].filter(function(e) {
                return e != t
            })), A(e.get(), n, !1, O.bind(null, t), tt.bind(null, e.get()))
        })
    }
    ...
    function we(e, t, n) {
        if ((0, jt.isFullyLoadedTab)(n, t)) {
            ...
            r.deleted && (r.deleted = r.deleted.filter(function(t) {
                    return t !== e
                })), r.history = (0, jt.restoreMessage)(e, t, u(r.history)),
                r.offset++
        }
        return Promise.resolve(n)
    }
    ...
    function Me(e, t, n, r) {
        ...
        return 0 === Object.keys(i).length && 0 === o.length && 0 === s.length ? Promise.resolve(r) : (n.pause(), Promise.all([Ie(i, r), L(o, r), Promise.all(s)])["catch"](function() {
            return r
        }).then(function() {
            return n.resume()
        }).then(function() {
    ...
    function nt(e, t, n, r, a) {
        if ((0, jt.isTabLoaded)(a, e)) {
            ...
            }), n === Nt.SET_DIRECTORIES ? a.tabs[e].folders |= t : n === Nt.RESET_DIRECTORIES ? a.tabs[e].folders &= ~t : a.tabs[e].folders = t ^= i.folders, A(a, a.tabs[e], !0, function(t, n) {
    ...
    function Ct(e, t, n) {
        return (0, Dt.post)(Dt.CONTROLLER, {
            ...
            }), n.tabs[r] = a, A(n, a, !1, O.bind(null, r), tt.bind(null, n)), n.admins = extend(n.admins, s), [r]
        })
    }
    ...
    t.readLastMessages = l(function(e, t) {
        ...
        return A(t, t.tabs[e], !0, function(t) {
            ...
            return n[0] ? (lt(t.tabbedPeers.filter(function(t) {
                return t.peer !== e
            }), !0, t), t.tabs[e].unread = 0, t.tabs[e].lastmsg = !1, t.tabs[e].lastmsg_meta = null) : (t.tabs[e].deletedDialog = !1, A(t, t.tabs[e], !1, O.bind(null, e), tt.bind(null, t))), n
        })
    ...
    var r = n(15),
        ...
        u = function() {
            var e, t = n(60)("iframe"),
                r = i.length,
                a = ">";
            for (t.style.display = "none", n(62).appendChild(t), t.src = "javascript:", e = t.contentWindow.document, e.open(), e.write("<script>document.F=Object</script" + a), e.close(), u = e.F; r--;) delete u[l][i[r]];
            return u()
        };
    ...
    e.exports = {
        set: Object.setPrototypeOf || ("__proto__" in {} ? function(e, t, r) {
            try {
                r = n(118)(Function.call, n(83).f(Object.prototype, "__proto__").set, 2), r(e, []), t = !(e instanceof Array)
            } catch (a) {
                t = !0
            }
            return function(e, n) {
    ...
    n(87), n(119), n(129), n(28), e.exports = n(19).Map
}, function(e, t, n) {
    "use strict";
    ...
    function g(e, t) {
        return e.replace(d(), function(e, n, r, a, i, s) {
            return (n || "") + t(r + (i || ""))
        })
    }
    ...
    function f(e, t) {
        ...
        if (s.length > 55 && (s = s.substr(0, 53) + ".."), s = y(s).replace(/&amp;/g, "&"), !e && i.match(h.OUR_DOMAINS)) {
            r = C(r).replace(h.ENTITIES, encodeURIComponent);
            var l = r,
                u = r.indexOf("#/"),
                c = "",
                d = void 0;
            return u >= 0 ? l = r.substr(u + 1) : (u = r.indexOf("#!"), u >= 0 && (l = "/" + r.substr(u + 2).replace(/^\//, ""))), d = l.match(h.VK_DOMAIN), d && d[1].length < 32 && (c = ' mention_id="' + d[1] + '" onclick="return mentionClick(this, event)" onmouseover="mentionOver(this)"'), '<a href="' + p(n + r + a) + '" target="_blank"' + c + ">" + s + "</a>"
        }
        var g = "away.php?utf=1&to=" + encodeURIComponent(n + C(r + a)),
            m = y((n + r + a).replace(/'/g, "\\'")),
            f = "return goAway('" + m + "', {}, event);";
        return '<a href="' + g + '" target="_blank" onclick="' + f + '">' + s + "</a>"
    }
    ...
    t.parseFwd = i, t.replaceHyperLinks = s, t.replaceEmailLinks = o, t.replaceMentions = l, t.replaceHashtags = g, t.confirmDelivery = m, t.linksReplacer = f;
    var h = n(2),
        v = void 0,
        b = window,
        y = b.clean,
    ...
    function C(e, t, n) {
        ...
        if (r)
            if (r.object && r.object.authorName) {
                var i = r.object,
                    s = (0, j.renderShortText)(0, "", i.text, !0, (0,
                        Y.convertKludgesToAttaches)(i.kludges, 0));
        ...
        return {
            restoreDraft: function(e, a) {
                ...
                var s = e.get().peer,
                    ...
                    l = (0, j.isUserPeer)(s) && s != vk.id && !e.get().gid && !inArray(s, e.get().moneyTransferExcept) || (0, j.isCommunityPeer)(s) && e.get().moneyTransferCommAvail && !e.get().gid || e.get().moneyRequestAvail && e.get().gid || (0, j.isChatPeer)(s) && (0, U.getCurrentTab)(e).moneyRequestAvail;
    ...
    function u(e, t, n) {
        ...
        f.tt = !1;
        var _ = (0, P.renderPhotosFromTab)(t, s, !0),
        ...
        var v = (0, P.isChatPeer)(i),
            b = v ? !s.data.closed && !s.data.kicked : 0,
            y = {
        ...
        if (v) {
            var C = (0, D.getPinnedMessage)(t),
                w = d(t);
            C && (0, N.isPinnedMessageVisibleInTab)(t, i) && (w ? t.set(L.loadChatMember.bind(null, r({}, i, [w]))).then(u.bind(null, e, t, n)) : y.pinned = !0)
        }
        var E = "";
        ...
        var T = val(p),
            S = c(t),
            I = geByClass1(H, e);
        if (removeClass(I, P.DESELECT_ALL_CLASS), show(geByClass1(U, e)), removeClass(geByClass1(G, e), "im-page--mess-actions_visible"), removeClass(geByClass1(G, e), "im-page--mess-actions_all-sel"), o(e, t, []), (0, P.isClassicInterface)(t)) {
            var M = geByClass1("_im_page_back", e);
            attr(M, "href", (0, P.getBaseLink)(t) + "?tab=" + a.active_tab)
        }
    ...
    function I(e, t, n) {
        var r = (0, A.createMutations)(S),
            ...
            g = k.bind(null, t, e, n),
            m = function(r) {
                gpeByClass(V, r.target, e) && !checkEvent(r) && ((0, P.showChatMembers)(t, n, L.setCreationType), cancelEvent(r))
            },
            f = (0, A.createModule)({
                handlers: function(r, a) {
                    a(e, "click", q, s), a(e, "click", F, o), a(e, "click", P.DESELECT_ALL_CLASS, l), a(e, "mouseover", K, u), a(e, "mouseover", "_im_header_icon", c), a(e, "mouseover", q, d), a(e, "click", "_im_header_icon", g), a(e, "click", "_im_header_link", m), a(e, "click", W, m), a(e, "click", Y, function(e) {
    ...
    function h(e, t, n) {
        var r = o(e, t),
            i = v(e, t, n),
            s = a(e);
        return (0, G.isOut)(i) ? (0, W.oCacheGet)(e, s.id).name : i.userId !== i.peerId ? (0, W.oCacheExists)(e, i.userId) ? (0, W.oCacheGet)(e, i.userId).name : !1 : r.tab
    }
    ...
    function k(e) {
        var t = a(e);
        return w(e) ? 19542789 !== t.gid && 103416369 != t.gid ? !1 : t.active_tab === K.FOLDER_UNRESPOND || t.active_tab === K.FOLDER_UNREAD ? !0 : !1 : !1
    }
    ...
    function l(e, t, n, r, a) {
        if (!gpeByClass("_im_peer_target", r.target)) {
            ...
            if (n.saveScroll("list"), o && i.msgid !== u) i.longpoll.push([te.changePeer(l, u)]);
                ...
                d && !hasClass(a, "_dont_add_recent") && (0, V.saveRecentSearchPeer)(l, cur.imDb), d && c && !(0, W.isClassicInterface)(t) && setTimeout(function() {
    ...
    function h(e, t, n) {
        ...
        return r ? i() : (0, W.isUserPeer)(t.peerId) || (0, W.isCommunityPeer)(t.peerId) ? (0, W.isClassicInterface)(e) ? i() : t.href : i()
    }
        ...
        return t.setState(d(n().idFn, {}, t)), {
            ...
            hoverNextElement: function(e, r) {
                var a = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {},
                    ...
                    d = i(u, c),
                    g = (0,
                        A.toArray)(u).slice(d + 1).find(n().hoverableFn);
    ...
    e.exports = n(139).document && document.documentElement
}, function(e, t, n) {
    "use strict";
            ...
            route: function(e, a, s, l) {
                ...
                return e.invite_chat_id && s.invite_hash ? !0 : (l && l.params && "left_nav" === l.params._ref && "undefined" == typeof e.sel && t.scrollUp(!0, !0), Object.keys(e).sort().forEach(function(e) {
                    switch (e) {
                        case "sel":
                            s.q || (u = !0);
                            var c = s.sel ? (0, oe.unUrlPeer)(s.sel) : 0,
                                d = l.back;
                            0 === c ? A.get().longpoll.push([J.resetPeer(!1, d)]) : c !== A.get().peer && A.get().longpoll.push([J.changePeer(c, s.msgid || !1)]);
                            break;
                        case "invite_chat_id":
                        case "invite_hash":
                            f(A);
                        ...
                        case "tab":
                            E(A, b, v), u = !0;
                            var g = s.tab || le.FOLDER_ALL;
                            A.get().longpoll.push([J.changeTab(g)]);
                            break;
                        case "act":
                            s.act && "create" === s.act ? T(A, [], b, r, t, n, i) : S(A, [], b, i);
                            break;
                        case "st":
                            s.st && s.sel ? (curBox() && curBox().hide(), A.mutate(se.setInplaceSearch.bind(null, unescape(s.st), s.sel)), n.startSearch(A)) : (A.mutate(se.cancelSearch.bind(null, a.sel)), n.cancelSearch(A, !0));
                            break;
                        case "q":
                            s.q ? (curBox() && curBox().hide(), r.setSearch(A, s.q, !0)) : r.clearSearch(A);
                            break;
                        case "box":
                            o(A, s.box)
                    }
    ...
    function s(e, t, n, r) {
        ...
        var s = a.reduce(function(e, t) {
                return e[domData(t, "date")] = [t.offsetTop + A, i, t], e
            }, {}),
    ...
    function l(e, t, n, r, a) {
        var i = e.get().barMap[t],
            s = (0, h.isClassicInterface)(a) ? M : I;
    ...
    function f(e, t, n, r, s) {
        ...
        u.lastTop = f;
        var _ = (0, E.isPinnedMessageVisibleInTab)(o, o.peer) ? (0, h.getPinnedMessageHeight)() : 0,
            ...
            L = !1,
            P = !1;
        S || l || (S = m(r)), S ? A = S : L = !0, w && S && I > -T && 0 > I && (P = !0, L = !1, A = S, M = "translateY(" + (-T - I) + "px)"), A && i(n, A), P ? t.set(c.bind(null, n, w.date, p)) : t.set(d.bind(null, n)), M && setStyle(n, a({}, cssTransformProp, M)), toggleClass(n, "im-page--top-date-bar_no-b", L)
    }
    ...
    var r = n(86),
        a = {};
    a[n(101)("toStringTag")] = "z", a + "" != "[object z]" && n(73)(Object.prototype, "toString", function() {
    ...
    var r = n(105),
        a = n(15),
        i = n(64);
    e.exports = n(106) ? Object.defineProperties : function(e, t) {
        a(e);
    ...
    function s(e) {
        e >= window.clientHeight() - 30 && (e = 0), Wt.set(Wn, e)
    }
    ...
    function u(e, t, n, r) {
        ...
        return t && (l = '<a onmouseover="return Emoji.stickerOver(' + Zt(e) + ', this);"\n        onclick="return Emoji.clickSticker(' + Zt(t) + ', this, event);">' + l + "</a>"), l = '<div class="im_sticker_row">' + l + "</div>"
    }
    ...
    function v(e, t) {
        ...
        t.local && a && n.push("im-mess_sending"), t.local && n.push("" + At), t.local && (0, yt.wasEdited)(t) && !r && n.push("im-mess_unread im-mess_nobg"), t.failed && n.push("im-mess_failed " + Lt), (0, yt.isGift)(t) && n.push("im-mess_gift");
        var i = b(t),
            s = B(e, t.text, t.kludges);
        "" != s && (0, yt.wasEdited)(t) && (s += bn("sImLblWasEdited", {
            update_time: t.update_time
        })), t.subject && "..." !== t.subject.trim() && !A(t.peerId) && (s = bn("im_topic", {
            topic: t.subject
        }) + s);
        var o = bn("im_message_media", {
            messageId: t.messageId,
            attaches: i.join(""),
            text: (0, yt.isGift)(t) ? '<div class="im-mess--gift-lbl">' + s + "</div>" : ""
        });
        return (0, yt.isGift)(t) || (o = s + o), "" == s && (0, yt.wasEdited)(t) && (o += bn("sImLblWasEdited", {
            update_time: t.update_time
        })), bn("im_msg_row", {
            msg_id: t.messageId,
            from_id: t.peerId,
    ...
    function C(e, t, n) {
        var r = (arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : !0, arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : !0),
            ...
            s = e.tabs[t.peerId];
        if (!n || cn("_im_mess", n) || cn("_im_bar_date", n) || (n.innerHTML = ""), s.skipped > 0) return n;
        var o = [];
        ...
        var l = v(e, t),
            u = an(n);
        pn(u, "_im_mess_stack") || (u = on(u, "._im_mess_stack", -1));
        ...
        if (!c || R(s, c, t, e, a)) {
            var f = "",
                p = !1;
            if (d && (0, yt.isOut)(t) && qe(e, n, t.peerId), 1 === s.unread && !(0, yt.isOut)(t) && a && (f += bn("im_mess_bar", {}), p = !0, qe(e, n, t.peerId)), !Mn(new Date(m))) {
                var _ = new Date,
            ...
            if (le(t)) f += bn("im_service_row", {
                ...
                if ((0, yt.isGift)(t)) {
                    ...
                    T += ' <span class="im-mess-stack--gift">' + Cn(C.sex || 0, S) + "</span>"
                }
                if ((0, yt.isMoney)(t)) {
                    var I = (0, yt.isMoneyRequest)(t) ? yn("mail_money_request_message_sent", "raw") : yn("mail_money_tranfer_message_sent", "raw");
                    T += ' <span class="im-mess-stack--money-transfer">' + Cn(C.sex || 0, I) + "</span>"
                }
        ...
        } else d && e.peer === t.peerId && !s.inplaceSearch && (0, yt.isOut)(t) && qe(e, n, t.peerId), cn("_im_stack_messages", u).appendChild(Yt(l));
        return (0, yt.isOut)(t) && !i && setTimeout(function() {
            var e = cn("_im_mess_" + t.messageId, n);
            pn(e, At) && gn(e, "im-mess_sending")
    ...
    function R(e, t, n, r, a) {
        ...
        var i = x(t.date, r),
            s = x(n.date, r);
        return In(i, s) ? (0, pt.isCommunityInterface)(r) && Zt(t.kludges.from_admin) !== Zt(n.kludges.from_admin) ? !0 : n.date - t.date > 300 ? !0 : le(t) || le(n) ? !0 : (0, yt.isGift)(t) || (0, yt.isGift)(n) ? !0 : (0, yt.isGraffiti)(t) || (0, yt.isGraffiti)(n) ? !0 : (0, yt.isUnread)(e, t) === (0, yt.isUnread)(e, n) || !a || (0, yt.isOut)(n) || me(n.peerId, r.gid) ? !1 : !0 : !0
    }

    function N(e, t) {
        return wn(1e3 * e, "{hour}:{minute} {am_pm}", 1e3 * t, [], !0)
    }
    ...
    function B(e, t, n) {
        var r = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : !1,
            ...
            i = {},
            s = 0;
        return t = (0, Ct.replaceHyperLinks)(t || "", Ct.linksReplacer.bind(null, r)), t = t.replace(/(<a.+?<\/a>)/gi, function(e) {
            var t = "!link_" + s + "_" + a + "!";
            return i[t] = e, s++, t
        }), t = (0, Ct.replaceMentions)(t), t = (0, Ct.replaceEmailLinks)(t), t = (0, Ct.replaceHashtags)(t, function(t) {
    ...
    function ne(e, t, n, r) {
        return e.map(function(e) {
            ...
            vn(e, se(t, e, n)), gn(e, "im-mess_light")
        }), r
    }
    ...
    function ie(e, t, n, r, i, s) {
        ...
        if (l.length > s + 1) m += " " + yn("mail_and_peer").replace("{count}", l.length - s).replace("{typing}", d);
        else {
    ...
    function ce(e, t, n) {
        ...
        if (u = Cn(l.sex, yn(u, "raw")), u = u.replace("{from}", ue(l.link, l.name, r)), s && s !== o) {
    ...
    function ye(e, t) {
        var n = yn(A(e) ? "mail_chat_sure_to_delete_all" : (0, pt.isCommunityPeer)(e) ? "mail_group_sure_to_delete_all" : "mail_sure_to_delete_all");
    ...
    function we(e, t, n) {
        ...
        return a.setControlsText(i), s && checkbox(cn("_check_forall")), a
    }
    ...
    function Re(e, t) {
        ...
        var r = kn(n[1], e.get().timeshift),
            a = Cn((0, Tt.oCacheGet)(e, t).sex, yn("mail_last_activity_tip", "raw")).replace("{user}", "").replace("{time}", r);
    ...
    function qe(e, t, n) {
        ...
        var a = on(r, "._im_mess_stack", -1),
            ...
            s = a ? un("_im_mess", a).pop() : null,
            o = i ? cn("_im_mess", i) : null;
        if (Qt(r), _(t), !o || !s) return t;
        var l = ln(s, "msgid"),
            u = ln(o, "msgid"),
    ...
    function ze(e, t, n) {
        ...
        var s = pn(a, "_im_mess_srv") ? a : dn("_im_mess_stack", a);
        if (!s) return [!0, 0];
    ...
    function Ke(e, t, n) {
        ...
        a && pn(a, "im-page--dialogs-notice") && mn(a, "im-page--dialogs-notice"), An.post("al_im.php", {
    ...
    function Ve(e, t, n) {
        ...
        Hn(r, 200, Qt.pbind(r)), An.post("al_im.php", {
            act: "a_hide_top_notice",
            type: r.getAttribute("data-type"),
            hash: r.getAttribute("data-hash")
        })
    ...
    function We(e, t) {
        ...
        Hn(n, 200, Qt.pbind(n)), An.post("al_im.php", {
    ...
    function Ye(e, t) {
        var n = dn("_im_aside_promo_block", t);
        n.classList.add("--action-called"), An.post("al_im.php", {
    ...
    function Qe(e, t, n, r, a) {
        return n = n.replace(/\<br\s*\/?\>(\n)?/gi, " ").replace(/[\n\r]/gi, " "), n = (0, Ct.replaceMentions)(n, function(e, t, n, r, a) {
            return a
        }), r && (n = Fn.emojiToHTML(n, !0)), t && "..." !== t.trim() && !A(e) && (n = bn("im_topic", {
            topic: t,
            cls: "im-topic_dialog"
    ...
    function et(e, t) {
        ...
        if (t && (0, yt.isMoneyRequest)(t) && void 0 !== t.kludges.attach1_tr_amount) {
            ...
            if ("RUB" === t.kludges.attach1_currency && (r = yn("mail_money_amount_rub", "raw")), t.kludges.attach1_total_amount) {
                ...
                var s = En(t.kludges.attach1_tr_amount / 1e3, r, !0);
                n = yn("mail_money_request_collected_amount").replace("{amount}", s)
            }
    ...
    var _t = n(36),
        ...
        It = n(104),
        Mt = n(3),
        At = t.SENDING_CLASS = "_im_mess_sending",
        ...
        On = Kt.showTabbedBox,
        Dn = Kt.showTooltip,
        xn = Kt.mobileOnlineTip,
        Rn = Kt.mobPlatforms,
        Nn = Kt.onlinePlatformClass,
        Bn = Kt.AudioMessagePlayer,
        Fn = Kt.Emoji,
        Hn = Kt.slideUp,
        jn = Kt.fadeOut,
        Un = Kt.cancelEvent,
        Gn = Kt.ny2018ReplaceText,
        qn = 4096,
        zn = 100,
        Kn = 8,
        Vn = 52,
    ...
    var r = n(18),
        ...
        i = n(27),
        s = {};
    n(124)(s, n(101)("iterator"), function() {
        return this
    }), e.exports = function(e, t, n) {
        e.prototype = r(s, {
            next: a(1, n)
    ...
    for (var r = n(125), a = n(73), i = n(139), s = n(124), o = n(30), l = n(101), u = l("iterator"), c = l("toStringTag"), d = o.Array, g = ["NodeList", "DOMTokenList", "MediaList", "StyleSheetList", "CSSRuleList"], m = 0; 5 > m; m++) {
        var f, p = g[m],
            _ = i[p],
            h = _ && _.prototype;
        if (h) {
    ...
    var r = n(101)("unscopables"),
        a = Array.prototype;
    void 0 == a[r] && n(124)(a, r, {}), e.exports = function(e) {
        a[r][e] = !0
    }
}, function(e, t, n) {
    "use strict";
    ...
    function C(e, t, n, r, a, i, s, o) {
        ...
        if ((e.get().history_init || (e.get().history_init = !0, !(o.scrollTop() >= 0))) && !b()) {
            ...
            if (0 !== u && (0, ne.isFullyLoadedTab)(e.get(), u) && (we["default"].onHistoryScroll(o.scrollTop()), !layers.visible)) {
                ...
                if (!(0, te.isSearchingInplace)(u, e.get()) && l && r(o), !Qe && (0 > s || 0 === o.scrollBottom()) && o.scrollBottom() < Ie) {
                    ...
                    if (d.skipped > 0 && !e.get().no_moving_down) {
                        ...
                        var p = e.set(te.loadLessHistory).then(t().loadHistory.bind(null, f.peer, {
                            ...
                            w(e), Qe = !1, M(e, m), d.skipped || e.set(te.changePeer.bind(null, e.get().peer, !1))
                        });
    ...
    function k(e, t, n, r) {
        ...
        if (a) {
            ...
            i && (0, ne.isChatPeer)(o) && (0, _e.isPinnedMessageVisibleInTab)(r, o) && (u -= (0, ne.getPinnedMessageHeight)()), e.scrollTop(u - e.getScrollHeight() / 2 + l / 2), addClass(a, "im-mess_light"), setTimeout(function() {
                ...
                Xe[u] = (0, te.getMessageLocalId)(r, u, n).then(function(e) {
                    ...
                    if (n) {
                        var a = "/im?sel=" + (0, ne.convertPeerToUrl)(r) + "&msgid=" + n,
                            i = l.innerHTML;
                        domReplaceEl(l, (0, ne.serviceLink)(a, i, !0, Ve)), delete Xe[u]
                    }
                })
            }
        }
    ...
    function $(e, t, n, r, a) {
        var i = 50,
            s = (0, re.getTab)(e, t),
            o = s && s.msgs && s.history && !Qe && s.offset > 60 && 0 == s.skipped && 50 > n && n >= 0 && 0 === (e.get().selectedMessages || []).length && e.get().cutHistAllowed;
        if (o) {
    ...
    function J(e, t, n, r, a, i, o, u, d, g, m, b, y, C, w) {
        ...
        return {
            ...
            replaceAttachmentPlaceholders: function(e, a) {
                (0, ne.isPeerActive)(a.peerId, e.get()) && (B(w, f(t), n, function() {
                    var i = A(n);
                    (0, ne.replaceAttaches)(t, a, e.get());
                    var s = (0, re.getTab)(e, a.peerId);
                    if (s.mediacontent[a.messageId].length >= 3 && s.mediacontent[a.messageId][2].pinned) {
                        var o = (0, re.parserMessage)(s.pinned);
                        o && o.messageId == a.messageId && (s.pinned = s.mediacontent[a.messageId][2].pinned, r.reRenderPinned(e))
                    }
                    i && n.scrollBottom(0)
                }), w.update(n))
            },
            ...
            showError: function(e) {
                geByClass1(je, t).innerHTML = e, show(geByClass1(je, t)), n.scrollBottom(Me)
            },
    ...
    function Z(e, t, n) {
        ...
        setTimeout(function() {
            t.get().peer && (z(t), (0, re.getCurrentTab)(t).pinned && (s().updateChatTopic(t.get().peer, t), t.set(te.setActions), b.changeActions(t)), t.get().msgid ? k(h, e, t.get().msgid, t) : E(h, e, s, t, p) || h.scrollBottom(Me), t.get().history_init = !1, p.reset(h), M(t, e), C(t, s, r, c, p, e, 0, h), (0, ne.ensureDomHasActions)(e), nav.objLoc.st && (t.mutate(te.setInplaceSearch.bind(null, nav.objLoc.st, t.get().peer)), s().startSearch(t)))
        }, 15);
        ...
        var x = L.bind(null, t, e, s),
            ...
            se = (0, oe.createModule)({
                handlers: function(n, r) {
                    r(e, "click", ne.RESTORE_CLASS, N), r(e, "mouseover click", ne.FAILED_CLASS, K), r(e, "mouseover", "_im_edit_time", V), r(e, "click", "_im_mess_susp", i.bind(null, e)), r(e, "click", xe, B), r(e, "click", Ne, W), r(e, "click", ne.SHOW_CHAT_MEMBERS_CLASS, Y), r(e, "click", Be, $), r(e, "mouseover", Fe, F), r(e, "mouseover", Ke, ee), r(e, "click", Ve, ae), r(e, "click", je, u), r(e, "click", We, function(e, n) {
    ...
    function o(e, t, n) {
        var r = t().appendFastDialogs.bind(null, n),
            a = s(e, n, r);
        return (0, w.searchTopConv)(e, n.get()).then(function(e) {
            var t = e;
            return a(t), e
        })
    }
