! function(e) {
        ...
        var r = (0, g.mount)(e, (0, f["default"])({
            ...
            l = (0, v.createModule)({
                handlers: function(n, r) {
                    r(e, "click", "_im_r_cl", s),
                        r(e, "click", "_im_peer_tab", function(e, n) {
                            if (!checkEvent(e)) {
    ...
    e.exports = {
        set: Object.setPrototypeOf || ("__proto__" in {} ? function(e, t, r) {
            try {
                r = n(5)(Function.call, n(8).f(Object.prototype, "__proto__").set, 2), r(e, []), t = !(e instanceof Array)
            } catch (a) {
                t = !0
            }
            return function(e, n) {
    ...
    var r = n(34)("unscopables"),
        a = Array.prototype;
    void 0 == a[r] && n(13)(a, r, {}), e.exports = function(e) {
        a[r][e] = !0
    }
}, function(e, t, n) {
    var r = n(109),
    ...
    var r = n(83),
        a = {};
    a[n(34)("toStringTag")] = "z", a + "" != "[object z]" && n(33)(Object.prototype, "toString", function() {
    ...
    function Z(e, t, n, r, a, i, s, u, d, g, m, b, y, w, C) {
        ...
        return {
            ...
            preparePeer: function(e) {
                ...
                z(e), a.setDraft(e, (0, re.getTabDraft)((0, re.getTab)(e, n))),
                    i().updateTyping(n, e), i().hideError(), r.renderPeer(e), r.hideActions(e), u.changePeer(n, e), T(e, t, r), C.toggle(!1), j(e, t, !0)
            },
    ...
    var r = n(130),
        ...
        u = function() {
            var e, t = n(128)("iframe"),
                r = i.length,
                a = ">";
            for (t.style.display = "none", n(67).appendChild(t), t.src = "javascript:", e = t.contentWindow.document, e.open(), e.write("<script>document.F=Object</script" + a), e.close(), u = e.F; r--;) delete u[l][i[r]];
            return u()
        };
    ...
    n(60), n(90), n(108), n(112), e.exports = n(7).Map
}, function(e, t, n) {
    "use strict";
    var r = n(73),
        a = n(57),
    ...
    function f(e, t) {
        ...
        if (o.length > 55 && (o = o.substr(0, 53) + ".."), o = y(o).replace(/&amp;/g, "&"), !e && i.match(h.OUR_DOMAINS)) {
            ...
            var l = r,
                ...
                c = "",
                d = void 0;
            return u >= 0 ? l = r.substr(u + 1) : (u = r.indexOf("#!"),
                u >= 0 && (l = "/" + r.substr(u + 2).replace(/^\//, ""))), d = l.match(h.VK_DOMAIN), d && d[1].length < 32 && (c = ' mention_id="' + d[1] + '" onclick="return mentionClick(this, event)" onmouseover="mentionOver(this)"'), '<a href="' + p(n + r + a) + '" target="_blank"' + c + ">" + o + "</a>"
        }
    ...
    for (var r = n(25), a = n(33), i = n(43), o = n(13), s = n(93), l = n(34), u = l("iterator"), c = l("toStringTag"), d = s.Array, g = ["NodeList", "DOMTokenList", "MediaList", "StyleSheetList", "CSSRuleList"], m = 0; 5 > m; m++) {
        var f, p = g[m],
            _ = i[p],
            h = _ && _.prototype;
        if (h) {
