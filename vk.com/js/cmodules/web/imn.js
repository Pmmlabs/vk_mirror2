! function(e) {
    ...
    var r = n(22),
        ...
        u = function() {
            var e, t = n(126)("iframe"),
                r = i.length,
                a = ">";
            for (t.style.display = "none", n(82).appendChild(t), t.src = "javascript:", e = t.contentWindow.document, e.open(), e.write("<script>document.F=Object</script" + a), e.close(), u = e.F; r--;) delete u[l][i[r]];
            return u()
        };
    ...
    function u(e, t, n, r) {
        ...
        if (i) {
            ...
            var d = !1;
            browser.msie ? (0 ^ r) === r && (d = !0) : d = Number.isInteger(r), d && Fn.getAutoplay() && window.StickersAnimation && window.StickersAnimation.loadAndPlayStickerWithTimer(c, 10)
        }
    ...
    function C(e, t, n) {
        ...
        if (!c || R(s, c, t, e, a)) {
            ...
            if (le(t)) f += vn("im_service_row", {
                ...
                t.attaches[0] && "chronicle_invite" === t.attaches[0].type && (T += " " + bn("mail_chronicle_invite_inf"));
    ...
    function Ke(e, t, n) {
        ...
        jn(r, 200, Yt.pbind(r)), Mn.post("al_im.php", {
            act: "a_hide_top_notice",
            type: r.getAttribute("data-type"),
            hash: r.getAttribute("data-hash")
        })
    ...
    var _modules = __webpack_require__(105),
    ...
    t.deleteEvent = r, t.replaceFlagsEvent = a, t.setFlagsEvent = i, t.resetFlagsEvent = s, t.addMessageEvent = o, t.editMessageEvent = l, t.editMessageLocallyEvent = u, t.readInboundEvent = c, t.readOutboundEvent = d, t.gotOnlineEvent = g, t.gotOfflineEvent = m, t.resetDirectoriesEvent = f,
        t.replaceDirectoriesEvent = p, t.setDirectoriesEvent = _, t.deleteDialogEvent = h, t.chatChangedEvent = v, t.typingUserEvent = b, t.typingChatEvent = y, t.videoCallEvent = C, t.unreadCountEvent = w, t.notifySettingsChangedEvent = E, t.emptyEvent = k, t.transitionEvent = T, t.resyncEvent = S, t.resetPeer = I, t.changePeer = M, t.changeTab = P, t.failedMessage = L, t.mutexEvent = A, t.resendEvent = O;
    var x = n(46),
        R = n(58),
    ...
    for (var r = n(109), a = n(54), i = n(5), s = n(3), o = n(34), l = n(50), u = l("iterator"), c = l("toStringTag"), d = o.Array, g = ["NodeList", "DOMTokenList", "MediaList", "StyleSheetList", "CSSRuleList"], m = 0; 5 > m; m++) {
        var f, p = g[m],
            _ = i[p],
            h = _ && _.prototype;
        if (h) {
    ...
    window.IM = {
        init: function(e) {
            ...
            cur.nav.push(function() {
                ...
                return t !== !1 && (p.unmount(), IM.activateTab = void 0, IM.chatPhotoSaved = void 0, IM.updateHistory = void 0, f.unmount(), window.store = void 0, _ = !0, e = !1, f = !1, p = !1, (0, g.stopLoggingAllUnhandled)()), t
            })
        }
    };
    try {
    ...
    function f(e, t, n, r, a) {
        return a.tabHistoryNotChanged = !1, (0, Ut.retryFn)(Nt.post, 3, function(e) {
            ...
            return a.admins = extend(a.admins, o), a.imQueue(e, !1), p(e, a)
        })["catch"](function(e) {
    ...
    function v(e, t) {
        ...
        return Promise.resolve(t).then(function(t) {
            return t.tabHistoryNotChanged = !1, (0, zt.isFullyLoadedTab)(t, n) && !t.tabs[n].msgid ? (t.gid && h(n, t), Promise.resolve(t).then(E)) : ((0, zt.isFullyLoadedTab)(t, n) && (t.tabs[n].msgid = !1), f(n, e, !1, !0, t))
    ...
    function y(e, t, n) {
        var r = n.msgid,
            a = n.peer;
        return !e && (0, zt.isFullyLoadedTab)(n, a) && n.tabs[a].msgs[r] ? (t === n.peer ? n.tabHistoryNotChanged = !0 : n.tabHistoryNotChanged = !1, n.gid && h(a, n), Promise.resolve(n).then(E).then(b.bind(null, a))) : f(a, !0, r, !0, n).then(E).then(function() {
    ...
    function N(e, t) {
        ...
        if ((0, zt.isTabLoaded)(t, r)) {
            ...
            if (i.deletedDialog = !1, !t.msg_local_ids_sort && e.local ? t.msg_local_ids_sort = a({}, e.messageId, 0) : e.local && (t.msg_local_ids_sort[e.messageId] = Object.keys(t.msg_local_ids_sort).length), n ? i.unread = 0 : (i.lastmsg == e.messageId && i.unread ? F(t, 1, e.peerId) : (!i.unread && F(t, 1, e.peerId), i.unread++), x(e.peerId, t)), (0, zt.isFullyLoadedTab)(t, r)) {
                var s = u(i.history);
                i.skipped > 0 && i.skipped++, i.offset++, i.msgs[e.messageId] = extend(!0, {}, e), i.history = (0, zt.appendToHistory)(t, e, s, !0, !0, !0), (0, Wt.isOut)(e) && (i.blocked_community = 0, E(t))
            }
    ...
    function j(e, t) {
        if ((0, zt.isFullyLoadedTab)(t, e.peerId)) {
            var n = t.tabs[e.peerId],
                r = n.unread;
            if (t = S(t, e.peerId, e.upToId, 0), null != e.unread ? n.unread = e.unread : n.unread = e.upToId >= n.lastmsg ? 0 : (0, Kt.countUnread)(e.peerId, t) + (n.unread > 0 ? +n.skipped : 0), r > 0 && !n.unread && F(t, -1, e.peerId), !n.skipped) {
                var a = u(n.history);
    ...
    function H(e, t) {
        var n = t.tabs[e.peerId];
        if ((0, zt.isTabLoaded)(t, e.peerId) && S(t, e.peerId, e.upToId, Ht.FLAG_OUTBOUND), (0, zt.isFullyLoadedTab)(t, e.peerId)) {
            var r = u(n.history);
    ...
    function Oe(e, t, n, r) {
        return t !== vk.id ? Promise.resolve(r) : ((0, zt.isTabLoaded)(r, n) && r.peer == n && (r = E(r)), Promise.resolve(r))
    }
    ...
    function it(e, t, n) {
        return t !== Ht.RESET_DIRECTORIES || e.folders & Vt.FOLDER_MASKS[n] ? t === Ht.REPLACE_DIRECTORIES ? e.folders & Vt.FOLDER_MASKS[n] ? -1 : 1 : t === Ht.SET_DIRECTORIES ? 1 : -1 : 0
    }
    ...
    function ot(e, t, n, r, a) {
        if ((0, zt.isTabLoaded)(a, e)) {
            var i = a.tabs[e];
            return n === Ht.REPLACE_DIRECTORIES && (t ^= i.folders), at(n, t, i) && Object.keys(Vt.FOLDER_MASKS).filter(function(e) {
    ...
    t.readLastMessages = l(function(e, t) {
        ...
        return n.skipped > 0 && (r = r.filter(function(e) {
            ...
            return S(t, e, r, Ht.FLAG_OUTBOUND)
        }))
    ...
    function w() {
        U = ge("audiomsg_record"), z = ge("audiomsg_player"), x = geByClass1("im-audio-message-input"), R = geByClass1("audio-msg-track--duration", x), B = geByClass1("audio-msg-track--wave", x),
            F = geByClass1("im-audio-message--cancel-btn", x), j = geByClass1("_im_audio_send", x), H = geByClass1("audio-msg-track--btn", x), G = geByClass1("im-chat-input--text", geByClass1("im-page--chat-input"));
