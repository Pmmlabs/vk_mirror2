! function(e) {
    ...
    function v(e, t) {
        ...
        return Promise.resolve(t).then(function(t) {
            return t.tabHistoryNotChanged = !1, (0, Kt.isFullyLoadedTab)(t, n) && !t.tabs[n].msgid ? (t.gid && h(n, t), Promise.resolve(t).then(E)) : ((0, Kt.isFullyLoadedTab)(t, n) && (t.tabs[n].msgid = !1),
                f(n, e, !1, !0, t))
    ...
    function s(e) {
        e >= window.clientHeight() - 30 && (e = 0), Yt.set(Wn, e)
    }
    ...
    function u(e, t, n, r) {
        ...
        return t && (l = '<a onmouseover="return Emoji.stickerOver(' + en(e) + ', this);"\n        onclick="return Emoji.clickSticker(' + en(t) + ', this, event);">' + l + "</a>"), l = '<div class="im_sticker_row">' + l + "</div>"
    }
    ...
    function _(e) {
        ...
        t && (fn(t, "_im_invisible_bar"), fn(t, "im-page--history-new-bar_hide"))
    }

    function h(e, t, n) {
        var r = v(e, t),
            a = dn("_im_mess_" + t.messageId, n);
        return a && (a.parentNode.replaceChild(Qt(r), a), y(n)), n
    }

    function v(e, t) {
        var n = ["_im_mess"],
            r = (0, wt.isUnread)(e.tabs[t.peerId], t);
        (0, wt.isOut)(t) && r && n.push("im-mess_unread _im_mess_unread"), (0, wt.isOut)(t) && n.push("im-mess_out"), (0, wt.wasEdited)(t) && n.push("im-mess_was_edited"), (0, Pt.canMessageBeEdited)(e, t) && n.push("im-mess_editable"), (0, wt.isImportant)(t) && n.push("im-mess_fav"), -1 != (e.selectedMessages || []).indexOf(t.messageId) && n.push("im-mess_selected");
        var a = Date.now() - 1e3 * t.date > 1e3;
        t.local && a && n.push("im-mess_sending"), t.local && n.push("" + At), t.local && (0, wt.wasEdited)(t) && !r && n.push("im-mess_unread im-mess_nobg"), t.failed && n.push("im-mess_failed " + Ot), (0, wt.isGift)(t) && n.push("im-mess_gift");
        var i = b(t),
            s = N(t.text, t.kludges);
        "" != s && (0, wt.wasEdited)(t) && (s += yn("sImLblWasEdited", {
            update_time: t.update_time
        })), t.subject && "..." !== t.subject.trim() && !P(t.peerId) && (s = yn("im_topic", {
            topic: t.subject
        }) + s);
        var o = yn("im_message_media", {
            messageId: t.messageId,
            attaches: i.join(""),
            text: (0, wt.isGift)(t) ? '<div class="im-mess--gift-lbl">' + s + "</div>" : ""
        });
        return (0, wt.isGift)(t) || (o = s + o), "" == s && (0, wt.wasEdited)(t) && (o += yn("sImLblWasEdited", {
            update_time: t.update_time
        })), yn("im_msg_row", {
            msg_id: t.messageId,
            from_id: t.peerId,
            ...
            ts: t.date,
            marker_params: t.failed ? 'aria-label="' + Cn("mail_send_message_error") + '" role="link"' : "",
            unread_params: r ? 'aria-label="' + Cn("mail_unread_message") + '"' : "",
            cls: n.join(" ")
        })
    }
    ...
    function y(e) {
        for (var t = e.getElementsByClassName("_im_mess_noa"), n = t.length; n--;) _n(t[n], "im-mess_fwd") || t[n].insertAdjacentHTML("afterbegin", yn("sImHistoryRowActions")), fn(t[n], "_im_mess_noa")
    }
    ...
    function C(e, t, n) {
        var r = (arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : !0, arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : !0),
            ...
            s = e.tabs[t.peerId];
        if (!n || dn("_im_mess", n) || dn("_im_bar_date", n) || (n.innerHTML = ""), s.skipped > 0) return n;
        var o = [];
        ...
        var l = v(e, t),
            u = sn(n);
        _n(u, "_im_mess_stack") || (u = ln(u, "._im_mess_stack", -1));
        var c = (0, ht.getLastMessage)(e, t.peerId, t.messageId),
        ...
        if (!c || R(s, c, t, e, a)) {
            var f = "",
                p = !1;
            if (d && (0, wt.isOut)(t) && qe(e, n, t.peerId), 1 === s.unread && !(0, wt.isOut)(t) && a && (f += yn("im_mess_bar", {}), p = !0, qe(e, n, t.peerId)), !Pn(new Date(m))) {
                var _ = new Date,
                    h = p ? "im-page--history-new-bar_hide _im_invisible_bar" : "";
                f += yn("im_day_bar", {
                    day: In(t.date, e.timeshift, !0, Cn("months_of", "raw"), !0),
                    date: t.date,
                    day_class: _.getDate() + _.getMonth() + _.getFullYear() + " " + h
                })
            }
            if (le(t)) f += yn("im_service_row", {
                text: ce(e, t, s),
                type: "",
                date: t.date,
                from_id: "",
                ...
                var b = e.gid && (0, wt.isOut)(t) ? en(t.kludges.from_admin) || 0 : 0,
                    C = (0, It.oCacheGet)(e, b ? -e.gid : g) || s,
                    E = P(t.peerId) ? C.name : C.first_name,
                    k = C.link || s.href,
                    T = yn("im_mess_stack_name", {
                        name: E,
                        link: k,
                        "class": (0, wt.isMoney)(t) ? " im-mess-stack--lnk-money-transfer" : ""
                    });
                if ((0, wt.isGift)(t)) {
                    var S = Cn("mail_gift_message_sent", "raw");
                    T += ' <span class="im-mess-stack--gift">' + wn(C.sex || 0, S) + "</span>"
                }
                if ((0, wt.isMoney)(t)) {
                    var I = (0, wt.isMoneyRequest)(t) ? Cn("mail_money_request_message_sent", "raw") : Cn("mail_money_tranfer_message_sent", "raw");
                    T += ' <span class="im-mess-stack--money-transfer">' + wn(C.sex || 0, I) + "</span>"
                }
                var M = e.gid ? "/gim" + e.gid : "/im",
                    L = void 0;
                if (L = t.local ? B(t.date, e.timeshift) : yn("im_stack_date", {
                        date: B(t.date, e.timeshift),
                        link: M + "?sel=" + t.peerId + "&msgid=" + t.messageId
                    }), b && e.admins[b]) {
                    var A = e.admins[b],
                        O = b === Wt.id ? Cn("mail_by_you") : A[0];
                    L = L + " " + yn("im_admin_link", {
                        name: O,
                        href: A[1]
                    })
                }
            ...
            }(0, St.toArray)(Jt(f)).forEach(function(e) {
                return n && n.appendChild(e)
            })
        } else d && e.peer === t.peerId && !s.inplaceSearch && (0, wt.isOut)(t) && qe(e, n, t.peerId), dn("_im_stack_messages", u).appendChild(Qt(l));
        return (0, wt.isOut)(t) && !i && setTimeout(function() {
            var e = dn("_im_mess_" + t.messageId, n);
            _n(e, At) && mn(e, "im-mess_sending")
    ...
    function k(e, t, n) {
        var r = e.tabs[t];
        return (0, St.toArray)(cn("_im_mess_unread", n)).forEach(function(e) {
            var t = en(un(e, "msgid"));
            t > 0 && r.out_up_to >= t && (fn(e, "_im_mess_unread"), fn(e, "im-mess_unread"), E(e))
        }), n
    }
    ...
    function R(e, t, n, r, a) {
        if ((0, wt.getUserId)(t) !== (0, wt.getUserId)(n)) return !0;
        var i = x(t.date, r),
            s = x(n.date, r);
        return Mn(i, s) ? (0, ht.isCommunityInterface)(r) && en(t.kludges.from_admin) !== en(n.kludges.from_admin) ? !0 : n.date - t.date > 300 ? !0 : le(t) || le(n) ? !0 : (0, wt.isGift)(t) || (0, wt.isGift)(n) ? !0 : (0, wt.isGraffiti)(t) || (0, wt.isGraffiti)(n) ? !0 : (0, wt.isUnread)(e, t) === (0, wt.isUnread)(e, n) || !a || (0, wt.isOut)(n) || me(n.peerId, r.gid) ? !1 : !0 : !0
    }
    ...
    function N(e, t) {
        ...
        }), t.emoji && (e = jn.emojiToHTML(e, !0)), qn && (e = qn(e)), e
    }
    ...
    function U(e) {
        return {
            search: {
                name: Cn("mail_im_peer_search"),
                icon: "search"
            },
            block_community: {
                icon: "block",
                name: Cn("mail_block_comm_messages")
            },
            allow_community: {
                icon: "unblock",
                name: Cn("mail_allow_comm_messages")
            },
            clear: {
                name: Cn(e.peer < -2e9 ? "mail_im_delete_email_contact" : "mail_im_delete_all_history"),
                icon: "clear"
            },
            chat: {
                name: Cn("mail_im_create_chat_with"),
                icon: "invite"
            },
            mute: {
                name: Cn("mail_im_mute"),
                icon: "mute"
            },
            unmute: {
                name: Cn("mail_im_unmute"),
                icon: "unmute"
            },
            photos: {
                name: Cn(e.gid ? "mail_im_show_media_history_group" : "mail_im_show_media_history"),
                icon: "media"
            },
            avatar: {
                icon: "avatar",
                name: Cn("mail_update_photo_red")
            },
            block: {
                icon: "block",
                name: Cn("mail_block_user")
            },
            invite: {
                icon: "invite",
                name: Cn("mail_im_create_chat_with")
            ...
            invite_link: {
                icon: "invite-link",
                name: Cn("mail_chat_invite_link")
            },
            leave: {
                icon: "leave",
                name: Cn("mail_leave_chat")
            },
            topic: {
                icon: "topic",
                name: Cn("mail_change_topic")
            },
            "return": {
                icon: "return",
                name: Cn("mail_return_to_chat")
            },
            pin_hide: {
                icon: "pin_hide",
                name: Cn("mail_menu_pin_hide")
            },
            pin_unhide: {
                icon: "pin_unhide",
                name: Cn("mail_menu_pin_show")
            },
            unpin: {
                icon: "unpin",
                name: Cn("mail_menu_unpin")
            }
        }
    }
    ...
    function V(e) {
        var t = Cn(e.get().gid ? "mail_search_only_messages_comm" : "mail_search_only_messages");
    ...
    function W() {
        return '<li class="im-search-results-head">' + Cn("mail_search_messages") + "</li>"
    }

    function Y() {
        return '<li class="im-search-results-head">' + Cn("mail_search_conversations_sep") + "</li>"
    }

    function Q() {
        return '<li class="im-search-results-head">' + Cn("mail_search_dialogs_sep") + "</li>"
    }

    function X() {
        return '<li class="im-search-results-head _im_recent_bar">\n    ' + Cn("mail_recent_searches") + '\n    <button type="button" class="' + zt + ' im-page--clear-recent">' + Cn("mail_clear_recent") + "</button>\n  </li>"
    }
    ...
    function J(e, t, n) {
        ...
        if (r) {
            hn(r, "aria-hidden", "false"), mn(r, "im-mess_failed " + Ot);
            var a = dn("_im_mess_marker", r);
            hn(a, "aria-label", Cn("mail_send_message_error")), hn(a, "role", "link")
        }
        return n
    }
    ...
    function Z(e, t, n) {
        ...
        if (r) {
            fn(r, "im-mess_failed"), hn(r, "aria-hidden", "true"), fn(r, Ot);
            var a = dn("_im_mess_marker", r);
    ...
    function te(e, t) {
        ...
        return e.forEach(function(e) {
            ...
            return gn("_im_mess_stack", e)
        }).forEach(function(e) {
            _n(an(e), "_im_bar_date") && Xt(an(e)), _n(an(e), "_im_unread_bar_row") && Xt(an(e)), Xt(e)
        }), t
    }
    ...
    function ne(e, t, n, r) {
        return e.map(function(e) {
            ...
            bn(e, se(t, e, n)), mn(e, "im-mess_light")
        }), r
    }
    ...
    function re(e, t, n) {
        ...
        if (r) {
            var a = dn(Dt, r);
            bn(r, a.innerHTML), fn(r, "im-mess_light")
        }
        return n
    }
    ...
    function ae(e, t, n, r) {
        ...
        var s = ((0, ht.isClassicInterface)(r), 60),
            o = ie(e, t, n, r, !1, a);
    ...
    function ie(e, t, n, r, i, s) {
        ...
        if (o.length && (0, Lt.loadChatMember)(a({}, t, o), r), 0 === l.length) return "";
        var u = M(t) || (0, ht.isCommunityPeer)(t) ? "first_name" : i ? "short_name" : "name";
        if (1 == l.length) {
            var c = n ? "" : (0, It.oCacheGet)(r, l[0])[u];
            return c + " " + Cn("mail_typing")
        }
        var d = Cn("mail_typing_several", l.length),
            g = l.slice(0, Math.min(l.length - 1, s)),
            m = g.map(function(e) {
                return (0, It.oCacheGet)(r, e)[u]
            }).join(", ");
        if (l.length > s + 1) m += " " + Cn("mail_and_peer").replace("{count}", l.length - s).replace("{typing}", d);
        else {
            var f = (0, It.oCacheGet)(r, l[g.length])[u];
            m += " " + Cn("mail_and_peer_one") + " " + f + " " + d
        }
        return m
    }
    ...
    function ce(e, t, n) {
        ...
        if (u = wn(l.sex, Cn(u, "raw")), u = u.replace("{from}", ue(l.link, l.name, r)), s && s !== o) {
            var d = a.source_email;
            if (d) u = u.replace("{user}", ue("/im?email=" + encodeURIComponent(d), "email", r));
            else {
                var g = (0, It.oCacheGet)(e, s),
                    m = i === Ft ? g.inv_name : g.kick_name;
        ...
        if (a.source_act === Ut || a.source_act === Gt)
            if (a.source_message) {
                var p = ge(jn.emojiToHTML(nn(a.source_message.replace(/<br\s?\/?>/gi, " ")), !0)),
    ...
    function pe(e) {
        return function(t) {
            var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "bottom",
                ...
                i = !1;
            setTimeout(function() {
                i || ("bottom" === n ? e.appendChild(a) : e.insertBefore(a, rn(e)), mn(a, "im-preloader_visible"))
            }, 0), t.then(function() {
                i = !0, fn(a, "im-preloader_visible"), a.parentNode && a.parentNode.removeChild(a)
            })
        }
    }
    ...
    function be(e, t) {
        return '<div class="im-mess--text">\n      <span>' + Cn("mail_restored") + '</span>\n      <a class="_im_go_to" href="/im?sel=' + F(e) + "&msgid=" + t + '">' + Cn("mail_im_goto_conversation") + "</a>\n    </div>"
    }

    function ye(e, t) {
        var n = Cn(P(e) ? "mail_chat_sure_to_delete_all" : (0, ht.isCommunityPeer)(e) ? "mail_group_sure_to_delete_all" : "mail_sure_to_delete_all");
        return On(Cn("mail_deleteall1"), n, Cn("mail_delete"), t, Cn("global_cancel"))
    }

    function Ce(e) {
        return On(Cn("mail_unpin_title"), Cn("mail_unpin_text"), Cn("mail_unpin"), e, Cn("global_cancel"))
    }

    function we(e, t, n) {
        var r = Cn("mail_dialog_msg_delete_N", t),
            a = On(Cn("mail_dialog_msg_delete_title"), r, Cn("mail_delete"), function() {
                return n(isChecked(dn("_check_forall")))
            }, Cn("global_cancel")),
            i = '<div class="checkbox im-delete-forall-checkbox _check_forall" onclick="checkbox(this);" role="checkbox" aria-checked="false">' + Cn("mail_delete_for_all") + "</div>",
            s = cur.imDb.selectByKey("del_forall_checked");
        return a.setControlsText(i), s && checkbox(dn("_check_forall")), a
    }
    ...
    function Re(e, t) {
        ...
        if (n[0]) return 2 === n[2] ? '<span class="is_vk_mobile is_online">' + Cn("mail_header_online_status") + Be(t, !1, !0) + "</span>" : "online" + (Bn[n[0]] ? Be(t) : "");
        if (!n[1]) return "";
        var r = Tn(n[1], e.get().timeshift),
            a = wn((0, It.oCacheGet)(e, t).sex, Cn("mail_last_activity_tip", "raw")).replace("{user}", "").replace("{time}", r);
    ...
    function Ge(e, t, n) {
        var r = dn("_im_mess_" + e, n);
        return r && pn(r, "im-mess_fav", t), n
    }

    function qe(e, t, n) {
        var r = dn("_im_unread_bar_row", t);
        if (!r) return t;
        var a = ln(r, "._im_mess_stack", -1),
            i = ln(r, "._im_mess_stack"),
            s = a ? cn("_im_mess", a).pop() : null,
            o = i ? dn("_im_mess", i) : null;
        if (Xt(r), _(t), !o || !s) return t;
        var l = un(s, "msgid"),
            u = un(o, "msgid"),
            c = (0, ht.getMessage)(e, n, l),
            d = (0, ht.getMessage)(e, n, u);
        if (R(e.tabs[n], c, d, e)) return t;
        var g = dn("_im_stack_messages", a),
            m = dn("_im_stack_messages", i).children;
        return (0, St.toArray)(m).forEach(function(e) {
            Xt(e), g.appendChild(e)
        }), Xt(i), t
    }
    ...
    function ze(e, t, n) {
        ...
        var s = _n(a, "_im_mess_srv") ? a : gn("_im_mess_stack", a);
        if (!s) return [!0, 0];
    ...
    function Ke(e, t, n) {
        Gn(t);
        var r = gn("_im_top_notice", n);
        Un(r, 200, Xt.pbind(r));
        var a = gn("_im_page_dialogs", r);
        a && _n(a, "im-page--dialogs-notice") && fn(a, "im-page--dialogs-notice"), Ln.post("al_im.php", {
    ...
    function Ve(e, t, n) {
        Gn(t);
        var r = gn("_im_aside_notice", n);
        Hn(r, 200, Xt.pbind(r)), Ln.post("al_im.php", {
            act: "a_hide_top_notice",
            type: r.getAttribute("data-type"),
            hash: r.getAttribute("data-hash")
        })
    ...
    function We(e, t) {
        Gn(e);
        var n = gn("_im_aside_promo_block", t);
        Hn(n, 200, Xt.pbind(n)), Ln.post("al_im.php", {
    ...
    function Ye(e, t) {
        var n = gn("_im_aside_promo_block", t);
        n.classList.add("--action-called"), Ln.post("al_im.php", {
    ...
    function Qe(e, t, n, r, a) {
        return n = n.replace(/\<br\s*\/?\>(\n)?/gi, " ").replace(/[\n\r]/gi, " "), n = (0, Et.replaceMentions)(n, function(e, t, n, r, a) {
            return a
        }), r && (n = jn.emojiToHTML(n, !0)), t && "..." !== t.trim() && !P(e) && (n = yn("im_topic", {
            topic: t,
            cls: "im-topic_dialog"
        ...
        for (var a = [], i = ""; n < e.length;) {
            ...
            if ("id" === s) i = t[n];
                ...
                var o = $e(e, t, n + 1, r + 1),
                    ...
                    c = l[1];
                n = c, a.push(Xe(i, u)), i = ""
            } else if (")" === s) return "" !== i && a.push(Xe(i)), [a, n];
            n++
        }
    ...
    function Je(e) {
        ...
        var l = $e(n, r),
            u = pt(l, 1),
            c = u[0];
        return Object.keys(Yn).length > 300 && (Yn = {}), Yn[e] = c, c
    }

    function Ze(e, t) {
        var n = {
            photo: Cn("mail_added_photos", "raw"),
            video: Cn("mail_added_videos", "raw"),
            audio: Cn("mail_added_audios", "raw")
        };
        switch (e.type) {
            case "mail":
                return kn(e.object.fwd_count, Cn("mail_fwd_msgs", "raw"), !0);
            case "photo":
            case "video":
            case "audio":
            ...
            case "audio_playlist":
                return Cn("mail_added_audio_playlist");
            case "doc":
                switch (e.kind) {
                    case "graffiti":
                        return Cn("mail_added_graffiti");
                    case "audiomsg":
                        return Cn("mail_added_audiomsg");
                    default:
                        return Cn("mail_added_docs")
                }
            case "geo":
            case "map":
                return Cn("mail_added_geo");
            case "wall":
                return Cn("mail_added_wall");
            case "wall_reply":
                return Cn("mail_added_wall_reply");
            case "gift":
                return Cn("mail_added_gift");
            case "link":
            case "share":
                return Cn("mail_added_link");
            case "sticker":
                return Cn("mail_added_sticker");
            case "market":
                return Cn("mail_added_market_item");
            case "money_transfer":
                return Cn("mail_added_money_transfer");
            case "money_request":
                return Cn("mail_added_money_request");
            case "story":
                return Cn("mail_added_story");
            case "mask":
                return Cn("mail_added_mask");
            case "article":
                return Cn("mail_added_article")
        }
        return ""
    }
    ...
    function nt(e) {
        ...
        if (!n || !(0, Mt.isPinnedMessageVisibleInTab)(e, (0, ht.getPeer)(e))) return "";
    ...
    function at(e, t) {
        e.bodyNode.addEventListener("mouseover", function(e) {
            _n(e.target, "_im_edit_time") && rt(t, e, e.target)
        })
    }
    ...
    function ct(e, t) {
        var n = [],
            ...
            a = r ? r[1].split(";") : [];
        for (a.length > Kn && (r[1] = a.slice(0, Kn).join(";")); e.length > zn;) {
            var i = e.substr(0, zn).lastIndexOf(" "); - 1 == i && (i = zn), n.push({
    ...
    function mt() {
        On(Cn("global_error"), Cn("mail_message_wait_until_uploaded"))
    }
    ...
    var vt = n(90),
        ...
        Ot = t.FAILED_CLASS = "_im_mess_failed",
        Dt = t.ORIGINAL_CLASS = "_im_mess_original",
        xt = t.RESTORE_CLASS = "_im_mess_restore",
        ...
        Ut = t.CHAT_PIN_MESSAGE = "chat_pin_message",
        Gt = t.CHAT_UNPIN_MESSAGE = "chat_unpin_message",
        qt = t.CHAT_INVITE_BY_LINK = "chat_invite_user_by_link",
        zt = (t.DESELECT_ALL_CLASS = "_im_deselect_all", t.SHOW_CHAT_MEMBERS_CLASS = "_im_show_chat_mems", t.HIDE_TOP_NOTICE_CLASS = "_im_top_notice_hide", t.HIDE_ASIDE_NOTICE_CLASS = "_im_aside_notice_hide", t.HIDE_ASIDE_PROMO_BLOCK_CLASS = "_im_aside_promo_block_hide", t.INSTALL_VKADMIN_LINK = "_im_vkadmin_promo_link", t.CLEAR_RECENT_CLASS = "_im_clear_recent"),
        ...
        Dn = Vt.showTabbedBox,
        xn = Vt.showTooltip,
        Rn = Vt.mobileOnlineTip,
        Bn = Vt.mobPlatforms,
        Nn = Vt.onlinePlatformClass,
        Fn = Vt.AudioMessagePlayer,
        jn = Vt.Emoji,
        Hn = Vt.slideUp,
        Un = Vt.fadeOut,
        Gn = Vt.cancelEvent,
        qn = Vt.ny2018ReplaceText,
        zn = 4096,
        Kn = 100,
        Vn = 8,
        Wn = "chatPosition",
    ...
    var r = n(96),
        ...
        u = function() {
            var e, t = n(60)("iframe"),
                r = i.length,
                a = ">";
            for (t.style.display = "none", n(54).appendChild(t), t.src = "javascript:", e = t.contentWindow.document, e.open(), e.write("<script>document.F=Object</script" + a), e.close(), u = e.F; r--;) delete u[l][i[r]];
            return u()
        };
    ...
    for (var r = n(50), a = n(94), i = n(123), s = n(10), o = n(140), l = n(1), u = l("iterator"), c = l("toStringTag"), d = o.Array, g = ["NodeList", "DOMTokenList", "MediaList", "StyleSheetList", "CSSRuleList"], m = 0; 5 > m; m++) {
        var f, p = g[m],
            _ = i[p],
            h = _ && _.prototype;
        if (h) {
