! function(e) {
    ...
    var r = n(42),
        ...
        u = function(e, t, n) {
            var c, d, g, m, f = e & u.F,
                ...
                C = y[l] || (y[l] = {});
            p && (n = t);
            for (c in n) d = !f && b && void 0 !== b[c], g = (d ? b : n)[c], m = v && d ? o(g, r) : h && "function" == typeof g ? o(Function.call, g) : g,
                b && s(b, c, g, e & u.U), y[c] != g && i(y, c, m), h && C[c] != g && (C[c] = g)
        };
    ...
    var r = n(47),
        ...
        u = function() {
            var e, t = n(142)("iframe"),
                r = i.length,
                a = ">";
            for (t.style.display = "none", n(108).appendChild(t), t.src = "javascript:", e = t.contentWindow.document, e.open(), e.write("<script>document.F=Object</script" + a), e.close(), u = e.F; r--;) delete u[l][i[r]];
            return u()
        };
    ...
    for (var r = n(114), a = n(10), i = n(42), s = n(71), o = n(94), l = n(54), u = l("iterator"), c = l("toStringTag"), d = o.Array, g = ["NodeList", "DOMTokenList", "MediaList", "StyleSheetList", "CSSRuleList"], m = 0; 5 > m; m++) {
        var f, p = g[m],
            _ = i[p],
            h = _ && _.prototype;
        if (h) {
