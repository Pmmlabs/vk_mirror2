! function(e) {
    ...
    for (var r = n(133), a = n(27), i = n(6), o = n(17), s = n(117), l = n(7), u = l("iterator"), c = l("toStringTag"), d = s.Array, g = ["NodeList", "DOMTokenList", "MediaList", "StyleSheetList", "CSSRuleList"], m = 0; 5 > m; m++) {
        var f, p = g[m],
            _ = i[p],
            h = _ && _.prototype;
        if (h) {
    ...
    var r = n(6),
        ...
        l = Function[s],
        u = ("" + l).split(s);
    n(107).inspectSource = function(e) {
        return l.call(e)
    ...
    function J(e, t, n) {
        ...
        setTimeout(function() {
            t.get().peer && (z(t), (0, re.getCurrentTab)(t).pinned && (o().updateChatTopic(t.get().peer, t), t.set(te.setActions), b.changeActions(t)), t.get().msgid ? k(h, e, t.get().msgid, t) : E(h, e, o, t, p) || h.scrollBottom(Ae), t.get().history_init = !1,
                p.reset(h), A(t, e), w(t, o, r, c, p, e, 0, h), (0, ne.ensureDomHasActions)(e), nav.objLoc.st && (t.mutate(te.setInplaceSearch.bind(null, nav.objLoc.st, t.get().peer)), o().startSearch(t)))
        }, 15);
    ...
    n(93), n(112), n(13), n(69), e.exports = n(107).Map
}, function(e, t, n) {
    "use strict";
    ...
    var r = n(24),
        a = {};
    a[n(7)("toStringTag")] = "z", a + "" != "[object z]" && n(27)(Object.prototype, "toString", function() {
    ...
    var r = n(5),
        ...
        u = function() {
            var e, t = n(33)("iframe"),
                r = i.length,
                a = ">";
            for (t.style.display = "none", n(114).appendChild(t), t.src = "javascript:", e = t.contentWindow.document, e.open(), e.write("<script>document.F=Object</script" + a), e.close(), u = e.F; r--;) delete u[l][i[r]];
            return u()
        };
        ...
        return {
            ...
            updateCounter: function(t, n) {
                ...
                if (r && !o(r) && (R(r, a), val(geByClass1("_im_dialog_unread_ct", r), (0, K.simplifyCounter)(a.unread)), toggleClass(r, "nim-dialog_unread", a.unread > 0), toggleClass(r, "nim-dialog_unread-out", f(t, a, w(a).flags))), (0, Y.isRecentSearchesActive)(t)) {
                    ...
                    i && (val(geByClass1("_sugg_unread_ct", i), (0, K.simplifyCounter)(a.unread)),
                        toggleClass(i, "sugg-is_unread", a.unread > 0))
                }
            },
    ...
    e.exports = {
        set: Object.setPrototypeOf || ("__proto__" in {} ? function(e, t, r) {
            try {
                r = n(121)(Function.call, n(79).f(Object.prototype, "__proto__").set, 2), r(e, []), t = !(e instanceof Array)
            } catch (a) {
                t = !0
            }
            return function(e, n) {
