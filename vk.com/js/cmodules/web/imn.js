! function(e) {
    ...
    e.exports = n(56).document && document.documentElement
}, function(e, t, n) {
    "use strict";
    ...
    function s(e, t, n) {
        geByClass("_im_header_icon", e).forEach(function(e) {
            ...
            else if ("star" === domData(e, "type") && Object(I.isFoldersAvailable)(t) && (toggleClass(e, "im-page--header-icon_star-active", Object(I.isImportant)(t)),
                    setStyle(e, {
    ...
    "use strict";
    n.r(t);
    var r = (n(165), n(11), n(81), n(179), n(7)),
        i = n(108),
        a = n(190),
        o = n(45),
        s = n(186),
    ...
    var r = n(19),
        i = n(111)("iterator"),
        a = n(185);
    e.exports = n(194).getIteratorMethod = function(e) {
    ...
    var r = n(111)("unscopables"),
        i = Array.prototype;
    void 0 == i[r] && n(67)(i, r, {}), e.exports = function(e) {
        i[r][e] = !0
    }
}, function(e, t, n) {
    "use strict";
    ...
    function p(e, t, n, r, i, a) {
        ...
        return Promise.resolve().then(function() {
            ...
            if (Object(G.isAnythingLoading)(e.get()) || !Object(V.isFullyLoadedTab)(e, e.get().peer)) {
                var d = l(e, pe, Object(Q.toArray)(s));
            ...
            return p.then(c.bind(null, e, t)).then(function() {
                ...
                if (l || c || s.length) {
                    if (l) return c || s.length ? Object(V.isMessageTooLong)(c) ? void showFastBox(getLang("global_error"), getLang("mail_err_edit_too_long")) : (t().cancelEditing(), void(Object(X.wasMessageReallyModified)(e, l, a) && (Object(X.replaceMsgAfterEdit)(e, l, c, s, a.getShareUrl(), a.getCancelledShares()), t().sendEditMessage(e, l), e.get().longpoll.push([Object(U.editMessageLocallyEvent)(l)])))) : void m(e, t, r, l.messageId);
    ...
    function y(e, t, n, r, i, a, o, s, c) {
        if (!t.get().removingMedias) {
            ...
            show(we), a && "string" == typeof i ? (s && f(t).addBindUrl(s, i, a), f(t).addAttach(i, a, o)) : (f(t).syncWithSelector(c), "number" == typeof a && c.chosenMedias[a] && b(c.chosenMedias[a], f(t)));
    ...
    function w(e, t, n) {
        ...
        Object(W.isAnyMessageBeingEdited)(e) && "" !== r || D(e, t).then(function(t) {
            ...
            return showTooltip(n.target, {
                ...
                onCreate: function() {
                    radioBtns.im_submit = {
                        els: Object(Q.toArray)(geByClass(ye)),
                        val: a
                    }
                }
            })
    ...
    function k(e, t, n) {
        ...
        if (r)
            if (r.object && r.object.authorName) {
                var a = r.object,
                    o = Object(V.renderShortText)(0, "", a.text, !0, Object(Z.convertKludgesToAttaches)(a.kludges, 0));
    ...
    function T(e, t, n, r, i, a, o, s, c, u) {
        return {
            ...
            progress: function(e, n, r) {
                show(we), t.showMediaProgress(e, n, r)
            },
            ...
            unmount: function() {
                Object(Y.destroyModule)(c), t.destroy(), s.unmount(), Emoji.destroy(e.get().emojiOptId), u.unmount()
            }
        }
    }
    ...
    function x(e, t, n) {
        var r = e.get().peer,
            i = Emoji.val(n);
        Object(V.isReservedPeer)(r) || f(e).dData.txt == i || L(r, e) || (t.checkMessageURLs(i, !0, pe), f(e).setText(i))
    }
    ...
    function B(e, t, n, r) {
        if (38 === r.which && n().isEmpty(e) && !t().getEditingMessage() && !Emoji.shown && !hasAccessibilityMode() && !Object(G.isAnythingLoading)(e.get())) {
            var i = Object(X.findLastMessageToEdit)(e, Object(W.getCurrentTab)(e));
    ...
    function H(e, t, n) {
        ...
        var r = Object(Y.createMutations)(T),
            a = r.callMutations,
            o = r.bindMutations,
            c = Object($.mount)(e, t, a),
            l = g.bind(null, t);
        ls.remove("im_send_queue_2" + vk.id), ls.remove("im_send_queue_1" + vk.id);
        var d = Object(q.initQueue)(l, h.bind(null, t), {
                store: "ls",
        ...
        var x = new MediaSelector(geByClass1(me, e), we, L, {
                maxShown: 0,
                vectorIcon: !0,
                ignoreMobile: !0,
        ...
        var K = E.bind(null, t, e, n),
            Q = S.bind(null, t, e, n),
            X = j.bind(null, t, e, n),
            Z = u.bind(null, t),
            J = Object(Y.createModule)({
                handlers: function(r, o) {
                    r(N, "click", function() {
                    ...
                    }), o(e.parentNode, "click", ve, Q), o(e.parentNode, "click", be, X), o(e, "click", _e, K), o(e, "click", "_im_will_fwd", I), o(e, "keydown", "_im_text", function(e) {
                        return B(t, n, a, e)
                    }), o(bodyNode, "click", ye, Z)
                }
            });
    ...
    var U = n(186),
        ...
        fe = 23,
        pe = 2e3,
        me = "_im_media_selector",
        he = "_im_media_fwd",
        _e = "_im_fwd_close",
        ve = "_im_peer_mute_unmute",
        be = "_im_peer_return_to_chat",
        ye = "_im_submit_btn",
        we = "_im_media_preview"
}, function(e, t, n) {
    var r = n(185),
        i = n(111)("iterator"),
        a = Array.prototype;
    ...
    var r = n(92),
        ...
        u = function() {
            var e, t = n(88)("iframe"),
                r = a.length,
                i = ">";
            for (t.style.display = "none", n(2).appendChild(t), t.src = "javascript:", e = t.contentWindow.document, e.open(), e.write("<script>document.F=Object</script" + i), e.close(), u = e.F; r--;) delete u[c][a[r]];
            return u()
        };
    ...
    function Me(e, t) {
        if (Gr) {
            ...
            try {
                ...
                e.topLevelType = null,
                    e.nativeEvent = null, e.targetInst = null, e.ancestors.length = 0, 10 > zr.length && zr.push(e)
            }
        }
    }
    ...
    for (var r = n(164), i = n(184), a = n(56), o = n(67), s = n(185), c = n(111), u = c("iterator"), l = c("toStringTag"), d = s.Array, f = ["NodeList", "DOMTokenList", "MediaList", "StyleSheetList", "CSSRuleList"], p = 0; 5 > p; p++) {
        var m, g = f[p],
            h = a[g],
            _ = h && h.prototype;
        if (_) {
    ...
    n(160), n(65), n(124), n(91), e.exports = n(194).Map
}, function(e, t) {
    e.exports = function(e) {
                ...
                Ze[u] = Object(ne.getMessageLocalId)(r, u, n).then(function(e) {
                    ...
                    if (n) {
                        var i = "/im?sel=" + Object(re.convertPeerToUrl)(r) + "&msgid=" + n,
                            a = c.innerHTML;
                        domReplaceEl(c, Object(re.serviceLink)(i, a, !0, Qe)),
                            delete Ze[u]
                    }
                })
            }
    ...
    var r = n(19),
        i = {};
    i[n(111)("toStringTag")] = "z", i + "" != "[object z]" && n(184)(Object.prototype, "toString", function() {
    ...
    var r = n(77),
        ...
        a = n(185),
        o = n(25);
    e.exports = n(26)(Array, "Array", function(e, t) {
    ...
    t.f = n(93) ? Object.defineProperty : function(e, t, n) {
    ...
    var r = n(101),
        ...
        a = n(118),
        o = {};
    n(67)(o, n(111)("iterator"), function() {
        return this
    }), e.exports = function(e, t, n) {
        e.prototype = r(o, {
            next: i(1, n)
    ...
    e.exports = {
        set: Object.setPrototypeOf || ("__proto__" in {} ? function(e, t, r) {
            try {
                r = n(76)(Function.call, n(110).f(Object.prototype, "__proto__").set, 2), r(e, []), t = !(e instanceof Array)
            } catch (i) {
                t = !0
            }
            return function(e, n) {
    ...
    var r = n(56),
        ...
        c = Function[s],
        u = ("" + c).split(s);
    n(194).inspectSource = function(e) {
        return c.call(e)
    ...
    var r = n(169),
        i = n(92),
        a = n(23);
    e.exports = n(93) ? Object.defineProperties : function(e, t) {
        i(e);
