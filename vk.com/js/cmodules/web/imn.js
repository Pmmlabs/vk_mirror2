! function(e) {
    ...
    var r = n(62),
        ...
        i = n(35),
        s = {};
    n(90)(s, n(132)("iterator"), function() {
        return this
    ...
    function c() {
        stManager.add(["voice_message_player.js", "speech.js"], function() {
            Y || (Y = Speech.newRecorder(), addEvent(Y, "progress", l)), AudioMessagePlayer.detachPlayer(), AudioMessagePlayer.pauseGlobalMedia(), Y.record().then(function() {
                ...
                showFastBox(getLang("global_error"), getLang(t)),
                    console.error(e)
            })
        })
    }
    ...
    var r = n(113),
        ...
        u = function() {
            var e, t = n(83)("iframe"),
                r = i.length,
                a = ">";
            for (t.style.display = "none", n(4).appendChild(t), t.src = "javascript:", e = t.contentWindow.document, e.open(), e.write("<script>document.F=Object</script" + a), e.close(), u = e.F; r--;) delete u[l][i[r]];
            return u()
        };
    ...
    o.nextTick = function(e) {
        ...
        o.on = i, o.addListener = i, o.once = i, o.off = i, o.removeListener = i, o.removeAllListeners = i, o.emit = i, o.binding = function(e) {
    ...
    function O(e, t, n) {
        ...
        a(r, {
            ...
            if ((0, U.isAnyMessageBeingEdited)(e)) toggleClass(r, "is_input_empty", !t),
                attr(r, "aria-label", getLang("mail_im_edit"));
            else {
                ...
                if (!(0, te.isSearchingInplace)(r.peerId, e.get()) && (0, ne.isFullyLoadedTab)(e, r.peerId) && (0, ne.isPeerActive)(r.peerId, e.get())) {
                    ...
                    N(w, a, n, function() {
                        var s = P(n),
                            ...
                            c = u[0],
                            d = u[1];
                        (0, ne.appendToHistory)(e.get(), r, a, !0, !0, !c && !o),
                        removeClass(t, "im-page--history_empty-hist");
    ...
    for (var r = n(39), a = n(114), i = n(108), s = n(90), o = n(135), l = n(132), u = l("iterator"), c = l("toStringTag"), d = o.Array, g = ["NodeList", "DOMTokenList", "MediaList", "StyleSheetList", "CSSRuleList"], m = 0; 5 > m; m++) {
        var f, p = g[m],
            _ = i[p],
            h = _ && _.prototype;
        if (h) {
