! function(e) {
    ...
    Object.defineProperty(t, "__esModule", {
        ...
        t.wasMessageReallyModified = s, t.replaceMsgAfterEdit = o;
    var l = n(35),
        u = n(139),
        c = n(48),
        d = n(138)
}, function(e, t, n) {
    for (var r = n(66), a = n(103), i = n(31), s = n(54), o = n(13), l = n(84), u = l("iterator"), c = l("toStringTag"), d = o.Array, g = ["NodeList", "DOMTokenList", "MediaList", "StyleSheetList", "CSSRuleList"], m = 0; 5 > m; m++) {
        var f, p = g[m],
            _ = i[p],
            h = _ && _.prototype;
        if (h) {
    ...
    function u(e, t, n, r) {
        ...
        var o = "",
            l = "";
        if (l = i ? "/stickers.php?act=proxy_sticker&sticker_id=" + e + "&size=" + a : "/images/stickers/" + Jt(e) + "/" + a + ".png", o = '<img height="128" class="' + s + '" src="' + l + '"/>', i) {
            var u = "/stickers.php?act=proxy_animation&product_id=" + t + "&sticker_id=" + e,
                c = "animatedSticker" + r;
            o = '<div id="' + c + '" data-animation-path="' + u + '" onmouseenter="StickersAnimation.loadAndPlaySticker(this);"\n     data-uniq-id="' + r + '" data-sticker-id="' + Jt(e) + '" class="sticker_animation sticker_animation_128 im_gift">' + o + "</div>";
            var d = !1;
            browser.msie ? (0 ^ r) === r && (d = !0) : d = Number.isInteger(r), d && Fn && Fn.autoplay && window.StickersAnimation && window.StickersAnimation.loadAndPlayStickerWithTimer(c, 10)
        }
        return t && (o = '<a onmouseover="return Emoji.stickerOver(' + Jt(e) + ', this);"\n        onclick="return Emoji.clickSticker(' + Jt(t) + ', this, event);">' + o + "</a>"), o = '<div class="im_sticker_row">' + o + "</div>"
    }
    ...
    var _t = n(120),
        ...
        Gt = (t.DESELECT_ALL_CLASS = "_im_deselect_all",
            t.SHOW_CHAT_MEMBERS_CLASS = "_im_show_chat_mems", t.HIDE_TOP_NOTICE_CLASS = "_im_top_notice_hide", t.HIDE_ASIDE_NOTICE_CLASS = "_im_aside_notice_hide", t.CLEAR_RECENT_CLASS = "_im_clear_recent"),
    ...
    var r = n(23),
        ...
        u = function() {
            var e, t = n(37)("iframe"),
                r = i.length,
                a = ">";
            for (t.style.display = "none", n(47).appendChild(t), t.src = "javascript:", e = t.contentWindow.document, e.open(), e.write("<script>document.F=Object</script" + a), e.close(), u = e.F; r--;) delete u[l][i[r]];
            return u()
        };
    ...
    t.readLastMessages = l(function(e, t) {
        ...
        })), r = intval(r.shift()), r <= n.in_up_to ? Promise.resolve(t) : (t.longpoll.push([Ht.readInboundEvent([6, e, r])]),
            (0, Nt.post)(Nt.CONTROLLER, {
                peer: e,
                ids: [r],
                hash: n.hash,
                act: "a_mark_read",
