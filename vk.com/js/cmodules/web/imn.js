! function(e) {
    ...
    function Ie(e, t, n, r) {
        ...
        return t.set(r.bind(null, e)).then(function(e) {
            return n().restoreDialogs(e, !0, a !== (0, pt.isReversedDialogs)(e)),
                e
        })
    }
    ...
    var r = n(129),
        ...
        u = function() {
            var e, t = n(103)("iframe"),
                r = i.length,
                a = ">";
            for (t.style.display = "none", n(93).appendChild(t), t.src = "javascript:", e = t.contentWindow.document, e.open(), e.write("<script>document.F=Object</script" + a), e.close(), u = e.F; r--;) delete u[l][i[r]];
            return u()
        };
    ...
    var _modules = __webpack_require__(79),
    ...
    for (var r = n(5), a = n(14), i = n(83), s = n(42), o = n(49), l = n(48), u = l("iterator"), c = l("toStringTag"), d = o.Array, g = ["NodeList", "DOMTokenList", "MediaList", "StyleSheetList", "CSSRuleList"], m = 0; 5 > m; m++) {
        var f, p = g[m],
            _ = i[p],
            h = _ && _.prototype;
        if (h) {
