! function(e) {
    ...
    var r = n(69),
        ...
        u = function() {
            var e, t = n(13)("iframe"),
                r = i.length,
                a = ">";
            for (t.style.display = "none", n(88).appendChild(t), t.src = "javascript:", e = t.contentWindow.document, e.open(), e.write("<script>document.F=Object</script" + a), e.close(), u = e.F; r--;) delete u[l][i[r]];
            return u()
        };
    ...
    function w(e, t, n) {
        var r = (0, Y.showFlushDialog)(t, function(a) {
            n().updateMenu(e),
                (0, Y.cleanHistory)(e, r, n, W.flushHistory, t)
        })
    }
            ...
            case "forward":
                (0, P.processFwd)(o, e.get().peer, e).then(function(t) {
                    ...
                    (0, L.isClassicInterface)(e) ? (cancelStackPush("forward", function(t) {
                        ...
                        }.bind(null, e.get().peer)),
                        e.get().longpoll.push([(0, A.resetPeer)(!0)])) : t().startForward(e)
                });
                break;
            case "star":
                var d = a(o, e, u);
    ...
    for (var r = n(112), a = n(108), i = n(35), s = n(49), o = n(115), l = n(94), u = l("iterator"), c = l("toStringTag"), d = o.Array, g = ["NodeList", "DOMTokenList", "MediaList", "StyleSheetList", "CSSRuleList"], m = 0; 5 > m; m++) {
        var f, _ = g[m],
            p = i[_],
            h = p && p.prototype;
        if (h) {
    ...
    function s(e, t) {
        i() && (console.error(e, t),
            console.trace(), (0, d.retryFn)(c.post, 3, function() {
                return 2
            })("al_im.php", {
                act: "a_weird_log",
                kind: e,
