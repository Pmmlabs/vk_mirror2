! function(e) {
    ...
    function l(e, t, n, r, a) {
        if (!gpeByClass("_im_peer_target", r.target)) {
            ...
            if (n.saveScroll("list"), s && i.msgid !== u) i.longpoll.push([te.changePeer(l, u)]);
                ...
                d && !hasClass(a, "_dont_add_recent") && (0, K.saveRecentSearchPeer)(l, cur.imDb), d && c && !(0, W.isClassicInterface)(t) && setTimeout(function() {
    ...
    function g(e, t, n, r, a, i, o, s, l, u) {
        var c = "",
            g = "";
        return t & te.FLAG_OUTBOUND ? c = d(getLang("mail_by_you"), u, l) : (0, W.isChatPeer)(n) && 0 !== r && (c = d((0, ie.oCacheGet)(e, r).first_name, (0, ie.oCacheGet)(e, r).photo, l)), o = (0, W.renderShortText)(n, s, o, a, i), g = c ? getTemplate("im_drow_prebody", {
            prebody: c,
            body: o
        }) : o
    }
    ...
    function _(e, t) {
        ...
        var l = s.flags,
            c = y(t, e, n),
            d = [];
        r.search && d.push("_im_search", "nim-dialog_search"), inArray(t.peerId, e.get().mutedPeers) && d.push("nim-dialog_muted"), t.verified && d.push("nim-dialog_verified"), (0, Y.isRecentSearchesActive)(e) && d.push("nim-dialog_recent"), -1 === s.messageId && d.push("nim-dialog_empty"), (0, W.isClassicInterface)(e) && d.push("nim-dialog_classic"), t.folders & te.FOLDER_IMPORTANT && d.push("nim-dialog_starred"), !r.search && (0, W.isUnrespond)(e, t.peerId, t) && d.push("nim-dialog_unrespond");
    ...
    function v(e, t, n, r, a) {
        if (!t.deletedDialog) {
            ...
            R(e, t), val(geByClass1("_dialog_body", e), s), val(geByClass1("_im_dialog_date", e), g), val(geByClass1("_im_dialog_unread_ct", e), (0, W.simplifyCounter)(t.unread)), val(geByClass1("_im_dialog_link", e), t.tab);
    ...
    function k(e, t, n, r, a, i) {
        ...
        if (o) {
            ...
            if (t.get().recentSearch) {
                var l = (0, K.removeFromRecentSearch)(s, cur.imDb);
                return re(o), cancelEvent(a), 0 === l.length && j(t, r, e), !1
            }
            var u = (0, W.isCommunityPeer)(s) || (0, W.isUserPeer)(s);
            (0, W.isClassicInterface)(t) && u ? (0, K.deleteDialog)(s, t.get()).then(function(n) {
                var r = V(n, 2),
                    a = r[0],
                    i = r[1];
    ...
    function T(e, t) {
        var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : "",
            ...
            o = c(e),
            s = "" === n ? [] : [n];
        return (0, Y.isRecentSearchesActive)(e) && s.push("nim-dialog_recent"), (0, W.isClassicInterface)(e) && s.push("nim-csr_classic"), inArray(t.peerId, e.get().mutedPeers) && s.push("nim-dialog_muted"), getTemplate("im_conversation_search_row", {
            peer: t.peerId,
            msg_id: t.lastmsg || "",
            photo: a,
            user_link: i,
    ...
    function I(e, t, n, r, a, i) {
        ...
        switch (s) {
            case "restore":
                u && e.set(K.restoreDialog.bind(null, o, l, c)).then(function() {
            ...
            case "spam":
                ...
                if (u) {
                    ...
                    val(g, d), (0, K.spamDialog)(o, l, e.get())
                }
                break;
            case "block":
                var m = void 0;
                m = (0, W.isCommunityInterface)(e) ? (0, W.showBlacklistBox)(o, e) : (0, W.showBlacklistBoxUser)(o, e), m.once("success", function() {
                    e.set(K.flushHistory.bind(null, o)).then(function() {
                        n().restoreDialogs(e)
                    })
                })
        }
    ...
    function N(e, t, n, r, a) {
        ...
        return e.set(K.markDialogAnswered.bind(null, o, s)).then(function() {
        ...
        return {
            ...
            appendDialogs: function(t, r) {
                removeClass(e.parentNode, "im-page--dialogs_with-mess"), r.forEach(function(n) {
                    ...
                    searchOnlyMessages: !1
                }), n.isEmpty() && 0 === r.length && (0, W.isPendingForward)(t) && (r = [M(getLang("mail_im_search_empty_chats"))]), n.replacePreserveOrder(r)
            },
            updateCounter: function(t, n) {
                var r = geByClass1("_im_dialog_" + n, e),
                    a = (0, Y.getTab)(t, n);
                if (r && !o(r) && (R(r, a), val(geByClass1("_im_dialog_unread_ct", r), (0, W.simplifyCounter)(a.unread)), toggleClass(r, "nim-dialog_unread", a.unread > 0), toggleClass(r, "nim-dialog_unread-out", f(t, a, w(a).flags))), (0, Y.isRecentSearchesActive)(t)) {
            ...
            updateTyping: function(t, n) {
                ...
                if (r && !o(r) && !n.get().tabs[t].deletedDialog) {
                    var a = geByClass1("_im_dialog_typing", r),
                        ...
                        s = (0, W.formatTyper)(n.get().tabs[t].typing, t, !(0, W.isChatPeer)(t), n.get(), 1, i);
        ...
        var r = (0, ne.createMutations)(U),
            ...
            w = (0, ne.createModule)({
                handlers: function(r, a) {
                    a(e, "click", "_im_dialog_close", y), a(e, "click", "_im_dialog_markre", m), a(e, "click", se, g), a(e, "click", "_im_dialog", h), a(e, "click", W.MESSAGE_SEARCH_CLASS, v), a(e, "mouseover", "_im_dialog_close", u), a(e, "mouseover", "_im_dialog_markre", c), a(e, "click", W.CLEAR_RECENT_CLASS, function() {
                        (0, K.resetRecentSearch)(cur.imDb), j(t, _, n)
    ...
    e.exports = function(e, t, n, v, b, y, w) {
        ...
        var C, E, k, T = function(e) {
            ...
            L = M[g] || M[f] || b && M[b],
            P = L || T(b),
            D = b ? I ? T("entries") : P : void 0,
            O = "Array" == t ? M.entries || L : L;
        if (O && (k = d(O.call(new e)), k !== Object.prototype && (c(k, S, !0), r || s(k, g) || o(k, g, h))), I && L && L.name !== _ && (A = !0, P = function() {
                return L.call(this)
    ...
    e.exports = {
        set: Object.setPrototypeOf || ("__proto__" in {} ? function(e, t, r) {
            try {
                r = n(31)(Function.call, n(22).f(Object.prototype, "__proto__").set, 2), r(e, []), t = !(e instanceof Array)
            } catch (a) {
                t = !0
            }
            return function(e, n) {
    ...
    function l(e, t, n) {
        ...
        })["catch"](function() {})) : (e().restoreDialogs(n, !1, !0),
            Promise.resolve(!1))
    }
    ...
    function h(e, t, n, r, a) {
        if (!(0, E.isSearching)(e)) {
            var o = cur.imDb.select(D.RECENT_SEARCH_OP);
            if (0 !== o.length || (0, O.doPopularSuggExist)(e)) {
                e.setState({
                    recentSearch: !0
                }), i(e, function() {
    ...
    function g(e, t) {
        ...
        if (!n && !r && !a) {
            ...
            s = trim(replaceEntities(stripHTML(s.replace(/<br>/g, "\n").replace(/<\*>.*$/, "")))), s = (0, W.replaceMentions)(s, function(e, t, n, r, a) {
                return a
    ...
    function M(e, t, n, r, i, o, d, m, v, b, w, M, L, P, D, O, x, R, N, F) {
        return {
            changePeer: function(e, n) {
                t.selectPeer(e, n)
            },
            ...
            route: function(e, a, o, l) {
                ...
                }), (0, se.isClassicInterface)(M) && "undefined" == typeof e.sel && O.updateMenu(M), u && k(M, r, t), !1)
            },
            updateDialogFilters: function(e) {
                (0, ie.isSearching)(e) || t.restoreDialogs(e), w.updateFilter(e)
            },
            removePeer: function(e, n) {
                t.removeDialog(e, n), t.saveScroll(e), e.get().peer === n && e.get().longpoll.push([Z.resetPeer()]), (0, se.isClassicInterface)(e) && O.updateMenu(e)
            },
            ...
            onEvents: function(e, o) {
                ...
                c(f, e, t, n, O), e.set(oe.checkNewPeople.bind(null, f, h, d)).then(function() {
                        ...
                        switch (o.type) {
                            case Z.ADD_MESSAGE:
                                ...
                                if (0 === d) {
                                    ...
                                    h === !1 && f === !0 && n.updateActions(e), (0, se.isClassicInterface)(e) && (O.updateCounter(e, o.peerId), O.updateMenu(e)), n.updateTyping(o.peerId, e), n.addMessage(e, o), (0, se.isClassicInterface)(e) || w.updateFilter(e), _(o) || !(0, se.isFullyLoadedTab)(e, o.peerId) || o.local || e.set(oe.loadMedia.bind(null, o)).then(function(e) {
                            ...
                            case Z.READ_INBOUND:
                                e.set(oe.markInboundMessagesAsRead.bind(null, o)).then(function(e) {
                                    t.updateCounter(e, o.peerId), n.updateGoToEnd(e, !0), (0, se.isClassicInterface)(e) && O.updateCounter(e, o.peerId), (0, ie.isSearching)(e) || t.restoreDialogs(e), w.updateFilter(e)
                                });
                                break;
                            ...
                            case Z.RESET_PEER:
                                ...
                                u(e, t, n, i), o.cancelSearch && k(e, r, t), (0, se.isClassicInterface)(e) && O.updateMenu(e), r.focusInput(e);
                                break;
                            case Z.CHANGE_TAB:
            ...
            unmount: function() {
                ...
                setFavIcon("/images/icons/favicons/fav_logo" + a + ".ico"), n.unmount(), r.unmount(), cancelStackFilter("im_peer"), w.unmount(), b && b.unmount(), O && O.unmount(), x && x(), P && P(), (0, se.isLocksAvailable)(M) && M.get().peer && M.set(oe.releaseBlock.bind(null, M.get().peer)), R.unmount(), O && O.unmount(), N.unmount(), clearInterval(D), cur.imDb.unmount(), cur.imDb = !1
            }
        }
    }
    ...
    function F(e, t) {
        ...
        setFavIcon("/images/icons/favicons/fav_im" + a + ".ico"), D(e, t, !1, !1, !1, !0), show(e);
        ...
        var O = N(t),
            B = void 0;
        (0, se.isLocksAvailable)(t) && (B = setInterval(se.blockLatencyCompensation.bind(null, t, n.longpoll), 2e3)), t.get().invitation && (0,
            se.showInvitationBox)(t, t.get().invitation, oe.leaveInvitation);
        var F = (0, ae.throttleAccumulate)(i.bind(null, t, p, f, b), 200),
            H = se.hideTopNotice.bind(null, t),
            K = se.hideAsideNotice.bind(null, t),
            W = (0, Y.createModule)({
                handlers: function(t, n) {
                    t(document, "mousemove mousedown keypress", S), t(window, "resize", P), n(e, "click", se.HIDE_TOP_NOTICE_CLASS, H), n(gpeByClass("_im-page-wrap", e), "click", se.HIDE_ASIDE_NOTICE_CLASS, K), n(gpeByClass("_im-page-wrap", e), "click", se.HIDE_ASIDE_PROMO_BLOCK_CLASS, se.hideAsidePromoBlock), n(gpeByClass("_im-page-wrap", e), "click", se.INSTALL_VKADMIN_LINK, se.installVKAdminApp), browser.safari && t(document, "visibilitychange", x)
                }
            });
        return u(W, f, p, _, e, I, c, F, l, r, h, t, k, O, B, b, y, v, T, P)
    }
    Object.defineProperty(t, "__esModule", {
        value: !0
    });
    ...
    for (var r = n(78), a = n(50), i = n(52), o = n(34), s = n(44), l = n(65), u = l("iterator"), c = l("toStringTag"), d = s.Array, g = ["NodeList", "DOMTokenList", "MediaList", "StyleSheetList", "CSSRuleList"], m = 0; 5 > m; m++) {
        var f, p = g[m],
            _ = i[p],
            h = _ && _.prototype;
        if (h) {
    ...
    function o(e) {
        if (!e.renew_hashes) {
            ...
            e.renew_hashes = (0, Ot.post)(Ot.CONTROLLER, {
                act: "a_renew_hash",
                peers: n.join(","),
                gid: e.gid
            }).then(function(t) {
    ...
    function g(e, t, n, r, a) {
        return a.tabHistoryNotChanged = !1, (0, Bt.retryFn)(Ot.post, 3, function(e) {
            return e - 1
        })(Ot.CONTROLLER, {
            act: "a_start",
            peer: e,
    ...
    function p(e, t) {
        return (t.block_states[e] || {}).free === !1 ? Promise.resolve(t) : (0, Ot.post)(Ot.CONTROLLER, {
            act: "a_block",
            peer: e,
            prevPeer: t.prevPeer,
            gid: t.gid
    ...
    function C(e, t, n) {
        var r = n.tabs[n.peer];
        return (0, Ot.post)(Ot.CONTROLLER, {
            peer: n.peer,
            whole: e,
            act: "a_history",
    ...
    function L(e, t) {
        return 0 === e.length ? Promise.resolve(t) : (0, Ot.post)(Ot.CONTROLLER, {
            act: "a_get_admin",
            admins: e.join(","),
            gid: t.gid
        }).then(function(e) {
    ...
    function x(e, t) {
        ...
        if ((0, jt.isTabLoaded)(t, r)) {
            ...
            return i.typing && i.typing[e.userId] && delete i.typing[e.userId], i.lastmsg = e.messageId, i.lastmsg_meta = e, h(e.peerId, t), M(t, i, !1, D.bind(null, r), tt.bind(null, t)), Promise.resolve(t)
        }
        return g(r, 0, 0, 0, t).then(function(t) {
            var a = t.tabs[r];
            return M(t, a, !1, D.bind(null, r), tt.bind(null, t)), h(e.peerId, t), n || P(e.peerId, t), t
        })
    }
    ...
    function X(e, t) {
        ...
        return (0, Bt.retryFn)(Ot.post, 3, function(e) {
            return e * e
        })(Ot.CONTROLLER, n).then(function(n) {
            return $(e, n, t)
        })["catch"](function() {
            return $(e, null, t)
        })
    ...
    function oe(e, t) {
        ...
        return (0, Bt.retryFn)(Ot.post, 1, function() {
            return 4
        })(Ot.CONTROLLER, {
    ...
    function he(e, t) {
        ...
        return (0, Ot.post)(Ot.CONTROLLER, {
            ...
            n.unread = s[0], n.in_up_to = s[1], n.out_up_to = s[2], n.unread || (e.get().dialog_tabs[Ut.FOLDER_UNREAD] = e.get().dialog_tabs[Ut.FOLDER_UNREAD].filter(function(e) {
                return e != t
            })), M(e.get(), n, !1, D.bind(null, t), tt.bind(null, e.get()))
        })
    }
    ...
    function je(e, t, n, r) {
        return r.creating = !0, r.longpoll.pause(), (0, Ot.post)(Ot.CONTROLLER, {
            act: "a_multi_start",
            hash: r.writeHash,
            peers: t.join(","),
            title: n
    ...
    function Ue(e) {
        ...
        return (0, Ot.post)(Ot.CONTROLLER, {
            ...
            return m.then(function(n) {
                ...
                }), delete e.resync_in_process, setTimeout(t.bind(null, !0), 0), Ke(intval(l.unread), e)
            })
        })["catch"](function(t) {
    ...
    function We(e, t) {
        return t.ctrl_submit = !!e, (0, Ot.post)(Ot.CONTROLLER, {
    ...
    function mt(e, t, n) {
        ...
        var r = (0,
            Gt.getTab)(n, t);
        return r.blocked_community = !e, (0, Ot.post)(Ot.CONTROLLER, {
    ...
    function wt(e, t, n) {
        return (0, Ot.post)(Ot.CONTROLLER, {
            ...
            }), n.tabs[r] = a, M(n, a, !1, D.bind(null, r), tt.bind(null, n)), n.admins = extend(n.admins, o), [r]
        })
    }
    ...
    t.readLastMessages = l(function(e, t) {
        ...
        })), r = intval(r.shift()), r <= n.in_up_to ? Promise.resolve(t) : (t.longpoll.push([Nt.readInboundEvent([6, e, r])]), (0, Ot.post)(Ot.CONTROLLER, {
            peer: e,
            ids: [r],
            hash: n.hash,
            act: "a_mark_read",
        ...
        var r = Date.now() + rand(0, 100).toFixed(0),
            a = n.tabs[e];
        return (0, Bt.retryFn)(Ot.post, 1)(Ot.CONTROLLER, {
            act: "a_send",
            to: e,
            hash: a.hash,
            msg: t.message,
        ...
        return t.tabs[e].lastTyping = Date.now(), (0, Ot.post)(Ot.CONTROLLER, {
            act: "a_typing",
            peer: e,
            gid: t.gid,
            hash: t.tabs[e].hash
        ...
        return Se(e, (0, Ot.post)("al_im.php", {
            act: "a_flush_history",
            id: e,
            from: "im",
            gid: t.gid,
        ...
        return e.kludges.source_act === jt.CHAT_PHOTO_REMOVE ? (delete t.tabs[e.peerId].photo, Promise.resolve(t)) : (0, Ot.post)(Ot.CONTROLLER, {
        ...
        return De(e, n, t, r), (0, Ot.post)(Ot.CONTROLLER, {
        ...
        return t.longpoll.push([a([0, e, n, !0])]), (0, Ot.post)(Ot.CONTROLLER, {
            act: "a_dialog_star",
            val: r ? 0 : 1,
            peer: e,
            hash: t.tabs[e].hash,
        ...
        return n.longpoll.push([Nt.resetDirectoriesEvent([0, e, r, !0]), Nt.readInboundEvent([6, e, t])]), (0, Ot.post)(Ot.CONTROLLER, {
            act: "a_mark_answered",
            peer: e,
            lastmsg: t,
            hash: n.tabs[e].hash,
        ...
        return M(t, t.tabs[e], !0, function(t) {
        ...
        }), t.tabs[e].deletedDialog = !0, (0, Ot.post)(Ot.CONTROLLER, {
            act: "a_delete_dialog",
            peer: e,
            gid: t.gid,
            hash: t.tabs[e].hash
            ...
            return n[0] ? (lt(t.tabbedPeers.filter(function(t) {
                return t.peer !== e
            }), !0, t), t.tabs[e].unread = 0, t.tabs[e].lastmsg = !1, t.tabs[e].lastmsg_meta = null) : (t.tabs[e].deletedDialog = !1, M(t, t.tabs[e], !1, D.bind(null, e), tt.bind(null, t))), n
        })
    }), t.pinMessage = l(function(e, t, n) {
        var r = n.tabs[t];
        return r.data.kicked || r.data.closed ? Promise.resolve(n) : (0, Ot.post)(Ot.CONTROLLER, {
            act: "a_pin_message",
            msgid: e,
            chat: t,
            hash: n.tabs[t].hash
        ...
        var n = t.tabs[e];
        return n.data.kicked || n.data.closed ? Promise.resolve(t) : (0, Ot.post)(Ot.CONTROLLER, {
            act: "a_unpin_message",
            chat: e,
            hash: t.tabs[e].hash
        }).then(function(r) {
    ...
    var r, a = "\\w\\$А-Яа-яёЁєЄҐґЇїІіЈј",
        ...
        P = t.FOLDER_ALL = "all",
        D = t.FOLDER_UNRESPOND = "unrespond",
        O = t.FOLDER_IMPORTANT = "important",
        x = (t.FOLDERS = [P, L, D, O], t.FOLDER_MASKS = (r = {}, n(r, D, 2), n(r, O, 1), r), t.TOP_DOMAINS = [].concat(b.split(","), y.split(","), w.split(",").map(function(e) {
            return "xn--" + e
        }))),
    ...
    var r = n(32),
        ...
        u = function() {
            var e, t = n(86)("iframe"),
                r = i.length,
                a = ">";
            for (t.style.display = "none", n(68).appendChild(t), t.src = "javascript:", e = t.contentWindow.document, e.open(), e.write("<script>document.F=Object</script" + a), e.close(), u = e.F; r--;) delete u[l][i[r]];
            return u()
        };
    ...
    t.f = n(57) ? Object.defineProperty : function(e, t, n) {
            ...
            if (n)
                for (var r = void 0, a = 0; a < n.length; a++) {
                    var i = s(n[a], 2),
                        ...
                        l = i[1],
                        u = void 0;
                    if (hasClass(e.target, o) ? u = l(e, e.target) : (r = gpeByClass(o, e.target, e.currentTarget)) && (u = l(e, r)), u === !1) break
                }
        }
    }
    ...
    function oe(e, t, n) {
        ...
        return '<div class="im-mess--text">\n    ' + yn(a) + ' <button type="button" data-peer="' + e + '" class="' + Dt + ' im-mess--btn">' + yn("mail_restore") + '</button>\n    <div class="' + Pt + ' im-mess--original">' + r + "</div>\n  </div>"
    }
    ...
    }), t.getClassicChatHeight = i, t.setClassicChatHeight = o, t.fixTableCellChildHeight = s, t.applyInnerHtml = l, t.renderSticker = u, t.isAlreadyDeleted = c, t.replaceMessageAttrs = d, t.isVoiceMessageAvailable = g, t.getAvailableMicrophones = m, t.renderAttach = f, t.dayFromVal = p, t.showInvisibleBar = _, t.editAndReplaceMessage = h, t.renderMessage = v, t.renderMessageMedia = b, t.ensureDomHasActions = y, t.appendToHistory = w, t.restoreQueue = C, t.markMessagesAsRead = k, t.replaceAttaches = T, t.isDuplicate = S, t.isReservedPeer = I, t.isUserPeer = A, t.isChatPeer = M, t.isPeerActive = P, t.isTabLoaded = D, t.isTabLoadedWithMessage = O, t.parseMessage = B, t.convertPeerToUrl = F, t.unUrlPeer = H, t.simplifyCounter = j, t.chatActions = U, t.renderPhotos = z, t.renderPhotosFromTab = V, t.renderBtnSearchOnlyMessages = K, t.renderMessagesSep = W, t.renderConversationsSep = Y, t.renderPopularSuggSep = Q, t.renderClearRecent = X, t.renderPopularSuggestions = $, t.setMessageError = Z, t.startResendMessage = J, t.removeMessages = ee, t.removeMessagesWithRestore = ne, t.restoreMessage = re, t.formatTyper = ae, t.formatTyperHelper = ie, t.renderEmptySearch = se, t.isServiceMsg = le, t.serviceLink = ue, t.renderServiceMsg = ce, t.addChatPhotoToUpdate = de, t.replaceSpecialSymbols = ge, t.isSelfMessage = me, t.showVerifiedTooltip = fe, t.wrapLoading = pe, t.tabFromIds = _e, t.checkSelectClick = he, t.renderGoTo = be, t.showFlushDialog = ye, t.showUnpinDialog = we, t.showMsgDeleteDialog = Ce, t.cleanHistory = Ee, t.showChatMembers = ke, t.inviteUser = Te, t.showUnreadOnly = Se, t.changeTab = Ie, t.isImportant = Ae, t.isUnrespond = Me, t.isPeerBlocked = Le, t.isPendingForward = Pe, t.isPeerBlockedByMe = De, t.blockLatencyCompensation = Oe, t.showSpamLayer = xe, t.getLastSeenTextInHeader = Re, t.showBlacklistBoxUser = Be, t.showBlacklistBox = Fe, t.getBaseLink = He, t.showFavvedBox = je, t.isEditableFocused = Ue, t.updateStar = Ge, t.removewNewUnreadBarAndMerge = qe, t.isMessagesVisible = ze, t.hideTopNotice = Ve, t.hideAsideNotice = Ke, t.hideAsidePromoBlock = We, t.installVKAdminApp = Ye, t.renderShortText = Qe, t.attachToText = Xe, t.lockButton = $e, t.unlockButton = Ze, t.renderPinnedMessage = Je, t.renderPinnedMedia = et, t.showEditTimeTooltip = tt, t.getPinnedMessageHeight = nt, t.boxHandleEditTimeTooltips = rt, t.showPinnedBox = at, t.isUserAliveInChat = it, t.getAliveMembersCount = ot, t.normalizeTab = st, t.normalizeTabsGotFromServer = lt, t.splitMessageToParts = ut, t.isMessageTooLong = ct, t.showInvitationBox = dt, t.showWaitUntilUploadedBox = gt, t.canMessageBeDeletedForAll = mt;
    var _t = n(40),
        ht = r(_t),
        vt = n(35),
        bt = r(vt),
        ...
        Dt = t.RESTORE_CLASS = "_im_mess_restore",
        Ot = (t.TYPING_CLASS = "_im_typing", t.CREATE_CHAT_ACTION = "chat_create"),
        ...
        return Promise.resolve().then(function() {
            ...
            return m.then(l.bind(null, e, t)).then(function() {
                ...
                if (s || i.length) {
                    ...
                    if (l) return (0, j.isMessageTooLong)(s) ? void showFastBox(getLang("global_error"), getLang("mail_err_edit_too_long")) : (t().cancelEditing(), void((0, W.wasMessageReallyModified)(e, l, r) && ((0, W.replaceMsgAfterEdit)(e, l, s, i, r.getShareUrl()), t().sendEditMessage(e, l), e.get().longpoll.push([(0, N.editMessageLocallyEvent)(l)]))));
                    var c = (0, j.splitMessageToParts)(s, i),
                        d = c.map(function(r) {
                            return o(n, f, {
                                message: r.msgText || "",
                                attaches: r.attaches || []
    ...
    function _(e, t, n, r, a, i, o) {
        function s(n, r) {
            var a = e.get().peer,
                i = Emoji.val(r);
            (0, j.isReservedPeer)(a) || T(a, e) || g(e).dData.txt == i || !i || I(e), D(e, t, i), u(r);
    ...
    function v(e, t, n, r, a, i, o, s, l) {
        if (!t.get().removingMedias) {
            ...
            show(pe), i && "string" == typeof a ? (s && g(t).addBindUrl(s, a, i), g(t).addAttach(a, i, o)) : g(t).syncWithSelector(l);
            var u = e().updateScroll();
            return e().scrollFix(t, t.get().peer, u), t.get().delayed_message && !(0, H.isAnythingLoading)(t.get()) ? (n([]), !1) : void D(t, r)
        }
    }
    ...
    function w(e, t, n) {
        ...
        if (r)
            if (r.object && r.object.authorName) {
                var i = r.object,
                    o = (0, j.renderShortText)(0, "", i.text, !0, (0, Y.convertKludgesToAttaches)(i.kludges, 0));
    ...
    function E(e, t, n, r, a, i, o, s, l, u) {
        return {
            restoreDraft: function(e, a) {
                ...
                var o = e.get().peer,
                    s = (0, j.isUserPeer)(o) && o != vk.id && !e.get().gid,
                    l = (0, j.isUserPeer)(o) && o != vk.id && !e.get().gid && !inArray(o, e.get().moneyTransferExcept) || (0, j.isCommunityPeer)(o) && e.get().moneyTransferCommAvail && !e.get().gid || e.get().moneyRequestAvail && e.get().gid || (0, j.isChatPeer)(o) && (0, U.getCurrentTab)(e).moneyRequestAvail;
                if (toggle(geByClass1("ms_item_gift", r), s && !(0, U.isAnyMessageBeingEdited)(e)), toggle(geByClass1("ms_item_money", r), l && !(0, U.isAnyMessageBeingEdited)(e)), (0, j.isReservedPeer)(o)) return Promise.resolve();
                var u = g(e);
            ...
            clearText: function(e, a) {
                g(a).clear(), t.unchooseMedia(), t.chosenMedias = [], Emoji.val(n, ""), C(a, r, i);
            ...
            unmount: function() {
                (0, V.destroyModule)(l), t.destroy(), s.unmount(), Emoji.destroy(e.get().emojiOptId), u.unmount()
            }
        }
    }
    ...
    function R(e, t, n) {
        ...
        var L = new MediaSelector(geByClass1(ce, e), pe, M, {
                maxShown: 0,
                vectorIcon: !0,
                ignoreMobile: !0,
                onAddMediaChange: function(r, a, i, o) {
                    return v(n, t, D, e, r, a, i, o, L)
                },
                editable: 1,
                onChangedSize: function() {
                    var r = n().updateScroll();
                    n().scrollFix(t, t.get().peer, r), O(e)
                },
                sortable: 1,
                teWidth: 150,
                mail: 1,
            ...
            D = m.bind(null, t, n, g, e, i, L),
            R = b.bind(null, t, e),
            N = geByClass1("_im_send", e),
            j = s.bind(null, t, n, g, i, e),
            q = (0, F.mount)(e, t, j, function() {
                addClass(N, "im-send-btn_audio"), removeClass(N, "im-send-btn_static")
            });
        h(e, t), t.get().textMediaSelector = L, t.set(H.initTextStore.bind(null, y, w, k, T));
        var z = geByClass1("_im_text", e);
        setTimeout(function() {
            (0, U.getPeer)(t) && i().setDraft(t, (0, U.getTabDraft)((0, U.getCurrentTab)(t))), _(t, e, L, D, S, l, n)
        }, 0);
        var W = C.bind(null, t, e, n),
            Y = u.bind(null, t),
            Q = (0, V.createModule)({
                handlers: function(r, o) {
                    r(N, "click", function() {
                        P(t, e).then(function(e) {
                            e || (0, U.isAnyMessageBeingEdited)(t) ? D([]) : (a(N, {
                                fasthide: !0
                        ...
                        return x(t, n, i, e)
                    }), o(bodyNode, "click", fe, Y)
                }
            });
        return o(t, L, z, e, D, n, y, l, Q, q)
    }
    Object.defineProperty(t, "__esModule", {
        value: !0
    }), t.mount = R;
    ...
    e.exports = n(52).document && document.documentElement
}, function(e, t, n) {
    "use strict";
    ...
    function i(e) {
        return new Promise(function(t, n) {
            ...
            }, s.open("POST", W.upload_url, !0), s.send(r)
        })
    }
    ...
    function l() {
        R.innerHTML = r(Y.duration), Y.duration >= D && v()
    }
    ...
    function I(e, t, n, r) {
        q = t, W = t.get().audio_msg, K = n, (0, L.initFailBack)(), (0, P.getAvailableMicrophones)().then(function(e) {
            var n = e.length > 0;
    ...
    function h(e, t, n, r) {
        ...
        n.unhoverElements(K), e.get().creationQuery = i, p(t, e, n, i, o)
    }
    ...
    function T(e, t, n) {
        ...
        var g = geByClass1(j, e),
            ...
            D = w.bind(null, t, r, e, s, m, n),
            x = geByClass1(R, e),
            H = (0, P.createModule)({
                handlers: function(t, n) {
                    t(x, "click", p), t(x, "mouseover", C.bind(null, x)), t(geByClass1(U, e), "click", T), t(geByClass1(G, e), "click", I), t(geByClass1(z, e), "click", M), t(geByClass1(q, e), "click", D), t(e, "mouseover", throttle(s.unhoverElements.bind(s, K), 100)), n(e, "click", F, E)
                }
            });
        return k(e, n, s, r, m, H, p, D)
    }
    Object.defineProperty(t, "__esModule", {
        value: !0
    }), t.mount = T;
    ...
    function o(e, t) {
        ...
        r && (0, P.isUserPeer)(n) && (0, O.getTab)(e, n) && (0, P.applyInnerHtml)(r, (0, P.getLastSeenTextInHeader)(e, n))
    }
    ...
    function f(e, t, n, r, a) {
        e.set(L.removeMessagesWithRestore.bind(null, n, a, r)).then(t().removeMessagesRestore.bind(null, n, a, r)), (0, L.removeMessageSend)(n, a, (0, O.getTab)(e, a).hash, r, e.get().gid)
    }
            ...
            case "delete":
                var d = vk.id == u && !e.get().gid,
                    g = !d && e.get().delAllAllowed && s.every(function(t) {
                        return (0, P.canMessageBeDeletedForAll)(e, (0, O.getMessage)(e, u, t))
                    });
                if (g) {
                    c = !1;
                    var m = (0, P.showMsgDeleteDialog)(u, s.length, function(r) {
                        y(e, t, n), m.hide(), cur.imDb.updateByKey("del_forall_checked", r), r ? (0, L.removeMessageSend)(s, u, (0, O.getTab)(e, u).hash, "deleteforall", e.get().gid) : f(e, t, s, l, u)
                    })
                } else f(e, t, s, l, u);
                break;
            case "spam":
                ...
                (0, L.processFwd)(s, e.get().peer, e).then(function(t) {
                    ...
                    (0, P.isClassicInterface)(e) ? (cancelStackPush("forward", function(t) {
                        e.set(L.prepareForward.bind(null, null)).then(function() {
                            e.get().longpoll.push([(0, D.changePeer)(t)])
                        })
                    }.bind(null, e.get().peer)), e.get().longpoll.push([(0, D.resetPeer)(!0)])) : t().startForward(e)
                });
                break;
            case "star":
                var p = a(s, e, u);
                e.set(L.favMessage.bind(null, s, p, u)), e.get().longpoll.push(s.map(function(e) {
                    return {
                        type: p ? D.SET_FLAGS : D.RESET_FLAGS,
                        messageId: e,
                        peerId: u,
                        flags: D.FLAG_IMPORTANT
                    }
                }));
                break;
            case "respond":
        ...
        switch (o) {
            ...
            case "block_community":
                e.set(L.toggleCommunityMessages.bind(null, !1, l)).then(function() {
                    e.get().longpoll.push([(0, D.resetPeer)()]), showDoneBox(getLang("mail_community_was_blocked"))
                });
                break;
            ...
            case "block":
                ...
                c.once("success", function(t) {
                    t.delta && (showDoneBox(t.msg), e.get().longpoll.push([(0, D.resetPeer)()]))
                });
                break;
            case "leave":
                var d = showFastBox({
                    ...
                    e.set(L.leaveChat.bind(null, l)), e.set(L.unpinMessageOptimistic.bind(null, l)), d.hide(), e.get().longpoll.push([(0, D.resetPeer)()])
                }, getLang("global_cancel"), function() {
                    d.hide()
                });
                break;
            ...
            case "invite":
                ...
                break;
            case "pin_hide":
                (0, N.pinnedMessageHide)(e, (0, O.getPeer)(e), t);
                break;
            case "pin_unhide":
                (0, N.pinnedMessageUnHide)(e, (0, O.getPeer)(e), t);
                break;
            case "unpin":
                (0, N.pinnedMessageUnpin)(e, (0, O.getPeer)(e), t)
        }
    ...
    function I(e, t, n) {
        var r = (0, M.createMutations)(S),
            ...
            g = k.bind(null, t, e, n),
            m = function(r) {
                gpeByClass(K, r.target, e) && !checkEvent(r) && ((0, P.showChatMembers)(t, n, L.setCreationType), cancelEvent(r))
            },
            f = (0, M.createModule)({
                handlers: function(r, a) {
                    a(e, "click", q, o), a(e, "click", F, s), a(e, "click", P.DESELECT_ALL_CLASS, l), a(e, "mouseover", V, u), a(e, "mouseover", "_im_header_icon", c), a(e, "mouseover", q, d), a(e, "click", "_im_header_icon", g), a(e, "click", "_im_header_link", m), a(e, "click", W, m), a(e, "click", Y, function(e) {
                        return (0, P.showChatMembers)(t, n, L.setCreationType)
                    }), a(e, "click", "_im_page_back", function(e) {
                        checkEvent(e) || (t.get().longpoll.push([(0, D.resetPeer)()]), cancelEvent(e))
                    })
                }
            });
    ...
    function E(e, t, n, r, a) {
        ...
        if (i) {
            ...
            if ((0, ne.isClassicInterface)(r)) {
                ...
                u += Oe + (c ? (0, ne.getPinnedMessageHeight)() : 0)
            }
    ...
    function N(e, t, n) {
        ...
        if ((0, ne.isClassicInterface)(e)) {
            ...
            return setStyle(p, {
                borderBottomWidth: o.offsetHeight - De - 1
            }), t.contHeight() - i
                ...
                Xe[u] = (0, te.getMessageLocalId)(r, u, n).then(function(e) {
                    ...
                    if (n) {
                        var a = "/im?sel=" + (0, ne.convertPeerToUrl)(r) + "&msgid=" + n,
                            i = l.innerHTML;
                        domReplaceEl(l, (0, ne.serviceLink)(a, i, !0, Ke)), delete Xe[u]
                    }
                })
            }
        }
    ...
    function J(e, t, n) {
        ...
        var b = (0, le.mount)(geByClass1("_im_dialog_actions", e), t, o),
            ...
            C = (0,
                de.mount)(geByClass1("_im_dialog_actions", e), t, o),
            I = (0, fe.mount)(e, t, o),
        ...
        var x = L.bind(null, t, e, o),
            ...
            oe = (0, se.createModule)({
                handlers: function(n, r) {
                    r(e, "click", ne.RESTORE_CLASS, N), r(e, "mouseover click", ne.FAILED_CLASS, V), r(e, "mouseover", "_im_edit_time", K), r(e, "click", "_im_mess_susp", i.bind(null, e)), r(e, "click", xe, B), r(e, "click", Ne, W), r(e, "click", ne.SHOW_CHAT_MEMBERS_CLASS, Y), r(e, "click", Be, $), r(e, "mouseover", Fe, F), r(e, "mouseover", Ve, ee), r(e, "click", Ke, ae), r(e, "click", je, u), r(e, "click", We, function(e, n) {
    ...
    (function(e, a, i) {
        (function() {
            ...
            function M(e, t) {
                e._state === oe && (e._result = t, e._state = se, 0 !== e._subscribers.length && $(D, e))
            }
            ...
            function P(e, t, n, r) {
                var a = e._subscribers,
                    i = a.length;
                e._onerror = null, a[i] = t, a[i + se] = n, a[i + le] = r, 0 === i && e._state && $(D, e)
            }
    ...
    var _modules = __webpack_require__(120),
        DROPBOX_CLASS = "_im_upload_dropbox"
}, function(e, t, n) {
    n(118), n(38), n(21), n(6), e.exports = n(41).Map
}, function(e, t) {
    e.exports = function(e) {
    ...
    function i(e, t) {
        ...
        t.status && e.stat && (t.status >= 500 && t.status < 600 && statlogsValueEvent("im_longpoll", 1, n + "0x", t.getResponseHeader("x-frontend")), P[n] = P[n] ? P[n] + 1 : 1, Date.now() - D >= L && (Object.keys(P).forEach(function(e) {
    ...
    var r = n(37),
        a = n(32),
        i = n(119);
    e.exports = n(57) ? Object.defineProperties : function(e, t) {
        a(e);
    ...
    var r = n(94),
        a = {};
    a[n(65)("toStringTag")] = "z", a + "" != "[object z]" && n(50)(Object.prototype, "toString", function() {
    ...
    function Q(e, t) {
        ...
        var n, a, i = {
            ...
            o = e.ownerDocument;
        return o ? (n = o.documentElement, W(e) && (i = Y(e, !0)), a = o == o.window ? o : 9 === o.nodeType ? o.defaultView || o.parentWindow : !1, [i.left + (t ? 0 : a.pageXOffset || n.scrollLeft) - (n.clientLeft || 0), i.top + (t ? 0 : a.pageYOffset || n.scrollTop) - (n.clientTop || 0)]) : [0, 0]
    }
    ...
    function $(e, t, n) {
        ...
        if (t && "border-box" === le(e, "boxSizing") && (t = !1), e == document) i = [Math.max(o.clientWidth, bodyNode.scrollWidth, o.scrollWidth, bodyNode.offsetWidth, o.offsetWidth), Math.max(o.clientHeight, bodyNode.scrollHeight, o.scrollHeight, bodyNode.offsetHeight, o.offsetHeight)];
            ...
            var s = function() {
                i = W(e) && (a = Y(e, n)) && void 0 !== a.width ? [a.width, a.height] : [e.offsetWidth, e.offsetHeight], t && each(i, function(t, n) {
    ...
    var Se = !1;
    window.ge = r, window.geByTag = a, window.geByTag1 = i, window.geByClass = o, window.geByClass1 = s, window.gpeByClass = l, window.domQuery = u, window.domQuery1 = c, window.domClosest = d, window.ce = f, window.re = p, window.se = _, window.sech = h, window.rs = v, window.psr = b, window.domReplaceEl = y, window.domEL = w, window.domNS = C, window.domPS = E, window.domFC = k, window.domLC = T, window.domPN = S, window.domChildren = I, window.domInsertBefore = A, window.domInsertAfter = M, window.domByClass = L, window.domData = P, window.domChildIndex = D, window.domCA = O, window.domClosestSibling = x, window.matchesSelector = R, window.isHover = N, window.isAncestor = B, window.getScroll = F, window.domClosestPositioned = H, window.domClosestOverflowHidden = j, window.show = U, window.hide = G, window.isVisible = q, window.clientHeight = z, window.getClientRectOffsetY = V, window.toggle = K, window.boundingRectEnabled = W, window.getXYRect = Y, window.getXY = Q, window.isWindow = X, window.getSize = $, window.hasClass = ee, window.addClass = te, window.addClassDelayed = ne, window.removeClass = re, window.removeClassDelayed = ae, window.toggleClass = ie, window.toggleClassDelayed = oe, window.replaceClass = se, window.getStyle = le, window.setStyle = ue, window.setStyleDelayed = ce, window.setPseudoStyle = de, window.data = ge, window.attr = me, window.removeAttr = fe, window.removeData = pe, window.cleanElems = _e, window.setTitle = he, window.getZoom = ve, window.val = be, window.elfocus = ye, window.traverseParent = we, window.getH = J, window.getW = Z, window.domClosestByTag = g, window.setDocumentTitle = Ce, window.lockDocumentTitle = Ee
}, function(e, t, n) {
    "use strict";
    ...
    var r = n(65)("unscopables"),
        a = Array.prototype;
    void 0 == a[r] && n(34)(a, r, {}), e.exports = function(e) {
        a[r][e] = !0
    }
}, function(e, t, n) {
    var r = n(2)("keys"),
