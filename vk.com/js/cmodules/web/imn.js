! function(e) {
    ...
    e.exports = n(170).document && document.documentElement
}, function(e, t, n) {
    "use strict";
    ...
    var r = n(125),
        a = n(15)("iterator"),
        i = n(140);
    e.exports = n(100).getIteratorMethod = function(e) {
    ...
    var r = n(170),
        ...
        l = Function[s],
        u = ("" + l).split(s);
    n(100).inspectSource = function(e) {
        return l.call(e)
    ...
    function ue(e, t, n) {
        if (e = r(e)) {
            ...
            if ("opacity" == t) browser.msie && ((n + "").length ? 1 !== n ? e.style.filter = "alpha(opacity=" + 100 * n + ")" : e.style.filter = "" : e.style.cssText = e.style.cssText.replace(/filter\s*:[^;]*/gi, ""), e.style.zoom = 1), e.style.opacity !== n && (e.style.opacity = n);
                ...
                a && /height|width/i.test(t) && (n = Math.abs(n)),
                    n = a && !/z-?index|font-?weight|opacity|zoom|line-?height/i.test(t) ? n + "px" : n, e.style[t] !== n && (e.style[t] = n)
            } catch (i) {
    ...
    var r = n(15)("unscopables"),
        a = Array.prototype;
    void 0 == a[r] && n(56)(a, r, {}), e.exports = function(e) {
        a[r][e] = !0
    }
    ...
    e.exports = {
        set: Object.setPrototypeOf || ("__proto__" in {} ? function(e, t, r) {
            try {
                r = n(4)(Function.call, n(152).f(Object.prototype, "__proto__").set, 2), r(e, []), t = !(e instanceof Array)
            } catch (a) {
                t = !0
            }
            return function(e, n) {
    ...
    function Z(e, t, n, r, a, i, s, u, d, g, m, b, y, w, C) {
        ...
        return {
            ...
            startForward: function(e) {
                addClass(t, "im-page--history_fwd"), geByClass1("_im_explain_fwd", t).textContent = getLang("mail_explain_fwd", e.get().pendingForward.msgIds.length), s().cancelSearch(e),
                    s().removeSelection(e), cancelStackPush("forward", function() {
                        return D(e, s, t)
                    })
            },
            cancelRecording: function() {
    ...
    var r = n(125),
        a = {};
    a[n(15)("toStringTag")] = "z", a + "" != "[object z]" && n(35)(Object.prototype, "toString", function() {
    ...
    e.exports = !n(106) && !n(149)(function() {
    ...
    var r = n(80),
        ...
        u = function() {
            var e, t = n(23)("iframe"),
                r = i.length,
                a = ">";
            for (t.style.display = "none", n(13).appendChild(t), t.src = "javascript:", e = t.contentWindow.document, e.open(), e.write("<script>document.F=Object</script" + a), e.close(), u = e.F; r--;) delete u[l][i[r]];
            return u()
        };
    ...
    n(103), n(84), n(166), n(120), e.exports = n(100).Map
}, function(e, t) {
    e.exports = function(e) {
    ...
    function I(e, t, n, r) {
        q = t, K = t.get().audio_msg, W = n, (0, L.initFailBack)(), (0, P.getAvailableMicrophones)().then(function(e) {
            var n = e.length > 0;
            n ? (C(), r()) : setCookie("remixvoice", "0", 7),
                t.set(M.setVoiceMessageAvail.bind(null, n))
        })["catch"](function(e) {
    ...
    for (var r = n(113), a = n(35), i = n(170), o = n(56), s = n(140), l = n(15), u = l("iterator"), c = l("toStringTag"), d = s.Array, g = ["NodeList", "DOMTokenList", "MediaList", "StyleSheetList", "CSSRuleList"], m = 0; 5 > m; m++) {
        var f, p = g[m],
            _ = i[p],
            h = _ && _.prototype;
        if (h) {
