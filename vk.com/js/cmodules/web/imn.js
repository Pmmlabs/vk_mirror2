! function(e) {
    ...
    e.exports = function(e, t, n) {
        ...
        return o !== n && "function" == typeof o && (i = o.prototype) !== n.prototype && r(i) && a && a(e, i),
            e
    }
    ...
    e.exports = n(70).document && document.documentElement
}, function(e, t) {
    "use strict";
    ...
    n(38), n(47), n(49), n(133), e.exports = n(31).Map
}, function(e, t, n) {
    var r = n(37),
        a = n(93);
    ...
    function le(e) {
        ...
        return n = e.dialog_tabs[t].length > 0 ? Math.min.apply(null, e.dialog_tabs[t].map(function(t) {
            ...
            return o.forEach(function(t) {
                ...
                }), d(s, e), j(i, e), e.dialog_tabs[t] = e.dialog_tabs[t].concat(Object.keys(i).map(intval)),
                e.dialog_tabs_all[t] = !a.has_more, Promise.resolve(e)
        })
    }
    ...
    var r = n(102),
        a = {};
    a[n(48)("toStringTag")] = "z", a + "" != "[object z]" && n(11)(Object.prototype, "toString", function() {
    ...
    for (var r = n(40), a = n(11), i = n(70), o = n(26), s = n(30), l = n(48), u = l("iterator"), c = l("toStringTag"), d = s.Array, g = ["NodeList", "DOMTokenList", "MediaList", "StyleSheetList", "CSSRuleList"], m = 0; 5 > m; m++) {
        var f, p = g[m],
            _ = i[p],
            h = _ && _.prototype;
        if (h) {
    ...
    e.exports = !n(65) && !n(87)(function() {
        return 7 != Object.defineProperty(n(3)("div"), "a", {
            get: function() {
                return 7
            }
        }).a
    ...
    function w(e, t, n) {
        ...
        for (var c = (0, pt.getLastMessage)(e, t.peerId, t.messageId); t.peerId === e.peer && c && !cn("_im_mess_" + c.messageId);) c = (0, pt.getLastMessage)(e, t.peerId, c.messageId);
    ...
    function Ce(e, t, n, r) {
        var a = yn("mail_dialog_msg_delete_N", t),
            i = Pn(yn("mail_dialog_msg_delete_title"), a, yn("mail_delete"), function() {
                return r(isChecked(cn("_check_forall")))
            }, yn("global_cancel")),
            o = "",
            s = !1;
        return n && (o = '<div class="checkbox im-delete-forall-checkbox _check_forall" onclick="checkbox(this);" role="checkbox" aria-checked="false">' + yn("mail_delete_for_all") + "</div>", s = cur.imDb.selectByKey("del_forall_checked")), i.setControlsText(o), s && checkbox(cn("_check_forall")), i
    }
    ...
    function qe(e, t, n) {
        ...
        var d = cn("_im_stack_messages", a),
            g = cn("_im_stack_messages", i).children;
        return (0, kt.toArray)(g).forEach(function(e) {
            Qt(e), d.appendChild(e)
        }), Qt(i), t
    }
    ...
    function et(e, t) {
        ...
        if (t && (0, yt.isMoneyRequest)(t) && void 0 !== t.kludges.attach1_tr_amount) {
            ...
            if (Jt(t.kludges.attach1_held_amount)) {
    ...
    e.exports = {
        set: Object.setPrototypeOf || ("__proto__" in {} ? function(e, t, r) {
            try {
                r = n(83)(Function.call, n(51).f(Object.prototype, "__proto__").set, 2), r(e, []), t = !(e instanceof Array)
            } catch (a) {
                t = !0
            }
            return function(e, n) {
    ...
    function Z(e, t, n, r, a, i, s, u, d, g, m, b, y, w, C) {
        ...
        return {
            ...
            preparePeer: function(e) {
                ...
                z(e), a.setDraft(e, (0,
                    re.getTabDraft)((0, re.getTab)(e, n))), i().updateTyping(n, e), i().hideError(), r.renderPeer(e), r.hideActions(e), u.changePeer(n, e), T(e, t, r), C.toggle(!1), j(e, t, !0)
            },
            saveScroll: function(e) {
                return v(e, n)
            },
    ...
    var r = n(41),
        ...
        u = function() {
            var e, t = n(3)("iframe"),
                r = i.length,
                a = ">";
            for (t.style.display = "none", n(19).appendChild(t), t.src = "javascript:", e = t.contentWindow.document, e.open(), e.write("<script>document.F=Object</script" + a), e.close(), u = e.F; r--;) delete u[l][i[r]];
            return u()
        };
    ...
    t.vkLocal = n, t.lTimeout = r, t.rand = a, t.irand = i, t.isUndefined = o, t.isFunction = s, t.isArray = l, t.isString = u, t.isObject = c, t.isEmpty = d, t.vkNow = g, t.vkImage = m, t.trim = f, t.stripHTML = p, t.escapeRE = _,
        t.intval = h, t.floatval = v, t.positive = b, t.isNumeric = y, t.winToUtf = w, t.replaceEntities = C, t.clean = E, t.unclean = k, t.each = T, t.indexOf = S, t.inArray = I, t.clone = A, t.arrayKeyDiff = M, t.extend = L, t.addTemplates = P, t.getTemplate = O, t.serializeForm = D, t.extractUrls = x, t.isRetina = R, window.PageID = window.PageID || 1;
    ...
    "use strict";
    var r = n(16);
    e.exports = n(108)("Map", function(e) {
        return function() {
