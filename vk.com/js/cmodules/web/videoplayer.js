! function(t) {
        ...
        D = function(t) {
            ...
            return a(e, t), e.prototype.buildEl = function() {
                ...
                if (!this._timelineAnimationRequestId && window.cancelAnimationFrame) {
                    var e = function i() {
                        if (t.player.getState() === d.PLAYING && !t.player.isActiveLive() && !t.timelineSlider.dragging) {
    ...
    var a = function() {
        ...
        c = function(t) {
            ...
            return s(e, t), e.prototype.initVideo = function(t) {
                ...
                f -= Math.round(r.frameWidth / 2) - d;
                var v = 0;
                7 > f && (v = f - 7 - c / 2, f = 7), setStyle(this.el, {
                    left: f + "px"
    ...
    var s = function() {
        ...
        M = function() {
            ...
            return t.prototype.initVideo = function(t) {
                ...
                return t && (e += "?t=" + T["default"].toString(this.curTime())), e
                ...
                this.getState() !== u.PLAYING && this.getState() !== u.ERROR && this.isInited() && (this.getState() === u.UNSTARTED && this.onBeforeFirstPlay(), this.changeState(u.PLAYING), this.isPlayingLinearAd() ? this.ads.play() : this.media.play(), this.externalCall("onVideoStreamPlaying", this.vars.oid, this.vars.vid))
            }, t.prototype.pause = function() {
                this.getState() === u.PLAYING && this.getState() !== u.ERROR && (this.isPlayingLinearAd() ? this.ads.pause() : this.media.pause(), this.changeState(u.PAUSED))
                ...
                "undefined" == typeof t && (t = this.getState() !== u.PLAYING), t ? this.play() : this.pause()
                ...
                var t = this.vars.list_id,
                    e = T["default"].toString(this.curTime());
                ...
                w.screenfull && (this.isFullscreen() ? w.screenfull.exit() : w.screenfull.request(this.el))
            }, t.prototype.isFullscreen = function() {
                return w.screenfull.element === this.el
                ...
                this.isTouchedByUser() || (this.touchedByUser = !0, this.isFromAutoplay() && (this.toggleMute(!1), this.ui.onTouchedByUser(), this.externalCall("onPlayerTouchedByUser"), setTimeout(function() {
                    t.getState() === u.PLAYING && t.externalCall("onVideoStreamPlaying", t.vars.oid, t.vars.vid)
                }, 0)))
                ...
                this.deinitVideo(), this.trigger(d._DESTROY), this._events.removeAllListeners(), window.removeEventListener("resize", this._resizeHandler), w.screenfull && document.removeEventListener(w.screenfull.raw.fullscreenchange, this._fsChangeHandler)
                ...
                if (t.hls_raw && !x[i]) {
                    ...
                    if (r.length) {
                        var _ = Math.min.apply(Math, r),
                            ...
                            b = k["default"].get("video_abr_quality") || f.DEFAULT,
                            E = Math.max(_, Math.min(b, m, f.DEFAULT)),
                            S = o[E],
                            L = S.replace(/index-(.+).m3u8/, "seg-1-$1.ts");
                        (0, I["default"])(S), (0, I["default"])(L), x[i] = E
                    }
                }
                ...
                key: "preferredVolume",
                get: function() {
                    var t = k["default"].get("video_volume");
                    return "number" == typeof t ? Math.min(1, Math.max(0, t)) : D
                },
                set: function(t) {
                    k["default"].set("video_volume", t)
                }
            }, {
                key: "preferredQuality",
                get: function() {
                    var t = k["default"].get("video_preferred_quality");
                    return f.qualityFromIndex(t) || f.DEFAULT
                },
                set: function(t) {
                    var e = f.indexFromQuality(t);
                    k["default"].set("video_preferred_quality", e)
                }
            }], [{
                key: "Events",
                get: function() {
        ...
        b = function(t) {
            ...
            return a(e, t), e.prototype.initVideo = function(t) {
                ...
                window.ns_ && this.player.isInited() && (this.comScoreMetaData = {
                    ...
                    customerC2: "13765216"
                }), this.player.getState() === f.PLAYING && (this.player.isPlayingLinearAd() ? this.comScoreTag.playVideoAdvertisement() : this.comScoreTag.playVideoContentPart(this.comScoreMetaData)))
                ...
                this.sendAdsPlayStarted(), this.comScoreTag && (this.player.getState() === f.PLAYING && this.comScoreTag.stop(), this.comScoreTag.playVideoAdvertisement()), "preroll" == t && (this.clearWatchData(), this.collectWatchStat = !1)
            }, e.prototype.onLinearAdCompleted = function() {
                this.sendAdsPlayFinished(), this.comScoreTag && (this.comScoreTag.stop(), this.player.getState() === f.PLAYING && this.comScoreTag.playVideoContentPart(this.comScoreMetaData))
    ...
    var n = i(142),
        r = i(152);
    t.exports = i(137) ? function(t, e, i) {
        ...
        U = function(t) {
            ...
            return a(e, t), e.prototype.initVideo = function(t) {
                ...
                "apps_slider" === t.module && (this._uiDisabled = !0, this.hideUI({
                    hideCursor: !1,
                    noTransition: !0
                })), t.is_aurora && this.player.isActiveLive() && (this.donationsLayer = new R["default"](this.player), this.el.appendChild(this.donationsLayer.el)), this._ignoreNoticeTypes = [], this._ignoreLiveWarning = !1
            }, e.prototype.deinitVideo = function() {
                ...
                var t = this.player,
                    e = (!t.isInited() || t.isBuffering() || t.isLoadingAds()) && !t.isPlayingLinearAd() && this.player.getState() !== h.ERROR && t.getLivePhase() !== y.UPCOMING;
                ...
                var t, e, i = [],
                    n = !1,
                    r = !1;
                i = this.player.getNextVideos(), i.length && (n = this.player.nextTimerEnabled()), this.getVar("show_suggestions") && !i.length && (i = this.player.getSuggestions(), r = !0, n = !1), i.length ? this.endScreen = new I["default"](this.player, i, n, r) : this.endScreen = new k["default"](this.player), this.el.appendChild(this.endScreen.el);
    ...
    var n = i(273),
        ...
        l = "prototype",
        u = function() {
            var t, e = i(299)("iframe"),
                n = o.length,
                r = ">";
            for (e.style.display = "none", i(181).appendChild(e), e.src = "javascript:", t = e.contentWindow.document, t.open(), t.write("<script>document.F=Object</script" + r), t.close(), u = t.F; n--;) delete u[l][o[n]];
            return u()
        };
    ...
    i(242), i(12), t.exports = i(133).Symbol
}, function(t, e) {
    var i = t.exports = {
        version: "2.2.1"
    };
    ...
    e.f = i(137) ? Object.defineProperty : function(t, e, i) {
            ...
            return s(e, t), e.prototype.show = function(t) {
                ...
                if (i = isFunction(i) ? i() : i) {
                    ...
                    var c = this.player.el.getBoundingClientRect(),
                        ...
                        y = this.el.getBoundingClientRect(),
                        f = p.left - c.left + Math.round(p.width * s) - Math.round(y.width / 2),
                        v = (r ? p.bottom : p.top) - c.top - (r ? 0 : y.height) + l * (r ? 1 : -1),
                        g = void 0;
                    u > f ? (g = f - u - h, f = u) : f + y.width > c.width - u && (g = f + y.width - (c.width - u) - h, f = c.width - y.width - u), setStyle(this.el, {
                        left: f + "px",
                        top: v + "px"
                    }), setStyle(this._arrow, {
    ...
    var n = i(188),
        r = i(148).concat("length", "prototype");
    ...
    t.exports = i(228).document && document.documentElement
}, function(t, e, i) {
    var n = i(286)("meta"),
        r = i(117),
        o = i(230),
    ...
    var n = i(142),
        r = i(273),
        o = i(177);
    t.exports = i(137) ? Object.defineProperties : function(t, e) {
        r(t);
    ...
    var l = i(300),
        ...
        v = function(t) {
            ...
            return a(e, t), e.prototype.initVideo = function(t) {
                ...
                this._disabled || (clearTimeout(this._hideTimeout), addClass(this._label, "_over"), this.isOpen() || (Date.now() - this.tooltip.lastShown < 50 ? this.showTooltip() : this._tooltipTimeout = setTimeout(this.showTooltip.bind(this), f)))
    ...
    var n = i(228),
        ...
        z = function(t, e, i) {
            return _(t), e = b(e, !0), _(i), o(F, e) ? (i.enumerable ? (o(t, R) && t[R][e] && (t[R][e] = !1), i = S(i, {
                enumerable: E(0, !1)
            })) : (o(t, R) || C(t, R, E(1, {})), t[R][e] = !0), U(t, e, i)) : C(t, e, i)
        },
        Q = function(t, e) {
            _(t);
        ...
        Y = function(t) {
            ...
            return e || !o(this, t) || !o(F, t) || o(this, R) && this[R][t] ? e : !0
        },
        K = function(t, e) {
            var i = T(t = m(t), e = b(e, !0));
            return !i || !o(F, e) || o(t, R) && t[R][e] || (i.enumerable = !0), i
        },
        X = function(t) {
            for (var e, i = k(m(t)), n = [], r = 0; i.length > r;) o(F, e = i[r++]) || e == R || e == u || n.push(e);
            return n
        },
        J = function(t) {
    ...
    H || (P = function() {
        ...
        return this._k
    }), w.f = K, A.f = z, i(146).f = L.f = X, i(236).f = Y, i(195).f = J, s && !i(55) && l(B, "propertyIsEnumerable", Y, !0)), a(a.G + a.W + a.F * !H, {
        Symbol: P
    });
    ...
    j && j[x] && j[x].findChild || (M = !0), a(a.S + a.F * !H, "Symbol", {
        ...
        stringify: $
    }), P[x][O] || i(66)(P[x], O, P[x].valueOf), c(P, "Symbol"), c(Math, "Math", !0), c(n.JSON, "JSON", !0)
}, , , function(t, e) {
    t.exports = function(t) {
    ...
    var l = function() {
        ...
        O = function(t) {
            ...
            return a(e, t), e.prototype.initVideo = function(t) {
                ...
                t.from_autoplay && (e = Math.min(_.INLINE_INITIAL, e));
                ...
                if (t.t) {
                    var e = k["default"].fromString(t.t);
                ...
                return this.provider instanceof w["default"] ? "hls" : this.provider instanceof T["default"] ? "flash" : this.provider instanceof S["default"] ? "base" : this.chooseProvider()
                ...
                this.provider && this.destroyProvider(), this.provider = t, this.el.appendChild(t.el), this.domListen(t.el, "timeupdate", this.onTimeupdate), this.domListen(t.el, "progress", this.onProgress), this.domListen(t.el, "volumechange", this.onVolumechange), this.domListen(t.el, "durationchange", function() {
                    ...
                    e._ui_seeking || e._disabled || e.player.getState() === c.ERROR || e.player.trigger(y.MEDIA_PAUSE)
                ...
                var e = this,
                    ...
                    o = function h() {
                        e.player.getVideoId() == i && e.player.checkLivePhase(function(t) {
                            ...
                            else if ((n || e.player.getLivePhase() === v.UPCOMING && t.phase !== v.UPCOMING) && (n = !1, e.onLiveStarted(), !e.player.isInited())) return;
                            switch (t.phase) {
                                case v.STARTED:
                                    r ? n && e.delay(h, D) : s();
                                    break;
                                ...
                                case v.UPCOMING:
                                    ...
                                    var i = e.player.getLivePhase() !== v.UPCOMING || n ? D : M;
                                    e.liveStartCheckTimeout = e.delay(h, i)
                            }
                    ...
                    a = function() {
                        e.request(t, {
                            onLoad: function(i) {
                                i.indexOf("#EXT-X-STREAM-INF:") > 0 || i.indexOf("#EXTINF:") > 0 ? u(t) : e.delay(o, D)
                            },
                            onError: function() {
                                e.delay(o, D)
                            }
                    ...
                    u = function(t) {
                        e.player.getVideoId() == i && (e.player.getState() == c.ERROR && e.player.changeState(e.player.prevState), e.player.changeLivePhase(v.STARTED), e.provider.src = t, e.provider.load(), e.player.getState() === c.PLAYING && e.play(), r = !0, n && e.delay(o, D))
                    };
                this.player.getLivePhase() == v.STARTED ? s() : o()
                ...
                this.player.checkLivePhase(function(e) {
                    switch (t.undelay(t.liveEndCheckTimeout), delete t.liveEndCheckTimeout, e.phase) {
                        ...
                        case v.WAITING:
                            ...
                            break;
                        case v.STARTED:
                            t.player.getState() == c.ERROR && t.player.changeState(t.player.prevState), t.isWaiting() && (e.media_url ? (t.provider.reset(), t.provider.src = e.media_url) : t.provider.delayRecoverNetwork && t.provider.delayRecoverNetwork()), t.player.getState() === c.PLAYING && t.provider.play(), t.liveEndCheckTimeout = t.delay(t.checkLiveEnded, R)
                    }
                ...
                if (t.length) {
                    ...
                    this.player.trigger(y.MEDIA_PROGRESS, e / this.getDuration()), this.bufEndReached || t.end(t.length - 1) !== this.getDuration() || (this.bufEndReached = !0, this.player.getState() === c.PLAYING && this.vigoStats.triggerEvent("heartbeat"))
                }
                ...
                this.updateVisibility(), this.vigoStats.triggerEvent(t ? "buf_start" : "buf_stop"), this.player.getLivePhase() === v.STARTED && (t ? this.liveEndCheckTimeout || (this.liveEndCheckTimeout = this.delay(this.checkLiveEnded, x)) : (this.undelay(this.liveEndCheckTimeout), delete this.liveEndCheckTimeout))
                ...
                var r = this.getMp4Url(t, n),
                    o = this.curTime();
                this.provider.src = r, this.player.onQualityChanged(t), this.player.getState() !== c.UNSTARTED && (this.vigoStats.triggerEvent("bitrate_change"), this.provider.load(), this.provider.currentTime = o, this.player.getState() === c.PLAYING && this.play(), this.buffering = !0, this._lastInterruptionCheckTime = null)
                ...
                this.provider && this.player.getState() === c.UNSTARTED && (this.preloadRequested || (this.preloadRequested = !0, this.vigoStats.triggerEvent("play"), this.provider.readyState || (this.buffering = !0), this.vigoStats.triggerEvent("pause"), this.provider.load()))
            }, e.prototype.play = function() {
                this.provider && (this._disabled || this.player.getLivePhase() !== v.UPCOMING && (this.provider.readyState || (this.buffering = !0), this.provider.play(), this._lastInterruptionCheckTime = null))
            }, e.prototype.pause = function() {
                ...
                return this.player.getState() === c.PLAYING && !this._disabled
                ...
                if (this.player.getState() !== c.PLAYING || this.player.getLivePhase() === v.UPCOMING || this._ui_seeking || this._disabled || this.buffering || !this.provider) return void(!this.interrupted || this.provider && this.provider.readyState !== HTMLMediaElement.HAVE_ENOUGH_DATA || (this.interrupted = !1));
    ...
    t.exports = !i(137) && !i(109)(function() {
        return 7 != Object.defineProperty(i(299)("div"), "a", {
            get: function() {
                return 7
            }
        }).a
