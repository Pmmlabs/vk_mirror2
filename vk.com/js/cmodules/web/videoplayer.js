! function(t) {
    ...
    t.exports = function(t, e, i, m, _, b, E) {
        ...
        var w, S, L, A = function(t) {
            ...
            I = P[c] || P[f] || _ && P[_],
            D = I || A(_),
            x = _ ? T ? A("entries") : D : void 0,
            R = "Array" == e ? P.entries || I : I;
        if (R && (L = d(R.call(new t)), L !== Object.prototype && (h(L, k, !0), r || a(L, c) || s(L, c, g))), T && I && I.name !== v && (C = !0, D = function() {
                return I.call(this)
            }), r && !E || !p && !C && P[c] || s(P, c, D), l[e] = D, l[k] = g, _)
            if (w = {
                    values: T ? D : A(v),
                    keys: b ? D : A(y),
                    entries: x
        ...
        T = function(t) {
            ...
            return s(e, t), e.prototype.initVideo = function(t) {
                ...
                if (!browser.mac && this.player.isFullscreen()) {
                    ...
                    this.player.setVolume(this.player.getVolume() + k * e), this._lastUserActivity = Date.now(), this.showUI()
                }
    ...
    t.exports = {
        set: Object.setPrototypeOf || ("__proto__" in {} ? function(t, e, r) {
            try {
                r = i(64)(Function.call, i(135).f(Object.prototype, "__proto__").set, 2), r(t, []), e = !(t instanceof Array)
            } catch (n) {
                e = !0
            }
            return function(t, i) {
    ...
    var r = "_initVideo",
        ...
        q = "ads.timeRemained",
        G = "ads.linearStarted",
        z = "ads.linearCompleted",
        Q = "ads.overlayStarted",
        W = "ads.overlayCompleted"
}, function(t, e, i) {
    var r = i(96),
        n = Math.min;
    t.exports = function(t) {
    ...
    var a = i(72),
        ...
        S = function(t) {
            ...
            return s(e, t), e.prototype.initVideo = function(t) {
                ...
                this._disabled = !1, this.buffering = !1, this.interrupted = !1, this.aborted = !1, this.preloadRequested = !1, this.bufEndReached = !1,
                    this.lastNetworkRecoveryTry = 0, this.vigoStats.reset(), this.destroyProvider(), this.undelay(this.liveStartCheckTimeout), this.undelay(this.liveEndCheckTimeout), this.liveHlsCheckRequest && (this.liveHlsCheckRequest.abort(), delete this.liveHlsCheckRequest), delete this.postLiveCheckCount
    ...
    var a = i(72),
        ...
        _ = function(t) {
            ...
            return s(e, t), e.prototype.buildEl = function() {
                ...
                this._minSize && (this._isTimeReversed = !this._isTimeReversed, m["default"].set("video_time_reversed", this._isTimeReversed ? 1 : 0),
                    m["default"].savePref("time_reversed", this._isTimeReversed ? 1 : 0), toggleClass(this.timeLabelCurrent, "_reversed", this._isTimeReversed), this.updateTime(this.player.curTime()))
            }, e.prototype.resize = function(t, e) {
                var i = this;
    ...
    var r = i(84),
        ...
        o = i(176),
        s = {};
    i(182)(s, i(113)("iterator"), function() {
        return this
    }), t.exports = function(t, e, i) {
        t.prototype = r(s, {
            next: n(1, i)
    ...
    var r = i(148),
        ...
        l = "prototype",
        u = function() {
            var t, e = i(200)("iframe"),
                r = o.length,
                n = ">";
            for (e.style.display = "none", i(85).appendChild(e), e.src = "javascript:", t = e.contentWindow.document, t.open(), t.write("<script>document.F=Object</script" + n), t.close(), u = t.F; r--;) delete u[l][o[r]];
            return u()
        };
    ...
    t.exports = i(212).document && document.documentElement
}, function(t, e, i) {
    t.exports = i(199)
}, function(t, e, i) {
    i(106), i(152), t.exports = i(122).Symbol
}, , , function(t, e, i) {
    var r = i(155),
        n = i(14),
        o = i(99);
    ...
    t.exports = !i(65) && !i(34)(function() {
        return 7 != Object.defineProperty(i(200)("div"), "a", {
            get: function() {
                return 7
            }
        }).a
    ...
    var r = i(212),
        ...
        j = s && h(function() {
            ...
            var r = k(B, e);
            r && delete B[e], T(t, e, i), r && t !== B && T(B, e, r)
        } : T,
        q = function(t) {
            var e = F[t] = w(P[R]);
        ...
        z = function(t, e, i) {
            return m(t), e = b(e, !0), m(i), o(F, e) ? (i.enumerable ? (o(t, M) && t[M][e] && (t[M][e] = !1), i = w(i, {
                enumerable: E(0, !1)
            })) : (o(t, M) || T(t, M, E(1, {})), t[M][e] = !0), j(t, e, i)) : T(t, e, i)
        },
        Q = function(t, e) {
            m(t);
    ...
    H || (P = function() {
        ...
        return this._k
    }), L.f = K, A.f = z, i(180).f = S.f = X, i(99).f = Y, i(14).f = J, s && !i(217) && l(B, "propertyIsEnumerable", Y, !0)), a(a.G + a.W + a.F * !H, {
        Symbol: P
    });
    ...
    U && U[R] && U[R].findChild || (x = !0), a(a.S + a.F * !H, "Symbol", {
        ...
        stringify: $
    }), P[R][V] || i(182)(P[R], V, P[R].valueOf), c(P, "Symbol"), c(Math, "Math", !0), c(r.JSON, "JSON", !0)
}, function(t, e) {
    t.exports = function(t) {
    ...
    i(60);
    for (var r = i(212), n = i(182), o = i(71), s = i(113)("toStringTag"), a = ["NodeList", "DOMTokenList", "MediaList", "StyleSheetList", "CSSRuleList"], l = 0; 5 > l; l++) {
        var u = a[l],
            h = r[u],
            d = h && h.prototype;
    ...
    var r = i(207),
        n = i(148),
        o = i(155);
    t.exports = i(65) ? Object.defineProperties : function(t, e) {
        n(t);
    ...
    var s = i(72),
        ...
        h = function(t) {
            function e(i) {
                r(this, e);
                var o = n(this, t.call(this, i));
                o.el = se('\n<div class="videoplayer_share_actions">\n  <div class="_donate"></div>\n  <div class="_like"></div>\n  <div class="_share"></div>\n  <div class="_bookmark"></div>\n  <div class="_add"></div>\n</div>\n    '), o._like = domByClass(o.el, "_like"), o._share = domByClass(o.el, "_share"), o._add = domByClass(o.el, "_add"), o._donate = domByClass(o.el, "_donate"), o._bookmark = domByClass(o.el, "_bookmark"), o.domListen(o._like, "click", function(t) {
                    ...
                    toDown: !0,
                    hideDelay: 200
                }), o.domListen(o._bookmark, "click", function() {
                    o.player.bookmark(s())
                }), o.attachTooltip({
                    el: o._bookmark,
                    text: function() {
                        return o.getLang(o.player.videoBookmarked ? "delete_bookmark" : "add_bookmark")
                    },
                    toDown: !0,
                    hideDelay: 200
                });
                ...
                return i.on(a.VIDEO_LIKE, function(t) {
                    ...
                    o.setAdded(t)
                }).on(a.VIDEO_BOOKMARK, function(t) {
                    o.setBookmarked(t)
                }), o
            }
            return o(e, t), e.prototype.initVideo = function(t) {
    ...
    i(152), i(140), i(109), i(183), t.exports = i(122).Promise
}, function(t, e, i) {
    "use strict";
    ...
    var r = i(171),
        n = i(69).concat("length", "prototype");
    ...
    var r, n, o, s = i(217),
        ...
        L = !! function() {
            try {
                var t = E.resolve(1),
                    e = (t.constructor = {})[i(113)("species")] = function(t) {
                        t(S, S)
                    };
                ...
                g(function() {
                    for (var r = t._v, n = 1 == t._s, o = 0, s = function(e) {
                            var i, o, s = n ? e.ok : e.fail,
                                ...
                                u = e.domain;
                            try {
                                s ? (n || (2 == t._h && R(t), t._h = 1), s === !0 ? i = r : (u && u.enter(), i = s(r), u && u.exit()), i === e.promise ? l(_("Promise-chain cycle")) : (o = k(i)) ? o.call(i, a, l) : a(i)) : l(r)
                            } catch (h) {
                                l(h)
                            }
                        }; i.length > o;) s(i[o++]);
    ...
    L || (E = function(t) {
        ...
        Promise: E
    }), i(176)(E, m), i(94)(m), o = i(122)[m], h(h.S + h.F * !L, m, {
        reject: function(t) {
            var e = T(this),
                i = e.reject;
            ...
            function u(t, e, i) {
                ...
                return function(o, s) {
                    ...
                    for (i.method = o, i.arg = s;;) {
                        ...
                        var u = r(t, e, i);
                        if ("normal" === u.type) {
                            if (n = i.done ? C : k, u.arg === P) continue;
                            return {
                                value: u.arg,
                                done: i.done
                            }
    ...
    var r = i(187),
        n = i(113)("iterator"),
        o = i(71);
    t.exports = i(122).getIteratorMethod = function(t) {
    ...
    e.f = i(65) ? Object.defineProperty : function(t, e, i) {
    ...
    var b = 1,
        E = function() {
            ...
            return t.prototype.initVideo = function(t) {
                var e = this;
                t = clone(t, !0), this.vars = t, this.changeState(s.UNSTARTED, !0), this.videoLiked = t.liked, this.videoAdded = t.added, this.isSubscribed = t.is_subscribed, this._livePhase = t.live, this.videoBookmarked = t.bookmarked, this.trigger(a._INIT_VIDEO, t), t.from_autoplay && this.toggleMute(!0, !1), this.isActiveLive() && this.startLiveHeartbeat(), t.show_suggestions && this.loadSuggestions(), (window.requestAnimationFrame || window.setTimeout)(function() {
                ...
                this.videoBookmarked = !this.videoBookmarked, this.trigger(a.VIDEO_BOOKMARK, this.videoBookmarked)
                ...
                this.deinitVideo(), this.trigger(a._DESTROY), this._events.removeAllListeners(), window.removeEventListener("resize", this._resizeHandler),
                    f.screenfull && document.removeEventListener(f.screenfull.raw.fullscreenchange, this._fsChangeHandler)
                ...
                if (t.hls_raw && !w[i]) {
                    ...
                    if (n.length) {
                        var b = Math.min.apply(Math, n),
                            ...
                            A = o[L],
                            k = A.replace(/index-(.+).m3u8/, "seg-1-$1.ts");
                        Object(g["default"])(A), Object(g["default"])(k), w[i] = L
                    }
                }
