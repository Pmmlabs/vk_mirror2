! function(t) {
    ...
    i(121), i(45), t.exports = i(74).Symbol
}, function(t, e) {
    var i;
    i = function() {
        return this
    ...
    var h = function(t) {
        function e(i) {
            ...
            return n.trackEvents = new u.default(i), n.playerListen(o.MEDIA_TIMEUPDATE, n.onMediaTimeupdate), n.playerListen(o.MEDIA_PLAYING, n.onMediaPlaying), n.playerListen(o.MEDIA_WAITING, n.onMediaWaiting), n.playerListen(o.MEDIA_SEEKING, n.onMediaSeeking), n.playerListen(o.MEDIA_SEEKED, n.onMediaSeeked), n.playerListen(o.MEDIA_ENDED, n.onMediaEnded), n.playerListen(o.MEDIA_VOLUMECHANGE, n.onMediaVolumeChange), n.playerListen(o.MEDIA_HLS_LEVEL_LOADED, n.onMediaHlsLevelLoaded), n.playerListen(o.MEDIA_HLS_FRAG_LOADED, n.onMediaHlsFragLoaded), n.playerListen(o.FULLSCREEN_CHANGE, n.onFullscreenChange), n.playerListen(o.QUALITY_CHANGE, n.onQualityChange), n.playerListen(o.STATE_CHANGE, n.onStateChange), n.playerListen(o.ADS_LINEAR_STARTED, n.onLinearAdStarted), n.playerListen(o.ADS_LINEAR_COMPLETED, n.onLinearAdCompleted), n.playerListen(o.UI_STICKERS_PROMO_EVENT, n.onUiStickersPromoEvent), window.ns_ || n.loadComScoreLib(), n
        }
        return function(t, e) {
            if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function, not " + typeof e);
            t.prototype = Object.create(e && e.prototype, {
            ...
            if (this.getVar("vsegs_size")) {
                ...
                for (var o = 0; o < t.length; ++o)
                    for (var s = Math.round(t.start(o)), a = Math.round(t.end(o)), l = Math.floor(s / e), u = Math.floor(a / e), h = l; h <= u; ++h) {
                        var c = e * h,
                            d = Math.min(this.getVar("duration"), c + e);
                        n[h] += (Math.min(d, a) - Math.max(c, s)) / (d - c)
                    }
    ...
    var n = i(104),
        ...
        o = i(14),
        s = {};
    i(136)(s, i(99)("iterator"), function() {
        return this
    }), t.exports = function(t, e, i) {
        t.prototype = n(s, {
            next: r(1, i)
    ...
    t.exports = function(t, e, i, y, v, g, _) {
        ...
        var m, b, S, E = function(t) {
            ...
            I = "Array" == e && k.entries || A;
        if (I && (S = c(I.call(new t))) !== Object.prototype && (h(S, w, !0), n || a(S, d) || s(S, d, f)), L && A && "values" !== A.name && (T = !0, C = function() {
                return A.call(this)
            }), n && !_ || !p && !T && k[d] || s(k, d, C), l[e] = C, l[w] = f, v)
            if (m = {
                    values: L ? C : E("values"),
                    keys: g ? C : E("keys"),
                    entries: P
    ...
    var n = i(47),
        ...
        o = i(120),
        s = i(10);
    t.exports = i(23)(Array, "Array", function(t, e) {
    ...
    i.r(e), i.d(e, "_INIT_VIDEO", function() {
        ...
        return Q
    }), i.d(e, "UI_ACTION_BUTTON_CLICKED", function() {
        return W
    ...
    var n = "_initVideo",
        ...
        N = "media.liveWarning",
        B = "media.hlsLevelLoaded",
        F = "media.hlsFragLoaded",
        H = "ui.seekstart",
        U = "ui.seekend",
        j = "ui.controlsHide",
        G = "ui.controlsShow",
        ...
        W = "ui.actionButtonClicked",
        q = "ads.waiting",
        K = "ads.timeRemained",
        Y = "ads.linearStarted",
        X = "ads.linearCompleted",
        J = "ads.overlayStarted",
        $ = "ads.overlayCompleted"
}, function(t, e, i) {
    "use strict";
    i.r(e);
    var n = i(26),
    ...
    var u = function(t) {
        ...
        return function(t, e) {
            ...
            if (this.player.trigger(n.QUALITIES_LIST_CHANGE, i), !this.manifestLoaded && i.length) {
                this.manifestLoaded = !0;
                var o = this.player.preferredQuality,
                    a = s.default.getPref("abr_disabled") && !this.player.isFromAutoplay() || this.getVar("hd_def") >= 0;
                if (!a) {
                    var u = this.player.getPreloadedQuality(),
                        h = s.default.getPref("abr_quality");
                    o = u || h || o, this.getVar("is_inline") && (o = Math.min(o, r.INLINE_INITIAL))
                }
                var c = Math.max.apply(Math, l(i));
                o = Math.min(o, c);
                var d = this.getLevelIndexForQuality(o);
                this.hls.startLevel = d, a && this.setCurrentLevel(d), this.player.onQualityChanged(o), this.getVar("live") && this.hls.levels.length > 1 && this.capLiveLevels(), this.needLoad && this.load(), a || this.player.isActiveLive() || this.forceNextLevel(d)
            }
            ...
            this.player.trigger(n.SUBTITLES_LIST_CHANGED, i)
            ...
            var i = this,
                ...
                s = null;
            if (-1 !== r) {
                this.el.textTracks[r].mode = "hidden", this.el.textTracks[r].oncuechange = function(t) {
                    i.player.trigger(n.SUBTITLE_CUE_CHANGE, t.target.activeCues)
                };
                var a = !0,
                    l = !1,
                    u = void 0;
                try {
                    for (var h, c = o[Symbol.iterator](); !(a = (h = c.next()).done); a = !0) {
                        var d = h.value;
                        if (r === d.id) {
                            s = d;
                            break
            ...
            this.player.trigger(n.SUBTITLE_TRACK_CHANGED, o, s)
    ...
    i(25);
    for (var n = i(70), r = i(136), o = i(120), s = i(99)("toStringTag"), a = ["NodeList", "DOMTokenList", "MediaList", "StyleSheetList", "CSSRuleList"], l = 0; l < 5; l++) {
        var u = a[l],
            h = n[u],
            c = h && h.prototype;
    ...
    var a = function(t) {
        function e(i) {
            ...
            return n.playerListen(r.SUBTITLE_TRACK_CHANGED, n._onSubtitleTrackChanged), n.playerListen(r.UI_ACTION_BUTTON_CLICKED, n._onActionButtonClicked), n
        }
        return function(t, e) {
            if ("function" != typeof e && null !== e) throw new TypeError("Super expression must either be null or a function, not " + typeof e);
            t.prototype = Object.create(e && e.prototype, {
            ...
            var a = this._getFromStorage();
            a.push(o), this._saveToStorage(a);
            var l = function() {
                i._sendEvents(a), i._saveToStorage([])
            };
            clearTimeout(this._flushTimeout), a.length >= 50 ? l() : this._flushTimeout = setTimeout(l, 500)
            ...
            t.length ? o.default.set(this._storageKey, {
                events: t,
                updated: Date.now()
            }) : o.default.remove(this._storageKey)
        }, e.prototype._getFromStorage = function() {
            var t = o.default.get(this._storageKey);
            return t ? t.events : []
        }, e.prototype._flushStorageEvents = function() {
            var t = this,
                e = o.default.getByPrefix("videoplayer_track_events");
            each(e, function(e, i) {
                i.updated + 5e3 < Date.now() && (t._sendEvents(i.events, i.hash), o.default.remove(e))
            })
        }, e
    }(n.default);
    e.default = a
    ...
    var n = i(81),
        r = i(8),
        o = i(116);
    t.exports = i(60) ? Object.defineProperties : function(t, e) {
        r(t);
    ...
    var v = function(t) {
        ...
        return function(t, e) {
            ...
            this.el = se('\n<div class="videoplayer_controls">\n  <div class="videoplayer_controls_item videoplayer_btn videoplayer_btn_play" role="button" tabindex="0" aria-label="' + this.getLang("play") + '">\n    ' + c.play("videoplayer_btn_icon videoplayer_play_icon") + '\n  </div>\n  <div class="videoplayer_controls_item videoplayer_btn videoplayer_btn_next" role="button" tabindex="0" aria-label="' + this.getLang("next") + '">\n    <div class="videoplayer_btn_icon videoplayer_next_icon"></div>\n  </div>\n  <div class="videoplayer_controls_item videoplayer_live" style="display:none;">\n    ' + c.live("videoplayer_btn_icon videoplayer_live_icon") + '\n  </div>\n  <div class="videoplayer_controls_item videoplayer_live_app" style="display:none;">\n    <a href="//vk.cc/liveapp" target="_blank" class="videoplayer_live_app_link">' + this.getLang("live_download_app") + '</a>\n  </div>\n  <div class="videoplayer_controls_item videoplayer_timeline"></div>\n  <div class="videoplayer_controls_item videoplayer_time">\n    <span class="_time_current"></span><span class="_time_duration"></span>\n  </div>\n  <div class="videoplayer_controls_item videoplayer_btn videoplayer_btn_mute" role="button" tabindex="0" aria-label="' + this.getLang("volume_off") + '">\n    ' + c.volume("videoplayer_btn_icon videoplayer_volume_icon") + '\n  </div>\n  <div class="videoplayer_controls_item videoplayer_volume"></div>\n  <div class="videoplayer_controls_item videoplayer_btn videoplayer_btn_expand" style="display:none;" role="button" tabindex="0" aria-label="' + this.getLang("expand") + '">\n    ' + c.expand("videoplayer_btn_icon videoplayer_expand_icon") + '\n  </div>\n  <div class="videoplayer_controls_item videoplayer_btn videoplayer_btn_subtitles" role="button" tabindex="0" aria-haspopup="true" aria-label="' + this.getLang("enable_subtitles") + '">\n    <div class="videoplayer_btn_icon videoplayer_subtitles_icon"></div>\n  </div>\n  <div class="videoplayer_controls_item videoplayer_btn videoplayer_btn_settings" role="button" tabindex="0" aria-haspopup="true" aria-label="' + this.getLang("aria_open_settings") + '">\n    <div class="videoplayer_btn_icon videoplayer_settings_icon"></div>\n  </div>\n  <div class="videoplayer_controls_item videoplayer_btn videoplayer_btn_fullscreen" role="button" tabindex="0" aria-label="' + this.getLang("aria_enter_fullscreen") + '">\n    ' + c.fullscreen("videoplayer_btn_icon videoplayer_fullscreen_icon") + '\n  </div>\n  \x3c!--<div class="videoplayer_controls_item videoplayer_quality" role="button" tabindex="0" aria-haspopup="true" aria-label="' + this.getLang("hdsd") + '"></div>--\x3e\n  <a class="videoplayer_controls_item videoplayer_btn videoplayer_btn_vk" style="display:none;" target="_blank" aria-label="' + this.getLang("goto_orig_video") + '">\n    ' + c.vk("videoplayer_btn_icon videoplayer_vk_icon") + "\n  </a>\n</div>\n    "), this.btnSettings = domByClass(this.el, "videoplayer_btn_settings"), this.btnSubtitles = domByClass(this.el, "videoplayer_btn_subtitles"), this.btnPlay = domByClass(this.el, "videoplayer_btn_play"), this.btnNext = domByClass(this.el, "videoplayer_btn_next"), this.btnMute = domByClass(this.el, "videoplayer_btn_mute"), this.btnMuteIcon = domByClass(this.el, "videoplayer_volume_icon"), this.btnExpand = domByClass(this.el, "videoplayer_btn_expand"), this.btnFullscreen = domByClass(this.el, "videoplayer_btn_fullscreen"), this.btnLogo = domByClass(this.el, "videoplayer_btn_vk"), this.liveLabel = domByClass(this.el, "videoplayer_live"), this.liveApp = domByClass(this.el, "videoplayer_live_app"), this.liveAppLink = domByClass(this.el, "videoplayer_live_app_link"), this.timeLabel = domByClass(this.el, "videoplayer_time"), this.timeLabelCurrent = domByClass(this.timeLabel, "_time_current"), this.timeLabelDuration = domByClass(this.timeLabel, "_time_duration"), this.timelineContainer = domByClass(this.el, "videoplayer_timeline"), this.volumeContainer = domByClass(this.el, "videoplayer_volume"), this.domListen(this.btnPlay, "click", function() {
                ...
                offsetY: -4
            }), d.screenfull.enabled || this.toggleControl(this.btnFullscreen, !1)
            ...
            switch (t) {
                ...
                case "timeline":
                    return (!e.live || this.player.getLivePhase() == s.ENDED) && !e.ads_snippet_video || e.force_timeline;
                case "time_label":
                ...
                case "fullscreen":
                    return !!d.screenfull.enabled && !e.app_promo && !e.ads_snippet_video;
                case "settings":
    ...
    var v = function(t) {
        ...
        return function(t, e) {
            ...
            if (t.t) {
                var e = d.default.fromString(t.t);
            ...
            return this.provider instanceof h.default ? "hls" : this.provider instanceof c.default ? "flash" : this.provider instanceof u.default ? "base" : this.chooseProvider()
            ...
            var n = void 0,
                a = void 0;
            e && this.player.isHlsSupported() ? (n = new h.default(this.player), a = e) : i && this.getVar("can_play_mp4") ? (n = new u.default(this.player), a = i) : i && this.player.isFlashSupported() && (n = new c.default(this.player), a = i), n && a ? (this.player.changeLivePhase(s.ENDED), this.player.changeState(r.ENDED), this.attachProvider(n), n.src = a, n.volume = this.getInitialVolume(), !this.player.isStartedPlaying() && this.getVar("autoplay") && this.player.play()) : (this.player.trigger(o.MEDIA_ERROR, {
    ...
    var E = function(t) {
        function e(i) {
            ...
            }), n.el.appendChild(n.thumb), n.controls = new u.default(i), n.el.appendChild(n.controls.el), n.shareActions = new h.default(i), n.el.appendChild(n.shareActions.el), n.contextMenu = new c.default(i), n.el.appendChild(n.contextMenu.el), n.playerTooltip = new y.default(i), n.el.appendChild(n.playerTooltip.el), n.actionButton = new m.default(n.player), n.el.appendChild(n.actionButton.el), n.autoplayTimer = ce("div", {
        ...
        return function(t, e) {
            ...
            if (this.updateTitle(t.md_title), toggleClass(this.titleLink, "_right_offset", !t.nolikes), toggleClass(this.titleLink, "_clickable", !!t.is_embed), t.live && this.onLivePhaseChange(t.live), t.stickers_promo && this.buildStickersPromo.apply(this, S(t.stickers_promo.split("|"))), this._mouseInside = isHover(this.el), this._lastUserActivity = Date.now(), this.updateWaiting(), this.player.isAutoplay()) {
            ...
            var t, e = !!this.endScreen && (t = this.endScreen).isStretchMode.apply(t, S(this.player.getSize()));
    ...
    t.exports = i(70).document && document.documentElement
}, function(t, e, i) {
    var n = i(99)("iterator"),
        r = !1;
    try {
    ...
    var o = function(t) {
        function e(i) {
            ...
            return n.el = se('\n<a class="videoplayer_action_button" target="_blank" href=""></a>\n    '), hide(n.el), n.playerListen(r.UI_CONTROLS_HIDE, n._updateMargins), n.playerListen(r.UI_CONTROLS_SHOW, n._updateMargins), n.domListen(n.el, "click", function() {
                n._onLinkOpened()
            }), n
        }
        return function(t, e) {
            ...
            this.player.trigger(r.UI_ACTION_BUTTON_CLICKED), hasClass(this.el, "_opened") || (addClass(this.el, "_opened"), this.attachTooltip())
        }, e.prototype._onMouseEnter = function() {
    ...
    var _ = function() {
        ...
        return t.prototype.initVideo = function(t) {
            ...
            return t && (e += "?t=" + d.default.toString(this.curTime())), e
            ...
            var t = this.vars.list_id,
                e = d.default.toString(this.curTime());
            ...
            c.screenfull && (this.isFullscreen() ? c.screenfull.exit() : c.screenfull.request(this.el))
        }, t.prototype.isFullscreen = function() {
            return c.screenfull.element === this.el
            ...
            this.deinitVideo(), this.trigger(r._DESTROY), this._events.removeAllListeners(), window.removeEventListener("resize", this._resizeHandler), c.screenfull && document.removeEventListener(c.screenfull.raw.fullscreenchange, this._fsChangeHandler)
    ...
    e.f = i(60) ? Object.defineProperty : function(t, e, i) {
    ...
    var n, r, o, s = i(61),
        ...
        w = !! function() {
            try {
                var t = b.resolve(1),
                    e = (t.constructor = {})[i(99)("species")] = function(t) {
                        t(E, E)
                    };
                ...
                g(function() {
                    for (var n = t._v, r = 1 == t._s, o = 0, s = function(e) {
                            var i, o, s = r ? e.ok : e.fail,
                                ...
                                u = e.domain;
                            try {
                                s ? (r || (2 == t._h && x(t), t._h = 1), !0 === s ? i = n : (u && u.enter(), i = s(n), u && u.exit()), i === e.promise ? l(_("Promise-chain cycle")) : (o = T(i)) ? o.call(i, a, l) : a(i)) : l(n)
                            } catch (t) {
                                l(t)
                            }
                        }; i.length > o;) s(i[o++]);
    ...
    w || (b = function(t) {
        ...
        Promise: b
    }), i(14)(b, "Promise"), i(122)("Promise"), o = i(74).Promise, h(h.S + h.F * !w, "Promise", {
        reject: function(t) {
            var e = k(this);
    ...
    t.exports = {
        set: Object.setPrototypeOf || ("__proto__" in {} ? function(t, e, n) {
            try {
                (n = i(125)(Function.call, i(112).f(Object.prototype, "__proto__").set, 2))(t, []), e = !(t instanceof Array)
            } catch (t) {
                e = !0
            }
            return function(t, i) {
    ...
    var n = i(75),
        r = i(99)("iterator"),
        o = i(120);
    t.exports = i(74).getIteratorMethod = function(t) {
    ...
    var n = i(8),
        ...
        l = function() {
            var t, e = i(16)("iframe"),
                n = o.length;
            for (e.style.display = "none", i(64).appendChild(e), e.src = "javascript:", (t = e.contentWindow.document).open(), t.write("<script>document.F=Object<\/script>"), t.close(), l = t.F; n--;) delete l.prototype[o[n]];
            return l()
        };
    ...
    i(45), i(135), i(29), i(96), t.exports = i(74).Promise
}, , function(t, e, i) {
    var n = i(51),
        r = i(54),
        o = i(128)("IE_PROTO"),
    ...
    var n = i(70),
        ...
        G = F && "symbol" == typeof P.iterator ? function(t) {
    ...
    F || (l((P = function() {
        ...
        return this._k
    }), L.f = q, T.f = z, i(131).f = w.f = K, i(40).f = W, i(117).f = Y, s && !i(61) && l(B, "propertyIsEnumerable", W, !0)), a(a.G + a.W + a.F * !F, {
        Symbol: P
    });
    ...
    H && H.prototype && H.prototype.findChild || (x = !0), a(a.S + a.F * !F, "Symbol", {
        for: function(t) {
    ...
    }), P.prototype[M] || i(136)(P.prototype, M, P.prototype.valueOf), d(P, "Symbol"), d(Math, "Math", !0), d(n.JSON, "JSON", !0)
}, function(t, e, i) {
    "use strict";
    var n = i(70),
        r = i(74),
    ...
    var n = i(130),
        r = i(119).concat("length", "prototype");
