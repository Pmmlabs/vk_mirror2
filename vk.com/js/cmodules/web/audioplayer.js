! function(t) {
    ...
    102: function(__webpack_module__, __webpack_exports__, __webpack_require__) {
        "use strict";
    ...
    23: function(__webpack_module__, __webpack_exports__, __webpack_require__) {
        ...
        __webpack_require__.r(__webpack_exports__);
        var _audioplayer_audio_unmask_source__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(18),
            _audioplayer_audio_layer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(102),
        ...
        window.AudioLayer = _audioplayer_audio_layer__WEBPACK_IMPORTED_MODULE_1__["default"], window.AudioUtils = {
            ...
            showAudioPlaylist: function(t, e, i, o, a, s) {
                return cur.apLayer ? cancelEvent(a) : vk.widget ? !0 : (boxRefreshCoords(boxLoader), show(boxLoader), show(boxLayerWrap), stManager.add(["auto_list.js", "audio.css"], function() {
                    ...
                    function r(r, l) {
                        ...
                        })), setStyle(h, {}), boxRefreshCoords(cur.apLayer), getAudioPlayer().updateCurrentPlaying(), layers.fullhide = a, cur.apLayerPlaylistId = [t, e], s && s(), cur.articleLayer && cur.articleLayer.audioPlaylistOpened()
                    }
            ...
            getContextPlaylist: function(t, e) {
                ...
                var o, a = getAudioPlayer(),
                    ...
                    A = window.traverseParent || function(t, e) {
                ...
                if (E) {
                    ...
                    I && u.mergeWith({
                        accessHash: I
                    }), h && h.getPageCurrentPlaylist() == u && h.getSortedList() ? u.initSortedList(h.getSortedList()) : s.isFromCurrentPlaylist || (u.removeSortedList(), u.shuffle(0))
                } else if (h && h.getPageCurrentPlaylist()) u = h.getPageCurrentPlaylist();
                else if ("module" == g) {
                    var T = P;
                    u = a.getPlaylist(AudioPlaylist.TYPE_PLAYLIST, T || cur.oid || vk.id, AudioPlaylist.DEFAULT_PLAYLIST_ID), l = [r]
                    ...
                    o = hashCode(S + "_" + w), "wall" == cur.module && val(C) && (w = val(C)), L && (p = {
                        postId: L,
                        wallQuery: w,
                        wallType: S
                    });
                    var U = 0 === s.context.indexOf("reply");
                    U && (l = i([gpeByClass("_replies_list", t)]), o = "reply" + o), l = l.concat(i([r]))
        ...
        AudioPlaylist.prototype.isFullyLoadable = function() {
            ...
            AudioUtils.debugLog("Implementation init"),
                AudioUtils.debugLog("param browser.flash", browser.flash), AudioUtils.debugLog("param force HTML5", !!t), browser.safari && parseInt(browser.version) >= 11 ? this._impl = new AudioPlayerHTML5Simple(s) : t ? this._impl = new AudioPlayerHTML5(s) : AudioPlayerHTML5WebAudio.isSupported() ? (this._impl = new AudioPlayerHTML5WebAudio(s), this._impl.failed && (this._impl = new AudioPlayerHTML5(s))) : AudioPlayerHTML5.isSupported() ? this._impl = new AudioPlayerHTML5(s) : browser.flash && (this._impl = new AudioPlayerFlash(s)), this._implSetVolume(0)
            ...
            if (l && n) {
                var d;
                d = geByClass("_audio_pl_" + n.getOwnerId() + "_" + n.getPlaylistId()), d && each(d, function() {
            ...
            this._adman && (this._isPlaying = !0,
                this._adman.resume(), this.notify(AudioPlayer.EVENT_PLAY))
            ...
            return this.opts.onBufferUpdate && addEvent(i, "progress", function() {
                ...
                t && (cur.audioLoadTimings = cur.audioLoadTimings || [], cur.audioLoadTimings.push(vkNow() - t), data(i, "setUrlTime", 0)), o._prefetchAudioEl == i, o._currentAudioEl == i && (o.opts.onCanPlay && o.opts.onCanPlay(), data(i, "canplay", !0))
