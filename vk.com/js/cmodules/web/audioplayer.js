! function(t) {
    ...
    var _lib_debug_tools__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(414);
    ...
    i(341)(c, s), c.prototype._update = function(t) {
        var e, i;
        this._cache.add(t);
    ...
    e.pbkdf2 = i(390), e.pbkdf2Sync = i(206)
}, function(t, e, i) {
    "use strict";
    ...
    var indexOf = __webpack_require__(358),
    ...
    i(341)(a, n), a.prototype.update = function(t, e, i) {
    ...
    var _utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(347),
        _playlist_loadAllPlaylistAudios__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(10);
    ...
    var r = e;
    r.utils = i(29), r.common = i(299), r.sha = i(402), r.ripemd = i(317), r.hmac = i(176), r.sha1 = r.sha.sha1, r.sha256 = r.sha.sha256, r.sha224 = r.sha.sha224, r.sha384 = r.sha.sha384, r.sha512 = r.sha.sha512, r.ripemd160 = r.ripemd.ripemd160
}, function(t, e, i) {
    "use strict";
    ...
    i(341)(o, n), o.prototype._transform = function(t, e, i) {
        var r = null;
        try {
            this.update(t, e)
        } catch (t) {
    ...
    (function(e, r, n) {
        ...
        function g(t) {
            if (s = s || i(26), !(p.call(g, this) || this instanceof s)) return new g(t);
    ...
    }).call(this, i(172), i(380).setImmediate, i(132))
}, function(t, e) {}, , , function(t, e, i) {
    "use strict";
    var r = i(310),
        n = i(341),
    ...
    r.inherits(v, b), t.exports = v, v.blockSize = 1024, v.outSize = 512, v.hmacStrength = 192, v.padLength = 128, v.prototype._prepareBlock = function(t, e) {
        ...
        for (var L = 0; L < i.length; L += 2) {
            ...
            var W = f(U, x, R, N),
                X = l(U, x, R, N);
            D = C, O = k, C = v, k = M, v = b, M = g, b = f(h, p, Y, z), g = l(p, p, Y, z), h = u, p = d, u = a, d = s, a = r, s = n, r = f(Y, z, W, X), n = l(Y, z, W, X)
        }
    ...
    (function(r, n) {
        ...
        (function() {
            ...
            function V(t, e, i, r) {
                ...
                e._state !== M || (d && s ? U(e, n) : u ? N(e, o) : t === C ? R(e, n) : t === k && N(e, n))
            }
            var q = function(t) {
    ...
    r(u, n), u.prototype.init = function() {
        ...
        for (; M < 160; M += 2) {
            var C = e[M - 30],
                ...
                j = O + R | 0,
                F = D + x + b(j, O) | 0;
            F = (F = F + L + b(j = j + U | 0, U) | 0) + N + b(j = j + B | 0, B) | 0, e[M] = F, e[M + 1] = j
        }
    ...
    "use strict";
    var r = e;
    r.base = i(241), r.short = i(398), r.mont = i(138), r.edwards = i(311)
}, , function(t, e, i) {
    var r = e;
    r.Reporter = i(143).Reporter, r.DecoderBuffer = i(372).DecoderBuffer, r.EncoderBuffer = i(372).EncoderBuffer, r.Node = i(391)
}, , , function(t, e, i) {
    "use strict";
    ...
    e.publicEncrypt = i(92), e.privateDecrypt = i(388), e.privateEncrypt = function(t, i) {
    ...
    (function(t) {
        ! function(t, e) {
            ...
            var h = function(t, e, i) {
                ...
                var yt = (d + (r = Math.imul(f, H)) | 0) + ((8191 & (n = (n = Math.imul(f, V)) + Math.imul(l, H) | 0)) << 13) | 0;
                d = ((o = Math.imul(l, V)) + (n >>> 13) | 0) + (yt >>> 26) | 0, yt &= 67108863, r = Math.imul(p, H), n = (n = Math.imul(p, V)) + Math.imul(_, H) | 0, o = Math.imul(_, V);
                var bt = (d + (r = r + Math.imul(f, Y) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(f, z) | 0) + Math.imul(l, Y) | 0)) << 13) | 0;
                d = ((o = o + Math.imul(l, z) | 0) + (n >>> 13) | 0) + (bt >>> 26) | 0, bt &= 67108863, r = Math.imul(b, H), n = (n = Math.imul(b, V)) + Math.imul(g, H) | 0, o = Math.imul(g, V), r = r + Math.imul(p, Y) | 0, n = (n = n + Math.imul(p, z) | 0) + Math.imul(_, Y) | 0, o = o + Math.imul(_, z) | 0;
                var gt = (d + (r = r + Math.imul(f, X) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(f, K) | 0) + Math.imul(l, X) | 0)) << 13) | 0;
                d = ((o = o + Math.imul(l, K) | 0) + (n >>> 13) | 0) + (gt >>> 26) | 0, gt &= 67108863, r = Math.imul(m, H), n = (n = Math.imul(m, V)) + Math.imul(A, H) | 0, o = Math.imul(A, V), r = r + Math.imul(b, Y) | 0, n = (n = n + Math.imul(b, z) | 0) + Math.imul(g, Y) | 0, o = o + Math.imul(g, z) | 0, r = r + Math.imul(p, X) | 0, n = (n = n + Math.imul(p, K) | 0) + Math.imul(_, X) | 0, o = o + Math.imul(_, K) | 0;
                var vt = (d + (r = r + Math.imul(f, Z) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(f, J) | 0) + Math.imul(l, Z) | 0)) << 13) | 0;
                d = ((o = o + Math.imul(l, J) | 0) + (n >>> 13) | 0) + (vt >>> 26) | 0, vt &= 67108863, r = Math.imul(E, H), n = (n = Math.imul(E, V)) + Math.imul(P, H) | 0, o = Math.imul(P, V), r = r + Math.imul(m, Y) | 0, n = (n = n + Math.imul(m, z) | 0) + Math.imul(A, Y) | 0, o = o + Math.imul(A, z) | 0, r = r + Math.imul(b, X) | 0, n = (n = n + Math.imul(b, K) | 0) + Math.imul(g, X) | 0, o = o + Math.imul(g, K) | 0, r = r + Math.imul(p, Z) | 0, n = (n = n + Math.imul(p, J) | 0) + Math.imul(_, Z) | 0, o = o + Math.imul(_, J) | 0;
                ...
                d = ((o = o + Math.imul(L, _t) | 0) + (n >>> 13) | 0) + (Ot >>> 26) | 0, Ot &= 67108863, r = Math.imul(B, ft), n = (n = Math.imul(B, lt)) + Math.imul(j, ft) | 0, o = Math.imul(j, lt);
                ...
                return d = ((o = Math.imul(j, _t)) + (n >>> 13) | 0) + (Ut >>> 26) | 0, Ut &= 67108863, u[0] = yt, u[1] = bt, u[2] = gt, u[3] = vt, u[4] = mt, u[5] = At, u[6] = wt, u[7] = Et, u[8] = Pt, u[9] = St, u[10] = It, u[11] = Tt, u[12] = Mt, u[13] = Ct, u[14] = kt, u[15] = Dt, u[16] = Ot, u[17] = Lt, u[18] = Ut, 0 !== d && (u[19] = d, i.length++), i
            };
    ...
    "use strict";
    e.randomBytes = e.rng = e.pseudoRandomBytes = e.prng = i(9), e.createHash = e.Hash = i(356), e.createHmac = e.Hmac = i(232);
    var r = i(345),
        n = Object.keys(r),
    ...
    var d = i(30);
    e.createSign = d.createSign, e.Sign = d.Sign, e.createVerify = d.createVerify, e.Verify = d.Verify, e.createECDH = i(16);
    var c = i(212);
    ...
    i(341)(a, o), a.prototype._update = function(t) {
    ...
    n.inherits = i(341), n.inherits(o, r), o.prototype._transform = function(t, e, i) {
        i(null, t)
    }
}, function(t, e) {
    var i = {}.toString;
    ...
    t.exports = n;
    var r = i(274).EventEmitter;

    function n() {
        r.call(this)
    }
    i(341)(n, r), n.Readable = i(298), n.Writable = i(114), n.Duplex = i(201), n.Transform = i(404), n.PassThrough = i(220), n.Stream = n, n.prototype.pipe = function(t, e) {
        var i = this;
    ...
    (e = t.exports = i(403)).Stream = e, e.Readable = e, e.Writable = i(133), e.Duplex = i(26), e.Transform = i(321), e.PassThrough = i(271)
}, function(t, e, i) {
    "use strict";
    var r = i(29),
        n = i(310);
    ...
    var r = e;
    r.bignum = i(226), r.define = i(63).define, r.base = i(191), r.constants = i(161), r.decoders = i(293), r.encoders = i(397)
}, function(t, e, i) {
    "use strict";
    ...
    "use strict";
    var r = e;
    r.version = i(209).version, r.utils = i(139), r.rand = i(23), r.curve = i(189), r.curves = i(343), r.ec = i(186), r.eddsa = i(124)
}, function(t, e, i) {
    "use strict";
    ...
    n.inherits = i(341), n.inherits(o, r), o.prototype.push = function(t, e) {
    ...
    "use strict";
    e.utils = i(243), e.Cipher = i(185), e.DES = i(137), e.CBC = i(424), e.EDE = i(173)
}, , function(t, e) {
    ...
    (function(t) {
        ...
        }, i(207), e.setImmediate = "undefined" != typeof self && self.setImmediate || void 0 !== t && t.setImmediate || this && this.setImmediate, e.clearImmediate = "undefined" != typeof self && self.clearImmediate || void 0 !== t && t.clearImmediate || this && this.clearImmediate
    }).call(this, i(132))
}, , function(t, e, i) {
    "use strict";
    ...
    var r = i(191).Reporter,
        n = i(191).EncoderBuffer,
        o = i(191).DecoderBuffer,
        a = i(310),
    ...
    "use strict";
    e.sha1 = i(15), e.sha224 = i(336), e.sha256 = i(111), e.sha384 = i(198), e.sha512 = i(182)
}, function(t, e, i) {
    "use strict";
    (function(e, r) {
        var n = i(257);
        ...
        Object.defineProperty(v.prototype, "destroyed", {
            ...
            return p || (p = i(40).StringDecoder), this._readableState.decoder = new p(t), this._readableState.encoding = t, this
        };
        var w = 8388608;
        ...
        v.prototype.read = function(t) {
            ...
            function _(e) {
                h("ondata"), p = !1, !1 !== t.write(e) || p || ((1 === o.pipesCount && o.pipes === t || o.pipesCount > 1 && -1 !== U(o.pipes, t)) && !l && (h("false write response, pause", i._readableState.awaitDrain), i._readableState.awaitDrain++, p = !0), i.pause())
            }
    ...
    (e = t.exports = function(t) {
        ...
        return new i
    }).sha = i(174), e.sha1 = i(95), e.sha224 = i(354), e.sha256 = i(365), e.sha384 = i(247), e.sha512 = i(184)
}, function(t, e, i) {
    "use strict";
    ...
    window.AudioPlayer || (window.TopAudioPlayer = n.TopAudioPlayer, window.AudioPlaylist = o.AudioPlaylist, window.AudioPlayerHTML5 = u.AudioPlayerHTML5, window.AudioPlayerFlash = d.AudioPlayerFlash, window.AudioPlayer = function() {
        ...
        if (this._currentAudio = !1, this._isPlaying = !1, this._prevPlaylist = null, this._currentPlaylist = null, this._playlists = [], this.subscribers = [], this._tasks = [], this._statusExport = {}, this._currentPlayingRows = [], this._podcastsActionRef = {}, this._podcastsActionLastId = {}, this._allowPrefetchNext = !1, !vk.isBanned) {
            ...
            this.stats = new f.AudioStats(e), this._initImpl(), this._initEvents(), this._restoreVolumeState(), this._podcastCleanStates(), setTimeout(function() {
