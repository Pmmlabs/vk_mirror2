! function(t) {
    ...
    85: function(module, exports, __webpack_require__) {
        ...
        var _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(t) {
            ...
            _audio_unmask_source = __webpack_require__(86),
            _audio_layer = __webpack_require__(117),
        ...
        AudioPlaylist.prototype.isFullyLoadable = function() {
            ...
            function o() {
                ...
                if (a.withInlinePlayer && (e ? this._addRowPlayer(t, i) : this._removeRowPlayer(t)), e) {
                    ...
                    if (!n && (a.isWithCovers || a.isNumeric)) {
                        if (n = se('<canvas class="audio_row__sound_bars"></canvas>'), t.appendChild(n), n.width = AudioUtils.AUDIO_ROW_COVER_SIZE * (isRetina() ? 2 : 1), n.height = AudioUtils.AUDIO_ROW_COVER_SIZE * (isRetina() ? 2 : 1), n.style.width = AudioUtils.AUDIO_ROW_COVER_SIZE, n.style.height = AudioUtils.AUDIO_ROW_COVER_SIZE,
                            isRetina()) {
            ...
            var t = ge("player");
            if (this._checks = this._checks || 0, this._checks++,
                AudioUtils.debugLog("Flash element check", this._checks), this._checks > 10) return AudioUtils.debugLog("No Flash element found after some amount of checks"), this._player = !1, this._onReady && this._onReady(!1);
