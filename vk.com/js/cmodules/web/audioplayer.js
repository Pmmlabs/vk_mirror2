! function(t) {
    ...
    var _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(t) {
        ...
        _audio_unmask_source = __webpack_require__(1),
        _audio_layer = __webpack_require__(3),
    ...
    window.AudioLayer = _audio_layer2["default"], window.AudioUtils = {
        ...
        chooseAudioBox: function(t, e, i) {
            if (void 0 !== t.selected) cur.lastAddMedia.unchooseMedia(t.selected), t.selected = void 0, removeClass(domPN(t), "audio_selected"), t.innerHTML = e.labels.add;
                ...
                cur.chooseMedia("audio", e.owner_id + "_" + e.id, e.info), (!cur.attachCount || cur.attachCount() > o) && cur.lastAddMedia && (t.selected = cur.lastAddMedia.chosenMedias.length - 1,
                    addClass(domPN(t), "audio_selected"), t.innerHTML = e.labels.cancel)
            }
    ...
    AudioPlaylist.prototype.isFullyLoadable = function() {
        ...
        this.stop(), delete this._currentAudio, delete this._currentPlaylist, this.notify(AudioPlayer.EVENT_UPDATE),
            this.notify(AudioPlayer.EVENT_PLAYLIST_CHANGED), this.updateCurrentPlaying()
        ...
        this._freqUpdateInterval = setInterval(function() {
            var l = void 0;
            o++, o > a && (o = 0, s = r, r = [e(.7, 1), e(.55, .8), e(.3, .55), e(.03, .45)], s || (s = [e(.7, 1), e(.55, .8), e(.3, .55), e(.03, .45)])),
                l = [t(o, s[0], r[0], a), t(o, s[1], r[1], a), t(o, s[2], r[2], a), t(o, s[3], r[3], a)], i.opts.onFrequency(l)
        }, 50)
