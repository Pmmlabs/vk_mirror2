! function(t) {
    ...
    i(182)(o, n), o.prototype._transform = function(t, e, i) {
        var r = null;
        try {
            this.update(t, e)
        } catch (t) {
    ...
    (function(r, n) {
        ...
        (function() {
            ...
            function q(t, e, i, r) {
                ...
                e._state !== M || (u && s ? O(e, n) : d ? B(e, o) : t === k ? R(e, n) : t === C && B(e, n))
            }
            var V = function(t) {
            ...
            X.all = V, X.race = Y, X.resolve = I, X.reject = z, X._setScheduler = function(t) {
                d = t
    ...
    window.TopAudioPlayer = n.TopAudioPlayer, window.AudioPlaylist = o.AudioPlaylist, window.AudioPlayerHTML5 = d.AudioPlayerHTML5, window.AudioPlayerFlash = u.AudioPlayerFlash, window.AudioPlayer || (window.AudioPlayer = function() {
        var t = this;
        ...
        r.AudioUtils.debugLog("Implementation init"), r.AudioUtils.debugLog("param browser.flash", browser.flash), r.AudioUtils.debugLog("param force HTML5", !!t), t ? this._impl = new d.AudioPlayerHTML5(o) : d.AudioPlayerHTML5.isSupported() ? this._impl = new d.AudioPlayerHTML5(o) : browser.flash && (this._impl = new u.AudioPlayerFlash(o)), this._implSetVolume(0)
        ...
        function f() {
            ...
            if (n.withInlinePlayer && (e ? this._addRowPlayer(t, i) : this._removeRowPlayer(t)), e) {
                ...
                this.off(t), removeClass(t, r.AudioUtils.AUDIO_PLAYING_CLS), removeClass(t, r.AudioUtils.AUDIO_CURRENT_CLS), u(n.duration), s && attr(s, "aria-label", getLang("global_audio_play")), o && attr(o, "role", "");
                var l = data(t, "bars");
    ...
    "use strict";
    var r = e;
    r.base = i(229), r.short = i(52), r.mont = i(87), r.edwards = i(218)
}, , function(t, e, i) {
    var r = i(284).Buffer,
        n = r.alloc(16, 0);
    ...
    "use strict";
    e.randomBytes = e.rng = e.pseudoRandomBytes = e.prng = i(77), e.createHash = e.Hash = i(226), e.createHmac = e.Hmac = i(209);
    var r = i(86),
        n = Object.keys(r),
    ...
    var u = i(57);
    e.createSign = u.createSign, e.Sign = u.Sign, e.createVerify = u.createVerify, e.Verify = u.Verify, e.createECDH = i(178);
    var c = i(212);
    ...
    var r = e;
    r.utils = i(168), r.common = i(59), r.sha = i(102), r.ripemd = i(281), r.hmac = i(223), r.sha1 = r.sha.sha1, r.sha256 = r.sha.sha256, r.sha224 = r.sha.sha224, r.sha384 = r.sha.sha384, r.sha512 = r.sha.sha512, r.ripemd160 = r.ripemd.ripemd160
}, function(t, e, i) {
    var r;
    ...
    n.inherits = i(182), n.inherits(o, r), o.prototype._transform = function(t, e, i) {
        i(null, t)
    }
}, function(t, e, i) {
    "use strict";
    ...
    i(182)(a, o), a.prototype._update = function(t) {
    ...
    "use strict";
    e.sha1 = i(137), e.sha224 = i(180), e.sha256 = i(4), e.sha384 = i(1), e.sha512 = i(196)
}, function(t, e) {
    ...
    "use strict";
    e.utils = i(160), e.Cipher = i(74), e.DES = i(32), e.CBC = i(143), e.EDE = i(101)
}, function(t, e, i) {
    "use strict";
    ...
    var _utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(90),
        _playlist_loadAllPlaylistAudios__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(256);
    ...
    (function(t) {
        ! function(t, e) {
            ...
            var h = function(t, e, i) {
                ...
                u = ((o = o + Math.imul(T, _t) | 0) + (n >>> 13) | 0) + (Ct >>> 26) | 0, Ct &= 67108863, r = Math.imul(N, ot), n = (n = Math.imul(N, at)) + Math.imul(j, ot) | 0, o = Math.imul(j, at), r = r + Math.imul(x, dt) | 0, n = (n = n + Math.imul(x, ut) | 0) + Math.imul(R, dt) | 0, o = o + Math.imul(R, ut) | 0, r = r + Math.imul(U, ft) | 0, n = (n = n + Math.imul(U, lt) | 0) + Math.imul(D, ft) | 0, o = o + Math.imul(D, lt) | 0;
                var Lt = (u + (r = r + Math.imul(k, pt) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(k, _t) | 0) + Math.imul(C, pt) | 0)) << 13) | 0;
                u = ((o = o + Math.imul(C, _t) | 0) + (n >>> 13) | 0) + (Lt >>> 26) | 0, Lt &= 67108863, r = Math.imul(N, dt), n = (n = Math.imul(N, ut)) + Math.imul(j, dt) | 0, o = Math.imul(j, ut), r = r + Math.imul(x, ft) | 0, n = (n = n + Math.imul(x, lt) | 0) + Math.imul(R, ft) | 0, o = o + Math.imul(R, lt) | 0;
                ...
                return u = ((o = Math.imul(j, _t)) + (n >>> 13) | 0) + (Ot >>> 26) | 0, Ot &= 67108863, d[0] = yt, d[1] = bt, d[2] = gt, d[3] = vt, d[4] = mt, d[5] = At, d[6] = wt, d[7] = Et, d[8] = Pt, d[9] = St, d[10] = It, d[11] = Tt, d[12] = Mt, d[13] = kt, d[14] = Ct, d[15] = Lt, d[16] = Ut, d[17] = Dt, d[18] = Ot, 0 !== u && (d[19] = u, i.length++), i
            };
    ...
    var o = "data:audio/wav;base64,UklGRiQAAABXQVZFZm10IBAAAAABAAEARKwAAIhYAQACABAAZGF0YQAAAAA=",
        a = function() {
            ...
            return t.prototype.destroy = function() {}, t.prototype.getPlayedTime = function() {
                ...
                var i = this,
                    n = Object(r.audioUnmaskSource)(t),
    ...
    i(182)(c, s), c.prototype._update = function(t) {
        var e, i;
        this._cache.add(t);
    ...
    (e = t.exports = function(t) {
        ...
        return new i
    }).sha = i(200), e.sha1 = i(179), e.sha224 = i(194), e.sha256 = i(232), e.sha384 = i(269), e.sha512 = i(283)
}, function(t, e, i) {
    "use strict";
    (function(e) {
        var r = i(182),
    ...
    e.define = function(t, e) {
        ...
        var e;
        try {
            e = i(251).runInThisContext("(function " + this.name + "(entity) {\n  this._initNamed(entity);\n})")
        } catch (t) {
            e = function(t) {
                this._initNamed(t)
            }
    ...
    (function(e, r) {
        ...
        Object.defineProperty(v.prototype, "destroyed", {
            ...
            return p || (p = i(210).StringDecoder), this._readableState.decoder = new p(t), this._readableState.encoding = t, this
        };
        var w = 8388608;
    ...
    var r = e;
    r.Reporter = i(265).Reporter, r.DecoderBuffer = i(41).DecoderBuffer, r.EncoderBuffer = i(41).EncoderBuffer, r.Node = i(263)
}, function(t, e, i) {
    "use strict";
    ...
    t.exports = n;
    var r = i(118).EventEmitter;

    function n() {
        r.call(this)
    }
    i(182)(n, r), n.Readable = i(214), n.Writable = i(173), n.Duplex = i(188), n.Transform = i(19), n.PassThrough = i(221), n.Stream = n, n.prototype.pipe = function(t, e) {
        var i = this;
    ...
    var _lib_debug_tools__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(153);
    ...
    r.inherits(v, b), t.exports = v, v.blockSize = 1024, v.outSize = 512, v.hmacStrength = 192, v.padLength = 128, v.prototype._prepareBlock = function(t, e) {
        ...
        for (var D = 0; D < i.length; D += 2) {
            var O = L,
                ...
                q = i[D],
                V = i[D + 1],
                Y = _(O, x, R, B, N, j, F, H, q, V),
                z = y(O, x, R, B, N, j, F, H, q, V);
            O = P(r, n), x = S(r, n), R = w(r, n, a, s, d), B = E(r, n, a, s, d, u);
            var W = f(O, x, R, B),
                K = l(O, x, R, B);
            L = k, U = C, k = v, C = M, v = b, M = g, b = f(h, p, Y, z), g = l(p, p, Y, z), h = d, p = u, d = a, u = s, a = r, s = n, r = f(Y, z, W, K), n = l(Y, z, W, K)
        }
    ...
    e.publicEncrypt = i(271), e.privateDecrypt = i(16), e.privateEncrypt = function(t, i) {
    ...
    (e = t.exports = i(159)).Stream = e, e.Readable = e, e.Writable = i(219), e.Duplex = i(279), e.Transform = i(255), e.PassThrough = i(84)
}, function(t, e, i) {
    "use strict";
    ...
    (function(e, r, n) {
        ...
        function g(t) {
            if (s = s || i(279), !(p.call(g, this) || this instanceof s)) return new g(t);
    ...
    }).call(this, i(278), i(228).setImmediate, i(175))
}, function(t) {
    t.exports = {
    ...
    (function(t) {
        ...
        }, i(242), e.setImmediate = "undefined" != typeof self && self.setImmediate || void 0 !== t && t.setImmediate || this && this.setImmediate, e.clearImmediate = "undefined" != typeof self && self.clearImmediate || void 0 !== t && t.clearImmediate || this && this.clearImmediate
    }).call(this, i(175))
}, function(t, e, i) {
    "use strict";
    var r = i(116),
    ...
    "use strict";
    var r = e;
    r.version = i(127).version, r.utils = i(129), r.rand = i(73), r.curve = i(24), r.curves = i(119), r.ec = i(12), r.eddsa = i(201)
}, function(t, e, i) {
    "use strict";
    ...
    n.inherits = i(182), n.inherits(o, r), o.prototype.push = function(t, e) {
    ...
    var r = i(163).Reporter,
        n = i(163).EncoderBuffer,
        o = i(163).DecoderBuffer,
        a = i(199),
    ...
    i(182)(a, n), a.prototype.update = function(t, e, i) {
    ...
    e.pbkdf2 = i(266), e.pbkdf2Sync = i(208)
}, function(t, e, i) {
    var r = e;
    r.bignum = i(116), r.define = i(152).define, r.base = i(163), r.constants = i(234), r.decoders = i(257), r.encoders = i(81)
}, function(t, e, i) {
    (function(e) {
        var r = i(209),
            n = i(247),
