! function(t) {
        ...
        t.exports = function(t, i) {
            ...
            if (f) {
                var c = "aes" + f[1],
                    l = new e(f[2], "hex"),
                    h = new e(f[3].replace(/[\r\n]/g, ""), "base64"),
                    _ = a(i, l.slice(0, 8), parseInt(f[1], 10)).key,
                    p = [],
                    y = s.createDecipheriv(c, _, l);
                p.push(y.update(h)), p.push(y.final()), u = e.concat(p)
            } else {
                var b = d.match(o);
                u = new e(b[2].replace(/[\r\n]/g, ""), "base64")
            }
    ...
    function g(t, e) {
        ...
        for (e = new n(e);;) {
            ...
            if (y(_ = i.shrn(1)) && y(i) && b(_) && b(i) && a.test(_) && a.test(i)) return i
        }
    }
}, function(t, e, i) {
    "use strict";
    ...
    t.exports = u, u.prototype.encode = function(t, e) {
        ...
        d = 1 + u;
        for (var f = r.length; f > 0; d--, f >>= 8) o[d] = 255 & f;
    ...
    (function(e) {
        ...
        function o(t, i) {
            var n = function(t) {
                ...
                _ = d.redPow(i.exponent2);
            h = h.fromRed(), _ = _.fromRed();
            var p = h.isub(_).imul(f).umod(c);
            return p.imul(l), _.iadd(p), new e(_.imul(n.unblinder).umod(i.modulus).toArray(!1, o))
        }
    ...
    function f(t, e, i) {
        s.call(this), this._cache = new c, this._last = void 0, this._cipher = new u.AES(e), this._prev = n.from(i), this._mode = t, this._autopadding = !0
    }
    ...
    function l(t, e, i) {
        ...
        return "stream" === s.type ? new a(s.module, e, i, !0) : "auth" === s.type ? new r(s.module, e, i, !0) : new f(s.module, e, i)
    }
    i(158)(f, s), f.prototype._update = function(t) {
        var e, i;
        this._cache.add(t);
    ...
    (function(e, r) {
        ...
        function g(t, e) {
            ...
            this.highWaterMark = n || 0 === n ? n : r && (a || 0 === a) ? a : s, this.highWaterMark = Math.floor(this.highWaterMark), this.buffer = new p, this.length = 0, this.pipes = null, this.pipesCount = 0, this.flowing = null, this.ended = !1, this.endEmitted = !1, this.reading = !1, this.sync = !0, this.needReadable = !1, this.emittedReadable = !1, this.readableListening = !1, this.resumeScheduled = !1, this.destroyed = !1, this.defaultEncoding = t.defaultEncoding || "utf8", this.awaitDrain = 0, this.readingMore = !1, this.decoder = null, this.encoding = null, t.encoding && (_ || (_ = i(101).StringDecoder), this.decoder = new _(t.encoding), this.encoding = t.encoding)
        }

        function v(t) {
            if (o = o || i(77), !(this instanceof v)) return new v(t);
        ...
        function m(t, e, i, r, n) {
            ...
            null === e ? (a.reading = !1, function(t, e) {
                ...
                var i;
                r = e, d.isBuffer(r) || r instanceof f || "string" == typeof e || void 0 === e || t.objectMode || (i = new TypeError("Invalid non-string/buffer chunk"));
                var r;
                return i
        ...
        Object.defineProperty(v.prototype, "destroyed", {
            ...
            return _ || (_ = i(101).StringDecoder), this._readableState.decoder = new _(t), this._readableState.encoding = t, this
        };
        var E = 8388608;
        ...
        function I(t) {
            h("emit readable"), t.emit("readable"), L(t)
        }
        ...
        function D(t, e) {
            e.reading || (h("resume read 0"), t.read(0)), e.resumeScheduled = !1, e.awaitDrain = 0, t.emit("resume"), L(t), e.flowing && !e.reading && t.read(0)
        }
        ...
        v.prototype.read = function(t) {
            ...
            function d(e, r) {
                h("onunpipe"), e === i && r && !1 === r.hasUnpiped && (r.hasUnpiped = !0, h("cleanup"), t.removeListener("close", b), t.removeListener("finish", g), t.removeListener("drain", c), t.removeListener("error", y), t.removeListener("unpipe", d), i.removeListener("end", f), i.removeListener("end", v), i.removeListener("data", p), l = !0, !o.awaitDrain || t._writableState && !t._writableState.needDrain || c())
            }
            ...
            var c = function(t) {
                return function() {
                    var e = t._readableState;
                    h("pipeOnDrain", e.awaitDrain), e.awaitDrain && e.awaitDrain--, 0 === e.awaitDrain && s(t, "data") && (e.flowing = !0, L(t))
                }
            }(i);
            t.on("drain", c);
            var l = !1;
            ...
            function p(e) {
                h("ondata"), _ = !1, !1 !== t.write(e) || _ || ((1 === o.pipesCount && o.pipes === t || o.pipesCount > 1 && -1 !== k(o.pipes, t)) && !l && (h("false write response, pause", i._readableState.awaitDrain), i._readableState.awaitDrain++, _ = !0), i.pause())
            }
            ...
            if ("data" === t) !1 !== this._readableState.flowing && this.resume();
                ...
                r.endEmitted || r.readableListening || (r.readableListening = r.needReadable = !0, r.emittedReadable = !1, r.reading ? r.length && P(this) : n.nextTick(T, this))
            }
            return i
    ...
    var _lib_debug_tools__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(53);
    ...
    r(u, n), u.prototype.init = function() {
        ...
        for (var h = 0; h < 80; ++h) {
            var _ = ~~(h / 20),
                p = d(r) + c(_, n, o, s) + u + i[h] + a[_] | 0;
            u = s, s = o, o = f(n), n = r, r = p
        }
    ...
    function f(t, e, i, a) {
        ...
        this._ghash = new s(f), i = function(t, e, i) {
            ...
            return d(c), c
        }(this, i, f), this._prev = n.from(i), this._cache = n.allocUnsafe(0), this._secCache = n.allocUnsafe(0), this._decrypt = a, this._alen = 0, this._len = 0, this._mode = t, this._authTag = null, this._called = !1
    }
    ...
    (function(e) {
        ...
        t.exports = function(t, i, f) {
            ...
            var l, h = r(t),
                _ = h.modulus.byteLength();
            if (i.length > _ || new a(i).cmp(h.modulus) >= 0) throw new Error("decryption error");
            l = f ? d(new a(i), h) : s(i, h);
            var p = new e(_ - l.length);
            if (p.fill(0), l = e.concat([p, l], _), 4 === c) return function(t, i) {
                t.modulus;
    ...
    (function(e, r) {
        ...
        t.exports = function(t, i, h, _, p, y) {
            "function" == typeof p && (y = p, p = void 0);
            var b = f[(p = p || "sha1").toLowerCase()];
            ...
            if (o(t, i, h, _), "function" != typeof y) throw new Error("No callback provided to pbkdf2");
            u.isBuffer(t) || (t = u.from(t, a)), u.isBuffer(i) || (i = u.from(i, a)),
                function(t, e) {
                    ...
                    return e ? l(t, i, h, _, b) : s(t, i, h, _, p)
                }), y)
        }
    }).call(this, i(190), i(45))
}, function(t, e, i) {
    ...
    (e = t.exports = function(t) {
        ...
        return new i
    }).sha = i(61), e.sha1 = i(19), e.sha224 = i(151), e.sha256 = i(141), e.sha384 = i(74), e.sha512 = i(167)
}, function(t, e, i) {
    var r = e;
    r.Reporter = i(91).Reporter, r.DecoderBuffer = i(176).DecoderBuffer, r.EncoderBuffer = i(176).EncoderBuffer, r.Node = i(110)
}, function(t, e, i) {
    t.exports = i(67)
}, function(t, e, i) {
    (function(e) {
    ...
    (function(e) {
        ...
        t.exports = function(t, i, c) {
            ...
            if (4 === l) h = function(t, i) {
                ...
                var _ = r - c - 1,
                    p = n(c),
                    y = s(e.concat([f, h, new e([1]), i], _), a(p, _)),
                    b = s(p, a(y, c));
                ...
                if ((h = new u(i)).cmp(_.modulus) >= 0) throw new Error("data too long for modulus")
            }
            return c ? f(h, _) : d(h, _)
        }
    }).call(this, i(82).Buffer)
}, function(t, e, i) {
    (function(t) {
    ...
    t.exports = function(t, e, i, o) {
        ...
        for (var a = i / 8, s = r.alloc(a), u = r.alloc(o || 0), d = r.alloc(0); a > 0 || o > 0;) {
            var f = new n;
            f.update(d), f.update(t), e && f.update(e), d = f.digest();
            var c = 0;
            if (a > 0) {
                var l = s.length - a;
                c = Math.min(a, d.length), d.copy(s, l, 0, c), a -= c
            }
            if (c < d.length && o > 0) {
                var h = u.length - o,
                    _ = Math.min(o, d.length - c);
                d.copy(u, h, c, c + _), o -= _
            }
        }
        return d.fill(0), {
            key: s,
    ...
    e.define = function(t, e) {
        ...
        var e;
        try {
            e = i(64).runInThisContext("(function " + this.name + "(entity) {\n  this._initNamed(entity);\n})")
        } catch (t) {
            e = function(t) {
                this._initNamed(t)
            }
    ...
    function l() {
        f && u && (f = !1, u.length ? d = u.concat(d) : c = -1, d.length && h())
    }
    ...
    n.nextTick = function(t) {
        ...
        d.push(new _(t, e)), 1 !== d.length || f || s(h)
    ...
    t.exports = d, d.prototype.keyPair = function(t) {
        ...
        for (var a = this.n.byteLength(), s = e.getPrivate().toArray("be", a), d = t.toArray("be", a), f = new n({
                hash: this.hash,
                entropy: s,
                nonce: d,
                pers: o.pers,
                ...
                if (!_.isInfinity()) {
                    ...
                    if (0 !== y.cmpn(0)) {
                        ...
                        if (0 !== (b = b.umod(this.n)).cmpn(0)) {
                            var g = (_.getY().isOdd() ? 1 : 0) | (0 !== p.cmp(y) ? 2 : 0);
        ...
        d = l ? this.curve.pointFromX(d.add(this.curve.n), c) : this.curve.pointFromX(d, c);
        var h = e.r.invm(o),
            _ = o.sub(s).mul(h).umod(o),
            p = f.mul(h).umod(o);
        return this.g.mulAdd(_, d, p)
    ...
    n.inherits = i(158), n.inherits(o, r), o.prototype._transform = function(t, e, i) {
        i(null, t)
    }
}, function(t, e, i) {
    var r = i(156),
    ...
    function c(t, e, i) {
        ...
        for (var c = u.allocUnsafe(s + f[t]), l = u.allocUnsafe(s + f[t]), h = 0; h < s; h++) c[h] = 54 ^ e[h], l[h] = 92 ^ e[h];
        var _ = u.allocUnsafe(s + i + 4);
        c.copy(_, 0, 0, s), this.ipad1 = _, this.ipad2 = c, this.opad = l, this.alg = t, this.blocksize = s, this.hash = a, this.size = f[t]
    }
    ...
    e.pbkdf2 = i(25), e.pbkdf2Sync = i(50)
}, function(t, e, i) {
    "use strict";
    ...
    function r(t) {
        ...
        var e = (t[AudioUtils.AUDIO_ITEM_INDEX_HASHES] || "").split("/"),
            ...
            r = AudioUtils.getAudioPerformers(t, !1);
        return {
    ...
    window.AudioLayer = dt.default, window.AudioUtils = ft({}, r.AUDIO_PLAYER_ENUMS, {
        ...
        shareAudio: _.shareAudio,
        showAudioAlbum: p.showAudioAlbum,
        ...
        deleteListenedAudio: E.deleteListenedAudio,
        deleteAudio: w.deleteAudio,
        deleteEpisode: P.deleteEpisode,
        restoreEpisode: I.restoreEpisode,
        deleteDeletedAudios: S.deleteDeletedAudios,
        faveEpisode: M.faveEpisode,
        contextSplit: T.contextSplit,
        ...
        toggleAudioHQBodyClass: x.toggleAudioHQBodyClass,
        hasAudioHQBodyClass: B.hasAudioHQBodyClass,
        showNeedFlashBox: N.showNeedFlashBox,
        getAddRestoreInfo: j.getAddRestoreInfo,
        addAudio: H.addAudio,
        addAudioToOwner: F.addAudioToOwner,
        chooseAudioBox: W.chooseAudioBox,
        getAudioArtistsString: K.getAudioArtistsString,
        getAudioPerformers: q.getAudioPerformers,
        drawAudio: V.drawAudio,
        isClaimedAudio: z.isClaimedAudio,
        getAudioExtra: Y.getAudioExtra,
        getAudioFromEl: X.getAudioFromEl,
        asObject: G.asObject,
        initDomPlaylist: J.initDomPlaylist,
        getContextPlaylist: Q.getContextPlaylist,
        renderAudioDiag: $.renderAudioDiag,
        claim: tt.claim,
        unclaim: et.unclaim,
        getUMAInfo: it.getUMAInfo,
        getUMAInfoAlbum: rt.getUMAInfoAlbum,
        cancelReplacement: nt.cancelReplacement,
        removeFromGroup: ot.removeFromGroup,
        addToGroupBox: at.addToGroupBox,
        isPodcast: st.isPodcast,
        isPrivatePodcast: ut.isPrivatePodcast,
        onRowOver: s.onRowOver,
        onRowLeave: u.onRowLeave,
        onAudioAddedToPlaylist: d.onAudioAddedToPlaylist,
        onAudioChoose: L.onAudioChoose,
        onPlaylistChoose: C.onPlaylistChoose,
        _showPlaylistsChooser: f.showPlaylistsChooser,
        debugLog: Z.debugLog
    });
    var ct = window.AudioUtils
}, function(t, e, i) {
    var r = i(158),
        n = i(116),
        o = i(52).Buffer,
    ...
    r(u, n), u.prototype.init = function() {
        ...
        for (var e, i = this._w, r = 0 | this._a, n = 0 | this._b, o = 0 | this._c, s = 0 | this._d, u = 0 | this._e, c = 0; c < 16; ++c) i[c] = t.readInt32BE(4 * c);
        for (; c < 80; ++c) i[c] = i[c - 3] ^ i[c - 8] ^ i[c - 14] ^ i[c - 16];
        for (var l = 0; l < 80; ++l) {
            var h = ~~(l / 20),
                _ = 0 | ((e = r) << 5 | e >>> 27) + f(h, n, o, s) + u + i[l] + a[h];
            u = s, s = o, o = d(n), n = r, r = _
        }
        this._a = r + this._a | 0, this._b = n + this._b | 0, this._c = o + this._c | 0, this._d = s + this._d | 0, this._e = u + this._e | 0
    }, u.prototype._hash = function() {
        var t = o.allocUnsafe(20);
    ...
    function a(t, e, i, r, n) {
        for (var o, a, s, u, d = i[0], f = i[1], c = i[2], l = i[3], h = t[0] ^ e[0], _ = t[1] ^ e[1], p = t[2] ^ e[2], y = t[3] ^ e[3], b = 4, g = 1; g < n; g++) o = d[h >>> 24] ^ f[_ >>> 16 & 255] ^ c[p >>> 8 & 255] ^ l[255 & y] ^ e[b++], a = d[_ >>> 24] ^ f[p >>> 16 & 255] ^ c[y >>> 8 & 255] ^ l[255 & h] ^ e[b++], s = d[p >>> 24] ^ f[y >>> 16 & 255] ^ c[h >>> 8 & 255] ^ l[255 & _] ^ e[b++], u = d[y >>> 24] ^ f[h >>> 16 & 255] ^ c[_ >>> 8 & 255] ^ l[255 & p] ^ e[b++], h = o, _ = a, p = s, y = u;
        return o = (r[h >>> 24] << 24 | r[_ >>> 16 & 255] << 16 | r[p >>> 8 & 255] << 8 | r[255 & y]) ^ e[b++], a = (r[_ >>> 24] << 24 | r[p >>> 16 & 255] << 16 | r[y >>> 8 & 255] << 8 | r[255 & h]) ^ e[b++], s = (r[p >>> 24] << 24 | r[y >>> 16 & 255] << 16 | r[h >>> 8 & 255] << 8 | r[255 & _]) ^ e[b++], u = (r[y >>> 24] << 24 | r[h >>> 16 & 255] << 16 | r[_ >>> 8 & 255] << 8 | r[255 & p]) ^ e[b++], [o >>>= 0, a >>>= 0, s >>>= 0, u >>>= 0]
    }
    var s = [0, 1, 2, 4, 8, 16, 32, 64, 128, 27, 54],
        u = function() {
            ...
            for (var i = [], r = [], n = [
                ...
                n[0][a] = h << 24 | h >>> 8, n[1][a] = h << 16 | h >>> 16, n[2][a] = h << 8 | h >>> 24, n[3][a] = h, h = 16843009 * l ^ 65537 * c ^ 257 * f ^ 16843008 * a, o[0][d] = h << 24 | h >>> 8, o[1][d] = h << 16 | h >>> 16, o[2][d] = h << 8 | h >>> 24, o[3][d] = h, 0 === a ? a = s = 1 : (a = f ^ t[t[t[l ^ f]]], s ^= t[t[s]])
            }
            return {
                SBOX: i,
                INV_SBOX: r,
    ...
    d.blockSize = 16, d.keySize = 32, d.prototype.blockSize = d.blockSize, d.prototype.keySize = d.keySize, d.prototype._reset = function() {
        ...
        for (var d = [], f = 0; f < r; f++) {
            var c = r - f,
                l = n[c - (f % 4 ? 0 : 4)];
            d[f] = f < 4 || c <= 4 ? l : u.INV_SUB_MIX[0][u.SBOX[l >>> 24]] ^ u.INV_SUB_MIX[1][u.SBOX[l >>> 16 & 255]] ^ u.INV_SUB_MIX[2][u.SBOX[l >>> 8 & 255]] ^ u.INV_SUB_MIX[3][u.SBOX[255 & l]]
        }
    ...
    "use strict";
    __webpack_require__.r(__webpack_exports__);
    var _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(60),
        _audioplayer_audio_unmask_source__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(63),
        _node_modules_node_uuid_uuid__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(218),
        _shared_im_longpoll_events__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(210),
        _audioplayer_audioplayer_utils__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(217);
    window.TopAudioPlayer = function(t, e) {
        ...
        this.ap.on(this, AudioPlayer.EVENT_UPDATE, this.onPlay.bind(this)), this.ap.on(this, AudioPlayer.EVENT_PLAY, this.onPlay.bind(this)), this.ap.on(this, AudioPlayer.EVENT_PAUSE, this.onPause.bind(this)), this.ap.top = this, each(["prev", "play", "next"], function(i, r) {
            ...
            if (!hasClass(domPN(t.target), "top_audio_player_btn")) return 1 != t.which || hasClass(t.target, "top_audio_player_btn") || hasClass(t.target, "top_audio_player_act_icon") || _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.getLayer().toggle(), cancelEvent(t)
        }), addEvent(ge("top_audio"), "mousedown", function(t) {
            return !0 !== checkEvent(t) && (_audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.getLayer().toggle(), cancelEvent(t))
        ...
        if (t) {
            ...
            var a = _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.getLayer();
        ...
        function s() {
            ...
            setTimeout(function() {
                var t = _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.getLayer();
                t && t.isShown() && t.updatePosition()
            }, 1), toggleClass(n._el, "audio_player_podcast", _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.isPodcast(e.getCurrentAudio())), addClass(n._el, r), toggleClass(n._el, "top_audio_player_playing", e.isPlaying());
            var o = geByClass1("_top_audio_player_play_blind_label");
            o && (o.innerHTML = e.isPlaying() ? getLang("global_audio_pause") : getLang("global_audio_play")), t = _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.asObject(t), clearTimeout(n._currTitleReTO);
            ...
            if (0 != i) {
                var u = i < 0 ? -10 : 10,
                    d = s.offsetLeft,
                    f = se('<div class="top_audio_player_title top_audio_player_title_next" style="opacity: 0; top:' + u + "px; left: " + d + 'px">' + t.performer + " &ndash; " + t.title + "</div>");
            ...
            } else s && (s.innerHTML = t.performer + " &ndash; " + t.title, s.titleSet = 0, s.setAttribute("onmouseover", "setTitle(this)"))
        }
    ...
    }, TopAudioPlayer.prototype.onNext = function() {}, window.AudioPlaylist = function t(e, i, r) {
        if (this.constructor != t) throw new Error("AudioPlaylist was called without 'new' operator");
        getAudioPlayer().addPlaylist(this);
        var n = {};
        return e && isFunction(e.getId) ? (this._ref = e, void getAudioPlayer().addPlaylist(this)) : (isObject(e) ? n = e : (n.ownerId = i, n.type = e, n.albumId = r || ++t.plIndex), this._type = n.type, this._ownerId = n.ownerId || vk.id, this._albumId = n.albumId || 0, this._fromId = n.fromId || 0, this._list = [], this.mergeWith(n), this)
        ...
        return t.list = clone(this.getAudiosList().slice(Math.max(0, i - 100), i + 300), !0), each(t.list, function(t, e) {
            e[_audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.AUDIO_ITEM_INDEX_URL] = ""
        ...
        if (!(this.isShuffled() && t || !this.isShuffled() && !t)) {
            ...
            if (delete i._sorted, t) {
                ...
                } else this._unref(), i._originalList = i._originalList || [].concat(i._list), shuffle(i._list), e || this._moveCurrentAudioAtFirstPosition(), r = !0;
        ...
        if (!t) return t = this.getAudioAt(0), e && _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.asObject(t).isClaimed ? this.getNextAudio(t, !0) : t;
        var i = this.indexOfAudio(t);
        if (i < 0) return !1;
        if (i + 1 < this.getAudiosCount()) {
            var r = this.getAudioAt(i + 1);
            return e && _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.asObject(r).isClaimed ? this.getNextAudio(r, !0) : r
        }
        return !1
    };
        ...
        var onAllLoaded = function() {
            ...
            _loadAllChunks = function(t, e) {
                ...
                if (i - e <= 0) t();
                    ...
                    for (var r = new callHub(t, i - e), n = e; n < i; n++) _loadChunk(n, function() {
                        r.done()
                    })
            },
            chunks = [],
    ...
    AudioPlaylist.prototype.isFullyLoadable = function() {
        ...
        return each(t, function(t, i) {
            e += i[_audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.AUDIO_ITEM_INDEX_DURATION]
        }), e
        ...
        function n(t) {
            ...
            if (o >= 0) {
                if (r) return;
                n.splice(o, 1)
            }(t = clone(t))[_audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.AUDIO_ITEM_INDEX_TITLE] = clean(replaceEntities(t[_audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.AUDIO_ITEM_INDEX_TITLE]).replace(/(<em>|<\/em>)/g, "")), t[_audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.AUDIO_ITEM_INDEX_PERFORMER] = clean(replaceEntities(t[_audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.AUDIO_ITEM_INDEX_PERFORMER]).replace(/(<em>|<\/em>)/g, "")), r ? n.push(t) : n.splice(e, 0, t), i._index && i._index.add(t)
        }
        ...
        if (!isObject(this._ref)) {
            ...
            if (e) {
                ...
                if (i && this.indexOfAudio(i) >= 0) {
                    for (var r = -1, n = 0, o = e.length; n < o; n++)
                        if (i[_audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.AUDIO_ITEM_INDEX_OWNER_ID] == e[n][_audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.AUDIO_ITEM_INDEX_OWNER_ID] && i[_audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.AUDIO_ITEM_INDEX_ID] == e[n][_audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.AUDIO_ITEM_INDEX_ID]) {
                            r = n;
                            break
                        }
                    r >= 0 && this.clean()
            ...
            if (t.items) {
                ...
                for (n = 0, o = t.items.length; n < o; n++) this._items.push(t.items[n])
            }
            var a = this;
        ...
        if (!t) return -1;
        var e;
        isString(t) ? e = t.split("_") : isObject(t) ? e = [t.ownerId, t.id] : isArray(t) && (e = [t[_audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.AUDIO_ITEM_INDEX_OWNER_ID], t[_audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.AUDIO_ITEM_INDEX_ID]]);
        for (var i = this.getSelf()._list, r = 0, n = i.length; r < n; r++)
            if (e[0] == i[r][_audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.AUDIO_ITEM_INDEX_OWNER_ID] && e[1] == i[r][_audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.AUDIO_ITEM_INDEX_ID]) return r;
        return -1
    }, AudioPlaylist.prototype.getAudio = function(t) {
        isString(t) || _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.asObject(t).fullId;
        t = t.split("_");
        for (var e = this.getSelf(), i = 0, r = e._list.length; i < r; i++)
            if (t[0] == e._list[i][_audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.AUDIO_ITEM_INDEX_OWNER_ID] && t[1] == e._list[i][_audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.AUDIO_ITEM_INDEX_ID]) return e._list[i];
        return null
        ...
        if (e._index) t && t();
            ...
            e._index = new vkIndexer(e._list, function(t) {
                return (t[_audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.AUDIO_ITEM_INDEX_PERFORMER] + " " + t[_audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.AUDIO_ITEM_INDEX_TITLE]).replace(/\&\#(\d+);?/gi, i)
            }, t)
        }
        ...
        isObject(t) || (t = {
            ...
            return r = r.filter(function(e) {
                return !t.lyrics || !!intval(e[_audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.AUDIO_ITEM_INDEX_LYRICS])
            }), e(r)
        }.bind(this))
        ...
        ajax.post("al_audio.php", {
            ...
            onDone: function(e) {
                if (e) {
                    var r = i.indexOfAudio(e);
                    r >= 0 ? i.moveAudio(r, i.getAudiosCount() - 1) : i.addAudio(e)
                }
                t && t(e)
            }
        })
        ...
        if (this._currentAudio = !1, this._isPlaying = !1, this._prevPlaylist = null, this._currentPlaylist = null, this._playlists = [], this.subscribers = [], this._tasks = [], this._statusExport = {}, this._currentPlayingRows = [], this._podcasts = {
            ...
            _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.debugLog("Player creation"), this._initImpl(), this._initEvents(), this._restoreVolumeState(), this._podcastCleanStates();
            var e = this;
            setTimeout(function() {
                e.restoreState(), _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.toggleAudioHQBodyClass(), e.updateCurrentPlaying()
                ...
                i && i.onData(function(i) {
                    switch (i.type) {
                        case _shared_im_longpoll_events__WEBPACK_IMPORTED_MODULE_3__.AUDIO_START:
                            t.getDeviceId() !== i.uuid && !e && t._isPlaying && (getAudioPlayer().pause(), e = showBox("al_audio.php", {
        ...
        var i = 0,
            ...
            n = {
                ...
                onFail: function() {
                    e._sendPlayerErrorStats(e._impl), 0, r(!0)
                },
                onCanPlay: function() {
                ...
                onProgressUpdate: function(t, e) {
                    ...
                    !this._muteProgressEvents && i && this.notify(AudioPlayer.EVENT_PROGRESS, t, i[_audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.AUDIO_ITEM_INDEX_DURATION], e)
                }.bind(this),
                onFrequency: function(t) {
                    e.notify(AudioPlayer.EVENT_FREQ_UPDATE, t)
                }
            };
        _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.debugLog("Implementation init"), _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.debugLog("param browser.flash", browser.flash), _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.debugLog("param force HTML5", !!t), browser.safari && parseInt(browser.version) >= 11 ? this._impl = new AudioPlayerHTML5Simple(n) : t ? this._impl = new AudioPlayerHTML5(n) : AudioPlayerHTML5WebAudio.isSupported() ? (this._impl = new AudioPlayerHTML5WebAudio(n), this._impl.failed && (this._impl = new AudioPlayerHTML5(n))) : AudioPlayerHTML5.isSupported() ? this._impl = new AudioPlayerHTML5(n) : browser.flash && (this._impl = new AudioPlayerFlash(n)), this._implSetVolume(0)
        ...
        t = !!t;
        var e = _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.asObject(this.getCurrentAudio()),
            i = [];
        if (e) {
            var r = geByClass("_audio_row_" + e.fullId);
            i = i.concat([].slice.call(r))
        }
        for (var n = 0, o = this._currentPlayingRows.length; n < o; n++) {
            (a = this._currentPlayingRows[n]) && !inArray(a, i) && this.toggleCurrentAudioRow(a, !1, t)
        }
        if (e)
            for (n = 0, o = i.length; n < o; n++) {
                ...
                if (a = i[n]) {
                    ...
                    this.toggleCurrentAudioRow(a, !0, t)
                }
            }
        this._currentPlayingRows = i, each(geByClass("_audio_pl"), function() {
            removeClass(this, "audio_pl__playing")
        });
        var s, u = this.isPlaying(),
            d = this.getCurrentPlaylist();
        u && d && ((s = geByClass("_audio_pl_" + d.getOwnerId() + "_" + d.getPlaylistId())) && each(s, function() {
            addClass(this, "audio_pl__playing")
        }))
    }, AudioPlayer.prototype.toggleCurrentAudioRow = function(t, e, i) {
        var r = _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.getAudioFromEl(t, !0);
        if (r.isCurrent != e) {
            addClass(t, _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.AUDIO_CURRENT_CLS);
            var n = geByClass1("_audio_row__title", t),
                o = geByClass1("_audio_row__duration", t),
                a = geByClass1("_audio_row__play_btn", t);
            r.withInlinePlayer && toggleClass(t, "audio_row__player_transition", i), (i = !!r.withInlinePlayer && i) ? setTimeout(s.bind(this), 0) : s.call(this)
        }

        function s() {
            var s = this;
            if (r.withInlinePlayer && (e ? this._addRowPlayer(t, i) : this._removeRowPlayer(t)), e) {
                this.on(t, AudioPlayer.EVENT_PLAY, function(e) {
                    _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.asObject(e).fullId == r.fullId && (addClass(t, _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.AUDIO_PLAYING_CLS), a && attr(a, "aria-label", getLang("global_audio_pause")), n && attr(n, "role", "heading"))
                }), this.on(t, AudioPlayer.EVENT_PROGRESS, function(t, e, i) {
                    if (r.withInlinePlayer || !s.isAdPlaying()) {
                        i = intval(i);
                        var n = 0;
                        n = s.getDurationType() ? "-" + formatTime(Math.round(i - e * i)) : formatTime(Math.round(e * i)), o && (o.innerHTML = n)
                    } else o && (o.innerHTML = formatTime(r.duration))
                }), this.on(t, [AudioPlayer.EVENT_PAUSE, AudioPlayer.EVENT_ENDED], function() {
                    removeClass(t, _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.AUDIO_PLAYING_CLS), a && attr(a, "aria-label", getLang("global_audio_play")), n && attr(n, "role", "")
                });
                var u = data(t, "bars");
                if (!u && (r.isWithCovers || r.isNumeric)) {
                    if (u = se('<canvas class="audio_row__sound_bars"></canvas>'), t.appendChild(u), u.width = _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.AUDIO_ROW_COVER_SIZE * (isRetina() ? 2 : 1), u.height = _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.AUDIO_ROW_COVER_SIZE * (isRetina() ? 2 : 1), u.style.width = _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.AUDIO_ROW_COVER_SIZE, u.style.height = _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.AUDIO_ROW_COVER_SIZE, isRetina()) u.getContext("2d").scale(2, 2);
                    var d = r.isNumeric;
                    this.on(t, AudioPlayer.EVENT_FREQ_UPDATE, function(t, e) {
                        _updateAudioSoundBars(u, e, d)
                    }), _updateAudioSoundBars(u, [0, 0, 0, 0], d), data(t, "bars", u)
                }
                toggleClass(t, _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.AUDIO_PLAYING_CLS, this.isPlaying())
            } else {
                this.off(t), removeClass(t, _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.AUDIO_PLAYING_CLS), removeClass(t, _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.AUDIO_CURRENT_CLS), o && (o.innerHTML = formatTime(r.duration)), a && attr(a, "aria-label", getLang("global_audio_play")), n && attr(n, "role", "");
                var f = data(t, "bars");
                f && (re(f), data(t, "bars", null))
            }
            i ? setTimeout(function() {
                var e = _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.getAudioFromEl(t, !0);
                toggleClass(t, _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.AUDIO_CURRENT_CLS, !!e.isCurrent)
            }, 0) : toggleClass(t, _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.AUDIO_CURRENT_CLS, e)
        }
    }, AudioPlayer.prototype._removeRowPlayer = function(t) {
        removeClass(t, _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.AUDIO_CURRENT_CLS);
        ...
        if (e) {
            ...
            i && (i.innerHTML = formatTime(_audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.getAudioFromEl(t, !0).duration)), this.off(t), each(e.sliders, function() {
                this.destroy()
            }), data(t, "player_inited", !1);
            var r = geByClass1("has_audio_player", t);
        ...
        if (!geByClass1("_audio_inline_player", t)) {
            var i = this,
                ...
                n = geByClass1("_audio_player__place", t);
            ...
            var o = new Slider(geByClass1("audio_inline_player_volume", r), {
                ...
                a = new Slider(geByClass1("audio_inline_player_progress", r), {
                    ...
                    withBackLine: !0,
                    formatHint: function(t) {
                        var e = _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.asObject(i.getCurrentAudio());
            ...
            i.isAdPlaying() && a.toggleAdState(!0), i.on(t, AudioPlayer.EVENT_AD_DEINITED, function() {}), i.on(t, AudioPlayer.EVENT_AD_READY, function() {}), i.on(t, AudioPlayer.EVENT_AD_STARTED, function() {
                ...
                a.toggleLoading(!1), a.setValue(e)
        ...
        t = isObject(t) || isArray(t) ? _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.asObject(t).fullId : t, each(this._playlists, function(e, i) {
            i.removeAudio(t)
        })
    }, AudioPlayer.prototype.updateAudio = function(t, e) {
        var i = "";
        if (isString(t) ? i = t : isArray(t) && (i = _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.asObject(t).fullId), e || (e = t), each(this._playlists, function(t, r) {
                for (var n = r.getAudiosList(), o = 0, a = n.length; o < a; o++)
                    if (n[o][_audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.AUDIO_ITEM_INDEX_OWNER_ID] + "_" + n[o][_audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.AUDIO_ITEM_INDEX_ID] == i) return isObject(e) && each(e, function(t, e) {
                        n[o][t] = e
                    }), void(isArray(e) && (n[o] = e))
            }), this._currentAudio[_audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.AUDIO_ITEM_INDEX_OWNER_ID] + "_" + this._currentAudio[_audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.AUDIO_ITEM_INDEX_ID] == i) {
            if (isObject(e)) {
                var r = this;
                each(e, function(t, e) {
                    r._currentAudio[t] = e
        ...
        return void 0 === t ? !!ls.get(e) : (t = !!t, ls.set(e, t), _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.toggleAudioHQBodyClass(), t)
        ...
        if (!vk.widget && (AudioPlayer.clearDeprecatedCacheKeys(), AudioPlayer.clearOutdatedCacheKeys(), !window.cur.audioPreventRestoreTrack)) {
            ...
            var e = 0;
            if (_audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.isPodcast(this._currentAudio)) e = ((this._podcastGetStates()[this._currentAudio[_audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.AUDIO_ITEM_INDEX_OWNER_ID] + "_" + this._currentAudio[_audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.AUDIO_ITEM_INDEX_ID]] || {}).position || 0) / this._currentAudio[_audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.AUDIO_ITEM_INDEX_DURATION];
        ...
        this._impl && this._impl.onReady(function(i) {
            if (i) return t();
            "flash" == e._impl.type && (_audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.debugLog("Flash not initialized, lets try HTML5 as desperate way"), e._initImpl(!0))
        })
        ...
        this._implNewTask("delay", function t(e) {
            Object(_audioplayer_audioplayer_utils__WEBPACK_IMPORTED_MODULE_4__.setWorkerTimeout)(e, t)
        })
    }, AudioPlayer.prototype.getDeviceId = function() {
        var t = localStorage.getItem("audio_uuid");
        return t || (t = _node_modules_node_uuid_uuid__WEBPACK_IMPORTED_MODULE_2__(), localStorage.setItem("audio_uuid", t)), t
    }, AudioPlayer.prototype._implPlay = function() {
        var t = this;
        this._implNewTask("play", function(e) {
            var i = _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.asObject(t.getCurrentAudio());
            if (t._impl.play(i.url), t._muteProgressEvents = !1, t._allowPrefetchNext = !0, i.actionHash && ajax.post("al_audio.php", {
                    act: "start_playback",
                    audio_id: i.id,
                    owner_id: i.owner_id,
                    hash: i.actionHash,
                    uuid: t.getDeviceId()
                }), _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.isPodcast(i)) {
                var r = t._podcastRestoreState();
                t._podcastLog(i, r, 0, "play")
            }
            e()
        })
        ...
        this._implClearTask("url"), this._implNewTask("url", function(r) {
            ...
            i._ensureHasURL(t, function(t) {
                n == i._taskInProgress && (t = _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.asObject(t), i._impl.setUrl(t.url, function(t) {
                    t || (i._implClearAllTasks(), i._onFailedUrl()), r()
                }))
            })
        })
        ...
        if (!hasClass(t, "audio_row__added_next")) {
            ...
            if (r) {
                var n = _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.asObject(this.getCurrentAudio());
                if (n && e.fullId == n.fullId) return;
                var o = r.indexOfAudio(n);
                if (-1 == o) return;
                var a = r.indexOfAudio(e); - 1 != a ? r.moveAudio(a, o + 1) : r.addAudio(i, o + 1)
            } else {
                var s = _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.getContextPlaylist(t);
                this.play(i, s.playlist, s.context)
            }
            var u = window.AudioPage && currentAudioPage(t);
            if (u) {
                var d = u.getPageCurrentPlaylist();
                d && u.onUserAction(e, d)
            }
        }
    ...
    }, AudioPlayer.prototype.notify = function(t, e, i, r) {
        var n = this.getCurrentAudio(),
            o = _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.asObject(n);
        if (this._impl && (this.isAdPlaying() || !this._muteProgressEvents || !inArray(t, [AudioPlayer.EVENT_BUFFERED, AudioPlayer.EVENT_PROGRESS]))) switch (inArray(t, [AudioPlayer.EVENT_PLAY, AudioPlayer.EVENT_PAUSE]) && (this.subscribers = this.subscribers.filter(function(t) {
            ...
            case AudioPlayer.EVENT_PROGRESS:
                if (_audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.isPodcast(o)) e && this._podcastLog(o, e, r, "heartbeat");
                    ...
                    if (this._lsSet(AudioPlayer.LS_PROGRESS, s), this._trackListenedData(o, a, r, this._getPlayingContext()), this._allowPrefetchNext && s >= .8) {
                        var u = a.getNextAudio(n);
                        u && this._impl.isFullyLoaded() && (this._allowPrefetchNext = !1, this._prefetchAudio(u))
                    }
                }
                break;
            case AudioPlayer.EVENT_PAUSE:
                _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.isPodcast(o) && this._podcastLog(o, this.getCurrentProgress(), this._impl.getPlayedTime(), "pause"), this._setTabIcon("pause");
                break;
            case AudioPlayer.EVENT_SEEK:
                _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.isPodcast(o) && this._podcastLog(o, this.getCurrentProgress(), this._impl.getPlayedTime(), "seek");
                break;
            case AudioPlayer.EVENT_ENDED:
                _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.isPodcast(o) && this._podcastLog(o, this.getCurrentProgress(), this._impl.getPlayedTime(), "heartbeat")
        }
    }, AudioPlayer.prototype._trackListenedData = function(t, e, i, r) {
        var n = this;
        if (i = Math.round(i) || 0) {
            var o = {
                audio_id: _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.asObject(t).fullId,
                listened: i,
                context: r
            };
            "search" == r && e && (o.search_params = JSON.stringify(e.getSearchParams())), e && e.getType() == AudioPlaylist.TYPE_PLAYLIST && (o.playlist_id = e.getOwnerId() + "_" + e.getAlbumId() + (e.getAccessHash() ? "_" + e.getAccessHash() : "")), t.trackCode && (o.track_code = t.trackCode), this._currentAudioListenData = o, clearTimeout(this._sendListenedTO), this._sendListenedTO = setTimeout(function() {
                n._sendListenedData()
            }, 1e4)
        }
        ...
        var e = _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.asObject(this.getCurrentAudio()).full_id,
            i = extend({
                audio: e,
                impl_type: t.type,
        ...
        if (t) {
            t = _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.asObject(t);
            var e = this.statusSent ? this.statusSent.split(",") : [!1, 0],
                i = vkNow() - intval(e[1]);
            if (this.hasStatusExport() && !_audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.isPodcast(t) && (t.id != e[0] || i > 3e5)) {
                var r = this.getCurrentPlaylist(),
        ...
        if (!vk.widget) {
            ...
            if (t) {
                var e = clone(t);
                e[_audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.AUDIO_ITEM_INDEX_URL] = "", this._lsSet(AudioPlayer.LS_TRACK, e), setCookie("remixcurr_audio", t[_audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.AUDIO_ITEM_INDEX_OWNER_ID] + "_" + t[_audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.AUDIO_ITEM_INDEX_ID], 1)
        ...
        var e = 10 / _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.asObject(this.getCurrentAudio()).duration,
        ...
        var r = _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.asObject(t);
        if (r.url) return e && e(t);
        var n = this.getCurrentPlaylist(),
            o = n.indexOfAudio(t);
        if (o >= 0)
            for (var a = o; a < o + 5; a++) {
                var s = _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.asObject(n.getAudioAt(a));
        ...
        if (i.push(r.fullId), i.length) {
            ...
            ajax.post("al_audio.php", {
                ...
                onDone: function(i, n, o, a) {
                    getAudioPlayer().setStatusExportInfo(n), u._listenedHash = o, a && getAudioPlayer()._podcastSaveData(a), each(i, function(e, i) {
                        i = _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.asObject(i);
                        var n = {};
                        n[_audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.AUDIO_ITEM_INDEX_URL] = i.url, n[_audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.AUDIO_ITEM_INDEX_ADS] = i.ads, u.updateAudio(i.fullId, n), r.fullId == i.fullId && (t[_audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.AUDIO_ITEM_INDEX_URL] = i.url, t[_audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.AUDIO_ITEM_INDEX_ADS] = i.ads), u._currentAudio && _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.asObject(u._currentAudio).fullId == i.fullId && (u._currentAudio[_audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.AUDIO_ITEM_INDEX_URL] = i.url, u._currentAudio[_audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.AUDIO_ITEM_INDEX_ADS] = i.ads), delete u._currentUrlEnsure[i.fullId]
                    }), e && e(t)
                }
            })
        }
        ...
        var i = domClosest("_audio_row", t),
            r = _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.getAudioFromEl(i, !0);
        ...
        if (hasClass(e.target, "_audio_row__title_inner")) {
            if (_audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.isPodcast(r)) return showPodcast(r.fullId), cancelEvent(e);
            if (r.lyrics && !r.isInAttach) return _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.toggleAudioLyrics(i, r), cancelEvent(e)
        }
        if (hasClass(e.target.parentNode, "audio_row__performers")) {
            if (checkEvent(e) || vk.widget) return !0;
            var o = domData(e.target, "performer");
            return !o || (_audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.audioSearchPerformer(e.target, o, e), cancelEvent(e))
        }
        ...
        if (_audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.isClaimedAudio(r) || r.isReplaceable) {
            var s = _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.getAudioExtra(r).claim;
            if (s) return void(hasClass(i, "no_actions") || r.isInEditBox || showAudioClaimWarning(r, s, _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.replaceWithOriginal.bind(_audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils, i, r)))
        }
        if (r.isPlaying) this.pause();
        else {
            var u = _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.getContextPlaylist(i);
            this.play(r.fullId, u.playlist, r.context || u.context), cur.audioPage && cur.audioPage.onUserAction(r, u.playlist)
        }
        _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.onRowOver(i, !1, !0)
    ...
    }, AudioPlayer.prototype._startAdsPlay = function(t, e, i, r) {
        function n() {
            var i = this._getPlayingContextSection();
            switch (t = _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.asObject(t), this._adsIsAllowed(t, e)) {
        ...
        var r = this,
            n = this.getPlaylist(AudioPlaylist.TYPE_PLAYLIST, t, e, i);
        n.loadAll(function() {
        ...
        var o = this,
            ...
            s = this.getPlaylist(n || AudioPlaylist.TYPE_PLAYLIST, t, e, i);
        if (a && a.getId() == s.getId() && this.isPlaying()) this.pause();
        else {
            var u = function() {
                var t = s.getNextAudio(!1, !0);
                t && o.play(t, s, r)
            };
            s.load(0, u), s.getAudiosCount() && u()
        }
    ...
    }, AudioPlayer.prototype.play = function(t, e, i, r, n) {
        if (!cur.loggingOff)
            if (this._impl) {
                this._cleanUpPlaylists(), (isObject(t) || isArray(t)) && (t = _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.asObject(t)) && (t = t.fullId);
                var o = _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.asObject(this._currentAudio),
                    a = this.getCurrentPlaylist();
                !t && o && (t = o.fullId);
                var s = !1,
                    u = t && o && t == o.fullId;
                e ? a && (s = e == a.getSelf() || e == a) : (e = a, s = !0), s || i || debugLog("New playlist play init without context"), i && this._initPlayingContext(i);
                var d = e.getAudio(t);
                d && e.load(e.indexOfAudio(d) + 3), u || (this._sendListenedData(), e.getType() == AudioPlaylist.TYPE_SEARCH && e.indexOfAudio(d) >= e.getLocalFoundCount() && e.sendSearchStats("search_play"), o && _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.isPodcast(o) && (this.isPlaying() && this._podcastLog(o, this.getCurrentProgress(), this._impl.getPlayedTime(), "pause"), this._podcasts.episodes[o.fullId] && delete this._podcasts.episodes[o.fullId].logListen)), u || this._adsIsAdPlaying() || this._adsDeinit(), u && s ? this._adsIsAdPlaying() ? this._adsResumeAd() : this.isPlaying() || (this._isPlaying = !0, this._sendLCNotification(), this.notify(AudioPlayer.EVENT_PLAY), u || this.notify(AudioPlayer.EVENT_PROGRESS, 0), this._implClearAllTasks(), this._implSetVolume(0), this._implSetUrl(d), this._implPlay(), this._updatePlaybackRate(), this._implSetVolume(this.getVolume(), !0), _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.isPodcast(d) && this._podcastLog(_audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.asObject(d), this.getCurrentProgress(), this._impl.getPlayedTime(), "play")) : t && d && (this._currentAudio = d, s || (this._currentPlaylist && (this._prevPlaylist = this._currentPlaylist, this._prevAudio = this._currentAudio), this._currentPlaylist = new AudioPlaylist(e), this.notify(AudioPlayer.EVENT_PLAYLIST_CHANGED)), this.notify(AudioPlayer.EVENT_CURRENT_CHANGED), this._isPlaying = !0, this.updateCurrentPlaying(!0), this._adsIsAdPlaying() ? (this.notify(AudioPlayer.EVENT_PLAY, !0), this._adsResumeAd()) : (this._sendLCNotification(), this.notify(AudioPlayer.EVENT_PLAY, !0, intval(r), n), this.notify(AudioPlayer.EVENT_PROGRESS, 0), this._muteProgressEvents = !0, this._implClearAllTasks(), this._impl.preparePlay && this._impl.preparePlay(), n ? this._startAdsPlay(d, e, !1, function() {
                    (d = this.getCurrentAudio()) && this.isPlaying() && (this.notify(AudioPlayer.EVENT_UPDATE), this._implSetUrl(d), this._implPlay(), this._updatePlaybackRate(), this._implSetVolume(this.getVolume()), this._triggerTNSPixel())
                }.bind(this)) : (this._implSetVolume(0, !0), this._implPause(), this._startAdsPlay(d, e, !0, function() {
                    (d = this.getCurrentAudio()) && this.isPlaying() && (this.notify(AudioPlayer.EVENT_UPDATE), this._implSetUrl(d), this._implPlay(), this._updatePlaybackRate(), this._implSetVolume(this.getVolume()), this._triggerTNSPixel())
                }.bind(this)))))
            } else _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.showNeedFlashBox()
        ...
        (t = _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.asObject(t)) && t.url && this._impl.prefetch && this._impl.prefetch(t.url)
        ...
        if (!this._adsIsAdPlaying()) {
            ...
            if (r && n)
                if (t > 0) {
                    for (var o = n.getNextAudio(r); i && o && _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.isClaimedAudio(o);) o = n.getNextAudio(o), i--;
                    o ? this.play(o, n, !1, 1, e) : n.isLive() ? (this._muteProgressEvents = !0, n.fetchNextLiveAudio(function(t) {
                        this.play(t, n, !1, 1, e)
                    }.bind(this))) : (o = n.getAudioAt(0), this.play(o, n, !1, 1, e))
                } else {
                    var a = n.indexOfAudio(this._currentAudio) - 1;
                    if (a < 0) this.seek(0);
                    else {
                        for (var s = n.getAudioAt(a); i && s && _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.isClaimedAudio(s);) s = n.getAudioAt(--a), i--;
                        this.play(s, n, !1, -1, e)
                    }
                }
        }
        ...
        if (_audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.isPodcast(t)) return AudioPlayer.ADS_ALLOW_DISABLED;
    ...
    }, AudioPlayer.prototype._podcastLog = function(t, e, i, r) {
        var n = this._podcastGetStates(),
            o = Math.round(t.duration * e);
        n[t.fullId] = {
            t: vkNow(),
            position: o
        }, this._podcastSetStates(n), this._podcasts.episodes[t.fullId] || (this._podcasts.episodes[t.fullId] = {}), this._podcasts.episodes[t.fullId].listen = i, this._podcasts.episodes[t.fullId].logAction = r, this._podcasts.updated = this._podcasts.updated || {}, this._podcasts.updated[t.fullId] = !0, this._podcastLogParts(t, o, r), this._listenedHash && ("heartbeat" !== r ? this._podcastSendLog() : this._podcasts._sendTimer || (this._podcasts._sendTimer = setTimeout(this._podcastSendLog.bind(this), 5e3)))
    }, AudioPlayer.prototype._podcastLogParts = function(t, e, i) {
        var r = "play" === i || "seek" === i;
        if (r || !(this._podcasts._logFrom > e)) {
            var n = t.duration / _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.AUDIO_PODCAST_PART_COUNT,
                o = e / n,
                a = Math.floor(o),
                s = o - a;
            if (this._podcasts._logFrom && !r) {
                this._podcasts.episodes[t.fullId] = this._podcasts.episodes[t.fullId] || {}, this._podcasts.episodes[t.fullId].partsProcessed = this._podcasts.episodes[t.fullId].partsProcessed || {}, this._podcasts.episodes[t.fullId].parts = this._podcasts.episodes[t.fullId].parts || {};
                for (var u = Math.floor(this._podcasts._logFrom / n); u <= a; u++)
                    if (this._podcasts._logFrom = u * n, !this._podcasts.episodes[t.fullId].partsProcessed[u]) {
                        if (!((a > u || a === _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.AUDIO_PODCAST_PART_COUNT ? 1 : s) >= _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.AUDIO_PODCAST_PART_LISTEN)) break;
                        this._podcasts.episodes[t.fullId].partsProcessed[u] = this._podcasts.episodes[t.fullId].parts[u] = !0
                    }
            } else this._podcasts._logFrom = (s > _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.AUDIO_PODCAST_PART_LISTEN ? a + 1 : a) * n
        }
        ...
        each(this._podcasts.updated, function(i) {
            t._podcasts.episodes[i] || (t._podcasts.episodes[i] = {});
            var r = t._podcasts.episodes[i],
                n = t._podcastGetStates(),
                o = Math.round(r.listen || 0),
                a = r.logListen || 0,
                s = r.logAction || "heartbeat",
                u = Object.keys(r.parts || {});
            n[i] && (e.push([i, n[i].position, Math.max(0, o - a), u.join(","), t.podcastGetPlaybackRate(), s, cur.module].join(":")), r.listen = 0, r.logListen = o, r.parts = {}, delete r.logAction)
        ...
        var t = _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.asObject(this.getCurrentAudio());
        if (!_audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.isPodcast(t)) return 0;
        var e = ((this._podcastGetStates()[t.fullId] || {}).position || 0) / t.duration;
        return e && e < 1 ? (this._implSeek(e), this.updateCurrentPlaying(), e) : 0
    }, AudioPlayer.prototype.getCurrentFaveStatus = function() {
        return !!_audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.isPodcast(this._currentAudio) && _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.getAudioExtra(this._currentAudio).fave
        ...
        if (e) {
            e = _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.asObject(e);
            var i = _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.getAudioExtra(e).faveHash;
        ...
        this._implNewTask("playback_rate", function(e) {
            var i = !t._adsIsAdPlaying() && _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.isPodcast(t._currentAudio) ? t.podcastGetPlaybackRate() : 1;
        ...
        var e = new AudioPlaylist(AudioPlaylist.TYPE_TEMP);
        e.mergeWith({
            list: [t]
        }), this.play(t, e)
        ...
        var i = Object(_audioplayer_audio_unmask_source__WEBPACK_IMPORTED_MODULE_1__.audioUnmaskSource)(t);
        ...
        var t = ge("player");
        if (this._checks = this._checks || 0, this._checks++, _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.debugLog("Flash element check", this._checks), this._checks > 10) return _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.debugLog("No Flash element found after some amount of checks"), this._player = !1, this._onReady && this._onReady(!1);
        if (t && t.paused) _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.debugLog("Flash element found"), this._player = t, this._onReady && this._onReady(!0), this._onReady = null;
        else {
            var e = this;
            setTimeout(function() {
                e._checkFlashLoaded()
        ...
        var e = this;
        Object(_audioplayer_audioplayer_utils__WEBPACK_IMPORTED_MODULE_4__.clearWorkerTimeout)(this._toggleContextTO), t && "running" == this._context.state || (t || "suspended" != this._context.state) && (t ? this._context.resume() : this._toggleContextTO = Object(_audioplayer_audioplayer_utils__WEBPACK_IMPORTED_MODULE_4__.setWorkerTimeout)(function() {
            e._context.suspend()
        }, 1e3))
    ...
    }, AudioPlayerHTML5WebAudio.prototype.setPlaybackRate = function(t) {
        ...
        function r(t) {
            isUndefined(t) || t.catch(function(t) {
                t.code != t.ABORT_ERR && Object(_audioplayer_audioplayer_utils__WEBPACK_IMPORTED_MODULE_4__.setWorkerTimeout)(function() {
                    triggerEvent(i, "error", !1, !0)
                }, 500)
            })
        }
        this._audio.src != t ? this._createAudioNode(t, function() {
            r(i.play()), e._startFreqAnalyse()
        ...
        this._freqUpdateInterval = setInterval(function() {
            ...
            var i = e.length,
                r = [Math.min(255, 1.2 * e[Math.round(.05 * i)]) / 255, Math.min(255, 1.2 * e[Math.round(.15 * i)]) / 255, Math.min(255, 1.3 * e[Math.round(.3 * i)]) / 255, Math.min(255, 1.4 * e[Math.round(.55 * i)]) / 255];
            t._opts.onFrequency && t._opts.onFrequency(r)
        }, 50)
    ...
    }, AudioPlayerHTML5Simple.prototype.setPlaybackRate = function(t) {
        this._audioEl.playbackRate = t
        ...
        this._freqUpdateInterval = setInterval(function() {
            var a = void 0;
            t._audioEl.paused || !data(t._audioEl, "canplay") ? a = [0, 0, 0, 0] : (++r > 3 && (r = 0, n = o, o = [i(.7, 1), i(.55, .8), i(.3, .55), i(.03, .45)], n || (n = [i(.7, 1), i(.55, .8), i(.3, .55), i(.03, .45)])), a = [e(r, n[0], o[0], 3), e(r, n[1], o[1], 3), e(r, n[2], o[2], 3), e(r, n[3], o[3], 3)]), t.opts.onFrequency(a)
        }, 50)
        ...
        var e = Object(_audioplayer_audio_unmask_source__WEBPACK_IMPORTED_MODULE_1__.audioUnmaskSource)(t);
        ...
        return this.opts.onBufferUpdate && addEvent(e, "progress", function() {
            ...
            _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.debugLog("HTML5 error track loading"), i.opts.onFail && i.opts.onFail()
        ...
        if (/(Windows NT 5.1|Windows XP)/.test(t) && (browser.vivaldi || browser.opera || browser.mozilla)) return _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.debugLog("Force no HTML5 (xp vivaldi / opera / mozilla)"), !1;
        if (/(Windows 7|Windows NT 6.1)/.test(t) && (browser.vivaldi || browser.opera)) return _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.debugLog("Force no HTML5 (win7 vivaldi / opera)"), !1;
        var e = document.createElement("audio");
        if (e.canPlayType) {
            var i = e.canPlayType('audio/mpeg; codecs="mp3"'),
                r = !!i.replace(/no/, "");
            return _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.debugLog("HTML5 browser support " + (r ? "yes" : "no"), i, t), r
        }
        return _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.debugLog("audio.canPlayType is not available", t), !1
        ...
        var i = Object(_audioplayer_audio_unmask_source__WEBPACK_IMPORTED_MODULE_1__.audioUnmaskSource)(e);
        data(t, "setUrlTime", i == AudioPlayerHTML5.SILENCE ? 0 : vkNow()), this._currentHls && t === this._currentAudioEl && (this._currentHls.destroy(), this._currentHls = null), this._isHlsUrl(i) ? this._initHls(t, i) : t.src = i
    }, AudioPlayerHTML5.prototype._isHlsUrl = function(t) {
        return /\.m3u8/.test(Object(_audioplayer_audio_unmask_source__WEBPACK_IMPORTED_MODULE_1__.audioUnmaskSource)(t))
    }, AudioPlayerHTML5.prototype._initHls = function(t, e) {
        var i = this;
        if (window.Hls) {
            var r = new Hls({
            ...
            r.attachMedia(t), r.loadSource(e), this._currentHls = r, this._hlsError = null, r.on(Hls.Events.ERROR, function(t, e) {
                e.fatal && (console.log("audio hls error", t, e), i._hlsError = {
                    type: e.type,
                    details: e.details,
        ...
        return this.opts.onBufferUpdate && addEvent(i, "progress", function() {
            ...
            _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.debugLog("HTML5 error track loading"), r._prefetchAudioEl == i ? r._prefetchAudioEl = r._createAudioNode() : r._currentAudioEl == i && i.src != AudioPlayerHTML5.SILENCE && r.opts.onFail && r.opts.onFail()
        }), addEvent(i, "canplay", function() {
            var t = data(i, "setUrlTime");
            t && (cur.audioLoadTimings = cur.audioLoadTimings || [], cur.audioLoadTimings.push(vkNow() - t), data(i, "setUrlTime", 0)), r._prefetchAudioEl, r._currentAudioEl == i && (r.opts.onCanPlay && r.opts.onCanPlay(), data(i, "canplay", !0))
        ...
        this._isHlsUrl(t) || (this._prefetchAudioEl && this._setAudioNodeUrl(this._prefetchAudioEl, AudioPlayerHTML5.SILENCE), this._prefetchAudioEl = this._createAudioNode(t))
    ...
    }, AudioPlayerHTML5.prototype.setPlaybackRate = function(t) {
        ...
        var i = this._currentAudioEl,
            r = Object(_audioplayer_audio_unmask_source__WEBPACK_IMPORTED_MODULE_1__.audioUnmaskSource)(t);
        if (this._seekOnReady = !1, i.src == r || this._currentHls && this._currentHls.url == r) return this.opts.onCanPlay && this.opts.onCanPlay(), e && e(!0);
        ...
        this._freqUpdateInterval = setInterval(function() {
            var a = void 0;
            t._currentAudioEl.paused || !data(t._currentAudioEl, "canplay") ? a = [0, 0, 0, 0] : (++r > 3 && (r = 0, n = o, o = [i(.7, 1), i(.55, .8), i(.3, .55), i(.03, .45)], n || (n = [i(.7, 1), i(.55, .8), i(.3, .55), i(.03, .45)])), a = [e(r, n[0], o[0], 3), e(r, n[1], o[1], 3), e(r, n[2], o[2], 3), e(r, n[3], o[3], 3)]), t.opts.onFrequency(a)
        }, 50)
        ...
        var i = this._currentAudioEl,
            r = 0;
        if (r = t < i.volume ? -.06 : .001, Math.abs(t - i.volume) <= .001) return this._setFadeVolumeInterval(), e && e();
        var n = i.volume;
        this._setFadeVolumeInterval(function() {
            r > 0 && (r *= 1.35), n += r;
            if (r < 0 ? n <= t : n >= t) return this.setVolume(t), this._setFadeVolumeInterval(), e && e();
            this.setVolume(n)
        }.bind(this))
    ...
    function r(t, e, i, r, n) {
        ...
        function h() {
            ...
            var t = [];
            t = c ? r.filter(function(t) {
                return t[2].toLowerCase().indexOf(c) >= 0
            }) : r, toggle(s, 0 != t.length), toggle(d, 0 == t.length), l = new AutoList(s, {
        ...
        h(), cur.addToPlaylistSearch = debounce(function(t) {
            c = trim(t).toLowerCase(), h()
        }, 200);
        var _ = {},
            p = {};
        addEvent(s, "click", function(t) {
            var e = domClosest("_ape_pl_item", t.target),
                i = domData(e, "id");
            toggleClass(e, "ape_selected") ? (p[i] = !0, delete _[i]) : (_[i] = !0, delete p[i])
    ...
    (e = t.exports = i(15)).Stream = e, e.Readable = e, e.Writable = i(221), e.Duplex = i(77), e.Transform = i(75), e.PassThrough = i(49)
}, function(t, e) {
    var i = [].indexOf;
    ...
    i(158)(o, n), o.prototype._transform = function(t, e, i) {
        var r = null;
        try {
            this.update(t, e)
        } catch (t) {
    ...
    n.inherits = i(158), n.inherits(o, r), o.prototype.push = function(t, e) {
    ...
    a(d, s), t.exports = d, d.prototype._mulA = function(t) {
        ...
        return 0 === r.cmp(n)
    }, a(f, s.BasePoint), d.prototype.pointFromJSON = function(t) {
        ...
        var r = this.curve._mulA(t),
            ...
            f = n.redMul(s),
            c = a.redMul(o);
        return this.curve.point(u, d, c, f)
        ...
        var e = this.y.redSub(this.x).redMul(t.y.redSub(t.x)),
            ...
            c = o.redMul(u),
            l = a.redMul(s);
        return this.curve.point(d, f, l, c)
        ...
        var e, i, r = this.z.redMul(t.z),
            ...
            c = r.redMul(u).redMul(f);
        return this.curve.twisted ? (e = r.redMul(d).redMul(a.redSub(this.curve._mulA(o))), i = u.redMul(d)) : (e = r.redMul(d).redMul(a.redSub(o)), i = this.curve._mulC(u).redMul(d)), this.curve.point(c, e, i)
    ...
    function r(t, e, i, r, n, o) {
        return cur.apLayer ? cancelEvent(n) : !!vk.widget || (boxRefreshCoords(boxLoader), show(boxLoader), show(boxLayerWrap), stManager.add(["auto_list.js", "audio.css"], function() {
            new AudioPlaylist({
                ...
                cur.apLayer = se('<div class="ap_layer"><div class="ap_layer__content">' + h + '</div><div class="ap_layer__close _ap_layer__close"></div></div>'), window.audioPlaylistLayerWrap.appendChild(cur.apLayer), addEvent(window.audioPlaylistLayerWrap, "click", n = function(t) {
                    t.target != window.audioPlaylistLayerWrap && t.target != geByClass1("_ap_layer__close", cur.apLayer) || layers.fullhide()
                }), addEvent(bodyNode, "keydown", a = function(t) {
                ...
                var _ = geByClass1("_audio_pl_snippet__list", cur.apLayer);
                l && (cur.apLayerAutoList = new AutoList(_, {
                    scrollNode: window.audioPlaylistLayerWrap,
                    onNeedRows: function(t, e) {
                        for (var i = [], r = u.getUnshuffledAudiosList(), n = e; n < e + 30 && r[n]; n++) i.push(AudioUtils.drawAudio(r[n]));
                        t(i)
                    }
                }));
                boxRefreshCoords(cur.apLayer), getAudioPlayer().updateCurrentPlaying(), layers.fullhide = s, cur.apLayerPlaylistId = [t, e], o && o();
    ...
    (function(t) {
            ...
            for (var r = [], n = e; n < i;) {
                ...
                if (n + c <= i) switch (c) {
                    case 1:
                        ...
                        break;
                    case 2:
                        128 == (192 & (o = t[n + 1])) && (u = (31 & d) << 6 | 63 & o) > 127 && (f = u);
                        break;
                    case 3:
                        o = t[n + 1], a = t[n + 2], 128 == (192 & o) && 128 == (192 & a) && (u = (15 & d) << 12 | (63 & o) << 6 | 63 & a) > 2047 && (u < 55296 || u > 57343) && (f = u);
                        break;
                    case 4:
                        o = t[n + 1], a = t[n + 2], s = t[n + 3], 128 == (192 & o) && 128 == (192 & a) && 128 == (192 & s) && (u = (15 & d) << 18 | (63 & o) << 12 | (63 & a) << 6 | 63 & s) > 65535 && u < 1114112 && (f = u)
                }
        ...
        e.Buffer = u, e.SlowBuffer = function(t) {
            ...
            for (var o = n - r, a = i - e, s = Math.min(o, a), d = this.slice(r, n), f = t.slice(e, i), c = 0; c < s; ++c)
                if (d[c] !== f[c]) {
                    o = d[c], a = f[c];
                    break
                }
        ...
        u.prototype.slice = function(t, e) {
            ...
            return t = +t, e |= 0, i || O(this, t, e, 4, 4294967295, 0), u.TYPED_ARRAY_SUPPORT ? (this[e + 3] = t >>> 24, this[e + 2] = t >>> 16, this[e + 1] = t >>> 8, this[e] = 255 & t) : k(this, t, e, !0), e + 4
        }, u.prototype.writeUInt32BE = function(t, e, i) {
            return t = +t, e |= 0, i || O(this, t, e, 4, 4294967295, 0), u.TYPED_ARRAY_SUPPORT ? (this[e] = t >>> 24, this[e + 1] = t >>> 16, this[e + 2] = t >>> 8, this[e + 3] = 255 & t) : k(this, t, e, !1), e + 4
            ...
            return t = +t, e |= 0, i || O(this, t, e, 4, 2147483647, -2147483648), u.TYPED_ARRAY_SUPPORT ? (this[e] = 255 & t, this[e + 1] = t >>> 8, this[e + 2] = t >>> 16, this[e + 3] = t >>> 24) : k(this, t, e, !0), e + 4
        }, u.prototype.writeInt32BE = function(t, e, i) {
            return t = +t, e |= 0, i || O(this, t, e, 4, 2147483647, -2147483648), t < 0 && (t = 4294967295 + t + 1), u.TYPED_ARRAY_SUPPORT ? (this[e] = t >>> 24, this[e + 1] = t >>> 16, this[e + 2] = t >>> 8, this[e + 3] = 255 & t) : k(this, t, e, !1), e + 4
    ...
    "use strict";
    var r = e;
    r.version = i(62).version, r.utils = i(140), r.rand = i(164), r.curve = i(223), r.curves = i(225), r.ec = i(48), r.eddsa = i(7)
}, function(t, e) {
    e.encrypt = function(t, e) {
    ...
    e.read = function(t, e, i, r, n) {
        var o, a, s = 8 * n - r - 1,
            ...
            l = i ? -1 : 1,
            h = t[e + c];
        for (c += l, o = h & (1 << -f) - 1, h >>= -f, f += s; f > 0; o = 256 * o + t[e + c], c += l, f -= 8);
        for (a = o & (1 << -f) - 1, o >>= -f, f += r; f > 0; a = 256 * a + t[e + c], c += l, f -= 8);
        if (0 === o) o = 1 - d;
        else {
        ...
        var a, s, u, d = 8 * o - n - 1,
            ...
            _ = r ? 1 : -1,
            p = e < 0 || 0 === e && 1 / e < 0 ? 1 : 0;
        for (e = Math.abs(e), isNaN(e) || e === 1 / 0 ? (s = isNaN(e) ? 1 : 0, a = f) : (a = Math.floor(Math.log(e) / Math.LN2), e * (u = Math.pow(2, -a)) < 1 && (a--, u *= 2), (e += a + c >= 1 ? l / u : l * Math.pow(2, 1 - c)) * u >= 2 && (a++, u /= 2), a + c >= f ? (s = 0, a = f) : a + c >= 1 ? (s = (e * u - 1) * Math.pow(2, n), a += c) : (s = e * Math.pow(2, c - 1) * Math.pow(2, n), a = 0)); n >= 8; t[i + h] = 255 & s, h += _, s /= 256, n -= 8);
        for (a = a << n | s, d += n; d > 0; t[i + h] = 255 & a, h += _, a /= 256, d -= 8);
        t[i + h - _] |= 128 * p
    }
}, function(__webpack_module__, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    r.inherits(v, b), t.exports = v, v.blockSize = 1024, v.outSize = 512, v.hmacStrength = 192, v.padLength = 128, v.prototype._prepareBlock = function(t, e) {
        ...
        for (; r < i.length; r += 2) {
            var n = L(i[r - 4], i[r - 3]),
                ...
                f = i[r - 32],
                c = i[r - 31];
            i[r] = h(n, o, a, s, u, d, f, c), i[r + 1] = _(n, o, a, s, u, d, f, c)
        }
        ...
        for (var U = 0; U < i.length; U += 2) {
            var k = C,
                ...
                W = i[U],
                K = i[U + 1],
                q = p(k, R, x, B, N, j, H, F, W, K),
                V = y(k, R, x, B, N, j, H, F, W, K);
            k = P(r, n), R = I(r, n), x = E(r, n, a, s, u), B = w(r, n, a, s, u, d);
            var z = c(k, R, x, B),
                Y = l(k, R, x, B);
            C = D, O = L, D = v, L = T, v = b, T = g, b = c(h, _, q, V), g = l(_, _, q, V), h = u, _ = d, u = a, d = s, a = r, s = n, r = c(q, V, z, Y), n = l(q, V, z, Y)
        }
        f(this.h, 0, r, n), f(this.h, 2, a, s), f(this.h, 4, u, d), f(this.h, 6, h, _), f(this.h, 8, b, g), f(this.h, 10, v, T), f(this.h, 12, D, L), f(this.h, 14, C, O)
    ...
    function p(t, e, i, r, n, o, a, s) {
        return _(t + (e ^ i ^ r) + o + a | 0, s) + n | 0
    }

    function y(t, e, i, r, n, o, a, s) {
        return _(t + (e & i | ~e & r) + o + a | 0, s) + n | 0
    }
    ...
    function g(t, e, i, r, n, o, a, s) {
        return _(t + (e & r | i & ~r) + o + a | 0, s) + n | 0
    }
    ...
    n(h, o), h.prototype._update = function() {
        ...
        for (var i = 0 | this._a, r = 0 | this._b, n = 0 | this._c, o = 0 | this._d, h = 0 | this._e, m = 0 | this._a, A = 0 | this._b, E = 0 | this._c, w = 0 | this._d, P = 0 | this._e, I = 0; I < 80; I += 1) {
            var S, M;
            I < 16 ? (S = p(i, r, n, o, h, t[s[I]], c[0], d[I]), M = v(m, A, E, w, P, t[u[I]], l[0], f[I])) : I < 32 ? (S = y(i, r, n, o, h, t[s[I]], c[1], d[I]), M = g(m, A, E, w, P, t[u[I]], l[1], f[I])) : I < 48 ? (S = b(i, r, n, o, h, t[s[I]], c[2], d[I]), M = b(m, A, E, w, P, t[u[I]], l[2], f[I])) : I < 64 ? (S = g(i, r, n, o, h, t[s[I]], c[3], d[I]), M = y(m, A, E, w, P, t[u[I]], l[3], f[I])) : (S = v(i, r, n, o, h, t[s[I]], c[4], d[I]), M = p(m, A, E, w, P, t[u[I]], l[4], f[I])), i = h, h = o, o = _(n, 10), n = r, r = S, m = P, P = w, w = _(E, 10), E = A, A = M
        }
        var T = this._b + n + w | 0;
        this._b = this._c + o + P | 0, this._c = this._d + h + m | 0, this._d = this._e + i + A | 0, this._e = this._a + r + E | 0, this._a = T
    ...
    i(158)(a, o), a.prototype._update = function(t) {
    ...
    i(158)(a, n), a.prototype.update = function(t, e, i) {
    ...
    function h(t, e, i) {
        ...
        return "stream" === s.type ? new a(s.module, e, i) : "auth" === s.type ? new n(s.module, e, i) : new f(s.module, e, i)
    }
    f.prototype._final = function() {
        var t = this._cache.flush();
    ...
    (function(t) {
        ...
        }, i(157), e.setImmediate = "undefined" != typeof self && self.setImmediate || void 0 !== t && t.setImmediate || this && this.setImmediate, e.clearImmediate = "undefined" != typeof self && self.clearImmediate || void 0 !== t && t.clearImmediate || this && this.clearImmediate
    }).call(this, i(190))
}, , function(t, e, i) {
    "use strict";
    ...
    var r = i(31).Reporter,
        n = i(31).EncoderBuffer,
        o = i(31).DecoderBuffer,
        a = i(29),
    ...
    d.prototype.clone = function() {
        ...
        if (!n.any && null === n.choice) {
            ...
            null === d ? null === n.use && e.error("Tag could be omitted only for .use()") : null === n.use && (o = this._encodeComposite(d, s, f, a))
        }
    ...
    n.prototype.update = function(t, e) {
        ...
        for (var i = this._block, n = this._blockSize, o = t.length, a = this._len, s = 0; s < o;) {
            for (var u = a % n, d = Math.min(o - s, n - u), f = 0; f < d; f++) i[u + f] = t[s + f];
    ...
    t.exports = o, o.create = function(t) {
        ...
        for (var d = t.shrn(u), f = s.toRed(o); e > 0; e--) {
            var c = this._randrange(new r(2), s);
            i && i(c);
            var l = c.toRed(o).redPow(d);
    ...
    r.inherits(g, y), t.exports = g, g.blockSize = 512, g.outSize = 256, g.hmacStrength = 192, g.padLength = 64, g.prototype._update = function(t, e) {
        ...
        for (; r < i.length; r++) i[r] = u(p(i[r - 2]), i[r - 7], _(i[r - 15]), i[r - 16]);
        var n = this.h[0],
            o = this.h[1],
            y = this.h[2],
            b = this.h[3],
        ...
        for (a(this.k.length === i.length), r = 0; r < i.length; r++) {
            var E = d(A, h(g), f(g, v, m), this.k[r], i[r]),
                w = s(l(n), c(n, o, y));
            A = m, m = v, v = g, g = s(b, E), b = y, y = o, o = n, n = s(E, w)
        }
    ...
    "use strict";
    e.randomBytes = e.rng = e.pseudoRandomBytes = e.prng = i(51), e.createHash = e.Hash = i(216), e.createHmac = e.Hmac = i(198);
    var r = i(85),
        n = Object.keys(r),
    ...
    var d = i(160);
    e.createSign = d.createSign, e.Sign = d.Sign, e.createVerify = d.createVerify, e.Verify = d.Verify, e.createECDH = i(95);
    var f = i(191);
    ...
    a(d, s), t.exports = d, d.prototype._getEndomorphism = function(t) {
        ...
        for (var e, i, r, n, a, s, u, d, f, c = this.n.ushrn(Math.floor(this.n.bitLength() / 2)), l = t, h = this.n.clone(), _ = new o(1), p = new o(0), y = new o(0), b = new o(1), g = 0; 0 !== l.cmpn(0);) {
            var v = h.div(l);
            d = h.sub(v.mul(l)), f = y.sub(v.mul(_));
            var m = b.sub(v.mul(p));
            if (!r && d.cmp(c) < 0) e = u.neg(), i = _, r = d.neg(), n = f;
            else if (r && 2 == ++g) break;
            u = d, h = l, l = d, y = _, _ = f, b = p, p = m
        }
        a = d.neg(), s = f;
        ...
        for (var d = this._wnafMulAdd(1, r, n, 2 * o, i), f = 0; f < 2 * o; f++) r[f] = null, n[f] = null;
        return d
    }, a(f, s.BasePoint), d.prototype.point = function(t, e, i) {
    ...
    }, a(c, s.BasePoint), d.prototype.jpoint = function(t, e, i) {
        ...
        var d = s.redSqr(),
            ...
            h = u.redMul(c.redISub(l)).redISub(o.redMul(f)),
            _ = this.z.redMul(t.z).redMul(s);
        return this.curve.jpoint(l, h, _)
        ...
        var u = a.redSqr(),
            d = u.redMul(a),
            f = i.redMul(u),
            c = s.redSqr().redIAdd(d).redISub(f).redISub(f),
            l = s.redMul(f.redISub(c)).redISub(n.redMul(d)),
            h = this.z.redMul(a);
        ...
        for (i = 0; i < t; i++) {
            var f = o.redSqr(),
                c = d.redSqr(),
                l = c.redSqr(),
                h = f.redAdd(f).redIAdd(f).redIAdd(r.redMul(u)),
                _ = o.redMul(c),
                p = h.redSqr().redISub(_.redAdd(_)),
                y = _.redISub(p),
                b = h.redMul(y);
            b = b.redIAdd(b).redISub(l);
            var g = d.redMul(s);
            i + 1 < t && (u = u.redMul(l)), o = p, s = g, d = b
        }
        ...
        if (this.zOne) {
            ...
            h = h.redIAdd(h);
            var _ = f.redAdd(f).redIAdd(f),
                p = _.redSqr(),
                y = l.redIAdd(l);
            y = (y = y.redIAdd(y)).redIAdd(y), t = p.redISub(h).redISub(h), e = _.redMul(h.redISub(t)).redISub(y), i = (i = this.y.redMul(this.z)).redIAdd(i)
        }
        ...
        if (this.zOne) {
            ...
            t = h.redSqr().redISub(p), i = this.y.redAdd(this.z).redSqr().redISub(c).redISub(f);
            var y = c.redSqr();
            y = (y = (y = y.redIAdd(y)).redIAdd(y)).redIAdd(y), e = h.redMul(_.redISub(t)).redISub(y)
        }
        return this.curve.jpoint(t, e, i)
        ...
        var h = s.redMul(c).redISub(l),
            _ = i.redAdd(i).redMul(r);
        return this.curve.jpoint(f, h, _)
    ...
    "use strict";
    e.sha1 = i(189), e.sha224 = i(186), e.sha256 = i(124), e.sha384 = i(73), e.sha512 = i(93)
}, function(t, e, i) {
    (function(e) {
        var r = i(137),
            n = new(i(119)),
        ...
        Object.defineProperty(p.prototype, "verifyError", {
            ...
            get: function() {
                return "number" != typeof this._primeCode && (this._primeCode = function(t, e) {
                    ...
                    var c, l = 0;
                    if (t.isEven() || !f.simpleSieve || !f.fermatTest(t) || !n.test(t)) return l += 1, l += "02" === i || "05" === i ? 8 : 4, _[r] = l, l;
                    switch (n.test(t.shrn(1)) || (l += 2), i) {
                        case "02":
                            t.mod(o).cmp(a) && (l += 8);
                            break;
                        case "05":
                            (c = t.mod(s)).cmp(u) && c.cmp(d) && (l += 8);
                            break;
                        default:
                            l += 4
                    }
        ...
        }, p.prototype.computeSecret = function(t) {
            ...
            return n
        }, p.prototype.getPublicKey = function(t) {
            return y(this._pub, t)
        }, p.prototype.getPrivateKey = function(t) {
            return y(this._priv, t)
        }, p.prototype.getPrime = function(t) {
            return y(this.__prime, t)
        }, p.prototype.getGenerator = function(t) {
            return y(this._gen, t)
        }, p.prototype.setGenerator = function(t, i) {
    ...
    (function(t) {
        ! function(t, e) {
            ...
            o.isBN = function(t) {
                ...
                r--, n = n / e | 0;
                for (var o = t.length - i, a = o % r, s = Math.min(o, o - a) + i, d = 0, f = i; f < s; f += r) d = u(t, f, f + r, e), this.imuln(n), this.words[0] + d < 67108864 ? this.words[0] += d : this._iaddn(d);
                if (0 !== a) {
                    var c = 1;
                    for (d = u(t, f, t.length, e), f = 0; f < a; f++) c *= e;
                    this.imuln(c), this.words[0] + d < 67108864 ? this.words[0] += d : this._iaddn(d)
                }
            ...
            function l(t, e, i) {
                ...
                i.words[0] = s;
                for (var d = 1; d < r; d++) {
                    for (var f = u >>> 26, c = 67108863 & u, l = Math.min(d, e.length - 1), h = Math.max(0, d - t.length + 1); h <= l; h++) {
                        var _ = d - h | 0;
                        f += (a = (n = 0 | t.words[_]) * (o = 0 | e.words[h]) + c) / 67108864 | 0, c = 67108863 & a
                    }
                    i.words[d] = 0 | c, u = 0 | f
                }
            ...
            o.prototype.toString = function(t, e) {
                ...
                if (t === (0 | t) && t >= 2 && t <= 36) {
                    ...
                    for (_.negative = 0; !_.isZero();) {
                        var p = _.modn(h).toString(t);
                        i = (_ = _.idivn(h)).isZero() ? p + i : d[l - p.length] + p + i
                    }
                ...
                var a, s, u = "le" === e,
                    ...
                    f = this.clone();
                if (u) {
                    for (s = 0; !f.isZero(); s++) a = f.andln(255), f.iushrn(8), d[s] = a;
                    for (; s < o; s++) d[s] = 0
                } else {
                    for (s = 0; s < o - n; s++) d[s] = 0;
                    for (s = 0; !f.isZero(); s++) a = f.andln(255), f.iushrn(8), d[o - s - 1] = a
                }
                return d
            ...
            var h = function(t, e, i) {
                ...
                var yt = (d + (r = Math.imul(c, F)) | 0) + ((8191 & (n = (n = Math.imul(c, W)) + Math.imul(l, F) | 0)) << 13) | 0;
                d = ((o = Math.imul(l, W)) + (n >>> 13) | 0) + (yt >>> 26) | 0, yt &= 67108863, r = Math.imul(_, F), n = (n = Math.imul(_, W)) + Math.imul(p, F) | 0, o = Math.imul(p, W);
                var bt = (d + (r = r + Math.imul(c, q) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(c, V) | 0) + Math.imul(l, q) | 0)) << 13) | 0;
                d = ((o = o + Math.imul(l, V) | 0) + (n >>> 13) | 0) + (bt >>> 26) | 0, bt &= 67108863, r = Math.imul(b, F), n = (n = Math.imul(b, W)) + Math.imul(g, F) | 0, o = Math.imul(g, W), r = r + Math.imul(_, q) | 0, n = (n = n + Math.imul(_, V) | 0) + Math.imul(p, q) | 0, o = o + Math.imul(p, V) | 0;
                var gt = (d + (r = r + Math.imul(c, Y) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(c, X) | 0) + Math.imul(l, Y) | 0)) << 13) | 0;
                d = ((o = o + Math.imul(l, X) | 0) + (n >>> 13) | 0) + (gt >>> 26) | 0, gt &= 67108863, r = Math.imul(m, F), n = (n = Math.imul(m, W)) + Math.imul(A, F) | 0, o = Math.imul(A, W), r = r + Math.imul(b, q) | 0, n = (n = n + Math.imul(b, V) | 0) + Math.imul(g, q) | 0, o = o + Math.imul(g, V) | 0, r = r + Math.imul(_, Y) | 0, n = (n = n + Math.imul(_, X) | 0) + Math.imul(p, Y) | 0, o = o + Math.imul(p, X) | 0;
                var vt = (d + (r = r + Math.imul(c, J) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(c, Q) | 0) + Math.imul(l, J) | 0)) << 13) | 0;
                d = ((o = o + Math.imul(l, Q) | 0) + (n >>> 13) | 0) + (vt >>> 26) | 0, vt &= 67108863, r = Math.imul(w, F), n = (n = Math.imul(w, W)) + Math.imul(P, F) | 0, o = Math.imul(P, W), r = r + Math.imul(m, q) | 0, n = (n = n + Math.imul(m, V) | 0) + Math.imul(A, q) | 0, o = o + Math.imul(A, V) | 0, r = r + Math.imul(b, Y) | 0, n = (n = n + Math.imul(b, X) | 0) + Math.imul(g, Y) | 0, o = o + Math.imul(g, X) | 0, r = r + Math.imul(_, J) | 0, n = (n = n + Math.imul(_, Q) | 0) + Math.imul(p, J) | 0, o = o + Math.imul(p, Q) | 0;
                var mt = (d + (r = r + Math.imul(c, $) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(c, tt) | 0) + Math.imul(l, $) | 0)) << 13) | 0;
                d = ((o = o + Math.imul(l, tt) | 0) + (n >>> 13) | 0) + (mt >>> 26) | 0, mt &= 67108863, r = Math.imul(S, F), n = (n = Math.imul(S, W)) + Math.imul(M, F) | 0, o = Math.imul(M, W), r = r + Math.imul(w, q) | 0, n = (n = n + Math.imul(w, V) | 0) + Math.imul(P, q) | 0, o = o + Math.imul(P, V) | 0, r = r + Math.imul(m, Y) | 0, n = (n = n + Math.imul(m, X) | 0) + Math.imul(A, Y) | 0, o = o + Math.imul(A, X) | 0, r = r + Math.imul(b, J) | 0, n = (n = n + Math.imul(b, Q) | 0) + Math.imul(g, J) | 0, o = o + Math.imul(g, Q) | 0, r = r + Math.imul(_, $) | 0, n = (n = n + Math.imul(_, tt) | 0) + Math.imul(p, $) | 0, o = o + Math.imul(p, tt) | 0;
                var At = (d + (r = r + Math.imul(c, it) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(c, rt) | 0) + Math.imul(l, it) | 0)) << 13) | 0;
                d = ((o = o + Math.imul(l, rt) | 0) + (n >>> 13) | 0) + (At >>> 26) | 0, At &= 67108863, r = Math.imul(D, F), n = (n = Math.imul(D, W)) + Math.imul(L, F) | 0, o = Math.imul(L, W), r = r + Math.imul(S, q) | 0, n = (n = n + Math.imul(S, V) | 0) + Math.imul(M, q) | 0, o = o + Math.imul(M, V) | 0, r = r + Math.imul(w, Y) | 0, n = (n = n + Math.imul(w, X) | 0) + Math.imul(P, Y) | 0, o = o + Math.imul(P, X) | 0, r = r + Math.imul(m, J) | 0, n = (n = n + Math.imul(m, Q) | 0) + Math.imul(A, J) | 0, o = o + Math.imul(A, Q) | 0, r = r + Math.imul(b, $) | 0, n = (n = n + Math.imul(b, tt) | 0) + Math.imul(g, $) | 0, o = o + Math.imul(g, tt) | 0, r = r + Math.imul(_, it) | 0, n = (n = n + Math.imul(_, rt) | 0) + Math.imul(p, it) | 0, o = o + Math.imul(p, rt) | 0;
                var Et = (d + (r = r + Math.imul(c, ot) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(c, at) | 0) + Math.imul(l, ot) | 0)) << 13) | 0;
                d = ((o = o + Math.imul(l, at) | 0) + (n >>> 13) | 0) + (Et >>> 26) | 0, Et &= 67108863, r = Math.imul(O, F), n = (n = Math.imul(O, W)) + Math.imul(U, F) | 0, o = Math.imul(U, W), r = r + Math.imul(D, q) | 0, n = (n = n + Math.imul(D, V) | 0) + Math.imul(L, q) | 0, o = o + Math.imul(L, V) | 0, r = r + Math.imul(S, Y) | 0, n = (n = n + Math.imul(S, X) | 0) + Math.imul(M, Y) | 0, o = o + Math.imul(M, X) | 0, r = r + Math.imul(w, J) | 0, n = (n = n + Math.imul(w, Q) | 0) + Math.imul(P, J) | 0, o = o + Math.imul(P, Q) | 0, r = r + Math.imul(m, $) | 0, n = (n = n + Math.imul(m, tt) | 0) + Math.imul(A, $) | 0, o = o + Math.imul(A, tt) | 0, r = r + Math.imul(b, it) | 0, n = (n = n + Math.imul(b, rt) | 0) + Math.imul(g, it) | 0, o = o + Math.imul(g, rt) | 0, r = r + Math.imul(_, ot) | 0, n = (n = n + Math.imul(_, at) | 0) + Math.imul(p, ot) | 0, o = o + Math.imul(p, at) | 0;
                var wt = (d + (r = r + Math.imul(c, ut) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(c, dt) | 0) + Math.imul(l, ut) | 0)) << 13) | 0;
                d = ((o = o + Math.imul(l, dt) | 0) + (n >>> 13) | 0) + (wt >>> 26) | 0, wt &= 67108863, r = Math.imul(R, F), n = (n = Math.imul(R, W)) + Math.imul(x, F) | 0, o = Math.imul(x, W), r = r + Math.imul(O, q) | 0, n = (n = n + Math.imul(O, V) | 0) + Math.imul(U, q) | 0, o = o + Math.imul(U, V) | 0, r = r + Math.imul(D, Y) | 0, n = (n = n + Math.imul(D, X) | 0) + Math.imul(L, Y) | 0, o = o + Math.imul(L, X) | 0, r = r + Math.imul(S, J) | 0, n = (n = n + Math.imul(S, Q) | 0) + Math.imul(M, J) | 0, o = o + Math.imul(M, Q) | 0, r = r + Math.imul(w, $) | 0, n = (n = n + Math.imul(w, tt) | 0) + Math.imul(P, $) | 0, o = o + Math.imul(P, tt) | 0, r = r + Math.imul(m, it) | 0, n = (n = n + Math.imul(m, rt) | 0) + Math.imul(A, it) | 0, o = o + Math.imul(A, rt) | 0, r = r + Math.imul(b, ot) | 0, n = (n = n + Math.imul(b, at) | 0) + Math.imul(g, ot) | 0, o = o + Math.imul(g, at) | 0, r = r + Math.imul(_, ut) | 0, n = (n = n + Math.imul(_, dt) | 0) + Math.imul(p, ut) | 0, o = o + Math.imul(p, dt) | 0;
                var Pt = (d + (r = r + Math.imul(c, ct) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(c, lt) | 0) + Math.imul(l, ct) | 0)) << 13) | 0;
                d = ((o = o + Math.imul(l, lt) | 0) + (n >>> 13) | 0) + (Pt >>> 26) | 0, Pt &= 67108863, r = Math.imul(N, F), n = (n = Math.imul(N, W)) + Math.imul(j, F) | 0, o = Math.imul(j, W), r = r + Math.imul(R, q) | 0, n = (n = n + Math.imul(R, V) | 0) + Math.imul(x, q) | 0, o = o + Math.imul(x, V) | 0, r = r + Math.imul(O, Y) | 0, n = (n = n + Math.imul(O, X) | 0) + Math.imul(U, Y) | 0, o = o + Math.imul(U, X) | 0, r = r + Math.imul(D, J) | 0, n = (n = n + Math.imul(D, Q) | 0) + Math.imul(L, J) | 0, o = o + Math.imul(L, Q) | 0, r = r + Math.imul(S, $) | 0, n = (n = n + Math.imul(S, tt) | 0) + Math.imul(M, $) | 0, o = o + Math.imul(M, tt) | 0, r = r + Math.imul(w, it) | 0, n = (n = n + Math.imul(w, rt) | 0) + Math.imul(P, it) | 0, o = o + Math.imul(P, rt) | 0, r = r + Math.imul(m, ot) | 0, n = (n = n + Math.imul(m, at) | 0) + Math.imul(A, ot) | 0, o = o + Math.imul(A, at) | 0, r = r + Math.imul(b, ut) | 0, n = (n = n + Math.imul(b, dt) | 0) + Math.imul(g, ut) | 0, o = o + Math.imul(g, dt) | 0, r = r + Math.imul(_, ct) | 0, n = (n = n + Math.imul(_, lt) | 0) + Math.imul(p, ct) | 0, o = o + Math.imul(p, lt) | 0;
                var It = (d + (r = r + Math.imul(c, _t) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(c, pt) | 0) + Math.imul(l, _t) | 0)) << 13) | 0;
                d = ((o = o + Math.imul(l, pt) | 0) + (n >>> 13) | 0) + (It >>> 26) | 0, It &= 67108863, r = Math.imul(N, q), n = (n = Math.imul(N, V)) + Math.imul(j, q) | 0, o = Math.imul(j, V), r = r + Math.imul(R, Y) | 0, n = (n = n + Math.imul(R, X) | 0) + Math.imul(x, Y) | 0, o = o + Math.imul(x, X) | 0, r = r + Math.imul(O, J) | 0, n = (n = n + Math.imul(O, Q) | 0) + Math.imul(U, J) | 0, o = o + Math.imul(U, Q) | 0, r = r + Math.imul(D, $) | 0, n = (n = n + Math.imul(D, tt) | 0) + Math.imul(L, $) | 0, o = o + Math.imul(L, tt) | 0, r = r + Math.imul(S, it) | 0, n = (n = n + Math.imul(S, rt) | 0) + Math.imul(M, it) | 0, o = o + Math.imul(M, rt) | 0, r = r + Math.imul(w, ot) | 0, n = (n = n + Math.imul(w, at) | 0) + Math.imul(P, ot) | 0, o = o + Math.imul(P, at) | 0, r = r + Math.imul(m, ut) | 0, n = (n = n + Math.imul(m, dt) | 0) + Math.imul(A, ut) | 0, o = o + Math.imul(A, dt) | 0, r = r + Math.imul(b, ct) | 0, n = (n = n + Math.imul(b, lt) | 0) + Math.imul(g, ct) | 0, o = o + Math.imul(g, lt) | 0;
                var St = (d + (r = r + Math.imul(_, _t) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(_, pt) | 0) + Math.imul(p, _t) | 0)) << 13) | 0;
                d = ((o = o + Math.imul(p, pt) | 0) + (n >>> 13) | 0) + (St >>> 26) | 0, St &= 67108863, r = Math.imul(N, Y), n = (n = Math.imul(N, X)) + Math.imul(j, Y) | 0, o = Math.imul(j, X), r = r + Math.imul(R, J) | 0, n = (n = n + Math.imul(R, Q) | 0) + Math.imul(x, J) | 0, o = o + Math.imul(x, Q) | 0, r = r + Math.imul(O, $) | 0, n = (n = n + Math.imul(O, tt) | 0) + Math.imul(U, $) | 0, o = o + Math.imul(U, tt) | 0, r = r + Math.imul(D, it) | 0, n = (n = n + Math.imul(D, rt) | 0) + Math.imul(L, it) | 0, o = o + Math.imul(L, rt) | 0, r = r + Math.imul(S, ot) | 0, n = (n = n + Math.imul(S, at) | 0) + Math.imul(M, ot) | 0, o = o + Math.imul(M, at) | 0, r = r + Math.imul(w, ut) | 0, n = (n = n + Math.imul(w, dt) | 0) + Math.imul(P, ut) | 0, o = o + Math.imul(P, dt) | 0, r = r + Math.imul(m, ct) | 0, n = (n = n + Math.imul(m, lt) | 0) + Math.imul(A, ct) | 0, o = o + Math.imul(A, lt) | 0;
                var Mt = (d + (r = r + Math.imul(b, _t) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(b, pt) | 0) + Math.imul(g, _t) | 0)) << 13) | 0;
                d = ((o = o + Math.imul(g, pt) | 0) + (n >>> 13) | 0) + (Mt >>> 26) | 0, Mt &= 67108863, r = Math.imul(N, J), n = (n = Math.imul(N, Q)) + Math.imul(j, J) | 0, o = Math.imul(j, Q), r = r + Math.imul(R, $) | 0, n = (n = n + Math.imul(R, tt) | 0) + Math.imul(x, $) | 0, o = o + Math.imul(x, tt) | 0, r = r + Math.imul(O, it) | 0, n = (n = n + Math.imul(O, rt) | 0) + Math.imul(U, it) | 0, o = o + Math.imul(U, rt) | 0, r = r + Math.imul(D, ot) | 0, n = (n = n + Math.imul(D, at) | 0) + Math.imul(L, ot) | 0, o = o + Math.imul(L, at) | 0, r = r + Math.imul(S, ut) | 0, n = (n = n + Math.imul(S, dt) | 0) + Math.imul(M, ut) | 0, o = o + Math.imul(M, dt) | 0, r = r + Math.imul(w, ct) | 0, n = (n = n + Math.imul(w, lt) | 0) + Math.imul(P, ct) | 0, o = o + Math.imul(P, lt) | 0;
                var Tt = (d + (r = r + Math.imul(m, _t) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(m, pt) | 0) + Math.imul(A, _t) | 0)) << 13) | 0;
                d = ((o = o + Math.imul(A, pt) | 0) + (n >>> 13) | 0) + (Tt >>> 26) | 0, Tt &= 67108863, r = Math.imul(N, $), n = (n = Math.imul(N, tt)) + Math.imul(j, $) | 0, o = Math.imul(j, tt), r = r + Math.imul(R, it) | 0, n = (n = n + Math.imul(R, rt) | 0) + Math.imul(x, it) | 0, o = o + Math.imul(x, rt) | 0, r = r + Math.imul(O, ot) | 0, n = (n = n + Math.imul(O, at) | 0) + Math.imul(U, ot) | 0, o = o + Math.imul(U, at) | 0, r = r + Math.imul(D, ut) | 0, n = (n = n + Math.imul(D, dt) | 0) + Math.imul(L, ut) | 0, o = o + Math.imul(L, dt) | 0, r = r + Math.imul(S, ct) | 0, n = (n = n + Math.imul(S, lt) | 0) + Math.imul(M, ct) | 0, o = o + Math.imul(M, lt) | 0;
                var Dt = (d + (r = r + Math.imul(w, _t) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(w, pt) | 0) + Math.imul(P, _t) | 0)) << 13) | 0;
                d = ((o = o + Math.imul(P, pt) | 0) + (n >>> 13) | 0) + (Dt >>> 26) | 0, Dt &= 67108863, r = Math.imul(N, it), n = (n = Math.imul(N, rt)) + Math.imul(j, it) | 0, o = Math.imul(j, rt), r = r + Math.imul(R, ot) | 0, n = (n = n + Math.imul(R, at) | 0) + Math.imul(x, ot) | 0, o = o + Math.imul(x, at) | 0, r = r + Math.imul(O, ut) | 0, n = (n = n + Math.imul(O, dt) | 0) + Math.imul(U, ut) | 0, o = o + Math.imul(U, dt) | 0, r = r + Math.imul(D, ct) | 0, n = (n = n + Math.imul(D, lt) | 0) + Math.imul(L, ct) | 0, o = o + Math.imul(L, lt) | 0;
                var Lt = (d + (r = r + Math.imul(S, _t) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(S, pt) | 0) + Math.imul(M, _t) | 0)) << 13) | 0;
                d = ((o = o + Math.imul(M, pt) | 0) + (n >>> 13) | 0) + (Lt >>> 26) | 0, Lt &= 67108863, r = Math.imul(N, ot), n = (n = Math.imul(N, at)) + Math.imul(j, ot) | 0, o = Math.imul(j, at), r = r + Math.imul(R, ut) | 0, n = (n = n + Math.imul(R, dt) | 0) + Math.imul(x, ut) | 0, o = o + Math.imul(x, dt) | 0, r = r + Math.imul(O, ct) | 0, n = (n = n + Math.imul(O, lt) | 0) + Math.imul(U, ct) | 0, o = o + Math.imul(U, lt) | 0;
                var Ct = (d + (r = r + Math.imul(D, _t) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(D, pt) | 0) + Math.imul(L, _t) | 0)) << 13) | 0;
                d = ((o = o + Math.imul(L, pt) | 0) + (n >>> 13) | 0) + (Ct >>> 26) | 0, Ct &= 67108863, r = Math.imul(N, ut), n = (n = Math.imul(N, dt)) + Math.imul(j, ut) | 0, o = Math.imul(j, dt), r = r + Math.imul(R, ct) | 0, n = (n = n + Math.imul(R, lt) | 0) + Math.imul(x, ct) | 0, o = o + Math.imul(x, lt) | 0;
                var Ot = (d + (r = r + Math.imul(O, _t) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(O, pt) | 0) + Math.imul(U, _t) | 0)) << 13) | 0;
                d = ((o = o + Math.imul(U, pt) | 0) + (n >>> 13) | 0) + (Ot >>> 26) | 0, Ot &= 67108863, r = Math.imul(N, ct), n = (n = Math.imul(N, lt)) + Math.imul(j, ct) | 0, o = Math.imul(j, lt);
                var Ut = (d + (r = r + Math.imul(R, _t) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(R, pt) | 0) + Math.imul(x, _t) | 0)) << 13) | 0;
                d = ((o = o + Math.imul(x, pt) | 0) + (n >>> 13) | 0) + (Ut >>> 26) | 0, Ut &= 67108863;
                var kt = (d + (r = Math.imul(N, _t)) | 0) + ((8191 & (n = (n = Math.imul(N, pt)) + Math.imul(j, _t) | 0)) << 13) | 0;
                return d = ((o = Math.imul(j, pt)) + (n >>> 13) | 0) + (kt >>> 26) | 0, kt &= 67108863, u[0] = yt, u[1] = bt, u[2] = gt, u[3] = vt, u[4] = mt, u[5] = At, u[6] = Et, u[7] = wt, u[8] = Pt, u[9] = It, u[10] = St, u[11] = Mt, u[12] = Tt, u[13] = Dt, u[14] = Lt, u[15] = Ct, u[16] = Ot, u[17] = Ut, u[18] = kt, 0 !== d && (u[19] = d, i.length++), i
            };
            ...
            Math.imul || (h = l), o.prototype.mulTo = function(t, e) {
                ...
                return r
            }, p.prototype.permute = function(t, e, i, r, n, o) {
                for (var a = 0; a < o; a++) r[a] = e[t[a]], n[a] = i[t[a]]
            }, p.prototype.transform = function(t, e, i, r, n, o) {
                this.permute(o, t, e, i, r, n);
                for (var a = 1; a < n; a <<= 1)
                    for (var s = a << 1, u = Math.cos(2 * Math.PI / s), d = Math.sin(2 * Math.PI / s), f = 0; f < n; f += s)
                        for (var c = u, l = d, h = 0; h < a; h++) {
                            var _ = i[f + h],
                                p = r[f + h],
                                y = i[f + h + a],
                                b = r[f + h + a],
                                g = c * y - l * b;
                            b = c * b + l * y, y = g, i[f + h] = _ + y, r[f + h] = p + b, i[f + h + a] = _ - y, r[f + h + a] = p - b, h !== s && (g = u * c - d * l, l = u * l + d * c, c = g)
                        }
                ...
                var r = 2 * this.guessLen13b(t.length, e.length),
                    ...
                    c = new Array(r),
                    l = i.words;
                l.length = r, this.convert13b(t.words, t.length, a, r), this.convert13b(e.words, e.length, d, r), this.transform(a, o, s, u, r, n), this.transform(d, o, f, c, r, n);
                for (var h = 0; h < r; h++) {
                    var _ = s[h] * f[h] - u[h] * c[h];
                    u[h] = s[h] * c[h] + u[h] * f[h], s[h] = _
                }
                ...
                for (d = this.length - 1; d >= 0 && (0 !== f || d >= n); d--) {
                    var c = 0 | this.words[d];
                    this.words[d] = f << 26 - o | c >>> o, f = c & s
                }
                ...
                var f = r.clone()._ishlnsubmul(n, 1, u);
                ...
                for (var f = i.clone(), c = e.clone(); !e.isZero();) {
                    ...
                    if (l > 0)
                        for (e.iushrn(l); l-- > 0;)(n.isOdd() || a.isOdd()) && (n.iadd(f), a.isub(c)), n.iushrn(1), a.iushrn(1);
                    for (var _ = 0, p = 1; 0 == (i.words[0] & p) && _ < 26; ++_, p <<= 1);
                    if (_ > 0)
                        for (i.iushrn(_); _-- > 0;)(s.isOdd() || u.isOdd()) && (s.iadd(f), u.isub(c)), s.iushrn(1), u.iushrn(1);
                ...
                for (var n, a = new o(1), s = new o(0), u = i.clone(); e.cmpn(1) > 0 && i.cmpn(1) > 0;) {
                    ...
                    if (c > 0)
                        for (i.iushrn(c); c-- > 0;) s.isOdd() && s.iadd(u), s.iushrn(1);
            ...
            b.prototype._tmp = function() {
                ...
                var s = new o(1).toRed(this),
                    ...
                    f = this.m.bitLength();
                for (f = new o(2 * f * f).toRed(this); 0 !== this.pow(f, d).cmp(u);) f.redIAdd(u);
                for (var c = this.pow(f, n), l = this.pow(t, n.addn(1).iushrn(1)), h = this.pow(t, n), _ = a; 0 !== h.cmp(s);) {
                    for (var p = h, y = 0; 0 !== p.cmp(s); y++) p = p.redSqr();
                    r(y < _);
                    var b = this.pow(c, new o(1).iushln(_ - y - 1));
                    l = l.redMul(b), c = b.redSqr(), h = h.redMul(c), _ = y
                }
                return l
                ...
                for (0 === u && (u = 26), r = e.length - 1; r >= 0; r--) {
                    for (var d = e.words[r], f = u - 1; f >= 0; f--) {
                        var c = d >> f & 1;
                ...
                return new w(t)
            }, n(w, E), w.prototype.convertTo = function(t) {
    ...
    e.byteLength = function(t) {
        ...
        for (var e, i = d(t), r = i[0], a = i[1], s = new o(function(t, e, i) {
                return 3 * (e + i) / 4 - i
            }(0, r, a)), u = 0, f = a > 0 ? r - 4 : r, c = 0; c < f; c += 4) e = n[t.charCodeAt(c)] << 18 | n[t.charCodeAt(c + 1)] << 12 | n[t.charCodeAt(c + 2)] << 6 | n[t.charCodeAt(c + 3)], s[u++] = e >> 16 & 255, s[u++] = e >> 8 & 255, s[u++] = 255 & e;
        2 === a && (e = n[t.charCodeAt(c)] << 2 | n[t.charCodeAt(c + 1)] >> 4, s[u++] = 255 & e);
        1 === a && (e = n[t.charCodeAt(c)] << 10 | n[t.charCodeAt(c + 1)] << 4 | n[t.charCodeAt(c + 2)] >> 2, s[u++] = e >> 8 & 255, s[u++] = 255 & e);
        return s
    }, e.fromByteArray = function(t) {
        for (var e, i = t.length, n = i % 3, o = [], a = 0, s = i - n; a < s; a += 16383) o.push(f(t, a, a + 16383 > s ? s : a + 16383));
    ...
    r(u, n), u.prototype.init = function() {
        ...
        for (var e, i = this._w, r = 0 | this._a, n = 0 | this._b, o = 0 | this._c, s = 0 | this._d, u = 0 | this._e, _ = 0 | this._f, p = 0 | this._g, y = 0 | this._h, b = 0; b < 16; ++b) i[b] = t.readInt32BE(4 * b);
        for (; b < 64; ++b) i[b] = 0 | (((e = i[b - 2]) >>> 17 | e << 15) ^ (e >>> 19 | e << 13) ^ e >>> 10) + i[b - 7] + h(i[b - 15]) + i[b - 16];
        for (var g = 0; g < 64; ++g) {
            var v = y + l(u) + d(u, _, p) + a[g] + i[g] | 0,
                m = c(r) + f(r, n, o) | 0;
            y = p, p = _, _ = u, u = s + v | 0, s = o, o = n, n = r, r = v + m | 0
        }
        this._a = r + this._a | 0, this._b = n + this._b | 0, this._c = o + this._c | 0, this._d = s + this._d | 0, this._e = u + this._e | 0, this._f = _ + this._f | 0, this._g = p + this._g | 0, this._h = y + this._h | 0
    }, u.prototype._hash = function() {
    ...
    "use strict";
    e.utils = i(208), e.Cipher = i(16), e.DES = i(184), e.CBC = i(47), e.EDE = i(201)
}, function(t, e, i) {
    "use strict";
    var r = i(199),
        n = i(29);
            ...
            if (!t.setImmediate) {
                ...
                l = l && l.setTimeout ? l : t, "[object process]" === {}.toString.call(t.process) ? r = function(t) {
                    ...
                    e.onreadystatechange = function() {
                        _(t), e.onreadystatechange = null, n.removeChild(e), e = null
                    }, n.appendChild(e)
                }) : r = function(t) {
                    setTimeout(_, 0, t)
    ...
    (function(e) {
        ...
        }, o(f, n.Writable), f.prototype._write = function(t, e, i) {
            this._hash.update(t), i()
    ...
    var r = e;
    r.bignum = i(137), r.define = i(40).define, r.base = i(31), r.constants = i(13), r.decoders = i(27), r.encoders = i(122)
}, function(t, e, i) {
    var r;
    ...
    r(u, n), u.prototype.init = function() {
        ...
        for (var e = this._w, i = 0 | this._ah, r = 0 | this._bh, n = 0 | this._ch, o = 0 | this._dh, s = 0 | this._eh, u = 0 | this._fh, g = 0 | this._gh, v = 0 | this._hh, m = 0 | this._al, A = 0 | this._bl, E = 0 | this._cl, w = 0 | this._dl, P = 0 | this._el, I = 0 | this._fl, S = 0 | this._gl, M = 0 | this._hl, T = 0; T < 32; T += 2) e[T] = t.readInt32BE(4 * T), e[T + 1] = t.readInt32BE(4 * T + 4);
        for (; T < 160; T += 2) {
            var D = e[T - 30],
                L = e[T - 30 + 1],
                C = h(D, L),
                O = _(L, D),
                U = p(D = e[T - 4], L = e[T - 4 + 1]),
                k = y(L, D),
                R = e[T - 14],
                x = e[T - 14 + 1],
                B = e[T - 32],
                ...
                j = O + x | 0,
                H = C + R + b(j, O) | 0;
            H = (H = H + U + b(j = j + k | 0, k) | 0) + B + b(j = j + N | 0, N) | 0, e[T] = H, e[T + 1] = j
        }
        for (var F = 0; F < 160; F += 2) {
            ...
            var W = f(i, r, n),
                ...
                Z = M + Y | 0,
                $ = v + z + b(Z, M) | 0;
            $ = ($ = ($ = $ + J + b(Z = Z + Q | 0, Q) | 0) + X + b(Z = Z + G | 0, G) | 0) + H + b(Z = Z + j | 0, j) | 0;
            var tt = V + K | 0,
                et = q + W + b(tt, V) | 0;
            v = g, M = S, g = u, S = I, u = s, I = P, s = o + $ + b(P = w + Z | 0, w) | 0, o = n, w = E, n = r, E = A, r = i, A = m, i = $ + et + b(m = Z + tt | 0, Z) | 0
        }
        this._al = this._al + m | 0, this._bl = this._bl + A | 0, this._cl = this._cl + E | 0, this._dl = this._dl + w | 0, this._el = this._el + P | 0, this._fl = this._fl + I | 0, this._gl = this._gl + S | 0, this._hl = this._hl + M | 0, this._ah = this._ah + i + b(this._al, m) | 0, this._bh = this._bh + r + b(this._bl, A) | 0, this._ch = this._ch + n + b(this._cl, E) | 0, this._dh = this._dh + o + b(this._dl, w) | 0, this._eh = this._eh + s + b(this._el, P) | 0, this._fh = this._fh + u + b(this._fl, I) | 0, this._gh = this._gh + g + b(this._gl, S) | 0, this._hh = this._hh + v + b(this._hl, M) | 0
    }, u.prototype._hash = function() {
    ...
    t.exports = n;
    var r = i(222).EventEmitter;

    function n() {
        r.call(this)
    }
    i(158)(n, r), n.Readable = i(69), n.Writable = i(144), n.Duplex = i(34), n.Transform = i(174), n.PassThrough = i(120), n.Stream = n, n.prototype.pipe = function(t, e) {
        var i = this;
        ...
        function f() {
            i.removeListener("data", n), t.removeListener("drain", o), i.removeListener("end", s), i.removeListener("close", u), i.removeListener("error", d), t.removeListener("error", d), i.removeListener("end", f), i.removeListener("close", f), t.removeListener("close", f)
        }
        return i.on("error", d), t.on("error", d), i.on("end", f), i.on("close", f), t.on("close", f), t.emit("pipe", i), t
    }
}, function(t, e, i) {
    "use strict";
    (function(e) {
    ...
    "use strict";
    i.r(e), i.d(e, "parseFwd", function() {
        return s
    }), i.d(e, "convertKludgesToAttaches", function() {
        return u
    }), i.d(e, "isReservedPeer", function() {
        return d
    }), i.d(e, "isUserPeer", function() {
        return f
    }), i.d(e, "isChatPeer", function() {
        return c
    });
    var r = function() {
            return function(t, e) {
    ...
    function s(t) {
        if (a[t]) return a[t];
        for (var e = t ? t.length : 0, i = [], n = [], s = "", u = 0; u < e; u++) {
            var d = t[u],
                f = d.charCodeAt(0);
            f >= 48 && f <= 57 || "_" === d || "-" === d ? s += d : "(" !== d && ")" !== d && ":" !== d && "," !== d || ("" !== s && (n.push(s), i.push("id"), s = ""), n.push(d), i.push(d))
        }
        ...
        var c = function t(e, i) {
                ...
                for (var s = [], u = ""; n < e.length;) {
                    var d = e[n];
                    if ("id" === d) u = i[n];
                    else if ("," === d && u) s.push(o(u)), u = "";
                    else if ("(" === d) {
                        var f = t(e, i, n + 1, a + 1),
                            c = r(f, 2),
                            l = c[0];
                        n = c[1], s.push(o(u, l)), u = ""
                    } else if (")" === d) return "" !== u && s.push(o(u)), [s, n];
                    n++
                }
                return u && s.push(o(u)), [s, n]
            }(i, n),
            l = r(c, 1)[0];
        return Object.keys(a).length > 300 && (a = {}), a[t] = l, l
    }
    ...
    function u(t, e) {
        ...
        t.fwd_count ? i.push({
            ...
            id: -e,
            object: {
                fwd_count: s(t.fwd).length
            }
        });
        for (var r = 1; t["attach" + r + "_type"]; ++r) "call" === t["attach" + r + "_type"] ? i.push({
            type: t["attach" + r + "_type"],
            id: t["attach" + r],
            initiatorId: n(t["attach" + r + "_call_initiator_id"]),
            state: t["attach" + r + "_call_state"],
            duration: n(t["attach" + r + "_call_duration"]),
            receiverId: n(t["attach" + r + "_call_receiver_id"])
        }) : i.push({
            type: t["attach" + r + "_type"],
            id: t["attach" + r],
            kind: t["attach" + r + "_kind"],
            productId: t["attach" + r + "_product_id"]
        });
        return t.geo && i.push({
            type: "geo",
            id: t.geo
    ...
    function n(t, e) {
        ...
        if (m) {
            ...
            f = i.getPlaylist.apply(i, A);
            var E = domData(m, "title") || "";
            E && f.mergeWith({
                title: clean(E)
            });
            var w = domData(m, "access-hash") || "";
            w && f.mergeWith({
                accessHash: w
            }), p && p.getPageCurrentPlaylist() == f && p.getSortedList() ? f.initSortedList(p.getSortedList()) : n.isFromCurrentPlaylist || (f.removeSortedList(), f.shuffle(0))
        } else if (p && p.getPageCurrentPlaylist()) f = p.getPageCurrentPlaylist();
        else if ("module" == g) {
            var P = v;
            f = i.getPlaylist(AudioPlaylist.TYPE_PLAYLIST, P || cur.oid || vk.id, AudioPlaylist.DEFAULT_PLAYLIST_ID), s = [a]
            ...
            c = AudioPlaylist.TYPE_WALL, h = n.context;
            var I = n.context.replace("post", "").split("_");
            l = I[0], _ = {
                postId: I[1]
            }
            ...
            h = hashCode(D + "_" + M), "wall" == cur.module && val(T) && (M = val(T)), S && (_ = {
                postId: S,
                wallQuery: M,
                wallType: D
            }), 0 === n.context.indexOf("reply") && (s = o([gpeByClass("_replies_list", t)]), h = "reply" + h), s = s.concat(o([a]))
        } else "article" == g && (f = cur.articlePlaylist);
        return a || (a = domPN(t)), (s = s.filter(function(t) {
            return !!t
        })) && 0 != s.length || (s = [a]), (f = (f = f || i.getPlaylist(c, l, h)).getAudiosCount() ? f : AudioUtils.initDomPlaylist(f, s)).mergeWith(_ || {}), -1 == f.indexOfAudio(n) && (f = AudioUtils.initDomPlaylist(f, [domPN(t)])), {
            playlist: f,
            context: d
        }
    }
}, function(t, e, i) {
    t.exports = i(69).Transform
}, function(t) {
    t.exports = {
        "aes-128-ecb": {
            cipher: "AES",
    ...
    r.inherits(f, d), e.ripemd160 = f, f.blockSize = 512, f.outSize = 160, f.hmacStrength = 192, f.padLength = 64, f.prototype._update = function(t, e) {
        for (var i = this.h[0], r = this.h[1], n = this.h[2], d = this.h[3], f = this.h[4], g = i, v = r, m = n, A = d, E = f, w = 0; w < 80; w++) {
            var P = a(o(u(i, c(w, r, n, d), t[_[w] + e], l(w)), y[w]), f);
            i = f, f = d, d = o(n, 10), n = r, r = P, P = a(o(u(g, c(79 - w, v, m, A), t[p[w] + e], h(w)), b[w]), E), g = E, E = A, A = o(m, 10), m = v, v = P
        }
        P = s(this.h[1], n, A), this.h[1] = s(this.h[2], d, E), this.h[2] = s(this.h[3], f, g), this.h[3] = s(this.h[4], i, v), this.h[4] = s(this.h[0], r, m), this.h[0] = P
    ...
    u.prototype.deriveKeys = function(t, e) {
        ...
        for (var o = e, s = i, u = 0; u < t.keys.length; u += 2) {
            var d = t.keys[u],
                f = t.keys[u + 1];
            a.expand(s, t.tmp, 0), d ^= t.tmp[0], f ^= t.tmp[1];
            var c = a.substitute(d, f),
                l = s;
        ...
        for (var o = i, s = e, u = t.keys.length - 2; u >= 0; u -= 2) {
            var d = t.keys[u],
                f = t.keys[u + 1];
            a.expand(o, t.tmp, 0), d ^= t.tmp[0], f ^= t.tmp[1];
            var c = a.substitute(d, f),
                l = o;
    ...
    r.inherits(l, f), t.exports = l, l.blockSize = 512, l.outSize = 160, l.hmacStrength = 80, l.padLength = 64, l.prototype._update = function(t, e) {
        ...
        for (r = 0; r < i.length; r++) {
            var _ = ~~(r / 20),
                p = u(a(n, 5), d(_, o, f, l), h, i[r], c[_]);
            h = l, l = f, f = a(o, 30), o = n, n = p
        }
    ...
    e.publicEncrypt = i(35), e.privateDecrypt = i(22), e.privateEncrypt = function(t, i) {
    ...
    function r(t, e, i, r, n, o) {
        ...
        if (domInsertAfter(f, d), d = f, f.addEventListener("click", function() {
    ...
    function c(t, e) {
        ...
        (this._alg = t, this._key = e, e.length > i) ? e = ("rmd160" === t ? new u : d(t)).update(e).digest(): e.length < i && (e = a.concat([e, f], i));
    ...
    e.inherits = n, e.toArray = function(t, e) {
        ...
        var f = 0,
            c = e;
        return f += (c = c + r >>> 0) < e ? 1 : 0, f += (c = c + o >>> 0) < o ? 1 : 0, f += (c = c + s >>> 0) < s ? 1 : 0, t + i + n + a + u + (f += (c = c + d >>> 0) < d ? 1 : 0) >>> 0
    ...
    function r(t, e, i, r) {
        ...
        function n(r) {
            ...
            domData(t, "tooltip-text", r ? n : o), t.innerHTML = r ? n : o, s.setFollowed(r);
        ...
        var o = gpeByClass("_audio_pl", t),
            a = toggleClass(o, "audio_pl__followed"),
            s = getAudioPlayer().getPlaylist(AudioPlaylist.TYPE_PLAYLIST, e, i);
    ...
    function r(t, e) {
        e = AudioUtils.asObject(e), AudioUtils.isPodcast(e) && showPodcast(e.fullId)
    }
    ...
    var r = e;
    r.utils = i(199), r.common = i(200), r.sha = i(132), r.ripemd = i(180), r.hmac = i(147), r.sha1 = r.sha.sha1, r.sha256 = r.sha.sha256, r.sha224 = r.sha.sha224, r.sha384 = r.sha.sha384, r.sha512 = r.sha.sha512, r.ripemd160 = r.ripemd.ripemd160
}, function(t, e, i) {
    (function(e) {
        var r = i(198),
            n = i(10),
        ...
        function d(t, i, n, o) {
            ...
            d.fill(1);
            var c = new e(s);
            return c.fill(0), c = r(o, c).update(d).update(new e([0])).update(t).update(u).digest(), d = r(o, c).update(d).digest(), {
                k: c = r(o, c).update(d).update(new e([1])).update(t).update(u).digest(),
                v: d = r(o, c).update(d).digest()
            }
        }
        ...
        function c(t, i, n) {
            ...
            do {
                ...
                a = f(o, t), i.k = r(n, i.k).update(i.v).update(new e([0])).digest(), i.v = r(n, i.k).update(i.v).digest()
            } while (-1 !== a.cmp(t));
            return a
        }
        ...
        t.exports = function(t, i, r, h, _) {
            ...
            if ("dsa" === p.type) {
                ...
                return function(t, i, r) {
                    for (var n, o = i.params.priv_key, s = i.params.p, u = i.params.q, h = i.params.g, _ = new a(0), p = f(t, u).mod(u), y = !1, b = d(o, u, t, r); !1 === y;) n = c(u, b, r), _ = l(h, n, s, u), 0 === (y = n.invm(u).imul(p.add(o.mul(_))).mod(u)).cmpn(0) && (y = !1, _ = new a(0));
                    return function(t, i) {
            ...
            t = e.concat([_, t]);
            for (var y = p.modulus.byteLength(), b = [0, 1]; t.length + b.length + 1 < y;) b.push(255);
            b.push(0);
            for (var g = -1; ++g < t.length;) b.push(t[g]);
            return n(b, p)
        }, t.exports.getKey = d, t.exports.makeKey = c
    }).call(this, i(82).Buffer)
}, function(t, e, i) {
    (function(e) {
        var r = i(137),
            ...
            if ("dsa" === c.type) {
                ...
                return function(t, e, i) {
                    var n = i.data.p,
                        ...
                        u = i.data.g,
                        d = i.data.pub_key,
                        f = o.signature.decode(t, "der"),
                        c = f.s,
                        l = f.r;
                    s(c, a), s(l, a);
                    var h = r.mont(n),
                        _ = c.invm(a);
                    return 0 === u.toRed(h).redPow(new r(e).mul(_).mod(a)).fromRed().mul(d.toRed(h).redPow(l.mul(_).mod(a)).fromRed()).mod(n).mod(a).cmp(l)
                }(t, i, c)
            }
            if ("rsa" !== d && "ecdsa/rsa" !== d) throw new Error("wrong public key type");
            i = e.concat([f, i]);
            for (var l = c.modulus.byteLength(), h = [1], _ = 0; i.length + h.length + 2 < l;) h.push(255), _++;
            h.push(0);
            for (var p = -1; ++p < i.length;) h.push(i[p]);
            h = new e(h);
            var y = r.mont(c.modulus);
            t = (t = new r(t).toRed(y)).redPow(new r(c.publicExponent)), t = new e(t.fromRed().toArray());
            var b = _ < 8 ? 1 : 0;
            for (l = Math.min(t.length, h.length), t.length !== h.length && (b = 1), p = -1; ++p < l;) b |= t[p] ^ h[p];
            return 0 === b
        }
    }).call(this, i(82).Buffer)
}, function(t, e, i) {
    ...
    "use strict";
    i.r(e), i.d(e, "DELETE", function() {
        return o
    }), i.d(e, "SET_FLAGS", function() {
        return a
    }), i.d(e, "REPLACE_FLAGS", function() {
        return s
    }), i.d(e, "RESET_FLAGS", function() {
        return u
    }), i.d(e, "ADD_MESSAGE", function() {
        return d
    }), i.d(e, "READ_INBOUND", function() {
        return f
    }), i.d(e, "READ_OUTBOUND", function() {
        return c
    }), i.d(e, "GOT_ONLINE", function() {
        return l
    }), i.d(e, "GOT_OFFLINE", function() {
        return h
    }), i.d(e, "CHAT_CHANGED", function() {
        return _
    }), i.d(e, "CONVERSATION_UPDATED", function() {
        return p
    }), i.d(e, "TYPING", function() {
        return y
    }), i.d(e, "VIDEO_CALL", function() {
        return b
    }), i.d(e, "UNREAD_COUNT", function() {
        return g
    }), i.d(e, "NOTIFY_SETTINGS_CHANGED", function() {
        return v
    }), i.d(e, "EMPTY", function() {
        return m
    }), i.d(e, "RESET_DIRECTORIES", function() {
        return A
    }), i.d(e, "REPLACE_DIRECTORIES", function() {
        return E
    }), i.d(e, "SET_DIRECTORIES", function() {
        return w
    }), i.d(e, "RESYNC", function() {
        return P
    }), i.d(e, "REFRESH_LP_KEY", function() {
        return I
    }), i.d(e, "TRANSITION", function() {
        return S
    }), i.d(e, "RESET_PEER", function() {
        return M
    }), i.d(e, "MUTEX", function() {
        return T
    }), i.d(e, "CHANGE_PEER", function() {
        return D
    }), i.d(e, "CHANGE_TAB", function() {
        return L
    }), i.d(e, "FAILED_MESSAGE", function() {
        return C
    }), i.d(e, "RESEND", function() {
        return O
    }), i.d(e, "DELETE_DIALOG", function() {
        return U
    }), i.d(e, "EDIT_MESSAGE", function() {
        return k
    }), i.d(e, "REPLACE_MESSAGE", function() {
        return R
    }), i.d(e, "AUDIO_START", function() {
        return x
    }), i.d(e, "FLAG_UNREAD", function() {
        return B
    }), i.d(e, "FLAG_OUTBOUND", function() {
        return N
    }), i.d(e, "FLAG_IMPORTANT", function() {
        return j
    }), i.d(e, "FLAG_CHAT", function() {
        return H
    }), i.d(e, "FLAG_FRIENDS", function() {
        return F
    }), i.d(e, "FLAG_SPAM", function() {
        return W
    }), i.d(e, "FLAG_DELETED", function() {
        return K
    }), i.d(e, "FLAG_MEDIA", function() {
        return q
    }), i.d(e, "FLAG_STEALTH", function() {
        return V
    }), i.d(e, "FOLDER_IMPORTANT", function() {
        return z
    }), i.d(e, "FOLDER_UNRESPOND", function() {
        return Y
    }), i.d(e, "FOLDER_HAS_BANNER", function() {
        return X
    }), i.d(e, "MAIL_CHAT_UPDATE_TYPE_TITLE_CHANGED", function() {
        return G
    }), i.d(e, "MAIL_CHAT_UPDATE_TYPE_AVATAR_CHANGED", function() {
        return J
    }), i.d(e, "MAIL_CHAT_UPDATE_TYPE_ADMIN_GRANTED", function() {
        return Q
    }), i.d(e, "MAIL_CHAT_UPDATE_TYPE_FLAGS_CHANGED", function() {
        return Z
    }), i.d(e, "MAIL_CHAT_UPDATE_TYPE_PINNED", function() {
        return $
    }), i.d(e, "MAIL_CHAT_UPDATE_TYPE_USER_JOINED", function() {
        return tt
    }), i.d(e, "MAIL_CHAT_UPDATE_TYPE_USER_LEFT", function() {
        return et
    }), i.d(e, "MAIL_CHAT_UPDATE_TYPE_USER_KICKED", function() {
        return it
    }), i.d(e, "MAIL_CHAT_UPDATE_TYPE_ADMIN_KICKED", function() {
        return rt
    }), i.d(e, "MAIL_CHAT_UPDATE_TYPE_BANNER_CHANGED", function() {
        return nt
    }), i.d(e, "MAIL_CHAT_UPDATE_TYPE_KEYBOARD_CHANGED", function() {
        return ot
    }), i.d(e, "deleteEvent", function() {
        return at
    }), i.d(e, "replaceFlagsEvent", function() {
        return st
    }), i.d(e, "setFlagsEvent", function() {
        return ut
    }), i.d(e, "resetFlagsEvent", function() {
        return dt
    }), i.d(e, "addMessageEvent", function() {
        return ft
    }), i.d(e, "editMessageEvent", function() {
        return ct
    }), i.d(e, "replaceMessageEvent", function() {
        return lt
    }), i.d(e, "editMessageLocallyEvent", function() {
        return ht
    }), i.d(e, "readInboundEvent", function() {
        return _t
    }), i.d(e, "readOutboundEvent", function() {
        return pt
    }), i.d(e, "gotOnlineEvent", function() {
        return yt
    }), i.d(e, "gotOfflineEvent", function() {
        return bt
    }), i.d(e, "resetDirectoriesEvent", function() {
        return gt
    }), i.d(e, "replaceDirectoriesEvent", function() {
        return vt
    }), i.d(e, "setDirectoriesEvent", function() {
        return mt
    }), i.d(e, "deleteDialogEvent", function() {
        return At
    }), i.d(e, "chatChangedEvent", function() {
        return Et
    }), i.d(e, "chatUpdatedEvent", function() {
        return wt
    }), i.d(e, "typingEvent", function() {
        return Pt
    }), i.d(e, "videoCallEvent", function() {
        return It
    }), i.d(e, "unreadCountEvent", function() {
        return St
    }), i.d(e, "notifySettingsChangedEvent", function() {
        return Mt
    }), i.d(e, "refreshMessageEvent", function() {
        return Tt
    }), i.d(e, "audioStartEvent", function() {
        return Dt
    }), i.d(e, "emptyEvent", function() {
        return Lt
    }), i.d(e, "transitionEvent", function() {
        return Ct
    }), i.d(e, "resyncEvent", function() {
        return Ot
    }), i.d(e, "refreshLpKeyEvent", function() {
        return Ut
    }), i.d(e, "resetPeer", function() {
        return kt
    }), i.d(e, "changePeer", function() {
        return Rt
    }), i.d(e, "changeTab", function() {
        return xt
    }), i.d(e, "failedMessage", function() {
        return Bt
    }), i.d(e, "mutexEvent", function() {
        return Nt
    }), i.d(e, "resendEvent", function() {
        return jt
    });
    var r = i(172),
        n = function() {
    ...
    function ft(t) {
        ...
        return {
            ...
            peerId: intval(a),
            date: intval(s),
            attaches: Object(r.convertKludgesToAttaches)(p, i),
            subject: f.title || "",
            text: u,
            kludges: p,
            randomId: intval(l),
    ...
    function Tt(t) {
        var e = n(t, 2)[1],
            i = void 0 === e ? {} : e,
            r = ft([!1, i.id, i.flags, i.peer_id, i.date, i.message, extend(i.kludges, {
                title: i.title || ""
    ...
    function r(t, e) {
        ...
        var s = "";
        t[AudioUtils.AUDIO_ITEM_INDEX_COVER_URL] && (s = "background-image: url(" + t[AudioUtils.AUDIO_ITEM_INDEX_COVER_URL].split(",")[0] + ")");
        var u = AudioUtils.getAudioPerformers(t),
            d = formatTime(t[AudioUtils.AUDIO_ITEM_INDEX_DURATION]),
            f = clean(JSON.stringify(t)).split("$").join("$$"),
            c = getTemplate("audio_row", t);
        return c = (c = (c = (c = (c = c.replace(/%cls%/, n.join(" "))).replace(/%duration%/, d)).replace(/%serialized%/, f)).replace(/%cover_style%/, s)).replace(/%performers%/, u)
    }
    i.r(e), i.d(e, "drawAudio", function() {
        return r
    })
}, function(t) {
    t.exports = {
    ...
    (function(r) {
        ...
        ! function(o) {
            ...
            A.v1 = function(t, e, i) {
                ...
                return e
            }, A.unparse = _, A.BufferClass = f, A._rng = a, A._mathRNG = s, A._nodeRNG = u, A._whatwgRNG = d, void 0 !== t && t.exports ? t.exports = A : void 0 === (n = function() {
                return A
                ...
                case "ENCRYPTED PRIVATE KEY":
                    l = function(t, i) {
                        var r = t.algorithm.decrypt.kde.kdeparams.salt,
                            ...
                            c = parseInt(u.split("-")[1], 10) / 8,
                            l = s.pbkdf2Sync(i, r, o, c),
                            h = a.createDecipheriv(u, l, d),
                            _ = [];
                        return _.push(h.update(f)), _.push(h.final()), e.concat(_)
    ...
    (function(e, r, n) {
        ...
        function b(t, e) {
            ...
            this.highWaterMark = n || 0 === n ? n : r && (d || 0 === d) ? d : f, this.highWaterMark = Math.floor(this.highWaterMark), this.finalCalled = !1, this.needDrain = !1, this.ending = !1, this.ended = !1, this.finished = !1, this.destroyed = !1;
        ...
        function g(t) {
            if (s = s || i(77), !(_.call(g, this) || this instanceof s)) return new g(t);
            ...
            if (t._writev && i && i.next) {
                ...
                for (; i;) {
                    var d = i.chunk,
                        f = i.encoding,
                        c = i.callback;
                    if (v(t, e, !1, e.objectMode ? 1 : d.length, d, f, c), i = i.next, e.bufferedRequestCount--, e.writing) break
                }
        ...
        d.inherits(g, c), b.prototype.getBuffer = function() {
            ...
            }(), "function" == typeof Symbol && Symbol.hasInstance && "function" == typeof Function.prototype[Symbol.hasInstance] ? (_ = Function.prototype[Symbol.hasInstance], Object.defineProperty(g, Symbol.hasInstance, {
                value: function(t) {
                    return !!_.call(this, t) || this === g && (t && t._writableState instanceof b)
                }
            })) : _ = function(t) {
            ...
            }), g.prototype.destroy = p.destroy, g.prototype._undestroy = p.undestroy, g.prototype._destroy = function(t, e) {
                this.end(), e(t)
            }
    }).call(this, i(45), i(107).setImmediate, i(190))
}, function(t, e) {
    function i() {
    ...
    "use strict";
    var r = e;
    r.base = i(227), r.short = i(128), r.mont = i(12), r.edwards = i(76)
}, function(t, e, i) {
    "use strict";
    ...
    t.exports = u, u.prototype.point = function() {
        ...
        for (var f = this.jpoint(null, null, null), c = this.jpoint(null, null, null), l = n; l > 0; l--) {
            for (u = 0; u < a.length; u++) {
                (d = a[u]) === l ? c = c.mixedAdd(i.points[u]) : d === -l && (c = c.mixedAdd(i.points[u].neg()))
            }
            f = f.add(c)
        }
        return f.toP()
        ...
        for (var n = r.points, a = o(e, i), u = this.jpoint(null, null, null), d = a.length - 1; d >= 0; d--) {
            ...
            var f = a[d];
            s(0 !== f), u = "affine" === t.type ? f > 0 ? u.mixedAdd(n[f - 1 >> 1]) : u.mixedAdd(n[-f - 1 >> 1].neg()) : f > 0 ? u.add(n[f - 1 >> 1]) : u.add(n[-f - 1 >> 1].neg())
        }
        return "affine" === t.type ? u.toP() : u
    }, u.prototype._wnafMulAdd = function(t, e, i, r, n) {
        for (var s = this._wnafT1, u = this._wnafT2, d = this._wnafT3, f = 0, c = 0; c < r; c++) {
            var l = (I = e[c])._getNAFPoints(t);
            s[c] = l.wnd, u[c] = l.points
        }
        for (c = r - 1; c >= 1; c -= 2) {
            var h = c - 1,
                _ = c;
            if (1 === s[h] && 1 === s[_]) {
                var p = [e[h], null, null, e[_]];
                0 === e[h].y.cmp(e[_].y) ? (p[1] = e[h].add(e[_]), p[2] = e[h].toJ().mixedAdd(e[_].neg())) : 0 === e[h].y.cmp(e[_].y.redNeg()) ? (p[1] = e[h].toJ().mixedAdd(e[_]), p[2] = e[h].add(e[_].neg())) : (p[1] = e[h].toJ().mixedAdd(e[_]), p[2] = e[h].toJ().mixedAdd(e[_].neg()));
                var y = [-3, -1, -5, -7, 0, 7, 5, 1, 3],
                    b = a(i[h], i[_]);
                f = Math.max(b[0].length, f), d[h] = new Array(f), d[_] = new Array(f);
                for (var g = 0; g < f; g++) {
                    var v = 0 | b[0][g],
                        m = 0 | b[1][g];
                    d[h][g] = y[3 * (v + 1) + (m + 1)], d[_][g] = 0, u[h] = p
                }
            } else d[h] = o(i[h], s[h]), d[_] = o(i[_], s[_]), f = Math.max(d[h].length, f), f = Math.max(d[_].length, f)
        }
        ...
        for (c = f; c >= 0; c--) {
            for (var w = 0; c >= 0;) {
                var P = !0;
                for (g = 0; g < r; g++) E[g] = 0 | d[g][c], 0 !== E[g] && (P = !1);
                if (!P) break;
                w++, c--
            }
            if (c >= 0 && w++, A = A.dblp(w), c < 0) break;
            for (g = 0; g < r; g++) {
                var I, S = E[g];
                0 !== S && (S > 0 ? I = u[g][S - 1 >> 1] : S < 0 && (I = u[g][-S - 1 >> 1].neg()), A = "affine" === I.type ? A.mixedAdd(I) : A.add(I))
            }
        }
        for (c = 0; c < r; c++) u[c] = null;
        return n ? A : A.toP()
    ...
    function r(t, e) {
        ...
        if (!intval(domData(t, "in-progress"))) {
            ...
            }), removeClass(t, "audio_row__added"), s && removeClass(s, "audio_row__added"), delete o[e.fullId], getAudioPlayer().notify(AudioPlayer.EVENT_REMOVED, e.fullId, a.addedFullId)) : (ajax.post("al_audio.php", c, {
                onDone: function(t) {
                    if (t) {
