! function(t) {
    ...
    (function(e, r, n) {
        ...
        function g(t) {
            if (s = s || i(339), !(p.call(g, this) || this instanceof s)) return new g(t);
    ...
    }).call(this, i(252), i(162).setImmediate, i(160))
}, function(t, e, i) {
    "use strict";
    var r = i(240),
        n = i(210),
    ...
    i(225)(c, s), c.prototype._update = function(t) {
        var e, i;
        this._cache.add(t);
    ...
    "use strict";
    var r = e;
    r.version = i(291).version, r.utils = i(280), r.rand = i(287), r.curve = i(300), r.curves = i(277), r.ec = i(311), r.eddsa = i(309)
}, , function(t, e, i) {
    "use strict";
    var r = i(133),
        n = i(49),
    ...
    t.exports = n;
    var r = i(178).EventEmitter;

    function n() {
        r.call(this)
    }
    i(225)(n, r), n.Readable = i(217), n.Writable = i(313), n.Duplex = i(116), n.Transform = i(319), n.PassThrough = i(29), n.Stream = n, n.prototype.pipe = function(t, e) {
        var i = this;
    ...
    (function(e, r) {
        ...
        function v(t) {
            if (o = o || i(339), !(this instanceof v)) return new v(t);
        ...
        Object.defineProperty(v.prototype, "destroyed", {
            ...
            return p || (p = i(38).StringDecoder), this._readableState.decoder = new p(t), this._readableState.encoding = t, this
        };
        var w = 8388608;
    ...
    (e = t.exports = function(t) {
        ...
        return new i
    }).sha = i(361), e.sha1 = i(216), e.sha224 = i(21), e.sha256 = i(263), e.sha384 = i(223), e.sha512 = i(88)
}, function(t, e, i) {
    "use strict";
        ...
        var i = 0,
            n = function(t) {
                if (-1 != i) {
                    ...
                    r.AudioUtils.isPodcast(this.getCurrentAudio()) ? (this._isPlaying = !1, this.notify(AudioPlayer.EVENT_PAUSE), this.notify(AudioPlayer.EVENT_ENDED), this.stop()) : this._repeatCurrent ? (this._implSeekImmediate(0), this._podcastsActionRef.__ = 1, this._implPlay()) : (this._isPlaying = !1, this.notify(AudioPlayer.EVENT_PAUSE), this.notify(AudioPlayer.EVENT_ENDED), this.playNext(!0)), this._sendListenedData()
                }
            }.bind(this),
            o = {
    ...
    }, AudioPlayer.prototype._podcastUpdateState = function(t, e, i, n, o) {
        var a = this._podcastGetStates(),
            s = Math.round(t.duration * e);
        if (a[t.fullId] = {
                t: vkNow(),
                position: s
            }, this._podcastSetStates(a), n) {
            var d = this._podcastsActionRef[t.fullId] || {},
                u = d[n] || {};
            this._podcastLogEmptyRed(t, n), r.AudioUtils.PodcastsLogs.log(n, extend({
                audio: t,
                position: s,
                listen: i
            }, u, o || {})), delete d[n], delete this._podcastsActionRef.__
        }
    }, AudioPlayer.prototype._podcastLogEmptyRed = function(t, e) {
        var i = (this._podcastsActionRef[t.fullId] || {})[e] || {};
        if (!i.ref && !i.refEl) {
            var r = geByClass1("_podcast_episode" + t.fullId) || geByClass1("_audio_row_" + t.fullId),
                n = "";
            r && (n = [r.className, domData(r, "ref")].join("|")), statlogsValueEvent("podcasts_log_empty_ref", t.fullId, cur.module, n, this._podcastsActionRef.__)
        }
    ...
    "use strict";
    e.sha1 = i(211), e.sha224 = i(359), e.sha256 = i(158), e.sha384 = i(170), e.sha512 = i(93)
}, function(t, e, i) {
    "use strict";
    ...
    function onRowOver(audioEl, event, forceRedraw) {
        var _this = this;
        hasClass(audioEl, "podcast_list_snippet") || (data(audioEl, "leaved", !1), data(audioEl, "actions") && !forceRedraw || hasClass(audioEl, "no_extra") || (clearTimeout(window.audioRowHoverTO), window.audioRowHoverTO = setTimeout(function() {
    ...
    (function(t) {
        ...
        }, i(271), e.setImmediate = "undefined" != typeof self && self.setImmediate || void 0 !== t && t.setImmediate || this && this.setImmediate, e.clearImmediate = "undefined" != typeof self && self.clearImmediate || void 0 !== t && t.clearImmediate || this && this.clearImmediate
    }).call(this, i(160))
}, function(t, e, i) {
    "use strict";
    ...
    var r = e;
    r.Reporter = i(248).Reporter, r.DecoderBuffer = i(125).DecoderBuffer, r.EncoderBuffer = i(125).EncoderBuffer, r.Node = i(283)
}, function(t, e, i) {
    "use strict";
    var r = i(133),
        n = i(93);
    ...
    n.inherits = i(225), n.inherits(o, r), o.prototype._transform = function(t, e, i) {
        i(null, t)
    }
}, function(t, e, i) {
    var r = i(183).Buffer,
        n = i(14).Transform,
        o = i(38).StringDecoder;
    ...
    i(225)(a, n), a.prototype.update = function(t, e, i) {
    ...
    i(225)(o, n), o.prototype._transform = function(t, e, i) {
        var r = null;
        try {
            this.update(t, e)
        } catch (t) {
    ...
    var _lib_debug_tools__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(242);
    ...
    (e = t.exports = i(40)).Stream = e, e.Readable = e, e.Writable = i(5), e.Duplex = i(339), e.Transform = i(238), e.PassThrough = i(201)
}, , function(t, e, i) {
    var r = i(229);
    ...
    "use strict";
    e.utils = i(142), e.Cipher = i(284), e.DES = i(119), e.CBC = i(28), e.EDE = i(279)
}, function(t, e, i) {
    "use strict";
    ...
    var _utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(256),
        _playlist_loadAllPlaylistAudios__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(230);
    ...
    n.inherits = i(225), n.inherits(o, r), o.prototype.push = function(t, e) {
    ...
    var r = e;
    r.utils = i(133), r.common = i(49), r.sha = i(114), r.ripemd = i(10), r.hmac = i(30), r.sha1 = r.sha.sha1, r.sha256 = r.sha.sha256, r.sha224 = r.sha.sha224, r.sha384 = r.sha.sha384, r.sha512 = r.sha.sha512, r.ripemd160 = r.ripemd.ripemd160
}, , function(t, e, i) {
    "use strict";
    ...
    window.AudioLayer = ht.default, window.AudioUtils = pt({}, r.AUDIO_PLAYER_ENUMS, {
    ...
    "use strict";
    e.randomBytes = e.rng = e.pseudoRandomBytes = e.prng = i(229), e.createHash = e.Hash = i(212), e.createHmac = e.Hmac = i(177);
    var r = i(1),
        n = Object.keys(r),
    ...
    var u = i(85);
    e.createSign = u.createSign, e.Sign = u.Sign, e.createVerify = u.createVerify, e.Verify = u.Verify, e.createECDH = i(273);
    var c = i(367);
    ...
    var r = i(169).Reporter,
        n = i(169).EncoderBuffer,
        o = i(169).DecoderBuffer,
        a = i(220),
    ...
    "use strict";
    var r = e;
    r.base = i(303), r.short = i(285), r.mont = i(190), r.edwards = i(89)
}, , , function(t, e, i) {
    "use strict";
    var r = i(57),
        n = i(8).utils,
    ...
    e.define = function(t, e) {
        ...
        var e;
        try {
            e = i(368).runInThisContext("(function " + this.name + "(entity) {\n  this._initNamed(entity);\n})")
        } catch (t) {
            e = function(t) {
                this._initNamed(t)
            }
    ...
    i(225)(a, o), a.prototype._update = function(t) {
    ...
    e.pbkdf2 = i(84), e.pbkdf2Sync = i(138)
}, function(t) {
    t.exports = {
        "aes-128-ecb": {
            cipher: "AES",
    ...
    var r = e;
    r.bignum = i(57), r.define = i(320).define, r.base = i(169), r.constants = i(61), r.decoders = i(209), r.encoders = i(342)
}, function(t, e, i) {
    var r = i(276),
        n = i(183).Buffer,
        o = i(109);
    ...
    e.publicEncrypt = i(189), e.privateDecrypt = i(317), e.privateEncrypt = function(t, i) {
        return e.publicEncrypt(t, i, !0)
    }, e.publicDecrypt = function(t, i) {
        return e.privateDecrypt(t, i, !0)
    }
}, function(module, exports, __webpack_require__) {
    var indexOf = __webpack_require__(321),
