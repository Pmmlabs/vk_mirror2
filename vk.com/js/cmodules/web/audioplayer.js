! function(t) {
    ...
    i(355)(f, s), f.prototype._update = function(t) {
        var e, i;
        this._cache.add(t);
    ...
    r.inherits(f, u), e.ripemd160 = f, f.blockSize = 512, f.outSize = 160, f.hmacStrength = 192, f.padLength = 64, f.prototype._update = function(t, e) {
        for (var i = this.h[0], r = this.h[1], n = this.h[2], u = this.h[3], f = this.h[4], g = i, v = r, m = n, A = u, E = f, w = 0; w < 80; w++) {
            var P = a(o(d(i, c(w, r, n, u), t[_[w] + e], l(w)), y[w]), f);
            i = f, f = u, u = o(n, 10), n = r, r = P, P = a(o(d(g, c(79 - w, v, m, A), t[p[w] + e], h(w)), b[w]), E), g = E, E = A, A = o(m, 10), m = v, v = P
        }
        P = s(this.h[1], n, A), this.h[1] = s(this.h[2], u, E), this.h[2] = s(this.h[3], f, g), this.h[3] = s(this.h[4], i, v), this.h[4] = s(this.h[0], r, m), this.h[0] = P
    ...
    var _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(105),
        _audioplayer_audio_unmask_source__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(297),
        _node_modules_node_uuid_uuid__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(54),
        _shared_im_longpoll_events__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(181),
        _audioplayer_audioplayer_utils__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(218);
    window.TopAudioPlayer = function(t, e) {
        ...
        function e(e) {
            return hasClass(this, "top_audio_player_play") ? (t.ap.isPlaying() ? t.ap.pause() : (t.ap.play(), t.ap.updateStartRef(t.ap.getCurrentAudio(), "top_player")), !1) : hasClass(this, "top_audio_player_prev") ? (t.ap.playPrev(), !1) : hasClass(this, "top_audio_player_next") ? (t.ap.playNext(), !1) : void 0
        }
        ...
        function s() {
            ...
            if (0 != i) {
                var d = i < 0 ? -10 : 10,
                    u = s.offsetLeft,
                    f = se('<div class="top_audio_player_title top_audio_player_title_next" style="opacity: 0; top:' + d + "px; left: " + u + 'px">' + t.performer + " &ndash; " + t.title + "</div>");
    ...
    AudioPlaylist.prototype.isFullyLoadable = function() {
        ...
        var trackType = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : "default";
        ...
        if (this._currentAudio = !1, this._isPlaying = !1, this._prevPlaylist = null, this._currentPlaylist = null, this._playlists = [], this.subscribers = [], this._tasks = [], this._statusExport = {}, this._currentPlayingRows = [], this._podcasts = {
                episodes: {}
            }, this._startRef = "", this._allowPrefetchNext = !1, !vk.isBanned) {
        ...
        function s() {
            ...
            if (r.withInlinePlayer && (e ? this._addRowPlayer(t, i) : this._removeRowPlayer(t)), e) {
                ...
                if (!d && (r.isWithCovers || r.isNumeric)) {
                    if (d = se('<canvas class="audio_row__sound_bars"></canvas>'), t.appendChild(d), d.width = _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.AUDIO_ROW_COVER_SIZE * (isRetina() ? 2 : 1), d.height = _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.AUDIO_ROW_COVER_SIZE * (isRetina() ? 2 : 1), d.style.width = _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.AUDIO_ROW_COVER_SIZE, d.style.height = _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.AUDIO_ROW_COVER_SIZE, isRetina()) d.getContext("2d").scale(2, 2);
                    var u = r.isNumeric;
                    this.on(t, AudioPlayer.EVENT_FREQ_UPDATE, function(t, e) {
                        _updateAudioSoundBars(d, e, u)
                    }), _updateAudioSoundBars(d, [0, 0, 0, 0], u), data(t, "bars", d)
                }
        ...
        if (i.push(r.fullId), i.length) {
            ...
            ajax.post("al_audio.php", {
                ...
                onDone: function(i, n, o, a) {
                    getAudioPlayer().setStatusExportInfo(n), d._listenedHash = o, a && getAudioPlayer()._podcastSaveData(a), each(i, function(e, i) {
                        i = _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.asObject(i);
                        var n = {};
                        n[_audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.AUDIO_ITEM_INDEX_URL] = i.url, n[_audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.AUDIO_ITEM_INDEX_ADS] = i.ads, d.updateAudio(i.fullId, n), r.fullId == i.fullId && (t[_audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.AUDIO_ITEM_INDEX_URL] = i.url, t[_audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.AUDIO_ITEM_INDEX_ADS] = i.ads), d._currentAudio && _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.asObject(d._currentAudio).fullId == i.fullId && (d._currentAudio[_audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.AUDIO_ITEM_INDEX_URL] = i.url, d._currentAudio[_audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.AUDIO_ITEM_INDEX_ADS] = i.ads), delete d._currentUrlEnsure[i.fullId]
                    }), e && e(t)
                }
            })
        }
        ...
        if (hasClass(e.target, "_audio_row__title_inner")) {
            if (_audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.isPodcast(r)) return showPodcast(r.fullId, null, "audio"), cancelEvent(e);
        ...
        if (r.isPlaying) this.pause();
            ...
            var d = _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.getContextPlaylist(i);
            this.play(r.fullId, d.playlist, r.context || d.context), cur.audioPage && cur.audioPage.onUserAction(r, d.playlist), this.updateStartRef(r, "", i)
        }
        ...
        var o = this,
            a = arguments.length > 5 && void 0 !== arguments[5] ? arguments[5] : "default",
            s = this.getCurrentPlaylist(),
            d = this.getPlaylist(n || AudioPlaylist.TYPE_PLAYLIST, t, e, i);
        if (s && s.getId() == d.getId() && this.isPlaying()) this.pause();
        else {
            var u = function() {
                var t = d.getNextAudio(!1, !0);
                t && o.play(t, d, r)
            };
            d.load(0, u, null, a), d.getAudiosCount() && u()
        }
        ...
        if (!cur.loggingOff)
            if (this._impl) {
                ...
                }.bind(this)) : (this._implSetVolume(0, !0), this._implPause(), this._startAdsPlay(u, e, !0, function() {
                    (u = this.getCurrentAudio()) && this.isPlaying() && (this.notify(AudioPlayer.EVENT_UPDATE), this._implSetUrl(u), this._implPlay(), this._updatePlaybackRate(), this._implSetVolume(this.getVolume()), this._triggerTNSPixel())
                }.bind(this)))))
        ...
        if (r || !(this._podcasts._logFrom > e)) {
            ...
            if (this._podcasts._logFrom && !r) {
                ...
                for (var d = Math.floor(this._podcasts._logFrom / n); d <= a; d++)
                    if (this._podcasts._logFrom = d * n, !this._podcasts.episodes[t.fullId].partsProcessed[d]) {
                        if (!((a > d || a === _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.AUDIO_PODCAST_PART_COUNT ? 1 : s) >= _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.AUDIO_PODCAST_PART_LISTEN)) break;
                        this._podcasts.episodes[t.fullId].partsProcessed[d] = this._podcasts.episodes[t.fullId].parts[d] = !0
                    }
        ...
        each(this._podcasts.updated, function(i) {
            ...
            var r = t._podcasts.episodes[i],
                ...
                u = "feed" === cur.module && feed ? feed.getModuleRef() : cur.module,
                f = "play" === s ? t.getStartRef() : "";
            n[i] && (e.push([i, n[i].position, Math.max(0, o - a), d.join(","), t.podcastGetPlaybackRate(), s, u, f].join(":")), r.listen = 0, r.logListen = o, r.parts = {}, delete r.logAction)
    ...
    }, AudioPlayer.prototype.updateStartRef = function(t, e, i) {
        var r = _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.isPodcast(t);
        this._startRef = "", r && (e ? this._startRef = e : i && (gpeByClass("podcast_snippet", i) ? this._startRef = "snippet" : gpeByClass("podcast_page_list", i) ? this._startRef = "page_list" : gpeByClass("podcast_episode_layer__header", i) ? this._startRef = "episode" : gpeByClass("podcast_episode_layer__list", i) ? this._startRef = "episode_list" : gpeByClass("audio_section__podcast", i) && (this._startRef = "player_list")))
    }, AudioPlayer.prototype.getStartRef = function() {
        return this._startRef || ""
    ...
    n.inherits = i(355), n.inherits(o, r), o.prototype._transform = function(t, e, i) {
        i(null, t)
    }
}, function(t, e, i) {
    "use strict";
    e.sha1 = i(34), e.sha224 = i(131), e.sha256 = i(76), e.sha384 = i(12), e.sha512 = i(259)
}, function(t, e, i) {
    var r = i(171),
        n = i(280);
    ...
    t.exports = o, o.create = function(t) {
        ...
        for (var u = t.shrn(d), f = s.toRed(o); e > 0; e--) {
    ...
    r(d, n), d.prototype.init = function() {
        ...
        for (var e, i = this._w, r = 0 | this._a, n = 0 | this._b, o = 0 | this._c, s = 0 | this._d, d = 0 | this._e, _ = 0 | this._f, p = 0 | this._g, y = 0 | this._h, b = 0; b < 16; ++b) i[b] = t.readInt32BE(4 * b);
        for (; b < 64; ++b) i[b] = 0 | (((e = i[b - 2]) >>> 17 | e << 15) ^ (e >>> 19 | e << 13) ^ e >>> 10) + i[b - 7] + h(i[b - 15]) + i[b - 16];
        for (var g = 0; g < 64; ++g) {
            var v = y + l(d) + u(d, _, p) + a[g] + i[g] | 0,
                m = c(r) + f(r, n, o) | 0;
            y = p, p = _, _ = d, d = s + v | 0, s = o, o = n, n = r, r = v + m | 0
        }
        this._a = r + this._a | 0, this._b = n + this._b | 0, this._c = o + this._c | 0, this._d = s + this._d | 0, this._e = d + this._e | 0, this._f = _ + this._f | 0, this._g = p + this._g | 0, this._h = y + this._h | 0
    ...
    (function(t) {
        ...
        }, i(118), e.setImmediate = "undefined" != typeof self && self.setImmediate || void 0 !== t && t.setImmediate || this && this.setImmediate, e.clearImmediate = "undefined" != typeof self && self.clearImmediate || void 0 !== t && t.clearImmediate || this && this.clearImmediate
    }).call(this, i(162))
}, function(t, e, i) {
    "use strict";
    ...
    function r(t, e, i, r, n) {
        ...
        function h() {
            ...
            }) : r, toggle(s, 0 != t.length), toggle(u, 0 == t.length), l = new AutoList(s, {
    ...
    r(d, n), d.prototype.init = function() {
        ...
        for (var h = 0; h < 80; ++h) {
            var _ = ~~(h / 20),
                p = u(r) + c(_, n, o, s) + d + i[h] + a[_] | 0;
            d = s, s = o, o = f(n), n = r, r = p
        }
    ...
    (function(r) {
        ...
        ! function(o) {
            ...
            A.v1 = function(t, e, i) {
                ...
                return e
            }, A.unparse = _, A.BufferClass = f, A._rng = a, A._mathRNG = s, A._nodeRNG = d, A._whatwgRNG = u, void 0 !== t && t.exports ? t.exports = A : void 0 === (n = function() {
                return A
    ...
    "use strict";
    __webpack_require__.r(__webpack_exports__);
    var _lib_debug_tools__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(123);
    ...
    (function(e) {
        ...
        t.exports = function(t, i) {
            ...
            if (f) {
                ...
                p.push(y.update(h)), p.push(y.final()), d = e.concat(p)
            } else {
                var b = u.match(o);
                d = new e(b[2].replace(/[\r\n]/g, ""), "base64")
            }
    ...
    var r = e;
    r.utils = i(214), r.common = i(206), r.sha = i(27), r.ripemd = i(22), r.hmac = i(351), r.sha1 = r.sha.sha1, r.sha256 = r.sha.sha256, r.sha224 = r.sha.sha224, r.sha384 = r.sha.sha384, r.sha512 = r.sha.sha512, r.ripemd160 = r.ripemd.ripemd160
}, , function(t, e, i) {
    "use strict";
    var r = i(350),
        n = i(341),
    ...
    a(u, s), t.exports = u, u.prototype._mulA = function(t) {
        ...
        return 0 === r.cmp(n)
    }, a(f, s.BasePoint), u.prototype.pointFromJSON = function(t) {
        ...
        return this.curve.twisted ? (e = r.redMul(u).redMul(a.redSub(this.curve._mulA(o))), i = d.redMul(u)) : (e = r.redMul(u).redMul(a.redSub(o)), i = this.curve._mulC(d).redMul(u)), this.curve.point(c, e, i)
    ...
    e.byteLength = function(t) {
        ...
        for (var e, i = u(t), r = i[0], a = i[1], s = new o(function(t, e, i) {
                return 3 * (e + i) / 4 - i
            }(0, r, a)), d = 0, f = a > 0 ? r - 4 : r, c = 0; c < f; c += 4) e = n[t.charCodeAt(c)] << 18 | n[t.charCodeAt(c + 1)] << 12 | n[t.charCodeAt(c + 2)] << 6 | n[t.charCodeAt(c + 3)], s[d++] = e >> 16 & 255, s[d++] = e >> 8 & 255, s[d++] = 255 & e;
        2 === a && (e = n[t.charCodeAt(c)] << 2 | n[t.charCodeAt(c + 1)] >> 4, s[d++] = 255 & e);
        1 === a && (e = n[t.charCodeAt(c)] << 10 | n[t.charCodeAt(c + 1)] << 4 | n[t.charCodeAt(c + 2)] >> 2, s[d++] = e >> 8 & 255, s[d++] = 255 & e);
        return s
    ...
    r.inherits(g, y), t.exports = g, g.blockSize = 512, g.outSize = 256, g.hmacStrength = 192, g.padLength = 64, g.prototype._update = function(t, e) {
        for (var i = this.W, r = 0; r < 16; r++) i[r] = t[e + r];
        for (; r < i.length; r++) i[r] = d(p(i[r - 2]), i[r - 7], _(i[r - 15]), i[r - 16]);
        var n = this.h[0],
            o = this.h[1],
            y = this.h[2],
            b = this.h[3],
        ...
        for (a(this.k.length === i.length), r = 0; r < i.length; r++) {
            var E = u(A, h(g), f(g, v, m), this.k[r], i[r]),
                w = s(l(n), c(n, o, y));
    ...
    "use strict";
    e.randomBytes = e.rng = e.pseudoRandomBytes = e.prng = i(294), e.createHash = e.Hash = i(133), e.createHmac = e.Hmac = i(231);
    var r = i(82),
        n = Object.keys(r),
    ...
    var u = i(225);
    e.createSign = u.createSign, e.Sign = u.Sign, e.createVerify = u.createVerify, e.Verify = u.Verify, e.createECDH = i(268);
    var f = i(306);
    ...
    e.read = function(t, e, i, r, n) {
        ...
        var a, s, d, u = 8 * o - n - 1,
            ...
            _ = r ? 1 : -1,
            p = e < 0 || 0 === e && 1 / e < 0 ? 1 : 0;
        for (e = Math.abs(e), isNaN(e) || e === 1 / 0 ? (s = isNaN(e) ? 1 : 0, a = f) : (a = Math.floor(Math.log(e) / Math.LN2), e * (d = Math.pow(2, -a)) < 1 && (a--, d *= 2), (e += a + c >= 1 ? l / d : l * Math.pow(2, 1 - c)) * d >= 2 && (a++, d /= 2), a + c >= f ? (s = 0, a = f) : a + c >= 1 ? (s = (e * d - 1) * Math.pow(2, n), a += c) : (s = e * Math.pow(2, c - 1) * Math.pow(2, n), a = 0)); n >= 8; t[i + h] = 255 & s, h += _, s /= 256, n -= 8);
        for (a = a << n | s, u += n; u > 0; t[i + h] = 255 & a, h += _, a /= 256, u -= 8);
        t[i + h - _] |= 128 * p
    }
}, function(t, e, i) {
    "use strict";
    ...
    n.inherits = i(355), n.inherits(o, r), o.prototype.push = function(t, e) {
    ...
    function r(t, e) {
        e = AudioUtils.asObject(e), AudioUtils.isPodcast(e) && showPodcast(e.fullId, null, "audio")
    }
    ...
    var r = e;
    r.bignum = i(171), r.define = i(204).define, r.base = i(208), r.constants = i(319), r.decoders = i(154), r.encoders = i(223)
}, function(t, e, i) {
    "use strict";
    ...
    function s(t) {
        if (a[t]) return a[t];
        for (var e = t ? t.length : 0, i = [], n = [], s = "", d = 0; d < e; d++) {
            var u = t[d],
                f = u.charCodeAt(0);
                    ...
                    if (!d) {
                        ...
                        a && (t = (a = a.split("_"))[0], o = a[1]), i && (AudioUtils.copiedToPlaylistAudiosHashes[r] = e[4]), ajax.post("al_audio.php", {
                            ...
                            onDone: function(t, n, o) {
                                AudioUtils.copiedToPlaylistAudios[r] = !!i && o, e[4] = i ? t : AudioUtils.copiedToPlaylistAudiosHashes[r], i = !i, d = !1
                            }
    ...
    i(355)(n, r), n.Readable = i(129), n.Writable = i(70), n.Duplex = i(183), n.Transform = i(4), n.PassThrough = i(343), n.Stream = n, n.prototype.pipe = function(t, e) {
        var i = this;
        ...
        function f() {
            i.removeListener("data", n), t.removeListener("drain", o), i.removeListener("end", s), i.removeListener("close", d), i.removeListener("error", u), t.removeListener("error", u), i.removeListener("end", f), i.removeListener("close", f), t.removeListener("close", f)
        }
    ...
    window.AudioLayer = ut.default, window.AudioUtils = ft({}, r.AUDIO_PLAYER_ENUMS, {
    ...
    (e = t.exports = function(t) {
        ...
        return new i
    }).sha = i(164), e.sha1 = i(48), e.sha224 = i(360), e.sha256 = i(33), e.sha384 = i(298), e.sha512 = i(307)
}, function(t, e, i) {
    var r = i(124),
        n = i(6).Buffer,
        o = i(290);
    ...
    i(355)(a, o), a.prototype._update = function(t) {
    ...
    function a(t, e, i, r, n) {
        for (var o, a, s, d, u = i[0], f = i[1], c = i[2], l = i[3], h = t[0] ^ e[0], _ = t[1] ^ e[1], p = t[2] ^ e[2], y = t[3] ^ e[3], b = 4, g = 1; g < n; g++) o = u[h >>> 24] ^ f[_ >>> 16 & 255] ^ c[p >>> 8 & 255] ^ l[255 & y] ^ e[b++], a = u[_ >>> 24] ^ f[p >>> 16 & 255] ^ c[y >>> 8 & 255] ^ l[255 & h] ^ e[b++], s = u[p >>> 24] ^ f[y >>> 16 & 255] ^ c[h >>> 8 & 255] ^ l[255 & _] ^ e[b++], d = u[y >>> 24] ^ f[h >>> 16 & 255] ^ c[_ >>> 8 & 255] ^ l[255 & p] ^ e[b++], h = o, _ = a, p = s, y = d;
        return o = (r[h >>> 24] << 24 | r[_ >>> 16 & 255] << 16 | r[p >>> 8 & 255] << 8 | r[255 & y]) ^ e[b++], a = (r[_ >>> 24] << 24 | r[p >>> 16 & 255] << 16 | r[y >>> 8 & 255] << 8 | r[255 & h]) ^ e[b++], s = (r[p >>> 24] << 24 | r[y >>> 16 & 255] << 16 | r[h >>> 8 & 255] << 8 | r[255 & _]) ^ e[b++], d = (r[y >>> 24] << 24 | r[h >>> 16 & 255] << 16 | r[_ >>> 8 & 255] << 8 | r[255 & p]) ^ e[b++], [o >>>= 0, a >>>= 0, s >>>= 0, d >>>= 0]
    }
    var s = [0, 1, 2, 4, 8, 16, 32, 64, 128, 27, 54],
        d = function() {
            ...
            for (var i = [], r = [], n = [
                ...
                n[0][a] = h << 24 | h >>> 8, n[1][a] = h << 16 | h >>> 16, n[2][a] = h << 8 | h >>> 24, n[3][a] = h, h = 16843009 * l ^ 65537 * c ^ 257 * f ^ 16843008 * a, o[0][u] = h << 24 | h >>> 8, o[1][u] = h << 16 | h >>> 16, o[2][u] = h << 8 | h >>> 24, o[3][u] = h, 0 === a ? a = s = 1 : (a = f ^ t[t[t[l ^ f]]], s ^= t[t[s]])
            }
            return {
                SBOX: i,
                INV_SBOX: r,
    ...
    (e = t.exports = i(281)).Stream = e, e.Readable = e, e.Writable = i(323), e.Duplex = i(242), e.Transform = i(80), e.PassThrough = i(26)
}, , function(t, e, i) {
    "use strict";
    var r = i(214),
        n = i(76);
    ...
    (function(e) {
        ...
        t.exports = function(t, i, c) {
            ...
            if (4 === l) h = function(t, i) {
                ...
                if ((h = new d(i)).cmp(_.modulus) >= 0) throw new Error("data too long for modulus")
            }
            return c ? f(h, _) : u(h, _)
        }
    }).call(this, i(179).Buffer)
}, function(t, e, i) {
    "use strict";
            ...
            new AudioPlaylist({
                ...
                l && (cur.apLayerAutoList = new AutoList(_, {
                    ...
                    onNeedRows: function(t, e) {
                        for (var i = [], r = d.getUnshuffledAudiosList(), n = e; n < e + 30 && r[n]; n++) i.push(AudioUtils.drawAudio(r[n]));
                        t(i)
                    }
                }));
        ...
        t.exports = function(t, i, d, u, f) {
            ...
            if ("dsa" === c.type) {
                ...
                return function(t, e, i) {
                    ...
                    var h = r.mont(n),
                        _ = c.invm(a);
                    return 0 === d.toRed(h).redPow(new r(e).mul(_).mod(a)).fromRed().mul(u.toRed(h).redPow(l.mul(_).mod(a)).fromRed()).mod(n).mod(a).cmp(l)
                }(t, i, c)
            }
    ...
    t.exports = u, u.prototype.keyPair = function(t) {
        ...
        for (var a = this.n.byteLength(), s = e.getPrivate().toArray("be", a), u = t.toArray("be", a), f = new n({
                hash: this.hash,
                entropy: s,
                nonce: u,
                pers: o.pers,
    ...
    d.prototype.deriveKeys = function(t, e) {
        ...
        for (var o = e, s = i, d = 0; d < t.keys.length; d += 2) {
            var u = t.keys[d],
                f = t.keys[d + 1];
            a.expand(s, t.tmp, 0), u ^= t.tmp[0], f ^= t.tmp[1];
        ...
        for (var o = i, s = e, d = t.keys.length - 2; d >= 0; d -= 2) {
            var u = t.keys[d],
                f = t.keys[d + 1];
            a.expand(o, t.tmp, 0), u ^= t.tmp[0], f ^= t.tmp[1];
            var c = a.substitute(u, f),
                l = o;
    ...
    e.pbkdf2 = i(138), e.pbkdf2Sync = i(7)
}, , function(t, e) {
    var i;
    i = function() {
        return this
    ...
    r(d, n), d.prototype.init = function() {
        ...
        for (var e, i = this._w, r = 0 | this._a, n = 0 | this._b, o = 0 | this._c, s = 0 | this._d, d = 0 | this._e, c = 0; c < 16; ++c) i[c] = t.readInt32BE(4 * c);
        for (; c < 80; ++c) i[c] = i[c - 3] ^ i[c - 8] ^ i[c - 14] ^ i[c - 16];
        for (var l = 0; l < 80; ++l) {
            var h = ~~(l / 20),
                _ = 0 | ((e = r) << 5 | e >>> 27) + f(h, n, o, s) + d + i[l] + a[h];
            d = s, s = o, o = u(n), n = r, r = _
        }
        this._a = r + this._a | 0, this._b = n + this._b | 0, this._c = o + this._c | 0, this._d = s + this._d | 0, this._e = d + this._e | 0
    }, d.prototype._hash = function() {
        var t = o.allocUnsafe(20);
    ...
    (function(t) {
        ! function(t, e) {
            ...
            o.isBN = function(t) {
                ...
                r--, n = n / e | 0;
                for (var o = t.length - i, a = o % r, s = Math.min(o, o - a) + i, u = 0, f = i; f < s; f += r) u = d(t, f, f + r, e), this.imuln(n), this.words[0] + u < 67108864 ? this.words[0] += u : this._iaddn(u);
                if (0 !== a) {
                    var c = 1;
                    for (u = d(t, f, t.length, e), f = 0; f < a; f++) c *= e;
            ...
            o.prototype.toString = function(t, e) {
                ...
                if (t === (0 | t) && t >= 2 && t <= 36) {
                    ...
                    for (_.negative = 0; !_.isZero();) {
                        ...
                        i = (_ = _.idivn(h)).isZero() ? p + i : u[l - p.length] + p + i
                    }
            ...
            var h = function(t, e, i) {
                ...
                var yt = (u + (r = Math.imul(c, F)) | 0) + ((8191 & (n = (n = Math.imul(c, W)) + Math.imul(l, F) | 0)) << 13) | 0;
                u = ((o = Math.imul(l, W)) + (n >>> 13) | 0) + (yt >>> 26) | 0, yt &= 67108863, r = Math.imul(_, F), n = (n = Math.imul(_, W)) + Math.imul(p, F) | 0, o = Math.imul(p, W);
                var bt = (u + (r = r + Math.imul(c, q) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(c, V) | 0) + Math.imul(l, q) | 0)) << 13) | 0;
                u = ((o = o + Math.imul(l, V) | 0) + (n >>> 13) | 0) + (bt >>> 26) | 0, bt &= 67108863, r = Math.imul(b, F), n = (n = Math.imul(b, W)) + Math.imul(g, F) | 0, o = Math.imul(g, W), r = r + Math.imul(_, q) | 0, n = (n = n + Math.imul(_, V) | 0) + Math.imul(p, q) | 0, o = o + Math.imul(p, V) | 0;
                var gt = (u + (r = r + Math.imul(c, Y) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(c, X) | 0) + Math.imul(l, Y) | 0)) << 13) | 0;
                u = ((o = o + Math.imul(l, X) | 0) + (n >>> 13) | 0) + (gt >>> 26) | 0, gt &= 67108863, r = Math.imul(m, F), n = (n = Math.imul(m, W)) + Math.imul(A, F) | 0, o = Math.imul(A, W), r = r + Math.imul(b, q) | 0, n = (n = n + Math.imul(b, V) | 0) + Math.imul(g, q) | 0, o = o + Math.imul(g, V) | 0, r = r + Math.imul(_, Y) | 0, n = (n = n + Math.imul(_, X) | 0) + Math.imul(p, Y) | 0, o = o + Math.imul(p, X) | 0;
                var vt = (u + (r = r + Math.imul(c, J) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(c, Q) | 0) + Math.imul(l, J) | 0)) << 13) | 0;
                u = ((o = o + Math.imul(l, Q) | 0) + (n >>> 13) | 0) + (vt >>> 26) | 0, vt &= 67108863, r = Math.imul(w, F), n = (n = Math.imul(w, W)) + Math.imul(P, F) | 0, o = Math.imul(P, W), r = r + Math.imul(m, q) | 0, n = (n = n + Math.imul(m, V) | 0) + Math.imul(A, q) | 0, o = o + Math.imul(A, V) | 0, r = r + Math.imul(b, Y) | 0, n = (n = n + Math.imul(b, X) | 0) + Math.imul(g, Y) | 0, o = o + Math.imul(g, X) | 0, r = r + Math.imul(_, J) | 0, n = (n = n + Math.imul(_, Q) | 0) + Math.imul(p, J) | 0, o = o + Math.imul(p, Q) | 0;
                var mt = (u + (r = r + Math.imul(c, $) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(c, tt) | 0) + Math.imul(l, $) | 0)) << 13) | 0;
                u = ((o = o + Math.imul(l, tt) | 0) + (n >>> 13) | 0) + (mt >>> 26) | 0, mt &= 67108863, r = Math.imul(S, F), n = (n = Math.imul(S, W)) + Math.imul(M, F) | 0, o = Math.imul(M, W), r = r + Math.imul(w, q) | 0, n = (n = n + Math.imul(w, V) | 0) + Math.imul(P, q) | 0, o = o + Math.imul(P, V) | 0, r = r + Math.imul(m, Y) | 0, n = (n = n + Math.imul(m, X) | 0) + Math.imul(A, Y) | 0, o = o + Math.imul(A, X) | 0, r = r + Math.imul(b, J) | 0, n = (n = n + Math.imul(b, Q) | 0) + Math.imul(g, J) | 0, o = o + Math.imul(g, Q) | 0, r = r + Math.imul(_, $) | 0, n = (n = n + Math.imul(_, tt) | 0) + Math.imul(p, $) | 0, o = o + Math.imul(p, tt) | 0;
                var At = (u + (r = r + Math.imul(c, it) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(c, rt) | 0) + Math.imul(l, it) | 0)) << 13) | 0;
                u = ((o = o + Math.imul(l, rt) | 0) + (n >>> 13) | 0) + (At >>> 26) | 0, At &= 67108863, r = Math.imul(D, F), n = (n = Math.imul(D, W)) + Math.imul(L, F) | 0, o = Math.imul(L, W), r = r + Math.imul(S, q) | 0, n = (n = n + Math.imul(S, V) | 0) + Math.imul(M, q) | 0, o = o + Math.imul(M, V) | 0, r = r + Math.imul(w, Y) | 0, n = (n = n + Math.imul(w, X) | 0) + Math.imul(P, Y) | 0, o = o + Math.imul(P, X) | 0, r = r + Math.imul(m, J) | 0, n = (n = n + Math.imul(m, Q) | 0) + Math.imul(A, J) | 0, o = o + Math.imul(A, Q) | 0, r = r + Math.imul(b, $) | 0, n = (n = n + Math.imul(b, tt) | 0) + Math.imul(g, $) | 0, o = o + Math.imul(g, tt) | 0, r = r + Math.imul(_, it) | 0, n = (n = n + Math.imul(_, rt) | 0) + Math.imul(p, it) | 0, o = o + Math.imul(p, rt) | 0;
                var Et = (u + (r = r + Math.imul(c, ot) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(c, at) | 0) + Math.imul(l, ot) | 0)) << 13) | 0;
                u = ((o = o + Math.imul(l, at) | 0) + (n >>> 13) | 0) + (Et >>> 26) | 0, Et &= 67108863, r = Math.imul(O, F), n = (n = Math.imul(O, W)) + Math.imul(U, F) | 0, o = Math.imul(U, W), r = r + Math.imul(D, q) | 0, n = (n = n + Math.imul(D, V) | 0) + Math.imul(L, q) | 0, o = o + Math.imul(L, V) | 0, r = r + Math.imul(S, Y) | 0, n = (n = n + Math.imul(S, X) | 0) + Math.imul(M, Y) | 0, o = o + Math.imul(M, X) | 0, r = r + Math.imul(w, J) | 0, n = (n = n + Math.imul(w, Q) | 0) + Math.imul(P, J) | 0, o = o + Math.imul(P, Q) | 0, r = r + Math.imul(m, $) | 0, n = (n = n + Math.imul(m, tt) | 0) + Math.imul(A, $) | 0, o = o + Math.imul(A, tt) | 0, r = r + Math.imul(b, it) | 0, n = (n = n + Math.imul(b, rt) | 0) + Math.imul(g, it) | 0, o = o + Math.imul(g, rt) | 0, r = r + Math.imul(_, ot) | 0, n = (n = n + Math.imul(_, at) | 0) + Math.imul(p, ot) | 0, o = o + Math.imul(p, at) | 0;
                var wt = (u + (r = r + Math.imul(c, dt) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(c, ut) | 0) + Math.imul(l, dt) | 0)) << 13) | 0;
                u = ((o = o + Math.imul(l, ut) | 0) + (n >>> 13) | 0) + (wt >>> 26) | 0, wt &= 67108863, r = Math.imul(R, F), n = (n = Math.imul(R, W)) + Math.imul(x, F) | 0, o = Math.imul(x, W), r = r + Math.imul(O, q) | 0, n = (n = n + Math.imul(O, V) | 0) + Math.imul(U, q) | 0, o = o + Math.imul(U, V) | 0, r = r + Math.imul(D, Y) | 0, n = (n = n + Math.imul(D, X) | 0) + Math.imul(L, Y) | 0, o = o + Math.imul(L, X) | 0, r = r + Math.imul(S, J) | 0, n = (n = n + Math.imul(S, Q) | 0) + Math.imul(M, J) | 0, o = o + Math.imul(M, Q) | 0, r = r + Math.imul(w, $) | 0, n = (n = n + Math.imul(w, tt) | 0) + Math.imul(P, $) | 0, o = o + Math.imul(P, tt) | 0, r = r + Math.imul(m, it) | 0, n = (n = n + Math.imul(m, rt) | 0) + Math.imul(A, it) | 0, o = o + Math.imul(A, rt) | 0, r = r + Math.imul(b, ot) | 0, n = (n = n + Math.imul(b, at) | 0) + Math.imul(g, ot) | 0, o = o + Math.imul(g, at) | 0, r = r + Math.imul(_, dt) | 0, n = (n = n + Math.imul(_, ut) | 0) + Math.imul(p, dt) | 0, o = o + Math.imul(p, ut) | 0;
                var Pt = (u + (r = r + Math.imul(c, ct) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(c, lt) | 0) + Math.imul(l, ct) | 0)) << 13) | 0;
                u = ((o = o + Math.imul(l, lt) | 0) + (n >>> 13) | 0) + (Pt >>> 26) | 0, Pt &= 67108863, r = Math.imul(N, F), n = (n = Math.imul(N, W)) + Math.imul(j, F) | 0, o = Math.imul(j, W), r = r + Math.imul(R, q) | 0, n = (n = n + Math.imul(R, V) | 0) + Math.imul(x, q) | 0, o = o + Math.imul(x, V) | 0, r = r + Math.imul(O, Y) | 0, n = (n = n + Math.imul(O, X) | 0) + Math.imul(U, Y) | 0, o = o + Math.imul(U, X) | 0, r = r + Math.imul(D, J) | 0, n = (n = n + Math.imul(D, Q) | 0) + Math.imul(L, J) | 0, o = o + Math.imul(L, Q) | 0, r = r + Math.imul(S, $) | 0, n = (n = n + Math.imul(S, tt) | 0) + Math.imul(M, $) | 0, o = o + Math.imul(M, tt) | 0, r = r + Math.imul(w, it) | 0, n = (n = n + Math.imul(w, rt) | 0) + Math.imul(P, it) | 0, o = o + Math.imul(P, rt) | 0, r = r + Math.imul(m, ot) | 0, n = (n = n + Math.imul(m, at) | 0) + Math.imul(A, ot) | 0, o = o + Math.imul(A, at) | 0, r = r + Math.imul(b, dt) | 0, n = (n = n + Math.imul(b, ut) | 0) + Math.imul(g, dt) | 0, o = o + Math.imul(g, ut) | 0, r = r + Math.imul(_, ct) | 0, n = (n = n + Math.imul(_, lt) | 0) + Math.imul(p, ct) | 0, o = o + Math.imul(p, lt) | 0;
                var It = (u + (r = r + Math.imul(c, _t) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(c, pt) | 0) + Math.imul(l, _t) | 0)) << 13) | 0;
                u = ((o = o + Math.imul(l, pt) | 0) + (n >>> 13) | 0) + (It >>> 26) | 0, It &= 67108863, r = Math.imul(N, q), n = (n = Math.imul(N, V)) + Math.imul(j, q) | 0, o = Math.imul(j, V), r = r + Math.imul(R, Y) | 0, n = (n = n + Math.imul(R, X) | 0) + Math.imul(x, Y) | 0, o = o + Math.imul(x, X) | 0, r = r + Math.imul(O, J) | 0, n = (n = n + Math.imul(O, Q) | 0) + Math.imul(U, J) | 0, o = o + Math.imul(U, Q) | 0, r = r + Math.imul(D, $) | 0, n = (n = n + Math.imul(D, tt) | 0) + Math.imul(L, $) | 0, o = o + Math.imul(L, tt) | 0, r = r + Math.imul(S, it) | 0, n = (n = n + Math.imul(S, rt) | 0) + Math.imul(M, it) | 0, o = o + Math.imul(M, rt) | 0, r = r + Math.imul(w, ot) | 0, n = (n = n + Math.imul(w, at) | 0) + Math.imul(P, ot) | 0, o = o + Math.imul(P, at) | 0, r = r + Math.imul(m, dt) | 0, n = (n = n + Math.imul(m, ut) | 0) + Math.imul(A, dt) | 0, o = o + Math.imul(A, ut) | 0, r = r + Math.imul(b, ct) | 0, n = (n = n + Math.imul(b, lt) | 0) + Math.imul(g, ct) | 0, o = o + Math.imul(g, lt) | 0;
                var St = (u + (r = r + Math.imul(_, _t) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(_, pt) | 0) + Math.imul(p, _t) | 0)) << 13) | 0;
                u = ((o = o + Math.imul(p, pt) | 0) + (n >>> 13) | 0) + (St >>> 26) | 0, St &= 67108863, r = Math.imul(N, Y), n = (n = Math.imul(N, X)) + Math.imul(j, Y) | 0, o = Math.imul(j, X), r = r + Math.imul(R, J) | 0, n = (n = n + Math.imul(R, Q) | 0) + Math.imul(x, J) | 0, o = o + Math.imul(x, Q) | 0, r = r + Math.imul(O, $) | 0, n = (n = n + Math.imul(O, tt) | 0) + Math.imul(U, $) | 0, o = o + Math.imul(U, tt) | 0, r = r + Math.imul(D, it) | 0, n = (n = n + Math.imul(D, rt) | 0) + Math.imul(L, it) | 0, o = o + Math.imul(L, rt) | 0, r = r + Math.imul(S, ot) | 0, n = (n = n + Math.imul(S, at) | 0) + Math.imul(M, ot) | 0, o = o + Math.imul(M, at) | 0, r = r + Math.imul(w, dt) | 0, n = (n = n + Math.imul(w, ut) | 0) + Math.imul(P, dt) | 0, o = o + Math.imul(P, ut) | 0, r = r + Math.imul(m, ct) | 0, n = (n = n + Math.imul(m, lt) | 0) + Math.imul(A, ct) | 0, o = o + Math.imul(A, lt) | 0;
                var Mt = (u + (r = r + Math.imul(b, _t) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(b, pt) | 0) + Math.imul(g, _t) | 0)) << 13) | 0;
                u = ((o = o + Math.imul(g, pt) | 0) + (n >>> 13) | 0) + (Mt >>> 26) | 0, Mt &= 67108863, r = Math.imul(N, J), n = (n = Math.imul(N, Q)) + Math.imul(j, J) | 0, o = Math.imul(j, Q), r = r + Math.imul(R, $) | 0, n = (n = n + Math.imul(R, tt) | 0) + Math.imul(x, $) | 0, o = o + Math.imul(x, tt) | 0, r = r + Math.imul(O, it) | 0, n = (n = n + Math.imul(O, rt) | 0) + Math.imul(U, it) | 0, o = o + Math.imul(U, rt) | 0, r = r + Math.imul(D, ot) | 0, n = (n = n + Math.imul(D, at) | 0) + Math.imul(L, ot) | 0, o = o + Math.imul(L, at) | 0, r = r + Math.imul(S, dt) | 0, n = (n = n + Math.imul(S, ut) | 0) + Math.imul(M, dt) | 0, o = o + Math.imul(M, ut) | 0, r = r + Math.imul(w, ct) | 0, n = (n = n + Math.imul(w, lt) | 0) + Math.imul(P, ct) | 0, o = o + Math.imul(P, lt) | 0;
                var Tt = (u + (r = r + Math.imul(m, _t) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(m, pt) | 0) + Math.imul(A, _t) | 0)) << 13) | 0;
                u = ((o = o + Math.imul(A, pt) | 0) + (n >>> 13) | 0) + (Tt >>> 26) | 0, Tt &= 67108863, r = Math.imul(N, $), n = (n = Math.imul(N, tt)) + Math.imul(j, $) | 0, o = Math.imul(j, tt), r = r + Math.imul(R, it) | 0, n = (n = n + Math.imul(R, rt) | 0) + Math.imul(x, it) | 0, o = o + Math.imul(x, rt) | 0, r = r + Math.imul(O, ot) | 0, n = (n = n + Math.imul(O, at) | 0) + Math.imul(U, ot) | 0, o = o + Math.imul(U, at) | 0, r = r + Math.imul(D, dt) | 0, n = (n = n + Math.imul(D, ut) | 0) + Math.imul(L, dt) | 0, o = o + Math.imul(L, ut) | 0, r = r + Math.imul(S, ct) | 0, n = (n = n + Math.imul(S, lt) | 0) + Math.imul(M, ct) | 0, o = o + Math.imul(M, lt) | 0;
                var Dt = (u + (r = r + Math.imul(w, _t) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(w, pt) | 0) + Math.imul(P, _t) | 0)) << 13) | 0;
                u = ((o = o + Math.imul(P, pt) | 0) + (n >>> 13) | 0) + (Dt >>> 26) | 0, Dt &= 67108863, r = Math.imul(N, it), n = (n = Math.imul(N, rt)) + Math.imul(j, it) | 0, o = Math.imul(j, rt), r = r + Math.imul(R, ot) | 0, n = (n = n + Math.imul(R, at) | 0) + Math.imul(x, ot) | 0, o = o + Math.imul(x, at) | 0, r = r + Math.imul(O, dt) | 0, n = (n = n + Math.imul(O, ut) | 0) + Math.imul(U, dt) | 0, o = o + Math.imul(U, ut) | 0, r = r + Math.imul(D, ct) | 0, n = (n = n + Math.imul(D, lt) | 0) + Math.imul(L, ct) | 0, o = o + Math.imul(L, lt) | 0;
                var Lt = (u + (r = r + Math.imul(S, _t) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(S, pt) | 0) + Math.imul(M, _t) | 0)) << 13) | 0;
                u = ((o = o + Math.imul(M, pt) | 0) + (n >>> 13) | 0) + (Lt >>> 26) | 0, Lt &= 67108863, r = Math.imul(N, ot), n = (n = Math.imul(N, at)) + Math.imul(j, ot) | 0, o = Math.imul(j, at), r = r + Math.imul(R, dt) | 0, n = (n = n + Math.imul(R, ut) | 0) + Math.imul(x, dt) | 0, o = o + Math.imul(x, ut) | 0, r = r + Math.imul(O, ct) | 0, n = (n = n + Math.imul(O, lt) | 0) + Math.imul(U, ct) | 0, o = o + Math.imul(U, lt) | 0;
                var Ct = (u + (r = r + Math.imul(D, _t) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(D, pt) | 0) + Math.imul(L, _t) | 0)) << 13) | 0;
                u = ((o = o + Math.imul(L, pt) | 0) + (n >>> 13) | 0) + (Ct >>> 26) | 0, Ct &= 67108863, r = Math.imul(N, dt), n = (n = Math.imul(N, ut)) + Math.imul(j, dt) | 0, o = Math.imul(j, ut), r = r + Math.imul(R, ct) | 0, n = (n = n + Math.imul(R, lt) | 0) + Math.imul(x, ct) | 0, o = o + Math.imul(x, lt) | 0;
                var Ot = (u + (r = r + Math.imul(O, _t) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(O, pt) | 0) + Math.imul(U, _t) | 0)) << 13) | 0;
                u = ((o = o + Math.imul(U, pt) | 0) + (n >>> 13) | 0) + (Ot >>> 26) | 0, Ot &= 67108863, r = Math.imul(N, ct), n = (n = Math.imul(N, lt)) + Math.imul(j, ct) | 0, o = Math.imul(j, lt);
                var Ut = (u + (r = r + Math.imul(R, _t) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(R, pt) | 0) + Math.imul(x, _t) | 0)) << 13) | 0;
                u = ((o = o + Math.imul(x, pt) | 0) + (n >>> 13) | 0) + (Ut >>> 26) | 0, Ut &= 67108863;
                var kt = (u + (r = Math.imul(N, _t)) | 0) + ((8191 & (n = (n = Math.imul(N, pt)) + Math.imul(j, _t) | 0)) << 13) | 0;
                return u = ((o = Math.imul(j, pt)) + (n >>> 13) | 0) + (kt >>> 26) | 0, kt &= 67108863, d[0] = yt, d[1] = bt, d[2] = gt, d[3] = vt, d[4] = mt, d[5] = At, d[6] = Et, d[7] = wt, d[8] = Pt, d[9] = It, d[10] = St, d[11] = Mt, d[12] = Tt, d[13] = Dt, d[14] = Lt, d[15] = Ct, d[16] = Ot, d[17] = Ut, d[18] = kt, 0 !== u && (d[19] = u, i.length++), i
            };
            ...
            Math.imul || (h = l), o.prototype.mulTo = function(t, e) {
                    ...
                    for (var s = a << 1, d = Math.cos(2 * Math.PI / s), u = Math.sin(2 * Math.PI / s), f = 0; f < n; f += s)
                        for (var c = d, l = u, h = 0; h < a; h++) {
                            var _ = i[f + h],
                                ...
                                b = r[f + h + a],
                                g = c * y - l * b;
                            b = c * b + l * y, y = g, i[f + h] = _ + y, r[f + h] = p + b, i[f + h + a] = _ - y, r[f + h + a] = p - b, h !== s && (g = d * c - u * l, l = d * l + u * c, c = g)
                        }
                ...
                var r = 2 * this.guessLen13b(t.length, e.length),
                    ...
                    c = new Array(r),
                    l = i.words;
                l.length = r, this.convert13b(t.words, t.length, a, r), this.convert13b(e.words, e.length, u, r), this.transform(a, o, s, d, r, n), this.transform(u, o, f, c, r, n);
                for (var h = 0; h < r; h++) {
                    var _ = s[h] * f[h] - d[h] * c[h];
                    d[h] = s[h] * c[h] + d[h] * f[h], s[h] = _
                }
                ...
                for (var f = i.clone(), c = e.clone(); !e.isZero();) {
                    ...
                    if (_ > 0)
                        for (i.iushrn(_); _-- > 0;)(s.isOdd() || d.isOdd()) && (s.iadd(f), d.isub(c)), s.iushrn(1), d.iushrn(1);
    ...
    (function(t) {
            ...
            for (var r = [], n = e; n < i;) {
                ...
                if (n + c <= i) switch (c) {
                    case 1:
                        ...
                        break;
                    case 2:
                        128 == (192 & (o = t[n + 1])) && (d = (31 & u) << 6 | 63 & o) > 127 && (f = d);
                        break;
                    case 3:
                        o = t[n + 1], a = t[n + 2], 128 == (192 & o) && 128 == (192 & a) && (d = (15 & u) << 12 | (63 & o) << 6 | 63 & a) > 2047 && (d < 55296 || d > 57343) && (f = d);
                        break;
                    case 4:
                        o = t[n + 1], a = t[n + 2], s = t[n + 3], 128 == (192 & o) && 128 == (192 & a) && 128 == (192 & s) && (d = (15 & u) << 18 | (63 & o) << 12 | (63 & a) << 6 | 63 & s) > 65535 && d < 1114112 && (f = d)
                }
        ...
        e.Buffer = d, e.SlowBuffer = function(t) {
            ...
            return r
        }, d.byteLength = _, d.prototype._isBuffer = !0, d.prototype.swap16 = function() {
            var t = this.length;
            ...
            for (var o = n - r, a = i - e, s = Math.min(o, a), u = this.slice(r, n), f = t.slice(e, i), c = 0; c < s; ++c)
                if (u[c] !== f[c]) {
                    o = u[c], a = f[c];
                    break
                }
        ...
        d.prototype.slice = function(t, e) {
            ...
            return t = +t, e |= 0, i || O(this, t, e, 1, 255, 0), d.TYPED_ARRAY_SUPPORT || (t = Math.floor(t)), this[e] = 255 & t, e + 1
        }, d.prototype.writeUInt16LE = function(t, e, i) {
            return t = +t, e |= 0, i || O(this, t, e, 2, 65535, 0), d.TYPED_ARRAY_SUPPORT ? (this[e] = 255 & t, this[e + 1] = t >>> 8) : U(this, t, e, !0), e + 2
        }, d.prototype.writeUInt16BE = function(t, e, i) {
            return t = +t, e |= 0, i || O(this, t, e, 2, 65535, 0), d.TYPED_ARRAY_SUPPORT ? (this[e] = t >>> 8, this[e + 1] = 255 & t) : U(this, t, e, !1), e + 2
        }, d.prototype.writeUInt32LE = function(t, e, i) {
            return t = +t, e |= 0, i || O(this, t, e, 4, 4294967295, 0), d.TYPED_ARRAY_SUPPORT ? (this[e + 3] = t >>> 24, this[e + 2] = t >>> 16, this[e + 1] = t >>> 8, this[e] = 255 & t) : k(this, t, e, !0), e + 4
        }, d.prototype.writeUInt32BE = function(t, e, i) {
            return t = +t, e |= 0, i || O(this, t, e, 4, 4294967295, 0), d.TYPED_ARRAY_SUPPORT ? (this[e] = t >>> 24, this[e + 1] = t >>> 16, this[e + 2] = t >>> 8, this[e + 3] = 255 & t) : k(this, t, e, !1), e + 4
            ...
            return t = +t, e |= 0, i || O(this, t, e, 1, 127, -128), d.TYPED_ARRAY_SUPPORT || (t = Math.floor(t)), t < 0 && (t = 255 + t + 1), this[e] = 255 & t, e + 1
        }, d.prototype.writeInt16LE = function(t, e, i) {
            return t = +t, e |= 0, i || O(this, t, e, 2, 32767, -32768), d.TYPED_ARRAY_SUPPORT ? (this[e] = 255 & t, this[e + 1] = t >>> 8) : U(this, t, e, !0), e + 2
        }, d.prototype.writeInt16BE = function(t, e, i) {
            return t = +t, e |= 0, i || O(this, t, e, 2, 32767, -32768), d.TYPED_ARRAY_SUPPORT ? (this[e] = t >>> 8, this[e + 1] = 255 & t) : U(this, t, e, !1), e + 2
        }, d.prototype.writeInt32LE = function(t, e, i) {
            return t = +t, e |= 0, i || O(this, t, e, 4, 2147483647, -2147483648), d.TYPED_ARRAY_SUPPORT ? (this[e] = 255 & t, this[e + 1] = t >>> 8, this[e + 2] = t >>> 16, this[e + 3] = t >>> 24) : k(this, t, e, !0), e + 4
        }, d.prototype.writeInt32BE = function(t, e, i) {
            return t = +t, e |= 0, i || O(this, t, e, 4, 2147483647, -2147483648), t < 0 && (t = 4294967295 + t + 1), d.TYPED_ARRAY_SUPPORT ? (this[e] = t >>> 24, this[e + 1] = t >>> 16, this[e + 2] = t >>> 8, this[e + 3] = 255 & t) : k(this, t, e, !1), e + 4
            ...
            if (e >>>= 0, i = void 0 === i ? this.length : i >>> 0, t || (t = 0), "number" == typeof t)
                ...
                var a = d.isBuffer(t) ? t : H(new d(t, r).toString()),
                    s = a.length;
    ...
    (function(e) {
        ...
        function u(t, i, n, o) {
            ...
            u.fill(1);
            var c = new e(s);
            return c.fill(0), c = r(o, c).update(u).update(new e([0])).update(t).update(d).digest(), u = r(o, c).update(u).digest(), {
                k: c = r(o, c).update(u).update(new e([1])).update(t).update(d).digest(),
        ...
        t.exports = function(t, i, r, h, _) {
            ...
            if ("dsa" === p.type) {
                ...
                return function(t, i, r) {
                    for (var n, o = i.params.priv_key, s = i.params.p, d = i.params.q, h = i.params.g, _ = new a(0), p = f(t, d).mod(d), y = !1, b = u(o, d, t, r); !1 === y;) n = c(d, b, r), _ = l(h, n, s, d), 0 === (y = n.invm(d).imul(p.add(o.mul(_))).mod(d)).cmpn(0) && (y = !1, _ = new a(0));
                    return function(t, i) {
    ...
    n.nextTick = function(t) {
        ...
        u.push(new _(t, e)), 1 !== u.length || f || s(h)
    ...
    e.define = function(t, e) {
        ...
        var e;
        try {
            e = i(139).runInThisContext("(function " + this.name + "(entity) {\n  this._initNamed(entity);\n})")
        } catch (t) {
            e = function(t) {
                this._initNamed(t)
            }
    ...
    var r = e;
    r.Reporter = i(212).Reporter, r.DecoderBuffer = i(337).DecoderBuffer, r.EncoderBuffer = i(337).EncoderBuffer, r.Node = i(266)
}, function(t, e, i) {
    var r = i(135),
        n = i(0),
        o = i(250);
    ...
    n.prototype.update = function(t, e) {
        ...
        for (var i = this._block, n = this._blockSize, o = t.length, a = this._len, s = 0; s < o;) {
            for (var d = a % n, u = Math.min(o - s, n - d), f = 0; f < u; f++) i[d + f] = t[s + f];
    ...
    e.inherits = n, e.toArray = function(t, e) {
        ...
        var f = 0,
            c = e;
        return f += (c = c + r >>> 0) < e ? 1 : 0, f += (c = c + o >>> 0) < o ? 1 : 0, f += (c = c + s >>> 0) < s ? 1 : 0, t + i + n + a + d + (f += (c = c + u >>> 0) < u ? 1 : 0) >>> 0
    ...
    function n(t, e) {
        ...
        if ((window.traverseParent || function(t, e) {
                ...
                return u = domData(t, "audio-context")
            }), u = (u = n.context || u) || ("audio" == cur.module ? cur.submodule : cur.module), e) return {
            context: u
        };
        ...
        else if ("feed" == d || 0 === n.context.indexOf("feed") || 0 === n.context.indexOf("feedsearch")) h = "feed", s = o(geByClass("wall_text", a));
        else if ("group_wall" == g || "user_wall" == g || 0 === n.context.indexOf("reply") || "wall" == d) {
    ...
    function c(t, e) {
        ...
        (this._alg = t, this._key = e, e.length > i) ? e = ("rmd160" === t ? new d : u(t)).update(e).digest(): e.length < i && (e = a.concat([e, f], i));
    ...
    r.inherits(v, b), t.exports = v, v.blockSize = 1024, v.outSize = 512, v.hmacStrength = 192, v.padLength = 128, v.prototype._prepareBlock = function(t, e) {
        ...
        for (; r < i.length; r += 2) {
            var n = L(i[r - 4], i[r - 3]),
                ...
                f = i[r - 32],
                c = i[r - 31];
            i[r] = h(n, o, a, s, d, u, f, c), i[r + 1] = _(n, o, a, s, d, u, f, c)
        }
        ...
        for (var U = 0; U < i.length; U += 2) {
            ...
            k = P(r, n), R = I(r, n), x = E(r, n, a, s, d), B = w(r, n, a, s, d, u);
            var z = c(k, R, x, B),
                Y = l(k, R, x, B);
            C = D, O = L, D = v, L = T, v = b, T = g, b = c(h, _, q, V), g = l(_, _, q, V), h = d, _ = u, d = a, u = s, a = r, s = n, r = c(q, V, z, Y), n = l(q, V, z, Y)
        }
        f(this.h, 0, r, n), f(this.h, 2, a, s), f(this.h, 4, d, u), f(this.h, 6, h, _), f(this.h, 8, b, g), f(this.h, 10, v, T), f(this.h, 12, D, L), f(this.h, 14, C, O)
    ...
    var r = i(208).Reporter,
        n = i(208).EncoderBuffer,
        o = i(208).DecoderBuffer,
        a = i(101),
    ...
    a(u, s), t.exports = u, u.prototype._getEndomorphism = function(t) {
        ...
        for (var e, i, r, n, a, s, d, u, f, c = this.n.ushrn(Math.floor(this.n.bitLength() / 2)), l = t, h = this.n.clone(), _ = new o(1), p = new o(0), y = new o(0), b = new o(1), g = 0; 0 !== l.cmpn(0);) {
            var v = h.div(l);
            u = h.sub(v.mul(l)), f = y.sub(v.mul(_));
            var m = b.sub(v.mul(p));
            if (!r && u.cmp(c) < 0) e = d.neg(), i = _, r = u.neg(), n = f;
            else if (r && 2 == ++g) break;
            d = u, h = l, l = u, y = _, _ = f, b = p, p = m
        }
        a = u.neg(), s = f;
        ...
        return u
    }, a(f, s.BasePoint), u.prototype.point = function(t, e, i) {
    ...
    }, a(c, s.BasePoint), u.prototype.jpoint = function(t, e, i) {
        ...
        for (i = 0; i < t; i++) {
            ...
            var g = u.redMul(s);
            i + 1 < t && (d = d.redMul(l)), o = p, s = g, u = b
        }
    ...
    t.exports = d, d.prototype.point = function() {
        ...
        for (c = r - 1; c >= 1; c -= 2) {
            ...
            if (1 === s[h] && 1 === s[_]) {
                ...
                var y = [-3, -1, -5, -7, 0, 7, 5, 1, 3],
                    b = a(i[h], i[_]);
                f = Math.max(b[0].length, f), u[h] = new Array(f), u[_] = new Array(f);
                for (var g = 0; g < f; g++) {
                    var v = 0 | b[0][g],
                        m = 0 | b[1][g];
                    u[h][g] = y[3 * (v + 1) + (m + 1)], u[_][g] = 0, d[h] = p
                }
            } else u[h] = o(i[h], s[h]), u[_] = o(i[_], s[_]), f = Math.max(u[h].length, f), f = Math.max(u[_].length, f)
        }
        ...
        for (c = f; c >= 0; c--) {
            for (var w = 0; c >= 0;) {
                var P = !0;
                for (g = 0; g < r; g++) E[g] = 0 | u[g][c], 0 !== E[g] && (P = !1);
                if (!P) break;
                w++, c--
            }
    ...
    (function(e, r) {
        ...
        function g(t, e) {
            ...
            this.highWaterMark = n || 0 === n ? n : r && (a || 0 === a) ? a : s, this.highWaterMark = Math.floor(this.highWaterMark), this.buffer = new p, this.length = 0, this.pipes = null, this.pipesCount = 0, this.flowing = null, this.ended = !1, this.endEmitted = !1, this.reading = !1, this.sync = !0, this.needReadable = !1, this.emittedReadable = !1, this.readableListening = !1, this.resumeScheduled = !1, this.destroyed = !1, this.defaultEncoding = t.defaultEncoding || "utf8", this.awaitDrain = 0, this.readingMore = !1, this.decoder = null, this.encoding = null, t.encoding && (_ || (_ = i(86).StringDecoder), this.decoder = new _(t.encoding), this.encoding = t.encoding)
        }

        function v(t) {
            if (o = o || i(242), !(this instanceof v)) return new v(t);
        ...
        Object.defineProperty(v.prototype, "destroyed", {
            ...
            return _ || (_ = i(86).StringDecoder), this._readableState.decoder = new _(t), this._readableState.encoding = t, this
        };
        var E = 8388608;
        ...
        v.prototype.read = function(t) {
            ...
            function u(e, r) {
                h("onunpipe"), e === i && r && !1 === r.hasUnpiped && (r.hasUnpiped = !0, h("cleanup"), t.removeListener("close", b), t.removeListener("finish", g), t.removeListener("drain", c), t.removeListener("error", y), t.removeListener("unpipe", u), i.removeListener("end", f), i.removeListener("end", v), i.removeListener("data", p), l = !0, !o.awaitDrain || t._writableState && !t._writableState.needDrain || c())
            }
    ...
    i(355)(a, n), a.prototype.update = function(t, e, i) {
    ...
    e.publicEncrypt = i(136), e.privateDecrypt = i(145), e.privateEncrypt = function(t, i) {
    ...
    r(d, n), d.prototype.init = function() {
        ...
        for (var e = this._w, i = 0 | this._ah, r = 0 | this._bh, n = 0 | this._ch, o = 0 | this._dh, s = 0 | this._eh, d = 0 | this._fh, g = 0 | this._gh, v = 0 | this._hh, m = 0 | this._al, A = 0 | this._bl, E = 0 | this._cl, w = 0 | this._dl, P = 0 | this._el, I = 0 | this._fl, S = 0 | this._gl, M = 0 | this._hl, T = 0; T < 32; T += 2) e[T] = t.readInt32BE(4 * T), e[T + 1] = t.readInt32BE(4 * T + 4);
        for (; T < 160; T += 2) {
            var D = e[T - 30],
                L = e[T - 30 + 1],
                C = h(D, L),
        ...
        for (var F = 0; F < 160; F += 2) {
            ...
            var tt = V + K | 0,
                et = q + W + b(tt, V) | 0;
            v = g, M = S, g = d, S = I, d = s, I = P, s = o + $ + b(P = w + Z | 0, w) | 0, o = n, w = E, n = r, E = A, r = i, A = m, i = $ + et + b(m = Z + tt | 0, Z) | 0
        }
    ...
    n(h, o), h.prototype._update = function() {
        ...
        for (var i = 0 | this._a, r = 0 | this._b, n = 0 | this._c, o = 0 | this._d, h = 0 | this._e, m = 0 | this._a, A = 0 | this._b, E = 0 | this._c, w = 0 | this._d, P = 0 | this._e, I = 0; I < 80; I += 1) {
            var S, M;
            I < 16 ? (S = p(i, r, n, o, h, t[s[I]], c[0], u[I]), M = v(m, A, E, w, P, t[d[I]], l[0], f[I])) : I < 32 ? (S = y(i, r, n, o, h, t[s[I]], c[1], u[I]), M = g(m, A, E, w, P, t[d[I]], l[1], f[I])) : I < 48 ? (S = b(i, r, n, o, h, t[s[I]], c[2], u[I]), M = b(m, A, E, w, P, t[d[I]], l[2], f[I])) : I < 64 ? (S = g(i, r, n, o, h, t[s[I]], c[3], u[I]), M = y(m, A, E, w, P, t[d[I]], l[3], f[I])) : (S = v(i, r, n, o, h, t[s[I]], c[4], u[I]), M = p(m, A, E, w, P, t[d[I]], l[4], f[I])), i = h, h = o, o = _(n, 10), n = r, r = S, m = P, P = w, w = _(E, 10), E = A, A = M
        }
        var T = this._b + n + w | 0;
    ...
    (function(e, r, n) {
        ...
        function g(t) {
            if (s = s || i(242), !(_.call(g, this) || this instanceof s)) return new g(t);
    ...
    }).call(this, i(199), i(36).setImmediate, i(162))
}, , function(t) {
    t.exports = {
    ...
    "use strict";
    e.utils = i(262), e.Cipher = i(9), e.DES = i(159), e.CBC = i(238), e.EDE = i(232)
}, function(t, e, i) {
    "use strict";
    var r = i(6).Buffer,
        n = i(100).Transform;
    ...
    i(355)(o, n), o.prototype._transform = function(t, e, i) {
        var r = null;
        try {
            this.update(t, e)
        } catch (t) {
    ...
    "use strict";
    var r = e;
    r.version = i(301).version, r.utils = i(330), r.rand = i(280), r.curve = i(350), r.curves = i(244), r.ec = i(149), r.eddsa = i(3)
}, , function(t, e, i) {
    t.exports = i(129).PassThrough
}, , function(t, e, i) {
    "use strict";
    ...
    t.exports = function(t, e, i, o) {
        ...
        for (var a = i / 8, s = r.alloc(a), d = r.alloc(o || 0), u = r.alloc(0); a > 0 || o > 0;) {
            ...
            if (c < u.length && o > 0) {
                var h = d.length - o,
                    _ = Math.min(o, u.length - c);
                u.copy(d, h, c, c + _), o -= _
            }
        }
        return u.fill(0), {
            key: s,
    ...
    "use strict";
    var r = e;
    r.base = i(275), r.short = i(269), r.mont = i(271), r.edwards = i(69)
}, function(t, e, i) {
    "use strict";
    var r = i(214),
        n = i(101);
