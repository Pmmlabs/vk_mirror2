! function(t) {
    ...
    var r = e;
    r.Reporter = i(421).Reporter, r.DecoderBuffer = i(105).DecoderBuffer, r.EncoderBuffer = i(105).EncoderBuffer, r.Node = i(327)
}, , function(t, e, i) {
    t.exports = i(374).Transform
}, function(t, e, i) {
    "use strict";
    ...
    e.pbkdf2 = i(150), e.pbkdf2Sync = i(400)
}, function(t, e, i) {
    "use strict";
    ...
    (function(e, r, n) {
        ...
        function g(t) {
            if (s = s || i(281), !(p.call(g, this) || this instanceof s)) return new g(t);
    ...
    }).call(this, i(454), i(110).setImmediate, i(183))
}, function(t, e, i) {
    "use strict";
    var r = i(217),
        n = i(153);
    ...
    e.publicEncrypt = i(293), e.privateDecrypt = i(340), e.privateEncrypt = function(t, i) {
    ...
    (function(t) {
        ! function(t, e) {
            ...
            var h = function(t, e, i) {
                ...
                var Dt = (u + (r = r + Math.imul(x, pt) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(x, _t) | 0) + Math.imul(R, pt) | 0)) << 13) | 0;
                u = ((o = o + Math.imul(R, _t) | 0) + (n >>> 13) | 0) + (Dt >>> 26) | 0, Dt &= 67108863;
                var Ot = (u + (r = Math.imul(N, pt)) | 0) + ((8191 & (n = (n = Math.imul(N, _t)) + Math.imul(j, pt) | 0)) << 13) | 0;
                return u = ((o = Math.imul(j, _t)) + (n >>> 13) | 0) + (Ot >>> 26) | 0, Ot &= 67108863, d[0] = yt, d[1] = bt, d[2] = gt, d[3] = vt, d[4] = mt, d[5] = At, d[6] = wt, d[7] = Et, d[8] = Pt, d[9] = St, d[10] = It, d[11] = Tt, d[12] = Mt, d[13] = Lt, d[14] = kt, d[15] = Ct, d[16] = Ut, d[17] = Dt, d[18] = Ot, 0 !== u && (d[19] = u, i.length++), i
            };
    ...
    function o(t) {
        ...
        if ((t = Object(r.asObject)(t)).restrictionStatus) {
            if (t.actionHash) var e = showBox("al_audio.php", {
                act: "restriction_box",
                audio_id: t.id,
                owner_id: t.owner_id,
                hash: t.actionHash
        ...
        (function() {
            ...
            function D(t, e, i) {
                e.constructor === t.constructor && i === S && constructor.resolve === I ? function(t, e) {
                    e._state === L ? R(t, e._result) : e._state === k ? B(t, e._result) : N(e, void 0, function(e) {
                        O(t, e)
                    }, function(e) {
                        B(t, e)
                    })
            ...
            function N(t, e, i, r) {
                var n = t._subscribers,
                    o = n.length;
                t._onerror = null, n[o] = e, n[o + L] = i, n[o + k] = r, 0 === o && t._state && f(j, t)
            }
            ...
            function q(t, e, i, r) {
                ...
                e._state !== M || (u && s ? O(e, n) : d ? B(e, o) : t === L ? R(e, n) : t === k && B(e, n))
            }
            var V = function(t) {
            ...
            function X(t) {
                this._id = z++, this._state = void 0, this._result = void 0, this._subscribers = [], T !== t && ("function" != typeof t && function() {
            ...
            X.all = V, X.race = W, X.resolve = I, X.reject = Y, X._setScheduler = function(t) {
                d = t
            ...
            Q.prototype._validationError = function() {
                ...
                var r = this.promise;
                r._state === M && (this._remaining--, t === k ? B(r, i) : this._result[e] = i), 0 === this._remaining && R(r, this._result)
    ...
    r.inherits(v, b), t.exports = v, v.blockSize = 1024, v.outSize = 512, v.hmacStrength = 192, v.padLength = 128, v.prototype._prepareBlock = function(t, e) {
        ...
        for (var D = 0; D < i.length; D += 2) {
            var O = C,
                ...
                Y = y(O, x, R, B, N, j, F, H, q, V);
            O = P(r, n), x = S(r, n), R = w(r, n, a, s, d), B = E(r, n, a, s, d, u);
            var z = f(O, x, R, B),
                K = l(O, x, R, B);
            C = L, U = k, L = v, k = M, v = b, M = g, b = f(h, p, W, Y), g = l(p, p, W, Y), h = d, p = u, d = a, u = s, a = r, s = n, r = f(W, Y, z, K), n = l(W, Y, z, K)
        }
        c(this.h, 0, r, n), c(this.h, 2, a, s), c(this.h, 4, d, u), c(this.h, 6, h, p), c(this.h, 8, b, g), c(this.h, 10, v, M), c(this.h, 12, L, k), c(this.h, 14, C, U)
    }, v.prototype._digest = function(t) {
        return "hex" === t ? r.toHex32(this.h, "big") : r.split32(this.h, "big")
    }
}, function(t, e, i) {
    t.exports = i(374).PassThrough
}, , , function(t, e, i) {
    "use strict";
    var r = i(402),
        n = i(201),
    ...
    t.exports = n;
    var r = i(381).EventEmitter;

    function n() {
        r.call(this)
    }
    i(201)(n, r), n.Readable = i(374), n.Writable = i(329), n.Duplex = i(439), n.Transform = i(29), n.PassThrough = i(154), n.Stream = n, n.prototype.pipe = function(t, e) {
        var i = this;
    ...
    "use strict";
    var r = e;
    r.base = i(21), r.short = i(227), r.mont = i(274), r.edwards = i(13)
}, function(t, e, i) {
    "use strict";
    (function(t) {
        var r = i(58),
        ...
        d.prototype.slice = function(t, e) {
            ...
            return t = +t, e |= 0, i || U(this, t, e, 4, 4294967295, 0), d.TYPED_ARRAY_SUPPORT ? (this[e + 3] = t >>> 24, this[e + 2] = t >>> 16, this[e + 1] = t >>> 8, this[e] = 255 & t) : O(this, t, e, !0), e + 4
        }, d.prototype.writeUInt32BE = function(t, e, i) {
            return t = +t, e |= 0, i || U(this, t, e, 4, 4294967295, 0), d.TYPED_ARRAY_SUPPORT ? (this[e] = t >>> 24, this[e + 1] = t >>> 16, this[e + 2] = t >>> 8, this[e + 3] = 255 & t) : O(this, t, e, !1), e + 4
            ...
            return t = +t, e |= 0, i || U(this, t, e, 4, 2147483647, -2147483648), d.TYPED_ARRAY_SUPPORT ? (this[e] = 255 & t, this[e + 1] = t >>> 8, this[e + 2] = t >>> 16, this[e + 3] = t >>> 24) : O(this, t, e, !0), e + 4
        }, d.prototype.writeInt32BE = function(t, e, i) {
            return t = +t, e |= 0, i || U(this, t, e, 4, 2147483647, -2147483648), t < 0 && (t = 4294967295 + t + 1), d.TYPED_ARRAY_SUPPORT ? (this[e] = t >>> 24, this[e + 1] = t >>> 16, this[e + 2] = t >>> 8, this[e + 3] = 255 & t) : O(this, t, e, !1), e + 4
    ...
    "use strict";
    e.sha1 = i(206), e.sha224 = i(126), e.sha256 = i(292), e.sha384 = i(60), e.sha512 = i(153)
}, function(t, e, i) {
    "use strict";
    var r = i(402),
        n = i(201);
    ...
    (e = t.exports = function(t) {
        ...
        return new i
    }).sha = i(199), e.sha1 = i(372), e.sha224 = i(3), e.sha256 = i(286), e.sha384 = i(270), e.sha512 = i(268)
}, , function(t, e, i) {
    "use strict";
    ...
    e.define = function(t, e) {
        ...
        var e;
        try {
            e = i(68).runInThisContext("(function " + this.name + "(entity) {\n  this._initNamed(entity);\n})")
        } catch (t) {
            e = function(t) {
                this._initNamed(t)
            }
    ...
    var r = e;
    r.bignum = i(104), r.define = i(247).define, r.base = i(27), r.constants = i(365), r.decoders = i(115), r.encoders = i(164)
}, , , , , , , , function(t, e, i) {
    "use strict";
    var r = i(198).Buffer,
        n = i(201),
    ...
    r(d, n), d.prototype.init = function() {
        ...
        for (; M < 160; M += 2) {
            var L = e[M - 30],
                ...
                j = U + R | 0,
                F = C + x + b(j, U) | 0;
            F = (F = F + D + b(j = j + O | 0, O) | 0) + B + b(j = j + N | 0, N) | 0, e[M] = F, e[M + 1] = j
        }
    ...
    function r(t, e, i, n, o) {
        ...
        var a = curBox(),
            ...
            d = geByClass1("_audio_atp_list", a.bodyNode),
        ...
        function p() {
            ...
            }) : n, toggle(d, 0 != t.length), toggle(c, 0 == t.length), h = new AutoList(d, {
    ...
    var _lib_debug_tools__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(285);
    ...
    "use strict";
    e.utils = i(16), e.Cipher = i(19), e.DES = i(214), e.CBC = i(307), e.EDE = i(157)
}, function(t, e, i) {
    "use strict";
    ...
    "use strict";
    var r = e;
    r.version = i(345).version, r.utils = i(145), r.rand = i(310), r.curve = i(197), r.curves = i(444), r.ec = i(360), r.eddsa = i(364)
}, function(t, e, i) {
    "use strict";
    e.randomBytes = e.rng = e.pseudoRandomBytes = e.prng = i(51), e.createHash = e.Hash = i(67), e.createHmac = e.Hmac = i(175);
    var r = i(351),
        n = Object.keys(r),
    ...
    var u = i(222);
    e.createSign = u.createSign, e.Sign = u.Sign, e.createVerify = u.createVerify, e.Verify = u.Verify, e.createECDH = i(376);
    var c = i(95);
    ...
    var r = i(27).Reporter,
        n = i(27).EncoderBuffer,
        o = i(27).DecoderBuffer,
        a = i(402),
    ...
    (function(e, r) {
        ...
        Object.defineProperty(v.prototype, "destroyed", {
            ...
            return p || (p = i(91).StringDecoder), this._readableState.decoder = new p(t), this._readableState.encoding = t, this
        };
        var w = 8388608;
    ...
    (e = t.exports = i(354)).Stream = e, e.Readable = e, e.Writable = i(59), e.Duplex = i(281), e.Transform = i(386), e.PassThrough = i(55)
}, , function(t, e, i) {
    (function(e) {
        var r = i(316),
            n = i(104);
    ...
    window.AudioLayer = pt.default, window.AudioUtils = _t({}, r.AUDIO_PLAYER_ENUMS, {
    ...
    var r = e;
    r.utils = i(217), r.common = i(303), r.sha = i(216), r.ripemd = i(412), r.hmac = i(461), r.sha1 = r.sha.sha1, r.sha256 = r.sha.sha256, r.sha224 = r.sha.sha224, r.sha384 = r.sha.sha384, r.sha512 = r.sha.sha512, r.ripemd160 = r.ripemd.ripemd160
}, , function(t, e, i) {
    var r = i(201);
    ...
    var _utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(407),
        _playlist_loadAllPlaylistAudios__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(93);
