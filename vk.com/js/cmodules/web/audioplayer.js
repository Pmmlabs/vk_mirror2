! function(t) {
    ...
    r(u, n), u.prototype.init = function() {
        ...
        for (var F = 0; F < 160; F += 2) {
            ...
            var W = c(i, r, n),
                ...
                Z = M + Y | 0,
                $ = v + z + b(Z, M) | 0;
            $ = ($ = ($ = $ + J + b(Z = Z + Q | 0, Q) | 0) + G + b(Z = Z + X | 0, X) | 0) + H + b(Z = Z + j | 0, j) | 0;
            var tt = V + K | 0,
                et = q + W + b(tt, V) | 0;
    ...
    "use strict";
    e.randomBytes = e.rng = e.pseudoRandomBytes = e.prng = i(81), e.createHash = e.Hash = i(178), e.createHmac = e.Hmac = i(69);
    var r = i(449),
        n = Object.keys(r),
    ...
    var d = i(2);
    e.createSign = d.createSign, e.Sign = d.Sign, e.createVerify = d.createVerify, e.Verify = d.Verify, e.createECDH = i(212);
    var c = i(294);
    ...
    function r(t, e, i, r, n) {
        ...
        function h() {
            ...
            var t = [];
            t = f ? r.filter(function(t) {
                return t[2].toLowerCase().indexOf(f) >= 0
        ...
        addEvent(s, "click", function(t) {
            var e = domClosest("_ape_pl_item", t.target),
                i = domData(e, "id");
            toggleClass(e, "ape_selected") ? (_[i] = !0, delete p[i]) : (p[i] = !0, delete _[i])
    ...
    t.exports = n;
    var r = i(408).EventEmitter;

    function n() {
        r.call(this)
    }
    i(6)(n, r), n.Readable = i(213), n.Writable = i(262), n.Duplex = i(269), n.Transform = i(201), n.PassThrough = i(31), n.Stream = n, n.prototype.pipe = function(t, e) {
        var i = this;
    ...
    "use strict";
    var r = e;
    r.version = i(130).version, r.utils = i(124), r.rand = i(258), r.curve = i(41), r.curves = i(193), r.ec = i(327), r.eddsa = i(314)
}, function(t, e, i) {
    "use strict";
    var r = i(203),
        n = i(29).utils,
    ...
    t.exports = u, u.prototype.point = function() {
        ...
        for (f = c; f >= 0; f--) {
            for (var w = 0; f >= 0;) {
                var P = !0;
                for (g = 0; g < r; g++) E[g] = 0 | d[g][f], 0 !== E[g] && (P = !1);
                if (!P) break;
                w++, f--
            }
            if (f >= 0 && w++, A = A.dblp(w), f < 0) break;
            for (g = 0; g < r; g++) {
                var I, S = E[g];
    ...
    t.exports = i(213).PassThrough
}, function(__webpack_module__, __webpack_exports__, __webpack_require__) {
    "use strict";
    __webpack_require__.r(__webpack_exports__);
    var _audio_player_utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(378),
        _audioplayer_audio_unmask_source__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(199),
        _node_modules_node_uuid_uuid__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(360),
        _shared_im_longpoll_events__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(368),
        _audioplayer_audioplayer_utils__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(158);
    window.TopAudioPlayer = function(t, e) {
        ...
        function s() {
            ...
            if (0 != i) {
                var u = i < 0 ? -10 : 10,
                    d = s.offsetLeft,
                    c = se('<div class="top_audio_player_title top_audio_player_title_next" style="opacity: 0; top:' + u + "px; left: " + d + 'px">' + t.performer + " &ndash; " + t.title + "</div>");
                c.setAttribute("onmouseover", "setTitle(this)"), i > 0 ? domInsertAfter(c, s) : domInsertBefore(c, s), addClass(s, "top_audio_player_title_out"), setStyle(s, {
                    top: -u,
                    opacity: 0
                }), setTimeout(function() {
                    setStyle(c, {
                    ...
                    re(s), removeClass(c, "top_audio_player_title_next")
    ...
    AudioPlaylist.prototype.isFullyLoadable = function() {
        ...
        for (var i = this.getSelf()._list, r = 0, n = i.length; r < n; r++)
            if (i[r] && e[0] == i[r][_audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.AUDIO_ITEM_INDEX_OWNER_ID] && e[1] == i[r][_audio_player_utils__WEBPACK_IMPORTED_MODULE_0__.AudioUtils.AUDIO_ITEM_INDEX_ID]) return r;
        return -1
        ...
        if (r.isPlaying) this.pause();
            ...
            this.play(r.fullId, u.playlist, r.context || u.context), cur.audioPage && cur.audioPage.onUserAction(r, u.playlist), this.updateStartRef(r, "", i)
        }
        ...
        var n = this,
            ...
            s = this.getPlaylist(o.type || AudioPlaylist.TYPE_PLAYLIST, t, e, i);
        if (a && a.getId() === s.getId() && this.isPlaying() && !o.shuffled) this.pause();
        else {
            var u = function() {
                o.preDoPlay && o.preDoPlay(s);
                var t = s.getNextAudio(!1, !0);
                t && n.play(t, s, r)
            };
            s.load(0, u, null, o.trackType), s.getAudiosCount() && !o.shuffled ? u() : this._impl.preparePlay && this._impl.preparePlay()
        }
        ...
        each(this._podcasts.updated, function(i) {
            ...
            var r = t._podcasts.episodes[i],
                ...
                d = "feed" === cur.module && feed ? feed.getModuleRef() : cur.module,
                c = "play" === s ? t.getStartRef() : "";
            n[i] && (e.push([i, n[i].position, Math.max(0, o - a), u.join(","), t.podcastGetPlaybackRate(), s, d, c].join(":")), r.listen = 0, r.logListen = o, r.parts = {}, delete r.logAction)
        ...
        i && i.catch(function(t) {
            t.code !== t.ABORT_ERR && console.log(t)
    ...
    "use strict";
    var r = e;
    r.base = i(30), r.short = i(65), r.mont = i(135), r.edwards = i(312)
}, , , , function(t, e, i) {
    var r = i(6),
        n = i(152);
    ...
    n(h, o), h.prototype._update = function() {
        ...
        for (var i = 0 | this._a, r = 0 | this._b, n = 0 | this._c, o = 0 | this._d, h = 0 | this._e, m = 0 | this._a, A = 0 | this._b, E = 0 | this._c, w = 0 | this._d, P = 0 | this._e, I = 0; I < 80; I += 1) {
            var S, M;
            I < 16 ? (S = _(i, r, n, o, h, t[s[I]], f[0], d[I]), M = v(m, A, E, w, P, t[u[I]], l[0], c[I])) : I < 32 ? (S = y(i, r, n, o, h, t[s[I]], f[1], d[I]), M = g(m, A, E, w, P, t[u[I]], l[1], c[I])) : I < 48 ? (S = b(i, r, n, o, h, t[s[I]], f[2], d[I]), M = b(m, A, E, w, P, t[u[I]], l[2], c[I])) : I < 64 ? (S = g(i, r, n, o, h, t[s[I]], f[3], d[I]), M = y(m, A, E, w, P, t[u[I]], l[3], c[I])) : (S = v(i, r, n, o, h, t[s[I]], f[4], d[I]), M = _(m, A, E, w, P, t[u[I]], l[4], c[I])), i = h, h = o, o = p(n, 10), n = r, r = S, m = P, P = w, w = p(E, 10), E = A, A = M
        }
        var T = this._b + n + w | 0;
    ...
    var r = e;
    r.Reporter = i(445).Reporter, r.DecoderBuffer = i(440).DecoderBuffer, r.EncoderBuffer = i(440).EncoderBuffer, r.Node = i(437)
}, , , function(t, e, i) {
    "use strict";
    var r = e;
    ...
    (function(r, n) {
        ...
        (function() {
            ...
            _ ? g = function() {
                r.nextTick(P)
            } : p ? (m = 0, A = new p(P), E = document.createTextNode(""), A.observe(E, {
                characterData: !0
            }), g = function() {
                E.data = m = ++m % 2
            ...
            function U(t, e, i) {
                e.constructor === t.constructor && i === I && constructor.resolve === S ? function(t, e) {
                    e._state === D ? x(t, e._result) : e._state === L ? B(t, e._result) : N(e, void 0, function(e) {
                        k(t, e)
                    }, function(e) {
                        B(t, e)
                    })
                }(t, e) : i === C ? B(t, C.error) : void 0 === i ? x(t, e) : a(i) ? function(t, e, i) {
                    f(function(t) {
                        var r = !1,
                            n = function(t, e, i, r) {
                                try {
            ...
            function k(t, e) {
                var i;
                t === e ? B(t, new TypeError("You cannot resolve a promise with itself")) : "function" == typeof(i = e) || "object" == typeof i && null !== i ? U(t, e, O(e)) : x(t, e)
            }
            ...
            function x(t, e) {
                t._state === T && (t._result = e, t._state = D, 0 !== t._subscribers.length && f(j, t))
            }

            function B(t, e) {
                t._state === T && (t._state = L, t._result = e, f(R, t))
            }

            function N(t, e, i, r) {
                var n = t._subscribers,
                    o = n.length;
                t._onerror = null, n[o] = e, n[o + D] = i, n[o + L] = r, 0 === o && t._state && f(j, t)
            }
            ...
            function j(t) {
                var e = t._subscribers,
                    i = t._state;
                if (0 !== e.length) {
                    for (var r, n, o = t._result, a = 0; a < e.length; a += 3) r = e[a], n = e[a + i], r ? W(i, r, n, o) : n(o);
            ...
            function W(t, e, i, r) {
                ...
                if (d) {
                    if ((n = function(t, e) {
                        ...
                        }(i, r)) === F ? (u = !0, o = n.error, n = null) : s = !0, e === n) return void B(e, new TypeError("A promises callback cannot return that same promise."))
                } else n = r, s = !0;
                e._state !== T || (d && s ? k(e, n) : u ? B(e, o) : t === D ? x(e, n) : t === L && B(e, n))
            }
            var K = function(t) {
            ...
            var q = function(t) {
                var e = new this(M);
                if (!d(t)) return B(e, new TypeError("You must pass an array to race.")), e;
                var i = t.length;
                ...
                for (var o = 0; e._state === T && o < i; o++) N(this.resolve(t[o]), void 0, r, n);
                return e
            };
            var V = function(t) {
                    var e = new this(M);
            ...
            function G(t) {
                this._id = z++, this._state = void 0, this._result = void 0, this._subscribers = [], M !== t && ("function" != typeof t && function() {
            ...
            G.all = K, G.race = q, G.resolve = S, G.reject = V, G._setScheduler = function(t) {
                u = t
            }, G._setAsap = function(t) {
                f = t
            }, G._asap = f, G.prototype = {
                constructor: G,
                then: I,
                catch: function(t) {
            ...
            function J(t, e) {
                this._instanceConstructor = t, this.promise = new t(M), Array.isArray(e) ? (this._input = e, this.length = e.length, this._remaining = e.length, this._result = new Array(this.length), 0 === this.length ? x(this.promise, this._result) : (this.length = this.length || 0, this._enumerate(), 0 === this._remaining && x(this.promise, this._result))) : B(this.promise, this._validationError())
            }
            J.prototype._validationError = function() {
                return new Error("Array Methods must be provided an Array")
            }, J.prototype._enumerate = function() {
                for (var t = this.length, e = this._input, i = 0; this._state === T && i < t; i++) this._eachEntry(e[i], i)
            }, J.prototype._eachEntry = function(t, e) {
                var i = this._instanceConstructor,
                    r = i.resolve;
                if (r === S) {
                    var n = O(t);
                    if (n === I && t._state !== T) this._settledAt(t._state, e, t._result);
                ...
                var r = this.promise;
                r._state === T && (this._remaining--, t === L ? B(r, i) : this._result[e] = i), 0 === this._remaining && x(r, this._result)
            ...
            var Q = function() {
                    ...
                    var e = t.Promise;
                    e && "[object Promise]" === Object.prototype.toString.call(e.resolve()) && !e.cast || (t.Promise = Y)
                },
                Z = {
                    Promise: Y,
                    polyfill: Q
    ...
    i(6)(c, s), c.prototype._update = function(t) {
        var e, i;
        this._cache.add(t);
    ...
    n.inherits = i(6), n.inherits(o, r), o.prototype.push = function(t, e) {
    ...
    e.define = function(t, e) {
        ...
        var e;
        try {
            e = i(453).runInThisContext("(function " + this.name + "(entity) {\n  this._initNamed(entity);\n})")
        } catch (t) {
            e = function(t) {
                this._initNamed(t)
            }
    ...
    (function(e, r, n) {
        ...
        function g(t) {
            if (s = s || i(210), !(p.call(g, this) || this instanceof s)) return new g(t);
    ...
    }).call(this, i(395), i(163).setImmediate, i(181))
}, , function(t, e, i) {
    t.exports = i(408).EventEmitter
}, , , function(t, e, i) {
    var r = i(112),
        n = i(47),
        o = i(70),
    ...
    r.inherits(c, d), e.ripemd160 = c, c.blockSize = 512, c.outSize = 160, c.hmacStrength = 192, c.padLength = 64, c.prototype._update = function(t, e) {
        for (var i = this.h[0], r = this.h[1], n = this.h[2], d = this.h[3], c = this.h[4], g = i, v = r, m = n, A = d, E = c, w = 0; w < 80; w++) {
            var P = a(o(u(i, f(w, r, n, d), t[p[w] + e], l(w)), y[w]), c);
            i = c, c = d, d = o(n, 10), n = r, r = P, P = a(o(u(g, f(79 - w, v, m, A), t[_[w] + e], h(w)), b[w]), E), g = E, E = A, A = o(m, 10), m = v, v = P
        }
        P = s(this.h[1], n, A), this.h[1] = s(this.h[2], d, E), this.h[2] = s(this.h[3], c, g), this.h[3] = s(this.h[4], i, v), this.h[4] = s(this.h[0], r, m), this.h[0] = P
    ...
    (function(t) {
        ...
        }, i(288), e.setImmediate = "undefined" != typeof self && self.setImmediate || void 0 !== t && t.setImmediate || this && this.setImmediate, e.clearImmediate = "undefined" != typeof self && self.clearImmediate || void 0 !== t && t.clearImmediate || this && this.clearImmediate
    }).call(this, i(181))
}, , , , function(t, e) {}, function(t, e, i) {
    "use strict";
    ...
    r.inherits(v, b), t.exports = v, v.blockSize = 1024, v.outSize = 512, v.hmacStrength = 192, v.padLength = 128, v.prototype._prepareBlock = function(t, e) {
        ...
        for (var U = 0; U < i.length; U += 2) {
            var k = C,
                ...
                W = i[U],
                K = i[U + 1],
                q = _(k, R, x, B, N, j, H, F, W, K),
                V = y(k, R, x, B, N, j, H, F, W, K);
            k = P(r, n), R = I(r, n), x = E(r, n, a, s, u), B = w(r, n, a, s, u, d);
            var z = f(k, R, x, B),
                Y = l(k, R, x, B);
            C = D, O = L, D = v, L = T, v = b, T = g, b = f(h, p, q, V), g = l(p, p, q, V), h = u, p = d, u = a, d = s, a = r, s = n, r = f(q, V, z, Y), n = l(q, V, z, Y)
        }
        c(this.h, 0, r, n), c(this.h, 2, a, s), c(this.h, 4, u, d), c(this.h, 6, h, p), c(this.h, 8, b, g), c(this.h, 10, v, T), c(this.h, 12, D, L), c(this.h, 14, C, O)
    ...
    "use strict";
    e.sha1 = i(407), e.sha224 = i(108), e.sha256 = i(406), e.sha384 = i(133), e.sha512 = i(179)
}, , , , function(t, e, i) {
    "use strict";
    var r = i(270).Buffer,
    ...
    (function(e, r) {
        ...
        Object.defineProperty(v.prototype, "destroyed", {
            ...
            return p || (p = i(190).StringDecoder), this._readableState.decoder = new p(t), this._readableState.encoding = t, this
        };
        var E = 8388608;
        ...
        v.prototype.read = function(t) {
            ...
            function _(e) {
                h("ondata"), p = !1, !1 !== t.write(e) || p || ((1 === o.pipesCount && o.pipes === t || o.pipesCount > 1 && -1 !== k(o.pipes, t)) && !l && (h("false write response, pause", i._readableState.awaitDrain), i._readableState.awaitDrain++, p = !0), i.pause())
            }
    ...
    (e = t.exports = i(202)).Stream = e, e.Readable = e, e.Writable = i(138), e.Duplex = i(210), e.Transform = i(96), e.PassThrough = i(215)
}, , function(t, e, i) {
    "use strict";
    t.exports = o;
    var r = i(96),
    ...
    n.inherits = i(6), n.inherits(o, r), o.prototype._transform = function(t, e, i) {
        i(null, t)
    }
}, function(t, e, i) {
    (function(e) {
    ...
    i(6)(a, n), a.prototype.update = function(t, e, i) {
    ...
    var r = e;
    r.utils = i(149), r.common = i(244), r.sha = i(186), r.ripemd = i(147), r.hmac = i(265), r.sha1 = r.sha.sha1, r.sha256 = r.sha.sha256, r.sha224 = r.sha.sha224, r.sha384 = r.sha.sha384, r.sha512 = r.sha.sha512, r.ripemd160 = r.ripemd.ripemd160
}, , , , function(t, e, i) {
    "use strict";
    ...
    (e = t.exports = function(t) {
        ...
        return new i
    }).sha = i(1), e.sha1 = i(5), e.sha224 = i(53), e.sha256 = i(438), e.sha384 = i(382), e.sha512 = i(8)
}, , function(t, e, i) {
    "use strict";
    var r = i(111),
        n = i(6),
    ...
    function n(t, e) {
        ...
        if (m) {
            ...
            w && c.mergeWith({
                accessHash: w
            }), _ && _.getPageCurrentPlaylist() == c && _.getSortedList() ? c.initSortedList(_.getSortedList()) : n.isFromCurrentPlaylist || (c.removeSortedList(), c.shuffle(0))
            ...
            h = hashCode(D + "_" + M), "wall" == cur.module && val(T) && (M = val(T)), S && (p = {
                postId: S,
                wallQuery: M,
                wallType: D
    ...
    e.publicEncrypt = i(66), e.privateDecrypt = i(243), e.privateEncrypt = function(t, i) {
    ...
    function r(t, e) {
        ...
        var u = AudioUtils.getAudioPerformers(t),
            ...
            c = clean(JSON.stringify(t)).split("$").join("$$"),
            f = getTemplate("audio_row", t);
        return f = (f = (f = (f = (f = f.replace(/%cls%/, n.join(" "))).replace(/%duration%/, d)).replace(/%serialized%/, c)).replace(/%cover_style%/, s)).replace(/%performers%/, u)
    }
    ...
    i(6)(a, o), a.prototype._update = function(t) {
    ...
    e.pbkdf2 = i(113), e.pbkdf2Sync = i(80)
}, , function(t, e, i) {
    "use strict";
    ...
    function r(t, e, i, r, n, o) {
        return cur.apLayer ? cancelEvent(n) : !!vk.widget || (boxRefreshCoords(boxLoader), show(boxLoader), show(boxLayerWrap), stManager.add(["auto_list.js", "audio.css"], function() {
            new AudioPlaylist({
                ...
                var f = extend(nav.objLoc, {
                    z: "audio_playlist" + t + "_" + e + (i ? "/" + i : "")
                });
                nav.setLoc(f), window.audioPlaylistLayerWrap || (window.audioPlaylistLayerWrap = se('<div class="ap_layer_wrap"></div>'), bodyNode.appendChild(window.audioPlaylistLayerWrap));
    ...
    function s(t) {
        ...
        for (var e = t ? t.length : 0, i = [], n = [], s = "", u = 0; u < e; u++) {
            var d = t[u],
                c = d.charCodeAt(0);
            c >= 48 && c <= 57 || "_" === d || "-" === d ? s += d : "(" !== d && ")" !== d && ":" !== d && "," !== d || ("" !== s && (n.push(s), i.push("id"), s = ""), n.push(d), i.push(d))
        }
    ...
    window.AudioLayer = ct.default, window.AudioUtils = ft({}, r.AUDIO_PLAYER_ENUMS, {
        ...
        getAudioFromEl: G.getAudioFromEl,
        asObject: X.asObject,
        ...
        copyPlaylistLink: dt.copyPlaylistLink,
    ...
    var r = e;
    r.bignum = i(203), r.define = i(115).define, r.base = i(59), r.constants = i(14), r.decoders = i(249), r.encoders = i(156)
}, , , function(t, e, i) {
    "use strict";
    ...
    r.inherits(g, y), t.exports = g, g.blockSize = 512, g.outSize = 256, g.hmacStrength = 192, g.padLength = 64, g.prototype._update = function(t, e) {
        ...
        for (a(this.k.length === i.length), r = 0; r < i.length; r++) {
            var E = d(A, h(g), c(g, v, m), this.k[r], i[r]),
                w = s(l(n), f(n, o, y));
    ...
    i(6)(o, n), o.prototype._transform = function(t, e, i) {
        var r = null;
        try {
            this.update(t, e)
        } catch (t) {
    ...
    "use strict";
    __webpack_require__.r(__webpack_exports__);
    var _lib_debug_tools__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(84);
    ...
    var r = i(59).Reporter,
        n = i(59).EncoderBuffer,
        o = i(59).DecoderBuffer,
        a = i(111),
    ...
    "use strict";
    e.utils = i(63), e.Cipher = i(404), e.DES = i(68), e.CBC = i(447), e.EDE = i(253)
}, function(t, e, i) {
    t.exports = i(348)
}, function(t, e, i) {
    "use strict";
