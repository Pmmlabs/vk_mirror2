        ...
        function o() {
            ...
            if (a.withInlinePlayer && (e ? this._addRowPlayer(t, i) : this._removeRowPlayer(t)), e) {
                ...
                if (!n && (a.isWithCovers || a.isNumeric)) {
                    if (n = se('<canvas class="audio_row__sound_bars"></canvas>'), t.appendChild(n), n.width = AudioUtils.AUDIO_ROW_COVER_SIZE * (isRetina() ? 2 : 1),
                        n.height = AudioUtils.AUDIO_ROW_COVER_SIZE * (isRetina() ? 2 : 1), n.style.width = AudioUtils.AUDIO_ROW_COVER_SIZE, n.style.height = AudioUtils.AUDIO_ROW_COVER_SIZE, isRetina()) {
