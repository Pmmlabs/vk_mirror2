! function(t) {
    ...
    "use strict";
    i.r(e), i.d(e, "UNKNOWN_STATE", function() {
        return r
    }), i.d(e, "BACKGROUND_STATE", function() {
        return n
    }), i.d(e, "FULL_SCREEN_STATE", function() {
        return o
    }), i.d(e, "APP_STATE", function() {
        return a
    }), i.d(e, "AudioStatsPlayerAdapter", function() {
        return s
    });
    var r = 0,
        n = 1,
    ...
    i(173)(a, n), a.prototype.update = function(t, e, i) {
    ...
    r.inherits(c, d), e.ripemd160 = c, c.blockSize = 512, c.outSize = 160, c.hmacStrength = 192, c.padLength = 64, c.prototype._update = function(t, e) {
        for (var i = this.h[0], r = this.h[1], n = this.h[2], d = this.h[3], c = this.h[4], g = i, v = r, m = n, A = d, w = c, E = 0; E < 80; E++) {
            var P = a(o(u(i, l(E, r, n, d), t[p[E] + e], f(E)), y[E]), c);
            i = c, c = d, d = o(n, 10), n = r, r = P, P = a(o(u(g, l(79 - E, v, m, A), t[_[E] + e], h(E)), b[E]), w), g = w, w = A, A = o(m, 10), m = v, v = P
        }
    ...
    var _utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(177),
        _playlist_loadAllPlaylistAudios__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(237);
    ...
    function p(t, e, i, o, a, s) {
        ...
        var c = {
            ...
            l = "";
        switch (3 === vk.lang && (l = u.getHours() > 11 ? "pm" : "am", c.hours = u.getHours() % 12 == 0 ? 12 : u.getHours() % 12), vk.lang) {
            case 1:
                switch (u.getHours()) {
                    case 11:
                        e = e.replace(" о ", " об ");
    ...
    function g(t, e) {
        ...
        for (e = new n(e);;) {
            ...
            if (i.isEven() && i.iadd(s), i.testn(1) || i.iadd(u), e.cmp(u)) {
                if (!e.cmp(d))
                    for (; i.mod(c).cmp(l);) i.iadd(h)
            } else
                for (; i.mod(o).cmp(f);) i.iadd(h);
    ...
    (e = t.exports = function(t) {
        ...
        return new i
    }).sha = i(209), e.sha1 = i(28), e.sha224 = i(161), e.sha256 = i(190), e.sha384 = i(199), e.sha512 = i(39)
}, function(t, e, i) {
    "use strict";
        ...
        if (window.tooltips && tooltips.hideAll(), !intval(domData(t, "in-progress"))) {
            ...
            if (u && u.deleteAll) showFastBox({
                ...
                if (a ? re(t) : addClass(t, "audio_row__deleted"), n) {
                    ...
                    var l = getAudioPlayer().getCurrentPlaylist();
                    l && l.getType() == AudioPlaylist.TYPE_RECOM && (s[e.fullId].removedCurrentPos = l.removeAudio(e))
    ...
    "use strict";
    var r = e;
    r.version = i(201).version, r.utils = i(228), r.rand = i(100), r.curve = i(158), r.curves = i(49), r.ec = i(221), r.eddsa = i(213)
}, function(t, e, i) {
    "use strict";
    e.randomBytes = e.rng = e.pseudoRandomBytes = e.prng = i(163), e.createHash = e.Hash = i(147), e.createHmac = e.Hmac = i(178);
    var r = i(159),
        n = Object.keys(r),
    ...
    var d = i(18);
    e.createSign = d.createSign, e.Sign = d.Sign, e.createVerify = d.createVerify, e.Verify = d.Verify, e.createECDH = i(131);
    var c = i(91);
    ...
    t.exports = n;
    var r = i(243).EventEmitter;

    function n() {
        r.call(this)
    }
    i(173)(n, r), n.Readable = i(231), n.Writable = i(153), n.Duplex = i(139), n.Transform = i(236), n.PassThrough = i(240), n.Stream = n, n.prototype.pipe = function(t, e) {
        var i = this;
    ...
    r(u, n), u.prototype.init = function() {
        ...
        for (; f < 80; ++f) i[f] = (e = i[f - 3] ^ i[f - 8] ^ i[f - 14] ^ i[f - 16]) << 1 | e >>> 31;
        for (var h = 0; h < 80; ++h) {
            var p = ~~(h / 20),
                _ = d(r) + l(p, n, o, s) + u + i[h] + a[p] | 0;
    ...
    var r = i(138).Reporter,
        n = i(138).EncoderBuffer,
        o = i(138).DecoderBuffer,
        a = i(203),
    ...
    d.prototype.clone = function() {
        ...
        if (i.obj && a && (r = t.enterObject()), a) {
            ...
            if (null === i.use && null === i.choice) {
                if (i.any) d = t.save();
                var f = this._decodeTag(t, null !== i.implicit ? i.implicit : i.tag, i.any);
                if (t.isError(f)) return f;
                i.any ? n = t.raw(d) : t = f
            }
            if (e && e.track && null !== i.tag && e.track(t.path(), l, t.length, "tagged"), e && e.track && null !== i.tag && e.track(t.path(), t.offset, t.length, "content"), n = i.any ? n : null === i.choice ? this._decodeGeneric(i.tag, t, e) : this._decodeChoice(t, e), t.isError(n)) return n;
    ...
    n.inherits = i(173), n.inherits(o, r), o.prototype.push = function(t, e) {
    ...
    function n(t, e, i) {
        ...
        i && (n += "/" + i), statlogsValueEvent("audio_copy_link", vk.id), Object(r.copyToClipboard)(n), showDoneBox(getLang("audio_playlist_link_copied"))
    }
}, function(t, e, i) {
    "use strict";
    ...
    (function(t) {
        ...
        e.Buffer = u, e.SlowBuffer = function(t) {
            ...
            for (var o = n - r, a = i - e, s = Math.min(o, a), d = this.slice(r, n), c = t.slice(e, i), l = 0; l < s; ++l)
                if (d[l] !== c[l]) {
                    o = d[l], a = c[l];
                    break
                }
        ...
        u.prototype.slice = function(t, e) {
            ...
            return t = +t, e |= 0, i || O(this, t, e, 2, 65535, 0), u.TYPED_ARRAY_SUPPORT ? (this[e] = 255 & t, this[e + 1] = t >>> 8) : L(this, t, e, !0), e + 2
        }, u.prototype.writeUInt16BE = function(t, e, i) {
            return t = +t, e |= 0, i || O(this, t, e, 2, 65535, 0), u.TYPED_ARRAY_SUPPORT ? (this[e] = t >>> 8, this[e + 1] = 255 & t) : L(this, t, e, !1), e + 2
        }, u.prototype.writeUInt32LE = function(t, e, i) {
            return t = +t, e |= 0, i || O(this, t, e, 4, 4294967295, 0), u.TYPED_ARRAY_SUPPORT ? (this[e + 3] = t >>> 24, this[e + 2] = t >>> 16, this[e + 1] = t >>> 8, this[e] = 255 & t) : U(this, t, e, !0), e + 4
        }, u.prototype.writeUInt32BE = function(t, e, i) {
            return t = +t, e |= 0, i || O(this, t, e, 4, 4294967295, 0), u.TYPED_ARRAY_SUPPORT ? (this[e] = t >>> 24, this[e + 1] = t >>> 16, this[e + 2] = t >>> 8, this[e + 3] = 255 & t) : U(this, t, e, !1), e + 4
            ...
            return t = +t, e |= 0, i || O(this, t, e, 2, 32767, -32768), u.TYPED_ARRAY_SUPPORT ? (this[e] = 255 & t, this[e + 1] = t >>> 8) : L(this, t, e, !0), e + 2
        }, u.prototype.writeInt16BE = function(t, e, i) {
            return t = +t, e |= 0, i || O(this, t, e, 2, 32767, -32768), u.TYPED_ARRAY_SUPPORT ? (this[e] = t >>> 8, this[e + 1] = 255 & t) : L(this, t, e, !1), e + 2
        }, u.prototype.writeInt32LE = function(t, e, i) {
            return t = +t, e |= 0, i || O(this, t, e, 4, 2147483647, -2147483648), u.TYPED_ARRAY_SUPPORT ? (this[e] = 255 & t, this[e + 1] = t >>> 8, this[e + 2] = t >>> 16, this[e + 3] = t >>> 24) : U(this, t, e, !0), e + 4
        }, u.prototype.writeInt32BE = function(t, e, i) {
            return t = +t, e |= 0, i || O(this, t, e, 4, 2147483647, -2147483648), t < 0 && (t = 4294967295 + t + 1), u.TYPED_ARRAY_SUPPORT ? (this[e] = t >>> 24, this[e + 1] = t >>> 16, this[e + 2] = t >>> 8, this[e + 3] = 255 & t) : U(this, t, e, !1), e + 4
    ...
    var r = i(215),
        ...
        h = r.define("TBSCertificate", function() {
            this.seq().obj(this.key("version").explicit(0).int(), this.key("serialNumber").int(), this.key("signature").use(a), this.key("issuer").use(c), this.key("validity").use(l), this.key("subject").use(c), this.key("subjectPublicKeyInfo").use(s), this.key("issuerUniqueID").implicit(1).bitstr().optional(), this.key("subjectUniqueID").implicit(2).bitstr().optional(), this.key("extensions").explicit(3).seqof(f).optional())
        }),
    ...
    r(u, n), u.prototype.init = function() {
        ...
        for (var e = this._w, i = 0 | this._ah, r = 0 | this._bh, n = 0 | this._ch, o = 0 | this._dh, s = 0 | this._eh, u = 0 | this._fh, g = 0 | this._gh, v = 0 | this._hh, m = 0 | this._al, A = 0 | this._bl, w = 0 | this._cl, E = 0 | this._dl, P = 0 | this._el, S = 0 | this._fl, I = 0 | this._gl, T = 0 | this._hl, C = 0; C < 32; C += 2) e[C] = t.readInt32BE(4 * C), e[C + 1] = t.readInt32BE(4 * C + 4);
        for (; C < 160; C += 2) {
            var M = e[C - 30],
                k = e[C - 30 + 1],
                D = h(M, k),
                O = p(k, M),
                L = _(M = e[C - 4], k = e[C - 4 + 1]),
                U = y(k, M),
                x = e[C - 14],
                R = e[C - 14 + 1],
                N = e[C - 32],
                ...
                j = O + R | 0,
                F = D + x + b(j, O) | 0;
            F = (F = F + L + b(j = j + U | 0, U) | 0) + N + b(j = j + B | 0, B) | 0, e[C] = F, e[C + 1] = j
        }
        for (var H = 0; H < 160; H += 2) {
            ...
            var tt = z + q | 0,
                et = Y + V + b(tt, z) | 0;
            v = g, T = I, g = u, I = S, u = s, S = P, s = o + $ + b(P = E + Q | 0, E) | 0, o = n, E = w, n = r, w = A, r = i, A = m, i = $ + et + b(m = Q + tt | 0, Q) | 0
        }
    ...
    n.inherits = i(173), n.inherits(o, r), o.prototype._transform = function(t, e, i) {
        i(null, t)
    }
}, function(t, e, i) {
    var r = i(59).Buffer,
    ...
    t.exports = function(t, e, i, o) {
        ...
        for (var a = i / 8, s = r.alloc(a), u = r.alloc(o || 0), d = r.alloc(0); a > 0 || o > 0;) {
            ...
            if (a > 0) {
                var f = s.length - a;
                l = Math.min(a, d.length), d.copy(s, f, 0, l), a -= l
            }
            if (l < d.length && o > 0) {
                var h = u.length - o,
                    p = Math.min(o, d.length - l);
                d.copy(u, h, l, l + p), o -= p
            }
        }
        return d.fill(0), {
            key: s,
        ...
        t.exports = function(t, i, u, d, c) {
            ...
            if ("dsa" === l.type) {
                ...
                return function(t, e, i) {
                    ...
                    var h = r.mont(n),
                        p = l.invm(a);
                    return 0 === u.toRed(h).redPow(new r(e).mul(p).mod(a)).fromRed().mul(d.toRed(h).redPow(f.mul(p).mod(a)).fromRed()).mod(n).mod(a).cmp(f)
                }(t, i, l)
            }
            if ("rsa" !== d && "ecdsa/rsa" !== d) throw new Error("wrong public key type");
            i = e.concat([c, i]);
            for (var f = l.modulus.byteLength(), h = [1], p = 0; i.length + h.length + 2 < f;) h.push(255), p++;
            h.push(0);
            ...
            var b = p < 8 ? 1 : 0;
            for (f = Math.min(t.length, h.length), t.length !== h.length && (b = 1), _ = -1; ++_ < f;) b |= t[_] ^ h[_];
            return 0 === b
        }
    }).call(this, i(35).Buffer)
}, function(t) {
    ...
    function a(t, e, i, r, n) {
        for (var o, a, s, u, d = i[0], c = i[1], l = i[2], f = i[3], h = t[0] ^ e[0], p = t[1] ^ e[1], _ = t[2] ^ e[2], y = t[3] ^ e[3], b = 4, g = 1; g < n; g++) o = d[h >>> 24] ^ c[p >>> 16 & 255] ^ l[_ >>> 8 & 255] ^ f[255 & y] ^ e[b++], a = d[p >>> 24] ^ c[_ >>> 16 & 255] ^ l[y >>> 8 & 255] ^ f[255 & h] ^ e[b++], s = d[_ >>> 24] ^ c[y >>> 16 & 255] ^ l[h >>> 8 & 255] ^ f[255 & p] ^ e[b++], u = d[y >>> 24] ^ c[h >>> 16 & 255] ^ l[p >>> 8 & 255] ^ f[255 & _] ^ e[b++], h = o, p = a, _ = s, y = u;
    ...
    var s = [0, 1, 2, 4, 8, 16, 32, 64, 128, 27, 54],
        u = function() {
            ...
            for (var i = [], r = [], n = [
                ...
                n[0][a] = h << 24 | h >>> 8, n[1][a] = h << 16 | h >>> 16, n[2][a] = h << 8 | h >>> 24, n[3][a] = h, h = 16843009 * f ^ 65537 * l ^ 257 * c ^ 16843008 * a, o[0][d] = h << 24 | h >>> 8, o[1][d] = h << 16 | h >>> 16, o[2][d] = h << 8 | h >>> 24, o[3][d] = h, 0 === a ? a = s = 1 : (a = c ^ t[t[t[f ^ c]]], s ^= t[t[s]])
            }
            return {
                SBOX: i,
                INV_SBOX: r,
    ...
    d.blockSize = 16, d.keySize = 32, d.prototype.blockSize = d.blockSize, d.prototype.keySize = d.keySize, d.prototype._reset = function() {
        ...
        for (var d = [], c = 0; c < r; c++) {
            var l = r - c,
                f = n[l - (c % 4 ? 0 : 4)];
            d[c] = c < 4 || l <= 4 ? f : u.INV_SUB_MIX[0][u.SBOX[f >>> 24]] ^ u.INV_SUB_MIX[1][u.SBOX[f >>> 16 & 255]] ^ u.INV_SUB_MIX[2][u.SBOX[f >>> 8 & 255]] ^ u.INV_SUB_MIX[3][u.SBOX[255 & f]]
        }
    ...
    (function(e, r) {
        ...
        Object.defineProperty(v.prototype, "destroyed", {
            ...
            return p || (p = i(242).StringDecoder), this._readableState.decoder = new p(t), this._readableState.encoding = t, this
        };
        var w = 8388608;
        ...
        v.prototype.read = function(t) {
            ...
            function d(e, r) {
                h("onunpipe"), e === i && r && !1 === r.hasUnpiped && (r.hasUnpiped = !0, h("cleanup"), t.removeListener("close", b), t.removeListener("finish", g), t.removeListener("drain", l), t.removeListener("error", y), t.removeListener("unpipe", d), i.removeListener("end", c), i.removeListener("end", v), i.removeListener("data", _), f = !0, !o.awaitDrain || t._writableState && !t._writableState.needDrain || l())
            }
            ...
            function _(e) {
                h("ondata"), p = !1, !1 !== t.write(e) || p || ((1 === o.pipesCount && o.pipes === t || o.pipesCount > 1 && -1 !== U(o.pipes, t)) && !f && (h("false write response, pause", i._readableState.awaitDrain), i._readableState.awaitDrain++, p = !0), i.pause())
            }
            ...
            if ("data" === t) !1 !== this._readableState.flowing && this.resume();
                ...
                r.endEmitted || r.readableListening || (r.readableListening = r.needReadable = !0, r.emittedReadable = !1, r.reading ? r.length && P(this) : n.nextTick(C, this))
            }
            return i
            ...
            return t.flowing || (h("resume"), t.flowing = !0, function(t, e) {
                e.resumeScheduled || (e.resumeScheduled = !0, n.nextTick(M, t, e))
            }(this, t)), this
    ...
    e.inherits = n, e.toArray = function(t, e) {
        ...
        var c = 0,
            l = e;
        return c += (l = l + r >>> 0) < e ? 1 : 0, c += (l = l + o >>> 0) < o ? 1 : 0, c += (l = l + s >>> 0) < s ? 1 : 0, t + i + n + a + u + (c += (l = l + d >>> 0) < d ? 1 : 0) >>> 0
    ...
    t.exports = u, u.prototype.point = function() {
        ...
        for (var c = this.jpoint(null, null, null), l = this.jpoint(null, null, null), f = n; f > 0; f--) {
            for (u = 0; u < a.length; u++) {
                (d = a[u]) === f ? l = l.mixedAdd(i.points[u]) : d === -f && (l = l.mixedAdd(i.points[u].neg()))
            }
            c = c.add(l)
        }
        return c.toP()
        ...
        for (var s = this._wnafT1, u = this._wnafT2, d = this._wnafT3, c = 0, l = 0; l < r; l++) {
            var f = (S = e[l])._getNAFPoints(t);
            s[l] = f.wnd, u[l] = f.points
        }
        for (l = r - 1; l >= 1; l -= 2) {
            var h = l - 1,
                p = l;
        ...
        for (l = c; l >= 0; l--) {
            for (var E = 0; l >= 0;) {
                var P = !0;
                for (g = 0; g < r; g++) w[g] = 0 | d[g][l], 0 !== w[g] && (P = !1);
                if (!P) break;
                E++, l--
            }
            if (l >= 0 && E++, A = A.dblp(E), l < 0) break;
            for (g = 0; g < r; g++) {
                var S, I = w[g];
    ...
    (function(e) {
        ...
        function u(t) {
            ...
            switch (l) {
                case "CERTIFICATE":
                    d = r.certificate.decode(f, "der").tbsCertificate.subjectPublicKeyInfo;
                case "PUBLIC KEY":
                    switch (d || (d = r.PublicKey.decode(f, "der")), u = d.algorithm.algorithm.join(".")) {
                ...
                case "ENCRYPTED PRIVATE KEY":
                    f = function(t, i) {
                        var r = t.algorithm.decrypt.kde.kdeparams.salt,
                            ...
                            l = parseInt(u.split("-")[1], 10) / 8,
                            f = s.pbkdf2Sync(i, r, o, l),
                            h = a.createDecipheriv(u, f, d),
                            p = [];
                        return p.push(h.update(c)), p.push(h.final()), e.concat(p)
                    }(f = r.EncryptedPrivateKey.decode(f, "der"), i);
                case "PRIVATE KEY":
                    switch (u = (d = r.PrivateKey.decode(f, "der")).algorithm.algorithm.join(".")) {
                        case "1.2.840.113549.1.1.1":
    ...
    u.prototype.deriveKeys = function(t, e) {
        ...
        for (var o = e, s = i, u = 0; u < t.keys.length; u += 2) {
            ...
            var l = a.substitute(d, c),
                f = s;
            s = (o ^ a.permute(l)) >>> 0, o = f
        }
        a.rip(s, o, r, n)
    ...
    function s(t, e, i, o, a, s) {
        if ((t = Object(r.ge)(t)) && 3 != t.nodeType && 8 != t.nodeType) {
            ...
            var l = Object(r.data)(t, "events") || Object(r.data)(t, "events", {}),
            ...
            Object(n.each)(e.split(/\s+/), function(e, i) {
                l[i] || (l[i] = [], !o && t.addEventListener ? t.addEventListener(i, h, s) : !o && t.attachEvent && t.attachEvent("on" + i, h)), l[i].push(d)
            })
        }
    }
    ...
    function s(t, e) {
        ...
        var c = AudioUtils.getAudioPerformers(t),
            l = t[AudioUtils.AUDIO_ITEM_INDEX_DURATION],
            f = formatTime(l),
    ...
    function r(t, e, i, r, n, o) {
        ...
        if (domInsertAfter(c, d), d = c, c.addEventListener("click", function() {
            ...
            var l = se(rs(AudioUtils.AUDIO_ROW_ACTION_ROW_ITEM, ["pl_more", 0, getLang("audio_row_show_all_playlists"), "audio_row__action_playlist"]));
    ...
    a(d, s), t.exports = d, d.prototype._getEndomorphism = function(t) {
        ...
        for (var e, i, r, n, a, s, u, d, c, l = this.n.ushrn(Math.floor(this.n.bitLength() / 2)), f = t, h = this.n.clone(), p = new o(1), _ = new o(0), y = new o(0), b = new o(1), g = 0; 0 !== f.cmpn(0);) {
            var v = h.div(f);
            d = h.sub(v.mul(f)), c = y.sub(v.mul(p));
            var m = b.sub(v.mul(_));
            if (!r && d.cmp(l) < 0) e = u.neg(), i = p, r = d.neg(), n = c;
            else if (r && 2 == ++g) break;
            u = d, h = f, f = d, y = p, p = c, b = _, _ = m
        }
        a = d.neg(), s = c;
    ...
    }, a(l, s.BasePoint), d.prototype.jpoint = function(t, e, i) {
        ...
        var d = s.redSqr(),
            c = d.redMul(s),
            l = r.redMul(d),
            f = u.redSqr().redIAdd(c).redISub(l).redISub(l),
            h = u.redMul(l.redISub(f)).redISub(o.redMul(c)),
        ...
        var u = a.redSqr(),
            d = u.redMul(a),
            c = i.redMul(u),
            l = s.redSqr().redIAdd(d).redISub(c).redISub(c),
            f = s.redMul(c.redISub(l)).redISub(n.redMul(d)),
            h = this.z.redMul(a);
        return this.curve.jpoint(l, f, h)
        ...
        for (i = 0; i < t; i++) {
            ...
            var g = d.redMul(s);
            i + 1 < t && (u = u.redMul(f)), o = _, s = g, d = b
        }
        ...
        if (this.zOne) {
            ...
            var c = this.x.redSqr(),
                l = this.y.redSqr(),
                f = l.redSqr(),
                h = this.x.redAdd(l).redSqr().redISub(c).redISub(f);
            h = h.redIAdd(h);
        ...
        if (this.zOne) {
            ...
            t = h.redSqr().redISub(_), i = this.y.redAdd(this.z).redSqr().redISub(l).redISub(c);
            var y = l.redSqr();
        ...
        var l = this.x.redMul(s).redISub(c);
        l = (l = l.redIAdd(l)).redIAdd(l);
        var f = this.y.redMul(d.redMul(u.redISub(d)).redISub(a.redMul(s)));
        f = (f = (f = f.redIAdd(f)).redIAdd(f)).redIAdd(f);
    ...
    e.define = function(t, e) {
        ...
        var e;
        try {
            e = i(108).runInThisContext("(function " + this.name + "(entity) {\n  this._initNamed(entity);\n})")
        } catch (t) {
            e = function(t) {
                this._initNamed(t)
            }
    ...
    "use strict";
    i.r(e), i.d(e, "WebPlayerAdapter", function() {
        return u
    });
    var r = i(7),
        n = i(177);
    var o = window,
        ...
        u = function(t) {
            ...
            return function(t, e) {
                ...
                return !!t && Boolean(t[n.AudioUtils.AUDIO_ITEM_INDEX_NEW_STATS])
            }, e.prototype.getPausedBy = function(t) {
                var e = this.player,
                    i = e.pausedByVideo,
                    r = e.pausedByStories,
                    n = e.pausedByAudio;
                return i && t < i || window.Videoview && Videoview.isLayerShown() ? "video" : r && t < r || window.cur && cur.storyLayer ? "stories" : n && t < n ? "audio" : null
            }, e.prototype.getState = function() {
                var e = t.prototype.getState.call(this),
                    i = this.getAudioId();
                if (i) {
                    var n = s("_audio_row_" + i + " audio_row__current", a("page_layout"));
                    if (n && n.length) return r.FULL_SCREEN_STATE
                }
                return e
                ...
                var t = this.player.getCurrentAudio();
                return t ? Math.round(this.player.getCurrentProgress() * t[n.AudioUtils.AUDIO_ITEM_INDEX_DURATION]) : 0
            }, e.prototype.getVolume = function() {
                return Math.round(100 * this.player.getVolume())
            }, e.prototype.getAudioId = function() {
                var t = this.player.getCurrentAudio();
                if (t) return t[n.AudioUtils.AUDIO_ITEM_INDEX_OWNER_ID] + "_" + t[n.AudioUtils.AUDIO_ITEM_INDEX_ID]
            }, e.prototype.getAudioTrackCode = function() {
                var t = this.player.getCurrentAudio();
                if (t) return t[n.AudioUtils.AUDIO_ITEM_INDEX_TRACK_CODE]
                ...
                return this.player._listenedTime
                ...
                var t = this.player.getCurrentAudio();
                return n.AudioUtils.isPodcast(t)
        ...
        }(r.AudioStatsPlayerAdapter)
}, function(t, e, i) {
    e.pbkdf2 = i(148), e.pbkdf2Sync = i(88)
}, function(t, e, i) {
    var r = {
            ECB: i(222),
            CBC: i(239),
        ...
        (function() {
            ...
            function L(t, e, i) {
                e.constructor === t.constructor && i === S && constructor.resolve === I ? function(t, e) {
                    e._state === M ? R(t, e._result) : e._state === k ? N(t, e._result) : B(e, void 0, function(e) {
                        U(t, e)
                    }, function(e) {
                        N(t, e)
                    })
            ...
            function U(t, e) {
                var i;
                t === e ? N(t, new TypeError("You cannot resolve a promise with itself")) : "function" == typeof(i = e) || "object" == typeof i && null !== i ? L(t, e, O(e)) : R(t, e)
            }
            ...
            function R(t, e) {
                t._state === C && (t._result = e, t._state = M, 0 !== t._subscribers.length && l(j, t))
            }

            function N(t, e) {
                t._state === C && (t._state = k, t._result = e, l(x, t))
            }

            function B(t, e, i, r) {
                var n = t._subscribers,
                    o = n.length;
                t._onerror = null, n[o] = e, n[o + M] = i, n[o + k] = r, 0 === o && t._state && l(j, t)
            }
            ...
            function j(t) {
                var e = t._subscribers,
                    i = t._state;
                if (0 !== e.length) {
                    for (var r, n, o = t._result, a = 0; a < e.length; a += 3) r = e[a], n = e[a + i], r ? V(i, r, n, o) : n(o);
            ...
            function V(t, e, i, r) {
                ...
                e._state !== C || (d && s ? U(e, n) : u ? N(e, o) : t === M ? R(e, n) : t === k && N(e, n))
            }
            var q = function(t) {
            ...
            var Y = function(t) {
                ...
                for (var o = 0; e._state === C && o < i; o++) B(this.resolve(t[o]), void 0, r, n);
                return e
            };
            var z = function(t) {
                    var e = new this(T);
            ...
            K.all = q, K.race = Y, K.resolve = I, K.reject = z, K._setScheduler = function(t) {
                u = t
            ...
            Z.prototype._validationError = function() {
                ...
                if (r === I) {
                    var n = O(t);
                    if (n === S && t._state !== C) this._settledAt(t._state, e, t._result);
                    else if ("function" != typeof n) this._remaining--, this._result[e] = t;
                    else if (i === X) {
                        var o = new i(T);
                        L(o, t, n), this._willSettleAt(o, e)
                ...
                var r = this.promise;
                r._state === C && (this._remaining--, t === k ? N(r, i) : this._result[e] = i), 0 === this._remaining && R(r, this._result)
            ...
            void 0 === (o = function() {
                return Q
            }.call(e, i, e, t)) || (t.exports = o), J()
        }).call(this)
    }).call(this, i(248), i(208))
}, function(t, e, i) {
    var r = i(194),
        n = i(244),
        o = i(16),
    ...
    function l(t, e, i) {
        ...
        for (var l = u.allocUnsafe(s + c[t]), f = u.allocUnsafe(s + c[t]), h = 0; h < s; h++) l[h] = 54 ^ e[h], f[h] = 92 ^ e[h];
        var p = u.allocUnsafe(s + i + 4);
        l.copy(p, 0, 0, s), this.ipad1 = p, this.ipad2 = l, this.opad = f, this.alg = t, this.blocksize = s, this.hash = a, this.size = c[t]
    }
    ...
    e.publicEncrypt = i(141), e.privateDecrypt = i(146), e.privateEncrypt = function(t, i) {
    ...
    (function(e) {
        ...
        function o(t, i) {
            ...
            var _ = h.isub(p).imul(c).umod(l);
            return _.imul(f), p.iadd(_), new e(p.imul(n.unblinder).umod(i.modulus).toArray(!1, o))
        }
    ...
    (function(t, e) {
        ! function(t, i) {
            ...
            if (!t.setImmediate) {
                ...
                }) : l && "onreadystatechange" in l.createElement("script") ? (n = l.documentElement, r = function(t) {
    ...
    e.byteLength = function(t) {
        ...
        for (var e, i = d(t), r = i[0], a = i[1], s = new o(function(t, e, i) {
                return 3 * (e + i) / 4 - i
            }(0, r, a)), u = 0, c = a > 0 ? r - 4 : r, l = 0; l < c; l += 4) e = n[t.charCodeAt(l)] << 18 | n[t.charCodeAt(l + 1)] << 12 | n[t.charCodeAt(l + 2)] << 6 | n[t.charCodeAt(l + 3)], s[u++] = e >> 16 & 255, s[u++] = e >> 8 & 255, s[u++] = 255 & e;
        2 === a && (e = n[t.charCodeAt(l)] << 2 | n[t.charCodeAt(l + 1)] >> 4, s[u++] = 255 & e);
        1 === a && (e = n[t.charCodeAt(l)] << 10 | n[t.charCodeAt(l + 1)] << 4 | n[t.charCodeAt(l + 2)] >> 2, s[u++] = e >> 8 & 255, s[u++] = 255 & e);
        return s
                    ...
                    onDone: function(e, i) {
                        if (i && i.play) {
                            ...
                            var a = function(t) {
                                    ...
                                    if (a) {
                                        var l = i[o.AUDIO_PLAYER_ENUMS.AUDIO_ITEM_INDEX_OWNER_ID] + "_" + i[o.AUDIO_PLAYER_ENUMS.AUDIO_ITEM_INDEX_ID],
                                            f = a.getAudio(l);
                                        f && (f[o.AUDIO_PLAYER_ENUMS.AUDIO_ITEM_INDEX_RESTRICTION] = i[o.AUDIO_PLAYER_ENUMS.AUDIO_ITEM_INDEX_RESTRICTION], f[o.AUDIO_PLAYER_ENUMS.AUDIO_ITEM_INDEX_FLAGS] = i[o.AUDIO_PLAYER_ENUMS.AUDIO_ITEM_INDEX_FLAGS], f[o.AUDIO_PLAYER_ENUMS.AUDIO_ITEM_INDEX_EXTRA] = i[o.AUDIO_PLAYER_ENUMS.AUDIO_ITEM_INDEX_EXTRA])
                                    }
                                    return each(e, function(t, e) {
    ...
    e.read = function(t, e, i, r, n) {
        var o, a, s = 8 * n - r - 1,
            ...
            f = i ? -1 : 1,
            h = t[e + l];
        for (l += f, o = h & (1 << -c) - 1, h >>= -c, c += s; c > 0; o = 256 * o + t[e + l], l += f, c -= 8);
        ...
        var a, s, u, d = 8 * o - n - 1,
            ...
            p = r ? 1 : -1,
            _ = e < 0 || 0 === e && 1 / e < 0 ? 1 : 0;
        for (e = Math.abs(e), isNaN(e) || e === 1 / 0 ? (s = isNaN(e) ? 1 : 0, a = c) : (a = Math.floor(Math.log(e) / Math.LN2), e * (u = Math.pow(2, -a)) < 1 && (a--, u *= 2), (e += a + l >= 1 ? f / u : f * Math.pow(2, 1 - l)) * u >= 2 && (a++, u /= 2), a + l >= c ? (s = 0, a = c) : a + l >= 1 ? (s = (e * u - 1) * Math.pow(2, n), a += l) : (s = e * Math.pow(2, l - 1) * Math.pow(2, n), a = 0)); n >= 8; t[i + h] = 255 & s, h += p, s /= 256, n -= 8);
    ...
    r(a, o), t.exports = a, a.prototype.decode = function(t, e) {
        ...
        var l = i.slice(s + 1, u).join("");
        l.replace(/[^a-z0-9\+\/=]+/gi, "");
        var f = new n(l, "base64");
    ...
    function c(t, e, i) {
        s.call(this), this._cache = new l, this._last = void 0, this._cipher = new u.AES(e), this._prev = n.from(i), this._mode = t, this._autopadding = !0
    }
    ...
    i(173)(c, s), c.prototype._update = function(t) {
        var e, i;
        this._cache.add(t);
    ...
    (function(e) {
        ...
        function _(t, e, i) {
            this.setGenerator(e), this.__prime = new r(t), this._prime = r.mont(this.__prime), this._primeLen = t.length, this._pub = void 0, this._priv = void 0, this._primeCode = void 0, i ? (this.setPublicKey = f, this.setPrivateKey = h) : this._primeCode = 8
        }
        ...
        Object.defineProperty(_.prototype, "verifyError", {
            ...
            get: function() {
                return "number" != typeof this._primeCode && (this._primeCode = function(t, e) {
                    ...
                    var l, f = 0;
                    if (t.isEven() || !c.simpleSieve || !c.fermatTest(t) || !n.test(t)) return f += 1, f += "02" === i || "05" === i ? 8 : 4, p[r] = f, f;
                    switch (n.test(t.shrn(1)) || (f += 2), i) {
                        case "02":
                            t.mod(o).cmp(a) && (f += 8);
                            break;
                        case "05":
                            (l = t.mod(s)).cmp(u) && l.cmp(d) && (f += 8);
                            break;
                        default:
                            f += 4
                    }
    ...
    (function(r) {
        ...
        ! function(o) {
            ...
            o ? function() {
                ...
                try {
                    var t = i(22).randomBytes;
                    u = a = t && function() {
                        return t(16)
                    }, a()
                } catch (t) {}
            }();
            for (var c = "function" == typeof r ? r : Array, l = [], f = {}, h = 0; h < 256; h++) l[h] = (h + 256).toString(16).substr(1), f[l[h]] = h;
            ...
            A.v1 = function(t, e, i) {
                ...
                for (var l = t.node || y, f = 0; f < 6; f++) n[r + f] = l[f];
                return e || p(n)
    ...
    function r(t, e) {
        ...
        if (!intval(domData(t, "in-progress"))) {
            ...
            }), removeClass(t, "audio_row__added"), s && removeClass(s, "audio_row__added"), delete o[e.fullId], getAudioPlayer().notify(AudioPlayer.EVENT_REMOVED, e.fullId, a.addedFullId)) : (ajax.post("al_audio.php", l, {
                onDone: function(t) {
                    if (t) {
    ...
    t.exports = u, u.prototype.decode = function(t, e) {
        ...
        if (t.isError(r)) return r;
        var n = l(t, r.primitive, 'Failed to get length of "' + e + '"');
    ...
    "use strict";
    e.utils = i(207), e.Cipher = i(9), e.DES = i(58), e.CBC = i(181), e.EDE = i(247)
}, function(t, e, i) {
    (function(e) {
    ...
    function n(t, e, i, n) {
        ...
        function a(r) {
            ...
            domData(t, "tooltip-text", r ? n : o), t.innerHTML = r ? n : o, c.setFollowed(r);
            var a = c.getAddClasses() || "";
            a = a.replace("audio_pl__followed", ""), r && (a += " audio_pl__followed"), c.mergeWith({
                addClasses: a
            ...
            if (cur.audioPage && cur.audioPage.updatePlaylistsCounter && "playlists" === cur.audioPage._currentSection) {
                if (t) {
                    ...
                    r = r.filter(function(t) {
                        var r = t.playlistId === i && t.playlistOwnerId === e;
                        return r && (n = t.pl), !r
                    }), n && cur.audioPage._data.playlists.push(n)
                } else cur.audioPage._data.playlists = cur.audioPage._data.playlists.filter(function(t) {
                    var n = t.id === i && t.owner_id === e;
                    return n && r.push({
                        playlistId: i,
                        playlistOwnerId: e,
                        pl: t
        ...
        var u = gpeByClass("_audio_pl", t),
            d = toggleClass(u, "audio_pl__followed"),
            c = getAudioPlayer().getPlaylist(AudioPlaylist.TYPE_PLAYLIST, e, i);
        a(d), s(d), ajax.post("al_audio.php", {
            act: "follow_playlist",
            playlist_owner_id: e,
            playlist_id: i,
            hash: n,
    ...
    r.inherits(v, b), t.exports = v, v.blockSize = 1024, v.outSize = 512, v.hmacStrength = 192, v.padLength = 128, v.prototype._prepareBlock = function(t, e) {
        ...
        for (; r < i.length; r += 2) {
            var n = k(i[r - 4], i[r - 3]),
                ...
                c = i[r - 32],
                l = i[r - 31];
            i[r] = h(n, o, a, s, u, d, c, l), i[r + 1] = p(n, o, a, s, u, d, c, l)
        }
        ...
        for (var L = 0; L < i.length; L += 2) {
            var U = D,
                ...
                V = i[L],
                q = i[L + 1],
                Y = _(U, x, R, N, B, j, F, H, V, q),
                z = y(U, x, R, N, B, j, F, H, V, q);
            U = P(r, n), x = S(r, n), R = w(r, n, a, s, u), N = E(r, n, a, s, u, d);
            var W = l(U, x, R, N),
                X = f(U, x, R, N);
            D = M, O = k, M = v, k = C, v = b, C = g, b = l(h, p, Y, z), g = f(p, p, Y, z), h = u, p = d, u = a, d = s, a = r, s = n, r = l(Y, z, W, X), n = f(Y, z, W, X)
        }
        c(this.h, 0, r, n), c(this.h, 2, a, s), c(this.h, 4, u, d), c(this.h, 6, h, p), c(this.h, 8, b, g), c(this.h, 10, v, C), c(this.h, 12, M, k), c(this.h, 14, D, O)
    ...
    r.inherits(f, c), t.exports = f, f.blockSize = 512, f.outSize = 160, f.hmacStrength = 80, f.padLength = 64, f.prototype._update = function(t, e) {
        for (var i = this.W, r = 0; r < 16; r++) i[r] = t[e + r];
        ...
        for (r = 0; r < i.length; r++) {
            var p = ~~(r / 20),
                _ = u(a(n, 5), d(p, o, c, f), h, i[r], l[p]);
            h = f, f = c, c = a(o, 30), o = n, n = _
        }
        this.h[0] = s(this.h[0], n), this.h[1] = s(this.h[1], o), this.h[2] = s(this.h[2], c), this.h[3] = s(this.h[3], f), this.h[4] = s(this.h[4], h)
        ...
        return t.init = function() {
            ...
            if (e) {
                var s = function() {
                    ...
                    if (0 != n) {
                        var c = n < 0 ? -10 : 10,
                            l = "opacity: 0; top: " + c + "px; left: " + d.offsetLeft + "px",
                            f = e.performer + " &ndash; " + e.title,
                            h = se('<div class="top_audio_player_title top_audio_player_title_next" style="' + l + '">' + f + "</div>");
    ...
    var r = e;
    r.Reporter = i(234).Reporter, r.DecoderBuffer = i(152).DecoderBuffer, r.EncoderBuffer = i(152).EncoderBuffer, r.Node = i(29)
}, function(t, e, i) {
    t.exports = i(154)
}, function(t, e, i) {
    "use strict";
    e.sha1 = i(132), e.sha224 = i(191), e.sha256 = i(0), e.sha384 = i(253), e.sha512 = i(130)
}, function(t, e, i) {
    (function(e) {
        var r = i(57),
            n = i(163),
        ...
        t.exports = function(t, i, l) {
            var f;
            f = t.padding ? t.padding : l ? 1 : 4;
            var h, p = r(t);
            if (4 === f) h = function(t, i) {
                var r = t.modulus.byteLength(),
                    d = i.length,
                    c = o("sha1").update(new e("")).digest(),
                    l = c.length,
                    f = 2 * l;
                if (d > r - f - 2) throw new Error("message too long");
                var h = new e(r - d - f - 2);
                h.fill(0);
                var p = r - l - 1,
                    _ = n(l),
    ...
    window.AudioPlayer || (window.TopAudioPlayer = n.TopAudioPlayer, window.AudioPlaylist = o.AudioPlaylist, window.AudioPlayerHTML5 = u.AudioPlayerHTML5, window.AudioPlayerFlash = d.AudioPlayerFlash, window.AudioPlayer = function() {
        var t = this;
        if (this._currentAudio = !1, this._isPlaying = !1, this._prevPlaylist = null, this._currentPlaylist = null, this._playlists = [], this.subscribers = [], this._tasks = [], this._statusExport = {}, this._currentPlayingRows = [], this._podcastsActionRef = {}, this._podcastsActionLastId = {}, this._allowPrefetchNext = !1, !vk.isBanned) {
            r.AudioUtils.debugLog("Player creation");
            var e = new c.WebPlayerAdapter(this);
            this.stats = new l.AudioStats(e), this._initImpl(), this._initEvents(), this._restoreVolumeState(), this._podcastCleanStates(), setTimeout(function() {
        ...
        var i = 0,
            n = function(t) {
                if (-1 != i) {
                    ...
                    r.AudioUtils.isPodcast(this.getCurrentAudio()) ? (this._isPlaying = !1, this.notify(AudioPlayer.EVENT_PAUSE), this.notify(AudioPlayer.EVENT_ENDED), this.stop()) : this._repeatCurrent ? (this.notify(AudioPlayer.EVENT_ENDED), this.notify(AudioPlayer.EVENT_PLAY), this.notify(AudioPlayer.EVENT_PROGRESS, 0), this._implSeekImmediate(0), this._implPlay()) : (this._isPlaying = !1, this.notify(AudioPlayer.EVENT_PAUSE), this.notify(AudioPlayer.EVENT_ENDED), this.playNext(!0)), this._sendListenedData()
                }
            }.bind(this),
            o = {
        ...
        if (this._impl && (this.isAdPlaying() || !this._muteProgressEvents || !inArray(t, [AudioPlayer.EVENT_BUFFERED, AudioPlayer.EVENT_PROGRESS]))) switch (inArray(t, [AudioPlayer.EVENT_PLAY, AudioPlayer.EVENT_PAUSE]) && (this.subscribers = this.subscribers.filter(function(t) {
            ...
            case AudioPlayer.EVENT_PROGRESS:
                if (this._listenedTime = n, r.AudioUtils.isPodcast(a)) e && n && this._podcastUpdateState(a, e, n, r.AudioUtils.PodcastsLogs.ACTION_HEARTBEAT);
        ...
        if (i = Math.round(i) || 0) {
            ...
            if (!s.useNewStats) {
                ...
                vk.widget && (u.ref = cur.widgetReferrer || ""), n === o.AudioPlaylist.TYPE_SEARCH && e && (u.search_params = JSON.stringify(e.getSearchParams())), e && (e.getType() === o.AudioPlaylist.TYPE_PLAYLIST && (u.playlist_id = e.getFullId && e.getFullId()), e.isShuffled() && (u.shuffled = 1)), t.trackCode && (u.track_code = t.trackCode), this.isRepeatCurrentAudio() && (u.repeat = "one"), this.isAutoPlayed() && (u.auto = 1), this.hasPrevAudio() && (u.prev_audio_id = r.AudioUtils.asObject(this._prevAudio).fullId), this.hasPrevPlaylist() && this._prevPlaylist.getType() === o.AudioPlaylist.TYPE_PLAYLIST && (u.prev_playlist_id = this._prevPlaylist.getFullId && this._prevPlaylist.getFullId()), this.isPlaying() || (u.end_stream_reason = "stop_btn"), u.state = document.hidden ? "background" : "app", this._currentAudioListenData = u, clearTimeout(this._sendListenedTO), this._sendListenedTO = setTimeout(function() {
                    a._sendListenedData()
                }, 1e4)
            }
        }
        ...
        if (r.AudioUtils.isClaimedAudio(n) || n.isReplaceable) {
            var l = r.AudioUtils.getAudioExtra(n).claim;
            if (l) return void(hasClass(i, "no_actions") || n.isInEditBox || showAudioClaimWarning(n, l, r.AudioUtils.replaceWithOriginal.bind(r.AudioUtils, i, n)))
        }
        if (this.podcastSetActionRef(n, n.isPlaying ? r.AudioUtils.PodcastsLogs.ACTION_PAUSE : r.AudioUtils.PodcastsLogs.ACTION_PLAY, "", i), n.isPlaying) this.pause();
            ...
            var f = r.AudioUtils.getContextPlaylist(i);
            this.play(n.fullId, f.playlist, n.context || f.context), cur.audioPage && cur.audioPage.onUserAction(n, f.playlist)
        }
        ...
        if (!cur.loggingOff)
            if (this._impl) {
                ...
                var l = e.getAudio(t);
                l && e.load(e.indexOfAudio(l) + 3), c || (this._trackListenedDataSwitch(s, i, e), this._sendListenedData(), e.getType() == o.AudioPlaylist.TYPE_SEARCH && e.indexOfAudio(l) >= e.getLocalFoundCount() && e.sendSearchStats("search_play"), s && r.AudioUtils.isPodcast(s) && this.isPlaying() && this._podcastUpdateState(s, this.getCurrentProgress(), this._impl.getPlayedTime(), r.AudioUtils.PodcastsLogs.ACTION_PAUSE, {
                    needResetListen: !0
                })), c || this._adsIsAdPlaying() || this._adsDeinit(), c && d ? this._adsIsAdPlaying() ? this._adsResumeAd() : this.isPlaying() || (this._isPlaying = !0, this._sendLCNotification(), this.notify(AudioPlayer.EVENT_PLAY), c || this.notify(AudioPlayer.EVENT_PROGRESS, 0), this._implClearAllTasks(), this._implSetVolume(0), this._implSetUrl(l), this._implPlay(), this._updatePlaybackRate(), this._implSetVolume(this.getVolume(), !0), r.AudioUtils.isPodcast(l) && this._podcastUpdateState(r.AudioUtils.asObject(l), this.getCurrentProgress(), this._impl.getPlayedTime())) : t && l && (this._currentAudio = l, d || (this._currentPlaylist && (this._prevPlaylist = this._currentPlaylist, this._prevAudio = this._currentAudio), this._currentPlaylist = new o.AudioPlaylist(e), this.notify(AudioPlayer.EVENT_PLAYLIST_CHANGED)), this.notify(AudioPlayer.EVENT_CURRENT_CHANGED), this._isPlaying = !0, this.updateCurrentPlaying(!0), this._adsIsAdPlaying() ? (this.notify(AudioPlayer.EVENT_PLAY, !0), this._adsResumeAd()) : (this._sendLCNotification(), this.notify(AudioPlayer.EVENT_PLAY, !0, intval(n), a), this.notify(AudioPlayer.EVENT_PROGRESS, 0), this._muteProgressEvents = !0, this._implClearAllTasks(), this._impl.preparePlay && this._impl.preparePlay(), a ? this._startAdsPlay(l, e, !1, function() {
                    (l = this.getCurrentAudio()) && this.isPlaying() && (this.notify(AudioPlayer.EVENT_UPDATE), this._implSetUrl(l), this._implPlay(), this._updatePlaybackRate(), this._implSetVolume(this.getVolume()), this._triggerTNSPixel())
                }.bind(this)) : (this._implSetVolume(0, !0), this._implPause(), this._startAdsPlay(l, e, !0, function() {
                    (l = this.getCurrentAudio()) && this.isPlaying() && (this.notify(AudioPlayer.EVENT_UPDATE), this._implSetUrl(l), this._implPlay(), this._updatePlaybackRate(), this._implSetVolume(this.getVolume()), this._triggerTNSPixel())
                }.bind(this)))))
                ...
                if (t > 0) {
                    ...
                    if (u) s(u, 1);
                        ...
                        if (u = a.getAudioAt(0), r.AudioUtils.isClaimedAudio(u))
                            for (var d = a.getAudiosList(), c = a.getAudiosCount(), l = 0; l < c; l++) {
                                var f = d[l];
                                if (!r.AudioUtils.isClaimedAudio(f)) {
                                    u = f;
                                    break
                                }
                            }
    ...
    t.exports = o, o.create = function(t) {
        ...
        for (var u = t.shrn(s), d = a.toRed(n); e > 0; e--) {
            ...
            var f = c.toRed(n).redPow(u);
            if (0 !== f.cmp(o) && 0 !== f.cmp(d)) {
                for (var h = 1; h < s; h++) {
                    if (0 === (f = f.redSqr()).cmp(o)) return f.fromRed().subn(1).gcd(t);
                    if (0 === f.cmp(d)) break
                }
                if (h === s) return (f = f.redSqr()).fromRed().subn(1).gcd(t)
            }
        }
        return !1
    }
    ...
    (function(e) {
        ...
        t.exports = function(t, i, c) {
            ...
            f = c ? d(new a(i), h) : s(i, h);
            var _ = new e(p - f.length);
            if (_.fill(0), f = e.concat([_, f], p), 4 === l) return function(t, i) {
                t.modulus;
                var r = t.modulus.byteLength(),
                ...
                if (function(t, i) {
                        ...
                        for (; ++o < n;) r += t[o] ^ i[o];
                        return r
                    }(a, f.slice(0, s))) throw new Error("decryption error");
                var h = s;
                for (; 0 === f[h];) h++;
                if (1 !== f[h++]) throw new Error("decryption error");
                return f.slice(h)
            }(h, f);
            if (1 === l) return function(t, e, i) {
                var r = e.slice(0, 2),
                    n = 2,
                    o = 0;
                for (; 0 !== e[n++];)
        ...
        t.exports = function(t, i, h, p, _, y) {
            ...
            u.isBuffer(t) || (t = u.from(t, a)), u.isBuffer(i) || (i = u.from(i, a)),
                function(t, e) {
                    ...
                    var i = f(n = n || u.alloc(8), n, 10, 128, t).then(function() {
                        return !0
                    }).catch(function() {
                        return !1
                    });
                    ...
                    return e ? f(t, i, h, p, b) : s(t, i, h, p, _)
                }), y)
        }
    }).call(this, i(208), i(248))
}, function(t, e, i) {
    ...
    function o(t) {
        ...
        return {
            ...
            useNewStats: Boolean(t[r.AUDIO_PLAYER_ENUMS.AUDIO_ITEM_INDEX_NEW_STATS])
        }
    }
}, function(t, e, i) {
    "use strict";
                    ...
                    return new a(function(t) {
                        return setTimeout(function() {
                            ...
                            g.innerHTML = "", g.appendChild(b), t([e, function(t) {
                                c = Object(r.rangeCreate)(l, f, h, p), Object(r.rangeInsert)(c, t), u = !1
                            }])
                        }, 0)
                    })
                }
    ...
    "use strict";
    var r = e;
    r.base = i(56), r.short = i(75), r.mont = i(72), r.edwards = i(168)
}, function(t, e, i) {
    t.exports = i(98)
}, function(t, e, i) {
    "use strict";
    ...
    (function(t) {
        ...
        }, i(93), e.setImmediate = "undefined" != typeof self && self.setImmediate || void 0 !== t && t.setImmediate || this && this.setImmediate, e.clearImmediate = "undefined" != typeof self && self.clearImmediate || void 0 !== t && t.clearImmediate || this && this.clearImmediate
    }).call(this, i(208))
}, function(t, e, i) {
    "use strict";
    var r = i(59).Buffer,
    ...
    i(173)(o, n), o.prototype._transform = function(t, e, i) {
        var r = null;
        try {
            this.update(t, e)
        } catch (t) {
    ...
    (function(e) {
        ...
        function d(t, i, n, o) {
            ...
            d.fill(1);
            var l = new e(s);
            return l.fill(0), l = r(o, l).update(d).update(new e([0])).update(t).update(u).digest(), d = r(o, l).update(d).digest(), {
                k: l = r(o, l).update(d).update(new e([1])).update(t).update(u).digest(),
                v: d = r(o, l).update(d).digest()
            }
        }
        ...
        t.exports = function(t, i, r, h, p) {
            ...
            if ("dsa" === _.type) {
                ...
                return function(t, i, r) {
                    for (var n, o = i.params.priv_key, s = i.params.p, u = i.params.q, h = i.params.g, p = new a(0), _ = c(t, u).mod(u), y = !1, b = d(o, u, t, r); !1 === y;) n = l(u, b, r), p = f(h, n, s, u), 0 === (y = n.invm(u).imul(_.add(o.mul(p))).mod(u)).cmpn(0) && (y = !1, p = new a(0));
                    return function(t, i) {
            ...
            return n(b, _)
        }, t.exports.getKey = d, t.exports.makeKey = l
    }).call(this, i(35).Buffer)
}, function(t, e, i) {
    t.exports = i(142)
}, function(t, e, i) {
    ...
    a(d, s), t.exports = d, d.prototype._mulA = function(t) {
        ...
        var e = this.y.redSub(this.x).redMul(t.y.redSub(t.x)),
            ...
            l = o.redMul(u),
            f = a.redMul(s);
        return this.curve.point(d, c, f, l)
        ...
        var e, i, r = this.z.redMul(t.z),
            ...
            l = r.redMul(u).redMul(c);
        return this.curve.twisted ? (e = r.redMul(d).redMul(a.redSub(this.curve._mulA(o))), i = u.redMul(d)) : (e = r.redMul(d).redMul(a.redSub(o)), i = this.curve._mulC(u).redMul(d)), this.curve.point(l, e, i)
    }, c.prototype.add = function(t) {
    ...
    (function(e, r, n) {
        ...
        function g(t) {
            if (s = s || i(154), !(p.call(g, this) || this instanceof s)) return new g(t);
            ...
            if (t._writev && i && i.next) {
                ...
                for (; i;) {
                    var d = i.chunk,
                        c = i.encoding,
                        l = i.callback;
                    if (v(t, e, !1, e.objectMode ? 1 : d.length, d, c, l), i = i.next, e.bufferedRequestCount--, e.writing) break
                }
        ...
        d.inherits(g, l), b.prototype.getBuffer = function() {
            ...
            function() {
                ...
                var r, n = this._writableState,
                    a = !1,
                    s = !n.objectMode && (r = t, f.isBuffer(r) || r instanceof h);
    ...
    }).call(this, i(248), i(164).setImmediate, i(208))
}, function(t, e, i) {
    "use strict";
    ...
    "use strict";
    i.r(e), i.d(e, "AudioStats", function() {
        return h
    });
    var r, n, o = i(7),
    ...
    var d = window.debounce,
        c = (u(r = {}, "start", 1), u(r, "stop", 2), u(r, "volume", 3), u(r, "rewind", 4), u(r, "play_further", 5), r),
        l = (u(n = {}, "default", 1), u(n, "next_track", 2), u(n, "prev_track", 3), u(n, "auto", 4), u(n, "interruption", 5), u(n, "pause", 6), u(n, "new", 7), u(n, "close_app", 8), n),
        f = 300,
        h = function() {
            function t(e) {
                ! function(t, e) {
                    if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
                }(this, t), this.playerAdapter = e, this.listenedData = null, this.sendTimeout = null, this.currentAudioId = null, this.pausedAudioId = null, this.playlistChanged = !1, this.currentPosition = 0, this.playedTime = 0, this.adsCompleted = !1, this.onVolume = d(this.onVolume.bind(this), f), this.playerAdapter.listenPlay(this.onPlay, this), this.playerAdapter.listenPause(this.onPause, this), this.playerAdapter.listenProgress(this.onProgress, this), this.playerAdapter.listenVolume(this.onVolume, this), this.playerAdapter.listenSeek(this.onSeek, this), this.playerAdapter.listenPlaylistChanged(this.onPlaylistChanged, this), this.playerAdapter.listenEnded(this.onEnded, this), this.playerAdapter.listenPlayNext(this.onPlayNext, this), this.playerAdapter.listenAdCompleted(this.onAdCompleted, this), this.onPageClose = this.onPageClose.bind(this), addEvent(window, "beforeunload", this.onPageClose)
            }
            return t.prototype.canOperate = function() {
                ...
                if (t) {
                    ...
                    return {
                        ownerId: i[0],
                        audioId: i[1],
                        trackCode: this.playerAdapter.getAudioTrackCode()
                    }
                }
                return {}
                ...
                if (this.canOperate()) {
                    ...
                    e || this.onTrackSwitch(this.currentAudioId, t), this.playedTime = vkNow(), this.currentAudioId = t, !this.playerAdapter.hasPrevAudio() || this.pausedAudioId && !this.playerAdapter.isAutoPlayed() ? this.currentPosition = this.playerAdapter.getProgressInSeconds() : (this.currentPosition = 0, i = 0), this.sendCurrentAudioEvent({
                        type: "start",
                ...
                this.canOperate() && (this.pausedAudioId = this.playerAdapter.getAudioId(), this.collectListenedData(), this.sendListenedDataDelayed(1e3), setTimeout(function() {
                    if (t.pausedAudioId || !(vkNow() - t.playedTime < 50)) {
                        var e = t.playerAdapter.getPausedBy(t.playedTime);
                        t.sendCurrentAudioEvent({
                            type: "stop",
                            subtype: e ? "interruption" : "default"
                        })
                    }
                }))
            }, t.prototype.onProgress = function() {
                this.currentPosition = this.playerAdapter.getProgressInSeconds(), this.pausedAudioId || this.collectListenedData(), this.adsCompleted && (this.sendCurrentAudioEvent({
                    type: "start",
                    subtype: this.getPlaySubtype(),
                    position: this.currentPosition
                }), this.adsCompleted = !1)
                ...
                if (this.canOperate()) {
                    ...
                    t.position !== t.positionTo && this.sendCurrentAudioEvent(a({
                        type: "rewind",
                        subtype: "default"
                    }, t))
                }
                ...
                this.playerAdapter.isRepeatCurrentAudio() && this.collectListenedData(), this.sendListenedData()
            ...
            }, t.prototype.onTrackSwitch = function() {
                ...
                if (this.listenedData) {
                    var t = this.playerAdapter.isAutoPlayed(),
                        ...
                        i = null;
                    this.playerAdapter.getSequence() && !t ? i = "next_btn" : this.playlistChanged && (i = "playlist_change"), !i && t && (i = "playlist_next"), this.listenedData.end_stream_reason = i || "unknown", e && (this.listenedData.listened = e)
                }
                ...
                if (this.canOperate()) {
                    ...
                    if (i) {
                        ...
                        window.cur && vk.widget && (r.ref = cur.widgetReferrer || ""), this.playerAdapter.hasSearchParams() && (r.search_params = JSON.stringify(this.playerAdapter.getSearchParams())), this.playerAdapter.hasPlaylist() && (this.playerAdapter.isRealPlaylist() && (r.playlist_id = this.playerAdapter.getPlaylistId()), this.playerAdapter.isShuffledPlaylist() && (r.shuffled = 1)), e && (r.track_code = e), this.playerAdapter.isRepeatCurrentAudio() && (r.repeat = "one"), this.playerAdapter.isAutoPlayed() && (r.auto = 1), this.playerAdapter.hasPrevAudio() && (r.prev_audio_id = this.playerAdapter.getPrevAudioId()), this.playerAdapter.hasPrevPlaylist() && this.playerAdapter.isRealPrevPlaylist() && (r.prev_playlist_id = this.playerAdapter.getPrevPlaylistId()), this.playerAdapter.isPlaying() || (r.end_stream_reason = "stop_btn"), r.state = document.hidden ? "background" : "app", this.listenedData = r, this.sendListenedDataDelayed(1e4)
                    }
                }
                ...
                var e = [c[t.type], l[t.subtype], 1];
                return t.audioId ? e.push(t.ownerId + "_" + t.audioId) : e.push(0), t.trackCode ? e.push(t.trackCode) : e.push(0), t.state ? e.push(t.state) : e.push(o.UNKNOWN_STATE), t.ref ? e.push(t.ref) : e.push(""), t.context ? e.push(t.context) : e.push("other"), t.volume || 0 === t.volume ? e.push(t.volume) : e.push(this.playerAdapter.getVolume()), t.position || 0 === t.position ? e.push(t.position) : e.push(this.playerAdapter.getProgressInSeconds()), t.shuffle ? e.push(t.shuffle ? 1 : 0) : e.push(0), t.repeat ? e.push(t.repeat) : e.push(0), t.listened ? e.push(t.listened) : e.push(0), t.positionTo && e.push(t.positionTo), e
            }, t.prototype.sendEvent = function(t) {
                statlogsValueEvent.apply(void 0, ["audio_sts"].concat(function(t) {
                    if (Array.isArray(t)) {
    ...
    window.AudioLayer = yt.default, window.AudioUtils = bt({}, r.AUDIO_PLAYER_ENUMS, {
        ...
        initRowPlaylistsChooser: l.initRowPlaylistsChooser,
        addToPlaylistsBoxInit: f.addToPlaylistsBoxInit,
        ...
        showAudioPlaylist: M.showAudioPlaylist,
        editPlaylist: O.editPlaylist,
        followPlaylist: L.followPlaylist,
        getLayer: U.getLayer,
        ...
        chooseAudioBox: V.chooseAudioBox,
        getAudioArtistsString: q.getAudioArtistsString,
        getAudioPerformers: Y.getAudioPerformers,
        ...
        PodcastsLogs: ct,
        copyPlaylistLink: lt.copyPlaylistLink,
        connectListenQueue: ft.connectListenQueue,
    ...
    r(l, o), l.prototype._update = function(t) {
        ...
        return "rmd160" === (t = t.toLowerCase()) || "ripemd160" === t ? new l("rmd160", e) : "md5" === t ? new n(s, e) : new l(t, e)
    }
}, function(t, e, i) {
    var r = i(252),
        n = i(113),
    ...
    var r = e;
    r.utils = i(54), r.common = i(60), r.sha = i(140), r.ripemd = i(11), r.hmac = i(157), r.sha1 = r.sha.sha1, r.sha256 = r.sha.sha256, r.sha224 = r.sha.sha224, r.sha384 = r.sha.sha384, r.sha512 = r.sha.sha512, r.ripemd160 = r.ripemd.ripemd160
}, function(t, e, i) {
    "use strict";
    ...
    i(173)(a, o), a.prototype._update = function(t) {
    ...
    (function(t, r) {
        ...
        d && d.getRandomValues || !r.browser ? (e.randomFill = function(e, i, r, n) {
            ...
            return l(i, e.length), f(r, i, e.length), h(e, i, r, n)
        }, e.randomFillSync = function(e, i, r) {
            void 0 === i && (i = 0);
            if (!(s.isBuffer(e) || e instanceof t.Uint8Array)) throw new TypeError('"buf" argument must be a Buffer or Uint8Array');
            l(i, e.length), void 0 === r && (r = e.length - i);
            return f(r, i, e.length), h(e, i, r)
    ...
    r(u, n), u.prototype.init = function() {
        ...
        for (var f = 0; f < 80; ++f) {
            var h = ~~(f / 20),
                p = 0 | ((e = r) << 5 | e >>> 27) + c(h, n, o, s) + u + i[f] + a[h];
    ...
    function n(t, e) {
        ...
        if (m) {
            ...
            l = AudioPlaylist.TYPE_WALL, h = n.context;
            ...
            l = AudioPlaylist.TYPE_WALL, f = cur.oid;
            var I = (v || "").split("_")[1],
                T = cur.wallQuery || "",
                C = ge("wall_search"),
                M = inArray(cur.wallType, ["own", "full_own"]) ? "own" : "all";
            h = hashCode(M + "_" + T), "wall" == cur.module && val(C) && (T = val(C)), I && (p = {
                postId: I,
                wallQuery: T,
                wallType: M
        ...
        return a || (a = domPN(t)), (s = s.filter(function(t) {
            return !!t
        })) && 0 != s.length || (s = [a]), (c = (c = c || i.getPlaylist(l, f, h)).getAudiosCount() ? c : AudioUtils.initDomPlaylist(c, s)).mergeWith(p || {}), -1 == c.indexOfAudio(n) && (c = AudioUtils.initDomPlaylist(c, [domPN(t)])), {
            playlist: c,
            context: d
        }
    }
    ...
    var r = e;
    r.bignum = i(227), r.define = i(76).define, r.base = i(138), r.constants = i(73), r.decoders = i(151), r.encoders = i(61)
}, function(t, e, i) {
    "use strict";
    ...
    t.exports = d, d.prototype.keyPair = function(t) {
        ...
        for (var a = this.n.byteLength(), s = e.getPrivate().toArray("be", a), d = t.toArray("be", a), c = new n({
            ...
            var h = o.k ? o.k(f) : new r(c.generate(this.n.byteLength()));
        ...
        var s, d = a.invm(this.n),
            ...
            l = d.mul(o).umod(this.n);
        return this.curve._maxwellTrick ? !(s = this.g.jmulAdd(c, i.getPublic(), l)).isInfinity() && s.eqXToP(o) : !(s = this.g.mulAdd(c, i.getPublic(), l)).isInfinity() && 0 === s.getX().umod(this.n).cmp(o)
        ...
        var o = this.n,
            ...
            l = 1 & i,
            f = i >> 1;
        if (d.cmp(this.curve.p.umod(this.curve.n)) >= 0 && f) throw new Error("Unable to find sencond key candinate");
        d = f ? this.curve.pointFromX(d.add(this.curve.n), l) : this.curve.pointFromX(d, l);
        var h = e.r.invm(o),
        ...
        t.exports = function(t, i) {
            ...
            if (c) {
                var l = "aes" + c[1],
                    f = new e(c[2], "hex"),
                    h = new e(c[3].replace(/[\r\n]/g, ""), "base64"),
                    p = a(i, f.slice(0, 8), parseInt(c[1], 10)).key,
                    _ = [],
                    y = s.createDecipheriv(l, p, f);
    ...
    (function(t) {
        ! function(t, e) {
            ...
            o.isBN = function(t) {
                ...
                if (0 !== a) {
                    var l = 1;
                    for (d = u(t, c, t.length, e), c = 0; c < a; c++) l *= e;
            ...
            function f(t, e, i) {
                ...
                i.words[0] = s;
                for (var d = 1; d < r; d++) {
                    for (var c = u >>> 26, l = 67108863 & u, f = Math.min(d, e.length - 1), h = Math.max(0, d - t.length + 1); h <= f; h++) {
                        var p = d - h | 0;
                        c += (a = (n = 0 | t.words[p]) * (o = 0 | e.words[h]) + l) / 67108864 | 0, l = 67108863 & a
                    }
                    i.words[d] = 0 | l, u = 0 | c
                }
            ...
            o.prototype.toString = function(t, e) {
                ...
                if (t === (0 | t) && t >= 2 && t <= 36) {
                    ...
                    for (p.negative = 0; !p.isZero();) {
                        ...
                        i = (p = p.idivn(h)).isZero() ? _ + i : d[f - _.length] + _ + i
                    }
            ...
            var h = function(t, e, i) {
                ...
                var yt = (d + (r = Math.imul(l, H)) | 0) + ((8191 & (n = (n = Math.imul(l, V)) + Math.imul(f, H) | 0)) << 13) | 0;
                d = ((o = Math.imul(f, V)) + (n >>> 13) | 0) + (yt >>> 26) | 0, yt &= 67108863, r = Math.imul(p, H), n = (n = Math.imul(p, V)) + Math.imul(_, H) | 0, o = Math.imul(_, V);
                var bt = (d + (r = r + Math.imul(l, Y) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(l, z) | 0) + Math.imul(f, Y) | 0)) << 13) | 0;
                d = ((o = o + Math.imul(f, z) | 0) + (n >>> 13) | 0) + (bt >>> 26) | 0, bt &= 67108863, r = Math.imul(b, H), n = (n = Math.imul(b, V)) + Math.imul(g, H) | 0, o = Math.imul(g, V), r = r + Math.imul(p, Y) | 0, n = (n = n + Math.imul(p, z) | 0) + Math.imul(_, Y) | 0, o = o + Math.imul(_, z) | 0;
                var gt = (d + (r = r + Math.imul(l, X) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(l, K) | 0) + Math.imul(f, X) | 0)) << 13) | 0;
                d = ((o = o + Math.imul(f, K) | 0) + (n >>> 13) | 0) + (gt >>> 26) | 0, gt &= 67108863, r = Math.imul(m, H), n = (n = Math.imul(m, V)) + Math.imul(A, H) | 0, o = Math.imul(A, V), r = r + Math.imul(b, Y) | 0, n = (n = n + Math.imul(b, z) | 0) + Math.imul(g, Y) | 0, o = o + Math.imul(g, z) | 0, r = r + Math.imul(p, X) | 0, n = (n = n + Math.imul(p, K) | 0) + Math.imul(_, X) | 0, o = o + Math.imul(_, K) | 0;
                var vt = (d + (r = r + Math.imul(l, Z) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(l, J) | 0) + Math.imul(f, Z) | 0)) << 13) | 0;
                d = ((o = o + Math.imul(f, J) | 0) + (n >>> 13) | 0) + (vt >>> 26) | 0, vt &= 67108863, r = Math.imul(E, H), n = (n = Math.imul(E, V)) + Math.imul(P, H) | 0, o = Math.imul(P, V), r = r + Math.imul(m, Y) | 0, n = (n = n + Math.imul(m, z) | 0) + Math.imul(A, Y) | 0, o = o + Math.imul(A, z) | 0, r = r + Math.imul(b, X) | 0, n = (n = n + Math.imul(b, K) | 0) + Math.imul(g, X) | 0, o = o + Math.imul(g, K) | 0, r = r + Math.imul(p, Z) | 0, n = (n = n + Math.imul(p, J) | 0) + Math.imul(_, Z) | 0, o = o + Math.imul(_, J) | 0;
                var mt = (d + (r = r + Math.imul(l, $) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(l, tt) | 0) + Math.imul(f, $) | 0)) << 13) | 0;
                d = ((o = o + Math.imul(f, tt) | 0) + (n >>> 13) | 0) + (mt >>> 26) | 0, mt &= 67108863, r = Math.imul(I, H), n = (n = Math.imul(I, V)) + Math.imul(T, H) | 0, o = Math.imul(T, V), r = r + Math.imul(E, Y) | 0, n = (n = n + Math.imul(E, z) | 0) + Math.imul(P, Y) | 0, o = o + Math.imul(P, z) | 0, r = r + Math.imul(m, X) | 0, n = (n = n + Math.imul(m, K) | 0) + Math.imul(A, X) | 0, o = o + Math.imul(A, K) | 0, r = r + Math.imul(b, Z) | 0, n = (n = n + Math.imul(b, J) | 0) + Math.imul(g, Z) | 0, o = o + Math.imul(g, J) | 0, r = r + Math.imul(p, $) | 0, n = (n = n + Math.imul(p, tt) | 0) + Math.imul(_, $) | 0, o = o + Math.imul(_, tt) | 0;
                var At = (d + (r = r + Math.imul(l, it) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(l, rt) | 0) + Math.imul(f, it) | 0)) << 13) | 0;
                d = ((o = o + Math.imul(f, rt) | 0) + (n >>> 13) | 0) + (At >>> 26) | 0, At &= 67108863, r = Math.imul(M, H), n = (n = Math.imul(M, V)) + Math.imul(k, H) | 0, o = Math.imul(k, V), r = r + Math.imul(I, Y) | 0, n = (n = n + Math.imul(I, z) | 0) + Math.imul(T, Y) | 0, o = o + Math.imul(T, z) | 0, r = r + Math.imul(E, X) | 0, n = (n = n + Math.imul(E, K) | 0) + Math.imul(P, X) | 0, o = o + Math.imul(P, K) | 0, r = r + Math.imul(m, Z) | 0, n = (n = n + Math.imul(m, J) | 0) + Math.imul(A, Z) | 0, o = o + Math.imul(A, J) | 0, r = r + Math.imul(b, $) | 0, n = (n = n + Math.imul(b, tt) | 0) + Math.imul(g, $) | 0, o = o + Math.imul(g, tt) | 0, r = r + Math.imul(p, it) | 0, n = (n = n + Math.imul(p, rt) | 0) + Math.imul(_, it) | 0, o = o + Math.imul(_, rt) | 0;
                var wt = (d + (r = r + Math.imul(l, ot) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(l, at) | 0) + Math.imul(f, ot) | 0)) << 13) | 0;
                d = ((o = o + Math.imul(f, at) | 0) + (n >>> 13) | 0) + (wt >>> 26) | 0, wt &= 67108863, r = Math.imul(O, H), n = (n = Math.imul(O, V)) + Math.imul(L, H) | 0, o = Math.imul(L, V), r = r + Math.imul(M, Y) | 0, n = (n = n + Math.imul(M, z) | 0) + Math.imul(k, Y) | 0, o = o + Math.imul(k, z) | 0, r = r + Math.imul(I, X) | 0, n = (n = n + Math.imul(I, K) | 0) + Math.imul(T, X) | 0, o = o + Math.imul(T, K) | 0, r = r + Math.imul(E, Z) | 0, n = (n = n + Math.imul(E, J) | 0) + Math.imul(P, Z) | 0, o = o + Math.imul(P, J) | 0, r = r + Math.imul(m, $) | 0, n = (n = n + Math.imul(m, tt) | 0) + Math.imul(A, $) | 0, o = o + Math.imul(A, tt) | 0, r = r + Math.imul(b, it) | 0, n = (n = n + Math.imul(b, rt) | 0) + Math.imul(g, it) | 0, o = o + Math.imul(g, rt) | 0, r = r + Math.imul(p, ot) | 0, n = (n = n + Math.imul(p, at) | 0) + Math.imul(_, ot) | 0, o = o + Math.imul(_, at) | 0;
                var Et = (d + (r = r + Math.imul(l, ut) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(l, dt) | 0) + Math.imul(f, ut) | 0)) << 13) | 0;
                d = ((o = o + Math.imul(f, dt) | 0) + (n >>> 13) | 0) + (Et >>> 26) | 0, Et &= 67108863, r = Math.imul(x, H), n = (n = Math.imul(x, V)) + Math.imul(R, H) | 0, o = Math.imul(R, V), r = r + Math.imul(O, Y) | 0, n = (n = n + Math.imul(O, z) | 0) + Math.imul(L, Y) | 0, o = o + Math.imul(L, z) | 0, r = r + Math.imul(M, X) | 0, n = (n = n + Math.imul(M, K) | 0) + Math.imul(k, X) | 0, o = o + Math.imul(k, K) | 0, r = r + Math.imul(I, Z) | 0, n = (n = n + Math.imul(I, J) | 0) + Math.imul(T, Z) | 0, o = o + Math.imul(T, J) | 0, r = r + Math.imul(E, $) | 0, n = (n = n + Math.imul(E, tt) | 0) + Math.imul(P, $) | 0, o = o + Math.imul(P, tt) | 0, r = r + Math.imul(m, it) | 0, n = (n = n + Math.imul(m, rt) | 0) + Math.imul(A, it) | 0, o = o + Math.imul(A, rt) | 0, r = r + Math.imul(b, ot) | 0, n = (n = n + Math.imul(b, at) | 0) + Math.imul(g, ot) | 0, o = o + Math.imul(g, at) | 0, r = r + Math.imul(p, ut) | 0, n = (n = n + Math.imul(p, dt) | 0) + Math.imul(_, ut) | 0, o = o + Math.imul(_, dt) | 0;
                var Pt = (d + (r = r + Math.imul(l, lt) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(l, ft) | 0) + Math.imul(f, lt) | 0)) << 13) | 0;
                d = ((o = o + Math.imul(f, ft) | 0) + (n >>> 13) | 0) + (Pt >>> 26) | 0, Pt &= 67108863, r = Math.imul(B, H), n = (n = Math.imul(B, V)) + Math.imul(j, H) | 0, o = Math.imul(j, V), r = r + Math.imul(x, Y) | 0, n = (n = n + Math.imul(x, z) | 0) + Math.imul(R, Y) | 0, o = o + Math.imul(R, z) | 0, r = r + Math.imul(O, X) | 0, n = (n = n + Math.imul(O, K) | 0) + Math.imul(L, X) | 0, o = o + Math.imul(L, K) | 0, r = r + Math.imul(M, Z) | 0, n = (n = n + Math.imul(M, J) | 0) + Math.imul(k, Z) | 0, o = o + Math.imul(k, J) | 0, r = r + Math.imul(I, $) | 0, n = (n = n + Math.imul(I, tt) | 0) + Math.imul(T, $) | 0, o = o + Math.imul(T, tt) | 0, r = r + Math.imul(E, it) | 0, n = (n = n + Math.imul(E, rt) | 0) + Math.imul(P, it) | 0, o = o + Math.imul(P, rt) | 0, r = r + Math.imul(m, ot) | 0, n = (n = n + Math.imul(m, at) | 0) + Math.imul(A, ot) | 0, o = o + Math.imul(A, at) | 0, r = r + Math.imul(b, ut) | 0, n = (n = n + Math.imul(b, dt) | 0) + Math.imul(g, ut) | 0, o = o + Math.imul(g, dt) | 0, r = r + Math.imul(p, lt) | 0, n = (n = n + Math.imul(p, ft) | 0) + Math.imul(_, lt) | 0, o = o + Math.imul(_, ft) | 0;
                var St = (d + (r = r + Math.imul(l, pt) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(l, _t) | 0) + Math.imul(f, pt) | 0)) << 13) | 0;
                d = ((o = o + Math.imul(f, _t) | 0) + (n >>> 13) | 0) + (St >>> 26) | 0, St &= 67108863, r = Math.imul(B, Y), n = (n = Math.imul(B, z)) + Math.imul(j, Y) | 0, o = Math.imul(j, z), r = r + Math.imul(x, X) | 0, n = (n = n + Math.imul(x, K) | 0) + Math.imul(R, X) | 0, o = o + Math.imul(R, K) | 0, r = r + Math.imul(O, Z) | 0, n = (n = n + Math.imul(O, J) | 0) + Math.imul(L, Z) | 0, o = o + Math.imul(L, J) | 0, r = r + Math.imul(M, $) | 0, n = (n = n + Math.imul(M, tt) | 0) + Math.imul(k, $) | 0, o = o + Math.imul(k, tt) | 0, r = r + Math.imul(I, it) | 0, n = (n = n + Math.imul(I, rt) | 0) + Math.imul(T, it) | 0, o = o + Math.imul(T, rt) | 0, r = r + Math.imul(E, ot) | 0, n = (n = n + Math.imul(E, at) | 0) + Math.imul(P, ot) | 0, o = o + Math.imul(P, at) | 0, r = r + Math.imul(m, ut) | 0, n = (n = n + Math.imul(m, dt) | 0) + Math.imul(A, ut) | 0, o = o + Math.imul(A, dt) | 0, r = r + Math.imul(b, lt) | 0, n = (n = n + Math.imul(b, ft) | 0) + Math.imul(g, lt) | 0, o = o + Math.imul(g, ft) | 0;
                var It = (d + (r = r + Math.imul(p, pt) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(p, _t) | 0) + Math.imul(_, pt) | 0)) << 13) | 0;
                d = ((o = o + Math.imul(_, _t) | 0) + (n >>> 13) | 0) + (It >>> 26) | 0, It &= 67108863, r = Math.imul(B, X), n = (n = Math.imul(B, K)) + Math.imul(j, X) | 0, o = Math.imul(j, K), r = r + Math.imul(x, Z) | 0, n = (n = n + Math.imul(x, J) | 0) + Math.imul(R, Z) | 0, o = o + Math.imul(R, J) | 0, r = r + Math.imul(O, $) | 0, n = (n = n + Math.imul(O, tt) | 0) + Math.imul(L, $) | 0, o = o + Math.imul(L, tt) | 0, r = r + Math.imul(M, it) | 0, n = (n = n + Math.imul(M, rt) | 0) + Math.imul(k, it) | 0, o = o + Math.imul(k, rt) | 0, r = r + Math.imul(I, ot) | 0, n = (n = n + Math.imul(I, at) | 0) + Math.imul(T, ot) | 0, o = o + Math.imul(T, at) | 0, r = r + Math.imul(E, ut) | 0, n = (n = n + Math.imul(E, dt) | 0) + Math.imul(P, ut) | 0, o = o + Math.imul(P, dt) | 0, r = r + Math.imul(m, lt) | 0, n = (n = n + Math.imul(m, ft) | 0) + Math.imul(A, lt) | 0, o = o + Math.imul(A, ft) | 0;
                var Tt = (d + (r = r + Math.imul(b, pt) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(b, _t) | 0) + Math.imul(g, pt) | 0)) << 13) | 0;
                d = ((o = o + Math.imul(g, _t) | 0) + (n >>> 13) | 0) + (Tt >>> 26) | 0, Tt &= 67108863, r = Math.imul(B, Z), n = (n = Math.imul(B, J)) + Math.imul(j, Z) | 0, o = Math.imul(j, J), r = r + Math.imul(x, $) | 0, n = (n = n + Math.imul(x, tt) | 0) + Math.imul(R, $) | 0, o = o + Math.imul(R, tt) | 0, r = r + Math.imul(O, it) | 0, n = (n = n + Math.imul(O, rt) | 0) + Math.imul(L, it) | 0, o = o + Math.imul(L, rt) | 0, r = r + Math.imul(M, ot) | 0, n = (n = n + Math.imul(M, at) | 0) + Math.imul(k, ot) | 0, o = o + Math.imul(k, at) | 0, r = r + Math.imul(I, ut) | 0, n = (n = n + Math.imul(I, dt) | 0) + Math.imul(T, ut) | 0, o = o + Math.imul(T, dt) | 0, r = r + Math.imul(E, lt) | 0, n = (n = n + Math.imul(E, ft) | 0) + Math.imul(P, lt) | 0, o = o + Math.imul(P, ft) | 0;
                var Ct = (d + (r = r + Math.imul(m, pt) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(m, _t) | 0) + Math.imul(A, pt) | 0)) << 13) | 0;
                d = ((o = o + Math.imul(A, _t) | 0) + (n >>> 13) | 0) + (Ct >>> 26) | 0, Ct &= 67108863, r = Math.imul(B, $), n = (n = Math.imul(B, tt)) + Math.imul(j, $) | 0, o = Math.imul(j, tt), r = r + Math.imul(x, it) | 0, n = (n = n + Math.imul(x, rt) | 0) + Math.imul(R, it) | 0, o = o + Math.imul(R, rt) | 0, r = r + Math.imul(O, ot) | 0, n = (n = n + Math.imul(O, at) | 0) + Math.imul(L, ot) | 0, o = o + Math.imul(L, at) | 0, r = r + Math.imul(M, ut) | 0, n = (n = n + Math.imul(M, dt) | 0) + Math.imul(k, ut) | 0, o = o + Math.imul(k, dt) | 0, r = r + Math.imul(I, lt) | 0, n = (n = n + Math.imul(I, ft) | 0) + Math.imul(T, lt) | 0, o = o + Math.imul(T, ft) | 0;
                var Mt = (d + (r = r + Math.imul(E, pt) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(E, _t) | 0) + Math.imul(P, pt) | 0)) << 13) | 0;
                d = ((o = o + Math.imul(P, _t) | 0) + (n >>> 13) | 0) + (Mt >>> 26) | 0, Mt &= 67108863, r = Math.imul(B, it), n = (n = Math.imul(B, rt)) + Math.imul(j, it) | 0, o = Math.imul(j, rt), r = r + Math.imul(x, ot) | 0, n = (n = n + Math.imul(x, at) | 0) + Math.imul(R, ot) | 0, o = o + Math.imul(R, at) | 0, r = r + Math.imul(O, ut) | 0, n = (n = n + Math.imul(O, dt) | 0) + Math.imul(L, ut) | 0, o = o + Math.imul(L, dt) | 0, r = r + Math.imul(M, lt) | 0, n = (n = n + Math.imul(M, ft) | 0) + Math.imul(k, lt) | 0, o = o + Math.imul(k, ft) | 0;
                var kt = (d + (r = r + Math.imul(I, pt) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(I, _t) | 0) + Math.imul(T, pt) | 0)) << 13) | 0;
                d = ((o = o + Math.imul(T, _t) | 0) + (n >>> 13) | 0) + (kt >>> 26) | 0, kt &= 67108863, r = Math.imul(B, ot), n = (n = Math.imul(B, at)) + Math.imul(j, ot) | 0, o = Math.imul(j, at), r = r + Math.imul(x, ut) | 0, n = (n = n + Math.imul(x, dt) | 0) + Math.imul(R, ut) | 0, o = o + Math.imul(R, dt) | 0, r = r + Math.imul(O, lt) | 0, n = (n = n + Math.imul(O, ft) | 0) + Math.imul(L, lt) | 0, o = o + Math.imul(L, ft) | 0;
                var Dt = (d + (r = r + Math.imul(M, pt) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(M, _t) | 0) + Math.imul(k, pt) | 0)) << 13) | 0;
                d = ((o = o + Math.imul(k, _t) | 0) + (n >>> 13) | 0) + (Dt >>> 26) | 0, Dt &= 67108863, r = Math.imul(B, ut), n = (n = Math.imul(B, dt)) + Math.imul(j, ut) | 0, o = Math.imul(j, dt), r = r + Math.imul(x, lt) | 0, n = (n = n + Math.imul(x, ft) | 0) + Math.imul(R, lt) | 0, o = o + Math.imul(R, ft) | 0;
                var Ot = (d + (r = r + Math.imul(O, pt) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(O, _t) | 0) + Math.imul(L, pt) | 0)) << 13) | 0;
                d = ((o = o + Math.imul(L, _t) | 0) + (n >>> 13) | 0) + (Ot >>> 26) | 0, Ot &= 67108863, r = Math.imul(B, lt), n = (n = Math.imul(B, ft)) + Math.imul(j, lt) | 0, o = Math.imul(j, ft);
                var Lt = (d + (r = r + Math.imul(x, pt) | 0) | 0) + ((8191 & (n = (n = n + Math.imul(x, _t) | 0) + Math.imul(R, pt) | 0)) << 13) | 0;
                d = ((o = o + Math.imul(R, _t) | 0) + (n >>> 13) | 0) + (Lt >>> 26) | 0, Lt &= 67108863;
                var Ut = (d + (r = Math.imul(B, pt)) | 0) + ((8191 & (n = (n = Math.imul(B, _t)) + Math.imul(j, pt) | 0)) << 13) | 0;
                return d = ((o = Math.imul(j, _t)) + (n >>> 13) | 0) + (Ut >>> 26) | 0, Ut &= 67108863, u[0] = yt, u[1] = bt, u[2] = gt, u[3] = vt, u[4] = mt, u[5] = At, u[6] = wt, u[7] = Et, u[8] = Pt, u[9] = St, u[10] = It, u[11] = Tt, u[12] = Ct, u[13] = Mt, u[14] = kt, u[15] = Dt, u[16] = Ot, u[17] = Lt, u[18] = Ut, 0 !== d && (u[19] = d, i.length++), i
            };
            ...
            Math.imul || (h = f), o.prototype.mulTo = function(t, e) {
                var i = this.length + t.length;
                return 10 === this.length && 10 === t.length ? h(this, t, e) : i < 63 ? f(this, t, e) : i < 1024 ? function(t, e, i) {
                    ...
                    for (var r = 0, n = 0, o = 0; o < i.length - 1; o++) {
                        ...
                        for (var s = 67108863 & r, u = Math.min(o, e.length - 1), d = Math.max(0, o - t.length + 1); d <= u; d++) {
                            var c = o - d,
                                l = (0 | t.words[c]) * (0 | e.words[d]),
                                f = 67108863 & l;
                            s = 67108863 & (f = f + s | 0), n += (a = (a = a + (l / 67108864 | 0) | 0) + (f >>> 26) | 0) >>> 26, a &= 67108863
                        }
                        i.words[o] = s, r = a, a = n
                    }
                ...
                for (var a = 1; a < n; a <<= 1)
                    for (var s = a << 1, u = Math.cos(2 * Math.PI / s), d = Math.sin(2 * Math.PI / s), c = 0; c < n; c += s)
                        for (var l = u, f = d, h = 0; h < a; h++) {
                            var p = i[c + h],
                                _ = r[c + h],
                                y = i[c + h + a],
                                b = r[c + h + a],
                                g = l * y - f * b;
                            b = l * b + f * y, y = g, i[c + h] = p + y, r[c + h] = _ + b, i[c + h + a] = p - y, r[c + h + a] = _ - b, h !== s && (g = u * l - d * f, f = u * f + d * l, l = g)
                        }
                ...
                var r = 2 * this.guessLen13b(t.length, e.length),
                    ...
                    l = new Array(r),
                    f = i.words;
                f.length = r, this.convert13b(t.words, t.length, a, r), this.convert13b(e.words, e.length, d, r), this.transform(a, o, s, u, r, n), this.transform(d, o, c, l, r, n);
                for (var h = 0; h < r; h++) {
                    var p = s[h] * c[h] - u[h] * l[h];
                    u[h] = s[h] * l[h] + u[h] * c[h], s[h] = p
                }
                return this.conjugate(s, u, r), this.transform(s, u, f, o, r, n), this.conjugate(f, o, r), this.normalize13b(f, r), i.negative = t.negative ^ e.negative, i.length = t.length + e.length, i.strip()
                ...
                for (var l = u - 1; l >= 0; l--) {
                    ...
                    for (f = Math.min(f / a | 0, 67108863), r._ishlnsubmul(n, f, l); 0 !== r.negative;) f--, r.negative = 0, r._ishlnsubmul(n, 1, l), r.isZero() || (r.negative ^= 1);
                    s && (s.words[l] = f)
                }
                ...
                for (var c = i.clone(), l = e.clone(); !e.isZero();) {
                    ...
                    if (f > 0)
                        for (e.iushrn(f); f-- > 0;)(n.isOdd() || a.isOdd()) && (n.iadd(c), a.isub(l)), n.iushrn(1), a.iushrn(1);
                    for (var p = 0, _ = 1; 0 == (i.words[0] & _) && p < 26; ++p, _ <<= 1);
                    if (p > 0)
                        for (i.iushrn(p); p-- > 0;)(s.isOdd() || u.isOdd()) && (s.iadd(c), u.isub(l)), s.iushrn(1), u.iushrn(1);
                ...
                for (var n, a = new o(1), s = new o(0), u = i.clone(); e.cmpn(1) > 0 && i.cmpn(1) > 0;) {
                    ...
                    if (l > 0)
                        for (i.iushrn(l); l-- > 0;) s.isOdd() && s.iadd(u), s.iushrn(1);
            ...
            b.prototype._tmp = function() {
                ...
                for (var l = this.pow(c, n), f = this.pow(t, n.addn(1).iushrn(1)), h = this.pow(t, n), p = a; 0 !== h.cmp(s);) {
                    for (var _ = h, y = 0; 0 !== _.cmp(s); y++) _ = _.redSqr();
                    r(y < p);
                    var b = this.pow(l, new o(1).iushln(p - y - 1));
                    f = f.redMul(b), l = b.redSqr(), h = h.redMul(l), p = y
                }
                return f
                ...
                for (0 === u && (u = 26), r = e.length - 1; r >= 0; r--) {
                    for (var d = e.words[r], c = u - 1; c >= 0; c--) {
                        var l = d >> c & 1;
                        n !== i[0] && (n = this.sqr(n)), 0 !== l || 0 !== a ? (a <<= 1, a |= l, (4 === ++s || 0 === r && 0 === c) && (n = this.mul(n, i[a]), s = 0, a = 0)) : s = 0
                    }
                    u = 26
                }
                return n
    ...
    (e = t.exports = i(51)).Stream = e, e.Readable = e, e.Writable = i(169), e.Duplex = i(154), e.Transform = i(31), e.PassThrough = i(41)
}, function(t, e) {
    var i = {}.toString;
    ...
    n(h, o), h.prototype._update = function() {
        ...
        for (var i = 0 | this._a, r = 0 | this._b, n = 0 | this._c, o = 0 | this._d, h = 0 | this._e, m = 0 | this._a, A = 0 | this._b, w = 0 | this._c, E = 0 | this._d, P = 0 | this._e, S = 0; S < 80; S += 1) {
            var I, T;
            S < 16 ? (I = _(i, r, n, o, h, t[s[S]], l[0], d[S]), T = v(m, A, w, E, P, t[u[S]], f[0], c[S])) : S < 32 ? (I = y(i, r, n, o, h, t[s[S]], l[1], d[S]), T = g(m, A, w, E, P, t[u[S]], f[1], c[S])) : S < 48 ? (I = b(i, r, n, o, h, t[s[S]], l[2], d[S]), T = b(m, A, w, E, P, t[u[S]], f[2], c[S])) : S < 64 ? (I = g(i, r, n, o, h, t[s[S]], l[3], d[S]), T = y(m, A, w, E, P, t[u[S]], f[3], c[S])) : (I = v(i, r, n, o, h, t[s[S]], l[4], d[S]), T = _(m, A, w, E, P, t[u[S]], f[4], c[S])), i = h, h = o, o = p(n, 10), n = r, r = I, m = P, P = E, E = p(w, 10), w = A, A = T
        }
        var C = this._b + n + E | 0;
        this._b = this._c + o + P | 0, this._c = this._d + h + m | 0, this._d = this._e + i + A | 0, this._e = this._a + r + w | 0, this._a = C
    ...
    function f() {
        c && u && (c = !1, u.length ? d = u.concat(d) : l = -1, d.length && h())
    }
    ...
    function U(t, e) {
        ...
        for (var r in t)(!/webkit/i.test(_ua) || "layerX" != r && "layerY" != r && "webkitMovementX" != r && "webkitMovementY" != r) && (e && "object" === s(t[r]) && "prototype" !== r && null !== t[r] ? i[r] = U(t[r]) : i[r] = t[r]);
        return i
    }
    ...
    function q(t) {
        var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
            i = e.kLimit || 1e3;
        return t >= (e.mLimit || 1e6) && !e.noCheck ? q(t = (t = E(t / 1e5)) > 1e3 ? E(t / 10) : t / 10, R(e, {
            noCheck: !0
        }), !0) + "M" : t >= i && !e.noCheck ? q(t = (t = E(t / 100)) > 100 ? E(t / 10) : t / 10, R(e, {
            noCheck: !0
        }), !0) + "K" : Object(n.langNumeric)(t, "%s", !0).replace(/,/g, ".")
    }
    var Y, z = a((Y = null, [function(t) {
            return Y || (Y = Object(r.se)("<span> </span>")), Y.innerText = t, Y.innerHTML
        }, function(t) {
            return Y || (Y = Object(r.se)("<span> </span>")), Y.innerHTML = t.replace(/<br\s*\/?>/gim, "\n"), Y.innerText
        }]), 2),
        W = z[0],
        X = z[1];
    ...
    function q(t, e, i) {
        for (var r = null; null === r && t;)(t = -1 === i ? O(t) : D(t)) && Y(t, e) && (r = t);
        return r
    }
    ...
    function J(t) {
        var e = arguments.length;
        if (e > 1)
            for (var i = 0; i < e; i++) J(arguments[i]);
        else if ((t = s(t)) && t.style) {
            var r = bt(t, "display");
    ...
    function tt(t, e, i) {
        ...
        var n = nt(t)[1],
            ...
            l = u.scrollTop || bodyNode.scrollTop || window.scrollY || 0,
            f = vk.staticheader ? Math.max(0, at(c)[1] - l) : at(c)[1];
        if (e) {
            if (n + o < l + f + i) return n + o - l - f - i;
            if (n > l + d - i) return n - l - d + i
        } else {
            if (n < l + f + i) return n - l - f - i;
            if (n + o > l + d - i) return n + o - l - d + i
        }
        return 0
    }

    function et(t, e) {
        return void 0 === e && (e = !Q(t)), e ? Z(t) : J(t), e
    }
        ...
        if (e && "border-box" === bt(t, "boxSizing") && (e = !1), t === document) o = [Math.max(n.clientWidth, bodyNode.scrollWidth, n.scrollWidth, bodyNode.offsetWidth, n.offsetWidth), Math.max(n.clientHeight, bodyNode.scrollHeight, n.scrollHeight, bodyNode.offsetHeight, n.offsetHeight)];
            ...
            if (Q(t)) u();
                ...
                var d = {
                    ...
                    c = {},
                    l = !1;
                t.style.cssText.indexOf("!important") > -1 && (l = t.style.cssText), Object(r.each)(d, function(e, i) {
    ...
    var ht = function(t, e, i) {
        i = Object(r.positive)(i), setTimeout(ft.pbind(t, e), i)
    };

    function pt(t, e, i) {
        return void 0 === i && (i = !dt(t, e)), (i ? ct : ft)(t, e), i
    }

    function _t(t, e, i, n) {
        return n = Object(r.positive)(n), void 0 === i && (i = !dt(t, e)), (i ? lt : ht)(t, e, n), i
    }
    ...
    function bt(t, e, i) {
        ...
        if (d.getComputedStyle) {
            ...
            if ("opacity" === e && o.browser.msie) {
                var l = t.currentStyle.filter;
                return l && l.indexOf("opacity=") >= 0 ? parseFloat(l.match(/opacity=([^)]*)/)[1]) / 100 + "" : "1"
            }
            var f = e.replace(/\-(\w)/g, function(t, e) {
                return e.toUpperCase()
            });
            "auto" === (u = t.currentStyle[e] || t.currentStyle[f]) && (u = 0), u = (u + "").split(" "), Object(r.each)(u, function(e, i) {
    ...
    function c(t, e, i) {
        s.call(this), this._cache = new f, this._cipher = new u.AES(e), this._prev = o.from(i), this._mode = t, this._autopadding = !0
    }
    i(173)(c, s), c.prototype._update = function(t) {
        var e, i;
        this._cache.add(t);
