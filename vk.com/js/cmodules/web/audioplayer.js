! function(t) {
    ...
    var r = e;
    r.utils = i(232), r.common = i(356), r.sha = i(114), r.ripemd = i(424), r.hmac = i(330), r.sha1 = r.sha.sha1, r.sha256 = r.sha.sha256, r.sha224 = r.sha.sha224, r.sha384 = r.sha.sha384, r.sha512 = r.sha.sha512, r.ripemd160 = r.ripemd.ripemd160
}, function(t, e, i) {
    var r = i(280),
        n = i(262),
        o = i(200),
    ...
    (function(e, r) {
        ...
        Object.defineProperty(v.prototype, "destroyed", {
            ...
            return p || (p = i(260).StringDecoder), this._readableState.decoder = new p(t), this._readableState.encoding = t, this
        };
        var w = 8388608;
        ...
        v.prototype.read = function(t) {
            ...
            function _(e) {
                h("ondata"), p = !1, !1 !== t.write(e) || p || ((1 === o.pipesCount && o.pipes === t || o.pipesCount > 1 && -1 !== O(o.pipes, t)) && !l && (h("false write response, pause", i._readableState.awaitDrain), i._readableState.awaitDrain++, p = !0), i.pause())
            }
    ...
    i(201)(c, s), c.prototype._update = function(t) {
        var e, i;
        this._cache.add(t);
    ...
    i(201)(a, n), a.prototype.update = function(t, e, i) {
    ...
    n.inherits = i(201), n.inherits(o, r), o.prototype._transform = function(t, e, i) {
        i(null, t)
    }
}, function(t, e, i) {
    (function(e) {
    ...
    "use strict";
    e.randomBytes = e.rng = e.pseudoRandomBytes = e.prng = i(185), e.createHash = e.Hash = i(154), e.createHmac = e.Hmac = i(64);
    var r = i(272),
        n = Object.keys(r),
    ...
    var d = i(129);
    e.createSign = d.createSign, e.Sign = d.Sign, e.createVerify = d.createVerify, e.Verify = d.Verify, e.createECDH = i(247);
    var c = i(417);
    ...
    r(u, n), u.prototype.init = function() {
        ...
        for (; M < 160; M += 2) {
            var L = e[M - 30],
                ...
                j = D + R | 0,
                F = k + x + b(j, D) | 0;
            F = (F = F + U + b(j = j + O | 0, O) | 0) + B + b(j = j + N | 0, N) | 0, e[M] = F, e[M + 1] = j
        }
        for (var H = 0; H < 160; H += 2) {
            ...
            var q = c(i, r, n),
                ...
                Z = T + K | 0,
                $ = v + Y + b(Z, T) | 0;
            $ = ($ = ($ = $ + J + b(Z = Z + Q | 0, Q) | 0) + X + b(Z = Z + G | 0, G) | 0) + F + b(Z = Z + j | 0, j) | 0;
            var tt = z + V | 0,
                et = W + q + b(tt, z) | 0;
    ...
    function a(t, e) {
        for (var i = JSON.parse(getTemplate("audio_bits_to_cls")), a = t[AudioUtils.AUDIO_ITEM_INDEX_FLAGS], s = [], u = 0; u < 32; u++) {
            var d = 1 << u;
            a & d && s.push(i[d])
        }
        AudioUtils.isPodcast(t) && (s.push("audio_podcast"), AudioUtils.isPrivatePodcast(t) && s.push("audio_podcast_private")), e && s.push(e);
        var c = "";
        t[AudioUtils.AUDIO_ITEM_INDEX_COVER_URL] && (c = "background-image: url(" + t[AudioUtils.AUDIO_ITEM_INDEX_COVER_URL].split(",")[0] + ")");
        var f = AudioUtils.getAudioPerformers(t),
            l = t[AudioUtils.AUDIO_ITEM_INDEX_DURATION],
            h = formatTime(l),
            p = clean(JSON.stringify(t)).split("$").join("$$"),
            _ = getTemplate("audio_row", t);
        return _ = (_ = (_ = (_ = (_ = (_ = _.replace(/%cls%/, s.join(" "))).replace(/%duration%/, h)).replace(/%serialized%/, p)).replace(/%cover_style%/, c)).replace(/%performers%/, f)).replace(/%duration_mod%/, function(t) {
    ...
    "use strict";
    e.sha1 = i(86), e.sha224 = i(443), e.sha256 = i(273), e.sha384 = i(376), e.sha512 = i(352)
}, function(t, e, i) {
    "use strict";
    ...
    i(201)(o, n), o.prototype._transform = function(t, e, i) {
        var r = null;
        try {
            this.update(t, e)
        } catch (t) {
    ...
    t.exports = n;
    var r = i(149).EventEmitter;

    function n() {
        r.call(this)
    }
    i(201)(n, r), n.Readable = i(430), n.Writable = i(23), n.Duplex = i(95), n.Transform = i(153), n.PassThrough = i(349), n.Stream = n, n.prototype.pipe = function(t, e) {
        var i = this;
    ...
    e.define = function(t, e) {
        ...
        var e;
        try {
            e = i(289).runInThisContext("(function " + this.name + "(entity) {\n  this._initNamed(entity);\n})")
        } catch (t) {
            e = function(t) {
                this._initNamed(t)
            }
    ...
    n.inherits = i(201), n.inherits(o, r), o.prototype.push = function(t, e) {
    ...
    i(201)(a, o), a.prototype._update = function(t) {
    ...
    var r = i(240).Reporter,
        n = i(240).EncoderBuffer,
        o = i(240).DecoderBuffer,
        a = i(66),
    ...
    var r = e;
    r.der = i(351), r.pem = i(439)
}, , , function(t, e, i) {
    var r = e;
    r.bignum = i(381), r.define = i(125).define, r.base = i(240), r.constants = i(160), r.decoders = i(177), r.encoders = i(363)
}, , function(t, e, i) {
    "use strict";
    i.r(e);
    var r = i(338),
    ...
    window.TopAudioPlayer = n.TopAudioPlayer, window.AudioPlaylist = o.AudioPlaylist, window.AudioPlayer || (window.AudioPlayer = function() {
        ...
        if (i = Math.round(i) || 0) {
            ...
            n === o.AudioPlaylist.TYPE_SEARCH && e && (s.search_params = JSON.stringify(e.getSearchParams())), e && (e.getType() === o.AudioPlaylist.TYPE_PLAYLIST && (s.playlist_id = e.getOwnerId() + "_" + e.getAlbumId() + (e.getAccessHash() ? "_" + e.getAccessHash() : "")), e.isShuffled() && (s.shuffled = 1)), t.trackCode && (s.track_code = t.trackCode), this.isRepeatCurrentAudio() && (s.repeat = "one"), this.isAutoPlayed() ? s.auto = 1 : this.isFromNextSequence() ? s.reason = "next" : this.isFromPrevSequence() ? s.reason = "prev" : s.reason = "new", this.hasPrevAudio() && (s.prev_audio_id = r.AudioUtils.asObject(this._prevAudio).fullId), this.hasPrevPlaylist() && (s.prev_playlist_id = this._prevPlaylist.getId()), s.state = document.hidden ? "background" : "app", this._currentAudioListenData = s, clearTimeout(this._sendListenedTO), this._sendListenedTO = setTimeout(function() {
                a._sendListenedData()
            }, 1e4)
        }
        ...
        return this._audioEl.src || this._startUrl || (this._startUrl = Object(a.audioUnmaskSource)(t)), e && e(!0)
        ...
        this._audioEl.src != e && (this._seekOnReady && this._startUrl && e !== this._startUrl && (this._seekOnReady = !1), this._startUrl = "", this._audioEl.src = e);
    ...
    (function(t) {
        ...
        u.prototype.slice = function(t, e) {
            ...
            return t = +t, e |= 0, i || D(this, t, e, 4, 4294967295, 0), u.TYPED_ARRAY_SUPPORT ? (this[e + 3] = t >>> 24, this[e + 2] = t >>> 16, this[e + 1] = t >>> 8, this[e] = 255 & t) : O(this, t, e, !0), e + 4
        }, u.prototype.writeUInt32BE = function(t, e, i) {
            return t = +t, e |= 0, i || D(this, t, e, 4, 4294967295, 0), u.TYPED_ARRAY_SUPPORT ? (this[e] = t >>> 24, this[e + 1] = t >>> 16, this[e + 2] = t >>> 8, this[e + 3] = 255 & t) : O(this, t, e, !1), e + 4
            ...
            return t = +t, e |= 0, i || D(this, t, e, 4, 2147483647, -2147483648), u.TYPED_ARRAY_SUPPORT ? (this[e] = 255 & t, this[e + 1] = t >>> 8, this[e + 2] = t >>> 16, this[e + 3] = t >>> 24) : O(this, t, e, !0), e + 4
        }, u.prototype.writeInt32BE = function(t, e, i) {
            return t = +t, e |= 0, i || D(this, t, e, 4, 2147483647, -2147483648), t < 0 && (t = 4294967295 + t + 1), u.TYPED_ARRAY_SUPPORT ? (this[e] = t >>> 24, this[e + 1] = t >>> 16, this[e + 2] = t >>> 8, this[e + 3] = 255 & t) : O(this, t, e, !1), e + 4
    ...
    (e = t.exports = function(t) {
        ...
        return new i
    }).sha = i(175), e.sha1 = i(170), e.sha224 = i(339), e.sha256 = i(134), e.sha384 = i(223), e.sha512 = i(73)
}, function(t, e) {
    ...
    var _utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(338),
        _playlist_loadAllPlaylistAudios__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(48);
    ...
    var r = e;
    r.Reporter = i(447).Reporter, r.DecoderBuffer = i(221).DecoderBuffer, r.EncoderBuffer = i(221).EncoderBuffer, r.Node = i(163)
}, , , function(t, e, i) {
    (function(r, n) {
        var o;
        (function() {
            ...
            function B(t, e) {
                t._state === M && (t._state = C, t._result = e, f(x, t))
            }
            ...
            function q(t, e, i, r) {
                ...
                if (d) {
                    if ((n = function(t, e) {
                        ...
                        }(i, r)) === H ? (u = !0, o = n.error, n = null) : s = !0, e === n) return void B(e, new TypeError("A promises callback cannot return that same promise."))
                } else n = r, s = !0;
                e._state !== M || (d && s ? O(e, n) : u ? B(e, o) : t === L ? R(e, n) : t === C && B(e, n))
            }
            var V = function(t) {
            ...
            X.all = V, X.race = W, X.resolve = I, X.reject = z, X._setScheduler = function(t) {
                u = t
    ...
    e.pbkdf2 = i(220), e.pbkdf2Sync = i(8)
}, function(t, e, i) {
    (function(t) {
        var r = i(353),
            n = i(106),
    ...
    var indexOf = __webpack_require__(320),
    ...
    window.AudioLayer = ft.default, window.AudioUtils = lt({}, r.AUDIO_PLAYER_ENUMS, {
        ...
        copyPlaylistLink: ct.copyPlaylistLink,
    ...
    var _lib_debug_tools__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(239);
    ...
    r.inherits(v, b), t.exports = v, v.blockSize = 1024, v.outSize = 512, v.hmacStrength = 192, v.padLength = 128, v.prototype._prepareBlock = function(t, e) {
        ...
        for (var U = 0; U < i.length; U += 2) {
            var O = k,
                ...
                q = i[U],
                V = i[U + 1],
                W = _(O, x, R, B, N, j, F, H, q, V),
                z = y(O, x, R, B, N, j, F, H, q, V);
            O = P(r, n), x = S(r, n), R = w(r, n, a, s, u), B = E(r, n, a, s, u, d);
            var Y = f(O, x, R, B),
                K = l(O, x, R, B);
    ...
    (function(t) {
        ! function(t, e) {
            ...
            var h = function(t, e, i) {
                ...
                var Ot = (d + (r = Math.imul(N, pt)) | 0) + ((8191 & (n = (n = Math.imul(N, _t)) + Math.imul(j, pt) | 0)) << 13) | 0;
                return d = ((o = Math.imul(j, _t)) + (n >>> 13) | 0) + (Ot >>> 26) | 0, Ot &= 67108863, u[0] = yt, u[1] = bt, u[2] = gt, u[3] = vt, u[4] = mt, u[5] = At, u[6] = wt, u[7] = Et, u[8] = Pt, u[9] = St, u[10] = It, u[11] = Tt, u[12] = Mt, u[13] = Lt, u[14] = Ct, u[15] = kt, u[16] = Dt, u[17] = Ut, u[18] = Ot, 0 !== d && (u[19] = d, i.length++), i
            };
    ...
    "use strict";
    e.utils = i(101), e.Cipher = i(74), e.DES = i(458), e.CBC = i(120), e.EDE = i(361)
}, , , , function(t, e, i) {
    (function(t) {
        ...
        }, i(212), e.setImmediate = "undefined" != typeof self && self.setImmediate || void 0 !== t && t.setImmediate || this && this.setImmediate, e.clearImmediate = "undefined" != typeof self && self.clearImmediate || void 0 !== t && t.clearImmediate || this && this.clearImmediate
    }).call(this, i(319))
}, , , function(t, e, i) {
    "use strict";
    var r = i(381),
    ...
    (function(e, r, n) {
        ...
        function g(t) {
            if (s = s || i(329), !(p.call(g, this) || this instanceof s)) return new g(t);
    ...
    }).call(this, i(230), i(388).setImmediate, i(319))
}, , function(t, e, i) {
    e.publicEncrypt = i(157), e.privateDecrypt = i(457), e.privateEncrypt = function(t, i) {
    ...
    "use strict";
    var r = e;
    r.base = i(448), r.short = i(365), r.mont = i(440), r.edwards = i(37)
}, , function(t, e, i) {
    "use strict";
    ...
    (e = t.exports = i(19)).Stream = e, e.Readable = e, e.Writable = i(415), e.Duplex = i(329), e.Transform = i(130), e.PassThrough = i(49)
}, , , function(t, e) {
    t.exports = function(t, e) {
    ...
    "use strict";
    var r = e;
    r.version = i(13).version, r.utils = i(325), r.rand = i(193), r.curve = i(420), r.curves = i(12), r.ec = i(123), r.eddsa = i(150)
}, , , function(t, e, i) {
    var r = i(201);
