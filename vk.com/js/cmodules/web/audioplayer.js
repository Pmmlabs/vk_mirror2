! function(t) {
    ...
    i(171)(a, o), a.prototype._update = function(t) {
    ...
    (function(e, r) {
        ...
        Object.defineProperty(v.prototype, "destroyed", {
            ...
            return p || (p = i(26).StringDecoder), this._readableState.decoder = new p(t), this._readableState.encoding = t, this
        };
        var w = 8388608;
    ...
    var r = e;
    r.Reporter = i(51).Reporter, r.DecoderBuffer = i(10).DecoderBuffer, r.EncoderBuffer = i(10).EncoderBuffer, r.Node = i(78)
}, function(t) {
    t.exports = {
    ...
    var _utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(175),
        _playlist_loadAllPlaylistAudios__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(82);
    ...
    t.exports = n;
    var r = i(159).EventEmitter;

    function n() {
        r.call(this)
    }
    i(171)(n, r), n.Readable = i(145), n.Writable = i(15), n.Duplex = i(212), n.Transform = i(162), n.PassThrough = i(155), n.Stream = n, n.prototype.pipe = function(t, e) {
        var i = this;
    ...
    i(171)(c, s), c.prototype._update = function(t) {
        var e, i;
        this._cache.add(t);
    ...
    (function(e, r, n) {
        ...
        function g(t) {
            if (s = s || i(149), !(p.call(g, this) || this instanceof s)) return new g(t);
    ...
    }).call(this, i(197), i(102).setImmediate, i(91))
}, function(t, e, i) {
    (function(e) {
    ...
    e.define = function(t, e) {
        ...
        var e;
        try {
            e = i(18).runInThisContext("(function " + this.name + "(entity) {\n  this._initNamed(entity);\n})")
        } catch (t) {
            e = function(t) {
                this._initNamed(t)
            }
    ...
    var r = i(24).Reporter,
        n = i(24).EncoderBuffer,
        o = i(24).DecoderBuffer,
        a = i(0),
    ...
    (e = t.exports = function(t) {
        ...
        return new i
    }).sha = i(48), e.sha1 = i(199), e.sha224 = i(130), e.sha256 = i(113), e.sha384 = i(107), e.sha512 = i(141)
}, function(t, e, i) {
    "use strict";
    (function(e) {
    ...
    "use strict";
    var r = e;
    r.version = i(139).version, r.utils = i(29), r.rand = i(167), r.curve = i(103), r.curves = i(227), r.ec = i(34), r.eddsa = i(215)
}, function(t, e, i) {
    "use strict";
    var r = i(193),
        n = i(98).utils,
    ...
    (function(t) {
        ...
        }, i(234), e.setImmediate = "undefined" != typeof self && self.setImmediate || void 0 !== t && t.setImmediate || this && this.setImmediate, e.clearImmediate = "undefined" != typeof self && self.clearImmediate || void 0 !== t && t.clearImmediate || this && this.clearImmediate
    }).call(this, i(91))
}, function(t, e, i) {
    "use strict";
    var r = e;
    r.base = i(188), r.short = i(206), r.mont = i(154), r.edwards = i(173)
}, function(t, e, i) {
    "use strict";
    ...
    i(171)(o, n), o.prototype._transform = function(t, e, i) {
        var r = null;
        try {
            this.update(t, e)
        } catch (t) {
    ...
    window.TopAudioPlayer = n.TopAudioPlayer, window.AudioPlaylist = o.AudioPlaylist, window.AudioPlayer || (window.AudioPlayer = function() {
        ...
        if (i = Math.round(i) || 0) {
            ...
            n === o.AudioPlaylist.TYPE_SEARCH && e && (s.search_params = JSON.stringify(e.getSearchParams())), e && (e.getType() === o.AudioPlaylist.TYPE_PLAYLIST && (s.playlist_id = e.getFullId && e.getFullId()), e.isShuffled() && (s.shuffled = 1)), t.trackCode && (s.track_code = t.trackCode), this.isRepeatCurrentAudio() && (s.repeat = "one"), this.isAutoPlayed() && (s.auto = 1), this.hasPrevAudio() && (s.prev_audio_id = r.AudioUtils.asObject(this._prevAudio).fullId), this.hasPrevPlaylist() && this._prevPlaylist.getType() === o.AudioPlaylist.TYPE_PLAYLIST && (s.prev_playlist_id = this._prevPlaylist.getFullId && this._prevPlaylist.getFullId()), this.isPlaying() || (s.end_stream_reason = "stop_btn"), s.state = document.hidden ? "background" : "app", this._currentAudioListenData = s, clearTimeout(this._sendListenedTO), this._sendListenedTO = setTimeout(function() {
                a._sendListenedData()
            }, 1e4)
        }
    ...
    e.pbkdf2 = i(111), e.pbkdf2Sync = i(176)
}, function(t, e, i) {
    "use strict";
    ...
    (e = t.exports = i(14)).Stream = e, e.Readable = e, e.Writable = i(43), e.Duplex = i(149), e.Transform = i(169), e.PassThrough = i(194)
}, function(t, e, i) {
    "use strict";
    ...
    i(171)(a, n), a.prototype.update = function(t, e, i) {
    ...
    var r = e;
    r.utils = i(37), r.common = i(157), r.sha = i(165), r.ripemd = i(202), r.hmac = i(47), r.sha1 = r.sha.sha1, r.sha256 = r.sha.sha256, r.sha224 = r.sha.sha224, r.sha384 = r.sha.sha384, r.sha512 = r.sha.sha512, r.ripemd160 = r.ripemd.ripemd160
}, function(t, e, i) {
    "use strict";
    ...
    "use strict";
    e.sha1 = i(177), e.sha224 = i(119), e.sha256 = i(182), e.sha384 = i(6), e.sha512 = i(158)
}, function(t, e, i) {
    var r = i(233),
        n = i(93),
        o = i(179).Buffer,
    ...
    n.inherits = i(171), n.inherits(o, r), o.prototype.push = function(t, e) {
    ...
    "use strict";
    e.utils = i(148), e.Cipher = i(7), e.DES = i(129), e.CBC = i(170), e.EDE = i(12)
}, function(t, e, i) {
    "use strict";
    ...
    n.inherits = i(171), n.inherits(o, r), o.prototype._transform = function(t, e, i) {
        i(null, t)
    }
}, function(t, e) {}, function(t, e, i) {
    e.publicEncrypt = i(136), e.privateDecrypt = i(222), e.privateEncrypt = function(t, i) {
    ...
    var _lib_debug_tools__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(178);
    ...
    var r = e;
    r.bignum = i(193), r.define = i(75).define, r.base = i(24), r.constants = i(237), r.decoders = i(232), r.encoders = i(56)
}, function(t, e, i) {
    "use strict";
    ...
    "use strict";
    e.randomBytes = e.rng = e.pseudoRandomBytes = e.prng = i(60), e.createHash = e.Hash = i(135), e.createHmac = e.Hmac = i(114);
    var r = i(204),
        n = Object.keys(r),
    ...
    var d = i(153);
    e.createSign = d.createSign, e.Sign = d.Sign, e.createVerify = d.createVerify, e.Verify = d.Verify, e.createECDH = i(150);
    var c = i(196);
