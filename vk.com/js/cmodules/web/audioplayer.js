! function(t) {
    ...
    window.AudioLayer = _audioplayer_audio_layer__WEBPACK_IMPORTED_MODULE_1__.default, window.AudioUtils = {
        ...
        toggleAudioLyrics: function(t, e) {
            ...
            if (i) {
                ...
                e.isPodcast && (r.podcast = !0), ajax.post("al_audio.php", r, {
                    onDone: function(o) {
        ...
        getRowActionName: function(t, e, i) {
            ...
            switch (t) {
                ...
                case "listened_delete":
                    ...
                    break;
                case "delete":
                    if (e.isPodcast) o = getLang("audio_podcast_delete_episode");
                    else if (window.AudioPage && AudioPage.isInRecentPlayed(i)) o = getLang("audio_remove_from_list");
                    else {
                        var s = a[e.fullId];
                ...
                case "add":
                    var r = a[e.fullId];
                    if (e.isPodcast) o = getLang("audio_podcast_restore_episode");
                    else if (r && "deleted" == r.state) o = getLang("audio_restore_audio");
                    ...
                    break;
                case "edit":
                    o = e.isPodcast ? getLang("audio_podcast_edit_episode") : getLang("audio_edit_audio");
                    break;
                case "next":
                ...
                case "recoms":
                    ...
                    break;
                case "fave":
                    o = e.isPodcast ? getLang("audio_podcast_listen_later") : "";
                    break;
                default:
                    o = ""
            }
                ...
                if (moreActions.length && actions.push(["more"]), actions.length) {
                    ...
                    each(actions, function(t, e) {
                        var i = AudioUtils.getRowActionName(e[0], audioObject, audioEl),
                            o = se('<button aria-label="' + i + '" data-action="' + e[0] + '" class="audio_row__action audio_row__action_' + e[0] + " _audio_row__action_" + e[0] + (e[4] || "") + '" ' + (e[3] || "") + ">" + (e[2] || "") + "</button>");
        ...
        addToPlaylistsBoxInit: function(t, e, i, o, a) {
            ...
            addEvent(l, "click", function(t) {
                var e = domClosest("_ape_pl_item", t.target),
                    i = domData(e, "id");
                toggleClass(e, "ape_selected") ? (A[i] = !0, delete h[i]) : (h[i] = !0, delete A[i])
        ...
        shareAudio: function(t, e) {
            if (e = e || getAudioPlayer().getCurrentAudio()) {
                var i = (e = AudioUtils.asObject(e)).isPodcast ? "podcast" : "audio";
        ...
        openEpisode: function(t, e) {
            (e = AudioUtils.asObject(e)).isPodcast && Podcast.show(e.fullId)
        },
        ...
        editEpisode: function(t, e) {
            e.isPodcast && (cur.podcastEditData = {
                audioId: e.fullId
        ...
        deleteEpisode: function(t, e) {
            e.isPodcast && Podcast.deleteEpisode(e.fullId, e.deleteHash)
        },
        restoreEpisode: function(t, e) {
            e.isPodcast && Podcast.restoreEpisode(e.fullId, e.editHash)
        },
        ...
        faveEpisode: function(t, e) {
            if (e.isPodcast) {
                ...
                Podcast.toggleFave(geByClass1("audio_row__action_fave", t), e.fullId, i)
            }
        },
                ...
                new AudioPlaylist({
                    ...
                    var c = n.getAudiosList().length,
                        p = getTemplate("audio_playlist_snippet", {
                            ...
                            href: "/audio?z=audio_playlist" + n.getOwnerId() + "_" + n.getPlaylistId() + "/" + n.getAccessHash(),
        ...
        drawAudio: function(t, e) {
            ...
            AudioUtils.isPodcast(t) && (a.push("audio_podcast"), AudioUtils.isPrivatePodcast(t) && a.push("audio_podcast_private")), e && a.push(e);
            var l = "";
        ...
        asObject: function(t) {
            ...
            return {
                ...
                isPodcast: AudioUtils.isPodcast(t)
            }
        },
        ...
        getContextPlaylist: function(t, e) {
            ...
            if (P) {
                ...
                s = hashCode(S + "_" + L), "wall" == cur.module && val(w) && (L = val(w)), T && (p = {
                    postId: T,
                    wallQuery: L,
                    wallType: S
        ...
        isPodcast: function(t) {
            return !(!t || t[AudioUtils.AUDIO_ITEM_INDEX_ALBUM_ID] !== AudioUtils.AUDIO_PODCAST_ALBUM)
        },
        ...
        function l() {
            ...
            }, 1), toggleClass(a._el, "audio_player_podcast", AudioUtils.isPodcast(e.getCurrentAudio())), addClass(a._el, o), toggleClass(a._el, "top_audio_player_playing", e.isPlaying());
            ...
            } else l && (l.innerHTML = t.performer + " &ndash; " + t.title, l.titleSet = 0, l.setAttribute("onmouseover", "setTitle(this)"))
        }
    ...
    AudioPlaylist.prototype.isFullyLoadable = function() {
        ...
        if (e) {
            ...
            var o = geByClass1("has_audio_player", t);
            o && removeClass(o, "has_audio_player")
        }
        ...
        if (!geByClass1("_audio_inline_player", t)) {
            ...
            a.appendChild(o), addClass(a, "has_audio_player");
        ...
        if (!vk.widget && (AudioPlayer.clearDeprecatedCacheKeys(), AudioPlayer.clearOutdatedCacheKeys(), !window.cur.audioPreventRestoreTrack)) {
            ...
            var e = 0;
            if (AudioUtils.isPodcast(this._currentAudio)) e = ((this._podcastGetStates()[this._currentAudio[AudioUtils.AUDIO_ITEM_INDEX_OWNER_ID] + "_" + this._currentAudio[AudioUtils.AUDIO_ITEM_INDEX_ID]] || {}).position || 0) / this._currentAudio[AudioUtils.AUDIO_ITEM_INDEX_DURATION];
        ...
        this._implNewTask("play", function(e) {
            ...
            if (t._impl.play(i.url), t._muteProgressEvents = !1, t._allowPrefetchNext = !0, i.isPodcast) {
                var o = this._podcastRestoreState();
                this._podcastLog(i, o, 0, "play")
            }
            e()
        })
        ...
        if (this._impl && (this.isAdPlaying() || !this._muteProgressEvents || !inArray(t, [AudioPlayer.EVENT_BUFFERED, AudioPlayer.EVENT_PROGRESS]))) switch (inArray(t, [AudioPlayer.EVENT_PLAY, AudioPlayer.EVENT_PAUSE]) && (this.subscribers = this.subscribers.filter(function(t) {
            ...
            case AudioPlayer.EVENT_PROGRESS:
                if (s.isPodcast) e && this._podcastLog(s, e, o, "heartbeat");
            ...
            case AudioPlayer.EVENT_PAUSE:
                s.isPodcast && this._podcastLog(s, this.getCurrentProgress(), this._impl.getPlayedTime(), "pause"), this._setTabIcon("pause");
                break;
            case AudioPlayer.EVENT_SEEK:
                s.isPodcast && this._podcastLog(s, this.getCurrentProgress(), this._impl.getPlayedTime(), "seek");
                break;
            case AudioPlayer.EVENT_ENDED:
                s.isPodcast && this._podcastLog(s, this.getCurrentProgress(), this._impl.getPlayedTime(), "heartbeat")
        }
        ...
        if (t) {
            ...
            var e = this.statusSent ? this.statusSent.split(",") : [!1, 0],
                i = vkNow() - intval(e[1]);
            if (this.hasStatusExport() && !t.isPodcast && (t.id != e[0] || i > 3e5)) {
                var o = this.getCurrentPlaylist(),
        ...
        if (s >= 0)
            for (var r = s; r < s + 5; r++) {
                ...
                !l || l.url || this._currentUrlEnsure[l.fullId] || (i.push(l.fullId + "_" + l.actionHash), this._currentUrlEnsure[l.fullId] = !0)
            }
        if (i.push(o.fullId), i.length) {
            ...
            ajax.post("al_audio.php", {
                ...
                onDone: function(i, a, s, r) {
                    getAudioPlayer().setStatusExportInfo(a), n._listenedHash = s, r && getAudioPlayer()._podcastSaveData(r), each(i, function(e, i) {
                        i = AudioUtils.asObject(i);
                        var a = {};
                        a[AudioUtils.AUDIO_ITEM_INDEX_URL] = i.url, a[AudioUtils.AUDIO_ITEM_INDEX_ADS] = i.ads, n.updateAudio(i.fullId, a), o.fullId == i.fullId && (t[AudioUtils.AUDIO_ITEM_INDEX_URL] = i.url, t[AudioUtils.AUDIO_ITEM_INDEX_ADS] = i.ads), n._currentAudio && AudioUtils.asObject(n._currentAudio).fullId == i.fullId && (n._currentAudio[AudioUtils.AUDIO_ITEM_INDEX_URL] = i.url, n._currentAudio[AudioUtils.AUDIO_ITEM_INDEX_ADS] = i.ads), delete n._currentUrlEnsure[i.fullId]
                    }), e && e(t)
                }
            })
        }
        ...
        if (o.isPodcast && "A" === e.target.tagName && domClosest("_audio_row__lyrics", e.target)) return !1;
        ...
        if (AudioUtils.isPodcast(t)) return AudioPlayer.ADS_ALLOW_DISABLED;
    ...
    }, AudioPlayer.prototype._podcastLog = function(t, e, i, o) {
        var a = this._podcastGetStates(),
            s = Math.round(t.duration * e);
        a[t.fullId] = {
            t: vkNow(),
            position: s
        }, this._podcastSetStates(a), this._podcasts.episodes[t.fullId] || (this._podcasts.episodes[t.fullId] = {}), this._podcasts.episodes[t.fullId].listen = i, this._podcasts.episodes[t.fullId].logAction = o, this._podcasts.updated = this._podcasts.updated || {}, this._podcasts.updated[t.fullId] = !0, this._podcastLogParts(t, s, o), this._listenedHash && ("heartbeat" !== o ? this._podcastSendLog() : this._podcasts._sendTimer || (this._podcasts._sendTimer = setTimeout(this._podcastSendLog.bind(this), 5e3)))
    }, AudioPlayer.prototype._podcastLogParts = function(t, e, i) {
        var o = "play" === i || "seek" === i;
        if (o || !(this._podcasts._logFrom > e)) {
            var a = t.duration / AudioUtils.AUDIO_PODCAST_PART_COUNT,
                s = e / a,
                r = Math.floor(s),
                l = s - r;
            if (this._podcasts._logFrom && !o) {
                ...
                for (var n = Math.floor(this._podcasts._logFrom / a); n <= r; n++)
                    if (this._podcasts._logFrom = n * a, !this._podcasts.episodes[t.fullId].partsProcessed[n]) {
                        if (!((r > n || r === AudioUtils.AUDIO_PODCAST_PART_COUNT ? 1 : l) >= AudioUtils.AUDIO_PODCAST_PART_LISTEN)) break;
                        this._podcasts.episodes[t.fullId].partsProcessed[n] = this._podcasts.episodes[t.fullId].parts[n] = !0
                    }
            } else this._podcasts._logFrom = (l > AudioUtils.AUDIO_PODCAST_PART_LISTEN ? r + 1 : r) * a
        }
        ...
        each(this._podcasts.updated, function(i) {
            ...
            var o = t._podcasts.episodes[i],
                a = t._podcastGetStates(),
                s = Math.round(o.listen || 0),
                r = o.logListen || 0,
                l = o.logAction || "heartbeat",
                n = Object.keys(o.parts || {});
            a[i] && (e.push([i, a[i].position, Math.max(0, s - r), n.join(","), t.podcastGetPlaybackRate(), l].join(":")), o.listen = 0, o.logListen = s, o.parts = {}, delete o.logAction)
        ...
        var t = this._currentAudio[AudioUtils.AUDIO_ITEM_INDEX_OWNER_ID] + "_" + this._currentAudio[AudioUtils.AUDIO_ITEM_INDEX_ID];
        return !!(this._podcasts.episodes[t] || {}).fave
        ...
        var i = e[AudioUtils.AUDIO_ITEM_INDEX_OWNER_ID] + "_" + e[AudioUtils.AUDIO_ITEM_INDEX_ID],
            o = (this._podcasts.episodes[i] || {}).fave_hash;
        o && stManager.add([jsc("web/podcast.js")], function() {
            Podcast.toggleFave(t, i, o)
        })
    }, AudioPlayer.prototype._updatePlaybackRate = function() {
        var t = this;
        this._implNewTask("playback_rate", function(e) {
            var i = !t._adsIsAdPlaying() && AudioUtils.isPodcast(t._currentAudio) ? t.podcastGetPlaybackRate() : 1;
        ...
        var t = this._lsGet(AudioPlayer.LS_PODCASTS) || {},
            e = t.rate || 1;
        (e += AudioPlayer.PLAYBACK_RATE_STEP) > AudioPlayer.PLAYBACK_RATE_MAX && (e = 1), t.rate = e, this._lsSet(AudioPlayer.LS_PODCASTS, t), this._updatePlaybackRate()
        ...
        if (window.Hls) {
            ...
            o.attachMedia(t), o.loadSource(e), this._currentHls = o, this._hlsError = null, o.on(Hls.Events.ERROR, function(t, e) {
            ...
            a.isPlaying() && !a.isAdPlaying() && this.play(e)
