! function(e) {
    ...
    var s = function() {
        ...
        return e.prototype._initEvents = function(e) {
            ...
            var _ = Object(n.gpeByClass)("audio_layer_container", this._ttel),
                l = _ || Object(n.domClosestOverflowHidden)(this._ttel),
                u = l !== bodyNode ? Object(n.getXY)(l) : [Object(a.scrollGetX)(), Object(a.scrollGetY)() + getPageHeaderHeight()],
                d = l !== bodyNode ? Object(n.getSize)(l) : [window.innerWidth, window.innerHeight],
            ...
            if (this._opts.setPos) b = this._opts.setPos(this) || {}, e.getType(o) === e.TYPE_VERTICAL ? void 0 !== b.arrowPosition ? Object(n.setStyle)(this._ttArrowEl, {
                marginLeft: b.arrowPosition
            }) : vk.rtl ? v("marginRight") : v("marginLeft") : void 0 !== b.arrowPosition ? Object(n.setStyle)(this._ttArrowEl, {
                marginTop: b.arrowPosition
            }) : v("marginTop");
            else {
                if (!o && this._prevSide && this._opts.preventSideChange) o = this._prevSide;
                    ...
                    if (this._opts.type === e.TYPE_VERTICAL) {
                        var g = hasClass(bodyNode, "body_im") ? 60 : this._opts.bottomGap || 0,
                            m = r.top - u[1] > p[1] + f - w[1],
                            O = Object(a.scrollGetY)() + d[1] - (r.top + r.height + f) - g > p[1];
                        o = "top" === this._opts.defaultSide ? m ? "top" : "bottom" : O ? "bottom" : "top"
                    } else o = r.left - u[0] < p[0] ? "right" : "left";
                var y = Object(n.getXY)(this._appendToEl),
                    E = [r.left - y[0], r.top - y[1]],
                    k = void 0,
                    C = w[0] + E[0];
                this._opts.centerShift ? (C += this._opts.centerShift || 0, k = this._opts.centerShift) : this._opts.rightShift && (C += k = -(p[0] / 2 - this._opts.rightShift)), this._prevSide = o;
                var j = void 0,
                    x = void 0,
                    P = void 0,
                    T = void 0,
                    M = void 0;
                switch (this._opts.align === (vk.rtl ? e.ALIGN_LEFT : e.ALIGN_RIGHT) ? (j = r.width - p[0], x = r.height - p[1]) : this._opts.align === (vk.rtl ? e.ALIGN_RIGHT : e.ALIGN_LEFT) ? (j = 0, x = 0) : (j = -p[0] / 2 + r.width / 2, x = r.height / 2 - p[1] / 2), o) {
                    case "bottom":
                        T = j + C, M = r.height + f - w[1] + E[1], k || ((P = j + r.left + w[0] + p[0] + 20 - (u[0] + d[0])) < 0 && (P = 0), T -= P, k = -P), b = {
                            left: T,
                            top: M
                        };
                        break;
                    case "top":
                        T = j + C, M = -p[1] - f + w[1] + E[1], k || ((P = j + r.left + w[0] + p[0] + 20 - (u[0] + d[0])) < 0 && (P = 0), T -= P, k = -P), b = {
                            left: T,
                            top: M
                        };
                        break;
                    case "right":
                        T = r.width + f + C, M = x + w[1] + E[1], k || ((P = x + r.top + w[1] - (u[1] + 20)) > 0 && (P = 0), M -= P, k = -P), b = {
                            left: T,
                            top: M
                        };
                        break;
                    case "left":
                        T = -p[0] - f + C, M = x + w[1] + E[1], k || ((P = x + r.top + w[1] - (u[1] + 20)) > 0 && (P = 0), M -= P, k = -P), b = {
                            left: T,
                            top: M
                        }
                }
                this._opts.type === e.TYPE_VERTICAL ? vk.rtl ? v("marginRight", k) : v("marginLeft", k) : v("marginTop", k)
            }
            Object(i.each)(["top", "bottom", "left", "right"], function(e, t) {
                o !== t && removeClass(this._ttel, "eltt_" + t)
            }.bind(this)), addClass(this._ttel, "eltt_" + o), Object(n.setStyle)(this._ttel, b)
    ...
    t.f = o(399) ? Object.defineProperty : function(e, t, o) {
    ...
    var n = o(494)("unscopables"),
        i = Array.prototype;
    void 0 == i[n] && o(142)(i, n, {}), e.exports = function(e) {
        i[n][e] = !0
    }
}, , , , , function(e, t, o) {
    'eat script';
    ...
    var n = o(40),
        ...
        r = o(217),
        a = o(350);
    e.exports = o(426)(Array, "Array", function(e, t) {
    ...
    'eat script';
    var n = o(334);
    e.exports = o(130)("Set", function(e) {
        return function() {
    ...
    window.layers = _, window.layerQueue = l
}, , , function(e, t, o) {
    var n = o(194),
        i = o(533).set;
    ...
    o(390), o(190), o(424), o(90), e.exports = o(532).Set
}, , function(e, t, o) {
    'eat script';
    ...
    'eat script';
    o.r(t), o.d(t, "updateOnlineText", function() {
        return a
    ...
    e.exports = function(e, t, o, h, w, b) {
        ...
        if ("function" == typeof g && (b || O.forEach && !u(function() {
            ...
            })).prototype = O, O.constructor = g), (j || P) && (E("delete"), E("has"), w && E("get")), (P || C) && E(m), b && O.clear && delete O.clear
    ...
    var n = o(8),
        i = o(374);
    e.exports = o(399) ? function(e, t, o) {
    ...
    function b(e, t, o, n, r, a) {
        ...
        return a.queue && (u.queue = 1), a.urlHash && (c.url_hash = a.urlHash), w(c, !1, e, u)
    }
    ...
    function O(e, t, o, n, i) {
        ...
        e.innerHTML = r ? Object(a.domData)(e, "add") : Object(a.domData)(e, "remove"), Object(a.domData)(e, "state", r ? 0 : 1), m(t, o, n, i, r)
    }

    function y(e, t, o, i, r, s) {
        var c = parseInt(Object(a.domData)(t, "state"));
        return Object(a.domData)(t, "state", c ? 0 : 1), m(o, i, r, s, c), Object(n.cancelEvent)(e)
    }
    ...
    'eat script';
    var n = o(56)(!0);
    o(426)(String, "String", function(e) {
    ...
    (function(n, i) {
        ...
        (function() {
            ...
            function B(e, t, o) {
                t.constructor === e.constructor && o === C && constructor.resolve === j ? function(e, t) {
            ...
            function I(e, t) {
                e._state === P && (e._result = t, e._state = T, 0 !== e._subscribers.length && u(N, e))
            }

            function R(e, t) {
                e._state === P && (e._state = M, e._result = t, u(S, e))
            }
            ...
            function F(e, t, o, n) {
                ...
                t._state !== P || (_ && s ? A(t, i) : c ? R(t, r) : e === T ? I(t, i) : e === M && R(t, i))
            }
            var H = function(e) {
            ...
            var q = function(e) {
                ...
                for (var r = 0; t._state === P && r < o; r++) W(this.resolve(e[r]), void 0, n, i);
                return t
            };
            var V = function(e) {
                    var t = new this(x);
            ...
            function Y(e) {
                this._id = z++, this._state = void 0, this._result = void 0, this._subscribers = [], x !== e && ("function" != typeof e && function() {
            ...
            Y.all = H, Y.race = q, Y.resolve = j, Y.reject = V, Y._setScheduler = function(e) {
                c = e
            ...
            function $(e, t) {
                this._instanceConstructor = e, this.promise = new e(x), Array.isArray(t) ? (this._input = t, this.length = t.length, this._remaining = t.length, this._result = new Array(this.length), 0 === this.length ? I(this.promise, this._result) : (this.length = this.length || 0, this._enumerate(), 0 === this._remaining && I(this.promise, this._result))) : R(this.promise, this._validationError())
            }
            $.prototype._validationError = function() {
                return new Error("Array Methods must be provided an Array")
            }, $.prototype._enumerate = function() {
                for (var e = this.length, t = this._input, o = 0; this._state === P && o < e; o++) this._eachEntry(t[o], o)
            }, $.prototype._eachEntry = function(e, t) {
                var o = this._instanceConstructor,
                    n = o.resolve;
                if (n === j) {
                    var i = D(e);
                    if (i === C && e._state !== P) this._settledAt(e._state, t, e._result);
                ...
                var n = this.promise;
                n._state === P && (this._remaining--, e === M ? R(n, o) : this._result[t] = o), 0 === this._remaining && I(n, this._result)
    ...
    var _top_search__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(186),
        _utils_common__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(312),
        _ads__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(402),
        _debug_tools__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(93),
        _dom__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(363),
        _dom_events__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(448),
        _scroll__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(435),
        _ui_util__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(450),
        _ajax__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(335),
        _nav_utils__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(526),
        _layout_utils__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(472),
        _video__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(357),
        _legacy_performance_stats__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(253),
    ...
    var n = o(84),
        i = o(494)("iterator"),
        r = o(217);
    e.exports = o(532).getIteratorMethod = function(e) {
    ...
    var _ui__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(443),
        _debug_tools__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(93),
        _dom_events__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(448),
        _ui_util__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(450),
        _dom__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(363),
        _fx__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(393),
        _utils_common__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(312);
    ...
    var l = {
        ...
        showFriends: function() {
            curFastChat.clistBox.visible ? curFastChat.clistBox.options.fixed ? FastChat.clistHide() : curFastChat.clistBox.show() : (FastChat.clistShow(), l.cont.tt && l.cont.tt.destroy && l.cont.tt.destroy())
        },
        showTT: function() {
            if (!Object(r.hasClass)(l.wrap, "chat_active") && !Object(r.hasClass)(l.wrap, "chat_expand")) {
                var e = browser.mac ? "Cmd" : "Ctrl";
                Object(n.showTooltip)(l.cont, {
        ...
        init: function() {
            ...
            }), utilsNode.appendChild(l.wrap), l.scrollNode = geByClass1("chat_cont_scrolling", l.wrap), l.ttNode = geByClass1("chat_tt_wrap", l.wrap), l.itemsCont = l.scrollNode.firstChild, l.onl = ge("chat_onl"), l.cont = l.onl.parentNode.parentNode, hide(l.wrap), l.inited = !0, stManager._addCss(".layers_shown .chat_onl_wrap {margin-right: " + Object(i.sbWidth)() + "px;}")
        }
    };
    ...
    function u(e, t, o, n) {
        ...
        if (e && (browser.chrome && i > 14 || browser.mozilla && i > 13 || browser.opera && i > 2)) {
            ...
            n && (browser.opera && Object(c.intval)(browser.version) <= 12 ? e.addEventListener("oTransitionEnd", _) : addEvent(e, "webkitTransitionEnd transitionend msTransitionEnd oTransitionEnd", _)), setTimeout(setStyle.pbind(e, t), 0)
        ...
        return s.processLoad = function() {
            if (Object(c.each)(o, function(e, t) {
                    var n = _(t, 2),
                        i = n[0],
                        r = n[1];
                    (r.width || r.height || Object(c.vkNow)() - i > 2e4) && o[e] && l.call(r, e, !0)
                ...
                Object(c.each)(d, function(e, t) {
                    var i = _(t, 2),
                        r = i[0],
                        u = i[1];
                    s.iloader && s.iloader.add(u, l, r), r.src = u, r.removeAttribute("data-src"), removeClass(r, a.need_load_class), o[u] || (n++, o[u] = [Object(c.vkNow)(), r])
    ...
    function F(e) {
        var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
            o = t.kLimit || 1e3;
        return e >= (t.mLimit || 1e6) && !t.noCheck ? F(e = (e = y(e / 1e5)) > 1e3 ? y(e / 10) : e / 10, S(t, {
            noCheck: !0
        }), !0) + "M" : e >= o && !t.noCheck ? F(e = (e = y(e / 100)) > 100 ? y(e / 10) : e / 10, S(t, {
            noCheck: !0
    ...
    o(390), o(190), o(424), o(491), e.exports = o(532).Map
}, , , , , , , , , , , , function(e, t, o) {
    'eat script';
    var n = o(8).f,
        i = o(512),
    ...
    var _utils_common__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(312),
        _debug_tools__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(93),
    ...
    var _videoplayer_lib_player_states__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(278);
    ...
    function K(e, t, o) {
        for (var n = null; null === n && e;)(e = -1 === o ? M(e) : T(e)) && F(e, t) && (n = e);
        return n
    }
    ...
    window.ge = r, window.geByTag = a, window.geByTag1 = s, window.geByClass = c, window.geByClass1 = _, window.gpeByClass = l, window.domQuery = u, window.domQuery1 = d, window.domClosest = p, window.ce = w, window.cf = O, window.re = y, window.se = E, window.sech = k, window.rs = C, window.psr = j, window.domReplaceEl = x, window.domEL = P, window.domNS = T, window.domPS = M, window.domFC = L, window.domLC = D, window.domPN = B, window.domChildren = A, window.domInsertBefore = S, window.domInsertAfter = I, window.domByClass = R, window.domData = W, window.domChildIndex = N, window.domCA = U, window.domClosestSibling = K, window.matchesSelector = F, window.isHover = H, window.isAncestor = q, window.getScroll = V, window.domClosestPositioned = z, window.domClosestOverflowHidden = G, window.show = Y, window.hide = X, window.isVisible = $, window.clientHeight = Z, window.getClientRectOffsetY = Q, window.toggle = J, window.boundingRectEnabled = ee, window.getXYRect = te, window.getXY = oe, window.isWindow = ne, window.getSize = ie, window.hasClass = se, window.addClass = ce, window.addClassDelayed = _e, window.removeClass = le, window.removeClassDelayed = ue, window.toggleClass = de, window.toggleClassDelayed = pe, window.replaceClass = fe, window.getStyle = he, window.setStyle = we, window.setStyleDelayed = be, window.setPseudoStyle = ve, window.data = ge, window.attr = me, window.removeAttr = Oe, window.removeData = ye, window.cleanElems = Ee, window.setTitle = ke, window.getZoom = Ce, window.val = je, window.elfocus = xe, window.traverseParent = Pe, window.getH = ae, window.getW = re, window.domClosestByTag = f, window.setDocumentTitle = Me, window.lockDocumentTitle = Le
}, , , , , , , , function(e, t, o) {
    var n = o(171),
        i = o(142),
        r = o(421),
        ...
        s = Function.toString,
        c = ("" + s).split("toString");
    o(532).inspectSource = function(e) {
        return s.call(e)
    ...
    var n = o(84),
        i = {};
    i[o(494)("toStringTag")] = "z", i + "" != "[object z]" && o(371)(Object.prototype, "toString", function() {
    ...
    var n = o(8),
        i = o(444),
        r = o(496);
    e.exports = o(399) ? Object.defineProperties : function(e, t) {
        i(e);
            ...
            if (!browser.mobile || browser.safari_mobile || browser.android) {
                ...
                if ("number" == typeof s || o.str && "string" == typeof s) t != s && Object(i.data)(e, "nextCount", t);
                    ...
                    f.length && E.appendChild(k = Object(i.ce)("div", {
                        ...
                        innerHTML: f
                    })), f.length || (v = v.replace(/^0+/, "")), v && ("0" !== v || f.length) || (v = o.noSpaceIfEmpty ? "" : "&nbsp;", x = !!f.length), E.appendChild(j = Object(i.ce)("div", {
                        className: "counter_anim_wrap inl_bl"
                    })), j.appendChild(y = Object(i.ce)("div", {
                    ...
                    var P = Object(i.getSize)(geByClass1("counter_anim_big_c", y, "span"))[0],
                        T = x ? "&nbsp;" === v ? P : Object(i.getSize)(geByClass1("counter_anim_small_c", y, "span"))[0] : 0;
                    !v && o.noSpaceIfEmpty && (T = 0), h.length && E.appendChild(C = Object(i.ce)("div", {
                        className: "counter_const inl_bl",
                        innerHTML: h
                    })), o.noWrapWidth || Object(i.setStyle)(E, {
                        width: (k && Object(i.getSize)(k)[0] || 0) + (C && Object(i.getSize)(C)[0] || 0) + P + 0
                    ...
                    M ? (Object(i.getStyle)(j, "width"), addClass(j, "counter_css_anim_wrap"), P !== T && Object(i.setStyle)(j, {
                        width: _ ? P : T
                    }), x && Object(i.setStyle)(y, D), setTimeout(L, 300), o.fadeMode && (Object(i.setStyle)(geByClass1("counter_anim_big", e), "opacity", 1), Object(i.setStyle)(geByClass1("counter_anim_small", e), "opacity", 0))) : (P !== T && a(j, {
                        width: _ ? P : T
                    }, {
                        duration: 100
                    }), x ? a(y, D, {
    ...
    function U() {
        x ? (addEvent(window, "blur", z), addEvent(window, "focus", G), onDomReady(function() {
    ...
    function se() {
        ...
        }), Object.keys(t).forEach(e.iterator(t)), Object.keys(o).forEach(e.iterator(o)), ls.set(C, t), ls.set(j, o)
    }
    ...
    function de(e) {
        return "page_view" === x && e[v] || !document.body.contains(e)
    }
    ...
    for (var n = o(66), i = o(371), r = o(171), a = o(142), s = o(217), c = o(494), _ = c("iterator"), l = c("toStringTag"), u = s.Array, d = ["NodeList", "DOMTokenList", "MediaList", "StyleSheetList", "CSSRuleList"], p = 0; p < 5; p++) {
        var f, h = d[p],
            w = r[h],
            b = w && w.prototype;
        if (b)
    ...
    e.exports = function(e, t, o, h, w, b, v) {
        ...
        var g, m, O, y = function(e) {
            ...
            C = !1,
            j = e.prototype,
            x = j[d] || j["@@iterator"] || w && j[w],
            P = x || y(w),
            T = w ? k ? y("entries") : P : void 0,
            M = "Array" == t && j.entries || x;
        if (M && (O = u(M.call(new e))) !== Object.prototype && (l(O, E, !0), n || s(O, d) || a(O, d, f)), k && x && "values" !== x.name && (C = !0, P = function() {
                return x.call(this)
            }), n && !v || !p && !C && j[d] || a(j, d, P), c[t] = P, c[E] = f, w)
            if (g = {
                    values: k ? P : y("values"),
                    keys: b ? P : y("keys"),
                    entries: T
                }, v)
                for (m in g) m in j || r(j, m, g[m]);
            else i(i.P + i.F * (p || C), t, g);
        return g
    }
}, , , , , function(e, t, o) {
    var n = o(194);
    ...
    function d(e) {
        if ((e = Object(n.ge)(e)) && Object(n.hasClass)(e, "ui_actions_menu_item") && !Object(n.hasClass)(e, "ui_actions_menu_item_lock")) {
            ...
            Object(n.val)(t, e.innerHTML), e.appendChild(t), P(e)
        }
    }
    ...
    'eat script';
    __webpack_require__.r(__webpack_exports__);
    var core_js_es6_map__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(322),
        core_js_es6_set__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(113),
        _polyfill_from_code_point__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(224),
        _polyfill_array_find_polyfill__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(128),
        _polyfill_array_from_polyfill__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(508),
        _polyfill_object_assign_polyfill__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(525),
        _polyfill_number_isinteger_polyfill__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(154),
        _polyfill_canvas_to_blob__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(207),
        es6_promise__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(233),
        _lib_ee__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(409),
        _lib_polyfills__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(287),
        _lib_ui_util__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(450),
        _lib_cookies__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(115),
        _lib_utils_common__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(312),
        _lib_ajax__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(335),
        _lib_browser__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(398),
        _lib_element_tooltip__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(2),
        _lib_favicon__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(534),
        _lib_flash__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(504),
        _lib_fx__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(393),
        _lib_history_and_bookmarks__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(309),
        _lib_lang__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(55),
        _lib_layers__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(96),
        _lib_ls__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(439),
        _lib_market__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(163),
        _lib_scroll__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(435),
        _lib_static_manager__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(299),
        _lib_stats__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(193),
        _lib_ui__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(443),
        _lib_video__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(357),
        _lib_scripts__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(419),
        _lib_global_search__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(408),
        _lib_top_search__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(186),
        _lib_nav__WEBPACK_IMPORTED_MODULE_33__ = __webpack_require__(245),
        _lib_nav_utils__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(526),
        _lib_perfomance_logger__WEBPACK_IMPORTED_MODULE_35__ = __webpack_require__(123),
        _shared_constants_groups__WEBPACK_IMPORTED_MODULE_36__ = __webpack_require__(155),
        _lib_date__WEBPACK_IMPORTED_MODULE_37__ = __webpack_require__(279),
        _lib_debug_tools__WEBPACK_IMPORTED_MODULE_38__ = __webpack_require__(93),
        _lib_layout_utils__WEBPACK_IMPORTED_MODULE_39__ = __webpack_require__(472),
        _lib_message_box__WEBPACK_IMPORTED_MODULE_40__ = __webpack_require__(290),
        _lib_box_utils__WEBPACK_IMPORTED_MODULE_41__ = __webpack_require__(104),
        _lib_feature_tooltips__WEBPACK_IMPORTED_MODULE_42__ = __webpack_require__(285),
        _lib_feature_boxes__WEBPACK_IMPORTED_MODULE_43__ = __webpack_require__(24),
        _lib_feature_entries__WEBPACK_IMPORTED_MODULE_44__ = __webpack_require__(177),
        _lib_tooltip_utils__WEBPACK_IMPORTED_MODULE_45__ = __webpack_require__(45),
        _lib_legacy__WEBPACK_IMPORTED_MODULE_46__ = __webpack_require__(307),
        _lib_long_view__WEBPACK_IMPORTED_MODULE_47__ = __webpack_require__(417),
        _lib_accessibility__WEBPACK_IMPORTED_MODULE_48__ = __webpack_require__(124),
        _lib_legacy_performance_stats__WEBPACK_IMPORTED_MODULE_49__ = __webpack_require__(253),
        _lib_input_utils__WEBPACK_IMPORTED_MODULE_50__ = __webpack_require__(68);
    ...
    function nodeUpdated(e, t) {
        ...
        }), Object(_lib_fx__WEBPACK_IMPORTED_MODULE_19__.animate)(e, {
            backgroundColor: "#FFF"
        }, t || 6e3, function(e) {
            setStyle(e, {
    ...
    1 === vk.al ? (location.search || "/" !== location.pathname) && location.replace("/") : (3 !== vk.al || history.pushState || (vk.al = 2), location.search || "/index.php" !== location.pathname || location.replace("/"), vk.version = !1), window.stVersions || (window.navMap = window.stVersions = window.stTypes = {}, window._rnd = 1), window.jsc = function(e) {
        ...
        try {
            ...
            try {
                ...
                Object(_lib_debug_tools__WEBPACK_IMPORTED_MODULE_38__.logEvalError)(e, evalString)
            }
        }
    } : function(obj) {
        var evalString = "(" + obj + ")";
    ...
    }), window.locHost = location.host, window.locProtocol = location.protocol, window.__dev = /[a-z0-9_\-]+\.[a-z0-9_\-]+\.[a-z0-9_\-]+\.[a-z0-9_\-]+/i.test(locHost), window.__dev || (window.__debugMode = !1), window.locHash = location.hash.replace("#/", "").replace("#!", ""), window.nodeUpdated = nodeUpdated, Object(_lib_debug_tools__WEBPACK_IMPORTED_MODULE_38__.initDebugTools)(), window.debugLog = _lib_debug_tools__WEBPACK_IMPORTED_MODULE_38__.debugLog, window.debugEl = _lib_debug_tools__WEBPACK_IMPORTED_MODULE_38__.debugEl;
    var reopen = function() {
    ...
    function _stlMousedown(e) {
        if (e = e || window.event, !checkEvent(e) && !__afterFocus)
            if (_stlWasSet && _stlWas) {
                var t = _stlWas;
                _stlWas = 0, scrollToY(t, 0, !0, !0), Object(_lib_nav_utils__WEBPACK_IMPORTED_MODULE_34__.updateLeftMenu)(!0)
            } else 1 === _stlBack ? _tbLink.onclick() : (_stlWas = scrollGetY(), scrollToY(0, 0, !0, !0), Object(_lib_nav_utils__WEBPACK_IMPORTED_MODULE_34__.updateLeftMenu)())
    }
    ...
    addEvent(window, "unload", function() {
        ...
        vk.loaded || (vk.loaded = !0, Object(_lib_ui__WEBPACK_IMPORTED_MODULE_28__.updSideTopLink)()), Object(_lib_layout_utils__WEBPACK_IMPORTED_MODULE_39__.checkPageBlocks)()
    ...
    }), window.updateHeaderStyles = _lib_nav_utils__WEBPACK_IMPORTED_MODULE_34__.updateHeaderStyles, window.updateNarrow = _lib_layout_utils__WEBPACK_IMPORTED_MODULE_39__.updateNarrow, window.checkPageBlocks = _lib_layout_utils__WEBPACK_IMPORTED_MODULE_39__.checkPageBlocks, window.redraw = _lib_layout_utils__WEBPACK_IMPORTED_MODULE_39__.redraw, window.onBodyResize = _lib_layout_utils__WEBPACK_IMPORTED_MODULE_39__.onBodyResize, window.onBodyScroll = _lib_layout_utils__WEBPACK_IMPORTED_MODULE_39__.onBodyScroll, window.onDocumentClick = function(e) {
        ...
        if (ls.set("last_reloaded", []), !cur.onMouseClick || !cur.onMouseClick(e)) {
            ...
            var _ = domData(o, "post-id");
            _ && (s.postId = _);
            var l = void 0,
                u = a;
            if (n = a.match(/^\/(.*?)(\?|#|$)/)) n = n[1];
            else {
                if (o.hostname) l = o.hostname, n = o.pathname + o.search;
                else {
                    var d = /^([^:\/]+)?(?::(\d+))?(\/?[^#]*)(#?.*)$/i.exec(a);
                    if (!d) return !0;
                    l = d[1], n = d[3] || "/"
    ...
    window.domStarted = function() {
        if (window.headNode = geByTag1("head"), extend(window, {
                ...
                _fixedNav: !1,
                _tbLink: {}
            }), addEvent(bodyNode, "resize", _lib_layout_utils__WEBPACK_IMPORTED_MODULE_39__.onBodyResize.pbind(!1)), utilsNode) {
            ...
            if (extend(window, {
                ...
                addEvent(window, "focus", function() {
                    ...
                    }, 10), a && (Object(_lib_ui__WEBPACK_IMPORTED_MODULE_28__.sbWidth)(!0), Object(_lib_layout_utils__WEBPACK_IMPORTED_MODULE_39__.onBodyResize)(!0), a = !1))
                })
            }
        ...
        if (utilsNode) {
            Object(_lib_nav_utils__WEBPACK_IMPORTED_MODULE_34__.updateSTL)();
            var e = ge("side_bar");
            extend(window, {
            ...
            if (browser.mozilla && browser.version >= 4 ? o /= 2.5 : browser.mozilla ? o *= 1.5 : browser.msie && browser.version >= 7 ? o /= 1.5 : browser.msie && (o *= 2.5), stManager.lowlimit = intval(150 * Math.max(2e6 / o, 1)), stManager.highlimit = 6 * stManager.lowlimit, stManager.lowlimit = Math.min(stManager.lowlimit, 600), Object(_lib_layout_utils__WEBPACK_IMPORTED_MODULE_39__.onBodyResize)(), setTimeout(_lib_layout_utils__WEBPACK_IMPORTED_MODULE_39__.onBodyResize.pbind(!1), 0), Object(_lib_accessibility__WEBPACK_IMPORTED_MODULE_48__.updateAriaElements)(), window.addEventListener("scroll", _lib_layout_utils__WEBPACK_IMPORTED_MODULE_39__.onBodyScroll, {
                    passive: !0
    ...
    }, Object(_lib_perfomance_logger__WEBPACK_IMPORTED_MODULE_35__.subscribePerformanceLoggerCollectors)(), window.onDomReady = onDomReady;
    ...
    function leftBlockFriendTooltip() {
        return Object(_lib_tooltip_utils__WEBPACK_IMPORTED_MODULE_45__.showTooltip)(ge("left_friend_subscribed"), {
            url: "al_friends.php",
            params: {
                act: "friend_tt",
                mid: cur.mfid,
    ...
    window.hab = hab, window.leftBlockOver = _lib_layout_utils__WEBPACK_IMPORTED_MODULE_39__.leftBlockOver, window.leftBlockOut = _lib_layout_utils__WEBPACK_IMPORTED_MODULE_39__.leftBlockOut, window.leftBlockHide = _lib_layout_utils__WEBPACK_IMPORTED_MODULE_39__.leftBlockHide, window.hideNewsAnnounce = function(e, t) {
        var o = {
            act: "hide_block",
            block: e,
            hash: t
        ...
        function o() {
            Object(_lib_fx__WEBPACK_IMPORTED_MODULE_19__.animate)("ads_ad_close_info_" + e, {
                opacity: 1
            }, 200, n)
        }
        ...
        setStyle("left_hide" + e, {
            ...
            onDone: function(t) {
                if (!t.done) return;
                if ("ya_direct" === e) return Object(_lib_fx__WEBPACK_IMPORTED_MODULE_19__.animate)(e, {
                    opacity: 0
                }, 200, function() {
        ...
        n && stManager.add(["tooltips.css", "tooltips.js"]), cur.mfid = e, ajax.post("al_friends.php", {
            ...
            onFail: function(e) {
                if (e) return Object(_lib_message_box__WEBPACK_IMPORTED_MODULE_40__.showFastBox)({
                    title: getLang("global_error")
                }, e), !0
            }
        }), cancelEvent(i)
    }, window.leftBlockFriendTooltip = leftBlockFriendTooltip, vk.counts = {}, window.handlePageView = _lib_nav_utils__WEBPACK_IMPORTED_MODULE_34__.handlePageView, window.handlePageParams = _lib_nav_utils__WEBPACK_IMPORTED_MODULE_34__.handlePageParams, window.handlePageCount = _lib_nav_utils__WEBPACK_IMPORTED_MODULE_34__.handlePageCount, window.comScoreUDM = _lib_nav_utils__WEBPACK_IMPORTED_MODULE_34__.comScoreUDM, window.updateOtherCounters = _lib_nav_utils__WEBPACK_IMPORTED_MODULE_34__.updateOtherCounters, window.processDestroy = _lib_nav_utils__WEBPACK_IMPORTED_MODULE_34__.processDestroy, window.globalHistoryDestroy = _lib_nav_utils__WEBPACK_IMPORTED_MODULE_34__.globalHistoryDestroy, window.showBackLink = _lib_nav_utils__WEBPACK_IMPORTED_MODULE_34__.showBackLink, window.nav = _lib_nav__WEBPACK_IMPORTED_MODULE_33__.default, nav.init(), vk.time && !window.browser.opera_mobile && setTimeout(function() {
        var e = new Date,
    ...
    }, 0), window.placeholderSetup = _lib_input_utils__WEBPACK_IMPORTED_MODULE_50__.placeholderSetup, window.placeholderInit = _lib_input_utils__WEBPACK_IMPORTED_MODULE_50__.placeholderInit, window.isInputActive = _lib_input_utils__WEBPACK_IMPORTED_MODULE_50__.isInputActive, window.__bq = _lib_box_utils__WEBPACK_IMPORTED_MODULE_41__.boxQueue, window.boxQueue = _lib_box_utils__WEBPACK_IMPORTED_MODULE_41__.boxQueue, window.curBox = _lib_box_utils__WEBPACK_IMPORTED_MODULE_41__.curBox, Object(_lib_box_utils__WEBPACK_IMPORTED_MODULE_41__.initBoxQueue)(), window.browser.mobile || addEvent(document, "keydown", function(e) {
        ...
        }), o && Object(_lib_feature_entries__WEBPACK_IMPORTED_MODULE_44__.getAudioPlayer)().onMediaKeyPressedEvent(e), _lib_legacy__WEBPACK_IMPORTED_MODULE_46__.Chat.inited && 191 === e.keyCode && (e.ctrlKey || e.metaKey && browser.mac) && _lib_legacy__WEBPACK_IMPORTED_MODULE_46__.Chat.showFriends()
    }), window.boxRefreshCoords = _lib_box_utils__WEBPACK_IMPORTED_MODULE_41__.boxRefreshCoords, window.MessageBox = _lib_message_box__WEBPACK_IMPORTED_MODULE_40__.MessageBox, window.showBox = _lib_message_box__WEBPACK_IMPORTED_MODULE_40__.showBox, window.showTabbedBox = _lib_message_box__WEBPACK_IMPORTED_MODULE_40__.showTabbedBox, window.showFastBox = _lib_message_box__WEBPACK_IMPORTED_MODULE_40__.showFastBox, window.showCaptchaBox = _lib_message_box__WEBPACK_IMPORTED_MODULE_40__.showCaptchaBox, window.showReCaptchaBox = _lib_message_box__WEBPACK_IMPORTED_MODULE_40__.showReCaptchaBox, window.checkTextLength = function(e, t, o, n, i, r, a) {
        ...
        if (t.lastLen !== s.length || r) {
            ...
            var d = function(e, t) {
                for (var o = 0, n = 0, i = e.length; n < i; n++) {
                    var r = _[e.charAt(n)],
                        s = e.charCodeAt(n);
                    o += void 0 !== r ? r : !a && s >= 128 && (s < 1025 || u[s] || s > 1119) && !l[s] && (s < 8220 || s > 8222) && (s < 8224 || s > 8226) ? ("&#" + s + ";").length : 1
                }
                return o
            }(s);
    ...
    }, window.autosizeSetup = _lib_layout_utils__WEBPACK_IMPORTED_MODULE_39__.autosizeSetup, window.goAway = function(e, t, o) {
        ...
        return !Object(_lib_message_box__WEBPACK_IMPORTED_MODULE_40__.showBox)("away.php", r, {}, o)
    }, window.showAudioClaimWarning = _lib_feature_boxes__WEBPACK_IMPORTED_MODULE_43__.showAudioClaimWarning, window.sureDeleteAll = function(title, text, where, objectId, toId, fromId, hash, event) {
        if (!checkEvent(event)) {
            var box = Object(_lib_message_box__WEBPACK_IMPORTED_MODULE_40__.showFastBox)({
                title: title
                ...
                ajax.post("/delete_all.php", {
                    ...
                    onDone: function onDone(res) {
                        if (__debugMode) eval(res);
                            ...
                            Object(_lib_debug_tools__WEBPACK_IMPORTED_MODULE_38__.logEvalError)(e, res)
                        }
                        box.hide()
                    },
                    showProgress: _lib_ui__WEBPACK_IMPORTED_MODULE_28__.lockButton.pbind(btn),
                    hideProgress: _lib_ui__WEBPACK_IMPORTED_MODULE_28__.unlockButton.pbind(btn)
                })
            }, getLang("global_cancel"));
            return !1
        }
        ...
        __qlClear(), Object(_lib_ui__WEBPACK_IMPORTED_MODULE_28__.unlockButton)(window.__qfBtn), window.qloginBox = Object(_lib_message_box__WEBPACK_IMPORTED_MODULE_40__.showCaptchaBox)(e, t, window.qloginBox, {
        ...
        __qlClear(), Object(_lib_ui__WEBPACK_IMPORTED_MODULE_28__.unlockButton)(window.__qfBtn), window.qloginBox = Object(_lib_message_box__WEBPACK_IMPORTED_MODULE_40__.showReCaptchaBox)(e, t, window.qloginBox, {
            onSubmit: function(e) {
    ...
    function cancelStackPop() {
        ...
        Object(_lib_top_search__WEBPACK_IMPORTED_MODULE_32__.topHeaderClearClose)(), e.length > 0 && e.pop().func();
        var t = e[e.length - 1];
        return t && t.dclick && Object(_lib_top_search__WEBPACK_IMPORTED_MODULE_32__.topHeaderClose)(function() {
            t.func(), cancelStackFilter(t.name)
        }), window.cancelStack = e, window.cancelStack
    }
    window.callHub = CallHub, window.CallHub = CallHub, window.showWriteMessageBox = _lib_feature_boxes__WEBPACK_IMPORTED_MODULE_43__.showWriteMessageBox, window.giftsBox = _lib_feature_boxes__WEBPACK_IMPORTED_MODULE_43__.giftsBox, window.moneyTransferBox = _lib_feature_boxes__WEBPACK_IMPORTED_MODULE_43__.moneyTransferBox, window.reportAd = _lib_feature_boxes__WEBPACK_IMPORTED_MODULE_43__.reportAd, window.gSearch = new _lib_global_search__WEBPACK_IMPORTED_MODULE_31__.default, window.showTooltip = _lib_tooltip_utils__WEBPACK_IMPORTED_MODULE_45__.showTooltip, window.showTitle = _lib_tooltip_utils__WEBPACK_IMPORTED_MODULE_45__.showTitle, window.showHint = _lib_tooltip_utils__WEBPACK_IMPORTED_MODULE_45__.showHint, window.updateMoney = function(e, t) {
        if (void 0 !== e && !1 !== e) {
            var o = "";
    ...
    }, window.zNav = _lib_nav_utils__WEBPACK_IMPORTED_MODULE_34__.zNav, window.handleScroll = handleScroll, window.topMsg = _lib_ui_util__WEBPACK_IMPORTED_MODULE_11__.topMsg, window.showMsg = _lib_ui_util__WEBPACK_IMPORTED_MODULE_11__.showMsg, window.topError = _lib_ui_util__WEBPACK_IMPORTED_MODULE_11__.topError, window.showGlobalPrg = _lib_ui_util__WEBPACK_IMPORTED_MODULE_11__.showGlobalPrg, window.showPhoto = _lib_feature_entries__WEBPACK_IMPORTED_MODULE_44__.showPhoto, window.showManyPhoto = _lib_feature_entries__WEBPACK_IMPORTED_MODULE_44__.showManyPhoto, window.showAlbums = _lib_feature_entries__WEBPACK_IMPORTED_MODULE_44__.showAlbums, window.showAlbum = _lib_feature_entries__WEBPACK_IMPORTED_MODULE_44__.showAlbum, window.showPhotoTags = _lib_feature_entries__WEBPACK_IMPORTED_MODULE_44__.showPhotoTags, window.showVideoTags = _lib_feature_entries__WEBPACK_IMPORTED_MODULE_44__.showVideoTags, window.videoCallback = _lib_feature_entries__WEBPACK_IMPORTED_MODULE_44__.videoCallback, window.showWiki = _lib_feature_entries__WEBPACK_IMPORTED_MODULE_44__.showWiki, window.showApp = _lib_feature_entries__WEBPACK_IMPORTED_MODULE_44__.showApp, window.articlePrepare = _lib_feature_entries__WEBPACK_IMPORTED_MODULE_44__.articlePrepare, window.showDoneBox = _lib_box_utils__WEBPACK_IMPORTED_MODULE_41__.showDoneBox, window.Fx = _lib_fx__WEBPACK_IMPORTED_MODULE_19__.Fx, window.fx = _lib_fx__WEBPACK_IMPORTED_MODULE_19__.Fx, window.animate = _lib_fx__WEBPACK_IMPORTED_MODULE_19__.animate, window.cubicBezier = _lib_fx__WEBPACK_IMPORTED_MODULE_19__.cubicBezier, window.fadeTo = _lib_fx__WEBPACK_IMPORTED_MODULE_19__.fadeTo, window.genFx = _lib_fx__WEBPACK_IMPORTED_MODULE_19__.genFx, window.getRGB = _lib_fx__WEBPACK_IMPORTED_MODULE_19__.getRGB, window.getColor = _lib_fx__WEBPACK_IMPORTED_MODULE_19__.getColor, window.slideDown = _lib_fx__WEBPACK_IMPORTED_MODULE_19__.slideDown, window.slideUp = _lib_fx__WEBPACK_IMPORTED_MODULE_19__.slideUp, window.slideToggle = _lib_fx__WEBPACK_IMPORTED_MODULE_19__.slideToggle, window.fadeIn = _lib_fx__WEBPACK_IMPORTED_MODULE_19__.fadeIn, window.fadeOut = _lib_fx__WEBPACK_IMPORTED_MODULE_19__.fadeOut, window.fadeToggle = _lib_fx__WEBPACK_IMPORTED_MODULE_19__.fadeToggle, window.animateCount = _lib_fx__WEBPACK_IMPORTED_MODULE_19__.animateCount, window.Chat = _lib_legacy__WEBPACK_IMPORTED_MODULE_46__.Chat, window.TopMenu = _lib_layout_utils__WEBPACK_IMPORTED_MODULE_39__.TopMenu, window.TopNotifier = _lib_feature_entries__WEBPACK_IMPORTED_MODULE_44__.TopNotifier, window.TopSearch = _lib_top_search__WEBPACK_IMPORTED_MODULE_32__.default, window.mentionOver = _lib_feature_tooltips__WEBPACK_IMPORTED_MODULE_42__.mentionOver, window.mentionClick = _lib_feature_entries__WEBPACK_IMPORTED_MODULE_44__.mentionClick, window.menuSettings = _lib_feature_boxes__WEBPACK_IMPORTED_MODULE_43__.menuSettings, window._postsSeen = {}, window._postsSaved = {}, window._postsSaveTimer = void 0, window._postsSendTimer = void 0, window._postsCleanTimer = void 0, window._postsSeenModules = {}, window._postsExtras = {}, window.mobilePromo = _lib_feature_boxes__WEBPACK_IMPORTED_MODULE_43__.mobilePromo, window.mobileOnlineTip = _lib_feature_tooltips__WEBPACK_IMPORTED_MODULE_42__.mobileOnlineTip, window.pageVerifiedTip = _lib_feature_tooltips__WEBPACK_IMPORTED_MODULE_42__.pageVerifiedTip, window.cssAnim = _lib_legacy__WEBPACK_IMPORTED_MODULE_46__.cssAnim, window.imagesLoader = _lib_legacy__WEBPACK_IMPORTED_MODULE_46__.imagesLoader, window.getCaretBoundingRect = function(e) {
    ...
    }, Object(_lib_ui__WEBPACK_IMPORTED_MODULE_28__.initUiHelpers)(), window.notaBene = _lib_ui__WEBPACK_IMPORTED_MODULE_28__.notaBene, window.updSideTopLink = _lib_ui__WEBPACK_IMPORTED_MODULE_28__.updSideTopLink, window.createButton = _lib_ui__WEBPACK_IMPORTED_MODULE_28__.createButton, window.actionsMenuItemLocked = _lib_ui__WEBPACK_IMPORTED_MODULE_28__.actionsMenuItemLocked, window.lockActionsMenuItem = _lib_ui__WEBPACK_IMPORTED_MODULE_28__.lockActionsMenuItem, window.unlockActionsMenuItem = _lib_ui__WEBPACK_IMPORTED_MODULE_28__.unlockActionsMenuItem, window.linkLocked = _lib_ui__WEBPACK_IMPORTED_MODULE_28__.linkLocked, window.lockLink = _lib_ui__WEBPACK_IMPORTED_MODULE_28__.lockLink, window.unlockLink = _lib_ui__WEBPACK_IMPORTED_MODULE_28__.unlockLink, window.lockButton = _lib_ui__WEBPACK_IMPORTED_MODULE_28__.lockButton, window.unlockButton = _lib_ui__WEBPACK_IMPORTED_MODULE_28__.unlockButton, window.buttonLocked = _lib_ui__WEBPACK_IMPORTED_MODULE_28__.buttonLocked, window.isButtonLocked = _lib_ui__WEBPACK_IMPORTED_MODULE_28__.isButtonLocked, window.disableButton = _lib_ui__WEBPACK_IMPORTED_MODULE_28__.disableButton, window.sbWidth = _lib_ui__WEBPACK_IMPORTED_MODULE_28__.sbWidth, window.isChecked = _lib_ui__WEBPACK_IMPORTED_MODULE_28__.isChecked, window.checkbox = _lib_ui__WEBPACK_IMPORTED_MODULE_28__.checkbox, window.disable = _lib_ui__WEBPACK_IMPORTED_MODULE_28__.disable, window.radioval = _lib_ui__WEBPACK_IMPORTED_MODULE_28__.radioval, window.radiobtn = _lib_ui__WEBPACK_IMPORTED_MODULE_28__.radiobtn, window.showProgress = _lib_ui__WEBPACK_IMPORTED_MODULE_28__.showProgress, window.hideProgress = _lib_ui__WEBPACK_IMPORTED_MODULE_28__.hideProgress, window.disableEl = _lib_ui__WEBPACK_IMPORTED_MODULE_28__.disableEl, window.enableEl = _lib_ui__WEBPACK_IMPORTED_MODULE_28__.enableEl, window.hashCode = function(e) {
        var t = 0;
        ...
        var t = " _online";
        return e && (t += " online"), mobPlatforms[e] && (t += " mobile"), Object(_lib_accessibility__WEBPACK_IMPORTED_MODULE_48__.updateOnlineText)(), t
    ...
    }, window.updateAriaElements = _lib_accessibility__WEBPACK_IMPORTED_MODULE_48__.updateAriaElements, window.updateAriaCheckboxes = _lib_accessibility__WEBPACK_IMPORTED_MODULE_48__.updateAriaCheckboxes, window.isFullScreen = function() {
    ...
    }, window.performance && window.performance.memory && rand(0, 100) < 5 && Object(_lib_legacy_performance_stats__WEBPACK_IMPORTED_MODULE_49__.collectMemoryStats)(), window.isPhotoeditor3Available = function() {
        return !browser.msie || parseInt(browser.version) > 10
    }, window.cancelStackFilter = function(e, t) {
        var o = window.cancelStack || [];
        return t && Object(_lib_top_search__WEBPACK_IMPORTED_MODULE_32__.topHeaderClearClose)(), window.cancelStack = o.filter(function(t) {
            return t.name !== e
        }), window.cancelStack
    }, window.cancelStackPush = function(e, t, o) {
        return o && Object(_lib_top_search__WEBPACK_IMPORTED_MODULE_32__.topHeaderClose)(function() {
    ...
    }), Object(_lib_long_view__WEBPACK_IMPORTED_MODULE_47__.initLongView)(), window.parallel = function() {
    ...
    }, window.audioShowActionTooltip = _lib_feature_tooltips__WEBPACK_IMPORTED_MODULE_42__.audioShowActionTooltip, window.shareAudioPlaylist = _lib_feature_entries__WEBPACK_IMPORTED_MODULE_44__.shareAudioPlaylist, window.getAudioPlayer = _lib_feature_entries__WEBPACK_IMPORTED_MODULE_44__.getAudioPlayer, window.deleteAudioOnClaim = _lib_feature_entries__WEBPACK_IMPORTED_MODULE_44__.deleteAudioOnClaim, window.initTopAudioPlayer = _lib_feature_entries__WEBPACK_IMPORTED_MODULE_44__.initTopAudioPlayer, window.openArticleEditor = _lib_feature_entries__WEBPACK_IMPORTED_MODULE_44__.openArticleEditor, window.toggleFastChats = function(e) {
        var t = this,
            o = !e;
    ...
    }, window.bookmark = _lib_feature_entries__WEBPACK_IMPORTED_MODULE_44__.bookmark, window.bookmarkPost = _lib_feature_entries__WEBPACK_IMPORTED_MODULE_44__.bookmarkPost, window.bookmarkArticle = _lib_feature_entries__WEBPACK_IMPORTED_MODULE_44__.bookmarkArticle, window.fifaReplaceText = _lib_legacy__WEBPACK_IMPORTED_MODULE_46__.fifaReplaceText;
    var initCommonWeb = function() {
        window.isToday = _lib_date__WEBPACK_IMPORTED_MODULE_37__.isToday, window.isYesterday = _lib_date__WEBPACK_IMPORTED_MODULE_37__.isYesterday, window.isTomorrow = _lib_date__WEBPACK_IMPORTED_MODULE_37__.isTomorrow, window.isSameDate = _lib_date__WEBPACK_IMPORTED_MODULE_37__.isSameDate, window.leadingZero = _lib_date__WEBPACK_IMPORTED_MODULE_37__.leadingZero, window.constants = {
            Groups: _shared_constants_groups__WEBPACK_IMPORTED_MODULE_36__.default
        }, Object(_lib_debug_tools__WEBPACK_IMPORTED_MODULE_38__.debugLog)("common module enabled")
    };
    ...
    var _dom__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(363),
        _ajax__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(335),
        _utils_common__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(312);
    ...
    function u() {
        ...
        if (!browser.mobile && e && t && o && !Object(i.isVisible)(boxLoader) && !Object(i.isVisible)(boxLayerBG) && !Object(i.isVisible)(layerBG)) {
            var s = window.lastWindowHeight || 0,
                ...
                l = vk.staticheader ? Math.max(0, getPageHeaderHeight() - c) : getPageHeaderHeight(),
                u = cur.__narrowBar.isBarFixed,
                d = Object(n.floatval)(Object(i.getStyle)(cur.__narrowBar.barBlock, "marginTop")),
                p = Object(i.getSize)(e)[1] - (u ? d : 0),
                ...
                g = Math.max(0, v),
                m = h - l,
                O = Object(i.getXY)(e)[1] + (u ? d : 0),
                y = cur.__narrowBar.lastSt || 0,
                E = cur.__narrowBar.lastStyles || {},
                k = l + b + p + d + g <= s && !cur.narrowHide,
                C = !1,
                j = void 0;
            c - 1 < m && !(k && browser.msie && O < l + d) || w ? j = {
                    marginTop: 0
                } : c - 1 < Math.min(y, O - l - d) || k ? (j = {
                    top: l,
                    marginLeft: Math.min(-bodyNode.scrollLeft, Math.max(-bodyNode.scrollLeft, bodyNode.clientWidth - Object(i.getSize)(_)[0]))
                }, C = !0) : c + 1 > Math.max(y, O + p + b - s) && v < 0 && !cur.narrowHide || cur.narrowHide && c + 1 > Math.max(y, O + p - l) ? (j = {
                    bottom: cur.narrowHide ? s - l : b,
                    marginLeft: Math.min(-bodyNode.scrollLeft, Math.max(-bodyNode.scrollLeft, bodyNode.clientWidth - Object(i.getSize)(_)[0]))
                }, C = !0) : j = {
                    marginTop: v >= 0 ? f - p : Math.min(O - h, f - p + m)
                },
                function(e, t) {
                    var o = clone(e),
                        i = clone(t);
                ...
                }(j, E) || (Object(n.each)(E, function(e) {
                    E[e] = null
                }), Object(i.setStyle)(e, extend(E, j)), cur.__narrowBar.lastStyles = j), C !== u && Object(i.toggleClass)(e, "fixed", C), cur.__narrowBar.lastSt = c, cur.__narrowBar.isBarFixed = C
        }
    }
    ...
    function f() {
        if (window.pageNode) {
            ...
            browser.mobile || vk.staticheader || Object(a.updateHeaderStyles)({
                marginLeft: e
            }), Object(a.updateLeftMenu)(), u(), Object(s.updSideTopLink)()
        }
    }
    ...
    function h(e) {
        if (window.pageNode) {
            var t = document.documentElement,
                ...
                d = Math.max(Object(n.intval)(window.innerHeight), Object(n.intval)(r)),
                f = !1;
            if (browser.mobile && (l = Math.max(l, Object(n.intval)(bodyNode.scrollWidth)), d = Math.max(d, Object(n.intval)(bodyNode.scrollHeight))), window.lastWindowWidth !== l || !0 === e) {
                f = !0, window.lastInnerWidth = window.lastWindowWidth = l, layerWrap.style.width = boxLayerWrap.style.width = l + "px";
            ...
            if ((window.lastWindowHeight !== d || !0 === e) && (f = !0, window.lastWindowHeight = d, layerBG.style.height = boxLayerBG.style.height = layerWrap.style.height = boxLayerWrap.style.height = d + "px", window.mvLayerWrap && !mvcur.minimized && (mvLayerWrap.style.height = d + "px"), window.wkLayerWrap)) {
                var g = browser.mobile ? window.innerHeight : d;
            ...
            Object(n.each)(y, function() {
                p(this, "ui_search_fixed"), setTimeout(p.pbind(this, "ui_search_fixed"), 0)
            }), E && (p(E, "fixed"), setTimeout(p.pbind(E, "fixed"), 0)), Object(a.updateLeftMenu)(), u(), Object(a.updateSTL)()
        }
    }
    ...
    var m = {
        init: function() {
            ...
            if (!e || !t) return !1;
            addEvent(e, "mousedown", m.clicked), this.inited = !0
        },
        clicked: function(e) {
        ...
        toggle: function(e) {
            var t = Object(i.ge)("top_profile_link"),
                ...
                n = hasClass(o, "shown");
            void 0 !== e && n === e || (void 0 === e && (e = !n), Object(i.toggleClass)(t, "active", e), Object(i.toggleClass)(o, "shown", e), e ? (cancelStackPush("top_menu", m.toggle.bind(this, !1), !0), cur.introExitTooltipHide && (cur.introExitTooltipHide(), delete cur.introExitTooltipHide)) : cancelStackFilter("top_menu", !0))
        },
        show: function() {
    ...
    e.exports = !o(399) && !o(463)(function() {
        return 7 != Object.defineProperty(o(14)("div"), "a", {
            get: function() {
                return 7
            }
        }).a
    ...
    var n = o(512),
        ...
        r = o(338),
        a = {};
    o(142)(a, o(494)("iterator"), function() {
        return this
    }), e.exports = function(e, t, o) {
        e.prototype = n(a, {
            next: i(1, o)
    ...
    'eat script';
    var n = o(334);
    e.exports = o(130)("Map", function(e) {
        return function() {
            return e(this, arguments.length > 0 ? arguments[0] : void 0)
        }
    }, {
    ...
    e.exports = o(171).document && document.documentElement
}, , function(e, t, o) {
    'eat script';
    ...
    var n = o(444),
        ...
        c = function() {
            var e, t = o(14)("iframe"),
                n = r.length;
            for (t.style.display = "none", o(506).appendChild(t), t.src = "javascript:", (e = t.contentWindow.document).open(), e.write("<script>document.F=Object<\/script>"), e.close(), c = e.F; n--;) delete c.prototype[r[n]];
            return c()
        };
    ...
    function k(e) {
        ...
        if (setTimeout(C.pbind(r, a), 10), e.counters) {
            ...
            if (e.handlecnts) {
                ...
                for (var k = _.length; v < k; v++) {
                    var j = _[v].split(":"),
                        x = Object(n.ge)("l_app" + Object(i.intval)(j[0]));
                    x && y(x, Object(i.intval)(j[1]))
                }
                setTimeout(c.updSeenAdsInfo, 0)
            } else
                for (var P = 0; P < f.length; P++) vk.counts[f[P]] = _[P]
        }
    }
                ...
                switch (c[1]) {
                    ...
                    case "audio_playlist":
                        var C = c[2].split("_"),
                            ...
                            x = j[0],
                            P = j[1];
                        return AudioUtils.showAudioPlaylist(x, P, c[3], void 0, void 0, t.onDone), !1;
                    case "article_edit":
                        return openArticleEditor.apply(null, c[2].split("_")), !1;
                    case "podcast":
                        return stManager.add([jsc("web/podcast.js"), "podcast.css"], function() {
                            Podcast.show(c[2])
                        }), !1
                }
            }
    ...
    e.exports = {
        set: Object.setPrototypeOf || ("__proto__" in {} ? function(e, t, n) {
            try {
                (n = o(347)(Function.call, o(241).f(Object.prototype, "__proto__").set, 2))(e, []), t = !(e instanceof Array)
            } catch (e) {
                t = !0
            }
            return function(e, o) {
