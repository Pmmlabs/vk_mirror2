! function(e) {
    ...
    t.vkLocal = o, t.lTimeout = n, t.rand = i, t.irand = a, t.isUndefined = r, t.isFunction = s, t.isArray = l, t.isString = d, t.isObject = c, t.isEmpty = u, t.vkNow = h, t.vkImage = p, t.trim = f, t.stripHTML = w, t.escapeRE = _, t.intval = v, t.floatval = g, t.positive = m, t.isNumeric = b, t.winToUtf = y, t.replaceEntities = x, t.clean = k, t.unclean = C, t.each = T, t.indexOf = S, t.inArray = L, t.clone = E, t.arrayKeyDiff = B, t.extend = A, t.addTemplates = N, t.getTemplate = P, t.serializeForm = M, t.extractUrls = j, t.isRetina = I, window.PageID = window.PageID || 1;
    ...
    function showVideo(e, t, o, n) {
        ...
        if (!checkEvent(n)) {
            ...
            }), i && (d.claim = i), ajax.post("al_video.php", d, o), vkImage().src = locProtocol + "//vk.com/rtrg?r=w*Z1Flwi3QdbWaoLMc7zOA*7Cr4Nrtojr9otHjsjIhsb2CVqRWalgbvxZw3MzxZa6be3Siu2XY3gvK5fysYtWLWgNwHMpjRTupSGZrcGRNlj7fduqq9*t7ij6CX4aMcBTD5be8mIXJsbTsvP8Zl2RZEd76a4FTuCOFqzMxqGtFc-", !1
        }
    }
    ...
    }, window.showVideo = showVideo, window.showInlineVideo = showInlineVideo, window.loadInlineVideo = loadInlineVideo, window.revertLastInlineVideo = revertLastInlineVideo, window.destroyInlineVideoPlayer = destroyInlineVideoPlayer, window.pauseLastInlineVideo = pauseLastInlineVideo, window.checkMp4 = checkMp4
}, function(e, t) {
    function o(e) {
        var t, o = function(e) {
                var t = e.split("#"),
    ...
    function z(e, t) {
        return void 0 === t && (t = !R(e)), t ? q(e) : O(e), t
    }
    ...
    t.ge = n, t.geByTag = i, t.geByTag1 = a, t.geByClass = r, t.geByClass1 = s, t.gpeByClass = l, t.domQuery = d, t.domQuery1 = c, t.domClosest = u, t.ce = h, t.re = p, t.se = f, t.sech = w, t.rs = _, t.psr = v, t.domReplaceEl = g, t.domEL = m, t.domNS = b, t.domPS = y, t.domFC = x, t.domLC = k, t.domPN = C, t.domChildren = T, t.domInsertBefore = S, t.domInsertAfter = L, t.domByClass = E, t.domData = B, t.domChildIndex = A, t.domCA = N, t.domClosestSibling = P, t.matchesSelector = M, t.isHover = j, t.isAncestor = I, t.getScroll = H, t.domClosestPositioned = F, t.domClosestOverflowHidden = D, t.show = q, t.hide = O, t.isVisible = R, t.clientHeight = V, t.getClientRectOffsetY = W, t.toggle = z, t.boundingRectEnabled = Y, t.getXYRect = U, t.getXY = G, t.isWindow = K, t.getSize = X, t.getW = $, t.getH = Z, t.hasClass = Q, t.addClass = J, t.addClassDelayed = ee, t.removeClass = te, t.removeClassDelayed = oe, t.toggleClass = ne, t.toggleClassDelayed = ie, t.replaceClass = ae, t.getStyle = re, t.setStyle = se, t.setStyleDelayed = le, t.setPseudoStyle = de, t.data = ce, t.attr = ue, t.removeAttr = he, t.removeData = pe, t.cleanElems = fe, t.setTitle = we, t.getZoom = _e, t.val = ve, t.elfocus = ge, t.traverseParent = me;
    var ye = o(8);
    ...
    __webpack_require__(12), __webpack_require__(40), __webpack_require__(14), __webpack_require__(2), __webpack_require__(16), __webpack_require__(8), __webpack_require__(26), __webpack_require__(44), __webpack_require__(27), __webpack_require__(13), __webpack_require__(41), __webpack_require__(39), __webpack_require__(24), __webpack_require__(35), __webpack_require__(4), __webpack_require__(21), __webpack_require__(15), __webpack_require__(9), __webpack_require__(1), __webpack_require__(42), __webpack_require__(36), __webpack_require__(6), __webpack_require__(23), __webpack_require__(17), __webpack_require__(20), __webpack_require__(33);
    var vk = window.vk;
    ...
    addEvent(document, "mousedown", function(e) {
        ...
        if (setTimeout(updateOtherCounters.pbind(n, i), 10), e.counters) {
            var a = (e.counters || "").split(","),
                r = "",
                s = "";
            intval(a[9]) > 0 ? (r = "exchange", s = "act=overview&status=-1") : intval(a[9]) < -1 ? (a[9] = 1, r = "ads", s = "act=a_comeback_office_redirect") : r = "ads?act=office&last=1";
            var l = 0,
                d = ge("l_set"),
                c = d && d.nextSibling || !1,
                u = !1,
        ...
        function() {
            ...
            function d(e, t) {
                ...
                ce.forEach(function(n) {
                    return I(n) ? void o.push(n) : void(h(n, e, t) ? (n[J] = Date.now(), ue.push(n)) : p(n, e, t) && (n[Z] ? delete n[Z] : (H(ue, n), he = he.concat(P(n))), delete n[J]))
