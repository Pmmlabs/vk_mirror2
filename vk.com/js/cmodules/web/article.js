! function(e) {
    ...
    function n() {
        return oe++ + "-" + Date.now() % 1e6 + "-" + irand(0, 99999)
    }
    Object.defineProperty(t, "__esModule", {
        value: !0
    });
    ...
    var ne = 50,
        ...
        se = function() {
            function e(t, r, a) {
                ...
                i(this, e), this._id = n(), T.lang = T.lang || {}, W(T.lang, o.lang), this._els = {
                    editor: ge(t),
                    canvas: U('<div class="article_editor_canvas article_edit article" contenteditable="true"></div>')
                }, this._els.editor.appendChild(this._els.canvas), this._els.editor.appendChild(this._photoUploadEl = U('<div class="article_photo_upload"></div>')), O(this._els.editor, "article_editor"), this._dirty = [], this._undos = [], this._objects = {}, this._options = o, (0, v.initLimits)(o.limits);
                var s = a || [];
                if (o.postData) {
            ...
            return e.prototype._setEventListener = function(e, t, r) {
                ...
                if (!this._options.noTitle) {
                    this._els.placeholders || (this._els.placeholders = U('<div class="article_ed__text_placeholders"></div>'), this._els.placeholderTitle = U("<h1>" + this.getOptions().placeholderTitle + "</h1>"), this._els.placeholderFirstParagraph = U("<p>" + this.getOptions().placeholderParagraph + "</p>"), this._els.placeholders.appendChild(this._els.placeholderTitle), this._els.placeholders.appendChild(this._els.placeholderFirstParagraph), this._els.editor.appendChild(this._els.placeholders));
                ...
                return B(this._els.canvas)[0] + (e ? 2 * this._options.figureSideMargin : 0)
                ...
                S(this._ps, function(r, a) {
                    if (a._object == e) {
                        ...
                        return (0, _.focusEl)(i), H(t._getParagraphElByIndex(r)), t._setAllParagraphsDirty(), t._triggerInputEvent(), !1
                    }
                })
                ...
                if (r && r.type == g.ParagraphType.Text && r.lines.length && r.lines[0].text) {
                    ...
                    if (i && r.lines[0].text == i) {
                        var n = this._getCurrentParagraphIndex(),
                            s = o(n, 1),
                            l = s[0];
                        H(this._els.shareParseForm), H(this._els.shareIFrame), this._els.shareIFrame = this._els.editor.appendChild(U('<iframe class="editor__share_parse_iframe" name="editor__share_parse_iframe"></iframe>')), this._els.shareParseForm = this._els.editor.appendChild(ce("form", {
                    ...
                    if ("uuid" == n && s) {
                        ...
                        if (l) {
                            ...
                            var d = this._getCurrentParagraphIndex(),
                                u = o(d, 1),
                                p = u[0];
                            Q(c, this._getParagraphElByIndex(p)), e.preventDefault(), this._setAllParagraphsDirty(), this._triggerInputEvent()
                        }
                    }
                }
                ...
                if (!this._formatTooltip) {
                    ...
                    this._formatTooltip = new ElementTooltip(this._els.editor, {
                        ...
                        onShow: function() {
                            ...
                            if (i || (e.justHeaders || a.push(["strong", "cur.articleEditor.setStrong()", !!e.decorations.strong]), e.quote || e.justHeaders || a.push(["em", "cur.articleEditor.setEm()", !!e.decorations.em]), a.push(["strike", "cur.articleEditor.setStrike()", !!e.decorations.strike]), e.decorations.link ? a.push(["link", "cur.articleEditor.clearLink()", e.decorations.link]) : a.push(["link", "cur.articleEditor.setLinkMode(true)", e.decorations.link]), e.object || e.header1 || e.list || (a.push(["header1", "cur.articleEditor.setHeader1(" + D(e.header2) + ")", e.header2]), a.push(["header2", "cur.articleEditor.setHeader2(" + D(e.header3) + ")", e.header3]), a.push(["quote", "cur.articleEditor.setQuote()", e.quote]))), 0 == a.length) return void t._formatTooltip.hide();
                            var n = j("article_format_btns", r);
                            n.innerHTML = "", a.forEach(function(e, t) {
                                t > 0 && (0, E.inArray)(e[0], ["header1"]) && n.appendChild(U('<div class="article_format_divider"></div>'));
                                var r = e[2] ? "article_format_btn_active" : "";
                                n.appendChild(U('<button class="article_format_btn ' + r + '" id="article_format_btn_' + e[0] + '" onclick="' + e[1] + '"></button>'))
                            }), t.setLinkMode(!1)
                        },
                    ...
                    i.addEventListener("keypress", function(e) {
                        return e.keyCode == ee.Enter ? (t._setLinkToSelectedText(i.value.trim()), t._formatTooltip.hide(), cancelEvent(e)) : void 0
                    });
                ...
                if (clearTimeout(this._saveUndoDelayed), this._undoStateDelayed) {
                    ...
                    this._undos.push({
                        ...
                        cursor: e
                    }), this._undos.length > ne && this._undos.shift()
                }
                var r = !0;
                    ...
                    S(t.childNodes, function(e, t) {
                        ...
                        switch (n) {
                            ...
                            case "del":
                                ...
                                break;
                            case "a":
                                o = ie.link, i.push((0, _.decodeURL)(t.getAttribute("href") || ""));
                                break;
                            case "code":
                                o = ie.code;
                                break;
                            case "font":
                                ...
                                "monospace" === s ? o = ie.code : "times" === s && (o = ie.code)
                        }
                ...
                return e.lines.forEach(function(a) {
                    ...
                    u.forEach(function(t, r) {
                        if (t) {
                            ...
                            var o = 0;
                            n && (i && i.endsWith("<br/>") && (o++, i = i.replace(/<br\/>$/, "")), i && i.endsWith("<br/>") && (o++, i = i.replace(/<br\/>$/, "")), i !== !1 && h.push(i)), S(re, function(e, r) {
                                var a = t.close[r.type];
                                void 0 !== a && h.push("</" + r.tag + ">")
                            }), h.push("<br/>".repeat(o)), S(te, function(e, r) {
                                var a = t.open[r.type];
                                void 0 !== t.open[r.type] && (a === !0 ? h.push("<" + r.tag + ">") : h.push("<" + r.tag + ' href="' + V(a) + '">'))
                            }), p = r
                        }
                ...
                var t = (0, _.isObjectParagraph)(e),
                    ...
                    n = a[1],
                    s = void 0;
                return s = t ? this._renderObjectParagraph(e, n) : U(i ? "<" + i + ">" + n + "</" + i + ">" : n), O(s, "_article_paragraph"), O(s, "article_paragraph"), O(s, "_article_p"), s
                ...
                e ? (this._els.canvas.innerHTML = "", this._ps.forEach(function(e) {
                    ...
                    if (!(e >= t._ps.length)) {
                        ...
                        r ? a.outerHTML != r.outerHTML && X(r, a) : t._els.canvas.appendChild(a)
                    }
                }), this._dirty = []
                    ...
                    for (var t = Array.prototype.slice.call(this._els.canvas.children), r = void 0; r = t.shift();)
                        if (!(0, _.isObjectParagraphEl)(r) || !this._isTrackedObjectEl(r))
                            for (var a = Array.prototype.slice.call(geByTag("img", r)), i = void 0, n = function() {
                                    ...
                                    (0, _.justCursorInString)(r.textContent) ? (X(r, o), H(i), Q(U("<p>" + _.CURSOR_MARKER_START + "</p>"), o)) : (Q(o, domPN(i)), H(a), H(i)), z(o, function(t) {
                                        return t == e._els.canvas ? !0 : void L(t, _.ArticleEditorParagraphClass)
                                    }), (0, _.queuePhotoProcess)(i.src, function(t, r, a) {
                                        if (t) H(o), e._forgetObject(n._uuid), a();
                                        else {
                    ...
                    for (var t = Array.prototype.slice.call(this._els.canvas.children), r = void 0, a = this._fromPasteEvent, i = this._pasteCurrentIndex, n = this._getCurrentParagraphIndex(), s = o(n, 1), l = s[0], c = -1, d = function() {
                            function t(e) {
                                if (e && e.nodeType != Node.TEXT_NODE && "BR" != e.tagName) {
                                    if (!(0, _.hasBlockElements)(e)) return void(e != n && ($(e.innerHTML) && F(e, r), o = !0));
                                    if (this._isTrackedObjectEl(e)) return void(e != n && (F(e, r), o = !0));
                                    for (var a = Array.prototype.slice.call(e.childNodes), i = void 0; i = a.shift();) t.call(this, i)
                                }
                            }
                            if (c++, a && !$(r.textContent) && c > i && l >= c) return H(r), "continue";
                            var n = r;
                ...
                var e = (0, _.getRange)(),
                    ...
                    i = t[2];
                if (r && !a) {
                    var n = z(r.startContainer, function(e) {
                ...
                void 0 === o && e && (o = this.getFirstCoverPhotoFromParagraphs()), this.getOptions().postData && (r = r || {}, r.from_post_convert = 1), y["default"].save(this.getArticleOwnerId(), this.getArticleId(), i, e, n, o ? o.id : "", this._getSaveDraftHash(), this._options.limits.maxSymbolsPerChunk, r, function(r, i, o, s, l) {
                    r || (i && (a._options.articleId = i), "al_articles.php" != nav.objLoc[0] || nav.objLoc.article_id || nav.setLoc(W({}, nav.objLoc, {
                    ...
                    if ((0, _.isQuoteEl)(r)) {
                        ...
                        if (i.shift(), i.length)
                            for (var o = void 0; o = i.shift();) {
                                if (this._saveCursorMarker(), e) Q(o, r);
                                else {
                                    var s = U("<" + a + "></" + a + ">");
                                    s.appendChild(o), Q(s, r)
                                }
                ...
                if (this._els.canvas) {
                    ...
                    if (e) {
                        var t = $(e.innerHTML) && "<br>" != e.innerHTML && "&nbsp;" != e.innerHTML;
                        if (t || "H1" == e.tagName) {
                ...
                this._isUploading = !!e, K(this._els.editor, "article_ed__uploading", this._isUploading)
                ...
                T.onMediaUploadStarted = function() {
                    ...
                    F(r, i), (0, _.focusEl)(i), n = r, e.setMediaUploadMode(!0)
                }, T.onMediaUploadFail = function() {
                    delete T.onMediaUploadStarted, n && H(n), e.setMediaUploadMode(!1)
                }, T.chooseMedia = function(t, r, o, s) {
                    delete T.onMediaUploadStarted, n && H(n);
                    ...
                    var c = e._renderObjectParagraph(l, ""),
                        d = e._getParagraphElByIndex(a + D(s));
                    F(c, d), (0, _.focusEl)(d), e._setAllParagraphsDirty(), e._triggerInputEvent(), e._saveUndoState(), e.saveDraft(), void 0 === s && i.hide(), e.setMediaUploadMode(!1)
                }, T.showMediaProgress = function() {}
                ...
                var t = this._getCurrentParagraphIndex(),
                    ...
                    a = r[0],
                    i = r[1];
                if (!this.isMediaUploadMode() && a !== !1 && a == i && (0, _.isParagraphEmpty)(this._ps[a], !0) && this._ps[a] && (0, E.inArray)(this._ps[a].type, [g.ParagraphType.Text, g.ParagraphType.Header2, g.ParagraphType.Header3])) {
                    G(this._objectPickerEl);
                    var n = this._getParagraphElByIndex(a),
                        s = R(this._els.editor),
                        l = R(n);
                    Z(this._objectPickerEl, {
                        left: -40,
                        top: l[1] - s[1]
                    })
                } else J(this._objectPickerEl)
                ...
                this._els.canvas.addEventListener("mouseover", function(t) {
                    if ("a" == t.target.tagName.toLowerCase()) {
                        ...
                        (0, _.isVKUrl)(i) || (i = "/away.php?to=" + encodeURIComponent(i) + "&utf=1"), e._linkTooltip = new ElementTooltip(r, {
                            ...
                            content: U('<a target="_blank" href="' + i + '" class="article_editor_link">' + a + "</a>")
                        })
                    }
                })
                ...
                function e(e, r, a) {
                    r.nodeType == Node.TEXT_NODE ? e.textOffset = a : e.nodeOffset = a, z(r, function(r) {
                ...
                function t(e) {
                    ...
                    var a = void 0;
                    return a = t.nodeType == Node.TEXT_NODE && void 0 !== e.textOffset ? Math.min(t.textContent.length, e.textOffset) : 0,
                        void 0 !== e.nodeOffset && t && t.children && (a = Math.min(e.nodeOffset, t.childNodes.length)), [t, a]
                }
                ...
                this._setEventListener(window, "scroll", function() {
                    ...
                    var t = (0, _.getRange)(),
                        ...
                        n = r[1];
                    if (a) {
                        var s = z(a.commonAncestorContainer, function(t) {
                ...
                this._els.canvas.addEventListener("keydown", function(i) {
                    var u = i.keyCode,
                        ...
                        T = w[1],
                        O = e._getParagraph(P);
                    if (i.keyCode == ee.Tab && y && 0 == P) return (0, _.focusEl)(e._getParagraphElByIndex(1)), cancelEvent(i);
                    if (p && i.keyCode == ee.KeyA && (0, _.isObjectParagraph)(O) && O._object.isCaptionFocused()) {
                    ...
                    if (u == ee.KeyC && i.altKey) return void e._toggleCodeBlocks();
                    if (u == ee.Apostrophe && !y && !I && e.getOptions().codeFormatEnabled && (0, E.inArray)(j, [g.ParagraphType.Text, g.ParagraphType.NumericList, g.ParagraphType.BulletList])) {
                        e._setCurrentParagraphDirty();
                        var L = (0, C.gpeByTag)("code", m.startContainer) || (0, C.gpeByTag)("code", m.endContainer);
                        if (L) {
                            e._saveCursorMarker();
                            var N = U("<span></span>");
                            N.innerHTML = L.innerHTML, X(L, N), e._triggerInputEvent()
                        } else document.execCommand("fontName", !1, "monospace"), x.msie && e._triggerInputEvent();
                        return cancelEvent(i)
                    }
                    if (u == ee.Tab && I && j == g.ParagraphType.Code) return document.execCommand("insertText", !1, "  "), cancelEvent(i);
                    var M = !1;
                    if (u == ee.Backspace) {
                        ...
                        if (D) {
                            if (O._object.isCaptionFocused()) {
                                ...
                                return X(z, W), (0, _.focusEl)(W), e._setAllParagraphsDirty(), e._triggerInputEvent(), cancelEvent(i)
                            }
                            var K = e._getParagraphElByIndex(P),
                                $ = (0, _.createParagraphEl)();
                            return X(K, $), (0, _.focusEl)($), e._setAllParagraphsDirty(), e._triggerInputEvent(), cancelEvent(i)
                        }
                        if (m && 0 == m.startOffset && m.collapsed) {
                            var q = (0, C.gpeByTag)("li", m.startContainer),
                                V = (0, _.getElementIndex)(q);
                            if (q) {
                                var Y = e._ps[P],
                                    G = clone(Y),
                                    J = clone(Y);
                                G.lines = G.lines.slice(0, V);
                                var Z = (0, _.buildParagraph)({
                                    lines: [clone(Y.lines[V])]
                                });
                                J.lines = J.lines.slice(V + 1), e._ps.splice(P, 1, G, Z, J), e._redraw(!0);
                    ...
                    if (u == ee.Delete) {
                        ...
                        if ((0, _.isObjectParagraph)(se) && m && y && (ce = !se._object.isCaptionFocused() && m.startContainer == se._object.el(), ce = ce || se._object.isCaptionFocused() && se._object.isEmptyCaption()), ce) {
                            ...
                            return X(de, ue), (0, _.focusEl)(ue), e._setAllParagraphsDirty(), e._triggerInputEvent(), cancelEvent(i)
                        }
                        ...
                        if (e._isWithinObjectParagraphEl((0, _.getFocusedElement)())) {
                            ...
                            return e._ps[ge]._object.isCaptionFocused() ? Q(fe, _e) : F(fe, _e), e._setAllParagraphsDirty(), (0, _.focusEl)(fe), e._triggerInputEvent(), cancelEvent(i)
                        }
                ...
                return this._els.canvas.addEventListener("dragenter", this._dragEnterEventsHandler = function(e) {
                    ...
                    var a = e.target;
                    t._isParagraphEl(a) && (Q(r, a), L(a, "article_ed__drag_drop")), t.onDragEnd(), t._setAllParagraphsDirty(), t._triggerInputEvent(), setTimeout(function() {
    ...
    var i = function() {
        ...
        n = r(17),
        o = (r(13), window.browser && (browser.mozilla || browser.safari)),
        s = void 0,
        l = function() {
            function e(t, r, i) {
