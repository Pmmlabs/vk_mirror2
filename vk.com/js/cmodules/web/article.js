! function(e) {
    ...
    7: function(e, t, r) {
        ...
        function $(e, t, r) {
            ...
            if (t) {
                if (d + p + r > i + n) return i + n - d - p - r;
                if (i > d + l - r) return i - d - l + r
            } else {
                if (d + p + r > i) return i - d - p - r;
        ...
        function X(e, t) {
            ...
            var r, i, n = {
                ...
                o = e.ownerDocument;
            return o ? (r = o.documentElement, V(e) && (n = Q(e, !0)), i = o == o.window ? o : 9 === o.nodeType ? o.defaultView || o.parentWindow : !1, [n.left + (t ? 0 : i.pageXOffset || r.scrollLeft) - (r.clientLeft || 0), n.top + (t ? 0 : i.pageYOffset || r.scrollTop) - (r.clientTop || 0)]) : [0, 0]
        }
        ...
        function pe(e, t, r) {
            var i = ue(e, "pseudo-id");
            i || (ue(e, "pseudo-id", i = irand(1e8, 999999999)), te(e, "_pseudo_" + i));
            var n = t + "-style-" + i,
                o = a(n),
                s = "._pseudo_" + i + ":" + t + "{";
            ...
            A = function() {
                function e(t, r, a) {
                    ...
                    s && 0 != s.length || (s = [(0, f.buildParagraph)({
                        ...
                        e.lines.forEach(function(e) {
                            e.text = (0, f.replaceParagraphEntities)(e.text), e.brs && isObject(e.brs) && (e.brs = Object.values(e.brs))
                        })
                ...
                return e.prototype._setEventListener = function(e, t, r) {
                            ...
                            C.forEach(function(r) {
                                ...
                                a && !(0, b.isEmpty)(a) && a.forEach(function(t) {
                                    ...
                                    if ("link" == r.type) l < a[1] && c > a[0] && (n[r.type] = 1, i.decorations[r.type] = !0);
                                        ...
                                        var d = l >= a[0] && l <= a[1],
                                            p = c >= a[0] && c <= a[1];
                                        d && p ? (n[r.type] = 2, i.decorations[r.type] = !0) : d && (e.text.length > a[1] ? n[r.type] = -1 : n[r.type] = 1)
                                    }
                                })
                            }), s += e.text.length
                        })
                    ...
                    return e.lines.forEach(function(e) {
                        ...
                        d.forEach(function(t, r) {
                            if (t) {
                                ...
                                r > 0 && (a = (0, f.prepareLineText)(l, p, r, e.brs), i || u.push(a));
                                var n = 0;
                                i && (a && a.endsWith("<br/>") && (n++, a = a.replace(/<br\/>$/, "")), a && a.endsWith("<br/>") && (n++, a = a.replace(/<br\/>$/, "")), a !== !1 && u.push(a)), each(P, function(e, r) {
                                    var a = t.close[r.type];
                                    void 0 !== a && u.push("</" + r.tag + ">")
                                }), u.push("<br/>".repeat(n)), each(C, function(e, r) {
                                    var a = t.open[r.type];
                                    void 0 !== t.open[r.type] && (a === !0 ? u.push("<" + r.tag + ">") : u.push("<" + r.tag + ' href="' + clean(a) + '">'))
                                }), p = r
                            }
                        }), u.push((0, f.prepareLineText)(l, p, void 0, e.brs)), i && (n = n ? " " + n : "", r += "<" + i + n + ">"), (0, b.inArray)(o, [g.ParagraphType.Quote, g.ParagraphType.Quote2]) && (r += "<p>"), r += u.join("") || (t ? "" : "<br/>"), (0, b.inArray)(o, [g.ParagraphType.Quote, g.ParagraphType.Quote2]) && (r += "</p>"), i && (r += "</" + i + ">")
                    }), [a, r]
                    ...
                    if (e.rangeCount) {
                        ...
                        var p = this._getContainingParagraphEl(n),
                            u = o(p, 2),
                            h = u[1];
                    ...
                    if (!this._markerCursorSet) {
                        ...
                        if (n != this._els.canvas) {
                            var d = this._getContainingParagraphEl(n)[1],
                                p = void 0;
                            e(n, s, f.CURSOR_MARKER_START), i || (p = this._getContainingParagraphEl(l)[1], p == d && l.textContent.includes(f.CURSOR_MARKER_START) && (c += 1), e(l, c, f.CURSOR_MARKER_END)), this._markerCursorSet = !0
                        }
                    }
                    ...
                    var a = this,
                        i = this._ps;
                    cur._debug1 = i.length + "/" + isObject(i) + "/" + isArray(i) + "/" + Object.keys(i).join(",") + "/" + Object.values(i).join(",");
                    var n = (0, _.getCleanedState)(this._ps, !1, !0);
                    e && (0, f.correctRealIndexes)(n, -1);
                    var o = this._getName(),
                        s = this.getCoverPhoto();
                    void 0 === s && e && (s = this.getFirstCoverPhotoFromParagraphs()), m["default"].save(this.getArticleOwnerId(), this.getArticleId(), n, e, o, s ? s.id : "", this._getSaveDraftHash(), this._options.limits.maxSymbolsPerChunk, r, function(r, i, n, s, l) {
                        ...
                        })), a._publishNameCandidate = o, e && (a._options.isPublished = !0), a._replaceVideos(l)), t && t(r, i, n, s)
                    })
                        ...
                        t._ps.forEach(function(e, a) {
                            if (e.type == g.ParagraphType.ObjectVideo) {
                                var c = e.mediaId.split("_"),
                                    ...
                                    u = d[1],
                                    h = d[2];
                                h || p != i || u != n || (e.mediaId = s + "_" + l, t._setParagraphDirty(a), r = !0)
                            }
                        })
                    }), r && this._redrawModel()
                    ...
                    cur.onMediaUploadStarted = function() {
                        ...
                        domInsertBefore(r, i), (0, f.focusEl)(i), n = r
                    ...
                    this._els.canvas.addEventListener("input", function() {
                        ...
                        e._redraw(o), e._restoreCursor(i), e._correctCursorToBeWithinCanvas(), e._dirty = [], a ? e._saveUndoStateDelayed(e._lastCursor) : e._saveUndoState(e._lastCursor), r = a = !1, e._fromPasteEvent = !1, browser.mozilla && e._showFormatTooltip(), e.saveDraft()
                    });
                    var s = !1,
                        l = !1,
                        c = 1,
                    ...
                    this._els.canvas.addEventListener("keydown", function(i) {
                        var p = i.keyCode,
                            ...
                            P = C[0],
                            T = C[1];
                        if (i.keyCode == E.Tab && y && 0 == P) return (0, f.focusEl)(e._getParagraphElByIndex(1)), cancelEvent(i);
                        var x = i.metaKey || i.ctrlKey;
                        if (x) switch (i.keyCode) {
                            case E.KeyB:
                        ...
                        if (p == E.Backspace) {
                            ...
                            if (k) {
                                if (S._object.isCaptionFocused()) {
                                    ...
                                    return domReplaceEl(N, D), (0, f.focusEl)(D), e._setAllParagraphsDirty(), e._triggerInputEvent(), cancelEvent(i)
                                }
                                var I = e._getParagraphElByIndex(P),
                                    R = (0, f.createParagraphEl)();
                                return domReplaceEl(I, R), (0, f.focusEl)(R), e._setAllParagraphsDirty(), e._triggerInputEvent(), cancelEvent(i)
                            }
                            if (v && 0 == v.startOffset && v.collapsed) {
                                ...
                                if (M) {
                                    ...
                                    return (0, f.focusEl)(W), cancelEvent(i)
                                }
                            }
                        ...
                        if (p == E.Delete) {
                            ...
                            if ((0, f.isObjectParagraph)(Q) && v && y && (Y = !Q._object.isCaptionFocused() && v.startContainer == Q._object.el(), Y = Y || Q._object.isCaptionFocused() && Q._object.isEmptyCaption()), Y) {
                                ...
                                return domReplaceEl(G, J), (0, f.focusEl)(J), e._setAllParagraphsDirty(), e._triggerInputEvent(), cancelEvent(i)
                            }
                            ...
                            if (e._isWithinObjectParagraphEl((0, f.getFocusedElement)())) {
                                ...
                                return e._ps[re]._object.isCaptionFocused() ? domInsertAfter(ae, te) : domInsertBefore(ae, te), e._setAllParagraphsDirty(), (0, f.focusEl)(ae), e._triggerInputEvent(), cancelEvent(i)
                            }
                            var ie = e._getContainingParagraphEl((0, f.getFocusedElement)()),
                                ne = o(ie, 3),
                                oe = ne[0],
                                le = ne[1],
                                ce = ne[2],
                            ...
                            if (i.shiftKey) {
                                ...
                                if (each(ce.lines, function(e, t) {
                                        var r = t.brs,
                                            a = t.text,
                                            i = a.length;
                                        return 0 == me || i >= me && (0, b.inArray)(me, r) ? (Ee = !0, !1) : (me -= i, 0 >= me && e == we ? !1 : void 0)
                                    }), Ee) {
                                    n = !0, e._setParagraphDirty(P, T), document.execCommand("insertParagraph");
                                    var Ce = domNS(oe);
                                    return Ce && ((0, f.focusEl)(Ce), Ce.focus()), e._triggerInputEvent(), cancelEvent(i)
                                }
                            ...
                            l = Pe && !(0, f.isListParagraph)(e._ps[P]) && !i.shiftKey && (0, b.inArray)(ce.type, [g.ParagraphType.Quote, g.ParagraphType.Quote2]), window.browser && window.browser.msie && setTimeout(e._triggerInputEvent.bind(e)), l || i.shiftKey || e._parseUrlParagraph(le), e._setParagraphDirty(P, T)
                        } else i.key && 1 == i.key.length ? (e._setParagraphDirty(P), e._setParagraphDirty(T), i.metaKey || (O = !0, i.key && ((0, f.isCyrillicChar)(i.key) ? c += 1 : (0, f.isLatinChar)(i.key) && (c -= 1), c = Math.min(Math.max(c, -5), 5))), r = (0, f.isWhiteSpaceChar)(i.key), t && !r && (a = !0), t = O, setTimeout(function() {
                                    ...
                                    for (var n = i.textContent.substring(a.startOffset - 5, a.startOffset), o = 0, l = h.Sequences.length; l > o; o++) {
                                        ...
                                        if (void 0 === p.cyrillic || p.cyrillic === d)
                                            if (p.pattern instanceof RegExp) {
                                                var u = n.match(p.pattern);
                                                if (u) {
                                                    var f = p.substitution;
                                                    u.length > 1 && (f = f.replace("$1", u[1])), t.call(e, a.startOffset, i, u[0], f, p.noUndo);
                                                    break
                                                }
                                            } else if (n.endsWith(p.pattern)) {
                                            t.call(e, a.startOffset, i, p.pattern, p.substitution, p.noUndo);
                                            break
                                        }
                                    }
                            }
    ...
    39: function(e, t) {
        ...
        function D(e, t) {
            for (var r, a = t ? B : M, i = []; e && (r = e.match(a));) {
    ...
    50: function(e, t, r) {
        ...
        function b(e) {
            ...
            return v(e) && (t._uuid = e._uuid), t.lines = e.lines || [{
                ...
                decorations: {},
                brs: []
            }], t.type = e.type ? parseInt(e.type) : ne.ParagraphType.Text, e._preparedData && (t._preparedData = e._preparedData), e.mediaId && (t.mediaId = e.mediaId), e.fromExtPage && (t.fromExtPage = e.fromExtPage), t
        }
        ...
        function M(e, t, r) {
            ...
            return t.type = n[t.type] || a(i), t.src = i, t.callback = r, t.name = i, t.type ? void H(i, B.bind(null, t)) : void r(new Error("Image type is not supported"))
        }
            ...
            return e._saveChunk = function(e, t, r, a, i) {
                ...
                if (a.forEach(function(e) {
                    ...
                    var f = new callHub(function() {
                        e._saveFinally(t, r, i, n, o, c, s, p.length, !1, d)
                    }, p.length);
                ...
                case g.ParagraphType.ObjectPhoto:
                    if (e) {
                        var i = geByTag1("img", r),
                            ...
                            o = (0, g.getAppropriateImage)(n, getW(i), !0),
                            s = f(o, 1),
                            l = s[0],
                            c = new Image;
                        c.onload = function() {
        ...
        function d(e) {
            if (!m.noImageOpen) {
                ...
                n && c && (addClass(t, "article_image_full_viewable"), t.addEventListener("click", function() {
                    ...
                    }), i.addEventListener("mousewheel", p), w = i;
                    var s = new Image;
                    s.onload = function() {
