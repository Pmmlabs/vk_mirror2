! function(e) {
    ...
    function T(e, t) {
        return Object(i.isString)(t) && (t = C(t)), A(e).replaceChild(t, e), t
    }
    ...
    function G(e, t) {
        for (var r = e = a(e), i = void 0; r && r.tagName && r !== bodyNode;) {
            var n = _e(r, "position"),
                o = _e(r, "overflow"),
                s = _e(r, "transform");
            if (t && browser.mozilla && "page_wrap" !== r.id && r !== e && "visible" !== o && ("static" === n ? !i || "relative" === i : "fixed" !== i)) break;
            "none" !== s ? i = void 0 : "static" !== n && "fixed" !== i && (i = n), r = A(r)
        }
        return r
    }
            ...
            if (null != a)
                for (var s in a)
                    if (a.hasOwnProperty(s)) {
                        var c = r[s],
                            l = a[s];
                        r !== l && (n && l && "object" === (void 0 === l ? "undefined" : o(l)) && !l.nodeType ? r[s] = M(n, c || (null != l.length ? [] : {}), l) : void 0 !== l && (r[s] = l))
                    }
        }
        return r
    }
            ...
            var s = function(e, t, r, a) {
                ...
                function f(s) {
                    ...
                    for (var E = o; E < Math.min(o + 3, e.length); E++) {
                        var C = Object(i.getAppropriateImage)(e[E], d[0], !0),
                            P = n(C, 1),
                            O = P[0];
    ...
    function w() {
        if (!(isEmpty(h.ads) || d.notFull || isArray(h.ads) && 0 == h.ads.length)) {
            ...
            var t = ce("ins");
            for (var r in addClass(t, "mrg-tag"), addClass(t, "article_adsblock"), d.mobile && addClass(t, "article_adsblock_mobile"), setStyle(t, {
                    display: "block",
                    "text-decoration": "none"
                }), h.ads.data) h.ads.data.hasOwnProperty(r) && domData(t, r, "" + h.ads.data[r]);
            var i = geByClass1("article_misc_block");
            i ? i.firstChild ? domInsertBefore(t, i.firstChild) : i.appendChild(t) : domInsertAfter(t, c), window.MRGtag || (window.MRGtag = []);
            var n = d.mobile ? {
                iframeMode: !0
            } : {};
            window.MRGtag.push(n)
        }
    }
                ...
                var i = Object(a.initPhotoCarousel)(r, d),
                    l = function(e) {
                        ...
                        r.addEventListener("click", function() {
                            ...
                            r && r.innerHTML && i.appendChild(se('<div class="article_full_view__caption"><div class="article_full_view__caption_inner">' + r.innerHTML + "</div></div>")), a.length > 1 && (toggleClass(j, "article_full_view__carousel", a.length > 1), P = se('<div class="article_full_view__right"></div>'), i.appendChild(P), O = se('<div class="article_full_view__left"></div>'), i.appendChild(O), P.addEventListener("click", function(e) {
    ...
    function S(e, t, r) {
        (toggleClass(O, "article_full_view__nav_hidden", 0 == r), toggleClass(P, "article_full_view__nav_hidden", r == t.length - 1), t.length > 1) && (geByClass1("article_full_view__counter_text", j).innerHTML = getLang("global_article_carousel_counter").replace("{counter}", r + 1).replace("{total}", t.length));
        x = r;
                ...
                this._els.canvas.addEventListener("keydown", function(t) {
                    ...
                    if (E) {
                        ...
                        if (Object(l.isObjectParagraph)(S))
                            if (S._object.isCaptionFocused()) I = 0 == E.startOffset && C;
                            else {
                        ...
                        if ((a == re || a == J) && e._resizeTooltip && e._resizeTooltip.isShown() && e._resizeTooltip.hide(), a == ie && C && 0 == T) return Object(l.focusEl)(e._getParagraphElByIndex(1)), cancelEvent(t);
                        ...
                        if (a == J) {
                            ...
                            if (E && C && 0 == E.startOffset && "LI" === !E.startContainer.nodeName) {
                        ...
                        if (a == re) {
                            ...
                            if (I)
                                if (!(ve._object.isCaptionFocused() && !!ve.lines[0].text)) {
                                    ...
                                    return U(Ee, Ce), Object(l.focusEl)(Ce), e._setAllParagraphsDirty(), e._triggerInputEvent(), cancelEvent(t)
                                }
                            if (C && Object(l.hasSeparator)(ye) && we) return e._setParagraphDirty(T + 1), delete ye.sep, e._redraw(!1, !0), cancelEvent(t);
                            if (C && we && Object(l.isObjectParagraph)(ye)) return Object(l.isParagraphEmpty)(ve) && ve.type != d.ParagraphType.Header1 && (e._ps.splice(T, 1), e._redraw(!0, !0)), Object(l.focusEl)(ye._object.getCaptionEl()), cancelEvent(t);
                            ...
                            if (H && R && D == d.ParagraphType.Code && C) {
                                var Pe = R.textContent.search(/[^\s]/);
                                return -1 == Pe && (Pe = R.textContent.length), document.execCommand("insertText", !1, "\n" + " ".repeat(Pe)), cancelEvent(t)
                            }
                            ...
                            if (t.shiftKey || t.ctrlKey && m.safari) {
                                ...
                                if (b(Me.lines, function(e, t) {
                                        var r = t.brs,
                                            i = t.text.length;
                                        return 0 == He || He <= i && inArray(He, r) ? (Fe = !0, !1) : !((He -= i) <= 0 && e == Ue) && void 0
                                    }), Fe) {
                            ...
                            var Ye = C && E.startContainer.nodeType == Node.TEXT_NODE && !E.startContainer.nextSibling && Re == Ae.textContent.length;
                ...
                if (Object(l.isObjectParagraph)(v)) {
                    ...
                    window.addEventListener("mousemove", t = function(t) {
                        if (i || !(Math.abs(y - t.pageY) < 10)) {
                            i || (i = L('<div class="article_ed__drag_shadow"></div>'), e._els.editor.appendChild(i), (m = I(e._els.canvas))[1] -= scrollGetY(), b = S(h), E = I(h), C = t.pageX - E[0], P = t.pageY - E[1] + e._options.layer.scrollTop, setStyle(i, {
                                width: b[0],
                                height: b[1]
                            }), e._focusParagraph(f)), w(e._els.canvas, "no_select"), m || d(), setStyle(i, {
                                left: t.pageX - m[0] - C,
                                top: t.pageY - scrollGetY() - P - m[1] + e._options.layer.scrollTop
