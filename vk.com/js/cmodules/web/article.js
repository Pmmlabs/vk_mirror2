! function(e) {
    ...
    window.cf = function(e) {
            ...
            return "transform"
        }(), window.vkExpand = window.vkExpand || "VK" + (0, we.vkNow)(), window.vkUUID = window.vkUUID || 0, window.vkCache = window.vkCache || {}, window.ge = a, window.geByTag = n, window.geByTag1 = i, window.geByClass = o, window.geByClass1 = s, window.gpeByClass = l, window.domQuery = c, window.domQuery1 = d, window.domClosest = u, window.ce = p, window.re = h, window.se = f, window.sech = g,
                    ...
                    e._ps.forEach(function(e) {
                        e.lines.forEach(function(e) {
                            ...
                            if (r >= 0) {
                                ...
                                for (var a = 0, n = 0; n < e.brs.length; n++) e.brs[n] > r && (a = 1),
                                    e.brs[n] -= a;
                                each(w, function(t, a) {
