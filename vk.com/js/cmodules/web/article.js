        ...
        var Z = 50,
            ...
            te = function() {
                ...
                return e.prototype.updateWarnInfos = function() {
                    ...
                    if (clearTimeout(this._saveUndoDelayedTO), this._undoStateDelayed) {
                    ...
                    var r = !0;
                    this._undoStateDelayed = Object(h.getCleanedState)(this._ps, r)
                }, e.prototype._undo = function() {
                    if (this._undos.length) {
                        var e = this._undos.pop();
                        this._ps = Object(h.expandParagraphFields)(e.ps), this._redraw(!0), this._restoreCursor(e.cursor), this._updateTextPlaceholders(), delete this._undoStateDelayed, this._saveUndoState()
                    }
                    ...
                    if (this._markerCursorSet) {
                        ...
                        if (r) {
                            ...
                            r[0].nodeType == Node.TEXT_NODE && (r[1] = Math.min(r[1], r[0].textContent.length)),
                                a.setStart(r[0], r[1]), n && (n[0].nodeType == Node.TEXT_NODE && (n[1] = Math.min(n[1], n[0].textContent.length)), a.setEnd(n[0], n[1]));
                            var o = window.getSelection();
                    ...
                    var e = this;
                    this._options.noTitle || (Object(u.isObjectParagraph)(this._ps[0]) && (this._ps[0] = Object(u.buildParagraph)({
                        type: p.ParagraphType.Header1
                    })), this._ps[0].type != p.ParagraphType.Header1 && (this._ps[0].type = p.ParagraphType.Header1), delete this._ps[0].sep), this._ps.forEach(function(t, r) {
                    ...
                    var e = this,
                        ...
                        i = function(t, r, i, a) {
                            ...
                            g["default"].add(p.ParagraphType.ObjectAudio, i.fullId, {
                                audio: a
                            }), e._getOrCreateParagraphObject(o), e._ps[n] = o, curBox().hide(), e._redrawModel();
                            var s = e._getParagraphElByIndex(n);
                            Object(u.focusEl)(s), e.saveUndoStateAndDraft()
                        },
                        a = function(t, r) {
                    ...
                    if (!this.isLocked()) {
                        ...
                        this._setEventListener(document, "selectionchange", function() {
                            ...
                            t = d, e._highlightObjectsInCurrentSelection(), e._showObjectPicker(), e._correctCaptionSelection(), e._ensureDummyParagraphs(), 0 == a && e._showFormatTooltip(), e._lastCursor = e._getCursor(), e._saveLastCursor()
                        });
                        var r = !1,
                            n = !1,
                            i = !1,
                        ...
                        this._els.canvas.addEventListener("input", function() {
                            ...
                            e._redraw(a), e._restoreCursor(r), e._correctCursorToBeWithinCanvas(), e._dirty = [], i ? e._saveUndoStateDelayed(e._lastCursor) : e._saveUndoState(e._lastCursor), n = i = !1, e._fromPasteEvent = !1, w.mozilla && e._showFormatTooltip(), e._updateTextPlaceholders(), e.saveDraft()
                        });
                        var s = !1,
                            c = !1,
                            l = 1,
                                ...
                                if (a == q.Backspace) {
                                    ...
                                    if (b && 0 == b.startOffset && b.collapsed) {
                                        ...
                                        if (G) {
                                            ...
                                            return Object(u.focusEl)(ne), e._saveUndoState(e._lastCursor), cancelEvent(t)
                                        }
                                    }
                    ...
                    this._els.canvas.addEventListener("mousedown", function(c) {
                        ...
                        if (Object(u.isObjectParagraph)(_)) {
                            ...
                            window.addEventListener("mousemove", r = function(r) {
                                ...
                                o !== !1 && f && (t._ps.splice(f, 1), Object(u.hasSeparator)(_) && (t._ps[f].sep = 1, delete _.sep), t._ps.splice(o + 1, 0, _), t._redraw(!0, !0), t.saveUndoSateAndDraft()), window.removeEventListener("mousemove", r), window.removeEventListener("mouseup", n), o = !1, j(t._els.canvas, "no_select"), clearInterval(a), e(!1), A(i), i = !1
                            })
                        }
                    })
