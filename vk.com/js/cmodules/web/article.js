! function(e) {
        ...
        re = function() {
            ...
            return e.prototype._setEventListener = function(e, t, r) {
                ...
                this._els.canvas.addEventListener("keydown", function(i) {
                    ...
                    if (u == X.Apostrophe && !y && !I && e.getOptions().codeFormatEnabled && (0, E.inArray)(j, [g.ParagraphType.Text, g.ParagraphType.NumericList, g.ParagraphType.BulletList])) {
    ...
    var i = function() {
        ...
        n = r(10),
        o = (r(15), window.browser && (browser.mozilla || browser.safari)),
        s = void 0,
        l = function() {
            function e(t, r, i) {
