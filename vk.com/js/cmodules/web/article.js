! function(e) {
    ...
    21: function(e, t, r) {
        ...
        function S(e, t) {
            return Object(n.isString)(t) && (t = C(t)), M(e).replaceChild(t, e), t
        }
        ...
        function G(e, t) {
            for (var r = (t = t || {}).fromEl || M(e), i = t.positions || ["relative", "absolute", "fixed"]; r && r !== bodyNode;) {
                var a = ve(r, "position");
        ...
        function q(e, t) {
            for (var r = e = s(e), n = void 0, i = void 0, o = void 0, c = !1; r && r.tagName && r !== bodyNode;) {
                ...
                "none" !== o ? c = void 0 : "static" !== n && "fixed" !== c && (c = n), r = M(r)
            }
            return r
        }
    ...
    268: function(e, t, r) {
                ...
                if (null != a)
                    for (var o in a)
                        if (a.hasOwnProperty(o)) {
                            var c = r[o],
                                l = a[o];
                            r !== l && (i && l && "object" === (void 0 === l ? "undefined" : s(l)) && !l.nodeType ? r[o] = D(i, c || (null != l.length ? [] : {}), l) : void 0 !== l && (r[o] = l))
                        }
            }
            return r
        }
        ...
        function W(e) {
            var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                r = t.kLimit || 1e3;
            return e >= (t.mLimit || 1e6) && !t.noCheck ? W(e = (e = P(e / 1e5)) > 1e3 ? P(e / 10) : e / 10, D(t, {
                noCheck: !0
            }), !0) + "M" : e >= r && !t.noCheck ? W(e = (e = P(e / 100)) > 100 ? P(e / 10) : e / 10, D(t, {
                noCheck: !0
    ...
    9: function(e, t, r) {
        ...
        var pe = function() {
            function e(t, r, n) {
                ...
                ! function(e, t) {
                    if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
                }(this, e), this._id = ue(), b.lang = b.lang || {}, M(b.lang, i.lang), this._options = i, this._els = {
                    editor: W(t),
            ...
            return e.prototype.updateWarnInfos = function() {
                ...
                if (!this._options.noTitle) {
                    this._els.placeholders || (this._els.placeholders = L('<div class="article_ed__text_placeholders"></div>'), this._els.placeholderTitle = L("<h1>" + this.getOptions().placeholderTitle + "</h1>"), this._els.placeholderFirstParagraph = L("<p>" + this.getOptions().placeholderParagraph + "</p>"), this._els.placeholders.appendChild(this._els.placeholderTitle), this._els.placeholders.appendChild(this._els.placeholderFirstParagraph), this._els.editor.appendChild(this._els.placeholders)), Object(l.isParagraphEmpty)(this._ps[0]) ? C(this._els.placeholderTitle, "article_ed__text_placeholder_hidden") : E(this._els.placeholderTitle, "article_ed__text_placeholder_hidden");
                    var e = this._ps[1],
                        t = !!e && e.sep,
                        r = this._getCurrentParagraphIndex(),
                        n = g(r, 1)[0];
                    Object(l.isParagraphEmpty)(e) && (!e || e.type != d.ParagraphType.Code) && n < 2 && this._ps.length <= 2 && !t ? C(this._els.placeholderFirstParagraph, "article_ed__text_placeholder_hidden") : E(this._els.placeholderFirstParagraph, "article_ed__text_placeholder_hidden")
                }
                    ...
                    m(t.childNodes, function(e, t) {
                        ...
                        switch (a) {
                            ...
                            case "del":
                                ...
                                break;
                            case "a":
                                o = le.link, i.push(Object(l.decodeURL)(t.getAttribute("href") || "").replace("#", "%23"));
                                break;
                            case "code":
                                o = le.code;
                                break;
                ...
                var r = this._getOrCreateParagraphObject(e),
                    n = r.el(),
                    i = parseInt(e.mode) || 0;
                return r.onRender && r.onRender(), r.setCaptionElHtml(t), x(n, "uuid", e._uuid), x(n, "type", e.type), x(n, "media-id", e._object.getMediaId()), x(n, "mode", i), E(n, l.ArticleEditorParagraphClass), n
                ...
                var t = Object(l.isObjectParagraph)(e),
                    ...
                    a = n[1],
                    o = void 0;
                return o = t ? this._renderObjectParagraph(e, a) : L(i ? "<" + i + ">" + a + "</" + i + ">" : a), Object(l.hasSeparator)(e) ? x(o, "sep", Object(l.genSepatorId)()) : x(o, "sep", null), E(o, l.ArticleEditorParagraphClass), E(o, "article_paragraph"), o
                ...
                void 0 === o && e && (o = this.getFirstCoverPhotoFromParagraphs()), this.getOptions().postData && ((r = r || {}).from_post_convert = 1), h.default.save(this.getArticleOwnerId(), this.getArticleId(), i, e, a, o ? o.id : "", this._getSaveDraftHash(), this._options.limits.maxSymbolsPerChunk, r, function(r, i, o, s, c, l) {
                    ...
                    r || (i && (n._options.articleId = i), "al_articles.php" != nav.objLoc[0] || nav.objLoc.article_id || nav.setLoc(M({}, nav.objLoc, {
                ...
                var o = void 0,
                    s = -1;
                b.chooseMedia = function(t, c, u, p) {
                ...
                if (!this.isLocked()) {
                    ...
                    this._els.canvas.addEventListener("input", function() {
                        ...
                        e._redraw(o), e._restoreCursor(i), e._correctCursorToBeWithinCanvas(), e._dirty = [], n ? e._saveUndoStateDelayed() : e._saveUndoState(), r = n = !1, e._fromPasteEvent = !1, y.mozilla && e._showFormatTooltip(), e._updateTextPlaceholders(), e.saveDraft(), e._undoable = !0, e._options.onUndoRedo && e._options.onUndoRedo()
                    });
                    var o = !1,
                        s = !1,
                        u = 1,
                    ...
                    this._els.canvas.addEventListener("keydown", function(t) {
                        ...
                        if (E) {
                            ...
                            if ((i == ne || i == Z) && e._resizeTooltip && e._resizeTooltip.isShown() && e._resizeTooltip.hide(), i == ie && O && 0 == C) return Object(l.focusEl)(e._getParagraphElByIndex(1)), cancelEvent(t);
                            if (h && i == $ && Object(l.isObjectParagraph)(x) && x._object.isCaptionFocused()) {
                            ...
                            var N = i == G && t.altKey,
                                M = x ? x.type : d.ParagraphType.Text,
                                D = Object(_.gpeByTag)("pre", E.startContainer),
                                R = !!(D || Object(_.gpeByTag)("pre", E.endContainer) || E.startContainer.nodeType == Node.ELEMENT_NODE && "PRE" == E.startContainer.tagName);
                            if (N) {
                                if (M === d.ParagraphType.Header1) return cancelEvent(t);
                                if (O) return e._toggleCodeBlocks(), cancelEvent(t);
                                if (!R && inArray(M, [d.ParagraphType.Text, d.ParagraphType.NumericList, d.ParagraphType.BulletList])) {
                            ...
                            if (i == ie && R && M == d.ParagraphType.Code) return document.execCommand("insertText", !1, "  "), cancelEvent(t);
                            var F = !1;
                            if (i == Z) {
                            ...
                            if (i == ne) {
                                ...
                                if (S)
                                    if (!(ve._object.isCaptionFocused() && !!ve.lines[0].text)) {
                                        var Oe = e._getParagraphElByIndex(C),
                                            Pe = Object(l.createParagraphEl)();
                                        return U(Oe, Pe), Object(l.focusEl)(Pe), e._setAllParagraphsDirty(), e._triggerInputEvent(), cancelEvent(t)
                                    }
                                if (O && Object(l.hasSeparator)(be) && Ee) return e._setParagraphDirty(C + 1), delete be.sep, e._redraw(!1, !0), cancelEvent(t);
                                if (O && Ee && Object(l.isObjectParagraph)(be)) return Object(l.isParagraphEmpty)(ve) && ve.type != d.ParagraphType.Header1 && (e._ps.splice(C, 1), e._redraw(!0, !0)), Object(l.focusEl)(be._object.getCaptionEl()), cancelEvent(t);
                                be && Object(l.isParagraphEmpty)(ve) && inArray(be.type, [d.ParagraphType.Header2, d.ParagraphType.Header3]) && (ve.type = be.type, e._setParagraphDirty(C), e._redraw()), e._setAllParagraphsDirty(), (y.msie && 0 == E.startOffset && 0 == C || f) && setTimeout(function() {
                                    e._setCurrentParagraphDirty(), e._triggerInputEvent()
                                })
                            } else if (i == ee) {
                                if (R && D && M == d.ParagraphType.Code && O) {
                                    var je = D.textContent.search(/[^\s]/);
                                    return -1 == je && (je = D.textContent.length), document.execCommand("insertText", !1, "\n" + " ".repeat(je)), cancelEvent(t)
                                }
                                ...
                                var Ie = e._getContainingParagraphEl(Object(l.getFocusedElement)()),
                                    ...
                                    Ae = Le[0],
                                    Ne = (Le[1], Le[2]),
                                    Me = getCaretCharacterOffsetWithin(Ae),
                                    De = g(Me, 2)[1];
                                ...
                                var We = O && E.startContainer.nodeType == Node.TEXT_NODE && !E.startContainer.nextSibling && De == Ae.textContent.length;
                    ...
                    if (Object(l.isObjectParagraph)(v)) {
                        ...
                        window.addEventListener("mousemove", t = function(t) {
                            if (n || !(Math.abs(b - t.pageY) < 10)) {
                                n || (n = L('<div class="article_ed__drag_shadow"></div>'), e._els.editor.appendChild(n), (y = k(e._els.canvas))[1] -= scrollGetY(), m = S(h), O = k(h), P = t.pageX - O[0], j = t.pageY - O[1] + e._options.layer.scrollTop, setStyle(n, {
                                    width: m[0],
                                    height: m[1]
                                }), e._focusParagraph(f)), E(e._els.canvas, "no_select"), y || d(), setStyle(n, {
                                    left: t.pageX - y[0] - P,
                                    top: t.pageY - scrollGetY() - j - y[1] + e._options.layer.scrollTop
                ...
                t && !e && (C(this._els.editor, "article_ed__warn_shown"), I(t)), t || e && (t = L('<div class="article_ed__warn_info">' + e + "</div>"), this._els.editor.appendChild(t), E(this._els.editor, "article_ed__warn_shown"))
