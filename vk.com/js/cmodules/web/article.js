    ...
    var pe = function() {
        ...
        return e.prototype.updateWarnInfos = function() {
            ...
            if (this._saveUndoDelayedTO && this._saveUndoState(), this._undos.length) {
                ...
                this._ps = Object(u.expandParagraphFields)(e.ps), this._undoCurrentState = Object(u.getCleanedState)(this._ps), this._undoCurrentStateCursor = e.cursor, this._redraw(!0), e.cursor && this._restoreCursor(e.cursor), this._updateTextPlaceholders()
            }
                ...
                for (var t = Array.prototype.slice.call(this._els.canvas.children), r = void 0; r = t.shift();)
                    if (!Object(l.isObjectParagraphEl)(r) || !this._isTrackedObjectEl(r))
                        for (var n = Array.prototype.slice.call(geByTag("img", r)), i = void 0, a = function() {
                                ...
                                Object(l.justCursorInString)(r.textContent) ? (U(r, o), I(i), B(L("<p>" + l.CURSOR_MARKER_START + "</p>"), o)) : (B(o, domPN(i)), I(n), I(i)), N(o, function(t) {
            ...
            if (!this.isLocked()) {
                ...
                this._setEventListener(document, "selectionchange", function() {
                    ...
                    if (!1 !== c) {
                        ...
                        if (b.msie && o && H("article_ed__extra_controls", p) && "BUTTON" != p.tagName) {
                            var h = e._ps[c];
                ...
                this._els.canvas.addEventListener("input", function() {
                    ...
                    e._redraw(o), e._restoreCursor(i), e._correctCursorToBeWithinCanvas(), e._dirty = [], n ? e._saveUndoStateDelayed() : e._saveUndoState(), r = n = !1, e._fromPasteEvent = !1, b.mozilla && e._showFormatTooltip(), e._updateTextPlaceholders(), e.saveDraft()
                });
                var o = !1,
                    s = !1,
                    u = 1,
                    ...
                    if (w) {
                        ...
                        if (N) {
                            ...
                            if (!R && inArray(D, [d.ParagraphType.Text, d.ParagraphType.NumericList, d.ParagraphType.BulletList])) {
                                ...
                                var H = Object(_.gpeByTag)("code", w.startContainer) || Object(_.gpeByTag)("code", w.endContainer);
                                if (H) {
                                    e._saveCursorMarker();
                                    var z = L("<span></span>");
                                    z.innerHTML = H.innerHTML, U(H, z), e._triggerInputEvent()
                        ...
                        if (i == ne) {
                            ...
                            if (e._isWithinObjectParagraphEl(Object(l.getFocusedElement)())) {
                                var Ce = e._getContainingParagraphEl(Object(l.getFocusedElement)()),
                                    ...
                                    ke = e._ps[xe]._object;
                                return !ke.isCaptioned() || ke.isCaptionFocused() ? B(Se, Te) : A(Se, Te), e._setAllParagraphsDirty(), Object(l.focusEl)(Se), e._triggerInputEvent(), cancelEvent(t)
                            }
