                        ...
                        this._els.canvas.addEventListener("keydown", function(t) {
                            ...
                            if (w) {
                                ...
                                if (a == G.Delete) {
                                    ...
                                    le && Object(l.isParagraphEmpty)(ce) && V(le.type, [d.ParagraphType.Header2, d.ParagraphType.Header3]) && (ce.type = le.type,
                                        e._setParagraphDirty(O), e._redraw()), e._setAllParagraphsDirty(), y.msie && 0 == w.startOffset && 0 == O && setTimeout(function() {
