! function(e) {
    ...
    function n(e, t) {
        w = t || {}, P = e, cur.article = e, w.moderDeletePhoto = P.moderDeletePhoto, y = ge("article_view_" + e.owner_id + "_" + e.id), b = w.scrollNode || window, E = w.getScrollTop || function() {
                        ...
                        if (!Object(l.isObjectParagraphEl)(r) || !this._isTrackedObjectEl(r))
                            for (var n = Array.prototype.slice.call(geByTag("img", r)), i = void 0, a = function() {
                                    ...
                                    Object(l.justCursorInString)(r.textContent) ? (z(r, o), L(i), H(N("<p>" + l.CURSOR_MARKER_START + "</p>"), o)) : (H(o, domPN(i)), L(n), L(i)), M(o, function(t) {
                                        ...
                                        if (t) L(o), e._forgetObject(a._uuid), e._setAllParagraphsDirty(), e._triggerInputEvent(), n();
                                        else {
