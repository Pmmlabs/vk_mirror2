! function(e) {
        ...
        if (e = e.substring(t, r), n && n.length) {
            ...
            n.forEach(function(r) {
                if (r -= t, !(0 >= r || r > e.length)) {
                    ...
                    n = i ? n : C(n), a.push(n), o = r
                }
            });
            var s = e.substring(o);
            return a.push(i ? s : C(s)), "" == a[a.length - 1], a.join("")
        }
        return i ? e : C(e)
    }
    ...
    function A(e, t, r) {
        ...
        if ("object" === ("undefined" == typeof e ? "undefined" : te(e)) && "img" === e.tagName.toLowerCase() && (i = e.src), "string" == typeof e && (i = e), /^data:/.test(i) && !t.convert) return void r(null, N(i));
        var a = {
            png: "image/png",
            jpg: "image/jpeg",
            jpeg: "image/jpeg",
    ...
    function A(e, t, r) {
        for (var n = null; null === n && e;) e = -1 === r ? E(e) : C(e), e && M(e, t) && (n = e);
        return n
    }
        ...
        for ("boolean" == typeof r && (a = r, r = t[1] || {}, n = 2), "object" === ("undefined" == typeof r ? "undefined" : U(r)) || c(r) || (r = {}); i > n; ++n)
            if (null != (e = t[n]))
                for (var o in e) {
                    var s = r[o],
                        l = e[o];
                    r !== l && (a && l && "object" === ("undefined" == typeof l ? "undefined" : U(l)) && !l.nodeType ? r[o] = I(a, s || (null != l.length ? [] : {}), l) : void 0 !== l && (r[o] = l))
                }
        return r
    }
    ...
    function R(e) {
        var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
            r = t.kLimit || 1e3,
            n = t.mLimit || 1e6;
        return e >= n && !t.noCheck ? (e = m(e / 1e5), e = e > 1e3 ? m(e / 10) : e / 10, R(e, I(t, {
            noCheck: !0
        }), !0) + "M") : e >= r && !t.noCheck ? (e = m(e / 100), e = e > 100 ? m(e / 10) : e / 10, R(e, I(t, {
            noCheck: !0
        ...
        ie = function() {
            ...
            return e.prototype.updateWarnInfos = function() {
                ...
                if (!this._formatTooltip) {
                    ...
                    var a = E("article_set_link_delete", r);
                    ...
                    this._els.canvas.addEventListener("keydown", function(t) {
                        ...
                        if (w) {
                            ...
                            if (Object(l.isObjectParagraph)(x))
                                if (x._object.isCaptionFocused()) S = 0 == w.startOffset && C;
                                else {
                            ...
                            if (a == G.Tab && C && 0 == O) return Object(l.focusEl)(e._getParagraphElByIndex(1)), cancelEvent(t);
                            ...
                            if (a == G.Delete) {
                                ...
                                if (C && Object(l.hasSeparator)(le) && he) return e._setParagraphDirty(O + 1), delete le.sep, e._redraw(!1, !0), cancelEvent(t);
                                if (C && he && Object(l.isObjectParagraph)(le)) return Object(l.isParagraphEmpty)(ce) && ce.type != d.ParagraphType.Header1 && (e._ps.splice(O, 1), e._redraw(!0, !0)), Object(l.focusEl)(le._object.getCaptionEl()), cancelEvent(t);
                                ...
                                if (U && R && B == d.ParagraphType.Code && C) {
                                ...
                                if (e._isWithinObjectParagraphEl(Object(l.getFocusedElement)())) {
                                    ...
                                    return e._ps[we]._object.isCaptionFocused() ? H(Ce, be) : A(Ce, be), e._setAllParagraphsDirty(), Object(l.focusEl)(Ce), e._triggerInputEvent(), cancelEvent(t)
                                }
                                ...
                                var Re = C && w.startContainer.nodeType == Node.TEXT_NODE && !w.startContainer.nextSibling && ke == Oe.textContent.length;
                                                    ...
                                                    if (void 0 === w.cyrillic || w.cyrillic === h)
                                                        if (w.pattern instanceof RegExp) {
                                                            ...
                                                            if (C) {
                                                                ...
                                                                C.length > 1 && (E = E.replace("$1", C[1])), t.call(e, i.startOffset, v, C[0], E, w.noUndo);
                                                                break
                                                            }
                    ...
                    if (Object(l.isObjectParagraph)(v)) {
                        ...
                        window.addEventListener("mousemove", r = function(r) {
                            if (i || !(Math.abs(m - r.pageY) < 10)) {
                                i || (i = N('<div class="article_ed__drag_shadow"></div>'), t._els.editor.appendChild(i), y = I(t._els.canvas), y[1] -= scrollGetY(), b = k(h), C = I(h), E = r.pageX - C[0], P = r.pageY - C[1] + t._options.layer.scrollTop, Y(i, {
                                    width: b[0],
                                    height: b[1]
                                }), console.log(r.pageY, C[1], y[1], scrollGetY(), y[1] - scrollGetY(), P), t._focusParagraph(f)), w(t._els.canvas, "no_select"), Y(i, {
                                    left: r.pageX - y[0] - E,
                ...
                t && !e && (O(this._els.editor, "article_ed__warn_shown"), L(t)), t || e && (t = N('<div class="article_ed__warn_info">' + e + "</div>"), this._els.editor.appendChild(t), w(this._els.editor, "article_ed__warn_shown"))
            }, e
        }();
    t["default"] = ie
}, function(e, t, r) {
