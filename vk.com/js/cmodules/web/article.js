! function(e) {
    ...
    134: function(e, t, r) {
        ...
        function n(e, t) {
            w = t || {}, P = e, window.cur && (window.cur.article = e), w.moderDeletePhoto = P.moderDeletePhoto, y = ge("article_view_" + e.owner_id + "_" + e.id), b = w.scrollNode || window, E = w.getScrollTop || function() {
            ...
            ie = function() {
                ...
                return e.prototype.updateWarnInfos = function() {
                    ...
                    if (i !== !1) {
                        ...
                        this._redraw(!0), this._updateTextPlaceholders(),
                            this._restoreCursor(t), this._saveUndoState(), this.saveDraft()
                    }
