! function(e) {
                    ...
                    this._els.canvas.addEventListener("keydown", function(t) {
                        ...
                        if (E) {
                            ...
                            if (a == re) {
                                ...
                                if (H && R && M == d.ParagraphType.Code && O) {
    ...
    486: function(e, t, r) {
        ...
        function w() {
            var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
            d.notFull = !1, C(), N(), j(), P(e.deviceInfo)
        }
