! function(e) {
    ...
    function w() {
        ...
        d.notFull = !1, C(), M(), j(), O(e.deviceInfo)
    }
    ...
    function O() {
        ...
        if (!(isEmpty(h.ads) || d.notFull || isArray(h.ads) && 0 == h.ads.length)) {
            ...
            var s = d.isWebView ? {
                ...
                l = h.ads.eventsHash;
            P("requested", l), s.onNoAds = function() {
                P("no_ads", l)
                ...
                this._els.canvas.addEventListener("keydown", function(t) {
                    ...
                    if (E) {
                        ...
                        if (a == re) {
                            ...
                            if (H && R && N == d.ParagraphType.Code && P) {
                            ...
                            var We = P && E.startContainer.nodeType == Node.TEXT_NODE && !E.startContainer.nextSibling && Ne == Ae.textContent.length;
                ...
                if (Object(l.isObjectParagraph)(v)) {
                    ...
                    window.addEventListener("mousemove", t = function(t) {
                        if (n || !(Math.abs(y - t.pageY) < 10)) {
                            n || (n = L('<div class="article_ed__drag_shadow"></div>'), e._els.editor.appendChild(n), (m = I(e._els.canvas))[1] -= scrollGetY(), b = S(h), E = I(h), P = t.pageX - E[0], O = t.pageY - E[1] + e._options.layer.scrollTop, setStyle(n, {
                                width: b[0],
                                height: b[1]
                            }), e._focusParagraph(f)), w(e._els.canvas, "no_select"), m || d(), setStyle(n, {
                                left: t.pageX - m[0] - P,
                                top: t.pageY - scrollGetY() - O - m[1] + e._options.layer.scrollTop
