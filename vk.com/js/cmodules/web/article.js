! function(e) {
    ...
    231: function(e, t, r) {
        ...
        var ue = function() {
            function e(t, r, n) {
                ...
                ! function(e, t) {
                    if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
                }(this, e), this._id = de(), y.lang = y.lang || {}, M(y.lang, i.lang), this._options = i, this._els = {
                    editor: W(t),
            ...
            return e.prototype.updateWarnInfos = function() {
                    ...
                    if (i && r.lines[0].text == i) {
                        ...
                        k(this._els.shareParseForm), k(this._els.shareIFrame), this._els.shareIFrame = this._els.editor.appendChild(L('<iframe class="editor__share_parse_iframe" name="editor__share_parse_iframe"></iframe>')), this._els.shareParseForm = this._els.editor.appendChild(ce("form", {
                            ...
                            if (e) {
                                ...
                                switch (e[0]) {
                                    case "audio_playlist":
                                        r = d.ParagraphType.ObjectAudioPlaylist, n = {
                                    ...
                                    case "photo":
                                        r = d.ParagraphType.ObjectPhoto, n = {
                                            size: Object(l.getPhotoSize)(i.editable.sizes),
                                ...
                                if (r) {
                                    ...
                                    f.default.add(r, s.mediaId, n), t._linkTooltip && t._linkTooltip.hide(), s = Object(l.buildParagraph)(s), t._getOrCreateParagraphObject(s), t._ps[o] = s;
                                    var c = t._getCursor();
                    ...
                    for (var t = Array.prototype.slice.call(this._els.canvas.children), r = void 0; r = t.shift();)
                        if (!Object(l.isObjectParagraphEl)(r) || !this._isTrackedObjectEl(r))
                            for (var n = Array.prototype.slice.call(geByTag("img", r)), i = void 0, a = function() {
                                    ...
                                    Object(l.justCursorInString)(r.textContent) ? (U(r, o), k(i), B(L("<p>" + l.CURSOR_MARKER_START + "</p>"), o)) : (B(o, domPN(i)), k(n), k(i)), N(o, function(t) {
                ...
                void 0 === o && e && (o = this.getFirstCoverPhotoFromParagraphs()), this.getOptions().postData && ((r = r || {}).from_post_convert = 1), h.default.save(this.getArticleOwnerId(), this.getArticleId(), i, e, a, o ? o.id : "", this._getSaveDraftHash(), this._options.limits.maxSymbolsPerChunk, r, function(r, i, o, s, c) {
                ...
                if (!this.isLocked()) {
                    ...
                    this._setEventListener(document, "selectionchange", function() {
                        var r = Object(l.getRange)(),
                            ...
                            i = n[0],
                            o = n[1];
                        if (i && !N(i.commonAncestorContainer, function(t) {
                    ...
                    this._els.canvas.addEventListener("mousedown", function() {
                        ...
                        var r = e._getCurrentParagraphIndex(),
                            n = g(r, 1)[0];
                        n && (e._handleObjectPaste(t), e._handlePhotoPaste(t), e._handleLinkPaste(t)), e._fromPasteEvent = !0, e._pasteCurrentIndex = n
                    ...
                    this._els.canvas.addEventListener("keydown", function(t) {
                        ...
                        if (E) {
                            ...
                            if (f && a == X && Object(l.isObjectParagraph)(S) && S._object.isCaptionFocused()) {
                            ...
                            if (a == ne && H && D == d.ParagraphType.Code) return document.execCommand("insertText", !1, "  "), cancelEvent(t);
                            var W = !1;
                            if (a == J) {
                            ...
                            if (a == re) {
                                ...
                                if (H && R && D == d.ParagraphType.Code && P) {
                                ...
                                if (t.shiftKey || t.ctrlKey && m.safari) {
                                    ...
                                    if (b(Me.lines, function(e, t) {
                                            var r = t.brs,
                                                n = t.text.length;
                                            return 0 == He || He <= n && inArray(He, r) ? (Fe = !0, !1) : !((He -= n) <= 0 && e == Ue) && void 0
                                        }), Fe) {
                                ...
                                var Ye = P && E.startContainer.nodeType == Node.TEXT_NODE && !E.startContainer.nextSibling && Re == Ae.textContent.length;
                                u = Ye && !Object(l.isListParagraph)(e._ps[T]) && !t.shiftKey && inArray(Me.type, [d.ParagraphType.Quote, d.ParagraphType.Quote2]), window.browser && window.browser.msie && setTimeout(e._triggerInputEvent.bind(e)), u || t.shiftKey || e._parseUrlParagraph(Ne), e._setParagraphDirty(T, x)
    ...
    330: function(e, t, r) {
        ...
        function w() {
            if (!(isEmpty(h.ads) || d.notFull || isArray(h.ads) && 0 == h.ads.length)) {
                ...
                var n = geByClass1("article_misc_block");
                n ? n.firstChild ? domInsertBefore(t, n.firstChild) : n.appendChild(t) : domInsertAfter(t, c), window.MRGtag || (window.MRGtag = []);
                var i = d.mobile ? {
                    iframeMode: !0
                } : {};
                window.MRGtag.push(i)
            }
        }
                    ...
                    var n = Object(a.initPhotoCarousel)(r, d),
                        l = function(e) {
                            ...
                            r.addEventListener("click", function() {
                                ...
                                r && r.innerHTML && n.appendChild(se('<div class="article_full_view__caption"><div class="article_full_view__caption_inner">' + r.innerHTML + "</div></div>")), a.length > 1 && (toggleClass(j, "article_full_view__carousel", a.length > 1), C = se('<div class="article_full_view__right"></div>'), n.appendChild(C), O = se('<div class="article_full_view__left"></div>'), n.appendChild(O), C.addEventListener("click", function(e) {
                                    return t = Math.min(a.length - 1, Math.max(0, t + 1)), S(i, a, t), b && b(1), cancelEvent(e)
                                }), O.addEventListener("click", function(e) {
                                    return t = Math.min(a.length - 1, Math.max(0, t - 1)), S(i, a, t), b && b(-1), cancelEvent(e)
                                })), j = se('<div class="article_full_view__counter"><div class="article_full_view__counter_text"></div><div class="article_full_view__close"></div></div>'), n.appendChild(j), a.length > 1 && toggleClass(j, "article_full_view__carousel", a.length > 1), c.appendChild(n), n.addEventListener("click", function(e) {
                                    domClosest("article_full_view__caption_inner", e.target) || I()
                                }), n.addEventListener("mousewheel", I), p = n;
        ...
        window.initArticle = y, window.deinitArticle = b, window.updateArticle = m, window.articleCloseImageFullSize = I
    },
    34: function(e, t, r) {
        "use strict";
                ...
                if (null != a)
                    for (var s in a)
                        if (a.hasOwnProperty(s)) {
                            var c = r[s],
                                l = a[s];
                            r !== l && (i && l && "object" === (void 0 === l ? "undefined" : o(l)) && !l.nodeType ? r[s] = M(i, c || (null != l.length ? [] : {}), l) : void 0 !== l && (r[s] = l))
                        }
            }
            return r
        }
        ...
        function F(e) {
            var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                r = t.kLimit || 1e3;
            return e >= (t.mLimit || 1e6) && !t.noCheck ? F(e = (e = E(e / 1e5)) > 1e3 ? E(e / 10) : e / 10, M(t, {
                noCheck: !0
            }), !0) + "M" : e >= r && !t.noCheck ? F(e = (e = E(e / 100)) > 100 ? E(e / 10) : e / 10, M(t, {
                noCheck: !0
    ...
    35: function(e, t, r) {
        ...
        function c(e, t, r) {
            return t = a(t) || document, r = r || "*", Array.prototype.slice.call(t.querySelectorAll(r + "." + e))
        }

        function l(e, t, r) {
            return t = a(t) || document, r = r || "*", t.querySelector && t.querySelector(r + "." + e) || c(e, t, r)[0]
        }
        ...
        function G(e, t) {
            for (var r = e = a(e), n = void 0; r && r.tagName && r !== bodyNode;) {
                var i = _e(r, "position"),
                    o = _e(r, "overflow"),
                    s = _e(r, "transform");
                if (t && browser.mozilla && "page_wrap" !== r.id && r !== e && "visible" !== o && ("static" === i ? !n || "relative" === n : "fixed" !== n)) break;
                "none" !== s ? n = void 0 : "static" !== i && "fixed" !== n && (n = i), r = A(r)
            }
            return r
        }
        ...
        function Z(e, t) {
            return void 0 === t && (t = !q(e)), t ? V(e) : $(e), t
        }
    ...
    40: function(e, t, r) {
        ...
        function i(e) {
            ...
            for (t = 0; t < i.length; t++) r = r.split(i[t]).join(n[t]);
        ...
        function a(e) {
            ...
            for (t = 0; t < n.length; t++) r = r.split(n.charAt(t)).join("йцукенгшщзхъфывапролджэячсмитьбю.ё".charAt(t));
            return r == e ? null : r
        }
        ...
        function o(e, t, r) {
            ...
            var n;
            if (isArray(t) ? (n = t[1], e != Math.floor(e) ? n = t[langConfig.numRules.float] : each(langConfig.numRules.int, function(r, i) {
        ...
        function c(e) {
            for (var t = e + "", r = arguments, n = r.length, i = 1; i < n; i += 2) {
                var a = "%" == r[i][0] ? r[i] : "{" + r[i] + "}";
                t = t.replace(a, r[i + 1])
            }
            return t
        ...
        function u(e, t, r, n, i, a) {
            var o;
            if (a || (a = ""), isArray(t) || (t = ["", t, t, t, t]), "number" == typeof e || "string" == typeof e ? (e > 2147483646e3 && (e = 0), e += r, o = new Date(e)) : o = e, i) t = t[1];
            else {
                var s = "";
        ...
        function p(e, t, r, n, i) {
            e *= 1e3, void 0 === r && (r = !0), void 0 === n && (n = d("months_of", "raw")), t *= 1e3;
            var a = Date.now(),
                o = new Date(a),
                s = new Date(e + t);
            return !i && e > a && e - a < 864e5 && o.getDate() == s.getDate() ? u(e, "{hour}:{minute} {am_pm}", t, [], !r) : s.getYear() != o.getYear() || e < a - 157248e5 ? u(e, d("global_date", "raw"), t, n, !r) : u(e, d("global_short_date", "raw"), t, n, !r)
        }

        function h(e, t, r, n) {
            return isToday(new Date(1e3 * e + 1e3 * t)) ? u(1e3 * e, "{hour}:{minute} {am_pm}", 1e3 * t, [], !r) : p(e, t, r, n)
        }
        ...
        function _(e, t) {
            ...
            if (n < 60) r = d("global_just_now");
            else if (n < 3600) {
                r = f(intval(n / 60), d("global_word_mins_ago", "raw"), d("global_mins_ago", "raw"))
            } else if (n < 14400) {
                r = f(intval(n / 3600), d("global_word_hours_ago", "raw"), d("global_hours_ago", "raw"))
            } else r = g(e, 0, !0, "_l");
            return r
        }
        ...
        function g(e, t, r, n) {
            ...
            var i = new Date(1e3 * e),
                a = new Date;
            return i.getFullYear() != a.getFullYear() && i.getTime() < a.getTime() - 1728e5 || Math.abs(i.getTime() - a.getTime()) > 157248e5 ? u(1e3 * e, d("global_date", "raw"), t, d("months_sm_of"), !r) : u(1e3 * e, d("global_short_date_time" + n, "raw"), t, d("months_sm_of"), !r)
        }
        ...
        function v(e, t, r) {
            ...
            var n = new Date,
                ...
                s = o.getFullYear(),
                c = o.getMonth();
            return u(1e3 * e, d(s < i && (a > 1 || c < 9 || i - s >= 2) ? "global_date" : "global_short_date_time", "raw"), t, d("months_sm_of", "raw"), !r)
        }
