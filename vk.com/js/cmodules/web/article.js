! function(e) {
    ...
    355: function(e, t, r) {
        ...
        window.ge = a, window.geByTag = o, window.geByTag1 = s, window.geByClass = c, window.geByClass1 = l, window.gpeByClass = d, window.domQuery = u, window.domQuery1 = p, window.domClosest = h, window.ce = g, window.cf = w, window.re = E, window.se = P, window.sech = O, window.rs = j, window.psr = C, window.domReplaceEl = T, window.domEL = x, window.domNS = S, window.domPS = k, window.domFC = I, window.domLC = L, window.domPN = A, window.domChildren = N, window.domInsertBefore = D, window.domInsertAfter = M, window.domByClass = R, window.domData = H, window.domChildIndex = B, window.domCA = z, window.domClosestSibling = U, window.matchesSelector = F, window.isHover = W, window.isAncestor = Y, window.getScroll = K, window.domClosestPositioned = V, window.domClosestOverflowHidden = $, window.show = q, window.hide = G, window.isVisible = X, window.clientHeight = Q, window.getClientRectOffsetY = J, window.toggle = Z, window.boundingRectEnabled = ee, window.getXYRect = te, window.getXY = re, window.isWindow = ne, window.getSize = ie, window.hasClass = se, window.addClass = ce, window.addClassDelayed = le, window.removeClass = de, window.removeClassDelayed = ue, window.toggleClass = pe, window.toggleClassDelayed = he, window.replaceClass = fe, window.getStyle = _e, window.setStyle = ge, window.setStyleDelayed = ve, window.setPseudoStyle = ye, window.data = be, window.attr = me, window.removeAttr = we, window.removeData = Ee, window.cleanElems = Pe, window.setTitle = Oe, window.getZoom = je, window.val = Ce, window.elfocus = Te, window.traverseParent = xe, window.getH = oe, window.getW = ae, window.domClosestByTag = f, window.setDocumentTitle = ke, window.lockDocumentTitle = Ie
    },
    356: function(e, t, r) {
        "use strict";
        r.r(t);
    ...
    7: function(e, t, r) {
        ...
        var ue = function() {
            function e(t, r, n) {
                ...
                ! function(e, t) {
                    if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
                }(this, e), this._id = de(), y.lang = y.lang || {}, D(y.lang, i.lang), this._options = i, this._els = {
                    editor: W(t),
            ...
            return e.prototype.updateWarnInfos = function() {
                ...
                if (!this._options.noTitle) {
                    this._els.placeholders || (this._els.placeholders = L('<div class="article_ed__text_placeholders"></div>'), this._els.placeholderTitle = L("<h1>" + this.getOptions().placeholderTitle + "</h1>"), this._els.placeholderFirstParagraph = L("<p>" + this.getOptions().placeholderParagraph + "</p>"), this._els.placeholders.appendChild(this._els.placeholderTitle), this._els.placeholders.appendChild(this._els.placeholderFirstParagraph), this._els.editor.appendChild(this._els.placeholders)), Object(l.isParagraphEmpty)(this._ps[0]) ? j(this._els.placeholderTitle, "article_ed__text_placeholder_hidden") : w(this._els.placeholderTitle, "article_ed__text_placeholder_hidden");
                    var e = this._ps[1],
                        t = !!e && e.sep,
                        r = this._getCurrentParagraphIndex(),
                        n = g(r, 1)[0];
                    Object(l.isParagraphEmpty)(e) && (!e || e.type != d.ParagraphType.Code) && n < 2 && this._ps.length <= 2 && !t ? j(this._els.placeholderFirstParagraph, "article_ed__text_placeholder_hidden") : w(this._els.placeholderFirstParagraph, "article_ed__text_placeholder_hidden")
                }
                ...
                var e = Object(l.getRange)(),
                    ...
                    r = t[0],
                    n = t[2],
                    i = C("a", r.startContainer),
                    a = C("a", r.endContainer) || i;
                ...
                return e.lines.forEach(function(n) {
                    ...
                    u.forEach(function(t, r) {
                        if (t) {
                            ...
                            var o = 0;
                            a && (i && i.endsWith("<br/>") && (o++, i = i.replace(/<br\/>$/, "")), i && i.endsWith("<br/>") && (o++, i = i.replace(/<br\/>$/, "")), !1 !== i && f.push(i)), m(ae, function(e, r) {
                                void 0 !== t.close[r.type] && f.push("</" + r.tag + ">")
                            }), f.push("<br/>".repeat(o)), m(ie, function(e, r) {
                                var n = t.open[r.type];
                        ...
                        if (!Object(l.isObjectParagraphEl)(r) || !this._isTrackedObjectEl(r))
                            for (var n = Array.prototype.slice.call(geByTag("img", r)), i = void 0, a = function() {
                                    ...
                                    Object(l.justCursorInString)(r.textContent) ? (U(r, o), I(i), H(L("<p>" + l.CURSOR_MARKER_START + "</p>"), o)) : (H(o, domPN(i)), I(n), I(i)), N(o, function(t) {
                                        ...
                                        j(t, l.ArticleEditorParagraphClass)
                ...
                if (!this.isLocked()) {
                    ...
                    this._els.canvas.addEventListener("input", function() {
                        ...
                        e._redraw(a), e._restoreCursor(r), e._correctCursorToBeWithinCanvas(), e._dirty = [], i ? e._saveUndoStateDelayed() : e._saveUndoState(), n = i = !1, e._fromPasteEvent = !1, b.mozilla && e._showFormatTooltip(), e._updateTextPlaceholders(), e.saveDraft()
                    });
                    var s = !1,
                        u = !1,
                        p = 1,
                    ...
                    this._els.canvas.addEventListener("keydown", function(t) {
                        ...
                        if (E) {
                            ...
                            if (Object(l.isObjectParagraph)(S))
                                if (S._object.isCaptionFocused()) k = 0 == E.startOffset && P;
                                else {
                                    var I = e._getContainingParagraphEl(E.startContainer);
                                    k = g(I, 1)[0] == S._object.el()
                                }
                            if (k && P && b.mozilla) {
                            ...
                            var D = a == q && t.altKey,
                                ...
                                B = !!(R || Object(_.gpeByTag)("pre", E.endContainer) || E.startContainer.nodeType == Node.ELEMENT_NODE && "PRE" == E.startContainer.tagName);
                            if (D) {
                                if (M === d.ParagraphType.Header1) return cancelEvent(t);
                                if (P) return e._toggleCodeBlocks(), cancelEvent(t);
                                if (!B && inArray(M, [d.ParagraphType.Text, d.ParagraphType.NumericList, d.ParagraphType.BulletList])) {
                            ...
                            if (a == ne && B && M == d.ParagraphType.Code) return document.execCommand("insertText", !1, "  "), cancelEvent(t);
                            var W = !1;
                            if (a == J) {
                            ...
                            if (a == re) {
                                var ve = e._ps[T],
                                    ye = e._ps[T + 1],
                                    be = getCaretCharacterOffsetWithin(E.startContainer),
                                    me = g(be, 1)[0],
                                    we = E.startContainer.textContent.length == me;
                                if (k)
                                ...
                                ye && Object(l.isParagraphEmpty)(ve) && inArray(ye.type, [d.ParagraphType.Header2, d.ParagraphType.Header3]) && (ve.type = ye.type, e._setParagraphDirty(T), e._redraw()), e._setAllParagraphsDirty(), (b.msie && 0 == E.startOffset && 0 == T || v) && setTimeout(function() {
                                    e._setCurrentParagraphDirty(), e._triggerInputEvent()
                                })
                            } else if (a == Z) {
                                if (B && R && M == d.ParagraphType.Code && P) {
                                    var Oe = R.textContent.search(/[^\s]/);
                                    return -1 == Oe && (Oe = R.textContent.length), document.execCommand("insertText", !1, "\n" + " ".repeat(Oe)), cancelEvent(t)
                                }
                                if (e._isWithinObjectParagraphEl(Object(l.getFocusedElement)())) {
                                    var je = e._getContainingParagraphEl(Object(l.getFocusedElement)()),
                                        Ce = g(je, 2),
                                        Te = Ce[0],
                                        xe = Ce[1],
                                        ...
                                        for (var u = o.textContent.substring(n.startOffset - 5, n.startOffset), f = 0, v = c.Sequences.length; f < v; f++) {
                                            ...
                                            if (void 0 === y.cyrillic || y.cyrillic === h)
                                                if (y.pattern instanceof RegExp) {
                                                    var b = u.match(y.pattern);
                                                    if (b) {
                                                        var m = y.substitution;
                                                        b.length > 1 && (m = m.replace("$1", b[1])), w.call(e, n.startOffset, o, b[0], m, y.noUndo);
                                                        break
                                                    }
                    ...
                    if (Object(l.isObjectParagraph)(v)) {
                        ...
                        window.addEventListener("mousemove", t = function(t) {
                            if (n || !(Math.abs(y - t.pageY) < 10)) {
                                n || (n = L('<div class="article_ed__drag_shadow"></div>'), e._els.editor.appendChild(n), (b = k(e._els.canvas))[1] -= scrollGetY(), m = S(h), E = k(h), P = t.pageX - E[0], O = t.pageY - E[1] + e._options.layer.scrollTop, setStyle(n, {
                                    width: m[0],
                                    height: m[1]
                                }), e._focusParagraph(f)), w(e._els.canvas, "no_select"), b || d(), setStyle(n, {
                                    left: t.pageX - b[0] - P,
                                    top: t.pageY - scrollGetY() - O - b[1] + e._options.layer.scrollTop
                ...
                t && !e && (j(this._els.editor, "article_ed__warn_shown"), I(t)), t || e && (t = L('<div class="article_ed__warn_info">' + e + "</div>"), this._els.editor.appendChild(t), w(this._els.editor, "article_ed__warn_shown"))
