! function(e) {
    ...
    t.vkLocal = r, t.lTimeout = a, t.rand = n, t.irand = i, t.isUndefined = o, t.isFunction = s, t.isArray = l, t.isString = c, t.isObject = d, t.isEmpty = p, t.vkNow = u, t.vkImage = h, t.trim = f, t.stripHTML = g, t.escapeRE = _, t.intval = v, t.floatval = y, t.positive = m, t.isNumeric = b, t.winToUtf = w, t.replaceEntities = E, t.clean = C, t.unclean = P, t.each = T, t.indexOf = x, t.inArray = O, t.clone = S, t.arrayKeyDiff = k, t.extend = j, t.addTemplates = A, t.getTemplate = L, t.serializeForm = N, t.extractUrls = D, t.isRetina = I, window.PageID = window.PageID || 1;
    var M = /(?:([!()?., \n\r\t \u00A0]|^)((https?:\/\/)?((?:[a-z0-9_\-]+\.)+(?:[a-z]{2,9}|xn--p1ai|xn--j1amh|xn--80asehdb|xn--80aswg))(\/.*?)?(\#.*?)?)(?:[\.!:;,\*\(\)]*(&nbsp;|[ \t\r\n \u00A0]))|([!()?., \n\r\t \u00A0]|^)((https?:\/\/)?((?:[a-z0-9а-яєґї_\-]+\.)+(?:рф|укр|онлайн|сайт|срб))(\/.*?)?(\#.*?)?)(?:[\.!:;,\*\(\)]*(&nbsp;|[ \t\r\n \u00A0])))/i,
        B = /(?:([!()?., \n\r\t \u00A0]|^)((https?:\/\/)?((?:[a-z0-9_\-]+\.)+(?:[a-z]{2,9}|xn--p1ai|xn--j1amh|xn--80asehdb|xn--80aswg))(\/.*?)?(\#.*?)?)(?:[\.!:;,\*\(\)&]*(&nbsp;|[ \t\r\n \u00A0]|$))|([!()?., \n\r\t \u00A0]|^)((https?:\/\/)?((?:[a-z0-9а-яєґї_\-]+\.)+(?:рф|укр|онлайн|сайт|срб))(\/.*?)?(\#.*?)?)(?:[\.!:;,\*\(\)&]*(&nbsp;|[ \t\r\n \u00A0]|$)))/i;
    window.isRetina = I, window.extractUrls = D, window.serializeForm = N, window.addTemplates = A, window.getTemplate = L, window.rand = n, window.irand = i, window.isUndefined = o, window.isFunction = s, window.isArray = l, window.isString = c, window.isObject = d, window.isEmpty = p, window.vkNow = u, window.vkImage = h, window.trim = f, window.stripHTML = g, window.escapeRE = _, window.intval = v, window.floatval = y, window.positive = m, window.isNumeric = b, window.winToUtf = w, window.replaceEntities = E, window.clean = C, window.unclean = P, window.each = T, window.indexOf = x, window.inArray = O, window.clone = S, window.arrayKeyDiff = k, window.extend = j, window.vkLocal = r, window.lTimeout = a
}, function(e, t, r) {
    "use strict";
    ...
    var n = function() {
        ...
        s = function() {
            ...
            return e.prototype.getEditor = function() {
                ...
                var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : !1;
                !!this._isLoading != !!e && (this._isLoading = e, this._setLoadingEl(), e || this.getEditor().onObjectStateLoaded(this))
    ...
    function f(e, t, r, a) {
        if (e = e.substring(t, r), a && a.length) {
            ...
            return a.forEach(function(r) {
                r -= t, 0 >= r || r > e.length || (n.push(C(e.substring(i, r) + "<br/>")), i = r)
            }), n.push(C(e.substring(i))), "" == n[n.length - 1], n.join("")
        }
        return C(e)
    }
    ...
    function b(e) {
        ...
        return v(e) && (t._uuid = e._uuid), t.lines = e.lines || [{
            ...
            decorations: {},
            brs: []
        }], t.type = e.type ? parseInt(e.type) : oe.ParagraphType.Text, e._preparedData && (t._preparedData = e._preparedData), e.mediaId && (t.mediaId = e.mediaId), e.fromExtPage && (t.fromExtPage = e.fromExtPage), t
    }
    ...
    function B(e, t, r) {
        ...
        if ("object" === ("undefined" == typeof e ? "undefined" : ne(e)) && "img" === e.tagName.toLowerCase() && (n = e.src), "string" == typeof e && (n = e), /^data:/.test(n) && !t.convert) return void r(null, M(n));
        var i = {
            png: "image/png",
            jpg: "image/jpeg",
            jpeg: "image/jpeg",
        ...
        return t.type = i[t.type] || a(n), t.src = n, t.callback = r, t.name = n, t.type ? void U(n, H.bind(null, t)) : void r(new Error("Image type is not supported"))
    }
    ...
    function W(e) {
        return e.replace(/\s/g, "").replace(de, "").replace(pe, "")
    }
    ...
    t.unwrapElement = a, t.replaceParagraphEntities = n, t.isQuoteEl = i, t.paragraphElProperties = o, t.deb = s, t.isParagraphEl = l, t.getCorrectedRange = c, t.selectEl = d, t.focusEl = p, t.isBR = u, t.getCaretCharacterOffsetWithin = h, t.prepareLineText = f, t.getElementIndex = g, t.isObjectParagraphEl = _, t.isObjectParagraph = v, t.isHeaderParagraph = y, t.isListParagraph = m, t.buildParagraph = b, t.convertBRsToArray = w, t.getRange = E, t.prepareSpacesWithSpaces = C, t.cleanTextSpaces = P, t.getLineEl = T, t.mergeRanges = x, t.isWhiteSpaceChar = O, t.isCyrillicChar = S, t.isLatinChar = k, t.isAlienParagraphEl = j, t.getFocusedElement = A, t.isTrackedParagraphEl = L, t.getPhotoSize = N, t.childNodeIndex = D, t.getAbsoluteCursorPosition = I, t.generateLatinizedName = R, t.dataURItoBlob = M, t.imageToBlob = B, t.queuePhotoProcess = z, t.cleanWhiteSpaces = W, t.justCursorInString = K, t.isParagraphEmpty = $, t.arrayUnique = q, t.decorationsSlice = V, t.cleanLineBRs = Q, t.cleanBRs = X, t.createParagraphEl = Y, t.traverseTree = G, t.throttle = J, t.isPublishNameCorrect = Z, t.correctRealIndexes = te, t.isVKUrl = re, t.decodeURL = ae;
    var oe = r(19),
        le = t.NBSP = "&nbsp;",
    ...
    function $(e, t, r) {
        ...
        var n = X(e)[1],
            ...
            p = vk.staticheader ? Math.max(0, G(c)[1] - d) : G(c)[1];
        if (t) {
            if (d + p + r > n + i) return n + i - d - p - r;
            if (n > d + l - r) return n - d - l + r
        } else {
            if (d + p + r > n) return n - d - p - r;
    ...
    function X(e, t) {
        ...
        var r, n, i = {
            ...
            o = e.ownerDocument;
        return o ? (r = o.documentElement, V(e) && (i = Q(e, !0)), n = o == o.window ? o : 9 === o.nodeType ? o.defaultView || o.parentWindow : !1, [i.left + (t ? 0 : n.pageXOffset || r.scrollLeft) - (r.clientLeft || 0), i.top + (t ? 0 : n.pageYOffset || r.scrollTop) - (r.clientTop || 0)]) : [0, 0]
    }
    ...
    function G(e, t, r) {
        ...
        if (t && "border-box" === le(e, "boxSizing") && (t = !1), e == document) i = [Math.max(o.clientWidth, bodyNode.scrollWidth, o.scrollWidth, bodyNode.offsetWidth, o.offsetWidth), Math.max(o.clientHeight, bodyNode.scrollHeight, o.scrollHeight, bodyNode.offsetHeight, o.offsetHeight)];
            ...
            var s = function() {
                i = V(e) && (n = Q(e, r)) && void 0 !== n.width ? [n.width, n.height] : [e.offsetWidth, e.offsetHeight], t && each(i, function(t, r) {
    ...
    function pe(e, t, r) {
        var n = ue(e, "pseudo-id");
        n || (ue(e, "pseudo-id", n = irand(1e8, 999999999)), te(e, "_pseudo_" + n));
        var i = t + "-style-" + n,
            o = a(i),
            s = "._pseudo_" + n + ":" + t + "{";
    ...
    t.ge = a, t.geByTag = n, t.geByTag1 = i, t.geByClass = o, t.geByClass1 = s, t.gpeByClass = l, t.domQuery = c, t.domQuery1 = d, t.domClosest = p, t.domClosestByTag = u, t.gpeByTag = h, t.ce = f, t.re = g, t.se = _, t.sech = v, t.rs = y, t.psr = m, t.domReplaceEl = b, t.domEL = w, t.domNS = E, t.domPS = C, t.domFC = P, t.domLC = T, t.domPN = x, t.domChildren = O, t.domInsertBefore = S, t.domInsertAfter = k, t.domByClass = j, t.domData = A, t.domChildIndex = L, t.domCA = N, t.domClosestSibling = D, t.matchesSelector = I, t.isHover = R, t.isAncestor = M, t.getScroll = B, t.domClosestPositioned = H, t.domClosestOverflowHidden = U, t.show = F, t.hide = z, t.isVisible = W, t.clientHeight = K, t.getClientRectOffsetY = $, t.toggle = q, t.boundingRectEnabled = V, t.getXYRect = Q, t.getXY = X, t.isWindow = Y, t.getSize = G, t.getW = J, t.getH = Z, t.hasClass = ee, t.addClass = te, t.addClassDelayed = re, t.removeClass = ae, t.removeClassDelayed = ne, t.toggleClass = ie, t.toggleClassDelayed = oe, t.replaceClass = se, t.getStyle = le, t.setStyle = ce, t.setStyleDelayed = de, t.setPseudoStyle = pe, t.data = ue, t.attr = he, t.removeAttr = fe, t.removeData = ge, t.cleanElems = _e, t.setTitle = ve, t.getZoom = ye, t.val = me, t.elfocus = be, t.traverseParent = we, t.setDocumentTitle = Ee, t.lockDocumentTitle = Ce;
    var Te = r(4);
    ...
    var xe = !1;
    window.ge = a, window.geByTag = n, window.geByTag1 = i, window.geByClass = o, window.geByClass1 = s, window.gpeByClass = l, window.domQuery = c, window.domQuery1 = d, window.domClosest = p, window.ce = f, window.re = g, window.se = _, window.sech = v, window.rs = y, window.psr = m, window.domReplaceEl = b, window.domEL = w, window.domNS = E, window.domPS = C, window.domFC = P, window.domLC = T, window.domPN = x, window.domChildren = O, window.domInsertBefore = S, window.domInsertAfter = k, window.domByClass = j, window.domData = A, window.domChildIndex = L, window.domCA = N, window.domClosestSibling = D, window.matchesSelector = I, window.isHover = R, window.isAncestor = M, window.getScroll = B, window.domClosestPositioned = H, window.domClosestOverflowHidden = U, window.show = F, window.hide = z, window.isVisible = W, window.clientHeight = K, window.getClientRectOffsetY = $, window.toggle = q, window.boundingRectEnabled = V, window.getXYRect = Q, window.getXY = X, window.isWindow = Y, window.getSize = G, window.hasClass = ee, window.addClass = te, window.addClassDelayed = re, window.removeClass = ae, window.removeClassDelayed = ne, window.toggleClass = ie, window.toggleClassDelayed = oe, window.replaceClass = se, window.getStyle = le, window.setStyle = ce, window.setStyleDelayed = de, window.setPseudoStyle = pe, window.data = ue, window.attr = he, window.removeAttr = fe, window.removeData = ge, window.cleanElems = _e, window.setTitle = ve, window.getZoom = ye, window.val = me, window.elfocus = be, window.traverseParent = we, window.getH = Z, window.getW = J, window.domClosestByTag = u, window.setDocumentTitle = Ee, window.lockDocumentTitle = Ce
}, function(e, t) {
    "use strict";
    ...
    var a = function() {
        ...
        return e._saveChunk = function(e, t, r, a, n) {
            ...
            if (a.forEach(function(e) {
                    ...
                    }), h += t, h >= l && (p.push(u), h = t, u = []), u.push(e)
                }), u.length && p.push(u), p.length > 1) {
                var f = new callHub(function() {
                    e._saveFinally(t, r, n, i, o, c, s, p.length, !1, d)
                }, p.length);
            ...
            } else e._saveFinally(t, r, n, i, o, c, s, 0, a, d)
        }, e
    }();
    t["default"] = a
}, function(e, t, r) {
        ...
        A = function() {
            function e(t, r, a) {
                ...
                n(this, e), this._id = i(), cur.lang = cur.lang || {}, extend(cur.lang, o.lang), this._els = {
                    editor: ge(t),
                    canvas: se('<div class="article_editor_canvas article_edit article" contenteditable="true"></div>')
                ...
                s && 0 != s.length || (s = [(0, f.buildParagraph)({
                    ...
                    e.lines.forEach(function(e) {
                        e.text = (0, f.replaceParagraphEntities)(e.text), e.brs && isObject(e.brs) && (e.brs = (0, f.convertBRsToArray)(e.brs))
                    })
                }), o.needIndexCorrection && (0, f.correctRealIndexes)(s, 1), this.initParagraphs(s), this._updateTextPlaceholders(!0), this._restoreLastCursor(), this.saveDraft(!1, !0), o.coverPhoto && this.setCoverPhoto(o.coverPhoto, !1), (this._options.isPublished || this._options.wasPublished) && this.setPublishName(r.name), this._publishNameCandidate = o.name || this._getName()
            }
            return e.prototype._setEventListener = function(e, t, r) {
                ...
                if (!this._options.noTitle) {
                    if (this._els.canvas.children.length >= 2) {
                        ...
                        if (a) {
                            addClass(r, "article_ed__empty");
                            var n = replaceEntities(getLang("pages_article_title_placeholder"));
                            r.setAttribute("title", n)
                        } else removeClass(r, "article_ed__empty"), r.removeAttribute("title");
                        var i = this._els.canvas.children[1];
                        if (i) {
                            var o = !trim(i.innerHTML.replace("<br>", ""));
                            if (o) {
                                addClass(i, "article_ed__empty");
                                var s = replaceEntities(getLang("pages_article_text_placeholder"));
                                i.setAttribute("title", s)
                            } else removeClass(i, "article_ed__empty"), i.removeAttribute("title")
                        }
                    }
                                ...
                                switch (e[0]) {
                                    ...
                                    case "video":
                                        extend(a, {
                                            ...
                                            fromExtPage: intval(r.from_ext_page),
                                            _preparedData: {
                                                editable: r.editable,
                    ...
                    if ("uuid" == i && s) {
                        ...
                        if (l) {
                            ...
                            var d = this._getCurrentParagraphIndex(),
                                p = o(d, 1),
                                u = p[0];
                            domInsertAfter(c, this._getParagraphElByIndex(u)), e.preventDefault(), this._setAllParagraphsDirty(), this._triggerInputEvent()
                        }
                    }
                }
                ...
                for (var n = {
                    ...
                    var p = (0, f.isObjectParagraph)(this._ps[d]) ? this._ps[d]._object.getCaptionEl() : this._getParagraphElByIndex(d);
                    if (void 0 === l) {
                        var u = (0, f.getCaretCharacterOffsetWithin)(p),
                            h = o(u, 2);
                        l = h[0], c = h[1]
                    }
                    var _ = this._ps[d];
                        ...
                        C.forEach(function(r) {
                            ...
                            a && !(0, b.isEmpty)(a) && a.forEach(function(t) {
                                ...
                                if ("link" == r.type) l < a[1] && c > a[0] && (i[r.type] = 1, n.decorations[r.type] = !0);
                                    ...
                                    var d = l >= a[0] && l <= a[1],
                                        p = c >= a[0] && c <= a[1];
                                    d && p ? (i[r.type] = 2, n.decorations[r.type] = !0) : d && (e.text.length > a[1] ? i[r.type] = -1 : i[r.type] = 1)
                                }
                            })
                        }), s += e.text.length
                    })
                ...
                if (n) {
                    ...
                    var p = a.firstElementChild;
                    if ((0, f.isObjectParagraphEl)(p)) {
                        var u = p.getAttribute("data-type"),
                            h = p.getAttribute("data-media-id"),
                            _ = JSON.parse(p.getAttribute("data-data") || "{}");
                        u && h && (a = geByTag1("figure", p), o = u, s.mediaId = h, s._preparedData = _)
                    }
                    var v = {
                        text: "",
                        decorations: {},
                ...
                return e.lines.forEach(function(e) {
                    ...
                    d.forEach(function(t, r) {
                        if (t) {
                            ...
                            r > 0 && (a = (0, f.prepareLineText)(l, p, r, e.brs), n || u.push(a));
                            var i = 0;
                            n && (a && a.endsWith("<br/>") && (i++, a = a.replace(/<br\/>$/, "")), a && a.endsWith("<br/>") && (i++, a = a.replace(/<br\/>$/, "")), a !== !1 && u.push(a)), each(P, function(e, r) {
                                var a = t.close[r.type];
                                void 0 !== a && u.push("</" + r.tag + ">")
                            }), u.push("<br/>".repeat(i)), each(C, function(e, r) {
                                var a = t.open[r.type];
                                void 0 !== t.open[r.type] && (a === !0 ? u.push("<" + r.tag + ">") : u.push("<" + r.tag + ' href="' + clean(a) + '">'))
                            }), p = r
                        }
                    }), u.push((0, f.prepareLineText)(l, p, void 0, e.brs)), n && (i = i ? " " + i : "", r += "<" + n + i + ">"), (0, b.inArray)(o, [g.ParagraphType.Quote, g.ParagraphType.Quote2]) && (r += "<p>"), r += u.join("") || (t ? "" : "<br/>"), (0, b.inArray)(o, [g.ParagraphType.Quote, g.ParagraphType.Quote2]) && (r += "</p>"), n && (r += "</" + n + ">")
                }), [a, r]
                ...
                if (e.rangeCount) {
                    ...
                    var p = this._getContainingParagraphEl(i),
                        u = o(p, 2),
                        h = u[1];
                ...
                if (!this._markerCursorSet) {
                    ...
                    if (i != this._els.canvas) {
                        var d = this._getContainingParagraphEl(i)[1],
                            p = void 0;
                        e(i, s, f.CURSOR_MARKER_START), n || (p = this._getContainingParagraphEl(l)[1], p == d && l.textContent.includes(f.CURSOR_MARKER_START) && (c += 1), e(l, c, f.CURSOR_MARKER_END)), this._markerCursorSet = !0
                    }
                }
                ...
                return t ? void(this._lastSavedDraft = n) : this._lastSavedDraft != n || e ? (this._options.onDraftNotSaved && this._options.onDraftNotSaved(), void(this._draftSaveTO = setTimeout(function() {
                    if (a._lastSavedDraft = n, 0 != a._ps.length) {
                ...
                void 0 === o && e && (o = this.getFirstCoverPhotoFromParagraphs()), m["default"].save(this.getArticleOwnerId(), this.getArticleId(), n, e, i, o ? o.id : "", this._getSaveDraftHash(), this._options.limits.maxSymbolsPerChunk, r, function(r, n, o, s, l) {
                    ...
                    })), a._publishNameCandidate = i, e && (a._options.isPublished = !0), a._replaceVideos(l)), t && t(r, n, o, s)
                })
                    ...
                    t._ps.forEach(function(e, a) {
                        if (e.type == g.ParagraphType.ObjectVideo) {
                            var c = e.mediaId.split("_"),
                                ...
                                u = d[1],
                                h = d[2];
                            h || p != n || u != i || (e.mediaId = s + "_" + l, t._setParagraphDirty(a), r = !0)
                        }
                    })
                }), r && this._redrawModel()
                ...
                (0, f.focusEl)(this._getParagraphElByIndex(this._ps.length - 1))
                ...
                showBox("al_video.php", {
                    ...
                    e._getOrCreateParagraphObject(u), 0 == s ? e._ps[a] = u : e._ps.splice(a + s, 0, u), e._redrawModel(), e._saveUndoState();
                ...
                var e = this,
                    ...
                    i = void 0;
                cur.onMediaUploadStarted = function() {
                    var t = (0, f.buildParagraph)({
                            type: g.ParagraphType.ObjectPhoto
                        }),
                        r = e._renderObjectParagraph(t, ""),
                        n = e._getParagraphElByIndex(a);
                    domInsertBefore(r, n), (0, f.focusEl)(n), i = r
                ...
                this._els.canvas.addEventListener("input", function() {
                    ...
                    var n = void 0;
                    e._fromPasteEvent || t || e._markerCursorSet || browser.safari ? e._saveCursorMarker() : n = e._getCursor(), e._processAlienPhotos(), e._flattenAlienParagraphs(), e._cloneObjectParagraphs(), e._ps.length > 0 && e._els.canvas.children.length !== e._ps.length && e._setAllParagraphsDirty(), e._dirty.forEach(e._updateLineData.bind(e)), i && (e._cleanParagraphsBRs(), i = !1), e._ensureAtLeastOneParagraph(), e._ensureTitleParagraph();
                ...
                this._els.canvas.addEventListener("keydown", function(n) {
                    var p = n.keyCode,
                        ...
                        P = C[0],
                        T = C[1];
                    if (n.keyCode == E.Tab && y && 0 == P) return (0, f.focusEl)(e._getParagraphElByIndex(1)), cancelEvent(n);
                    var x = n.metaKey || n.ctrlKey;
                    if (x) switch (n.keyCode) {
                        case E.KeyB:
                    ...
                    if (p == E.Backspace) {
                        ...
                        var S = e._getParagraph(P),
                            k = !1;
                        if ((0, f.isObjectParagraph)(S))
                            if (S._object.isCaptionFocused()) k = 0 == v.startOffset && y;
                            else {
                                var j = e._getContainingParagraphEl(v.startContainer),
                                    A = o(j, 1),
                                    L = A[0];
                                k = L == S._object.el()
                            }
                        if (k) {
                            if (S._object.isCaptionFocused()) {
                                var N = e._getParagraphElByIndex(P),
                                    D = (0, f.createParagraphEl)();
                                return domReplaceEl(N, D), (0, f.focusEl)(D), e._setAllParagraphsDirty(), e._triggerInputEvent(), cancelEvent(n)
                            }
                            var I = e._getParagraphElByIndex(P),
                                R = (0, f.createParagraphEl)();
                            return domReplaceEl(I, R), (0, f.focusEl)(R), e._setAllParagraphsDirty(), e._triggerInputEvent(), cancelEvent(n)
                        }
                        if (v && 0 == v.startOffset && v.collapsed) {
                            var M = (0, w.gpeByTag)("li", v.startContainer),
                                B = (0, f.getElementIndex)(M);
                            if (M) {
                                var H = e._ps[P],
                                    U = clone(H),
                                    F = clone(H);
                                U.lines = U.lines.slice(0, B);
                                var z = (0, f.buildParagraph)({
                                    lines: [clone(H.lines[B])]
                                });
                                F.lines = F.lines.slice(B + 1), e._ps.splice(P, 1, U, z, F), e._redraw(!0);
                                var W = e._getParagraphElByIndex(P + 1);
                                return (0, f.focusEl)(W), cancelEvent(n)
                            }
                        }
                        if (v && 0 == v.startOffset) {
                            var K = e._getCurrentParagraphIndex(),
                                $ = o(K, 1),
                                q = $[0],
                                V = q > 0 ? e._ps[q - 1] : !1;
                            if ((0, f.isObjectParagraph)(V)) return
                        }
                    ...
                    if (p == E.Delete) {
                        var Q = e._ps[P],
                            X = e._ps[P + 1],
                            Y = !1;
                        if ((0, f.isObjectParagraph)(Q) && v && y && (Y = !Q._object.isCaptionFocused() && v.startContainer == Q._object.el(), Y = Y || Q._object.isCaptionFocused() && Q._object.isEmptyCaption()), Y) {
                            var G = e._getParagraphElByIndex(P),
                                J = (0, f.createParagraphEl)();
                            return domReplaceEl(G, J), (0, f.focusEl)(J), e._setAllParagraphsDirty(), e._triggerInputEvent(), cancelEvent(n)
                        }
                        X && (0, f.isParagraphEmpty)(Q) && (0, b.inArray)(X.type, [g.ParagraphType.Header2, g.ParagraphType.Header3]) && (Q.type = X.type, e._setParagraphDirty(P), e._redraw()), e._setAllParagraphsDirty()
                    } else if (p == E.Enter) {
                        if (e._isWithinObjectParagraphEl((0, f.getFocusedElement)())) {
                            var Z = e._getContainingParagraphEl((0, f.getFocusedElement)()),
                                ee = o(Z, 2),
                                te = ee[0],
                                re = ee[1],
                                ae = (0, f.createParagraphEl)();
                            return e._ps[re]._object.isCaptionFocused() ? domInsertAfter(ae, te) : domInsertBefore(ae, te), e._setAllParagraphsDirty(), (0, f.focusEl)(ae), e._triggerInputEvent(), cancelEvent(n)
                        }
                        var ne = e._getContainingParagraphEl((0, f.getFocusedElement)()),
                            ie = o(ne, 3),
                            oe = ie[0],
                            le = ie[1],
                            ce = ie[2],
                            ...
                            ue = pe[0],
                            he = pe[1],
                            fe = (0, f.getCaretCharacterOffsetWithin)(oe),
                            ge = o(fe, 2),
                            _e = ge[1];
                        if (n.shiftKey) {
                            var ve = (0, f.getCaretCharacterOffsetWithin)(oe),
                                ye = o(ve, 2),
                                me = ye[1],
                                be = domClosestByTag("li", ue.startContainer),
                                we = 0;
                            be && (we = domChildIndex(be));
                            var Ee = !1;
                            if (each(ce.lines, function(e, t) {
                                    var r = t.brs,
                                        a = t.text,
                                        n = a.length;
                                    return 0 == me || n >= me && (0, b.inArray)(me, r) ? (Ee = !0, !1) : (me -= n, 0 >= me && e == we ? !1 : void 0)
                                }), Ee) {
                                i = !0, e._setParagraphDirty(P, T), document.execCommand("insertParagraph");
                                var Ce = domNS(oe);
                                return Ce && ((0, f.focusEl)(Ce), Ce.focus()), e._triggerInputEvent(), cancelEvent(n)
                            }
                            browser.msie && 0 == me && ue.insertNode(se("<br>"))
                        }
                        var Pe = he && ue.startContainer.nodeType == Node.TEXT_NODE && !ue.startContainer.nextSibling && _e == oe.textContent.length;
                        l = Pe && !(0, f.isListParagraph)(e._ps[P]) && !n.shiftKey && (0, b.inArray)(ce.type, [g.ParagraphType.Quote, g.ParagraphType.Quote2]), window.browser && window.browser.msie && setTimeout(e._triggerInputEvent.bind(e)), l || n.shiftKey || e._parseUrlParagraph(le), e._setParagraphDirty(P, T)
                    } else n.key && 1 == n.key.length ? (e._setParagraphDirty(P), e._setParagraphDirty(T), n.metaKey || (O = !0, n.key && ((0, f.isCyrillicChar)(n.key) ? c += 1 : (0, f.isLatinChar)(n.key) && (c -= 1), c = Math.min(Math.max(c, -5), 5))), r = (0, f.isWhiteSpaceChar)(n.key), t && !r && (a = !0), t = O, setTimeout(function() {
                        function t(e, t, r, a, n) {
                            var i = this._getCursor(),
                                o = t.textContent.substring(0, e - r.length),
                                l = t.textContent.substring(e);
                            n || (s = [t, o + r + l, i]), t.textContent = o + a + l, this._restoreCursor(i), this._setParagraphDirty(P), this._triggerInputEvent()
                        }
                        d = d || c > 0;
                        var r = window.getSelection();
                        if (r.isCollapsed && r.rangeCount) {
                            ...
                            if (n.nodeType == Node.TEXT_NODE && a.startOffset > 0)
                                for (var i = n.textContent.substring(a.startOffset - 5, a.startOffset), o = 0, l = h.Sequences.length; l > o; o++) {
                                    var p = h.Sequences[o];
                                    if (void 0 === p.cyrillic || p.cyrillic === d)
                                        if (p.pattern instanceof RegExp) {
                                            var u = i.match(p.pattern);
                                            if (u) {
                                                var f = p.substitution;
                                                u.length > 1 && (f = f.replace("$1", u[1])), t.call(e, a.startOffset, n, u[0], f, p.noUndo);
                                                break
                                            }
                                        } else if (i.endsWith(p.pattern)) {
                                        t.call(e, a.startOffset, n, p.pattern, p.substitution, p.noUndo);
                                        break
                                    }
                                }
                        }
            ...
            case g.ParagraphType.ObjectPhoto:
                if (e) {
                    var n = geByTag1("img", r),
                        ...
                        o = (0, g.getAppropriateImage)(i, getW(n), !0),
                        s = f(o, 1),
                        l = s[0],
                        c = new Image;
                    c.onload = function() {
    ...
    function d(e) {
        if (!m.noImageOpen) {
            var t = geByTag1("img", e),
                ...
                a = (0, g.getAppropriateImage)(r, window.innerWidth, !0),
                n = f(a, 3),
                i = n[0],
                o = n[1],
                s = n[2],
            ...
            i && c && (addClass(t, "article_image_full_viewable"), t.addEventListener("click", function() {
                ...
                }), n.addEventListener("mousewheel", p), w = n;
                var s = new Image;
                s.onload = function() {
    ...
    var g = r(19),
        ...
        P = void 0,
        T = void 0;
    window.initArticle = a, window.deinitArticle = i, window.updateArticle = n, window.articleCloseImageFullSize = p
}, function(e, t) {
    "use strict";
    ...
    Object.defineProperty(t, "__esModule", {
        value: !0
    }), t.getAppropriateImage = n, t.ParagraphType = {
        Text: 1,
        Header1: 2,
        Header2: 3,
        Header3: 4,
            ...
            return o(t, e), t.prototype.render = function() {
                ...
                if (e && (e.editable || e.thumb)) {
                    ...
                    if (e.thumb) a = e.thumb;
                        ...
                        var n = (0, c.getAppropriateImage)(e.editable.sizes, this.getEditor().getWidth(!0));
                        a = n[0]
                    }
                    setStyle(this._el, {
                        width: t,
