                ...
                if (!this._formatTooltip) {
                    ...
                    this._formatTooltip = new ElementTooltip(this._els.editor, {
                        ...
                        onShow: function() {
                            ...
                            if (i || (e.justHeaders || a.push(["strong", "cur.articleEditor.setStrong()", !!e.decorations.strong]), e.quote || e.justHeaders || a.push(["em", "cur.articleEditor.setEm()", !!e.decorations.em]), a.push(["strike", "cur.articleEditor.setStrike()", !!e.decorations.strike]), e.decorations.link ? a.push(["link", "cur.articleEditor.clearLink()", e.decorations.link]) : a.push(["link", "cur.articleEditor.setLinkMode(true)", e.decorations.link]),
                                    e.object || e.header1 || e.list || (a.push(["header1", "cur.articleEditor.setHeader1(" + intval(e.header2) + ")", e.header2]), a.push(["header2", "cur.articleEditor.setHeader2(" + intval(e.header3) + ")", e.header3]), a.push(["quote", "cur.articleEditor.setQuote()", e.quote]))), 0 == a.length) return void t._formatTooltip.hide();
                ...
                this._els.canvas.addEventListener("keydown", function(i) {
                    ...
                    if (u == E.Backspace) {
                        ...
                        if (S) {
                            if (O._object.isCaptionFocused()) {
                                ...
                                return domReplaceEl(L, N), (0, f.focusEl)(N), e._setAllParagraphsDirty(), e._triggerInputEvent(), cancelEvent(i)
                            }
                            var D = e._getParagraphElByIndex(C),
                                I = (0, f.createParagraphEl)();
                            return domReplaceEl(D, I), (0, f.focusEl)(I), e._setAllParagraphsDirty(), e._triggerInputEvent(), cancelEvent(i)
                        }
                    ...
                    if (u == E.Delete) {
                        ...
                        if ((0, f.isObjectParagraph)(U) && v && y && (z = !U._object.isCaptionFocused() && v.startContainer == U._object.el(), z = z || U._object.isCaptionFocused() && U._object.isEmptyCaption()), z) {
                            ...
                            return domReplaceEl(W, K), (0, f.focusEl)(K), e._setAllParagraphsDirty(), e._triggerInputEvent(), cancelEvent(i)
                        }
                        ...
                        if (e._isWithinObjectParagraphEl((0, f.getFocusedElement)())) {
                            ...
                            return e._ps[Q]._object.isCaptionFocused() ? domInsertAfter(X, V) : domInsertBefore(X, V), e._setAllParagraphsDirty(), (0, f.focusEl)(X), e._triggerInputEvent(), cancelEvent(i)
                        }
                        var Y = e._getContainingParagraphEl((0, f.getFocusedElement)()),
                            ...
                            ae = re[0],
                            ie = re[1],
                            ne = (0, f.getCaretCharacterOffsetWithin)(J),
                            oe = o(ne, 2),
                            le = oe[1];
                        if (i.shiftKey) {
                            ...
                            if (each(ee.lines, function(e, t) {
                                    var r = t.brs,
                                        a = t.text,
                                        i = a.length;
                                    return 0 == ue || i >= ue && (0, b.inArray)(ue, r) ? (fe = !0, !1) : (ue -= i, 0 >= ue && e == he ? !1 : void 0)
                                }), fe) {
                                n = !0, e._setParagraphDirty(C, P), document.execCommand("insertParagraph");
                                var ge = domNS(J);
                                return ge && ((0, f.focusEl)(ge), ge.focus()), e._triggerInputEvent(), cancelEvent(i)
                            }
                            browser.msie && 0 == ue && ae.insertNode(se("<br>"))
                        }
                        var _e = ie && ae.startContainer.nodeType == Node.TEXT_NODE && !ae.startContainer.nextSibling && le == J.textContent.length;
                        l = _e && !(0, f.isListParagraph)(e._ps[C]) && !i.shiftKey && (0, b.inArray)(ee.type, [g.ParagraphType.Quote, g.ParagraphType.Quote2]), window.browser && window.browser.msie && setTimeout(e._triggerInputEvent.bind(e)), l || i.shiftKey || e._parseUrlParagraph(Z), e._setParagraphDirty(C, P)
                    } else i.key && 1 == i.key.length ? (e._setParagraphDirty(C), e._setParagraphDirty(P), i.metaKey || (x = !0, i.key && ((0, f.isCyrillicChar)(i.key) ? c += 1 : (0, f.isLatinChar)(i.key) && (c -= 1), c = Math.min(Math.max(c, -5), 5))), r = (0, f.isWhiteSpaceChar)(i.key), t && !r && (a = !0), t = x, setTimeout(function() {
