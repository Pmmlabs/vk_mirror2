        ...
        var a = function() {
            ...
            return e._saveChunk = function(e, t, r, a, i) {
                ...
                l = l ? JSON.stringify(l) : "", ajax.post("al_articles.php", extend({
                    ...
                    chunks_count: s,
                    Article_text: l,
                    debug: JSON.stringify(cur.articleEditor._ps).substr(0, 100),
                    hash: o
                }, n || {}), {
                    onDone: c,
                    onFail: function(e) {
                    ...
                    this._els.canvas.addEventListener("keydown", function(i) {
                        ...
                        if (u == E.Delete) {
                            ...
                            var Y = e._getContainingParagraphEl((0, f.getFocusedElement)()),
                                ...
                                ae = re[0],
                                ie = re[1],
                                ne = (0, f.getCaretCharacterOffsetWithin)(G),
                                oe = o(ne, 2),
                                le = oe[1];
                            if (i.shiftKey) {
                                var ce = (0, f.getCaretCharacterOffsetWithin)(G),
                                    de = o(ce, 2),
                                    ue = de[1],
                            ...
                            var _e = ie && ae.startContainer.nodeType == Node.TEXT_NODE && !ae.startContainer.nextSibling && le == G.textContent.length;
    ...
    84: function(e, t, r) {
        ...
        function $(e, t, r) {
            ...
            var i = X(e)[1],
                ...
                u = vk.staticheader ? Math.max(0, J(c)[1] - d) : J(c)[1];
            if (t) {
