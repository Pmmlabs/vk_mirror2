        ...
        A = function() {
            ...
            return e.prototype._setEventListener = function(e, t, r) {
                ...
                return this._els.canvas.addEventListener("dragenter", this._dragEnterEventsHandler = function(e) {
                    ...
                    var a = e.target;
                    t._isParagraphEl(a) && (domInsertAfter(r, a),
                        removeClass(a, "article_ed__drag_drop")), t.onDragEnd(), t._setAllParagraphsDirty(), t._triggerInputEvent(), setTimeout(function() {
