                ...
                if (!this.isLocked()) {
                    ...
                    this._els.canvas.addEventListener("keydown", function(t) {
                        ...
                        if (w) {
                            ...
                            } else t.key && 1 == t.key.length ? (e._setParagraphDirty(T),
                                e._setParagraphDirty(j), t.metaKey || (K = !0, t.key && (Object(l.isCyrillicChar)(t.key) ? p += 1 : Object(l.isLatinChar)(t.key) && (p -= 1), p = Math.min(Math.max(p, -5), 5))), n = Object(l.isWhiteSpaceChar)(t.key), r && !n && (i = !0), r = K, setTimeout(function() {
