! function(e) {
    ...
    function u(e, t, r, a) {
        if (e = e.substring(t, r), a && a.length) {
            ...
            return a.forEach(function(r) {
                r -= t, 0 >= r || r > e.length || (n.push(m(e.substring(i, r) + "<br/>")), i = r)
            }), n.push(m(e.substring(i))), "" == n[n.length - 1], n.join("")
        }
        return m(e)
    }
    ...
    function g(e) {
        var t = void 0;
        return t = isObject(e) ? e.type : e, inArray(t, [K.ParagraphType.Header1, K.ParagraphType.Header2, K.ParagraphType.Header3])
    }

    function _(e) {
        return e && (e.type == K.ParagraphType.NumericList || e.type == K.ParagraphType.BulletList)
    }
    ...
    function v(e) {
        ...
        return f(e) && (t._uuid = e._uuid), t.lines = e.lines || [{
            ...
            decorations: {},
            brs: []
        }], t.type = e.type ? parseInt(e.type) : K.ParagraphType.Text, e._preparedData && (t._preparedData = e._preparedData), e.mediaId && (t.mediaId = e.mediaId), t
    }
    ...
    function m(e) {
        return -1 != e.search(/^\s/) && (e = " " + e.trimLeft()), -1 != e.search(/\s$/) && (e = e.trimRight() + V), e
    }
    ...
    function j(e) {
        if (e.hasAttribute(Y)) {
            for (var t = e.getAttribute(Y); e = e.previousSibling;)
                if (e.hasAttribute(Y) && t == e.getAttribute(Y)) return !1;
            return !0
        }
        return !1
    }
    ...
    function L(e, t, r) {
        ...
        if ("object" === ("undefined" == typeof e ? "undefined" : Q(e)) && "img" === e.tagName.toLowerCase() && (n = e.src), "string" == typeof e && (n = e), /^data:/.test(n) && !t.convert) return void r(null, N(n));
        var i = {
            png: "image/png",
            jpg: "image/jpeg",
            jpeg: "image/jpeg",
        ...
        return t.type = i[t.type] || a(n), t.src = n, t.callback = r, t.name = n, t.type ? void R(n, I.bind(null, t)) : void r(new Error("Image type is not supported"))
    }
    ...
    function B(e) {
        return e.replace(/\s/g, "").replace(G, "").replace(J, "")
    }

    function U(e) {
        return e = trim(e), 1 == e.length && e[0] == G
    }
    ...
    t.isQuoteEl = a, t.paragraphElProperties = n, t.deb = i, t.isParagraphEl = o, t.getCorrectedRange = s, t.selectEl = l, t.focusEl = c, t.getCaretCharacterOffsetWithin = d, t.prepareLineText = u, t.getElementIndex = p, t.isObjectParagraphEl = h, t.isObjectParagraph = f, t.isHeaderParagraph = g, t.isListParagraph = _, t.buildParagraph = v, t.getRange = y, t.prepareSpacesWithSpaces = m, t.cleanTextSpaces = b, t.getLineEl = w, t.mergeRanges = E, t.isWhiteSpaceChar = C, t.isCyrillicChar = P, t.isLatinChar = T, t.isAlienParagraphEl = O, t.getFocusedElement = x, t.isTrackedParagraphEl = j, t.getPhotoSize = S, t.childNodeIndex = k, t.getAbsoluteCursorPosition = A, t.generateLatinizedName = D, t.dataURItoBlob = N, t.imageToBlob = L, t.queuePhotoProcess = H, t.cleanWhiteSpaces = B, t.justCursorInString = U, t.arrayUnique = F, t.arrayClear3Repetitions = z, t.createParagraphEl = W, t.traverseTree = $, t.throttle = q;
    var K = r(12),
        V = t.NBSP = "&nbsp;",
        Y = t.DATA_ATTR_TRACKED = "data-t",
        G = t.CURSOR_MARKER_START = "​",
        J = t.CURSOR_MARKER_END = "‌",
        Z = t.ArticleEditorParagraphClass = "_article_p",
        ee = /[\u0400-\u04FF]/,
        te = {
            1072: "a",
            1073: "b",
        ...
        S = function() {
            ...
            return e.prototype._setEventListener = function(e, t, r) {
                ...
                if (!this._options.noTitle) {
                    ...
                    r ? (addClass(a, "article_ed__empty"), a.setAttribute("title", getLang("pages_article_title_placeholder"))) : (removeClass(a, "article_ed__empty"), a.removeAttribute("title"));
                    var n = this._isParagraphEmpty(this._getParagraph(1)) && this._ps.length < 3,
                        i = this._els.canvas.children[1];
                    i && (n ? (addClass(i, "article_ed__empty"), i.setAttribute("title", getLang("pages_article_text_placeholder"))) : (removeClass(i, "article_ed__empty"), i.removeAttribute("title"))), e && this._els.canvas.addEventListener("input", function() {
                ...
                this._setAllParagraphsDirty(), document.execCommand("italic"),
                    browser.msie && this._triggerInputEvent()
                    ...
                    e.nodeType == Node.TEXT_NODE ? t.text += (0, _.cleanTextSpaces)(clean(e.data)) : "BR" == e.nodeName && t.text.length > 0 && t.brs.push(t.text.length), each(e.childNodes, function(e, a) {
                        ...
                        switch (i) {
                            ...
                            case "del":
                                ...
                                break;
                            case "a":
                                o = P.link, n.push(a.getAttribute("href") || "")
                        }
                        o && (t.decorations[o.type] = t.decorations[o.type] || [], n[0] < n[1] && t.decorations[o.type].push(n), t.decorations[o.type] = (0, _.mergeRanges)(t.decorations[o.type]))
                    })
                }
                ...
                return e.lines.forEach(function(e) {
                    ...
                    d.forEach(function(t, r) {
                        if (t) {
                            ...
                            r > 0 && (a = (0, _.prepareLineText)(l, u, r, e.brs), n || p.push(a));
                            var i = 0;
                            n && (a && a.endsWith("<br/>") && (i++, a = a.replace(/<br\/>$/, "")), a && a.endsWith("<br/>") && (i++, a = a.replace(/<br\/>$/, "")), a !== !1 && p.push(a)), each(E, function(e, r) {
                                var a = t.close[r.type];
                                void 0 !== a && p.push("</" + r.tag + ">")
                            }), p.push("<br/>".repeat(i)), each(w, function(e, r) {
                                var a = t.open[r.type];
                ...
                }), cur.chooseMedia = function(t, r, n) {
                    curBox().hide();
                ...
                this._setEventListener(window, "scroll", function() {
                    ...
                    var s = e._getCurrentParagraphIndex(),
                        l = o(s, 1),
                        c = l[0];
                    c !== !1 && (e._highlightObjectsInCurrentSelection(), e._showObjectPicker(), e._correctCaptionSelection(), e._ensureDummyParagraphs(), 0 == n && e._showFormatTooltip(), e._lastCursor = e._getCursor(), e._saveLastCursor())
                });
                var t = !1,
                    r = !1,
                    a = !1,
                ...
                this._els.canvas.addEventListener("keydown", function(n) {
                    var c = n.keyCode,
                        ...
                        w = m[0],
                        E = m[1];
                    if (n.keyCode == b.Tab && h && 0 == w) return (0, _.focusEl)(e._getParagraphElByIndex(1)), cancelEvent(n);
                    ...
                    var C = !1;
                    if (c == b.Backspace) {
                        if (i) return i[0].textContent = i[1], e._restoreCursor(i[2]), i = !1, cancelEvent(n);
                        ...
                        if (T) {
                            if (!P._object.isCaptionFocused()) {
                                ...
                                return domReplaceEl(S, k), (0, _.focusEl)(k), e._setAllParagraphsDirty(), e._triggerInputEvent(), cancelEvent(n)
                            }
                    ...
                    if (c == b.Delete) {
                        ...
                        if ((0, _.isObjectParagraph)(M) && p && h && (B = !M._object.isCaptionFocused() && p.startContainer == M._object.el(), B = B || M._object.isCaptionFocused() && M._object.isEmptyCaption()), B) {
                            ...
                            return domReplaceEl(U, F), (0, _.focusEl)(F), e._setAllParagraphsDirty(), e._triggerInputEvent(), cancelEvent(n)
                        }
                        ...
                        if (e._isWithinObjectParagraphEl((0, _.getFocusedElement)())) {
                            ...
                            return e._ps[q]._object.isCaptionFocused() ? domInsertAfter(Q, $) : domInsertBefore(Q, $), e._setAllParagraphsDirty(), (0, _.focusEl)(Q), e._triggerInputEvent(), cancelEvent(n)
                        }
                        var X = e._getContainingParagraphEl((0, _.getFocusedElement)()),
                            ...
                            ae = o(re, 2),
                            ne = (ae[0], ae[1]),
                            ie = te && ee.startContainer.nodeType == Node.TEXT_NODE && !ee.startContainer.nextSibling && ne == V.textContent.length;
                        s = ie && !(0, _.isListParagraph)(e._ps[w]) && !n.shiftKey && (0, y.inArray)(G.type, [v.ParagraphType.Quote, v.ParagraphType.Quote2]), window.browser && window.browser.msie && setTimeout(e._triggerInputEvent.bind(e)), s || n.shiftKey || e._parseUrlParagraph(Y), e._setParagraphDirty(w, E)
                    } else n.key && 1 == n.key.length ? (e._setParagraphDirty(w), e._setParagraphDirty(E), n.metaKey || (C = !0, n.key && ((0, _.isCyrillicChar)(n.key) ? l += 1 : (0, _.isLatinChar)(n.key) && (l -= 1), l = Math.min(Math.max(l, -5), 5))), r = (0, _.isWhiteSpaceChar)(n.key), t && !r && (a = !0), t = C, setTimeout(function() {
                        function t(e, t, r, a, n) {
                            var o = this._getCursor(),
                                s = t.textContent.substring(0, e - r.length),
                                l = t.textContent.substring(e);
                            n || (i = [t, s + r + l, o]), t.textContent = s + a + l, this._restoreCursor(o), this._setParagraphDirty(w), this._triggerInputEvent()
                        }
                        var r = l > 0,
                        ...
                        if (a.isCollapsed && a.rangeCount) {
                            ...
                            if (o.nodeType == Node.TEXT_NODE && n.startOffset > 0)
                                for (var s = o.textContent.substring(n.startOffset - 5, n.startOffset), c = 0, d = g.Sequences.length; d > c; c++) {
                                    var u = g.Sequences[c];
                                    if (void 0 === u.cyrillic || u.cyrillic === r)
                                        if (u.pattern instanceof RegExp) {
                                            ...
                                            if (p) {
                                                ...
                                                p.length > 1 && (h = h.replace("$1", p[1])), t.call(e, n.startOffset, o, p[0], h, u.noUndo);
                                                break
                                            }
                                        } else if (s.endsWith(u.pattern)) {
                                        t.call(e, n.startOffset, o, u.pattern, u.substitution, u.noUndo);
                                        break
                                    }
                                }
                        }
