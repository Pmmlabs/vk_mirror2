! function(e) {
        ...
        window.curFastChat || (window.curFastChat = {}), window.FastChat = {
            ...
            send: function(e, t, n) {
                ...
                d.media = d.media.join(","), r.sending = !0, Emoji.ttHide(r.emojiId), curFastChat.tabs[e].entrypoint = !1, ajax.post("al_im.php", d, {
                    onDone: function(t) {
                        clearTimeout(r.saveDraftTO),
                            FastChat.saveDraft(e), FastChat.sendOnResponse(t, u, r)
                    },
                    onFail: function(t) {
    ...
    188: function(e, t, n) {
        ...
        n.r(t);
        n(114), n(7), n(53), n(220), n(166), n(35), n(98);
    ...
    220: function(__webpack_module__, __webpack_exports__, __webpack_require__) {
        "use strict";
        __webpack_require__.r(__webpack_exports__);
        var _helpers_im_shared_helpers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(12),
            _longpoll_singleton__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(228),
        ...
        window.curNotifier || (window.curNotifier = {
            ...
            showEvent: function showEvent(ev, force) {
                ev.custom && ev.custom.ttl && Object(_helpers_im_shared_helpers__WEBPACK_IMPORTED_MODULE_0__.confirmDelivery)(ev.custom.id),
    ...
    8: function(e, t, n) {
        ...
        var Mt = n(37),
            ...
            wn = u(function(e, t) {
                return e.kludges.source_act === qt.CHAT_PHOTO_REMOVE ? (delete t.tabs[e.peerId].photo,
                    delete t.tabs[e.peerId].photoLarge, Promise.resolve(t)) : Object(Mt.post)(Mt.CONTROLLER, {
    ...
    98: function(__webpack_module__, __webpack_exports__, __webpack_require__) {
        "use strict";
