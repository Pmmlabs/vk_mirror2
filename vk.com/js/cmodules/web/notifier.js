! function(e) {
    ...
    function j(e, t) {
        e = a(e);
        for (var i, r, n, o, s = e; s && s.tagName && s !== bodyNode && (i = ce(s, "position"), r = ce(s, "overflow"), n = ce(s, "transform"), !t || !browser.mozilla || "page_wrap" == s.id || s === e || "visible" === r || ("static" === i ? o && "relative" !== o : "fixed" === o));) "none" !== n ? o = void 0 : "static" !== i && "fixed" !== o && (o = i),
            s = F(s);
        return s
    }
    ...
    "use strict";
    var _im_shared_helpers = __webpack_require__(2),
        _longpoll_singleton = __webpack_require__(31),
    ...
    i(26), i(5), i(10), i(12), i(19), i(17), i(27), window.getWndInner = a, window.lastWndScroll = [!1, !1], window.updateWndVScroll = r, window.defBox = n;
    try {
    ...
    function ne(e, t, i, a, n, o) {
        ...
        if (c.length > o + 1) h += " " + Fi("mail_and_peer").replace("{count}", e.totalCount - o).replace("{typing}", d);
        else {
    ...
    function M(e, t) {
        ...
        if ((0, Gt.isTabLoaded)(t, a)) {
            ...
            return n.lastmsg = e.messageId, n.lastmsg_meta = e, g(e.peerId, t), x(t, n, !1, A.bind(null, a), at.bind(null, t)), Promise.resolve(t)
        }
    ...
    function U(e, t) {
        return (0, zt.pause)(ei + 2).then(function() {
            if ((0, Gt.isTabLoaded)(t, e)) {
                var i = t.tabs[e];
                if (i.typing) {
                    var a = Date.now() - 1e3 * i.typing.ts;
                    a >= 1e3 * ei && (i.typing = void 0)
                }
            }
            return t
        })
