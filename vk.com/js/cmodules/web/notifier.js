! function(e) {
    ...
    "use strict";
    n.r(t);
    n(4), n(29), n(33), n(24), n(13), n(36), n(12);
    ...
    window.curFastChat || (window.curFastChat = {}), window.FastChat = {
        ...
        updateChatInfo: function(e, t) {
            ...
            n && n.title && (n.name = o, n.title.innerHTML = o + u), c.classList.add("chat_tab_img"), a ? c.innerHTML = '<div class="chat_tab_grid">' + a + "</div>" : i && (c.id = "im_dialog_ph" + (e - 2e9), c.src = i), s.parentNode.replaceChild(c, s)
        },
                ...
                switch (e.type) {
                    ...
                    case "mail":
                        i += rs(curFastChat.tpl.msg_fwd, {
                            ...
                            label: getLang(e.object.fwd_count > 1 ? "mail_im_fwd_msgs" : "mail_im_fwd_msg")
                        });
                        break;
                    default:
                        i += rs(vk.pr_tpl, {
