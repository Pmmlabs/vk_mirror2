! function(e) {
    ...
    "use strict";
    var r = i(50);
    e.exports = i(115)("Map", function(e) {
        return function() {
    ...
    function o(e) {
        if (!e.renew_hashes) {
            ...
            e.renew_hashes = (0, At.post)(At.CONTROLLER, {
                act: "a_renew_hash",
                peers: i.join(","),
                gid: e.gid
            }).then(function(t) {
    ...
    function p(e, t, i, r, a) {
        return a.tabHistoryNotChanged = !1, (0, jt.retryFn)(At.post, 3, function(e) {
            return e - 1
        })(At.CONTROLLER, {
            act: "a_start",
            peer: e,
            ...
            if (o.forEach(function(e) {
                ...
                }), a.tabs || (a.tabs = {}), a.dialog_tab_cts = u, a.tabs[e] || (a.tabs[e] = (0, Ut.normalizeTab)(a, n)), h(c, a), i) {
                if (a.tabs[e]) {
    ...
    function m(e, t, i) {
        ...
        return i.imQueueSet(e, r), i.tabs[e].history = (0, Ut.removeMessages)([t], u(i.tabs[e].history)), Promise.resolve(i)
    }

    function g(e, t) {
        return (t.block_states[e] || {}).free === !1 ? Promise.resolve(t) : (0, At.post)(At.CONTROLLER, {
            act: "a_block",
            peer: e,
            prevPeer: t.prevPeer,
            gid: t.gid
    ...
    function v(e, t) {
        ...
        return Promise.resolve(t).then(function(t) {
            return t.tabHistoryNotChanged = !1, (0, Ut.isFullyLoadedTab)(t, i) && !t.tabs[i].msgid ? (t.gid && g(i, t), Promise.resolve(t).then(N)) : ((0, Ut.isFullyLoadedTab)(t, i) && (t.tabs[i].msgid = !1), p(i, e, !1, !0, t))
    ...
    function C(e, t, i) {
        var r = i.msgid,
            a = i.peer;
        return !e && (0, Ut.isFullyLoadedTab)(i, a) && i.tabs[a].msgs[r] ? (t === i.peer ? i.tabHistoryNotChanged = !0 : i.tabHistoryNotChanged = !1, i.gid && g(a, i), Promise.resolve(i).then(N).then(b.bind(null, a))) : p(a, !0, r, !0, i).then(N).then(function() {
            var e = (0, Gt.getTab)(i, a);
            return e.msgid = r, i
        }).then(b.bind(null, a))
    }

    function y(e, t, i) {
        if (Ye(i)) throw (0, Ut.showWaitUntilUploadedBox)(), new Error("Cant change peer while loading somethind");
        var r = i.gid ? "gim" + i.gid : "im";
        if (i.prevPeer = i.peer, i.peer = e, i.msgid = t || "", cur.peer = e, ei({
            ...
            var a = [];
            (0, Ut.isTabLoaded)(i, e) && b(e, i, !0), a = i.tabbedPeers.map(function(e) {
                return e.peer
            }).indexOf(e) < 0 ? [{
                peer: e,
                type: "perm"
        ...
        } else ft(i.tabbedPeers, !1, i);
        return ti(), pe(i.prevPeer, i)
    }
        ...
        if (cur.wallMentions = [], (0, Ut.isChatPeer)(e.peer) && (0, Ut.isFullyLoadedTab)(e, e.peer)) {
            ...
            Object.keys(t.msgs || {}).reverse().forEach(function(e) {
                var r = (0, Gt.parserMessage)(t.msgs[e]),
                    a = r && r.userId;
                a && a != vk.id && -1 === i.indexOf(a) && (0, Ut.isUserAliveInChat)(t, a) && i.push(a)
    ...
    function N(e) {
        ...
        var i = e.tabs[t],
            r = [];
        i.offset && r.push("photos"), i.offset && r.push("search"), (-2e9 > t || i.offset) && r.push("clear"), (0, Ut.isCommunityInterface)(e) && r.push("block"), (0, Ut.isCommunityPeer)(t) && (i.blocked_community ? r.push("allow_community") : r.push("block_community")), !(0, Ut.isChatPeer)(t) && !(0, Ut.isUserPeer)(t) || (0, Ut.isCommunityInterface)(e) || (0, Ut.isChatPeer)(t) && (i.data.kicked || i.data.closed) || (inArray(t, e.mutedPeers) ? r.push("unmute") : r.push("mute")), (0, Ut.isUserPeer)(t) && !e.gid && !i.blacklisted && i.is_friend && r.push("invite"), (0, Ut.isChatPeer)(t) && !i.data.closed && !i.data.kicked && i.data.link && r.push("invite_link"), !(0, Ut.isChatPeer)(t) || i.data.closed || i.data.kicked || r.push("topic", "avatar", "invite", "leave"), (0, Ut.isChatPeer)(t) && i.data.closed && !i.data.kicked && r.push("return"), (0, Ut.isChatPeer)(t) && i.pinned && (geByClass1("im-page--chat-header_hide-pin-actions") || (r.push((0, Yt.isPinnedMessageVisibleInTab)(e, t) ? "pin_hide" : "pin_unhide"), r.push("unpin")));
        var a = (0, Ut.chatActions)(e);
    ...
    function T(e, t, i) {
        var r = i.tabs[i.peer];
        return (0, At.post)(At.CONTROLLER, {
            peer: i.peer,
            whole: e,
            act: "a_history",
    ...
    function k(e, t, i, r) {
        var a = e.tabs[t];
        return r === Ht.FLAG_OUTBOUND ? a.out_up_to = i : a.in_up_to = i, e
    }
    ...
    function I(e, t, i) {
        var r = i.tabs[e];
        return r.msgs[t.messageId] && (r.msgs[t.messageId].errored = 1, r.history = (0, Ut.setMessageError)(e, t, u(r.history))), Promise.resolve(i)
    }

    function O(e, t, i, r) {
        var a = r.tabs[e];
        return a.msgs[t] && (a.msgs[t].errored = 0, a.lastmsg_meta = i, a.lastmsg = t, a.history = (0, Ut.startResendMessage)(e, t, u(a.history))), Promise.resolve(r)
    }
    ...
    function L(e, t, i, r) {
        ...
        t.deletedDialog || (e.dialog_tabs = Object.keys(e.dialog_tabs).reduce(function(e, n) {
            return !i && !tt(n)(t) || a && !a(n, e[n], t) || (e[n] = (0, qt.arrayUnique)(r(e[n], n))), e
        }, e.dialog_tabs))
    }

    function M(e, t) {
        return 0 === e.length ? Promise.resolve(t) : (0, At.post)(At.CONTROLLER, {
            act: "a_get_admin",
            admins: e.join(","),
            gid: t.gid
        }).then(function(e) {
    ...
    function A(e, t) {
        ...
        if ((0, Ut.isFullyLoadedTab)(t, e.peerId)) {
            var r = u(i.history);
            i.msgs[e.messageId] = extend(!0, {}, e), i.history = (0, Ut.editAndReplaceMessage)(t, e, r)
        }
        i && i.lastmsg == e.messageId && (i.lastmsg_meta = e);
        var a = i && i.pinned && (0, Gt.parserMessage)(i.pinned);
    ...
    function D(e, t) {
        ...
        if ((0, Ut.isTabLoaded)(t, r)) {
            var n = t.tabs[r];
            if (n.deletedDialog = !1, !t.msg_local_ids_sort && e.local ? t.msg_local_ids_sort = a({}, e.messageId, 0) : e.local && (t.msg_local_ids_sort[e.messageId] = Object.keys(t.msg_local_ids_sort).length), i ? n.unread = 0 : (n.lastmsg == e.messageId && n.unread ? B(t, 1, e.peerId) : (!n.unread && B(t, 1, e.peerId), n.unread++), R(e.peerId, t)), (0, Ut.isFullyLoadedTab)(t, r)) {
                var o = u(n.history);
                n.skipped > 0 && n.skipped++, n.offset++, n.msgs[e.messageId] = extend(!0, {}, e), n.history = (0, Ut.appendToHistory)(t, e, o, !0, !0, !0), (0, Vt.isOut)(e) && (n.blocked_community = 0, N(t))
            }
            return n.typing && n.typing[e.userId] && delete n.typing[e.userId], n.lastmsg = e.messageId, n.lastmsg_meta = e, b(e.peerId, t), L(t, n, !1, P.bind(null, r), nt.bind(null, t)), Promise.resolve(t)
        }
        return p(r, 0, 0, 0, t).then(function(t) {
            var a = t.tabs[r];
            return L(t, a, !1, P.bind(null, r), nt.bind(null, t)), b(e.peerId, t), i || R(e.peerId, t), t
        })
    }
    ...
    function H(e, t) {
        if ((0, Ut.isFullyLoadedTab)(t, e.peerId)) {
            var i = t.tabs[e.peerId],
                r = i.unread;
            if (t = k(t, e.peerId, e.upToId, 0), null != e.unread ? i.unread = e.unread : i.unread = e.upToId >= i.lastmsg ? 0 : (0, Gt.countUnread)(e.peerId, t) + (i.unread > 0 ? +i.skipped : 0), r > 0 && !i.unread && B(t, -1, e.peerId), !i.skipped) {
                var a = u(i.history);
                i.history = (0, Ut.removewNewUnreadBarAndMerge)(t, a, e.peerId)
            }
        } else(0, Ut.isTabLoaded)(t, e.peerId) && (t.tabs[e.peerId].unread > 0 && B(t, -1, e.peerId), t.tabs[e.peerId].unread = 0, t.tabs[e.peerId].in_up_to = e.upToId);
        ...
        })), 0 !== t.unread_cnt || t.active_tab !== Wt.FOLDER_UNREAD || t.gid ? Promise.resolve(t) : it(Wt.FOLDER_ALL, t)
    }

    function j(e, t) {
        var i = t.tabs[e.peerId];
        if ((0, Ut.isTabLoaded)(t, e.peerId) && k(t, e.peerId, e.upToId, Ht.FLAG_OUTBOUND), (0, Ut.isFullyLoadedTab)(t, e.peerId)) {
            var r = u(i.history);
            i.history = (0, Ut.markMessagesAsRead)(t, e.peerId, r)
        }
    ...
    function z(e, t, i) {
        ...
        if (1 === e.length) {
            ...
            return s === !1 ? i.set(Se.bind(null, a({}, t, [o.userId]))).then(function(i) {
                var a = (0, Gt.getAuthorFullName)(i, t, n);
                return {
                    msgIds: e,
                    object: r(o, a)
                }
    ...
    function W(e, t, i, r) {
        ...
        if (a) {
            var n = t !== !1 ? t == Jt ? 2 : mobPlatforms[t] ? 1 : 0 : a.last_seen[2];
    ...
    function $(e, t) {
        if ((0, Ut.isFullyLoadedTab)(t, e.peerId)) {
            ...
            a && (i.msgs[e.messageId] = e, delete i.msgs["rid" + e.randomId]), i.history = (0, Ut.replaceMessageAttrs)(t, u(i.history), e)
        }
        return Promise.resolve(t)
    }
    ...
    function Z(e, t) {
        ...
        return (0, jt.retryFn)(At.post, 3, function(e) {
            return e * e
        })(At.CONTROLLER, i).then(function(i) {
            return ee(e, i, t)
        })["catch"](function() {
            return ee(e, null, t)
        })
    ...
    function ue(e, t) {
        ...
        return (0, jt.retryFn)(At.post, 1, function() {
            return 4
        })(At.CONTROLLER, {
    ...
    function de(e, t) {
        return (0, At.post)(At.CONTROLLER, {
            ...
            }), (0, Ut.normalizeTabsGotFromServer)(t, a), e === t.searchText && (t.searchOffset = s, t.searchAllLoaded = c), Object.keys(a).filter(function(e) {
                return !t.tabs[e]
            }).forEach(function(e) {
                t.tabs[e] = a[e]
            }), [a, o]
    ...
    function be(e, t) {
        ...
        return (0, At.post)(At.CONTROLLER, {
            ...
            i.unread = s[0], i.in_up_to = s[1], i.out_up_to = s[2], i.unread || (e.get().dialog_tabs[Wt.FOLDER_UNREAD] = e.get().dialog_tabs[Wt.FOLDER_UNREAD].filter(function(e) {
                return e != t
            })), L(e.get(), i, !1, P.bind(null, t), nt.bind(null, e.get()))
        })
    }
    ...
    function Ce(e, t, i) {
        if ((0, Ut.isFullyLoadedTab)(i, t)) {
            var r = i.tabs[t];
            r.deleted = r.deleted ? r.deleted.concat(e) : e, r.history = (0, Ut.removeMessages)(e, u(r.history)), r.offset -= e.filter(function(e) {
                return r.msgs[e]
    ...
    function we(e, t, i, r) {
        if ((0, Ut.isFullyLoadedTab)(r, t)) {
            var a = r.tabs[t];
            a.deleted = a.deleted ? a.deleted.concat(e) : e, a.history = (0, Ut.removeMessagesWithRestore)(e, t, i, u(a.history)), a.offset -= e.filter(function(e) {
                return a.msgs[e]
            }).length
        }
        return Promise.resolve(r)
    ...
    function Ee(e, t, i) {
        if ((0, Ut.isTabLoaded)(i, e)) {
            ...
            return ft(a, !0, i), t.then(function(t) {
                var a = Pt(t, 2);
    ...
    function Ie(e, t, i, r) {
        function a(e, t) {
            (0, Ut.isChatPeer)(e) && t && !(0, Kt.oCacheExists)(r, t) && (n[e] ? -1 === n[e].indexOf(t) && n[e].push(t) : n[e] = [t])
        }
        var n = {},
            o = t.filter(function(e) {
                return !(0, Ut.isTabLoaded)(r, e.peerId)
            }).map(function(e) {
                return p(e.peerId, 0, 0, 0, r)
            });
        t.forEach(function(e) {
            (0, Ut.isTabLoaded)(r, e.peerId) && a(e.peerId, e.userId)
        }), e.forEach(function(e) {
        ...
        return 0 === Object.keys(n).length && 0 === s.length && 0 === o.length ? Promise.resolve(r) : (i.pause(), Promise.all([Se(n, r), M(s, r), Promise.all(o)])["catch"](function() {
            return r
        }).then(function() {
            return i.resume()
        }).then(function() {
    ...
    function Oe(e, t, i, r) {
        return t !== vk.id ? Promise.resolve(r) : ((0, Ut.isTabLoaded)(r, i) && r.peer == i && (r = N(r)), Promise.resolve(r))
    }
    ...
    function Re(e, t, i, r) {
        if ((0, Ut.isFullyLoadedTab)(r, t)) {
            ...
            e.filter(function(e) {
                ...
                var n = (0, Gt.getMessage)(r, t, e),
                    o = i ? n.flags | Ht.FLAG_IMPORTANT : n.flags & ~Ht.FLAG_IMPORTANT;
                n.flags = o, a.msgs[e] = n, a.history = (0, Ut.updateStar)(e, i, u(a.history))
            })
        }
        return Promise.resolve(r)
    }
    ...
    function ze(e, t, i, r) {
        return r.creating = !0, r.longpoll.pause(), (0, At.post)(At.CONTROLLER, {
            act: "a_multi_start",
            hash: r.writeHash,
            peers: t.join(","),
            title: i
    ...
    function Ue(e) {
        ...
        return (0, At.post)(At.CONTROLLER, {
            ...
            return h.then(function(i) {
                e.tabs = o, e.admins = extend(e.admins, l), i && (e.tabs[f] = i.tabs[f], e.tabs[f].history = (0, Ut.restoreQueue)(f, e, u(e.tabs[f].history))), e.loadingDialogs = !1, e.offset = Object.keys(o).length, e.mutedPeers = c.mutedPeers, e.lastDialogsOptions = {
                    has_more: c.has_more
                ...
                return Object.keys(e.dialog_tabs).filter(function(e) {
                    ...
                    r == Wt.FOLDER_ALL ? e.dialog_tabs[t] = a.filter(tt(t)).map(function(e) {
                        return e.peerId
                    }) : e.dialog_tabs[t] = []
                }), delete e.resync_in_process, setTimeout(t.bind(null, !0), 0), Xe(intval(c.unread), e)
            })
        })["catch"](function(t) {
            return (0, qt.lplog)("Resync error: " + t.message + " " + t.stack, "error"),
                (0, jt.pause)(2).then(Ue.bind(null, e))
        })
    }
    ...
    function $e(e, t) {
        return t.ctrl_submit = !!e, (0, At.post)(At.CONTROLLER, {
    ...
    function et(e, t, i, r, a) {
        return (0, Ut.isFullyLoadedTab)(a, e) && (a.tabs[e].scrollTop = intval(t), a.tabs[e].scrollBottom = intval(i), a.tabs[e].contHeight = intval(r)), Promise.resolve(a)
    }
    ...
    function ot(e, t, i, r, a) {
        if ((0, Ut.isTabLoaded)(a, e)) {
            var n = a.tabs[e];
            return i === Ht.REPLACE_DIRECTORIES && (t ^= n.folders), rt(i, t, n) && Object.keys(Wt.FOLDER_MASKS).filter(function(e) {
                return Wt.FOLDER_MASKS[e] & t
            }).forEach(function(e) {
                a.dialog_tab_cts[e] += at(n, i, e)
            }), i === Ht.SET_DIRECTORIES ? a.tabs[e].folders |= t : i === Ht.RESET_DIRECTORIES ? a.tabs[e].folders &= ~t : a.tabs[e].folders = t ^= n.folders, L(a, a.tabs[e], !0, function(t, i) {
                return t.concat([e]).map(function(e) {
                    return a.tabs[e]
                }).filter(tt(i)).map(function(e) {
                    return e.peerId
                })
            }, nt.bind(null, a)), Promise.resolve(a)
        }
        return p(e, 0, 0, 0, a).then(ot.bind(null, e, t, i, a))
    }
    ...
    function ft(e, t, i) {
        return i.tabbedPeers = e, (0, Ut.isClassicInterface)(i) && (ei({
    ...
    function ht(e) {
        return e.peer ? he(e.peer, e) ? fe(e.peer, e) : (0, Ut.isFullyLoadedTab)(e, e.peer) ? e.tabs[e.peer].allShown : !1 : !0
    }
    ...
    function _t(e, t) {
        var i = t.tabs[e];
        return (0, Ut.isFullyLoadedTab)(t, e) && (i.history = f(i.history)), Promise.resolve(t)
    }
    ...
    function gt(e, t, i) {
        ...
        var r = (0, Gt.getTab)(i, t);
        return r.blocked_community = !e, (0, At.post)(At.CONTROLLER, {
    ...
    function Ft(e, t, i) {
        return (0, At.post)(At.CONTROLLER, {
            ...
            }), i.tabs[r] = a, L(i, a, !1, P.bind(null, r), nt.bind(null, i)), i.admins = extend(i.admins, o), [r]
        })
    }
    ...
    function Mt(e, t, i, r) {
        var n = (0, Gt.getMessage)(e, i, t),
            o = n.userId;
        return (0, Kt.oCacheGet)(r, o) ? Promise.resolve(r) : Se(a({}, i, [o]), r)
    }
    ...
    t.strHistory = f, t.updateBlockStates = h, t.loadPeer = p, t.restoreHistoryQueue = _, t.removeFailed = m, t.selectPeer = v, t.selectPeerOnMessage = C, t.changePeer = y, t.updateMentions = w, t.setActions = N, t.loadMoreHistory = T, t.loadLessHistory = F, t.createEmailChat = E, t.loadLongPollKey = x, t.loadLongPollTs = S, t.setMessageErrored = I, t.resendMessage = O, t.loadAdmins = M, t.editMessage = A, t.addMessage = D, t.markInboundMessagesAsRead = H, t.markOutboundMessagesAsRead = j, t.initTextStore = q, t.processFwd = z, t.mergeTabs = U, t.updateOnline = W, t.setTyping = G, t.waitTyping = V, t.addSelection = Q, t.cleanSelected = Y, t.dropSelection = X, t.replaceMessage = $, t.saveMedia = J, t.loadMedia = Z, t.addAttachmentsToStoreData = ee, t.replaceMediaAttachesStore = te, t.setCurrentSearchDate = ie, t.setCurrentSearch = re, t.searchHints = ae, t.searchHintsIndex = ne, t.localIndexToDialog = oe, t.preloadSearchIndex = ue, t.loadDialogs = le, t.searchMessages = de, t.isSearchAllLoaded = fe, t.isSearchingInplace = he, t.cancelSearch = pe, t.clearDate = _e, t.searchInplaceStart = me, t.searchMessagesInplace = ge, t.loadImportant = ve, t.loadActualLastMessage = be, t.removeMessages = Ce, t.removeMessageSend = ye, t.removeMessagesWithRestore = we, t.restoreMessage = Ne, t.restoreMessageSend = Te, t.forwardMessages = Fe, t.prepareForward = ke, t.deletedDialog = Ee, t.setChatTitle = xe, t.loadChatMember = Se, t.checkNewPeople = Ie, t.updateActions = Oe, t.setMutedPeer = Le, t.setExecStack = Me, t.updateFavMessage = Re, t.updateImportant = Pe, t.loadSpam = Ae, t.flushSpam = De, t.setCreationType = Be, t.getOwnerPhoto = He, t.presetAvatar = je, t.setChatPhoto = qe, t.createChat = ze, t.resync = Ue, t.chatUserHasJoined = We, t.chatUserHasLeft = Ge, t.toggleSendingAbility = Ve, t.setDelayedMessage = Ke, t.isAnythingLoading = Ye, t.updateUnreadCount = Xe, t.changeSubmitSettings = $e, t.updateFavAndTitle = Ze, t.saveHistoryScroll = et, t.filterFromTab = tt, t.changeDialogsTab = it, t.updateFolderState = ot, t.getMutexQueue = st, t.releaseBlock = ct, t.toggleCommunityMute = ut, t.restoreDialog = lt, t.spamDialog = dt, t.updateTabbedPeers = ft, t.isEverythingLoaded = ht, t.cleanTab = pt, t.stringifyTab = _t, t.updateGoToEndVisibility = mt, t.toggleCommunityMessages = gt, t.updateHistory = vt, t.startRecording = bt, t.cancelRecording = Ct, t.setVoiceMessageAvail = yt, t.toggleConversation = wt, t.updateSearchQuery = Nt, t.initializeChatResize = Tt, t.joinChat = Ft, t.resetInviteLink = kt, t.leaveInvitation = Et, t.saveRecentSearchPeer = xt, t.resetRecentSearch = St, t.removeFromRecentSearch = It, t.pinMessageOptimistic = Ot, t.unpinMessageOptimistic = Lt, t.checkChatMember = Mt, t.hidePromoTooltip = Rt;
    var At = i(69),
        Dt = i(141),
        Bt = i(87),
        Ht = r(Bt),
    ...
    t.readLastMessages = c(function(e, t) {
        ...
        })), r = intval(r.shift()), r <= i.in_up_to ? Promise.resolve(t) : (t.longpoll.push([Ht.readInboundEvent([6, e, r])]), (0, At.post)(At.CONTROLLER, {
            peer: e,
            ids: [r],
            hash: i.hash,
            act: "a_mark_read",
        ...
        var r = Date.now() + rand(0, 100).toFixed(0),
            a = i.tabs[e];
        return (0, jt.retryFn)(At.post, 1)(At.CONTROLLER, {
            act: "a_send",
            to: e,
            hash: a.hash,
            msg: t.message,
        ...
        return t.tabs[e].lastTyping = Date.now(), (0, At.post)(At.CONTROLLER, {
            act: "a_typing",
            peer: e,
            gid: t.gid,
            hash: t.tabs[e].hash
        ...
        return Ee(e, (0, At.post)("al_im.php", {
            act: "a_flush_history",
            id: e,
            from: "im",
            gid: t.gid,
        ...
        return (0, At.post)(At.CONTROLLER, {
            ...
            var r = Pt(t, 2),
                a = (r[0], r[1]);
            return i.tabs[e] = extend(i.tabs[e], (0, Ut.normalizeTab)(i, a)), i
        })
        ...
        return e.kludges.source_act === Ut.CHAT_PHOTO_REMOVE ? (delete t.tabs[e.peerId].photo, Promise.resolve(t)) : (0, At.post)(At.CONTROLLER, {
        ...
        return (0, At.post)(At.CONTROLLER, {
            ...
            chat: e - 2e9,
            hash: t.tabs[e].hash
        }).then(Oe.bind(null, Ut.CHAT_KICK_USER, vk.id, e, t))
    }), t.returnToChat = c(function(e, t) {
        return (0, At.post)(At.CONTROLLER, {
            act: "a_return_to_chat",
            chat: e - 2e9,
            hash: t.tabs[e].hash
        }).then(Oe.bind(null, Ut.CHAT_INVITE_USER, vk.id, e, t))
        ...
        return Re(e, i, t, r), (0, At.post)(At.CONTROLLER, {
        ...
        return t.longpoll.push([a([0, e, i, !0])]), (0, At.post)(At.CONTROLLER, {
            act: "a_dialog_star",
            val: r ? 0 : 1,
            peer: e,
            hash: t.tabs[e].hash,
        ...
        return i.longpoll.push([Ht.resetDirectoriesEvent([0, e, r, !0]), Ht.readInboundEvent([6, e, t])]), (0, At.post)(At.CONTROLLER, {
            act: "a_mark_answered",
            peer: e,
            lastmsg: t,
            hash: i.tabs[e].hash,
        ...
        }), t.tabs[e].deletedDialog = !0, (0, At.post)(At.CONTROLLER, {
            act: "a_delete_dialog",
            peer: e,
            gid: t.gid,
            hash: t.tabs[e].hash
        }).then(function(i) {
            return i[0] ? (ft(t.tabbedPeers.filter(function(t) {
                return t.peer !== e
            }), !0, t), t.tabs[e].unread = 0, t.tabs[e].lastmsg = !1, t.tabs[e].lastmsg_meta = null) : (t.tabs[e].deletedDialog = !1, L(t, t.tabs[e], !1, P.bind(null, e), nt.bind(null, t))), i
        })
    }), t.pinMessage = c(function(e, t, i) {
        var r = i.tabs[t];
        return r.data.kicked || r.data.closed ? Promise.resolve(i) : (0, At.post)(At.CONTROLLER, {
            act: "a_pin_message",
            msgid: e,
            chat: t,
            hash: i.tabs[t].hash
        ...
        var i = t.tabs[e];
        return i.data.kicked || i.data.closed ? Promise.resolve(t) : (0, At.post)(At.CONTROLLER, {
            act: "a_unpin_message",
            chat: e,
            hash: t.tabs[e].hash
        }).then(function(r) {
    ...
    var r = i(84),
        a = i(11);
    e.exports = i(105) ? function(e, t, i) {
    ...
    var r = i(84),
        a = i(127),
        n = i(136);
    e.exports = i(105) ? Object.defineProperties : function(e, t) {
        a(e);
    ...
    var r = i(127),
        ...
        u = function() {
            var e, t = i(97)("iframe"),
                r = n.length,
                a = ">";
            for (t.style.display = "none", i(44).appendChild(t), t.src = "javascript:", e = t.contentWindow.document, e.open(), e.write("<script>document.F=Object</script" + a), e.close(), u = e.F; r--;) delete u[c][n[r]];
            return u()
        };
    ...
    var r = i(58),
        a = {};
    a[i(53)("toStringTag")] = "z", a + "" != "[object z]" && i(125)(Object.prototype, "toString", function() {
    ...
    e.exports = i(22).document && document.documentElement
}, function(e, t, i) {
    var r = i(114),
        a = i(11),
        n = i(25),
    ...
    e.exports = {
        set: Object.setPrototypeOf || ("__proto__" in {} ? function(e, t, r) {
            try {
                r = i(81)(Function.call, i(45).f(Object.prototype, "__proto__").set, 2), r(e, []), t = !(e instanceof Array)
            } catch (a) {
                t = !0
            }
            return function(e, i) {
    ...
    window.curFastChat || (window.curFastChat = {}), window.FastChat = {
        ...
        clistToggleOnlines: function(e) {
            void 0 === e && (e = !curFastChat.clOnlines, FastChat.stateChange({
                    op: "onlines_toggled",
                    val: e ? 1 : 0
                })), toggleClass(curFastChat.el.clistOnline, "fc_clist_online_active", e),
                curFastChat.clOnlines = e
        },
    ...
    for (var r = i(73), a = i(125), n = i(22), o = i(26), s = i(128), c = i(53), u = c("iterator"), l = c("toStringTag"), d = s.Array, f = ["NodeList", "DOMTokenList", "MediaList", "StyleSheetList", "CSSRuleList"], h = 0; 5 > h; h++) {
        var p, _ = f[h],
            m = n[_],
            g = m && m.prototype;
        if (g) {
    ...
    var r = i(103),
        ...
        n = i(128),
        o = i(25);
    e.exports = i(94)(Array, "Array", function(e, t) {
    ...
    var r = i(58),
        a = i(53)("iterator"),
        n = i(128);
    e.exports = i(67).getIteratorMethod = function(e) {
    ...
    t.f = i(105) ? Object.defineProperty : function(e, t, i) {
    ...
    var r = i(53)("unscopables"),
        a = Array.prototype;
    void 0 == a[r] && i(26)(a, r, {}), e.exports = function(e) {
        a[r][e] = !0
    }
}, function(e, t, i) {
    i(32), i(96), i(65), i(21), e.exports = i(67).Map
}, function(e, t, i) {
    ...
    window.curNotifier || (window.curNotifier = {
        ...
        init: function(e) {
            if (!window.curNotifier || !curNotifier.connection_id) {
                ...
                this.initIdleMan(), this.initCommunityQueues(),
                    (curNotifier.cont = ge("notifiers_wrap")) || bodyNode.insertBefore(curNotifier.cont = ce("div", {
                        id: "notifiers_wrap",
                        className: "fixed"
                    }), ge("page_wrap"))
            }
    ...
    e.exports = !i(105) && !i(14)(function() {
        return 7 != Object.defineProperty(i(97)("div"), "a", {
            get: function() {
                return 7
            }
        }).a
    ...
    i(121), i(118), i(28), i(106), i(55), i(4), i(93), window.getWndInner = r, window.lastWndScroll = [!1, !1], window.updateWndVScroll = a, window.defBox = n;
    try {
