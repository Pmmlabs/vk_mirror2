! function(e) {
    ...
    12: function(e, t, n) {
        ...
        function Ye(e) {
            e >= window.clientHeight() - 30 && (e = 0), Y.set(Ke, e)
        }
        ...
        function Je(e, t, n, r) {
            ...
            return t && (s = '<a onmouseover="return Emoji.stickerOver(' + ee(e) + ', this);"\n        onclick="return Emoji.clickSticker(' + ee(t) + ', this, event);">' + s + "</a>"), s = '<div class="im_sticker_row">' + s + "</div>"
        }
        ...
        function st(e, t, n) {
            ...
            return i && (i.parentNode.replaceChild(Q(r), i), dt(n)), n
        }
        ...
        function ct(e, t) {
            ...
            t.local && a && n.push("im-mess_sending"), t.local && n.push("" + k), t.local && Object(c.wasEdited)(t) && !r && n.push("im-mess_unread im-mess_nobg"), t.failed && n.push("im-mess_failed " + T), Object(c.isGift)(t) && n.push("im-mess_gift");
            var o = ut(t),
                l = function(e, t) {
                    var n = "",
                        r = Object(f.unpackStore)(e).sourceEnabled && t.kludges && t.kludges.from_widget && t.kludges.ref_source;
                    Object(c.wasEdited)(t) && (n += be("sImLblWasEdited", {
                        update_time: t.update_time
                    }));
                    if (Object(s.isCommunityInterface)(e) && r) {
                        var i = t.kludges.ref_source,
                            a = {};
                        try {
                            (a = JSON.parse(Object(b.unclean)(i))).link && a.info && (a.link = Object(u.replaceHyperLinks)(Object(b.clean)(a.link), u.linksReplacer.bind(null, !1)), a = Object(b.clean)(langStr(ye("mail_source_info"), "link", a.link, "info", Object(b.clean)(a.info))), n += be("sImLblWasSourceInfo", {
                                source: a
                            }))
                        } catch (e) {}
                    }
                ...
                _ = i + Et(e, t.text, t.kludges, !1, t.peerId);
            "" != _ && (_ += l), t.subject && "..." !== t.subject.trim() && !Object(d.isChatPeer)(t.peerId) && (_ = be("im_topic", {
                topic: t.subject
            }) + _);
            var h = be("im_message_media", {
                type: "media",
                messageId: t.messageId,
                attaches: o.join(""),
                text: Object(c.isGift)(t) ? '<div class="im-mess--gift-lbl">' + _ + "</div>" : ""
            });
            return Object(c.isGift)(t) || (h = _ + h), "" == _ && (h += l), be("im_msg_row", {
                msg_id: t.messageId,
                from_id: t.peerId,
                text: h,
        ...
        function ut(e) {
            return e.attaches.reduce(function(t, n) {
                return !Object(c.hasReply)(e) || "mail" !== n.type && "reply" !== n.type ? ("sticker" === n.type ? e.messageId ? t.push(Je(n.id, n.productId, n.kind, e.messageId)) : t.push(Je(n.id, n.productId)) : t.push(rt(n.type)), t) : t
            }, [])
        }

        function dt(e) {
            for (var t = e.getElementsByClassName("_im_mess_noa"), n = t.length; n--;) pe(t[n], "im-mess_fwd") || t[n].insertAdjacentHTML("afterbegin", be("sImHistoryRowActions")), _e(t[n], "_im_mess_noa")
        }

        function lt(e, t, n) {
            var r, i, a, o, s, c = V.id,
                u = e.attaches[0],
                d = u.initiatorId,
                l = u.state,
                f = u.receiverId,
            ...
            switch (l) {
                case "reached":
                    h = ye(c === d ? "mail_call_outgoing" : "mail_call_incoming");
                ...
                case "canceled_by_initiator":
                    h = ye(c === d ? "mail_call_canceled" : "mail_call_missed");
                    break;
                case "canceled_by_receiver":
                    if (c === d) {
                        if (t) return ye("mail_call_declined");
                        var m = Object(_.oCacheGet)(n, f);
                        return m ? we(m.sex, ye("mail_call_declined_by", "raw")).replace("{user_name}", m.first_name) : ye("mail_call_declined")
                    }
                    return ye("mail_call_canceled");
                default:
                    h = ye("mail_added_call")
            }
        ...
        function ft(e, t, n) {
            ...
            var l = ct(e, t),
                h = ae(n);
            pe(h, "_im_mess_stack") || (h = se(h, "._im_mess_stack", -1));
            for (var p = Object(s.getLastMessage)(e, t.peerId, t.messageId); t.peerId === e.peer && p && !de("_im_mess_" + p.messageId);) p = Object(s.getLastMessage)(e, t.peerId, p.messageId);
            var m = de("_im_unread_bar_row", n),
                g = Object(c.getUserId)(t),
                v = p ? Ct(p.date, e) : 0;
            if (!p || kt(o, p, t, e, i)) {
                var b = "",
                    y = !1;
                if (m && Object(c.isOut)(t) && An(e, n, t.peerId), 1 === o.unread && !Object(c.isOut)(t) && i && (b += be("im_mess_bar", {}), y = !0, An(e, n, t.peerId)), !Se(new Date(v))) {
                    var w = new Date,
                        C = y ? "im-page--history-new-bar_hide _im_invisible_bar" : "";
                    b += be("im_day_bar", {
                        day: Oe(t.date, e.timeshift, !0, ye("months_of", "raw"), !0),
                        date: t.date,
                        day_class: w.getDate() + w.getMonth() + w.getFullYear() + " " + C
                    })
                }
                if (Object(c.isServiceMsg)(t)) b += be("im_service_row", {
                    text: Jt(e, t, o),
                    type: "",
                    date: t.date,
                    from_id: "",
                ...
                else if (Object(c.isCallMessage)(t)) b += be("im_service_row", {
                    text: $t("", lt(t, !1, e), ""),
                    type: "",
                    date: t.date,
                    from_id: "",
                    ...
                    var T = e.gid && Object(c.isOut)(t) ? ee(t.kludges.from_admin) || -e.gid : 0,
                    ...
                    if (Object(c.isGift)(t)) {
                        var j = ye("mail_gift_message_sent", "raw");
                        S += ' <span class="im-mess-stack--gift">' + we(E.sex || 0, j) + "</span>"
                    }
                    if (Object(c.isMoney)(t)) {
                        var I = Object(c.isMoneyRequest)(t) ? ye("mail_money_request_message_sent", "raw") : ye("mail_money_tranfer_message_sent", "raw");
                        S += ' <span class="im-mess-stack--money-transfer">' + we(E.sex || 0, I) + "</span>"
                    }
                    var x = e.gid ? "/gim" + e.gid : "/im",
                        F = void 0;
                    if (F = t.local ? Tt(t.date, e.timeshift) : be("im_stack_date", {
                            date: Tt(t.date, e.timeshift),
                            link: x + "?sel=" + t.peerId + "&msgid=" + t.messageId
                        }), T && e.admins[T]) {
                        var A = e.admins[T],
                            M = T === V.id ? ye("mail_by_you") : A[0];
                        F = F + " " + be("im_admin_link", {
                            name: M,
                            href: A[1]
                        })
                    }
                ...
                Object(f.toArray)(J(b)).forEach(function(e) {
                    return n && n.appendChild(e)
                })
            } else m && e.peer === t.peerId && !o.inplaceSearch && Object(c.isOut)(t) && An(e, n, t.peerId), de("_im_stack_messages", h).appendChild(Q(l));
            return Object(c.isOut)(t) && !a && setTimeout(function() {
                var e = de("_im_mess_" + t.messageId, n);
                pe(e, k) && fe(e, "im-mess_sending")
        ...
        function ht(e, t, n) {
            var r = e.tabs[t];
            return Object(f.toArray)(ue("_im_mess_unread", n)).forEach(function(e) {
                var t, n = ee(ce(e, "msgid"));
                n > 0 && r.out_up_to >= n && (_e(e, "_im_mess_unread"), _e(e, "im-mess_unread"), (t = de("_im_mess_blind_unread_marker", e)) && (t.removeAttribute("aria-label"), t.removeAttribute("role"), t.removeAttribute("tabindex")))
            }), n
        }
        ...
        function kt(e, t, n, r, i) {
            ...
            var a = Ct(t.date, r),
                o = Ct(n.date, r);
            return !Ne(a, o) || (!(!Object(s.isCommunityInterface)(r) || ee(t.kludges.from_admin) === ee(n.kludges.from_admin)) || (n.date - t.date > 300 || (!(!Object(c.isServiceMsg)(t) && !Object(c.isServiceMsg)(n)) || (!(!Object(c.isCallMessage)(n) && !Object(c.isCallMessage)(t)) || (!(!Object(c.isGift)(t) && !Object(c.isGift)(n)) || (!(!Object(c.isGraffiti)(t) && !Object(c.isGraffiti)(n)) || (!!Object(c.hasReply)(n) || !(Object(c.isUnread)(e, t) === Object(c.isUnread)(e, n) || !i || Object(c.isOut)(n) || tn(n.peerId, r.gid)))))))))
        }
        ...
        function Et(e, t, n) {
            ...
            }), n.emoji && (t = De.emojiToHTML(t, !0)), Ue && (t = Ue(t)), t
        }

        function Ot(e) {
            return Object(d.isChatPeer)(e) ? "c" + (e - 2e9) : e < -2e9 ? "e" + Math.abs(e + 2e9) : gt(e) ? "mr" + (e - 19e8) : e
        }
        ...
        function At(e, t, n) {
            ...
            if (Array.isArray(t.photo)) return Ft(t.photo);
            var r = t.data.active.slice(0, 4).map(_.oCacheGet.bind(null, e));
            return Ft(r.map(function(e) {
                return e.photo
            }), n ? [] : r.map(function(e) {
                return e.link
            }))
        ...
        function Ht(e, t, n) {
            ...
            if (r) {
                me(r, "aria-hidden", "false"), fe(r, "im-mess_failed " + T);
                var i = de("_im_mess_marker", r);
                me(i, "aria-label", ye("mail_send_message_error")), me(i, "role", "link")
            }
            return n
        }
        ...
        function Ut(e, t, n) {
            ...
            if (r) {
                _e(r, "im-mess_failed"), me(r, "aria-hidden", "true"), _e(r, T);
                var i = de("_im_mess_marker", r);
        ...
        function zt(e, t) {
            ...
            return e.forEach(function(e) {
                ...
                pe(ie(e), "_im_bar_date") && X(ie(e)), pe(ie(e), "_im_unread_bar_row") && X(ie(e)), X(e)
            }), t
        }
        ...
        function Gt(e, t, n, r) {
            return e.map(function(e) {
                ...
                ve(e, function(e, t, n) {
                    var r = t.innerHTML;
                    return '<div class="im-mess--text">\n    ' + ye("delete" === n ? "mail_deleted_stop" : "mail_marked_as_spam") + ' <button type="button" data-peer="' + e + '" class="' + O + ' im-mess--btn">' + ye("mail_restore") + '</button>\n    <div class="' + E + ' im-mess--original">' + r + "</div>\n  </div>"
        ...
        function Kt(e, t, n) {
            ...
            if (r) {
                var i = de(E, r);
                ve(r, i.innerHTML), _e(r, "im-mess_light")
            }
            return n
        }
        ...
        function Vt() {
            ...
            var a = Qt(e, t, n, r, !1, i);
            return a.length > 60 ? Qt(e, t, n, r, !0, i) : a
        }

        function Yt(e) {
            var t, n = (C(t = {}, m.ACTIVITY_TYPE_TYPING, 1), C(t, m.ACTIVITY_TYPE_RECORDING_AUDIO, 2), t),
        ...
        function Qt(e, t, n, r, i, a) {
            var o = function(e, t, n) {
                ...
                }), r.length && Object(m.loadChatMember)(C({}, n, r), e), Object.keys(i).sort(function(e, n) {
            ...
            var c = Object(d.isUserPeer)(t) || Object(s.isCommunityPeer)(t) ? "first_name" : i ? "short_name" : "name",
                u = Yt(e),
                l = "";
            u === m.ACTIVITY_TYPE_RECORDING_AUDIO ? l = ye("mail_recording_audio_several", o.length) : u === m.ACTIVITY_TYPE_TYPING && (l = ye("mail_typing_several", o.length));
            ...
            if (o.length > a + 1) {
                ...
                h += " " + ye("mail_and_peer").replace("{count}", p - a).replace("{typing}", l)
            } else {
                if (o.length > 1 && (h += " " + ye("mail_and_peer_one")), !Object(d.isChatPeer)(t) && n) h += " " + l;
        ...
        function Jt(e, t, n) {
            ...
            if (u = (u = we(c.sex, ye(u, "raw"))).replace("{from}", $t(c.link, c.name, r)), o && o !== s) {
                var l = i.source_email;
                if (l) u = u.replace("{user}", $t("/im?email=" + encodeURIComponent(l), "email", r));
                else {
                    var f = Object(_.oCacheGet)(e, o),
                        h = a === x ? f.inv_name : f.kick_name;
                    u = u.replace("{user}", $t(f.link, h, r))
                }
            }
            if (i.source_text) {
            ...
            if (i.source_act === M || i.source_act === P)
                if (i.source_message) {
                    var m = $t("", en(De.emojiToHTML(ne(i.source_message.replace(/<br\s?\/?>/gi, " ")), !0)), !1, "im_srv_mess_link");
                    u = u.replace("{msg}", m)
            ...
            if (t === F) {
                ...
                if (i) {
                    ...
                    i.parentNode.innerHTML = be("im_msg_row", {
                        msg_id: e.messageId,
                        from_id: e.peerId,
                        text: Jt(n, e, a) + n.chat_photo_msg,
                        ts: e.date,
                        cls: "im-mess_srv"
                    })
                }
        ...
        function rn(e) {
            return function(t) {
                ...
                function o() {
                    a = !0, _e(i, "im-preloader_visible"), i.parentNode && i.parentNode.removeChild(i)
                }
                setTimeout(function() {
        ...
        function sn(e, t) {
            return '<div class="im-mess--text">\n      <span>' + ye("mail_restored") + '</span>\n      <a class="_im_go_to" href="/im?sel=' + Ot(e) + "&msgid=" + t + '">' + ye("mail_im_goto_conversation") + "</a>\n    </div>"
        }
        ...
        function cn(e, t, n) {
            var r = ye("mail_deleteall1"),
                ...
                a = ye("mail_delete");
            return Object(d.isChatPeer)(t) && (Object(v.doesChatTabHaveFlag)(e, 1024) ? (r = ye("mail_leave_channel"), i = ye("mail_unfollow_channel_confirmation"), a = ye("mail_unfollow_channel")) : i = ye("mail_chat_sure_to_delete_all")), Object(s.isCommunityPeer)(t) && (i = ye("mail_group_sure_to_delete_all")), xe(r, i, a, n, ye("global_cancel"))
        }
        ...
        function un(e, t, n) {
            ...
            if (i) {
                ...
                a ? (o = ye("mail_leave_channel"), c = ye("mail_vkcomgroup_leave_confirm"), u = ye("mail_leave_channel")) : (o = ye("mail_leave_chat"), c = ye("mail_chat_leave_confirm"), u = ye("mail_leave_chat"))
            }
            Object(s.isCommunityPeer)(t) && (c = ye("mail_group_sure_to_delete_all"));
        ...
        function dn(e) {
            return xe(ye("mail_unpin_title"), ye("mail_unpin_text"), ye("mail_unpin"), e, ye("global_cancel"))
        }

        function ln(e, t, n, r) {
            var i = ye("mail_dialog_msg_delete_N", t),
                a = xe(ye("mail_dialog_msg_delete_title"), i, ye("mail_delete"), function() {
                    return r(isChecked(de("_check_forall")))
                }, ye("global_cancel")),
                o = "",
                s = !1;
            return n && (o = '<div class="checkbox im-delete-forall-checkbox _check_forall" onclick="checkbox(this);" role="checkbox" aria-checked="false">' + ye("mail_delete_for_all") + "</div>", s = cur.imDb.selectByKey("del_forall_checked")), a.setControlsText(o), s && checkbox(de("_check_forall")), a
        }
                    ...
                    var o = Object(a.createModule)({
                        handlers: function(i, s) {
                            s(r.bodyNode.parentNode, "click", "_im_invite_box", function() {
                                r.hide(), hn(e, e.get().peer, t, n), Object(a.destroyModule)(o)
        ...
        function Tn(e, t) {
            return En(e.get(), t, Object(s.getTab)(e, t).last_seen)
        }

        function En(e, t, n, r) {
            if (n[0]) return ye("mail_header_online_status") + (Me[n[0]] ? On(t, !1, !1, !0) : "");
            if (!n[1]) return "";
            var i = Te(n[1], e.timeshift),
                a = we(Object(_.oCacheGet)(e, t).sex, ye("mail_last_activity_tip", "raw")).replace("{user}", "").replace("{time}", i);
            return n[2] && (a += On(t, !1, !1, r)), a
        }
        ...
        function An(e, t, n) {
            ...
            if (!r) return t;
            var i = se(r, "._im_mess_stack", -1),
                a = se(r, "._im_mess_stack"),
                o = i ? ue("_im_mess", i).pop() : null,
                c = a ? de("_im_mess", a) : null;
            if (X(r), at(t), !c || !o) return t;
            var u = ce(c, "msgid"),
                d = Object(s.getPreviousMessage)(e, n, u),
                l = Object(s.getMessage)(e, n, u);
            if (!d || kt(e.tabs[n], d, l, e)) return t;
            var _ = de("_im_stack_messages", i),
                h = de("_im_stack_messages", a).children;
        ...
        function Mn(e, t, n) {
            ...
            var o = pe(i, "_im_mess_srv") ? i : le("_im_mess_stack", i);
            if (!o) return [!0, 0];
        ...
        function Pn(e, t, n) {
            ...
            i && pe(i, "im-page--dialogs-notice") && _e(i, "im-page--dialogs-notice"), je.post("al_im.php", {
        ...
        function Ln(e, t, n) {
            ...
            Re(r, 200, X.pbind(r)), je.post("al_im.php", {
                act: "a_hide_top_notice",
                type: r.getAttribute("data-type"),
                hash: r.getAttribute("data-hash")
            })
        ...
        function Dn(e, t) {
            ...
            Re(n, 200, X.pbind(n)), je.post("al_im.php", {
        ...
        function Rn(e, t) {
            le("_im_aside_promo_block", t).classList.add("--action-called"), je.post("al_im.php", {
        ...
        function Bn(e, t, n, r, i) {
            return n = n.replace(/\<br\s*\/?\>(\n)?/gi, " ").replace(/[\n\r]/gi, " "), n = Object(u.replaceMentions)(n, function(e, t, n, r, i) {
                return i
            }), r && (n = De.emojiToHTML(n, !0)), t && "..." !== t.trim() && !Object(d.isChatPeer)(e) && (n = be("im_topic", {
                topic: t,
                cls: "im-topic_dialog"
        ...
        function zn(e) {
            ...
            return i || (i = !(i = n.text) && n.attaches.length ? be("im_pinned_message_media", {
                text: Hn(n.attaches[0], n.attaches)
        ...
        function Wn(e, t) {
            ...
            if (t && Object(c.isMoneyRequest)(t) && void 0 !== t.kludges.attach1_tr_amount) {
                ...
                if (ee(t.kludges.attach1_held_amount)) {
                    var s = ke(t.kludges.attach1_held_amount / 1e3, r, !0);
                    n += " " + ye("mail_money_request_held_amount").replace("{amount}", s)
                }
        ...
        function Vn() {
            var e = getSize(de(G))[1];
            return e || (e = Ge), e
        }

        function Yn(e, t) {
            e.bodyNode.addEventListener("mouseover", function(e) {
                pe(e.target, "_im_edit_time") ? Kn(t, 0, e.target) : pe(e.target, "_im_page_info") && Gn(0, 0, e.target)
            })
        }
        ...
        function tr(e, t) {
            var n = [],
                ...
                i = r ? r[1].split(";") : [];
            for (i.length > ze && (r[1] = i.slice(0, ze).join(";")); e.length > qe;) {
                var a = e.substr(0, qe).lastIndexOf(" "); - 1 == a && (a = qe), n.push({
        ...
        function ir() {
            xe(ye("global_error"), ye("mail_message_wait_until_uploaded"))
        }
        ...
        function dr(e, t, n, i) {
            i && !Ze(e, n, i) && (Object(s.getMessage)(e, n, i) ? (e.setState({
                msgid: i
        ...
        function lr(e) {
            ...
            var n = e.get().tabs[e.get().peer],
                r = Object(s.parserMessage)(n.msgs[ce(t, "msgid")]);
    ...
    4: function(e, t, n) {
        "use strict";
        n.r(t);
        n(121), n(38), n(111), n(82), n(128), n(195), n(80);
    ...
    80: function(__webpack_module__, __webpack_exports__, __webpack_require__) {
        "use strict";
    ...
    82: function(__webpack_module__, __webpack_exports__, __webpack_require__) {
        "use strict";
        __webpack_require__.r(__webpack_exports__);
        var _helpers_im_shared_helpers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(177),
            _longpoll_singleton__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(11),
            _lib_debug_tools__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(172),
