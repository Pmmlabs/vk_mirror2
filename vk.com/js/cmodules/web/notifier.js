! function(e) {
    ...
    212: function(__webpack_module__, __webpack_exports__, __webpack_require__) {
        "use strict";
    ...
    235: function(e, t, n) {
        ...
        function Ne(e, t) {
            var n = Pn(j(e) ? "mail_chat_sure_to_delete_all" : Object(Ft.isCommunityPeer)(e) ? "mail_group_sure_to_delete_all" : "mail_sure_to_delete_all");
            return Qn(Pn("mail_deleteall1"), n, Pn("mail_delete"), t, Pn("global_cancel"))
        }
    ...
    63: function(__webpack_module__, __webpack_exports__, __webpack_require__) {
        "use strict";
        __webpack_require__.r(__webpack_exports__);
        var _helpers_im_shared_helpers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(218),
            _longpoll_singleton__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(197),
            ...
            lpCheck: function lpCheck() {
                if (curNotifier.lp_started && !curNotifier.lpActive && !curNotifier.lpInvalid) {
                    ...
                    var onFail = function(e) {
                        completed || (completed = !0, curNotifier.lpActive = !1, clearTimeout(curNotifier.lp_req_check_to), curNotifier.error_timeout = curNotifier.error_timeout || 1, clearTimeout(curNotifier.lp_error_to), curNotifier.lp_error_to = setTimeout(this.lpCheck.bind(this), 1e3 * curNotifier.error_timeout + irand(1e3, 1e4)),
                            curNotifier.error_timeout < 64 && (curNotifier.error_timeout *= 2))
                    }.bind(this);
    ...
    64: function(e, t, n) {
        ...
        n.r(t), n(170), n(215), n(229), n(63), n(136), n(233), n(212), window.getWndInner = r, window.lastWndScroll = [!1, !1], window.updateWndVScroll = i, window.defBox = a;
        try {
