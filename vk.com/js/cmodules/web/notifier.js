! function(e) {
    ...
    var r = i(120),
        ...
        c = Function[s],
        u = ("" + c).split(s);
    i(127).inspectSource = function(e) {
        return c.call(e)
    ...
    i(66), i(5), i(108), i(43), i(63), i(58), i(11), window.getWndInner = r, window.lastWndScroll = [!1, !1], window.updateWndVScroll = a, window.defBox = n;
    try {
    ...
    "use strict";
    var r = i(15)(!0);
    i(132)(String, "String", function(e) {
    ...
    e.exports = !i(74) && !i(70)(function() {
        return 7 != Object.defineProperty(i(6)("div"), "a", {
            get: function() {
                return 7
            }
        }).a
    ...
    var r = i(81)("unscopables"),
        a = Array.prototype;
    void 0 == a[r] && i(146)(a, r, {}), e.exports = function(e) {
        a[r][e] = !0
    }
}, function(e, t, i) {
    var r = i(94),
    ...
    i(31), i(9), i(78), i(26), e.exports = i(127).Map
}, , , , function(e, t) {
    "use strict";
    ...
    e.exports = {
        set: Object.setPrototypeOf || ("__proto__" in {} ? function(e, t, r) {
            try {
                r = i(53)(Function.call, i(25).f(Object.prototype, "__proto__").set, 2), r(e, []), t = !(e instanceof Array)
            } catch (a) {
                t = !0
            }
            return function(e, i) {
    ...
    var r = i(71),
        a = {};
    a[i(81)("toStringTag")] = "z", a + "" != "[object z]" && i(1)(Object.prototype, "toString", function() {
    ...
    function D(e, t) {
        ...
        if ((0, zt.isTabLoaded)(t, r)) {
            ...
            if (n.deletedDialog = !1, !t.msg_local_ids_sort && e.local ? t.msg_local_ids_sort = a({}, e.messageId, 0) : e.local && (t.msg_local_ids_sort[e.messageId] = Object.keys(t.msg_local_ids_sort).length), i ? n.unread = 0 : (n.lastmsg == e.messageId && n.unread ? B(t, 1, e.peerId) : (!n.unread && B(t, 1, e.peerId), n.unread++), R(e.peerId, t)), (0, zt.isFullyLoadedTab)(t, r)) {
                var o = u(n.history);
                n.skipped > 0 && n.skipped++, n.offset++, n.msgs[e.messageId] = extend(!0, {}, e),
                    n.history = (0, zt.appendToHistory)(t, e, o, !0, !0, !0), (0, Gt.isOut)(e) && (n.blocked_community = 0, N(t))
            }
    ...
    "use strict";
    var _im_shared_helpers = __webpack_require__(139),
    ...
    window.curNotifier || (window.curNotifier = {
        ...
        lpChecked: function(e) {
            ...
            return this.lcSend("feed", extend({
                    ...
                    key: curNotifier.key
                }, e)), curNotifier.timestamp = e.ts,
                Notifier.pushEvents(e.events), 0
        },
        lpOnReset: function() {
    ...
    var r = i(14),
        ...
        n = i(57),
        o = i(46);
    e.exports = i(132)(Array, "Array", function(e, t) {
    ...
    for (var r = i(72), a = i(1), n = i(120), o = i(146), s = i(57), c = i(81), u = c("iterator"), l = c("toStringTag"), d = s.Array, f = ["NodeList", "DOMTokenList", "MediaList", "StyleSheetList", "CSSRuleList"], h = 0; 5 > h; h++) {
        var p, _ = f[h],
            m = n[_],
            g = m && m.prototype;
        if (g) {
    ...
    e.exports = i(120).document && document.documentElement
}, function(e, t, i) {
    "use strict";
    ...
    function n(e) {
        e >= window.clientHeight() - 30 && (e = 0), jt.set(Di, e)
    }

    function o(e, t) {
        var i = ii(e, t),
            r = i.firstElementChild.offsetHeight !== i.parentNode.offsetHeight;
        r && ui(i.firstElementChild, {
    ...
    function h(e) {
        return di("im_preloader", {
            preloader: Ut(Ht.pr_tpl, {
                id: ""
            }),
    ...
    function _(e) {
        var t = ii("_im_invisible_bar", e);
        t && (ni(t, "_im_invisible_bar"), ni(t, "im-page--history-new-bar_hide"))
    }

    function m(e, t, i) {
        var r = g(e, t),
            a = ii("_im_mess_" + t.messageId, i);
        return a && a.parentNode.replaceChild(qt(r), a), i
    }

    function g(e, t) {
        var i = ["_im_mess"],
            r = (0, pt.isUnread)(e.tabs[t.peerId], t);
        (0, pt.isOut)(t) && r && i.push("im-mess_unread _im_mess_unread"), (0, pt.isOut)(t) && i.push("im-mess_out"), (0, pt.wasEdited)(t) && i.push("im-mess_was_edited"), (0, wt.canMessageBeEdited)(e, t) && i.push("im-mess_editable"), (0, pt.isImportant)(t) && i.push("im-mess_fav"), -1 != (e.selectedMessages || []).indexOf(t.messageId) && i.push("im-mess_selected");
        var a = Date.now() - 1e3 * t.date > 1e3;
        t.local && a && i.push("im-mess_sending"), t.local && i.push("" + Nt), t.local && (0, pt.wasEdited)(t) && !r && i.push("im-mess_unread im-mess_nobg"), t.failed && i.push("im-mess_failed " + Tt), (0, pt.isGift)(t) && i.push("im-mess_gift");
        var n = v(t),
            o = P(t.text, t.kludges);
        "" != o && (0, pt.wasEdited)(t) && (o += di("sImLblWasEdited", {
            update_time: t.update_time
        })), t.subject && "..." !== t.subject.trim() && !E(t.peerId) && (o = di("im_topic", {
            topic: t.subject
        }) + o);
        var s = di("im_message_media", {
            messageId: t.messageId,
            attaches: n.join(""),
            text: (0, pt.isGift)(t) ? '<div class="im-mess--gift-lbl">' + o + "</div>" : ""
        });
        return (0, pt.isGift)(t) || (s = o + s), "" == o && (0, pt.wasEdited)(t) && (s += di("sImLblWasEdited", {
            update_time: t.update_time
        })), di("im_msg_row", {
            msg_id: t.messageId,
            from_id: t.peerId,
            ...
            unread_params: r ? 'aria-label="' + fi("mail_unread_message") + '" role="link" tabindex="0"' : "",
            cls: i.join(" ")
        })
    }
    ...
    function b(e, t, i) {
        var r = (arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : !0, arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : !0),
            ...
            o = e.tabs[t.peerId];
        if (!i || ii("_im_mess", i) || ii("_im_bar_date", i) || (i.innerHTML = ""), o.skipped > 0) return i;
        var s = [];
        t.local || (s = e.imQueue(t.peerId, r)), s.length > 0 && Z(s.map(function(e) {
            return ii("_im_mess_rid" + e.rid, i)
        }, i).filter(function(e) {
            return e
        }));
        var c = g(e, t),
            u = $t(i);
        si(u, "_im_mess_stack") || (u = Zt(u, "._im_mess_stack", -1));
        var l = (0, ut.getLastMessage)(e, t.peerId, t.messageId),
            d = ii("_im_unread_bar_row", i),
            f = (0, pt.getUserId)(t),
            h = l ? L(l.date, e) : 0;
        if (!l || M(o, l, t, e, a)) {
            var p = "",
                _ = !1;
            if (d && (0, pt.isOut)(t) && je(e, i, t.peerId), 1 === o.unread && !(0, pt.isOut)(t) && a && (p += di("im_mess_bar", {}), _ = !0, je(e, i, t.peerId)), !Ci(new Date(h))) {
                var m = new Date,
                    v = _ ? "im-page--history-new-bar_hide _im_invisible_bar" : "";
                p += di("im_day_bar", {
                    day: vi(t.date, e.timeshift, !0, fi("months_of", "raw"), !0),
                    date: t.date,
                    day_class: m.getDate() + m.getMonth() + m.getFullYear() + " " + v
                })
            }
            if (oe(t)) p += di("im_service_row", {
                text: ce(e, t, o),
                type: "",
                date: t.date,
                from_id: "",
                ...
                var b = e.gid && (0, pt.isOut)(t) ? Vt(t.kludges.from_admin) || 0 : 0,
                    y = (0, bt.oCacheGet)(e, b ? -e.gid : f) || o,
                    w = E(t.peerId) ? y.name : y.first_name,
                    N = y.link || o.href,
                    T = di("im_mess_stack_name", {
                        name: w,
                        link: N,
                ...
                if ((0, pt.isGift)(t)) {
                    ...
                    T += ' <span class="im-mess-stack--gift">' + hi(y.sex || 0, F) + "</span>"
                }
                if ((0, pt.isMoney)(t)) {
                    var k = (0, pt.isMoneyRequest)(t) ? fi("mail_money_request_message_sent", "raw") : fi("mail_money_tranfer_message_sent", "raw");
                    T += ' <span class="im-mess-stack--money-transfer">' + hi(y.sex || 0, k) + "</span>"
                }
                t.attaches[0] && "chronicle_invite" === t.attaches[0].type && (T += " " + fi("mail_chronicle_invite_inf"));
                var S = e.gid ? "/gim" + e.gid : "/im",
                    x = void 0;
                if (x = t.local ? R(t.date, e.timeshift) : di("im_stack_date", {
                        date: R(t.date, e.timeshift),
                        link: S + "?sel=" + t.peerId + "&msgid=" + t.messageId
                    }), b && e.admins[b]) {
                    var I = e.admins[b],
                        O = b === Ht.id ? fi("mail_by_you") : I[0];
                    x = x + " " + di("im_admin_link", {
                        name: O,
                        href: I[1]
                    })
                }
            ...
            }(0, vt.toArray)(Wt(p)).forEach(function(e) {
                return i && i.appendChild(e)
            })
        } else d && e.peer === t.peerId && !o.inplaceSearch && (0, pt.isOut)(t) && je(e, i, t.peerId), ii("_im_stack_messages", u).appendChild(qt(c));
        return (0, pt.isOut)(t) && !n && setTimeout(function() {
            var e = ii("_im_mess_" + t.messageId, i);
            si(e, Nt) && ai(e, "im-mess_sending")
    ...
    function y(e) {
        var t = ii("_im_mess_blind_unread_marker", e);
        t && (t.removeAttribute("aria-label"), t.removeAttribute("role"), t.removeAttribute("tabindex"))
    }

    function w(e, t, i) {
        var r = e.tabs[t];
        return (0, vt.toArray)(ti("_im_mess_unread", i)).forEach(function(e) {
            var t = Vt(ei(e, "msgid"));
            t > 0 && r.out_up_to >= t && (ni(e, "_im_mess_unread"), ni(e, "im-mess_unread"), y(e))
        }), i
    }

    function N(e, t, i) {
        var r = ii("_im_msg_media" + t.messageId, e);
    ...
    function M(e, t, i, r, a) {
        if ((0, pt.getUserId)(t) !== (0, pt.getUserId)(i)) return !0;
        var n = L(t.date, r),
            o = L(i.date, r);
        return bi(n, o) ? (0, ut.isCommunityInterface)(r) && Vt(t.kludges.from_admin) !== Vt(i.kludges.from_admin) ? !0 : i.date - t.date > 300 ? !0 : oe(t) || oe(i) ? !0 : (0, pt.isGift)(t) || (0, pt.isGift)(i) ? !0 : (0, pt.isGraffiti)(t) || (0, pt.isGraffiti)(i) ? !0 : (0, pt.isUnread)(e, t) !== (0, pt.isUnread)(e, i) && a && !(0, pt.isOut)(i) ? !0 : !1 : !0
    }

    function R(e, t) {
        return pi(1e3 * e, "{hour}:{minute} {am_pm}", 1e3 * t, [], !0)
    }

    function P(e, t) {
        var i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : !1;
        return e = (0, _t.replaceHyperLinks)(e || "", _t.linksReplacer.bind(null, i)), e = (0, _t.replaceMentions)(e), e = (0, _t.replaceEmailLinks)(e), t.emoji && (e = Ii.emojiToHTML(e, !0)), e
    }
    ...
    function Y(e) {
        ...
        return t.length > i && (t = t.slice(0, i)), '<li class="im-popular clear_fix">' + t.map(function(t) {
            ...
            return '<div class="' + o + '" data-peer="' + i + '">\n    <a class="im-popular--avatar-w ' + Si(a.online) + '" href="' + r.link + '"><img class="im-popular--avatar" src="' + r.photo + '"/></a>\n    <div class="im-popular--name-w"><a class="im-popular--name" href="' + r.link + '">' + (r.first_name || r.name) + '</a></div>\n    <span class="im-popular--unread _sugg_unread_ct">' + B(a.unread) + "</span>\n</div>"
        }).join("") + "</li>"
    }

    function X(e, t, i) {
        var r = ii("_im_mess_" + t.messageId, i);
        if (r) {
            ci(r, "aria-hidden", "false"), ai(r, "im-mess_failed " + Tt);
            var a = ii("_im_mess_marker", r);
            ci(a, "aria-label", fi("mail_send_message_error")), ci(a, "role", "link")
        }
        return i
    }

    function $(e, t, i) {
        var r = ii("_im_mess_" + t, i);
        if (r) {
            ni(r, "im-mess_failed"), ci(r, "aria-hidden", "true"), ni(r, Tt);
            var a = ii("_im_mess_marker", r);
            ci(a, "aria-label", ""), ci(a, "role", "")
        }
        return i
    }
    ...
    function Z(e, t) {
        ...
        return e.forEach(function(e) {
            ...
            return ri("_im_mess_stack", e)
        }).forEach(function(e) {
            var t = Xt(e);
            si(t, "_im_bar_date") && zt(t), zt(e)
        }), t
    }

    function ee(e, t, i, r) {
        return e.map(function(e) {
            return ii("_im_mess_" + e, r)
        }).filter(function(e) {
            return e
        }).forEach(function(e) {
            li(e, ae(t, e, i)), ai(e, "im-mess_light")
        }), r
    }

    function te(e, t, i) {
        var r = ii("_im_mess_" + e, i);
        if (r) {
            var a = ii(Ft, r);
            li(r, a.innerHTML), ni(r, "im-mess_light")
        }
        return i
    }
    ...
    function ie(e, t, i, r) {
        ...
        var o = ((0, ut.isClassicInterface)(r), 60),
            s = re(e, t, i, r, !1, a);
    ...
    function re(e, t, i, r, a) {
        ...
        if (o.length > 10 && (0, Ct.imWeirdLog)("too_much_typers", {
                nTypers: o.length,
                typers: e,
                peer: t,
                tabName: r.tabs[t].tab,
                typersJson: JSON.stringify(e)
            }), k(t) || (0, ut.isCommunityPeer)(t)) {
            var s = i ? "" : (0, bt.oCacheGet)(r, t).first_name;
            return s + " " + fi("mail_typing")
        }
        var c = fi("mail_typing_several", o.length),
            u = o.slice(0, o.length > n ? n : n - 1).filter(function(e) {
                return (0, bt.oCacheExists)(r, e)
            }),
            l = a ? "short_name" : "name",
            d = u.map(function(e) {
                return (0, bt.oCacheGet)(r, e)[l]
            }).join(", ");
        if (o.length > n) {
            var f = o.length - n;
            d += " " + fi("mail_and_peer").replace("{count}", f).replace("{typing}", c)
        } else {
            var h = !!d,
                p = void 0;
            h && o[n - 1] && (d += " " + fi("mail_and_peer_one") + " "), p = h && o.length !== n || !o[n - 1] ? "" : (0, bt.oCacheGet)(r, o[n - 1])[l], d += p + " " + c
        }
        return d
    }
    ...
    function ae(e, t, i) {
        ...
        return '<div class="im-mess--text">\n    ' + fi(a) + ' <button type="button" data-peer="' + e + '" class="' + kt + ' im-mess--btn">' + fi("mail_restore") + '</button>\n    <div class="' + Ft + ' im-mess--original">' + r + "</div>\n  </div>"
    }
    ...
    function ce(e, t, i) {
        ...
        if (u = hi(c.sex, fi(u, "raw")), u = u.replace("{from}", se(c.link, c.name, r)), o && o !== s) {
            var d = a.source_email;
            if (d) u = u.replace("{user}", se("/im?email=" + encodeURIComponent(d), "email", r));
            else {
                var f = (0, bt.oCacheGet)(e, o),
                    h = n === It ? f.inv_name : f.kick_name;
        ...
        if (a.source_act === Mt || a.source_act === Rt)
            if (a.source_message) {
                var _ = le(Ii.emojiToHTML(Qt(a.source_message.replace(/<br\s?\/?>/gi, " ")), !0)),
    ...
    function ue(e, t, i, r) {
        if (t === Ot) {
            var a = ii("_im_mess_" + e.messageId, r);
            if (a) {
                var n = i.tabs[e.peerId];
                a.parentNode.innerHTML = di("im_msg_row", {
                    msg_id: e.messageId,
                    from_id: e.peerId,
    ...
    function he(e) {
        return function(t) {
            var i = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "bottom",
                ...
                n = !1;
            setTimeout(function() {
                n || ("bottom" === i ? e.appendChild(a) : e.insertBefore(a, Yt(e)), ai(a, "im-preloader_visible"))
            }, 0), t.then(function() {
                n = !0, ni(a, "im-preloader_visible"), a.parentNode && a.parentNode.removeChild(a)
            })
        }
    }
    ...
    function _e(e, t) {
        ...
        do
            if (!i || i.onclick || i.onmousedown || "A" == i.tagName || si(i, "_im_no_select") || si(i, "im_msg_media_link") || "IMG" == i.tagName && !si(i, "_im_graffiti") && !si(i, "emoji") && !si(i, "emoji_css") && !si(i, "im_gift") || "TEXTAREA" == i.tagName || si(i, "play_new") || si(i, "videoplayer") || (a = n.test(i.className))) break; while (r-- && (i = i.parentNode));
        return a ? !!Kt(me()) : !0
    }
    ...
    function ge(e, t) {
        return '<div class="im-mess--text">\n      <span>' + fi("mail_restored") + '</span>\n      <a class="_im_go_to" href="/im?sel=' + A(e) + "&msgid=" + t + '">' + fi("mail_im_goto_conversation") + "</a>\n    </div>"
    }

    function ve(e, t) {
        var i = fi(E(e) ? "mail_chat_sure_to_delete_all" : (0, ut.isCommunityPeer)(e) ? "mail_group_sure_to_delete_all" : "mail_sure_to_delete_all");
        return Ni({
            title: fi("mail_deleteall1"),
            dark: 1,
            bodyStyle: "padding: 20px; line-height: 160%;"
        }, i, fi("mail_delete"), t, fi("global_cancel"))
    }

    function be(e) {
        return Ni({
            title: fi("mail_unpin_title"),
            dark: 1,
            bodyStyle: "padding: 20px; line-height: 160%;"
        }, fi("mail_unpin_text"), fi("mail_unpin"), e, fi("global_cancel"))
    }
    ...
    function ye(e, t, i, r, a) {
        ...
        Mi(r), wi("al_im.php", {
            ...
            onDone: function(r, a) {
                var n = (0, gt.createModule)({
                    handlers: function(a, o) {
                        o(r.bodyNode.parentNode, "click", "_im_invite_box", function() {
                            r.hide(), we(e, e.get().peer, t, i), (0, gt.destroyModule)(n)
                        }), o(r.bodyNode.parentNode, "mouseover", "im_status_mob_onl", function(e, t) {
                            var i = ii("_im_chat_members_w", r.bodyNode.parentNode),
                                a = 160,
                                n = ri("_im_member_item", t),
                                o = n.offsetTop - i.scrollTop + a,
                                s = o > 370;
                            ki(t, {
                                was: Vt(ei(t, "was")),
                                mid: Vt(ei(t, "peer")),
                                vk_mobile: Vt(ei(t, "vk_mobile")),
                                forcetoup: s
                            })
                        })
                    }
    ...
    function Te(e, t, i, r) {
        ...
        var a = (0, ut.isReversedDialogs)(t);
        return t.set(r.bind(null, e)).then(function(e) {
            return i().restoreDialogs(e, !0, a !== (0, ut.isReversedDialogs)(e)), e
        })
    }
    ...
    function Fe(e, t) {
        ...
        var i = e.get().tabs[t];
        return ht.FOLDER_MASKS[ht.FOLDER_IMPORTANT] & i.folders
    }
    ...
    function Ie(e, t) {
        ...
        Object.keys(i).forEach(function(r) {
            i[r].time ? i[r].free === !1 && Date.now() - i[r].time >= 5e4 && t.push([dt.mutexEvent([, 1, "gim" + e.get().gid, r, 0, ""])]) : i[r].time = Date.now()
        })
    }
    ...
    function Oe(e, t, i) {
        ...
        return !Ti("al_im.php", {
            ...
            params: {
                width: 638,
                onHide: function() {
                    xi.loaded && xi.detachPlayer(!0), r.unmount()
                }
            }
        }, i)
    }
    ...
    function Le(e, t) {
        var i = (0, ut.getTab)(e, t).last_seen;
        if (i[0]) return 2 === i[2] ? '<span class="is_vk_mobile is_online">' + fi("mail_header_online_status") + Me(t, !1, !0) + "</span>" : "online" + (Ei[i[0]] ? Me(t) : "");
        if (!i[1]) return "";
        var r = mi(i[1], e.get().timeshift),
            a = hi((0, bt.oCacheGet)(e, t).sex, fi("mail_last_activity_tip", "raw")).replace("{user}", "").replace("{time}", r);
    ...
    function He(e, t, i) {
        var r = ii("_im_mess_" + e, i);
        return r && oi(r, "im-mess_fav", t), i
    }

    function je(e, t, i) {
        var r = ii("_im_unread_bar_row", t);
        if (!r) return t;
        var a = Zt(r, "._im_mess_stack", -1),
            n = Zt(r, "._im_mess_stack"),
            o = a ? ti("_im_mess", a).pop() : null,
            s = n ? ii("_im_mess", n) : null;
        if (zt(r), _(t), !s || !o) return t;
        var c = ei(o, "msgid"),
            u = ei(s, "msgid"),
            l = (0, ut.getMessage)(e, i, c),
            d = (0, ut.getMessage)(e, i, u);
        if (M(e.tabs[i], l, d, e)) return t;
        var f = ii("_im_stack_messages", a),
            h = ii("_im_stack_messages", n).children;
        return (0, vt.toArray)(h).forEach(function(e) {
            zt(e), f.appendChild(e)
        }), zt(n), t
    }
    ...
    function qe(e, t, i) {
        ...
        if (!r) return [!1, 0];
        var a = ii("_im_mess_" + r, t);
        if (!a) {
            var n = (0, ut.getLastMessage)(e, e.get().peer, r);
            if (!n) return [!0, 0];
            a = ii("_im_mess_" + n.messageId, t)
        }
        var o = si(a, "_im_mess_srv") ? a : ri("_im_mess_stack", a);
        if (!o) return [!0, 0];
    ...
    function ze(e, t, i) {
        Mi(t);
        var r = ri("_im_top_notice", i);
        Li(r, 200, zt.pbind(r));
        var a = ri("_im_page_dialogs", r);
        a && si(a, "im-page--dialogs-notice") && ni(a, "im-page--dialogs-notice"), yi.post("al_im.php", {
    ...
    function Ue(e, t, i) {
        Mi(t);
        var r = ri("_im_aside_notice", i);
        Oi(r, 200, zt.pbind(r)), yi.post("al_im.php", {
            act: "a_hide_top_notice",
            type: r.getAttribute("data-type"),
            hash: r.getAttribute("data-hash")
        })
    ...
    function We(e, t, i, r, a) {
        return i = i.replace(/\<br\s*\/?\>(\n)?/gi, " ").replace(/[\n\r]/gi, " "), i = (0, _t.replaceMentions)(i, function(e, t, i, r, a) {
            return a
        }), r && (i = Ii.emojiToHTML(i, !0)), t && "..." !== t.trim() && !E(e) && (i = di("im_topic", {
            topic: t,
            cls: "im-topic_dialog"
        }) + i), !i && a.length > 0 && (i = di("im_dialog_media", {
            name: Qe(a[0], a)
        })), i
    }
    ...
    function Ke(e) {
        ...
        var c = Ve(i, r),
            u = st(c, 1),
            l = u[0];
        return Object.keys(Bi).length > 300 && (Bi = {}), Bi[e] = l, l
    }
    ...
    function Qe(e, t) {
        ...
        switch (e.type) {
            case "mail":
                return _i(e.object.fwd_count, fi("mail_fwd_msgs", "raw"), !0);
            case "photo":
            case "video":
            case "audio":
            ...
            case "chronicle":
                return fi("mail_added_chronicle");
            case "chronicle_invite":
                return fi("mail_invite_chronice");
            case "market":
    ...
    function Ye(e) {
        ai(e, "im-send-btn_loading")
    }

    function Xe(e) {
        ni(e, "im-send-btn_loading")
    }

    function $e(e) {
        var t = e.get(),
            i = (0, ut.getPinnedMessage)(e);
        if (!i || !(0, yt.isPinnedMessageVisibleInTab)(e, (0, ut.getPeer)(e))) return "";
        var r = (0, bt.oCacheGet)(e, i.userId);
        if (!r) return "";
        var a = i.text;
        a = !a && i.attaches.length ? di("im_pinned_message_media", {
            text: Qe(i.attaches[0], i.attaches)
        }) : P(a, i && i.kludges || {}) || "", a = a.replace(/<br\s?\/?>/gi, " ");
        var n = di("im_pinned_message", {
            date: gi(i.date, t.timeshift),
            content: a,
            link: r.link,
            name: r.name
        });
    ...
    function tt(e, t) {
        var i = (0, bt.oCacheGet)(e, t.peerId);
    ...
    function it(e, t) {
        for (var i in t) t.hasOwnProperty(i) && tt(e, t[i])
    }
    ...
    function rt(e, t) {
        var i = [],
            ...
            a = r ? r[1].split(";") : [];
        for (a.length > Pi && (r[1] = a.slice(0, Pi).join(";")); e.length > Ri;) {
            var n = e.substr(0, Ri).lastIndexOf(" "); - 1 == n && (n = Ri), i.push({
                msgText: Kt(e.substr(0, n))
            }), e = Kt(e.substr(n))
        }
        for (e.length && i.push({
                msgText: e,
                ...
                attaches: t
            }), a = a.slice(Pi); a.length; a = a.slice(Pi)) i.push({
            attaches: [
                ["mail", a.slice(0, Pi).join(";")]
            ]
        });
        return i
    }
    ...
    function nt(e, t, i) {
        ...
        wi("al_im.php", {
            ...
            onDone: function(t, i) {
                r = (0, mt.mount)(t.bodyNode, e)
            }
        }, {})
    }

    function ot() {
        Ni(fi("global_error"), fi("mail_message_wait_until_uploaded"))
    }
    Object.defineProperty(t, "__esModule", {
        value: !0
    ...
    var lt = i(142),
        ...
        Et = (t.TYPING_CLASS = "_im_typing", t.CREATE_CHAT_ACTION = "chat_create"),
        St = t.CHAT_TITLE_ACTION = "chat_title_update",
        xt = t.CHAT_INVITE_USER = "chat_invite_user",
        It = t.CHAT_KICK_USER = "chat_kick_user",
        Ot = t.CHAT_PHOTO_UPDATE = "chat_photo_update",
        Lt = t.CHAT_PHOTO_REMOVE = "chat_photo_remove",
        Mt = t.CHAT_PIN_MESSAGE = "chat_pin_message",
        Rt = t.CHAT_UNPIN_MESSAGE = "chat_unpin_message",
        Pt = t.CHAT_INVITE_BY_LINK = "chat_invite_user_by_link",
        At = (t.DESELECT_ALL_CLASS = "_im_deselect_all", t.SHOW_CHAT_MEMBERS_CLASS = "_im_show_chat_mems", t.HIDE_TOP_NOTICE_CLASS = "_im_top_notice_hide", t.HIDE_ASIDE_NOTICE_CLASS = "_im_aside_notice_hide", t.CLEAR_RECENT_CLASS = "_im_clear_recent"),
        Dt = t.MESSAGE_SEARCH_CLASS = "_im_mess_search",
        Bt = window,
        Ht = Bt.vk,
        jt = Bt.ls,
        qt = Bt.se,
        ...
        Ti = Bt.showTabbedBox,
        Fi = Bt.showTooltip,
        ki = Bt.mobileOnlineTip,
        Ei = Bt.mobPlatforms,
        Si = Bt.onlinePlatformClass,
        xi = Bt.AudioMessagePlayer,
        Ii = Bt.Emoji,
        Oi = Bt.slideUp,
        Li = Bt.fadeOut,
        Mi = Bt.cancelEvent,
    ...
    var r = i(24),
        ...
        u = function() {
            var e, t = i(6)("iframe"),
                r = n.length,
                a = ">";
            for (t.style.display = "none", i(79).appendChild(t), t.src = "javascript:", e = t.contentWindow.document, e.open(), e.write("<script>document.F=Object</script" + a), e.close(), u = e.F; r--;) delete u[c][n[r]];
            return u()
        };
    ...
    function n(e, t) {
        ...
        return Object.keys(r.msgs).filter(function(i) {
            var a = v(e, t, i);
            return !(0, j.isOut)(a) && intval(i) > r.in_up_to;
        })[0]
    }
    ...
    function d(e, t) {
        ...
        for (var o in r.msgs)
            if (r.msgs.hasOwnProperty(o)) {
                var c = v(t, e, o);
                (0, j.isOut)(c) || (n += (0, j.isUnread)(r, c) ? 1 : 0)
            }
        return n
    }
    ...
    function _(e, t, i) {
        var r = s(e, t),
            ...
            n = Object.keys(r.msgs).filter(function(i) {
                var r = v(e, t, i),
                    n = r.local && r.type !== q.EDIT_MESSAGE;
    ...
    function g(e, t, i) {
        var r = s(e, t),
            n = v(e, t, i),
            o = a(e);
        return (0, j.isOut)(n) ? (0, G.oCacheGet)(e, o.id).name : n.userId !== n.peerId ? (0, G.oCacheExists)(e, n.userId) ? (0, G.oCacheGet)(e, n.userId).name : !1 : r.tab
    }
    ...
    function T(e) {
        var t = a(e);
        return w(e) ? 19542789 !== t.gid && 103416369 != t.gid ? !1 : t.active_tab === U.FOLDER_UNRESPOND || t.active_tab === U.FOLDER_UNREAD ? !0 : !1 : !1
    }
    ...
    function R(e, t) {
        var i = a(e);
        return t && t !== M(e) || i.recentSearch ? !0 : !1
    }
    ...
    var r = i(71),
        a = i(81)("iterator"),
        n = i(57);
    e.exports = i(127).getIteratorMethod = function(e) {
    ...
    var r = i(82),
        ...
        n = i(10),
        o = {};
    i(146)(o, i(81)("iterator"), function() {
        return this
    }), e.exports = function(e, t, i) {
        e.prototype = r(o, {
            next: a(1, i)
