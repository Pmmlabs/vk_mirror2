! function(e) {
    ...
    126: function(e, t, n) {
        ...
        function _(e, t) {
            ...
            return Promise.resolve(t).then(function(t) {
                return t.tabHistoryNotChanged = !1, Object(Bt.isFullyLoadedTab)(t, n) && !t.tabs[n].msgid ? (t.gid && m(n, t), Promise.resolve(t).then(y)) : (Object(Bt.isFullyLoadedTab)(t, n) && (t.tabs[n].msgid = !1), f(n, e, !1, !0, t))
        ...
        function v(e, t, n) {
            var r = n.msgid,
                i = n.peer;
            return !e && Object(Bt.isFullyLoadedTab)(n, i) && n.tabs[i].msgs[r] ? (t === n.peer ? n.tabHistoryNotChanged = !0 : n.tabHistoryNotChanged = !1, n.gid && m(i, n), Promise.resolve(n).then(y).then(g.bind(null, i))) : f(i, !0, r, !0, n).then(y).then(function() {
        ...
        function He(e) {
            ...
            return Object(Lt.post)(Lt.CONTROLLER, {
                ...
                return h.then(function(n) {
                    e.tabs = o, e.admins = extend(e.admins, d), n && (e.tabs[f] = n.tabs[f], e.tabs[f].history = Object(Bt.restoreQueue)(f, e, u(e.tabs[f].history))),
                        e.loadingDialogs = !1, e.mutedPeers = c.mutedPeers, e.lastDialogsOptions = {
                            has_more: c.has_more
    ...
    158: function(e, t, n) {
        ...
        function N(e, t, n) {
            ...
            if (!d || B(o, d, t, e, i)) {
                var p = "",
                    m = !1;
                if (l && Object(Ft.isOut)(t) && Ke(e, n, t.peerId), 1 === o.unread && !Object(Ft.isOut)(t) && i && (p += Mn("im_mess_bar", {}), m = !0, Ke(e, n, t.peerId)), !Un(new Date(h))) {
                    var _ = new Date,
                ...
                if (Object(Ft.isServiceMsg)(t)) p += Mn("im_service_row", {
                    text: he(e, t, o),
                    type: "",
                    date: t.date,
                    from_id: "",
                ...
                else if (Object(Ft.isCallMessage)(t)) p += Mn("im_service_row", {
                    text: fe("", k(t, !1, e), ""),
                    type: "",
                    date: t.date,
                    from_id: "",
        ...
        function Te(e, t, n, r) {
            var i = Rn("mail_dialog_msg_delete_N", t),
                ...
                o = "",
                s = !1;
            return n && (o = '<div class="checkbox im-delete-forall-checkbox _check_forall" onclick="checkbox(this);" role="checkbox" aria-checked="false">' + Rn("mail_delete_for_all") + "</div>", s = cur.imDb.selectByKey("del_forall_checked")),
                a.setControlsText(o), s && checkbox(Fn("_check_forall")), a
        }
        ...
        function yt(e, t) {
            ...
            var h = l.slice(0, f - 1).join(", "),
                p = l.pop();
            return Rn("global_and").replace(/{before}/gi, h).replace(/{after}/gi, p)
        }
    ...
    177: function(e, t, n) {
        ...
        n.r(t), n(161), n(117), n(195), n(24), n(76), n(13), n(81), window.getWndInner = r, window.lastWndScroll = [!1, !1], window.updateWndVScroll = i, window.defBox = a;
        try {
    ...
    195: function(e, t, n) {
        ...
        function r(e, t) {
            ...
            this.toBottom = ("auto" === o || "" === o || browser.msie && 0 === o) && "auto" != s && "" !== s && !(browser.msie && 0 === s), this.toRight = ("auto" === c || "" === c || browser.msie && 0 === c) && "auto" != u && "" !== u && !(browser.msie && 0 === u), this.toRight && setStyle(n.wrap, {
                    ...
                    marginRight: lastWndScroll[0] ? sbWidth() : 0
                }), addClass(n.wrap, "fc_tobottom")),
                this.options.marginFixedToLayer && setStyle(n.wrap, {
                    marginRight: hasClass(document.body, "layers_shown") ? sbWidth() : 0
    ...
    24: function(__webpack_module__, __webpack_exports__, __webpack_require__) {
        "use strict";
        __webpack_require__.r(__webpack_exports__);
        var _helpers_im_shared_helpers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(89),
            _longpoll_singleton__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(74),
        ...
        window.curNotifier || (window.curNotifier = {
            ...
            proxyIm: function(e) {
                return this.isActive() ? (this.playSound(e), void(Notifier.canNotifyUi() && cur.peer != e.author_id && Notifier.shouldDisturb(e) && (e.onclick = "IMBRIDGE.activateTab(" + e.author_id + ");",
                    Notifier.showEventUi(e)))) : void(curNotifier.is_server ? (e.onclick = "IMBRIDGE.activateTab(" + e.author_id + ");", this.sendImProxy(e)) : curNotifier.is_server || this.lcSend("message_from_im", e))
            },
