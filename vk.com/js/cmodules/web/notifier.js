! function(e) {
    ...
    var a = i(77),
        r = i(96),
        n = i(5);
    e.exports = i(152) ? Object.defineProperties : function(e, t) {
        r(e);
    ...
    var a = i(77),
        r = i(13);
    e.exports = i(152) ? function(e, t, i) {
    ...
    e.exports = {
        set: Object.setPrototypeOf || ("__proto__" in {} ? function(e, t, a) {
            try {
                a = i(139)(Function.call, i(165).f(Object.prototype, "__proto__").set, 2), a(e, []), t = !(e instanceof Array)
            } catch (r) {
                t = !0
            }
            return function(e, i) {
    ...
    var a = i(110),
        ...
        n = i(140),
        o = i(95);
    e.exports = i(28)(Array, "Array", function(e, t) {
    ...
    e.exports = i(123).document && document.documentElement
}, , , function(e, t, i) {
    var a = i(94);
    e.exports = function(e, t, i) {
    ...
    function p(e, t, i, a, r) {
        return r.tabHistoryNotChanged = !1, (0, zt.retryFn)(Bt.post, 3, function(e) {
            ...
            if (o.forEach(function(e) {
                ...
                }), r.tabs || (r.tabs = {}), r.dialog_tab_cts = u, r.tabs[e] || (r.tabs[e] = (0, Gt.normalizeTab)(r, n)), h(c, r), i) {
                if (r.tabs[e]) {
            ...
            return r.admins = extend(r.admins, s), r.imQueue(e, !1), At(), m(e, r)
        })["catch"](function(e) {
    ...
    function v(e, t) {
        ...
        return Promise.resolve(t).then(function(t) {
            return t.tabHistoryNotChanged = !1, (0, Gt.isFullyLoadedTab)(t, i) && !t.tabs[i].msgid ? (t.gid && g(i, t), Promise.resolve(t).then(k)) : ((0, Gt.isFullyLoadedTab)(t, i) && (t.tabs[i].msgid = !1), p(i, e, !1, !0, t))
    ...
    function C(e, t, i) {
        var a = i.msgid,
            r = i.peer;
        return !e && (0, Gt.isFullyLoadedTab)(i, r) && i.tabs[r].msgs[a] ? (t === i.peer ? i.tabHistoryNotChanged = !0 : i.tabHistoryNotChanged = !1, i.gid && g(r, i), Promise.resolve(i).then(k).then(b.bind(null, r))) : p(r, !0, a, !0, i).then(k).then(function() {
    ...
    function y(e, t, i) {
        if (Xe(i)) throw (0, Gt.showWaitUntilUploadedBox)(), new Error("Cant change peer while loading somethind");
        var a = i.gid ? "gim" + i.gid : "im";
        if (i.prevPeer = i.peer, i.peer = e, i.msgid = t || "", cur.peer = e, ii({
            ...
            var r = [];
            (0, Gt.isTabLoaded)(i, e) && b(e, i, !0), r = i.tabbedPeers.map(function(e) {
                return e.peer
            }).indexOf(e) < 0 ? [{
                peer: e,
                type: "perm"
    ...
    function k(e) {
        ...
        var i = e.tabs[t],
            a = [];
        i.offset && a.push("photos"), i.offset && a.push("search"), (-2e9 > t || i.offset) && a.push("clear"), (0, Gt.isCommunityInterface)(e) && a.push("block"), (0, Gt.isCommunityPeer)(t) && (i.blocked_community ? a.push("allow_community") : a.push("block_community")), !(0, Gt.isChatPeer)(t) && !(0, Gt.isUserPeer)(t) || (0, Gt.isCommunityInterface)(e) || (0, Gt.isChatPeer)(t) && (i.data.kicked || i.data.closed) || (inArray(t, e.mutedPeers) ? a.push("unmute") : a.push("mute")), (0, Gt.isUserPeer)(t) && !e.gid && !i.blacklisted && i.is_friend && a.push("invite"), (0, Gt.isChatPeer)(t) && !i.data.closed && !i.data.kicked && i.data.link && a.push("invite_link"), !(0, Gt.isChatPeer)(t) || i.data.closed || i.data.kicked || a.push("topic", "avatar", "invite", "leave"), (0, Gt.isChatPeer)(t) && i.data.closed && !i.data.kicked && a.push("return"), (0, Gt.isChatPeer)(t) && i.pinned && (geByClass1("im-page--chat-header_hide-pin-actions") || (a.push((0, $t.isPinnedMessageVisibleInTab)(e, t) ? "pin_hide" : "pin_unhide"), a.push("unpin")));
        var r = (0, Gt.chatActions)(e);
    ...
    function F(e, t, i, a) {
        var r = e.tabs[t];
        return a === qt.FLAG_OUTBOUND ? r.out_up_to = i : r.in_up_to = i, e
    }
    ...
    function L(e, t, i, a) {
        ...
        t.deletedDialog || (e.dialog_tabs = Object.keys(e.dialog_tabs).reduce(function(e, n) {
            return !i && !it(n)(t) || r && !r(n, e[n], t) || (e[n] = (0, Ut.arrayUnique)(a(e[n], n))), e
        }, e.dialog_tabs))
    }
    ...
    function D(e, t) {
        ...
        if ((0, Gt.isTabLoaded)(t, a)) {
            var n = t.tabs[a];
            if (n.deletedDialog = !1, !t.msg_local_ids_sort && e.local ? t.msg_local_ids_sort = r({}, e.messageId, 0) : e.local && (t.msg_local_ids_sort[e.messageId] = Object.keys(t.msg_local_ids_sort).length), i ? n.unread = 0 : (n.lastmsg == e.messageId && n.unread ? B(t, 1, e.peerId) : (!n.unread && B(t, 1, e.peerId), n.unread++), R(e.peerId, t)), (0, Gt.isFullyLoadedTab)(t, a)) {
                var o = u(n.history);
                n.skipped > 0 && n.skipped++, n.offset++, n.msgs[e.messageId] = extend(!0, {}, e), n.history = (0, Gt.appendToHistory)(t, e, o, !0, !0, !0), (0, Qt.isOut)(e) && (n.blocked_community = 0, k(t))
            }
    ...
    function j(e, t) {
        if ((0, Gt.isFullyLoadedTab)(t, e.peerId)) {
            var i = t.tabs[e.peerId],
                a = i.unread;
            if (t = F(t, e.peerId, e.upToId, 0), null != e.unread ? i.unread = e.unread : i.unread = e.upToId >= i.lastmsg ? 0 : (0, Kt.countUnread)(e.peerId, t) + (i.unread > 0 ? +i.skipped : 0), a > 0 && !i.unread && B(t, -1, e.peerId), !i.skipped) {
                var r = u(i.history);
                i.history = (0, Gt.removewNewUnreadBarAndMerge)(t, r, e.peerId)
            }
        } else(0, Gt.isTabLoaded)(t, e.peerId) && (t.tabs[e.peerId].unread > 0 && B(t, -1, e.peerId), t.tabs[e.peerId].unread = 0, t.tabs[e.peerId].in_up_to = e.upToId);
        ...
        })), 0 !== t.unread_cnt || t.active_tab !== Vt.FOLDER_UNREAD || t.gid ? Promise.resolve(t) : at(Vt.FOLDER_ALL, t)
    }

    function H(e, t) {
        var i = t.tabs[e.peerId];
        if ((0, Gt.isTabLoaded)(t, e.peerId) && F(t, e.peerId, e.upToId, qt.FLAG_OUTBOUND), (0, Gt.isFullyLoadedTab)(t, e.peerId)) {
            var a = u(i.history);
    ...
    function V(e, t, i) {
        return (0, zt.pause)(Jt + 2).then(function() {
            if ((0, Gt.isTabLoaded)(i, e)) {
                var a = i.tabs[e];
                if (a.typing) {
                    var r = Date.now() - (a.typing[t] || 0);
                    r >= 1e3 * Jt && delete a.typing[t]
                }
            }
            return i
        })
    ...
    function Oe(e, t, i, a) {
        function r(e, t) {
            (0, Gt.isChatPeer)(e) && t && !(0, Yt.oCacheExists)(a, t) && (n[e] ? -1 === n[e].indexOf(t) && n[e].push(t) : n[e] = [t])
        }
        var n = {},
            o = t.filter(function(e) {
                return !(0, Gt.isTabLoaded)(a, e.peerId)
            }).map(function(e) {
                return p(e.peerId, 0, 0, 0, a)
            });
        t.forEach(function(e) {
            (0, Gt.isTabLoaded)(a, e.peerId) && r(e.peerId, e.userId)
        }), e.forEach(function(e) {
    ...
    function Le(e, t, i, a) {
        return t !== vk.id ? Promise.resolve(a) : ((0, Gt.isTabLoaded)(a, i) && a.peer == i && (a = k(a)), Promise.resolve(a))
    }
        ...
        return (0, Bt.post)(Bt.CONTROLLER, {
            ...
            return h.then(function(i) {
                ...
                return Object.keys(e.dialog_tabs).filter(function(e) {
                    ...
                    a == Vt.FOLDER_ALL ? e.dialog_tabs[t] = r.filter(it(t)).map(function(e) {
                        return e.peerId
                    }) : e.dialog_tabs[t] = []
                }), delete e.resync_in_process, setTimeout(t.bind(null, !0), 0), $e(intval(c.unread), e)
            })
        })["catch"](function(t) {
            return (0, Ut.lplog)("Resync error: " + t.message + " " + t.stack, "error"), (0, zt.pause)(2).then(We.bind(null, e))
        })
    }
    ...
    function st(e, t, i, a, r) {
        if ((0, Gt.isTabLoaded)(r, e)) {
            var n = r.tabs[e];
            return i === qt.REPLACE_DIRECTORIES && (t ^= n.folders), rt(i, t, n) && Object.keys(Vt.FOLDER_MASKS).filter(function(e) {
                return Vt.FOLDER_MASKS[e] & t
            }).forEach(function(e) {
                r.dialog_tab_cts[e] += nt(n, i, e)
            }), i === qt.SET_DIRECTORIES ? r.tabs[e].folders |= t : i === qt.RESET_DIRECTORIES ? r.tabs[e].folders &= ~t : r.tabs[e].folders = t ^= n.folders, L(r, r.tabs[e], !0, function(t, i) {
    ...
    function ht(e, t, i) {
        return i.tabbedPeers = e, (0, Gt.isClassicInterface)(i) && (ii({
    ...
    function pt(e) {
        return e.peer ? he(e.peer, e) ? fe(e.peer, e) : (0, Gt.isFullyLoadedTab)(e, e.peer) ? e.tabs[e.peer].allShown : !1 : !0
    }
    ...
    function _t(e, t) {
        var i = t.tabs[e];
        return (0, Gt.isFullyLoadedTab)(t, e) && (i.history = f(i.history)), Promise.resolve(t)
    }
    ...
    function Rt(e, t, i, a) {
        var n = (0, Kt.getMessage)(e, i, t),
            o = n.userId;
        return (0, Yt.oCacheGet)(a, o) ? Promise.resolve(a) : Ie(r({}, i, [o]), a)
    }
    ...
    t.readLastMessages = c(function(e, t) {
        ...
        return i.skipped > 0 && (a = a.filter(function(e) {
            ...
            return F(t, e, a, qt.FLAG_OUTBOUND)
        }))
        ...
        return xe(e, (0, Bt.post)("al_im.php", {
            act: "a_flush_history",
            id: e,
            from: "im",
            gid: t.gid,
        ...
        return (0, Bt.post)(Bt.CONTROLLER, {
            ...
            var a = Dt(t, 2),
                r = (a[0], a[1]);
            return i.tabs[e] = extend(i.tabs[e], (0, Gt.normalizeTab)(i, r)), i
        })
        ...
        return e.kludges.source_act === Gt.CHAT_PHOTO_REMOVE ? (delete t.tabs[e.peerId].photo, Promise.resolve(t)) : (0, Bt.post)(Bt.CONTROLLER, {
            ...
            if (t.tabs[e.peerId].photo = r, (0, Gt.isFullyLoadedTab)(t, e.peerId)) {
        ...
        return Pe(e, i, t, a), (0, Bt.post)(Bt.CONTROLLER, {
    ...
    var a = i(9),
        r = i(1)("iterator"),
        n = i(140);
    e.exports = i(158).getIteratorMethod = function(e) {
    ...
    t.f = i(152) ? Object.defineProperty : function(e, t, i) {
    ...
    function o(e) {
        e >= window.clientHeight() - 30 && (e = 0), Qt.set(Vi, e)
    }

    function s(e, t) {
        var i = li(e, t),
            a = i.firstElementChild.offsetHeight !== i.parentNode.offsetHeight;
        a && gi(i.firstElementChild, {
    ...
    function u(e, t, i, a) {
        ...
        return t && (c = '<a onmouseover="return Emoji.stickerOver(' + ei(e) + ', this);"\n        onclick="return Emoji.clickSticker(' + ei(t) + ', this, event);">' + c + "</a>"), c = '<div class="im_sticker_row">' + c + "</div>"
    }
    ...
    function p(e) {
        return bi("im_preloader", {
            preloader: $t(Kt.pr_tpl, {
                id: ""
            }),
    ...
    function _(e) {
        var t = li("_im_invisible_bar", e);
        t && (hi(t, "_im_invisible_bar"), hi(t, "im-page--history-new-bar_hide"))
    }

    function g(e, t, i) {
        var a = v(e, t),
            r = li("_im_mess_" + t.messageId, i);
        return r && (r.parentNode.replaceChild(Yt(a), r), C(i)), i
    }

    function v(e, t) {
        var i = ["_im_mess"],
            a = (0, wt.isUnread)(e.tabs[t.peerId], t);
        (0, wt.isOut)(t) && a && i.push("im-mess_unread _im_mess_unread"), (0, wt.isOut)(t) && i.push("im-mess_out"), (0, wt.wasEdited)(t) && i.push("im-mess_was_edited"), (0, St.canMessageBeEdited)(e, t) && i.push("im-mess_editable"), (0, wt.isImportant)(t) && i.push("im-mess_fav"), -1 != (e.selectedMessages || []).indexOf(t.messageId) && i.push("im-mess_selected");
        var r = Date.now() - 1e3 * t.date > 1e3;
        t.local && r && i.push("im-mess_sending"), t.local && i.push("" + Ot), t.local && (0, wt.wasEdited)(t) && !a && i.push("im-mess_unread im-mess_nobg"), t.failed && i.push("im-mess_failed " + Lt), (0, wt.isGift)(t) && i.push("im-mess_gift");
        var n = b(t),
            o = D(t.text, t.kludges);
        "" != o && (0, wt.wasEdited)(t) && (o += bi("sImLblWasEdited", {
            update_time: t.update_time
        })), t.subject && "..." !== t.subject.trim() && !S(t.peerId) && (o = bi("im_topic", {
            topic: t.subject
        }) + o);
        var s = bi("im_message_media", {
            messageId: t.messageId,
            attaches: n.join(""),
            text: (0, wt.isGift)(t) ? '<div class="im-mess--gift-lbl">' + o + "</div>" : ""
        });
        return (0, wt.isGift)(t) || (s = o + s), "" == o && (0, wt.wasEdited)(t) && (s += bi("sImLblWasEdited", {
            update_time: t.update_time
        })), bi("im_msg_row", {
            msg_id: t.messageId,
            from_id: t.peerId,
            ...
            ts: t.date,
            marker_params: t.failed ? 'aria-label="' + Ci("mail_send_message_error") + '" role="link"' : "",
            unread_params: a ? 'aria-label="' + Ci("mail_unread_message") + '"' : "",
            cls: i.join(" ")
        })
    }
    ...
    function C(e) {
        for (var t = e.getElementsByClassName("_im_mess_noa"), i = t.length; i--;) mi(t[i], "im-mess_fwd") || t[i].insertAdjacentHTML("afterbegin", bi("sImHistoryRowActions")), hi(t[i], "_im_mess_noa")
    }
    ...
    function y(e, t, i) {
        var a = (arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : !0, arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : !0),
            ...
            o = e.tabs[t.peerId];
        if (!i || li("_im_mess", i) || li("_im_bar_date", i) || (i.innerHTML = ""), o.skipped > 0) return i;
        var s = [];
        t.local || (s = e.imQueue(t.peerId, a)), s.length > 0 && te(s.map(function(e) {
            return li("_im_mess_rid" + e.rid, i)
        }, i).filter(function(e) {
            return e
        }));
        var c = v(e, t),
            u = ni(i);
        mi(u, "_im_mess_stack") || (u = si(u, "._im_mess_stack", -1));
        var l = (0, gt.getLastMessage)(e, t.peerId, t.messageId),
            d = li("_im_unread_bar_row", i),
            f = (0, wt.getUserId)(t),
            h = l ? R(l.date, e) : 0;
        if (!l || P(o, l, t, e, r)) {
            var p = "",
                m = !1;
            if (d && (0, wt.isOut)(t) && Ue(e, i, t.peerId), 1 === o.unread && !(0, wt.isOut)(t) && r && (p += bi("im_mess_bar", {}), m = !0, Ue(e, i, t.peerId)), !xi(new Date(h))) {
                var _ = new Date,
                    g = m ? "im-page--history-new-bar_hide _im_invisible_bar" : "";
                p += bi("im_day_bar", {
                    day: Fi(t.date, e.timeshift, !0, Ci("months_of", "raw"), !0),
                    date: t.date,
                    day_class: _.getDate() + _.getMonth() + _.getFullYear() + " " + g
                })
            }
            if (ce(t)) p += bi("im_service_row", {
                text: le(e, t, o),
                type: "",
                date: t.date,
                from_id: "",
                ...
                var b = e.gid && (0, wt.isOut)(t) ? ei(t.kludges.from_admin) || 0 : 0,
                    y = (0, Et.oCacheGet)(e, b ? -e.gid : f) || o,
                    k = S(t.peerId) ? y.name : y.first_name,
                    N = y.link || o.href,
                    T = bi("im_mess_stack_name", {
                        name: k,
                        link: N,
                        "class": (0, wt.isMoney)(t) ? " im-mess-stack--lnk-money-transfer" : ""
                    });
                if ((0, wt.isGift)(t)) {
                    var F = Ci("mail_gift_message_sent", "raw");
                    T += ' <span class="im-mess-stack--gift">' + yi(y.sex || 0, F) + "</span>"
                }
                if ((0, wt.isMoney)(t)) {
                    var E = (0, wt.isMoneyRequest)(t) ? Ci("mail_money_request_message_sent", "raw") : Ci("mail_money_tranfer_message_sent", "raw");
                    T += ' <span class="im-mess-stack--money-transfer">' + yi(y.sex || 0, E) + "</span>"
                }
                var x = e.gid ? "/gim" + e.gid : "/im",
                    I = void 0;
                if (I = t.local ? A(t.date, e.timeshift) : bi("im_stack_date", {
                        date: A(t.date, e.timeshift),
                        link: x + "?sel=" + t.peerId + "&msgid=" + t.messageId
                    }), b && e.admins[b]) {
                    var O = e.admins[b],
                        L = b === Kt.id ? Ci("mail_by_you") : O[0];
                    I = I + " " + bi("im_admin_link", {
                        name: L,
                        href: O[1]
                    })
                }
            ...
            }(0, Ft.toArray)(Jt(p)).forEach(function(e) {
                return i && i.appendChild(e)
            })
        } else d && e.peer === t.peerId && !o.inplaceSearch && (0, wt.isOut)(t) && Ue(e, i, t.peerId), li("_im_stack_messages", u).appendChild(Yt(c));
        return (0, wt.isOut)(t) && !n && setTimeout(function() {
            var e = li("_im_mess_" + t.messageId, i);
            mi(e, Ot) && fi(e, "im-mess_sending")
    ...
    function w(e, t, i) {
        var a = void 0;
        return a = "object" === ("undefined" == typeof e ? "undefined" : _t(e)) ? e : t.imQueue(e, !1), a.length > 0 && a.map(function(e) {
    ...
    function k(e) {
        var t = li("_im_mess_blind_unread_marker", e);
        t && (t.removeAttribute("aria-label"), t.removeAttribute("role"), t.removeAttribute("tabindex"))
    }

    function N(e, t, i) {
        var a = e.tabs[t];
        return (0, Ft.toArray)(ui("_im_mess_unread", i)).forEach(function(e) {
            var t = ei(ci(e, "msgid"));
            t > 0 && a.out_up_to >= t && (hi(e, "_im_mess_unread"), hi(e, "im-mess_unread"), k(e))
        }), i
    }

    function T(e, t, i) {
        var a = li("_im_msg_media" + t.messageId, e);
    ...
    function P(e, t, i, a, r) {
        if ((0, wt.getUserId)(t) !== (0, wt.getUserId)(i)) return !0;
        var n = R(t.date, a),
            o = R(i.date, a);
        return Ei(n, o) ? (0, gt.isCommunityInterface)(a) && ei(t.kludges.from_admin) !== ei(i.kludges.from_admin) ? !0 : i.date - t.date > 300 ? !0 : ce(t) || ce(i) ? !0 : (0, wt.isGift)(t) || (0, wt.isGift)(i) ? !0 : (0, wt.isGraffiti)(t) || (0, wt.isGraffiti)(i) ? !0 : (0, wt.isUnread)(e, t) === (0, wt.isUnread)(e, i) || !r || (0, wt.isOut)(i) || he(i.peerId, a.gid) ? !1 : !0 : !0
    }

    function A(e, t) {
        return wi(1e3 * e, "{hour}:{minute} {am_pm}", 1e3 * t, [], !0)
    }
    ...
    function D(e, t) {
        var i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : !1,
            ...
            r = {},
            n = 0;
        return e = (0, kt.replaceHyperLinks)(e || "", kt.linksReplacer.bind(null, i)), e = e.replace(/(<a.+?<\/a>)/gi, function(e) {
            var t = "!link_" + n + "_" + a + "!";
            return r[t] = e, n++, t
        }), e = (0, kt.replaceMentions)(e), e = (0, kt.replaceEmailLinks)(e), Object.keys(r).forEach(function(t) {
            e = e.replace(t, function() {
                return r[t]
            })
        }), t.emoji && (e = Bi.emojiToHTML(e, !0)), zi && (e = zi(e)), e
    }
    ...
    function q(e) {
        return {
            search: {
                name: Ci("mail_im_peer_search"),
                icon: "search"
            },
            block_community: {
                icon: "block",
                name: Ci("mail_block_comm_messages")
            },
            allow_community: {
                icon: "unblock",
                name: Ci("mail_allow_comm_messages")
            },
            clear: {
                name: Ci(e.peer < -2e9 ? "mail_im_delete_email_contact" : "mail_im_delete_all_history"),
                icon: "clear"
            },
            chat: {
                name: Ci("mail_im_create_chat_with"),
                icon: "invite"
            },
            mute: {
                name: Ci("mail_im_mute"),
                icon: "mute"
            },
            unmute: {
                name: Ci("mail_im_unmute"),
                icon: "unmute"
            },
            photos: {
                name: Ci(e.gid ? "mail_im_show_media_history_group" : "mail_im_show_media_history"),
                icon: "media"
            },
            avatar: {
                icon: "avatar",
                name: Ci("mail_update_photo_red")
            },
            block: {
                icon: "block",
                name: Ci("mail_block_user")
            },
            invite: {
                icon: "invite",
                name: Ci("mail_im_create_chat_with")
            ...
            invite_link: {
                icon: "invite-link",
                name: Ci("mail_chat_invite_link")
            },
            leave: {
                icon: "leave",
                name: Ci("mail_leave_chat")
            },
            topic: {
                icon: "topic",
                name: Ci("mail_change_topic")
            },
            "return": {
                icon: "return",
                name: Ci("mail_return_to_chat")
            },
            pin_hide: {
                icon: "pin_hide",
                name: Ci("mail_menu_pin_hide")
            },
            pin_unhide: {
                icon: "pin_unhide",
                name: Ci("mail_menu_pin_show")
            },
            unpin: {
                icon: "unpin",
                name: Ci("mail_menu_unpin")
            }
        }
    }
    ...
    function G(e, t, i) {
        ...
        var a = t.data.active.slice(0, 4).map(Et.oCacheGet.bind(null, e)),
            r = a.map(function(e) {
                return e.photo
            }),
    ...
    function V(e) {
        var t = Ci(e.get().gid ? "mail_search_only_messages_comm" : "mail_search_only_messages");
        return '<li class="im-page--mess-search-w">\n    <div class="im-page--mess-search ' + Gt + '">\n      <button type="button" class="im-i--messages-search"></button>' + t + "\n    </div>\n  </li>"
    }

    function K() {
        return '<li class="im-search-results-head">' + Ci("mail_search_messages") + "</li>"
    }

    function Q() {
        return '<li class="im-search-results-head">' + Ci("mail_search_conversations_sep") + "</li>"
    }

    function Y() {
        return '<li class="im-search-results-head">' + Ci("mail_search_dialogs_sep") + "</li>"
    }

    function X() {
        return '<li class="im-search-results-head _im_recent_bar">\n    ' + Ci("mail_recent_searches") + '\n    <button type="button" class="' + Wt + ' im-page--clear-recent">' + Ci("mail_clear_recent") + "</button>\n  </li>"
    }

    function $(e) {
        var t = e.get().popular_sugg,
            i = (0, gt.isClassicInterface)(e) ? 8 : 5;
        return t.length > i && (t = t.slice(0, i)), '<li class="im-popular clear_fix">' + t.map(function(t) {
            var i = t.peerId,
                a = (0, Et.oCacheGet)(e, i) || t,
                r = e.get().tabs[i] || t,
            ...
            return '<div class="' + o + '" data-peer="' + i + '">\n    <a class="im-popular--avatar-w ' + Ai(r.online) + '" href="' + a.link + '"><img class="im-popular--avatar" src="' + a.photo + '"/></a>\n    <div class="im-popular--name-w"><a class="im-popular--name" href="' + a.link + '">' + (a.first_name || a.name) + '</a></div>\n    <span class="im-popular--unread _sugg_unread_ct">' + H(r.unread) + "</span>\n</div>";
        }).join("") + "</li>"
    }

    function J(e, t, i) {
        var a = li("_im_mess_" + t.messageId, i);
        if (a) {
            _i(a, "aria-hidden", "false"), fi(a, "im-mess_failed " + Lt);
            var r = li("_im_mess_marker", a);
            _i(r, "aria-label", Ci("mail_send_message_error")), _i(r, "role", "link")
        }
        return i
    }

    function Z(e, t, i) {
        var a = li("_im_mess_" + t, i);
        if (a) {
            hi(a, "im-mess_failed"), _i(a, "aria-hidden", "true"), hi(a, Lt);
            var r = li("_im_mess_marker", a);
            _i(r, "aria-label", ""), _i(r, "role", "")
        }
        return i
    }
    ...
    function te(e, t) {
        ...
        return e.forEach(function(e) {
            ...
            return 0 === oi(e).length
        }).map(function(e) {
            return di("_im_mess_stack", e)
        }).forEach(function(e) {
            mi(ri(e), "_im_bar_date") && Xt(ri(e)), mi(ri(e), "_im_unread_bar_row") && Xt(ri(e)), Xt(e)
        }), t
    }

    function ie(e, t, i, a) {
        return e.map(function(e) {
            return li("_im_mess_" + e, a)
        }).filter(function(e) {
            return e
        }).forEach(function(e) {
            vi(e, oe(t, e, i)), fi(e, "im-mess_light")
        }), a
    }

    function ae(e, t, i) {
        var a = li("_im_mess_" + e, i);
        if (a) {
            var r = li(Mt, a);
            vi(a, r.innerHTML), hi(a, "im-mess_light")
        }
        return i
    }
    ...
    function re(e, t, i, a) {
        ...
        var o = ((0, gt.isClassicInterface)(a), 60),
            s = ne(e, t, i, a, !1, r);
    ...
    function ne(e, t, i, a, n, o) {
        var s = [],
            c = Object.keys(e || {}).sort(function(t, i) {
                ...
                var t = (0, Et.oCacheExists)(a, e);
                return t || s.push(e), t
            });
        if (s.length && (0, It.loadChatMember)(r({}, t, s), a), 0 === c.length) return "";
        var u = x(t) || (0, gt.isCommunityPeer)(t) ? "first_name" : n ? "short_name" : "name";
        if (1 == c.length) {
            var l = i ? "" : (0, Et.oCacheGet)(a, c[0])[u];
            return l + " " + Ci("mail_typing")
        }
        var d = Ci("mail_typing_several", c.length),
            f = c.slice(0, Math.min(c.length - 1, o)),
            h = f.map(function(e) {
                return (0, Et.oCacheGet)(a, e)[u]
            }).join(", ");
        if (c.length > o + 1) h += " " + Ci("mail_and_peer").replace("{count}", c.length - o).replace("{typing}", d);
        else {
            var p = (0, Et.oCacheGet)(a, c[f.length])[u];
            h += " " + Ci("mail_and_peer_one") + " " + p + " " + d
        }
        return h
    }
    ...
    function oe(e, t, i) {
        ...
        return '<div class="im-mess--text">\n    ' + Ci(r) + ' <button type="button" data-peer="' + e + '" class="' + Rt + ' im-mess--btn">' + Ci("mail_restore") + '</button>\n    <div class="' + Mt + ' im-mess--original">' + a + "</div>\n  </div>"
    }

    function se() {
        return '<div class="im-page--chat-search-empty">\n    ' + Ci("mail_im_search_empty") + "\n  </div>"
    }
    ...
    function le(e, t, i) {
        ...
        if (u = yi(c.sex, Ci(u, "raw")), u = u.replace("{from}", ue(c.link, c.name, a)), o && o !== s) {
            var d = r.source_email;
            if (d) u = u.replace("{user}", ue("/im?email=" + encodeURIComponent(d), "email", a));
            else {
                var f = (0, Et.oCacheGet)(e, o),
                    h = n === Bt ? f.inv_name : f.kick_name;
        ...
        if (r.source_act === qt || r.source_act === zt)
            if (r.source_message) {
                var m = fe(Bi.emojiToHTML(ii(r.source_message.replace(/<br\s?\/?>/gi, " ")), !0)),
    ...
    function de(e, t, i, a) {
        if (t === jt) {
            var r = li("_im_mess_" + e.messageId, a);
            if (r) {
                var n = i.tabs[e.peerId];
                r.parentNode.innerHTML = bi("im_msg_row", {
                    msg_id: e.messageId,
                    from_id: e.peerId,
    ...
    function fe(e) {
        return e.replace(/&lt;&lt;/g, "&laquo;").replace(/&gt;&gt;/g, "&raquo;").replace(/ \-\-/g, " &mdash;").replace(/\-\- /g, "&mdash; ").replace(yt.MENTION_RAW, "$1$4")
    }
    ...
    function me(e) {
        return function(t) {
            var i = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "bottom",
                ...
                n = !1;
            setTimeout(function() {
                n || ("bottom" === i ? e.appendChild(r) : e.insertBefore(r, ai(e)), fi(r, "im-preloader_visible"))
            }, 0), t.then(function() {
                n = !0, hi(r, "im-preloader_visible"), r.parentNode && r.parentNode.removeChild(r)
            })
        }
    }
        ...
        return {
            0: {
                msgs: e.reduce(function(e, t) {
                    return e[t] = [t, bt.FLAG_IMPORTANT, 0, 0, "", "", {}, 0], e
                }, {}),
                hash: t,
                history: 1
            }
    ...
    function ge(e, t) {
        ...
        do
            if (!i || i.onclick || i.onmousedown || "A" == i.tagName || mi(i, "_im_no_select") || mi(i, "im_msg_media_link") || "IMG" == i.tagName && !mi(i, "_im_graffiti") && !mi(i, "emoji") && !mi(i, "emoji_css") && !mi(i, "im_gift") || "TEXTAREA" == i.tagName || mi(i, "play_new") || mi(i, "videoplayer") || (r = n.test(i.className))) break; while (a-- && (i = i.parentNode));
        return r ? !!ti(ve()) : !0
    }
    ...
    function be(e, t) {
        return '<div class="im-mess--text">\n      <span>' + Ci("mail_restored") + '</span>\n      <a class="_im_go_to" href="/im?sel=' + B(e) + "&msgid=" + t + '">' + Ci("mail_im_goto_conversation") + "</a>\n    </div>"
    }

    function Ce(e, t) {
        var i = Ci(S(e) ? "mail_chat_sure_to_delete_all" : (0, gt.isCommunityPeer)(e) ? "mail_group_sure_to_delete_all" : "mail_sure_to_delete_all");
        return Oi(Ci("mail_deleteall1"), i, Ci("mail_delete"), t, Ci("global_cancel"))
    }

    function ye(e) {
        return Oi(Ci("mail_unpin_title"), Ci("mail_unpin_text"), Ci("mail_unpin"), e, Ci("global_cancel"))
    }

    function we(e, t, i) {
        var a = Ci("mail_dialog_msg_delete_N", t),
            r = Oi(Ci("mail_dialog_msg_delete_title"), a, Ci("mail_delete"), function() {
                return i(isChecked(li("_check_forall")))
            }, Ci("global_cancel")),
            n = '<div class="checkbox im-delete-forall-checkbox _check_forall" onclick="checkbox(this);" role="checkbox" aria-checked="false">' + Ci("mail_delete_for_all") + "</div>",
            o = cur.imDb.selectByKey("del_forall_checked");
        return r.setControlsText(n), o && checkbox(li("_check_forall")), r
    }
    ...
    function Ne(e, t, i, a, r) {
        ...
        qi(a), Ii("al_im.php", {
            ...
            onDone: function(a, r) {
                var n = (0, Tt.createModule)({
                    handlers: function(r, o) {
                        o(a.bodyNode.parentNode, "click", "_im_invite_box", function() {
                            a.hide(), Te(e, e.get().peer, t, i), (0, Tt.destroyModule)(n)
                        }), o(a.bodyNode.parentNode, "mouseover", "im_status_mob_onl", function(e, t) {
                            var i = li("_im_chat_members_w", a.bodyNode.parentNode),
                                r = 160,
                                n = di("_im_member_item", t),
                                o = n.offsetTop - i.scrollTop + r,
                                s = o > 370;
                            Ri(t, {
                                was: ei(ci(t, "was")),
                                mid: ei(ci(t, "peer")),
                                vk_mobile: ei(ci(t, "vk_mobile")),
                                forcetoup: s
                            })
                        })
                    }
    ...
    function Fe(e, t, i) {
        if (e.get().active_tab === yt.FOLDER_ALL && 0 === e.get().unread_cnt) return !1;
        var a = e.get().active_tab === yt.FOLDER_ALL ? yt.FOLDER_UNREAD : yt.FOLDER_ALL;
    ...
    function Ee(e, t, i, a) {
        ...
        var r = (0, gt.isReversedDialogs)(t);
        return t.set(a.bind(null, e)).then(function(e) {
            return i().restoreDialogs(e, !0, r !== (0, gt.isReversedDialogs)(e)), e
        })
    }
    ...
    function xe(e, t) {
        ...
        var i = e.get().tabs[t];
        return yt.FOLDER_MASKS[yt.FOLDER_IMPORTANT] & i.folders
    }
    ...
    function Se(e, t) {
        ...
        return yt.FOLDER_MASKS[yt.FOLDER_UNRESPOND] & a.folders
    }
    ...
    function Le(e, t) {
        return (t.get().block_states[e] || {}).who === Kt.id
    }

    function Me(e, t) {
        var i = e.get().block_states;
        Object.keys(i).forEach(function(a) {
            i[a].time ? i[a].free === !1 && Date.now() - i[a].time >= 5e4 && t.push([bt.mutexEvent([, 1, "gim" + e.get().gid, a, 0, ""])]) : i[a].time = Date.now()
        })
    }
    ...
    function Re(e, t, i) {
        ...
        return !Li("al_im.php", {
            ...
            params: {
                width: 638,
                onHide: function() {
                    Di.loaded && Di.detachPlayer(!0), a.unmount()
                }
            }
        }, i)
    }
    ...
    function Pe(e, t) {
        var i = (0, gt.getTab)(e, t).last_seen;
        if (i[0]) return 2 === i[2] ? '<span class="is_vk_mobile is_online">' + Ci("mail_header_online_status") + Ae(t, !1, !0) + "</span>" : "online" + (Pi[i[0]] ? Ae(t) : "");
        if (!i[1]) return "";
        var a = Ni(i[1], e.get().timeshift),
            r = yi((0, Et.oCacheGet)(e, t).sex, Ci("mail_last_activity_tip", "raw")).replace("{user}", "").replace("{time}", a);
    ...
    function ze(e, t, i) {
        var a = li("_im_mess_" + e, i);
        return a && pi(a, "im-mess_fav", t), i
    }

    function Ue(e, t, i) {
        var a = li("_im_unread_bar_row", t);
        if (!a) return t;
        var r = si(a, "._im_mess_stack", -1),
            n = si(a, "._im_mess_stack"),
            o = r ? ui("_im_mess", r).pop() : null,
            s = n ? li("_im_mess", n) : null;
        if (Xt(a), _(t), !s || !o) return t;
        var c = ci(o, "msgid"),
            u = ci(s, "msgid"),
            l = (0, gt.getMessage)(e, i, c),
            d = (0, gt.getMessage)(e, i, u);
        if (P(e.tabs[i], l, d, e)) return t;
        var f = li("_im_stack_messages", r),
            h = li("_im_stack_messages", n).children;
        return (0, Ft.toArray)(h).forEach(function(e) {
            Xt(e), f.appendChild(e)
        }), Xt(n), t
    }

    function We(e, t, i) {
        var a = (0, gt.getFirstUnread)(e, e.get().peer);
        if (!a) return [!1, 0];
        var r = li("_im_mess_" + a, t);
        if (!r) {
            var n = (0, gt.getLastMessage)(e, e.get().peer, a);
            if (!n) return [!0, 0];
            r = li("_im_mess_" + n.messageId, t)
        }
        var o = mi(r, "_im_mess_srv") ? r : di("_im_mess_stack", r);
        if (!o) return [!0, 0];
    ...
    function Ge(e, t, i) {
        qi(t);
        var a = di("_im_top_notice", i);
        Hi(a, 200, Xt.pbind(a));
        var r = di("_im_page_dialogs", a);
        r && mi(r, "im-page--dialogs-notice") && hi(r, "im-page--dialogs-notice"), Si.post("al_im.php", {
    ...
    function Ve(e, t, i) {
        qi(t);
        var a = di("_im_aside_notice", i);
        ji(a, 200, Xt.pbind(a)), Si.post("al_im.php", {
            act: "a_hide_top_notice",
            type: a.getAttribute("data-type"),
            hash: a.getAttribute("data-hash")
        })
    ...
    function Ke(e, t) {
        qi(e);
        var i = di("_im_aside_promo_block", t);
        ji(i, 200, Xt.pbind(i)), Si.post("al_im.php", {
    ...
    function Qe(e, t) {
        var i = di("_im_aside_promo_block", t);
        i.classList.add("--action-called"), Si.post("al_im.php", {
            act: "a_vkadmin_app_install",
            platform: t.getAttribute("data-platform")
        })
    }

    function Ye(e, t, i, a, r) {
        return i = i.replace(/\<br\s*\/?\>(\n)?/gi, " ").replace(/[\n\r]/gi, " "), i = (0, kt.replaceMentions)(i, function(e, t, i, a, r) {
            return r
        }), a && (i = Bi.emojiToHTML(i, !0)), t && "..." !== t.trim() && !S(e) && (i = bi("im_topic", {
            topic: t,
            cls: "im-topic_dialog"
        }) + i), !i && r.length > 0 && (i = bi("im_dialog_media", {
            name: Ze(r[0], r)
        })), i
    }
        ...
        for (var r = [], n = ""; i < e.length;) {
            ...
            if ("id" === o) n = t[i];
                ...
                var s = $e(e, t, i + 1, a + 1),
                    ...
                    l = c[1];
                i = l, r.push(Xe(n, u)), n = ""
            } else if (")" === o) return "" !== n && r.push(Xe(n)), [r, i];
            i++
        }
        return n && r.push(Xe(n)), [r, i]
    }
    ...
    function Je(e) {
        ...
        var c = $e(i, a),
            u = mt(c, 1),
            l = u[0];
        return Object.keys(Ki).length > 300 && (Ki = {}), Ki[e] = l, l
    }

    function Ze(e, t) {
        var i = {
            photo: Ci("mail_added_photos", "raw"),
            video: Ci("mail_added_videos", "raw"),
            audio: Ci("mail_added_audios", "raw")
        };
        switch (e.type) {
            case "mail":
                return ki(e.object.fwd_count, Ci("mail_fwd_msgs", "raw"), !0);
            case "photo":
            case "video":
            case "audio":
                ...
                return ki(a, i[e.type], !0);
            case "audio_playlist":
                return Ci("mail_added_audio_playlist");
            case "doc":
                switch (e.kind) {
                    case "graffiti":
                        return Ci("mail_added_graffiti");
                    case "audiomsg":
                        return Ci("mail_added_audiomsg");
                    default:
                        return Ci("mail_added_docs")
                }
            case "geo":
            case "map":
                return Ci("mail_added_geo");
            case "wall":
                return Ci("mail_added_wall");
            case "wall_reply":
                return Ci("mail_added_wall_reply");
            case "gift":
                return Ci("mail_added_gift");
            case "link":
            case "share":
                return Ci("mail_added_link");
            case "sticker":
                return Ci("mail_added_sticker");
            case "market":
                return Ci("mail_added_market_item");
            case "money_transfer":
                return Ci("mail_added_money_transfer");
            case "money_request":
                return Ci("mail_added_money_request");
            case "story":
                return Ci("mail_added_story");
            case "mask":
                return Ci("mail_added_mask");
            case "article":
                return Ci("mail_added_article")
        }
        return ""
    }

    function et(e) {
        fi(e, "im-send-btn_loading")
    }

    function tt(e) {
        hi(e, "im-send-btn_loading")
    }

    function it(e) {
        var t = e.get(),
            i = (0, gt.getPinnedMessage)(e);
        if (!i || !(0, xt.isPinnedMessageVisibleInTab)(e, (0, gt.getPeer)(e))) return "";
        var a = (0, Et.oCacheGet)(e, i.userId);
        if (!a) return "";
        var r = i.text;
        r = !r && i.attaches.length ? bi("im_pinned_message_media", {
            text: Ze(i.attaches[0], i.attaches)
        }) : D(r, i && i.kludges || {}) || "", r = r.replace(/<br\s?\/?>/gi, " ");
        var n = bi("im_pinned_message", {
            date: Ti(i.date, t.timeshift),
            content: r,
            link: a.link,
            name: a.name
        });
    ...
    function rt(e, t) {
        e.bodyNode.addEventListener("mouseover", function(e) {
            mi(e.target, "_im_edit_time") && at(t, e, e.target)
        })
    }
    ...
    function ct(e, t) {
        var i = (0, Et.oCacheGet)(e, t.peerId),
            a = (0, gt.getTab)(e, t.peerId) || {};
    ...
    function lt(e, t) {
        var i = [],
            ...
            r = a ? a[1].split(";") : [];
        for (r.length > Wi && (a[1] = r.slice(0, Wi).join(";")); e.length > Ui;) {
            var n = e.substr(0, Ui).lastIndexOf(" "); - 1 == n && (n = Ui), i.push({
                msgText: ti(e.substr(0, n))
            }), e = ti(e.substr(n))
        }
        for (e.length && i.push({
                msgText: e,
                ...
                attaches: t
            }), r = r.slice(Wi); r.length; r = r.slice(Wi)) i.push({
            attaches: [
                ["mail", r.slice(0, Wi).join(";")]
            ]
        });
        return i
    }
        ...
        Ii("al_im.php", {
            ...
            onFail: function(e) {
                return setTimeout(function() {
                    return Oi(Ci("global_error"), e)
                }, 0), !0
            },
            onDone: function(t, i) {
                a = (0, Nt.mount)(t.bodyNode, e)
            }
        }, {})
    }

    function ht() {
        Oi(Ci("global_error"), Ci("mail_message_wait_until_uploaded"))
    }

    function pt(e, t) {
        var i = (0, gt.getTab)(e, t.peerId) || {};
        if (!t || !(0, wt.isOut)(t)) return !1;
    ...
    var vt = i(90),
        ...
        At = t.CHAT_TITLE_ACTION = "chat_title_update",
        Dt = t.CHAT_INVITE_USER = "chat_invite_user",
        Bt = t.CHAT_KICK_USER = "chat_kick_user",
        jt = t.CHAT_PHOTO_UPDATE = "chat_photo_update",
        Ht = t.CHAT_PHOTO_REMOVE = "chat_photo_remove",
        qt = t.CHAT_PIN_MESSAGE = "chat_pin_message",
        zt = t.CHAT_UNPIN_MESSAGE = "chat_unpin_message",
        Ut = t.CHAT_INVITE_BY_LINK = "chat_invite_user_by_link",
        Wt = (t.DESELECT_ALL_CLASS = "_im_deselect_all", t.SHOW_CHAT_MEMBERS_CLASS = "_im_show_chat_mems", t.HIDE_TOP_NOTICE_CLASS = "_im_top_notice_hide", t.HIDE_ASIDE_NOTICE_CLASS = "_im_aside_notice_hide", t.HIDE_ASIDE_PROMO_BLOCK_CLASS = "_im_aside_promo_block_hide", t.INSTALL_VKADMIN_LINK = "_im_vkadmin_promo_link", t.CLEAR_RECENT_CLASS = "_im_clear_recent"),
        Gt = t.MESSAGE_SEARCH_CLASS = "_im_mess_search",
        Vt = window,
        Kt = Vt.vk,
        Qt = Vt.ls,
        Yt = Vt.se,
        ...
        Li = Vt.showTabbedBox,
        Mi = Vt.showTooltip,
        Ri = Vt.mobileOnlineTip,
        Pi = Vt.mobPlatforms,
        Ai = Vt.onlinePlatformClass,
        Di = Vt.AudioMessagePlayer,
        Bi = Vt.Emoji,
        ji = Vt.slideUp,
        Hi = Vt.fadeOut,
        qi = Vt.cancelEvent,
        zi = Vt.ny2018ReplaceText,
        Ui = 4096,
        Wi = 100,
        Gi = 8,
        Vi = "chatPosition",
    ...
    var a = i(9),
        r = {};
    r[i(1)("toStringTag")] = "z", r + "" != "[object z]" && i(94)(Object.prototype, "toString", function() {
    ...
    var a = i(123),
        ...
        c = Function[s],
        u = ("" + c).split(s);
    i(158).inspectSource = function(e) {
        return c.call(e)
    ...
    i(87), i(120), i(148), i(21), e.exports = i(158).Map
}, , function(e, t) {
    "use strict";
    ...
    window.curFastChat || (window.curFastChat = {}), window.FastChat = {
        ...
        clistPeerOver: function(e, t, i) {
            if (e && checkOver(i, e)) {
                ...
                curFastChat.clSel && t && curFastChat.clSel != a && FastChat.clistPeerOver(ge("fc_contact" + curFastChat.clSel), 0),
                    toggleClass(e, "fc_contact_over", t), t ? curFastChat.clSel = a : curFastChat.clSel == a && (curFastChat.clSel = !1)
            }
        },
    ...
    var a = i(1)("unscopables"),
        r = Array.prototype;
    void 0 == r[a] && i(10)(r, a, {}), e.exports = function(e) {
        r[a][e] = !0
    }
}, , function(e, t) {
    "use strict";
    ...
    "use strict";
    var _im_shared_helpers = __webpack_require__(106),
    ...
    var a = i(96),
        ...
        u = function() {
            var e, t = i(60)("iframe"),
                a = n.length,
                r = ">";
            for (t.style.display = "none", i(54).appendChild(t), t.src = "javascript:", e = t.contentWindow.document, e.open(), e.write("<script>document.F=Object</script" + r), e.close(), u = e.F; a--;) delete u[c][n[a]];
            return u()
        };
    ...
    for (var a = i(50), r = i(94), n = i(123), o = i(10), s = i(140), c = i(1), u = c("iterator"), l = c("toStringTag"), d = s.Array, f = ["NodeList", "DOMTokenList", "MediaList", "StyleSheetList", "CSSRuleList"], h = 0; 5 > h; h++) {
        var p, m = f[h],
            _ = n[m],
            g = _ && _.prototype;
        if (g) {
    ...
    i(142), i(81), i(20), i(118), i(109), i(166), i(143), window.getWndInner = a, window.lastWndScroll = [!1, !1], window.updateWndVScroll = r, window.defBox = n;
    try {
