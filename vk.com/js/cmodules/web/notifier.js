        ...
        window.curFastChat || (window.curFastChat = {}), window.FastChat = {
            ...
            prepareMessageData: function(e) {
                var t = e.peerId,
                    ...
                    d = "",
                    f = e.randomId;
                return Object(h.l)(e) && (d = this.renderServiceMessage(e)), -1 !== String(a).indexOf("rid") && (f = Number(a.slice(3))), Object.assign({
                    id: a,
                    peer: t,
                    from_id: n,
                    text: Object(h.l)(e) ? d : this.getMessageText(o, t) + l,
                    out: Object(h.k)(e),
                    unread: Boolean(1 & i),
                    date: r,
