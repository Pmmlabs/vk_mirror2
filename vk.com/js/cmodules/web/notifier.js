! function(e) {
    ...
    183: function(e, t, i) {
        ...
        t.readLastMessages = c(function(e, t) {
            ...
            var i = t.tabs[e];
            return i.data.kicked || i.data.closed ? Promise.resolve(t) : (0,
                qt.post)(qt.CONTROLLER, {
                act: "a_unpin_message",
                chat: e,
                hash: t.tabs[e].hash
            }).then(function(a) {
    ...
    3: function(e, t, i) {
        ...
        i(48), i(36), i(171), i(65), i(66), i(109), i(149), window.getWndInner = a, window.lastWndScroll = [!1, !1], window.updateWndVScroll = r, window.defBox = n;
        try {
    ...
    65: function(module, exports, __webpack_require__) {
        "use strict";
        var _im_shared_helpers = __webpack_require__(13),
            _longpoll_singleton = __webpack_require__(191),
