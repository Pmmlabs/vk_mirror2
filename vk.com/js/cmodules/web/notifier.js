! function(e) {
    ...
    118: function(__webpack_module__, __webpack_exports__, __webpack_require__) {
        "use strict";
        __webpack_require__.r(__webpack_exports__);
        var _helpers_im_shared_helpers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(184),
            _longpoll_singleton__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(173),
    ...
    156: function(e, t, n) {
        ...
        n.r(t), n(14), n(160), n(93), n(118), n(197), n(18), n(63), window.getWndInner = r, window.lastWndScroll = [!1, !1], window.updateWndVScroll = i, window.defBox = a;
        try {
    ...
    188: function(e, t, n) {
        ...
        function $e(e, t, n) {
            ...
            i && In(i, "im-page--dialogs-notice") && xn(i, "im-page--dialogs-notice"), Vn.post("al_im.php", {
    ...
    50: function(e, t, n) {
        ...
        function o(e, t, n) {
            return Object(Rt.post)(Rt.CONTROLLER, {
                act: "a_renew_hash",
                peers: e.join(","),
        ...
        function s(e) {
            if (!e.renew_hashes) {
                ...
                var n = Object.keys(e.tabs).filter(function(t) {
                    return Object(zt.isFullyLoadedTab)(e, t)
                });
        ...
        function h(e, t, n, r, i) {
            return i.tabHistoryNotChanged = !1, Object(Bt.retryFn)(Rt.post, 3, function(e) {
                return e - 1
            })(Rt.CONTROLLER, {
                act: "a_start",
                peer: e,
                ...
                if (o.forEach(function(e) {
                        return Object(Vt.oCacheAdd)(i, e)
                    }), i.tabs || (i.tabs = {}), i.dialog_tab_cts = u, i.tabs[e] || (i.tabs[e] = Object(zt.normalizeTab)(i, a)), f(c, i), n) {
                    if (i.tabs[e]) {
                ...
                return Object(Kt.imWeirdCatch)("loadPeer", e)
            })
        }
        ...
        function p(e, t) {
            var n = t.imQueue(e, !1),
                ...
                i = n.filter(function(n) {
                    return !Object(Wt.isRidExist)(t, e, n.rid)
                });
            return r.msgs = i.reduce(function(e, t) {
                return e["rid" + t.rid] = t.mess, e
            }, r.msgs), t.imQueueSet(e, i), t.tabs[e].history = Object(zt.restoreQueue)(i, t, d(t.tabs[e].history)), Promise.resolve(t)
        }
        ...
        function m(e, t, n) {
            ...
            return n.imQueueSet(e, r), n.tabs[e].history = Object(zt.removeMessages)([t], d(n.tabs[e].history)), Promise.resolve(n)
        }

        function _(e, t) {
            return (t.block_states[e] || {}).free === !1 ? Promise.resolve(t) : Object(Rt.post)(Rt.CONTROLLER, {
                act: "a_block",
                peer: e,
                prevPeer: t.prevPeer,
                gid: t.gid
        ...
        function g(e, t) {
            ...
            return Promise.resolve(t).then(function(t) {
                return t.tabHistoryNotChanged = !1, Object(zt.isFullyLoadedTab)(t, n) && !t.tabs[n].msgid ? (t.gid && _(n, t), Promise.resolve(t).then(w)) : (Object(zt.isFullyLoadedTab)(t, n) && (t.tabs[n].msgid = !1), h(n, e, !1, !0, t))
            }).then(w).then(v.bind(null, n))
        }

        function v(e, t) {
            var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : !1;
            return Object(zt.isTabLoaded)(t, e) && (t.tabs[e].last_touched = Date.now()), Object(zt.isTabLoaded)(t, e) && n && (t.tabs[e].last_visited = Date.now()), t
        }

        function b(e, t, n) {
            var r = n.msgid,
                i = n.peer;
            return !e && Object(zt.isFullyLoadedTab)(n, i) && n.tabs[i].msgs[r] ? (t === n.peer ? n.tabHistoryNotChanged = !0 : n.tabHistoryNotChanged = !1, n.gid && _(i, n), Promise.resolve(n).then(w).then(v.bind(null, i))) : h(i, !0, r, !0, n).then(w).then(function() {
                var e = Object(Wt.getTab)(n, i);
                return e.msgid = r, n
            }).then(v.bind(null, i))
        }

        function C(e, t, n, r) {
            if (Ge(r)) throw Object(zt.showWaitUntilUploadedBox)(), new Error("Cant change peer while loading somethind");
            var i = r.gid ? "gim" + r.gid : "im";
            if (r.prevPeer = r.peer, r.peer = e, r.msgid = t || "", r.currentEntryPoint = n, cur.peer = e, rn({
                    sel: e ? Object(zt.convertPeerToUrl)(e) : null,
                    msgid: r.msgid,
                    email: "",
                    0: i
                }), 0 != r.prevPeer && v(r.prevPeer, r, !0), 0 !== e) {
                var a = [];
                Object(zt.isTabLoaded)(r, e) && v(e, r, !0), a = r.tabbedPeers.map(function(e) {
                    return e.peer
                }).indexOf(e) < 0 ? [{
                    peer: e,
                    type: "perm"
            ...
            return an(), he(r.prevPeer, r)
        }

        function y(e) {
            if (cur.wallMentions = [], Object(zt.isChatPeer)(e.peer) && Object(zt.isFullyLoadedTab)(e, e.peer) && !Object(zt.isFvkcomgroup)(e, e.peer)) {
                var t = e.tabs[e.peer],
                    n = [];
                Object.keys(t.msgs || {}).reverse().forEach(function(e) {
                    var r = Object(Wt.parserMessage)(t.msgs[e]),
                        i = r && r.userId;
                    i && i != vk.id && -1 === n.indexOf(i) && Object(zt.isUserAliveInChat)(t, i) && n.push(i)
                }), (t.memberIds || []).forEach(function(e) {
                    -1 === n.indexOf(e) && n.push(e)
                }), n.forEach(function(t) {
                    if (Object(Vt.oCacheExists)(e, t)) {
                        var n = Object(Vt.oCacheGet)(e, t),
        ...
        function w(e) {
            ...
            var n = e.tabs[t],
                r = [],
                i = Object(zt.isChatPeer)(t) && (n.data.closed || n.data.kicked),
                a = Object(zt.isFvkcomgroup)(e, t);
            n.offset && r.push("photos"), n.offset && r.push("search"), (-2e9 > t || n.offset) && !a && r.push("clear"), Object(zt.isCommunityInterface)(e) && !a && r.push("block"), Object(zt.isCommunityPeer)(t) && (n.blocked_community ? r.push("allow_community") : r.push("block_community")), !Object(zt.isChatPeer)(t) && !Object(zt.isUserPeer)(t) || Object(zt.isCommunityInterface)(e) || Object(zt.isChatPeer)(t) && (n.data.kicked || n.data.closed) || (inArray(t, e.mutedPeers) ? r.push("unmute") : r.push("mute")), Object(zt.isUserPeer)(t) && !e.gid && !n.blacklisted && n.is_friend && r.push("invite"), !e.chatSettingsAllowed && Object(zt.isChatPeer)(t) && !i && n.data.link && r.push("invite_link"), Object(zt.isChatPeer)(t) && !i && (e.chatSettingsAllowed || (Object(Yt.canChangeTitle)(e) && r.push("topic"), Object(Yt.canChangeAvatar)(e) && r.push("avatar")), Object(Yt.canInviteUser)(e) && r.push("invite"), e.gid || r.push("leave")), Object(zt.isChatPeer)(t) && n.data.closed && !n.data.kicked && r.push("return"), Object(zt.isChatPeer)(t) && e.chatSettingsAllowed && !n.data.closed && !n.data.kicked && r.push("settings"), Object(zt.isChatPeer)(t) && n.pinned && (r.push(Object(Qt.isPinnedMessageVisibleInTab)(e, t) ? "pin_hide" : "pin_unhide"), Object(Yt.canPinOrUnpin)(e) && r.push("unpin"));
            var o = Object(zt.chatActions)(e, a);
        ...
        function T(e, t, n, r) {
            var i = e.tabs[t];
            return r === Dt.FLAG_OUTBOUND && i.out_up_to > n ? e : (r === Dt.FLAG_OUTBOUND ? i.out_up_to = n : i.in_up_to = n, e)
        }
        ...
        function E(e, t, n) {
            var r = n.tabs[e];
            return r.msgs[t.messageId] && (r.msgs[t.messageId].errored = 1, r.history = Object(zt.setMessageError)(e, t, d(r.history))), Promise.resolve(n)
        }

        function S(e, t, n, r) {
            var i = r.tabs[e];
            return i.msgs[t] && (i.msgs[t].errored = 0, i.lastmsg_meta = n, i.lastmsg = t, i.history = Object(zt.startResendMessage)(e, t, d(i.history))), Promise.resolve(r)
        }

        function x(e, t, n, r) {
            var i = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : !1;
            t.deletedDialog || (e.dialog_tabs = Object.keys(e.dialog_tabs).reduce(function(e, a) {
                return !n && !Xe(a)(t) || i && !i(a, e[a], t) || (e[a] = Object(Ht.arrayUnique)(r(e[a], a))), e
            }, e.dialog_tabs))
        }

        function j(e, t) {
            return 0 === e.length ? Promise.resolve(t) : Object(Rt.post)(Rt.CONTROLLER, {
                act: "a_get_admin",
                admins: e.join(","),
                gid: t.gid
            }).then(function(e) {
        ...
        function L(e, t, n) {
            return Object(zt.isReversedDialogs)(n) ? t.concat([e]) : [e].concat(t)
        }

        function A(e, t) {
            var n = e.get().peer,
                r = Object(Wt.getTab)(e, n);
            if (Object(zt.isFullyLoadedTab)(e, n)) {
                var i = d(r.history);
                r.history = Object(zt.updateMessageInCache)(e, i, t)
            }
        }

        function M(e, t) {
            var n = Object(Wt.getTab)(t, e.peerId);
            if (Object(zt.isFullyLoadedTab)(t, e.peerId)) {
                var r = d(n.history);
                n.msgs[e.messageId] = extend(!0, {}, e), n.history = Object(zt.editAndReplaceMessage)(t, e, r)
            }
            n && n.lastmsg == e.messageId && (n.lastmsg_meta = e);
            var i = n && n.pinned && Object(Wt.parserMessage)(n.pinned);
            return i && i.messageId == e.messageId && (n.pinned = e), Promise.resolve(t)
        }

        function R(e, t) {
            var n = e.flags & Dt.FLAG_OUTBOUND,
                i = e.peerId;
            if (Object(zt.isTabLoaded)(t, i)) {
                var a = t.tabs[i];
                if (a.deletedDialog = !1, !t.msg_local_ids_sort && e.local ? t.msg_local_ids_sort = r({}, e.messageId, 0) : e.local && (t.msg_local_ids_sort[e.messageId] = Object.keys(t.msg_local_ids_sort).length), n ? a.unread = 0 : (a.lastmsg == e.messageId && a.unread ? P(t, 1, e.peerId) : (!a.unread && P(t, 1, e.peerId), a.unread++), I(e.peerId, t)), Object(zt.isFullyLoadedTab)(t, i)) {
                    var o = d(a.history);
                    a.skipped > 0 && a.skipped++, a.offset++, a.msgs[e.messageId] = extend(!0, {}, e), a.history = Object(zt.appendToHistory)(t, e, o, !0, !0, !0), Object(Gt.isOut)(e) && (a.blocked_community = 0, w(t))
                }
                if (a.typing) {
        ...
        function D(e, t) {
            if (Object(zt.isFullyLoadedTab)(t, e.peerId)) {
                var n = t.tabs[e.peerId],
                    r = n.unread;
                if (t = T(t, e.peerId, e.upToId, 0), null != e.unread ? n.unread = e.unread : n.unread = e.upToId >= n.lastmsg ? 0 : Object(Wt.countUnread)(e.peerId, t) + (n.unread > 0 ? +n.skipped : 0), r > 0 && !n.unread && P(t, -1, e.peerId), !n.skipped) {
                    var i = d(n.history);
                    n.history = Object(zt.removewNewUnreadBarAndMerge)(t, i, e.peerId)
                }
            } else Object(zt.isTabLoaded)(t, e.peerId) && (t.tabs[e.peerId].unread > 0 && P(t, -1, e.peerId), t.tabs[e.peerId].unread = 0, t.tabs[e.peerId].in_up_to = e.upToId);
            return Object(zt.isTabLoaded)(t, e.peerId) && (t.dialog_tabs[Ut.FOLDER_UNREAD] = t.dialog_tabs[Ut.FOLDER_UNREAD].filter(function(t) {
        ...
        function B(e, t) {
            var n = t.tabs[e.peerId];
            if (Object(zt.isTabLoaded)(t, e.peerId) && T(t, e.peerId, e.upToId, Dt.FLAG_OUTBOUND), Object(zt.isFullyLoadedTab)(t, e.peerId)) {
                var r = d(n.history);
                n.history = Object(zt.markMessagesAsRead)(t, e.peerId, r)
            }
        ...
        function q(e, t, n) {
            ...
            if (1 === e.length) {
                var a = e[0],
                    o = Object(Wt.getMessage)(n, t, a),
                    s = Object(Wt.getAuthorFullName)(n, t, a);
                return s === !1 ? n.set(Fe.bind(null, r({}, t, [o.userId]))).then(function(n) {
                    var r = Object(Wt.getAuthorFullName)(n, t, a);
                    return {
                        msgIds: e,
                        object: i(o, r)
                    }
        ...
        function z(e, t) {
            Object(zt.normalizeTabsGotFromServer)(t, e);
            var n = t.tabs[t.peer];
        ...
        function U(e, t, n, r) {
            var i = Object(Wt.getTab)(r, e);
            if (i) {
                var a = t !== !1 ? t == tn ? 2 : mobPlatforms[t] ? 1 : 0 : i.last_seen[2];
        ...
        function G(e, t) {
            return Object(Bt.pause)(Zt + 2).then(function() {
                if (Object(zt.isTabLoaded)(t, e)) {
                    var n = t.tabs[e];
                    if (n.typing) {
                        var r = Date.now() - 1e3 * n.typing.ts;
                        r >= 1e3 * Zt && (n.typing = void 0)
                    }
                }
                return t
            })
        ...
        function K(e, t) {
            if (t.selectedMessages || (t.selectedMessages = []), 1 === e.length && inArray(e[0], t.selectedMessages)) t.selectedMessages = t.selectedMessages.filter(function(t) {
                ...
                t.selectedMessages = Object(Ht.arrayUnique)(n).sort(function(e, t) {
                    return e - t
                })
            }
            return Promise.resolve(t)
        ...
        function $(e, t) {
            if (Object(zt.isFullyLoadedTab)(t, e.peerId)) {
                ...
                i && (n.msgs[e.messageId] = e, delete n.msgs["rid" + e.randomId]), n.history = Object(zt.replaceMessageAttrs)(t, d(n.history), e)
            }
            return Promise.resolve(t)
        }
        ...
        function J(e, t) {
            ...
            return Object(Bt.retryFn)(Rt.post, 3, function(e) {
                return e * e
        ...
        function ee(e, t) {
            var n = t.tabs[e.peerId];
            return n.history = Object(zt.replaceAttaches)(d(n.history), e, t), Promise.resolve(t)
        }

        function te(e, t, n) {
            var r = Object(zt.dayFromVal)(t),
                i = n.tabs[e];
        ...
        function ue(e, t) {
            ...
            return Object(Bt.retryFn)(Rt.post, 1, function() {
                return 4
            })(Rt.CONTROLLER, {
        ...
        function de(e) {
            ...
            return n = e.dialog_tabs[t].length > 0 ? Math.min.apply(null, e.dialog_tabs[t].map(function(t) {
            ...
            })) : 0, Object(Rt.post)(Rt.CONTROLLER, {
                act: "a_get_dialogs",
                start_message_id: n,
                tab: t,
                gid: e.gid
                ...
                return o.forEach(function(t) {
                    return Object(Vt.oCacheAdd)(e, t)
        ...
        function fe(e, t) {
            if (t.peer === e && Object(zt.isFullyLoadedTab)(t, e)) {
                var n = t.tabs[e];
        ...
        function he(e, t) {
            if (Object(zt.isFullyLoadedTab)(t, e)) {
                var n = t.tabs[e];
                delete n.inplaceSearch, delete n.searchOffset, delete n.searchAllLoaded, delete n.searchText, delete n.searchDay, rn({
                    st: ""
                }), an()
            }
            return Promise.resolve(t)
        ...
        function ve(e, t, n) {
            if (Object(zt.isFullyLoadedTab)(n, t)) {
                var r = n.tabs[t];
        ...
        function be(e, t, n) {
            if (Object(zt.isFullyLoadedTab)(n, t)) {
                var r = n.tabs[t];
                r.history = Object(zt.removeMessages)(e, d(r.history)), r.offset -= e.filter(function(e) {
                    return r.msgs[e]
        ...
        function Ce(e, t, n, r) {
            if (Object(zt.isFullyLoadedTab)(r, t)) {
                var i = r.tabs[t];
                i.deleted = i.deleted ? i.deleted.concat(e) : e, i.history = Object(zt.removeMessagesWithRestore)(e, t, n, d(i.history)), i.offset -= e.filter(function(e) {
                    return i.msgs[e]
                }).length
            }
            return Promise.resolve(r)
        ...
        function ye(e, t, n) {
            if (Object(zt.isFullyLoadedTab)(n, t)) {
                ...
                r.deleted && (r.deleted = r.deleted.filter(function(t) {
                    return t !== e
                })), r.history = Object(zt.restoreMessage)(e, t, d(r.history)), r.offset++
            }
            return Promise.resolve(n)
        }
        ...
        function Fe(e, t) {
            ...
            return Object(Rt.post)(Rt.CONTROLLER, {
                ...
                return r.forEach(function(e) {
                    return Object(Vt.oCacheAdd)(t, e)
                }), t
            })
        }
        ...
        function Ee(e, t, n) {
            function r(e, t) {
                Object(zt.isChatPeer)(e) && t && !Object(Vt.oCacheExists)(a, t) && (i[e] ? -1 === i[e].indexOf(t) && i[e].push(t) : i[e] = [t])
            }
            var i = {},
                a = n.get(),
                o = t.filter(function(e) {
                    return !Object(zt.isTabLoaded)(a, e.peerId)
                }).map(function(e) {
                    return e.peerId
                });
            t.forEach(function(e) {
                Object(zt.isTabLoaded)(a, e.peerId) && r(e.peerId, e.userId)
            }), e.forEach(function(e) {
                r(e.peerId, +e.kludges.source_mid)
            });
            var s = t.filter(function(e) {
                return e.flags & Dt.FLAG_OUTBOUND && !e.local
            }).map(function(e) {
        ...
        function xe(e, t, n, r) {
            return t !== vk.id ? Promise.resolve(r) : (Object(zt.isTabLoaded)(r, n) && r.peer == n && (r = w(r)), Promise.resolve(r))
        }
        ...
        function Le(e, t, n, r) {
            if (Object(zt.isFullyLoadedTab)(r, t)) {
                ...
                e.filter(function(e) {
                    ...
                    var a = Object(Wt.getMessage)(r, t, e),
                        o = n ? a.flags | Dt.FLAG_IMPORTANT : a.flags & ~Dt.FLAG_IMPORTANT;
                    a.flags = o, i.msgs[e] = a, i.history = Object(zt.updateStar)(e, n, d(i.history))
                })
            }
            return Promise.resolve(r)
        }
        ...
        function He(e, t, n) {
            return Object(Rt.post)("al_page.php", {
        ...
        function qe(e) {
            ...
            return Object(Rt.post)(Rt.CONTROLLER, {
                ...
                s.forEach(function(t) {
                    return Object(Vt.oCacheAdd)(e, t)
                }), Object(zt.normalizeTabsGotFromServer)(e, o), c.user_unread && handlePageCount("msg", c.user_unread), Object(Ht.lplog)("Resync success", "success");
                var f = e.peer,
                    h = void 0;
                if (Object(zt.isReservedPeer)(f)) h = Promise.resolve(!1);
                else {
                    var p = {
                        tabs: r({}, f, e.tabs[f]),
                        oCache: {}
                ...
                return h.then(function(n) {
                    e.tabs = o, e.admins = extend(e.admins, u), n && (e.tabs[f] = n.tabs[f], e.tabs[f].history = Object(zt.restoreQueue)(f, e, d(e.tabs[f].history))), e.loadingDialogs = !1, e.mutedPeers = c.mutedPeers, e.lastDialogsOptions = {
                        has_more: c.has_more
                    ...
                    return Object.keys(e.dialog_tabs).filter(function(e) {
                        ...
                        i == Ut.FOLDER_ALL ? e.dialog_tabs[t] = r.filter(Xe(t)).map(function(e) {
                            return e.peerId
                        }) : e.dialog_tabs[t] = []
                    }), delete e.resync_in_process, setTimeout(t.bind(null, !0), 0), Ve(intval(c.unread), e)
                })
            })["catch"](function(t) {
                return Object(Ht.lplog)("Resync error: " + t.message + " " + t.stack, "error"), Object(Bt.pause)(2).then(qe.bind(null, e))
            })
        }
        ...
        function Ke(e, t) {
            return t.ctrl_submit = !!e, Object(Rt.post)(Rt.CONTROLLER, {
        ...
        function Qe(e, t, n) {
            return function() {
                ...
                if (0 === r) return Object($t.setDocumentTitle)(e ? e : document.title), setFavIcon("/images/icons/favicons/fav_im" + t + ".ico"), clearInterval(n.update_title_to), void(n.update_title_to = !1);
                if (e) Object($t.setDocumentTitle)(e), setFavIcon("/images/icons/favicons/fav_im" + t + ".ico"), e = !1;
                else {
                    e = document.title;
                    var i = r > 9 ? 10 : r;
                    setFavIcon("/images/icons/favicons/fav_im" + i + t + ".ico"), Object($t.setDocumentTitle)(winToUtf(getLang("mail_im_new_messages", r)))
                }
            }
        }
        ...
        function Ye(e, t, n) {
            ...
            } else !t && n.update_old_title && (Object($t.setDocumentTitle)(n.update_old_title), n.cur_unread_cnt = {}, r = !1, n.update_old_title = !1, setFavIcon("/images/icons/favicons/fav_im" + i + ".ico"), clearInterval(n.update_title_to), n.update_title_to = !1);
            return Promise.resolve(n)
        }

        function $e(e, t, n, r, i) {
            return Object(zt.isFullyLoadedTab)(i, e) && (i.tabs[e].scrollTop = intval(t), i.tabs[e].scrollBottom = intval(n), i.tabs[e].contHeight = intval(r)), Promise.resolve(i)
        }
        ...
        function Je(e, t) {
            t.active_tab = e, Object(Pt.updateLocation)({
                tab: e === Ut.FOLDER_ALL ? null : e
            });
            var n = [];
            if (e !== Ut.FOLDER_ALL && !Object(zt.isReversedDialogs)(t)) {
        ...
        function Ze(e, t, n) {
            return e === Dt.SET_DIRECTORIES && n.folders & t ? !1 : e !== Dt.RESET_DIRECTORIES || n.folders & t ? !0 : !1
        }

        function et(e, t, n) {
            return t !== Dt.RESET_DIRECTORIES || e.folders & Ut.FOLDER_MASKS[n] ? t === Dt.REPLACE_DIRECTORIES ? e.folders & Ut.FOLDER_MASKS[n] ? -1 : 1 : t === Dt.SET_DIRECTORIES ? 1 : -1 : 0
        }

        function tt(e, t, n, r) {
            var i = e.dialog_tabs_all;
            if (i[Ut.FOLDER_ALL] || i[t]) return !0;
            ...
            var a = n.map(function(t) {
                ...
                return Object(zt.isReversedDialogs)(e) ? t.lastmsg > r.lastmsg : t.lastmsg < r.lastmsg
            });
            return a.length > 0 ? !0 : !1
        }

        function nt(e, t, n, r, i) {
            if (Object(zt.isTabLoaded)(i, e)) {
                var a = i.tabs[e];
                return n === Dt.REPLACE_DIRECTORIES && (t ^= a.folders), Ze(n, t, a) && Object.keys(Ut.FOLDER_MASKS).filter(function(e) {
                    return Ut.FOLDER_MASKS[e] & t
                }).forEach(function(e) {
                    i.dialog_tab_cts[e] += et(a, n, e)
                }), n === Dt.SET_DIRECTORIES ? i.tabs[e].folders |= t : n === Dt.RESET_DIRECTORIES ? i.tabs[e].folders &= ~t : i.tabs[e].folders = t ^= a.folders, x(i, i.tabs[e], !0, function(t, n) {
        ...
        function it(e, t) {
            return f(r({}, e, {
                free: !0
            }), t), Object(Rt.post)(Rt.CONTROLLER, {
                act: "a_block_release",
                peer: e,
                gid: t.gid
            }).then(function() {
        ...
        function ct(e, t, n) {
            return n.tabbedPeers = e, Object(zt.isClassicInterface)(n) && (rn({
                peers: n.tabbedPeers.filter(function(e) {
                    var t = e.peer,
                        r = e.type;
                    return t !== n.peer && "perm" === r
                }).map(function(e) {
                    return Object(zt.getBareTab)(e.peer, n)
                }).filter(function(e) {
                    return !e.deletedDialog
                }).map(function(e) {
                    return e.peerId
                }).map(zt.convertPeerToUrl).join("_")
            }), t && an()), Promise.resolve(n)
        }

        function ut(e) {
            return e.peer ? fe(e.peer, e) ? le(e.peer, e) : Object(zt.isFullyLoadedTab)(e, e.peer) ? e.tabs[e.peer].allShown : !1 : !0
        }

        function dt(e, t) {
            var n = t.tabs[e];
            return Object(zt.isFullyLoadedTab)(t, e) && (n.skipped = null, n.msgs = null, n.offset = null, n.allShown = null, n.history = null), Promise.resolve(t)
        }

        function lt(e, t) {
            var n = t.tabs[e];
            return Object(zt.isFullyLoadedTab)(t, e) && (n.history = l(n.history)), Promise.resolve(t)
        }
        ...
        function ht(e, t, n) {
            if (!Object(zt.isCommunityPeer)(t)) return Promise.resolve(n);
            var r = Object(Wt.getTab)(n, t);
            return r.blocked_community = !e, Object(Rt.post)(Rt.CONTROLLER, {
        ...
        function pt(e, t) {
            if (0 !== t.peer && Object(zt.isFullyLoadedTab)(t, t.peer)) {
                var n = Object(Wt.getTab)(t, t.peer);
        ...
        function Ct(e) {
            return "undefined" == typeof e.chatResizeInitialized && (e.chatResizeInitialized = !0, Object(zt.getClassicChatHeight)() > window.clientHeight() && Object(zt.setClassicChatHeight)(0)), Promise.resolve(e)
        }
        ...
        function kt(e, t) {
            var n = Object(Ht.arrayUnique)([e].concat(t.select(qt.RECENT_SEARCH_OP))).slice(0, 500);
        ...
        function xt(e, t, n, i) {
            var a = Object(Wt.getMessage)(e, n, t),
                o = a.userId;
            return Object(Vt.oCacheGet)(i, o) ? Promise.resolve(i) : Fe(r({}, n, [o]), i)
        }
        ...
        function At(e, t, n, r) {
            var i = r.tabs[e];
            return i.caccess[t] = n, Object(Rt.post)(Rt.CONTROLLER, {
        ...
        var Rt = n(37),
            ...
            en = 2e4,
            tn = 8,
            nn = Object(Pt.updateLazyLocation)(),
            rn = nn.scheduleNav,
            an = nn.commitNav,
            on = nn.scheduleNavWithTimeOut,
            sn = {
                settings: 0,
                block: 1,
                fav: 1,
            ...
            cn = u(function(e, t) {
                var n = t.tabs[e],
                    r = Object.keys(n.msgs).map(function(n) {
                        return Object(Wt.getMessage)(t, e, n)
                    }).filter(function(e) {
                        return !Object(Gt.isOut)(e)
                    }).map(function(e) {
                        return e.messageId
                    }).sort(function(e, t) {
                        return t - e
                ...
                return n.skipped > 0 && (r = r.filter(function(e) {
                ...
                })), r = intval(r.shift()), r <= n.in_up_to ? Promise.resolve(t) : (t.longpoll.push([Dt.readInboundEvent([6, e, r])]), Object(Rt.post)(Rt.CONTROLLER, {
                    peer: e,
                    ids: [r],
                    hash: n.hash,
                    act: "a_mark_read",
                    ...
                    return T(t, e, r, Dt.FLAG_OUTBOUND)
                }))
            }),
            un = function(e, t, n, r) {
                var i = Date.now() + rand(0, 100).toFixed(0);
                return Object(Bt.retryFn)(Rt.post, 1)(Rt.CONTROLLER, Object.assign({
                    act: "a_send",
                    to: e,
                    hash: n.hash,
                    msg: t.message,
            ...
            mn = u(function(e, t) {
                return Object(Rt.post)(Rt.CONTROLLER, {
                    ...
                    return a.forEach(function(e) {
                        return Object(Vt.oCacheAdd)(t, e)
                    }), Object(zt.normalizeTabsGotFromServer)(t, i), e === t.searchText && (t.searchOffset = s, t.searchAllLoaded = c), Object.keys(i).filter(function(e) {
                        return !t.tabs[e]
                    }).forEach(function(e) {
                        t.tabs[e] = i[e]
                    }), [i, o]
            ...
            _n = u(function(e, t) {
                ...
                return rn({
                    st: n.searchText
                }), an(), Object(Rt.post)(Rt.CONTROLLER, {
                    act: "a_search",
                    q: i,
                    from: "in",
                    gid: t.gid,
            ...
            vn = u(function(e, t) {
                return t.tabs[e].lastTyping = Date.now(), Object(Rt.post)(Rt.CONTROLLER, {
                    act: "a_typing",
                    peer: e,
                    gid: t.gid,
                    hash: t.tabs[e].hash
            ...
            bn = u(function(e, t) {
                return Te(e, Object(Rt.post)("al_im.php", {
                    act: "a_flush_history",
                    id: e,
                    from: "im",
                    gid: t.gid,
            ...
            kn = u(function(e, t) {
                return e.kludges.source_act === zt.CHAT_PHOTO_REMOVE ? (delete t.tabs[e.peerId].photo, delete t.tabs[e.peerId].photoLarge, Promise.resolve(t)) : Object(Rt.post)(Rt.CONTROLLER, {
                    ...
                    if (t.tabs[e.peerId].photo = i[0], t.tabs[e.peerId].photoLarge = i[1], Object(zt.isFullyLoadedTab)(t, e.peerId)) {
                        var s = e.kludges.source_act;
                        o.history = Object(zt.addChatPhotoToUpdate)(e, s, t, d(o.history))
                    }
                    return t
                })
            }),
            Nn = u(function(e, t) {
                return Object(Rt.post)(Rt.CONTROLLER, {
                    ...
                    gid: t.gid,
                    hash: t.tabs[e].hash
                }).then(xe.bind(null, zt.CHAT_KICK_USER, vk.id, e, t))
            }),
            Tn = u(function(e, t) {
                return Object(Rt.post)(Rt.CONTROLLER, {
                    ...
                    gid: t.gid,
                    hash: t.tabs[e].hash
                }).then(xe.bind(null, zt.CHAT_INVITE_USER, vk.id, e, t))
            }),
            On = u(function(e, t, n) {
                return Object(Rt.post)(Rt.CONTROLLER, {
                    act: "a_mute",
            ...
            Fn = u(function(e, t, n, r) {
                return Le(e, n, t, r), Object(Rt.post)(Rt.CONTROLLER, {
            ...
            En = u(function(e, t, n, r) {
                return r.creating = !0, r.longpoll.pause(), Object(Rt.post)(Rt.CONTROLLER, {
                    act: "a_multi_start",
                    hash: r.writeHash,
                    peers: t.join(","),
                    title: n
            ...
            Sn = u(function(e, t) {
                var n = Ut.FOLDER_MASKS[Ut.FOLDER_IMPORTANT],
                    ...
                    i = r ? Dt.resetDirectoriesEvent : Dt.setDirectoriesEvent;
                return t.longpoll.push([i([0, e, n, !0])]), Object(Rt.post)(Rt.CONTROLLER, {
                    act: "a_dialog_star",
                    val: r ? 0 : 1,
                    peer: e,
                    hash: t.tabs[e].hash,
            ...
            xn = u(function(e, t, n) {
                ...
                return n.longpoll.push([Dt.resetDirectoriesEvent([0, e, r, !0]), Dt.readInboundEvent([6, e, t])]), Object(Rt.post)(Rt.CONTROLLER, {
                    act: "a_mark_answered",
                    peer: e,
                    lastmsg: t,
                    hash: n.tabs[e].hash,
            ...
            jn = u(function(e, t) {
                ...
                }), t.tabs[e].deletedDialog = !0, Object(Rt.post)(Rt.CONTROLLER, {
                    act: "a_delete_dialog",
                    peer: e,
                    gid: t.gid,
                    hash: t.tabs[e].hash
            ...
            In = u(function(e, t, n) {
                return Object(Rt.post)(Rt.CONTROLLER, {
                    ...
                    var t = Jt(e, 4),
                        ...
                        o = t[3];
                    return a.forEach(function(e) {
                        return Object(Vt.oCacheAdd)(n, e)
            ...
            An = u(function(e, t, n) {
                var r = n.tabs[t];
                return r.data.kicked || r.data.closed ? Promise.resolve(n) : Object(Rt.post)(Rt.CONTROLLER, {
                    act: "a_pin_message",
                    msgid: e,
                    chat: t,
                    gid: n.gid,
            ...
            Mn = u(function(e, t) {
                var n = t.tabs[e];
                return n.data.kicked || n.data.closed ? Promise.resolve(t) : Object(Rt.post)(Rt.CONTROLLER, {
                    act: "a_unpin_message",
                    chat: e,
                    gid: t.gid,
                    hash: t.tabs[e].hash
            ...
            Un = u(function(e, t) {
                return t.tabs[e].top_banner = void 0, Object(Rt.post)(Rt.CONTROLLER, {
                    act: "a_hide_banner",
                    peer_id: e,
                    hash: t.tabs[e].hash
                }).then(function() {
    ...
    69: function(e, t, n) {
        ...
        function r(e, t) {
            ...
            return Object.keys(r.msgs).filter(function(n) {
                var i = g(e, t, n);
                return !Object(z.isOut)(i) && intval(n) > r.in_up_to
            })[0]
        }

        function i(e) {
            var t = Object(K.unpackStore)(e);
        ...
        function u(e, t, n) {
            ...
            return Object.keys(r.msgs).filter(function(e) {
                ...
                var n = g(e, e.get().peer, t);
                return !Object(z.isServiceMsg)(n) && !Object(z.isCallMessage)(n)
            }).map(intval)
        }

        function d(e, t) {
            var n = Object(K.unpackStore)(t),
                r = o(n, e),
                i = 0;
            for (var a in r.msgs)
                if (r.msgs.hasOwnProperty(a)) {
                    var s = g(t, e, a);
                    Object(z.isOut)(s) || (i += Object(z.isUnread)(r, s) ? 1 : 0)
                }
            return i
        }
        ...
        function l(e, t, n) {
            ...
            return Object.keys(r.msgs).filter(function(r) {
                return intval(g(e, t, r).randomId) === n
            }).length > 0
        }
        ...
        function p(e, t, n) {
            var r = o(e, t),
                ...
                a = Object.keys(r.msgs).filter(function(n) {
                    ...
                    return !i.local && a ? !1 : i.local && !a ? !0 : h(e, i.messageId) > h(e, r.messageId)
                }),
                s = a.pop();
            return s ? g(e, t, s) : null
        }
        ...
        function _(e, t, n) {
            var r = o(e, t),
                i = g(e, t, n),
                a = Object(K.unpackStore)(e);
            return Object(z.isOut)(i) ? Object(G.oCacheGet)(e, a.id).name : i.userId !== i.peerId ? Object(G.oCacheExists)(e, i.userId) ? Object(G.oCacheGet)(e, i.userId).name : !1 : r.tab;
        }
        ...
        function C(e) {
            return Object(K.unpackStore)(e).gid
        }
        ...
        function j(e, t) {
            return x(t) ? !!o(e, t).blocked_community : !1
        }
        ...
        function B(e) {
            return 1 == Object(K.unpackStore)(e).isEditing
        }
        ...
        function q(e) {
            return e.draft || (e.draft = Object(V.loadDraftForPeer)(cur.imDb, e.peerId)), e.draft
        }
