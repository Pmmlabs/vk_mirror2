! function(e) {
    ...
    130: function(__webpack_module__, __webpack_exports__, __webpack_require__) {
        "use strict";
    ...
    161: function(e, t, n) {
        ...
        n.r(t), n(40), n(175), n(76), n(177), n(36), n(172), n(130), window.getWndInner = r, window.lastWndScroll = [!1, !1], window.updateWndVScroll = i, window.defBox = a;
        try {
    ...
    177: function(__webpack_module__, __webpack_exports__, __webpack_require__) {
        ...
        var _helpers_im_shared_helpers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(87),
            _longpoll_singleton__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(110),
        ...
        window.curNotifier || (window.curNotifier = {
            ...
            initFrameTransport: function() {
                ...
                var e = browser.version.split("."),
                    t = intval(e[0]),
                    n = intval(e[1]);
                curNotifier.post_message = Notifier.debug || !(browser.opera && intval(browser.version) < 15 || browser.msie || browser.mozilla && t >= 31 || browser.safari && (t > 7 || 7 == t && n >= 1)),
                    curNotifier.transport = "frame", this.lcInit();
