! function(e) {
    ...
    15: function(e, t, i) {
        ...
        function X(e, t, i) {
            ...
            if (t && "border-box" === ce(e, "boxSizing") && (t = !1), e == document) n = [Math.max(o.clientWidth, bodyNode.scrollWidth, o.scrollWidth, bodyNode.offsetWidth, o.offsetWidth), Math.max(o.clientHeight, bodyNode.scrollHeight, o.scrollHeight, bodyNode.offsetHeight, o.offsetHeight)];
                ...
                var s = function() {
                    if (n = K(e) && (r = Y(e, i)) && void 0 !== r.width ? [r.width, r.height] : [e.offsetWidth, e.offsetHeight], t) {
                        each(n, function(t, i) {
        ...
        function ue(e, t, i) {
            if (e = a(e)) {
                ...
                if ("opacity" == t) browser.msie && ((i + "").length ? 1 !== i ? e.style.filter = "alpha(opacity=" + 100 * i + ")" : e.style.filter = "" : e.style.cssText = e.style.cssText.replace(/filter\s*:[^;]*/gi, ""),
                    e.style.zoom = 1), e.style.opacity !== i && (e.style.opacity = i);
                else try {
    ...
    16: function(e, t, i) {
        ...
        i(2), i(132), i(73), i(90), i(200), i(13), i(139), window.getWndInner = a, window.lastWndScroll = [!1, !1], window.updateWndVScroll = r, window.defBox = n;
        try {
    ...
    28: function(e, t, i) {
        ...
        function o(e) {
            if (!e.renew_hashes) {
                ...
                e.renew_hashes = (0, qt.post)(qt.CONTROLLER, {
                    act: "a_renew_hash",
                    peers: i.join(","),
                    gid: e.gid
                }).then(function(t) {
        ...
        function f(e, t, i, a, r) {
            return r.tabHistoryNotChanged = !1, (0, Gt.retryFn)(qt.post, 3, function(e) {
                return e - 1
            })(qt.CONTROLLER, {
                act: "a_start",
                peer: e,
                ...
                if (o.forEach(function(e) {
                        return (0, Jt.oCacheAdd)(r, e)
                    }), r.tabs || (r.tabs = {}), r.dialog_tab_cts = u, r.tabs[e] || (r.tabs[e] = (0, Yt.normalizeTab)(r, n)), d(c, r), i) {
                    if (r.tabs[e]) {
                ...
                return (0, Zt.imWeirdCatch)("loadPeer", e)
            })
        }
        ...
        function h(e, t) {
            var i = t.imQueue(e, !1),
                ...
                r = i.filter(function(i) {
                    return !(0, $t.isRidExist)(t, e, i.rid)
                });
            return a.msgs = r.reduce(function(e, t) {
                return e["rid" + t.rid] = t.mess, e
            }, a.msgs), t.imQueueSet(e, r), t.tabs[e].history = (0, Yt.restoreQueue)(r, t, u(t.tabs[e].history)), Promise.resolve(t)
        }
        ...
        function p(e, t, i) {
            ...
            return i.imQueueSet(e, a), i.tabs[e].history = (0, Yt.removeMessages)([t], u(i.tabs[e].history)), Promise.resolve(i)
        }

        function m(e, t) {
            return (t.block_states[e] || {}).free === !1 ? Promise.resolve(t) : (0, qt.post)(qt.CONTROLLER, {
                act: "a_block",
                peer: e,
                prevPeer: t.prevPeer,
                gid: t.gid
        ...
        function _(e, t) {
            ...
            return Promise.resolve(t).then(function(t) {
                return t.tabHistoryNotChanged = !1, (0, Yt.isFullyLoadedTab)(t, i) && !t.tabs[i].msgid ? (t.gid && m(i, t), Promise.resolve(t).then(y)) : ((0, Yt.isFullyLoadedTab)(t, i) && (t.tabs[i].msgid = !1), f(i, e, !1, !0, t))
            }).then(y).then(g.bind(null, i))
        }

        function g(e, t) {
            var i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : !1;
            return (0, Yt.isTabLoaded)(t, e) && (t.tabs[e].last_touched = Date.now()), (0, Yt.isTabLoaded)(t, e) && i && (t.tabs[e].last_visited = Date.now()), t
        }

        function v(e, t, i) {
            var a = i.msgid,
                r = i.peer;
            return !e && (0, Yt.isFullyLoadedTab)(i, r) && i.tabs[r].msgs[a] ? (t === i.peer ? i.tabHistoryNotChanged = !0 : i.tabHistoryNotChanged = !1, i.gid && m(r, i), Promise.resolve(i).then(y).then(g.bind(null, r))) : f(r, !0, a, !0, i).then(y).then(function() {
                var e = (0, $t.getTab)(i, r);
                return e.msgid = a, i
            }).then(g.bind(null, r))
        }

        function b(e, t, i, a) {
            if (Ke(a)) throw (0, Yt.showWaitUntilUploadedBox)(), new Error("Cant change peer while loading somethind");
            var r = a.gid ? "gim" + a.gid : "im";
            if (a.prevPeer = a.peer, a.peer = e, a.msgid = t || "", a.currentEntryPoint = i, cur.peer = e, si({
                ...
                var n = [];
                (0, Yt.isTabLoaded)(a, e) && g(e, a, !0), n = a.tabbedPeers.map(function(e) {
                    return e.peer
                }).indexOf(e) < 0 ? [{
                    peer: e,
                    type: "perm"
        ...
        function C(e) {
            if (cur.wallMentions = [], (0, Yt.isChatPeer)(e.peer) && (0, Yt.isFullyLoadedTab)(e, e.peer)) {
                ...
                Object.keys(t.msgs || {}).reverse().forEach(function(e) {
                    var a = (0, $t.parserMessage)(t.msgs[e]),
                        r = a && a.userId;
                    r && r != vk.id && -1 === i.indexOf(r) && (0, Yt.isUserAliveInChat)(t, r) && i.push(r)
                }), (t.memberIds || []).forEach(function(e) {
                    -1 === i.indexOf(e) && i.push(e)
                }), i.forEach(function(t) {
                    if ((0, Jt.oCacheExists)(e, t)) {
                        var i = (0, Jt.oCacheGet)(e, t),
        ...
        function y(e) {
            ...
            var i = e.tabs[t],
                a = [],
                r = (0, Yt.isChatPeer)(t) && (i.data.closed || i.data.kicked);
            i.offset && a.push("photos"), i.offset && a.push("search"), (-2e9 > t || i.offset) && a.push("clear"), (0, Yt.isCommunityInterface)(e) && a.push("block"), (0, Yt.isCommunityPeer)(t) && (i.blocked_community ? a.push("allow_community") : a.push("block_community")), !(0, Yt.isChatPeer)(t) && !(0, Yt.isUserPeer)(t) || (0, Yt.isCommunityInterface)(e) || (0, Yt.isChatPeer)(t) && (i.data.kicked || i.data.closed) || (inArray(t, e.mutedPeers) ? a.push("unmute") : a.push("mute")), (0, Yt.isUserPeer)(t) && !e.gid && !i.blacklisted && i.is_friend && a.push("invite"), !e.chatSettingsAllowed && (0, Yt.isChatPeer)(t) && !r && i.data.link && a.push("invite_link"), (0, Yt.isChatPeer)(t) && !r && (e.chatSettingsAllowed || (0, ti.canChangeTitle)(e) && a.push("topic", "avatar"), (0, ti.canInviteUser)(e) && a.push("invite"), a.push("leave")), (0, Yt.isChatPeer)(t) && i.data.closed && !i.data.kicked && a.push("return"), (0, Yt.isChatPeer)(t) && e.chatSettingsAllowed && !i.data.closed && !i.data.kicked && a.push("settings"), (0, Yt.isChatPeer)(t) && i.pinned && (a.push((0, ei.isPinnedMessageVisibleInTab)(e, t) ? "pin_hide" : "pin_unhide"), (0, ti.canPinOrUnpin)(e) && a.push("unpin"));
            var n = (0, Yt.chatActions)(e);
        ...
        function w(e, t, i) {
            var a = i.tabs[i.peer];
            return (0, qt.post)(qt.CONTROLLER, {
                peer: i.peer,
                whole: e,
                act: "a_history",
        ...
        function k(e) {
            ...
            return (0, qt.post)(qt.CONTROLLER, {
                ...
                var a = jt(i, 5),
                    ...
                    o = a[2];
                a[3], a[4];
                t.allShown = t.allShown || o, t.history = l(t.history) + r, t.historyToAppend = r;
        ...
        function N(e, t, i, a) {
            var r = e.tabs[t];
            return a === Wt.FLAG_OUTBOUND && r.out_up_to > i ? e : (a === Wt.FLAG_OUTBOUND ? r.out_up_to = i : r.in_up_to = i, e)
        }
        ...
        function E(e, t, i) {
            var a = i.tabs[e];
            return a.msgs[t.messageId] && (a.msgs[t.messageId].errored = 1, a.history = (0, Yt.setMessageError)(e, t, u(a.history))), Promise.resolve(i)
        }

        function S(e, t, i, a) {
            var r = a.tabs[e];
            return r.msgs[t] && (r.msgs[t].errored = 0, r.lastmsg_meta = i, r.lastmsg = t, r.history = (0, Yt.startResendMessage)(e, t, u(r.history))), Promise.resolve(a)
        }
        ...
        function x(e, t, i, a) {
            ...
            t.deletedDialog || (e.dialog_tabs = Object.keys(e.dialog_tabs).reduce(function(e, n) {
                return !i && !Ze(n)(t) || r && !r(n, e[n], t) || (e[n] = (0, Vt.arrayUnique)(a(e[n], n))), e
            }, e.dialog_tabs))
        }

        function I(e, t) {
            return 0 === e.length ? Promise.resolve(t) : (0, qt.post)(qt.CONTROLLER, {
                act: "a_get_admin",
                admins: e.join(","),
                gid: t.gid
            }).then(function(e) {
        ...
        function A(e, t, i) {
            return (0, Yt.isReversedDialogs)(i) ? t.concat([e]) : [e].concat(t)
        }

        function O(e, t) {
            var i = (0, $t.getTab)(t, e.peerId);
            if ((0, Yt.isFullyLoadedTab)(t, e.peerId)) {
                var a = u(i.history);
                i.msgs[e.messageId] = extend(!0, {}, e), i.history = (0, Yt.editAndReplaceMessage)(t, e, a)
            }
            i && i.lastmsg == e.messageId && (i.lastmsg_meta = e);
            var r = i && i.pinned && (0, $t.parserMessage)(i.pinned);
            return r && r.messageId == e.messageId && (i.pinned = e), Promise.resolve(t)
        }

        function M(e, t) {
            var i = e.flags & Wt.FLAG_OUTBOUND,
                a = e.peerId;
            if ((0, Yt.isTabLoaded)(t, a)) {
                var n = t.tabs[a];
                if (n.deletedDialog = !1, !t.msg_local_ids_sort && e.local ? t.msg_local_ids_sort = r({}, e.messageId, 0) : e.local && (t.msg_local_ids_sort[e.messageId] = Object.keys(t.msg_local_ids_sort).length), i ? n.unread = 0 : (n.lastmsg == e.messageId && n.unread ? R(t, 1, e.peerId) : (!n.unread && R(t, 1, e.peerId), n.unread++), L(e.peerId, t)), (0, Yt.isFullyLoadedTab)(t, a)) {
                    var o = u(n.history);
                    n.skipped > 0 && n.skipped++, n.offset++, n.msgs[e.messageId] = extend(!0, {}, e), n.history = (0, Yt.appendToHistory)(t, e, o, !0, !0, !0), (0, Xt.isOut)(e) && (n.blocked_community = 0, y(t))
                }
                if (n.typing) {
        ...
        function P(e, t) {
            if ((0, Yt.isFullyLoadedTab)(t, e.peerId)) {
                var i = t.tabs[e.peerId],
                    a = i.unread;
                if (t = N(t, e.peerId, e.upToId, 0), null != e.unread ? i.unread = e.unread : i.unread = e.upToId >= i.lastmsg ? 0 : (0, $t.countUnread)(e.peerId, t) + (i.unread > 0 ? +i.skipped : 0), a > 0 && !i.unread && R(t, -1, e.peerId), !i.skipped) {
                    var r = u(i.history);
                    i.history = (0, Yt.removewNewUnreadBarAndMerge)(t, r, e.peerId)
                }
            } else(0, Yt.isTabLoaded)(t, e.peerId) && (t.tabs[e.peerId].unread > 0 && R(t, -1, e.peerId), t.tabs[e.peerId].unread = 0, t.tabs[e.peerId].in_up_to = e.upToId);
        ...
        function D(e, t) {
            var i = t.tabs[e.peerId];
            if ((0, Yt.isTabLoaded)(t, e.peerId) && N(t, e.peerId, e.upToId, Wt.FLAG_OUTBOUND), (0, Yt.isFullyLoadedTab)(t, e.peerId)) {
                var a = u(i.history);
                i.history = (0, Yt.markMessagesAsRead)(t, e.peerId, a)
            }
        ...
        function H(e, t, i) {
            ...
            if (1 === e.length) {
                var n = e[0],
                    o = (0, $t.getMessage)(i, t, n),
                    s = (0, $t.getAuthorFullName)(i, t, n);
                return s === !1 ? i.set(Se.bind(null, r({}, t, [o.userId]))).then(function(i) {
                    var r = (0, $t.getAuthorFullName)(i, t, n);
                    return {
                        msgIds: e,
                        object: a(o, r)
                    }
        ...
        function q(e, t, i, a) {
            var r = (0, $t.getTab)(a, e);
            if (r) {
                var n = t !== !1 ? t == ni ? 2 : mobPlatforms[t] ? 1 : 0 : r.last_seen[2];
        ...
        function U(e, t) {
            return (0, Gt.pause)(ai + 2).then(function() {
                if ((0, Yt.isTabLoaded)(t, e)) {
                    var i = t.tabs[e];
                    if (i.typing) {
                        var a = Date.now() - 1e3 * i.typing.ts;
                        a >= 1e3 * ai && (i.typing = void 0)
                    }
                }
                return t
            })
        ...
        function G(e, t) {
            if (t.selectedMessages || (t.selectedMessages = []), 1 === e.length && inArray(e[0], t.selectedMessages)) t.selectedMessages = t.selectedMessages.filter(function(t) {
                ...
                t.selectedMessages = (0, Vt.arrayUnique)(i).sort(function(e, t) {
                    return e - t
                })
            }
            return Promise.resolve(t)
        ...
        function Y(e, t) {
            if ((0, Yt.isFullyLoadedTab)(t, e.peerId)) {
                ...
                r && (i.msgs[e.messageId] = e, delete i.msgs["rid" + e.randomId]), i.history = (0, Yt.replaceMessageAttrs)(t, u(i.history), e)
            }
            return Promise.resolve(t)
        }
        ...
        function $(e, t) {
            ...
            return (0, Gt.retryFn)(qt.post, 3, function(e) {
                return e * e
            })(qt.CONTROLLER, i).then(function(i) {
                return X(e, i, t)
            })["catch"](function() {
                return X(e, null, t)
            })
        ...
        function J(e, t) {
            var i = t.tabs[e.peerId];
            return i.history = (0, Yt.replaceAttaches)(u(i.history), e, t), Promise.resolve(t)
        }

        function Z(e, t, i) {
            var a = (0, Yt.dayFromVal)(t),
                r = i.tabs[e];
        ...
        function oe(e, t) {
            ...
            var r = e.select(Kt.RECENT_SEARCH_OP);
            return (0, Gt.retryFn)(qt.post, 1, function() {
                return 4
            })(qt.CONTROLLER, {
        ...
        function ue(e, t) {
            return (0, qt.post)(qt.CONTROLLER, {
                ...
                return n.forEach(function(e) {
                    return (0, Jt.oCacheAdd)(t, e)
                }), (0, Yt.normalizeTabsGotFromServer)(t, r), e === t.searchText && (t.searchOffset = s, t.searchAllLoaded = c), Object.keys(r).filter(function(e) {
                    return !t.tabs[e]
                }).forEach(function(e) {
                    t.tabs[e] = r[e]
                }), [r, o]
        ...
        function fe(e, t) {
            if ((0, Yt.isFullyLoadedTab)(t, e)) {
                var i = t.tabs[e];
                delete i.inplaceSearch, delete i.searchOffset, delete i.searchAllLoaded, delete i.searchText, delete i.searchDay, si({
                    st: ""
                }), ci()
            }
            return Promise.resolve(t)
        ...
        function ge(e, t) {
            ...
            return (0, qt.post)(qt.CONTROLLER, {
                ...
                var s = jt(o, 3);
                i.unread = s[0], i.in_up_to = s[1], i.out_up_to = s[2], i.unread || (e.get().dialog_tabs[Qt.FOLDER_UNREAD] = e.get().dialog_tabs[Qt.FOLDER_UNREAD].filter(function(e) {
                    return e != t
        ...
        function be(e, t, i) {
            if ((0, Yt.isFullyLoadedTab)(i, t)) {
                var a = i.tabs[t];
                a.history = (0, Yt.removeMessages)(e, u(a.history)), a.offset -= e.filter(function(e) {
                    return a.msgs[e]
        ...
        function ye(e, t, i, a) {
            if ((0, Yt.isFullyLoadedTab)(a, t)) {
                var r = a.tabs[t];
                r.deleted = r.deleted ? r.deleted.concat(e) : e, r.history = (0, Yt.removeMessagesWithRestore)(e, t, i, u(r.history)), r.offset -= e.filter(function(e) {
                    return r.msgs[e]
                }).length
            }
            return Promise.resolve(a)
        ...
        function we(e, t, i) {
            if ((0, Yt.isFullyLoadedTab)(i, t)) {
                ...
                a.deleted && (a.deleted = a.deleted.filter(function(t) {
                    return t !== e
                })), a.history = (0, Yt.restoreMessage)(e, t, u(a.history)), a.offset++
            }
            return Promise.resolve(i)
        }
        ...
        function xe(e, t, i) {
            function a(e, t) {
                (0, Yt.isChatPeer)(e) && t && !(0, Jt.oCacheExists)(n, t) && (r[e] ? -1 === r[e].indexOf(t) && r[e].push(t) : r[e] = [t])
            }
            var r = {},
                n = i.get(),
                o = t.filter(function(e) {
                    return !(0, Yt.isTabLoaded)(n, e.peerId)
                }).map(function(e) {
                    return e.peerId
                });
            t.forEach(function(e) {
                (0, Yt.isTabLoaded)(n, e.peerId) && a(e.peerId, e.userId)
            }), e.forEach(function(e) {
                a(e.peerId, +e.kludges.source_mid)
            });
            var s = t.filter(function(e) {
                return e.flags & Wt.FLAG_OUTBOUND && !e.local
            }).map(function(e) {
        ...
        function Le(e, t, i, a) {
            return t !== vk.id ? Promise.resolve(a) : ((0, Yt.isTabLoaded)(a, i) && a.peer == i && (a = y(a)), Promise.resolve(a))
        }
        ...
        function Me(e, t, i, a) {
            if ((0, Yt.isFullyLoadedTab)(a, t)) {
                ...
                e.filter(function(e) {
                    ...
                    var n = (0, $t.getMessage)(a, t, e),
                        o = i ? n.flags | Wt.FLAG_IMPORTANT : n.flags & ~Wt.FLAG_IMPORTANT;
                    n.flags = o, r.msgs[e] = n, r.history = (0, Yt.updateStar)(e, i, u(r.history))
                })
            }
            return Promise.resolve(a)
        }
        ...
        function ze(e, t, i, a) {
            return a.creating = !0, a.longpoll.pause(), (0, qt.post)(qt.CONTROLLER, {
                act: "a_multi_start",
                hash: a.writeHash,
                peers: t.join(","),
                title: i
        ...
        function Ue(e) {
            ...
            return (0, qt.post)(qt.CONTROLLER, {
                ...
                s.forEach(function(t) {
                    return (0, Jt.oCacheAdd)(e, t)
                }), (0, Yt.normalizeTabsGotFromServer)(e, o), c.user_unread && handlePageCount("msg", c.user_unread), (0, Vt.lplog)("Resync success", "success");
                var f = e.peer,
                    h = void 0;
                if ((0, Yt.isReservedPeer)(f)) h = Promise.resolve(!1);
                else {
                    var p = {
                        tabs: r({}, f, e.tabs[f]),
                        oCache: {}
                ...
                return h.then(function(i) {
                    e.tabs = o, e.admins = extend(e.admins, l), i && (e.tabs[f] = i.tabs[f], e.tabs[f].history = (0, Yt.restoreQueue)(f, e, u(e.tabs[f].history))), e.loadingDialogs = !1, e.mutedPeers = c.mutedPeers, e.lastDialogsOptions = {
                        has_more: c.has_more
                    ...
                    return Object.keys(e.dialog_tabs).filter(function(e) {
                        ...
                        a == Qt.FOLDER_ALL ? e.dialog_tabs[t] = r.filter(Ze(t)).map(function(e) {
                            return e.peerId
                        }) : e.dialog_tabs[t] = []
                    }), delete e.resync_in_process, setTimeout(t.bind(null, !0), 0), Ye(intval(c.unread), e)
                })
            })["catch"](function(t) {
                return (0, Vt.lplog)("Resync error: " + t.message + " " + t.stack, "error"), (0, Gt.pause)(2).then(Ue.bind(null, e))
            })
        }
        ...
        function Qe(e, t) {
            return t.ctrl_submit = !!e, (0, qt.post)(qt.CONTROLLER, {
        ...
        function $e(e, t, i) {
            return function() {
                ...
                if (0 === a) return (0, ii.setDocumentTitle)(e ? e : document.title), setFavIcon("/images/icons/favicons/fav_im" + t + ".ico"), clearInterval(i.update_title_to), void(i.update_title_to = !1);
                if (e)(0, ii.setDocumentTitle)(e), setFavIcon("/images/icons/favicons/fav_im" + t + ".ico"), e = !1;
                else {
                    e = document.title;
                    var r = a > 9 ? 10 : a;
                    setFavIcon("/images/icons/favicons/fav_im" + r + t + ".ico"), (0, ii.setDocumentTitle)(winToUtf(getLang("mail_im_new_messages", a)))
                }
            }
        }
        ...
        function Xe(e, t, i) {
            ...
            } else !t && i.update_old_title && ((0, ii.setDocumentTitle)(i.update_old_title), i.cur_unread_cnt = {}, a = !1, i.update_old_title = !1, setFavIcon("/images/icons/favicons/fav_im" + r + ".ico"), clearInterval(i.update_title_to), i.update_title_to = !1);
            return Promise.resolve(i)
        }

        function Je(e, t, i, a, r) {
            return (0, Yt.isFullyLoadedTab)(r, e) && (r.tabs[e].scrollTop = intval(t), r.tabs[e].scrollBottom = intval(i), r.tabs[e].contHeight = intval(a)), Promise.resolve(r)
        }
        ...
        function et(e, t) {
            ...
            if (e !== Qt.FOLDER_ALL && !(0, Yt.isReversedDialogs)(t)) {
                ...
                i = t.dialog_tabs[Qt.FOLDER_ALL].map(function(e) {
                    return t.tabs[e]
        ...
        function tt(e, t, i) {
            return e === Wt.SET_DIRECTORIES && i.folders & t ? !1 : e !== Wt.RESET_DIRECTORIES || i.folders & t ? !0 : !1
        }

        function it(e, t, i) {
            return t !== Wt.RESET_DIRECTORIES || e.folders & Qt.FOLDER_MASKS[i] ? t === Wt.REPLACE_DIRECTORIES ? e.folders & Qt.FOLDER_MASKS[i] ? -1 : 1 : t === Wt.SET_DIRECTORIES ? 1 : -1 : 0
        }

        function at(e, t, i, a) {
            var r = e.dialog_tabs_all;
            if (r[Qt.FOLDER_ALL] || r[t]) return !0;
            ...
            var n = i.map(function(t) {
                ...
                return (0, Yt.isReversedDialogs)(e) ? t.lastmsg > a.lastmsg : t.lastmsg < a.lastmsg
            });
            return n.length > 0 ? !0 : !1
        }

        function rt(e, t, i, a, r) {
            if ((0, Yt.isTabLoaded)(r, e)) {
                var n = r.tabs[e];
                return i === Wt.REPLACE_DIRECTORIES && (t ^= n.folders), tt(i, t, n) && Object.keys(Qt.FOLDER_MASKS).filter(function(e) {
                    return Qt.FOLDER_MASKS[e] & t
                }).forEach(function(e) {
                    r.dialog_tab_cts[e] += it(n, i, e)
                }), i === Wt.SET_DIRECTORIES ? r.tabs[e].folders |= t : i === Wt.RESET_DIRECTORIES ? r.tabs[e].folders &= ~t : r.tabs[e].folders = t ^= n.folders, x(r, r.tabs[e], !0, function(t, i) {
        ...
        function lt(e, t, i) {
            return i.tabbedPeers = e, (0, Yt.isClassicInterface)(i) && (si({
                peers: i.tabbedPeers.filter(function(e) {
                    var t = e.peer,
                        a = e.type;
                    return t !== i.peer && "perm" === a
                }).map(function(e) {
                    return (0, Yt.getBareTab)(e.peer, i)
                }).filter(function(e) {
                    return !e.deletedDialog
                }).map(function(e) {
                    return e.peerId
                }).map(Yt.convertPeerToUrl).join("_")
            }), t && ci()), Promise.resolve(i)
        }

        function dt(e) {
            return e.peer ? de(e.peer, e) ? le(e.peer, e) : (0, Yt.isFullyLoadedTab)(e, e.peer) ? e.tabs[e.peer].allShown : !1 : !0
        }

        function ft(e, t) {
            var i = t.tabs[e];
            return (0, Yt.isFullyLoadedTab)(t, e) && (i.skipped = null, i.msgs = null, i.offset = null, i.allShown = null, i.history = null), Promise.resolve(t)
        }

        function ht(e, t) {
            var i = t.tabs[e];
            return (0, Yt.isFullyLoadedTab)(t, e) && (i.history = l(i.history)), Promise.resolve(t)
        }
        ...
        function mt(e, t, i) {
            if (!(0, Yt.isCommunityPeer)(t)) return Promise.resolve(i);
            var a = (0, $t.getTab)(i, t);
            return a.blocked_community = !e, (0, qt.post)(qt.CONTROLLER, {
        ...
        function Et(e, t) {
            var i = (0, Vt.arrayUnique)([e].concat(t.select(Kt.RECENT_SEARCH_OP))).slice(0, 500);
            t.update(Kt.RECENT_SEARCH_OP, i)
        }
        ...
        function xt(e, t) {
            var i = t.select(Kt.RECENT_SEARCH_OP).filter(function(t) {
                return t !== e
            });
            return t.update(Kt.RECENT_SEARCH_OP, i), i
        }

        function It(e, t, i) {
            var a = i.tabs[t],
                r = (0, $t.getMessage)(i, t, e);
        ...
        function Mt(e, t, i, a) {
            var n = (0, $t.getMessage)(e, i, t),
                o = n.userId;
            return (0, Jt.oCacheGet)(a, o) ? Promise.resolve(a) : Se(r({}, i, [o]), a)
        }
        ...
        function Dt(e, t) {
            return t.tabs[e].top_banner = void 0, (0, qt.post)(qt.CONTROLLER, {
                act: "a_hide_banner",
                peer_id: e
            }).then(function() {
                return t
        ...
        var qt = i(181),
            ...
            ti = i(115),
            ii = i(15),
            ai = t.TYPING_PERIOD = 5,
            ri = 2e4,
            ni = 8,
            oi = (0, zt.updateLazyLocation)(),
            si = oi.scheduleNav,
            ci = oi.commitNav,
            ui = oi.scheduleNavWithTimeOut,
            li = t.ACTION_PRIORITIES = {
                settings: 0,
                block: 1,
                fav: 1,
                chat: 2,
        ...
        t.readLastMessages = c(function(e, t) {
            ...
            return i.skipped > 0 && (a = a.filter(function(e) {
            ...
            })), a = intval(a.shift()), a <= i.in_up_to ? Promise.resolve(t) : (t.longpoll.push([Wt.readInboundEvent([6, e, a])]), (0, qt.post)(qt.CONTROLLER, {
                peer: e,
                ids: [a],
                hash: i.hash,
                act: "a_mark_read",
                ...
                return N(t, e, a, Wt.FLAG_OUTBOUND)
            }))
        }), t.deliverMessage = c(function(e, t, i) {
            var a = Date.now() + rand(0, 100).toFixed(0),
                r = i.tabs[e];
            return (0, Gt.retryFn)(qt.post, 1)(qt.CONTROLLER, {
                act: "a_send",
                to: e,
                hash: r.hash,
                msg: t.message,
            ...
            return t.tabs[e].lastTyping = Date.now(), (0, qt.post)(qt.CONTROLLER, {
                act: "a_typing",
                peer: e,
                gid: t.gid,
                hash: t.tabs[e].hash
            ...
            return Fe(e, (0, qt.post)("al_im.php", {
                act: "a_flush_history",
                id: e,
                from: "im",
                gid: t.gid,
            ...
            return e.kludges.source_act === Yt.CHAT_PHOTO_REMOVE ? (delete t.tabs[e.peerId].photo, delete t.tabs[e.peerId].photoLarge, Promise.resolve(t)) : (0, qt.post)(qt.CONTROLLER, {
                ...
                if (t.tabs[e.peerId].photo = r[0], t.tabs[e.peerId].photoLarge = r[1], (0, Yt.isFullyLoadedTab)(t, e.peerId)) {
            ...
            return (0, qt.post)(qt.CONTROLLER, {
                ...
                chat: e - 2e9,
                hash: t.tabs[e].hash
            }).then(Le.bind(null, Yt.CHAT_KICK_USER, vk.id, e, t))
        }), t.returnToChat = c(function(e, t) {
            return (0, qt.post)(qt.CONTROLLER, {
                act: "a_return_to_chat",
                chat: e - 2e9,
                hash: t.tabs[e].hash
            }).then(Le.bind(null, Yt.CHAT_INVITE_USER, vk.id, e, t))
            ...
            return Me(e, i, t, a), (0, qt.post)(qt.CONTROLLER, {
            ...
            var i = Qt.FOLDER_MASKS[Qt.FOLDER_IMPORTANT],
                a = t.tabs[e].folders & i,
                r = a ? Wt.resetDirectoriesEvent : Wt.setDirectoriesEvent;
            return t.longpoll.push([r([0, e, i, !0])]), (0, qt.post)(qt.CONTROLLER, {
                act: "a_dialog_star",
                val: a ? 0 : 1,
                peer: e,
                hash: t.tabs[e].hash,
            ...
            var a = Qt.FOLDER_MASKS[Qt.FOLDER_UNRESPOND];
            return i.longpoll.push([Wt.resetDirectoriesEvent([0, e, a, !0]), Wt.readInboundEvent([6, e, t])]), (0, qt.post)(qt.CONTROLLER, {
                act: "a_mark_answered",
                peer: e,
                lastmsg: t,
                hash: i.tabs[e].hash,
            ...
            }), t.tabs[e].deletedDialog = !0, (0, qt.post)(qt.CONTROLLER, {
                act: "a_delete_dialog",
                peer: e,
                gid: t.gid,
                hash: t.tabs[e].hash
            ...
            var a = i.tabs[t];
            return a.data.kicked || a.data.closed ? Promise.resolve(i) : (0, qt.post)(qt.CONTROLLER, {
                act: "a_pin_message",
                msgid: e,
                chat: t,
                hash: i.tabs[t].hash
            ...
            var i = t.tabs[e];
            return i.data.kicked || i.data.closed ? Promise.resolve(t) : (0, qt.post)(qt.CONTROLLER, {
                act: "a_unpin_message",
                chat: e,
                hash: t.tabs[e].hash
            }).then(function(a) {
    ...
    88: function(e, t, i) {
        ...
        var kt = i(199),
            ...
            qt = (t.TYPING_CLASS = "_im_typing", t.CREATE_CHAT_ACTION = "chat_create"),
    ...
    90: function(module, exports, __webpack_require__) {
        "use strict";
        var _im_shared_helpers = __webpack_require__(82),
            _longpoll_singleton = __webpack_require__(62),
    ...
    94: function(e, t, i) {
        ...
        var r, n = "\\w\\$А-Яа-яёЁєЄҐґЇїІіЈј",
            ...
            k = (t.OUR_DOMAINS = /^([a-zA-Z0-9\.\_\-]+\.)?(vkontakte\.ru|vk\.com|vkadre\.ru|vshtate\.ru|userapi\.com|vk\.me)$/, t.ENTITIES = /([^a-zA-Z0-9#%;_\-.\/?&=\[\]])/g, t.VK_DOMAIN = /^(?:https?:\/\/)?(?:vk\.com|vkontakte\.ru)?\/([a-zA-Z0-9\._]+)\??$/,
                t.MENTION = /\[(id|club)(\d+)(?:\:([a-z0-9_\-]+))?\|([^\$]+?)\]/g, t.MENTION_RAW = /(^|[\s.,:\'\";>\)\(])(\*|@)([A-Za-z0-9_\.]{2,32})\s*\((.+?)\)/g, t.ARROW_UP = 38),
            N = t.ARROW_DOWN = 40,
            T = t.PAGE_UP = 33,
            F = t.PAGE_DOWN = 34,
            E = t.END_KEY = 35,
