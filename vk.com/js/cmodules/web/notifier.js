! function(e) {
    ...
    177: function(__webpack_module__, __webpack_exports__, __webpack_require__) {
        "use strict";
    ...
    187: function(e, t, n) {
        ...
        n.r(t);
        n(231), n(278), n(199), n(296), n(217), n(26), n(177);
    ...
    217: function(e, t, n) {
        ...
        window.curFastChat || (window.curFastChat = {}), window.FastChat = {
            ...
            stopLp: function() {
                curFastChat.lpInited = !1, clearInterval(curFastChat.checkLpInt),
                    delete curFastChat.im_queue, delete curFastChat.cl_queue
            },
            checkLp: function() {
            ...
            gotPeers: function(e) {
                r() || each(curFastChat.needPeers, function(t) {
                    if (e[t]) {
                        ...
                        var n = this[1],
                            r = this[3];
                        2 & this[0] && void 0 === e[t].history || (clearTimeout(this[2]), delete curFastChat.needPeers[t]),
                            curFastChat.tabs[t] ? FastChat.gotHistory(t, e[t].history) : r.fixedLoad ? FastChat.addTabIcon(t, e[t]) : (FastChat.addTabIcon(t, e[t]), FastChat.addBox(t, e[t], r), n ? (curFastChat.tabs[t].auto = 1, FastChat.imFeed(t, n)) : (2 & this[0] && FastChat.gotHistory(t, e[t].history), r && r.nofocus || FastChat.activateTab(t))), r.onHistoryLoaded && r.onHistoryLoaded()
                    }
                })
            },
    ...
    296: function(__webpack_module__, __webpack_exports__, __webpack_require__) {
        ...
        var _helpers_im_shared_helpers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(325),
            _longpoll_singleton__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(78),
        ...
        window.curNotifier || (window.curNotifier = {
            ...
            onActivated: function() {
                curNotifier.idle_manager && !curNotifier.idle_manager.is_activated ? curNotifier.idle_manager.activate() : curNotifier.idle_manager && curNotifier.idle_manager.is_idle || Notifier.setFocus(1),
