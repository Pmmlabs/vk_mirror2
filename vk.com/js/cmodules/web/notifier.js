! function(e) {
    ...
    function Ge(e, t, i) {
        return e && !i.delayed_message ? (i.delayed_message = e,
            i.delayed_ts = t) : e || (i.delayed_message = e, i.delayed_ts = t), Promise.resolve(i)
    }
    ...
    i(91), i(45), i(40), i(46), i(51), i(11), i(24), window.getWndInner = a, window.lastWndScroll = [!1, !1], window.updateWndVScroll = r, window.defBox = n;
    try {
    ...
    "use strict";
    var _im_shared_helpers = __webpack_require__(16),
        _longpoll_singleton = __webpack_require__(90),
    ...
    window.curNotifier || (window.curNotifier = {
        ...
        lpChecked: function(e) {
            var t = e.failed;
            if (2 == t) return 4 == e.err ? 2 : (curNotifier.lpInvalid = !0, debugLog("notifier lpCheck error", e), clearTimeout(curNotifier.lp_error_to), curNotifier.lp_error_to = setTimeout(this.lpGetKey.bind(this), 1e3 * curNotifier.error_timeout),
                curNotifier.error_timeout < 64 && (curNotifier.error_timeout *= 2), 1 == e.err ? 1 : 3);
