! function(e) {
    ...
    207: function(__webpack_module__, __webpack_exports__, __webpack_require__) {
        "use strict";
        __webpack_require__.r(__webpack_exports__);
        var _helpers_im_shared_helpers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(245),
            _longpoll_singleton__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(114),
    ...
    285: function(e, t, n) {
        ...
        n.r(t), n(331), n(9), n(313), n(207), n(349), n(116), n(361), window.getWndInner = r, window.lastWndScroll = [!1, !1], window.updateWndVScroll = i, window.defBox = a;
        try {
    ...
    361: function(__webpack_module__, __webpack_exports__, __webpack_require__) {
        "use strict";
        __webpack_require__.r(__webpack_exports__), window.TopNotifierCur || (window.TopNotifierCur = {
            ...
            onLoad: function onLoad(rows, js, offset, header) {
                offset && TopNotifierCur.offset == offset || ((void 0 === rows || "undefined" === rows) && ajax.plainpost("/errors.php", {
                    ...
                    }), eval("(function(){" + js + ";})()"), val(TopNotifier.getContentNode(), rows),
                    TopNotifier.refreshHeader(header), TopNotifierCur.offset = offset, TopNotifier.cleanCount(), TopNotifier.refresh())
            },
    ...
    61: function(e, t, n) {
        ...
        function o(e, t) {
            ...
            switch (t.failed) {
                case 1:
                    return Object(p.lpLogFc)("red", "LP failed: old timestamp; resync, next ts", t.ts),
                        e.onResult({
                            ts: t.ts,
                            updates: [
                                [-1]
