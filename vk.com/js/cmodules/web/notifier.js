! function(e) {
    ...
    111: function(e, t, n) {
        ...
        var o = /^([a-zA-Z0-9\.\_\-]+\.)?(vkontakte\.ru|vk\.com|vkadre\.ru|vshtate\.ru|userapi\.com|vk\.me)$/,
            ...
            N = "(^|[s.,:'\";>)(]?)((#(?:[a-zA-Zа-яА-ЯёіјєїґўЁІЈЄЇҐЎ’_\\d]|(?:&#(?:19[2-9]|(?:[2-9]|1[0-3])[0-9][0-9]);?)){0,100}(?:[a-zA-Zа-яА-ЯёіјєїґўЁІЈЄЇҐЎ’]|(?:&#(?:19[2-9]|(?:[2-9]|1[0-3])[0-9][0-9]);?))(?:[a-zA-Zа-яА-ЯёіјєїґўЁІЈЄЇҐЎ’_\\d]|(?:&#(?:19[2-9]|(?:[2-9]|1[0-3])[0-9][0-9]);?)){0,100}))(@((?:[a-z0-9_]*[a-z0-9])?(?:(?:.[a-z](?:[a-z0-9_]+[a-z0-9])?)*.[a-z][a-z0-9_]{2,40}[a-z0-9])?))?(?=$|[s.,:'\"&;?<)(]?)"
    },
    127: function(e, t, n) {
        "use strict";
    ...
    156: function(e, t, n) {
        ...
        var O = "_im_mess_sending",
            ...
            Ne = q.showTooltip,
            Ie = q.mobPlatforms,
            De = q.onlinePlatformClass,
            Ae = q.AudioMessagePlayer,
            Se = q.Emoji,
            Le = q.slideUp,
            Fe = q.fadeOut,
            Be = q.cancelEvent,
            Re = q.fifaReplaceText,
            Ue = 4096,
            We = 100,
            He = 8,
            Ke = 52,
        ...
        function Ge(e) {
            e >= window.clientHeight() - 30 && (e = 0), G.set(qe, e)
        }
        ...
        function Xe(e, t, n, r) {
            var i = window.devicePixelRatio >= 2 ? "256" : "128",
                ...
                a = "im_gift";
            o && (a += " sticker_img");
            var s = '<img height="128" class="' + a + '" src="' + Stickers.getStickerUrl(J(e), i) + '"/>';
            if (o) {
        ...
        function Je(e, t, n) {
            ...
            return i && (t = lt(e, n, t = Wt([i], t), !0, !1)), t
        }
        ...
        function it(e, t, n) {
            var r = ae(n, "msgid"),
                i = ce("_im_mess_" + r, t),
                o = n.cloneNode(!0);
            return i && (i.parentNode.replaceChild(o, i), ct(t)), t
        }
        ...
        function at(e, t) {
            var n = ["_im_mess"],
                ...
                i = Object(s.hasReply)(t) ? ge("im_message_media", {
                    type: "reply",
            ...
            var l = st(t),
                _ = function(e, t) {
                    ...
                    if (Object(a.isCommunityInterface)(e) && r) {
                        var i = t.kludges.ref_source,
                            o = {};
                        try {
                            (o = JSON.parse(Object(b.unclean)(i))).link && o.info && (o.link = Object(c.replaceHyperLinks)(Object(b.clean)(o.link), c.linksReplacer.bind(null, !1)), o = Object(b.clean)(langStr(be("mail_source_info"), "link", o.link, "info", Object(b.clean)(o.info))), n += ge("sImLblWasSourceInfo", {
                                source: o
                            }))
                        } catch (e) {}
                    }
                ...
                f = i + wt(e, t.text, t.kludges, !1, t.peerId);
            "" != f && (f += _), t.subject && "..." !== t.subject.trim() && !Object(u.isChatPeer)(t.peerId) && (f = ge("im_topic", {
                topic: t.subject
            }) + f);
            var p = ge("im_message_media", {
                type: "media",
                messageId: t.messageId,
                attaches: l.join(""),
                text: Object(s.isGift)(t) ? '<div class="im-mess--gift-lbl">' + f + "</div>" : ""
            });
            return Object(s.isGift)(t) || (p = f + p), "" == f && (p += _), ge("im_msg_row", {
                msg_id: t.messageId,
                from_id: t.peerId,
        ...
        function st(e) {
            return e.attaches.reduce(function(t, n) {
                return !Object(s.hasReply)(e) || "mail" !== n.type && "reply" !== n.type ? ("sticker" === n.type ? e.messageId ? t.push(Xe(n.id, n.productId, n.kind, e.messageId)) : t.push(Xe(n.id, n.productId)) : t.push(tt(n.type)), t) : t
            }, [])
        }

        function ct(e) {
            for (var t = e.getElementsByClassName("_im_mess_noa"), n = t.length; n--;) fe(t[n], "im-mess_fwd") || t[n].insertAdjacentHTML("afterbegin", ge("sImHistoryRowActions")), de(t[n], "_im_mess_noa")
        }

        function ut(e, t, n) {
            var r, i, o, a, s, c = z.id,
                u = e.attaches[0],
                l = u.initiatorId,
                d = u.state,
                f = u.receiverId,
            ...
            switch (d) {
                case "reached":
                    h = be(c === l ? "mail_call_outgoing" : "mail_call_incoming");
                ...
                case "canceled_by_initiator":
                    h = be(c === l ? "mail_call_canceled" : "mail_call_missed");
                    break;
                case "canceled_by_receiver":
                    if (c === l) {
                        if (t) return be("mail_call_declined");
                        var m = Object(_.oCacheGet)(n, f);
                        return m ? ve(m.sex, be("mail_call_declined_by", "raw")).replace("{user_name}", m.first_name) : be("mail_call_declined")
                    }
        ...
        function lt(e, t, n) {
            ...
            var f = at(e, t),
                h = re(n);
            fe(h, "_im_mess_stack") || (h = oe(h, "._im_mess_stack", -1));
            for (var p = Object(a.getLastMessage)(e, t.peerId, t.messageId); t.peerId === e.peer && p && !ce("_im_mess_" + p.messageId);) p = Object(a.getLastMessage)(e, t.peerId, p.messageId);
            ...
            if (!p || yt(c, p, t, e, i)) {
                var v = "",
                    C = !1;
                if (m && Object(s.isOut)(t) && Pn(e, n, t.peerId), 1 === c.unread && !Object(s.isOut)(t) && i && (v += ge("im_mess_bar", {}), C = !0, Pn(e, n, t.peerId)), !ke(new Date(b))) {
                    var y = new Date,
                ...
                if (Object(s.isServiceMsg)(t)) v += ge("im_service_row", {
                    ...
                    var E = e.gid && Object(s.isOut)(t) ? J(t.kludges.from_admin) || -e.gid : 0,
                        T = Object(_.oCacheGet)(e, E ? -e.gid : g) || c,
                        k = Object(u.isChatPeer)(t.peerId) ? T.name : T.first_name,
                        j = T.link || c.href,
                        x = ge("im_mess_stack_name", {
                            name: k,
                            link: j,
                            class: Object(s.isMoney)(t) ? " im-mess-stack--lnk-money-transfer" : ""
                        });
                    if (Object(s.isGift)(t)) {
                        var M = be("mail_gift_message_sent", "raw");
                        x += ' <span class="im-mess-stack--gift">' + ve(T.sex || 0, M) + "</span>"
                    }
                    if (Object(s.isMoney)(t)) {
                        var P = Object(s.isMoneyRequest)(t) ? be("mail_money_request_message_sent", "raw") : be("mail_money_tranfer_message_sent", "raw");
                        x += ' <span class="im-mess-stack--money-transfer">' + ve(T.sex || 0, P) + "</span>"
                    }
                    var N = e.gid ? "/gim" + e.gid : "/im",
                        I = void 0;
                    if (I = t.local ? Ot(t.date, e.timeshift) : ge("im_stack_date", {
                            date: Ot(t.date, e.timeshift),
                            link: N + "?sel=" + t.peerId + "&msgid=" + t.messageId
                        }), E && e.admins[E]) {
                        var D = e.admins[E],
                            A = E === z.id ? be("mail_by_you") : D[0];
            ...
            } else m && e.peer === t.peerId && !c.inplaceSearch && Object(s.isOut)(t) && Pn(e, n, t.peerId), ce("_im_stack_messages", h).appendChild(V(f));
            return Object(s.isOut)(t) && !o && setTimeout(function() {
                var e = ce("_im_mess_" + t.messageId, n);
                fe(e, O) && le(e, "im-mess_sending")
        ...
        function _t(e, t, n) {
            var r = e.tabs[t];
            return Object(d.toArray)(se("_im_mess_unread", n)).forEach(function(e) {
                var t, n = J(ae(e, "msgid"));
                n > 0 && r.out_up_to >= n && (de(e, "_im_mess_unread"), de(e, "im-mess_unread"), (t = ce("_im_mess_blind_unread_marker", e)) && (t.removeAttribute("aria-label"), t.removeAttribute("role"), t.removeAttribute("tabindex")))
            }), n
        }
        ...
        function ft(e, t, n) {
            var r = t.peerId,
                i = t.messageId,
                o = ce("_im_msg_reply" + i, e),
                a = ce("_im_msg_media" + i, e),
        ...
        function yt(e, t, n, r, i) {
            ...
            var o = Ct(t.date, r),
                c = Ct(n.date, r);
            return !Te(o, c) || (!(!Object(a.isCommunityInterface)(r) || J(t.kludges.from_admin) === J(n.kludges.from_admin)) || (n.date - t.date > 300 || (!(!Object(s.isServiceMsg)(t) && !Object(s.isServiceMsg)(n)) || (!(!Object(s.isCallMessage)(n) && !Object(s.isCallMessage)(t)) || (!(!Object(s.isGift)(t) && !Object(s.isGift)(n)) || (!(!Object(s.isGraffiti)(t) && !Object(s.isGraffiti)(n)) || (!!Object(s.hasReply)(n) || !(Object(s.isUnread)(e, t) === Object(s.isUnread)(e, n) || !i || Object(s.isOut)(n) || Zt(n.peerId, r.gid)))))))))
        }

        function Ot(e, t) {
            return Ce(1e3 * e, "{hour}:{minute} {am_pm}", 1e3 * t, [], !0)
        }
        ...
        function wt(e, t, n) {
            ...
            }), n.emoji && (t = Se.emojiToHTML(t, !0)), Re && (t = Re(t)), t
        }
        ...
        function Pt(e) {
            ...
            switch (e.length) {
                ...
                case 3:
                    return xt(e[0], t[0]) + e.slice(1).map(function(e, n) {
                        return Mt(e, t[n + 1])
                    }).join("");
                case 4:
                    return e.map(function(e, n) {
        ...
        function Bt(e, t, n) {
            ...
            if (r) {
                he(r, "aria-hidden", "false"), le(r, "im-mess_failed " + w);
                var i = ce("_im_mess_marker", r);
                he(i, "aria-label", be("mail_send_message_error")), he(i, "role", "link")
            }
            return n
        }
        ...
        function Rt(e, t, n) {
            ...
            if (r) {
                de(r, "im-mess_failed"), he(r, "aria-hidden", "true"), de(r, w);
                var i = ce("_im_mess_marker", r);
        ...
        function Wt(e, t) {
            ...
            return e.forEach(function(e) {
                ...
                fe(ne(e), "_im_bar_date") && Y(ne(e)), fe(ne(e), "_im_unread_bar_row") && Y(ne(e)), Y(e)
            }), t
        }
        ...
        function Kt(e, t, n, r) {
            return e.map(function(e) {
                ...
                me(e, function(e, t, n) {
                    var r = t.innerHTML;
                    return '<div class="im-mess--text">\n    ' + be("delete" === n ? "mail_deleted_stop" : "mail_marked_as_spam") + ' <button type="button" data-peer="' + e + '" class="' + T + ' im-mess--btn">' + be("mail_restore") + '</button>\n    <div class="' + E + ' im-mess--original">' + r + "</div>\n  </div>"
        ...
        function zt() {
            ...
            var o = Vt(e, t, n, r, !1, i);
            return o.length > 60 ? Vt(e, t, n, r, !0, i) : o
        }
        ...
        function Vt(e, t, n, r, i, o) {
            ...
            var c = Object(u.isUserPeer)(t) || Object(a.isCommunityPeer)(t) ? "first_name" : i ? "short_name" : "name",
                l = Gt(e),
                d = "";
            l === p.ACTIVITY_TYPE_RECORDING_AUDIO ? d = be("mail_recording_audio_several", s.length) : l === p.ACTIVITY_TYPE_TYPING && (d = be("mail_typing_several", s.length));
            ...
            if (s.length > o + 1) {
                ...
                h += " " + be("mail_and_peer").replace("{count}", m - o).replace("{typing}", d)
            } else {
                if (s.length > 1 && (h += " " + be("mail_and_peer_one")), !Object(u.isChatPeer)(t) && n) h += " " + d;
                else h += " " + Object(_.oCacheGet)(r, s[f.length])[c] + " " + d
            }
            return h.trim()
        }
        ...
        function Xt(e, t, n) {
            ...
            if (u = (u = ve(c.sex, be(u, "raw"))).replace("{from}", Qt(c.link, c.name, r)), a && a !== s) {
                var d = i.source_email;
                if (d) u = u.replace("{user}", Qt("/im?email=" + encodeURIComponent(d), "email", r));
                else {
                    var f = Object(_.oCacheGet)(e, a),
                        h = o === P ? f.inv_name : f.kick_name;
                    u = u.replace("{user}", Qt(f.link, h, r))
                }
            }
            if (i.source_text) {
            ...
            if (i.source_act === D || i.source_act === A)
                if (i.source_message) {
                    var m = Qt("", Jt(Se.emojiToHTML(ee(i.source_message.replace(/<br\s?\/?>/gi, " ")), !0)), !1, "im_srv_mess_link");
                    u = u.replace("{msg}", m)
            ...
            if (t === N) {
                ...
                if (i) {
                    ...
                    i.parentNode.innerHTML = ge("im_msg_row", {
                        msg_id: e.messageId,
                        from_id: e.peerId,
                        text: Xt(n, e, o) + n.chat_photo_msg,
                        ts: e.date,
                        cls: "im-mess_srv"
                    })
                }
        ...
        function tn(e) {
            return function(t) {
                ...
                function a() {
                    o = !0, de(i, "im-preloader_visible"), i.parentNode && i.parentNode.removeChild(i)
                }
                setTimeout(function() {
                    o || ("bottom" === n ? e.appendChild(i) : e.insertBefore(i, te(e)), le(i, "im-preloader_visible"))
        ...
        function rn(e, t) {
            ...
            do {
                if (!n || n.onclick || n.onmousedown || "A" == n.tagName || fe(n, "_im_no_select") || fe(n, "im_msg_media_link") || "IMG" == n.tagName && !fe(n, "_im_graffiti") && !fe(n, "emoji") && !fe(n, "emoji_css") && !fe(n, "im_gift") || "TEXTAREA" == n.tagName || fe(n, "play_new") || fe(n, "videoplayer") || (i = o.test(n.className))) break
        ...
        function an(e, t, n) {
            var r = be("mail_deleteall1"),
                ...
                o = be("mail_delete");
            return Object(u.isChatPeer)(t) && (Object(g.doesChatTabHaveFlag)(e, 1024) ? (r = be("mail_leave_channel"), i = be("mail_unfollow_channel_confirmation"), o = be("mail_unfollow_channel")) : i = be("mail_chat_sure_to_delete_all")), Object(a.isCommunityPeer)(t) && (i = be("mail_group_sure_to_delete_all")), Me(r, i, o, n, be("global_cancel"))
        }
        ...
        function sn(e, t, n) {
            var r = Object(a.getTab)(e, t),
                ...
                s = be("mail_deleteall1"),
                c = be("mail_sure_to_delete_all"),
                l = be("mail_delete");
            if (i) {
                if (r.data.closed || r.data.kicked) return an(r, t, n.bind(null, !0));
                o ? (s = be("mail_leave_channel"), c = be("mail_vkcomgroup_leave_confirm"), l = be("mail_leave_channel")) : (s = be("mail_leave_chat"), c = be("mail_chat_leave_confirm"), l = be("mail_leave_chat"))
            }
            Object(a.isCommunityPeer)(t) && (c = be("mail_group_sure_to_delete_all"));
            ...
            return i && !o && d.setControlsText('<div class="checkbox im-delete-forall-checkbox _check_is_delete" onclick="checkbox(this);" role="checkbox" aria-checked="false">' + be("mail_deleteall1") + "</div>"), d
        }

        function cn(e) {
            return Me(be("mail_unpin_title"), be("mail_unpin_text"), be("mail_unpin"), e, be("global_cancel"))
        }

        function un(e, t, n, r) {
            var i = be("mail_dialog_msg_delete_N", t),
                o = Me(be("mail_dialog_msg_delete_title"), i, be("mail_delete"), function() {
                    return r(isChecked(ce("_check_forall")))
                }, be("global_cancel")),
                a = "",
                s = !1;
            return n && (a = '<div class="checkbox im-delete-forall-checkbox _check_forall" onclick="checkbox(this);" role="checkbox" aria-checked="false">' + be("mail_delete_for_all") + "</div>", s = cur.imDb.selectByKey("del_forall_checked")), o.setControlsText(a), s && checkbox(ce("_check_forall")), o
        }
        ...
        function yn(e, t) {
            return On(e.get(), t, Object(a.getTab)(e, t).last_seen)
        }

        function On(e, t, n, r) {
            if (n[0]) return be("mail_header_online_status") + (Ie[n[0]] ? wn(t, !1, !1, !0) : "");
            if (!n[1]) return "";
            var i = Oe(n[1], e.timeshift),
                o = ve(Object(_.oCacheGet)(e, t).sex, be("mail_last_activity_tip", "raw")).replace("{user}", "").replace("{time}", i);
            return n[2] && (o += wn(t, !1, !1, r)), o
        }
        ...
        function Pn(e, t, n) {
            ...
            var i = oe(r, "._im_mess_stack", -1),
                o = oe(r, "._im_mess_stack"),
                s = i ? se("_im_mess", i).pop() : null,
                c = o ? ce("_im_mess", o) : null;
            if (Y(r), rt(t), !c || !s) return t;
            var u = ae(c, "msgid"),
                l = Object(a.getPreviousMessage)(e, n, u),
                _ = Object(a.getMessage)(e, n, u);
            if (!l || yt(e.tabs[n], l, _, e)) return t;
            var f = ce("_im_stack_messages", i),
                h = ce("_im_stack_messages", o).children;
            return Object(d.toArray)(h).forEach(function(e) {
                Y(e), f.appendChild(e)
            }), Y(o), t
        }
        ...
        function Nn(e, t, n) {
            ...
            if (!i) {
                ...
                if (!o) return [!0, 0];
                i = ce("_im_mess_" + o.messageId, t)
            }
            var s = fe(i, "_im_mess_srv") ? i : ue("_im_mess_stack", i);
            if (!s) return [!0, 0];
        ...
        function In(e, t, n) {
            ...
            i && fe(i, "im-page--dialogs-notice") && de(i, "im-page--dialogs-notice"), je.post("al_im.php", {
        ...
        function Dn(e, t, n) {
            ...
            Le(r, 200, Y.pbind(r)), je.post("al_im.php", {
                act: "a_hide_top_notice",
                type: r.getAttribute("data-type"),
                hash: r.getAttribute("data-hash")
            })
        ...
        function An(e, t) {
            ...
            Le(n, 200, Y.pbind(n)), je.post("al_im.php", {
        ...
        function Sn(e, t) {
            ue("_im_aside_promo_block", t).classList.add("--action-called"), je.post("al_im.php", {
        ...
        function Ln(e, t, n, r, i) {
            return n = n.replace(/\<br\s*\/?\>(\n)?/gi, " ").replace(/[\n\r]/gi, " "), n = Object(c.replaceMentions)(n, function(e, t, n, r, i) {
                return i
            }), r && (n = Se.emojiToHTML(n, !0)), t && "..." !== t.trim() && !Object(u.isChatPeer)(e) && (n = ge("im_topic", {
                topic: t,
                cls: "im-topic_dialog"
        ...
        function Fn(e, t) {
            ...
            switch (e.type) {
                ...
                case "respond":
                    ...
                    return ye(r, be("mail_fwd_msgs", "raw"), !0);
                case "photo":
                case "video":
                case "audio":
        ...
        function Un(e) {
            ...
            }) : wt(e, i, n && n.kludges || {}) || ""), i = i.replace(/<br\s?\/?>/gi, " "), ge("im_pinned_message", {
            ...
            if (t && Object(s.isMoneyRequest)(t) && void 0 !== t.kludges.attach1_tr_amount) {
                ...
                if ("RUB" === t.kludges.attach1_currency && (r = be("mail_money_amount_rub", "raw")), t.kludges.attach1_total_amount) {
                    var i = ye(t.kludges.attach1_tr_amount / 1e3, "%s", !0),
                        o = ye(t.kludges.attach1_total_amount / 1e3, r, !0);
                    n = be("mail_money_request_collected_amount_from").replace("{amount}", i).replace("{total_amount}", o)
                } else {
                    var a = ye(t.kludges.attach1_tr_amount / 1e3, r, !0);
                    n = be("mail_money_request_collected_amount").replace("{amount}", a)
                }
        ...
        function Kn(e, t, n) {
            ...
            r && Ne(n, {
                text: be("mail_message_edited") + " " + we(r, e.get().timeshift),
                className: "_im_history_tooltip",
                appendParentCls: "_im_mess_stack",
                black: 1,
                shift: [0, 4]
        ...
        function qn() {
            var e = getSize(ce(K))[1];
            return e || (e = Ke), e
        }

        function zn(e, t) {
            e.bodyNode.addEventListener("mouseover", function(e) {
                fe(e.target, "_im_edit_time") ? Kn(t, 0, e.target) : fe(e.target, "_im_page_info") && Hn(0, 0, e.target)
            })
        }
        ...
        function $n(e, t) {
            for (var n in t) t.hasOwnProperty(n) && Xn(e, t[n])
        }
        ...
        function Jn(e, t) {
            var n = [],
                ...
                i = r ? r[1].split(";") : [];
            for (i.length > We && (r[1] = i.slice(0, We).join(";")); e.length > Ue;) {
                var o = e.substr(0, Ue).lastIndexOf(" "); - 1 == o && (o = Ue), n.push({
                    msgText: Z(e.substr(0, o))
                }), e = Z(e.substr(o))
            }
            for (e.length && n.push({
                    msgText: e,
        ...
        function tr() {
            Me(be("global_error"), be("mail_message_wait_until_uploaded"))
        }
        ...
        function ar(e, t) {
            ...
            if ([
                    ...
                    var t = v(e, 2),
                        ...
                        o = t[1],
                        a = Math.floor(r / n);
                    r %= n, a >= 1 && i.push(ye(a, o))
                }), 1 === (n = i.length)) return i.pop();
            var o = i.slice(0, n - 1).join(", "),
                a = i.pop();
            return be("global_and").replace(/{before}/gi, o).replace(/{after}/gi, a)
        }

        function sr(e, t, n, i) {
            i && !$e(e, n, i) && (Object(a.getMessage)(e, n, i) ? (e.setState({
                msgid: i
        ...
        function cr(e) {
            ...
            var n = e.get().tabs[e.get().peer],
                r = Object(a.parserMessage)(n.msgs[ae(t, "msgid")]);
        ...
        window.curFastChat || (window.curFastChat = {}), window.FastChat = {
            ...
            getResourcesThatShouldBeLoaded: function(e) {
                ...
                function s(e, t) {
                    ...
                    Object(d.isChatPeer)(e) && t && r && !r.data.members[t] && (n[e] ? -1 === n[e].indexOf(t) && n[e].push(t) : n[e] = [t])
                }
            ...
            clistCache: function(e) {
                ...
                for (r in curFastChat.clistCache = {}, curFastChat.friends)
                    for (l = curFastChat.friends[r][0], r = intval(r), d = 0; _ = " " + l.charAt(d).toLowerCase(), curFastChat.clistCache[_] || (curFastChat.clistCache[_] = {}), curFastChat.clistCache[_][r] = 1, -1 != (d = l.indexOf(" ", d + 1));) ++d
            },
            ...
            formatTyping: function(e) {
                var t = e.peerId,
                    ...
                    r = this.getTab(t),
                    i = n[0],
                    o = Object(d.isChatPeer)(t) ? r.data.members[i] : r,
                    a = function(e) {
                        return e.fname || e.name || ""
                    };
                if (1 === n.length || !Object(d.isChatPeer)(t)) return langSex(o.sex, getLang("mail_im_typing")).replace("{user}", a(o));
                var s = n[n.length - 1],
                    c = Object(d.isChatPeer)(t) ? r.data.members[s] : r;
                            ...
                            onClose: function(t) {
                                ...
                                if (delete r[e], curNotifier.isIdle || FastChat.stateChange({
                                    ...
                                    var o, a, s, c, u, l = {},
                                        d = [];
                                    for (each(r, function() {
                                            this.posSeq > i && (l[this.posSeq] = this, d.push(this.posSeq))
                                        }), d.unshift(i), d.sort(), u = !browser.msie && d.length < 10, o = 1; o < d.length; o++) a = d[o], s = l[a].box, c = o > 1 ? l[d[o - 1]].box.pos : t, u ? animate(s.wrap, {
                                        left: c[1]
                                    }, 100, function(e) {
                                        e._update_pos()
            ...
            send: function(e, t, n) {
                ...
                if (curFastChat.sendOnUpload = !1, FastChat.removeProgress(e), a.style.visibility = "visible", i || o.length) {
                    ...
                    for (var _, f = 0, h = o.length; f < h; ++f)(_ = o[f]) && d.media.push(_[0] + ":" + _[1]);
                    d.media = d.media.join(","), r.sending = !0, Emoji.ttHide(r.emojiId), curFastChat.tabs[e].entrypoint = !1, ajax.post("al_im.php", d, {
                        onDone: function(t) {
                            clearTimeout(r.saveDraftTO), FastChat.saveDraft(e), FastChat.sendOnResponse(t, l, r)
                        },
                        onFail: function(t) {
                        ...
                        hideProgress: function() {
                            r.sending = !1, clearTimeout(r.sendProgressTO), FastChat.removeProgress(l)
                        }
            ...
            prepareMessageData: function(e) {
                var t = e.peerId,
                    ...
                    _ = "",
                    h = e.randomId;
                return Object(l.isServiceMsg)(e) && (_ = this.renderServiceMessage(e)), -1 !== String(r).indexOf("rid") && (h = Number(r.slice(3))), Object.assign({
                    id: r,
                    peer: t,
                    from_id: a,
                    text: Object(l.isServiceMsg)(e) ? _ : this.getMessageText(i, t) + u,
                    out: Object(l.isOut)(e),
                    unread: Boolean(1 & n),
                    date: o,
                    date_str: FastChat.mkdate(o),
                    randomId: h,
                    isServiceMessage: Object(l.isServiceMsg)(e)
                }, this.getMessageAuthor(e), d)
            },
            getMessageAuthor: function(e) {
                var t = e.peerId,
                    n = Object(l.getUserId)(e),
                    r = this.getTab(e.peerId);
                if (!r || !n) return {};
                var i = Object(l.isOut)(e) ? curFastChat.me : Object(d.isChatPeer)(t) ? r.data.members[n] : r,
                    o = i.name,
                    a = i.link,
                    s = i.photo,
                    c = i.fname,
                    u = i.first_name;
                return {
                    fname: Object(d.isChatPeer)(t) ? c || u : "",
                    name: o,
                    link: a,
                    photo: s,
                    from_id: n
            ...
            getMessageMedia: function(e) {
                var t = this,
                    ...
                    i = "",
                    o = {};
                return !Object(l.isServiceMsg)(e) && Array.isArray(e.attaches) && (e.attaches.forEach(function(e) {
                    switch (e.type) {
                        case "sticker":
                        ...
                        case "mail":
                            ...
                            i += rs(curFastChat.tpl.msg_fwd, {
                                msg_id: r,
                                peerId_nice: Object(d.convertPeerToUrl)(n),
            ...
            renderServiceMessage: function(e) {
                var t = e.kludges,
                    ...
                    c = r === o;
                switch (i) {
                    case d.CREATE_CHAT_ACTION:
                        s = "mail_im_chat_created";
                        break;
                    case d.CHAT_TITLE_ACTION:
                        s = t.source_is_channel ? "mail_im_title_updated_channel" : "mail_im_title_updated_dot";
                        break;
                    case d.CHAT_INVITE_USER:
                        s = c ? "mail_im_returned_to_chat" : "mail_im_invited";
                        break;
                    case d.CHAT_KICK_USER:
                        s = c ? "mail_im_left" : "mail_im_kicked_from_chat";
                        break;
                    case d.CHAT_PHOTO_UPDATE:
                        s = "mail_im_photo_set";
                        break;
                    case d.CHAT_PHOTO_REMOVE:
                        s = t.source_is_channel ? "mail_im_photo_removed_channel" : "mail_im_photo_removed";
                        break;
                    case d.CHAT_PIN_MESSAGE:
                        s = t.source_message ? "mail_im_pin_message" : "mail_im_pin_message_empty2";
                        break;
                    case d.CHAT_UNPIN_MESSAGE:
                        s = t.source_message ? "mail_im_unpin_message" : "mail_im_unpin_message_empty2";
                        break;
                    case d.CHAT_INVITE_BY_LINK:
                        s = "mail_im_invite_by_link";
                        break;
                    default:
                        return "mail_no_support"
                }
                if (s = (s = langSex(a.sex, getLang(s, "raw"))).replace("{from}", Object(d.serviceLink)(a.link, a.name, !0)), o && o !== r) {
                    var u = t.source_email;
                    if (u) s = s.replace("{user}", Object(d.serviceLink)("/im?email=" + encodeURIComponent(u), "email", !0));
                    else {
                        var l = this.getMember(n, o) || {
                                name_inv_case: "",
                                name_kick_case: "",
                                link: ""
                            },
                            _ = i === d.CHAT_KICK_USER ? l.name_kick_case : l.name_inv_case;
                        s = s.replace("{user}", Object(d.serviceLink)(l.link, _, !0))
                    }
                }
                if (t.source_text) {
                ...
                if (t.source_act === d.CHAT_PIN_MESSAGE || t.source_act === d.CHAT_UNPIN_MESSAGE)
                    if (t.source_message) {
                        var h = Object(d.replaceSpecialSymbols)(Emoji.emojiToHTML(stripHTML(t.source_message.replace(/<br\s?\/?>/gi, " ")), !0)),
                            p = Object(d.serviceLink)("", h, !1, "im_srv_mess_link");
                        s = s.replace("{msg}", p)
                    } else s = s.replace(/{link}(.+){\/link}/i, function(e, t) {
                        return Object(d.serviceLink)("", t, !1, "im_srv_mess_link")
                    });
                return s
            },
            getMember: function(e, t) {
                var n = this.getTab(e);
                return Object(d.isChatPeer)(e) && n ? n.data.members[t] : n || null
            },
            ...
            addMessage: function(e) {
                ...
                domFC(s) && "BR" == domFC(s).tagName && re(domFC(s)), c ? s.insertBefore(l, c) : s.appendChild(l), vk.id != e.from_id && (delete curFastChat.typingEvents[t], FastChat.updateTyping(t, 1)), n.scroll && n.scroll.update()
            },
            getTab: function(e) {
            ...
            updateTabUnreadCounter: function(e, t) {
                ...
                Object(l.isOut)(t) ? e.unread = 0 : e.unread++, this.updateTabUnreadCounterElement(e, t.peerId)
            },
    ...
    202: function(e, t, n) {
        ...
        function d(e) {
            if (window.scrollNode && !c.browser.mobile && window._tbLink) {
                ...
                if (window._stlSideTop = Math.max((d ? Object(r.getSize)(l)[1] : 0) - i - (c.browser.mozilla ? Object(r.getXY)(pageNode)[1] : 0), n[1]), e || o != __scrLeft) {
    ...
    21: function(e, t, n) {
        ...
        function ee(e, t, n) {
            ...
            var i = ie(e)[1],
                ...
                _ = vk.staticheader ? Math.max(0, ae(l)[1] - d) : ae(l)[1];
            if (t) {
                if (i + o < d + _ + n) return i + o - d - _ - n;
                if (i > d + u - n) return i - d - u + n
            } else {
                if (i < d + _ + n) return i - d - _ - n;
                if (i + o > d + u - n) return i + o - d - u + n
            }
            return 0
        }
        ...
        function he(e, t, n) {
            return void 0 === n && (n = !ue(e, t)), (n ? le : _e)(e, t), n
        }

        function pe(e, t, n, i) {
            return i = Object(r.positive)(i), void 0 === n && (n = !ue(e, t)), (n ? de : fe)(e, t, i), n
        }
        ...
        function Ce(e, t, n) {
            ...
            i || (ye(e, "pseudo-id", i = Object(r.irand)(1e8, 999999999)), le(e, "_pseudo_" + i));
            var o = t + "-style-" + i,
                a = s(o),
                c = "._pseudo_" + i + ":" + t + "{";
    ...
    23: function(__webpack_module__, __webpack_exports__, __webpack_require__) {
        ...
        var _ui__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(202),
            _debug_tools__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(150),
            _dom_events__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(500),
            _ui_util__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(671),
            _dom__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(21),
            _fx__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(311),
            _utils_common__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(268),
            _lang__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(465),
            _ajax__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(265),
            _box_utils__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(279),
            _accessibility__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(667);
        ...
        function showCaptchaBox(e, t, n, r) {
            ...
            return o && (u.value = "", l.src = "/captcha.php?sid=" + e + a, Object(_dom__WEBPACK_IMPORTED_MODULE_4__.hide)(Object(_dom__WEBPACK_IMPORTED_MODULE_4__.geByClass1)("progress", n.bodyNode))), Object(_dom__WEBPACK_IMPORTED_MODULE_4__.show)(u), Object(_dom_events__WEBPACK_IMPORTED_MODULE_2__.addEvent)(u, "keypress", i), Object(_dom_events__WEBPACK_IMPORTED_MODULE_2__.addEvent)(l, "click", function() {
    ...
    245: function(__webpack_module__, __webpack_exports__, __webpack_require__) {
        "use strict";
        __webpack_require__.r(__webpack_exports__);
        var _helpers_im_shared_helpers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(495),
            _longpoll_singleton__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(630),
            _lib_debug_tools__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(150),
    ...
    265: function(__webpack_module__, __webpack_exports__, __webpack_require__) {
        "use strict";
        ...
        var _utils_common__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(268),
            _debug_tools__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(150),
            _browser__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(133),
            _dom__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(21),
            _dom_events__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(500),
            _message_box__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(23),
            _utils__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(705),
            _ui_util__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(671),
            _box_utils__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(279),
            _lang__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(465),
    ...
    279: function(e, t, n) {
        ...
        function _(e) {
            ...
            t.parentEl ? Object(o.geByClass1)(t.parentEl).appendChild(l) : bodyNode.insertBefore(l, pageNode);
                ...
                m = function e() {
                    h < 0 || (window.doneBoxTO = setTimeout(function() {
                        !t.permit || t.permit() ? Object(a.fadeOut)(l.firstChild, 500, function() {
                            Object(o.re)(l), t.callback && t.callback()
                        }) : e()
                    }, h))
                };
    ...
    311: function(e, t, n) {
        ...
        function s(e, t, n, s) {
            if (e = Object(i.ge)(e)) {
                ...
                return u.show && !f && Object(i.show)(e), p = new l(e, u), Object(r.each)(t, function(t, n) {
                    ...
                    }(h != n || Object(r.isArray)(h) && h.join(",") === n.join(",")) && (d[t] = h, _[t] = n)
                }), p.start(d, _), Object(i.data)(e, "tween", p), p
            }
        }
        ...
        function c(e, t, n, r, i, o) {
            ...
            for (; h < p;) {
                var m = a(l);
                if (Math.abs(m - u) < o) return s(l);
                u > m ? h = l : p = l, l = .5 * (p - h) + h
            }
            return s(l)
        }
        ...
        function b(e, t, n) {
            var i = Object(r.createMutations)(g).bindMutations,
                c = function(e, t, n) {
                    ...
                    if (n.target.classList.contains(l)) i && f(e, r, t);
    ...
    465: function(e, t, n) {
        ...
        function h(e, t, n, o, a, s) {
            ...
            return 68 === vk.lang && (l.year = l.year + 543), t.replace("{hour}", l.hours).replace("{num_hour}", Object(r.leadingZero)(l.hours)).replace("{minute}", Object(r.leadingZero)(l.minutes)).replace("{day}", l.day).replace("{num_day}", Object(r.leadingZero)(l.day)).replace("{month}", o[l.month]).replace("{year}", l.year).replace("{short_year}", l.year % 100).replace("{second}", Object(r.leadingZero)(l.seconds)).replace("{am_pm}", d)
        }
    ...
    468: function(e, t, n) {
        ...
        var c = 1,
            ...
            g = "change_title",
            b = "add_admin",
            v = (s(r = {}, f, _), s(r, h, _), s(r, b, d), s(r, p, c), s(r, m, u), s(r, g, l), r),
            C = 1;
        ...
        function P(e, t, n, r) {
            ...
            switch (t) {
                ...
                case h:
                case b:
                    return N(c, l) ? I(c, r) && u : D(c, r);
                case p:
                case m:
                case g:
                    return N(c, l) ? I(c, r) && u : u
            }
            return !1
        }
    ...
    495: function(e, t, n) {
        ...
        function m(e, t) {
            ...
            if (u.length > 55 && (u = u.substr(0, 53) + ".."), u = a(u).replace(/&amp;/g, "&"), !e && c.match(r.OUR_DOMAINS)) {
                var l, d = i = s(i).replace(r.ENTITIES, encodeURIComponent),
                    _ = i.indexOf("#/"),
                    f = "";
                return _ >= 0 ? d = i.substr(_ + 1) : (_ = i.indexOf("#!")) >= 0 && (d = "/" + i.substr(_ + 2).replace(/^\//, "")), (l = d.match(r.VK_DOMAIN)) && l[1].length < 32 && (f = ' mention_id="' + l[1] + '" onclick="return mentionClick(this, event)" onmouseover="mentionOver(this)"'), '<a href="' + function(e) {
        ...
        function s(e, t, n, o, a, s) {
            if ((e = Object(r.ge)(e)) && 3 != e.nodeType && 8 != e.nodeType) {
                ...
                Object(i.each)(t.split(/\s+/), function(t, n) {
                    d[n] || (d[n] = [], !o && e.addEventListener ? e.addEventListener(n, f, s) : !o && e.attachEvent && e.attachEvent("on" + n, f)), d[n].push(u)
                })
            }
        }
    ...
    504: function(e, t, n) {
        ...
        function d(e, t, n) {
            ...
            return function() {
                var e = +new Date - o;
                statlogsValueEvent("messages_send_time_web", e, t, n, a, i)
            }
        }
        ...
        function h(e, t, n, i) {
            var o = p(e),
                a = "" === t ? "network" : "unknown";
            Object(r.randEnabled)(1) && statlogsValueEvent("messages_send_errors_web", a, n, i, o)
        }
    ...
    580: function(__webpack_module__, __webpack_exports__, __webpack_require__) {
        "use strict";
        __webpack_require__.r(__webpack_exports__);
        var _lib_debug_tools__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(150);
        window.TopNotifierCur || (window.TopNotifierCur = {
            ...
            checkClick: function(e, t) {
                ...
                if (n && n.className) {
                    ...
                    for (r = 0; r < a.length; ++r) {
                        var l = a[r].match("feedback_(.+)_row");
                        if (a[r] && l && l[1]) {
                            s = l[1];
                            break
                        }
            ...
            apiCallProcess: function(e, t, n, r, i) {
                if (isButtonLocked(i)) return !1;
                var o = function() {
                    ajax.post("/al_feed.php", {
                        act: "a_api_call",
                        hash: cur.topNotifyHash,
                ...
                return r ? cur.confirmBox = showFastBox(getLang("global_action_confirmation"), r, getLang("global_yes"), function() {
                    o(), cur.confirmBox.hide()
                }, getLang("global_cancel")) : o(), !0
            },
    ...
    620: function(e, t, n) {
        ...
        function B(e, t, n, i, o) {
            return o.tabHistoryNotChanged = !1, Object(a.retryFn)(r.post, 3, function(e) {
                ...
                if (a.forEach(function(e) {
                    ...
                    }), o.tabs || (o.tabs = {}), o.dialog_tab_cts = l, o.tabs[e] || (o.tabs[e] = Object(u.normalizeTab)(o, i)), F(c, o), n) {
                    if (o.tabs[e]) {
                ...
                return o.admins = extend(o.admins, s), o.imQueue(e, !1), Rn(), R(e, o)
            }).catch(function(e) {
        ...
        function z(e, t, n, r) {
            if (Rt(r)) throw Object(u.showWaitUntilUploadedBox)(), new Error("Cant change peer while loading something");
            ...
            if (r.prevPeer = r.peer, r.peer = e, r.msgid = t || "", r.currentEntryPoint = n, cur.peer = e, x({
                ...
                Object(u.isTabLoaded)(r, e) && K(e, r, !0), nn(r.tabbedPeers.map(function(e) {
                    return e.peer
                }).indexOf(e) < 0 ? [{
                    peer: e,
                    type: "perm"
        ...
        function G(e) {
            cur.wallMentions = function() {
                return new Promise(function(t, n) {
                    ...
                    r.membersLoaded ? i() : Mn(e.peer, e).then(i)
                })
            }
        }
        ...
        function ne(e, t, n, r) {
            ...
            t.deletedDialog || (e.dialog_tabs = Object.keys(e.dialog_tabs).reduce(function(e, o) {
                return !n && !qt(o)(t) || i && !i(o, e[o], t) || (e[o] = Object(s.arrayUnique)(r(e[o], o))), e
            }, e.dialog_tabs))
        }
        ...
        function ue(e, t) {
            ...
            if (Object(u.isTabLoaded)(t, r)) {
                ...
                return i.lastmsg = e.messageId, i.lastmsg_meta = e, K(e.peerId, t), ne(t, i, !1, oe.bind(null, r), Gt.bind(null, t)), Promise.resolve(t)
            }
            return B(r, 0, 0, 0, t).then(function(t) {
                return ne(t, t.tabs[r], !1, oe.bind(null, r), Gt.bind(null, t)), K(e.peerId, t), n || ie(e.peerId, t), t
            })
        }
        ...
        function de(e, t) {
            if (Object(u.isFullyLoadedTab)(t, e.peerId)) {
                var n = t.tabs[e.peerId],
                    r = n.unread;
                if (t = X(t, e.peerId, e.upToId, 0), null != e.unread ? n.unread = e.unread : n.unread = e.upToId >= n.lastmsg ? 0 : Object(d.countUnread)(e.peerId, t) + (n.unread > 0 ? +n.skipped : 0), r > 0 && !n.unread && le(t, -1, e.peerId), !n.skipped) {
                    var i = S(n.history);
            ...
            })), 0 !== t.unread_cnt || t.active_tab !== l.FOLDER_UNREAD || t.gid ? Promise.resolve(t) : zt(l.FOLDER_ALL, t)
        }
        ...
        function he(e, t, n) {
            ...
            if (1 === e.length) {
                ...
                return !1 === a ? n.set(mt.bind(null, y({}, t, [o.userId]))).then(function(n) {
        ...
        var ye = function(e, t, n, i) {
                ...
                return Object(r.post)(w, l, 2e4).then(function(e) {
                    var t = C(e, 1)[0];
        ...
        function Je(e, t) {
            ...
            return Object(r.post)(w, {
                ...
                n.unread = s[0], n.in_up_to = s[1], n.out_up_to = s[2], n.unread || (e.get().dialog_tabs[l.FOLDER_UNREAD] = e.get().dialog_tabs[l.FOLDER_UNREAD].filter(function(e) {
                    return e != t
                })), ne(e.get(), n, !1, oe.bind(null, t), Gt.bind(null, e.get()))
            })
        }
        ...
        var ot = A(function(e, t, n) {
                return n.tabs[e].lastTyping = Date.now(), Object(r.post)(w, {
                    act: "a_activity",
                    type: t,
                    peer: e,
                    gid: n.gid,
        ...
        function bt(e, t, n) {
            var r = e.needMembers,
                i = e.needAdminIds,
                o = e.needPeers;
            return t.pause(), Promise.all([mt(r, n), re(i, n), Promise.all(o.map(function(e) {
                return B(e, 0, 0, 0, n)
            }))]).catch(function() {
                return n
            }).then(function() {
        ...
        var yt = A(function(e, t) {
                return Object(r.post)(w, {
                    ...
                    gid: t.gid,
                    hash: t.tabs[e].hash
                }).then(Ct.bind(null, u.CHAT_KICK_USER, vk.id, e, t))
            }),
            Ot = A(function(e, t) {
                return Object(r.post)(w, {
                    ...
                    gid: t.gid,
                    hash: t.tabs[e].hash
                }).then(Ct.bind(null, u.CHAT_INVITE_USER, vk.id, e, t))
            }),
            wt = A(function(e, t, n) {
                return Object(r.post)(w, {
                    act: "a_mute",
        ...
        var kt = A(function(e, t, n, i) {
            return jt(e, n, t, i), Object(r.post)(w, {
        ...
        function Lt(e) {
            ...
            return Object(r.post)(w, {
                ...
                return p.then(function(n) {
                    e.tabs = o, e.admins = extend(e.admins, d), n && (e.tabs[h] = n.tabs[h], e.tabs[h].history = Object(u.restoreQueue)(h, e, S(e.tabs[h].history))), e.loadingDialogs = !1, e.mutedPeers = c.mutedPeers, e.lastDialogsOptions = {
                        has_more: c.has_more
                    ...
                    return Object.keys(e.dialog_tabs).filter(function(e) {
                        ...
                        i == l.FOLDER_ALL ? e.dialog_tabs[t] = r.filter(qt(t)).map(function(e) {
                            return e.peerId
                        }) : e.dialog_tabs[t] = []
                    }), delete e.resync_in_process, setTimeout(t.bind(null, !0), 0), Ut(intval(c.unread), e)
                })
            }).catch(function(t) {
                return Object(s.lplog)("Resync error: " + t.message + " " + t.stack, "error"), Object(a.pause)(2).then(Lt.bind(null, e))
            })
        }
        ...
        function Vt(e, t, n, r, i) {
            ...
            return B(e, 0, 0, 0, i).then(Vt.bind(null, e, t, n, i))
        }
        var Yt = A(function(e, t) {
        ...
        var Zt = A(function(e, t) {
            return ne(t, t.tabs[e], !0, function(t) {
                ...
                return n[0] ? (nn(t.tabbedPeers.filter(function(t) {
                    return t.peer !== e
                }), !0, t), t.tabs[e].unread = 0, t.tabs[e].lastmsg = !1, t.tabs[e].lastmsg_meta = null) : (t.tabs[e].deletedDialog = !1, ne(t, t.tabs[e], !1, oe.bind(null, e), Gt.bind(null, t))), n
            })
        });
        ...
        var mn = A(function(e, t, n) {
            return Object(r.post)(w, {
                ...
                }), n.tabs[r] = i, ne(n, i, !1, oe.bind(null, r), Gt.bind(null, n)), n.admins = extend(n.admins, a), [r]
            })
        });
        ...
        var Tn = A(function(e, t, n) {
            ...
            Pn = A(function(e, t) {
                return Promise.all([Mn(e, t), function(e, t) {
                    var n = t.tabs[e];
                    return Object(r.post)(w, {
        ...
        function Fn(e, t, n, r) {
            ...
            return Object(f.oCacheGet)(r, i) ? Promise.resolve(r) : mt(y({}, n, [i]), r)
        }
    ...
    630: function(e, t, n) {
        ...
        function f(e, t, n) {
            u.onLp(e, t, n), d() && _() && (e != t || n.length) && function(e, t, n) {
        ...
        function h() {
            return l() ? (u || (s.lpConfig.id = s.id, window.lpConnect = c = Object(r.createLongpoll)(s.lpConfig, f), e = Object(i.createLongpollEventsQueue)(s.lpConfig.ts, function(e) {
        ...
        function p() {
            l() && (Object(o.lpLogFc)("orange", "init longpoll connection on load"), h(), window.curNotifier.idle_manager.on("unidle", function() {
                c.abortWaiting()
            }), m())
        }

        function m() {
            l() && (d() ? c.isStopped() && _() ? (Object(o.lpLogFc)("orange", "now master, init connection"), Object(a.imWeirdLog)("fc_longpoll_master", {}, !1), c.reinitConnection()) : c.isStopped() || _() || (Object(o.lpLogFc)("orange", "now slave, stop connection"), Object(a.imWeirdLog)("fc_longpoll_slave", {}, !1), c.stopConnection()) : setTimeout(m, 500))
        }

        function g(e) {
            d() && !_() && l() && (Object(o.lpLogFc)("silver", "recv from master", e.tsOld, e.tsNow, e.evs), c.onLp(e.tsOld, e.tsNow, e.evs))
        }
    ...
    632: function(e, t, n) {
        "use strict";
        n.r(t);
        n(347), n(472), n(643), n(245), n(201), n(127), n(580);
            ...
            _head_mdown: function(e) {
                if (!checkEvent(e)) {
                    ...
                    r.options.fixed && FastChat.pinTab(r.options.peer || -1, e, !0), a || r.focus(e), r.toBottom ? (r.toBottom = !1, t = o[0] - intval(getStyle(r.wrap, "bottom")) - u, setStyle(r.wrap, {
                        top: t,
                        bottom: "auto"
                    }), removeClass(r.wrap, "fc_tobottom")) : t = intval(getStyle(r.wrap, "top")), r.toRight ? (r.toRight = !1, n = o[1] - intval(getStyle(r.wrap, "right")) - l, setStyle(r.wrap, {
                        left: n,
                        right: "auto"
                    })) : n = intval(getStyle(r.wrap, "left")), d = t, _ = n, cur._fcdrag = 1;
                    var m = function(e) {
                        return d = Math.max(0, Math.min(f, t + e.pageY - s)), f - d < 10 ? d = f : d < 10 && (d = 0), r.wrap.style.top = d + "px", _ = Math.max(0, Math.min(h, n + e.pageX - c)), h - _ < 10 ? _ = h : _ < 10 && (_ = 0), r.wrap.style.left = _ + "px", cancelEvent(e)
                    };
                    return addEvent(document, "mousemove", m), addEvent(document, "mouseup", function e(t) {
                        cur._fcdrag = 0, removeEvent(document, "mousemove", m), removeEvent(document, "mouseup", e), removeEvent(document, p, cancelEvent), setStyle(bodyNode, "cursor", ""), setStyle(i, "cursor", ""), (r.toBottom = d >= f - 5) && (setStyle(r.wrap, {
                            top: "auto",
                            bottom: 0
                        ...
                        cur._fcpromo > 0 ? cur._fcpromo = n ? 0 : -1 : r.options.minimizer && n ? !r.minimized && a ? r.minimize(!0) : r.minimized && r.unminimize(!0) : r.options.onDragEnd && r.options.onDragEnd(r.toBottom ? -1 : d / o[0], r.toRight ? -1 : _ / o[1])
            ...
            _resize_mdown: function(e) {
                if (!checkEvent(e)) {
                    ...
                    var m = _ + o[0] - t - c,
                        g = f + o[1] - n - u,
                        b = function(e) {
                            return l = Math.max(r.options.minH, Math.min(m, _ + e.pageY - a)), m - l < 10 && (l = m), r.resizeableH.style.height = l + "px", d = Math.max(r.options.minW, Math.min(g, f + e.pageX - s)), g - d < 10 && (d = g), r.resizeableW.style.width = d + "px", p && p(l, d), cancelEvent(e)
                        };
                    return addEvent(document, "mousemove", b), addEvent(document, "mouseup", function e(t) {
                        removeEvent(document, "mousemove", b), removeEvent(document, "mouseup", e), removeEvent(document, h, cancelEvent), setStyle(bodyNode, "cursor", ""), setStyle(i, "cursor", ""), (r.toBottom = l == m) && (setStyle(r.wrap, {
                            top: "auto",
                            bottom: 0
                            ...
                            right: 0,
                            marginRight: lastWndScroll[0] ? sbWidth() : 0
                        }), r._update_pos(), r.options.onResizeEnd && r.options.onResizeEnd(l, d, o[0], o[1], r.toBottom, r.toRight)
    ...
    647: function(e, t, n) {
        ...
        function Ne(e) {
            var t = i(e, 2)[1],
                n = void 0 === t ? {} : t,
                r = _e([!1, n.id, n.flags, n.peer_id, n.date, n.message, extend(n.kludges, {
                    title: n.title || ""
    ...
    671: function(__webpack_module__, __webpack_exports__, __webpack_require__) {
        "use strict";
        ...
        var _dom__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(21),
            _utils_common__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(268);
    ...
    705: function(__webpack_module__, __webpack_exports__, __webpack_require__) {
        "use strict";
        ...
        var _utils_common__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(268),
            _ui_util__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(671),
            _debug_tools__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(150),
            _cookies__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(205),
            _ajax__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(265),
            _message_box__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(23),
            _dom__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(21),
            _lang__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(465),
            _browser__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(133),
            _accessibility__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(667),
            _dom_events__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(500),
            _scroll__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(411);
