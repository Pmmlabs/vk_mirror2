! function(e) {
    ...
    i(95), i(62), i(66), i(31), i(69), i(76), i(112), window.getWndInner = r, window.lastWndScroll = [!1, !1], window.updateWndVScroll = a, window.defBox = n;
    try {
    ...
    "use strict";
    var _im_shared_helpers = __webpack_require__(22),
    ...
    var r = i(40),
        a = {};
    a[i(80)("toStringTag")] = "z", a + "" != "[object z]" && i(53)(Object.prototype, "toString", function() {
    ...
    t.f = i(29) ? Object.defineProperty : function(e, t, i) {
    ...
    e.exports = function(e, t, i, v, b, C, y) {
        ...
        var w, N, T, k = function(e) {
            ...
            I = S[f] || S[p] || b && S[b],
            O = I || k(b),
            L = b ? E ? k("entries") : O : void 0,
            M = "Array" == t ? S.entries || I : I;
        if (M && (T = d(M.call(new e)), T !== Object.prototype && (l(T, F, !0), r || s(T, f) || o(T, f, g))), E && I && I.name !== m && (x = !0, O = function() {
                return I.call(this)
            }), r && !y || !h && !x && S[f] || o(S, f, O), c[t] = O, c[F] = g, b)
            if (w = {
                    values: E ? O : k(m),
                    keys: C ? O : k(_),
                    entries: L
    ...
    var r = i(91),
        ...
        c = Function[s],
        u = ("" + c).split(s);
    i(145).inspectSource = function(e) {
        return c.call(e)
    ...
    function i(e, t) {
        ...
        i.toBottom = i.toRight = !1, t.fixed ? (n.bottom = 0, n.right = 72) : (void 0 !== t.startTop ? n.top = t.startTop : void 0 !== t.startBottom && (n.bottom = t.startBottom), void 0 !== t.startLeft ? n.left = t.startLeft : void 0 !== t.startRight && (n.right = t.startRight)), setStyle(i.wrap, n), t.movable && addEvent(t.movable, "mousedown", i._head_mdown.bind(i)), i.resizeableH = t.resizeableH || e, t.startHeight && setStyle(i.resizeableH, "height", t.startHeight), i.resizeableW = t.resizeableW || e, t.startWidth && setStyle(i.resizeableW, "width", t.startWidth), addEvent(e, "mousedown", i._cont_mdown.bind(i)), t.closer && (addEvent(t.closer, "mousedown", i._close_mdown.bind(i)), addEvent(t.closer, "click", i._close_click.bind(i))),
            t.hider && (addEvent(t.hider, "mousedown", i._close_mdown.bind(i)), addEvent(t.hider, "click", i._hide_click.bind(i))), t.minimizer && t.minimizer !== !0 && (addEvent(t.minimizer, "mousedown", i._close_mdown.bind(i)), addEvent(t.minimizer, "click", i._min_toggle.bind(i))), i.wrap.appendChild(e), t.resize !== !1 && (i.resizeWrap = ce("div", {
    ...
    function g(e, t, i) {
        ...
        return a && (a.parentNode.replaceChild(Kt(r), a), C(i)), i
    }
    ...
    function y(e, t, i) {
        ...
        if (!l || P(o, l, t, e, a)) {
            var p = "",
                _ = !1;
            if (d && (0, Ct.isOut)(t) && Ue(e, i, t.peerId), 1 === o.unread && !(0, Ct.isOut)(t) && a && (p += gi("im_mess_bar", {}), _ = !0, Ue(e, i, t.peerId)), !Fi(new Date(h))) {
                var m = new Date,
            ...
            if (ce(t)) p += gi("im_service_row", {
                ...
                var b = e.gid && (0, Ct.isOut)(t) ? Jt(t.kludges.from_admin) || 0 : 0,
                    y = (0, kt.oCacheGet)(e, b ? -e.gid : f) || o,
                    N = S(t.peerId) ? y.name : y.first_name,
                    T = y.link || o.href,
                    k = gi("im_mess_stack_name", {
                        name: N,
                        link: T,
                ...
                if ((0, Ct.isGift)(t)) {
                    ...
                    k += ' <span class="im-mess-stack--gift">' + bi(y.sex || 0, F) + "</span>"
                }
                if ((0, Ct.isMoney)(t)) {
                    var E = (0, Ct.isMoneyRequest)(t) ? vi("mail_money_request_message_sent", "raw") : vi("mail_money_tranfer_message_sent", "raw");
                    k += ' <span class="im-mess-stack--money-transfer">' + bi(y.sex || 0, E) + "</span>"
                }
                t.attaches[0] && "chronicle_invite" === t.attaches[0].type && (k += " " + vi("mail_chronicle_invite_inf"));
    ...
    function P(e, t, i, r, a) {
        ...
        var n = R(t.date, r),
            o = R(i.date, r);
        return ki(n, o) ? (0, _t.isCommunityInterface)(r) && Jt(t.kludges.from_admin) !== Jt(i.kludges.from_admin) ? !0 : i.date - t.date > 300 ? !0 : ce(t) || ce(i) ? !0 : (0, Ct.isGift)(t) || (0, Ct.isGift)(i) ? !0 : (0, Ct.isGraffiti)(t) || (0, Ct.isGraffiti)(i) ? !0 : (0, Ct.isUnread)(e, t) === (0, Ct.isUnread)(e, i) || !a || (0, Ct.isOut)(i) || he(i.peerId, r.gid) ? !1 : !0 : !0
    }
    ...
    function G(e, t, i) {
        ...
        var r = t.data.active.slice(0, 4).map(kt.oCacheGet.bind(null, e)),
            a = r.map(function(e) {
                return e.photo
            }),
    ...
    function we(e, t, i) {
        var r = vi("mail_dialog_msg_delete_N", t),
            a = Si(vi("mail_dialog_msg_delete_title"), r, vi("mail_delete"), function() {
                ...
                var n = (0, Nt.createModule)({
                    handlers: function(a, o) {
                        o(r.bodyNode.parentNode, "click", "_im_invite_box", function() {
                            r.hide(), ke(e, e.get().peer, t, i), (0, Nt.destroyModule)(n)
    ...
    function Pe(e, t) {
        ...
        var r = wi(i[1], e.get().timeshift),
            a = bi((0, kt.oCacheGet)(e, t).sex, vi("mail_last_activity_tip", "raw")).replace("{user}", "").replace("{time}", r);
    ...
    function et(e) {
        ...
        if (!i || !(0, Ft.isPinnedMessageVisibleInTab)(e, (0, _t.getPeer)(e))) return "";
        var r = (0, kt.oCacheGet)(e, i.userId);
        if (!r) return "";
        var a = i.text;
    ...
    function ot(e, t) {
        var i = (0, kt.oCacheGet)(e, t.peerId),
    ...
    var r = i(40),
        a = i(80)("iterator"),
        n = i(79);
    e.exports = i(145).getIteratorMethod = function(e) {
    ...
    e.exports = function(e, t, i, _, m, g) {
        ...
        if ("function" == typeof b && (g || y.forEach && !d(function() {
            ...
            }), b.prototype = y, y.constructor = b), (F || x) && (N("delete"), N("has"), m && N("get")), (x || k) && N(C), g && y.clear && delete y.clear
    ...
    var r = i(10),
        ...
        u = function() {
            var e, t = i(147)("iframe"),
                r = n.length,
                a = ">";
            for (t.style.display = "none", i(104).appendChild(t), t.src = "javascript:", e = t.contentWindow.document, e.open(), e.write("<script>document.F=Object</script" + a), e.close(), u = e.F; r--;) delete u[c][n[r]];
            return u()
        };
    ...
    function H(e, t) {
        if ((0, Wt.isFullyLoadedTab)(t, e.peerId)) {
            var i = t.tabs[e.peerId],
                r = i.unread;
            if (t = F(t, e.peerId, e.upToId, 0), null != e.unread ? i.unread = e.unread : i.unread = e.upToId >= i.lastmsg ? 0 : (0, Vt.countUnread)(e.peerId, t) + (i.unread > 0 ? +i.skipped : 0), r > 0 && !i.unread && B(t, -1, e.peerId), !i.skipped) {
                var a = u(i.history);
    ...
    function j(e, t) {
        var i = t.tabs[e.peerId];
        if ((0, Wt.isTabLoaded)(t, e.peerId) && F(t, e.peerId, e.upToId, jt.FLAG_OUTBOUND), (0, Wt.isFullyLoadedTab)(t, e.peerId)) {
            var r = u(i.history);
    ...
    function q(e, t, i, r, a) {
        return a.text = {}, a.imQueue = e, a.imQueueResend = t,
            a.imQueueSet = i, a.imQueueComplete = r, Promise.resolve(a)
    }
    ...
    function le(e) {
        ...
        return i = e.dialog_tabs[t].length > 0 ? Math.min.apply(null, e.dialog_tabs[t].map(function(t) {
            ...
            }), h(s, e), U(n, e), e.dialog_tabs[t] = e.dialog_tabs[t].concat(Object.keys(n).map(intval)), e.dialog_tabs_all[t] = !a.has_more, Promise.resolve(e)
        })
    }
    ...
    t.readLastMessages = c(function(e, t) {
        ...
        return i.skipped > 0 && (r = r.filter(function(e) {
            ...
            return F(t, e, r, jt.FLAG_OUTBOUND)
        }))
    ...
    e.exports = i(91).document && document.documentElement
}, function(e, t, i) {
    var r = i(2);
    e.exports = function(e, t, i) {
    ...
    for (var r = i(57), a = i(53), n = i(91), o = i(54), s = i(79), c = i(80), u = c("iterator"), l = c("toStringTag"), d = s.Array, f = ["NodeList", "DOMTokenList", "MediaList", "StyleSheetList", "CSSRuleList"], h = 0; 5 > h; h++) {
        var p, _ = f[h],
            m = n[_],
            g = m && m.prototype;
        if (g) {
    ...
    var r, a = "\\w\\$А-Яа-яёЁєЄҐґЇїІіЈј",
        ...
        x = t.ENTER = 13,
        S = t.ESC = 27,
        I = (t.UNPRINTABLE_KEYS = [w, N, T, k, x, S, F, E], t.UP_DOWN_CONTROLS = [T, k, N, w, E, F], t.PRINTABLE = "printable", t.FOLDER_UNREAD = "unread"),
        O = t.FOLDER_ALL = "all",
    ...
    e.exports = {
        set: Object.setPrototypeOf || ("__proto__" in {} ? function(e, t, r) {
            try {
                r = i(105)(Function.call, i(144).f(Object.prototype, "__proto__").set, 2), r(e, []), t = !(e instanceof Array)
            } catch (a) {
                t = !0
            }
            return function(e, i) {
    ...
    var r = i(42),
        a = i(10),
        n = i(139);
    e.exports = i(29) ? Object.defineProperties : function(e, t) {
        a(e);
    ...
    var r = i(80)("unscopables"),
        a = Array.prototype;
    void 0 == a[r] && i(54)(a, r, {}), e.exports = function(e) {
        a[r][e] = !0
    }
}, , function(e, t, i) {
    var r = i(146),
    ...
    i(41), i(34), i(114), i(86), e.exports = i(145).Map
}, function(e, t, i) {
    var r = i(80)("iterator"),
        a = !1;
    try {
