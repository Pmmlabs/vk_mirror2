! function(e) {
    ...
    107: function(e, t, n) {
        ...
        function m(e) {
            return s(e, "link") && _(e.kludges.attach1_url)
        }
    ...
    139: function(e, t, n) {
        ...
        function o(e, t, n) {
            return Object(At.post)(At.CONTROLLER, {
                act: "a_renew_hash",
                peers: e.join(","),
        ...
        function h(e, t, n, r, i) {
            return i.tabHistoryNotChanged = !1, Object(Dt.retryFn)(At.post, 3, function(e) {
                return e - 1
            })(At.CONTROLLER, {
                act: "a_start",
                peer: e,
        ...
        function _(e, t) {
            return (t.block_states[e] || {}).free === !1 ? Promise.resolve(t) : Object(At.post)(At.CONTROLLER, {
                act: "a_block",
                peer: e,
                prevPeer: t.prevPeer,
                gid: t.gid
        ...
        function I(e, t) {
            return 0 === e.length ? Promise.resolve(t) : Object(At.post)(At.CONTROLLER, {
                act: "a_get_admin",
                admins: e.join(","),
                gid: t.gid
            }).then(function(e) {
        ...
        function J(e, t) {
            ...
            return Object(Dt.retryFn)(At.post, 3, function(e) {
                return e * e
            })(At.CONTROLLER, n).then(function(n) {
                return Z(e, n, t)
            })["catch"](function() {
                return Z(e, null, t)
            })
        ...
        function ue(e, t) {
            ...
            return Object(Dt.retryFn)(At.post, 1, function() {
                return 4
            })(At.CONTROLLER, {
        ...
        function de(e) {
            ...
            })) : 0, Object(At.post)(At.CONTROLLER, {
                act: "a_get_dialogs",
                start_message_id: n,
                tab: t,
                gid: e.gid
        ...
        function He(e, t, n) {
            return Object(At.post)("al_page.php", {
        ...
        function Ke(e, t) {
            return t.ctrl_submit = !!e, Object(At.post)(At.CONTROLLER, {
        ...
        function it(e, t) {
            return f(r({}, e, {
                free: !0
            }), t), Object(At.post)(At.CONTROLLER, {
                act: "a_block_release",
                peer: e,
                gid: t.gid
            }).then(function() {
        ...
        function ht(e, t, n) {
            ...
            return r.blocked_community = !e, Object(At.post)(At.CONTROLLER, {
        ...
        var At = n(86),
            ...
            sn = u(function(e, t) {
                ...
                })), r = intval(r.shift()), r <= n.in_up_to ? Promise.resolve(t) : (t.longpoll.push([Pt.readInboundEvent([6, e, r])]), Object(At.post)(At.CONTROLLER, {
                    peer: e,
                    ids: [r],
                    hash: n.hash,
                    act: "a_mark_read",
            ...
            cn = function(e, t, n, r) {
                ...
                return Object(Dt.retryFn)(At.post, 1)(At.CONTROLLER, Object.assign({
                    act: "a_send",
                    to: e,
                    hash: n.hash,
                    msg: t.message,
            ...
            pn = u(function(e, t) {
                ...
                return nn({
                    st: n.searchText
                }), rn(), Object(At.post)(At.CONTROLLER, {
                    act: "a_search",
                    q: i,
                    from: "in",
                    gid: t.gid,
            ...
            gn = u(function(e, t) {
                return t.tabs[e].lastTyping = Date.now(), Object(At.post)(At.CONTROLLER, {
                    act: "a_typing",
                    peer: e,
                    gid: t.gid,
                    hash: t.tabs[e].hash
            ...
            vn = u(function(e, t) {
                return Te(e, Object(At.post)("al_im.php", {
                    act: "a_flush_history",
                    id: e,
                    from: "im",
                    gid: t.gid,
            ...
            wn = u(function(e, t) {
                return e.kludges.source_act === qt.CHAT_PHOTO_REMOVE ? (delete t.tabs[e.peerId].photo, delete t.tabs[e.peerId].photoLarge, Promise.resolve(t)) : Object(At.post)(At.CONTROLLER, {
            ...
            Fn = u(function(e, t, n, r) {
                return Le(e, n, t, r), Object(At.post)(At.CONTROLLER, {
            ...
            On = u(function(e, t, n, r) {
                return r.creating = !0, r.longpoll.pause(), Object(At.post)(At.CONTROLLER, {
                    act: "a_multi_start",
                    hash: r.writeHash,
                    peers: t.join(","),
                    title: n
            ...
            En = u(function(e, t) {
                ...
                return t.longpoll.push([i([0, e, n, !0])]), Object(At.post)(At.CONTROLLER, {
                    act: "a_dialog_star",
                    val: r ? 0 : 1,
                    peer: e,
                    hash: t.tabs[e].hash,
            ...
            Sn = u(function(e, t, n) {
                ...
                return n.longpoll.push([Pt.resetDirectoriesEvent([0, e, r, !0]), Pt.readInboundEvent([6, e, t])]), Object(At.post)(At.CONTROLLER, {
                    act: "a_mark_answered",
                    peer: e,
                    lastmsg: t,
                    hash: n.tabs[e].hash,
            ...
            xn = u(function(e, t) {
                ...
                }), t.tabs[e].deletedDialog = !0, Object(At.post)(At.CONTROLLER, {
                    act: "a_delete_dialog",
                    peer: e,
                    gid: t.gid,
                    hash: t.tabs[e].hash
            ...
            Ln = u(function(e, t, n) {
                var r = n.tabs[t];
                return r.data.kicked || r.data.closed ? Promise.resolve(n) : Object(At.post)(At.CONTROLLER, {
                    act: "a_pin_message",
                    msgid: e,
                    chat: t,
                    gid: n.gid,
            ...
            Mn = u(function(e, t) {
                var n = t.tabs[e];
                return n.data.kicked || n.data.closed ? Promise.resolve(t) : Object(At.post)(At.CONTROLLER, {
                    act: "a_unpin_message",
                    chat: e,
                    gid: t.gid,
                    hash: t.tabs[e].hash
            ...
            zn = u(function(e, t) {
                return t.tabs[e].top_banner = void 0, Object(At.post)(At.CONTROLLER, {
                    act: "a_hide_banner",
                    peer_id: e,
                    hash: t.tabs[e].hash
                }).then(function() {
    ...
    169: function(e, t, n) {
        ...
        n.r(t), n(69), n(209), n(90), n(176), n(171), n(160), n(61), window.getWndInner = r, window.lastWndScroll = [!1, !1], window.updateWndVScroll = i, window.defBox = a;
        try {
        ...
        window.curFastChat || (window.curFastChat = {}), window.FastChat = {
            ...
            clChecked: function(e, t) {
                if (curFastChat.inited && curFastChat.ready && curFastChat.cl_queue) {
                    if (t.failed) return clearTimeout(curFastChat.lp_error_to),
                        void(curFastChat.lp_error_to = setTimeout(FastChat.updateQueueKeys.bind(FastChat), 1e3 * (curNotifier.error_timeout || 1)));
            ...
            onMyTyping: function(e) {
                ...
                if (!(-2e9 >= e) && t) {
                    var n = vkNow();
                    curFastChat.myTypingEvents[e] && n - curFastChat.myTypingEvents[e] < 5e3 || (curFastChat.myTypingEvents[e] = n,
                        ajax.post("al_im.php", {
                            act: "a_typing",
                            peer: e,
                            hash: t.sendhash,
    ...
    176: function(__webpack_module__, __webpack_exports__, __webpack_require__) {
        "use strict";
        __webpack_require__.r(__webpack_exports__);
        var _helpers_im_shared_helpers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(155),
            _longpoll_singleton__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(98),
    ...
    212: function(e, t, n) {
        ...
        function se(e, t, n, r) {
            return e.map(function(e) {
                ...
                An(e, le(t, e, n)), Sn(e, "im-mess_light")
            }), r
        }
        ...
        function ce(e, t, n) {
            ...
            if (r) {
                var i = On(qt, r);
                An(r, i.innerHTML), xn(r, "im-mess_light")
            }
            return n
        }
    ...
    23: function(e, t, n) {
        ...
        function L(e, t) {
            do e = F(e); while (e && !A(e, t));
            return e
        }

        function M(e, t, n) {
            for (var r = null; null === r && e;) e = -1 === n ? k(e) : w(e), e && A(e, t) && (r = e);
            return r
        }
        ...
        function ue(e, t, n) {
            if (e = r(e)) {
                ...
                if ("opacity" == t) browser.msie && ((n + "").length ? 1 !== n ? e.style.filter = "alpha(opacity=" + 100 * n + ")" : e.style.filter = "" : e.style.cssText = e.style.cssText.replace(/filter\s*:[^;]*/gi, ""), e.style.zoom = 1),
    ...
    29: function(e, t, n) {
        ...
        var v, b = n(60),
            ...
            j = "change_title",
            L = "add_admin",
            M = (v = {}, r(v, O, F), r(v, E, F), r(v, L, T), r(v, S, y), r(v, x, w), r(v, I, k), r(v, j, N), v),
            A = 1
    },
    36: function(e, t, n) {
        "use strict";
    ...
    61: function(__webpack_module__, __webpack_exports__, __webpack_require__) {
        "use strict";
