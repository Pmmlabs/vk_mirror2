! function(e) {
    ...
    123: function(e, t, n) {
        ...
        function c(e, t, n, r) {
            var i = t && !n ? 1 : !t && n ? -1 : 0;
            i && !Object(Nt.isClassicInterface)(e) && r().compensateHistoryHeightChange(i)
        }
        ...
        function l(e, t, n) {
            ...
            return i && (t = ie([i], t), t = N(e, n, t, !0, !1)), t
        }

        function f(e) {
            var t = Object(Nt.checkVoiceMessageAvailable)(e);
        ...
        function p(e) {
            return Ln("im_preloader", {
                preloader: ln(sn.pr_tpl, {
                    id: ""
                }),
        ...
        function _(e) {
            ...
            t && (On(t, "_im_invisible_bar"), On(t, "im-page--history-new-bar_hide"))
        }
        ...
        function v(e, t, n) {
            ...
            return i && (i.parentNode.replaceChild(un(r), i), y(n)), n
        }

        function b(e, t) {
            var n = ["_im_mess"],
                r = Object(Tt.isUnread)(e.tabs[t.peerId], t);
            Object(Tt.isOut)(t) && r && n.push("im-mess_unread _im_mess_unread"), Object(Tt.isOut)(t) && n.push("im-mess_out"), Object(Tt.wasEdited)(t) && n.push("im-mess_was_edited"), Object(It.canMessageBeEdited)(e, t) && n.push("im-mess_editable"), Object(Tt.isImportant)(t) && n.push("im-mess_fav"), -1 != (e.selectedMessages || []).indexOf(t.messageId) && n.push("im-mess_selected");
            var i = Date.now() - 1e3 * t.date > 1e3;
            t.local && i && n.push("im-mess_sending"), t.local && n.push("" + At), t.local && Object(Tt.wasEdited)(t) && !r && n.push("im-mess_unread im-mess_nobg"), t.failed && n.push("im-mess_failed " + Pt), Object(Tt.isGift)(t) && n.push("im-mess_gift");
            var a = C(t),
                o = H(e, t.text, t.kludges);
            "" != o && Object(Tt.wasEdited)(t) && (o += Ln("sImLblWasEdited", {
                update_time: t.update_time
            })), t.subject && "..." !== t.subject.trim() && !j(t.peerId) && (o = Ln("im_topic", {
                topic: t.subject
            }) + o);
            var s = Ln("im_message_media", {
                messageId: t.messageId,
                attaches: a.join(""),
                text: Object(Tt.isGift)(t) ? '<div class="im-mess--gift-lbl">' + o + "</div>" : ""
            });
            return Object(Tt.isGift)(t) || (s = o + s), "" == o && Object(Tt.wasEdited)(t) && (s += Ln("sImLblWasEdited", {
                update_time: t.update_time
            })), Ln("im_msg_row", {
                msg_id: t.messageId,
                from_id: t.peerId,
        ...
        function y(e) {
            for (var t = e.getElementsByClassName("_im_mess_noa"), n = t.length; n--;) Sn(t[n], "im-mess_fwd") || t[n].insertAdjacentHTML("afterbegin", Ln("sImHistoryRowActions")), On(t[n], "_im_mess_noa")
        }
            ...
            switch (o) {
                ...
                case "canceled_by_receiver":
                    if (r === a) {
                        ...
                        var d = Object(St.oCacheGet)(n, s);
                        return d ? Rn(d.sex, Mn("mail_call_declined_by", "raw")).replace("{user_name}", d.first_name) : Mn("mail_call_declined")
                    }
                    return Mn("mail_call_canceled");
                default:
                    c = Mn("mail_added_call")
            }
            return Ln("im_calls_link", {
                text: c
            })
        }
        ...
        function N(e, t, n) {
            var r = (arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : !0, arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : !0),
                ...
                o = e.tabs[t.peerId];
            if (!n || Nn("_im_mess", n) || Nn("_im_bar_date", n) || (n.innerHTML = ""), o.skipped > 0) return n;
            var s = [];
            ...
            var c = b(e, t),
                u = bn(n);
            Sn(u, "_im_mess_stack") || (u = yn(u, "._im_mess_stack", -1));
            for (var d = Object(Nt.getLastMessage)(e, t.peerId, t.messageId); t.peerId === e.peer && d && !Nn("_im_mess_" + d.messageId);) d = Object(Nt.getLastMessage)(e, t.peerId, d.messageId);
            var l = Nn("_im_unread_bar_row", n),
                f = Object(Tt.getUserId)(t),
                h = d ? P(d.date, e) : 0;
            if (!d || D(o, d, t, e, i)) {
                var p = "",
                    m = !1;
                if (l && Object(Tt.isOut)(t) && Ve(e, n, t.peerId), 1 === o.unread && !Object(Tt.isOut)(t) && i && (p += Ln("im_mess_bar", {}), m = !0, Ve(e, n, t.peerId)), !zn(new Date(h))) {
                    var _ = new Date,
                        g = m ? "im-page--history-new-bar_hide _im_invisible_bar" : "";
                    p += Ln("im_day_bar", {
                        day: Hn(t.date, e.timeshift, !0, Mn("months_of", "raw"), !0),
                        date: t.date,
                        day_class: _.getDate() + _.getMonth() + _.getFullYear() + " " + g
                    })
                }
                if (Object(Tt.isServiceMsg)(t)) p += Ln("im_service_row", {
                    text: fe(e, t, o),
                    type: "",
                    date: t.date,
                    from_id: "",
                ...
                else if (Object(Tt.isCallMessage)(t)) p += Ln("im_service_row", {
                    text: le("", k(t, !1, e), ""),
                    type: "",
                    date: t.date,
                    from_id: "",
                    ...
                    var v = e.gid && Object(Tt.isOut)(t) ? pn(t.kludges.from_admin) || 0 : 0,
                        C = Object(St.oCacheGet)(e, v ? -e.gid : f) || o,
                        w = j(t.peerId) ? C.name : C.first_name,
                        N = C.link || o.href,
                        F = Ln("im_mess_stack_name", {
                            name: w,
                            link: N,
                            "class": Object(Tt.isMoney)(t) ? " im-mess-stack--lnk-money-transfer" : ""
                        });
                    if (Object(Tt.isGift)(t)) {
                        var O = Mn("mail_gift_message_sent", "raw");
                        F += ' <span class="im-mess-stack--gift">' + Rn(C.sex || 0, O) + "</span>"
                    }
                    if (Object(Tt.isMoney)(t)) {
                        var E = Object(Tt.isMoneyRequest)(t) ? Mn("mail_money_request_message_sent", "raw") : Mn("mail_money_tranfer_message_sent", "raw");
                        F += ' <span class="im-mess-stack--money-transfer">' + Rn(C.sex || 0, E) + "</span>"
                    }
                    var S = e.gid ? "/gim" + e.gid : "/im",
                        x = void 0;
                    if (x = t.local ? B(t.date, e.timeshift) : Ln("im_stack_date", {
                            date: B(t.date, e.timeshift),
                            link: S + "?sel=" + t.peerId + "&msgid=" + t.messageId
                        }), v && e.admins[v]) {
                        var I = e.admins[v],
                            L = v === sn.id ? Mn("mail_by_you") : I[0];
                        x = x + " " + Ln("im_admin_link", {
                            name: L,
                            href: I[1]
                        })
                    }
                ...
                Object(Et.toArray)(fn(p)).forEach(function(e) {
                    return n && n.appendChild(e)
                })
            } else l && e.peer === t.peerId && !o.inplaceSearch && Object(Tt.isOut)(t) && Ve(e, n, t.peerId), Nn("_im_stack_messages", u).appendChild(un(c));
            return Object(Tt.isOut)(t) && !a && setTimeout(function() {
                var e = Nn("_im_mess_" + t.messageId, n);
                Sn(e, At) && Fn(e, "im-mess_sending")
        ...
        function T(e, t, n) {
            ...
            return r = "object" === ("undefined" == typeof e ? "undefined" : Rt(e)) ? e : t.imQueue(e, !1), r.length > 0 && r.map(function(e) {
                ...
                return Object(Nt.getMessage)(t, e.peerId, e.messageId)
            }).forEach(function(e) {
                return N(t, e, n, !1)
            }), n
        }
        ...
        function O(e, t, n) {
            var r = e.tabs[t];
            return Object(Et.toArray)(kn("_im_mess_unread", n)).forEach(function(e) {
                var t = pn(wn(e, "msgid"));
                t > 0 && r.out_up_to >= t && (On(e, "_im_mess_unread"), On(e, "im-mess_unread"), F(e))
            }), n
        }
        ...
        function S(e, t) {
            if (!Object(Nt.isFullyLoadedTab)(t, e.peerId)) return 0;
        ...
        function D(e, t, n, r, i) {
            if (Object(Tt.getUserId)(t) !== Object(Tt.getUserId)(n)) return !0;
            var a = P(t.date, r),
                o = P(n.date, r);
            return qn(a, o) ? Object(Nt.isCommunityInterface)(r) && pn(t.kludges.from_admin) !== pn(n.kludges.from_admin) ? !0 : n.date - t.date > 300 ? !0 : Object(Tt.isServiceMsg)(t) || Object(Tt.isServiceMsg)(n) ? !0 : Object(Tt.isCallMessage)(n) || Object(Tt.isCallMessage)(t) ? !0 : Object(Tt.isGift)(t) || Object(Tt.isGift)(n) ? !0 : Object(Tt.isGraffiti)(t) || Object(Tt.isGraffiti)(n) ? !0 : Object(Tt.isUnread)(e, t) === Object(Tt.isUnread)(e, n) || !i || Object(Tt.isOut)(n) || me(n.peerId, r.gid) ? !1 : !0 : !0
        }

        function B(e, t) {
            return An(1e3 * e, "{hour}:{minute} {am_pm}", 1e3 * t, [], !0)
        }
        ...
        function H(e, t, n) {
            var r = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : !1,
                ...
                a = {},
                o = 0;
            return t = Object(Ft.replaceHyperLinks)(t || "", Ft.linksReplacer.bind(null, r)), t = t.replace(/(<a.+?<\/a>)/gi, function(e) {
                var t = "!link_" + o + "_" + i + "!";
                return a[t] = e, o++, t
            }), t = Object(Ft.replaceMentions)(t), t = Object(Ft.replaceEmailLinks)(t), t = Object(Ft.replaceHashtags)(t, function(t) {
                var n = Object(Nt.getGroupId)(e),
                    r = n ? "gim" + n : "im";
                return '<a href="/' + r + "?sel=" + Object(Nt.getPeer)(e) + "&st=" + encodeURIComponent(t) + '">' + t + "</a>"
        ...
        function Q(e, t, n) {
            ...
            var r = t.data.active.slice(0, 4).map(St.oCacheGet.bind(null, e)),
                i = r.map(function(e) {
                    return e.photo
                }),
        ...
        function te(e, t, n) {
            ...
            if (r) {
                xn(r, "aria-hidden", "false"), Fn(r, "im-mess_failed " + Pt);
                var i = Nn("_im_mess_marker", r);
                xn(i, "aria-label", Mn("mail_send_message_error")), xn(i, "role", "link")
            }
            return n
        }
        ...
        function ne(e, t, n) {
            ...
            if (r) {
                On(r, "im-mess_failed"), xn(r, "aria-hidden", "true"), On(r, Pt);
                var i = Nn("_im_mess_marker", r);
                xn(i, "aria-label", ""), xn(i, "role", "")
            }
            return n
        }
        ...
        function ie(e, t) {
            ...
            return e.forEach(function(e) {
                ...
                return 0 === Cn(e).length
            }).map(function(e) {
                return Tn("_im_mess_stack", e)
            }).forEach(function(e) {
                Sn(vn(e), "_im_bar_date") && dn(vn(e)), Sn(vn(e), "_im_unread_bar_row") && dn(vn(e)), dn(e)
            }), t
        }
        ...
        function ae(e, t, n, r) {
            return e.map(function(e) {
                ...
                jn(e, ue(t, e, n)), Fn(e, "im-mess_light")
            }), r
        }
        ...
        function oe(e, t, n) {
            ...
            if (r) {
                var i = Nn(Dt, r);
                jn(r, i.innerHTML), On(r, "im-mess_light")
            }
            return n
        }
        ...
        function se(e, t, n, r) {
            ...
            var o = (Object(Nt.isClassicInterface)(r), 60),
                s = ce(e, t, n, r, !1, i);
        ...
        function ce(e, t, n, i, a, o) {
            var s = [],
                c = (e && e.userIds || []).filter(function(e) {
                    var t = Object(St.oCacheExists)(i, e);
                    return t || s.push(e), t && e != i.id
                });
            if (s.length && Object(jt.loadChatMember)(r({}, t, s), i), 0 === c.length) return "";
            var u = I(t) || Object(Nt.isCommunityPeer)(t) ? "first_name" : a ? "short_name" : "name";
            if (1 == c.length) {
                var d = n ? "" : Object(St.oCacheGet)(i, c[0])[u];
                return d + " " + Mn("mail_typing")
            }
            var l = Mn("mail_typing_several", c.length),
                f = c.slice(0, Math.min(c.length - 1, o)),
                h = f.map(function(e) {
                    return Object(St.oCacheGet)(i, e)[u]
                }).join(", ");
            if (c.length > o + 1) h += " " + Mn("mail_and_peer").replace("{count}", e.totalCount - o).replace("{typing}", l);
            else {
                var p = Object(St.oCacheGet)(i, c[f.length])[u];
                h += " " + Mn("mail_and_peer_one") + " " + p + " " + l
            }
            return h
        }
        ...
        function fe(e, t, n) {
            ...
            if (u = Rn(c.sex, Mn(u, "raw")), u = u.replace("{from}", le(c.link, c.name, r)), o && o !== s) {
                var l = i.source_email;
                if (l) u = u.replace("{user}", le("/im?email=" + encodeURIComponent(l), "email", r));
                else {
                    var f = Object(St.oCacheGet)(e, o),
                        h = a === Ut ? f.inv_name : f.kick_name;
                    u = u.replace("{user}", le(f.link, h, r))
                }
            }
            if (i.source_text) {
            ...
            if (i.source_act === Kt || i.source_act === Qt)
                if (i.source_message) {
                    var m = pe(Xn.emojiToHTML(_n(i.source_message.replace(/<br\s?\/?>/gi, " ")), !0)),
        ...
        function he(e, t, n, r) {
            if (t === Gt) {
                ...
                if (i) {
                    ...
                    i.parentNode.innerHTML = Ln("im_msg_row", {
                        msg_id: e.messageId,
                        from_id: e.peerId,
        ...
        function _e(e, t) {
            return Kn(e, {
                url: Object(Nt.isCommunityPeer)(t) ? "al_groups.php" : "al_profile.php",
                params: {
                    act: "verified_tt",
                    mid: t,
                    gid: t
        ...
        function ge(e) {
            return function(t) {
                function n() {
                    o = !0, On(a, "im-preloader_visible"), a.parentNode && a.parentNode.removeChild(a)
                }
                var r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "bottom",
                    i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : "",
                    a = un(Ln("im_preloader", {
                        preloader: ln(sn.pr_tpl, {
                            id: ""
                        }),
                    ...
                    o = !1;
                setTimeout(function() {
                    o || ("bottom" === r ? e.appendChild(a) : e.insertBefore(a, gn(e)), Fn(a, "im-preloader_visible"))
                }, 0), t.then(n)["catch"](function(e) {
                    Object(Lt.imWeirdCatch)("wrapLoading", e), n()
                })
            }
        }
        ...
        function be(e, t) {
            ...
            do
                if (!n || n.onclick || n.onmousedown || "A" == n.tagName || Sn(n, "_im_no_select") || Sn(n, "im_msg_media_link") || "IMG" == n.tagName && !Sn(n, "_im_graffiti") && !Sn(n, "emoji") && !Sn(n, "emoji_css") && !Sn(n, "im_gift") || "TEXTAREA" == n.tagName || Sn(n, "play_new") || Sn(n, "videoplayer") || (i = a.test(n.className))) break; while (r-- && (n = n.parentNode));
            return i ? !!mn(Ce()) : !0
        }
        ...
        function ye(e, t) {
            return '<div class="im-mess--text">\n      <span>' + Mn("mail_restored") + '</span>\n      <a class="_im_go_to" href="/im?sel=' + q(e) + "&msgid=" + t + '">' + Mn("mail_im_goto_conversation") + "</a>\n    </div>"
        }

        function we(e, t) {
            var n = Mn(j(e) ? "mail_chat_sure_to_delete_all" : Object(Nt.isCommunityPeer)(e) ? "mail_group_sure_to_delete_all" : "mail_sure_to_delete_all");
            return Gn(Mn("mail_deleteall1"), n, Mn("mail_delete"), t, Mn("global_cancel"))
        }

        function ke(e) {
            return Gn(Mn("mail_unpin_title"), Mn("mail_unpin_text"), Mn("mail_unpin"), e, Mn("global_cancel"))
        }

        function Ne(e, t, n, r) {
            var i = Mn("mail_dialog_msg_delete_N", t),
                a = Gn(Mn("mail_dialog_msg_delete_title"), i, Mn("mail_delete"), function() {
                    return r(isChecked(Nn("_check_forall")))
                }, Mn("global_cancel")),
                o = "",
                s = !1;
            return n && (o = '<div class="checkbox im-delete-forall-checkbox _check_forall" onclick="checkbox(this);" role="checkbox" aria-checked="false">' + Mn("mail_delete_for_all") + "</div>", s = cur.imDb.selectByKey("del_forall_checked")), a.setControlsText(o), s && checkbox(Nn("_check_forall")), a
        }
        ...
        function Se(e, t, n, r) {
            ...
            var i = Object(Nt.isReversedDialogs)(t);
            return t.set(r.bind(null, e)).then(function(e) {
                return n().restoreDialogs(e, !0, i !== Object(Nt.isReversedDialogs)(e)), e
            })
        }
        ...
        function Ie(e, t) {
            ...
            if ("undefined" == typeof t && (t = e.get().peer), !Object(Nt.isFoldersAvailable)(e)) return !1;
        ...
        function Pe(e, t) {
            return De(e.get(), t, Object(Nt.getTab)(e, t).last_seen)
        }

        function De(e, t, n, r) {
            if (n[0]) return 2 === n[2] ? '<span class="is_vk_mobile is_online">' + Mn("mail_header_online_status") + Be(t, !1, !0, !0, r) + "</span>" : "online" + (Qn[n[0]] ? Be(t, !1, !1, !0, r) : "");
            if (!n[1]) return "";
            var i = Dn(n[1], e.timeshift),
                a = Rn(Object(St.oCacheGet)(e, t).sex, Mn("mail_last_activity_tip", "raw")).replace("{user}", "").replace("{time}", i);
        ...
        function Ve(e, t, n) {
            ...
            var i = yn(r, "._im_mess_stack", -1),
                ...
                o = i ? kn("_im_mess", i).pop() : null,
                s = a ? Nn("_im_mess", a) : null;
            if (dn(r), _(t), !s || !o) return t;
            var c = wn(s, "msgid"),
                u = Object(Nt.getPreviousMessage)(e, n, c),
                d = Object(Nt.getMessage)(e, n, c);
            if (!u || D(e.tabs[n], u, d, e)) return t;
            var l = Nn("_im_stack_messages", i),
                f = Nn("_im_stack_messages", a).children;
            return Object(Et.toArray)(f).forEach(function(e) {
                dn(e), l.appendChild(e)
            }), dn(a), t
        }

        function Ke(e, t, n) {
            var r = Object(Nt.getFirstUnread)(e, e.get().peer);
            if (!r) return [!1, 0];
            var i = Nn("_im_mess_" + r, t);
            if (!i) {
                var a = Object(Nt.getLastMessage)(e, e.get().peer, r);
                if (!a) return [!0, 0];
                i = Nn("_im_mess_" + a.messageId, t)
            }
            var o = Sn(i, "_im_mess_srv") ? i : Tn("_im_mess_stack", i);
            if (!o) return [!0, 0];
        ...
        function Qe(e, t, n) {
            er(t);
            var r = Tn("_im_top_notice", n);
            Zn(r, 200, dn.pbind(r));
            var i = Tn("_im_page_dialogs", r);
            i && Sn(i, "im-page--dialogs-notice") && On(i, "im-page--dialogs-notice"), Wn.post("al_im.php", {
        ...
        function Ye(e, t, n) {
            er(t);
            var r = Tn("_im_aside_notice", n);
            Jn(r, 200, dn.pbind(r)), Wn.post("al_im.php", {
                act: "a_hide_top_notice",
                type: r.getAttribute("data-type"),
                hash: r.getAttribute("data-hash")
            })
        ...
        function $e(e, t) {
            er(e);
            var n = Tn("_im_aside_promo_block", t);
            Jn(n, 200, dn.pbind(n)), Wn.post("al_im.php", {
        ...
        function Je(e, t, n, r, i) {
            return n = n.replace(/\<br\s*\/?\>(\n)?/gi, " ").replace(/[\n\r]/gi, " "), n = Object(Ft.replaceMentions)(n, function(e, t, n, r, i) {
                return i
            }), r && (n = Xn.emojiToHTML(n, !0)), t && "..." !== t.trim() && !j(e) && (n = Ln("im_topic", {
                topic: t,
                cls: "im-topic_dialog"
            }) + n), !n && i.length > 0 && (n = Ln("im_dialog_media", {
                name: Ze(i[0], i)
            })), n
        }
        ...
        function nt(e) {
            var t = e.get(),
                n = Object(Nt.getPinnedMessage)(e);
            if (!n || !Object(xt.isPinnedMessageVisibleInTab)(e, Object(Nt.getPeer)(e))) return "";
            var r = Object(St.oCacheGet)(e, n.userId);
            if (!r) return "";
            var i = rt(e, n);
            i || (i = n.text, i = !i && n.attaches.length ? Ln("im_pinned_message_media", {
                text: Ze(n.attaches[0], n.attaches)
            }) : H(e, i, n && n.kludges || {}) || ""), i = i.replace(/<br\s?\/?>/gi, " ");
            var a = Ln("im_pinned_message", {
        ...
        function rt(e, t) {
            var n = "";
            if (t && Object(Tt.isMoneyRequest)(t) && void 0 !== t.kludges.attach1_tr_amount) {
                ...
                if ("RUB" === t.kludges.attach1_currency && (r = Mn("mail_money_amount_rub", "raw")), t.kludges.attach1_total_amount) {
                    var i = Pn(t.kludges.attach1_tr_amount / 1e3, "%s", !0),
                        a = Pn(t.kludges.attach1_total_amount / 1e3, r, !0);
                    n = Mn("mail_money_request_collected_amount_from").replace("{amount}", i).replace("{total_amount}", a)
                } else {
                    var o = Pn(t.kludges.attach1_tr_amount / 1e3, r, !0);
                    n = Mn("mail_money_request_collected_amount").replace("{amount}", o)
                }
                if (pn(t.kludges.attach1_held_amount)) {
                    var s = Pn(t.kludges.attach1_held_amount / 1e3, r, !0);
                    n += " " + Mn("mail_money_request_held_amount").replace("{amount}", s)
                }
                t.text && (n += '<span class="divider"></span>' + H(e, t.text, t.kludges)),
                    t.kludges.attach1_total_amount && (n += Ln("im_pinned_message_media_bar", {
        ...
        function at() {
            var e = getSize(Nn(an))[1];
            return e || (e = ir), e
        }

        function ot(e, t) {
            e.bodyNode.addEventListener("mouseover", function(e) {
                Sn(e.target, "_im_edit_time") && it(t, e, e.target)
            })
        }
        ...
        function dt(e, t) {
            var n = Object(St.oCacheGet)(e, t.peerId),
                r = Object(Nt.getTab)(e, t.peerId) || {};
            ...
            Un("al_im.php", {
                ...
                onFail: function(e) {
                    return setTimeout(function() {
                        return Gn(Mn("global_error"), e)
                    }, 0), !0
                },
                onDone: function(t, n) {
                    r = Object(Ot.mount)(t.bodyNode, e)
                }
            }, {})
        }

        function mt() {
            Gn(Mn("global_error"), Mn("mail_message_wait_until_uploaded"))
        }

        function _t(e, t) {
            var n = Object(Nt.getTab)(e, t.peerId) || {};
            if (!t || !Object(Tt.isOut)(t)) return !1;
        ...
        function Ct(e, t) {
            ...
            if (u.forEach(function(e) {
                    var t = Mt(e, 2),
                        ...
                        r = t[1],
                        i = Math.floor(d / n);
                    d %= n, i >= 1 && l.push(Pn(i, r))
                }), f = l.length, 1 === f) return l.pop();
            var h = l.slice(0, f - 1).join(", "),
                p = l.pop();
            return Mn("global_and").replace(/{before}/gi, h).replace(/{after}/gi, p)
        }
        ...
        var Tt = n(454),
            ...
            Jt = "_im_top_notice_hide",
            Zt = "_im_aside_notice_hide",
    ...
    304: function(e, t, n) {
        ...
        function l(e, t, n, r, i) {
            return i.tabHistoryNotChanged = !1, Object(At.retryFn)(Lt.post, 3, function(e) {
                return e - 1
            })(Lt.CONTROLLER, {
                act: "a_start",
                peer: e,
                ...
                return i.admins = extend(i.admins, s), i.imQueue(e, !1), It(), f(e, i)
            })["catch"](function(e) {
        ...
        function m(e, t) {
            ...
            return Promise.resolve(t).then(function(t) {
                return t.tabHistoryNotChanged = !1, Object(Bt.isFullyLoadedTab)(t, n) && !t.tabs[n].msgid ? (t.gid && p(n, t), Promise.resolve(t).then(C)) : (Object(Bt.isFullyLoadedTab)(t, n) && (t.tabs[n].msgid = !1), l(n, e, !1, !0, t))
        ...
        function g(e, t, n) {
            var r = n.msgid,
                i = n.peer;
            return !e && Object(Bt.isFullyLoadedTab)(n, i) && n.tabs[i].msgs[r] ? (t === n.peer ? n.tabHistoryNotChanged = !0 : n.tabHistoryNotChanged = !1, n.gid && p(i, n), Promise.resolve(n).then(C).then(_.bind(null, i))) : l(i, !0, r, !0, n).then(C).then(function() {
        ...
        function C(e) {
            ...
            n.offset && r.push("photos"), n.offset && r.push("search"), (-2e9 > t || n.offset) && r.push("clear"), Object(Bt.isCommunityInterface)(e) && r.push("block"), Object(Bt.isCommunityPeer)(t) && (n.blocked_community ? r.push("allow_community") : r.push("block_community")), !Object(Bt.isChatPeer)(t) && !Object(Bt.isUserPeer)(t) || Object(Bt.isCommunityInterface)(e) || Object(Bt.isChatPeer)(t) && (n.data.kicked || n.data.closed) || (inArray(t, e.mutedPeers) ? r.push("unmute") : r.push("mute")), Object(Bt.isUserPeer)(t) && !e.gid && !n.blacklisted && n.is_friend && r.push("invite"), !e.chatSettingsAllowed && Object(Bt.isChatPeer)(t) && !i && n.data.link && r.push("invite_link"), Object(Bt.isChatPeer)(t) && !i && (e.chatSettingsAllowed || Object(Vt.canChangeTitle)(e) && r.push("topic", "avatar"), Object(Vt.canInviteUser)(e) && r.push("invite"), r.push("leave")), Object(Bt.isChatPeer)(t) && n.data.closed && !n.data.kicked && r.push("return"), Object(Bt.isChatPeer)(t) && e.chatSettingsAllowed && !n.data.closed && !n.data.kicked && r.push("settings"), Object(Bt.isChatPeer)(t) && n.pinned && (r.push(Object(Gt.isPinnedMessageVisibleInTab)(e, t) ? "pin_hide" : "pin_unhide"), Object(Vt.canPinOrUnpin)(e) && r.push("unpin"));
        ...
        function M(e, t) {
            ...
            if (Object(Bt.isTabLoaded)(t, i)) {
                var a = t.tabs[i];
                if (a.deletedDialog = !1, !t.msg_local_ids_sort && e.local ? t.msg_local_ids_sort = r({}, e.messageId, 0) : e.local && (t.msg_local_ids_sort[e.messageId] = Object.keys(t.msg_local_ids_sort).length), n ? a.unread = 0 : (a.lastmsg == e.messageId && a.unread ? R(t, 1, e.peerId) : (!a.unread && R(t, 1, e.peerId), a.unread++), x(e.peerId, t)), Object(Bt.isFullyLoadedTab)(t, i)) {
                    var o = c(a.history);
                    a.skipped > 0 && a.skipped++, a.offset++, a.msgs[e.messageId] = extend(!0, {}, e), a.history = Object(Bt.appendToHistory)(t, e, o, !0, !0, !0), Object(zt.isOut)(e) && (a.blocked_community = 0, C(t))
                }
                if (a.typing) {
                    var s = a.typing.userIds.indexOf(e.userId);
                    s >= 0 && a.typing.userIds.splice(s, 1)
                }
                return a.lastmsg = e.messageId, a.lastmsg_meta = e, _(e.peerId, t), E(t, a, !1, I.bind(null, i), et.bind(null, t)), Promise.resolve(t)
            }
            return l(i, 0, 0, 0, t).then(function(t) {
                var r = t.tabs[i];
                return E(t, r, !1, I.bind(null, i), et.bind(null, t)), _(e.peerId, t), n || x(e.peerId, t), t
            })
        }
        ...
        function A(e, t) {
            if (Object(Bt.isFullyLoadedTab)(t, e.peerId)) {
                var n = t.tabs[e.peerId],
                    r = n.unread;
                if (t = k(t, e.peerId, e.upToId, 0), null != e.unread ? n.unread = e.unread : n.unread = e.upToId >= n.lastmsg ? 0 : Object(qt.countUnread)(e.peerId, t) + (n.unread > 0 ? +n.skipped : 0), r > 0 && !n.unread && R(t, -1, e.peerId), !n.skipped) {
                    var i = c(n.history);
        ...
        function P(e, t) {
            var n = t.tabs[e.peerId];
            if (Object(Bt.isTabLoaded)(t, e.peerId) && k(t, e.peerId, e.upToId, Rt.FLAG_OUTBOUND), Object(Bt.isFullyLoadedTab)(t, e.peerId)) {
                var r = c(n.history);
        ...
        function W(e, t) {
            return Object(At.pause)(Yt + 2).then(function() {
        ...
        function $(e, t) {
            ...
            return Object(At.retryFn)(Lt.post, 3, function(e) {
                return e * e
        ...
        function oe(e, t) {
            ...
            return Object(At.retryFn)(Lt.post, 1, function() {
                return 4
            })(Lt.CONTROLLER, {
        ...
        function me(e, t) {
            ...
            return Object(Lt.post)(Lt.CONTROLLER, {
                ...
                n.unread = s[0], n.in_up_to = s[1], n.out_up_to = s[2], n.unread || (e.get().dialog_tabs[Ht.FOLDER_UNREAD] = e.get().dialog_tabs[Ht.FOLDER_UNREAD].filter(function(e) {
                    return e != t
                })), E(e.get(), n, !1, I.bind(null, t), et.bind(null, e.get()))
            })
        }
        ...
        function Ee(e, t, n) {
            var r = e.needMembers,
                i = e.needAdminIds,
                a = e.needPeers;
            return t.pause(), Promise.all([Fe(r, n), S(i, n), Promise.all(a.map(function(e) {
                return l(e, 0, 0, 0, n)
            }))])["catch"](function() {
                return n
            }).then(function() {
        ...
        function Se(e, t, n, r) {
            return t !== vk.id ? Promise.resolve(r) : (Object(Bt.isTabLoaded)(r, n) && r.peer == n && (r = C(r)), Promise.resolve(r))
        }
        ...
        function He(e) {
            ...
            return Object(Lt.post)(Lt.CONTROLLER, {
                ...
                s.forEach(function(t) {
                    return Object(Wt.oCacheAdd)(e, t)
                }), Object(Bt.normalizeTabsGotFromServer)(e, o), u.user_unread && handlePageCount("msg", u.user_unread), Object(Pt.lplog)("Resync success", "success");
                var f = e.peer,
                    h = void 0;
                ...
                return h.then(function(n) {
                    e.tabs = o, e.admins = extend(e.admins, d), n && (e.tabs[f] = n.tabs[f], e.tabs[f].history = Object(Bt.restoreQueue)(f, e, c(e.tabs[f].history))), e.loadingDialogs = !1, e.mutedPeers = u.mutedPeers, e.lastDialogsOptions = {
                        has_more: u.has_more
                    ...
                    }), delete e.resync_in_process, setTimeout(t.bind(null, !0), 0), Ge(intval(u.unread), e)
                })
            })["catch"](function(t) {
                return Object(Pt.lplog)("Resync error: " + t.message + " " + t.stack, "error"), Object(At.pause)(2).then(He.bind(null, e))
            })
        }
        ...
        function Ze(e, t, n) {
            return t !== Rt.RESET_DIRECTORIES || e.folders & Ht.FOLDER_MASKS[n] ? t === Rt.REPLACE_DIRECTORIES ? e.folders & Ht.FOLDER_MASKS[n] ? -1 : 1 : t === Rt.SET_DIRECTORIES ? 1 : -1 : 0
        }
        ...
        function tt(e, t, n, r, i) {
            if (Object(Bt.isTabLoaded)(i, e)) {
                var a = i.tabs[e];
                return n === Rt.REPLACE_DIRECTORIES && (t ^= a.folders), Je(n, t, a) && Object.keys(Ht.FOLDER_MASKS).filter(function(e) {
                    return Ht.FOLDER_MASKS[e] & t
                }).forEach(function(e) {
                    i.dialog_tab_cts[e] += Ze(a, n, e)
                }), n === Rt.SET_DIRECTORIES ? i.tabs[e].folders |= t : n === Rt.RESET_DIRECTORIES ? i.tabs[e].folders &= ~t : i.tabs[e].folders = t ^= a.folders, E(i, i.tabs[e], !0, function(t, n) {
            ...
            return l(e, 0, 0, 0, i).then(tt.bind(null, e, t, n, i))
        }
        ...
        function ct(e) {
            return e.peer ? de(e.peer, e) ? ue(e.peer, e) : Object(Bt.isFullyLoadedTab)(e, e.peer) ? e.tabs[e.peer].allShown : !1 : !0
        }
        ...
        var Lt = n(266),
            ...
            $t = 2e4,
            Xt = 8,
            Jt = Object(Mt.updateLazyLocation)(),
            Zt = Jt.scheduleNav,
            en = Jt.commitNav,
            ...
            rn = s(function(e, t) {
                ...
                return n.skipped > 0 && (r = r.filter(function(e) {
                ...
                })), r = intval(r.shift()), r <= n.in_up_to ? Promise.resolve(t) : (t.longpoll.push([Rt.readInboundEvent([6, e, r])]), Object(Lt.post)(Lt.CONTROLLER, {
                    peer: e,
                    ids: [r],
                    hash: n.hash,
                    act: "a_mark_read",
                    ...
                    return k(t, e, r, Rt.FLAG_OUTBOUND)
                }))
            }),
            an = s(function(e, t, n) {
                var r = Date.now() + rand(0, 100).toFixed(0),
                    i = n.tabs[e];
                return Object(At.retryFn)(Lt.post, 1)(Lt.CONTROLLER, {
                    act: "a_send",
                    to: e,
                    hash: i.hash,
                    msg: t.message,
            ...
            kn = s(function(e, t, n) {
                ...
                return n.longpoll.push([Rt.resetDirectoriesEvent([0, e, r, !0]), Rt.readInboundEvent([6, e, t])]), Object(Lt.post)(Lt.CONTROLLER, {
                    act: "a_mark_answered",
                    peer: e,
                    lastmsg: t,
                    hash: n.tabs[e].hash,
            ...
            Nn = s(function(e, t) {
                return E(t, t.tabs[e], !0, function(t) {
                    ...
                    return n[0] ? (st(t.tabbedPeers.filter(function(t) {
                        return t.peer !== e
                    }), !0, t), t.tabs[e].unread = 0, t.tabs[e].lastmsg = !1, t.tabs[e].lastmsg_meta = null) : (t.tabs[e].deletedDialog = !1, E(t, t.tabs[e], !1, I.bind(null, e), et.bind(null, t))), n
                })
            }),
            Tn = s(function(e, t, n) {
                return Object(Lt.post)(Lt.CONTROLLER, {
                    ...
                    }), n.tabs[r] = i, E(n, i, !1, I.bind(null, r), et.bind(null, n)), n.admins = extend(n.admins, o), [r]
                })
            }),
            Fn = s(function(e, t) {
                var n = t.tabs[e];
    ...
    353: function(__webpack_module__, __webpack_exports__, __webpack_require__) {
        "use strict";
        __webpack_require__.r(__webpack_exports__);
        var _helpers_im_shared_helpers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(338),
            _longpoll_singleton__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(554),
    ...
    391: function(e, t, n) {
        ...
        n.r(t), n(185), n(270), n(524), n(353), n(220), n(127), n(98), window.getWndInner = r, window.lastWndScroll = [!1, !1], window.updateWndVScroll = i, window.defBox = a;
        try {
    ...
    405: function(e, t, n) {
        ...
        function o(e, t, n, r) {
            var i = Object(g.unpackStore)(e),
                a = Object(g.getTab)(i, n || i.peer);
            return p(a, t) ? !1 : l(e, x, n, r)
        }
        ...
        function c(e, t, n, r) {
            var i = Object(g.unpackStore)(e),
                ...
                o = l(e, O, n, r),
                s = f(a, b);
            return r = "undefined" == typeof r ? window.vk.id : r, p(a, t) ? !1 : s || p(a, r) || h(a, r) ? o : o && !h(a, t) && m(a, t)
        }
        ...
        function l(e, t, n, r) {
            ...
            switch (t) {
                ...
                case T:
                case x:
                    return f(a, s) ? h(a, r) && o : p(a, r);
                case F:
                case O:
                case E:
                case S:
                    return f(a, s) ? h(a, r) && o : o
            }
            return !1
        }
        ...
        var _, g = n(141),
            ...
            S = "change_title",
            x = "add_admin",
            I = (_ = {}, r(_, N, k), r(_, T, k), r(_, x, w), r(_, F, v), r(_, O, b), r(_, E, C), r(_, S, y), _)
    },
    41: function(e, t, n) {
        "use strict";
