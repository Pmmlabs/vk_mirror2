! function(e) {
        ...
        function p(e, t) {
            ...
            if (o.length > 55 && (o = o.substr(0, 53) + ".."), o = C(o).replace(/&amp;/g, "&"), !e && a.match(_.OUR_DOMAINS)) {
                ...
                var c = r,
                    ...
                    d = "",
                    l = void 0;
                return u >= 0 ? c = r.substr(u + 1) : (u = r.indexOf("#!"), u >= 0 && (c = "/" + r.substr(u + 2).replace(/^\//, ""))), l = c.match(_.VK_DOMAIN), l && l[1].length < 32 && (d = ' mention_id="' + l[1] + '" onclick="return mentionClick(this, event)" onmouseover="mentionOver(this)"'),
                    '<a href="' + m(n + r + i) + '" target="_blank"' + d + ">" + o + "</a>"
            }
    ...
    296: function(__webpack_module__, __webpack_exports__, __webpack_require__) {
        "use strict";
        __webpack_require__.r(__webpack_exports__);
        var _helpers_im_shared_helpers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(208),
            _longpoll_singleton__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(50),
                        ...
                        if (!completed && (completed = !0, curNotifier.lpActive = !1, curNotifier.lp_started)) {
                            ...
                            try {
                                ...
                                if (isArray(response))
                                    ...
                                    for (; add_queue = add_queues.shift();) this.lcSend("addfeed", [add_queue, response]), this.addFeed(add_queue, response),
                ...
                return each(t, function(t, n) {
                    ...
                    switch (i[1]) {
                        ...
                        case "read":
                            ...
                            break;
                        case "typing":
                            e > 2e9 ? (curFastChat.typingEvents[e] || (curFastChat.typingEvents[e] = {}),
                                curFastChat.typingEvents[e][i[3]] = r) : curFastChat.typingEvents[e] = r, FastChat.updateTyping(e);
                            break;
                        case "edit":
                            var c = n.msgs[i[3]];
    ...
    333: function(e, t, n) {
        ...
        n.r(t), n(186), n(274), n(8), n(296), n(324), n(59), n(7), window.getWndInner = r, window.lastWndScroll = [!1, !1], window.updateWndVScroll = i, window.defBox = a;
        try {
    ...
    8: function(e, t, n) {
        ...
        function r(e, t) {
            ...
            var a = {};
            n.toBottom = n.toRight = !1, t.fixed ? (a.bottom = 0, a.right = 72) : (void 0 !== t.startTop ? a.top = t.startTop : void 0 !== t.startBottom && (a.bottom = t.startBottom), void 0 !== t.startLeft ? a.left = t.startLeft : void 0 !== t.startRight && (a.right = t.startRight)), setStyle(n.wrap, a),
                t.movable && addEvent(t.movable, "mousedown", n._head_mdown.bind(n)), n.resizeableH = t.resizeableH || e, t.startHeight && setStyle(n.resizeableH, "height", t.startHeight), n.resizeableW = t.resizeableW || e, t.startWidth && setStyle(n.resizeableW, "width", t.startWidth), addEvent(e, "mousedown", n._cont_mdown.bind(n)), t.closer && (addEvent(t.closer, "mousedown", n._close_mdown.bind(n)), addEvent(t.closer, "click", n._close_click.bind(n))), t.hider && (addEvent(t.hider, "mousedown", n._close_mdown.bind(n)), addEvent(t.hider, "click", n._hide_click.bind(n))), t.minimizer && t.minimizer !== !0 && (addEvent(t.minimizer, "mousedown", n._close_mdown.bind(n)), addEvent(t.minimizer, "click", n._min_toggle.bind(n))), n.wrap.appendChild(e), t.resize !== !1 && (n.resizeWrap = ce("div", {
