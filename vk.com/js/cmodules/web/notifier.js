! function(e) {
    ...
    function C(e, t) {
        return isString(t) && (t = _(t)), O(e).replaceChild(t, e), t
    }
    ...
    function B(e, t) {
        t = t || {};
        for (var n = t.fromEl || O(e), r = t.positions || ["relative", "absolute", "fixed"]; n && n != bodyNode;) {
            var i = ce(n, "position");
    ...
    function H(e, t) {
        e = r(e);
        for (var n, i, a, o, s = e; s && s.tagName && s !== bodyNode && (n = ce(s, "position"), i = ce(s, "overflow"), a = ce(s, "transform"), !t || !browser.mozilla || "page_wrap" == s.id || s === e || "visible" === i || ("static" === n ? o && "relative" !== o : "fixed" === o));) "none" !== a ? o = void 0 : "static" !== n && "fixed" !== o && (o = n), s = O(s);
        return s
    }
    ...
    function Y(e, t) {
        ...
        var n, i, a = {
            ...
            o = e.ownerDocument;
        return o ? (n = o.documentElement, V(e) && (a = Q(e, !0)), i = o == o.window ? o : 9 === o.nodeType ? o.defaultView || o.parentWindow : !1, [a.left + (t ? 0 : i.pageXOffset || n.scrollLeft) - (n.clientLeft || 0), a.top + (t ? 0 : i.pageYOffset || n.scrollTop) - (n.clientTop || 0)]) : [0, 0]
    }
    ...
    function X(e, t, n) {
        ...
        if (t && "border-box" === ce(e, "boxSizing") && (t = !1), e == document) a = [Math.max(o.clientWidth, bodyNode.scrollWidth, o.scrollWidth, bodyNode.offsetWidth, o.offsetWidth), Math.max(o.clientHeight, bodyNode.scrollHeight, o.scrollHeight, bodyNode.offsetHeight, o.offsetHeight)];
            ...
            var s = function() {
                a = V(e) && (i = Q(e, n)) && void 0 !== i.width ? [i.width, i.height] : [e.offsetWidth, e.offsetHeight], t && each(a, function(t, n) {
    ...
    function we(e) {
        return Oe ? void 0 : window.document.title = replaceEntities(e)
    }

    function ke(e) {
        Oe = e, e && window.cur && window.cur.destroy.push(function() {
            ke(!1)
        })
    }
    ...
    var Oe = !1;
    window.ge = r, window.geByTag = i, window.geByTag1 = a, window.geByClass = o, window.geByClass1 = s, window.gpeByClass = c, window.domQuery = u, window.domQuery1 = d, window.domClosest = l, window.ce = p, window.re = m, window.se = _, window.sech = g, window.rs = v, window.psr = b, window.domReplaceEl = C, window.domEL = y, window.domNS = w, window.domPS = k, window.domFC = N, window.domLC = T, window.domPN = O, window.domChildren = F, window.domInsertBefore = E, window.domInsertAfter = S, window.domByClass = x, window.domData = j, window.domChildIndex = I, window.domCA = L, window.domClosestSibling = A, window.matchesSelector = M, window.isHover = R, window.isAncestor = P, window.getScroll = D, window.domClosestPositioned = B, window.domClosestOverflowHidden = H, window.show = q, window.hide = z, window.isVisible = U, window.clientHeight = W, window.getClientRectOffsetY = G, window.toggle = K, window.boundingRectEnabled = V, window.getXYRect = Q, window.getXY = Y, window.isWindow = $, window.getSize = X, window.hasClass = ee, window.addClass = te, window.addClassDelayed = ne, window.removeClass = re, window.removeClassDelayed = ie, window.toggleClass = ae, window.toggleClassDelayed = oe, window.replaceClass = se, window.getStyle = ce, window.setStyle = ue, window.setStyleDelayed = de, window.setPseudoStyle = le, window.data = fe, window.attr = he, window.removeAttr = pe, window.removeData = me, window.cleanElems = _e, window.setTitle = ge, window.getZoom = ve, window.val = be, window.elfocus = Ce, window.traverseParent = ye, window.getH = Z, window.getW = J, window.domClosestByTag = f, window.setDocumentTitle = we, window.lockDocumentTitle = ke
}, function(e, t, n) {
    "use strict";

    function r(e, t) {
        var n = Object(Y.unpackStore)(e),
            r = n.tabs[n.peer];
        return Object.keys(r.msgs).filter(function(n) {
            var i = b(e, t, n);
            return !Object(W.isOut)(i) && intval(n) > r.in_up_to
        })[0]
    }

    function i(e) {
        var t = Object(Y.unpackStore)(e);
    ...
    function o(e) {
        var t = u(e);
        return t ? t.keyboard : null
    }

    function s(e, t) {
        var n = c(e, t);
        return n ? n.keyboard : null
    }
    ...
    function l(e, t, n) {
        ...
        return Object.keys(r.msgs).filter(function(e) {
            ...
            var n = b(e, e.get().peer, t);
            return !Object(W.isServiceMsg)(n) && !Object(W.isCallMessage)(n)
        }).map(intval)
    }

    function f(e, t) {
        var n = Object(Y.unpackStore)(t),
            r = c(n, e),
            i = 0;
        for (var a in r.msgs)
            if (r.msgs.hasOwnProperty(a)) {
                var o = b(t, e, a);
                Object(W.isOut)(o) || (i += Object(W.isUnread)(r, o) ? 1 : 0)
            }
        return i
    }
    ...
    function _(e, t, n) {
        var r = c(e, t),
            ...
            a = Object.keys(r.msgs).filter(function(n) {
                var r = b(e, t, n),
                    a = r.local && r.type !== G.EDIT_MESSAGE;
    ...
    function v(e, t, n) {
        var r = c(e, t),
            i = b(e, t, n),
            a = Object(Y.unpackStore)(e);
        return Object(W.isOut)(i) ? Object(V.oCacheGet)(e, a.id).name : i.userId !== i.peerId ? Object(V.oCacheExists)(e, i.userId) ? Object(V.oCacheGet)(e, i.userId).name : !1 : r.tab
    }
    ...
    function w(e) {
        return Object(Y.unpackStore)(e).gid
    }
    ...
    function L(e, t) {
        return I(t) ? !!c(e, t).blocked_community : !1
    }
    ...
    function q(e) {
        return 1 == Object(Y.unpackStore)(e).isEditing
    }
    ...
    function U(e) {
        return e.draft || (e.draft = Object(Q.loadDraftForPeer)(cur.imDb, e.peerId)), e.draft
    }
    ...
    window.curFastChat || (window.curFastChat = {}), window.FastChat = {
        ...
        clistRender: function(e) {
            ...
            if (i ? (s = [], each(FastChat.clistCache(i), function() {
                ...
                }), o !== !1 || e || i ? i && !curFastChat.clHasMore && t.push(FastChat.getCorrespondents(i, s, o === !1)) : t.push('<div class="fc_clist_empty">' + getLang(i ? "mail_im_clist_notfound" : "mail_im_clist_empty") + "</div>"),
                curFastChat.clOffset = o, e) {
                for (var c = ce("div", {
                        innerHTML: t.join("")
    ...
    function a(e) {
        e >= window.clientHeight() - 30 && (e = 0), ln.set(ur, e)
    }
    ...
    function c(e, t, n, r) {
        var i = t && !n ? 1 : !t && n ? -1 : 0;
        i && !Object(Ot.isClassicInterface)(e) && r().compensateHistoryHeightChange(i)
    }
    ...
    function f(e) {
        var t = Object(Ot.checkVoiceMessageAvailable)(e);
    ...
    function b(e, t) {
        ...
        Object(Ft.isOut)(t) && r && n.push("im-mess_unread _im_mess_unread"), Object(Ft.isOut)(t) && n.push("im-mess_out"), Object(Ft.wasEdited)(t) && n.push("im-mess_was_edited"), Object(Lt.canMessageBeEdited)(e, t) && n.push("im-mess_editable"), Object(Ft.isImportant)(t) && n.push("im-mess_fav"), -1 != (e.selectedMessages || []).indexOf(t.messageId) && n.push("im-mess_selected");
        var i = Date.now() - 1e3 * t.date > 1e3;
        t.local && i && n.push("im-mess_sending"), t.local && n.push("" + Bt), t.local && Object(Ft.wasEdited)(t) && !r && n.push("im-mess_unread im-mess_nobg"), t.failed && n.push("im-mess_failed " + Ht), Object(Ft.isGift)(t) && n.push("im-mess_gift");
        var a = C(t),
            o = q(e, t.text, t.kludges, !1, t.peerId);
        "" != o && Object(Ft.wasEdited)(t) && (o += Rn("sImLblWasEdited", {
            update_time: t.update_time
        })), t.subject && "..." !== t.subject.trim() && !I(t.peerId) && (o = Rn("im_topic", {
            topic: t.subject
        }) + o);
    ...
    function y(e) {
        for (var t = e.getElementsByClassName("_im_mess_noa"), n = t.length; n--;) In(t[n], "im-mess_fwd") || t[n].insertAdjacentHTML("afterbegin", Rn("sImHistoryRowActions")), xn(t[n], "_im_mess_noa")
    }
    ...
    function N(e, t, n) {
        ...
        var c = b(e, t),
            u = wn(n);
        In(u, "_im_mess_stack") || (u = Nn(u, "._im_mess_stack", -1));
        for (var d = Object(Ot.getLastMessage)(e, t.peerId, t.messageId); t.peerId === e.peer && d && !Fn("_im_mess_" + d.messageId);) d = Object(Ot.getLastMessage)(e, t.peerId, d.messageId);
        ...
        if (!d || B(o, d, t, e, i)) {
            var p = "",
                m = !1;
            if (l && Object(Ft.isOut)(t) && Qe(e, n, t.peerId), 1 === o.unread && !Object(Ft.isOut)(t) && i && (p += Rn("im_mess_bar", {}), m = !0, Qe(e, n, t.peerId)), !Gn(new Date(h))) {
                var _ = new Date,
            ...
            if (Object(Ft.isServiceMsg)(t)) p += Rn("im_service_row", {
                ...
                var v = e.gid && Object(Ft.isOut)(t) ? gn(t.kludges.from_admin) || -e.gid : 0,
                    C = Object(jt.oCacheGet)(e, v ? -e.gid : f) || o,
                    w = I(t.peerId) ? C.name : C.first_name,
                    N = C.link || o.href,
                    O = Rn("im_mess_stack_name", {
                        name: w,
                        link: N,
                        "class": Object(Ft.isMoney)(t) ? " im-mess-stack--lnk-money-transfer" : ""
                    });
                if (Object(Ft.isGift)(t)) {
                    var F = Pn("mail_gift_message_sent", "raw");
                    O += ' <span class="im-mess-stack--gift">' + Dn(C.sex || 0, F) + "</span>"
                }
                if (Object(Ft.isMoney)(t)) {
                    var E = Object(Ft.isMoneyRequest)(t) ? Pn("mail_money_request_message_sent", "raw") : Pn("mail_money_tranfer_message_sent", "raw");
                    O += ' <span class="im-mess-stack--money-transfer">' + Dn(C.sex || 0, E) + "</span>"
                }
            ...
            Object(xt.toArray)(mn(p)).forEach(function(e) {
                return n && n.appendChild(e)
            })
        } else l && e.peer === t.peerId && !o.inplaceSearch && Object(Ft.isOut)(t) && Qe(e, n, t.peerId), Fn("_im_stack_messages", u).appendChild(fn(c));
        return Object(Ft.isOut)(t) && !a && setTimeout(function() {
            var e = Fn("_im_mess_" + t.messageId, n);
            In(e, Bt) && Sn(e, "im-mess_sending")
    ...
    function T(e, t, n) {
        ...
        return r = "object" === ("undefined" == typeof e ? "undefined" : Dt(e)) ? e : t.imQueue(e, !1), r.length > 0 && r.map(function(e) {
            ...
            return Object(Ot.getMessage)(t, e.peerId, e.messageId)
        }).forEach(function(e) {
            return N(t, e, n, !1)
        }), n
    }
    ...
    function F(e, t, n) {
        var r = e.tabs[t];
        return Object(xt.toArray)(On("_im_mess_unread", n)).forEach(function(e) {
            var t = gn(Tn(e, "msgid"));
            t > 0 && r.out_up_to >= t && (xn(e, "_im_mess_unread"), xn(e, "im-mess_unread"), O(e))
        }), n
    }
    ...
    function S(e, t) {
        if (!Object(Ot.isFullyLoadedTab)(t, e.peerId)) return 0;
    ...
    function M(e, t) {
        return Object(Rt.doesChatTabHaveFlag)(Object(Ot.getTab)(e, t), 1024)
    }
    ...
    function B(e, t, n, r, i) {
        ...
        var a = D(t.date, r),
            o = D(n.date, r);
        return Wn(a, o) ? Object(Ot.isCommunityInterface)(r) && gn(t.kludges.from_admin) !== gn(n.kludges.from_admin) ? !0 : n.date - t.date > 300 ? !0 : Object(Ft.isServiceMsg)(t) || Object(Ft.isServiceMsg)(n) ? !0 : Object(Ft.isCallMessage)(n) || Object(Ft.isCallMessage)(t) ? !0 : Object(Ft.isGift)(t) || Object(Ft.isGift)(n) ? !0 : Object(Ft.isGraffiti)(t) || Object(Ft.isGraffiti)(n) ? !0 : Object(Ft.isUnread)(e, t) === Object(Ft.isUnread)(e, n) || !i || Object(Ft.isOut)(n) || ge(n.peerId, r.gid) ? !1 : !0 : !0
    }
    ...
    function q(e, t, n) {
        ...
        return t = Object(Et.replaceHyperLinks)(t || "", Et.linksReplacer.bind(null, r)), t = t.replace(/(<a.+?<\/a>)/gi, function(e) {
            ...
            var n = Object(Ot.getGroupId)(e),
                r = n ? "gim" + n : "im",
                a = i || Object(Ot.getPeer)(e);
            return '<a href="/' + r + "?sel=" + a + "&st=" + encodeURIComponent(t) + '">' + t + "</a>"
        }), Object.keys(o).forEach(function(e) {
            t = t.replace(e, function() {
                return o[e]
            })
        }), n.emoji && (t = er.emojiToHTML(t, !0)), ir && (t = ir(t)), t
    }
    ...
    function Q(e) {
        ...
        switch (e.length) {
            ...
            case 3:
                return K(e[0], t[0]) + e.slice(1).map(function(e, n) {
                    return V(e, t[n + 1])
                }).join("");
            case 4:
                return e.map(function(e, n) {
    ...
    function Y(e, t, n) {
        ...
        var r = t.data.active.slice(0, 4).map(jt.oCacheGet.bind(null, e)),
            i = r.map(function(e) {
                return e.photo
            }),
    ...
    function ae(e, t) {
        ...
        return e.forEach(function(e) {
            In(e, "im-mess_srv") ? e.parentNode.parentNode.removeChild(e.parentNode) : e.parentNode.removeChild(e)
        }), n.filter(function(e) {
            return 0 === kn(e).length
        }).map(function(e) {
            return En("_im_mess_stack", e)
        }).forEach(function(e) {
            In(yn(e), "_im_bar_date") && hn(yn(e)), In(yn(e), "_im_unread_bar_row") && hn(yn(e)), hn(e)
        }), t
    }
    ...
    function ue(e, t, n, r) {
        ...
        var o = (Object(Ot.isClassicInterface)(r), 60),
            s = de(e, t, n, r, !1, i);
    ...
    function pe(e, t, n) {
        ...
        if (i.source_act === $t || i.source_act === Xt)
            if (i.source_message) {
                var m = _e(er.emojiToHTML(bn(i.source_message.replace(/<br\s?\/?>/gi, " ")), !0)),
                    _ = he("", m, !1, "im_srv_mess_link");
                u = u.replace("{msg}", _)
    ...
    function ve(e, t) {
        return $n(e, {
            url: Object(Ot.isCommunityPeer)(t) ? "al_groups.php" : "al_profile.php",
            params: {
                act: "verified_tt",
                mid: t,
                gid: t
    ...
    function Ne(e, t, n) {
        var r = Pn("mail_deleteall1"),
            ...
            a = Pn("mail_delete");
        return I(t) && (Object(Rt.doesChatTabHaveFlag)(e, 1024) ? (r = Pn("mail_leave_vkcomgroup"), i = Pn("mail_unfollow_channel_confirmation"), a = Pn("mail_unfollow_channel")) : i = Pn("mail_chat_sure_to_delete_all")), Object(Ot.isCommunityPeer)(t) && (i = Pn("mail_group_sure_to_delete_all")), Qn(r, i, a, n, Pn("global_cancel"))
    }
    ...
    function Oe(e, t, n, r) {
        var i = Pn("mail_dialog_msg_delete_N", t),
            ...
            o = "",
            s = !1;
        return n && (o = '<div class="checkbox im-delete-forall-checkbox _check_forall" onclick="checkbox(this);" role="checkbox" aria-checked="false">' + Pn("mail_delete_for_all") + "</div>", s = cur.imDb.selectByKey("del_forall_checked")), a.setControlsText(o), s && checkbox(Fn("_check_forall")), a
    }
    ...
    function je(e, t, n, r) {
        ...
        var i = Object(Ot.isReversedDialogs)(t);
        return t.set(r.bind(null, e)).then(function(e) {
            return n().restoreDialogs(e, !0, i !== Object(Ot.isReversedDialogs)(e)), e
        })
    }
    ...
    function Le(e, t) {
        ...
        if ("undefined" == typeof t && (t = e.get().peer), !Object(Ot.isFoldersAvailable)(e)) return !1;
    ...
    function Be(e, t) {
        return He(e.get(), t, Object(Ot.getTab)(e, t).last_seen)
    }
    ...
    function He(e, t, n, r) {
        ...
        var i = qn(n[1], e.timeshift),
            a = Dn(Object(jt.oCacheGet)(e, t).sex, Pn("mail_last_activity_tip", "raw")).replace("{user}", "").replace("{time}", i);
    ...
    function Qe(e, t, n) {
        ...
        var c = Tn(s, "msgid"),
            u = Object(Ot.getPreviousMessage)(e, n, c),
            d = Object(Ot.getMessage)(e, n, c);
    ...
    function Ye(e, t, n) {
        var r = Object(Ot.getFirstUnread)(e, e.get().peer);
        if (!r) return [!1, 0];
        var i = Fn("_im_mess_" + r, t);
        if (!i) {
            var a = Object(Ot.getLastMessage)(e, e.get().peer, r);
            if (!a) return [!0, 0];
            i = Fn("_im_mess_" + a.messageId, t)
        }
        var o = In(i, "_im_mess_srv") ? i : En("_im_mess_stack", i);
        if (!o) return [!0, 0];
    ...
    function $e(e, t, n) {
        ...
        i && In(i, "im-page--dialogs-notice") && xn(i, "im-page--dialogs-notice"), Kn.post("al_im.php", {
    ...
    function Xe(e, t, n) {
        ...
        tr(r, 200, hn.pbind(r)), Kn.post("al_im.php", {
            act: "a_hide_top_notice",
            type: r.getAttribute("data-type"),
            hash: r.getAttribute("data-hash")
        })
    ...
    function Je(e, t) {
        ...
        tr(n, 200, hn.pbind(n)), Kn.post("al_im.php", {
    ...
    function Ze(e, t) {
        var n = En("_im_aside_promo_block", t);
        n.classList.add("--action-called"), Kn.post("al_im.php", {
    ...
    function et(e, t, n, r, i) {
        return n = n.replace(/\<br\s*\/?\>(\n)?/gi, " ").replace(/[\n\r]/gi, " "), n = Object(Et.replaceMentions)(n, function(e, t, n, r, i) {
            return i
        }), r && (n = er.emojiToHTML(n, !0)), t && "..." !== t.trim() && !I(e) && (n = Rn("im_topic", {
            topic: t,
            cls: "im-topic_dialog"
    ...
    function it(e) {
        var t = e.get(),
            n = Object(Ot.getPinnedMessage)(e);
        if (!n || !Object(It.isPinnedMessageVisibleInTab)(e, Object(Ot.getPeer)(e))) return "";
        var r = Object(jt.oCacheGet)(e, n.userId);
        if (!r) return "";
        var i = at(e, n);
    ...
    function st() {
        var e = getSize(Fn(cn))[1];
        return e || (e = cr), e
    }

    function ct(e, t) {
        e.bodyNode.addEventListener("mouseover", function(e) {
            In(e.target, "_im_edit_time") && ot(t, e, e.target)
        })
    }
    ...
    function ft(e, t) {
        var n = Object(jt.oCacheGet)(e, t.peerId),
            r = Object(Ot.getTab)(e, t.peerId) || {};
        return n && (t.photo = t.photo || n.photo, t.name = t.name || n.name, t.href = t.link || n.link, t.sex = t.sex || n.sex), t.last_touched = r.last_touched || 0, t.verified = !!t.verified, t.lastmsg = t.lastmsg || t.lastmsg_meta && t.lastmsg_meta[0] || !1, t.folders = t.folders || null, t.unread = t.unread || 0, t.last_seen = t.last_seen || [0, 0, 0], t.online = t.last_seen && t.last_seen[0] || 0, t.out_up_to = null != t.out_up_to ? t.out_up_to : t.in_up_to || 0, I(t.peerId) && (t.memberIds = t.memberIds || r.memberIds || null), t
    }
    ...
    function pt(e, t) {
        var n = [],
            ...
            i = r ? r[1].split(";") : [];
        for (i.length > or && (r[1] = i.slice(0, or).join(";")); e.length > ar;) {
            var a = e.substr(0, ar).lastIndexOf(" "); - 1 == a && (a = ar), n.push({
        ...
        for (e.length && n.push({
                ...
                attaches: t
            }), i = i.slice(or); i.length; i = i.slice(or)) n.push({
            attaches: [
                ["mail", i.slice(0, or).join(";")]
            ]
        });
        return n
    }
    ...
    function vt(e, t) {
        var n = Object(Ot.getTab)(e, t.peerId) || {};
    ...
    function wt(e, t) {
        ...
        var h = l.slice(0, f - 1).join(", "),
            p = l.pop();
        return Pn("global_and").replace(/{before}/gi, h).replace(/{after}/gi, p)
    }
    ...
    n.d(t, "getFirstUnread", function() {
        return Ot.getFirstUnread
    }), n.d(t, "isSearchShown", function() {
        return Ot.isSearchShown
    }), n.d(t, "getPeer", function() {
        return Ot.getPeer
    }), n.d(t, "getCurrentKeyboard", function() {
        return Ot.getCurrentKeyboard
    }), n.d(t, "getKeyboard", function() {
        return Ot.getKeyboard
    }), n.d(t, "getTab", function() {
        return Ot.getTab
    }), n.d(t, "getCurrentTab", function() {
        return Ot.getCurrentTab
    }), n.d(t, "getSelectedMessages", function() {
        return Ot.getSelectedMessages
    }), n.d(t, "getMessageRangeFromSelection", function() {
        return Ot.getMessageRangeFromSelection
    }), n.d(t, "countUnread", function() {
        return Ot.countUnread
    }), n.d(t, "getMessageByRid", function() {
        return Ot.getMessageByRid
    }), n.d(t, "isRidExist", function() {
        return Ot.isRidExist
    }), n.d(t, "getLocalId", function() {
        return Ot.getLocalId
    }), n.d(t, "getLastMessage", function() {
        return Ot.getLastMessage
    }), n.d(t, "parserMessage", function() {
        return Ot.parserMessage
    }), n.d(t, "getAuthorFullName", function() {
        return Ot.getAuthorFullName
    }), n.d(t, "getMessage", function() {
        return Ot.getMessage
    }), n.d(t, "getPreviousMessage", function() {
        return Ot.getPreviousMessage
    }), n.d(t, "isClassicInterface", function() {
        return Ot.isClassicInterface
    }), n.d(t, "isLocksAvailable", function() {
        return Ot.isLocksAvailable
    }), n.d(t, "isFoldersAvailable", function() {
        return Ot.isFoldersAvailable
    }), n.d(t, "isCommunityInterface", function() {
        return Ot.isCommunityInterface
    }), n.d(t, "getBareTab", function() {
        return Ot.getBareTab
    }), n.d(t, "isReversedDialogs", function() {
        return Ot.isReversedDialogs
    }), n.d(t, "isFullyLoadedTab", function() {
        return Ot.isFullyLoadedTab
    }), n.d(t, "makeTabNotFullyLoaded", function() {
        return Ot.makeTabNotFullyLoaded
    }), n.d(t, "isGoToEndVisible", function() {
        return Ot.isGoToEndVisible
    }), n.d(t, "getUnreadScrollBottom", function() {
        return Ot.getUnreadScrollBottom
    }), n.d(t, "isSendingAvailable", function() {
        return Ot.isSendingAvailable
    }), n.d(t, "isCommunityPeer", function() {
        return Ot.isCommunityPeer
    }), n.d(t, "isCommunityBlocked", function() {
        return Ot.isCommunityBlocked
    }), n.d(t, "checkVoiceMessageAvailable", function() {
        return Ot.checkVoiceMessageAvailable
    }), n.d(t, "isSearching", function() {
        return Ot.isSearching
    }), n.d(t, "getSearchText", function() {
        return Ot.getSearchText
    }), n.d(t, "isSearchingValue", function() {
        return Ot.isSearchingValue
    }), n.d(t, "isRecentSearchesActive", function() {
        return Ot.isRecentSearchesActive
    }), n.d(t, "getPinnedMessage", function() {
        return Ot.getPinnedMessage
    }), n.d(t, "doPopularSuggExist", function() {
        return Ot.doPopularSuggExist
    }), n.d(t, "isAnyMessageBeingEdited", function() {
        return Ot.isAnyMessageBeingEdited
    }), n.d(t, "getGroupId", function() {
        return Ot.getGroupId
    }), n.d(t, "getTabDraft", function() {
        return Ot.getTabDraft
    });
    var Ft = n(28),
        Et = n(36),
        St = n(27),
    ...
    function r(e, t) {
        if (Object(v.unpackStore)(e).searchShown) return !1;
    ...
    function i(e, t, n) {
        ...
        i && a && (i.pinHideId = a.chat_local_id, cur.imDb.update(C.PIN_HIDDEN_ID_OP, [i.peerId, i.pinHideId]), c(n, t, e), re(geByClass1("_im_pinned_tt")), r && window.Notifier && Notifier.lcSend("pin_hide", {
            hide: 1,
            peer: t
    ...
    function a(e, t, n) {
        var r = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : !0,
            i = Object(g.getTab)(e, t);
        i && i.pinHideId && (delete i.pinHideId, cur.imDb.update(C.PIN_HIDDEN_ID_OP, [i.peerId, void 0]),
            c(n, t, e), r && window.Notifier && Notifier.lcSend("pin_hide", {
                hide: 0,
                peer: t
    ...
    var _helpers_im_shared_helpers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(36),
        _longpoll_singleton__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(1),
                        ...
                        try {
                            ...
                            if (isArray(response))
                                for (main_response = response.shift();
                                    (add_response = response.shift()) && (add_queue = add_queues.shift());) 2 != add_response.failed || 4 != add_response.err ? (this.lcSend("addfeed", [add_queue, add_response]),
                                    this.addFeed(add_queue, add_response), add_response.failed && delete curNotifier.addQueues[add_queue]) : (Notifier.debug && debugLog("!!notifier key busy!! " + curNotifier.instance_id), busy |= 1);
    ...
    function o(e, t, n) {
        return Object(Dt.post)(Dt.CONTROLLER, {
            act: "a_renew_hash",
            peers: e.join(","),
    ...
    function s(e) {
        if (!e.renew_hashes) {
            ...
            var n = Object.keys(e.tabs).filter(function(t) {
                return Object(Wt.isFullyLoadedTab)(e, t)
            });
    ...
    function h(e, t, n, r, i) {
        return i.tabHistoryNotChanged = !1, Object(qt.retryFn)(Dt.post, 3, function(e) {
            return e - 1
        })(Dt.CONTROLLER, {
            act: "a_start",
            peer: e,
            ...
            if (o.forEach(function(e) {
                    return Object(Qt.oCacheAdd)(i, e)
                }), i.tabs || (i.tabs = {}), i.dialog_tab_cts = u, i.tabs[e] || (i.tabs[e] = Object(Wt.normalizeTab)(i, a)), f(c, i), n) {
                if (i.tabs[e]) {
            ...
            return i.admins = extend(i.admins, s), i.imQueue(e, !1), It(), p(e, i)
        })["catch"](function(e) {
            return Object(Yt.imWeirdCatch)("loadPeer", e)
        })
    }
    ...
    function p(e, t) {
        var n = t.imQueue(e, !1),
            ...
            i = n.filter(function(n) {
                return !Object(Kt.isRidExist)(t, e, n.rid)
            });
        return r.msgs = i.reduce(function(e, t) {
            return e["rid" + t.rid] = t.mess, e
        }, r.msgs), t.imQueueSet(e, i), t.tabs[e].history = Object(Wt.restoreQueue)(i, t, d(t.tabs[e].history)), Promise.resolve(t)
    }
    ...
    function m(e, t, n) {
        ...
        return n.imQueueSet(e, r), n.tabs[e].history = Object(Wt.removeMessages)([t], d(n.tabs[e].history)), Promise.resolve(n)
    }

    function _(e, t) {
        return (t.block_states[e] || {}).free === !1 ? Promise.resolve(t) : Object(Dt.post)(Dt.CONTROLLER, {
            act: "a_block",
            peer: e,
            prevPeer: t.prevPeer,
            gid: t.gid
    ...
    function g(e, t) {
        ...
        return Promise.resolve(t).then(function(t) {
            return t.tabHistoryNotChanged = !1, Object(Wt.isFullyLoadedTab)(t, n) && !t.tabs[n].msgid ? (t.gid && _(n, t), Promise.resolve(t).then(w)) : (Object(Wt.isFullyLoadedTab)(t, n) && (t.tabs[n].msgid = !1), h(n, e, !1, !0, t))
        }).then(w).then(v.bind(null, n))
    }

    function v(e, t) {
        var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : !1;
        return Object(Wt.isTabLoaded)(t, e) && (t.tabs[e].last_touched = Date.now()), Object(Wt.isTabLoaded)(t, e) && n && (t.tabs[e].last_visited = Date.now()), t
    }

    function b(e, t, n) {
        var r = n.msgid,
            i = n.peer;
        return !e && Object(Wt.isFullyLoadedTab)(n, i) && n.tabs[i].msgs[r] ? (t === n.peer ? n.tabHistoryNotChanged = !0 : n.tabHistoryNotChanged = !1, n.gid && _(i, n), Promise.resolve(n).then(w).then(v.bind(null, i))) : h(i, !0, r, !0, n).then(w).then(function() {
            var e = Object(Kt.getTab)(n, i);
            return e.msgid = r, n
        }).then(v.bind(null, i))
    }

    function C(e, t, n, r) {
        if (Ge(r)) throw Object(Wt.showWaitUntilUploadedBox)(), new Error("Cant change peer while loading somethind");
        var i = r.gid ? "gim" + r.gid : "im";
        if (r.prevPeer = r.peer, r.peer = e, r.msgid = t || "", r.currentEntryPoint = n, cur.peer = e, on({
                sel: e ? Object(Wt.convertPeerToUrl)(e) : null,
                msgid: r.msgid,
                email: "",
                0: i
            }), 0 != r.prevPeer && v(r.prevPeer, r, !0), 0 !== e) {
            var a = [];
            Object(Wt.isTabLoaded)(r, e) && v(e, r, !0), a = r.tabbedPeers.map(function(e) {
                return e.peer
            }).indexOf(e) < 0 ? [{
                peer: e,
                type: "perm"
        ...
        return sn(), he(r.prevPeer, r)
    }

    function y(e) {
        if (cur.wallMentions = [], Object(Wt.isChatPeer)(e.peer) && Object(Wt.isFullyLoadedTab)(e, e.peer) && !Object(Wt.isFvkcomgroup)(e, e.peer)) {
            var t = e.tabs[e.peer],
                n = [];
            Object.keys(t.msgs || {}).reverse().forEach(function(e) {
                var r = Object(Kt.parserMessage)(t.msgs[e]),
                    i = r && r.userId;
                i && i != vk.id && -1 === n.indexOf(i) && Object(Wt.isUserAliveInChat)(t, i) && n.push(i)
            }), (t.memberIds || []).forEach(function(e) {
                -1 === n.indexOf(e) && n.push(e)
            }), n.forEach(function(t) {
                if (Object(Qt.oCacheExists)(e, t)) {
                    var n = Object(Qt.oCacheGet)(e, t),
    ...
    function w(e) {
        ...
        var n = e.tabs[t],
            r = [],
            i = Object(Wt.isChatPeer)(t) && (n.data.closed || n.data.kicked),
            a = Object(Wt.isFvkcomgroup)(e, t);
        n.offset && r.push("photos"), n.offset && r.push("search"), (-2e9 > t || n.offset) && !a && r.push("clear"), Object(Wt.isCommunityInterface)(e) && !a && r.push("block"), Object(Wt.isCommunityPeer)(t) && (n.blocked_community ? r.push("allow_community") : r.push("block_community")), !Object(Wt.isChatPeer)(t) && !Object(Wt.isUserPeer)(t) || Object(Wt.isCommunityInterface)(e) || Object(Wt.isChatPeer)(t) && (n.data.kicked || n.data.closed) || (inArray(t, e.mutedPeers) ? r.push("unmute") : r.push("mute")), Object(Wt.isUserPeer)(t) && !e.gid && !n.blacklisted && n.is_friend && r.push("invite"), !e.chatSettingsAllowed && Object(Wt.isChatPeer)(t) && !i && n.data.link && r.push("invite_link"), Object(Wt.isChatPeer)(t) && !i && (e.chatSettingsAllowed || (Object(Xt.canChangeTitle)(e) && r.push("topic"), Object(Xt.canChangeAvatar)(e) && r.push("avatar")), Object(Xt.canInviteUser)(e) && r.push("invite"), e.gid || r.push("leave")), Object(Wt.isChatPeer)(t) && n.data.closed && !n.data.kicked && r.push("return"), Object(Wt.isChatPeer)(t) && e.chatSettingsAllowed && !n.data.closed && !n.data.kicked && r.push("settings"), Object(Wt.isChatPeer)(t) && n.pinned && (r.push(Object($t.isPinnedMessageVisibleInTab)(e, t) ? "pin_hide" : "pin_unhide"), Object(Xt.canPinOrUnpin)(e) && r.push("unpin"));
        var o = Object(Wt.chatActions)(e, a);
    ...
    function T(e, t, n, r) {
        var i = e.tabs[t];
        return r === Ht.FLAG_OUTBOUND && i.out_up_to > n ? e : (r === Ht.FLAG_OUTBOUND ? i.out_up_to = n : i.in_up_to = n, e)
    }
    ...
    function E(e, t, n) {
        var r = n.tabs[e];
        return r.msgs[t.messageId] && (r.msgs[t.messageId].errored = 1, r.history = Object(Wt.setMessageError)(e, t, d(r.history))), Promise.resolve(n)
    }

    function S(e, t, n, r) {
        var i = r.tabs[e];
        return i.msgs[t] && (i.msgs[t].errored = 0, i.lastmsg_meta = n, i.lastmsg = t, i.history = Object(Wt.startResendMessage)(e, t, d(i.history))), Promise.resolve(r)
    }

    function x(e, t, n, r) {
        var i = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : !1;
        t.deletedDialog || (e.dialog_tabs = Object.keys(e.dialog_tabs).reduce(function(e, a) {
            return !n && !Xe(a)(t) || i && !i(a, e[a], t) || (e[a] = Object(zt.arrayUnique)(r(e[a], a))), e
        }, e.dialog_tabs))
    }

    function j(e, t) {
        return 0 === e.length ? Promise.resolve(t) : Object(Dt.post)(Dt.CONTROLLER, {
            act: "a_get_admin",
            admins: e.join(","),
            gid: t.gid
        }).then(function(e) {
    ...
    function L(e, t, n) {
        return Object(Wt.isReversedDialogs)(n) ? t.concat([e]) : [e].concat(t)
    }

    function A(e, t) {
        var n = e.get().peer,
            r = Object(Kt.getTab)(e, n);
        if (Object(Wt.isFullyLoadedTab)(e, n)) {
            var i = d(r.history);
            r.history = Object(Wt.updateMessageInCache)(e, i, t)
        }
    }

    function M(e, t) {
        var n = Object(Kt.getTab)(t, e.peerId);
        if (Object(Wt.isFullyLoadedTab)(t, e.peerId)) {
            var r = d(n.history);
            n.msgs[e.messageId] = extend(!0, {}, e), n.history = Object(Wt.editAndReplaceMessage)(t, e, r)
        }
        n && n.lastmsg == e.messageId && (n.lastmsg_meta = e);
        var i = n && n.pinned && Object(Kt.parserMessage)(n.pinned);
    ...
    function R(e, t) {
        var n = e.flags & Ht.FLAG_OUTBOUND,
            i = e.peerId;
        if (Object(Wt.isTabLoaded)(t, i)) {
            var a = t.tabs[i];
            if (a.deletedDialog = !1, !t.msg_local_ids_sort && e.local ? t.msg_local_ids_sort = r({}, e.messageId, 0) : e.local && (t.msg_local_ids_sort[e.messageId] = Object.keys(t.msg_local_ids_sort).length), n ? a.unread = 0 : (a.lastmsg == e.messageId && a.unread ? P(t, 1, e.peerId) : (!a.unread && P(t, 1, e.peerId), a.unread++), I(e.peerId, t)), Object(Wt.isFullyLoadedTab)(t, i)) {
                var o = d(a.history);
                a.skipped > 0 && a.skipped++, a.offset++, a.msgs[e.messageId] = extend(!0, {}, e), a.history = Object(Wt.appendToHistory)(t, e, o, !0, !0, !0), Object(Vt.isOut)(e) && (a.blocked_community = 0, w(t))
            }
            if (a.typing) {
        ...
        return h(i, 0, 0, 0, t).then(function(t) {
            var r = t.tabs[i];
            return x(t, r, !1, L.bind(null, i), tt.bind(null, t)), v(e.peerId, t), n || I(e.peerId, t), t
        })
    }
    ...
    function D(e, t) {
        if (Object(Wt.isFullyLoadedTab)(t, e.peerId)) {
            var n = t.tabs[e.peerId],
                r = n.unread;
            if (t = T(t, e.peerId, e.upToId, 0), null != e.unread ? n.unread = e.unread : n.unread = e.upToId >= n.lastmsg ? 0 : Object(Kt.countUnread)(e.peerId, t) + (n.unread > 0 ? +n.skipped : 0), r > 0 && !n.unread && P(t, -1, e.peerId), !n.skipped) {
                var i = d(n.history);
                n.history = Object(Wt.removewNewUnreadBarAndMerge)(t, i, e.peerId)
            }
        } else Object(Wt.isTabLoaded)(t, e.peerId) && (t.tabs[e.peerId].unread > 0 && P(t, -1, e.peerId), t.tabs[e.peerId].unread = 0, t.tabs[e.peerId].in_up_to = e.upToId);
        return Object(Wt.isTabLoaded)(t, e.peerId) && (t.dialog_tabs[Gt.FOLDER_UNREAD] = t.dialog_tabs[Gt.FOLDER_UNREAD].filter(function(t) {
            return intval(t) !== e.peerId
        })), 0 !== t.unread_cnt || t.active_tab !== Gt.FOLDER_UNREAD || t.gid ? Promise.resolve(t) : Je(Gt.FOLDER_ALL, t)
    }

    function B(e, t) {
        var n = t.tabs[e.peerId];
        if (Object(Wt.isTabLoaded)(t, e.peerId) && T(t, e.peerId, e.upToId, Ht.FLAG_OUTBOUND), Object(Wt.isFullyLoadedTab)(t, e.peerId)) {
            var r = d(n.history);
            n.history = Object(Wt.markMessagesAsRead)(t, e.peerId, r)
        }
    ...
    function q(e, t, n) {
        ...
        if (1 === e.length) {
            var a = e[0],
                o = Object(Kt.getMessage)(n, t, a),
                s = Object(Kt.getAuthorFullName)(n, t, a);
            return s === !1 ? n.set(Fe.bind(null, r({}, t, [o.userId]))).then(function(n) {
                var r = Object(Kt.getAuthorFullName)(n, t, a);
                return {
                    msgIds: e,
                    object: i(o, r)
                }
    ...
    function z(e, t) {
        Object(Wt.normalizeTabsGotFromServer)(t, e);
        var n = t.tabs[t.peer];
    ...
    function U(e, t, n, r) {
        var i = Object(Kt.getTab)(r, e);
        if (i) {
            var a = t !== !1 ? t == rn ? 2 : mobPlatforms[t] ? 1 : 0 : i.last_seen[2];
    ...
    function G(e, t) {
        return Object(qt.pause)(tn + 2).then(function() {
            if (Object(Wt.isTabLoaded)(t, e)) {
                var n = t.tabs[e];
                if (n.typing) {
                    var r = Date.now() - 1e3 * n.typing.ts;
                    r >= 1e3 * tn && (n.typing = void 0)
                }
            }
            return t
        })
    ...
    function V(e, t) {
        if (t.selectedMessages || (t.selectedMessages = []), 1 === e.length && inArray(e[0], t.selectedMessages)) t.selectedMessages = t.selectedMessages.filter(function(t) {
            ...
            t.selectedMessages = Object(zt.arrayUnique)(n).sort(function(e, t) {
                return e - t
            })
        }
        return Promise.resolve(t)
    ...
    function $(e, t) {
        if (Object(Wt.isFullyLoadedTab)(t, e.peerId)) {
            ...
            i && (n.msgs[e.messageId] = e, delete n.msgs["rid" + e.randomId]), n.history = Object(Wt.replaceMessageAttrs)(t, d(n.history), e)
        }
        return Promise.resolve(t)
    }
    ...
    function J(e, t) {
        ...
        return Object(qt.retryFn)(Dt.post, 3, function(e) {
            return e * e
    ...
    function ee(e, t) {
        var n = t.tabs[e.peerId];
        return n.history = Object(Wt.replaceAttaches)(d(n.history), e, t), Promise.resolve(t)
    }

    function te(e, t, n) {
        var r = Object(Wt.dayFromVal)(t),
            i = n.tabs[e];
    ...
    function ue(e, t) {
        ...
        return Object(qt.retryFn)(Dt.post, 1, function() {
            return 4
        })(Dt.CONTROLLER, {
    ...
    function de(e) {
        ...
        return n = e.dialog_tabs[t].length > 0 ? Math.min.apply(null, e.dialog_tabs[t].map(function(t) {
        ...
        })) : 0, Object(Dt.post)(Dt.CONTROLLER, {
            act: "a_get_dialogs",
            start_message_id: n,
            tab: t,
            gid: e.gid
            ...
            return o.forEach(function(t) {
                return Object(Qt.oCacheAdd)(e, t)
    ...
    function fe(e, t) {
        if (t.peer === e && Object(Wt.isFullyLoadedTab)(t, e)) {
            var n = t.tabs[e];
    ...
    function he(e, t) {
        if (Object(Wt.isFullyLoadedTab)(t, e)) {
            var n = t.tabs[e];
            delete n.inplaceSearch, delete n.searchOffset, delete n.searchAllLoaded, delete n.searchText, delete n.searchDay, on({
                st: ""
            }), sn()
        }
        return Promise.resolve(t)
    ...
    function ge(e, t) {
        ...
        return Object(Dt.post)(Dt.CONTROLLER, {
            ...
            var s = en(o, 3);
            n.unread = s[0], n.in_up_to = s[1], n.out_up_to = s[2], n.unread || (e.get().dialog_tabs[Gt.FOLDER_UNREAD] = e.get().dialog_tabs[Gt.FOLDER_UNREAD].filter(function(e) {
                return e != t
    ...
    function ve(e, t, n) {
        if (Object(Wt.isFullyLoadedTab)(n, t)) {
            var r = n.tabs[t];
    ...
    function be(e, t, n) {
        if (Object(Wt.isFullyLoadedTab)(n, t)) {
            var r = n.tabs[t];
            r.history = Object(Wt.removeMessages)(e, d(r.history)), r.offset -= e.filter(function(e) {
                return r.msgs[e]
    ...
    function Ce(e, t, n, r) {
        if (Object(Wt.isFullyLoadedTab)(r, t)) {
            var i = r.tabs[t];
            i.deleted = i.deleted ? i.deleted.concat(e) : e, i.history = Object(Wt.removeMessagesWithRestore)(e, t, n, d(i.history)), i.offset -= e.filter(function(e) {
                return i.msgs[e]
            }).length
        }
        return Promise.resolve(r)
    ...
    function ye(e, t, n) {
        if (Object(Wt.isFullyLoadedTab)(n, t)) {
            ...
            r.deleted && (r.deleted = r.deleted.filter(function(t) {
                return t !== e
            })), r.history = Object(Wt.restoreMessage)(e, t, d(r.history)), r.offset++
        }
        return Promise.resolve(n)
    }
    ...
    function Fe(e, t) {
        ...
        return Object(Dt.post)(Dt.CONTROLLER, {
            ...
            return r.forEach(function(e) {
                return Object(Qt.oCacheAdd)(t, e)
            }), t
        })
    }
    ...
    function Ee(e, t, n) {
        function r(e, t) {
            Object(Wt.isChatPeer)(e) && t && !Object(Qt.oCacheExists)(a, t) && (i[e] ? -1 === i[e].indexOf(t) && i[e].push(t) : i[e] = [t])
        }
        var i = {},
            a = n.get(),
            o = t.filter(function(e) {
                return !Object(Wt.isTabLoaded)(a, e.peerId)
            }).map(function(e) {
                return e.peerId
            });
        t.forEach(function(e) {
            Object(Wt.isTabLoaded)(a, e.peerId) && r(e.peerId, e.userId)
        }), e.forEach(function(e) {
    ...
    function Se(e, t, n) {
        var r = e.needMembers,
            i = e.needAdminIds,
            a = e.needPeers;
        return t.pause(), Promise.all([Fe(r, n), j(i, n), Promise.all(a.map(function(e) {
            return h(e, 0, 0, 0, n)
        }))])["catch"](function() {
            return n
        }).then(function() {
    ...
    function xe(e, t, n, r) {
        return t !== vk.id ? Promise.resolve(r) : (Object(Wt.isTabLoaded)(r, n) && r.peer == n && (r = w(r)), Promise.resolve(r))
    }
    ...
    function Le(e, t, n, r) {
        if (Object(Wt.isFullyLoadedTab)(r, t)) {
            ...
            e.filter(function(e) {
                ...
                var a = Object(Kt.getMessage)(r, t, e),
                    o = n ? a.flags | Ht.FLAG_IMPORTANT : a.flags & ~Ht.FLAG_IMPORTANT;
                a.flags = o, i.msgs[e] = a, i.history = Object(Wt.updateStar)(e, n, d(i.history))
            })
        }
        return Promise.resolve(r)
    }
    ...
    function He(e, t, n) {
        return Object(Dt.post)("al_page.php", {
    ...
    function qe(e) {
        ...
        return Object(Dt.post)(Dt.CONTROLLER, {
            ...
            s.forEach(function(t) {
                return Object(Qt.oCacheAdd)(e, t)
            }), Object(Wt.normalizeTabsGotFromServer)(e, o), c.user_unread && handlePageCount("msg", c.user_unread), Object(zt.lplog)("Resync success", "success");
            var f = e.peer,
                h = void 0;
            if (Object(Wt.isReservedPeer)(f)) h = Promise.resolve(!1);
            else {
                var p = {
                    tabs: r({}, f, e.tabs[f]),
                    oCache: {}
            ...
            return h.then(function(n) {
                e.tabs = o, e.admins = extend(e.admins, u), n && (e.tabs[f] = n.tabs[f], e.tabs[f].history = Object(Wt.restoreQueue)(f, e, d(e.tabs[f].history))), e.loadingDialogs = !1, e.mutedPeers = c.mutedPeers, e.lastDialogsOptions = {
                    has_more: c.has_more
                ...
                return Object.keys(e.dialog_tabs).filter(function(e) {
                    ...
                    i == Gt.FOLDER_ALL ? e.dialog_tabs[t] = r.filter(Xe(t)).map(function(e) {
                        return e.peerId
                    }) : e.dialog_tabs[t] = []
                }), delete e.resync_in_process, setTimeout(t.bind(null, !0), 0), Ke(intval(c.unread), e)
            })
        })["catch"](function(t) {
            return Object(zt.lplog)("Resync error: " + t.message + " " + t.stack, "error"), Object(qt.pause)(2).then(qe.bind(null, e))
        })
    }
    ...
    function Ve(e, t) {
        return t.ctrl_submit = !!e, Object(Dt.post)(Dt.CONTROLLER, {
    ...
    function Qe(e, t, n) {
        return function() {
            ...
            if (0 === r) return Object(Jt.setDocumentTitle)(e ? e : document.title), setFavIcon("/images/icons/favicons/fav_im" + t + ".ico"), clearInterval(n.update_title_to), void(n.update_title_to = !1);
            if (e) Object(Jt.setDocumentTitle)(e), setFavIcon("/images/icons/favicons/fav_im" + t + ".ico"), e = !1;
            else {
                e = document.title;
                var i = r > 9 ? 10 : r;
                setFavIcon("/images/icons/favicons/fav_im" + i + t + ".ico"), Object(Jt.setDocumentTitle)(winToUtf(getLang("mail_im_new_messages", r)))
            }
        }
    }
    ...
    function Ye(e, t, n) {
        ...
        } else !t && n.update_old_title && (Object(Jt.setDocumentTitle)(n.update_old_title), n.cur_unread_cnt = {}, r = !1, n.update_old_title = !1, setFavIcon("/images/icons/favicons/fav_im" + i + ".ico"), clearInterval(n.update_title_to), n.update_title_to = !1);
        return Promise.resolve(n)
    }

    function $e(e, t, n, r, i) {
        return Object(Wt.isFullyLoadedTab)(i, e) && (i.tabs[e].scrollTop = intval(t), i.tabs[e].scrollBottom = intval(n), i.tabs[e].contHeight = intval(r)), Promise.resolve(i)
    }
    ...
    function Je(e, t) {
        t.active_tab = e, Object(Bt.updateLocation)({
            tab: e === Gt.FOLDER_ALL ? null : e
        });
        var n = [];
        if (e !== Gt.FOLDER_ALL && !Object(Wt.isReversedDialogs)(t)) {
            var r = t.dialog_tabs[e];
            n = t.dialog_tabs[Gt.FOLDER_ALL].map(function(e) {
                return t.tabs[e]
    ...
    function et(e, t, n) {
        return t !== Ht.RESET_DIRECTORIES || e.folders & Gt.FOLDER_MASKS[n] ? t === Ht.REPLACE_DIRECTORIES ? e.folders & Gt.FOLDER_MASKS[n] ? -1 : 1 : t === Ht.SET_DIRECTORIES ? 1 : -1 : 0
    }

    function tt(e, t, n, r) {
        var i = e.dialog_tabs_all;
        if (i[Gt.FOLDER_ALL] || i[t]) return !0;
        ...
        var a = n.map(function(t) {
            ...
            return Object(Wt.isReversedDialogs)(e) ? t.lastmsg > r.lastmsg : t.lastmsg < r.lastmsg
        });
        return a.length > 0 ? !0 : !1
    }

    function nt(e, t, n, r, i) {
        if (Object(Wt.isTabLoaded)(i, e)) {
            var a = i.tabs[e];
            return n === Ht.REPLACE_DIRECTORIES && (t ^= a.folders), Ze(n, t, a) && Object.keys(Gt.FOLDER_MASKS).filter(function(e) {
                return Gt.FOLDER_MASKS[e] & t
            }).forEach(function(e) {
                i.dialog_tab_cts[e] += et(a, n, e)
            }), n === Ht.SET_DIRECTORIES ? i.tabs[e].folders |= t : n === Ht.RESET_DIRECTORIES ? i.tabs[e].folders &= ~t : i.tabs[e].folders = t ^= a.folders, x(i, i.tabs[e], !0, function(t, n) {
    ...
    function it(e, t) {
        return f(r({}, e, {
            free: !0
        }), t), Object(Dt.post)(Dt.CONTROLLER, {
            act: "a_block_release",
            peer: e,
            gid: t.gid
        }).then(function() {
    ...
    function ct(e, t, n) {
        return n.tabbedPeers = e, Object(Wt.isClassicInterface)(n) && (on({
            peers: n.tabbedPeers.filter(function(e) {
                var t = e.peer,
                    r = e.type;
                return t !== n.peer && "perm" === r
            }).map(function(e) {
                return Object(Wt.getBareTab)(e.peer, n)
            }).filter(function(e) {
                return !e.deletedDialog
            }).map(function(e) {
                return e.peerId
            }).map(Wt.convertPeerToUrl).join("_")
        }), t && sn()), Promise.resolve(n)
    }

    function ut(e) {
        return e.peer ? fe(e.peer, e) ? le(e.peer, e) : Object(Wt.isFullyLoadedTab)(e, e.peer) ? e.tabs[e.peer].allShown : !1 : !0
    }

    function dt(e, t) {
        var n = t.tabs[e];
        return Object(Wt.isFullyLoadedTab)(t, e) && (n.skipped = null, n.msgs = null, n.offset = null, n.allShown = null, n.history = null), Promise.resolve(t)
    }

    function lt(e, t) {
        var n = t.tabs[e];
        return Object(Wt.isFullyLoadedTab)(t, e) && (n.history = l(n.history)), Promise.resolve(t)
    }
    ...
    function ht(e, t, n) {
        if (!Object(Wt.isCommunityPeer)(t)) return Promise.resolve(n);
        var r = Object(Kt.getTab)(n, t);
        return r.blocked_community = !e, Object(Dt.post)(Dt.CONTROLLER, {
    ...
    function pt(e, t) {
        if (0 !== t.peer && Object(Wt.isFullyLoadedTab)(t, t.peer)) {
            var n = Object(Kt.getTab)(t, t.peer);
    ...
    function Ct(e) {
        return "undefined" == typeof e.chatResizeInitialized && (e.chatResizeInitialized = !0, Object(Wt.getClassicChatHeight)() > window.clientHeight() && Object(Wt.setClassicChatHeight)(0)), Promise.resolve(e)
    }
    ...
    function kt(e, t) {
        var n = Object(zt.arrayUnique)([e].concat(t.select(Ut.RECENT_SEARCH_OP))).slice(0, 500);
    ...
    function xt(e, t, n, i) {
        var a = Object(Kt.getMessage)(e, n, t),
            o = a.userId;
        return Object(Qt.oCacheGet)(i, o) ? Promise.resolve(i) : Fe(r({}, n, [o]), i)
    }
    ...
    function At(e, t, n) {
        return n.tabs[e].keyboard = t && t.buttons ? t : null, Mt(e, !1, n)
    }

    function Mt(e, t, n) {
        return ((n.tabs || {})[e] || {}).keyboard && (n.tabs[e].keyboard.hide = t), Promise.resolve(n)
    }

    function Rt(e, t, n, r) {
        var i = r.tabs[e];
        return i.caccess[t] = n, Object(Dt.post)(Dt.CONTROLLER, {
    ...
    n.r(t), n.d(t, "TYPING_PERIOD", function() {
        ...
        return Lt
    }), n.d(t, "setCurrentKeyboard", function() {
        return At
    ...
    var Dt = n(31),
        ...
        nn = 2e4,
        rn = 8,
        an = Object(Bt.updateLazyLocation)(),
        on = an.scheduleNav,
        sn = an.commitNav,
        cn = an.scheduleNavWithTimeOut,
        un = {
            settings: 0,
            block: 1,
            fav: 1,
        ...
        dn = u(function(e, t) {
            var n = t.tabs[e],
                r = Object.keys(n.msgs).map(function(n) {
                    return Object(Kt.getMessage)(t, e, n)
                }).filter(function(e) {
                    return !Object(Vt.isOut)(e)
                }).map(function(e) {
                    return e.messageId
                }).sort(function(e, t) {
                    return t - e
            ...
            return n.skipped > 0 && (r = r.filter(function(e) {
            ...
            })), r = intval(r.shift()), r <= n.in_up_to ? Promise.resolve(t) : (t.longpoll.push([Ht.readInboundEvent([6, e, r])]), Object(Dt.post)(Dt.CONTROLLER, {
                peer: e,
                ids: [r],
                hash: n.hash,
                act: "a_mark_read",
                ...
                return T(t, e, r, Ht.FLAG_OUTBOUND)
            }))
        }),
        ln = function(e, t, n, r) {
            var i = Date.now() + rand(0, 100).toFixed(0);
            return Object(qt.retryFn)(Dt.post, 1)(Dt.CONTROLLER, Object.assign({
                act: "a_send",
                to: e,
                hash: n.hash,
                msg: t.message,
        ...
        gn = u(function(e, t) {
            return Object(Dt.post)(Dt.CONTROLLER, {
                ...
                return a.forEach(function(e) {
                    return Object(Qt.oCacheAdd)(t, e)
                }), Object(Wt.normalizeTabsGotFromServer)(t, i), e === t.searchText && (t.searchOffset = s, t.searchAllLoaded = c), Object.keys(i).filter(function(e) {
                    return !t.tabs[e]
                }).forEach(function(e) {
                    t.tabs[e] = i[e]
                }), [i, o]
        ...
        vn = u(function(e, t) {
            ...
            return on({
                st: n.searchText
            }), sn(), Object(Dt.post)(Dt.CONTROLLER, {
                act: "a_search",
                q: i,
                from: "in",
                gid: t.gid,
        ...
        Cn = u(function(e, t) {
            return t.tabs[e].lastTyping = Date.now(), Object(Dt.post)(Dt.CONTROLLER, {
                act: "a_typing",
                peer: e,
                gid: t.gid,
                hash: t.tabs[e].hash
        ...
        yn = u(function(e, t) {
            return Te(e, Object(Dt.post)("al_im.php", {
                act: "a_flush_history",
                id: e,
                from: "im",
                gid: t.gid,
        ...
        Tn = u(function(e, t) {
            return e.kludges.source_act === Wt.CHAT_PHOTO_REMOVE ? (delete t.tabs[e.peerId].photo, delete t.tabs[e.peerId].photoLarge, Promise.resolve(t)) : Object(Dt.post)(Dt.CONTROLLER, {
                ...
                if (t.tabs[e.peerId].photo = i[0], t.tabs[e.peerId].photoLarge = i[1], Object(Wt.isFullyLoadedTab)(t, e.peerId)) {
                    var s = e.kludges.source_act;
                    o.history = Object(Wt.addChatPhotoToUpdate)(e, s, t, d(o.history))
                }
                return t
            })
        }),
        On = u(function(e, t) {
            return Object(Dt.post)(Dt.CONTROLLER, {
                ...
                gid: t.gid,
                hash: t.tabs[e].hash
            }).then(xe.bind(null, Wt.CHAT_KICK_USER, vk.id, e, t))
        }),
        Fn = u(function(e, t) {
            return Object(Dt.post)(Dt.CONTROLLER, {
                ...
                gid: t.gid,
                hash: t.tabs[e].hash
            }).then(xe.bind(null, Wt.CHAT_INVITE_USER, vk.id, e, t))
        }),
        En = u(function(e, t, n) {
            return Object(Dt.post)(Dt.CONTROLLER, {
                act: "a_mute",
            ...
            }).then(je.bind(null, e, t))
        }),
        Sn = u(function(e, t, n, r) {
            return Le(e, n, t, r), Object(Dt.post)(Dt.CONTROLLER, {
        ...
        xn = u(function(e, t, n, r) {
            return r.creating = !0, r.longpoll.pause(), Object(Dt.post)(Dt.CONTROLLER, {
                act: "a_multi_start",
                hash: r.writeHash,
                peers: t.join(","),
                title: n
        ...
        jn = u(function(e, t) {
            var n = Gt.FOLDER_MASKS[Gt.FOLDER_IMPORTANT],
                r = t.tabs[e].folders & n,
                i = r ? Ht.resetDirectoriesEvent : Ht.setDirectoriesEvent;
            return t.longpoll.push([i([0, e, n, !0])]), Object(Dt.post)(Dt.CONTROLLER, {
                act: "a_dialog_star",
                val: r ? 0 : 1,
                peer: e,
                hash: t.tabs[e].hash,
        ...
        In = u(function(e, t, n) {
            ...
            return n.longpoll.push([Ht.resetDirectoriesEvent([0, e, r, !0]), Ht.readInboundEvent([6, e, t])]), Object(Dt.post)(Dt.CONTROLLER, {
                act: "a_mark_answered",
                peer: e,
                lastmsg: t,
                hash: n.tabs[e].hash,
        ...
        Ln = u(function(e, t) {
            ...
            }), t.tabs[e].deletedDialog = !0, Object(Dt.post)(Dt.CONTROLLER, {
                act: "a_delete_dialog",
                peer: e,
                gid: t.gid,
                hash: t.tabs[e].hash
        ...
        An = u(function(e, t, n) {
            return Object(Dt.post)(Dt.CONTROLLER, {
                ...
                var t = en(e, 4),
                    ...
                    o = t[3];
                return a.forEach(function(e) {
                    return Object(Qt.oCacheAdd)(n, e)
        ...
        Rn = u(function(e, t, n) {
            var r = n.tabs[t];
            return r.data.kicked || r.data.closed ? Promise.resolve(n) : Object(Dt.post)(Dt.CONTROLLER, {
                act: "a_pin_message",
                msgid: e,
                chat: t,
                gid: n.gid,
        ...
        Pn = u(function(e, t) {
            var n = t.tabs[e];
            return n.data.kicked || n.data.closed ? Promise.resolve(t) : Object(Dt.post)(Dt.CONTROLLER, {
                act: "a_unpin_message",
                chat: e,
                gid: t.gid,
                hash: t.tabs[e].hash
        ...
        Hn = u(function(e, t) {
            ...
            return Object(Dt.post)(Dt.CONTROLLER, {
                ...
                var r = en(e, 1),
                    i = r[0];
                return n.photoGrid = i.grid, n.photoLarge = i.photo, n.membersLastSeen = i.lastSeen || null, n.inviters = i.inviters, n.caccess = i.caccess, n.invitedByMe = i.invitedByMe || [], n.inviteLink = i.link || null, n.serverSettings = i.serverSettings || null, t
            })
        }),
        qn = u(function(e, t, n) {
            var r = n.tabs[e];
        ...
        Gn = u(function(e, t) {
            return t.tabs[e].top_banner = void 0, Object(Dt.post)(Dt.CONTROLLER, {
                act: "a_hide_banner",
                peer_id: e,
                hash: t.tabs[e].hash
            }).then(function() {
    ...
    function l() {
        d() && (o().forEach(function(e) {
            ...
            !t && e.time < Date.now() - 1e3 && !e.warned && (e.warned = !0, i("red", "im not fc", e.ev), Object(p.isWeirdLogging)() && s("im not fc", e.ev))
        }), a().forEach(function(e) {
            var t = o().find(function(t) {
                return t.ev === e.ev
            });
            t && t.warned && !e.warned && (e.warned = !0, i("red", "now fc like im", e.ev), Object(p.isWeirdLogging)() && s("now fc like im", e.ev))
        })), u()
    }
    ...
    n.r(t), n(8), n(25), n(2), n(17), n(9), n(29), n(34), window.getWndInner = r, window.lastWndScroll = [!1, !1], window.updateWndVScroll = i, window.defBox = a;
    try {
    ...
    function s(e) {
        return e.map(function(e) {
            switch (e[0]) {
                ...
                case 18:
                    return p.replaceMessageEvent(e);
                case 51:
    ...
    var i, a = "\\w\\$А-Яа-яёЁєЄҐґЇїІіЈј",
        ...
        O = /\[(id|club)(\d+)(?:\:([a-z0-9_\-]+))?\|([^\$]+?)\]/g,
        F = /(^|[\s.,:\'\";>\)\(])(\*|@)([A-Za-z0-9_\.]{2,32})\s*\((.+?)\)/g,
        E = 38,
        S = 40,
        x = 33,
        j = 34,
        ...
        V = new RegExp("([a-zA-Zа-яА-Я\\-_\\.0-9\\+]+@(" + s + c + "))", "ig"),
        Q = new RegExp(b, "ig"),
        Y = "#",
    ...
    function r(e, t) {
        ...
        var n = vk.id == t.peerId && !Object(f.unpackStore)(e).gid;
    ...
    function o(e) {
        return e.flags & w.FLAG_OUTBOUND
    }
    ...
    function g(e) {
        return e.flags & w.FLAG_IMPORTANT
    }
    ...
    function b(e, t) {
        var n = Object(k.unpackStore)(e);
        return o(t) ? n.id : t.userId
    }
        ...
        for ("boolean" == typeof n && (a = n, n = t[1] || {}, r = 2), "object" === ("undefined" == typeof n ? "undefined" : H(n)) || c(n) || (n = {}); i > r; ++r)
            if (null != (e = t[r]))
                for (var o in e) {
                    var s = n[o],
                        u = e[o];
                    n !== u && (a && u && "object" === ("undefined" == typeof u ? "undefined" : H(u)) && !u.nodeType ? n[o] = j(a, s || (null != u.length ? [] : {}), u) : void 0 !== u && (n[o] = u));
                }
        return n
    }
    ...
    function A(e) {
        ...
        return O(n("input"), function(e, t) {
            return "radio" != t.type && "checkbox" != t.type || t.checked ? r(e, t) : void 0
        }), O(n("select"), r), O(n("textarea"), r), t
    }
    ...
    function D(e) {
        var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
            n = t.kLimit || 1e3,
            r = t.mLimit || 1e6;
        return e >= r && !t.noCheck ? (e = v(e / 1e5), e = e > 1e3 ? v(e / 10) : e / 10, D(e, j(t, {
            noCheck: !0
        }), !0) + "M") : e >= n && !t.noCheck ? (e = v(e / 100), e = e > 100 ? v(e / 10) : e / 10, D(e, j(t, {
            noCheck: !0
    ...
    function o(e, t, n, r) {
        var i = Object(y.unpackStore)(e),
            a = Object(C.getTab)(i, n || i.peer);
        return _(a, t) ? !1 : h(e, M, n, r)
    }
    ...
    function c(e, t, n, r) {
        var i = Object(y.unpackStore)(e);
        if (v(e, P)) return !0;
        var a = Object(C.getTab)(i, n || i.peer),
            o = h(e, I, n, r),
            s = p(a, N);
        return r = "undefined" == typeof r ? window.vk.id : r, _(a, t) ? !1 : s || _(a, r) || m(a, r) ? o : o && !m(a, t) && g(a, t)
    }
    ...
    function l(e, t, n) {
        return d(e, t, n) && !Object(w.isFvkcomgroup)(e, t)
    }

    function f(e, t, n) {
        if (!Object(C.isCommunityPeer)(n)) return !0;
        var r = Object(C.getTab)(e, t);
        return !!r.caccess[n]
    }
    ...
    function h(e, t, n, r) {
        ...
        var a = Object(C.getTab)(i, n),
            o = !a.data.kicked && !a.data.closed,
            s = R[t],
            c = Object(w.isFvkcomgroup)(e, n);
        if (c) switch (t) {
            case M:
            case j:
            case I:
    ...
    var b, C = n(6),
        ...
        E = 32,
        S = "see_invite_link",
        x = "change_invite_link",
        j = "invite_user",
        I = "kick_user",
        L = "pin_unpin",
        A = "change_title",
        M = "add_admin",
        R = (b = {}, r(b, S, E), r(b, x, E), r(b, M, F), r(b, j, k), r(b, I, N), r(b, L, T), r(b, A, O), b),
        P = 1
}, function(e, t, n) {
    "use strict";
