! function(e) {
    ...
    176: function(__webpack_module__, __webpack_exports__, __webpack_require__) {
        ...
        var _helpers_im_shared_helpers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(32),
            _longpoll_singleton__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(301),
                    ...
                    curNotifier.lpActive = !0, clearTimeout(curNotifier.lp_req_check_to), curNotifier.lp_req_check_to = setTimeout(onFail, 1e3 * (params.wait + 5)), curNotifier.lpMakeRequest(curNotifier.frame_url, params, function(text) {
                        if (!completed && (completed = !0, curNotifier.lpActive = !1, curNotifier.lp_started)) {
                            ...
                            try {
                                ...
                                busy ? ls.get(LC_SERVER_SWITCH_TO_ACTIVE_FLAG) ? ls.remove(LC_SERVER_SWITCH_TO_ACTIVE_FLAG) : this.lcNoServer() : (clearTimeout(curNotifier.lpCheckTO),
                                    curNotifier.lpCheckTO = setTimeout(this.lpCheck.bind(this), curNotifier.request_timeout || 1e3), curNotifier.error_timeout = Math.max(1, (curNotifier.error_timeout || 1) / 1.5))
                            } catch (e) {
    ...
    208: function(e, t, n) {
        ...
        function ut(e, t) {
            var n = t.tabs[e];
            return Object(Bt.isFullyLoadedTab)(t, e) && (n.skipped = null,
                n.msgs = null, n.offset = null, n.allShown = null, n.history = null), Promise.resolve(t)
        }
    ...
    96: function(e, t, n) {
        ...
        n.r(t), n(222), n(70), n(87), n(176), n(205), n(290), n(0), window.getWndInner = r, window.lastWndScroll = [!1, !1], window.updateWndVScroll = i, window.defBox = a;
        try {
