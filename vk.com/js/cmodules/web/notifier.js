! function(e) {
    ...
    132: function(e, t, i) {
        ...
        function ye(e, t, i, a) {
            if ((0, Gt.isFullyLoadedTab)(a, t)) {
                var r = a.tabs[t];
                r.deleted = r.deleted ? r.deleted.concat(e) : e, r.history = (0, Gt.removeMessagesWithRestore)(e, t, i, u(r.history)),
                    r.offset -= e.filter(function(e) {
                        return r.msgs[e]
                    }).length
            }
            return Promise.resolve(a)
    ...
    194: function(e, t, i) {
        ...
        i(24), i(41), i(78), i(214), i(150), i(176), i(141), window.getWndInner = a, window.lastWndScroll = [!1, !1], window.updateWndVScroll = r, window.defBox = n;
        try {
    ...
    214: function(module, exports, __webpack_require__) {
        "use strict";
        var _im_shared_helpers = __webpack_require__(128),
            _longpoll_singleton = __webpack_require__(4),
