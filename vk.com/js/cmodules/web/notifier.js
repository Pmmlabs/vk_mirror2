! function(e) {
    ...
    14: function(e, t, n) {
        ...
        function s(e) {
            ...
            return s || (Object(P.imWeirdLog)("empty_other_kludges", [n, r, i, a, o, s, c, u, d, l]), s = {}), {
                ...
                kludges: f,
                randomId: intval(u),
                userId: Object(M.isChatPeer)(i) ? intval(f.from) : intval(i),
                update_time: l,
                chat_local_id: d
            }
        }
            ...
            gotPeers: function(e) {
                r() || each(curFastChat.needPeers, function(t) {
                    if (e[t]) {
                        ...
                        var n = this[1],
                            r = this[3];
                        2 & this[0] && void 0 === e[t].history || (clearTimeout(this[2]), delete curFastChat.needPeers[t]), curFastChat.tabs[t] ? FastChat.gotHistory(t, e[t].history) : r.fixedLoad ? FastChat.addTabIcon(t, e[t]) : (FastChat.addTabIcon(t, e[t]), FastChat.addBox(t, e[t], r),
                            n ? (curFastChat.tabs[t].auto = 1, FastChat.imFeed(t, n)) : (2 & this[0] && FastChat.gotHistory(t, e[t].history), r && r.nofocus || FastChat.activateTab(t))), r.onHistoryLoaded && r.onHistoryLoaded()
                    }
                })
            },
    ...
    194: function(__webpack_module__, __webpack_exports__, __webpack_require__) {
        "use strict";
        __webpack_require__.r(__webpack_exports__);
        var _helpers_im_shared_helpers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(208),
            _longpoll_singleton__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(53),
    ...
    69: function(e, t, n) {
        ...
        n.r(t);
        n(169), n(4), n(164), n(194), n(165), n(204), n(84);
