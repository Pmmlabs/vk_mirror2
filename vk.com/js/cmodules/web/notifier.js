! function(e) {
    ...
    i(13), i(9), i(33), i(29), i(12), i(1), i(22), window.getWndInner = a, window.lastWndScroll = [!1, !1], window.updateWndVScroll = r, window.defBox = n;
    try {
    ...
    extend(a.prototype, EventEmitter.prototype), extend(a.prototype, {
        ...
        start: function() {
            this.started = !0, browser.mobile || (this.opts.parentManager && this.opts.parentManager.on("idle", this.cbInactiveB),
                addEvent(this.opts.focusElement, "focus", this.cbActiveB), addEvent(this.opts.focusElement, "blur", this.cbInactiveB), clearTimeout(this.checkIdleCbTo), this.checkIdleCb(), this.checkIdleCbTo = setTimeout(this.checkIdleCb.bind(this), this.opts.idleTimeout))
        },
    ...
    "use strict";
    var _im_shared_helpers = __webpack_require__(24),
        _longpoll_singleton = __webpack_require__(35),
    ...
    function c() {
        window.lpConnect = C = (0, p.createLongPoll)(b.lpConfig, s)
    }
    ...
    function l() {
        return a() ? (y || (c(), u(), window.curNotifier.idle_manager.on("unidle", function() {
            C.abortWaiting()
        }), (0, g.imWeirdLog)("fc_longpoll_init", {}, !1)), y) : null
    }

    function d() {
        a() && ((0, _.lpLogFc)("orange", "init longpoll connection on load"), b.lpConfig.id = b.id, l(), f())
    }
