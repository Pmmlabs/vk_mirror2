! function(e) {
    ...
    173: function(e, t, n) {
        ...
        var z, W = a((z = null, [function(e) {
                return z || (z = Object(r.se)("<span> </span>")), z.innerText = e, z.innerHTML
            }, function(e) {
                return z || (z = Object(r.se)("<span> </span>")), z.innerHTML = e.replace(/<br\s*\/?>/gim, "\n"), z.innerText
            }]), 2),
            G = W[0],
            K = W[1];
    ...
    181: function(__webpack_module__, __webpack_exports__, __webpack_require__) {
        ...
        var _helpers_im_shared_helpers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(38),
            _longpoll_singleton__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(409),
            _lib_debug_tools__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(16),
    ...
    206: function(e, t, n) {
        "use strict";
        n.r(t);
        n(287), n(58), n(63), n(181), n(368), n(5), n(404);
    ...
    378: function(e, t, n) {
        ...
        function ot(e, t) {
            ...
            t.local && a && n.push("im-mess_sending"), t.local && n.push("" + C), t.local && Object(s.wasEdited)(t) && !r && n.push("im-mess_unread im-mess_nobg"), t.failed && n.push("im-mess_failed " + k), Object(s.isGift)(t) && n.push("im-mess_gift");
            var d = st(t),
                f = function(e, t) {
                    var n = "",
                    ...
                    if (Object(o.isCommunityInterface)(e) && r) {
                        var i = t.kludges.ref_source,
                            a = {};
                        try {
                            (a = JSON.parse(Object(v.unclean)(i))).link && a.info && (a.link = Object(c.replaceHyperLinks)(Object(v.clean)(a.link), c.linksReplacer.bind(null, !1)), a = Object(v.clean)(langStr(ve("mail_source_info"), "link", a.link, "info", Object(v.clean)(a.info))), n += ge("sImLblWasSourceInfo", {
                                source: a
                            }))
                        } catch (e) {}
                    }
            ...
            "" != _ && (_ += f), t.subject && "..." !== t.subject.trim() && !Object(u.isChatPeer)(t.peerId) && (_ = ge("im_topic", {
                topic: t.subject
            }) + _);
            var p = ge("im_message_media", {
                ...
                messageId: t.messageId,
                attaches: d.join(""),
                text: Object(s.isGift)(t) ? '<div class="im-mess--gift-lbl">' + _ + "</div>" : ""
            });
            return Object(s.isGift)(t) || (p = _ + p), "" == _ && (p += f), ge("im_msg_row", {
                msg_id: t.messageId,
                from_id: t.peerId,
                text: p,
        ...
        function dt(e, t, n) {
            ...
            if (!p || wt(c, p, t, e, i)) {
                var b = "",
                    y = !1;
                if (m && Object(s.isOut)(t) && In(e, n, t.peerId), 1 === c.unread && !Object(s.isOut)(t) && i && (b += ge("im_mess_bar", {}), y = !0, In(e, n, t.peerId)), !Oe(new Date(v))) {
                    var w = new Date,
                ...
                if (Object(s.isServiceMsg)(t)) b += ge("im_service_row", {
                    text: Xt(e, t, c),
                    type: "",
                    date: t.date,
                    from_id: "",
                ...
                else if (Object(s.isCallMessage)(t)) b += ge("im_service_row", {
                    text: Qt("", ut(t, !1, e), ""),
                    type: "",
                    date: t.date,
                    from_id: "",
                    ...
                    if (Object(s.isMoney)(t)) {
                        var I = Object(s.isMoneyRequest)(t) ? ve("mail_money_request_message_sent", "raw") : ve("mail_money_tranfer_message_sent", "raw");
                        S += ' <span class="im-mess-stack--money-transfer">' + be(E.sex || 0, I) + "</span>"
                    }
                    var x = e.gid ? "/gim" + e.gid : "/im",
                        F = void 0;
                    if (F = t.local ? Ct(t.date, e.timeshift) : ge("im_stack_date", {
                            date: Ct(t.date, e.timeshift),
                            link: x + "?sel=" + t.peerId + "&msgid=" + t.messageId
                        }), T && e.admins[T]) {
                        var A = e.admins[T],
                            M = T === G.id ? ve("mail_by_you") : A[0];
                        F = F + " " + ge("im_admin_link", {
                            name: M,
                            href: A[1]
                        })
                    }
                ...
                Object(l.toArray)(X(b)).forEach(function(e) {
                    return n && n.appendChild(e)
                })
            } else m && e.peer === t.peerId && !c.inplaceSearch && Object(s.isOut)(t) && In(e, n, t.peerId), ce("_im_stack_messages", h).appendChild(V(_));
            return Object(s.isOut)(t) && !a && setTimeout(function() {
                var e = ce("_im_mess_" + t.messageId, n);
                _e(e, C) && de(e, "im-mess_sending")
        ...
        function ft(e, t, n) {
            var r = e.tabs[t];
            return Object(l.toArray)(se("_im_mess_unread", n)).forEach(function(e) {
        ...
        function wt(e, t, n, r, i) {
            ...
            var a = yt(t.date, r),
                c = yt(n.date, r);
            return !Ee(a, c) || (!(!Object(o.isCommunityInterface)(r) || J(t.kludges.from_admin) === J(n.kludges.from_admin)) || (n.date - t.date > 300 || (!(!Object(s.isServiceMsg)(t) && !Object(s.isServiceMsg)(n)) || (!(!Object(s.isCallMessage)(n) && !Object(s.isCallMessage)(t)) || (!(!Object(s.isGift)(t) && !Object(s.isGift)(n)) || (!(!Object(s.isGraffiti)(t) && !Object(s.isGraffiti)(n)) || (!!Object(s.hasReply)(n) || !(Object(s.isUnread)(e, t) === Object(s.isUnread)(e, n) || !i || Object(s.isOut)(n) || Zt(n.peerId, r.gid)))))))))
        }
        ...
        function Rt(e, t, n) {
            ...
            if (r) {
                he(r, "aria-hidden", "false"), de(r, "im-mess_failed " + k);
        ...
        function Bt(e, t, n) {
            ...
            if (r) {
                le(r, "im-mess_failed"), he(r, "aria-hidden", "true"), le(r, k);
                var i = ce("_im_mess_marker", r);
        ...
        function Vt(e, t, n, r, i, a) {
            ...
            var c = Object(u.isUserPeer)(t) || Object(o.isCommunityPeer)(t) ? "first_name" : i ? "short_name" : "name",
                d = Kt(e),
                l = "";
            ...
            var _ = s.slice(0, Math.min(s.length - 1, a)),
                h = _.map(function(e) {
            ...
            if (s.length > a + 1) {
                ...
                h += " " + ve("mail_and_peer").replace("{count}", m - a).replace("{typing}", l)
            } else {
                if (s.length > 1 && (h += " " + ve("mail_and_peer_one")), !Object(u.isChatPeer)(t) && n) h += " " + l;
                else h += " " + Object(f.oCacheGet)(r, s[_.length])[c] + " " + l
            }
            return h.trim()
        }
        ...
        function Xt(e, t, n) {
            ...
            if (u = (u = be(c.sex, ve(u, "raw"))).replace("{from}", Qt(c.link, c.name, r)), o && o !== s) {
                var l = i.source_email;
                if (l) u = u.replace("{user}", Qt("/im?email=" + encodeURIComponent(l), "email", r));
                else {
                    var _ = Object(f.oCacheGet)(e, o),
                        h = a === I ? _.inv_name : _.kick_name;
                    u = u.replace("{user}", Qt(_.link, h, r))
                }
            }
            if (i.source_text) {
            ...
            if (i.source_act === A || i.source_act === M)
                if (i.source_message) {
                    var m = Qt("", Jt(Pe.emojiToHTML(ee(i.source_message.replace(/<br\s?\/?>/gi, " ")), !0)), !1, "im_srv_mess_link");
                    u = u.replace("{msg}", m)
        ...
        function on(e, t, n) {
            var r = ve("mail_deleteall1"),
                ...
                a = ve("mail_delete");
            return Object(u.isChatPeer)(t) && (Object(g.doesChatTabHaveFlag)(e, 1024) ? (r = ve("mail_leave_channel"), i = ve("mail_unfollow_channel_confirmation"), a = ve("mail_unfollow_channel")) : i = ve("mail_chat_sure_to_delete_all")), Object(o.isCommunityPeer)(t) && (i = ve("mail_group_sure_to_delete_all")), je(r, i, a, n, ve("global_cancel"))
        }
        ...
        function sn(e, t, n) {
            ...
            if (i) {
                ...
                a ? (s = ve("mail_leave_channel"), c = ve("mail_vkcomgroup_leave_confirm"), d = ve("mail_leave_channel")) : (s = ve("mail_leave_chat"), c = ve("mail_chat_leave_confirm"), d = ve("mail_leave_chat"))
            }
            Object(o.isCommunityPeer)(t) && (c = ve("mail_group_sure_to_delete_all"));
        ...
        function wn(e, t) {
            return Cn(e.get(), t, Object(o.getTab)(e, t).last_seen)
        }

        function Cn(e, t, n, r) {
            if (n[0]) return ve("mail_header_online_status") + (Fe[n[0]] ? kn(t, !1, !1, !0) : "");
            if (!n[1]) return "";
            var i = Ce(n[1], e.timeshift),
                a = be(Object(f.oCacheGet)(e, t).sex, ve("mail_last_activity_tip", "raw")).replace("{user}", "").replace("{time}", i);
        ...
        function xn(e, t, n) {
            ...
            var s = _e(i, "_im_mess_srv") ? i : ue("_im_mess_stack", i);
            if (!s) return [!0, 0];
        ...
        function Ln(e, t, n, r, i) {
            return n = n.replace(/\<br\s*\/?\>(\n)?/gi, " ").replace(/[\n\r]/gi, " "), n = Object(c.replaceMentions)(n, function(e, t, n, r, i) {
                return i
            }), r && (n = Pe.emojiToHTML(n, !0)), t && "..." !== t.trim() && !Object(u.isChatPeer)(e) && (n = ge("im_topic", {
                topic: t,
                cls: "im-topic_dialog"
        ...
        function sr(e, t, n, i) {
            i && !$e(e, n, i) && (Object(o.getMessage)(e, n, i) ? (e.setState({
                msgid: i
    ...
    404: function(__webpack_module__, __webpack_exports__, __webpack_require__) {
        "use strict";
        __webpack_require__.r(__webpack_exports__);
        var _lib_debug_tools__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(16);
        window.TopNotifierCur || (window.TopNotifierCur = {
            ...
            apiCallProcess: function(e, t, n, r) {
                return !isButtonLocked(r) && (ajax.post("/al_feed.php", {
                    act: "a_api_call",
                    hash: cur.topNotifyHash,
                    query: e
                }, {
                    onDone: function(e) {
                        var i = domPN(r);
                        val(i, '<div class="feedback_apicallText">' + (n ? '<div class="feedback_apicallIcon ' + n + 'Icon"></div>' : "") + t + "</div>")
                    },
                    onFail: function(e) {
                        if (e) return setTimeout(showFastBox(getLang("global_error"), e).hide, 3e3), !0
                    },
