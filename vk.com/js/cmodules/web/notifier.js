! function(e) {
        ...
        window.curNotifier || (window.curNotifier = {
            ...
            lpCheck: function lpCheck() {
                if (curNotifier.lp_started && !curNotifier.lpActive && !curNotifier.lpInvalid) {
                    ...
                    if (!Notifier.lcCheckServer()) return Notifier.debug && debugLog("no server from check"),
                        void this.lcNoServer();
                    var now = vkNow(),
                        add_queues = [],
                        completed = !1,
                        params = {
        ...
        function p(e, t) {
            ...
            if (s.length > 55 && (s = s.substr(0, 53) + ".."), s = C(s).replace(/&amp;/g, "&"), !e && r.match(v.OUR_DOMAINS)) {
                ...
                var c = a,
                    ...
                    u = "",
                    d = void 0;
                return l >= 0 ? c = a.substr(l + 1) : (l = a.indexOf("#!"), l >= 0 && (c = "/" + a.substr(l + 2).replace(/^\//, ""))), d = c.match(v.VK_DOMAIN), d && d[1].length < 32 && (u = ' mention_id="' + d[1] + '" onclick="return mentionClick(this, event)" onmouseover="mentionOver(this)"'),
                    '<a href="' + m(i + a + o) + '" target="_blank"' + u + ">" + s + "</a>"
            }
    ...
    139: function(e, t, i) {
        ...
        i(24), i(45), i(32), i(28), i(142), i(11), i(81), window.getWndInner = a, window.lastWndScroll = [!1, !1], window.updateWndVScroll = o, window.defBox = r;
        try {
                    ...
                    switch (o[1]) {
                        ...
                        case "typing":
                            e > 2e9 ? (curFastChat.typingEvents[e] || (curFastChat.typingEvents[e] = {}),
                                curFastChat.typingEvents[e][o[3]] = a) : curFastChat.typingEvents[e] = a, FastChat.updateTyping(e);
                            break;
                        case "edit":
                            var c = i.msgs[o[3]];
