! function(e) {
    ...
    126: function(e, t, n) {
        ...
        function ae(e, t) {
            ...
            return e.forEach(function(e) {
                ...
                In(Cn(e), "_im_bar_date") && fn(Cn(e)),
                    In(Cn(e), "_im_unread_bar_row") && fn(Cn(e)), fn(e)
            }), t
        }
    ...
    195: function(e, t, n) {
        ...
        n.r(t), n(37), n(0), n(51), n(220), n(246), n(225), n(46), window.getWndInner = r, window.lastWndScroll = [!1, !1], window.updateWndVScroll = i, window.defBox = a;
        try {
    ...
    220: function(__webpack_module__, __webpack_exports__, __webpack_require__) {
        ...
        var _helpers_im_shared_helpers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(80),
            _longpoll_singleton__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(135),
                        ...
                        if (!completed && (completed = !0, curNotifier.lpActive = !1, curNotifier.lp_started)) {
                            ...
                            try {
                                ...
                                text && -1 == text.indexOf("Ad Muncher") && (topError("Notifier error: " + e.message, {
                                    ...
                                    }), debugLog(e.message, e.stack, e)), curNotifier.error_timeout = curNotifier.error_timeout || 1,
                                    clearTimeout(curNotifier.lp_error_to), curNotifier.lp_error_to = setTimeout(this.lpCheck.bind(this), 1e3 * curNotifier.error_timeout), curNotifier.error_timeout < 64 && (curNotifier.error_timeout *= 2)
                            }
                        }
                    }.bind(this), onFail)
                }
        ...
        function nt(e, t, n, r, i) {
            if (Object(Ht.isTabLoaded)(i, e)) {
                ...
                return n === Rt.REPLACE_DIRECTORIES && (t ^= a.folders), Ze(n, t, a) && Object.keys(qt.FOLDER_MASKS).filter(function(e) {
                    ...
                    }), n === Rt.SET_DIRECTORIES ? i.tabs[e].folders |= t : n === Rt.RESET_DIRECTORIES ? i.tabs[e].folders &= ~t : i.tabs[e].folders = t ^= a.folders,
                    x(i, i.tabs[e], !0, function(t, n) {
