    ...
    467: function(t, e, n) {
        (function(i, r) {
            ...
            (function() {
                ...
                function R(t, e) {
                    e._state === at ? C(t, e._result) : e._state === ct ? O(t, e._result) : k(e, void 0, function(e) {
                        E(t, e)
                    }, function(e) {
                        O(t, e)
                    })
                ...
                function S(t, e, n) {
                    e.constructor === t.constructor && n === rt && constructor.resolve === ot ? R(t, e) : n === ut ? O(t, ut.error) : void 0 === n ? C(t, e) : a(n) ? A(t, e, n) : C(t, e)
                }

                function E(t, e) {
                    t === e ? O(t, w()) : s(e) ? S(t, e, x(e)) : C(t, e)
                }
                ...
                function q(t, e, n, i) {
                    var r, o, s, c, u = a(n);
                    if (u) {
                        if (r = D(n, i), r === ht ? (c = !0, o = r.error, r = null) : s = !0, e === r) return void O(e, b())
                    } else r = i, s = !0;
                    e._state !== st || (u && s ? E(e, r) : c ? O(e, o) : t === at ? C(e, r) : t === ct && O(e, r))
                }
                ...
                function W(t) {
                    ...
                    var i = this,
                        r = new i(y);
                    if (!J(t)) return O(r, new TypeError("You must pass an array to race.")), r;
                    for (var o = t.length, s = 0; r._state === st && o > s; s++) k(i.resolve(t[s]), void 0, e, n);
                    return r
                }
                ...
                function U(t, e) {
                    this._instanceConstructor = t, this.promise = new t(y), Array.isArray(e) ? (this._input = e, this.length = e.length, this._remaining = e.length, this._result = new Array(this.length), 0 === this.length ? C(this.promise, this._result) : (this.length = this.length || 0, this._enumerate(), 0 === this._remaining && C(this.promise, this._result))) : O(this.promise, this._validationError())
                }
                ...
                var rt = v,
                    ...
                    dt = 0,
                    mt = F;
                F.all = ft, F.race = pt, F.resolve = ot, F.reject = lt, F._setScheduler = c, F._setAsap = u, F._asap = X, F.prototype = {
                    constructor: F,
                    then: rt,
                    "catch": function(t) {
                ...
                U.prototype._validationError = function() {
                    ...
                    var i = this.promise;
                    i._state === st && (this._remaining--, t === ct ? O(i, n) : this._result[e] = n), 0 === this._remaining && C(i, this._result)
        ...
        var r = {
            ...
            o = function() {
                ...
                return t.prototype._getOption = function(t) {
                    ...
                    for (var h = 0; s > h; ++h) {
                        for (var f = 0, p = Math.floor(h * c), l = 0; c > l; l++) f += a[p + l] / 256;
                        f /= Math.ceil(c), "HSL" == u && (this._ctx.fillStyle = "hsl( " + Math.round(360 * h / s) + ", " + (50 + 50 * f) + "%, 50%)"), this._ctx.fillRect(h * (e + n), o, n, -f * o)
                    }
