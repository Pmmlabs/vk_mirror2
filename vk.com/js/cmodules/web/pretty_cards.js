! function(t) {
    function e(e) {
        for (var s, a, n = e[0], l = e[1], d = e[2], c = 0, p = []; c < n.length; c++) a = n[c], i[a] && p.push(i[a][0]), i[a] = 0;
    ...
    "qf0/": function(t, e, r) {
        ...
        window.PrettyCardGallery = class {
            ...
            onContainerWheel(t) {
                if (!(vkNow() - this.lastWinOnScroll < 300)) {
                    ...
                    var e = this.cardsElements.length * this.CARD_WIDTH + Math.max(0, this.cardsElements.length - 1) * this.CARDS_MARGIN,
                        ...
                        i = this.cardsPos || 0;
                    isNumeric(r) && (i += r), this.cardsPos = Math.max(0, Math.min(i, e - this.wrapper.clientWidth)), Object(s.addClass)(this.wrapper, "pretty-cards__wrapper_transition_off"), setStyle(this.wrapper, "transform", "translateX(-" + this.cardsPos + "px)"), this.scrollPosition += Math.round(this.cardsPos / (this.CARD_WIDTH - this.CARDS_MARGIN)) - this.scrollPosition, this.scrollPosition = Math.max(0, this.scrollPosition), this.scrollPosition = Math.max(0, Math.min(this.cardsElements.length - this.VIEWPORT_CARDS, this.scrollPosition));
                    var o = e - this.wrapper.clientWidth - this.cardsPos - this.POST_PADDING,
                        a = this.cardsPos - this.POST_PADDING;
                    toggleClass(this.scrollerRight, "pretty-cards__scroller_hidden_right", o < 0), toggleClass(this.scrollerLeft, "pretty-cards__scroller_hidden_left", a < 0), Object(s.addClass)(this.scrollerProtector, "pretty-cards__scroller_position_right", 0), show(this.scrollerProtector)
                }
            }
                ...
                if (this.draggingCard && !this.blockDragging) {
                    ...
                    if (setStyle(this.draggingCard, {
                        ...
                        if (o !== this.lastDestinationCardIndex) {
                            ...
                            o > this.lastDestinationCardIndex ? o > a ? (this.wrapperTransitions(!0, this.cardsElements[o]), Object(s.addClass)(this.cardsElements[o], "pretty-card_dragging_left")) : o <= a && Object(s.removeClass)(this.cardsElements[this.lastDestinationCardIndex], "pretty-card_dragging_right") : o < this.lastDestinationCardIndex && (o >= a ? Object(s.removeClass)(this.cardsElements[this.lastDestinationCardIndex], "pretty-card_dragging_left") : o < a && (this.wrapperTransitions(!0, this.cardsElements[o]), Object(s.addClass)(this.cardsElements[o], "pretty-card_dragging_right"))), this.lastDestinationCardIndex = o
                        }
                    }
                }
            }
            ...
            onUrlChosen(t, e, r) {
                var i = t.btns.ok[0],
                    o = Object(s.geByClass1)("share_url_input", t.bodyNode),
                    a = val(o);
                lockButton(i), disable(o, !0), hide("share_url_error"), ajax.post("al_wall.php", {
                    ...
                    onFail: t => {
                        var e = "";
                        return t && t !== getLang("global_unknown_error") && (e = t + " "), Object(s.ge)("share_url_error").innerHTML = e + getLang("global_share_link_failed"), disable(o, !1), unlockButton(i), show("share_url_error"), elfocus(o), !0
                    }
                })
            }
            chooseUrl(t, e, r) {
                window.onShareChooseUrlBoxInit = () => {
                    var e = curBox(),
                        i = Object(s.geByClass1)("share_url_input", e.bodyNode);
            ...
            wrapperTransitions(t, e, r) {
                e && (t ? Object(s.addClass)(e, !0 === r ? "pretty-card_transitions_long" : "pretty-card_transitions_on") : (Object(s.removeClass)(e, "pretty-card_transitions_long"), Object(s.removeClass)(e, "pretty-card_transitions_on")))
            }
            addCard(t) {
                if (this.options.card_template_html && (!(this.cardsElements.length >= intval(this.options.cards_max)) || this.placeholderElement)) {
                    ...
                    this.wrapperTransitions(!1, r), Object(s.addClass)(r, "pretty-card_removing_yes"), this.cardsElements.splice(this.cardsElements.length - 1, 0, r), this.placeholderElement && (this.wrapperTransitions(!1, this.placeholderElement), this.wrapper.insertBefore(r, this.placeholderElement), Object(s.addClass)(this.placeholderElement, "pretty-card_adding_yes"), this.placeholderElement.offsetHeight), r.offsetHeight, this.wrapperTransitions(!0, this.placeholderElement), this.wrapperTransitions(!0, r), Object(s.removeClass)(r, "pretty-card_removing_yes"), this.placeholderElement && Object(s.removeClass)(this.placeholderElement, "pretty-card_adding_yes"), e ? setTimeout(() => {
                        ...
                        addEvent(t, "click", this.priceAdderClicked.bind(this, t)), addEvent(Object(s.geByClass1)("pretty-card__editor-button_type_remove", domNS(t)), "click", this.priceRemoverClicked.bind(this, t))
                    ...
                    var l = Object(s.geByClass1)("pretty-card__edit-button_action_remove", r);
                    addEvent(l, "click", () => {
                        ...
                        this.wrapperTransitions(!0, r), Object(s.addClass)(r, "pretty-card_removing_yes");
                        for (var i = e + 1; i < t; ++i) {
                            var o = this.cardsElements[i];
                            this.wrapperTransitions(!0, o), setTimeout(s.addClass.pbind(o, "pretty-card_adding_yes"), (i - e - 1) * this.TRANSFORM_ANIMATION_DELAY)
                        }
                        r.offsetHeight;
                        for (var a = e + 1; a < t; ++a) {
                        ...
                        this.cardsElements.splice(e, 1), this.scroll(0, !1), setTimeout(() => {
                            ...
                            for (var t = e; t < this.cardsElements.length; ++t) {
                                ...
                                this.wrapperTransitions(!1, i), Object(s.removeClass)(i, "pretty-card_adding_yes")
                            }
                        }, n)
                    }), addEvent(l, "mouseover", () => {
                        showTooltip(l, {
                    ...
                    }), addEvent(Object(s.geByClass1)("pretty-card__link-editor", r), "click", () => {
                        this.chooseUrl((t, e, s) => {
                            r.prettyCardAllowedButtons = e, this.setLink(r, t, s)
                        }, r.prettyCardLink, this.options.owner_id)
                    });
                    var d = Object(s.geByClass1)("pretty-card__button", r);
                    addEvent(d, "click", this.buttonEditorClicked.bind(this, d, r)), addEvent(d, "mouseover", Page.actionsDropdownUnhide), addEvent(d, "mouseout", Page.actionsDropdownHide.bind(this, this.buttonEditorDropdown)), addEvent(Object(s.geByClass1)("pretty-card__button-remove", d), "click", this.buttonRemoveClicked.bind(this, d)), this.initPhotoUploader(r), addEvent(r, "mousedown", this.onCardMouseDown.bind(this, r)), addEvent(geByTag1("body"), "mouseup", this.onCardMouseUp.bind(this, r))
                }
            }
            setLink(t, e, r) {
                var i = Object(s.geByClass1)("pretty-card__link-editor", t);
                i.innerHTML = r, t.prettyCardLink = e;
                var o = "tel:" === e.substr(0, 4);
                toggleClass(i, "pretty-card__link-editor_phone_yes", o)
            }
            initPhotoUploader(t) {
                var e = Object(s.geByClass1)("pretty-card__upload-photo-button", t),
                    r = Object(s.geByClass1)("pretty-card__edit-button_action_photo", t),
                    i = Object(s.geByClass1)("pretty-card__upload-progress", t),
            ...
            onPhotoUploadStart(t, e, r) {
                debugLog("Upload started"), Object(s.addClass)(t, "pretty-card__upload-progress_shown_yes"), showProgress(t, "", "inv")
            }
            onPhotoUploadError(t, e, r) {
                ...
                }, r), hideProgress(t), Object(s.removeClass)(t, "pretty-card__upload-progress_shown_yes"), Upload.embed(e)
            }
            onPhotoUploadComplete(t, e, r, i) {
                ...
                o && o.photo ? UploadPhotoTransform.getPhotoUrl(o, this.options.stored_photo_size_list, function(r) {
                    debugLog("Success uploading photo"), this.setPhoto(e, r), e.prettyCardPhoto = o.photo, hideProgress(t), Object(s.removeClass)(t, "pretty-card__upload-progress_shown_yes")
                }.bind(this), function() {
            ...
            setPhoto(t, e) {
                var r = Object(s.geByClass1)("pretty-card__photo", t),
                    i = Object(s.geByClass1)("pretty-card__photo-fader", t);
                setStyle(i, {
                    backgroundImage: "url(" + e + ")"
                }), hide(Object(s.geByClass1)("pretty-card__upload-photo-button", r)), Object(s.addClass)(i, "pretty-card__photo-fader_top_yes"), setTimeout(() => {
                    setStyle(r, {
                        backgroundImage: "url(" + e + ")"
                    }), Object(s.removeClass)(i, "pretty-card__photo-fader_top_yes"), Object(s.removeClass)(r, "pretty-card__photo_upload_yes")
                }, 200)
            }
            onCardMouseDown(t, e) {
            ...
            onCardMouseUp(t) {
                if (t === this.draggingCard) {
                    ...
                    }), Object(s.removeClass)(t, "pretty-card_dragging_yes"), setTimeout(() => {
                        Object(s.removeClass)(t, "pretty-card_ontop_yes");
                        var i = !0,
                            o = !1,
                            a = void 0;
                        try {
                            for (var n, l = this.cardsElements[Symbol.iterator](); !(i = (n = l.next()).done); i = !0) {
                                var d = n.value;
                                this.wrapperTransitions(!1, d), Object(s.removeClass)(d, "pretty-card_dragging_right"), Object(s.removeClass)(d, "pretty-card_dragging_left"), setStyle(d, {
                                    transform: ""
                                })
                            }
                        } catch (t) {
            ...
            setButtonRaw(t, e, r) {
                Object(s.removeClass)(t, "button_contour"), Object(s.addClass)(t, "button_bright_blue"), Object(s.geByClass1)("pretty-card__button-editor-label", t).innerHTML = r
            }
            setButton(t, e, r) {
                var s = r[e],
                    i = s[0],
            ...
            buttonRemoveClicked(t) {
                return Object(s.addClass)(t, "button_contour"), Object(s.removeClass)(t, "button_bright_blue"), Object(s.geByClass1)("pretty-card__button-editor-label", t).innerHTML = getLang("global_wall_pretty_cards_add_button"), Page.actionsDropdownHide(this.buttonEditorDropdown, 1), t.prettyCardButtonKey = "", !1
            }
            togglePrice(t, e) {
                toggleClass(t, "pretty-card__price_hidden_yes", !!e), toggleClass(domNS(t), "pretty-card__price-wrapper_hidden_yes", !e)
            }
            priceAdderClicked(t) {
                this.togglePrice(t, !0), elfocus(Object(s.geByClass1)("pretty-card__editor", domNS(t)))
            }
            ...
            priceInputChanged(t) {
                ...
                if ("" !== e) {
                    ...
                    var o = Object(s.geByClass1)("pretty-card__price-adder", gpeByClass("pretty-card__price-container", t));
                            ...
                            if (e(i), o) {
                                ...
                                if (a) {
                                    var n = this.cardsElements.indexOf(a) - this.scrollPosition,
                                        l = !1;
                                    n > this.VIEWPORT_CARDS - 1 ? (this.scroll(n - (this.VIEWPORT_CARDS - 1)), l = !0) : n < 0 && (this.scroll(n), l = !0);
                                    setTimeout(() => {
                                        Object(s.addClass)(a, "pretty-card_error_yes"), setTimeout(s.removeClass.pbind(a, "pretty-card_error_yes"), 1e3)
                                    }, l ? this.TRANSFORM_ANIMATION_DURATION + 300 : 300)
                                }
                            }
                            return !0
                        }
            ...
            getSendData() {
                ...
                try {
                    for (var a, n = this.cardsElements[Symbol.iterator](); !(r = (a = n.next()).done); r = !0) {
                        var l = a.value;
                        if (l !== this.placeholderElement) {
                            var d = Object(s.geByClass1)("pretty-card__price_actual", l),
                                h = val(d),
                                c = void 0;
                            hasClass(domPN(d), "pretty-card__price-wrapper_hidden_yes") ? c = this.options.price_unshown : "" === (c = h.replace(/\D+/g, "")) && h && (c = "0");
                            var p = Object(s.geByClass1)("pretty-card__price_old", l),
                                _ = val(p),
                                g = void 0;
                            hasClass(domPN(p), "pretty-card__price-wrapper_hidden_yes") ? g = this.options.price_unshown : "" === (g = _.replace(/\D+/g, "")) && _ && (g = "0");
                            var u = Object(s.geByClass1)("pretty-card__button", l),
                                y = l.prettyCardId,
                                C = {
                                    id: y,
                                    title: val(Object(s.geByClass1)("pretty-card__title", l)),
                                    price: c,
                                    price_old: g,
                                    button: u.prettyCardButtonKey ? u.prettyCardButtonKey : "",
                                    link: l.prettyCardLink,
                                    photo: l.prettyCardPhoto
                                };
                            e.push(y), t.push(C)
                        }
                    }
