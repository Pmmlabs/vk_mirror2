! function(e) {
    ...
    151: function(e, t, n) {
        ...
        window.parseLatin = i, window.parseCyr = a, window.parseLatKeys = u, window.langNumeric = c, window.langSex = l, window.langStr = d, window.addLangKeys = s, window.getLang = f, window.langDate = w, window.getShortDate = p, window.getShortDateOrTime = h, window.langWordNumeric = v, window.getDateText = g, window.getBigDateNew = m, window.getSmDate = y
    },
    301: function(e, t, n) {
        "use strict";
        ...
        var g, m, y, b, O = (g = document, m = g.createDocumentFragment(), y = g.createElement("div"), b = g.createRange && g.createRange(), m.appendChild(y), b && b.selectNodeContents(y), b && b.createContextualFragment ? function(e) {
        ...
        function $(e, t) {
            for (var n = e = i(e), r = void 0, o = void 0, a = void 0, u = !1; n && n.tagName && n !== bodyNode;) {
                if (r = he(n, "position"), o = he(n, "overflow"), a = he(n, "transform"), t && browser.mozilla) {
