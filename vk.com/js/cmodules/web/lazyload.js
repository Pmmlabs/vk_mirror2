! function(e) {
    ...
    107: function(e, t, n) {
        ...
        (function(e, o, i) {
            (function() {
                ...
                function W(e) {
                    this._id = pe++, this._state = void 0, this._result = void 0, this._subscribers = [], g !== e && ("function" != typeof e && I(), this instanceof W ? R(this, e) : U())
                }
    ...
    154: function(e, t, n) {
        ...
        function L(e, t) {
            do e = T(e); while (e && !z(e, t));
            return e
        }

        function M(e, t, n) {
            for (var r = null; null === r && e;) e = -1 === n ? x(e) : C(e), e && z(e, t) && (r = e);
            return r
        }
        ...
        function I(e, t) {
            e = r(e);
            for (var n, o, i, a, u = e; u && u.tagName && u !== bodyNode && (n = se(u, "position"), o = se(u, "overflow"), i = se(u, "transform"), !t || !browser.mozilla || "page_wrap" == u.id || u === e || "visible" === o || ("static" === n ? a && "relative" !== a : "fixed" === a));) "none" !== i ? a = void 0 : "static" !== n && "fixed" !== a && (a = n), u = T(u);
            return u
        }
        ...
        window.cf = function(e) {
            ...
            return "transform"
        }(), window.vkExpand = window.vkExpand || "VK" + (0, xe.vkNow)(), window.vkUUID = window.vkUUID || 0, window.vkCache = window.vkCache || {}, window.ge = r, window.geByTag = o, window.geByTag1 = i, window.geByClass = a, window.geByClass1 = u, window.gpeByClass = s, window.domQuery = l, window.domQuery1 = c, window.domClosest = d, window.ce = p, window.re = m, window.se = h, window.sech = v, window.rs = y, window.psr = g, window.domReplaceEl = b, window.domEL = _, window.domNS = C, window.domPS = x, window.domFC = S, window.domLC = k, window.domPN = T, window.domChildren = A, window.domInsertBefore = E, window.domInsertAfter = N, window.domByClass = j, window.domData = O, window.domChildIndex = P, window.domCA = L, window.domClosestSibling = M, window.matchesSelector = z, window.isHover = R, window.isAncestor = B, window.getScroll = D, window.domClosestPositioned = H, window.domClosestOverflowHidden = I, window.show = U, window.hide = W, window.isVisible = F, window.clientHeight = Y, window.getClientRectOffsetY = $, window.toggle = q, window.boundingRectEnabled = X, window.getXYRect = V, window.getXY = K, window.isWindow = Q, window.getSize = Z, window.hasClass = ee, window.addClass = te, window.addClassDelayed = ne, window.removeClass = re, window.removeClassDelayed = oe, window.toggleClass = ie, window.toggleClassDelayed = ae, window.replaceClass = ue, window.getStyle = se, window.setStyle = le, window.setStyleDelayed = ce, window.setPseudoStyle = de, window.data = fe, window.attr = we, window.removeAttr = pe, window.removeData = me, window.cleanElems = he, window.setTitle = ve, window.getZoom = ye, window.val = ge, window.elfocus = be, window.traverseParent = _e, window.getH = J, window.getW = G, window.domClosestByTag = f
    },
    158: function(e, t) {
        "use strict";
        ...
        function M(e, t) {
            for (var n, r = t ? D : B, o = []; e && (n = e.match(r));) {
