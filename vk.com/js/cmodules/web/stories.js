! function(e) {
    ...
    function at(e, t, n) {
        var r = e.alternate;
        return null === r ? (r = new it(e.tag, e.key, e.internalContextTag), r.type = e.type, r.stateNode = e.stateNode, r.alternate = e, e.alternate = r) : (r.effectTag = 0, r.nextEffect = null, r.firstEffect = null,
            r.lastEffect = null), r.expirationTime = n, r.pendingProps = t, r.child = e.child, r.memoizedProps = e.memoizedProps, r.memoizedState = e.memoizedState, r.updateQueue = e.updateQueue, r.sibling = e.sibling, r.index = e.index, r.ref = e.ref, r
    }
    ...
    function u() {
        bodyNode.appendChild(ce("div", {
            ...
            })), layerQueue.hide(), layerQueue.push(), layers.fullhide = a, addEvent(window, "visibilitychange", m.visibilitychange, void 0, void 0, !0),
            addEvent(window, "resize", m.resize), addEvent(document, "keydown", m.keydown), addEvent(document, "keyup", m.keyup)
    }
