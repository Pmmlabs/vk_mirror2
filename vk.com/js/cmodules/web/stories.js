    ...
    449: function(e, t, n) {
        ...
        function G(e, t, n) {
            ...
            if (t && "border-box" === le(e, "boxSizing") && (t = !1), e == document) i = [Math.max(a.clientWidth, bodyNode.scrollWidth, a.scrollWidth, bodyNode.offsetWidth, a.offsetWidth), Math.max(a.clientHeight, bodyNode.scrollHeight, a.scrollHeight, bodyNode.offsetHeight, a.offsetHeight)];
                ...
                var s = function() {
                    if (i = $(e) && (o = q(e, n)) && void 0 !== o.width ? [o.width, o.height] : [e.offsetWidth, e.offsetHeight], t) {
                        each(i, function(t, n) {
    ...
    467: function(e, t, n) {
        (function(r, o) {
            ...
            (function() {
                ...
                function W(e, t) {
                    this._instanceConstructor = e, this.promise = new e(_), Array.isArray(t) ? (this._input = t, this.length = t.length, this._remaining = t.length, this._result = new Array(this.length), 0 === this.length ? P(this.promise, this._result) : (this.length = this.length || 0, this._enumerate(),
                        0 === this._remaining && P(this.promise, this._result))) : O(this.promise, this._validationError())
                }
