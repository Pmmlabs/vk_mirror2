! function(e) {
        ...
        var o = n(128),
            ...
            I = function() {
                ...
                return e.prototype.destroy = function() {
                    ...
                    if (hasClass(e.target, "stories_item_cont") || hasClass(e.target, "stories_item_back")) return this._feedbackTTShown && this.hideFeedbackTooltip(), k(this.wrapEl, "paused"), this.isActive ? n ? void(this.isPaused() && this.playStory()) : void this._onPlayEnd() : void this.opts.onSelect(this)
                    ...
                    ajax.post("al_stories.php", {
                        ...
                        onDone: function(e) {
                            window.cur.module === p.STORIES_MANAGE_MODULE && window.GeStories.storyDidRemove(r, e), P().hide(), t._popStoryAndClearList(n)
                        },
                    ...
                    ajax.post("al_stories.php", {
                        ...
                        onDone: function() {
                            P().hide(), t._popStoryAndClearList(n), showDoneBox(m("stories_report_sent"), {
    ...
    253: function(e, t, n) {
        ...
        function O(e) {
            e && e.dispatchConfig.phasedRegistrationNames && L(e._targetInst, P, e)
        }

        function N(e) {
            if (e && e.dispatchConfig.phasedRegistrationNames) {
                var t = e._targetInst;
                t = t ? x(t) : null, L(t, P, e)
            }
        }
        ...
        function se(e, t, n) {
            return e = B.getPooled(Ar.change, e, t, n), e.type = "change", X(n), D(e), e
        }
        ...
        function Be(e, t) {
            ...
            }) : n = void 0, ro && En(ro, n) ? null : (ro = n, e = B.getPooled(eo.select, no, e, t), e.type = "select", e.target = to, D(e), e)
        }
            ...
            function n(e) {
                for (;;) {
                    ...
                    if (null !== n && (null === n.firstEffect && (n.firstEffect = e.firstEffect),
                            null !== e.lastEffect && (null !== n.lastEffect && (n.lastEffect.nextEffect = e.firstEffect), n.lastEffect = e.lastEffect), 1 < e.effectTag && (null !== n.lastEffect ? n.lastEffect.nextEffect = e : n.firstEffect = e, n.lastEffect = e)), null !== r) return r;
                    if (null === n) {
        ...
        var gr, _r = mr,
            ...
            Er = {
                ...
                extractEvents: function(e, t, n, r) {
                    ...
                    return i ? (wr && (Cr || i !== kr.compositionStart ? i === kr.compositionEnd && Cr && (o = M()) : (cr._root = r, cr._startText = j(), Cr = !0)), i = V.getPooled(i, t, n, r), o ? i.data = o : (o = Y(n), null !== o && (i.data = o)), D(i), o = i) : o = null, (e = _r ? q(e, n) : $(e, n)) ? (t = W.getPooled(kr.beforeInput, t, n, r), t.data = e, D(t)) : t = null, [o, t]
                }
            },
            Tr = null,
            xr = null,
        ...
        var Br = {
            ...
            Hr = {
                ...
                extractEvents: function(e, t, n, r) {
                    ...
                    return a.type = "mouseleave", a.target = i, a.relatedTarget = o, n = we.getPooled(Br.mouseEnter, t, n, r), n.type = "mouseenter", n.target = o, n.relatedTarget = i, R(a, n, e, t), [a, n]
                }
            },
        ...
        if (wn.canUseDOM)
            if ("function" != typeof requestIdleCallback || "function" != typeof cancelIdleCallback) {
                ...
                Ro = function(e, t) {
                    return jo = e, null != t && "number" == typeof t.timeout && (Ho = Do() + t.timeout), Uo || (Uo = !0, requestAnimationFrame(Yo)), 0
                }, Fo = function() {
                    jo = null, Bo = !1, Ho = -1
                }
        ...
        var o = n(167),
            ...
            p = function() {
                ...
                return e.prototype._init = function(e, t, n, r) {
                    ...
                    (hasClass(e.target, "stories_layer_cont") || t) && (t && (this.isCloseBtnClick = !0),
                        cancelStackPop())
                    ...
                    if (this.storiesToRead.length) {
                        var e = this.list; - 1 !== [l.MODULE, u.MODULE, c.STORIES_MANAGE_MODULE].indexOf(cur.module) && (e = cur.module), 0 === e.indexOf("replies") && (e = "reply");
                    ...
                    return new Promise(function(r) {
                        ...
                        c = g - c + y / 2 - f[0] / 2 + scrollGetX(), p = v - p + m / 2 - f[1] / 2 + scrollGetY(), c = -c, p = -p;
                        var _ = {};
                        "expand" === e && (_.transform = "translate(" + c + "px, " + p + "px) scale(0)", n.animateFromEl = t), setStyle(n.activeStory.wrapEl, _), "minimize" === e && setStyle(o, "transform", "scale(0)"), n.animationTimer = setTimeout(function() {
                            addClass(n.stories, "animated"), addClass(o, "stories_feed_item_ava_animate"), n.animationTimer = setTimeout(function() {
                                "expand" === e ? (setStyle("stories_layers_background", "opacity", 1), setStyle(n.activeStory.wrapEl, "transform", "translate(0, 0) scale(1)")) : (setStyle(n.activeStory.wrapEl, "transform", "translate(" + c + "px, " + p + "px) scale(0.01)"), setStyle(o, "transform", "scale(1)")), n.animationTimer = setTimeout(function() {
                    ...
                    var n = geByClass1("stories_volume_control_slide", this.volumeControl),
                        ...
                        f = function h() {
                            removeEvent(window, "mousemove", p), removeEvent(window, "mouseup", h), t._updateVolumeButton(), removeClass(t.volumeControlContainer, "changing")
                        };
                    addEvent(window, "mousemove", p), addEvent(window, "mouseup", f), p(e)
    ...
    40: function(e, t, n) {
        ...
        function N() {
            var e, t = arguments,
                ...
                o = t.length,
                i = !1;
            for ("boolean" == typeof n && (i = n, n = t[1] || {}, r = 2), "object" === ("undefined" == typeof n ? "undefined" : M(n)) || l(n) || (n = {}); o > r; ++r)
                if (null != (e = t[r]))
                    for (var a in e) {
                        var s = n[a],
                            u = e[a];
                        n !== u && (i && u && "object" === ("undefined" == typeof u ? "undefined" : M(u)) && !u.nodeType ? n[a] = N(i, s || (null != u.length ? [] : {}), u) : void 0 !== u && (n[a] = u))
                    }
            return n
        }
