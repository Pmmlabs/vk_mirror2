! function(t) {
        ...
        y = function() {
            ...
            return t.prototype._init = function(t, e, o, s) {
                ...
                addClass(this.layerEl, "stories_layer_hiding"), !this.hideAllLayers && c.layerHide(), t !== !0 && this.activeStory ? this.animateStory("minimize").then(function() {
                    return e.doHide()
                }) : this.doHide(t), removeClass(this.layerEl, "shown"), o || cancelStackPop(), this.activeStory && this.activeStory.pauseStory()
                ...
                if (t) {
                    var o = nav.objLoc;
                    o.w = "story" + t.getRawId(), e.match(/^-?(\d+)_(\d+)$/) || (o.w += "/" + e), nav.setLoc(nav.toStr(o))
                }
                    ...
                    "expand" === t && (g.transform = "translate(" + d + "px, " + h + "px) scale(0)", o.animateFromEl = e), setStyle(o.activeStory.wrapEl, g), "minimize" === t && setStyle(r, "transform", "scale(0)"), o.animationTimer = setTimeout(function() {
                        addClass(o.stories, "animated"), addClass(r, "stories_feed_item_ava_animate"), o.animationTimer = setTimeout(function() {
                            "expand" === t ? (setStyle("stories_layers_background", "opacity", 1), setStyle(o.activeStory.wrapEl, "transform", "translate(0, 0) scale(1)")) : (setStyle(o.activeStory.wrapEl, "transform", "translate(" + d + "px, " + h + "px) scale(0.01)"), setStyle(r, "transform", "scale(1)")), o.animationTimer = setTimeout(function() {
                                s(), "expand" === t ? (setStyle(o.activeStory.wrapEl, "transform", ""), removeClass(o.layerEl, "animation"), removeClass(o.stories, "animated"), o.playStory(), c.layerShown()) : (removeClass(r, "stories_feed_item_ava_animate"), setStyle(r, "transform", ""))
                            }, 330)
                        }, 30)
                    }, 30)
                })
                ...
                this._updateVolumeButton(), this.activeStory.volumeUpdate(), this.activeStory && (this.playStory(), removeClass(this.layerEl, "paused"))
                ...
                var o = geByClass1("stories_volume_control_slide", this.volumeControl),
                    ...
                    u = function p() {
                        removeEvent(window, "mousemove", h), removeEvent(window, "mouseup", p), e._updateVolumeButton(), removeClass(e.volumeControlContainer, "changing")
                    };
    ...
    (function(t, r, i) {
        (function() {
            ...
            function L(t, e, o) {
                e.constructor === t.constructor && o === rt && constructor.resolve === it ? C(t, e) : o === dt ? P(t, dt.error) : void 0 === o ? x(t, e) : a(o) ? E(t, e, o) : x(t, e)
            }

            function T(t, e) {
                t === e ? P(t, w()) : n(e) ? L(t, e, S(e)) : x(t, e)
            }
            ...
            U.prototype._validationError = function() {
                ...
                if (s === it) {
                    ...
                    if (r === rt && t._state !== nt) this._settledAt(t._state, e, t._result);
                        ...
                        var i = new o(g);
                        L(i, t, r), this._willSettleAt(i, e)
    ...
    var n = function() {
        ...
        v = function() {
            ...
            return t.prototype.destroy = function() {
                ...
                return addEvent(t, "click", this.removeStoryBox.bind(this)), addEvent(t, "mouseover", function() {
                    showTooltip(t, {
                        black: 1,
                        center: 1,
                        shift: [1, 13, 0],
                ...
                }), addEvent(this.shareButton, "click", this.shareBox.bind(this)), addEvent(this.shareButton, "mouseover", function() {
                    showTooltip(t.shareButton, {
                        black: 1,
                        center: 1,
                        shift: [1, 13, 0],
                        text: getLang("stories_share")
                    })
                }), this.shareButton
                ...
                }), addEvent(this.followBtn, "click", this._onFollowBtnClick.bind(this)), addEvent(this.followBtn, "mouseover", function() {
                    var e = hasClass(t.followBtn, "followed") ? getLang("stories_unfollow") : getLang("stories_follow");
                ...
                this._destroyFeedBackTT(), this.isActive = !1, this._destroyStory(), this._stopLoader(), val(this.sendFormTextEl, ""), this._unlockSendForm(), removeClass(this.wrapEl, "autoplay_failed")
                ...
                if (this.story) {
                    window.tooltips && tooltips.hideAll(), this._resetErrors(), this._destroyFeedBackTT(), this.story.pause(), cancelAnimationFrame(this.timeLineAnim);
                    try {
                ...
                ajax.post("al_stories.php", {
                    ...
                    onDone: function() {
                        curBox().hide(), e._removeStoryFromMemoryByIndex(o), Stories.removeList(e.getRawId()), 0 === e.data.items.length && u.onReplyDeleted(e.getOwnerId())
                    },
                    showProgress: lockButton.pbind(t),
                    hideProgress: unlockButton.pbind(t)
                })
                ...
                toggleClass(n, "force_to_right", !r && !s && !i), toggleClass(this.wrapEl, "replies_button_to_bottom", !this.isAuthor() && !i && !s)
