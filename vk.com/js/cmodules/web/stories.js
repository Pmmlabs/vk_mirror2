    ...
    var a = function() {
        ...
        U = function() {
            ...
            return e.prototype.destroy = function() {
                ...
                A("stories_hide_reply_wrap", this.contWrap) && (this.data.items.length <= 1 && m.onReplyDeleted(this.getOwnerId()),
                    this._resetReplyHide(), this._removeStoryFromMemoryByIndex(e || this.getIndex(), !isNumeric(e)))
            ...
            return e.prototype._init = function(e, t, n, r) {
                ...
                if (a.map(function(t, n) {
                        ...
                        if (!e.renderedStories[r]) {
                            ...
                            i >= n && e.stories.children[n] ? e.stories.insertBefore(a.render(), e.stories.children[n]) : e.stories.appendChild(a.render()),
                                e.renderedStories[r] = {
                                    story: a,
                                    index: o
