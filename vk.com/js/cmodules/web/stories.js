    ...
    EJ7F: function(e, t, s) {
        ...
        class W extends i.Component {
            ...
            emojiInit() {
                ...
                }), R(this.refs.smileButton, "click", D), placeholderInit(this.refs.messageInput, {
                    editable: !0
        ...
        class _e extends i.Component {
            constructor(e) {
                ...
                super(e), t = this, this.componentDidMount = (() => {
                    ...
                    var e = pe(Object(X.O)(this.props.el), 2),
                        t = e[0],
                        s = e[1];
                    this.setState({
                        widthViewBox: t,
                ...
                var s = pe(Object(X.O)(this.props.el), 2),
                    r = s[0],
                    o = s[1];
        ...
        class Ce {
            ...
            destroy() {
                this._destroyStory(), Object(ke.h)(Object(X.I)("stories_item_cont", this.contWrap)), Object(ke.h)(Object(X.I)("stories_reply_to", this.replyToWrap)), Object(ke.h)(this.shareButton), delete this.shareButton, Object(ke.h)(this.followBtn), delete this.followBtn, Object(ke.h)(this.answersEl), delete this.answersEl, clearTimeout(this.showMessageTimer);
                for (var e = Object(X.H)("stories_time_line", this.timeLineEl), t = 0; t < e.length; t++) Object(ke.h)(e[t]);
                Object(ke.h)(this.viewsButton), Object(ke.h)(Object(X.I)("stories_feedback_close", this.wrapEl)), Object(ke.h)(Object(X.I)("stories_link", this.wrapEl)), delete this.contWrap, delete this.backButton, delete this.replyToWrap, delete this.descEl, delete this.replyToWrap, delete this.timeLineEl, delete this.authorButtons, delete this.inlineLoader, this.wrapEl && this.wrapEl.parentNode && this.wrapEl.parentNode.removeChild(this.wrapEl), delete this.wrapEl;
                ...
                if (!s && r && r.activeStory) {
                    var o = Object(X.C)("#feed_story_" + this.layer.getBlockKey(this.data), r.activeStory.wrapEl)[0];
                    Object(X.ib)(o, "story_feed_new_item"), Object(X.ib)(o, "story_feed_new_item_promo")
                }
            }
            _destroyTimeLine() {
                for (var e = Object(X.H)("stories_time_line", this.timeLineEl), t = 0; t < e.length; t++) Object(ke.h)(e[t])
            ...
            render() {
                ...
                })), this.isActiveLive() ? Object(X.a)(this.wrapEl, "live") : this._initTimeLine(), Object(X.xb)(this.wrapEl, "multi_stories", this.data.items.length > 1), this.wrapEl
            }
            updateBottom(e) {
                var t = Object(X.I)("stories_bottom_wrap", this.wrapEl);
            ...
            _initTimeLine() {
                this.timeLineEl && (this._destroyTimeLine(), re(this.timeLineEl)), Object(X.I)("stories_item_cont", this.contWrap).appendChild(this._renderTimeLine())
            }
            _isActionsShown() {
            ...
            _renderPreview() {
                return Object(X.nb)('<div class="stories_preview"></div>')
            }
            _renderMessage(e) {
                return Object(X.nb)(`<div class="stories_message">\n  <div class="stories_message_text">${e}</div>\n</div>`)
            }
            _showMessage(e) {
                re(Object(X.I)("stories_message", this.contWrap));
            ...
            _setPreview(e, t) {
                ...
                i !== this.curPreviewUrl && i && (t = t || (() => {}), e = e || Object(X.I)("stories_preview", this.contWrap), _(i).then(r => {
                    s === this.index && i !== this.curPreviewUrl && (this.curPreviewUrl = i, Object(X.sb)(e, "backgroundImage", "url(" + r + ")")), Object(X.sb)(e, "opacity", 1), setTimeout(t, 0)
                }))
            }
            getPreview() {
            ...
            _renderAuthor() {
                ...
                return Object(ke.b)(l, "click", e => {
                    Object(X.p)("a", e.target) && this.layer._sendNavigationStatEvents("go_to_author")
                }), !0 === this.data.hide_owner && val(Object(X.I)("stories_author_cont", l), ""), Object(X.xb)(this.wrapEl, "hide_owner", !0 === this.data.hide_owner), this.descEl = Object(X.I)("stories_desc", l), this.authorButtons = Object(X.I)("stories_author_buttons", l), l
            }
            _renderFollowButton() {
            ...
            _onMouseUpHandle(e) {
                ...
                if (delete this.downTs, e.target === this.pressedStory) {
                    ...
                    if (hasClass(e.target, "stories_item_cont") || hasClass(e.target, "stories_item_back"))
                        if (this._feedbackTTShown && this.hideFeedbackTooltip(), Object(X.ib)(this.wrapEl, "paused"), this.isTooltipOpened()) this._hideTooltip();
                        else {
                            if (!this.isActive) {
            ...
            playStory() {
                ...
                this.isLocked() || (Object(X.ib)(this.wrapEl, "paused"), hide(boxLayerBG), hide(boxLayerWrap), this.story && !e || this._initStory(), this.story.play(), t && this.layer._sendNavigationStatEvents("resume_release"), delete this.downTs)
            }
            pauseStory(e) {
            ...
            stop() {
                this._destroyFeedBackTT(), this.isActive = !1, this._destroyStory(), this._stopLoader(), val(Object(X.I)("stories_send_form_text", this.wrapEl), ""), this._unlockSendForm(), Object(X.ib)(this.wrapEl, "autoplay_failed")
            }
            getCurStoryData() {
            ...
            _initStory() {
                ...
                if ("live" === t) this.story = new me(e, s, this.wrapEl);
                else {
                    "video" === t ? (this.story = new be(e, s), Object(X.a)(this.wrapEl, "video")) : (this.story = new we(e, s), this.opts.onVideoEnd(), Object(X.ib)(this.wrapEl, "video"));
                ...
                this.opts.onStartStory(), Object(X.xb)(this.wrapEl, "stories_can_comment", !0 === e.can_comment), e.reply_to && this.replyToWrap.appendChild(this._renderReplyTo()), !this.data.author.can_follow || this.data.is_promo || this.isActiveLive() || this.authorButtons.appendChild(this._renderFollowButton()), this.story.isNarrativeMetaStory = e.isNarrativeMetaStory, this._destroyFeedBackTT(), this.story.isNarrativeMetaStory || (this.updateBottom(), this.contWrap.appendChild(this.story.render())), e.clickable_stickers && (this.stickerLayers = r.render(i.createElement(_e, {
                    ...
                    el: this.contWrap
                }), this.contStickers)), this.story.data && this.story.data.narrative && this.story.data.narrative.is_cover && (this.contWrap.appendChild(this.story.renderNarrativeCover()), Object(ke.b)(Object(X.I)("stories_narrative_cover", this.contWrap), "click", e => {
                    this._showTooltip(e, this._createNarrativeTooltipLink())
                })), this.story.isNarrativeMetaStory && !this.story.failed && (re(Object(X.I)("stories_photo", this.contWrap)), re(Object(X.I)("stories_video", this.contWrap)), Object(X.a)(this.contWrap, "stories_item_cont_wrap_meta_story"), this.contWrap.appendChild(this.story.renderNarrativeMetaStory()), this.story._onCanPlay())
            }
            ...
            fillTimeLine() {
                ...
                if (e)
                    for (var t = 0; t < e.children.length; t++) {
                        var s = Object(X.I)("stories_time_line_item_cont_active", e.children[t]);
                        t === this.index && (this.currentTimeLineEl = s);
                        var i = t < this.index ? 100 : 0;
                        Object(X.sb)(s, "transform", "translateX(" + i + "%)")
                    }
            }
            _destroyStory() {
                if (this.story) {
                    this.updateBottom(!0), window.tooltips && tooltips.hideAll(), this._hideTooltip(), this._resetErrors(), this._destroyFeedBackTT(), this.story.pause(), Object(X.ib)(this.contWrap, "stories_item_cont_wrap_meta_story"), re(Object(X.I)("narrative-meta-story", this.contWrap)), Object(X.ib)(this.contWrap, "stories_narrative_cover_blur"), re(Object(X.I)("stories_narrative_cover", this.contWrap)), Object(ke.h)(Object(X.I)("stories_narrative_cover", this.contWrap)), Object(ke.h)(window, "resize", this._onResizeHandle);
                    var e = this.getCurStoryData();
                    ...
                    this._replyHideEnd(), Object(ke.h)(this.followBtn), val(this.authorButtons, ""), Object(ke.h)(this.answersEl), Object(ke.h)(Object(X.I)("stories_reply_to", this.replyToWrap)), val(this.replyToWrap, ""), this.hideInlineLoader(), delete this.story
                }
            }
            _timeLineUpdate() {
                var e = this.story;
                if (e && !e.isPaused() && !this.isActiveLive()) {
                    ...
                    Object(X.sb)(this.currentTimeLineEl, "transform", "translateX(" + i + "%) translateZ(0)"), i < 100 ? this.timeLineAnim = requestAnimationFrame(this._timeLineUpdate.bind(this)) : this._onPlayEnd(!0)
                }
            }
            _onLoadingStart() {
            ...
            _onPlay() {
                this._resetErrors(), this._stopLoader(), this._timeLineUpdate(), this.preloadNextStory(), this.opts.onPlayStory(), Object(X.ib)(this.wrapEl, "animate_story"), Object(X.ib)(this.wrapEl, "autoplay_failed"), this.data.items[this.getIndex()].unread = !1, this._updateFeedStoryPreview()
            }
            _onPause() {
            ...
            _onAnswerSend(e, t) {
                ...
                if (this.isActiveLive()) this.story.sendMessage(s, t);
                    ...
                    i = r ? `narrative:${r.raw_id}` : `story:${this.story.getId()}`, ajax.post("al_im.php", {
                        ...
                        hideProgress: () => {
                            val(this.sendFormButton, ""), Object(X.ib)(this.sendFormButton, "sending")
                        }
                    })
                }
            }
            _onAnswerSended(e) {
                ...
                })), val(Object(X.I)("stories_send_form_text", this.wrapEl), ""), this._blurSendForm(), this.updateFeedbackTTPos(), this.pauseStory(), e && e()
            }
            _onSendFormFocus() {
            ...
            _blurSendForm() {
                var e = Object(X.I)("stories_send_form_text", this.wrapEl);
                e && e.blur()
            }
            _getSendText() {
                var e = Emoji.editableVal(Object(X.I)("stories_send_form_text", this.wrapEl));
                return trim(e)
            }
            _onSendFormBlur() {
            ...
            _resetFendForm() {
                this._unlockSendForm(), this.playStory(), val(Object(X.I)("stories_send_form_text", this.wrapEl), "")
            }
            _emojiOnKeyAction() {
                this._getSendText() ? Object(X.a)(this.sendFormButton, "active") : Object(X.ib)(this.sendFormButton, "active")
            }
            _getLoaderHtml() {
            ...
            _resetErrors() {
                var e = Object(X.I)("stories_error_wrap", this.contWrap);
                e && (Object(ke.h)(Object(X.I)("stories_error_button", e)), re(e)), Object(X.ib)(this.wrapEl, "failed"), Object(X.ib)(this.wrapEl, "fatal_error")
            }
            _showError(e) {
                if (this.contWrap) {
                    var t, s, i = e;
            ...
            _stopLoader() {
                setTimeout(() => {
                    re(Object(X.I)("stories_loader", this.contWrap))
                }, 0)
            }
            _showLoader() {
            ...
            _renderReplyTo() {
                ...
                var h = !1;
                return o ? (Object(X.a)(d, "deleted"), h = Object(Ee.d)("stories_deleted_story")) : a ? (Object(X.a)(d, "private"), h = Object(Ee.d)("stories_private_story")) : n && (Object(X.a)(d, "expired"), h = Object(Ee.d)("stories_expired_story")), h && (val(Object(X.I)("stories_reply_to_error_msg", d), h), re(Object(X.I)("stories_reply_to_owner_name_wrap", d))), d
            }
            sendMask() {
            ...
            _getFeedbackTTElem() {
                return Object(X.I)("stories_answers_tt_arrow", this.wrapEl) || Object(X.I)("_views_button", this.wrapEl)
            }
            _destroyFeedBackTT() {
            ...
            updateFeedbackTTArrow() {
                ...
                if (hasClass(e, "stories_answers_tt_arrow")) {
                    var t = Object(X.I)("stories_feedback_tt_arrow", this.wrapEl),
                        s = e.offsetLeft + getSize(e)[0] / 2 - getSize(t)[0] / 2 - 1;
                    Object(X.sb)(t, "left", `${s}px`)
                }
            }
            showFeedbackTooltip() {
                var e = arguments.length > 0 && void 0 !== arguments[0] && arguments[0];
                ...
                if (t)
                    if (this._feedbackTTShown && !0 !== e) cancelStackPop();
                        ...
                        showTooltip(t, {
                            ...
                            zIndex: 100,
                            shift: [s, 19, 0],
                            appendEl: Object(X.I)("stories_bottom_wrap", this.wrapEl),
                            onHide: () => {
                                this._feedbackTTShown = !1
                            },
                            onShowStart: () => {
                                this.isActive && (this._feedbackTTShown = !0, this._feedbackTTLoaded ? this._feedbackRequestEnd && (this.feedbackScroll.update(), this._feedbackTooltipInitHeaders(), tooltips.rePositionTT(t.tt), this._onFeedbackScroll(), setTimeout(() => tooltips.rePositionTT(t.tt), 200)) : (Object(X.I)("stories_feedback_tt", this.wrapEl).appendChild(Object(X.nb)('<div class="stories_feedback_tt_arrow"></div>')), this._feedbackTTLoaded = !0, this._feedbackRequestEnd = !1, this._feedbackTooltipHeadersInited = !1, Object(ke.b)(Object(X.I)("stories_feedback_close", this.wrapEl), "click", () => this.hideFeedbackTooltip()), setTimeout(() => {
                                    ajax.post("al_stories.php", {
                                        act: "feedback",
                                        ...
                                        onDone: (e, s, i, r, o, a) => {
                                            if (this.isActive) {
                                                ...
                                                var n = Object(X.I)("stories_feedback_content", this.wrapEl);
                                                val(n, e), this.updateQuestions(a, this._showMessage.bind(this), this.getCurStoryData().small_preview), this.feedbackScroll = new uiScroll(Object(X.I)("stories_feedback_content", this.wrapEl), {
                                                    theme: "default emoji no_transition",
                                                    onmore: () => this._onMoreFeedBack(),
                                                    onscroll: () => this._onFeedbackScroll()
                                                }), this.feedbackScroll.scrollTop(0), Object(X.a)(this.feedbackScroll.container, "ui_scroll_shadow_bottom_visible"), Object(X.I)("ui_scroll_overflow", this.feedbackScroll.container).appendChild(ce("div", {
            ...
            updateQuestions(e, t, s) {
                var o = Object(X.G)("stories_feedback_questions");
                Object(X.ib)(Object(X.I)("_views_button", this.wrapEl), "stories_button_new_questions"), o && (r.render(i.createElement(J, {
                    showMessage: t,
                    storyUrl: s,
                    questions: e,
                    sendNavigationStatEvents: this.layer._sendNavigationStatEvents.bind(this.layer),
            ...
            destroyFeedbackQuestions() {
                var e = Object(X.G)("stories_feedback_questions");
                r.unmountComponentAtNode(e), re(e), re(Object(X.G)("stories_feedback_title_questions")), this.feedbackTooltipReInitHeaders(), this.feedbackScroll.scrollTop(0), tooltips.rePositionTT(this._getFeedbackTTElem().tt)
            }
            updateFeedbackTTPos() {
                var e = this._getFeedbackTTElem();
            ...
            _feedbackTooltipInitHeaders() {
                if (!this._feedbackTooltipHeadersInited) {
                    ...
                    var e = Object(X.I)("stories_feedback_content", this.wrapEl),
                        t = Object(X.I)("stories_feedback_headers", this.wrapEl),
                        s = Object(X.H)("stories_feedback_title", e);
                    ...
                    Object(X.sb)(e, "margin-top", s[0].offsetHeight), hide(s[0])
                }
            }
            feedbackTooltipReInitHeaders() {
                this._feedbackTooltipHeadersInited && (this._feedbackTooltipHeadersInited = !1, this.feedbackHeaders = [], val(Object(X.I)("stories_feedback_headers", this.wrapEl), ""), this._feedbackTooltipInitHeaders())
            }
            _onFeedbackScroll() {
                if (this._feedbackTooltipHeadersInited)
            ...
            _onMoreFeedBack() {
                !this.feedbackLoadingMore && this.feedbackNextFrom && (this.feedbackLoadingMore = !0, ajax.post("al_stories.php", {
                    ...
                    onDone: (e, t) => {
                        ...
                        for (var s, i = Object(X.I)("stories_feedback_views", this.wrapEl), r = ce("div", {
                                innerHTML: e
            ...
            _restoreReply(e) {
                cancelEvent(e);
                var t = Object(X.I)("stories_hide_reply_wrap", this.contWrap);
                ajax.post("al_stories.php", {
                    act: "restore_reply",
                    raw_id: this.getRawId(),
                    hash: this.data.reply_hide_hash
                    ...
                    hideProgress: () => Object(X.ib)(t, "loading")
                })
            }
            _resetReplyHide() {
                re(Object(X.I)("stories_hide_reply_wrap", this.contWrap)), Object(X.ib)(this.wrapEl, "hiding_reply")
            }
            _hideAllReplies() {
            ...
            _doHideAllReplies(e) {
                ajax.post("al_stories.php", {
                    ...
                    onDone: () => {
                        ...
                        var e = Object(X.I)("_stories_hide_replies", this.contWrap);
            ...
            _doBan(e) {
                ajax.post("al_stories.php", {
                    ...
                    onDone: () => {
                        Object(je.b)().hide(), this.opts.removeList(), this.data.items = [];
                        var e = Object(X.I)("_stories_reply_ban", this.contWrap);
            ...
            _replyHideEnd() {
                ...
                Object(X.I)("stories_hide_reply_wrap", this.contWrap) && (this.data.items.length <= 1 && j(this.getOwnerId()), this._resetReplyHide(), this._removeStoryFromMemoryByIndex(e || this.getIndex(), !isNumeric(e)))
            }
            _feedbackRemoveReplyFromDom(e) {
                var t = Object(X.I)("stories_feedback_content", this.wrapEl);
                if (t) {
            ...
            _updateFeedStoryPreview() {
                var e = Object(X.G)("feed_story_" + this.layer.getBlockKey(this.data));
                if (e && !hasClass(e, "stories_feed_reply_item")) {
                    var t = this.indexToUnread(!0),
                        s = this.data.items[t];
                    s && s.small_preview && Object(X.sb)(e, "background-image", `url(${s.small_preview})`)
                }
            }
            _sendStatEvent(e) {
                var t = this.getCurStoryData();
            ...
            report() {
                ...
                var s = Object(Oe.b)("al_stories.php", {
                    ...
                    onDone: () => {
                        var e = Object(X.H)("radiobtn", "stories_report");
        ...
        var Le = .563,
            ...
            Be = 540,
            Ne = 320,
            Ie = "user_personal_card",
            Pe = "group_personal_card",
            Me = s("Tn+0");
        ...
        var qe = o.Promise,
            $e = {
                show(e) {
                    ...
                    this.getList(e).then(e => {
                        S(new class {
                            ...
                            _readStories() {
                                if (this.storiesToRead.length && Fe()) {
                                    ...
                                    this.storiesToRead = [], ajax.post("al_stories.php", {
                                        ...
                                        navigation_stats: function() {
                                            var e = Ae.map(e => [e.ownerId, e.storyId, e.source, e.action].join(",")).join(";");
                                            return Ae = [], e
                                        }(),
                                        loading_stats: function() {
                                            var e = De.map(e => [e.ownerId, e.storyId, e.source, e.time].join(",")).join(";");
                                            return De = [], e
                                        }(),
                            ...
                            _getSource() {
                                var e = "list";
                                return this._source ? this._source : (-1 !== [Ie, Pe, Z, Me.b].indexOf(cur.module) && (e = cur.module), e)
                            }
                ...
                initFeed() {
                    ...
                    e = Object(X.G)(e);
                    var t = Object(X.I)("stories_feed_items", e),
                        s = attr(t, "id");
                ...
                feedNext(e) {
                    var t = Object(X.G)("stories_feed_wrap");
                ...
                feedPaging(e, t, s) {
                    s || (s = Object(X.G)("stories_feed_wrap"));
                    var i = Object(X.I)("stories_feed_items", s),
                        r = attr(i, "id"),
                        o = r + "_position",
                        a = cur[o] || 0,
                        n = getSize(s)[0];
                    ...
                    cur[o] = Math.max(0, Math.min(a, i.scrollWidth - n)), t ? Object(X.ib)(i, "animated") : Object(X.a)(i, "animated"), setStyle(i, "transform", "translateX(-" + cur[o] + "px)"), $e.updateFeedArrows(r)
                },
                feedScrollToOwner(e) {
                    var t = Object(X.G)("feed_story_" + e);
                    if (t) {
                    ...
                    if (e = e || "news", i)
                        if (inArray(e, ["news", "search"])) {
                            var o = (e, i) => {
                                ...
                                var o = Object(X.G)(s);
                                o && (e ? (setStyle(o, "transform", "translateX(0px)"), Object(X.Ab)(o, e), o.children.length < 6 ? Object(X.a)(r, "stories_feed_not_nav_buttons") : Object(X.ib)(r, "stories_feed_not_nav_buttons"), cur[s + "_position"] = 0, $e.updateFeedArrows(s), show(r)) : hide(r))
                            };
                            if (t && t.stories) {
                                var a = t.section,
                                    n = t.q,
                ...
                updateFeedArrows() {
                    ...
                    if (t) {
                        cur[s] || (cur[s] = 0);
                        var i = Object(X.I)("stories_feed_wrap").offsetWidth,
                            r = t.scrollWidth - i,
                            o = Object(X.I)("stories_feed_arrow_left", domPN(t)),
                            a = Object(X.I)("stories_feed_arrow_right", domPN(t));
                        0 === cur[s] ? Object(X.a)(o, "disabled") : Object(X.ib)(o, "disabled"), cur[s] === r || r <= 0 ? Object(X.a)(a, "disabled") : Object(X.ib)(a, "disabled")
                    }
                },
                showBlackList() {
                ...
                blackListItemClick(e, t) {
                    ...
                    cur.storiesBlackListShown[s] ? (delete cur.storiesBlackListShown[s], Object(X.ib)(e, "olist_item_wrap_on")) : (cur.storiesBlackListShown[s] = 1, Object(X.a)(e, "olist_item_wrap_on"))
                },
                saveBlackList(e) {
                ...
                blacklistUpdateUsers(e) {
                    ...
                    if (e = trim(e).toLowerCase(), cur.storiesBlacklistLastQ !== e) {
                        ...
                        a || (a = '<div class="no_rows">' + Object(Ee.d)("global_search_not_found").replace("{search}", clean(t)) + "</div>"), Object(X.Ab)(Object(X.I)("olist", "stories_black_list_result"), a)
                    }
                },
                blackListInit(e) {
                ...
                showNextRepliesChunk(e) {
                    ...
                    Object(X.ib)(Object(X.I)("stories_replies_chunk_hidden", t), "stories_replies_chunk_hidden");
                    var s = Object(X.I)("stories_replies_chunk_hidden", t);
                    s ? Object(X.Ab)(e, langNumeric(Object(Ee.d)("stories_replies_more_button", intval(attr(s, "data-size"))))) : re(e), cur.storyLayer && cur.storyLayer.activeStory && cur.storyLayer.activeStory.feedbackTooltipReInitHeaders(), cur.storyLayer && cur.storyLayer.activeStory && cur.storyLayer.activeStory.updateFeedbackTTPos()
                },
                groupStoriesBlockUpdate() {
                    ...
                    if (t) {
                        ...
                        var r = Object(X.I)("stories_groups_block_stories_wrap"),
                            o = Object(X.I)("stories_groups_block_stories_button", r);
                        Object(X.xb)(r, "has_unread", s > 0), Object(X.xb)(r, "has_stories", t.length > 0), Object(X.xb)(o, "has_stories", t.length > 0);
                        ...
                        Object(X.Ab)(Object(X.I)("stories_groups_block_stories_rows", r), l)
                    }
                },
