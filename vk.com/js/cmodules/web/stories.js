! function(e) {
    ...
    function de(e, t, n) {
        ...
        a || (a = headNode.appendChild(h("style", {
            ...
            s += e + ": " + t + " !important;"
        }), s += "}", a.sheet ? (a.sheet.cssRules.length && a.sheet.deleteRule(0),
            a.sheet.insertRule(s, 0)) : a.styleSheet && (a.styleSheet.cssText = s)
    }
    ...
    var a = n(22),
        ...
        u = r(l);
    o.propTypes = {
        story: u["default"].object.isRequired
    }, i.propTypes = {
    ...
    function rt(e) {
        ...
        return t = t && t.__reactInternalMemoizedMergedChildContext || Pn,
            mo = ho.current, Xe(ho, t, e), Xe(yo, yo.current, e), !0
    }
        ...
        function b(e, n) {
            if (de ? r("245") : void 0, de = !0, n <= m()) {
                ...
                null !== o ? (e.finishedWork = null,
                    e.remainingExpirationTime = t(o)) : (e.finishedWork = null, o = s(e, n), null !== o && (e.remainingExpirationTime = t(o)))
    ...
    function an(e, t) {
        ...
        for (var r = 0; r < t.length; r++) {
            var o = t[r];
            n.hasOwnProperty(o) && n[o] || ("topScroll" === o ? Ne("topScroll", "scroll", e) : "topFocus" === o || "topBlur" === o ? (Ne("topFocus", "focus", e), Ne("topBlur", "blur", e), n.topBlur = !0, n.topFocus = !0) : "topCancel" === o ? (ne("cancel", !0) && Ne("topCancel", "cancel", e), n.topCancel = !0) : "topClose" === o ? (ne("close", !0) && Ne("topClose", "close", e), n.topClose = !0) : Qr.hasOwnProperty(o) && Oe(o, Qr[o], e), n[o] = !0)
        }
    }
        ...
        for ("boolean" == typeof n && (i = n, n = t[1] || {}, r = 2), "object" === ("undefined" == typeof n ? "undefined" : F(n)) || s(n) || (n = {}); o > r; ++r)
            if (null != (e = t[r]))
                for (var a in e) {
                    var l = n[a],
                        u = e[a];
                    n !== u && (i && u && "object" === ("undefined" == typeof u ? "undefined" : F(u)) && !u.nodeType ? n[a] = O(i, l || (null != u.length ? [] : {}), u) : void 0 !== u && (n[a] = u))
                }
        return n
    }
    ...
    var a = function() {
        ...
        U = function() {
            ...
            return e.prototype.destroy = function() {
                ...
                !n && o && o.activeStory && N(M("#feed_story_" + this.getOwnerId(), o.activeStory.wrapEl)[0], "story_feed_new_item")
                ...
                this.isLocked() || (N(this.wrapEl, "paused"), this.story || this._initStory(), this.story.play(), delete this.downTs)
            }, e.prototype.pauseStory = function(e) {
                ...
                this._destroyFeedBackTT(), this.isActive = !1, this._destroyStory(), this._stopLoader(), val(A("stories_send_form_text", this.wrapEl), ""), this._unlockSendForm(), N(this.wrapEl, "autoplay_failed")
                ...
                } else "photo" === t && (this.story = new k["default"](e, n), this.opts.onVideoEnd(), N(this.wrapEl, "video"));
                ...
                this._resetErrors(), this._stopLoader(), this._timeLineUpdate(), this.preloadNextStory(), this.opts.onPlayStory(), N(this.wrapEl, "animate_story"), N(this.wrapEl, "autoplay_failed"), this.data.items[this.getIndex()].unread = !1, this._updateFeedStoryPreview()
                ...
                return r && this.story ? void ajax.post("al_im.php", {
                    ...
                    hideProgress: function() {
                        val(n.sendFormButton, ""), N(n.sendFormButton, "sending")
                    }
                }) : cancelEvent(e)
                ...
                this._getSendText() ? O(this.sendFormButton, "active") : N(this.sendFormButton, "active")
                ...
                e && (P(A("stories_error_button", e)), re(e)), N(this.wrapEl, "failed"), N(this.wrapEl, "fatal_error")
                ...
                var u = !1;
                return i ? (O(l, "deleted"), u = E("stories_deleted_story")) : a && (O(l, "private"), u = E("stories_private_story")), u && (val(A("stories_reply_to_error_msg", l), u), re(A("stories_reply_to_owner_name_wrap", l))), l
                                    ...
                                    ajax.post("al_stories.php", {
                                        ...
                                        onDone: function(t, r, o, i, a) {
                                            if (e.isActive) {
                                                ...
                                                }), e.feedbackScroll.scrollTop(0), O(e.feedbackScroll.container, "ui_scroll_shadow_bottom_visible"), A("ui_scroll_overflow", e.feedbackScroll.container).appendChild(ce("div", {
                ...
                var e = this;
                this.pauseStory(), O(this.wrapEl, "hiding_reply"), B().hide();
                var t = this.getIndex(),
                ...
                L(A("_stories_reply_restore", r), "click", this._restoreReply.bind(this)), L(A("_stories_reply_continue", r), "click", function() {
                    ...
                    onDone: function() {
                        e.opts.removeList(), cur.needUpdateFeedStories = !0, N(r, "loading")
                    },
                    onFail: function() {
                ...
                re(A("stories_hide_reply_wrap", this.contWrap)), N(this.wrapEl, "hiding_reply")
                ...
                ajax.post("al_stories.php", {
                    ...
                    onDone: function() {
                        ...
                        val(e, E("stories_all_replies_hidden")), O(e, "disabled")
                    },
                    showProgress: T.pbind(e),
                    hideProgress: x.pbind(e)
                })
                ...
                ajax.post("al_stories.php", {
                    ...
                    onDone: function() {
                        ...
                        val(e, E("stories_banned")), O(e, "disabled")
                    },
                    showProgress: T.pbind(e),
                    hideProgress: x.pbind(e)
                })
        ...
        C = function(e) {
            ...
            return s(t, e), t.prototype.componentDidMount = function() {
                ...
                var e = this.props.story.getCurStoryData(),
                    t = e.link;
                return S(t) ? u["default"].createElement("div", {
                ...
                }), w(this.refs.smileButton, "click", k), placeholderInit(this.refs.messageInput, {
                    editable: !0
                })) : this.emojiId && !this.refs.messageInput && (b(this.refs.smileButton, "click", k), Emoji.destroy(this.emojiId), delete this.emojiId)
                ...
                var e = _(Emoji.editableVal(this.refs.messageInput));
                this.setState({
    ...
    Object.defineProperty(t, "__esModule", {
            value: !0
        }), t.parseLatin = n, t.parseCyr = r, t.parseLatKeys = o, t.langNumeric = i, t.langSex = a, t.langStr = s, t.addLangKeys = l, t.getLang = u, t.langDate = c, t.getShortDate = d, t.getShortDateOrTime = p, t.langWordNumeric = f, t.getDateText = h, t.getBigDateNew = y, t.getSmDate = m, window.parseLatin = n,
        window.parseCyr = r, window.parseLatKeys = o, window.langNumeric = i, window.langSex = a, window.langStr = s, window.addLangKeys = l, window.getLang = u, window.langDate = c, window.getShortDate = d, window.getShortDateOrTime = p, window.langWordNumeric = f, window.getDateText = h, window.getBigDateNew = y, window.getSmDate = m
}, function(e, t) {
    "use strict";
    Object.defineProperty(t, "__esModule", {
        value: !0
