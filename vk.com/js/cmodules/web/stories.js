            ...
            U = function() {
                ...
                return e.prototype.destroy = function() {
                    ...
                    if (this.story) {
                        ...
                        this._replyHideEnd(), P(this.followBtn), val(this.authorButtons, ""),
                            P(this.answersEl), P(A("stories_reply_to", this.replyToWrap)), val(this.replyToWrap, ""), this.hideInlineLoader(), delete this.story
                    }
