    ...
    x625: function(e, t, s) {
        ...
        window.AdsEditEasyPromote = class e {
            ...
            static frameMessage(t) {
                ...
                var s = {};
                t.data && "{" === t.data.substr(0, 1) && "billing" !== (s = Object(i.k)(t.data)).type || ("submit" === t.data || "3dsPage" === s.action ? setTimeout(e.setCardFrameHeight.pbind(600), 200) : "3dsFinish" === s.action ? e.setCardFrameHeight() : "resizeFrame" === s.action && setTimeout(e.setCardFrameHeight.pbind(s.action_params.height), 200))
            }
