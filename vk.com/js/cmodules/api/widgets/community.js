! function(t) {
    ...
    window.Community = {
        init: function() {
            if (this.override("lite.js"), this.override("page.js"), stManager.emitter.addListener("update", this.override.bind(this)), 2 == cur.mode || 4 == cur.mode) {
            ...
            cur.Rpc = new fastXDM.Client({
                ...
                safe: !0
            }), cur.wallMyDeleted = {}, cur.mainDiv = ge("main"), Community.resizeWidget(), setTimeout(function() {
                Community.resizeWidget()
            }, 0)
        },
        ...
        changeGroupState: function(t, e) {
            var o = function() {
                ...
                cur.changinGroupState || (cur.changinGroupState = !0, lockButton(e), cur.noAuth ? (Widgets.oauth(), window.gotSession = function(o) {
                    -1 == o && (setTimeout(location.reload.bind(location), 1e3), location.href = location.href + "&1"), o && ajax.post("/widget_community.php", {
                        act: "a_get_info",
                        oid: cur.oid
                    }, {
                        onDone: function(o) {
                            o.hash && (cur.noAuth = !1, cur.justAuth = !0, cur.hash = o.hash, cur.changinGroupState = !1, Community.changeGroupState(t, e))
                        }
                    })
                }) : t && !cur.justAuth ? (unlockButton(e), cur.changinGroupState = !1, Widgets.showSubscribeBox(cur.oid, function() {
                    Community.sendStateEvent(t), o(!0)
                }, t)) : cur.justAuth || Community.sendChangeState(t, cur.oid, function() {
                    unlockButton(e), o(t), cur.changinGroupState = !1
                }, !1, function() {
                    unlockButton(e), cur.changinGroupState = !1
                }))
            }.bind(this);
            cur.confirmUnsubscribe && !t ? Widgets.showUnsubscribeBox(cur.oid, o) : o()
        },
        changeEventState: function(t, e) {
            ...
            cur.changinEventState || (cur.changinEventState = !0, lockButton(e), cur.noAuth ? (Widgets.oauth(), window.gotSession = function(o) {
                cur.noAuth = !1, ajax.post("/widget_community.php", {
                    ...
                    onDone: function(o) {
                        o.hash && (cur.hash = o.hash, cur.changinEventState = !1, Community.changeEventState(t, e))
                    }
                })
            }) : t > 0 && !cur.justAuth ? (unlockButton(e), cur.changinEventState = !1, Widgets.showSubscribeBox(cur.oid, function(e) {
                void 0 !== e && val("community_footer", e), Community.sendStateEvent(t), o(!0), Community.resizeWidget()
            }, t, !0)) : cur.justAuth || Community.sendChangeState(t, cur.oid, function(t) {
                void 0 !== t && val("community_footer", t), cur.changinEventState = !1, o(!1), Community.resizeWidget()
            }, 1, function() {
        ...
        showMore: function() {
            ...
            if (!buttonLocked(t) && isVisible(t)) {
                lockButton(t);
                var e = 0;
                for (post in cur.wallMyDeleted) cur.wallMyDeleted[post] && e++;
                ajax.post("/widget_community.php", {
                    act: "load_more",
                    offset: cur.offset - e,
                    oid: cur.oid,
                    ...
                    onDone: function(e, o, i) {
                        cur.offset += i, cur.offset >= o ? hide(t) : unlockButton(t), ge("page_wall_posts").appendChild(cf(e)), Community.resizeWidget(), setTimeout(Community.resizeWidget, 500)
                    }
                })
            }
        },
            ...
            if (StaticFiles[t] || e === !0) switch (t) {
                case "lite.js":
                    extend(window, {
                        ...
                        showWiki: function(t) {
                            if (t = (t && t.w || "").split("/"), "likes" == t[0]) Community.showLikesBox(t[1]);
                            else {
                                if ("shares" != t[0]) return !0;
                                Community.showLikesBox(t[1], {
                                    tab: "published"
                                })
                            }
                        },
