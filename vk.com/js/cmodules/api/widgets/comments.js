        ...
        window.WComments = {
            ...
            resizePostSizedThumbs: function(e, t, a, i, o) {
                var s = geByClass("page_post_thumb_wrap", e),
                    ...
                    h = positive(e.style.height),
                    _ = 0;
                if (t > u && (t = null), (i > h || o && s.length > 1) && (i = null), !i && t) i = Math.round(h * (t / u));
                else if (i && !t) t = Math.round(u * (i / h));
                else {
                    if (!t || !i) return;
                    o && (i = Math.min(i, Math.round(h * (t / u))), t = Math.round(u * (i / h)))
                }
                return each(s, function(e, t) {
                    ...
                    var s = 0,
                        ...
                        l = (t - a * o.x) / (u - a * o.x),
                        d = (i - a * o.y) / (h - a * o.y),
                        c = r.length - 1 == e ? i - _ : Math.round(o.height * d),
                        p = 0,
                        m = 0;
                    _ += c + a, each(o.tiles, function(e, i) {
                    ...
                    case "new_reply":
                        ...
                        if (isVisible("reply_link" + o)) re("reply_link" + o), show("replies_wrap" + o), c = !0;
                            ...
                            if (cur.wallMyOpened[o]) {
                                ...
                                var h = geByClass1("wr_header", d, "a"),
                                    _ = geByClass("reply", d, "div").length + 1,
                                    m = _;
                                h && (m = intval(h.getAttribute("offs").split("/")[1]) + 1), (m > 5 || m > _) && (h || (h = ce("a", {
                                    className: "wr_header"
                                }), d.insertBefore(h, d.firstChild)), Wall.updateRepliesHeader(o, h, _, m))
                                ...
                                if (extend(c, {
                                    ...
                                    if (u = se(rs(s.wallTpl.reply_fast, {
                                        ...
                                        if (w && "replies_open" == w.className && Wall.openNewComments(e), !o) {
                                            var f = geByClass1("wr_header", h, "a"),
                                                b = geByClass("reply", h, "div").length + 1,
                                                y = b;
                                            f && (y = intval(f.getAttribute("offs").split("/")[1]) + 1), (y > 5 || y > b) && (f || h.insertBefore(f = ce("a", {
                                                className: "wr_header"
                                            }), h.firstChild), Wall.updateRepliesHeader(e, f, b, y))
                                        }
                                    }
                                    s.reverse ? h.insertBefore(u, h.firstChild) : h.appendChild(u)
                                }
                            },
                        ...
                        window.MediaSelector = function(e, t, a, i) {
                                        ...
                                        setItems: function(e) {
                                            ...
                                            n.moreWrap = !1, n.lastTypes = e, each(e, function(e, t) {
                                                var c, p = t[0],
                                                    ...
                                                    h = t[2];
                                                if (l && (s ? p == s : e == i)) {
                                                    var _ = r.appendChild(ce("div", {
                                                        className: "ms_items_more_wrap"
                                                    }));
                                                    addEvent(_, "mouseover click", function(e) {
                                                        "mouseover" == e.type && n.touched || n.show()
                                                    }), addEvent(_, "mouseout", function() {
                                                        n.hide()
                                                    }), c = _.appendChild(ce("a", {
                                                    ...
                                                    }), m.appendChild(o), c = _.appendChild(m), n.moreWrap = _
                                                }
                                                c = (o ? o : r).appendChild(ce("a", {
                                                    innerHTML: o ? u : '<span class="blind_label">' + u + "</span>",
                                                    className: "ms_item ms_item_" + p + " _type_" + p
                                                })), c.setAttribute("tabindex", 0), o || (c.setAttribute("data-title", u), c.setAttribute("aria-label", u), c.setAttribute("role", "link"), addEvent(c, "mouseover", function() {
                                                    showTitle(this, !1, !1, {
                                                        noZIndex: !0
                                                    })
                                                })), h && addEvent(c, "click", function() {
                                                    return n.hide(!0), a.onItemClick && !a.onItemClick(p) ? !1 : (h(), !1)
                                                })
                                            })
                                        }
                                    });
                                return t && n.setItems(t), browser.msie && (removeEvent(e, "MSPointerDown"), addEvent(e, "MSPointerDown", n.activate.pbind(!0))), removeEvent(e, "mouseover"),
                                    addEvent(e, "mouseover click", n.activate), a.global || cur.destroy.push(function() {
                            ...
                            if (p) {
                                ...
                                var u, h = clean(p.id),
                                    _ = ge(t);
                                if (l) {
                                    _.innerHTML = '<div id="page_pics_preview' + h + '" class="page_pics_preview media_preview clear_fix"></div><div id="page_dpics_preview' + h + '" class="page_pics_preview post_thumbed_media page_media_sortable media_preview clear_fix"></div><div id="page_docs_preview' + h + '" class="page_docs_preview post_thumbed_media page_media_sortable media_preview clear_fix"></div><div id="page_pdocs_preview' + h + '" class="page_docs_preview media_preview clear_fix"></div><div id="page_ldocs_preview' + h + '" class="page_docs_preview media_preview clear_fix"></div><div id="page_mpics_preview' + h + '" class="page_pics_preview media_preview clear_fix"></div><div id="page_ppdocs_preview' + h + '" class="page_docs_preview media_preview clear_fix"></div><div id="page_progress_preview' + h + '" class="page_progress_preview media_preview clear_fix"></div>';
                                    var m = domFC(_),
                                        g = domNS(m),
                                        v = domNS(g),
                                        w = domNS(v),
                                        ...
                                        y = domNS(b),
                                        u = domNS(y);
                                    removeClass(_, "media_preview"), addClass(_, "multi_media_preview")
                                } else addClass(_, "med_no_attach"), show(_);
                                return s = {
                                    _addMediaLink: e,
                                    lnkId: h,
                                    menu: p,
                                    ...
                                    chooseMedia: function(t, a, o, r, u, y) {
                                        ...
                                        switch (t) {
                                            ...
                                            case "album":
                                                ...
                                                var R = "fl_l page_album_link" + (U ? "" : " page_album_nocover");
                                                S = '<a class="' + R + '" ' + x + ">                      " + (U ? '<div class="page_album_thumb_wrap"><img class="page_album_thumb" src="' + clean(U) + '"/></div>' : "") + '                        <div class="page_album_title">                          <div class="page_album_size">' + clean(o.count) + '</div>                          <div class="page_album_title_text">' + clean(o.title) + "</div>                        </div>                      </a>", N = 1, T = m;
                                                break;
                                            default:
                                                return
                                        }
                                        if (l) {
                                            ...
                                            addClass(F, N ? "fl_l" : "clear_fix"), void 0 !== o.upload_ind && re("upload" + o.upload_ind + "_progress_wrap"), i.toggleLnk && toggle(e, s.attachCount() + 1 < n), d && 1 === N ? (addClass(T, "editable_thumbs_wrap"), T = domLC(T) && hasClass(domLC(T), "editable_thumbs") ? domLC(T) : T.appendChild(ce("div", {
                                                ...
                                                domFC(T) ? ThumbsEdit.addMedia(T, r, o) : i.teWidth && i.teHeight ? ThumbsEdit.init(T, [r], {
                                                    ...
                                                    force: !0,
                                                    onUpdate: i.onChangedSize
                                                }), toggleClass(_, "media_preview_has_medias", s.hasVisibleRows()), i.onChangedSize && i.onChangedSize()
                                            }, !0)) : (show(T), T.appendChild(F), c && (T == v ? stManager.add(["sorter.js"], function() {
                                                var e = getXY(v),
                                                    t = getSize(v),
                                                    a = function() {
                                            ...
                                            }, !0)), i.onChangedSize && i.onChangedSize()), j.push([t, a, F, r])
                                        } else {
                                            var D = 0;
                                            "postpone" === t ? D = 1 : "mark_as_ads" === t && (D = 2);
                                            var F = se('<div class="' + (N === !1 ? "page_docs_preview" : "page_pics_preview") + (D ? "" : " post_thumbed_media") + '"><div class="page_preview_' + t + '_wrap"' + (i.nocl ? ' style="cursor: default"' : "") + I + ">" + S + '<div nosorthandle="1" class="page_media_x_wrap inl_bl" data-title="' + getLang("dont_attach") + '" onmouseover="showTitle(this)" onclick="cur.addMedia[' + s.lnkId + "].unchooseMedia(" + D + '); return cancelEvent(event);"><div class="page_media_x" nosorthandle="1"></div></div>' + P + "</div></div>");
                                            addClass(F, N ? "fl_l" : "clear_fix"), void 0 !== o.upload_ind && re("upload" + o.upload_ind + "_progress_wrap"), "postpone" !== t && "mark_as_ads" !== t && (s.chosenMedia = [t, a], s.chosenMediaData = o), s.singleAdded(F, t)
                                        }
                                        "share" == t ? o.title && !r ? (cur.shareShowImg = 0, s.showPreview(!0), s.shareData.images = !1) : s.showExternalPreview() : "page" == t ? o.nopreview || (cur.shareShowImg = 0, s.shareData = extend(s.shareData || {}, o, {
                                            images: !1
                                        }), s.showPreview()) : "poll" == t ? s.createPoll(o) : "postpone" == t ? s.setupPostpone(o, exp) : "mark_as_ads" == t && (s.markAsAds = 1), toggleClass(_, "media_preview_has_medias", s.hasVisibleRows()), i.onChangedSize && i.onChangedSize();
                                        var q = window.event;
                                        return q && "click" == q.type && (q.ctrlKey || q.metaKey || q.shiftKey) && (u = !0), cur.fileApiUploadStarted && void 0 !== o.upload_ind || cur.preventBoxHide || u === !0 || inArray(t, ["poll", "share", "page", "postpone", "mark_as_ads"]) || boxQueue.hideLast(), cur.lastPostMsg = !1, i.onMediaAdd && i.onMediaAdd(), cur.onMediaChanged && cur.onMediaChanged(), void 0 !== o.upload_ind && delete o.upload_ind, !1
                                    },
                                    unchooseMedia: function(t) {
                                        if (s.onChange && s.onChange(!1, t) === !1) return !1;
                                        if (l) {
                                            if (void 0 === t) return window.ThumbsEdit && ThumbsEdit.removeAll("thumbs_edit" + h), each(s.chosenMedias, function(e, t) {
                                            ...
                                            if (o[t]) {
                                                ...
                                                }), g.qsorter.destroy(), re(o[t][2]), g.childNodes.length > 1 && qsorter.init(g, s.qsorterOpts())) : re(o[t][2])) : ("photo" == o[t][0] || "video" == o[t][0] || "album" == o[t][0]) && window.ThumbsEdit && ThumbsEdit.removeById("thumbs_edit" + h, o[t][0] + o[t][1]), o[t][0]) {
                                                    case "page":
                                                    case "share":
                                            ...
                                            var c, a;
                                            if (void 0 == t && (t = 0), (a = geByClass("page_media_x_wrap", _, "div")[t]) && a.tt && a.tt.el && a.tt.destroy(), 1 == t && s.postponePreview) {
                                                show(geByClass1("add_media_type_" + h + "_postpone", p.menuNode, "a"));
                                                ...
                                                s.markAsAds = !1;
                                                var x = geByClass1("page_preview_mark_as_ads_wrap", _);
                                                ...
                                                if (s.postponePreview || s.markAsAds) {
                                                    for (var C = s.postponePreview && domPN(s.postponePreview), x = s.markAsAds && domPN(geByClass1("page_preview_mark_as_ads_wrap", _)), S = [], P = 0; P < _.childNodes.length; P++) {
                                                        var M = _.childNodes[P];
                                                ...
                                                } else val(_, ""), addClass(_, "med_no_attach"), p.setItems(p.types);
                                        ...
                                        toggleClass(_, "media_preview_has_medias", s.hasVisibleRows()), cur.onMediaChanged && cur.onMediaChanged(), cur.lastPostMsg = !1, s.onChange && s.onChange(!1)
                                    },
                                    singleAdded: function(t, a) {
                                        "postpone" === a ? _.appendChild(t) : "mark_as_ads" === a ? s.postponePreview ? _.insertBefore(t, domLC(_)) : _.appendChild(t) : domFC(_) ? _.insertBefore(t, domFC(_)) : _.appendChild(t), removeClass(_, "med_no_attach");
                                        var o = [];
                                    ...
                                    getMedias: function() {
                                        if (l) {
                                            var e = window.ThumbsEdit ? ThumbsEdit.getMedias("thumbs_edit" + h) : [],
                                                t = {},
                                                a = s.chosenMedias || [],
                                                i = [],
                                                o = function(e, a, o) {
                                    ...
                                    showMediaProgress: function(t, a, o) {
                                        ...
                                        if (m) {
                                            ...
                                            cur.attachMediaIndexes || (cur.attachMediaIndexes = {}), cur.attachMediaIndexes[p] = h;
                                    ...
                                    hasVisibleRows: function() {
                                        var e = !1;
                                        return each(geByClass("media_preview", _), function() {
                                    ...
                                    attachCount: function() {
                                        ...
                                        if (!_) return 0;
                                        if (!l) return _.childNodes.length - (s.postponePreview ? 1 : 0) - (s.markAsAds ? 1 : 0);
                                        var e = (d && window.ThumbsEdit ? (ThumbsEdit.cache()["thumbs_edit" + h] || {}).previews || [] : m.childNodes).length + g.childNodes.length + b.childNodes.length + v.childNodes.length / (v.sorter ? 2 : 1) + u.childNodes.length;
                                    ...
                                    createPoll: function(e) {
                                        ...
                                        e[22] ? "disabled" : "", e[8] ? "" : "disabled", s.pollPreview = w.appendChild(ce("div", {
                                            ...
                                            innerHTML: '                  <input onkeydown="cur.addMedia[' + h + '].keyPoll(this, event)" class="text dark medadd_c_pollq" id="create_poll_question' + h + '" value="' + (e.question || "") + '" />                  <div class="medadd_c_pollh">' + e.lang.a + '</div>                  <div class="medadd_c_pollans" id="create_poll_answers' + h + '"></div>                  <div class="medadd_c_polladd_wr" id="create_poll_add' + h + '">                    <div class="medadd_c_polladd fakeinput dark" onclick="cur.addMedia[' + h + '].incPoll()">' + e.lang.i + "</div>                  </div>" + (e.edit ? "" : '<div class="checkbox medadd_c_pollcb' + (e.anon ? " on" : "") + '" id="create_poll_anonymous' + h + '" onclick="checkbox(this);cur.addMedia[' + h + '].changedPoll();">' + e.lang.c + "</div>") + (e.pollSettings || "")
                                        })), e.answers || (e.answers = [
                                            [0, ""],
                                            [0, ""]
                                        ...
                                        for (var o = 0, r = e.answers.length; r > o; ++o) t = e.answers[o], i.push('<div class="medadd_c_polla_wr">' + rs(cur.pollAnswerTemplate, {
                                            ...
                                            lnkid: h
                                        }) + "</div>"), 9 == o && hide("create_poll_add" + h);
                                        return val("create_poll_answers" + h, i.join("")), e.question ? void elfocus("create_poll_question" + h) : (s.pollPreview.style.height = a, void animate(s.pollPreview, {
                                            height: 166
                                        }, 200, function() {
                                            s.pollPreview.style.height = "auto", elfocus("create_poll_question" + h)
                                        }))
                                    },
                                    incPoll: function() {
                                        var e = ge("create_poll_answers" + h),
                                        ...
                                        })))), toggle("create_poll_add" + h, a - 1 > t)
                                    },
                                    decPoll: function(e) {
                                        e.tt && e.tt.el && e.tt.destroy(), re(domPN(e)), show("create_poll_add" + h)
                                    },
                                    ...
                                    pollData: function(e) {
                                        for (var t, a = ge("create_poll_answers" + h), i = trim(val("create_poll_question" + h)), o = {
                                                media: i,
                                                anonymous: isChecked("create_poll_anonymous" + h)
                                            }, s = 0, r = !1, n = domFC(a); n; n = domNS(n))
                                            if (t = trim(val(domFC(n)))) {
                                                var l = -intval((domFC(n).id.match(/^create_poll_ans(\d+)$/) || [0, -s++])[1]);
                                                o["answers[" + l + "]"] = t, r = !0
                                            }
                                        return i ? r ? o : (domFC(a) || cur.addMedia[h].incPoll(), e !== !0 && notaBene(domFC(domFC(a))), !1) : (e !== !0 && notaBene("create_poll_question" + h), !1)
                                    },
                                    urlsCancelled: [],
                                    shareData: {},
                                        ...
                                        if (!(cur.noCheckMessageURLs || s.chosenMedia || s.urlAttachmentLoading && s.urlAttachmentLoading[0] > vkNow() - 1e4 || s.attachCount() >= n)) {
                                            ...
                                            for (var r in d) {
                                                var c = d[r],
                                                    ...
                                                    u = c.domain,
                                                    h = l;
                                                if (l.match(/^https?:\/\//) || (l = "http://" + l), !inArray(l, s.urlsCancelled) && !inArray(h, s.urlsCancelled)) {
                                                    var _ = !0;
                                                    if (u.match(/(^|\.|\/\/)(vkontakte\.ru|vk\.com)/) && (_ = p.match(/(#photo|^\/(photo|video|album|page|audio|doc)|z=(album|photo|video|audio_playlist)|w=(page|product))(-?\d+_)?\d+|\.(jpg|png|gif)$|market-?\d+\?section=album_\d+|^\/stickers\/.+$|^\/blog\/.+$|^http:\/\/instagram\.com\/p\/.+/) ? !0 : !1), _) return void s.checkURL(h, a)
                                                }
                                            }
                                        }
                                    },
                                    clearCheckURL: function() {
                                        clearTimeout(cur.checkURLTO), re(s.urlAttachmentLoading[2]), l ? toggle(u, u.childNodes > 0) : toggleClass(_, "med_no_attach", !_.childNodes), s.urlAttachmentLoading = !1, setStyle(bodyNode, {
                                            cursor: "default"
                                        })
                                    },
                                        ...
                                        if (r.images && (a = r.images[cur.shareShowImg], o = s.bigLink || r.big_link || a && isArray(a) && a[0] ? "medadd_c_linkimg_big" : ""), r.failed) var l = getLang("page_not_loaded");
                                            ...
                                            if (r.images && r.images[cur.shareShowImg] && p) {
                                                var u = r.images[cur.shareShowImg],
                                                    h = o ? 'style="width: 100%"' : r.imagesStyles && r.imagesStyles[cur.shareShowImg] || "";
                                                if (c = '<img class="medadd_c_linkimg" src="' + p + '" ' + d + " " + h + " />", c += o ? Page.buildMediaLinkEl(r.domain) : "", r.images.length > 0) {
                                                    var _ = (r.images.length > 1 ? '<div class="medadd_c_linkimg_scroll_wrap medadd_c_linkimg_scroll_wrap_left ' + (0 == cur.shareShowImg ? "medadd_c_linkimg_scroll_wrap_left_first" : "") + '" onclick="' + (0 == cur.shareShowImg ? "Page.ownerPhoto('" + r.media + "');" : "cur.shareShowNext(true);") + '"><div class="medadd_c_linkimg_scroll"></div></div>' : "", ""),
                                                        m = "";
                                                    cur.shareShowImg < r.images.length - 1 ? _ = '<div class="medadd_c_linkimg_scroll_wrap medadd_c_linkimg_scroll_wrap_right" onclick="cur.shareShowNext();"><div class="medadd_c_linkimg_scroll"></div></div>' : cur.shareShowImg == r.images.length - 1 && isArray(u) && u[0] && (_ = "");
                                    ...
                                    showExternalPreview: function() {
                                        ...
                                        cur.shareSetOwnPhoto = function(t) {
                                            ...
                                            var h = setTimeout(function() {
                                                show("medadd_c_linkimg_loader"), h = null, i.onChangedSize && i.onChangedSize()
                                            }, 100);
                                            cur.showLoaderTimeout = h;
                                            var _ = function() {
                                                if (n.width || n.height || !p) {
                                                    var t = n.width,
                                                        ...
                                                        i = "",
                                                        o = "";
                                                    if (u && (clearTimeout(u), u = null), h && (clearTimeout(h), h = null), hide("medadd_c_linkimg_loader"), clearInterval(cur.shareImgInterval), !isArray(e.images[cur.shareShowImg]) && (20 > t || 20 > a)) {
                                            ...
                                            clearInterval(cur.shareImgInterval), cur.shareImgInterval = setInterval(_, 300), cur.shareImgInterval2 = setTimeout(_, 0)
                                        }, cur.shareShowNext()
                                    },
                                    uploadShare: function(e) {
                                        var t = s.shareData,
                                            ...
                                            i = a.appendChild(ce("div", {
                                                innerHTML: '<iframe class="upload_frame" name="share_upload_iframe' + h + '"></iframe>'
                                            })),
                                            o = i.appendChild(ce("form", {
                                                action: "/share.php",
                                                method: "post",
                                                target: "share_upload_iframe" + h
                                            })),
                                    ...
                                    setupPostpone: function(e, t) {
                                        var a;
                                        a = l || y ? y : domPN(geByClass1("page_preview_postpone_wrap", _));
                                        var o = cur.editingPost && "wpe_media_preview" == domPN(a).id,
                                            r = o || !l ? "" : "1px",
                                            n = !1,
                                            d = '<div class="clear_fix">                  <div class="fl_l"><input type="hidden" id="postpone_date' + h + '" value="' + (e.date || "") + '" /></div>                  <div class="fl_l medadd_c_timerat">' + e.lang.profile_wall_postpone_at + '</div>                  <div class="fl_l"><input type="hidden" id="postpone_time' + h + '"/></div></div>';
                                        cur.editingPost && void 0 != e.friends_only ? (d += '<div class="medadd_c_timersett">', void 0 != e.status_export && (d += '<div class="checkbox_status_export' + (e.status_export ? " on" : "") + ' fl_l" id="status_export' + h + '" onclick="checkbox(this)" onmouseover="showTooltip(this, {text: \'' + e.lang.export_to_twitter + "', black: 1, shift: [12,4,0]});\"></div>"), void 0 != e.facebook_export && (d += '<div class="checkbox_facebook_export' + (e.facebook_export ? " on" : "") + ' fl_l" id="facebook_export' + h + '" onclick="checkbox(this)" onmouseover="showTooltip(this, {text: \'' + e.lang.export_to_facebook + "', black: 1, shift: [12,4,0]});\"></div>"), d += '<div class="checkbox' + (e.friends_only ? " on" : "") + ' fl_l" id="friends_only' + h + '" onclick="checkbox(this);checkbox(\'status_export' + h + "',!isChecked(this));checkbox('facebook_export" + h + "',!isChecked(this));\">" + e.lang.friends_only + "</div></div>", n = !0) : cur.editingPost && t && (d += t, n = !0), s.postponePreview = a.appendChild(ce("div", {
                                            ...
                                            new Datepicker("postpone_date" + h, {
                                                time: "postpone_time" + h,
                                                width: 155,
                                                noPast: !0,
                                                minStep: 1,
                                ...
                                }, cur.addMedia || (cur.addMedia = {}), cur.addMedia[h] = s, i.onAddMediaChange && (s.onChange = i.onAddMediaChange), s
                            }
                        }
                }
            }
