! function(e) {
    ...
    160: function(__webpack_module__, __webpack_exports__, __webpack_require__) {
        "use strict";
                                    ...
                                    chooseMedia: function(t, a, o, r, u, y) {
                                        ...
                                        switch (t) {
                                            case "graffiti":
                                                isObject(o) || (o = {
                                                    thumb: o || ""
                                                }), S = '<div class="fl_l page_preview_graffiti"><img class="page_preview_graffiti" src="' + clean(o.thumb) + '" /></div>', N = T = b;
                                                break;
                                            case "photo":
                                                isObject(o) || (o = {
                                                    thumb_m: o[0] || "",
                                                ...
                                                x = i.nocl ? "" : " onclick=\"return showPhoto('" + clean(a) + "', '" + o.list + "', {" + W.replace(/"/g, "&quot;") + '});"', S = "<div " + x + ' class="fl_l page_preview_photo' + (y ? " page_preview_ph_graff" : "") + '"><img class="page_preview_photo" src="' + clean(o.thumb_m) + '" /></div>', T = 1, N = m;
                                                break;
                                            case "video":
                                                if (isObject(o) || (o = {
                                                        thumb: o || ""
                                                ...
                                                x = i.nocl ? "" : " onclick=\"return showVideo('" + clean(a) + "', false, {queue:1});\"", S = "<div" + x + ' class="fl_l page_preview_video"><img class="page_preview_video" src="' + clean(o.thumb) + '" /></div>', T = 1, N = m;
                                                break;
                                            case "audio":
                                            ...
                                            case "audio_playlist":
                                                ...
                                                P = '<div class="audio_pl_snippet_small audio_pl_snippet_no_list audio_pl_snippet _audio_pl _audio_pl_' + E + ' audio_pl_attach_preview clear_fix"><div class="audio_pl_attach_preview__play audio_pl_snippet_play_small" onclick="return getAudioPlayer().playPlaylist(' + parseInt(o.ownerId) + ", " + parseInt(o.id) + ", " + z + ')"></div><div class="audio_pl_snippet__cover" style="' + L + '"></div><div class="audio_pl_snippet__info_title audio_pl__title">' + clean(unclean(o.title)) + '</div><div class="audio_pl_snippet__info_author_line">' + B + "</div></div>", S = '<span class="medadd_h">' + getLang("audio_attach_title_playlist") + "</span>", N = f;
                                                break;
                                            case "share":
                                            ...
                                            case "poll":
                                                if (!o.lang) return !1;
                                                S = '<div class="medadd_h medadd_h_poll inl_bl">' + clean(o.lang.q) + "</div>", hide(domByClass(p.menuNode, "_type_poll")), N = w;
                                                break;
                                            case "album":
                                                ...
                                                S = '<a class="' + j + '" ' + x + ">                    " + (U ? '<div class="page_album_thumb_wrap"><img class="page_album_thumb" src="' + clean(U) + '"/></div>' : "") + '                      <div class="page_album_title">                        <div class="page_album_size">' + clean(o.count) + '</div>                        <div class="page_album_title_text">' + clean(o.title) + "</div>                      </div>                    </a>", T = 1, N = m;
                                                break;
                                            default:
                                                return
                                        }
                                        if (l) {
                                            ...
                                            }, !0)) : (show(N), N.appendChild(q), c && (N == v ? stManager.add(["sorter.js"], function() {
                                                var e = getXY(v),
                                                    t = getSize(v),
                                                    a = function() {
                                                        v.sorter ? sorter.added(v) : N.childNodes.length > 1 && sorter.init(v, {
                                                            onReorder: i.onAddMediaChange
                                                        })
                                                    };
                                                e[0] || e[1] || t[0] || t[1] ? a() : cur.sorterClbk = a, i.onChangedSize && i.onChangedSize()
                                            }, !0) : N == g && stManager.add(["qsorter.js"], function() {
                                                g.qsorter ? qsorter.added(g) : N.childNodes.length > 1 && qsorter.init(g, s.qsorterOpts()), i.onChangedSize && i.onChangedSize()
                                            }, !0)), i.onChangedSize && i.onChangedSize()), R.push([t, a, q, r])
                                        } else {
                                            var D = 0;
                                            "postpone" === t ? D = 1 : "mark_as_ads" === t && (D = 2);
                                            var q = se('<div class="' + (T === !1 ? "page_docs_preview" : "page_pics_preview") + (D ? "" : " post_thumbed_media") + '"><div class="page_preview_' + t + '_wrap"' + (i.nocl ? ' style="cursor: default"' : "") + I + ">" + S + '<div nosorthandle="1" class="page_media_x_wrap inl_bl" data-title="' + getLang("dont_attach") + '" onmouseover="showTitle(this)" onclick="cur.addMedia[' + s.lnkId + "].unchooseMedia(" + D + '); return cancelEvent(event);"><div class="page_media_x" nosorthandle="1"></div></div>' + P + "</div></div>");
                                            addClass(q, T ? "fl_l" : "clear_fix"), void 0 !== o.upload_ind && re("upload" + o.upload_ind + "_progress_wrap"), "postpone" !== t && "mark_as_ads" !== t && (s.chosenMedia = [t, a], s.chosenMediaData = o), s.singleAdded(q, t)
                                        }
