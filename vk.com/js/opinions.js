function delete_opinion(id, out) {
    ...
    ajax.post("/opinions.php", {
        act: 'a_delete_opinion',
        id: id,
        out: out
    });
}
...
function clear_blacklist() {
    ...
    ajax.post("/opinions.php", {
        act: 'a_clear_blacklist',
        'hash': ge('clear_bl_hash').value
    });
}