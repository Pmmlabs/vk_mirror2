...
function initEditBox() {
    ...
    uiSince = new Dropdown(ge('since'), [
        [0, getLang('select_place_time_not_selected')]
    ].concat(selData.since_years), {
...
function enableAddAddress() {
    ...
    each(geByClass('separator', ge('addresses')), function() {
...
function deleteAddress(id) {
    ...
    ajax.post('editProfile.php', {
        act: 'a_edit_address',
        hash: ge('hash').value,
        aid: id
    }); // type not passed => deleted
    return false;
}
