...
function initVideoLinks() {
    if (video_no_flv) {
        ge('button240').style.display = 'block';
    }
    if (video_max_hd >= 1) {
        ge('button360').style.display = 'block';
    }
    if (video_max_hd >= 2) {
        ge('button480').style.display = 'block';
    }
    if (video_max_hd >= 3) {
        ge('button720').style.display = 'block';
    }
...
function logoOver() {
    ge('logo1').className = 'logo2';
}

function logoOut() {
    ge('logo1').className = 'logo1';
}
...
function updVol() {
    ...
    if (vol > 0.67) {
        vb.setAttribute('value', 'max');
    } else
    if (vol > 0.34) {
        vb.setAttribute('value', 'ave');
    } else
    if (vol > 0.1) {
        vb.setAttribute('value', 'min');
    } else {
