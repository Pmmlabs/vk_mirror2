...
profile_custom_snippet_photo_err_size='{sorry}.<br>Фотография должна иметь размер не меньше {width} точек в ширину и не меньше {height} точек в высоту.<br>Кроме того, нельзя использовать фотографии, у которых одна из сторон в несколько раз превышает другую.';
