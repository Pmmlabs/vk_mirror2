    ...
    function updateOnChange() {
        selector.old_setOptions({
            onChange: function(value) {
                ...
                if (options.houseSelect) {
                    options.houseSelect.setOptions({
                        street: value
                    });
                }
                if (options.placeSelect) {
                    options.placeSelect.setOptions({
                        street: value
                    });
                }
                if (isFunction(options.onChange)) {
    ...
    function cityUpdated(ignoreChildren) {
        ...
        if (options.city) {
            selectsData.getCityInfo(options.city, 16, function(cityInfo) {
                selector.setOptions({
                    enableCustom: realEnableCustom(!cityInfo.completed_streets)
                });
...
function StationDistrictSelect(fields, input, container, options) {
    ...
    options.baseItems = options.multiselect ? [] : [
        [0, options.placeholder]
    ];
    ...
    function cityUpdated() {
        ...
        if (options.city) {
            selectsData.getCityInfo(options.city, fields, function(cityInfo) {
                var new_options = {
                    defaultItems: options.baseItems.concat(cityInfo[options.obj])
                };
            ...
            selector.old_setOptions({
                defaultItems: options.baseItems
            });
            updateVisibility();
        }
    }
...
function DistrictSelect(input, container, options) {
    return StationDistrictSelect(2, input, container, extend(options, {
        placeholder: options.placeholder ? options.placeholder : getLang('select_district_not_selected'),
        obj: 'districts',
...
function SchoolSelect(input, container, type_input, type_container, options) {
    ...
    function updateChildren(new_value) {
        if (options.classSelect) {
            options.classSelect.setOptions({
                school: new_value
            });
        }
    }
    ...
    function cityUpdated() {
        ...
        if (options.city) {
            selectsData.getCityInfo(options.city, 4, function(cityInfo) {
                ...
                var new_options = {},
                    new_defaultItems = [],
                    new_enableCustom = realEnableCustom(!cityInfo.completed_schools);
                if (options.items_count < 101) {
                    if (options.items_count) {
                        new_defaultItems = [
                            [0, options.placeholder]
                        ].concat(cityInfo.schools);
                ...
                selector.setOptions({
                    enableCustom: new_enableCustom,
                    defaultItems: new_defaultItems
                });
                if (options.school) {
        ...
        if (options.country) {
            selectsData.getCountryInfo(options.country, fields, function(countryInfo) {
                var new_options = {
                    defaultItems: [
                        [0, options.placeholder]
                    ].concat(countryInfo[options.obj])
                };
...
function EducationFormSelect(input, container, options) {
    return EducationFormStatusSelect(2, input, container, extend(options, {
        placeholder: options.placeholder ? options.placeholder : getLang('select_eduform_not_selected'),
        obj: 'edu_forms',
        value: options.edu_form
    }));
}

function EducationStatusSelect(input, container, options) {
    return EducationFormStatusSelect(4, input, container, extend(options, {
        placeholder: options.placeholder ? options.placeholder : getLang('select_edustatus_not_selected'),
        obj: 'edu_statuses',
        value: options.edu_status
    }));
}
    ...
    function facultyUpdated() {
        ...
        if (options.faculty > 0) {
            selectsData.getFacultyInfo(options.faculty, function(facultyInfo) {
                ...
                if (realEnableCustom(!facultyInfo.completed_chairs)) {
                    selector.setOptions({
                        ...
                        defaultItems: [
                            [0, options.placeholder]
                        ].concat(facultyInfo.chairs)
                    });
                } else {
                    selector.setOptions({
                        autocomplete: (options.items_count > 10),
                        enableCustom: false,
                        defaultItems: []
                    });
                }
            ...
            if (options.faculty == 0) {
                ...
                selector.setOptions({
                    autocomplete: realEnableCustom(true),
                    enableCustom: realEnableCustom(true),
                    defaultItems: [
                        [0, options.placeholder]
                    ]
                });
...
function FacultySelect(input, container, options) {
    ...
    function updateChildren(new_value) {
        if (options.chairSelect) {
            options.chairSelect.setOptions({
                faculty: new_value
            });
        }
    }
            ...
            selectsData.getUniversityInfo(options.university, function(universityInfo) {
                ...
                if (realEnableCustom(!universityInfo.completed_faculties)) {
                    selector.setOptions({
                        ...
                        defaultItems: [
                            [0, options.placeholder]
                        ].concat(universityInfo.faculties)
                    });
                } else {
                    selector.setOptions({
                        autocomplete: (options.items_count > 10),
...
function UniversitySelect(input, container, options) {
    ...
    function updateChildren(new_value) {
        if (options.facultySelect) {
            options.facultySelect.setOptions({
                university: new_value
            });
        }
        if (options.eduFormSelect) {
            options.eduFormSelect.setOptions({
                university: new_value
            });
        }
        if (options.eduStatusSelect) {
            options.eduStatusSelect.setOptions({
                university: new_value
            });
        }
    }
...
function CitySelect(input, container, options) {
    ...
    function updateChildren(new_value) {
        ...
        if (opts.streetSelect) {
            opts.streetSelect.setOptions({
                city: new_value
            });
        }
        if (opts.stationSelect) {
            opts.stationSelect.setOptions({
                city: new_value
            });
        }
        if (opts.districtSelect) {
            opts.districtSelect.setOptions({
                city: new_value
            });
        }
        if (opts.placeSelect) {
            opts.placeSelect.setOptions({
                city: new_value
            });
        }
        if (opts.schoolSelect) {
            opts.schoolSelect.setOptions({
                city: new_value
            });
        }
        if (opts.universitySelect) {
            opts.universitySelect.setOptions({
                city: new_value
            });
        }
    }
...
function CountrySelect(input, container, options) {
    ...
    function updateChildren(new_value) {
        var opts = selector.options;
        if (opts.citySelect) {
            opts.citySelect.setOptions({
                country: new_value
            });
        }
        if (opts.eduFormSelect) {
            opts.eduFormSelect.setOptions({
                country: new_value
            });
        }
        if (opts.eduStatusSelect) {
            opts.eduStatusSelect.setOptions({
                country: new_value
            });
        }
        if (opts.classSelect) {
            opts.classSelect.setOptions({
                country: new_value
            });
        }
        if (opts.schoolSelect) {
