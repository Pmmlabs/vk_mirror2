    ...
    var HighchartsAdapter = function() {
        function p(c) {
            ...
            function a(a, c) {
                ...
                for (j in g)
                    if (f[j])
                        for (k = f[j].length; k--;) i(a, j, f[j][k])
            }
            ...
            init: function(c) {
                ...
                if (!Array.prototype.forEach) this.each = function(b, d) {
                    for (var a = 0, c = b.length; a < c; a++)
                        if (d.call(b[a], b[a], a, b) === !1) return a
                };
    ...
    (function() {
        ...
        Axis.prototype = {
            ...
            getTitlePosition: function() {
                ...
                return {
                    x: horiz ?
                        alongAxis : offAxis + (opposite ? this.width : 0) + offset +
                        (axisTitleOptions.x || 0), // x
                    y: horiz ?
                        offAxis - (opposite ? this.height : 0) + offset : alongAxis + (axisTitleOptions.y || 0) // y
                };
            },
        ...
        Series.prototype = {
            ...
            drawPoints: function() {
                var series = this,
                    ...
                    globallyEnabled = pick(
                        seriesMarkerOptions.enabled, !series.requireSorting || series.activePointCount < (0.5 * series.xAxis.len / seriesMarkerOptions.radius)
                    );
            ...
            destroy: function() {
                ...
                each(['area', 'graph', 'dataLabelsGroup', 'group', 'markerGroup', 'tracker',
                    'graphNeg', 'areaNeg', 'posClip', 'negClip'
                ], function(prop) {
                    if (series[prop]) {
        ...
        var ColumnSeries = extendClass(Series, {
            ...
            translate: function() {
                ...
                each(series.points, function(point) {
                    ...
                    point.tooltipPos = chart.inverted ? [yAxis.len - plotY, series.xAxis.len - barX - barW / 2] : [barX + barW / 2, plotY + yAxis.pos - chart.plotTop];
                    ...
                    if (dataLabel && !enabled) {
                        ...
                        if (dataLabel) {
                            ...
                            dataLabel = point.dataLabel = series.chart.renderer[rotation ? 'text' : 'label']( // labels don't support rotation
                                ...
                                .attr(attr)
                                .css(extend(options.style, cursor && {
                                    cursor: cursor
                                }))
                                .add(dataLabelsGroup)
                                .shadow(options.shadow);
