...
VkMap.prototype.updatePoints = function(points) {
    ...
    for (var i_point in points) {
        this.points.push({
            address: points[i_point].address,
            name: points[i_point].name
        });
    }
...
VkMap.prototype.yandexGetTypeControl = function() {
    var types = [
        [1, getLang('places_map_roadmap')],
        [2, getLang('places_map_satellite')],
        [3, getLang('places_map_hybrid')]
    ];
    var width = 80;
...
VkMap.prototype.yandexUpdateMapAddress = function() {
    ...
    function setCenter() {
        ...
        if (false && this.yandex.mapUpdated) {
            this.yandex.map.setZoom(this.address.zoomCalculated, {
                smooth: false
            });
            var this_ = this;
            this.yandex.map.panTo(this.yandex.pointer.getGeoPoint(), {
                flying: true,
                callback: function() {
                    finalUpdate.call(this_);
                }
            });
        } else {
    ...
    if (this.address.isDefault) {
        ...
        var geocoder = new YMaps.Geocoder(this.address.strCalculated, {
            results: 1
        });
        if (geocoder) {
...
VkMap.prototype.googleUpdateMapAddress = function() {
    ...
    if (this.address.isDefault) {
        ...
        if (geocoder) {
            var _this = this;
            geocoder.geocode({
                address: this.address.strCalculated
...
VkMap.prototype.yandexUpdateMapPoints = function() {
    ...
    function geocode(point) {
        var geocoderLocal = new YMaps.Geocoder(point.address, {
            results: 1
        });
