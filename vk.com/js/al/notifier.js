! function(t) {
    ...
    78: function(t, e, i) {
        ...
        i(88), i(91), i(90), i(89), i(87), i(86), i(92), window.getWndInner = a, window.lastWndScroll = [!1, !1], window.updateWndVScroll = o, window.defBox = s;
        try {
    ...
    87: function(t, e, i) {
        ...
        window.curFastChat || (window.curFastChat = {}), window.FastChat = {
                        ...
                        onDone: function(a) {
                            ...
                            for (var o in e) {
                                var s = e[o],
                                    r = ge("fc_msg" + s),
                                    n = r && r.parentNode;
                                r && (i.msgs[s] && i.msgs[s][1] && (i.msgs[s][1] = 0, i.msgs[s][0] || i.unread--), removeClass(r, "fc_msg_unread"), hasClass(n.parentNode, "fc_msgs_unread") && each(n.childNodes, function() {
            ...
            restoreDraft: function(t) {
                ...
                return !i || !e || !r || r.txt && val(i).length > r.txt.length && 0 === r.medias.length ? !1 : (e.editable ? i.innerHTML = Emoji.emojiToHTML(r.txt, 1) : val(i, r.txt || ""), setTimeout(function() {
