                ...
                return t.prototype.push = function(t) {
                    ...
                    for (var e, n = [], i = 0; i < t.length; i++)
                        if (this._truncateTo > 0 && (t[i] = Math.min(this._truncateTo, Math.abs(t[i]))), this._sampleCount += 1, this._sampleCount >= this._sampleRate)
                            for (; this._sampleCount >= this._sampleRate;) this._sampleCount -= this._sampleRate, this._sampleCount <= .8 && this._algorithm.push(t[i]), e = this._algorithm.get(), n.push(e), this._normalizeAlgorithm && this._normalizeAlgorithm.push(e), this._algorithm.clear(), this._sampleCount > .2 && this._algorithm.push(t[i]);
                    ...
                    if (this._normalizeAlgorithm) {
                        ...
                        if (this._normalizeAlgorithm.clear(), o > 0)
                            for (var r = 0; r < n.length; r++) n[r] = n[r] / o, this._truncateTo > 0 && (n[r] = Math.min(this._truncateTo, Math.abs(n[r])))
                    }
                    return n
                }, t
            }()
        ...
        e.Mp3Recorder = function(t) {
            ...
            return r(e, t), e.prototype._createWorker = function() {
                var t = this,
                    ...
                    n = new Worker("/js/al/speech_worker_mp3.js");
        ...
        e.OpusRecorder = function(t) {
            ...
            return r(e, t), e.prototype._createWorker = function(t) {
                var e = this,
                    ...
                    i = new Worker("/js/al/speech_worker_opus.js");
    ...
    150: function(t, e, n) {
        ...
        (0, r.initFailBack)(), e.AudioRecorder = function() {
            ...
            return t.prototype.addEventListener = function(t, e, n) {
                ...
                return window.MediaRecorder && o.mimeType ? e = new MediaRecorder(this._stream, o) : (o.mimeType || (o.mimeType = "audio/ogg;codecs=opus"), e = "audio/ogg;codecs=opus" == o.mimeType ? new s.OpusRecorder(this._stream, o) : new a.Mp3Recorder(this._stream, o)), this._mimeType = o.mimeType, e.addEventListener("dataavailable", function(t) {
                    n.duration = Math.round((Date.now() - n._start) / 1e3), n.eventTarget.dispatchEvent(new Event("progress")), i.push(t.detail || t.data)
                }), e.addEventListener("start", function() {
                    n._start = Date.now()
                }), e.addEventListener("stop", function() {
                    n.isRecording = !1, n.buffer = new Blob(i, {
                        type: o.mimeType
                    }), n.wave = (0, c.fastResample)(n._waveData, 256), n.eventTarget.dispatchEvent(new Event("finish"))
                }), e
    ...
    156: function(t, e, n) {
        ...
        e.Wave = function() {
            ...
            return t.prototype._getOption = function(t) {
                ...
                var t = this;
                if (!this._stopped) {
                    var e, n, i = this.timeAccumIndex + 1,
                        o = 0;
                    this._ctx.clearRect(0, 0, this._canvas.width, this._canvas.height), this._ctx.fillStyle = this._getOption("color");
                    for (var r = 0; r < this.timeAccumItems.length; r++, i++) i >= this.timeAccumItems.length && (i = 0), o = this.timeAccumItems[i] * (this._height - 2) + 2, e = r * (this._getOption("blockWidth") + this._getOption("spacing")), n = (this._height - o) / 2, this._ctx.fillRect(e * this._ratio, n * this._ratio, this._getOption("blockWidth") * this._ratio, o * this._ratio);
