(function(t, e, i) {
            ...
            (function(t, i, n) {
                ...
                s.Mixin = {}, s.Mixin.Events = {
                        addEventListener: function(t, e, i) {
                            ...
                            var n, o, r, l, h, c, u, p = this[a] = this[a] || {},
                                d = i && s.stamp(i);
                            for (t = s.Util.splitWords(t), n = 0, o = t.length; o > n; n++) r = {
                                action: e,
                                context: i || this
                            }, l = t[n], i ? (h = l + "_idx", c = h + "_len", u = p[h] = p[h] || {}, u[d] || (u[d] = [], p[c] = (p[c] || 0) + 1), u[d].push(r)) : (p[l] = p[l] || [], p[l].push(r));
                            return this
                        },
                        ...
                        fireEvent: function(t, e) {
                            ...
                            var i, n, o, r, l, h = s.Util.extend({}, e, {
                                ...
                                c = this[a];
                            if (c[t])
                                for (i = c[t].slice(), n = 0, o = i.length; o > n; n++) i[n].action.call(i[n].context || this, h);
                            r = c[t + "_idx"];
                            for (l in r)
                                if (i = r[l].slice())
                        ...
                        getViewportOffset: function(t) {
                            ...
                            do {
                                ...
                                if ("relative" === e && !a.offsetLeft) {
                                    var c = s.DomUtil.getStyle(a, "width"),
                                        u = s.DomUtil.getStyle(a, "max-width"),
                                        p = a.getBoundingClientRect();
                                    ("none" !== c || "none" !== u) && (o += p.left + a.clientLeft), n += p.top + (r.scrollTop || l.scrollTop || 0);
                                    break
                                }
                                a = a.offsetParent
                            } while (a);
                    ...
                    function() {
                        ...
                        distanceTo: function(t) {
                            ...
                            var e = 6378137,
                                ...
                                l = Math.sin(n / 2),
                                h = Math.sin(o / 2),
                                c = l * l + h * h * Math.cos(a) * Math.cos(r);
                        ...
                        getBoundsZoom: function(t, e, i) {
                            ...
                            var n, o = this.getMinZoom() - (e ? 1 : 0),
                                ...
                                c = !0;
                            i = s.point(i || [0, 0]);
                            do o++, n = this.project(h, o).subtract(this.project(l, o)).add(i), c = e ? n.x < r.x || n.y < r.y : r.contains(n); while (c && a >= o);
                        ...
                        project: function(t) {
                            var e = s.LatLng.DEG_TO_RAD,
                                ...
                                c = Math.sqrt(1 - h * h),
                                u = c * Math.sin(l);
                            u = Math.pow((1 - u) / (1 + u), .5 * c);
                            var p = Math.tan(.5 * (.5 * Math.PI - l)) / u;
                            return l = -o * Math.log(p), new s.Point(r, l)
                        },
                        unproject: function(t) {
                            for (var e, i = s.LatLng.RAD_TO_DEG, n = this.R_MAJOR, o = this.R_MINOR, a = t.x * i / n, r = o / n, l = Math.sqrt(1 - r * r), h = Math.exp(-t.y / n), c = Math.PI / 2 - 2 * Math.atan(h), u = 15, p = 1e-7, d = u, m = .1; Math.abs(m) > p && --d > 0;) e = l * Math.sin(c), m = Math.PI / 2 - 2 * Math.atan(h * Math.pow((1 - e) / (1 + e), .5 * l)) - c, c += m;
                            return new s.LatLng(c * i, a)
                        }
                        ...
                        getTileUrl: function(t, e) {
                            ...
                            return c + s.Util.getParamString(this.wmsParams, c, !0) + "&BBOX=" + h
                        },
                        ...
                        _sqClosestPointOnSegment: function(t, e, i, n) {
                            var o, a = e.x,
                                ...
                                h = i.y - r,
                                c = l * l + h * h;
                            return c > 0 && (o = ((t.x - a) * l + (t.y - r) * h) / c, o > 1 ? (a = i.x, r = i.y) : o > 0 && (a += l * o, r += h * o)), l = t.x - a, h = t.y - r, n ? l * l + h * h : new s.Point(a, r)
                        }
                        ...
                        closestLayerPoint: function(t) {
                            for (var e, i, n = 1 / 0, o = this._parts, a = null, r = 0, l = o.length; l > r; r++)
                                for (var h = o[r], c = 1, u = h.length; u > c; c++) {
                                    e = h[c - 1], i = h[c];
                        ...
                        var i, n, o, a, r, l, h, c, u, p = [1, 4, 2, 8],
                            d = s.LineUtil;
                        for (n = 0, h = t.length; h > n; n++) t[n]._code = d._getBitCode(t[n], e);
                        for (a = 0; 4 > a; a++) {
                            for (c = p[a], i = [], n = 0, h = t.length, o = h - 1; h > n; o = n++) r = t[n], l = t[o], r._code & c ? l._code & c || (u = d._getEdgeIntersection(l, r, c, e), u._code = d._getBitCode(u, e), i.push(u)) : (l._code & c && (u = d._getEdgeIntersection(l, r, c, e), u._code = d._getBitCode(u, e), i.push(u)), i.push(r));
                            t = i
                        }
                        return t
                    ...
                    function() {
                        ...
                        _containsPoint: function(t, e) {
                            var i, n, o, a, r, l, h, c = this.options.weight / 2;
                            for (s.Browser.touch && (c += 10), i = 0, a = this._parts.length; a > i; i++)
                                for (h = this._parts[i], n = 0, r = h.length, o = r - 1; r > n; o = n++)
                                    if ((e || 0 !== n) && (l = s.LineUtil.pointToSegmentDistance(t, h[o], h[n]), c >= l)) return !0;
                            return !1
                        }
                    } : {}), s.Polygon.include(s.Path.CANVAS ? {
                        _containsPoint: function(t) {
                            var e, i, n, o, a, r, l, h, c = !1;
                            if (s.Polyline.prototype._containsPoint.call(this, t, !0)) return !0;
                            for (o = 0, l = this._parts.length; l > o; o++)
                                for (e = this._parts[o], a = 0, h = e.length, r = h - 1; h > a; r = a++) i = e[a], n = e[r], i.y > t.y != n.y > t.y && t.x < (n.x - i.x) * (t.y - i.y) / (n.y - i.y) + i.x && (c = !c);
                            return c
                        }
                        ...
                        geometryToLayer: function(t, e, i) {
                            ...
                            switch (i = i || this.coordsToLatLng, h.type) {
                                case "Point":
                                    return n = i(c), e ? e(t, n) : new s.Marker(n);
                                case "MultiPoint":
                                    for (a = 0, r = c.length; r > a; a++) n = i(c[a]), l = e ? e(t, n) : new s.Marker(n), u.push(l);
                                    return new s.FeatureGroup(u);
                                case "LineString":
                                    return o = this.coordsToLatLngs(c, 0, i), new s.Polyline(o);
                                case "Polygon":
                                    return o = this.coordsToLatLngs(c, 1, i), new s.Polygon(o);
                                case "MultiLineString":
                                    return o = this.coordsToLatLngs(c, 1, i), new s.MultiPolyline(o);
                                case "MultiPolygon":
                                    return o = this.coordsToLatLngs(c, 2, i), new s.MultiPolygon(o);
                ...
                s.Marker.include(r), s.Circle.include(r), s.CircleMarker.include(r), s.Polyline.include({
                    ...
                    function() {
                        ...
                        addListener: function(t, e, i, o) {
                            ...
                            }, t.addEventListener(e, a, !1)) : t.addEventListener(e, a, !1) : "attachEvent" in t && t.attachEvent("on" + e, a), t[c] = a, this))
                        },
                        ...
                        _onDragEnd: function() {
                            ...
                            if (t.fire("dragend"), n) t.fire("moveend");
                                ...
                                var o = this._lastPos.subtract(this._positions[0]),
                                    ...
                                    l = o.multiplyBy(r / a),
                                    h = l.distanceTo([0, 0]),
                                    c = Math.min(e.inertiaMaxSpeed, h),
                                    u = l.multiplyBy(c / h),
                                    p = c / (e.inertiaDeceleration * r),
                                    d = u.multiplyBy(-p / 2).round();
                        ...
                        addDoubleTapListener: function(t, e, n) {
                            function o(t) {
                                ...
                                if (s.Browser.msTouch ? (m.push(t.pointerId), e = m.length) : e = t.touches.length, !(e > 1)) {
                                    var i = Date.now(),
                                        n = i - (r || i);
                                    l = t.touches ? t.touches[0] : t, h = n > 0 && c >= n, r = i
                                }
                            }
                        ...
                        _handleGeolocationResponse: function(t) {
                            ...
                            for (var u in t.coords) "number" == typeof t.coords[u] && (c[u] = t.coords[u]);
    ...
    18: [function(t, e, i) {
        (function() {
            (function(t, n) {
                ...
                var u = {};
                u.name = "mustache.js", u.version = "0.7.2", u.tags = ["{{", "}}"], u.Scanner = o, u.Context = s, u.Writer = a;
                var p = /\s*/,
                    d = /\s+/,
                    m = /\S/,
                    f = /\s*=/,
                ...
                u.escape = n, o.prototype.eos = function() {
                    return "" === this.tail
                    ...
                    if (t = t || "", n = n || u.tags, "string" == typeof n && (n = n.split(d)), 2 !== n.length) throw Error("Invalid tags: " + n.join(", "));
                    for (var a, r, m, v, y = c(n), L = new o(t), T = [], b = [], P = [], E = !1, x = !1; !L.eos();) {
                        ...
                        if (E = !0, r = L.scan(g) || "name", L.scan(p), "=" === r) m = L.scanUntil(f), L.scan(f), L.scanUntil(y[1]);
                            ...
                            var D = RegExp("\\s*" + i("}" + n[1]));
                            m = L.scanUntil(D), L.scan(_), L.scanUntil(y[1]), r = "&"
                        } else m = L.scanUntil(y[1]);
                        if (!L.scan(y[1])) throw Error("Unclosed tag at " + L.pos);
                        if ("/" === r) {
                            if (0 === T.length) throw Error('Unopened section "' + m + '" at ' + a);
                            var C = T.pop();
                            if (C[1] !== m) throw Error('Unclosed section "' + C[1] + '" at ' + a)
                        }
                        var S = [r, m, a, L.pos];
                    ...
                    var C = T.pop();
                    if (C) throw Error('Unclosed section "' + C[1] + '" at ' + L.pos);
                    return l(h(b))
                };
                var L = new a;
                ...
                }, u.compilePartial = function(t, e, i) {
            ...
            _update: function() {
                ...
                for (var e in this._legends)
                    if (this._legends.hasOwnProperty(e) && this._legends[e]) {
                        ...
                        i.className = "map-legend wax-legend", i.innerHTML = this.options.sanitizer(e), t = "block"
                    }
        ...
        var i = t("./geocoder"),
            n = L.Control.extend({
                ...
                _closeIfOpen: function() {
                    L.DomUtil.hasClass(this._container, "active") && (L.DomUtil.removeClass(this._container, "active"), this._results.innerHTML = "", this._input.blur())
                },
                onAdd: function(t) {
                    ...
                    return i.href = "#", i.innerHTML = "&nbsp;", a.type = "text", a.setAttribute("placeholder", "Search"), L.DomEvent.addListener(i, "click", this._toggle, this), L.DomEvent.addListener(s, "submit", this._geocode, this), L.DomEvent.disableClickPropagation(e), this._map = t, this._results = n, this._input = a, this._form = s, this._map.on("click", this._closeIfOpen, this), e
                },
                _geocode: function(t) {
                    L.DomEvent.preventDefault(t), L.DomUtil.addClass(this._container, "searching");
                    var e = this._map;
                    this.geocoder.query(this._input.value, L.bind(function(t, i) {
                        if (L.DomUtil.removeClass(this._container, "searching"), !t && i && i.results && i.results.length) {
                            if (this._results.innerHTML = "", 1 === i.results.length && i.lbounds) this._map.fitBounds(i.lbounds), this._closeIfOpen();
                                ...
                                for (var n = 0, o = Math.min(i.results.length, 5); o > n; n++) {
                                    for (var s = [], a = 0; i.results[n].length > a; a++) i.results[n][a].name && s.push(i.results[n][a].name);
                                    if (s.length) {
    ...
    10: [function(t, e) {
        ...
        var i = L.Control.extend({
            ...
            _share: function(t) {
                function e(t) {
                    if (t.originalEvent && "TEXTAREA" === t.originalEvent.target.nodeName) {
                        var e = t.originalEvent.target;
                        e.focus(), e.select()
                    } else t.originalEvent && "#close" === t.originalEvent.target.getAttribute("href") && this._clickOut(t);
                    L.DomEvent.stop(t.originalEvent)
                }
                L.DomEvent.stop(t);
                var i = this._tilejson || this._map._tilejson || {},
                    n = "http://twitter.com/intent/tweet?status=" + encodeURIComponent(i.name + "\n" + (i.webpage || window.location)),
                    o = "https://www.facebook.com/sharer.php?u=" + encodeURIComponent(this.options.url || i.webpage || window.location) + "&t=" + encodeURIComponent(i.name),
                    s = "<a class='leaflet-popup-close-button' href='#close'>Ã—</a>" + "<h3>Share this map</h3><div class='mapbox-share-buttons'><a class='mapbox-share-facebook mapbox-icon mapbox-icon-facebook' target='_blank' href='{{facebook}}'>Facebook</a><a class='mapbox-share-twitter mapbox-icon mapbox-icon-twitter' target='_blank' href='{{twitter}}'>Twitter</a></div>".replace("{{twitter}}", n).replace("{{facebook}}", o) + "<h3>Get the embed code</h3><small>Copy and paste this HTML into your website or blog.</small>" + "<textarea rows=4>{{value}}</textarea>".replace("{{value}}", "&lt;iframe width='500' height='300' frameBorder='0' src='{{embed}}'&gt;&lt;/iframe&gt;".replace("{{embed}}", i.embed || window.location));
                this._popup = L.marker(this._map.getCenter(), {
                    ...
                    L.DomEvent.stopPropagation(t.originalEvent)
                }).on("click", e, this).addTo(this._map)
            }
        });
        e.exports = function(t, e) {
            return new i(t, e)
    ...
    19: [function(t, e) {
        (function() {
            var t = function() {
                    ...
                    function e(t, e, s, a, r, h, c) {
                        var u = new l(n(t, m), n(e, m), i(s), a > 0 ? "" + a : null, n(r, f), null, i(c));
                        return h && ("string" == typeof h ? u.setRawQuery(h.replace(/[^?&=0-9A-Za-z_\-~.%]/g, o)) : u.setAllParameters(h)), u
                    }
            ...
            var n = function(e) {
                    ...
                    function u(t, i, n, o, s) {
                        try {
                            t.startDoc && 0 == n && t.startDoc(s);
                            for (var a, r, l, h = n, u = i.length; u > h;) {
                                var p = i[h++],
                                    _ = i[h];
                                switch (p) {
                                    case "&":
                                        z.test(_) ? (t.pcdata && t.pcdata("&" + _, s, V, c(t, i, h, o, s)), h++) : t.pcdata && t.pcdata("&amp;", s, V, c(t, i, h, o, s));
                                        break;
                                    case "</":
                                        (a = /^([-\w:]+)[^\'\"]*/.exec(_)) ? a[0].length === _.length && ">" === i[h + 1] ? (h += 2, l = a[1].toLowerCase(), t.endTag && t.endTag(l, s, V, c(t, i, h, o, s))) : h = d(i, h, t, s, V, o): t.pcdata && t.pcdata("&lt;/", s, V, c(t, i, h, o, s));
                                        break;
                                    case "<":
                                        if (a = /^([-\w:]+)\s*\/?/.exec(_))
                                            if (a[0].length === _.length && ">" === i[h + 1]) {
                                                h += 2, l = a[1].toLowerCase(), t.startTag && t.startTag(l, [], s, V, c(t, i, h, o, s));
                                                var g = e.ELEMENTS[l];
                                                if (g & q) {
                                                    var v = {
                                                        name: l,
                                        ...
                                        else t.pcdata && t.pcdata("&lt;", s, V, c(t, i, h, o, s));
                                        break;
                                    case "<!--":
                                        if (!o.noMoreEndComments) {
                                            for (r = h + 1; u > r && (">" !== i[r] || !/--$/.test(i[r - 1])); r++);
                                            if (u > r) {
                                                if (t.comment) {
                                                    var y = i.slice(h, r).join("");
                                                    t.comment(y.substr(0, y.length - 2), s, V, c(t, i, r + 1, o, s))
                                                }
                                                h = r + 1
                                            } else o.noMoreEndComments = !0
                                        }
                                        o.noMoreEndComments && t.pcdata && t.pcdata("&lt;!--", s, V, c(t, i, h, o, s));
                                        break;
                                    case "<!":
                                        if (/^\w/.test(_)) {
                                            if (!o.noMoreGT) {
                                                for (r = h + 1; u > r && ">" !== i[r]; r++);
                                                u > r ? h = r + 1 : o.noMoreGT = !0
                                            }
                                            o.noMoreGT && t.pcdata && t.pcdata("&lt;!", s, V, c(t, i, h, o, s))
                                        } else t.pcdata && t.pcdata("&lt;!", s, V, c(t, i, h, o, s));
                                        break;
                                    case "<?":
                                        if (!o.noMoreGT) {
                                        ...
                                        break;
                                    case ">":
                                        t.pcdata && t.pcdata("&gt;", s, V, c(t, i, h, o, s));
                                        break;
                                    case "":
                                        break;
                                    default:
                                        t.pcdata && t.pcdata(p, s, V, c(t, i, h, o, s))
                                }
                            }
                            t.endDoc && t.endDoc(s)
                        } catch (L) {
                    ...
                    function d(t, e, i, n, o, s) {
                        var a = _(t, e);
                        return a ? (i.endTag && i.endTag(a.name, n, o, c(i, t, e, s, n)), a.next) : t.length
                    }

                    function m(t, e, i, n, o, s) {
                        var a = _(t, e);
                        return a ? (i.startTag && i.startTag(a.name, a.attrs, n, o, c(i, t, a.next, s, n)), a.eflags & q ? f(t, a, i, n, o, s) : a.next) : t.length
                    }

                    function f(t, i, n, o, s, a) {
                        var l = t.length;
                        J.hasOwnProperty(i.name) || (J[i.name] = RegExp("^" + i.name + "(?:[\\s\\/]|$)", "i"));
                        for (var h = J[i.name], u = i.next, p = i.next + 1; l > p && ("</" !== t[p - 1] || !h.test(t[p])); p++);
                        l > p && (p -= 1);
                        var d = t.slice(u, p).join("");
                        if (i.eflags & e.eflags.CDATA) n.cdata && n.cdata(d, o, s, c(n, t, p, a, o));
                        else {
                            if (!(i.eflags & e.eflags.RCDATA)) throw Error("bug");
                            n.rcdata && n.rcdata(r(d), o, s, c(n, t, p, a, o))
                        }
                        return p
                    }
                            ...
                            startTag: function(o, s, r) {
                                if (!n && e.ELEMENTS.hasOwnProperty(o)) {
                                    ...
                                    if (!(l & e.eflags.FOLDABLE)) {
                                        ...
                                        s = h.attribs;
                                        var c, u;
                                        if ("tagName" in h ? (u = h.tagName, c = e.ELEMENTS[u]) : (u = o, c = l), l & e.eflags.OPTIONAL_ENDTAG) {
                                            var p = i[i.length - 1];
                                            !p || p.orig !== o || p.rep === u && o === u || r.push("</", p.rep, ">")
                                        }
                                        ...
                                        r.push(">"), l & e.eflags.EMPTY && !(c & e.eflags.EMPTY) && r.push("</", u, ">")
                                    }
                                }
                            },
                            endTag: function(t, o) {
                    ...
                    function E(t, i, n, o, s) {
                        for (var a = 0; i.length > a; a += 2) {
                            var r, l = i[a],
                                ...
                                c = h,
                                u = null;
                            if (r = t + "::" + l, (e.ATTRIBS.hasOwnProperty(r) || (r = "*::" + l, e.ATTRIBS.hasOwnProperty(r))) && (u = e.ATTRIBS[r]), null !== u) switch (u) {
                                case e.atype.NONE:
                                    break;
                                case e.atype.SCRIPT:
                                ...
                                case e.atype.STYLE:
                                    ...
                                    }), h = p.length > 0 ? p.join(" ; ") : null, s && L(s, t, l, c, h);
                                    break;
                                case e.atype.ID:
                                case e.atype.IDREF:
                                case e.atype.IDREFS:
                                ...
                                case e.atype.URI_FRAGMENT:
                                    h && "#" === h.charAt(0) ? (h = h.substring(1), h = o ? o(h) : h, null !== h && void 0 !== h && (h = "#" + h)) : h = null, s && L(s, t, l, c, h);
                                    break;
                                default:
                                    h = null, s && L(s, t, l, c, h)
                            } else h = null, s && L(s, t, l, c, h);
                            i[a + 1] = h
                        }
                        return i
                    }
                    ...
                    var D, C, S;
                    "undefined" != typeof window && (D = window.parseCssDeclarations, C = window.sanitizeCssProperty, S = window.cssSchema);
                    var k = {
                            lt: "<",
                            LT: "<",
                            gt: ">",
            ...
            o = L.Control.extend({
                ...
                _click: function(t) {
                    ...
                    if (this.options.pinnable) {
                        ...
                        !i && this.options.touchTeaser && L.Browser.touch && (i = this._template("teaser", t.data)), i ? (L.DomUtil.addClass(this._container, "closable"), this._pinned = !0, this._show(i, t)) : this._pinned && (L.DomUtil.removeClass(this._container, "closable"), this._pinned = !1, this._hide())
                    }
                },
            ...
            if (!e("json")) {
                ...
                if (o = function(t, e) {
                        ...
                        return i = o = null, l ? r = 2 == l ? function(t, e) {
                            ...
                            var i, s, r = a.call(t) == u,
                                l = !r && "function" != typeof t.constructor && b(t, "hasOwnProperty") ? t.hasOwnProperty : n;
                    ...
                    var P = {
                        ...
                        D = function(t, e, i, r, l, h, c) {
                            var u, g, y, T, b, P, E, w, C, S, k, A, U, O, I, B, R = e[t];
                            try {
                                R = e[t]
                            } catch (z) {}
                            if ("object" == typeof R && R)
                                if (u = a.call(R), u != p || n.call(R, "toJSON")) "function" == typeof R.toJSON && (u != d && u != m && u != f || n.call(R, "toJSON")) && (R = R.toJSON(t));
                                else if (R > -1 / 0 && 1 / 0 > R) {
                                if (L) {
                                    for (T = v(R / 864e5), g = v(T / 365.2425) + 1970 - 1; T >= L(g + 1, 0); g++);
                                    for (y = v((T - L(g, 0)) / 30.42); T >= L(g, y + 1); y++);
                                    T = 1 + T - L(g, y), b = (R % 864e5 + 864e5) % 864e5, P = v(b / 36e5) % 24, E = v(b / 6e4) % 60, w = v(b / 1e3) % 60, C = b % 1e3
                                } else g = R.getUTCFullYear(), y = R.getUTCMonth(), T = R.getUTCDate(), P = R.getUTCHours(), E = R.getUTCMinutes(), w = R.getUTCSeconds(), C = R.getUTCMilliseconds();
                                R = (0 >= g || g >= 1e4 ? (0 > g ? "-" : "+") + x(6, 0 > g ? -g : g) : x(4, g)) + "-" + x(2, y + 1) + "-" + x(2, T) + "T" + x(2, P) + ":" + x(2, E) + ":" + x(2, w) + "." + x(3, C) + "Z"
                            } else R = null;
                            if (i && (R = i.call(e, t, R)), null === R) return "null";
                            if (u = a.call(R), u == _) return "" + R;
                            if (u == d) return R > -1 / 0 && 1 / 0 > R ? "" + R : "null";
                            if (u == m) return M("" + R);
                            if ("object" == typeof R) {
                                for (U = c.length; U--;)
                                    if (c[U] === R) throw TypeError();
                                if (c.push(R), S = [], O = h, h += l, u == f) {
                                    for (A = 0, U = R.length; U > A; I || (I = !0), A++) k = D(A, R, i, r, l, h, c), S.push(k === s ? "null" : k);
                                    B = I ? l ? "[\n" + h + S.join(",\n" + h) + "\n" + O + "]" : "[" + S.join(",") + "]" : "[]"
                                } else o(r || R, function(t) {
                                    var e = D(t, R, i, r, l, h, c);
                                    e !== s && S.push(M(t) + ":" + (l ? " " : "") + e), I || (I = !0)
                                }), B = I ? l ? "{\n" + h + S.join(",\n" + h) + "\n" + O + "}" : "{" + S.join(",") + "}" : "{}";
                                return c.pop(), B
                            }
                        };
                    l.stringify = function(t, e, i) {
                        ...
                        return D("", (r = {}, r[""] = t, r), o, s, n, "", [])
                    }
                }
                if (!e("json-parse")) {
                    var C, S, k = String.fromCharCode,
                        A = {
                            92: "\\",
                            34: '"',
                            47: "/",
                        ...
                        U = function() {
                            throw C = S = null, SyntaxError()
                        },
                        O = function() {
                            for (var t, e, i, n, o, s = S, a = s.length; a > C;) switch (o = s.charCodeAt(C)) {
                                case 9:
                                case 10:
                                case 13:
                                case 32:
                                ...
                                case 58:
                                case 44:
                                    return t = g ? s.charAt(C) : s[C], C++, t;
                                case 34:
                                    for (t = "@", C++; a > C;)
                                        if (o = s.charCodeAt(C), 32 > o) U();
                                        else if (92 == o) switch (o = s.charCodeAt(++C)) {
                                        case 92:
                                        case 34:
                                        case 47:
                                        case 98:
                                        ...
                                        case 114:
                                            ...
                                            break;
                                        case 117:
                                            for (e = ++C, i = C + 4; i > C; C++) o = s.charCodeAt(C), o >= 48 && 57 >= o || o >= 97 && 102 >= o || o >= 65 && 70 >= o || U();
                                            t += k("0x" + s.slice(e, C));
                                            break;
                                        default:
                                            U()
                                        ...
                                        if (34 == o) break;
                                        for (o = s.charCodeAt(C), e = C; o >= 32 && 92 != o && 34 != o;) o = s.charCodeAt(++C);
                                        t += s.slice(e, C)
                                    }
                                    if (34 == s.charCodeAt(C)) return C++, t;
                                    U();
                                default:
                                    if (e = C, 45 == o && (n = !0, o = s.charCodeAt(++C)), o >= 48 && 57 >= o) {
                                        for (48 == o && (o = s.charCodeAt(C + 1), o >= 48 && 57 >= o) && U(), n = !1; a > C && (o = s.charCodeAt(C), o >= 48 && 57 >= o); C++);
                                        if (46 == s.charCodeAt(C)) {
                                            for (i = ++C; a > i && (o = s.charCodeAt(i), o >= 48 && 57 >= o); i++);
                                            i == C && U(), C = i
                                        }
                                        if (o = s.charCodeAt(C), 101 == o || 69 == o) {
                                            for (o = s.charCodeAt(++C), (43 == o || 45 == o) && C++, i = C; a > i && (o = s.charCodeAt(i), o >= 48 && 57 >= o); i++);
                                            i == C && U(), C = i
                                        }
                                        return +s.slice(e, C)
                                    }
                                    if (n && U(), "true" == s.slice(C, C + 4)) return C += 4, !0;
                                    if ("false" == s.slice(C, C + 5)) return C += 5, !1;
                                    if ("null" == s.slice(C, C + 4)) return C += 4, null;
                                    U()
                            }
                            return "$"
                        },
                        I = function(t) {
                            ...
                            if ("$" == t && U(), "string" == typeof t) {
                                ...
                                if ("[" == t) {
                                    for (e = []; t = O(), "]" != t; i || (i = !0)) i && ("," == t ? (t = O(), "]" == t && U()) : U()), "," == t && U(), e.push(I(t));
                                    return e
                                }
                                if ("{" == t) {
                                    for (e = {}; t = O(), "}" != t; i || (i = !0)) i && ("," == t ? (t = O(), "}" == t && U()) : U()), ("," == t || "string" != typeof t || "@" != (g ? t.charAt(0) : t[0]) || ":" != O()) && U(), e[t.slice(1)] = I(O());
                                    return e
                                }
                                U()
                            }
                    ...
                    l.parse = function(t, e) {
                        var i, n;
                        return C = 0, S = "" + t, i = I(O()), "$" != O() && U(), C = S = null, e && a.call(e) == u ? R((n = {}, n[""] = i, n), "", e) : i
                    }
                }
            }
            r && define(function() {
