...
var uiTabs = {
    ...
    uiSearch = {
        destroy: function(t) {
            ...
            uiSearch.stopEvents(e), removeData(e)
        },
        ...
        init: function(el, options) {
            if (el && (el = uiSearch.getFieldEl(el))) {
                ...
                if (!data(el, "inited")) {
                    ...
                    if (placeholderInit(el), data(el, "opts", options), options.suggester) {
                        options.suggester.instance = new Suggester(el, extend(options.suggester, {
                            ...
                            onSearch: function(t, e, i) {
                                t || (options.allowFiltersForEmpty || uiSearch.removeAllFilters(el), uiSearch.hideProgress(el)), toggleClass(wrapEl, "ui_search_field_empty", !t), options.onChange && options.onChange.call(el, t, e, i)
                            }
                        }));
                        var mainHandler = {
                            start: function() {
                    ...
                    options.fixed && uiSearch.setFixed(el), options.noAutoDestroy || cur.destroy.push(uiSearch.stopEvents.pbind(el)), uiSearch.initFilters(el, options), isFunction(options.onInit) && options.onInit(el, options)
                }
            }
        },
        ...
        onChanged: function(t, e, i) {
            ...
            toggleClass(o, "ui_search_field_empty", !trim(n)), n || s.allowFiltersForEmpty || uiSearch.removeAllFilters(t), e || s.onChange && s.onChange.call(t, n, i)
        },
        focus: function(t) {
    ...
    uiScroll = function() {
        ...
        return t.prototype = {
            ...
            fixBlocker: function() {
                browser.chrome && !this.options.noForceReFlow && this.forceReFlow(), this.el.blocker.scrollTop = this.blockerScrollTop
            },
            forceReFlow: function() {
                this.el.blocker.style.display = "inline-block", this.el.blocker.offsetHeight, this.el.blocker.style.display = ""
            },
            fixSize: function(t) {
