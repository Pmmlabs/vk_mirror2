...
window.Widgets = {
    ...
    popupBoxAdjust: function(startWidth, startHeight, opts) {
        ...
        function sL() {
            return window.screenX !== void 0 ? screenX : window.screenLeft;
        }

        function sT() {
            return window.screenY !== void 0 ? screenY : window.screenTop;
        }
