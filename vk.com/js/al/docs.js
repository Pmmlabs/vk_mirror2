var Docs = {
    ...
    getDocHTML: function(e) {
        var o = e[0],
            ...
            d = e[10] ? e[10] : "",
            l = "/doc" + a + "_" + o,
            h = a == vk.id || u == vk.id || a == cur.oid && a < 0 && cur.groupAdmin;
    ...
    globalSearch: function(more) {
        ...
        var ts = +new Date;
        !more && cur.found && saveSearchAttemptStats("docs", ts, cur.found);
            ...
            if (searchStr == cur.searchStr) {
                var options = {
                    onDone: function(list, shown, count) {
                        ...
                        return more || cur.found || saveSearchAttemptStats("docs", ts, count), Docs.processGlobalSearch(searchStr, !more, list, shown, count)
                    },
        ...
        return cur.found || saveSearchAttemptStats("docs", ts, cache[2]), Docs.processGlobalSearch(searchStr, !0, cache[0], cache[1], cache[2])
    },
    ...
    deleteItem: function(e, c, s, o) {
        var t = domClosest("_docs_item", e);
        if (t) return e && window.tooltips && tooltips.destroy(e), ajax.post("/docs.php", {
            act: "a_delete",
            hash: o,
            did: s,
            oid: c
            ...
            onDone: function(e) {
                addClass(t, "docs_item_deleted");
                var o = ge("docs_restore_row" + c + "_" + s);
                o && (o.innerHTML = e);
                for (var r = cur.docs.length; r--;) {
                    cur.docs[r][0] == s && (cur["item_restore" + s] = [cur.docs.splice(r, 1)[0], r], cur.index.remove(cur["item_restore" + s][0]), cur.typesChanged = !0)
                }
                cur.count -= 1, cur.found -= 1, cur.list = {}
            },
            showProgress: addClass.pbind(t, "docs_item_loading"),
            hideProgress: removeClass.pbind(t, "docs_item_loading")
        }), !1
    },
    ...
    showFileTT: function(o, e, r) {
        ...
        "gif" == e && (cur.fileTT = setTimeout(function() {
            var e = r + "?wnd=1";
            cur.fileTTImage = new vkImage, cur.fileTTImage.src = e, cur.fileTTImage.onload = function() {
