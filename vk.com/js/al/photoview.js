var Photoview = {
            ...
            if (o) {
                ...
                for (var i in r)
                    if (r[i]) {
                        ...
                        var n = geByTag1("img", r[i]);
                        n && (n.src = o, setStyle(n, {
                            height: "auto"
                        }))
                    }
                if (cur.pvNoTemp || (cur.pvNoTemp = {}), cur.pvNoTemp[cur.filterPhoto] = !0, window.ThumbsEdit && e) {
                    ...
                    for (var i in s) {
                        var v = s[i].previews || [],
                            c = !1;
                        for (var u in v) "photo" == v[u].type && v[u].photo.id == "photo" + t && (v[u].photo.sizes = e, c = !0);
                            ...
                            for (var s in p) {
                                ...
                                for (var l in c) {
                                    if ("photo" == c[l].type && c[l].photo.id == "photo" + o.id) {
                                        ...
                                        c[l].click = v.showPhoto.pbind(e.id, e.list, parseJSON(a)), c[l].itemId = h.pid, h.sizes = r, u = !0
                                    }
                                    d++
                                }
                                u && (ThumbsEdit.refresh(s), v.onChange && v.onChange())
                            }
                        }
        ...
        onImageWrapMouseDown: function(o) {
            if (2 != o.button && !cur.pvEditorMode && !cur.pvTagger && checkEvent(o) === !1) {
                var e = cur.pvIndex;
                return Photoview.updateNavBtnsLeftThreshold(), o.pageX < cur.pvLeftBtnAmount ? e -= 1 : e += 1, cur.pvPointerPosition = [o.pageX, o.pageY], Photoview.show(!1, e, o)
            }
        },
        onImageWrapMouseLeave: function(o) {
            removeClass(cur.pvNavBtnLeft, "pv_nav_btn_show"), removeClass(cur.pvNavBtnRight, "pv_nav_btn_show"), removeClass(cur.pvImageAreaWrap, "pv_init_hover"), Photoview.updateNavBtnsLeftThreshold(!0)
        },
        onImageWrapMouseMove: function(o) {
            Photoview.updateNavBtnsLeftThreshold(), toggleClass(cur.pvNavBtnLeft, "pv_nav_btn_show", o.pageX < cur.pvLeftBtnAmount), toggleClass(cur.pvNavBtnRight, "pv_nav_btn_show", o.pageX > cur.pvLeftBtnAmount)
        },
                    ...
                    if (!i && !cur.pvCanvas) {
                        if (cur.pvJumpTo) {
                            ...
                            if (s > 0 && (p < cur.pvJumpFrom && p + 4 > cur.pvJumpFrom || p < cur.pvJumpFrom + a && p + 4 > cur.pvJumpFrom + a)) {
                                ...
                                var v = cur.pvJumpTo.z.match(/^albums(-?\d+)$/);
                                v && (cur.pvAlbumsData || (cur.pvAlbumsData = {}), cur.pvAlbumsData[v[1]] || (cur.pvAlbumsData[v[1]] = "loading", ajax.post("al_photos.php", {
                                    act: "show_albums",
                                    owner: v[1],
                                    other: 1
                                }, {
        ...
        doShow: function() {
            ...
            if (cur.pvShown) {
                ...
                cur.pvTagger && Phototag.stopTag(), Photoview.hideTag(!0), (e.width < 200 || e.height < 200) && (p.actions.prof = !1, p.actions.dialog = !1);
                var n = "";
                ("NA" != p.album && 2 != s || p.graffiti) && (n = p.album);
                var v = !p.album || !p.author;
                if (!cur.pvIsLightMode && !v) {
                    var c = "";
                    ...
                    var d = cur.pvCommsLikes[p.id],
                        l = d[0],
                        h = d[1];
                    c += Likes.makeTemplate(p.likes_tpl, {
                        object_raw: p.id,
                        likes_count: h || "",
                        liked: p.liked,
                    ...
                    var g = 1 & p.actions.edit || p.desc;
                    if (g) var _ = (p.desc, "<div" + (1 & p.actions.edit ? ' class="pv_can_edit pv_desc_cont" onclick="Photoview.editInline(event)"' + (p.desc ? ' onmouseover=""' : "") : ' class="pv_cant_edit pv_desc_cont"') + ">" + (p.desc || '<span class="pv_desc_edit">' + getLang("photos_edit_desc") + "</span>") + "</div>");
                    1 == p.was_edited ? c += '<div id="pv_edit_info" class="pv_right_block">' + getLang("photos_was_edited") + "</div>" : p.was_edited && (c += '<div id="pv_edit_info" class="pv_right_block" onmouseover="showTooltip(this, {text: \'' + p.was_edited + "', black: 1});\">" + getLang("photos_was_edited") + "</div>"), c += '<div id="pv_desc" class="pv_right_block" style="' + (g ? "" : "display: none") + '">' + _ + "</div>", c += '<div id="pv_microdata">' + (p.microdata_html ? p.microdata_html : "") + (p.microdata_preview_button ? p.microdata_preview_button : "") + "</div>", p.microdata_html && shortCurrency();
                    var m = p.tagshtml ? "" : ' style="display: none"';
                    c += '<div id="pv_tags"' + m + ' class="pv_right_block">' + getLang("photos_onthisphoto") + ": " + p.tagshtml + "</div>";
                    var w = p.place ? '<span class="pv_place_label"></span> <a class="pv_place_a" id="pv_place_a" onclick="Photoview.showPlace()">' + p.place + "</a>" : "";
                    c += '<div id="pv_place" class="pv_right_block">' + w + "</div>", c += l.tagName ? '<div id="pv_comments_place"></div>' : trim(l), cur.pvReplyForm && re(cur.pvReplyForm), cur.pvReplyForm = null, c += '<div id="pv_rotate"><form method="POST" target="pv_rotate_frame" name="pv_rotate_form" id="pv_rotate_form"></form></div></div>', cur.pvNarrow.innerHTML = "", Photoview.updateRightBlock(), cur.pvNarrow.innerHTML = c;
                    var f = geByClass1("pv_closed_commments_placeholder");
                    if (s || !p.actions.comm ? removeClass(f, "unshown") : p.reply_form && (addClass(f, "unshown"), p.replyFormEl = cur.pvReplyForm = p.replyFormEl || se(p.reply_form), cur.pvNarrowColumn.appendChild(cur.pvReplyForm), cur.onReplyFormSizeUpdate = cur.onMediaChanged = function(o) {
                        ...
                        each(geByClass("page_gif_loading", l), function() {
                            Page.hideGif(this, !1)
                        });
                        var P = ge("pv_comments_place");
                        domPN(P).replaceChild(l, P)
                    }
                ...
                n = n || "", cur.pvAlbumName.innerHTML = n, toggle(cur.pvBottomInfo, !cur.pvIsLightMode || cur.pvShowBottomActions || n);
                var b = [];
                if (vk.id && b.push('<a id="pv_share" onclick="Photoview.sendPhoto()">' + getLang("photos_share_from_view") + "</a>"), !p.taginfo && p.actions.tag && p.tags[0] < cur.pvMaxTags && b.push("<a id=\"pv_tag_link\" onclick=\"stManager.add(['photo_tagger_mode.js', 'tagger.css', 'tagger.js'], function() { Phototag.startTag(); })\">" + getLang("photos_tagperson") + "</a>"), p.actions.del && b.push('<a id="pv_delete" onclick="Photoview.deletePhoto()">' + getLang("photos_pv_act_delete") + "</a>"), p.actions.save && b.push('<a id="pv_save_to_me" onclick="Photoview.savePhoto()">' + getLang("photos_pv_act_save") + "</a>"), cur.pvShowBottomActions && !v) {
                    var L = [],
                        C = [];
                    if (p.actions.spam && (L.push(["spam", getLang("photos_report"), "", "Photoview.showSpamActions()"]), L.push("sep"), C = cur.pvReasons), p.actions.forbid) {
                        var y = Photoview._getViewedPhotoFullId().split("_"),
                            S = y[0],
                            x = y[1],
                            I = 1;
                        L.push(["atfr", getLang("reports_atfr"), "sfof(" + S + ", " + x + ", " + I + ")"])
                    }
                    ...
                    var k = "";
                    each(L, function(o, e) {
                        k += "sep" == e ? '<div class="pv_more_act_item_sep"></div>' : '<div class="pv_more_act_item" onmouseover="' + (e[3] || "") + '" onclick="' + (e[2] || "") + '" id="pv_more_act_' + e[0] + '">' + e[1] + "</div>"
                    }), k += '<a class="pv_more_act_item" id="pv_more_act_download" target="_blank" href="' + Photoview.genData(p, "w").src + '">' + getLang("photos_pv_act_open_original") + "</a>", k = '<div class="pv_more_acts">' + k + "</div>", L.length ? (L = JSON.stringify(L), L = L.replace(/\"/g, "&quot;"), b.push('<a class="pv_actions_more" data-items="' + L + '">' + getLang("photos_actions_more") + "</a>")) : inArray(nav.objLoc[0], ["support", "helpdesk"]) && b.push('<a id="pv_more_act_download" target="_blank" href="' + Photoview.genData(p, "w").src + '">' + getLang("photos_pv_act_open_original") + "</a>"), b = b.join('<span class="divider"></span>'), cur.pvIsLightMode && (b += '<div id="pv_rotate" style="display:none;"><form method="POST" target="pv_rotate_frame" name="pv_rotate_form" id="pv_rotate_form"></form></div></div>'), cur.pvBottomActions.innerHTML = b;
                    var B = geByClass1("pv_actions_more");
                    B && (cur.pvMoreActionsTooltip = new ElementTooltip(B, {
                        id: "pv_more_acts_tt",
                        forceSide: "top",
                ...
                cur.pvPhotoTags ? cur.pvPhotoTags.reload(E) : vk.id && (cur.pvPhotoTags = new PhotoTags(E, cur.pvPhotoTagsContainer)), setTimeout(Photoview.afterShow, 2)
            }
        },
        ...
        preload: function(o, e) {
            ...
            if (r) {
                ...
                for (var n = cur.shownAs1AprilEditor ? Photoview.photoSize1April : Photoview.allSizes, v = 0; v < Math.min(Photoview.cacheSize, r - Photoview.cacheSize); ++v) {
                    for (var c = o + (v + 1) * -e; c >= r;) c -= r;
                    for (; 0 > c;) c += r;
                    var u = cur.pvData[t][c];
                    if (u)
                        for (var d = 0, l = n.length; l > d; ++d) {
                            var h = n[d];
                            u[h] && u[h].src && (u[h].src = Photoview.blank, delete u[h])
                        }
                }
                for (var v = 0; v < Photoview.cacheSize; ++v) {
                    for (var c = o + (v + 1) * e; c >= r;) c -= r;
                    for (; 0 > c;) c += r;
                    var u = cur.pvData[t][c];
                    if (!u || !u.id) {
        ...
        doHide: function(o) {
                ...
                for (var a = 0; a < Photoview.cacheSize; ++a) {
                    ...
                    if (p)
                        for (var s = 0, n = e.length; n > s; ++s) {
                            var v = e[s];
                            p[v] && p[v].src && (p[v].src = Photoview.blank, delete p[v])
                        }
                }
            ...
            if (layerQueue.pop(), Photoview.destroyPeriod(), o.pvPreloaded && o === cur) {
                for (var u = geByClass1("photos_container"), d = ce("div", {
                        innerHTML: o.pvPreloaded
                    }); d.firstChild;) u.appendChild(d.firstChild);
        ...
        receiveComms: function(o, e, t, r, a, i) {
            if (o == cur.pvListId && e == cur.pvIndex) {
                for (var p = ce("div", {
                        innerHTML: t
                    }), s = ge("pv_comments_list"), n = current = domLC(s), v = getXY(current, !0)[1], c = cur.pvData[o][e], u = domLC(p); u; u = domLC(p)) {
                ...
                i && n && (layerWrap.scrollTop += getXY(n, !0)[1] - v), cur.pvCommsLikes[c.id][0] = ge("pv_comments"), extend(cur.pvReplyNames, r), Photoview.updateComms()
            }
        },
        ...
        sendComment: function(o, e, t) {
            var r = cur.pvListId,
                ...
                v = geByClass1("addpost_button", cur.pvReplyForm),
                t = t || {},
                c = t.stickerId;
            if (c) var u = {
                message: "",
        ...
        updatePhotoDimensions: function(o) {
            if (!Photoview.isPhotosList() && !cur.pvEditorModeDimensionsUpdated) {
                ...
                var r = isVisible(cur.pvTagInfo),
                    ...
                    n = Math.max(e, i - Photoview.SIDE_COLUMN_WIDTH - 2 * Photoview.SIDE_MIN_GAP),
                    v = Math.max(t, p - s - 2 * Photoview.VERTICAL_MIN_GAP - a);
                ...
                var u = c.width / c.height,
                    d = Math.min(n, c.width),
                    l = d / u;
                l = Math.min(v, l), d = Math.ceil(l * u);
                ...
                var g = cur.prevPhotoWidth = Math.max(d, e, cur.prevPhotoWidth || 0),
                    _ = cur.prevPhotoHeight = Math.max(l, t, (cur.prevPhotoHeight || 0) - a),
                    m = Math.max(0, _ / 2 - l / 2);
                if (m > 0 && !r) {
                ...
                setStyle(cur.pvPhoto, {
                    ...
                    width: g
                }), cur.pvTagFrame && Photoview.updateTagFrameDimensions(d, l, m), cur.pvPhotoTagsContainer && Photoview.updatePhotoTagsContainerDimensions(d), setStyle(cur.pvImgProgress, "marginTop", m + l / 2);
                var P = (cur.pvIsLightMode ? 0 : Photoview.SIDE_COLUMN_WIDTH) + g;
                setStyle(cur.pvCont, {
                    width: P,
                    paddingLeft: sbWidth()
                }), Photoview.updateRightBlock(), Photoview.updateVerticalPosition(), cur.pvPhWidth = d, cur.pvPhHeight = l, Photoview.updateNavBtnsLeftThreshold();
                var T = getXY(cur.pvCont),
                    b = getSize(cur.pvCont),
                    L = T[1] + b[1],
                    C = T[0] + b[0],
                    y = 60,
                    S = 85,
        ...
        likeUpdate: function(o, e, t) {
            ...
            if (p) {
                var s = i.tt || {},
                    n = clone(s.opts || {}),
                    v = domByClass(s.container, "_value"),
                    c = domByClass(s.container, "_content"),
                    u = domByClass(s.container, "_title");
                t && u && val(u, t), s && (s.likeInvalidated = !0), v && (v.value = e), animateCount(p, e), toggleClass(i, "pv_liked", o), toggleClass(i, "no_likes", !e), toggleClass(c, "me_hidden", !o), e ? !s.el || isVisible(s.container) || t || tooltips.show(s.el, extend(n, {
                    showdt: 0
                })) : s.el && s.hide()
            }
        },
        ...
        loaded: function(o, e, t, r, a) {
            if ("deleted" != o) {
                ...
                for (var i = (vkNow(), 0), p = r.length; p > i; ++i) {
                    for (var s = t + i, n = clone(r[i]); s >= e;) s -= e;
                    cur.pvCommsLikes[n.id] = [n.comments, n.likes, vkNow(), !1], delete n.comments, delete n.likes, cur.pvData[o][s] = n
                }
                cur.pvCandidate = 1
            }
        },
            ...
            if (cur.pvaLoading = 0, cur.pvAlbumsShown) {
                ...
                if (a) {
                    for (var v = ce("div", {
                        ...
                        if (hasClass(v.firstChild, "photos_period_delimiter")) {
                            var c = domData(v.firstChild, "year");
