var html5audio = {
    ...
    onErr: function(url, e) {
        topError('Audio loading error: ' + e.target.error.code, {
            dt: -1,
            type: 101,
            url: url,
    ...
    onCanPlay: function() {
        if (ge('the_audio')) setTimeout(function() {
            ge('the_audio').play();
        }, 1000);
    },
...
<div id="audio_player" style="top:' + ypos + 'px">\
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0">\
    ...
    docMouseMove: function() {
        if (html5audio.audio_moveState == 1) {
            html5audio.onPrMove();
        } else
        if (html5audio.audio_moveState == 2) {
            html5audio.onVolMove();
        }
    }
}
