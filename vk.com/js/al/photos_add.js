var PhotosAdd = {
    ...
    fileDone: function(i, res) {
        hide("photo_cancel" + i);
        for (var before = "", j = i + 1, obj; j < cur.files.length; ++j)
        ...
        PhotosAdd.fetchGeo(obj), setTimeout(ajax.post.pbind("al_photos.php", extend({
            ...
            onDone: function(o, e) {
                if (!o) return PhotosAdd.fileFail(i, 0);
                cur.files[i].cont.innerHTML = "", utilsNode.removeChild(cur.files[i].cont), extend(cur.files[i], {
                    id: o,
                    deleting: !1,
                    cont: !1
                }), ge("photo_upload_row" + i).innerHTML = e, autosizeSetup("photo_caption" + o, {
                    minHeight: 30
                }), show("photo_delete" + o), window._tbLink && _tbLink.loc && (cur.__phinputs = cur.__phinputs || [], globalHistoryDestroy(_tbLink.loc))
            },
            onFail: function(o) {
                if (o) return setTimeout(showFastBox({
                    title: getLang("global_error"),
                    dark: 1
                }, o).hide, 3e3), PhotosAdd.fileCancel(i), !0
            }
        }), 0)
    },
    ...
    chooseFlash: function() {
        ...
        show("photo_flash_upload"), hide("photo_default_upload")
    },
    ...
    saveDesc: function(e, o) {
        var t = ge("photo_caption" + e).value,
            r = (cur.descs || {})[e];
        delete(cur.descs || {})[e], trim(t) != r && ajax.post("al_photos.php", {
            act: "save_desc",
            photo: e,
            hash: o,
            text: t,
    ...
    activeTab: function(o) {
        ...
        addClass(domPN(o), "active_link"), domFC(ge("photo_add_tab")) !== o && re("photo_add_tab")
    },
    initHtml5: function() {
    ...
    rotateAngle: function(o, e, t, r) {
        ...
        if ("rotate_photo" == i.act && (i.angle = (i.angle + i.to + 4) % 4), i["rot" + (i.to + 4) % 4]) return i.act = "done_rotate", i.complete = 1, ajax.post("/al_photos.php", i, {
    ...
    rotateFailed: function(o) {
        PhotosAdd.transformAvailable() || re("rotating_image" + o), delete ge("photos_add_controls" + o).blocked
    },
    ...
    correctThumb: function(o, e, t) {
        ...
        hide(a), setStyle(a, {
            ...
            Upload.fileList[cur.uplId][o].animating = !1, PhotosAdd.thumbOver(o, t)
        }, 600)
    },
    updateCount: function() {
        ge("photos_add_save").innerHTML = langNumeric(cur.qsrt.count, cur.uploaderLang.photos_save_X_photos), 0 == cur.qsrt.count && (show("photos_add_empty"), hide("photos_add_box"), hide(ge("photos_add_bar").parentNode), Upload.fileList[cur.uplId] = !1)
    },
    saveHtml5: function() {
    ...
    scrollToBottom: function(o) {
        if (!cur.scrollFixed) {
            ...
            if (o = o || cur.lastPhotoRow, e.pageNode && o) {
                ...
                var i = r[1] + a[1] - d + 200;
                0 < i && i > scrollNode.scrollTop && scrollToY(i, 400)
            }
        }
    },
    _onScroll: function() {
        if (null !== cur.pageBlockHeader && (cur.pageBlockHeader = cur.pageBlockHeader || geByClass1("page_block_header", ge("photos_add_block")), cur.pageBlockHeader)) {
            ...
            geByClass1("photos_container_edit_grid", domPN(cur.pageBlockHeader));
            var e = ge("photos_add_block");
    ...
    onUploadStart: function(o, e) {
        ...
        cur.photosAddFirst || (cur.photosAddFirst = !0), o.prepareCont = se(rs(cur.uploadRowTpl, {
            photo_raw: "",
            thumb: "",
            description: "",
            hash: ""
            ...
            display: "none"
        }), photos._showProgressPanel(o.prepareCont), cur.flash_lite && (cur.flashPrepareCont = cur.flashPrepareCont || {}, cur.flashPrepareCont[o.num] = cur.flashPrepareCont[o.num] || {}, cur.flashPrepareCont[o.num][o.filename] = o.prepareCont), ge("photos_add_list").appendChild(o.prepareCont), cur.lastPhotoRow = o.prepareCont, PhotosAdd.makeTask(function() {
    ...
    onUploadComplete: function(info, res) {
        ...
        if (obj.code) Upload.onUploadError(cur.UplId, obj.code);
        else {
    ...
    queueReceiveUpdates: function(o, e) {
        e.events && e.events.forEach(function(o) {
            var e = o.split("<!>"),
                ...
                r = e[2],
                a = JSON.parse(r);
            a && Object.keys(a).length && addClass(ge("photo_edit_row_" + t), "has_faces animated")
        })
    },
