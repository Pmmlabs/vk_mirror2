FAQ = {
    ...
    appendExtraField: function(e) {
        ...
        if (t) {
            for (var o = 0; ge("faq_optional_extra_field_" + o);) o++;
            var a = se(getTemplate("faqExtraField", {
                index: o
            }));
            t.appendChild(a), t.children.length >= 10 && hide(e), FAQ.prepareExtraField(a)
        }
    },
    prepareExtraField: function(e) {
        ...
        var o = new Dropdown(geByClass1("_required", e), cur.selData.extra_field_required_types, {
            width: 191,
            introText: "",
            noResult: "",
            multiselect: !1,
        ...
        data(e, "requiredSelector", o);
        var a = geByClass1("faq_optional_extra_field__close", e);
        addEvent(a, "click", FAQ.removeExtraField.pbind(e))
    },
    ...
    saveFAQ: function(e, t, o) {
        ...
        if (each(c, function(e, t) {
                _[e] = t
            }), _.section = intval(cur.sectionSelector.val()), 0 == _.section || 39 == _.section) _.categories = cur.desktopCategorySelector.val(), _.spec_section = cur.specSectionSelector.val();
        else if (31 == _.section || 25 == _.section) {
            var u = cur.platformSelector.val();
            if (!u) return elfocus(cur.platformSelector.input), notaBene(cur.platformSelector.selector);
            _.platforms = u;
            var f = cur.categorySelector.val();
            if (!f) return elfocus(cur.categorySelector.input), notaBene(cur.categorySelector.selector);
            _.categories = f
        }
        if (1 == _.section && (_.categories = cur.adsCategorySelector.val()), cur.actionButtonSelector && (_.action_id = intval(cur.actionButtonSelector.val()), 0 != _.action_id && (_.action_label = trim(val("faq_action_btn_label"))), 7 == _.action_id)) {
