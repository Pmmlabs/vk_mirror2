Abuse = {
    ...
    switchActivitySection: function(oid, reason, solved, section, event) {
        ...
        ajax.post('abuse.php', {
            ...
            showProgress: setStyle.pbind('ab_owner_header_progress' + oid, {
                display: 'inline'
            }),
    ...
    solve: function(oid, status, hash) {
        var evs = [];
        if (cur.checkedActivity) each(cur.checkedActivity[oid] || {}, function(ev) {
            evs.push(ev)
        });
        ...
        ajax.post('abuse.php', {
            ...
            evs: evs.join(','),
            hash: hash,
            reason: ge('top_reason_' + oid).value
        }, {
    ...
    initChangeReasonDD: function(oid) {
        ...
        Abuse.changeReasonDD[oid] = new DropdownMenu([
            [1, '�����������'],
            [2, '����'],
            [3, '������']
        ], {
