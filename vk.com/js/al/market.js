var Market = {
        ...
        switchTab: function(o, e, t) {
            var r = geByClass1("side_link", gpeByClass("ui_tabs", e));
            uiTabs.switchTab(e);
            var a = val(r);
            return ajax.post("/al_market.php", {
                ...
                onDone: function(e, t, r) {
                    cur.listEl.innerHTML = t, r ? show(cur.more) : hide(cur.more), Market.section(o)
                },
                showProgress: Market.switchTabSpinner.pbind(r, "round_spinner", "on", a),
                hideProgress: Market.switchTabSpinner.pbind(r, "round_spinner", "off", a)
            }), !1
        },
        section: function(e) {
            if (!(e = e || "") && "comments" == cur.mSection) {
        ...
        _createSorters: function() {
            cur.itemsSorter && cur.itemsSorter.destroy(), cur.albumsSorter && cur.albumsSorter.destroy(), cur.canEdit && ((!cur.mSection || "albums" == cur.mSection) && 1 < cur.albumsCount && (cur.itemsSorter = new GridSorter("market_albums_cont", "market_album_photo_img", {
                onReorder: Market._onAlbumReorder
            })), (!cur.mSection || cur.aid) && 1 < cur.itemsCount && !hasClass("market", "market_search_section") && (cur.itemsSorter = new GridSorter(cur.listEl, "market_row_img", {
        ...
        getFilterValue: function(r) {
            var e = !1;
            if ("Selector" == r.__className)(e = clone(r.selectedItems()[0])).push(e[0] == r.options.defaultItems[0][0]);
            else if ("INPUT" == r.tagName) {
                var t = val(r);
                if (e = [t, t, "" === t], "text" == r.type) {
                    var o = gpeByClass("ui_search_fltr_sel", r),
                        a = domPS(o);
                    if (hasClass(a, "ui_search_fltr_label")) {
                        var i = a.textContent,
                            s = "",
                            n = geByClass1("ui_search_fltr_label_postfix", a);
                        n && (s = n.getAttribute("data-prefix"), n = n.textContent, i = i.replace(n, "").replace(/,\s$/, ""), s && (n = !1)), geByClass1("ui_search_fltr_sep", o) && each(geByTag("input", o), function(e, t) {
                            t == r && (i += " " + (0 == e ? getLang("market_filter_range_from") : getLang("market_filter_range_to")))
                        }), e[1] = i + (s ? " " + s : " ") + e[1] + (n ? " " + n : "")
                    }
                }
            }
        ...
        updateFiltersPane: function() {
            each(cur.searchFilters, function(e, t) {
                ...
                uiSearch.toggleFilter(cur.searchInp, e, window.clean(r[1]), !r[2])
            })
        },
        ...
        getSearchParams: function() {
            ...
            return each(cur.searchFilters, function(e, t) {
                var r = Market.getFilterValue(t);
                o[e] = r[0]
            }), cur.aid && (o.aid = cur.aid), "disabled" == cur.mSection && (o.disabled = 1), o
        },
        ...
        updateList: function(t) {
            ...
            var e = function() {
                cur.searchOffset = t && 0 < t ? t : 0;
                var e = Market.getSearchParams();
                Market.sameParams(e) && !cur.ignoreEqual || (delete cur.ignoreEqual, t || hasClass("shown", geByClass1("ui_search_fltr_control", "market_search_wrap")) || uiSearch && uiSearch.showProgress(cur.searchInp), cur.params = e, Market.searchItems(), "comments" == cur.mSection && Market.section("")), e.offset || scrollToTop()
            };
            t ? e() : cur.searchTimeout = setTimeout(e.bind(this), 10)
        },
        searchItems: function() {
            var s = cur.params || Market.getSearchParams();
            ajax.post("/al_market.php", s, {
                cache: 1,
                onDone: function(e, t, r) {
                    var o = geByClass1("market_summary_text", "market_list_wrap");
                    if (o) {
                        var a = "";
                        a = e ? getLang("market_summary_X_goods", e, !0) : getLang("market_summary_no_goods"), o.innerHTML = a
                    } else val("market_items_count", e ? langNumeric(e, "%s", !0) : "");
                    0 < s.offset ? cur.listEl.appendChild(cf(t)) : (cur.listEl.innerHTML = t, cur.searchOffset = 0), r ? show(cur.more) : hide(cur.more), cur.searchOffset || e ? removeClass("market", "market_content_not_found") : (s.q ? (addClass(cur.notFound, "market_q_search"), ge("search_ph").innerHTML = s.q.replace(/([<>&#]*)/g, "")) : removeClass(cur.notFound, "market_q_search"), addClass("market", "market_content_not_found"), hide(cur.more)), cur.filterIsRemoved ? cur.filterIsRemoved = !1 : Market.updateFiltersPane();
                    var i = 0;
                    each(s, function(e, t) {
                        (!inArray(e, ["id", "load", "sort", "offset", "disabled"]) && "" != t || "sort" == e && 0 != t) && i++
                    }), i ? addClass("market", "market_search_section") : (removeClass("market", "market_search_section"), cur.albumsCount && show(cur.albumbEl), cur.tabsEl && (show(cur.tabsEl), hide(cur.headerEl))), Market._reinitSorters(0 < i), each(s, function(e, t) {
        ...
        uploadInit: function(e, r, u) {
            cur.lang = extend(cur.lang || {}, r.lang);
            var t = {
                file_name: "photo",
            ...
            return t = u ? extend(t, {
            ...
            }), Upload.init(e, r.url, cur.mkOptions.photoVars, extend(t, {
                onUploadStart: function(e, t) {
                    curBox().changed = !0, "form" == Upload.types[e] && show(box.progress), re(geByClass1("error", r.errorObj))
                },
                ...
                onUploadComplete: function(r, e, t) {
                    var o = parseJSON(e) || {
                        error: "ERR_CLIENT_BAD_RESPONSE: bad request response"
                    };
                    if (!o.error && o.photos) {
                        var a = void 0 !== r.ind ? r.ind : r;
                        if (u) {
                            var i = Upload.options[cur.uploadId].base_url + "upload.php?act=market_photo_crop&_query=" + encodeURIComponent(e) + "&_origin=" + encodeURIComponent(locProtocol + "//" + locHost);
                            Market.cropPhoto(o.photos[0], i), Upload.embed(a)
                        } else {
                            var s = (r.fileName || r).replace(/[&<>"']/g, ""),
                                n = r.fileName ? a + "_" + r.fileName : r,
                                c = ge("upload" + n + "_progress_wrap");
                            c && hide(geByClass1("market_prg_x", c)), o.photos = JSON.stringify(o.photos), ajax.post("al_photos.php", extend({
                                act: "choose_uploaded"
                            }, o), {
                                onDone: function(e, t) {
                                    Market.choosePhoto(r, e, extend(t, {
                                        upload_ind: a + "_" + s
                                    }))
                                },
                                onFail: Market.uploadFail.pbind(u, r)
                            })
                        }
                    } else Market.uploadFail(u, r, o.error + (t || ""))
                },
                onUploadProgress: function(e, t, r) {
                    var o = void 0 !== e.ind ? e.ind : e;
                    if (u) {
                        var a = getProgressBarEl(ge("form" + o + "_progress"));
                        if (!a) {
                            for (var i = Upload.obj[o], s = getSize(i)[1] / 2 + 10, n = i.firstChild; n;) 1 == n.nodeType && (n.id == "uploader" + o && browser.msie ? setStyle(n, {
                                position: "relative",
                                left: "-5000px"
                            }) : setStyle(n, {
                                visibility: "hidden"
                            ...
                            i.appendChild(ce("div", {
                                ...
                                innerHTML: '<div id="form' + o + '_progress" class="ui_progress">                <div class="ui_progress_back"></div>                <div class="ui_progress_bar"></div>              </div>'
                            }, {
                                height: s + "px",
                                marginTop: -s + "px"
                            })), a = getProgressBarEl(ge("form" + o + "_progress"))
                        }
                        var c = intval(t / r * 100);
                        setStyle(a, {
                            width: c + "%"
                        })
                    } else {
                        if ("fileApi" == Upload.types[o]) {
                            ...
                            e.fileName && (l.fileName = e.fileName.replace(/[&<>"']/g, ""))
                        }
                        Market.showUploadPhotoProgress(o, l)
                    }
                },
                onUploadError: function(e, t) {
                    Market.uploadFail(u, e, t)
                }
            }))
        },
        uploadExtraPhotos: function(e) {
            return !(void 0 !== cur.extraUploadId && void 0 !== cur.uploadId && window.Upload && Upload.checked && Upload.checked[cur.uploadId]) || (geByTag1("input", "market_ei_photo_upload").click(), !1)
        },
        uploadFail: function(e, t, r) {
            var o;
            switch (r.match(/^ERR_[A-Z0-9_]+/) || (r = 'ERR_CLIENT_BAD_ERROR: error "' + r.toString() + '"'), r.match(/^(ERR_[A-Z0-9_]+)/)[1]) {
            ...
            if (o = o.replace("{sorry}", "<b>" + getLang("global_error_occured") + "</b>"), 2 === e) {
                var a = ge("market_photo_crop_error");
                return val(a, o), show(a), !0
            }
            ...
            if (e) {
                var n = Upload.obj[i],
                    c = domPN(n);
                hasClass(c, "market_upload_progress") && removeClass(c, "market_upload_progress")
            } else {
                t.fileName && t.fileName;
                var l = t.fileName ? i + "_" + t.fileName : t;
                re("upload" + l + "_progress_wrap"), Market.unchoosePhoto(i)
            }
            return Upload.embed(i), showMsg(s.errorObj, o, "error", !0), !0
        },
        choosePhoto: function(e, t, r) {
            ...
            var s = '<div class="_ei_photo market_ei_photo_wrap market_ei_photo%ind% inl_bl" id="market_ei_photo%ind%">' + ('<div class="market_ei_photo"><img class="market_ei_img" src="' + r.thumb_m + '" />') + '<div nosorthandle="1" class="ui_thumb_x_button ui_thumb_small_x" data-title="' + getLang("dont_attach") + '" onmouseover="showTitle(this)" onclick="Market.unchoosePhoto(%ind%); return cancelEvent(event);"><div class="ui_thumb_x" nosorthandle="1"></div></div></div></div>',
                n = se(rs(s, {
                    ind: i
                }));
            a.insertBefore(n, ge("market_ei_photo_add"));
            var c = e.fileName || e.name || "";
            re("upload" + (c ? o + "_" + c : o) + "_progress_wrap"), c && ((!browser.msie || 8 < browser.version) && 1 < cur.itemPhotos.length ? stManager.add(["usorter.js"], function() {
                a.usorter ? usorter.added(a) : 1 < cur.itemPhotos.length && usorter.init(a, {
        ...
        unchoosePhoto: function(e) {
            ...
            t.usorter && (t.usorter.destroy(), t.usorter = !1), 1 < cur.itemPhotos.length && stManager.add(["usorter.js"], function() {
                usorter.init(t, {
                    clsUp: "market_ei_preview_up"
                })
            })
        ...
        getUploadedPhotos: function() {
            ...
            var r, o = [];
            return each(geByClass("_ei_photo", "market_ei_photos"), function(e, t) {
                (r = (t.className || "").match(/market_ei_photo(\d+)/)) && (r = intval(r[1]), o.push(cur.itemPhotos[r]))
            }), o
        },
        showUploadPhotoProgress: function(e, t) {
            var r = ge("market_ei_photos_progress"),
                ...
                a = t.fileName || t.name || "",
                i = a ? e + "_" + a : e,
                s = a ? 33 < a.length ? a.substr(0, 30) + "..." : a : "";
            if (r) {
                var n = getProgressBarEl(ge("upload" + i + "_progress_wrap"));
                if (!n) {
                    var c = ce("div", {
                        id: "upload" + i + "_progress_wrap",
                        innerHTML: '<div class="market_prg_wrap">' + ('  <div class="ui_progress">    <div class="ui_progress_back"></div>    <div class="ui_progress_bar" style="width: ' + o + '%;"></div>  </div></div>') + "</div>" + (s ? '<div class="market_prg_label">' + s + "</div>" : "") + '<div class="market_prg_x" data-title="' + getLang("dont_attach") + '" onmouseover="showTitle(this)" onclick="Upload.terminateUpload(' + e + ", '" + (a || e) + "'); if (window.tooltips) tooltips.hide(this);\"></div>",
                        className: "clear_fix"
                    }, {
                        marginTop: "6px"
                    });
                    r.appendChild(c), n = getProgressBarEl(ge("upload" + i + "_progress_wrap")), show(r), toggle("market_ei_photo_add", Market.uploadedPhotosCount() < Upload.options[e].max_files)
                }
                return o ? (setStyle(n, {
                    width: o + "%"
        ...
        cropInit: function() {
            ...
            }).width > e.height && (e.width = e.height), e.height > e.width && (e.height = e.width), e.left = Math.floor((o[0] - e.width) / 2), e.top = Math.floor((o[1] - e.height) / 2)), cur.photoTagger && cur.photoTagger.destroy(), cur.photoTagger = photoTagger("market_photo_crop_img", {
                minw: a[0],
                minh: a[1],
                square: 1,
                rect: e,
        ...
        showEditBox: function(e, t, r) {
            return t || (t = cur.oid), 0 < t ? MarketEditItemBox.show(e, t, r) : (showBox("al_market.php", {
                act: "a_edit_item_box",
                id: e,
                oid: t,
                aid: cur.aid
        ...
        saveItem: function(e) {
            if (!buttonLocked("btn")) {
                ...
                cur.mkOptions.item_id && (a.id = cur.mkOptions.item_id), a.name.length ? a.description.length ? floatval(a.price) ? (re(geByClass1("error", "market_edit_item_box")), ajax.post("al_market.php?act=a_save_item", a, {
                    onDone: function(e, t) {
                    ...
                    onFail: function(e) {
                        return showMsg("market_edit_item_box", e, "error", !0), !(ge("box_layer_wrap").scrollTop = 0)
                    },
                    showProgress: lockButton.pbind(e),
                    hideProgress: unlockButton.pbind(e)
                })) : notaBene("item_price") : notaBene("item_description") : notaBene("item_name")
            }
        },
        deleteItem: function(e, t, r) {
            var o = showFastBox({
                ...
                ajax.post("al_market.php?act=a_delete_item", i, {
                    onDone: function(e, t) {
                        for (; boxQueue.count();) boxQueue.hideLast(!1, window.event);
                        if (window.WkView && WkView.hide(), re("market_item" + i.id), "market" == cur.module || "marketplace" == cur.module) {
                            cur.itemsCount--;
                            var r = "",
                                o = "";
                            0 < cur.itemsCount ? (r = langNumeric(cur.itemsCount, "%s", !0), o = getLang("market_summary_X_goods", cur.itemsCount, !0)) : (o = getLang("market_summary_no_goods"), geByClass1("market_empty", cur.notFound).innerHTML = cur.aid ? getLang("market_album_empty") : getLang("market_catalog_empty"), hide(cur.listEl), show(cur.notFound));
                            var a = geByClass1("market_summary_text", "market_list_wrap");
                            a ? a.innerHTML = o : val("market_items_count", r), t && each(t, function(e, t) {
                                var r = geByClass1("market_album_size", "market_album_block" + e);
                                r && (r.innerHTML = t)
        ...
        deleteAlbum: function(r, e) {
            return showFastBox({
                ...
                ajax.post("/al_market.php?act=a_delete_album", {
                    ...
                    onDone: function() {
                        var e = ge("market_album_block" + r);
                        curBox().hide(), cur.albumsCount--, cur.albumsSorter && qsorter.remove(ge("market_albums_cont"), e), re(e);
                        var t = "";
                        0 < cur.albumsCount ? t = langNumeric(cur.albumsCount, "%s", !0) : (hide("market_albums_wrap"), show("market_no_albums_wrap")), ge("market_albums_count").innerHTML = t, cur.aid && nav.go("/market" + cur.oid)
                    }
                })
            }), !1
        },
        ...
        itemBoxinit: function() {
            ...
            }), cur.mkOptions.photos && 1 < cur.mkOptions.photos.length && addEvent(domPN(ge("market_item_photo")), "click", Market.switchPhoto.pbind(!1)), cur.mkOptions.canEnlarge && show("market_item_bigph");
            for (var r = 1; r < cur.mkOptions.photos.length && r <= 5; r++) vkImage().src = cur.mkOptions.photos[r].thumb_x;
        ...
        switchPhoto: function(e, t) {
            if (Market.outPhotoThumb(), void 0 === e || !1 === e)(e = cur.mkOptions.photoIndex + 1) >= cur.mkOptions.photos.length && (e = 0);
            else if (!t) return void(cur.switchPhotoTO = setTimeout(Market.switchPhoto.pbind(e, !0), 50));
            if (e >= cur.mkOptions.photos.length) return !1;
            cur.mkOptions.photoIndex = e, ge("market_item_photo").src = cur.mkOptions.photos[e].thumb_x, removeClass(geByClass1("market_item_thumb_active", "market_item_photos_sidebar"), "market_item_thumb_active"), addClass("market_item_thumb" + e, "market_item_thumb_active")
        },
        ...
        showPhotoActions: function(e) {
            var t = ge("market_item_bigph"),
                r = getXY(t),
                o = getSize(t);
            e.pageX > r[0] - 100 && e.pageX < r[0] + o[0] + 100 && e.pageY > r[1] - 100 && e.pageY < r[1] + o[1] + 100 ? addClass(t, "visible") : removeClass(t, "visible")
        },
        ...
        checkDescriptionClick: function(e, t) {
            ...
            var r = t.target || t.srcElement,
                o = 8;
            do {
                if (!r || r == e || r.onclick || r.onmousedown || inArray(r.tagName, ["A", "IMG", "TEXTAREA", "EMBED", "OBJECT"])) break
        ...
        descriptionClick: function(e, t) {
            ...
            if (r) {
                ...
                o && isVisible(o) && o.onclick()
            }
        },
        toggleFavourite: function(r, o, e, a) {
            if (!isButtonLocked(a)) {
                var t = {
                    act: "a_set_favourite",
                    owner_id: r,
                ...
                ajax.post("/al_market.php", t, {
                    onDone: function(e, t) {
                        e && (toggleClass(a, "selected"), toggleClass("market_row_fav" + r + "_" + o, "selected"), geByClass1("_btn_text", a).innerHTML = t)
                    },
        ...
        reportFromDD: function(e, t) {
            var r = function(e) {
                document.querySelector("._like_market" + cur.mkOptions.itemOwnerId + "_" + cur.mkOptions.itemId).querySelector(".ui_actions_menu").innerHTML = '<a class="ui_actions_menu_item" tabIndex="0" role="link">' + e + "</a>"
            };
            stManager.add([jsc("web/reports.js"), "reports.css"], function() {
                window.showReportReasonDescriptionPopup("market", cur.mkOptions.itemOwnerId, cur.mkOptions.itemId, parseInt(t), e, r)
            })
        },
        ...
        like: function() {
            if (vk.id) {
                ...
                ajax.post("like.php", {
                    ...
                    onDone: function(e, t) {
                        return Market.likeUpdate(r, e, t)
                    }
                }), Market.likeUpdate(r, cur.mkOptions.likes + (r ? 1 : -1))
            }
        },
        ...
        likeOver: function(e) {
            ...
            if (t && !cur.viewAsBox) {
                var r = getXY(e)[0],
                    o = getXY(t)[0] + getSize(t, !0)[0] / 2 - r - 41;
                showTooltip(e, {
                    url: "like.php",
                    params: {
                        act: "a_get_stats",
        ...
        comments: function(r) {
            if (r) {
                var e = domFC(ge("market_comments")).id || "";
                if (!isVisible("market_comments_header") || geByClass1("progress_inline", "market_comments_header") || WkView.cmp(e, "post" + r) < 0) return
            }
            ajax.post("al_market.php", {
                act: "a_get_comments",
                ...
                onDone: function(e, t) {
                    Market.receiveComms(e, t, !1, r), r && ge("post" + r) && Wall.scrollHighlightReply("post" + r)
                },
                showProgress: function() {
        ...
        receiveComms: function(e, t, r, o) {
            for (var a = ce("div", {
                ...
                for (ge("market_reply_form") && addClass(c, "reply_replieable"); current && 0 < WkView.cmp(current.id, c.id);) current = domPS(current);
                current && !WkView.cmp(current.id, c.id) ? (i.replaceChild(c, current), current = c) : (current && domNS(current) ? (i.insertBefore(c, domNS(current)), ++cur.mkOptions.commCount) : !current && domFC(i) ? !0 === r ? (--cur.mkOptions.commShown, a.removeChild(c)) : i.insertBefore(c, domFC(i)) : i.appendChild(c), ++cur.mkOptions.commShown)
            }
        ...
        commSaved: function(e) {
            var t = ge("market_comments_wrap"),
                r = !!t && cur.mkOptions.itemRaw,
                o = e.match(/^(-?\d+)market(_\d+)/);
            r && o && ge("market_comment" + o[1] + o[2]) && (cur.mkComments || (cur.mkComments = {}), cur.mkComments[cur.mkOptions.itemRaw] = t)
        },
        sendComment: function(r, o, e) {
            var a = ge("reply_field" + r),
                t = ge("reply_button" + r),
                i = (ge("feedback_row" + r), (cur.mkOptions.reply_names[(cur.reply_to || {})[0]] || [])[1]),
                s = a && data(a, "composer");
            if (e.stickerId) var n = {
                message: "",
                attach1_type: "sticker",
                attach1: e.stickerId,
                sticker_referrer: e.sticker_referrer
            };
            else {
                if ((n = s ? Composer.getSendParams(s, Market.sendComment.pbind(r)) : {
                        message: trim(Emoji.editableVal(a))
                    }).delayed) return;
                if (!n.attach1_type && (!n.message || i && !i.indexOf(n.message))) return void Emoji.editableFocus(a, !1, !0)
            }
            hide("reply_warn" + r), ajax.post("al_market.php", Wall.fixPostParams(extend(n, {
                act: "post_comment",
                item: cur.mkOptions.itemRaw,
                hash: cur.mkOptions.hash,
                ...
                onDone: function(e, t) {
                    ++cur.mkOptions.commCount, Market.receiveComms(e, t, !0), wkLayerWrap.scrollTop = wkLayerWrap.scrollHeight, s ? Composer.reset(s) : Emoji.val(a, ""), a.autosize && a.autosize.update(), browser.mobile ? Wall.hideEditReply(r) : (Emoji.editableFocus(a, !1, !0), Wall.cancelReplyTo(r, o)), re("reply_link" + r)
                },
                onFail: function(e) {
                    if (a) return showTooltip(a, {
                        text: e,
                        showdt: 200,
                        forcetodown: 0,
                        slide: 15
                    }), Emoji.editableFocus(a, !1, !0), !0
                },
        ...
        _onEdit: function() {
            window.WkView && WkView.hide(), 0 < cur.mkOptions.oid ? MarketEditItemBox.show(cur.mkOptions.itemId, cur.mkOptions.itemOwnerId) : Market.showEditBox(cur.mkOptions.itemId, cur.mkOptions.itemOwnerId)
        },
        _onDelete: function() {
    ...
    MarketCart = {
        add: function(l, e, u, t, r) {
            if (!buttonLocked(l)) {
                if (!t) {
                    if (!cur.marketObjDD) return;
                    var o = cur.marketObjDD.val_full();
                    if (0 == (t = o[0]) || !o[2]) return notaBene(cur.marketObjDD.container)
                }
                ajax.post("market?act=a_modify_count", {
                    ...
                    onDone: function(e, t, r, o, a, i, s, n, c) {
                        e && (val(l, r ? getLang("market_item_X_added_to_cart", r) : getLang("market_item_add_to_cart")), r && (show("market_goto_cart"), notaBene("market_goto_cart", "#FFFFA0")), MarketCart._updateItemCount(u, r), MarketCart._updateInfo(n, c))
                    }
                })
            }
        },
        setCount: function(e, t, u, r) {
            var m = ge("market_cart_row" + u + "_" + r),
                o = trim(val(e)),
                a = attr(e, "modify-hash");
            if (m && !hasClass(m, "processing")) return o.match(/^\d+$/) ? void ajax.post("market?act=a_modify_count", {
                owner_id: t,
                item_id: u,
                obj_id: r,
                value: o,
                ...
                showProgress: function() {
                    addClass(m, "processing"), e.readOnly = !0
                },
                hideProgress: function() {
                    removeClass(m, "processing"), e.readOnly = !1
                },
                onDone: function(e, t, r, o, a, i, s, n, c, l) {
                    e && (val(geByClass1("_price", m), o), val(geByClass1("_sum", m), a), val("market_cart_rows_total", i), cur.marketOrderData.hash = s, MarketCart._updateItemCount(u, r), MarketCart._updateInfo(n, c))
                }
            }) : notaBene(e)
        },
        ...
        _updateItemCount: function(e, t) {
            ...
            if (o && a) {
                toggleClass(r, "market_row_in_cart", 0 < t), val(a, t), toggle(o, 0 < t);
        ...
        changeItemCount: function(e, t, l, r, o) {
            ajax.post("market?act=a_modify_count", {
                owner_id: t,
                item_id: l,
                hash: r,
                ...
                onDone: function(e, t, r, o, a, i, s, n, c) {
                    e && (MarketCart._updateItemCount(l, r), MarketCart._updateInfo(n, c))
                }
            })
        },
        addItem: function(e, o, t) {
            MarketCart._updateItemCount(o, 0), ajax.post("market?act=a_add_item_cart", {
                owner_id: e,
                item_id: o,
                hash: t
            }, {
                onDone: function(e, t, r) {
                    Market._updateItemCount(o, e), Market._updateInfo(t, r)
                }
            })
        },
        ...
        order: function() {
            ...
            buttonLocked(r) || (lockButton(r), 0 == e.delivery_id && (notaBene(cur.marketCartDeliveryDD.container), t = !0), e.contact_phone.length < 4 && (notaBene("market_cart_contact_phone"), t = !0), isVisible("market_cart_delivery_address_block") && (e.delivery_address = trim(val("market_cart_delivery_address")), e.delivery_person = trim(val("market_cart_delivery_person")), e.delivery_person.length < 4 && (notaBene("market_cart_delivery_person"), t = !0), e.delivery_address.length < 4 && (notaBene("market_cart_delivery_address"), t = !0)), isVisible("market_cart_delivery_need_to_meet") && (e.need_to_meet = isChecked("market_cart_delivery_need_to_meet") ? 1 : 0), t ? unlockButton(r) : ajax.post("market?act=a_create_order", e, {
                showProgress: function() {
                    hide(o)
                },
                hideProgress: function() {
        ...
        buyerChanged: function(e) {
            (e = intval(e)) <= 0 || ajax.post("market?act=a_load_delivery_data", {
    ...
    MarketEditItemBox = {
        ...
        init: {
            price: function() {
                var r = ge("item_price");
                addEvent(r, "keydown keyup keypress change paste cut drop input blur", function(e) {
                    var t = r.value.replace(/[^0-9\.]/g, "");
                    return r.value != t && val(r, t), !0
            ...
            category: function(r) {
                var e = r.categories,
                    t = r.category,
                    o = (r.subcategories, r.subcategory),
                    a = new Dropdown(ge("item_category"), e, {
                        big: 1,
                        multiselect: !1,
                        autocomplete: !0,
                        noResult: "",
                        ...
                        onChange: function(e) {
                            if (r.withSubcategories) {
                                var t = {};
                                null != r.subcategories[1e4 + Number(e)] && (t = r.subcategories[1e4 + Number(e)]), isEmpty(t) ? hide(ge("item_subcategory_wrap")) : (MarketEditItemBox.uiSubCategory.setOptions({
                                    defaultItems: t
                                }), show(ge("item_subcategory_wrap")))
                            }
                        }
                    });
                if (t && a.val(t), MarketEditItemBox.uiCategory = a, r.withSubcategories) {
                    var i = {};
                    t && null != r.subcategories[1e4 + Number(t)] && (i = r.subcategories[1e4 + t]);
            ...
            address: function(t) {
                if (t) {
                    var e = new CitySelect(ge("group_market_city"), ge("group_market_city_wrap"), {
                            big: 1,
                            placeholder: getLang("groups_market_select_city"),
                            city: t.city,
                            country: t.country,
                            onChange: function() {
                                if (MarketEditItemBox.uiMetro.val("", !0), -1 != t.citiesWithMetro.indexOf(this.city)) {
                                    var e = {
                                        act: "a_select_metro",
                                        city_id: this.city
                                    };
                        ...
                        r = new CountrySelect(ge("group_market_country"), ge("group_market_country_wrap"), {
                            ...
                            citySelect: e,
                            onChange: function(e) {
                                var t = null == cur.mkOptions.countriesCurrency[e] ? "RUB" : cur.mkOptions.countriesCurrency[e]; - 1 == indexOf(cur.mkOptions.availableCurrencies, t) && (t = "RUB"), ge("item_currency").innerHTML = getLang("market_tiny_" + t)
                            }
                        }),
                        o = {
                            big: 1,
                    ...
                    t.metroSelect && (o.selectedItems = t.metroSelect);
                    var a = Dropdown(ge("group_market_metro"), t.metros, o);
                    t.marketMetros && show(ge("group_market_metro_wrap")), MarketEditItemBox.uiCity = e, MarketEditItemBox.uiCountry = r, MarketEditItemBox.uiMetro = a
                }
            },
            albums: function(e) {
        ...
        upload: {
                ...
                return t = u ? extend(t, {
                    ...
                    onUploadComplete: function(r, e, t) {
                        ...
                        if (!o.error && o.photos) {
                            ...
                            if (u) {
                                var i = Upload.options[cur.uploadId].base_url + "upload.php?act=market_photo_crop&_query=" + encodeURIComponent(e) + "&_origin=" + encodeURIComponent(locProtocol + "//" + locHost);
                                MarketEditItemBox.upload.cropPhoto(o.photos[0], i), Upload.embed(a)
                            } else {
                                var s = (r.fileName || r).replace(/[&<>"']/g, ""),
                                    n = r.fileName ? a + "_" + r.fileName : r,
                                    c = ge("upload" + n + "_progress_wrap");
                                c && hide(geByClass1("market_prg_x", c)), o.photos = JSON.stringify(o.photos), ajax.post("al_photos.php", extend({
                                    ...
                                    onDone: function(e, t) {
                                        MarketEditItemBox.upload.choosePhoto(r, e, extend(t, {
                                            upload_ind: a + "_" + s
                                        }))
                                    },
                                    onFail: MarketEditItemBox.upload.uploadFail.pbind(u, r)
                                })
                            }
                        } else MarketEditItemBox.upload.uploadFail(u, r, o.error + (t || ""))
                    },
                    onUploadProgress: function(e, t, r) {
                        var o = void 0 !== e.ind ? e.ind : e;
                        if (u) {
                            ...
                            MarketEditItemBox.upload.showUploadPhotoProgress(o, l)
                        }
                    },
                    onUploadError: function(e, t) {
                        MarketEditItemBox.upload.uploadFail(u, e, t)
                    }
                }))
            },
            uploadExtraPhotos: function(e) {
            ...
            uploadFail: function(e, t, r) {
                ...
                if (e) {
                    ...
                    t.fileName && t.fileName;
                    var l = t.fileName ? i + "_" + t.fileName : t;
                    re("upload" + l + "_progress_wrap"), MarketEditItemBox.upload.unchoosePhoto(i)
                }
                return Upload.embed(i), showMsg(s.errorObj, o, "error", !0), !0
            },
            choosePhoto: function(e, t, r) {
                ...
                if (isObject(r) || null == r || (r = {
                    ...
                    if (re("upload" + (i ? o + "_" + i : o) + "_progress_wrap"), !(MarketEditItemBox.upload.uploadedPhotosCount() >= Upload.options[cur.extraUploadId].max_files)) {
                        vkImage().src = r.thumb_m, isArray(cur.itemPhotos) || (cur.itemPhotos = []);
                        var s = cur.itemPhotos.length;
                        cur.itemPhotos.push(t);
                        var n = '<div class="_ei_photo market_ei_photo_wrap market_ei_photo%ind% inl_bl" id="market_ei_photo%ind%">' + ('<div class="market_ei_photo"><img class="market_ei_img" src="' + r.thumb_m + '" />') + '<div nosorthandle="1" class="ui_thumb_x_button ui_thumb_small_x" data-title="' + getLang("dont_attach") + '" onmouseover="showTitle(this)" onclick="MarketEditItemBox.upload.unchoosePhoto(%ind%); return cancelEvent(event);"><div class="ui_thumb_x" nosorthandle="1"></div></div></div></div>',
                            c = se(rs(n, {
                                ind: s
                            }));
                        a.insertBefore(c, ge("market_ei_photo_add")), i && ((!browser.msie || 8 < browser.version) && 1 < cur.itemPhotos.length ? stManager.add(["usorter.js"], function() {
                            a.usorter ? usorter.added(a) : 1 < cur.itemPhotos.length && usorter.init(a, {
                                clsUp: "market_ei_preview_up"
                            })
            ...
            showUploadPhotoProgress: function(e, t) {
                ...
                if (r) {
                    ...
                    if (!n) {
                        ...
                        r.appendChild(c), n = getProgressBarEl(ge("upload" + i + "_progress_wrap")), show(r), toggle("market_ei_photo_add", MarketEditItemBox.upload.uploadedPhotosCount() < Upload.options[e].max_files)
                    }
                    return o && (setStyle(n, {
                        width: o + "%"
            ...
            cropPhoto: function(e, t) {
                if (e && e.sizes) {
                    ...
                    } else MarketEditItemBox.upload.uploadFail(!0)
                } else MarketEditItemBox.upload.uploadFail(!0)
            },
            cropInit: function() {
                var e, t = cur.photoCropOpts,
        ...
        saveItem: function(e) {
            if (!isButtonLocked(e)) {
                ...
                ge("item_user_limit") && (i.user_limit = trim(val("item_user_limit"))), ge("item_limit") && (i.limit = trim(val("item_limit"))), 0 < cur.mkOptions.oid ? (i.country_id = MarketEditItemBox.uiCountry.val(), i.city_id = MarketEditItemBox.uiCity.val(), isVisible("group_market_metro_wrap") ? i.metro_id = MarketEditItemBox.uiMetro.val() : i.metro_id = 0, cur.mkOptions.from_attach || cur.mkOptions.from_wall || (i.attach_to_wall = isChecked("item_share") ? 1 : 0), cur.mkOptions.from_wall && (i.add_attach_data = 1), i.disabled = isChecked("item_disabled"), cur.mkOptions.withSubcategories && null != cur.mkOptions.subcategories[1e4 + Number(i.category)] && (i.subcategory = MarketEditItemBox.uiSubCategory.val())) : (i.disabled = isChecked("item_disabled"), i.albums = MarketEditItemBox.uiAlbums ? MarketEditItemBox.uiAlbums.val() : 0), cur.mkOptions.item_id && (i.id = cur.mkOptions.item_id), i.name.length ? i.description.length ? floatval(i.price) ? (re(geByClass1("error", "market_edit_item_box")), ajax.post("al_market.php?act=a_save_item", i, {
                    onDone: function(e, t, r, o) {
                        if (curBox().hide(), cur.mkOptions.item_id && "marketplace" != cur.module) {
                            var a = ge("market_item" + cur.mkOptions.item_id);
                            a && (a.innerHTML = se(e).innerHTML)
                        } else cur.mkOptions.from_attach || cur.mkOptions.from_wall ? i.add_attach_data && cur.chooseMedia("market", o[1], o[0], !1, !1, !1) : nav.reload();
                        cur.aid && nav.reload(), t && each(t, function(e, t) {
                            var r = geByClass1("market_album_size", "market_album_block" + e);
                            r && (r.innerHTML = t)
                        }), i.disabled && !i.id ? nav.change({
                            section: "disabled"
                        }) : (i.disabled || "disabled" == cur.mSection && !i.disabled) && addClass("market_item" + i.id, "market_row_disabled"), "marketplace" == cur.module && "my" != cur.act && nav.go("/market?act=my"), cur.mkOptions.from_attach && MarketChooseBox.attachItem("item", cur.mkOptions.oid, r)
                    },
                    onFail: function(e) {
                        return showMsg("market_edit_item_box", e, "error", !0), !(ge("box_layer_wrap").scrollTop = 0)
                    },
    ...
    MarketChooseBox = {
        ...
        onScroll: function() {
            ...
            if (e) {
                var t = clientHeight();
                scrollGetY() + t > getXY(e)[1] - t / 2 && MarketChooseBox.showMore(cur.marketChooseBox.curTabId, e)
            }
        },
        showMore: function(o, a) {
            if (!cur.marketChooseBox.isLoading) {
                if (-1 == ["search", "album", "albums", "all"].indexOf(o)) return !1;
                var e = {
                    type: o,
                    to_id: cur.oid,
                ...
                "search" == o ? (e.q = trim(val(cur.marketChooseBox.searchInputEl)), e.album_id = cur.marketChooseBox.curAlbum) : "album" == o && (e.album_id = cur.marketChooseBox.curAlbum), ajax.post("/al_market.php", e, {
                    cache: 1,
                    onDone: function(e, t, r) {
                        a.insertAdjacentHTML("beforeBegin", t), cur.marketChooseBox.position[o] += e, r || (hide(geByClass1("ui_load_more_btn", cur.marketChooseBox.curTab)), cur.marketChooseBox.disableScroll[o] = !0)
                    },
                    showProgress: function() {
        ...
        setCurrentTab: function(e) {
            cur.marketChooseBox.prevTab = cur.marketChooseBox.curTab, hide(cur.marketChooseBox.prevTab), (cur.marketChooseBox.curTab = e) == cur.marketChooseBox.tabAll ? cur.marketChooseBox.curTabId = "all" : e == cur.marketChooseBox.tabAlbums ? cur.marketChooseBox.curTabId = "albums" : e == cur.marketChooseBox.tabAlbum ? cur.marketChooseBox.curTabId = "album" : e == cur.marketChooseBox.tabSearch && (cur.marketChooseBox.curTabId = "search"), show(cur.marketChooseBox.curTab)
        },
        ...
        getAlbum: function(e, o, t) {
            cancelEvent(t);
            var a = "album";
            cur.marketChooseBox.position[a] = 0, cur.marketChooseBox.disableScroll[a] = !1;
            var r = {
                type: a,
                offset: cur.marketChooseBox.position[a],
                limit: cur.marketChooseBox.perPage[a],
                act: "a_choose_box_get_items",
                to_id: e,
                album_id: o
            };
            ajax.post("/al_market.php", r, {
                onDone: function(e, t, r) {
                    cur.marketChooseBox.tabAlbum.innerHTML = t, cur.marketChooseBox.position[a] = e, r || (cur.marketChooseBox.disableScroll[a] = !0), cur.marketChooseBox.curAlbum = o, 0 == e && hide(cur.marketChooseBox.searchInputEl), MarketChooseBox.setCurrentTab(cur.marketChooseBox.tabAlbum), hide(cur.marketChooseBox.tabs), MarketChooseBox.showBackButton()
                },
                showProgress: function() {
                    cur.marketChooseBox.isLoading = !0
                },
        ...
        attachItem: function(e, t, r, o) {
            if (cancelEvent(o), "item" == e) {
                ...
                ajax.post("/al_market.php", a, {
                    onDone: function(e, t, r) {
                        cur.chooseMedia("market_album", e, t, r, !0, !1), curBox().hide()
                    }
                })
            }
        },
        ...
        searchItems: function() {
            ...
            var o = "search";
            cur.marketChooseBox.position[o] = 0;
            var t = {
                type: o,
                offset: cur.marketChooseBox.position[o],
                limit: cur.marketChooseBox.perPage[o],
            ...
            ajax.post("/al_market.php", t, {
                cache: 1,
                onDone: function(e, t, r) {
                    cur.marketChooseBox.position[o] = e, cur.marketChooseBox.tabSearch.innerHTML = t, cur.marketChooseBox.curTab != cur.marketChooseBox.tabSearch && (hide(cur.marketChooseBox.tabs), MarketChooseBox.showBackButton(), MarketChooseBox.setCurrentTab(cur.marketChooseBox.tabSearch))
                },
                showProgress: function() {
                    cur.marketChooseBox.isLoading = !1
                },
    ...
    MarketTags = {
        init: function(e, t) {
            if (!this.inited) {
                ...
                this.cont.appendChild(r), this.resultList = geByClass("result_list", r)[0], this.resultListShadow = geByClass("result_list_shadow", r)[0], hide(this.resultList, this.resultListShadow), browser.chrome ? this.resultList.style.opacity = 1 : browser.safari || setStyle(this.resultListShadow, "top", browser.mozilla ? 0 : browser.msie && browser.version < 8 ? 0 : -1), this.resultList.style.width = this.resultListShadow.style.width = r.style.width = getSize(e)[0] + "px", this.onShowCallback = !!t && t.onShow, this.initSelect(t), cur.indexTags = new vkIndexer(cur.tagsList, function(e) {
                    return e[1]
                }), addEvent(e, "keyup click mouseup", this.inputUpHandler), addEvent(document, "click", this.documentClick), addEvent(e, "keypress keydown", this.inputDownHandler)
            }
        },
        inputUpHandler: function(e) {
            var i = MarketTags;
            if (i.select) {
                if ((i.select.isVisible() && -1 < i.select.active || cur.preventISRequest) && (delete cur.preventISRequest, inArray(e.keyCode, [KEY.UP, KEY.DOWN, KEY.PAGEUP, KEY.PAGEDOWN, KEY.RETURN]))) return cancelEvent(e);
                clearTimeout(cur.requestTimeout);
                var s = val(i.input);
                (i.currentTerm = s) ? cur.requestTimeout = setTimeout(function() {
                    var e = cur.indexTags.search(s),
                        t = i.getHighlight(s);
                    list = [];
                    for (var r = 0, o = e.length; r < o; r++) {
                        var a = clone(e[r]);
                        t && (a.push(""), a.push(a[1]), a[1] = a[1].replace(t.re, t.val)), list.push(a)
                    }
                    i.showSelectList(s, list)
                }, 300): i.showSelectList(s, cur.tagsList.slice(0, 10))
            }
        },
        ...
        showSelectList: function(e, t) {
            this.select && ((t = isArray(t) && t.length ? t : []).length ? (this.select.clear(), this.lastItems = t, this.select.content(t), this.select.show(), isFunction(this.onShowCallback) && this.onShowCallback()) : this.select.hide())
        },
        ...
        getHighlight: function(e) {
            var t = cur.indexTags,
                r = t.delimiter,
                o = t.trimmer;
            return e += " " + (parseLatin(e) || ""), e = (e = escapeRE(e).replace(/&/g, "&amp;")).replace(o, "").replace(r, "|"), {
                re: new RegExp("(" + e + ")", "gi"),
                val: "<em>$1</em>"
            }
        },
    ...
    Marketplace = {
        init: function() {
            ...
            }, 0), Marketplace.filters.init(), nav.objLoc.q && saveSearchAttemptStats("market", 0, !isVisible(cur.notFound))
        },
        scroll: {
            init: function() {
        ...
        filters: {
            ...
            getValue: function(r) {
                var e = !1;
                if ("Selector" == r.__className) r.selectedItems()[0] && (e = clone(r.selectedItems()[0])).push(r.selectedItems()[0]);
                else if ("INPUT" == r.tagName) {
                    var t = val(r);
                    if (e = [t, t, "" === t], "text" == r.type) {
                        var o = gpeByClass("ui_search_fltr_sel", r),
                ...
                } else hasClass(r, "checkbox") && isChecked(r) && (e = [1, "", ""]);
                return e
            },
            onEnterSearch: function() {
                var e = trim(val(cur.searchInp));
                cur.lastQ != e && Marketplace.searchItems("", "" !== e)
            },
            ...
            onChangeQuery: function(e, t, r) {
                "string" == typeof t && Marketplace.searchItems(t, "" !== e)
            },
        ...
        switchToCatalog: function(e, t) {
            return !!cur.searchMode || uiRightMenu.go(e, t)
        },
        ...
        deleteItem: function(e, t, r, o) {
            var s = showFastBox({
                ...
                ajax.post("al_market.php?act=a_delete_item", i, {
                    onDone: function(e, t) {
                        s.hide(), re("market_item" + i.id), cur.itemsCount--;
                        var r = "",
                            o = "";
                        0 < cur.itemsCount ? (r = langNumeric(cur.itemsCount, "%s", !0), o = getLang("market_summary_X_goods", cur.itemsCount, !0)) : (o = getLang("market_summary_no_goods"), geByClass1("market_empty", cur.notFound).innerHTML = cur.aid ? getLang("market_album_empty") : getLang("market_catalog_empty"), hide(cur.listEl), show(cur.notFound));
                        var a = geByClass1("market_summary_text", "market_list_wrap");
                        a ? a.innerHTML = o : val("market_items_count", r), Marketplace.changeCounter(-1), showDoneBox(e)
                    },
        ...
        getSearchParams: function() {
            ...
            t && t[0] && 0 < t[0].length && (e.sort = t[0][0]);
            var r = cur.searchFilters.category.selectedItems();
            r && r[0] && (e.category = 0 < r[0].length ? r[0][0] : 0);
            var o = cur.searchFilters.subcategory.selectedItems();
            o && o[0] && (e.subcategory = 0 < o[0].length ? o[0][0] : 0);
            var a = cur.searchFilters.country.selectedItems();
            a && a[0] && 0 < a[0].length ? a[0][0] != cur.defaultCountry && (e.country = a[0][0]) : e.country = 0;
            var i = cur.searchFilters.city.selectedItems();
            i && i[0] && 0 < i[0].length ? i[0][0] != cur.defaultCity && (e.city = i[0][0]) : e.city = 0;
            var s = cur.searchFilters.metro.selectedItems();
            s && s[0] && 0 < s[0].length && (e.metro = s[0][0]);
            var n = val(cur.searchFilters.price_from);
            n && (e.price_from = n);
            var c = val(cur.searchFilters.price_to);
            (c && (e.price_to = c), e.q) && (isChecked(cur.searchFilters.by_names) && (e.by_names = 1));
        ...
        changeView: function(t) {
            if (cur.viewType != t && !cur.changeViewTypeLoad) {
                var e = {},
                    r = !1,
                    o = !(cur.searchOffset = 0),
                    a = "";
                a = "my" == cur.act ? "a_marketplace_my" : "fav" == cur.act ? "a_marketplace_fav" : (o = !(r = !0), "a_marketplace_search"), r && (e = Marketplace.getSearchParams()), o && (e.section = cur.section), e.view_type = t, e.act = a, ajax.post("/al_market.php", e, {
                    cache: 1,
                    onDone: function(e) {
                        e && (cur.marketplaceContent.innerHTML = e), cur.viewIcons.forEach(function(e) {
                            cur.viewType = t, toggleClass(e, "selected")
                        })
                    },
                    showProgress: function() {
        ...
        searchItems: function(_, h) {
            if (!cur.isSearchLoading) {
                cur.searchOffset = 0;
                var g = Marketplace.getSearchParams();
                _ && (g.q = _);
                var k = +new Date;
                ajax.post("/al_market.php?act=a_marketplace_search", g, {
                    cache: 1,
                    onDone: function(e, t, r, o, a, i, s, n) {
                        var c = !1;
                        if (c = g.groups ? 0 != o : 0 == t && 0 != o && !cur.forseTabSwitch, !g.groups && c) {
                            var l = geByClass("ui_tab", "market_place_search_tabs")[1];
                            c = !0, uiTabs.switchTab(l), cur.groups = 1
                        }
                        var u = c ? a : r,
                            m = c ? o : t,
                            d = langNumeric(t, "%s", !0),
                            p = langNumeric(o, "%s", !0);
                        cur.searchMode = !n, cur.searchMode ? (cur.filtersShown || searcher.toggleMinimizedFilters(ge("search_filters_minimized")), addClass(cur.onlyFriendsTogglerBlock, "unshown"), removeClass(cur.searchTabs, "hide"), addClass(cur.itemsSubheader, "hide"), addClass(cur.marketplaceContent, "marketplace_content_search"), cur.userItemSearchCounter.innerHTML = t ? d : "0", cur.commItemSearchCounter.innerHTML = o ? p : "0") : (addClass(cur.searchTabs, "hide"), removeClass(cur.onlyFriendsTogglerBlock, "unshown"), removeClass(cur.itemsSubheader, "hide"), removeClass(cur.marketplaceContent, "marketplace_content_search"), cur.userItemsCounter.innerHTML = d), u ? show(cur.userItemsMoreBtn) : hide(cur.userItemsMoreBtn), cur.marketplaceContent.innerHTML = e, m ? (cur.searchMode || removeClass(cur.itemsSubheader, "hide"), show(cur.marketplaceFull), hide(cur.notFound)) : ("" == g.q && addClass(cur.itemsSubheader, "hide"), cur.notFoundText.innerHTML = i, hide(cur.marketplaceFull), show(cur.notFound)), cur.searchResults || (cur.searchResults = {}), _ && s && (!cur.searchResults[_] || cur.searchResults[_].count < t + o) && (cur.searchResults[_] = {
                            count: t + o,
                            countHash: s
                        }), c ? cur.uiMetro.disable(!0) : cur.uiMetro.disable(!1), Marketplace.updateLocation(g), h && saveSearchAttemptStats("market", k, !isVisible(cur.notFound))
                    },
                    showProgress: function() {
        ...
        showMore: function() {
            if (!isButtonLocked(cur.userItemsMoreBtn)) {
                ...
                var s = {},
                    ...
                    r = !0,
                    o = "";
                o = "my" == cur.act ? "a_marketplace_my" : "fav" == cur.act ? "a_marketplace_fav" : (r = !(t = !0), "a_marketplace_search"), t && (s = Marketplace.getSearchParams()), r && (s.section = cur.section), s.offset = cur.searchOffset, s.act = o, ajax.post("/al_market.php", s, {
                    onDone: function(e, t, r, o, a, i) {
                        ("a_marketplace_search" == s.act && 1 == s.groups ? a : r) ? show(cur.userItemsMoreBtn): hide(cur.userItemsMoreBtn), e && cur.marketplaceContent.appendChild(cf(e))
                    },
                    showProgress: function() {
        ...
        hideUserItems: function(r, o, e) {
            var a = showFastBox(getLang("market_hide_user_items_confirm_title"), getLang("market_hide_user_items_confirm"), getLang("market_hide_user_items_confirm_btn"), function() {
                var e = a.btns.ok[0];
                if (!isButtonLocked(e)) {
                    var t = {
