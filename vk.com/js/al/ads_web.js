...
AdsWeb.showAds = function() {
    ...
    window.vkAsyncInit = function() {
        ...
        VK.Widgets.Ads('ads_web_widget_container', {
            base_domain: location.protocol + '//' + location.host,
            onAdsReady: AdsWeb.onAdsReady,
            onResizeWidget: AdsWeb.onAdsResizeWidget
        }, paramsExtra);
    }
...
AdsWeb.initSiteCode = function(widgetHtml, adsParams, adsParamsExtra, openapiVersion) {
    ...
    window.radioBtns['ads_demo'] = {
        els: Array.prototype.slice.apply(geByClass('radiobtn', ge('ads_web_site_code_ads_demo_wrap')))
    };
    window.radioBtns['ads_ad_type'] = {
        els: Array.prototype.slice.apply(geByClass('radiobtn', ge('ads_web_site_code_ads_ad_type_wrap')))
    };
    window.radioBtns['ads_ad_unit_type'] = {
        els: Array.prototype.slice.apply(geByClass('radiobtn', ge('ads_web_site_code_ads_ad_unit_type_wrap')))
    };
    window.radioBtns['ads_font_size'] = {
        els: Array.prototype.slice.apply(geByClass('radiobtn', ge('ads_web_site_code_ads_font_size_wrap')))
    };
}
...
AdsWeb.saveSite = function(editBox, actionParams) {
    ...
    ajax.post('/adsweb?act=site_save', ajaxParams, {
        onDone: onComplete,
        onFail: onComplete
    });
...
AdsWeb.deleteSite = function(actionParams) {
    ...
    ajax.post('/adsweb?act=site_delete', ajaxParams, {
        onDone: onComplete,
        onFail: onComplete
    });
...
AdsWeb.changeSiteParams = function(actionParams, doneRedirect) {
    ...
    ajax.post('/adsweb?act=site_change_params', ajaxParams, {
        onDone: onComplete,
        onFail: onComplete
    });
...
AdsWeb.changeDomainNameParams = function(actionParams) {
    ...
    ajax.post('/adsweb?act=domain_name_change_params', ajaxParams, {
        onDone: onComplete,
        onFail: onComplete
    });
...
AdsWeb.removeDomainName = function(actionParams) {
    ...
    ajax.post('/adsweb?act=domain_name_remove', ajaxParams, {
        onDone: onComplete,
        onFail: onComplete
    });
...
AdsWeb.saveSiteTags = function(editBox, actionParams, uiTags) {
    ...
    ajax.post('/adsweb?act=site_tags_save', ajaxParams, {
        onDone: onComplete,
        onFail: onComplete
    });
...
AdsWeb.changeUnitParams = function(actionParams) {
    ...
    ajax.post('/adsweb?act=unit_change_params', ajaxParams, {
        onDone: onComplete,
        onFail: onComplete
    });
...
AdsWeb.initTagEdit = function(editBox, actionParams, tagRootTypeInitial) {
    ...
    window.ads_web_tag_edit_box_save = '���������';
    ...
    if (tagRootTypeInitial !== false) {
        window.radioBtns['ads_tag_root_type'] = {
            val: tagRootTypeInitial,
            els: Array.prototype.slice.apply(geByClass('radiobtn', ge('ads_web_tag_root_type_wrap')))
        };
    }
...
AdsWeb.saveTag = function(editBox, actionParams, tagRootTypeInitial) {
    ...
    ajax.post('/adsweb?act=tag_save', ajaxParams, {
        onDone: onComplete,
        onFail: onComplete
    });
...
AdsWeb.removeTag = function(actionParams) {
    ...
    ajax.post('/adsweb?act=tag_remove', ajaxParams, {
        onDone: onComplete,
        onFail: onComplete
    });
...
AdsWeb.saveAdmin = function(editBox, actionParams) {
    ...
    ajax.post('/adsweb?act=admin_save', ajaxParams, {
        onDone: onComplete,
        onFail: onComplete
    });
...
AdsWeb.removeAdmin = function(actionParams) {
    ...
    ajax.post('/adsweb?act=admin_remove', ajaxParams, {
        onDone: onComplete,
        onFail: onComplete
    });
...
AdsWeb.initDomainSpecialEdit = function(editBox, actionParams, domainSpecialType) {
    ...
    window.radioBtns['ads_domain_special_type'] = {
        val: domainSpecialType,
        els: Array.prototype.slice.apply(geByClass('radiobtn', ge('ads_web_domain_special_type_wrap')))
    };
...
AdsWeb.saveDomainSpecial = function(editBox, actionParams, domainSpecialStatus) {
    ...
    ajax.post('/adsweb?act=domain_special_save', ajaxParams, {
        onDone: onComplete,
        onFail: onComplete
    });
