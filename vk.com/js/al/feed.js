var Feed = {
    longView: {
        ...
        isElemViewable: function(e, t, o, s) {
            var i = feed.longView.getHeaderHeight(),
                ...
                c = e.offsetTop + i,
                d = c + a,
                l = d > r && n > c ? (Math.min(n, d) - Math.max(r, c)) / a : 0;
            return l >= t
        },
            ...
            "news" != cur.section && "comments" != cur.section && t > .3 || "news" == cur.section && (e || t > .05) || (cur.feedUpdateLoading = !0, ajax.post("al_feed.php?au_" + cur.section, extend(feed.getSectionParams(cur.section), {
                ...
                onDone: function(t, o, s) {
                    ...
                    if (!("feed" !== cur.module || t.section != cur.section || t.timestamp < cur.timestamp || s < cur.timestamp)) {
                        ...
                        if ("news" == cur.section) {
                            if (a = scrollGetY(), o) {
                                for (d.innerHTML = o; d.lastChild;) i = d.lastChild, c.insertBefore(i, c.firstChild), Feed.onPostLoaded(i, !0);
        ...
        switch (s) {
            case "new_post":
                ...
                if (C && (b = wall.updatePostImages(b)), y) {
                    ...
                    if (p = geByClass1("feed_reposts_wrap" + y, m, "div")) _ = geByClass1("feed_reposts_first", p, "div").firstChild, h = geByClass1("feed_reposts_group", p, "div"), g = geByClass1("feed_reposts_more_link", p, "a"), feed.needScrollPost(t, _) && (c -= _.offsetHeight + d(_)), _.parentNode.replaceChild(f = se(T), _), h.insertBefore(_, h.firstChild), isVisible(h) || val(g, getLang("news_show_X_reposts", h.childNodes.length)), p = p.parentNode, m.firstChild != p && m.insertBefore(p, m.firstChild), feed.needScrollPost(t, p) && (c += p.offsetHeight + d(p)), p.bits = 0;
    ...
    feedPostRepl: function(e, t) {
        ...
        if ("search" == cur.section && cur.q) {
            ...
            var a, c, d, l = s.toLowerCase();
            for (a = r.length - 1; a >= 0; a--)
                if (d = r[a], trim(d))
                    for (c = 0; - 1 != (c = l.indexOf(d, c));) s.charAt(c - 1) != String.fromCharCode(2) ? (s = s.substr(0, c) + "" + a + "" + s.substr(c + d.length), l = l.substr(0, c) + "" + a + "" + l.substr(c + d.length)) : c += 2;
    ...
    notifySendReply: function(e, t, o) {
        ...
        if (s && !s.sending) {
            ...
            if (o.stickerId) var d = {
                ...
                if (d.delayed) return;
                if (!d.attach1_type && (!d.message || s.greet && !s.greet.indexOf(d.message))) return void Emoji.editableFocus(r, !1, !0)
            }
            extend(d, {
                act: "post",
                from: "feedback",
            ...
            l && isVisible(domPN(l)) && (d.from_oid = domData(domClosest("_submit_post_box", l), "from-oid")), s.sending = 1, ajax.post("al_wall.php", Wall.fixPostParams(d), {
                onDone: function(t, o) {
    ...
    scrollCheck: debounce(function(e) {
        if (e = e || {}, "scroll" == e.type || cur.idleManager && !cur.idleManager.isIdle) {
            var t, o, s, i, r, n, a = feed.longView,
                ...
                l = 0,
                u = [];
            if (cur.isFeedLoading || cur.disableAutoMore || (i = ge("show_more_link"), isVisible(i) && d + c + 1e3 > i.offsetTop && feed.showMore()), (domPN(cur.topRow) != cur.rowsCont || "feed_rows_next" == (cur.topRow || {}).id) && (cur.topRow = domFC(cur.rowsCont)), vk.id && cur.topRow && "feed_rows_next" != cur.topRow.id && (!((window.curNotifier || {}).idle_manager || {}).is_idle || "init" == e.type)) {
                var f = [];
                for (i = domPS(cur.topRow); i; i = domPS(i)) cur.topRow.offsetTop > d && (cur.topRow = i), i.unseen || (i.unseen = !0, f.push(Feed.postsGetRaws(i)));
                for (Page.postsUnseen(f), i = cur.topRow; i && (t = l ? l : i.offsetTop, !(t >= d + c)); i = r)
                    if (r = domNS(i), "feed_rows_next" == (r || {}).id && (r = null), l = r ? r.offsetTop : t + i.offsetHeight, d > l && r && (cur.topRow = r), LongView && LongView.register(i, "feed"), !a.registerElement(i) && (n = i.bits || 0, !(n >= 3) && (cur.feedSeenPostHeight > 0 ? (cur.feedPostHeaderHeight = cur.feedPostHeaderHeight || getH(geByClass1("post_header", i)), o = t + cur.feedPostHeaderHeight, s = o + cur.feedSeenPostHeight, i.postBottom || (i.postBottom = o + getH(geByClass1("wall_text", i))), s = Math.min(s, i.postBottom), n |= (o >= d && d + c > o ? 1 : 0) | (s >= d && d + c > s ? 2 : 0)) : n |= (t >= d && d + c > t ? 1 : 0) | (l >= d && d + c > l ? 2 : 0), n && (i.bits = n, 3 == n)))) {
    ...
    postsGetRaws: function(e) {
        ...
        if (d && (a.hash = d), "block_" === r.id.substr(0, 6)) {
            a[r.id] = 1, a.block = r.id.substr(6);
            var l = attr(r, "data-contain");
