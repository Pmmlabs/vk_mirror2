var Feed = {
    ...
    setSection: function(newSection, from, options) {
        ...
        if (from > 1) {
            ...
            if (newSection === 'search' && options.stories_block_show) {
                addClass(cur.feedEls.wrap, 'feed_submit_shown_stories');
            } else {
                removeClass(cur.feedEls.wrap, 'feed_submit_shown_stories');
            }
