var Feed = {
            ...
            "news" != cur.section && "comments" != cur.section && t > .3 || "news" == cur.section && (e || t > .05) || (cur.feedUpdateLoading = !0, ajax.post("al_feed.php?au_" + cur.section, extend(feed.getSectionParams(cur.section), {
                ...
                onDone: function(t, o, s) {
                    ...
                    if (!("feed" !== cur.module || t.section != cur.section || t.timestamp < cur.timestamp || s < cur.timestamp)) {
                        ...
                        if ("news" == cur.section) {
                            if (a = scrollGetY(), o) {
                                for (d.innerHTML = o; d.lastChild;) r = d.lastChild, c.insertBefore(r, c.firstChild), Feed.onPostLoaded(r, !0);
                            ...
                            for (d.innerHTML = o; r = d.lastChild;)
                                if ("DIV" == r.tagName)
                            ...
                            d.removeChild(r)
                        } else a = scrollGetY(), c.insertBefore(r, c.firstChild), Feed.onPostLoaded(r, !0), nodeUpdated(r), l = r.offsetHeight, a > 100 && scrollToY(a + l, 0, !1, !0);
    ...
    pushEvent: function(e, t) {
        ...
        switch (s) {
            ...
            case "del_post":
                if (i) {
                    var F = domClosest("feed_row", i) || domClosest("feed_row_unshown", i) || i;
                    cur.wallMyDeleted[r] || (feed.needScrollPost(t, i) && (c -= i.offsetHeight + d(i)), revertLastInlineVideo(i), re(F)), cur.options.offset--, hasClass(cur.feedEls.wrap, "feed_has_new") && !isVisible(F) && (cur.newPostsCount--, cur.newPostsCount ? cur.feedEls.newPosts.innerHTML = getLang("news_new_posts", cur.newPostsCount) : removeClass(cur.feedEls.wrap, "feed_has_new"))
                }
                break;
            case "res_post":
    ...
    applyOptions: function(options, from) {
        ...
        }, 800) : options.podcasts_trend_tooltip && setTimeout(function() {
            Feed.showPodcastTrendTooltip(options.podcasts_trend_tooltip_hash)
    ...
    notifySendReply: function(e, t, o) {
        ...
        if (s && !s.sending) {
            ...
            if (o.stickerId) var d = {
                ...
                if (d.delayed) return;
                if (!d.attach1_type && (!d.message || s.greet && !s.greet.indexOf(d.message))) return void Emoji.editableFocus(i, !1, !0)
            }
            extend(d, {
                act: "post",
                from: "feedback",
    ...
    scrollCheck: debounce(function(e) {
        if (e = e || {}, "scroll" == e.type || cur.idleManager && !cur.idleManager.isIdle) {
            var t, o, s, r, i, n, a = feed.longView,
                ...
                l = 0,
                u = [];
            if (cur.isFeedLoading || cur.disableAutoMore || (r = ge("show_more_link"), isVisible(r) && d + c + 1e3 > r.offsetTop && feed.showMore()), (domPN(cur.topRow) != cur.rowsCont || "feed_rows_next" == (cur.topRow || {}).id) && (cur.topRow = domFC(cur.rowsCont)), vk.id && cur.topRow && "feed_rows_next" != cur.topRow.id && (!((window.curNotifier || {}).idle_manager || {}).is_idle || "init" == e.type)) {
                var f = [];
                for (r = domPS(cur.topRow); r; r = domPS(r)) cur.topRow.offsetTop > d && (cur.topRow = r), r.unseen || (r.unseen = !0, f.push(Feed.postsGetRaws(r)));
                for (Page.postsUnseen(f), r = cur.topRow; r && (t = l ? l : r.offsetTop, !(t >= d + c)); r = i)
    ...
    postsGetRaws: function(e) {
        ...
        if (d && (a.hash = d), "block_" === i.id.substr(0, 6)) {
    ...
    showPodcastTrendTooltip: function(e) {
        var t = ge("ui_rmenu_podcasts");
        t && (cur.podcastsTabFeatureTT = new ElementTooltip(t, {
            content: '<div class="feature_tooltip__close" onclick="cur.podcastsTabFeatureTT.hide();"></div>' + getLang("wall_podcasts_trend_feature_text"),
            forceSide: "left",
            cls: "feature_intro_tt feature_info_tooltip podcasts_trend_feature_tooltip",
            autoShow: !1,
            noHideOnClick: !0,
            noAutoHideOnWindowClick: !0,
            appendToParent: !0,
