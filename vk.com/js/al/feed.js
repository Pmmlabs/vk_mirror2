var Feed = {
            ...
            return each(t, function(e, t) {
                ...
                if (o && s) {
                    ...
                    if (r && (i += "_" + r), !f[i] && document.body.contains(t))
                        if (u(t, l, a, c)) {
                            var n = Date.now();
                            t.longViewStartedAt ? n - t.longViewStartedAt >= d && (f[i] = !0, p.push(feed.postsGetRaws(t))) : t.longViewStartedAt = Date.now()
                            ...
                            if ("news" == cur.section) {
                                ...
                                if (each([].slice.call(geByClass("reply", s, "div")), function() {
                                    ...
                                    var h = scrollGetY(),
                                        ...
                                        w = getXY(u)[1],
                                        m = r.parentNode.offsetHeight;
                                    p = m - p, inArray(i, cur.feedUnread) || cur.feedUnread.unshift(i), !cur.idleManager.isIdle && h + 100 < w && w < h + g + 100 ? (a.insertBefore(ge("post_ph" + i) || ce("div", {
                                        id: "post_ph" + i
                                    }), a.firstChild), inArray(i, cur.feedToSort) || cur.feedToSort.push(i)) : (re(r.parentNode), a.insertBefore(r.parentNode, a.firstChild), h + g + 100 < w && (p = m), p && scrollToY(scrollGetY() + p, 0, !1, !0)), cur.feedUnreadCount += f
                                }
                                c.removeChild(s)
    ...
    pushEvent: function(t, o) {
        ...
        switch ((Wall.isArchiveWall() ? "archive_post" === s : "reveal_post" === s) && (s = "res_post"), (Wall.isArchiveWall() ? "reveal_post" === s : "archive_post" === s) && (s = "del_post"), s) {
            case "new_post":
                ...
                var f, p, _, h, g, w = (L = cur.rowsCont).childNodes,
                    m = wall.getNewPostHTML(t, d, feed.feedPostRepl),
                    v = t[12],
                ...
                var C = !1,
                    k = m;
                if (b && (m = wall.updatePostImages(m)), v) {
                    ...
                    if (f = geByClass1("feed_reposts_wrap" + v, L, "div")) p = geByClass1("feed_reposts_first", f, "div").firstChild, _ = geByClass1("feed_reposts_group", f, "div"), h = geByClass1("feed_reposts_more_link", f, "a"), feed.needScrollPost(o, p) && (c -= p.offsetHeight + l(p)), p.parentNode.replaceChild(x = se(k), p), _.insertBefore(p, _.firstChild), isVisible(_) || val(h, getLang("news_show_X_reposts", _.childNodes.length)), f = f.parentNode, L.firstChild != f && L.insertBefore(f, L.firstChild), feed.needScrollPost(o, f) && (c += f.offsetHeight + l(f)), f.bits = 0;
                        ...
                        m = rs(cur.wallTpl.grouped_posts, {
                            place: v,
                        ...
                        var P = se('<div class="feed_row' + (b ? "_unshown" : "") + '">' + m + "</div>"),
                            T = domFC(T);
                    ...
                    } else x = se('<div class="feed_row' + (b ? "_unshown" : "") + '"><div class="feed_repost' + v + '">' + m + "</div></div>"), Wall.updateAnonNewPost(t, x), L.insertBefore(x, L.firstChild), C = !0, !b && feed.needScrollPost(o, x) && (c += x.offsetHeight + l(x))
                } else x = se('<div class="feed_row' + (b ? "_unshown" : "") + '">' + m + "</div>"), Wall.updateAnonNewPost(t, x), L.insertBefore(x, L.firstChild), C = !0, !b && feed.needScrollPost(o, x) && (c += x.offsetHeight + l(x));
                if (0 == t[8]) {
                ...
                b && C && (cur.newPostsCount = cur.newPostsCount ? cur.newPostsCount + 1 : 1, cur.feedEls.newPosts.innerHTML = getLang("news_new_posts", cur.newPostsCount), addClass(cur.feedEls.wrap, "feed_has_new"), 1 == cur.newPostsCount && feed.needScrollPost(o, cur.feedEls.newPosts) && !y && (c += getSize(cur.feedEls.newPosts)[1])), AudioUtils.updateQueueReceivedPost(x), wall.votingUpdateByPostRaw(r), cur.feedUnreadCount++, "search" != n && nodeUpdated(x), 300 < w.length ? L.removeChild(w[300]) : w.length <= 1 && removeClass(cur.feedEls.wrap, "feed_is_empty"), Wall.updateMentionsIndex();
                break;
            case "new_post_reply":
                if (i) break;
                w = (L = cur.rowsCont).childNodes, m = wall.getNewPostHTML(t, !1, feed.feedPostRepl);
                var x = se('<div class="feed_row">' + m + "</div>");
                L.insertBefore(x, L.firstChild), feed.needScrollPost(o, x) && (c += x.offsetHeight + l(x)), cur.feedUnreadCount++, 300 < w.length ? L.removeChild(w[300]) : w.length <= 1 && removeClass(cur.feedEls.wrap, "feed_is_empty");
                break;
            case "edit_post":
                var E, B = ge("wpt" + r);
                ...
                (L = ge("post" + r)) && !isVisible(L.parentNode) && (M = wall.updatePostImages(M)), window.fifaReplaceText && (M = fifaReplaceText(M)), val(B, M), R && (R = geByClass1("wall_post_more", B)) && R.onclick(), wall.votingUpdateByPostRaw(r), E && (c += B.offsetHeight), nodeUpdated(B), window.Wall && Wall.updatePostAuthorData(r);
                break;
            case "edit_reply":
                var R, H = t[3];
                B = ge("wpt" + H);
            ...
            case "res_post":
                ...
                break;
            case "new_reply":
                if (!i || cur.wallMyReplied[r] || ge("post" + t[3])) break;
                ...
                var V = ge("replies" + r),
                    I = ge("replies_wrap" + r),
                    O = i.offsetHeight,
                    q = (d = (u = r.split("_")[0]) < 0 ? 8 & a ? constants.Groups.GROUPS_ADMIN_LEVEL_EDITOR : 2 & a ? constants.Groups.GROUPS_ADMIN_LEVEL_MODERATOR : constants.Groups.GROUPS_ADMIN_LEVEL_USER : constants.Groups.GROUPS_ADMIN_LEVEL_USER, wall.getNewReplyHTML(t, d)),
                    U = (x = !1, !1);
                if (isVisible(V) && isVisible(I) && !isVisible("reply_link" + r)) {
                    var W = V.nextSibling,
                        G = geByClass("new_reply", V, "div").length + 1;
                    ...
                    } else q = wall.updatePostImages(q), x = se(q), addClass(x, "new_reply"), W && "replies_open" == W.className || (W = ce("div", {
                        className: "replies_open",
                        onclick: wall.openNewComments.pbind(r),
                        role: "button",
                        tabIndex: 0
                    }), V.parentNode.insertBefore(W, V.nextSibling)), W.innerHTML = getLang("wall_x_new_replies_more", Math.min(100, G)), W.newCnt = G
                } else re("reply_link" + r), show(I, V), U = !0;
                r.split("_")[0] == vk.id && cur.feedUnreadCount++, x || (x = se(q)), V.appendChild(x), feed.needScrollPost(o, U ? x : W) && (c += i.offsetHeight - O), U && nodeUpdated(x), Wall.repliesSideSetup(r), Wall.updateMentionsIndex(), Likes.update("wall" + r, {
                    comment_num: t[13]
                });
                break;
            case "del_reply":
                if (!cur.wallMyDeleted[r] && i) {
                    ...
                    feed.needScrollPost(o, i) && (c -= i.offsetHeight);
                    S = i.parentNode.id.match(/replies(-?\d+_\d+)/);
    ...
    unifiedRestoreRow: function(e, t, r) {
        var o = ce("span", {
        ...
        ajax.post("al_feed.php", {
            ...
            onDone: function(e) {
                var t = gpeByClass("_feedback_deleted", r);
                if (t) {
            ...
            showProgress: function() {
                r && "button" === r.tagName.toLowerCase() ? lockButton(r) : r.parentNode.replaceChild(o, r)
            },
            hideProgress: function() {
                r && "button" === r.tagName.toLowerCase() ? unlockButton(r) : o.parentNode.replaceChild(r, o)
            }
        })
    },
        ...
        if (cur.notifyDeletingAll || (cur.notifyDeletingAll = {}), !cur.notifyDeletingAll[l]) {
            ...
            ajax.post("al_feed.php", {
                ...
                onDone: function(e, t) {
                    ...
                    if (1 != t) {
                        var s, r;
                        if ((s = hasClass(o, "_top_feedback_deleted") ? (!0, ge("top_notify_cont")) : cur.rowsCont) && (r = s.firstChild)) {
                            for (var i, n, a = !1, c = scrollGetY(); r.className && hasClass(r, "_feed_row") && r.firstChild && l == r.firstChild.getAttribute("author") && (i = r.offsetHeight, n = r.offsetTop, !1 === a && (a = getXY(r.offsetParent)[1]), hide(r), n + a < c && (c -= i, scrollToY(c, 0))), r = r.nextSibling;);
    ...
    scrollCheck: debounce(function(e) {
        if ("scroll" == (e = e || {}).type || cur.idleManager && !cur.idleManager.isIdle) {
            ...
            if (cur.isFeedLoading || cur.disableAutoMore || (r = ge("show_more_link"), isVisible(r) && l + c + 1e3 > r.offsetTop && feed.showMore()), domPN(cur.topRow) == cur.rowsCont && "feed_rows_next" != (cur.topRow || {}).id || (cur.topRow = domFC(cur.rowsCont)), vk.id && cur.topRow && "feed_rows_next" != cur.topRow.id && (!((window.curNotifier || {}).idle_manager || {}).is_idle || "init" == e.type)) {
                ...
                var w = ge("show_more_link"),
                    m = w.offsetTop;
                if (!w.seen && l <= m && m < l + c) {
                    w.seen = Date.now();
                    var v = cur.section + (cur.subsection ? "_" + cur.subsection : "");
                    statlogsValueEvent("feed_load_more_seen", isButtonLocked(w), v)
                }
            }
        }
    }, 20),
    postsGetRaws: function(e) {
        ...
        if (l && (a.hash = l), "block_" === i.id.substr(0, 6)) {
            ...
            var u = i.id;
            hasClass(i, "post_photos") && (s = geByClass1("post_image", i, "a")) && (s = domFC(s)) && (o = s.getAttribute("data-post-id").match(/^(-?\d+_p?\d+)$/)) && (u = o[1]), a[u] = 1
        }
        return a
    },
