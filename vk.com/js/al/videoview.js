var Videoview = {
        ...
        initAddButton: function() {
            ...
            function i(i, t, a) {
                ...
                toggleClass(v, "mv_add_icon_curr", !i), toggleClass(v, "mv_add_icon_down", i), toggleClass(d, "mv_add_icon_curr", i), removeEvent(r, "click", o), removeEvent(r, "setAdded", o), i ? (l.innerHTML = getLang("video_added_to_my_playlist"), e(t)) : (l.innerHTML = getLang("video_add_to_my_playlist"), mvcur.addButtonTT && mvcur.addButtonTT.destroy(), mvcur.addButtonTT = null, addEvent(r, "click", o), addEvent(r, "setAdded", o)), a || s == i || Videoview.playerOnAdded(), s = i;
        ...
        show: function(e, i, o, t) {
            window.ap && ap.isPlaying() && (ap.pause(), ap.pausedByVideo = vkNow()), window.forcePauseAudio = !0, t && t.autoplay && Videoview.playerCallback.onVideoStreamPlaying(), debugLog("show video " + i);
            ...
            return t.playlistId ? Videoview.initPlaylistBlock(i, t.playlistId, t.catLoadMore) : VideoPlaylist.removeBlock(), Videoview.cleanUpStoredVSegs(), t.minimized && setTimeout(Videoview.minimize.bind(Videoview), 0), !1
        },
        ...
        initPlaylistBlock: function(e, i, o) {
            if (-127333786 != e.split("_")[0]) {
                ...
                if (a && /^wall_/.test(i) && VideoPlaylist.lists[i] && cur.wallVideos && cur.wallVideos[i] && (VideoPlaylist.extendList(i, cur.wallVideos[i].list), VideoPlaylist.updateBlockList(i)), a) {
                    ...
                    (window.Video && Video.isInVideosList() && vk.id == cur.oid || 5 > n) && (t || VideoPlaylist.toggle(!1)), isFunction(o) && o(VideoPlaylist.updateBlockList.pbind(i)), setTimeout(function() {
        ...
        restoreVideo: function(e, i, o, t, a) {
            var n = ge("mv_warning");
            return n && (n.innerHTML = '<img style="margin-left: 100px;" src="/images/upload.gif" />'), ajax.post("al_video.php", {
                act: "restore_video",
                vid: e,
                oid: i,
                hash: o,
        ...
        licensed: function(e, i) {
            ...
            (o || e).innerHTML = '<img src="/images/upload.gif" />', show(o), ajax.post("al_video.php", {
                act: "change_licensed",
                video: mvcur.mvData.videoRaw,
                hash: i
            }, {
...
window.VideoChat = {
    ...
    receiveDelete: function(e, i) {
        ...
        o && !hasClass(o, "_deleting") && VideoChat.scroll.updateAbove(function() {
    ...
    vk: function(e, i) {
        ...
        onLoaded(function() {
            checkMp4(function(o, t) {
                !o && "timeout" == t && /smart-tv/.test(window._ua) && (o = !0), o && !i.is_flv || browser.flash >= Videoview.FLASH_MIN_VERSION || i.live ? (i.can_play_mp4 = o ? 1 : 0, VideoInitializer.vkHtml5(e, i)) : show(domByClass(e, "video_box_msg")), !o && t && window._ua && _ua.indexOf("smart-tv") > -1 && ajax.post("al_video.php?act=log_cant_play_mp4_reason", {
                    ua: window._ua,
                    reason: t
                }, {
                    onFail: function() {
