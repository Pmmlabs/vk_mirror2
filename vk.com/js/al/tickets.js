var Tickets = {
    ...
    getPayFields: function() {
        ...
        switch (cur.payType) {
            case 0:
                e.pay_type = cur.payType, e.pay_date = val("tickets_payment_date"), e.number_from = cur.phone, val("tickets_number_to") && (e.number_to = trim(val("tickets_number_to"))), val("tickets_sms_text") && (e.sms_text = trim(val("tickets_sms_text"))), val("tickets_payed_sum") && (e.payed_sum = trim(val("tickets_payed_sum")));
                break;
            case 1:
            ...
            case 2:
            case 3:
                e.pay_type = cur.payType, e.pay_date = val("tickets_payment_date"), e.pay_sum = floatval(val("tickets_pay_sum")), e.pay_currency = cur.currencyDD.val(), 2 == cur.payType && (4 == cur.paySystem ? e.pay_system_name = trim(val("tickets_paysystem_name")) : e.pay_system = cur.paySystem);
                break;
            case 4:
