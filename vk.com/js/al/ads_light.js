! function() {
    ...
    isVkDomain && ("__adsLoaded" in window || (window.__adsLoaded = vkNow()), window.AdsLight = AdsLight), AdsLight.init = function() {
        ...
        function s(e) {
            e && AdsLight.handleEvent("ads.onEvent", "onFocusWindow", 0), r || (r = !0, _ = window.vkNow && vkNow() || 0, vk__adsLight.userEventTime = window.vkNow && vkNow() || 0, n())
        }
        ...
        function a(e, t) {
            ...
            return e && !t ? (clearTimeout(c), void(c = setTimeout(function() {
                a(e, !0)
            }, 100))) : (e && AdsLight.handleEvent("ads.onEvent", "onScrollWindow", 0), vk__adsLight.userEventTime = window.vkNow && vkNow() || 0, n(), isVkDomain && window.vkNow && window.vk && vk.ads_rotate_interval && s() && (clearTimeout(h), h = setTimeout(function() {
        ...
        for (var s in vk__adsLight.adsShowedAll)(!e[s] || vk__adsLight.adsShowedAll[s].publish_time > e[s].publish_time) && n - vk__adsLight.adsShowedAll[s].publish_time < 1e4 && (e[s] = vk__adsLight.adsShowedAll[s]);
        for (var i = [], a = 0, d = t.length; d > a; a++) {
            var s = t[a];
            i.push(e[s].ads_showed_hash)
        }
        ...
        var t = ge("ads_left"),
            s = e && __adsLoaded === !1,
            i = !0;
        return i = i && t && isVisible(t) && (vk__adsLight.activeTab > 0 && AdsLight.isVisibleBlockWrap() || s), i = i && vk.id && (vk__adsLight.adsCanShow >= 1 || vkNow() + vk__adsLight.adsCanShow > 36e5), "web" === vk__adsLight.adsSection ? i = i && 2 === vk__adsLight.loadComplete : (i = i && isVisible("side_bar") && !layers.visible && !isVisible("left_friends"), i = i && !vk.no_ads && (vk.loaded || s)), i
    }, AdsLight.getAjaxParams = function(e, t) {
        var s = {},
            i = AdsLight.canUpdate(!0);
        return t.noAds || t.cache ? s.al_ad = 0 : i || t.ads ? ((t.ads || window.vkNow && window.vk && vk.ads_rotate_interval && "web" !== vk__adsLight.adsSection && vkNow() - __adsLoaded >= vk.ads_rotate_interval) && (__adsLoaded = vkNow(), s.al_ad = 1), (e.al_ad || s.al_ad) && (s.ads_section = vk__adsLight.adsSection, s.ads_showed = AdsLight.getAdsShowed())) : s.al_ad = null, s
        ...
        function s(t) {
            ...
            t || !l || l == vk__adsLight.windowId ? (clearInterval(a), clearTimeout(d), vk__adsLight.updateProgress = 2, AdsLight.onAdsShowed(0), e()) : l != o && (o = l, clearInterval(a), clearTimeout(d), a = setInterval(s, i ? 100 : 200), d = setTimeout(s.pbind(!0), 5050)), n[l] = n[l] ? n[l] + 1 : 1
        }
        ...
        for (var t in e) {
            ...
            var s = e[t].split(":"),
                ...
                n = "label=",
                r = "";
            switch (o.substr(0, n.length) === n && (r = o.substr(n.length)), vk__adsLight.yaDirectAdActive = !1, i) {
                case "ya_direct":
                    ...
                    return AdsLight.tryRenderYaDirect(d[1], a, r, e.slice(t + 1)), !0;
                case "criteo":
        ...
        for (var _ = getXY(e)[1], h = scrollGetY(), c = !t, v = _ + 50 > h + lastWindowHeight ? 0 : 200, g = AdsLight.getBlockSize(e), u = [0, 0], p = e.appendChild("string" == typeof t ? ce("div", {
                innerHTML: t
            }, {
                display: "none"
        ...
        for (var s, i = 0; s = t[i]; i++) s.getAttribute("external_stats_complete") || (s.setAttribute("external_stats_complete", 1), vkImage().src = s.getAttribute("external_stats_src"))
        ...
        var s = ge("ads_left"),
            ...
            a = [];
        return i.right && i.bottom && (a.push([i.left + 1 * (i.right - i.left) / 5, i.top + 1 * (i.bottom - i.top) / 5]), a.push([i.left + 4 * (i.right - i.left) / 5, i.top + 4 * (i.bottom - i.top) / 5])), AdsLight.isVisibleBlockWrapCoords(a, s, t, e), vk__adsLight.wrapVisible
        ...
        !i && o.length && window != parent && isVkDomain && "web" === vk__adsLight.adsSection && vk__adsLight.rpc && vk__adsLight.rpc.callMethod ? (vk__adsLight.rpc.callMethod("publish", "ads.isVisibleBlockWrap", o, c), h = setTimeout(c, 300)) : !i && o.length && window != parent && !isVkDomain && window.VK && VK.callMethod ? (VK.callMethod("adsPublish", "ads.isVisibleBlockWrap", o, c), h = setTimeout(c, 300)) : c()
        ...
        return o || n ? (s && (o && (s[0] = a), n && (s[1] = d)), isVkDomain && "web" === vk__adsLight.adsSection && vk__adsLight.rpc && vk__adsLight.rpc.callMethod && vk__adsLight.rpc.callMethod("resizeWidget", o && a, n && d), [a, d]) : [a, d]
        ...
        var i, a = "mouseover" === e.type,
            d = !1;
        if (hasClass(t, s) ? (i = t, toggleClass(i, "over", a), d = a ? 1 : .3) : (i = geByClass1(s, i), i.over = 1, hasClass(i, "over") || (d = a ? .3 : 0)), d !== !1 && animate(i, {
                opacity: d
            }, 200), a && t == i) {
        ...
        if (vk__adsLight.yaDirectLoaded) {
            ...
            if (ge(d)) return void animate(ge(d), {
                ...
                re(d), AdsLight.tryRenderYaDirect(e, t, s, i)
            });
            a = ce("div", {
                id: d
            });
            var o = ge("ads_left");
            if (!o) return AdsLight.sendExperimentStat(t, "fail"), void AdsLight.onYaDirectRenderUnsuccessful(i);
        ...
        }, i.src = "/ads_light.php?act=criteo", void ge("ads_left").appendChild(i))
            ...
            clearTimeout(d), d = setTimeout(function() {
                ...
                if (clearTimeout(d), t && t[0] && t[0].html) {
                    try {
                        ...
                        AdsLight.showNewBlock(o, (i.label ? i.label : "") + t[0].html, n)
                    } catch (l) {}
                    s(t)
                } else a({
                    reason: "no-ads"
        ...
        var d, o = "__rb" + (new Date).getTime(),
            ...
            l = {},
            _ = 5e3;
        i && i.test_id && (l.test_id = i.test_id), i && i.cpm_floor && "0" != i.cpm_floor && (l.cpm_floor = i.cpm_floor), i && i.vk_id && (l.vk_id = i.vk_id);
        var h;
        for (h in l) r += "&" + h + "=" + l[h];
        return a(r, t, s), o
    }, AdsLight.tryRenderTarget = function(e, t, s, i, a, d, o) {
        var n = {
            slot_id: t,
            label: i,
            cpm_floor: a,
        ...
        e && (n.test_id = e), window.vk && vk.id && (n.vk_id = vk.id), AdsLight.sendExperimentStat(s, "try");
        var r = !1,
            l = setTimeout(function() {
                AdsLight.sendExperimentStat(s, "noresult"), r && window[r] && (window[r] = function() {}), AdsLight.tryExperiment(o)
            }, 6e3);
        stManager.add(["mrtarg.js", "mrtarg.css"], function() {
            r = AdsLight.getRBAds("ads_left", function() {
                clearTimeout(l), AdsLight.sendExperimentStat(s, "success"), window.RB && window.RB.doCheck && window.RB.doCheck()
            }, function(e) {
                clearTimeout(l), AdsLight.sendExperimentStat(s, "fail"), AdsLight.tryExperiment(o)
            }, n)
        })
    }, AdsLight.init()
}();
