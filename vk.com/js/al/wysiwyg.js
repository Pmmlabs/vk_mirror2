...
function ToolBarButton(editor, buttonObj) {
    ...
    addEvent(this.div, 'mouseover', function() {
        editor.showTooltip(self.div, buttonObj.tooltip, 0);
    });
...
ToolBarButton.prototype = {
    mouseUpEvent: function(e) {
        if (this.mouseup && !this.disabled) this.mouseup();
    },
    mouseover: function() {
...
function ToolBar(editor, mode, params) {
    ...
    this.buttons = {
        bold: {
            x: 0,
            y: 0,
            tooltip: cur.lang.wiki_bold
        },
        italic: {
            x: -20,
            y: 0,
            tooltip: cur.lang.wiki_italic
        },
        underline: {
            x: -40,
            y: 0,
            tooltip: cur.lang.wiki_underline
        },
        gray: {
            x: -21,
            y: -39,
            tooltip: cur.lang.wiki_gray
        },
        strike: {
            x: -60,
            y: 0,
            tooltip: cur.lang.wiki_strike
        },
        sub: {
            x: -80,
            y: 0,
            tooltip: cur.lang.wiki_subscript
        },
        sup: {
            x: -100,
            y: 0,
            tooltip: cur.lang.wiki_superscript
        },
        left: {
            x: -120,
            y: 0,
            tooltip: cur.lang.wiki_align_left
        },
        center: {
            x: -140,
            y: 0,
            tooltip: cur.lang.wiki_align_center
        },
        right: {
            x: -40,
            y: -40,
            tooltip: cur.lang.wiki_align_right
        },
        marker_list: {
            x: -160,
            y: 0,
            tooltip: cur.lang.wiki_marker_list
        },
        numeric_list: {
            x: -180,
            y: 0,
            tooltip: cur.lang.wiki_numeric_list
        },
        outdent: {
            x: -200,
            y: 0,
            tooltip: cur.lang.wiki_outdent,
            canSelect: false,
            disabled: true
        },
        indent: {
        ...
        h1: {
            x: -240,
            y: 0,
            tooltip: cur.lang.wiki_add_header
        },
        h2: {
            x: -260,
            y: 0,
            tooltip: cur.lang.wiki_add_sub_header
        },
        h3: {
            x: -280,
            y: 0,
            tooltip: cur.lang.wiki_add_sub_sub_header
        },

        table: {
            x: 0,
            y: -20,
            tooltip: cur.lang.wiki_add_table
        },
        table_delete: {
            x: -20,
            y: -20,
            tooltip: cur.lang.wiki_delete_table,
            canSelect: false,
            disabled: true
        },
        insert_row_before: {
            x: -40,
            y: -20,
            tooltip: cur.lang.wiki_insert_row_before,
            canSelect: false,
            disabled: true
        },
        insert_row_after: {
            x: -60,
            y: -20,
            tooltip: cur.lang.wiki_insert_row_after,
            canSelect: false,
            disabled: true
        },
        insert_col_before: {
            x: -80,
            y: -20,
            tooltip: cur.lang.wiki_insert_col_before,
            canSelect: false,
            disabled: true
        },
        insert_col_after: {
            x: -100,
            y: -20,
            tooltip: cur.lang.wiki_insert_col_after,
            canSelect: false,
            disabled: true
        },
        delete_row: {
            x: -120,
            y: -20,
            tooltip: cur.lang.wiki_delete_row,
            disabled: true
        },
        delete_col: {
            x: -140,
            y: -20,
            tooltip: cur.lang.wiki_delete_col,
            disabled: true
        },
        col_width: {
            x: -160,
            y: -39,
            tooltip: cur.lang.wiki_col_width,
            disabled: true
        },
        link: {
            x: -160,
            y: -20,
            tooltip: cur.lang.wiki_add_link
        },
        unlink: {
            x: -180,
            y: -20,
            tooltip: cur.lang.wiki_delete_link,
            canSelect: false,
            disabled: true
        },
        citate: {
            x: -200,
            y: -20,
            tooltip: cur.lang.wiki_add_citate
        },
        character: {
            x: -220,
            y: -20,
            tooltip: cur.lang.wiki_insert_char
        },
        image: {
            x: -240,
            y: -20,
            tooltip: cur.lang.wiki_add_photo
        },
        video: {
            x: -260,
            y: -20,
            tooltip: cur.lang.wiki_add_video
        },
        audio: {
            x: -280,
            y: -20,
            tooltip: cur.lang.wiki_add_audio
        },

        doc: {
            x: -180,
            y: -40,
            tooltip: cur.lang.wiki_add_doc
        },
        time: {
            x: -60,
            y: -40,
            tooltip: cur.lang.wiki_insert_time
        },
        hider: {
            x: -80,
            y: -40,
            tooltip: cur.lang.wiki_insert_hider
        },
        signature: {
            x: -140,
            y: -40,
            tooltip: cur.lang.wiki_insert_signature
        },
        category: {
            x: 0,
            y: -40,
            tooltip: cur.lang.wiki_category_sub_category,
            canSelect: false
        },
        wiki: {
            x: -100,
            y: -40,
            tooltip: cur.lang.wiki_markup
        },
        pre: {
            x: -120,
            y: -40,
            tooltip: cur.lang.wiki_pre
        }
    }
    ...
    var afterIFrameInit = function() {
        if (!this.iFrameComplete || !this.iFrameCutComplete) {
            ...
            this.chooseVideoBox = new MessageBox({
                title: cur.lang.wiki_adding_video,
                width: 610,
            ...
            this.chooseAudioBox = new MessageBox({
                title: cur.lang.wiki_adding_audio,
                width: 610,
            ...
            this.charBox = new MessageBox({
                title: cur.lang.wiki_inserting_char,
                width: 340,
            ...
            this.categoryBox = new MessageBox({
                title: cur.lang.wiki_page_cat_and_sub_cat,
                width: 350,
                bodyStyle: 'padding: 0px;'
            });
            ...
            this.categoryBox.addButton({
                ...
                style: 'button_no',
                label: cur.lang.box_cancel
            });
            this.categoryBox.addButton({
                onClick: function() {
                    this.changeCategory();
                }.bind(this),
                label: cur.lang.wiki_edit
            });
...
Wysiwyg.prototype = {
    ...
    createResizeBar: function(width) {
        ...
        addEvent(document, 'mousemove', function(e) {
            if (self.isResize) self.resizeEditor(e, false, self);
        });
        addEvent(this.frameDoc, 'mousemove', function(e) {
            if (self.isResize) self.resizeEditor(e, true, self);
        });
    ...
    addButtonsActions: function() {
        ...
        var self = this,
            t = this.toolbar;
        each(defaultAction, function(i, obj) {
            self.defaultAction(obj[0], obj[1], obj[2])
        });
    ...
    defaultAction: function(elemName, actName, updateFormat) {
        var self = this;
        this.toolbar.addAction(elemName, function() {
            self.actSimple.call(self, elemName, actName, updateFormat)
        });
    },
    ...
    getElemsInSelection: function() {
        ...
        if (range.startContainer != range.endContainer) {
            ...
            var prev = common.commonPrev,
                next = common.commonNext,
                curr = prev;
    ...
    testSelectionCenter: function() {
        var elems = this.getElemsInSelection(),
            elemsCenters = true;
        if (elems.length > 1) {
    ...
    tableArrowTest: function(e) {
        if (this.nodeList['TABLE'] && this.inArray(e.keyCode, [KEY.LEFT, KEY.RIGHT, KEY.UP, KEY.DOWN])) {
            ...
            if ((table.className == '') || (table.className == 'wikTable') || (table.className == 'wk_table')) {
                var td = this.getParentElement('TD'),
                    row = td.parentNode,
    ...
    alertBox: function(title, content, okButton, cancelButton, okCallback, cancelCallback) {
        ...
        if (cancelButton) {
            alertBox.addButton(cancelButton, function() {
                alertBox.hide();
                if (cancelCallback) cancelCallback();
            }, 'gray');
        }
        if (okButton) {
            alertBox.addButton(okButton, function() {
                alertBox.hide();
    ...
    getCommonParent: function(prev, next) {
        var prevTemp = prev,
            nextTemp = next,
            prevParentArray = new Array(),
            nextParentArray = new Array();
    ...
    *************************** */
    ...
    changeCategory: function() {
        var box = this.categoryBox,
            error = '',
            regExp = new RegExp('[!@$%^&~\|]+', 'i');
        var catText = box.cb_text.value,
            subText = box.cb_sub_text.value,
            catError = box.cb_error;
    ...
    *************************** */
    actHider: function() {
        ...
        var range = this.getRange();
        var self = this;
        var hiderBox = new MessageBox({
            title: cur.lang.wiki_info
        });
        ...
        if (this.nodeList['TD'] && this.nodeList['TD'].classes['hiderBody']) {
            hiderBox.addButton(cur.lang.box_cancel, function() {
                hiderBox.hide();
            }, 'no');
    ...
    createHider: function(headerNode, bodyNode, opened) {
        ...
        addEvent(hiderArrow, 'click', function() {
            this.switchHider(hiderArrow)
        }.bind(this));
    ...
    *************************** */
    chooseVideo: function() {
        this.chooseVideoBox = showBox('video.php', {
    ...
    surround: function(tagName, range) {
        ...
        if (browser.msie) {
            ...
            if (rng.htmlText == '') {
                ...
                var prev = startRng.parentElement(),
                ...
                if ((prev.nodeName != 'BODY') && (next.nodeName != 'BODY')) {
                    if (prev.parentNode == next.parentNode) contTag = this.surroundByTagName(sel, rng, prev, next, startRng, endRng, tagName);
                        ...
                        var commonPrev = commonObj.commonPrev,
            ...
            var prev = rng.startContainer,
                next = rng.endContainer;
    ...
    *************************** */
    actHeader: function(tag) {
        ...
        var range = this.getRange(),
            text = browser.msie ? range.text : range.toString();
        if (text.length != 0) {
    ...
    *************************** */
    charBoxInit: function() {
        ...
        var charsArray = [
            [
                [169, 'copy', cur.lang.wiki_char_copy],
                [174, 'reg', cur.lang.wiki_char_reg],
                [8482, 'trade', cur.lang.wiki_char_trade],
                [8240, 'permil', cur.lang.wiki_char_permil],
                [8249, 'lsaquo', cur.lang.wiki_char_lsaquo],
                [8250, 'rsaquo', cur.lang.wiki_char_rsaquo],
                [171, 'laquo', cur.lang.wiki_char_laquo],
                [187, 'raquo', cur.lang.wiki_char_raquo],
                [167, 'sect', cur.lang.wiki_char_sect],
                [182, 'para', cur.lang.wiki_char_para]
            ],
            [
                [185, 'sup1', cur.lang.wiki_char_sup1],
                [178, 'sup2', cur.lang.wiki_char_sup2],
                [179, 'sup3', cur.lang.wiki_char_sup3],
                [188, 'frac14', cur.lang.wiki_char_frac14],
                [189, 'frac12', cur.lang.wiki_char_frac12],
                [190, 'frac34', cur.lang.wiki_char_frac34],
                [8722, 'minus', cur.lang.wiki_char_minus],
                [177, 'plusmn', cur.lang.wiki_char_plusmn],
                [247, 'divide', cur.lang.wiki_char_divide],
                [8260, 'fras1', cur.lang.wiki_char_fras1]
            ],
            [
                [215, 'times', cur.lang.wiki_char_times],
                [402, 'fnof', cur.lang.wiki_char_fnof],
                [8747, 'int', cur.lang.wiki_char_int],
                [8721, 'sum', cur.lang.wiki_char_sum],
                [8734, 'infin', cur.lang.wiki_char_infin],
                [8730, 'radic', cur.lang.wiki_char_radic],
                [8800, 'ne', cur.lang.wiki_char_ne],
                [176, 'deg', cur.lang.wiki_char_deg],
                [8804, 'le', cur.lang.wiki_char_le],
                [8805, 'ge', cur.lang.wiki_char_ge]
            ],
            [
                [945, 'alpha', cur.lang.wiki_char_alpha],
                [946, 'beta', cur.lang.wiki_char_beta],
                [947, 'gamma', cur.lang.wiki_char_gamma],
                [948, 'delta', cur.lang.wiki_char_delta],
                [949, 'epsilon', cur.lang.wiki_char_epsilon],
                [969, 'omega', cur.lang.wiki_char_omega],
                [937, 'Omega', cur.lang.wiki_char_omega_uppercase],
                [956, 'mu', cur.lang.wiki_char_mu],
                [8211, 'ndash', cur.lang.wiki_char_ndash],
                [8212, 'mdash', cur.lang.wiki_char_mdash]
            ],
            [
                [8592, 'larr', cur.lang.wiki_char_larr],
                [8594, 'rarr', cur.lang.wiki_char_rarr],
                [8593, 'uarr', cur.lang.wiki_char_uarr],
                [8595, 'darr', cur.lang.wiki_char_darr],
                [8596, 'harr', cur.lang.wiki_char_harr],
                [8597, 'varr', cur.lang.wiki_char_varr],
                [9824, 'spades', cur.lang.wiki_char_spades],
                [9827, 'clubs', cur.lang.wiki_char_clubs],
                [9829, 'hearts', cur.lang.wiki_char_hearts],
                [9830, 'diams', cur.lang.wiki_char_diams]
            ]
        ];
        ...
        addEvent(chars, 'mouseover', function(e) {
            overFunc(e)
        });
    ...
    *************************** */
    choosePhoto: function() {
        this.choosePhotoBox = showBox('photos.php', {
    ...
    photoBoxInit: function() {
        ...
        addEvent(box.pb_photo_id, 'blur', function() {
            if (this.isLoadNow) return false;
            this.tryLoadPhoto();
        }.bind(this));
        addEvent(box.pb_photo_id, 'keyup', function() {
            if (this.isLoadNow) return false;
            this.tryLoadPhoto();
        }.bind(this));
        addEvent(box.pb_photo_id, 'click', function() {
            this.select();
        });
    ...
    photoSetup: function(elemID, changeSize, loaded) {
        ...
        if (box == undefined || box.loaded == undefined || !loaded) {
            ...
            this.photoBox = showBox('wiki.php', {
                act: 'photo_box',
                al_wiki_editor: true
            }, {
                params: {
        ...
        box.removeButtons();
        box.addButton(cur.lang.box_cancel, function() {
            box.hide();
            box.boxShow = false;
            notes.photoElemID = null;
        }, 'gray');
        ...
        if (elemID != undefined) {
            ...
            box.correct = true;
            box.setOptions({
                title: cur.lang.wiki_edit_photo
            });
            box.addButton(cur.lang.wiki_edit, function() {
                notes.insertPhoto(elemID);
            });
            ...
            box.addButton(cur.lang.global_add, function() {
                notes.insertPhoto();
            });
            this.addPhotoBoxControlText();
            each(['pb_photo_id', 'pb_photo_text', 'pb_photo_url', 'pb_photo_width', 'pb_photo_height'], function(i, obj) {
                box[obj].value = '';
            });
            var options = {
                disabled: [
                    [],
                    ['pb_photo_url', 'pb_photo_width', 'pb_photo_height'], false
                ],
                disable: [
                    [],
    ...
    testPhotoSetupError: function(errorNum) {
        var box = this.photoBox,
            error = null,
            pmin = this.params.photoMinSize,
            pmax = this.params.photoMaxSize;
        if (!box.correct) {
        ...
        if (errorNum != undefined) {
            if ((error == null) || (error && (error[0] != errorNum))) {
                fadeTo(box.pb_error, this.showErrorTime, 0, function() {
                    hide(box.pb_error);
                    box.showError = false;
                });
            }
    ...
    loadPhotoResize: function(photoURL, w, h, changeSize) {
        var box = this.photoBox,
            preview = box.pb_photo_preview,
            view = box.pb_photo_view;
        var pw = box.pb_photo_width,
            ph = box.pb_photo_height;
        view.src = photoURL;
        if (w > h) {
            var newW = this.photoPreviewSize,
                newH = Math.round(h / (w / this.photoPreviewSize));
        } else {
            var newW = Math.round(w / (h / this.photoPreviewSize)),
                newH = this.photoPreviewSize;
        }
    ...
    sizeChange: function(e, sideName) {
        ...
        if (isChecked(box.saveRatio) && box.correct) {
            var w = box.current.originalWidth,
                h = box.current.originalHeight;
            var iw = parseInt(box.pb_photo_width.value),
                ih = parseInt(box.pb_photo_height.value);
    ...
    *************************** */
    actTable: function(loaded) {
        ...
        if (box == undefined || !loaded) {
            this.tableBox = showBox('wiki.php', {
                act: 'table_box'
            }, {
                onDone: function() {
                    notes.tableBox.loaded = true;
                    notes.tableBox.setOptions({
                        width: 465,
        ...
        if ((table != null) && (table.nodeName == 'TABLE') && ((table.className != 'hider') && (table.className != 'hiderOpened'))) {
            ...
            box.setOptions({
                title: cur.lang.wiki_edit_table
            });
            box.removeButtons();
            box.addButton(cur.lang.box_cancel, function() {
                box.hide();
            ...
            box.setOptions({
                title: cur.lang.wiki_adding_table
            });
            box.removeButtons();
            box.addButton(cur.lang.box_cancel, function() {
                box.hide();
            }, 'gray');
            box.addButton(cur.lang.wiki_insert, function() {
                notes.insertTable();
            });
    ...
    actTableActions: function(action) {
        ...
        if (action == 'delete_row') {
            ...
            if (table.rows.length == 1) {
                this.alertBox(cur.lang.wiki_warning, deleteLastRow, cur.lang.box_yes, cur.lang.box_cancel, function() {
                    deleteRow(true)
                }, null);
            } else {
                this.alertBox(cur.lang.wiki_warning, cur.lang.wiki_warning_delete_row, cur.lang.box_yes, cur.lang.box_cancel, function() {
                    deleteRow(false)
                }, null);
            }
            ...
            if (table.rows[0].cells.length == 1) {
                this.alertBox(cur.lang.wiki_warning, deleteLastCol, cur.lang.box_yes, cur.lang.box_cancel, function() {
                    deleteCol(true)
                }, null);
            } else {
                this.alertBox(cur.lang.wiki_warning, cur.lang.wiki_warning_delete_col, cur.lang.box_yes, cur.lang.box_cancel, function() {
                    deleteCol(false)
                }, null);
            }
            ...
            if (table.rows[0].cells.length == 1) {
                this.alertBox(cur.lang.wiki_warning, cur.lang.wiki_col_width, cur.lang.box_yes, cur.lang.box_cancel, function() {
                    colWidth(true, this.value)
                }, null);
            } else {
                ...
                widthAlertBox = showFastBox({
                    title: cur.lang.wiki_col_width,
                    width: 230
                }, "������� ������ �������: <input type='text' id='col_width_input' maxlength = '3' size = '3' value = '" + columnWidth + "'>&nbsp;<b>%</b>");
                ge('col_width_input').value = columnWidth;
                widthAlertBox.removeButtons();
                widthAlertBox.addButton(box_cancel, function() {
                    widthAlertBox.hide();
                }, 'gray');
                widthAlertBox.addButton(box_save, function() {
                    colWidth(false, ge('col_width_input').value);
                    widthAlertBox.hide();
                });
                ge('col_width_input').focus();
            }
        } else if ((action == 'insert_row_before') || (action == 'insert_row_after')) {
            var newRow = this.frameDoc.createElement('TR'),
                cellTag = 'TD';
            ...
            for (var i = 0; i < table.rows.length; i++) {
                var cell = null,
                    cellType = table.rows[i].cells[colIndex].nodeName;
                if (cellType == 'TD') {
    ...
    testInsertTable: function(errorNum) {
        ...
        if (errorNum != undefined) {
            if ((error == null) || (error && (error[0] != errorNum))) {
                fadeTo(box.tb_error, this.showErrorTime, 0, function() {
                    hide(box.tb_error);
                    box.showError = false;
                });
            }
    ...
    tableCreateCells: function(rows, cols) {
        ...
        addEvent(cells, 'mouseover', function(e) {
            over(e)
        });
        addEvent(cells, 'mouseout', function(e) {
            out(e)
        });
        addEvent(cells, 'mouseup', function(e) {
            up(e)
        });
    ...
    *************************** */
    insertLink: function(linkElem) {
        var box = this.linkBox,
            url = trim(box.lb_link_url.value),
            text = trim(box.lb_link_text.value),
            popup = false;
    ...
    actLink: function(loaded) {
        ...
        if (linkElem != null) {
            box.setOptions({
                title: cur.lang.wiki_edit_link
            });
            box.addButton(cur.lang.wiki_edit, function() {
                notes.insertLink(linkElem);
            });
            ...
            var href = this.decURI(linkElem.href),
                subHref = href.replace(this.vk, '').replace(this.vkcom, '');
            ...
            box.setOptions({
                title: cur.lang.wiki_adding_link
            });
            box.addButton(global_add, function() {
                notes.insertLink();
            });
    ...
    testInsertLinkError: function(errorNum) {
        ...
        if (errorNum != undefined) {
            if ((error == null) || (error && (error[0] != errorNum))) {
                fadeTo(box.lb_error, this.showErrorTime, 0, function() {
                    hide(box.lb_error);
                    box.showError = false;
                });
            }
    ...
    *************************** */
    ...
    createAudioTable: function(audioID, performer, title, duration) {
        var playSrc = 'http://' + locDomain + '/images/play.gif',
            ac = '';
        ...
        addEvent(table, 'click', function(e) {
            self.selectElement.call(self, this);
            return cancelEvent(e);
        });
        table.unselectable = 'on';
        var tableChilds = table.getElementsByTagName('*');
        each(tableChilds, function(i, obj) {
            obj.unselectable = 'on';
        });
    ...
    chooseAudio: function() {
        this.chooseAudioBox = showBox('audio.php', {
    ...
    *************************** */
    chooseDoc: function() {
        this.chooseDocBox = showBox('docs.php', {
    ...
    *************************** */
    setCut: function(maxHeight, offset) {
        var childs = this.frameDoc.body.childNodes,
            currHeight = 0,
            bCut = this.frameDocCut,
            cutElem = null;
        bCut.body.innerHTML = '';
    ...
    setCutIE: function(maxHeight, offset) {
        ...
        if ((cutElem != null) && ((currHeight + offset) < divHeight)) {
            var cutComment = this.frameDoc.createComment('CUT'),
                childs = this.frameDoc.body.childNodes;
    ...
    getWikiLink: function(node) {
        ...
        if ((url.indexOf(this.vk) == 0) || (url.indexOf(this.vkcom) == 0) || (url.indexOf('javascript:wikiBox.loadPage') == 0)) {
            ...
            if (innerLink = innerUrl.match(/id[0-9]+/i)) {} else if (innerLink = innerUrl.match(/photo-?[0-9]+_[0-9]+/i)) {} else if (innerLink = innerUrl.match(/video-?[0-9]+_[0-9]+/i)) {} else if (innerLink = innerUrl.match(/club[0-9]+/i)) {} else if (innerLink = innerUrl.match(/topic-?[0-9]+_[0-9]+/i)) {} else if (innerLink = innerUrl.match(/note-?[0-9]+_[0-9]+/i)) {} else if (innerLink = innerUrl.match(/page-?[0-9]+_[0-9]+/i)) {} else if (innerLink = innerUrl.match(/wikiBox\.loadPage\((\d+), '(.*?)'\)/i)) {
                var groupID = parseInt(innerLink[1]);
                pGroupID = this.params.groupID, group = '', pageName = innerLink[2];
                ...
                var groupID = parseInt(innerLink[1]);
                pGroupID = this.params.groupID, group = '', pageId = parseInt(innerLink[2]);
                if (text != '') text = '|box|' + text;
                if (pGroupID && (pGroupID == groupID)) {
                ...
                var groupID = parseInt(innerLink[1]),
                    pGroupID = this.params.groupID,
                    group = '',
                    pageName = innerLink[2];
    ...
    getWikiHeader: function(node) {
        var result = '',
            headerText = this.getInnerText(node);
    ...
    *************************** */
    ...
    htmlSetContent: function(html) {
        var c = html.replace(/href=([\"\'])(.+?)\1/gi, function(a, b, c) {
            return 'href="' + this.encURI(this.decURI(c)) + '"'
        }.bind(this));
        c = c.replace(/<!--[\s\S]*?-->/gi, '');
        c = c.replace(/<\/?nowiki>/gi, function(nowiki) {
            return nowiki.replace(/nowiki/gi, 'pre')
        });
        c = c.replace(/<pre>[\s\S]*?<\/pre>/gi, function(pre) {
            return pre.replace(/\n/gi, 'z98_7n_op1')
        });
        c = c.replace(/\r\n|\r|\n/gi, '');
        c = c.replace(/<pre>([\s\S]*?)<\/pre>/gi, function(a, b) {
            return this.preReplaceFunc(b)
        }.bind(this));
            ...
            if (audioPatternMatch != null) {
                ...
                for (var i = 0; i < divsLength; i++) {
                    if (divs[index] && (divs[index].className.toLowerCase() == 'audio' || divs[index].className.toLowerCase() == 'audiorow')) {
                        var audioText = '',
                            tags = divs[index].getElementsByTagName('*');
    ...
    htmlVideoGetInfo: function(wiki) {
        ...
        if (videoPatternMatch != null) {
            ...
            for (var i = 0; i < wikiVideos.length; i++) {
                ...
                videos[i] = params;
                var id = 'video' + i;
                var func = function(videoID) {
                    return function() { /*self.actVideo.call(self, videoID)*/ }
                };
                var closureFunc = func(id);
                if (img != null) {
                    img.id = id;
