...
checkOAuth: function(googleLang, state, type) {
  ...
  if (type == 1) {
    ...
    var oauthUrl = 'https://graph.facebook.com/oauth/authorize?client_id=128749580520227&redirect_uri='+encodeURIComponent(redirectUri)+'&scope=offline_access&display=popup&state='+state;
  } else if (type == 4) {
