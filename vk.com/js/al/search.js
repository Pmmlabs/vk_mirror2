var slide_show = function(e) {
    ...
    searcher = {
        ...
        applyOptions: function(options, changeSection) {
            ...
            res.className = "search_results search_" + cur.section + "_results" + ("statuses" == cur.section || "auto" == cur.section ? " wall_module" : "") + ("statuses" == cur.section && "" !== options.summary || gpeByClass("page_block", res) ? "" : " page_block"), lighted && addClass(sc, "highlight");
