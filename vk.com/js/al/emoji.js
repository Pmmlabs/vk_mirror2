if (!window.Emoji) {
    var Emoji = {
        ...
        init: function(txt, opts) {
            ...
            Emoji.stickerSize = (window.devicePixelRatio >= 2) ? '128' : '64';
            Emoji.tabDefaultId = Emoji.TAB_RECENT_STICKERS;
            opts.txt = txt;
            opts.id = optId;
        ...
        curEmojiCats: {
            ...
            8: ['D83DDC93', 'D83DDC94', 'D83DDC95', 'D83DDC96', 'D83DDC97', 'D83DDC98', 'D83DDC99', 'D83DDC9A', 'D83DDC9B', 'D83DDC9C', 'D83DDC9D', 'D83DDC9E', 'D83DDC9F', 'D83DDCAC', 'D83DDCAD', 'D83DDD1E', '26A0', '26D4', 'D83DDC29', 'D83CDD98', 'D83CDF1A', 'D83DDDA4', 'D83DDCA8', 'D83DDD25', '2600', '2601', '26C4', '2744', '26C5', '2728', 'D83CDF0D', 'D83CDF1B', 'D83CDF1D', 'D83CDF1E', '2604', 'D83CDF08', 'D83CDF16', '2695'],
            9: ['D83CDDE8D83CDDF3', 'D83CDDE9D83CDDEA', 'D83CDDEAD83CDDF8', 'D83CDDEBD83CDDF7', 'D83CDDECD83CDDE7', 'D83CDDEED83CDDF9', 'D83CDDEFD83CDDF5', 'D83CDDF0D83CDDF7', 'D83CDDF7D83CDDFA', 'D83CDDFAD83CDDF8', 'D83CDDFAD83CDDE6', 'D83CDDF0D83CDDFF', 'D83CDDE7D83CDDFE', 'D83CDDE6D83CDDFA', 'D83CDDE6D83CDDF9', 'D83CDDE7D83CDDEA', 'D83CDDE7D83CDDF7', 'D83CDDFBD83CDDF3', 'D83CDDEDD83CDDF0', 'D83CDDE9D83CDDF0', 'D83CDDEED83CDDF1', 'D83CDDEED83CDDF3', 'D83CDDEED83CDDE9', 'D83CDDEED83CDDEA', 'D83CDDE8D83CDDE6', 'D83CDDE8D83CDDF4', 'D83CDDF2D83CDDF4', 'D83CDDF2D83CDDFE', 'D83CDDF2D83CDDFD', 'D83CDDF3D83CDDF1', 'D83CDDF3D83CDDFF', 'D83CDDF3D83CDDF4', 'D83CDDE6D83CDDEA', 'D83CDDF5D83CDDF1', 'D83CDDF5D83CDDF9', 'D83CDDF5D83CDDF7', 'D83CDDF8D83CDDE6', 'D83CDDF8D83CDDEC', 'D83CDDF9D83CDDF7', 'D83CDDF5D83CDDED', 'D83CDDEBD83CDDEE', 'D83CDDE8D83CDDF1', 'D83CDDE8D83CDDED', 'D83CDDF8D83CDDEA', 'D83CDDFFD83CDDE6', 'D83CDFF3200DD83CDF08FE0F', 'D83CDDE6D83CDDF7', 'D83CDDE8D83CDDF7', 'D83CDDEAD83CDDEC', 'D83CDDEDD83CDDF7', 'D83CDDEED83CDDF7', 'D83CDDF2D83CDDE6', 'D83CDDF3D83CDDEC', 'D83CDDF5D83CDDE6', 'D83CDDF5D83CDDEA', 'D83CDDF7D83CDDF8', 'D83CDDF8D83CDDF3', 'D83CDFF4DB40DC67DB40DC62DB40DC65DB40DC6EDB40DC67DB40DC7F', 'D83CDDFAD83CDDFE', 'D83CDDEED83CDDF8', 'D83CDDF9D83CDDF3']
        },
        curEmojiRecent: {},
        ...
        updateRecentStickers: function(optId) {
            var opts = Emoji.opts[optId];
            if (!Emoji.stickers[Emoji.TAB_RECENT_STICKERS] || !opts || !opts.emojiExpanded) {
                return;
            }
  ...
  <div class="emoji_smile _emoji_btn" title="' + placeholder + '" onmouseover="return Emoji.show(this, event);" onmouseout="return Emoji.hide(this, event);" onclick="return cancelEvent(event);">\
    <div class="emoji_smile_icon"></div>\
            ...
            if (selId) {
                ...
                for (var j in window.emojiStickers) {
                    ...
                    if (isRecentTab) {
                        ...
                        packHtml += '<div class="emoji_favorite_stickers_cont" id="emoji_favorite_stickers_cont' + optId + '">';
                    }
                    var list = pack.stickers;

                    for (var i in list) {
                        packHtml += Emoji.render.stickerRs(optId, packId, list[i]);
                    }
                    if (isRecentTab) {
                        recentHtml = packHtml + '</div>';
                    } else if (isFavTab) {
                        favoriteHtml = packHtml + '</div>';
                    } else if (isForced) {
                        html = packHtml + html;
                    } else {
                        html += packHtml;
                ...
                html = favoriteHtml + recentHtml + html;
            } else {
        ...
        updateStickersCont: function(optId) {
            var opts = Emoji.opts[optId];
            var html = Emoji.getTabCont(optId, Emoji.tabDefaultId);
        ...
        updateStickersPos: function(optId) {
            ...
            while (el) {
                if (!recent && hasClass(el, 'emoji_recent_stickers_cont')) {
                    el = el.firstChild;
                    recent = true;
                } else if (!favorite && hasClass(el, 'emoji_favorite_stickers_cont')) {
                    if (el.firstChild) {
                        el = el.firstChild;
                        favorite = true;
                    }
                ...
                if (!el.nextSibling && recent || !el.nextSibling && favorite) {
                    el = el.parentNode;
                }
                el = el.nextSibling;
            }
        ...
        scrollToStickerPack: function(optId, selId, fast) {
            ...
            var st = (stickersStart && selId != Emoji.tabDefaultId) ? stickersStart.offsetTop + getSize(stickersStart)[1] : 0;
        ...
        render: {
            ...
            stickerRs: function(optId, tabId, stickerMeta) {
                var tempOpts = {
                    optId: optId,
                    selId: tabId,
                    stickerId: stickerMeta[0],
                ...
                if ((!browser.msie || browser.msie_edge) && stickerMeta[3]) {
                    ...
                    var m = rand(1, 100000);
                    tempOpts.animationUrl = stickerMeta[3];
                    tempOpts.uniqId = m;
                } else {
            ...
            stickerHintRs: function(optId, el, stickerMeta) {
                ...
                return rs(rsTemplate, tempOpts);
            },
            stickerContent: function(optId, el, immediate) {
                var animationPath = attr(el, 'data-animation-path');
                var src = attr(el, 'data-src');
                var imgSrc = '/images/blank.gif';
                if (!immediate) {
                    imgSrc = src;
                }
                var stickerId = attr(el, 'data-sticker-id');
                var favHash = attr(el, 'data-fav-hash');
                var fav = attr(el, 'data-fav');
                var str = '';
                if (animationPath) {
                    var uniqId = attr(el, 'data-uniq-id');
                    str = "<div data-uniq-id='" + uniqId + "' onmouseenter='StickersAnimation.loadAndPlaySticker(this);'" +
                        " class='sticker_animation' data-sticker-id='" + stickerId + "' data-animation-path='" + animationPath + "'>" +
                        '<img class="sticker_img emoji_sticker_image" src="' + imgSrc + '" data-src="' + src + '"/>' +
                        "</div>";
                } else {
                    str = '<img class="emoji_sticker_image" src="' + imgSrc + '" data-src="' + src + '"/>';
                }
                if (Emoji.favoriteAvailable) {
                    var favClass = '';
                    if (fav == 1) {
                        favClass = ' on';
                    }
