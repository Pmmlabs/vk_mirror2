! function(t) {
                ...
                return t.prototype.push = function(t) {
                    ...
                    for (var e, i = [], o = 0; o < t.length; o++)
                        if (this._truncateTo > 0 && (t[o] = Math.min(this._truncateTo, Math.abs(t[o]))), this._sampleCount += 1, this._sampleCount >= this._sampleRate)
                            for (; this._sampleCount >= this._sampleRate;) this._sampleCount -= this._sampleRate, this._sampleCount <= .8 && this._algorithm.push(t[o]), e = this._algorithm.get(), i.push(e), this._normalizeAlgorithm && this._normalizeAlgorithm.push(e), this._algorithm.clear(), this._sampleCount > .2 && this._algorithm.push(t[o]);
                    ...
                    if (this._normalizeAlgorithm) {
                        ...
                        if (this._normalizeAlgorithm.clear(), n > 0)
                            for (var s = 0; s < i.length; s++) i[s] = i[s] / n, this._truncateTo > 0 && (i[s] = Math.min(this._truncateTo, Math.abs(i[s])))
                    }
                    return i
                }, t
            }()
    ...
    167: function(t, e, i) {
        ...
        }), window.mail && window.mail.onMessagesRepainted && (onDOMReady(s), mail.onMessagesRepainted(s)), window.AudioMessagePlayer = {
            loaded: !0,
