...
AdsPayments.openChangeBudgetBox = function(e, n) {
    ...
    if (cur.freeCompany) {
        ...
        "moder_id" in cur.freeCompany && cur.uiModerId.selectItem(cur.freeCompany.moder_id), "segment_id" in cur.freeCompany && cur.uiSegmentId.selectItem(cur.freeCompany.segment_id);
