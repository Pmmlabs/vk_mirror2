var Jobs = {
  view: function(id, e) {
    return showWiki({w: 'job'+id}, false, e);
  },
  addVacancyBox: function() {
    return !showBox('al_jobs.php', {act: 'add_box'}, {params: {dark: 1, width: 550}});
  },
  addVacancy: function(html) {
    var el = se(html), listEl = ge('jobs_vacancies_list');
  ...
  editVacancyBox: function(id) {
    return !showBox('al_jobs.php', {act: 'edit_box', id: id}, {params: {dark: 1, width: 550}});
  },
  ...
  declineApplicationBox: function(id) {
    return !showBox('al_jobs.php', {act: 'decline_application_box', id: id}, {params: {dark: 1, width: 550, hideButtons: true, bodyStyle: 'padding: 0'}});
  },
  acceptApplicationBox: function(id) {
    return !showBox('al_jobs.php', {act: 'accept_application_box', id: id}, {params: {dark: 1, width: 400, hideButtons: true, bodyStyle: 'padding: 0'}});
  },
  editCommentBox: function(id) {
    return !showBox('al_jobs.php', {act: 'edit_comment_box', id: id}, {params: {dark: 1, width: 400, hideButtons: true, bodyStyle: 'padding: 0'}});
  },
...
try{stManager.done('jobs.js');}catch(e){}
